---
title: "Get operationApprovalRequest"
...
## Response
If successful, this method returns a `200 OK` response code and [operationApprovalRequest](../resources/intune-rbac-operationapprovalrequest.md) object in the response body.
