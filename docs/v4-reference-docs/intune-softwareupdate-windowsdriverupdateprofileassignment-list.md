...
description: "List properties and relationships of the windowsDriverUpdateProfileAssignment objects."
author: "jaiprakashmb"
...
## Response
If successful, this method returns a `200 OK` response code and a collection of [windowsDriverUpdateProfileAssignment](../resources/intune-softwareupdate-windowsdriverupdateprofileassignment.md) objects in the response body.
