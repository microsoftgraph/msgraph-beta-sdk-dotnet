...
## Response
If successful, this method returns a `200 OK` response code and [deviceManagementCompliancePolicy](../resources/intune-deviceconfigv2-devicemanagementcompliancepolicy.md) object in the response body.
