...
## Response
If successful, this method returns a `200 OK` response code and [macOSCustomAppConfiguration](../resources/intune-deviceconfig-macoscustomappconfiguration.md) object in the response body.
