...
description: "Read properties and relationships of the enrollmentRestrictionsConfigurationPolicySetItem object."
author: "jaiprakashmb"
...
## Response
If successful, this method returns a `200 OK` response code and [enrollmentRestrictionsConfigurationPolicySetItem](../resources/intune-policyset-enrollmentrestrictionsconfigurationpolicysetitem.md) object in the response body.
