...
description: "List properties and relationships of the deviceManagementReusablePolicySetting objects."
author: "jaiprakashmb"
...
## Response
If successful, this method returns a `200 OK` response code and a collection of [deviceManagementReusablePolicySetting](../resources/intune-deviceconfigv2-devicemanagementreusablepolicysetting.md) objects in the response body.
