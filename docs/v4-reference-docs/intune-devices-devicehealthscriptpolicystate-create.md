---
title: "Create deviceHealthScriptPolicyState"
description: "Create a new deviceHealthScriptPolicyState object."
author: "jaiprakashmb"
...
Create a new [deviceHealthScriptPolicyState](../resources/intune-devices-devicehealthscriptpolicystate.md) object.
...
## Response
If successful, this method returns a `201 Created` response code and a [deviceHealthScriptPolicyState](../resources/intune-devices-devicehealthscriptpolicystate.md) object in the response body.
