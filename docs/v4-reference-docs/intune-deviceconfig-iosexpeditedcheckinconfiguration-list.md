...
# List iosExpeditedCheckinConfigurations
...
## Response
If successful, this method returns a `200 OK` response code and a collection of [iosExpeditedCheckinConfiguration](../resources/intune-deviceconfig-iosexpeditedcheckinconfiguration.md) objects in the response body.
