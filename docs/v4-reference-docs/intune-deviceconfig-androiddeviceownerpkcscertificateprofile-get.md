...
description: "Read properties and relationships of the androidDeviceOwnerPkcsCertificateProfile object."
author: "jaiprakashmb"
...
## Response
If successful, this method returns a `200 OK` response code and [androidDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-androiddeviceownerpkcscertificateprofile.md) object in the response body.
