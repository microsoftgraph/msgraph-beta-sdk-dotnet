...
using System;
namespace Microsoft.Graph.Beta.ProgramControls.Item.Program.Controls.Item {
    /// <summary>
    ...
    public class ProgramControlItemRequestBuilder : BaseRequestBuilder {
        ...
        public ProgramControlItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/programControls/{programControl%2Did}/program/controls/{programControl%2Did1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ProgramControlItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProgramControlItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/programControls/{programControl%2Did}/program/controls/{programControl%2Did1}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
