...
using MicrosoftGraph.ProgramControls.Item.Program;
using System;
...
namespace MicrosoftGraph.ProgramControls.Item {
    /// <summary>Builds and executes requests for operations under \programControls\{programControl-id}</summary>
    public class ProgramControlRequestBuilder {
        ...
        /// </summary>
        public ProgramControlRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/programControls/{programControl_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ProgramControlRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ProgramControl body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <summary>Get entity from programControls by key</summary>
