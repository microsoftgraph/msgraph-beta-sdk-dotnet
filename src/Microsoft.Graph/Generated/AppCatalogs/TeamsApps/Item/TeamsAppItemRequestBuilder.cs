...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.TeamsApp?> GetAsync(CancellationToken cancellationToken = default, Action<TeamsAppItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.TeamsApp> GetAsync(CancellationToken cancellationToken = default, Action<TeamsAppItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.TeamsApp?> PatchAsync(Microsoft.Graph.Beta.Models.TeamsApp body, CancellationToken cancellationToken = default, Action<TeamsAppItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.TeamsApp> PatchAsync(Microsoft.Graph.Beta.Models.TeamsApp body, CancellationToken cancellationToken = default, Action<TeamsAppItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
