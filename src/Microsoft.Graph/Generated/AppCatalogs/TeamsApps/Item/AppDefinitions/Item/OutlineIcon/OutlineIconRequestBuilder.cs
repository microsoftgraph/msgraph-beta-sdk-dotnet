...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<OutlineIconRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<OutlineIconRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TeamsAppIcon?> GetAsync(CancellationToken cancellationToken = default, Action<OutlineIconRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TeamsAppIcon> GetAsync(CancellationToken cancellationToken = default, Action<OutlineIconRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TeamsAppIcon?> PatchAsync(TeamsAppIcon body, CancellationToken cancellationToken = default, Action<OutlineIconRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TeamsAppIcon> PatchAsync(TeamsAppIcon body, CancellationToken cancellationToken = default, Action<OutlineIconRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
