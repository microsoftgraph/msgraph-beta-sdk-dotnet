...
using MicrosoftGraph.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.OutlineIcon.HostedContent.Value;
...
namespace MicrosoftGraph.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.OutlineIcon.HostedContent {
    /// <summary>Builds and executes requests for operations under \appCatalogs\teamsApps\{teamsApp-id}\appDefinitions\{teamsAppDefinition-id}\outlineIcon\hostedContent</summary>
    public class HostedContentRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(TeamworkHostedContent body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
