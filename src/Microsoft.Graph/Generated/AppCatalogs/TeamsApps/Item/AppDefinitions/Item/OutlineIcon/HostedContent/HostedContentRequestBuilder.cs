...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<HostedContentRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<HostedContentRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TeamworkHostedContent?> GetAsync(CancellationToken cancellationToken = default, Action<HostedContentRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TeamworkHostedContent> GetAsync(CancellationToken cancellationToken = default, Action<HostedContentRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<TeamworkHostedContent>(requestInfo, TeamworkHostedContent.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TeamworkHostedContent?> PatchAsync(TeamworkHostedContent body, CancellationToken cancellationToken = default, Action<HostedContentRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TeamworkHostedContent> PatchAsync(TeamworkHostedContent body, CancellationToken cancellationToken = default, Action<HostedContentRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
