...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.TeamsApp?> PostAsync(Microsoft.Graph.Beta.Models.TeamsApp body, CancellationToken cancellationToken = default, Action<TeamsAppsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.TeamsApp> PostAsync(Microsoft.Graph.Beta.Models.TeamsApp body, CancellationToken cancellationToken = default, Action<TeamsAppsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
