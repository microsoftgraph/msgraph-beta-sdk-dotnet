...
namespace Microsoft.Graph.Beta.AppCatalogs.TeamsApps {
    ...
    public class TeamsAppsRequestBuilder {
        ...
        /// </summary>
        public async Task<TeamsAppCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TeamsAppsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.TeamsApp> PostAsync(Microsoft.Graph.Beta.Models.TeamsApp body, CancellationToken cancellationToken = default, Action<TeamsAppsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
