...
namespace Microsoft.Graph.Beta.AppCatalogs.TeamsApps {
    ...
    public class TeamsAppsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.appCatalogs.teamsApps.item collection</summary>
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<TeamsAppsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Microsoft.Graph.Beta.Models.TeamsApp body, Action<TeamsAppsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<TeamsAppCollectionResponse> GetAsync(Action<TeamsAppsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.TeamsApp> PostAsync(Microsoft.Graph.Beta.Models.TeamsApp body, Action<TeamsAppsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
