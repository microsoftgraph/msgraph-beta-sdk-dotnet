...
using MicrosoftGraphSdk.Drive.Special.Item.ListItem.Activities.Item.DriveItem.Content;
...
namespace MicrosoftGraphSdk.Drive.Special.Item.ListItem.Activities.Item.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/special/{driveItem_id}/listItem/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
