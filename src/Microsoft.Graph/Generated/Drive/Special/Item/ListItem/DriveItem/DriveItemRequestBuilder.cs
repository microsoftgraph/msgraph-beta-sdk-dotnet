...
using MicrosoftGraphSdk.Drive.Special.Item.ListItem.DriveItem.Content;
...
namespace MicrosoftGraphSdk.Drive.Special.Item.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/special/{driveItem_id}/listItem/driveItem{?select,expand}";
