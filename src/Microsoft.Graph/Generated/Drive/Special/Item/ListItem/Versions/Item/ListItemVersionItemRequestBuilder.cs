...
using MicrosoftGraphSdk.Drive.Special.Item.ListItem.Versions.Item.Fields;
using MicrosoftGraphSdk.Drive.Special.Item.ListItem.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Drive.Special.Item.ListItem.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/special/{driveItem_id}/listItem/versions/{listItemVersion_id}{?select,expand}";
