...
namespace MicrosoftGraphSdk.Drive.Special.Item.ListItem.Versions.Item.Fields {
    ...
    public class FieldsRequestBuilder {
        ...
        public FieldsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/special/{driveItem_id}/listItem/versions/{listItemVersion_id}/fields{?select,expand}";
