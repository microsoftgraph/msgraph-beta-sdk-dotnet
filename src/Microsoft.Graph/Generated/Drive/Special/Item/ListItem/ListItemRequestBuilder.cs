...
using MicrosoftGraphSdk.Drive.Special.Item.ListItem.Activities;
using MicrosoftGraphSdk.Drive.Special.Item.ListItem.Analytics;
using MicrosoftGraphSdk.Drive.Special.Item.ListItem.CreateLink;
using MicrosoftGraphSdk.Drive.Special.Item.ListItem.DriveItem;
using MicrosoftGraphSdk.Drive.Special.Item.ListItem.Fields;
using MicrosoftGraphSdk.Drive.Special.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Drive.Special.Item.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Drive.Special.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/special/{driveItem_id}/listItem{?select,expand}";
