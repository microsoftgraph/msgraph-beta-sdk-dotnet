...
using MicrosoftGraphSdk.Drive.Special.Item.Versions.Item.Content;
using MicrosoftGraphSdk.Drive.Special.Item.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Drive.Special.Item.Versions.Item {
    ...
    public class DriveItemVersionItemRequestBuilder {
        ...
        public DriveItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/special/{driveItem_id}/versions/{driveItemVersion_id}{?select,expand}";
