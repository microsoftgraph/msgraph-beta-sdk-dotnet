...
namespace MicrosoftGraphSdk.Drive.Special.Item.Versions.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/special/{driveItem_id}/versions/{driveItemVersion_id}/content";
