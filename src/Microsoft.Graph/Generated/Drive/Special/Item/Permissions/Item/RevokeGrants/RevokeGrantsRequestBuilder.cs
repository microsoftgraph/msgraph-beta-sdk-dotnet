...
namespace MicrosoftGraphSdk.Drive.Special.Item.Permissions.Item.RevokeGrants {
    ...
    public class RevokeGrantsRequestBuilder {
        ...
        public RevokeGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/special/{driveItem_id}/permissions/{permission_id}/microsoft.graph.revokeGrants";
