...
using MicrosoftGraphSdk.Drive.Special.Item.Children.Item.Content;
...
namespace MicrosoftGraphSdk.Drive.Special.Item.Children.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/special/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
