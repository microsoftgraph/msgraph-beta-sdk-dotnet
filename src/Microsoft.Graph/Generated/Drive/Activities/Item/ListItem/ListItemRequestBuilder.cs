...
using MicrosoftGraphSdk.Drive.Activities.Item.ListItem.CreateLink;
using MicrosoftGraphSdk.Drive.Activities.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Drive.Activities.Item.ListItem.Ref;
...
namespace MicrosoftGraphSdk.Drive.Activities.Item.ListItem {
    /// <summary>Builds and executes requests for operations under \drive\activities\{itemActivityOLD-id}\listItem</summary>
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/activities/{itemActivityOLD_id}/listItem{?select,expand}";
