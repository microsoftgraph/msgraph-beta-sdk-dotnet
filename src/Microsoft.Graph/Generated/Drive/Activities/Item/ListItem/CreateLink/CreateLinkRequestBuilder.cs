...
namespace MicrosoftGraphSdk.Drive.Activities.Item.ListItem.CreateLink {
    /// <summary>Builds and executes requests for operations under \drive\activities\{itemActivityOLD-id}\listItem\microsoft.graph.createLink</summary>
    public class CreateLinkRequestBuilder {
        ...
        public CreateLinkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/activities/{itemActivityOLD_id}/listItem/microsoft.graph.createLink";
