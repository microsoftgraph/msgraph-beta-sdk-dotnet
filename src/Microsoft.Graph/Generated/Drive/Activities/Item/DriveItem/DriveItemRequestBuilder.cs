using Microsoft.Graph.Beta.Drive.Activities.Item.DriveItem.Content;
...
namespace Microsoft.Graph.Beta.Drive.Activities.Item.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}";
