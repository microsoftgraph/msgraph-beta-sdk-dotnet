...
using MicrosoftGraphSdk.Drive.Activities.Item.DriveItem.Ref;
...
namespace MicrosoftGraphSdk.Drive.Activities.Item.DriveItem {
    /// <summary>Builds and executes requests for operations under \drive\activities\{itemActivityOLD-id}\driveItem</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
        ...
        /// <summary>Get driveItem from drive</summary>
