using Microsoft.Graph.Beta.Drive.Root.ListItem.Activities.Item.DriveItem;
using Microsoft.Graph.Beta.Drive.Root.ListItem.Activities.Item.ListItem;
...
namespace Microsoft.Graph.Beta.Drive.Root.ListItem.Activities.Item {
    /// <summary>
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Drive.Root.ListItem.Activities.Item.ListItem.ListItemRequestBuilder ListItem { get =>
            new Microsoft.Graph.Beta.Drive.Root.ListItem.Activities.Item.ListItem.ListItemRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/root/listItem/activities/{itemActivityOLD%2Did}{?%24select,%24expand}";
