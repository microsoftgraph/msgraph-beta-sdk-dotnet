...
namespace Microsoft.Graph.Beta.Drive.Root.ListItem.Activities.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/root/listItem/activities/{itemActivityOLD%2Did}/listItem{?%24select,%24expand}";
