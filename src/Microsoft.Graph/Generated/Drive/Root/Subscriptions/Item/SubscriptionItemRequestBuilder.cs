using Microsoft.Graph.Beta.Drive.Root.Subscriptions.Item.Reauthorize;
...
namespace Microsoft.Graph.Beta.Drive.Root.Subscriptions.Item {
    ...
    public class SubscriptionItemRequestBuilder {
        ...
        public SubscriptionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/root/subscriptions/{subscription%2Did}{?%24select,%24expand}";
