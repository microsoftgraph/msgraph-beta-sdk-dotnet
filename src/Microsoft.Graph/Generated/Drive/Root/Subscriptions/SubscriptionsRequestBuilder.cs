...
using MicrosoftGraphSdk.Drive.Root.Subscriptions.Count;
using MicrosoftGraphSdk.Drive.Root.Subscriptions.Item;
...
namespace MicrosoftGraphSdk.Drive.Root.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.drive.root.subscriptions.item collection</summary>
