using Microsoft.Graph.Beta.Drive.Root.Versions.Item.Content;
using Microsoft.Graph.Beta.Drive.Root.Versions.Item.RestoreVersion;
...
namespace Microsoft.Graph.Beta.Drive.Root.Versions.Item {
    ...
    public class DriveItemVersionItemRequestBuilder {
        ...
        public DriveItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/root/versions/{driveItemVersion%2Did}{?%24select,%24expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DriveItemVersion> PatchAsync(DriveItemVersion body, Action<DriveItemVersionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
