...
using MicrosoftGraphSdk.Drive.Root.Versions.Item.Content;
using MicrosoftGraphSdk.Drive.Root.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Drive.Root.Versions.Item {
