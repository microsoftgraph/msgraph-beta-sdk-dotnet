...
using MicrosoftGraphSdk.Drive.List.Activities.Item.DriveItem.Ref;
...
namespace MicrosoftGraphSdk.Drive.List.Activities.Item.DriveItem {
    /// <summary>Builds and executes requests for operations under \drive\list\activities\{itemActivityOLD-id}\driveItem</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
