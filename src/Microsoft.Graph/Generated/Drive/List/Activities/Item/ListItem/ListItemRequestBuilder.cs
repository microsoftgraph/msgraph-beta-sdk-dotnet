...
using MicrosoftGraphSdk.Drive.List.Activities.Item.ListItem.CreateLink;
using MicrosoftGraphSdk.Drive.List.Activities.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Drive.List.Activities.Item.ListItem.Ref;
...
namespace MicrosoftGraphSdk.Drive.List.Activities.Item.ListItem {
    /// <summary>Builds and executes requests for operations under \drive\list\activities\{itemActivityOLD-id}\listItem</summary>
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/activities/{itemActivityOLD_id}/listItem{?select,expand}";
