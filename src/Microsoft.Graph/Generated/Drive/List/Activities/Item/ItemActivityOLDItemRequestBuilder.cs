...
using MicrosoftGraphSdk.Drive.List.Activities.Item.DriveItem;
using MicrosoftGraphSdk.Drive.List.Activities.Item.ListItem;
...
namespace MicrosoftGraphSdk.Drive.List.Activities.Item {
    /// <summary>Builds and executes requests for operations under \drive\list\activities\{itemActivityOLD-id}</summary>
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/activities/{itemActivityOLD_id}{?select,expand}";
