...
using MicrosoftGraph.Drive.List.Activities.Item;
...
namespace MicrosoftGraph.Drive.List.Activities {
    /// <summary>Builds and executes requests for operations under \drive\list\activities</summary>
    public class ActivitiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.drive.list.activities.item collection</summary>
        ...
        public ActivitiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/activities{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
