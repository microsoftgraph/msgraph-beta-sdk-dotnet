using Microsoft.Graph.Beta.Drive.List.Activities;
using Microsoft.Graph.Beta.Drive.List.Columns;
using Microsoft.Graph.Beta.Drive.List.ContentTypes;
using Microsoft.Graph.Beta.Drive.List.Drive;
using Microsoft.Graph.Beta.Drive.List.Items;
using Microsoft.Graph.Beta.Drive.List.Operations;
using Microsoft.Graph.Beta.Drive.List.Subscriptions;
...
namespace Microsoft.Graph.Beta.Drive.List {
    /// <summary>
    ...
    public class ListRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Drive.List.Drive.DriveRequestBuilder Drive { get =>
            new Microsoft.Graph.Beta.Drive.List.Drive.DriveRequestBuilder(PathParameters, RequestAdapter);
        }
