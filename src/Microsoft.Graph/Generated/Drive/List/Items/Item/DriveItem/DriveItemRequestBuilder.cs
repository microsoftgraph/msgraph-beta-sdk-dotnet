...
using MicrosoftGraphSdk.Drive.List.Items.Item.DriveItem.Ref;
...
namespace MicrosoftGraphSdk.Drive.List.Items.Item.DriveItem {
    /// <summary>Builds and executes requests for operations under \drive\list\items\{listItem-id}\driveItem</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/items/{listItem_id}/driveItem{?select,expand}";
