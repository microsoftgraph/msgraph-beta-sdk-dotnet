...
using MicrosoftGraph.Drive.List.Items.Item.Versions.Item.Fields;
using MicrosoftGraph.Drive.List.Items.Item.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraph.Drive.List.Items.Item.Versions.Item {
