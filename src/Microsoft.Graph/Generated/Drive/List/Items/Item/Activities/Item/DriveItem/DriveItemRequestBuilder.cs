using Microsoft.Graph.Beta.Drive.List.Items.Item.Activities.Item.DriveItem.Content;
...
namespace Microsoft.Graph.Beta.Drive.List.Items.Item.Activities.Item.DriveItem {
    /// <summary>
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}";
