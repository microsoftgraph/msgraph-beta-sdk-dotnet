...
using MicrosoftGraphSdk.Drive.List.Items.Item.Activities.Item.DriveItem.Ref;
...
namespace MicrosoftGraphSdk.Drive.List.Items.Item.Activities.Item.DriveItem {
    /// <summary>Builds and executes requests for operations under \drive\list\items\{listItem-id}\activities\{itemActivityOLD-id}\driveItem</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/items/{listItem_id}/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
