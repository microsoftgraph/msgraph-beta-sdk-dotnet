...
namespace Microsoft.Graph.Beta.Drive.List.Items.Item.Activities.Item.DriveItem.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/driveItem/content";
