...
using MicrosoftGraph.Drive.List.Items.Item.Activities.Item;
...
namespace MicrosoftGraph.Drive.List.Items.Item.Activities {
    ...
    public class ActivitiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.drive.list.items.item.activities.item collection</summary>
