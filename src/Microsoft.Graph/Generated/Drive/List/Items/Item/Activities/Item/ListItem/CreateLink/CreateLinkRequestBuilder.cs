...
namespace MicrosoftGraph.Drive.List.Items.Item.Activities.Item.ListItem.CreateLink {
    /// <summary>Builds and executes requests for operations under \drive\list\items\{listItem-id}\activities\{itemActivityOLD-id}\listItem\microsoft.graph.createLink</summary>
    public class CreateLinkRequestBuilder {
        ...
        public CreateLinkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/items/{listItem_id}/activities/{itemActivityOLD_id}/listItem/microsoft.graph.createLink";
