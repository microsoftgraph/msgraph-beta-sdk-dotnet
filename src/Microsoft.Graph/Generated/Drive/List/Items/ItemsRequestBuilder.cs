...
using MicrosoftGraphSdk.Drive.List.Items.Count;
using MicrosoftGraphSdk.Drive.List.Items.Delta;
using MicrosoftGraphSdk.Drive.List.Items.DeltaWithToken;
using MicrosoftGraphSdk.Drive.List.Items.Item;
...
namespace MicrosoftGraphSdk.Drive.List.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.drive.list.items.item collection</summary>
