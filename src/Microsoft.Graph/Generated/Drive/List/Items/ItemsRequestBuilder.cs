using Microsoft.Graph.Beta.Drive.List.Items.Count;
using Microsoft.Graph.Beta.Drive.List.Items.Delta;
using Microsoft.Graph.Beta.Drive.List.Items.DeltaWithToken;
using Microsoft.Graph.Beta.Drive.List.Items.Item;
...
namespace Microsoft.Graph.Beta.Drive.List.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.drive.list.items.item collection</summary>
        ...
        public ItemsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/items{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
