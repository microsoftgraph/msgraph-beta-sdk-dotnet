...
namespace MicrosoftGraphSdk.Drive.List.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <summary>
        /// Builds and executes requests for operations under \drive\list\items\microsoft.graph.delta()
        /// </summary>
        public DeltaRequestBuilder Delta() {
            return new DeltaRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Builds and executes requests for operations under \drive\list\items\microsoft.graph.delta(token='{token}')
