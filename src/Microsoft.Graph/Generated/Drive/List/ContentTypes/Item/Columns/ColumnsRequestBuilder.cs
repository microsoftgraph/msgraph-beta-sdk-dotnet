using Microsoft.Graph.Beta.Drive.List.ContentTypes.Item.Columns.Count;
using Microsoft.Graph.Beta.Drive.List.ContentTypes.Item.Columns.Item;
...
namespace Microsoft.Graph.Beta.Drive.List.ContentTypes.Item.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.drive.list.contentTypes.item.columns.item collection</summary>
