...
using MicrosoftGraph.Drive.List.ContentTypes.Item.Columns.Item;
...
namespace MicrosoftGraph.Drive.List.ContentTypes.Item.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.drive.list.contentTypes.item.columns.item collection</summary>
