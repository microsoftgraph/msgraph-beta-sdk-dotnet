...
namespace Microsoft.Graph.Beta.Drive.List.ContentTypes.Item.Columns.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/columns/$count{?%24search,%24filter}";
