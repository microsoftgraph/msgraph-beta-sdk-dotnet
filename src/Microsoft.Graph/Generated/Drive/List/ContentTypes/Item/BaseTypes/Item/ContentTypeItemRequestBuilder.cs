...
namespace Microsoft.Graph.Beta.Drive.List.ContentTypes.Item.BaseTypes.Item {
    ...
    public class ContentTypeItemRequestBuilder {
        ...
        public ContentTypeItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/baseTypes/{contentType%2Did1}{?%24select,%24expand}";
