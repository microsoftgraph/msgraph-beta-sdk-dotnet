...
using MicrosoftGraphSdk.Drive.List.ContentTypes.Item.BaseTypes.AddCopy;
using MicrosoftGraphSdk.Drive.List.ContentTypes.Item.BaseTypes.AddCopyFromContentTypeHub;
using MicrosoftGraphSdk.Drive.List.ContentTypes.Item.BaseTypes.GetCompatibleHubContentTypes;
using MicrosoftGraphSdk.Drive.List.ContentTypes.Item.BaseTypes.Ref;
using System;
...
namespace MicrosoftGraphSdk.Drive.List.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder {
        ...
        /// <summary>
        /// Builds and executes requests for operations under \drive\list\contentTypes\{contentType-id}\baseTypes\microsoft.graph.getCompatibleHubContentTypes()
        /// </summary>
