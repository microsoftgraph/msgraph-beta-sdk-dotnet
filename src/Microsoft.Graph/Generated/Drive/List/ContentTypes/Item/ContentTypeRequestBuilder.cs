...
using MicrosoftGraph.Drive.List.ContentTypes.Item.AssociateWithHubSites;
using MicrosoftGraph.Drive.List.ContentTypes.Item.Base;
using MicrosoftGraph.Drive.List.ContentTypes.Item.BaseTypes;
using MicrosoftGraph.Drive.List.ContentTypes.Item.ColumnLinks;
using MicrosoftGraph.Drive.List.ContentTypes.Item.ColumnPositions;
using MicrosoftGraph.Drive.List.ContentTypes.Item.Columns;
using MicrosoftGraph.Drive.List.ContentTypes.Item.CopyToDefaultContentLocation;
using MicrosoftGraph.Drive.List.ContentTypes.Item.IsPublished;
using MicrosoftGraph.Drive.List.ContentTypes.Item.Publish;
using MicrosoftGraph.Drive.List.ContentTypes.Item.Unpublish;
...
namespace MicrosoftGraph.Drive.List.ContentTypes.Item {
