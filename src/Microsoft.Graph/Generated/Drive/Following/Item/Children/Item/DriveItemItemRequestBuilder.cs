...
using MicrosoftGraphSdk.Drive.Following.Item.Children.Item.Content;
...
namespace MicrosoftGraphSdk.Drive.Following.Item.Children.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/following/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
