...
namespace MicrosoftGraphSdk.Drive.Following.Item.ListItem.Activities.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/following/{driveItem_id}/listItem/activities/{itemActivityOLD_id}/listItem{?select,expand}";
        ...
        /// <summary>Get listItem from drive</summary>
