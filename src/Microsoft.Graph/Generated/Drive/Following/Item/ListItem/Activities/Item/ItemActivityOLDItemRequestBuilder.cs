...
using MicrosoftGraphSdk.Drive.Following.Item.ListItem.Activities.Item.DriveItem;
using MicrosoftGraphSdk.Drive.Following.Item.ListItem.Activities.Item.ListItem;
...
namespace MicrosoftGraphSdk.Drive.Following.Item.ListItem.Activities.Item {
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/following/{driveItem_id}/listItem/activities/{itemActivityOLD_id}{?select,expand}";
