...
using MicrosoftGraphSdk.Drive.Following.Item.ListItem.DriveItem.Content;
...
namespace MicrosoftGraphSdk.Drive.Following.Item.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/following/{driveItem_id}/listItem/driveItem{?select,expand}";
