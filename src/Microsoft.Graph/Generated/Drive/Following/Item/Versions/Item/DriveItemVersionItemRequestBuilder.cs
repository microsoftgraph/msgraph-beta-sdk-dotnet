...
using MicrosoftGraphSdk.Drive.Following.Item.Versions.Item.Content;
using MicrosoftGraphSdk.Drive.Following.Item.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Drive.Following.Item.Versions.Item {
    ...
    public class DriveItemVersionItemRequestBuilder {
        ...
        public DriveItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/following/{driveItem_id}/versions/{driveItemVersion_id}{?select,expand}";
