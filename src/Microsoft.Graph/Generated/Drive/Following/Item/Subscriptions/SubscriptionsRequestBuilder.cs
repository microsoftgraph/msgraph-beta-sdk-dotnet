...
using MicrosoftGraphSdk.Drive.Following.Item.Subscriptions.Count;
using MicrosoftGraphSdk.Drive.Following.Item.Subscriptions.Item;
...
namespace MicrosoftGraphSdk.Drive.Following.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.drive.following.item.subscriptions.item collection</summary>
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/following/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
