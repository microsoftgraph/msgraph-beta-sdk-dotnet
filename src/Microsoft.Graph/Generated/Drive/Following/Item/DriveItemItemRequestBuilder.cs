using Microsoft.Graph.Beta.Drive.Following.Item.Content;
...
namespace Microsoft.Graph.Beta.Drive.Following.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/following/{driveItem%2Did}{?%24select,%24expand}";
