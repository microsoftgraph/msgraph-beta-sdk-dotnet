...
using MicrosoftGraphSdk.Drive.Items.Item.Subscriptions.Count;
using MicrosoftGraphSdk.Drive.Items.Item.Subscriptions.Item;
...
namespace MicrosoftGraphSdk.Drive.Items.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.drive.items.item.subscriptions.item collection</summary>
