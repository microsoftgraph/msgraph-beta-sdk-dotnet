...
namespace Microsoft.Graph.Beta.Drive.Items.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// </summary>
        public async Task<SubscriptionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SubscriptionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Subscription> PostAsync(Subscription body, CancellationToken cancellationToken = default, Action<SubscriptionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
