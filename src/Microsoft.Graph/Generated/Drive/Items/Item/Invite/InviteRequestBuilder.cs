...
namespace Microsoft.Graph.Beta.Drive.Items.Item.Invite {
    ...
    public class InviteRequestBuilder {
        ...
        /// </summary>
        public async Task<InviteResponse> PostAsync(InvitePostRequestBody body, CancellationToken cancellationToken = default, Action<InviteRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
