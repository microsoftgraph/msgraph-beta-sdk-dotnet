...
namespace Microsoft.Graph.Beta.Drive.Items.Item.Invite {
    ...
    public class InviteRequestBuilder {
        ...
        public InviteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/microsoft.graph.invite";
        ...
        /// </summary>
        public async Task<InviteResponse> PostAsync(InvitePostRequestBody body, Action<InviteRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<InviteResponse>(requestInfo, InviteResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
