...
using MicrosoftGraphSdk.Drive.Items.Item.ListItem.Activities;
using MicrosoftGraphSdk.Drive.Items.Item.ListItem.Analytics;
using MicrosoftGraphSdk.Drive.Items.Item.ListItem.CreateLink;
using MicrosoftGraphSdk.Drive.Items.Item.ListItem.DriveItem;
using MicrosoftGraphSdk.Drive.Items.Item.ListItem.Fields;
using MicrosoftGraphSdk.Drive.Items.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Drive.Items.Item.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Drive.Items.Item.ListItem {
