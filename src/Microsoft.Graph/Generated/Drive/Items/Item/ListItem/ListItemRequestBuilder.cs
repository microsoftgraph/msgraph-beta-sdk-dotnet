using Microsoft.Graph.Beta.Drive.Items.Item.ListItem.Activities;
using Microsoft.Graph.Beta.Drive.Items.Item.ListItem.Analytics;
using Microsoft.Graph.Beta.Drive.Items.Item.ListItem.CreateLink;
using Microsoft.Graph.Beta.Drive.Items.Item.ListItem.DocumentSetVersions;
using Microsoft.Graph.Beta.Drive.Items.Item.ListItem.DriveItem;
using Microsoft.Graph.Beta.Drive.Items.Item.ListItem.Fields;
using Microsoft.Graph.Beta.Drive.Items.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using Microsoft.Graph.Beta.Drive.Items.Item.ListItem.Versions;
...
namespace Microsoft.Graph.Beta.Drive.Items.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/listItem{?%24select,%24expand}";
