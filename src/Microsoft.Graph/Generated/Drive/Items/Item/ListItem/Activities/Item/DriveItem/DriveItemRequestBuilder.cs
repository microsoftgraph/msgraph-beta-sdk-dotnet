using Microsoft.Graph.Beta.Drive.Items.Item.ListItem.Activities.Item.DriveItem.Content;
...
namespace Microsoft.Graph.Beta.Drive.Items.Item.ListItem.Activities.Item.DriveItem {
    /// <summary>
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}";
