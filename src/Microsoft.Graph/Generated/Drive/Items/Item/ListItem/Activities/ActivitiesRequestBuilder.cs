using Microsoft.Graph.Beta.Drive.Items.Item.ListItem.Activities.Count;
using Microsoft.Graph.Beta.Drive.Items.Item.ListItem.Activities.Item;
...
namespace Microsoft.Graph.Beta.Drive.Items.Item.ListItem.Activities {
    ...
    public class ActivitiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.drive.items.item.listItem.activities.item collection</summary>
        ...
        public ActivitiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/activities{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
