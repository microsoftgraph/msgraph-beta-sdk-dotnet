...
namespace Microsoft.Graph.Beta.Drive.Items.Item.ListItem.Activities.Item.ListItem {
    /// <summary>
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/activities/{itemActivityOLD%2Did}/listItem{?%24select,%24expand}";
