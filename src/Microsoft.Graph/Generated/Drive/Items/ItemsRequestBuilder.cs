...
using MicrosoftGraph.Drive.Items.Item;
...
namespace MicrosoftGraph.Drive.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.drive.items.item collection</summary>
