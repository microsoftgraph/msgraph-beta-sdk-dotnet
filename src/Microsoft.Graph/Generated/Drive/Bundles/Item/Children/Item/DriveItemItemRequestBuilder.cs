...
using MicrosoftGraphSdk.Drive.Bundles.Item.Children.Item.Content;
...
namespace MicrosoftGraphSdk.Drive.Bundles.Item.Children.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
