...
using MicrosoftGraphSdk.Drive.Bundles.Item.Versions.Item.Content;
using MicrosoftGraphSdk.Drive.Bundles.Item.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Drive.Bundles.Item.Versions.Item {
    ...
    public class DriveItemVersionItemRequestBuilder {
        ...
        public DriveItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/versions/{driveItemVersion_id}{?select,expand}";
