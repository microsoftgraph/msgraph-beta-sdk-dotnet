...
namespace MicrosoftGraphSdk.Drive.Bundles.Item.Versions.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/versions/{driveItemVersion_id}/content";
