...
namespace MicrosoftGraphSdk.Drive.Bundles.Item.Versions.Item.RestoreVersion {
    ...
    public class RestoreVersionRequestBuilder {
        ...
        public RestoreVersionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/versions/{driveItemVersion_id}/microsoft.graph.restoreVersion";
