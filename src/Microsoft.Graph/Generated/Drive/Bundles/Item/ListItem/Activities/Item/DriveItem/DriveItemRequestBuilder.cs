...
using MicrosoftGraphSdk.Drive.Bundles.Item.ListItem.Activities.Item.DriveItem.Content;
...
namespace MicrosoftGraphSdk.Drive.Bundles.Item.ListItem.Activities.Item.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/listItem/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
