...
using MicrosoftGraphSdk.Drive.Bundles.Item.ListItem.Activities;
using MicrosoftGraphSdk.Drive.Bundles.Item.ListItem.Analytics;
using MicrosoftGraphSdk.Drive.Bundles.Item.ListItem.CreateLink;
using MicrosoftGraphSdk.Drive.Bundles.Item.ListItem.DriveItem;
using MicrosoftGraphSdk.Drive.Bundles.Item.ListItem.Fields;
using MicrosoftGraphSdk.Drive.Bundles.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Drive.Bundles.Item.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Drive.Bundles.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/listItem{?select,expand}";
