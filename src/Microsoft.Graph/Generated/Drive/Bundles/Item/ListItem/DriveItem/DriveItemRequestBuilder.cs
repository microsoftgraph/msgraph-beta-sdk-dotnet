...
using MicrosoftGraphSdk.Drive.Bundles.Item.ListItem.DriveItem.Content;
...
namespace MicrosoftGraphSdk.Drive.Bundles.Item.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/listItem/driveItem{?select,expand}";
