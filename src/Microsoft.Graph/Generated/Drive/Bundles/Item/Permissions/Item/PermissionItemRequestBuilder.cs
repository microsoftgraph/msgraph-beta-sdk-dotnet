...
using MicrosoftGraphSdk.Drive.Bundles.Item.Permissions.Item.Grant;
using MicrosoftGraphSdk.Drive.Bundles.Item.Permissions.Item.RevokeGrants;
...
namespace MicrosoftGraphSdk.Drive.Bundles.Item.Permissions.Item {
    ...
    public class PermissionItemRequestBuilder {
        ...
        public PermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/permissions/{permission_id}{?select,expand}";
