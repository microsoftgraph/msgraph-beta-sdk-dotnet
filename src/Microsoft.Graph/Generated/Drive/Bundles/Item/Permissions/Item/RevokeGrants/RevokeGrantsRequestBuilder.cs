...
namespace MicrosoftGraphSdk.Drive.Bundles.Item.Permissions.Item.RevokeGrants {
    ...
    public class RevokeGrantsRequestBuilder {
        ...
        public RevokeGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/permissions/{permission_id}/microsoft.graph.revokeGrants";
