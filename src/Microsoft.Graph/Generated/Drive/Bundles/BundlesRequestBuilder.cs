using Microsoft.Graph.Beta.Drive.Bundles.Count;
using Microsoft.Graph.Beta.Drive.Bundles.Item;
...
namespace Microsoft.Graph.Beta.Drive.Bundles {
    ...
    public class BundlesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.drive.bundles.item collection</summary>
        ...
        public BundlesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/bundles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
