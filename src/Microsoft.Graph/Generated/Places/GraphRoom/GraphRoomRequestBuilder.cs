...
using Microsoft.Graph.Beta.Places.GraphRoom.Count;
...
namespace Microsoft.Graph.Beta.Places.GraphRoom {
    /// <summary>
    ...
    public class GraphRoomRequestBuilder {
        ...
        public GraphRoomRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/places/graph.room{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
#nullable enable
        public async Task<RoomCollectionResponse?> GetAsync(Action<GraphRoomRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<RoomCollectionResponse> GetAsync(Action<GraphRoomRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
