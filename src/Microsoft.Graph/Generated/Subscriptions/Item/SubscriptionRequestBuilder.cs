...
namespace MicrosoftGraph.Subscriptions.Item {
    /// <summary>Builds and executes requests for operations under \subscriptions\{subscription-id}</summary>
    public class SubscriptionRequestBuilder {
        ...
        public SubscriptionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/subscriptions/{subscription_id}{?select}";
