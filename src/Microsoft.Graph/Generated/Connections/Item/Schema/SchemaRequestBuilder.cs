...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SchemaRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SchemaRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ExternalConnectors.Schema?> GetAsync(CancellationToken cancellationToken = default, Action<SchemaRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ExternalConnectors.Schema> GetAsync(CancellationToken cancellationToken = default, Action<SchemaRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ExternalConnectors.Schema?> PatchAsync(Microsoft.Graph.Beta.Models.ExternalConnectors.Schema body, CancellationToken cancellationToken = default, Action<SchemaRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ExternalConnectors.Schema> PatchAsync(Microsoft.Graph.Beta.Models.ExternalConnectors.Schema body, CancellationToken cancellationToken = default, Action<SchemaRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
