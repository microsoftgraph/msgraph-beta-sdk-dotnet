...
namespace Microsoft.Graph.Beta.Connections.Item.Items.Item.ExternalConnectorsAddActivities {
    ...
    public class ExternalConnectorsAddActivitiesRequestBuilder : BaseRequestBuilder {
        ...
        public ExternalConnectorsAddActivitiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/connections/{externalConnection%2Did}/items/{externalItem%2Did}/externalConnectors.addActivities", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ExternalConnectorsAddActivitiesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExternalConnectorsAddActivitiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/connections/{externalConnection%2Did}/items/{externalItem%2Did}/externalConnectors.addActivities", rawUrl) {
        }
        /// <summary>
