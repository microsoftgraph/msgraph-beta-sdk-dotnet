...
namespace Microsoft.Graph.Beta.Branding.Localizations.Item.SquareLogoDark {
    ...
    public class SquareLogoDarkRequestBuilder : BaseRequestBuilder {
        ...
        public SquareLogoDarkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/branding/localizations/{organizationalBrandingLocalization%2Did}/squareLogoDark", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SquareLogoDarkRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SquareLogoDarkRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/branding/localizations/{organizationalBrandingLocalization%2Did}/squareLogoDark", rawUrl) {
        }
        /// <summary>
