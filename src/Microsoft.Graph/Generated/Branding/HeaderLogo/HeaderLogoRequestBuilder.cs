...
namespace Microsoft.Graph.Beta.Branding.HeaderLogo {
    ...
    public class HeaderLogoRequestBuilder : BaseRequestBuilder {
        ...
        public HeaderLogoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/branding/headerLogo", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HeaderLogoRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HeaderLogoRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/branding/headerLogo", rawUrl) {
        }
        /// <summary>
