...
namespace Microsoft.Graph.IdentityGovernanceNamespace
{
    ...
    /// </summary>
    public partial class TaskReferenceRequest : Microsoft.Graph.BaseRequest, ITaskReferenceRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Deletes the specified Task reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified Task reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The Task reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
