...
namespace Microsoft.Graph.IdentityGovernanceNamespace
{
    ...
    /// <summary>
    /// The type WorkflowReferenceRequest.
    /// </summary>
    public partial class WorkflowReferenceRequest : Microsoft.Graph.BaseRequest, IWorkflowReferenceRequest
    {
        /// <summary>
        /// Constructs a new WorkflowReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public WorkflowReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified Workflow reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified Workflow reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified Workflow reference.
        /// </summary>
        /// <param name="id">The Workflow reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified Workflow reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The Workflow reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
