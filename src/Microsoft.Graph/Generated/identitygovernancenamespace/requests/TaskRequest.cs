...
namespace Microsoft.Graph.IdentityGovernanceNamespace
{
    ...
    /// </summary>
    public partial class TaskRequest : Microsoft.Graph.BaseRequest, ITaskRequest
    {
        /// <summary>
        ...
        private void InitializeCollectionProperties(TaskObject taskToInitialize)
        {
            ...
            if (taskToInitialize != null)
            {
                if (taskToInitialize.TaskProcessingResults != null && taskToInitialize.TaskProcessingResults.CurrentPage != null)
                {
                    taskToInitialize.TaskProcessingResults.InitializeNextPageRequest(this.Client, taskToInitialize.TaskProcessingResultsNextLink);
                    // Copy the additional data collection to the page itself so that information is not lost
                    taskToInitialize.TaskProcessingResults.AdditionalData = taskToInitialize.AdditionalData;
                }
