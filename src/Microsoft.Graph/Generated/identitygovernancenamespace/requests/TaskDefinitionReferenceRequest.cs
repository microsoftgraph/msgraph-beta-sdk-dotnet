...
namespace Microsoft.Graph.IdentityGovernanceNamespace
{
    ...
    /// <summary>
    /// The type TaskDefinitionReferenceRequest.
    /// </summary>
    public partial class TaskDefinitionReferenceRequest : Microsoft.Graph.BaseRequest, ITaskDefinitionReferenceRequest
    {
        /// <summary>
        /// Constructs a new TaskDefinitionReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public TaskDefinitionReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified TaskDefinition reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// </summary>
        /// <param name="id">The TaskDefinition reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified TaskDefinition reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The TaskDefinition reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
