...
namespace Microsoft.Graph.IdentityGovernanceNamespace
{
    ...
    /// <summary>
    /// The type TaskProcessingResultReferenceRequest.
    /// </summary>
    public partial class TaskProcessingResultReferenceRequest : Microsoft.Graph.BaseRequest, ITaskProcessingResultReferenceRequest
    {
        /// <summary>
        /// Constructs a new TaskProcessingResultReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public TaskProcessingResultReferenceRequest(
            string requestUrl,
        ...
        public async System.Threading.Tasks.Task DeleteAsync(CancellationToken cancellationToken = default)
        {
            ...
            await this.SendAsync<TaskProcessingResult>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <param name="id">The TaskProcessingResult reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified TaskProcessingResult reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The TaskProcessingResult reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
