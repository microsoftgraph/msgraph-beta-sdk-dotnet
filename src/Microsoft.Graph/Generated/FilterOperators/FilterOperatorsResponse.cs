...
namespace MicrosoftGraphSdk.FilterOperators {
    public class FilterOperatorsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as FilterOperatorsResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as FilterOperatorsResponse).Value = n.GetCollectionOfObjectValues<FilterOperatorSchema>().ToList(); } },
            };
        }
        /// <summary>
