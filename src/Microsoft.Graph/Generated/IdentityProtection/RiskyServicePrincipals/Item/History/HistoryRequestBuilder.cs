...
namespace Microsoft.Graph.Beta.IdentityProtection.RiskyServicePrincipals.Item.History {
    ...
    public class HistoryRequestBuilder {
        ...
        /// </summary>
        public async Task<RiskyServicePrincipalHistoryItemCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<HistoryRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<RiskyServicePrincipalHistoryItem> PostAsync(RiskyServicePrincipalHistoryItem body, CancellationToken cancellationToken = default, Action<HistoryRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
