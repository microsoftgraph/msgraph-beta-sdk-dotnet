...
namespace Microsoft.Graph.Beta.IdentityProtection.RiskyServicePrincipals.Item.History.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityProtection/riskyServicePrincipals/{riskyServicePrincipal_id}/history/$count";
