...
namespace Microsoft.Graph.Beta.IdentityProtection.RiskyServicePrincipals.Dismiss {
    ...
    public class DismissRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DismissRequestBody body, Action<DismissRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(DismissRequestBody body, Action<DismissRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
