...
namespace Microsoft.Graph.Beta.IdentityProtection.RiskyServicePrincipals {
    ...
    public class RiskyServicePrincipalsRequestBuilder {
        ...
        /// </summary>
        public async Task<RiskyServicePrincipalCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RiskyServicePrincipalsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<RiskyServicePrincipal> PostAsync(RiskyServicePrincipal body, CancellationToken cancellationToken = default, Action<RiskyServicePrincipalsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
