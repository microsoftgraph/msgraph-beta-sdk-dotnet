...
namespace MicrosoftGraphSdk.IdentityProtection.RiskyServicePrincipals {
    ...
    public class RiskyServicePrincipalsRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(RiskyServicePrincipal body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
