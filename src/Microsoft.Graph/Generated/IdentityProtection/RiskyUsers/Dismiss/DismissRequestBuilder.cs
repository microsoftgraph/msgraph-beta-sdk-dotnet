...
namespace Microsoft.Graph.Beta.IdentityProtection.RiskyUsers.Dismiss {
    ...
    public class DismissRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(DismissPostRequestBody body, Action<DismissRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
