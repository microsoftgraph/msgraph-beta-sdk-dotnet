...
namespace Microsoft.Graph.Beta.IdentityProtection.RiskyUsers {
    ...
    public class RiskyUsersRequestBuilder {
        ...
        /// </summary>
        public async Task<RiskyUserCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RiskyUsersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<RiskyUser> PostAsync(RiskyUser body, CancellationToken cancellationToken = default, Action<RiskyUsersRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
