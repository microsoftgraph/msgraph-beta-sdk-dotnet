...
namespace MicrosoftGraphSdk.IdentityProtection.ServicePrincipalRiskDetections {
    public class ServicePrincipalRiskDetectionsResponse : IParsable {
        ...
        /// </summary>
        public static ServicePrincipalRiskDetectionsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ServicePrincipalRiskDetectionsResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ServicePrincipalRiskDetectionsResponse).Value = n.GetCollectionOfObjectValues<ServicePrincipalRiskDetection>(ServicePrincipalRiskDetection.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
