...
namespace Microsoft.Graph.Beta.IdentityProtection.ServicePrincipalRiskDetections {
    ...
    public class ServicePrincipalRiskDetectionsRequestBuilder {
        ...
        /// </summary>
        public async Task<ServicePrincipalRiskDetectionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalRiskDetectionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ServicePrincipalRiskDetection> PostAsync(ServicePrincipalRiskDetection body, CancellationToken cancellationToken = default, Action<ServicePrincipalRiskDetectionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
