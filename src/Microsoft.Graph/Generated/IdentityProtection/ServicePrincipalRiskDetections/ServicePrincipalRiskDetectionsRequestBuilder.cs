...
namespace Microsoft.Graph.Beta.IdentityProtection.ServicePrincipalRiskDetections {
    ...
    public class ServicePrincipalRiskDetectionsRequestBuilder {
        ...
        /// </summary>
        public async Task<ServicePrincipalRiskDetectionCollectionResponse> GetAsync(Action<ServicePrincipalRiskDetectionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<ServicePrincipalRiskDetectionCollectionResponse>(requestInfo, ServicePrincipalRiskDetectionCollectionResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to servicePrincipalRiskDetections for identityProtection
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ServicePrincipalRiskDetection> PostAsync(ServicePrincipalRiskDetection body, Action<ServicePrincipalRiskDetectionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
        ...
        /// <summary>Retrieve the properties of a collection of servicePrincipalRiskDetection objects.</summary>
