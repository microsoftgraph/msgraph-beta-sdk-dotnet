...
using MicrosoftGraph.Me.Photos.Item.Value;
...
namespace MicrosoftGraph.Me.Photos.Item {
    ...
    public class ProfilePhotoRequestBuilder {
        ...
        public ProfilePhotoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/photos/{profilePhoto_id}{?select}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ProfilePhotoRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
