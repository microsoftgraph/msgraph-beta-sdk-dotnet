...
#nullable enable
        public async Task<FindRoomsWithRoomListResponse?> GetAsync(CancellationToken cancellationToken = default, Action<FindRoomsWithRoomListRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<FindRoomsWithRoomListResponse> GetAsync(CancellationToken cancellationToken = default, Action<FindRoomsWithRoomListRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
