...
namespace Microsoft.Graph.Beta.Me.FindRoomsWithRoomList {
    ...
    public class FindRoomsWithRoomListRequestBuilder {
        ...
        /// </summary>
        public async Task<FindRoomsWithRoomListResponse> GetAsync(CancellationToken cancellationToken = default, Action<FindRoomsWithRoomListRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<FindRoomsWithRoomListResponse>(requestInfo, FindRoomsWithRoomListResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
