using Microsoft.Graph.Beta.Me.AppConsentRequestsForApproval.Item.UserConsentRequests;
...
using System;
namespace Microsoft.Graph.Beta.Me.AppConsentRequestsForApproval.Item {
    /// <summary>
    ...
    public class AppConsentRequestItemRequestBuilder : BaseRequestBuilder {
        ...
        public AppConsentRequestItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/appConsentRequestsForApproval/{appConsentRequest%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AppConsentRequestItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AppConsentRequestItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/appConsentRequestsForApproval/{appConsentRequest%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
