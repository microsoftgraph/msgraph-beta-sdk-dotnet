...
using MicrosoftGraph.Me.AppConsentRequestsForApproval.Item.UserConsentRequests.Item.Approval;
...
namespace MicrosoftGraph.Me.AppConsentRequestsForApproval.Item.UserConsentRequests.Item {
    /// <summary>Builds and executes requests for operations under \me\appConsentRequestsForApproval\{appConsentRequest-id}\userConsentRequests\{userConsentRequest-id}</summary>
    public class UserConsentRequestRequestBuilder {
        ...
        public UserConsentRequestRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/appConsentRequestsForApproval/{appConsentRequest_id}/userConsentRequests/{userConsentRequest_id}{?select,expand}";
