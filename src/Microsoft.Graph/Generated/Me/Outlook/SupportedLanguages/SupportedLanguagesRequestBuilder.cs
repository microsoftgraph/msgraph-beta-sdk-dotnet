...
namespace MicrosoftGraphSdk.Me.Outlook.SupportedLanguages {
    ...
    public class SupportedLanguagesRequestBuilder {
        ...
        /// </summary>
        public async Task<SupportedLanguagesResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
