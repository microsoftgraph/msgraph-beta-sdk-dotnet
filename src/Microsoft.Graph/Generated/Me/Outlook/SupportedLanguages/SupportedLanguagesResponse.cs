...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Me.Outlook.SupportedLanguages {
    ...
    public class SupportedLanguagesResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static SupportedLanguagesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as SupportedLanguagesResponse).Value = n.GetCollectionOfObjectValues<LocaleInfo>(LocaleInfo.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
