...
namespace MicrosoftGraphSdk.Me.Outlook.Tasks.Item.Attachments.Item {
    /// <summary>Builds and executes requests for operations under \me\outlook\tasks\{outlookTask-id}\attachments\{attachment-id}</summary>
    public class AttachmentItemRequestBuilder {
        ...
        public AttachmentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/outlook/tasks/{outlookTask_id}/attachments/{attachment_id}{?select,expand}";
