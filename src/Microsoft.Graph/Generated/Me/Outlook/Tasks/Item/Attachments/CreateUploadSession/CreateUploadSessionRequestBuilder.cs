...
namespace MicrosoftGraphSdk.Me.Outlook.Tasks.Item.Attachments.CreateUploadSession {
    /// <summary>Builds and executes requests for operations under \me\outlook\tasks\{outlookTask-id}\attachments\microsoft.graph.createUploadSession</summary>
    public class CreateUploadSessionRequestBuilder {
        ...
        public CreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/outlook/tasks/{outlookTask_id}/attachments/microsoft.graph.createUploadSession";
