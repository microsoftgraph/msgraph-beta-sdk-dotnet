...
using MicrosoftGraph.Me.Outlook.Tasks.Item.Attachments.CreateUploadSession;
using MicrosoftGraph.Me.Outlook.Tasks.Item.Attachments.Item;
...
namespace MicrosoftGraph.Me.Outlook.Tasks.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.outlook.tasks.item.attachments.item collection</summary>
