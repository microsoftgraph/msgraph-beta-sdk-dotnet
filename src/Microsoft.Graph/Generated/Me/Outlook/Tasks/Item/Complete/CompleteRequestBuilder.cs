...
namespace MicrosoftGraphSdk.Me.Outlook.Tasks.Item.Complete {
    /// <summary>Builds and executes requests for operations under \me\outlook\tasks\{outlookTask-id}\microsoft.graph.complete</summary>
    public class CompleteRequestBuilder {
        ...
        public CompleteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/outlook/tasks/{outlookTask_id}/microsoft.graph.complete";
