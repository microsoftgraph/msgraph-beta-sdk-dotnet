...
using MicrosoftGraphSdk.Me.Outlook.TaskFolders.Item.SingleValueExtendedProperties.Item;
...
namespace MicrosoftGraphSdk.Me.Outlook.TaskFolders.Item.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \me\outlook\taskFolders\{outlookTaskFolder-id}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.outlook.taskFolders.item.singleValueExtendedProperties.item collection</summary>
