...
using MicrosoftGraphSdk.Me.Outlook.TaskFolders.Item.MultiValueExtendedProperties.Item;
...
namespace MicrosoftGraphSdk.Me.Outlook.TaskFolders.Item.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \me\outlook\taskFolders\{outlookTaskFolder-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.outlook.taskFolders.item.multiValueExtendedProperties.item collection</summary>
