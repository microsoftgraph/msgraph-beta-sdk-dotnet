...
namespace Microsoft.Graph.Beta.Me.Outlook.TaskFolders.Item.Tasks.Item.Complete
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Me.Outlook.TaskFolders.Item.Tasks.Item.Complete.CompleteRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Me.Outlook.TaskFolders.Item.Tasks.Item.Complete.CompletePostResponse"/></returns>
...
#nullable enable
        public async Task<global::Microsoft.Graph.Beta.Me.Outlook.TaskFolders.Item.Tasks.Item.Complete.CompletePostResponse?> PostAsCompletePostResponseAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Microsoft.Graph.Beta.Me.Outlook.TaskFolders.Item.Tasks.Item.Complete.CompletePostResponse> PostAsCompletePostResponseAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/outlooktask-complete?view=graph-rest-beta" />
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Me.Outlook.TaskFolders.Item.Tasks.Item.Complete.CompleteResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Microsoft.Graph.Beta.Models.ODataErrors.ODataError">When receiving a 4XX or 5XX status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Microsoft.Graph.Beta.Me.Outlook.TaskFolders.Item.Tasks.Item.Complete.CompleteResponse?> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Microsoft.Graph.Beta.Me.Outlook.TaskFolders.Item.Tasks.Item.Complete.CompleteResponse> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Me.Outlook.TaskFolders.Item.Tasks.Item.Complete.CompleteRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("The Outlook tasks API is deprecated and will stop returning data on February 20, 2023. Please use the new To Do API. For more details, please visit https://developer.microsoft.com/en-us/office/blogs/announcing-the-general-availability-of-microsoft-to-do-apis-on-graph/ as of 2020-08/Outlook_Tasks")]
        public global::Microsoft.Graph.Beta.Me.Outlook.TaskFolders.Item.Tasks.Item.Complete.CompleteRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Beta.Me.Outlook.TaskFolders.Item.Tasks.Item.Complete.CompleteRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
