...
namespace MicrosoftGraph.Me.Outlook.TaskFolders.Item.Tasks.Item.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \me\outlook\taskFolders\{outlookTaskFolder-id}\tasks\{outlookTask-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.outlook.taskFolders.item.tasks.item.multiValueExtendedProperties.item collection</summary>
