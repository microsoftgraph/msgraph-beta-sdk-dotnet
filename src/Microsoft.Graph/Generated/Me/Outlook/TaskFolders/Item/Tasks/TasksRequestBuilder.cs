...
using MicrosoftGraph.Me.Outlook.TaskFolders.Item.Tasks.Item;
...
namespace MicrosoftGraph.Me.Outlook.TaskFolders.Item.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.outlook.taskFolders.item.tasks.item collection</summary>
