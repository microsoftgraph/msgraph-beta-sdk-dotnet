...
using MicrosoftGraphSdk.Me.Outlook.TaskFolders.Item.Tasks.Item.Attachments.CreateUploadSession;
using MicrosoftGraphSdk.Me.Outlook.TaskFolders.Item.Tasks.Item.Attachments.Item;
...
namespace MicrosoftGraphSdk.Me.Outlook.TaskFolders.Item.Tasks.Item.Attachments {
    /// <summary>Builds and executes requests for operations under \me\outlook\taskFolders\{outlookTaskFolder-id}\tasks\{outlookTask-id}\attachments</summary>
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.outlook.taskFolders.item.tasks.item.attachments.item collection</summary>
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/outlook/taskFolders/{outlookTaskFolder_id}/tasks/{outlookTask_id}/attachments{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
