...
using MicrosoftGraph.Me.Outlook.TaskFolders.Item.Tasks.Item.Attachments.CreateUploadSession;
using MicrosoftGraph.Me.Outlook.TaskFolders.Item.Tasks.Item.Attachments.Item;
...
namespace MicrosoftGraph.Me.Outlook.TaskFolders.Item.Tasks.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.outlook.taskFolders.item.tasks.item.attachments.item collection</summary>
