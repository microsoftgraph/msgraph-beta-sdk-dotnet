...
using MicrosoftGraph.Me.Outlook.TaskFolders.Item.Tasks.Item.Attachments;
using MicrosoftGraph.Me.Outlook.TaskFolders.Item.Tasks.Item.Complete;
using MicrosoftGraph.Me.Outlook.TaskFolders.Item.Tasks.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Me.Outlook.TaskFolders.Item.Tasks.Item.SingleValueExtendedProperties;
...
namespace MicrosoftGraph.Me.Outlook.TaskFolders.Item.Tasks.Item {
    ...
    public class OutlookTaskRequestBuilder {
        ...
        public OutlookTaskRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/outlook/taskFolders/{outlookTaskFolder_id}/tasks/{outlookTask_id}{?select}";
