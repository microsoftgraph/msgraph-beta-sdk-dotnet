...
namespace MicrosoftGraph.Me.Outlook.TaskFolders.Item.Tasks.Item.MultiValueExtendedProperties.Item {
    /// <summary>Builds and executes requests for operations under \me\outlook\taskFolders\{outlookTaskFolder-id}\tasks\{outlookTask-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}</summary>
    public class MultiValueLegacyExtendedPropertyRequestBuilder {
        ...
        public MultiValueLegacyExtendedPropertyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/outlook/taskFolders/{outlookTaskFolder_id}/tasks/{outlookTask_id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty_id}{?select,expand}";
