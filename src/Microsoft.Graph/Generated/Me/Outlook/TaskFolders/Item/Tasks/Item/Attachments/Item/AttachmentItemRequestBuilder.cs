...
namespace MicrosoftGraphSdk.Me.Outlook.TaskFolders.Item.Tasks.Item.Attachments.Item {
    /// <summary>Builds and executes requests for operations under \me\outlook\taskFolders\{outlookTaskFolder-id}\tasks\{outlookTask-id}\attachments\{attachment-id}</summary>
    public class AttachmentItemRequestBuilder {
        ...
        public AttachmentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/outlook/taskFolders/{outlookTaskFolder_id}/tasks/{outlookTask_id}/attachments/{attachment_id}{?select,expand}";
