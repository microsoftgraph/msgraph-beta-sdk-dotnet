...
#nullable enable
        public async Task<OutlookTaskFolderCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TaskFoldersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OutlookTaskFolderCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TaskFoldersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OutlookTaskFolder?> PostAsync(OutlookTaskFolder body, CancellationToken cancellationToken = default, Action<TaskFoldersRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OutlookTaskFolder> PostAsync(OutlookTaskFolder body, CancellationToken cancellationToken = default, Action<TaskFoldersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
