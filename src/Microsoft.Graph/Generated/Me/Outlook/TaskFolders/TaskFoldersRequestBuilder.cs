...
namespace Microsoft.Graph.Beta.Me.Outlook.TaskFolders {
    ...
    public class TaskFoldersRequestBuilder {
        ...
        /// </summary>
        public async Task<OutlookTaskFolderCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TaskFoldersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OutlookTaskFolder> PostAsync(OutlookTaskFolder body, CancellationToken cancellationToken = default, Action<TaskFoldersRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
