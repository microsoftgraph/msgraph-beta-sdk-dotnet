...
#nullable enable
        public async Task<OutlookCategoryCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<MasterCategoriesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OutlookCategoryCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MasterCategoriesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OutlookCategory?> PostAsync(OutlookCategory body, CancellationToken cancellationToken = default, Action<MasterCategoriesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OutlookCategory> PostAsync(OutlookCategory body, CancellationToken cancellationToken = default, Action<MasterCategoriesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
