using Microsoft.Graph.Beta.Me.Outlook.MasterCategories.Count;
using Microsoft.Graph.Beta.Me.Outlook.MasterCategories.Item;
...
namespace Microsoft.Graph.Beta.Me.Outlook.MasterCategories {
    ...
    public class MasterCategoriesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.outlook.masterCategories.item collection</summary>
        ...
        public MasterCategoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/outlook/masterCategories{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public MasterCategoriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreateGetRequestInformation(Action<MasterCategoriesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new MasterCategoriesRequestBuilderGetRequestConfiguration();
        ...
        public RequestInformation CreatePostRequestInformation(OutlookCategory body, Action<MasterCategoriesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new MasterCategoriesRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
        ...
        /// </summary>
        public async Task<OutlookCategoryCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MasterCategoriesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<OutlookCategoryCollectionResponse>(requestInfo, OutlookCategoryCollectionResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to masterCategories for me
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OutlookCategory> PostAsync(OutlookCategory body, CancellationToken cancellationToken = default, Action<MasterCategoriesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<OutlookCategory>(requestInfo, OutlookCategory.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        ...
        public class MasterCategoriesRequestBuilderGetRequestConfiguration {
            ...
            public MasterCategoriesRequestBuilderGetQueryParameters QueryParameters { get; set; } = new MasterCategoriesRequestBuilderGetQueryParameters();
            /// <summary>
