...
namespace Microsoft.Graph.Beta.Me.Outlook.TaskGroups.Item {
    ...
    public class OutlookTaskGroupItemRequestBuilder : BaseRequestBuilder {
        ...
        public OutlookTaskGroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/outlook/taskGroups/{outlookTaskGroup%2Did}{?%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OutlookTaskGroupItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OutlookTaskGroupItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/outlook/taskGroups/{outlookTaskGroup%2Did}{?%24select}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<OutlookTaskGroupItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<OutlookTaskGroupItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OutlookTaskGroup?> GetAsync(CancellationToken cancellationToken = default, Action<OutlookTaskGroupItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OutlookTaskGroup> GetAsync(CancellationToken cancellationToken = default, Action<OutlookTaskGroupItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OutlookTaskGroup?> PatchAsync(OutlookTaskGroup body, CancellationToken cancellationToken = default, Action<OutlookTaskGroupItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OutlookTaskGroup> PatchAsync(OutlookTaskGroup body, CancellationToken cancellationToken = default, Action<OutlookTaskGroupItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
