...
namespace MicrosoftGraph.Me.Outlook.TaskGroups.Item.TaskFolders.Item.Tasks.Item.Attachments.Item {
    /// <summary>Builds and executes requests for operations under \me\outlook\taskGroups\{outlookTaskGroup-id}\taskFolders\{outlookTaskFolder-id}\tasks\{outlookTask-id}\attachments\{attachment-id}</summary>
    public class AttachmentRequestBuilder {
        ...
        public AttachmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/outlook/taskGroups/{outlookTaskGroup_id}/taskFolders/{outlookTaskFolder_id}/tasks/{outlookTask_id}/attachments/{attachment_id}{?select,expand}";
