using Microsoft.Graph.Beta.Me.Outlook.TaskGroups.Item.TaskFolders.Count;
using Microsoft.Graph.Beta.Me.Outlook.TaskGroups.Item.TaskFolders.Item;
...
namespace Microsoft.Graph.Beta.Me.Outlook.TaskGroups.Item.TaskFolders {
    ...
    public class TaskFoldersRequestBuilder : BaseRequestBuilder {
        ...
        public TaskFoldersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/outlook/taskGroups/{outlookTaskGroup%2Did}/taskFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TaskFoldersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TaskFoldersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/outlook/taskGroups/{outlookTaskGroup%2Did}/taskFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", rawUrl) {
        }
        /// <summary>
