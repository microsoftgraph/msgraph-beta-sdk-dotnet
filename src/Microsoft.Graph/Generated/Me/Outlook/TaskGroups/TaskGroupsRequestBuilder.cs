...
namespace Microsoft.Graph.Beta.Me.Outlook.TaskGroups {
    ...
    public class TaskGroupsRequestBuilder : BaseRequestBuilder {
        ...
        public TaskGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/outlook/taskGroups{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TaskGroupsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<OutlookTaskGroupCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TaskGroupsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OutlookTaskGroupCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TaskGroupsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OutlookTaskGroup?> PostAsync(OutlookTaskGroup body, CancellationToken cancellationToken = default, Action<TaskGroupsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OutlookTaskGroup> PostAsync(OutlookTaskGroup body, CancellationToken cancellationToken = default, Action<TaskGroupsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
