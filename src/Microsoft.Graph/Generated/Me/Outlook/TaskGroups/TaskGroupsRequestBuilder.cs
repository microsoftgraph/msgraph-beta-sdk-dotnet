...
namespace Microsoft.Graph.Beta.Me.Outlook.TaskGroups {
    ...
    public class TaskGroupsRequestBuilder {
        ...
        /// </summary>
        public async Task<OutlookTaskGroupCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TaskGroupsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OutlookTaskGroup> PostAsync(OutlookTaskGroup body, CancellationToken cancellationToken = default, Action<TaskGroupsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
