...
namespace Microsoft.Graph.Beta.Me.Outlook.SupportedTimeZonesWithTimeZoneStandard {
    ...
    public class SupportedTimeZonesWithTimeZoneStandardRequestBuilder {
        ...
        public SupportedTimeZonesWithTimeZoneStandardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string timeZoneStandard = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/me/outlook/supportedTimeZones(TimeZoneStandard='{TimeZoneStandard}'){?%24top,%24skip,%24search,%24filter,%24count}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
            if (!string.IsNullOrWhiteSpace(timeZoneStandard)) urlTplParams.Add("TimeZoneStandard", timeZoneStandard);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<SupportedTimeZonesWithTimeZoneStandardRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<SupportedTimeZonesWithTimeZoneStandardRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
