...
namespace Microsoft.Graph.Beta.Me.Outlook.SupportedTimeZonesWithTimeZoneStandard {
    ...
    public class SupportedTimeZonesWithTimeZoneStandardRequestBuilder {
        ...
        /// </summary>
        public async Task<SupportedTimeZonesWithTimeZoneStandardResponse> GetAsync(CancellationToken cancellationToken = default, Action<SupportedTimeZonesWithTimeZoneStandardRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<SupportedTimeZonesWithTimeZoneStandardResponse>(requestInfo, SupportedTimeZonesWithTimeZoneStandardResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
