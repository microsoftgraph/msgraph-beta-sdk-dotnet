...
namespace Microsoft.Graph.Beta.Me.TransitiveMemberOf.Item.User.ExportDeviceAndAppManagementDataWithSkipWithTop {
    ...
    public class ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder {
        ...
        public ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? skip = default, int? top = default) {
            ...
            UrlTemplate = "{+baseurl}/me/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.exportDeviceAndAppManagementData(skip={skip},top={top})";
