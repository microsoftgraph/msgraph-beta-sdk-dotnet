...
namespace Microsoft.Graph.Beta.Me.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.MultiValueExtendedProperties.Item {
    ...
    public class MultiValueLegacyExtendedPropertyItemRequestBuilder {
        ...
        public MultiValueLegacyExtendedPropertyItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendar/calendarView/{event_id}/instances/{event_id1}/exceptionOccurrences/{event_id2}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty_id}{?select,expand}";
