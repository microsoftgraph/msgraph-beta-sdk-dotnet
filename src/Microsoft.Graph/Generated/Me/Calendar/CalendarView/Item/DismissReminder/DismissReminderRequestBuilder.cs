...
using System;
namespace Microsoft.Graph.Beta.Me.Calendar.CalendarView.Item.DismissReminder {
    /// <summary>
    ...
    public class DismissReminderRequestBuilder : BaseRequestBuilder {
        ...
        public DismissReminderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendar/calendarView/{event%2Did}/dismissReminder", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DismissReminderRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DismissReminderRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendar/calendarView/{event%2Did}/dismissReminder", rawUrl) {
        }
        /// <summary>
