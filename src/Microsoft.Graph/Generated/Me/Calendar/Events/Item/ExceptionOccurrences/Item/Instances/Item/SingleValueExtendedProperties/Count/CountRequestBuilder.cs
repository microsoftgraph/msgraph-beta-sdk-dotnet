...
namespace Microsoft.Graph.Beta.Me.Calendar.Events.Item.ExceptionOccurrences.Item.Instances.Item.SingleValueExtendedProperties.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/singleValueExtendedProperties/$count{?%24search,%24filter}";
