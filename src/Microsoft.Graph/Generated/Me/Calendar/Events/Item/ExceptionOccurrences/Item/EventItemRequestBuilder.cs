...
using Microsoft.Graph.Beta.Me.Calendar.Events.Item.ExceptionOccurrences.Item.MultiValueExtendedProperties;
...
namespace Microsoft.Graph.Beta.Me.Calendar.Events.Item.ExceptionOccurrences.Item {
    ...
    public class EventItemRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Me.Calendar.Events.Item.ExceptionOccurrences.Item.Calendar.CalendarRequestBuilder Calendar { get =>
            new Microsoft.Graph.Beta.Me.Calendar.Events.Item.ExceptionOccurrences.Item.Calendar.CalendarRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
