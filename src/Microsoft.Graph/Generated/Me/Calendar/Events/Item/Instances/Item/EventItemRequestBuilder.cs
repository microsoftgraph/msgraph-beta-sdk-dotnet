...
using Microsoft.Graph.Beta.Me.Calendar.Events.Item.Instances.Item.MultiValueExtendedProperties;
using Microsoft.Graph.Beta.Me.Calendar.Events.Item.Instances.Item.SingleValueExtendedProperties;
...
namespace Microsoft.Graph.Beta.Me.Calendar.Events.Item.Instances.Item {
    ...
    public class EventItemRequestBuilder : BaseRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendar/events/{event%2Did}/instances/{event%2Did1}{?%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendar/events/{event%2Did}/instances/{event%2Did1}{?%24select}", rawUrl) {
        }
        /// <summary>
