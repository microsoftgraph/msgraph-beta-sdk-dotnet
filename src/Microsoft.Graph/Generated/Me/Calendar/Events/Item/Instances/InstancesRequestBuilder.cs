using Microsoft.Graph.Beta.Me.Calendar.Events.Item.Instances.Count;
using Microsoft.Graph.Beta.Me.Calendar.Events.Item.Instances.Delta;
using Microsoft.Graph.Beta.Me.Calendar.Events.Item.Instances.Item;
...
namespace Microsoft.Graph.Beta.Me.Calendar.Events.Item.Instances {
    /// <summary>
    ...
    public class InstancesRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Me.Calendar.Events.Item.Instances.Item.EventItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("event%2Did1", position);
            return new Microsoft.Graph.Beta.Me.Calendar.Events.Item.Instances.Item.EventItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public InstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendar/events/{event%2Did}/instances{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new InstancesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InstancesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendar/events/{event%2Did}/instances{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", rawUrl) {
        }
        /// <summary>
