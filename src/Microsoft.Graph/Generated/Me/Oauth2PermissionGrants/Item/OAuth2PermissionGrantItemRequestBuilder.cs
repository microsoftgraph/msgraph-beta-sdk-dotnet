...
namespace Microsoft.Graph.Beta.Me.Oauth2PermissionGrants.Item {
    ...
    public class OAuth2PermissionGrantItemRequestBuilder {
        ...
        public OAuth2PermissionGrantItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/oauth2PermissionGrants/{oAuth2PermissionGrant%2Did}{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<OAuth2PermissionGrant> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
