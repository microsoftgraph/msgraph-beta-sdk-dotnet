...
namespace Microsoft.Graph.Beta.Me.Oauth2PermissionGrants.Item {
    ...
    public class OAuth2PermissionGrantItemRequestBuilder {
        ...
        /// </summary>
        public async Task<OAuth2PermissionGrant> GetAsync(CancellationToken cancellationToken = default, Action<OAuth2PermissionGrantItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
