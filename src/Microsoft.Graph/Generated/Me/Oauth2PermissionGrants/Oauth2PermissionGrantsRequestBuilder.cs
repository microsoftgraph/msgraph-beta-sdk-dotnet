...
#nullable enable
        public async Task<OAuth2PermissionGrantCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<Oauth2PermissionGrantsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OAuth2PermissionGrantCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<Oauth2PermissionGrantsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
