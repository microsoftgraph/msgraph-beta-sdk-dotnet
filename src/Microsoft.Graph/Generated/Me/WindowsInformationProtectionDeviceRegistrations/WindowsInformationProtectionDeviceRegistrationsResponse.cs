...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Me.WindowsInformationProtectionDeviceRegistrations {
    public class WindowsInformationProtectionDeviceRegistrationsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as WindowsInformationProtectionDeviceRegistrationsResponse).Value = n.GetCollectionOfObjectValues<WindowsInformationProtectionDeviceRegistration>().ToList(); } },
            };
        }
        /// <summary>
