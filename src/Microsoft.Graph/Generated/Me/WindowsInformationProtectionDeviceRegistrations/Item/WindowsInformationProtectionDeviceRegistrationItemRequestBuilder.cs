...
namespace Microsoft.Graph.Beta.Me.WindowsInformationProtectionDeviceRegistrations.Item {
    ...
    public class WindowsInformationProtectionDeviceRegistrationItemRequestBuilder {
        ...
        /// </summary>
        public async Task<WindowsInformationProtectionDeviceRegistration> GetAsync(CancellationToken cancellationToken = default, Action<WindowsInformationProtectionDeviceRegistrationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
