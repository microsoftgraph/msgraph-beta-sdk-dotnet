...
namespace Microsoft.Graph.Beta.Me.WindowsInformationProtectionDeviceRegistrations {
    ...
    public class WindowsInformationProtectionDeviceRegistrationsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.windowsInformationProtectionDeviceRegistrations.item collection</summary>
        ...
        public WindowsInformationProtectionDeviceRegistrationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/windowsInformationProtectionDeviceRegistrations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
