...
using MicrosoftGraph.Me.Profile.Account;
using MicrosoftGraph.Me.Profile.Addresses;
using MicrosoftGraph.Me.Profile.Anniversaries;
using MicrosoftGraph.Me.Profile.Awards;
using MicrosoftGraph.Me.Profile.Certifications;
using MicrosoftGraph.Me.Profile.EducationalActivities;
using MicrosoftGraph.Me.Profile.Emails;
using MicrosoftGraph.Me.Profile.Interests;
using MicrosoftGraph.Me.Profile.Languages;
using MicrosoftGraph.Me.Profile.Names;
using MicrosoftGraph.Me.Profile.Notes;
using MicrosoftGraph.Me.Profile.Patents;
using MicrosoftGraph.Me.Profile.Phones;
using MicrosoftGraph.Me.Profile.Positions;
using MicrosoftGraph.Me.Profile.Projects;
using MicrosoftGraph.Me.Profile.Publications;
using MicrosoftGraph.Me.Profile.Skills;
using MicrosoftGraph.Me.Profile.WebAccounts;
using MicrosoftGraph.Me.Profile.Websites;
...
namespace MicrosoftGraph.Me.Profile {
    ...
    public class ProfileRequestBuilder {
        ...
        public ProfileRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/profile{?select,expand}";
