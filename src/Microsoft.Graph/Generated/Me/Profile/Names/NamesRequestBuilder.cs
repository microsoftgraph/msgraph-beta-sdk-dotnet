...
namespace Microsoft.Graph.Beta.Me.Profile.Names {
    ...
    public class NamesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.profile.names.item collection</summary>
        ...
        public NamesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/profile/names{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
