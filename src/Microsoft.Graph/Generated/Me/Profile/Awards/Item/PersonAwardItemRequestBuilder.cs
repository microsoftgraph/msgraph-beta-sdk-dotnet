...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PersonAwardItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PersonAwardItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PersonAward?> GetAsync(CancellationToken cancellationToken = default, Action<PersonAwardItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PersonAward> GetAsync(CancellationToken cancellationToken = default, Action<PersonAwardItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PersonAward?> PatchAsync(PersonAward body, CancellationToken cancellationToken = default, Action<PersonAwardItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PersonAward> PatchAsync(PersonAward body, CancellationToken cancellationToken = default, Action<PersonAwardItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
