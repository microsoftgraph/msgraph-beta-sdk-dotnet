...
namespace MicrosoftGraphSdk.Me.Profile.Languages {
    ...
    public class LanguagesRequestBuilder {
        ...
        /// </summary>
        public async Task<LanguageProficiencyCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
