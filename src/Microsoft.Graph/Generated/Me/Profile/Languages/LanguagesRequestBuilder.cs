...
#nullable enable
        public async Task<LanguageProficiencyCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<LanguagesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<LanguageProficiencyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<LanguagesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<LanguageProficiency?> PostAsync(LanguageProficiency body, CancellationToken cancellationToken = default, Action<LanguagesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<LanguageProficiency> PostAsync(LanguageProficiency body, CancellationToken cancellationToken = default, Action<LanguagesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
