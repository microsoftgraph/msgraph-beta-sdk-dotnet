...
namespace Microsoft.Graph.Beta.Me.Profile.Languages {
    ...
    public class LanguagesRequestBuilder {
        ...
        /// </summary>
        public async Task<LanguageProficiencyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<LanguagesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<LanguageProficiency> PostAsync(LanguageProficiency body, CancellationToken cancellationToken = default, Action<LanguagesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
