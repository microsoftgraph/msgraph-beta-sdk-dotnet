...
namespace MicrosoftGraph.Me.Profile.Skills {
    /// <summary>Builds and executes requests for operations under \me\profile\skills</summary>
    public class SkillsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.profile.skills.item collection</summary>
        public SkillsRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("skillProficiency_id", position);
            return new SkillsRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
