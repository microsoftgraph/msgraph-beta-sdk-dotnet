...
namespace Microsoft.Graph.Beta.Me.Profile.EducationalActivities {
    ...
    public class EducationalActivitiesRequestBuilder : BaseRequestBuilder {
        ...
        public EducationalActivityItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("educationalActivity%2Did", position);
...
#nullable enable
        public async Task<EducationalActivityCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<EducationalActivitiesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationalActivityCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<EducationalActivitiesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EducationalActivity?> PostAsync(EducationalActivity body, CancellationToken cancellationToken = default, Action<EducationalActivitiesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationalActivity> PostAsync(EducationalActivity body, CancellationToken cancellationToken = default, Action<EducationalActivitiesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
