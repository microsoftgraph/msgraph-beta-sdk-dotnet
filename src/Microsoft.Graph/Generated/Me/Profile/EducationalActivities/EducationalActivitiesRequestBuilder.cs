...
namespace Microsoft.Graph.Beta.Me.Profile.EducationalActivities {
    ...
    public class EducationalActivitiesRequestBuilder {
        ...
        /// <summary>
        /// Retrieve a list of educationalActivity objects from a user&apos;s profile.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/profile-list-educationalactivities?view=graph-rest-1.0" />
        /// </summary>
        ...
        /// <summary>
        /// Create a new educationalActivity in a user&apos;s profile.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/profile-post-educationalactivities?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
