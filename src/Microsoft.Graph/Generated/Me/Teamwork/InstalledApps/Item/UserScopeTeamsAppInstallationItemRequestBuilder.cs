...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UserScopeTeamsAppInstallationItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UserScopeTeamsAppInstallationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UserScopeTeamsAppInstallation?> GetAsync(CancellationToken cancellationToken = default, Action<UserScopeTeamsAppInstallationItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserScopeTeamsAppInstallation> GetAsync(CancellationToken cancellationToken = default, Action<UserScopeTeamsAppInstallationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UserScopeTeamsAppInstallation?> PatchAsync(UserScopeTeamsAppInstallation body, CancellationToken cancellationToken = default, Action<UserScopeTeamsAppInstallationItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserScopeTeamsAppInstallation> PatchAsync(UserScopeTeamsAppInstallation body, CancellationToken cancellationToken = default, Action<UserScopeTeamsAppInstallationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
