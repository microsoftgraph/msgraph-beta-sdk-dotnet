...
using MicrosoftGraph.Me.Devices.Item;
...
namespace MicrosoftGraph.Me.Devices {
    ...
    public class DevicesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.devices.item collection</summary>
