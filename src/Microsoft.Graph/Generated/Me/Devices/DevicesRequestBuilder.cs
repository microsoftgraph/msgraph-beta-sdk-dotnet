using Microsoft.Graph.Beta.Me.Devices.Count;
using Microsoft.Graph.Beta.Me.Devices.Delta;
using Microsoft.Graph.Beta.Me.Devices.GetByIds;
using Microsoft.Graph.Beta.Me.Devices.GetUserOwnedObjects;
using Microsoft.Graph.Beta.Me.Devices.Item;
using Microsoft.Graph.Beta.Me.Devices.ValidateProperties;
...
namespace Microsoft.Graph.Beta.Me.Devices {
    /// <summary>
    ...
    public class DevicesRequestBuilder : BaseRequestBuilder {
        ...
        public DevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/devices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DevicesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DevicesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/devices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get devices from me
        /// </summary>
