...
namespace Microsoft.Graph.Beta.Me.Devices {
    ...
    public class DevicesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.devices.item collection</summary>
        ...
        public DevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
