...
using MicrosoftGraphSdk.Me.Devices.Item.RegisteredOwners.Count;
using MicrosoftGraphSdk.Me.Devices.Item.RegisteredOwners.Item;
...
namespace MicrosoftGraphSdk.Me.Devices.Item.RegisteredOwners {
    ...
    public class RegisteredOwnersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.devices.item.registeredOwners.item collection</summary>
        ...
        public RegisteredOwnersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device_id}/registeredOwners{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
