...
using Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners.GraphEndpoint;
using Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners.GraphServicePrincipal;
using Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners.GraphUser;
...
namespace Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners {
    ...
    public class RegisteredOwnersRequestBuilder : BaseRequestBuilder {
        ...
        public RegisteredOwnersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/devices/{device%2Did}/registeredOwners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RegisteredOwnersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RegisteredOwnersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/devices/{device%2Did}/registeredOwners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
