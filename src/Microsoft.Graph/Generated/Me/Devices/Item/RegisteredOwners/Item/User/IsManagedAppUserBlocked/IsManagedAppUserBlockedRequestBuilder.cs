...
namespace Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners.Item.User.IsManagedAppUserBlocked {
    ...
    public class IsManagedAppUserBlockedRequestBuilder {
        ...
        public IsManagedAppUserBlockedRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.isManagedAppUserBlocked()";
