using Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners.Item.MicrosoftGraphEndpoint;
using Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners.Item.MicrosoftGraphServicePrincipal;
using Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners.Item.MicrosoftGraphUser;
...
namespace Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners.Item {
    ...
    public class DirectoryObjectItemRequestBuilder {
        ...
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}";
