using Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners.Item.GraphEndpoint;
using Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners.Item.GraphServicePrincipal;
using Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners.Item.GraphUser;
...
namespace Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners.Item {
    ...
    public class DirectoryObjectItemRequestBuilder : BaseRequestBuilder {
        ...
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DirectoryObjectItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DirectoryObjectItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}", rawUrl) {
        }
    }
}
