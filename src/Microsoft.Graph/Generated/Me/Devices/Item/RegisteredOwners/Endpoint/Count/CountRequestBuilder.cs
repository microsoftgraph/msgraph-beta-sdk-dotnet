...
namespace Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners.Endpoint.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device%2Did}/registeredOwners/microsoft.graph.endpoint/$count";
