...
namespace Microsoft.Graph.Beta.Me.Devices.Item {
    ...
    public class DeviceItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        {
            get =>             new RegisteredOwnersRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get =>             new RegisteredUsersRequestBuilder(PathParameters, RequestAdapter);
        }
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/me/devices/{device%2Did}", PathParameters);
...
#endif
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/me/devices/{device%2Did}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
