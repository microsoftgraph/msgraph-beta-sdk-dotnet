using Microsoft.Graph.Beta.Me.Devices.Item.CheckMemberGroups;
using Microsoft.Graph.Beta.Me.Devices.Item.CheckMemberObjects;
using Microsoft.Graph.Beta.Me.Devices.Item.Commands;
using Microsoft.Graph.Beta.Me.Devices.Item.Extensions;
using Microsoft.Graph.Beta.Me.Devices.Item.GetMemberGroups;
using Microsoft.Graph.Beta.Me.Devices.Item.GetMemberObjects;
using Microsoft.Graph.Beta.Me.Devices.Item.MemberOf;
using Microsoft.Graph.Beta.Me.Devices.Item.RegisteredOwners;
using Microsoft.Graph.Beta.Me.Devices.Item.RegisteredUsers;
using Microsoft.Graph.Beta.Me.Devices.Item.Restore;
using Microsoft.Graph.Beta.Me.Devices.Item.TransitiveMemberOf;
using Microsoft.Graph.Beta.Me.Devices.Item.UsageRights;
...
namespace Microsoft.Graph.Beta.Me.Devices.Item {
    ...
    public class DeviceItemRequestBuilder {
        ...
        public DeviceItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device%2Did}{?%24select,%24expand}";
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(Microsoft.Graph.Beta.Models.Device body, Action<DeviceItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task DeleteAsync(Action<DeviceItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Device> GetAsync(Action<DeviceItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Device> PatchAsync(Microsoft.Graph.Beta.Models.Device body, Action<DeviceItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
        ...
        /// <summary>Get devices from me</summary>
