...
#nullable enable
        public async Task<ServicePrincipalCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GraphServicePrincipalRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServicePrincipalCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<GraphServicePrincipalRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
