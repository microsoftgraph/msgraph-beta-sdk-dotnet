...
namespace Microsoft.Graph.Beta.Me.Devices.Item.RegisteredUsers.Item.ServicePrincipal {
    /// <summary>
    ...
    public class ServicePrincipalRequestBuilder {
        ...
        public ServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/microsoft.graph.servicePrincipal{?%24select,%24expand}";
