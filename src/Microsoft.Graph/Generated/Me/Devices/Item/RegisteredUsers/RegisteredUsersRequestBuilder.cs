...
using MicrosoftGraphSdk.Me.Devices.Item.RegisteredUsers.Count;
using MicrosoftGraphSdk.Me.Devices.Item.RegisteredUsers.Item;
...
namespace MicrosoftGraphSdk.Me.Devices.Item.RegisteredUsers {
    ...
    public class RegisteredUsersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.devices.item.registeredUsers.item collection</summary>
        ...
        public RegisteredUsersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device_id}/registeredUsers{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
