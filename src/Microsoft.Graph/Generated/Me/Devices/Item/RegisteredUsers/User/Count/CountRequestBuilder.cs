...
namespace Microsoft.Graph.Beta.Me.Devices.Item.RegisteredUsers.User.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device%2Did}/registeredUsers/microsoft.graph.user/$count";
