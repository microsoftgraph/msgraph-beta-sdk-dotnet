...
using MicrosoftGraphSdk.Me.Devices.Item.TransitiveMemberOf.Count;
using MicrosoftGraphSdk.Me.Devices.Item.TransitiveMemberOf.Item;
...
namespace MicrosoftGraphSdk.Me.Devices.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.devices.item.transitiveMemberOf.item collection</summary>
        ...
        public TransitiveMemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device_id}/transitiveMemberOf{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
