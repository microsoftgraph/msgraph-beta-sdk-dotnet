using Microsoft.Graph.Beta.Me.Devices.Item.TransitiveMemberOf.Device.Count;
...
namespace Microsoft.Graph.Beta.Me.Devices.Item.TransitiveMemberOf.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        public DeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device%2Did}/transitiveMemberOf/microsoft.graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
