...
namespace Microsoft.Graph.Beta.Me.Devices.Item.TransitiveMemberOf.Group.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device%2Did}/transitiveMemberOf/microsoft.graph.group/$count{?%24search,%24filter}";
