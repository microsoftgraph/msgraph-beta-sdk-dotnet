...
namespace Microsoft.Graph.Beta.Me.Devices.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.devices.item.memberOf.item collection</summary>
        ...
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MemberOfRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
