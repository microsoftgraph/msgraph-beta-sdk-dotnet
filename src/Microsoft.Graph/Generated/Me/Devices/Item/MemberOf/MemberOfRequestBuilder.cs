...
using MicrosoftGraphSdk.Me.Devices.Item.MemberOf.Count;
using MicrosoftGraphSdk.Me.Devices.Item.MemberOf.Item;
...
namespace MicrosoftGraphSdk.Me.Devices.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.devices.item.memberOf.item collection</summary>
