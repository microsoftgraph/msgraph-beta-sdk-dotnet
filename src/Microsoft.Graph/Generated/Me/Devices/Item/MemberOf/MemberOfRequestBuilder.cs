using Microsoft.Graph.Beta.Me.Devices.Item.MemberOf.Count;
using Microsoft.Graph.Beta.Me.Devices.Item.MemberOf.Item;
using Microsoft.Graph.Beta.Me.Devices.Item.MemberOf.MicrosoftGraphApplication;
using Microsoft.Graph.Beta.Me.Devices.Item.MemberOf.MicrosoftGraphDevice;
using Microsoft.Graph.Beta.Me.Devices.Item.MemberOf.MicrosoftGraphGroup;
using Microsoft.Graph.Beta.Me.Devices.Item.MemberOf.MicrosoftGraphOrgContact;
using Microsoft.Graph.Beta.Me.Devices.Item.MemberOf.MicrosoftGraphServicePrincipal;
using Microsoft.Graph.Beta.Me.Devices.Item.MemberOf.MicrosoftGraphUser;
...
namespace Microsoft.Graph.Beta.Me.Devices.Item.MemberOf {
    /// <summary>
    ...
    public class MemberOfRequestBuilder {
        ...
        public MemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/me/devices/{device%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MemberOfRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/device-list-memberof?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DirectoryObjectCollectionResponse?> GetAsync(Action<MemberOfRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<DirectoryObjectCollectionResponse> GetAsync(Action<MemberOfRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<MemberOfRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<MemberOfRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#nullable restore
        ...
        public class MemberOfRequestBuilderGetRequestConfiguration {
            ...
            public MemberOfRequestBuilderGetQueryParameters QueryParameters { get; set; } = new MemberOfRequestBuilderGetQueryParameters();
            /// <summary>
