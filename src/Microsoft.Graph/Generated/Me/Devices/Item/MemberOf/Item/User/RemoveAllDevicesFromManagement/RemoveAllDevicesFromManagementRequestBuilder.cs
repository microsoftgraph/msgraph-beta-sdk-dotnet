...
namespace Microsoft.Graph.Beta.Me.Devices.Item.MemberOf.Item.User.RemoveAllDevicesFromManagement {
    ...
    public class RemoveAllDevicesFromManagementRequestBuilder {
        ...
        public RemoveAllDevicesFromManagementRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.removeAllDevicesFromManagement";
