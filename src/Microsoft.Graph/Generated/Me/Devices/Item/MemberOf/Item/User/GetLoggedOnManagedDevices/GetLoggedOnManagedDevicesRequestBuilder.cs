...
namespace Microsoft.Graph.Beta.Me.Devices.Item.MemberOf.Item.User.GetLoggedOnManagedDevices {
    ...
    public class GetLoggedOnManagedDevicesRequestBuilder {
        ...
        public GetLoggedOnManagedDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.getLoggedOnManagedDevices()";
