using Microsoft.Graph.Beta.Me.Devices.Item.MemberOf.ServicePrincipal.Count;
...
namespace Microsoft.Graph.Beta.Me.Devices.Item.MemberOf.ServicePrincipal {
    ...
    public class ServicePrincipalRequestBuilder {
        ...
        public ServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device%2Did}/memberOf/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
