...
namespace MicrosoftGraphSdk.Me.Devices.Item.Commands.Item.Responsepayload {
    ...
    public class ResponsepayloadRequestBuilder {
        ...
        public ResponsepayloadRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/devices/{device_id}/commands/{command_id}/responsepayload{?select,expand}";
