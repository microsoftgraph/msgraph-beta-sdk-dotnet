...
namespace Microsoft.Graph.Beta.Me.MicrosoftGraphRemoveAllDevicesFromManagement {
    /// <summary>
    ...
    public class MicrosoftGraphRemoveAllDevicesFromManagementRequestBuilder {
        ...
        public MicrosoftGraphRemoveAllDevicesFromManagementRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphRemoveAllDevicesFromManagementRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(Action<MicrosoftGraphRemoveAllDevicesFromManagementRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(Action<MicrosoftGraphRemoveAllDevicesFromManagementRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
