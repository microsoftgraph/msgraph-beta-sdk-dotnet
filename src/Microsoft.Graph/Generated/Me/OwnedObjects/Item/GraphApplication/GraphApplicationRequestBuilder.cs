...
namespace Microsoft.Graph.Beta.Me.OwnedObjects.Item.GraphApplication {
    /// <summary>
    ...
    public class GraphApplicationRequestBuilder {
        ...
        public GraphApplicationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/ownedObjects/{directoryObject%2Did}/graph.application{?%24select,%24expand}";
