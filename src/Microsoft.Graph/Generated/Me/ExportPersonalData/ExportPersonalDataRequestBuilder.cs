...
namespace Microsoft.Graph.Beta.Me.ExportPersonalData
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Me.ExportPersonalData.ExportPersonalDataRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(Microsoft.Graph.Beta.Me.ExportPersonalData.ExportPersonalDataPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(Microsoft.Graph.Beta.Me.ExportPersonalData.ExportPersonalDataPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Me.ExportPersonalData.ExportPersonalDataPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Me.ExportPersonalData.ExportPersonalDataPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Me.ExportPersonalData.ExportPersonalDataRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Me.ExportPersonalData.ExportPersonalDataRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Me.ExportPersonalData.ExportPersonalDataRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
