using Microsoft.Graph.Beta.Me.Onenote.SectionGroups.Item.ParentNotebook;
using Microsoft.Graph.Beta.Me.Onenote.SectionGroups.Item.ParentSectionGroup;
using Microsoft.Graph.Beta.Me.Onenote.SectionGroups.Item.SectionGroups;
using Microsoft.Graph.Beta.Me.Onenote.SectionGroups.Item.Sections;
...
namespace Microsoft.Graph.Beta.Me.Onenote.SectionGroups.Item {
    ...
    public class SectionGroupItemRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Me.Onenote.SectionGroups.Item.SectionGroups.SectionGroupsRequestBuilder SectionGroups { get =>
            new Microsoft.Graph.Beta.Me.Onenote.SectionGroups.Item.SectionGroups.SectionGroupsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public SectionGroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onenote/sectionGroups/{sectionGroup%2Did}{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public SectionGroupItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public async Task DeleteAsync(Action<SectionGroupItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SectionGroup> GetAsync(Action<SectionGroupItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<SectionGroup>(requestInfo, SectionGroup.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Update the navigation property sectionGroups in me
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SectionGroup> PatchAsync(SectionGroup body, Action<SectionGroupItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
