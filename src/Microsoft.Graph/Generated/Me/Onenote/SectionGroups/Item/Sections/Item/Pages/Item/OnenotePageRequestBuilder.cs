...
using MicrosoftGraph.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.Content;
using MicrosoftGraph.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.CopyToSection;
using MicrosoftGraph.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.OnenotePatchContent;
using MicrosoftGraph.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.ParentNotebook;
using MicrosoftGraph.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.ParentSection;
using MicrosoftGraph.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.Preview;
...
namespace MicrosoftGraph.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item {
    /// <summary>Builds and executes requests for operations under \me\onenote\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id}\pages\{onenotePage-id}</summary>
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onenote/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}{?select,expand}";
