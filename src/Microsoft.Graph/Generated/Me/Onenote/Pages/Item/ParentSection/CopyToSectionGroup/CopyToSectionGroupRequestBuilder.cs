...
namespace MicrosoftGraphSdk.Me.Onenote.Pages.Item.ParentSection.CopyToSectionGroup {
    /// <summary>Builds and executes requests for operations under \me\onenote\pages\{onenotePage-id}\parentSection\microsoft.graph.copyToSectionGroup</summary>
    public class CopyToSectionGroupRequestBuilder {
        ...
        public CopyToSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onenote/pages/{onenotePage_id}/parentSection/microsoft.graph.copyToSectionGroup";
