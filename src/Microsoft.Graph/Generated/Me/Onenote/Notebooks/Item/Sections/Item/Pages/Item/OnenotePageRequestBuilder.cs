...
using MicrosoftGraph.Me.Onenote.Notebooks.Item.Sections.Item.Pages.Item.Content;
using MicrosoftGraph.Me.Onenote.Notebooks.Item.Sections.Item.Pages.Item.CopyToSection;
using MicrosoftGraph.Me.Onenote.Notebooks.Item.Sections.Item.Pages.Item.OnenotePatchContent;
using MicrosoftGraph.Me.Onenote.Notebooks.Item.Sections.Item.Pages.Item.ParentNotebook;
using MicrosoftGraph.Me.Onenote.Notebooks.Item.Sections.Item.Pages.Item.ParentSection;
using MicrosoftGraph.Me.Onenote.Notebooks.Item.Sections.Item.Pages.Item.Preview;
...
namespace MicrosoftGraph.Me.Onenote.Notebooks.Item.Sections.Item.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}{?select,expand}";
