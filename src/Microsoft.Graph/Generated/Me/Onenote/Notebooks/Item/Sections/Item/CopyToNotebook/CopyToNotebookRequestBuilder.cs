...
#nullable enable
        public async Task<OnenoteOperation?> PostAsync(CopyToNotebookPostRequestBody body, CancellationToken cancellationToken = default, Action<CopyToNotebookRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OnenoteOperation> PostAsync(CopyToNotebookPostRequestBody body, CancellationToken cancellationToken = default, Action<CopyToNotebookRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
