...
namespace MicrosoftGraphSdk.Me.Onenote.Notebooks.Item.Sections.Item.Pages.Item.ParentSection.CopyToNotebook {
    ...
    public class CopyToNotebookRequestBuilder {
        ...
        public CopyToNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentSection/microsoft.graph.copyToNotebook";
