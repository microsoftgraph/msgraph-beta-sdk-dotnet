...
namespace Microsoft.Graph.Beta.Me.Onenote.Notebooks.Item.Sections.Item.CopyToSectionGroup {
    ...
    public class CopyToSectionGroupRequestBuilder : BaseRequestBuilder {
        ...
        public CopyToSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/copyToSectionGroup", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CopyToSectionGroupRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CopyToSectionGroupRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/copyToSectionGroup", rawUrl) {
        }
        /// <summary>
