...
namespace MicrosoftGraph.Me.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.CopyToNotebook {
    /// <summary>Builds and executes requests for operations under \me\onenote\notebooks\{notebook-id}\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id}\microsoft.graph.copyToNotebook</summary>
    public class CopyToNotebookRequestBuilder {
        ...
        public CopyToNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/microsoft.graph.copyToNotebook";
