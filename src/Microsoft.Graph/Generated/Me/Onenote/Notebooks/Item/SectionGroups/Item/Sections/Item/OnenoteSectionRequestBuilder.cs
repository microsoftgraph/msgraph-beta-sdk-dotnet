...
using MicrosoftGraph.Me.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.CopyToNotebook;
using MicrosoftGraph.Me.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.CopyToSectionGroup;
using MicrosoftGraph.Me.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages;
using MicrosoftGraph.Me.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.ParentNotebook;
using MicrosoftGraph.Me.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.ParentSectionGroup;
...
namespace MicrosoftGraph.Me.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item {
    /// <summary>Builds and executes requests for operations under \me\onenote\notebooks\{notebook-id}\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id}</summary>
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}{?select,expand}";
