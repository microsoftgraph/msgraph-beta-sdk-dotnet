...
namespace MicrosoftGraphSdk.Me.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages.Item.ParentSection.CopyToSectionGroup {
    /// <summary>Builds and executes requests for operations under \me\onenote\notebooks\{notebook-id}\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id}\pages\{onenotePage-id}\parentSection\microsoft.graph.copyToSectionGroup</summary>
    public class CopyToSectionGroupRequestBuilder {
        ...
        public CopyToSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentSection/microsoft.graph.copyToSectionGroup";
        ...
        public class CopyToSectionGroupResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"onenoteOperation", (o,n) => { (o as CopyToSectionGroupResponse).OnenoteOperation = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.OnenoteOperation>(MicrosoftGraphSdk.Models.Microsoft.Graph.OnenoteOperation.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
