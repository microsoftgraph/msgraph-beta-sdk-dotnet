...
namespace MicrosoftGraphSdk.Me.Onenote.Notebooks.Item.CopyNotebook {
    ...
    public class CopyNotebookRequestBuilder {
        ...
        /// </summary>
        public async Task<OnenoteOperation> PostAsync(CopyNotebookRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
