...
namespace Microsoft.Graph.Beta.Me.Onenote.Notebooks {
    ...
    public class NotebooksRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.onenote.notebooks.item collection</summary>
        ...
        public NotebooksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onenote/notebooks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
