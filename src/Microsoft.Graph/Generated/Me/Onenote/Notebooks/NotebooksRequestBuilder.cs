...
namespace Microsoft.Graph.Beta.Me.Onenote.Notebooks {
    ...
    public class NotebooksRequestBuilder : BaseRequestBuilder {
        ...
        public NotebooksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onenote/notebooks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new NotebooksRequestBuilder and sets the default values.
        /// </summary>
