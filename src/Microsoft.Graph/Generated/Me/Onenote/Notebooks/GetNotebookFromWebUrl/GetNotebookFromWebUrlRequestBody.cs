...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Me.Onenote.Notebooks.GetNotebookFromWebUrl {
    /// <summary>Provides operations to call the getNotebookFromWebUrl method.</summary>
    public class GetNotebookFromWebUrlRequestBody : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static GetNotebookFromWebUrlRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
