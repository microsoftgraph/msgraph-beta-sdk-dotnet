...
using MicrosoftGraph.Me.Onenote.Sections.Item.Pages.Item.Content;
using MicrosoftGraph.Me.Onenote.Sections.Item.Pages.Item.CopyToSection;
using MicrosoftGraph.Me.Onenote.Sections.Item.Pages.Item.OnenotePatchContent;
using MicrosoftGraph.Me.Onenote.Sections.Item.Pages.Item.ParentNotebook;
using MicrosoftGraph.Me.Onenote.Sections.Item.Pages.Item.ParentSection;
using MicrosoftGraph.Me.Onenote.Sections.Item.Pages.Item.Preview;
...
namespace MicrosoftGraph.Me.Onenote.Sections.Item.Pages.Item {
    /// <summary>Builds and executes requests for operations under \me\onenote\sections\{onenoteSection-id}\pages\{onenotePage-id}</summary>
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}{?select,expand}";
        ...
        /// <summary>
        /// Builds and executes requests for operations under \me\onenote\sections\{onenoteSection-id}\pages\{onenotePage-id}\microsoft.graph.preview()
        /// </summary>
