using Microsoft.Graph.Beta.Me.Onenote.Sections.Item.Pages.Count;
using Microsoft.Graph.Beta.Me.Onenote.Sections.Item.Pages.Item;
...
namespace Microsoft.Graph.Beta.Me.Onenote.Sections.Item.Pages {
    ...
    public class PagesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.onenote.sections.item.pages.item collection</summary>
        ...
        public PagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onenote/sections/{onenoteSection%2Did}/pages{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
