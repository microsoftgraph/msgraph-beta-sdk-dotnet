using Microsoft.Graph.Beta.Me.Onenote.Sections.Item.CopyToNotebook;
using Microsoft.Graph.Beta.Me.Onenote.Sections.Item.CopyToSectionGroup;
using Microsoft.Graph.Beta.Me.Onenote.Sections.Item.Pages;
using Microsoft.Graph.Beta.Me.Onenote.Sections.Item.ParentNotebook;
using Microsoft.Graph.Beta.Me.Onenote.Sections.Item.ParentSectionGroup;
...
using System;
namespace Microsoft.Graph.Beta.Me.Onenote.Sections.Item {
    /// <summary>
    ...
    public class OnenoteSectionItemRequestBuilder : BaseRequestBuilder {
        ...
        public OnenoteSectionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onenote/sections/{onenoteSection%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OnenoteSectionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OnenoteSectionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onenote/sections/{onenoteSection%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
