...
using MicrosoftGraph.Me.Events.Item.Attachments.CreateUploadSession;
using MicrosoftGraph.Me.Events.Item.Attachments.Item;
...
namespace MicrosoftGraph.Me.Events.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.events.item.attachments.item collection</summary>
