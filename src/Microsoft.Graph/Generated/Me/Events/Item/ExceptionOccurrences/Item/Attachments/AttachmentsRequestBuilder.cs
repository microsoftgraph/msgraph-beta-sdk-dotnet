...
using MicrosoftGraphSdk.Me.Events.Item.ExceptionOccurrences.Item.Attachments.Count;
using MicrosoftGraphSdk.Me.Events.Item.ExceptionOccurrences.Item.Attachments.CreateUploadSession;
using MicrosoftGraphSdk.Me.Events.Item.ExceptionOccurrences.Item.Attachments.Item;
...
namespace MicrosoftGraphSdk.Me.Events.Item.ExceptionOccurrences.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.events.item.exceptionOccurrences.item.attachments.item collection</summary>
