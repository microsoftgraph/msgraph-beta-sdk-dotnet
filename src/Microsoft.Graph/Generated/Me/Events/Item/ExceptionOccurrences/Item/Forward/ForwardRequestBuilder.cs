...
namespace Microsoft.Graph.Beta.Me.Events.Item.ExceptionOccurrences.Item.Forward {
    ...
    public class ForwardRequestBuilder {
        ...
        public ForwardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/microsoft.graph.forward";
