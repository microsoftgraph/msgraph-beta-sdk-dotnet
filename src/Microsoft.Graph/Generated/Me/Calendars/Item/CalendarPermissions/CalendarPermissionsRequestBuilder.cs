...
using MicrosoftGraph.Me.Calendars.Item.CalendarPermissions.Item;
...
namespace MicrosoftGraph.Me.Calendars.Item.CalendarPermissions {
    /// <summary>Builds and executes requests for operations under \me\calendars\{calendar-id}\calendarPermissions</summary>
    public class CalendarPermissionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.calendars.item.calendarPermissions.item collection</summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CalendarPermission body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
