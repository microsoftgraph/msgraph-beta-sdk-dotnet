...
namespace Microsoft.Graph.Beta.Me.Calendars.Item.CalendarPermissions {
    ...
    public class CalendarPermissionsRequestBuilder {
        ...
        /// </summary>
        public async Task<CalendarPermissionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CalendarPermissionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<CalendarPermission> PostAsync(CalendarPermission body, CancellationToken cancellationToken = default, Action<CalendarPermissionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
