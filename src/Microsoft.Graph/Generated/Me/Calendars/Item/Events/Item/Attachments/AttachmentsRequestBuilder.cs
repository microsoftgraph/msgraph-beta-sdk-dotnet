...
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.Attachments.Count;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.Attachments.CreateUploadSession;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.Attachments.Item;
...
namespace MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.calendars.item.events.item.attachments.item collection</summary>
