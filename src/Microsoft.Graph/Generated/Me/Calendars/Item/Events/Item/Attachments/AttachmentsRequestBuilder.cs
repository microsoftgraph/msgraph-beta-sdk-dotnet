...
using MicrosoftGraph.Me.Calendars.Item.Events.Item.Attachments.CreateUploadSession;
using MicrosoftGraph.Me.Calendars.Item.Events.Item.Attachments.Item;
...
namespace MicrosoftGraph.Me.Calendars.Item.Events.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.calendars.item.events.item.attachments.item collection</summary>
