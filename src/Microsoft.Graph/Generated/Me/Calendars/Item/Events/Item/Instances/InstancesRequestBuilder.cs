...
using MicrosoftGraph.Me.Calendars.Item.Events.Item.Instances.Delta;
using MicrosoftGraph.Me.Calendars.Item.Events.Item.Instances.Item;
...
namespace MicrosoftGraph.Me.Calendars.Item.Events.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.calendars.item.events.item.instances.item collection</summary>
