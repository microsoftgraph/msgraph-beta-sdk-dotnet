...
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.Accept;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.Attachments;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.Calendar;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.Cancel;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.Decline;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.DismissReminder;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.Extensions;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.Forward;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.MultiValueExtendedProperties;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.SingleValueExtendedProperties;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.SnoozeReminder;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.TentativelyAccept;
...
namespace MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar_id}/events/{event_id}/exceptionOccurrences/{event_id1}/instances/{event_id2}{?select}";
