...
namespace Microsoft.Graph.Beta.Me.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.SingleValueExtendedProperties.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar_id}/calendarView/{event_id}/exceptionOccurrences/{event_id1}/instances/{event_id2}/singleValueExtendedProperties/$count";
