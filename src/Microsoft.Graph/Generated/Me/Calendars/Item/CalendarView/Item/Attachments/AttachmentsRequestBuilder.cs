...
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.Attachments.CreateUploadSession;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.Attachments.Item;
...
namespace MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.calendars.item.calendarView.item.attachments.item collection</summary>
