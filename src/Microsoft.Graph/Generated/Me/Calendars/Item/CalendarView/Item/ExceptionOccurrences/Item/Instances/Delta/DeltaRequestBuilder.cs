...
namespace Microsoft.Graph.Beta.Me.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.Instances.Delta {
    ...
    public class DeltaRequestBuilder {
        ...
        public DeltaRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
