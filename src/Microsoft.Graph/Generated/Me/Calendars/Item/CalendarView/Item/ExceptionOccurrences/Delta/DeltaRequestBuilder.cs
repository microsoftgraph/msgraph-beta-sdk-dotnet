...
namespace MicrosoftGraphSdk.Me.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Delta {
    /// <summary>Builds and executes requests for operations under \me\calendars\{calendar-id}\calendarView\{event-id}\exceptionOccurrences\microsoft.graph.delta()</summary>
    public class DeltaRequestBuilder {
        ...
        public DeltaRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar_id}/calendarView/{event_id}/exceptionOccurrences/microsoft.graph.delta()";
