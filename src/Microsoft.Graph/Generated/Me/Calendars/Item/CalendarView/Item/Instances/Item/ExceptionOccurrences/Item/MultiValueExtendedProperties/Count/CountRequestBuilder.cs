...
namespace Microsoft.Graph.Beta.Me.Calendars.Item.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.MultiValueExtendedProperties.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar_id}/calendarView/{event_id}/instances/{event_id1}/exceptionOccurrences/{event_id2}/multiValueExtendedProperties/$count";
