...
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.Accept;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.Cancel;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.Decline;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.DismissReminder;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.Forward;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.SnoozeReminder;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.TentativelyAccept;
...
namespace MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item {
    /// <summary>Builds and executes requests for operations under \me\calendars\{calendar-id}\calendarView\{event-id}\exceptionOccurrences\{event-id1}</summary>
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar_id}/calendarView/{event_id}/exceptionOccurrences/{event_id1}{?select,expand}";
