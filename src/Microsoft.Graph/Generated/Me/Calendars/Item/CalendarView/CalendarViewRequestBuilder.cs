...
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Delta;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item;
...
namespace MicrosoftGraph.Me.Calendars.Item.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.calendars.item.calendarView.item collection</summary>
