...
namespace MicrosoftGraphSdk.Me.Authentication.Fido2Methods {
    ...
    public class Fido2MethodsRequestBuilder {
        ...
        /// </summary>
        public async Task<Fido2AuthenticationMethodCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
