...
namespace Microsoft.Graph.Beta.Me.Authentication.SignInPreferences {
    ...
    public class SignInPreferencesRequestBuilder : BaseRequestBuilder {
        ...
        public SignInPreferencesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/authentication/signInPreferences{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SignInPreferencesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SignInPreferencesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/authentication/signInPreferences{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
