...
using MicrosoftGraphSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Count;
using MicrosoftGraphSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Item;
...
namespace MicrosoftGraphSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.authentication.microsoftAuthenticatorMethods.item.device.transitiveMemberOf.item collection</summary>
        ...
        public TransitiveMemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod_id}/device/transitiveMemberOf{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
