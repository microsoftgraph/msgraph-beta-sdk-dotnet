using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.ActivateServicePlan;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.AssignLicense;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.ChangePassword;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.CheckMemberGroups;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.CheckMemberObjects;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.ExportDeviceAndAppManagementData;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.ExportDeviceAndAppManagementDataWithSkipWithTop;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.ExportPersonalData;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.FindMeetingTimes;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.FindRoomLists;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.FindRooms;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.FindRoomsWithRoomList;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetEffectiveDeviceEnrollmentConfigurations;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetLoggedOnManagedDevices;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetMailTips;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetManagedAppDiagnosticStatuses;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetManagedAppPolicies;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetManagedDevicesWithAppFailures;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetManagedDevicesWithFailedOrPendingApps;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetMemberGroups;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetMemberObjects;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.InvalidateAllRefreshTokens;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.IsManagedAppUserBlocked;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.ReminderViewWithStartDateTimeWithEndDateTime;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.RemoveAllDevicesFromManagement;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.ReprocessLicenseAssignment;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.Restore;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.RevokeSignInSessions;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.SendMail;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.TranslateExchangeIds;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.UnblockManagedApps;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.WipeAndBlockManagedApps;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.WipeManagedAppRegistrationByDeviceTag;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.WipeManagedAppRegistrationsByAzureAdDeviceId;
using Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.WipeManagedAppRegistrationsByDeviceTag;
...
namespace Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User {
