...
namespace Microsoft.Graph.Beta.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Item.User.FindRoomsWithRoomList {
    ...
    public class FindRoomsWithRoomListRequestBuilder {
        ...
        public FindRoomsWithRoomListRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string roomList = default) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/memberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.findRooms(RoomList='{RoomList}')";
