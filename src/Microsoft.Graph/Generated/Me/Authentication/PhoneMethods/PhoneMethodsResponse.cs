...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.Me.Authentication.PhoneMethods {
    public class PhoneMethodsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as PhoneMethodsResponse).Value = n.GetCollectionOfObjectValues<PhoneAuthenticationMethod>().ToList(); } },
            };
        }
        /// <summary>
