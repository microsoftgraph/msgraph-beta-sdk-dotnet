...
namespace Microsoft.Graph.Beta.Me.Authentication.PlatformCredentialMethods {
    ...
    public class PlatformCredentialMethodsRequestBuilder : BaseRequestBuilder {
        ...
        public PlatformCredentialAuthenticationMethodItemRequestBuilder this[string position] { get {
        ...
        public PlatformCredentialMethodsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/authentication/platformCredentialMethods{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PlatformCredentialMethodsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<PlatformCredentialAuthenticationMethodCollectionResponse?> GetAsync(Action<PlatformCredentialMethodsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<PlatformCredentialAuthenticationMethodCollectionResponse> GetAsync(Action<PlatformCredentialMethodsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<PlatformCredentialMethodsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<PlatformCredentialMethodsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new PlatformCredentialMethodsRequestBuilderGetRequestConfiguration();
...
#nullable restore
        ...
        /// </summary>
        public class PlatformCredentialMethodsRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public PlatformCredentialMethodsRequestBuilderGetQueryParameters QueryParameters { get; set; } = new PlatformCredentialMethodsRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new platformCredentialMethodsRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public PlatformCredentialMethodsRequestBuilderGetRequestConfiguration() {
