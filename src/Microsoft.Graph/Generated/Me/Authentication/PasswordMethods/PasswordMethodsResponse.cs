...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.Me.Authentication.PasswordMethods {
    public class PasswordMethodsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as PasswordMethodsResponse).Value = n.GetCollectionOfObjectValues<PasswordAuthenticationMethod>().ToList(); } },
            };
        }
        /// <summary>
