...
namespace Microsoft.Graph.Beta.Me.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.ServicePrincipal {
    ...
    public class ServicePrincipalRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.ServicePrincipal> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
