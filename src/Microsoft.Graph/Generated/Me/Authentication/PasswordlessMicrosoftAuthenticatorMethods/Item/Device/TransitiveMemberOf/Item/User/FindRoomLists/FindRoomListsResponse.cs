...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Me.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Item.User.FindRoomLists {
    /// <summary>Provides operations to call the findRoomLists method.</summary>
    public class FindRoomListsResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        /// </summary>
        public static FindRoomListsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
