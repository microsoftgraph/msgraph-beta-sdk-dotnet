...
using MicrosoftGraphSdk.Me.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device.Commands;
using MicrosoftGraphSdk.Me.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device.Extensions;
using MicrosoftGraphSdk.Me.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device.MemberOf;
using MicrosoftGraphSdk.Me.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners;
using MicrosoftGraphSdk.Me.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers;
using MicrosoftGraphSdk.Me.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf;
using MicrosoftGraphSdk.Me.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device.UsageRights;
...
namespace MicrosoftGraphSdk.Me.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        public DeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod_id}/device{?select,expand}";
