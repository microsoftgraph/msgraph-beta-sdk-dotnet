...
namespace Microsoft.Graph.Beta.Me.Authentication.TemporaryAccessPassMethods {
    ...
    public class TemporaryAccessPassMethodsRequestBuilder {
        ...
        /// </summary>
        public async Task<TemporaryAccessPassAuthenticationMethodCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TemporaryAccessPassMethodsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TemporaryAccessPassAuthenticationMethod> PostAsync(TemporaryAccessPassAuthenticationMethod body, CancellationToken cancellationToken = default, Action<TemporaryAccessPassMethodsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
