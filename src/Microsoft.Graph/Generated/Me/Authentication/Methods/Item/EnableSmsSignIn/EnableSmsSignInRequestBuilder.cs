...
using System;
namespace Microsoft.Graph.Beta.Me.Authentication.Methods.Item.EnableSmsSignIn {
    /// <summary>
    ...
    public class EnableSmsSignInRequestBuilder : BaseRequestBuilder {
        ...
        public EnableSmsSignInRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/authentication/methods/{authenticationMethod%2Did}/enableSmsSignIn", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EnableSmsSignInRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EnableSmsSignInRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/authentication/methods/{authenticationMethod%2Did}/enableSmsSignIn", rawUrl) {
        }
        /// <summary>
