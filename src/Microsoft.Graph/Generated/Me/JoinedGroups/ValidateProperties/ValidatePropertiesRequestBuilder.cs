...
using System;
namespace Microsoft.Graph.Beta.Me.JoinedGroups.ValidateProperties {
    /// <summary>
    ...
    public class ValidatePropertiesRequestBuilder : BaseRequestBuilder {
        ...
        public ValidatePropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedGroups/validateProperties", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ValidatePropertiesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ValidatePropertiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedGroups/validateProperties", rawUrl) {
        }
        /// <summary>
