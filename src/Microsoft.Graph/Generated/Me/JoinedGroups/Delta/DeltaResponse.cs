...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Delta {
    ...
    public class DeltaResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Microsoft.Graph.Beta.Models.Group> Value {
            get { return BackingStore?.Get<List<Microsoft.Graph.Beta.Models.Group>>(nameof(Value)); }
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Beta.Models.Group>("value", Value);
