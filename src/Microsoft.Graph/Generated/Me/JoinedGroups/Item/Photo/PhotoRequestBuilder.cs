using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Photo.Value;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Photo {
    ...
    public class PhotoRequestBuilder {
        ...
        public PhotoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/photo{?%24select}";
