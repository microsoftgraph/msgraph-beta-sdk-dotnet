using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Onenote.Pages.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Onenote.Pages.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Onenote.Pages {
    ...
    public class PagesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.onenote.pages.item collection</summary>
        ...
        public PagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/onenote/pages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
