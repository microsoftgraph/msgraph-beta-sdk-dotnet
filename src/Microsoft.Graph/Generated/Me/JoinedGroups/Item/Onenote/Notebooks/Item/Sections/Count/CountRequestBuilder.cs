...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Onenote.Notebooks.Item.Sections.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sections/$count";
