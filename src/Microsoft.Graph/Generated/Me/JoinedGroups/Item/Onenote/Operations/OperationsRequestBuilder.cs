using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Onenote.Operations.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Onenote.Operations.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Onenote.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.onenote.operations.item collection</summary>
        ...
        public OperationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/onenote/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
