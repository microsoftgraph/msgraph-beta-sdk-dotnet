...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Onenote.Sections.Item.Pages.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/onenote/sections/{onenoteSection%2Did}/pages/$count";
