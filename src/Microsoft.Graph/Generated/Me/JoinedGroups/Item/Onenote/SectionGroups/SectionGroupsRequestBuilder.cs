using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Onenote.SectionGroups.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Onenote.SectionGroups.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Onenote.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.onenote.sectionGroups.item collection</summary>
        ...
        public SectionGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/onenote/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
