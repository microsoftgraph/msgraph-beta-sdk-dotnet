...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Onenote.SectionGroups.Item.Sections.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/$count";
