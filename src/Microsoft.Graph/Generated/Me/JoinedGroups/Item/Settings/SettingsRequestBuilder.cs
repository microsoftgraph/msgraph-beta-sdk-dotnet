using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Settings.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Settings.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Settings {
    ...
    public class SettingsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.settings.item collection</summary>
        ...
        public SettingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/settings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
