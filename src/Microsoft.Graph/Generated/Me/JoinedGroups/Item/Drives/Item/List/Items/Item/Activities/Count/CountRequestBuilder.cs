...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.List.Items.Item.Activities.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/activities/$count";
