...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.Root.ListItem.Analytics {
    ...
    public class AnalyticsRequestBuilder {
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/root/listItem/analytics{?%24select,%24expand}";
