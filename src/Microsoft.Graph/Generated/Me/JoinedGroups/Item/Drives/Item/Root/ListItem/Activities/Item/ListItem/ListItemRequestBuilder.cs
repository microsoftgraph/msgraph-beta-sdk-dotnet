...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.Root.ListItem.Activities.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/root/listItem/activities/{itemActivityOLD%2Did}/listItem{?%24select,%24expand}";
