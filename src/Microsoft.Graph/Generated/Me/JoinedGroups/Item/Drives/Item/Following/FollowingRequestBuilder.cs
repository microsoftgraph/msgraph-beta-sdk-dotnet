using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.Following.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.Following.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.Following {
    ...
    public class FollowingRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.drives.item.following.item collection</summary>
        ...
        public FollowingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/following{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
