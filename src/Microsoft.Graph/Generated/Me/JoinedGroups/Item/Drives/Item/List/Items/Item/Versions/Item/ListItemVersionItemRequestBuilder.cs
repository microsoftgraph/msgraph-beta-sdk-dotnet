using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.List.Items.Item.Versions.Item.Fields;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.List.Items.Item.Versions.Item.RestoreVersion;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.List.Items.Item.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/versions/{listItemVersion%2Did}{?%24select,%24expand}";
