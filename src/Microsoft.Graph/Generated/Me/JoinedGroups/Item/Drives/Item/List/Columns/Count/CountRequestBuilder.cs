...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.List.Columns.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/columns/$count";
