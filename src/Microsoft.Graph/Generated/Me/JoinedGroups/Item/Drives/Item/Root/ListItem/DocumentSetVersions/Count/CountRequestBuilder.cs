...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.Root.ListItem.DocumentSetVersions.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/root/listItem/documentSetVersions/$count";
