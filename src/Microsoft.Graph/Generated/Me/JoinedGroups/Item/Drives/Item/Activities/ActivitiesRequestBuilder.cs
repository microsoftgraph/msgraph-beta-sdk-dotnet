using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.Activities.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.Activities.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.Activities {
    ...
    public class ActivitiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.drives.item.activities.item collection</summary>
        ...
        public ActivitiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
