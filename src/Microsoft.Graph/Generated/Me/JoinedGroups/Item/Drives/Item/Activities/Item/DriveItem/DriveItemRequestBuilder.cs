using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.Activities.Item.DriveItem.Content;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.Activities.Item.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}";
