...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Drives.Item.Root.Subscriptions.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/root/subscriptions/$count";
