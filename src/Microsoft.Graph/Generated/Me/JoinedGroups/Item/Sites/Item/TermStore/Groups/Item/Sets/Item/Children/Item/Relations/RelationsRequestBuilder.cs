using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item.Children.Item.Relations.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item.Children.Item.Relations.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item.Children.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.sites.item.termStore.groups.item.sets.item.children.item.relations.item collection</summary>
        ...
        public RelationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}/sets/{set%2Did}/children/{term%2Did}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
