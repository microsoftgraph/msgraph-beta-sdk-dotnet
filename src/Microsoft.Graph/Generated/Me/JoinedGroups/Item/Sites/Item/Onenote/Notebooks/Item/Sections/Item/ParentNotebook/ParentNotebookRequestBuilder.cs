...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.Onenote.Notebooks.Item.Sections.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public ParentNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/parentNotebook{?%24select,%24expand}";
