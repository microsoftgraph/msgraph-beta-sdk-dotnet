using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.Lists.Item.Items.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.Lists.Item.Items.Delta;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.Lists.Item.Items.DeltaWithToken;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.Lists.Item.Items.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.Lists.Item.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.sites.item.lists.item.items.item collection</summary>
        ...
        public ItemsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
