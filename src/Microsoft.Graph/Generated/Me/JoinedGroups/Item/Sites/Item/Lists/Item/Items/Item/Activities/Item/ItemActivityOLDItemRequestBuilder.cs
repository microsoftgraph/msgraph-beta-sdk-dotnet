using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.Lists.Item.Items.Item.Activities.Item.DriveItem;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.Lists.Item.Items.Item.Activities.Item.ListItem;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.Lists.Item.Items.Item.Activities.Item {
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.Lists.Item.Items.Item.Activities.Item.ListItem.ListItemRequestBuilder ListItem { get =>
            new Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.Lists.Item.Items.Item.Activities.Item.ListItem.ListItemRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}";
