...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.Lists.Item.Items.DeltaWithToken {
    ...
    public class DeltaWithTokenRequestBuilder {
        ...
        public DeltaWithTokenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string token = default) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/microsoft.graph.delta(token='{token}')";
