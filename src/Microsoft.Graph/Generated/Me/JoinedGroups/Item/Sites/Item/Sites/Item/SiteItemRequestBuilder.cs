...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.Sites.Item {
    ...
    public class SiteItemRequestBuilder {
        ...
        public SiteItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/sites/{site%2Did1}{?%24select,%24expand}";
