using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.TermStore.Groups.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.TermStore.Groups.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.TermStore.Groups {
    ...
    public class GroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.sites.item.termStore.groups.item collection</summary>
        public Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.TermStore.Groups.Item.GroupItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("group%2Did1", position);
            return new Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.TermStore.Groups.Item.GroupItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public GroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/groups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>
        /// Create new navigation property to groups for me
        /// <param name="body"></param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Microsoft.Graph.Beta.Models.TermStore.Group body, Action<GroupsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.TermStore.Group> PostAsync(Microsoft.Graph.Beta.Models.TermStore.Group body, Action<GroupsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
