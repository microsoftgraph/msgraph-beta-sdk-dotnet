using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.TermStore.Groups.Item.Sets;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.TermStore.Groups.Item {
    ...
    public class GroupItemRequestBuilder {
        ...
        public GroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}{?%24select,%24expand}";
        ...
        /// <summary>
        /// Delete navigation property groups for me
        ...
        /// <summary>
        /// Update the navigation property groups in me
