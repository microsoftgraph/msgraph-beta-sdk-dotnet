...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Sites.Item.ContentTypes.Item.BaseTypes.Item {
    ...
    public class ContentTypeItemRequestBuilder {
        ...
        public ContentTypeItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/baseTypes/{contentType%2Did1}{?%24select,%24expand}";
