using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Photos.Item.Value;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Photos.Item {
    ...
    public class ProfilePhotoItemRequestBuilder {
        ...
        public ProfilePhotoItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/photos/{profilePhoto%2Did}{?%24select}";
