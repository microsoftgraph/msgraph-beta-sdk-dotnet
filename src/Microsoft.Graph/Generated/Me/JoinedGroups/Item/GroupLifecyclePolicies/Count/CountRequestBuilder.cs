...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.GroupLifecyclePolicies.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/groupLifecyclePolicies/$count";
