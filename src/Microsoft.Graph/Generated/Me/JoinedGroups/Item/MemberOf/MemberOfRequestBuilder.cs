using Microsoft.Graph.Beta.Me.JoinedGroups.Item.MemberOf.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.MemberOf.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.memberOf.item collection</summary>
        ...
        public MemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
