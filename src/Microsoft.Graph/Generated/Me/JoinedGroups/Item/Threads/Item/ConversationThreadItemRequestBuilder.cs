using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Threads.Item.Posts;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Threads.Item.Reply;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Threads.Item {
    ...
    public class ConversationThreadItemRequestBuilder {
        ...
        public ConversationThreadItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/threads/{conversationThread%2Did}{?%24select}";
