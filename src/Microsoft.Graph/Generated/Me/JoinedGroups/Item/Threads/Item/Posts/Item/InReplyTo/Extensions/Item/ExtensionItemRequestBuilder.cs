...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Threads.Item.Posts.Item.InReplyTo.Extensions.Item {
    ...
    public class ExtensionItemRequestBuilder {
        ...
        public ExtensionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/inReplyTo/extensions/{extension%2Did}{?%24select,%24expand}";
