...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Threads.Item.Reply {
    ...
    public class ReplyRequestBuilder {
        ...
        public ReplyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/threads/{conversationThread%2Did}/microsoft.graph.reply";
