...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Threads.Item.Posts.Item.Mentions.Item {
    ...
    public class MentionItemRequestBuilder {
        ...
        public MentionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/mentions/{mention%2Did}{?%24select,%24expand}";
        ...
        /// <summary>
        /// Update the navigation property mentions in me
