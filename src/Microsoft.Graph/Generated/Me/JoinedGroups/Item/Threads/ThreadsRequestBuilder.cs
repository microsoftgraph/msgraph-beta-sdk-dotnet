using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Threads.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Threads.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Threads {
    ...
    public class ThreadsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.threads.item collection</summary>
        ...
        public ThreadsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/threads{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
