...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Events.Item.Instances.Item.SingleValueExtendedProperties.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/events/{event%2Did}/instances/{event%2Did1}/singleValueExtendedProperties/$count";
