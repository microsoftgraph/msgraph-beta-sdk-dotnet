...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Events.Item.Attachments.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/events/{event%2Did}/attachments/$count";
