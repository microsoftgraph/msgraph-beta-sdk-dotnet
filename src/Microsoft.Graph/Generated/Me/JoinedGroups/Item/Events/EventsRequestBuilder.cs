using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Events.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Events.Delta;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Events.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Events {
    ...
    public class EventsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.events.item collection</summary>
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/events{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
