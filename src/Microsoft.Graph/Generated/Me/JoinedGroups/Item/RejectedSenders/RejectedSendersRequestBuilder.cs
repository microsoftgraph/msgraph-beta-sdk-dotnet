using Microsoft.Graph.Beta.Me.JoinedGroups.Item.RejectedSenders.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.RejectedSenders.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.RejectedSenders {
    ...
    public class RejectedSendersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.rejectedSenders.item collection</summary>
        ...
        public RejectedSendersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/rejectedSenders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
