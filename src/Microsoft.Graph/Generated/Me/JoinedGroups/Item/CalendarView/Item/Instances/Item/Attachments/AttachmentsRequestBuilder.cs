using Microsoft.Graph.Beta.Me.JoinedGroups.Item.CalendarView.Item.Instances.Item.Attachments.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.CalendarView.Item.Instances.Item.Attachments.CreateUploadSession;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.CalendarView.Item.Instances.Item.Attachments.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.CalendarView.Item.Instances.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.calendarView.item.instances.item.attachments.item collection</summary>
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
