...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.DismissReminder {
    ...
    public class DismissReminderRequestBuilder {
        ...
        public DismissReminderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/microsoft.graph.dismissReminder";
