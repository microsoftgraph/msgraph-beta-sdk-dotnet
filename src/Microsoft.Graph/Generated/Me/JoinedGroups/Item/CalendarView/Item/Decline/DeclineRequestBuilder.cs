...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.CalendarView.Item.Decline {
    ...
    public class DeclineRequestBuilder {
        ...
        public DeclineRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendarView/{event%2Did}/microsoft.graph.decline";
