using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Members.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Members.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.members.item collection</summary>
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
