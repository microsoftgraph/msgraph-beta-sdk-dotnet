using Microsoft.Graph.Beta.Me.JoinedGroups.Item.MembersWithLicenseErrors.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.MembersWithLicenseErrors.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.MembersWithLicenseErrors {
    ...
    public class MembersWithLicenseErrorsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.membersWithLicenseErrors.item collection</summary>
        ...
        public MembersWithLicenseErrorsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/membersWithLicenseErrors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
