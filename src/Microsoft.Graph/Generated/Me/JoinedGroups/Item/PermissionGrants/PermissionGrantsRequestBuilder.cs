using Microsoft.Graph.Beta.Me.JoinedGroups.Item.PermissionGrants.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.PermissionGrants.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.PermissionGrants {
    ...
    public class PermissionGrantsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.permissionGrants.item collection</summary>
        ...
        public PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
