using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner {
    ...
    public class PlannerRequestBuilder {
        ...
        public PlannerRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/planner{?%24select,%24expand}";
