using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans.Item.Tasks.Item.AssignedToTaskBoardFormat;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans.Item.Tasks.Item.BucketTaskBoardFormat;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans.Item.Tasks.Item.Details;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans.Item.Tasks.Item.ProgressTaskBoardFormat;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans.Item.Tasks.Item {
    ...
    public class PlannerTaskItemRequestBuilder {
        ...
        public PlannerTaskItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}{?%24select,%24expand}";
