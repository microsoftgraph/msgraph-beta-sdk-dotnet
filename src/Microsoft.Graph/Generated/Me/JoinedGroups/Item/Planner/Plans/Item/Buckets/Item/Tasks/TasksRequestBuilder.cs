using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans.Item.Buckets.Item.Tasks.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans.Item.Buckets.Item.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.planner.plans.item.buckets.item.tasks.item collection</summary>
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
