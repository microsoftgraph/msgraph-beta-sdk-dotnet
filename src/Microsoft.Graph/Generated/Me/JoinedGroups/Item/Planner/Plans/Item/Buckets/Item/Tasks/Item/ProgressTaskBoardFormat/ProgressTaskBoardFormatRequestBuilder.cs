...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.ProgressTaskBoardFormat {
    ...
    public class ProgressTaskBoardFormatRequestBuilder {
        ...
        public ProgressTaskBoardFormatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/progressTaskBoardFormat{?%24select,%24expand}";
