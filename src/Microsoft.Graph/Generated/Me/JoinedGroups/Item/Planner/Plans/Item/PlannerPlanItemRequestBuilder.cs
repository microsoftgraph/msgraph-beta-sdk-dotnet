using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans.Item.Buckets;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans.Item.Details;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans.Item.Tasks;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans.Item {
    ...
    public class PlannerPlanItemRequestBuilder {
        ...
        public PlannerPlanItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}{?%24select,%24expand}";
