...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Planner.Plans.Item.Buckets.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/$count";
