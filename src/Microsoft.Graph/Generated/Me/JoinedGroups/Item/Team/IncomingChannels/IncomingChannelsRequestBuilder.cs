using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.IncomingChannels.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.IncomingChannels.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.IncomingChannels {
    ...
    public class IncomingChannelsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.team.incomingChannels.item collection</summary>
        ...
        public IncomingChannelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/incomingChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
