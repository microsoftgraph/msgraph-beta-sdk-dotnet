...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.IncomingChannels.Item {
    ...
    public class ChannelItemRequestBuilder {
        ...
        public ChannelItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/incomingChannels/{channel%2Did}{?%24select,%24expand}";
        ...
        /// <summary>Get incomingChannels from me</summary>
