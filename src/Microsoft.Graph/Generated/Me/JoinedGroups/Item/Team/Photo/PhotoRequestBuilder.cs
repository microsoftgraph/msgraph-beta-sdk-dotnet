using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Photo.Value;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Photo {
    ...
    public class PhotoRequestBuilder {
        ...
        public PhotoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/photo{?%24select,%24expand}";
