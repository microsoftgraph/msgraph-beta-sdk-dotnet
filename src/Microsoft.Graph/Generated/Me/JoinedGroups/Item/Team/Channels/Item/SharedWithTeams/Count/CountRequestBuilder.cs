...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Channels.Item.SharedWithTeams.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/sharedWithTeams/$count";
