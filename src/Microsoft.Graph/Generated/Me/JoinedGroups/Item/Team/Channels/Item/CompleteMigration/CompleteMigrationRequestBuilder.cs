...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Channels.Item.CompleteMigration {
    ...
    public class CompleteMigrationRequestBuilder {
        ...
        public CompleteMigrationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/microsoft.graph.completeMigration";
        ...
        /// </summary>
        public async Task PostAsync(Action<CompleteMigrationRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
