using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Channels.Item.FilesFolder.Content;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Channels.Item.FilesFolder {
    ...
    public class FilesFolderRequestBuilder {
        ...
        public FilesFolderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/filesFolder{?%24select,%24expand}";
