using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Channels.AllMessages;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Channels.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Channels.GetAllMessages;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Channels.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Channels {
    ...
    public class ChannelsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.team.channels.item collection</summary>
        ...
        public ChannelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/channels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
