using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.TimeCards.Item.ClockOut;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.TimeCards.Item.Confirm;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.TimeCards.Item.EndBreak;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.TimeCards.Item.StartBreak;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.TimeCards.Item {
    ...
    public class TimeCardItemRequestBuilder {
        ...
        public TimeCardItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/schedule/timeCards/{timeCard%2Did}{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task DeleteAsync(Action<TimeCardItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TimeCard> GetAsync(Action<TimeCardItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(TimeCard body, Action<TimeCardItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
        ...
        /// <summary>Get timeCards from me</summary>
