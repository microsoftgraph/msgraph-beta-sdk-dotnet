...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.OpenShiftChangeRequests.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/schedule/openShiftChangeRequests/$count";
