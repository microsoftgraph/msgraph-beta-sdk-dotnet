using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.OfferShiftRequests.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.OfferShiftRequests.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.OfferShiftRequests {
    ...
    public class OfferShiftRequestsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.team.schedule.offerShiftRequests.item collection</summary>
        ...
        public OfferShiftRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/schedule/offerShiftRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
