using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.OfferShiftRequests;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.OpenShiftChangeRequests;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.OpenShifts;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.SchedulingGroups;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.Share;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.Shifts;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.SwapShiftsChangeRequests;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.TimeCards;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.TimeOffReasons;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.TimeOffRequests;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule.TimesOff;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Schedule {
    ...
    public class ScheduleRequestBuilder {
        ...
        public ScheduleRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/schedule{?%24select,%24expand}";
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(Microsoft.Graph.Beta.Models.Schedule body, Action<ScheduleRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.Schedule body, Action<ScheduleRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
