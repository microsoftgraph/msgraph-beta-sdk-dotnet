...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PermissionGrants.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/permissionGrants/$count";
