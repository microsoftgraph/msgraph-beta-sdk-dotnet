using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Tags.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Tags.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Tags {
    ...
    public class TagsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.team.tags.item collection</summary>
        ...
        public TagsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/tags{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
