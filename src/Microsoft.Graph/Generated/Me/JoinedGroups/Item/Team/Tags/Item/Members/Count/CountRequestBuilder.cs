...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Tags.Item.Members.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/tags/{teamworkTag%2Did}/members/$count";
