using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.InstalledApps.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.InstalledApps.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.InstalledApps {
    ...
    public class InstalledAppsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.team.installedApps.item collection</summary>
        ...
        public InstalledAppsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/installedApps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
