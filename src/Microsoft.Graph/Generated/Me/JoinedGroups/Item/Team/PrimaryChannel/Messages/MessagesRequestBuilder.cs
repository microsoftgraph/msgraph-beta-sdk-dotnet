using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.Messages.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.Messages.Delta;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.Messages.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.team.primaryChannel.messages.item collection</summary>
        ...
        public MessagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/primaryChannel/messages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
