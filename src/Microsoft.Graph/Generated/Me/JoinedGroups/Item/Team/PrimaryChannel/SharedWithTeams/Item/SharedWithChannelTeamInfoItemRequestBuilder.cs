using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.SharedWithTeams.Item.AllowedMembers;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.SharedWithTeams.Item {
    ...
    public class SharedWithChannelTeamInfoItemRequestBuilder {
        ...
        public SharedWithChannelTeamInfoItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}{?%24select,%24expand}";
