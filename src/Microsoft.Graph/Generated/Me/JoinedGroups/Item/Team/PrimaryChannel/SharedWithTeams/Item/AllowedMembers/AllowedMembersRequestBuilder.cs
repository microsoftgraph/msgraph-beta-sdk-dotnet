using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.SharedWithTeams.Item.AllowedMembers.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.SharedWithTeams.Item.AllowedMembers.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.SharedWithTeams.Item.AllowedMembers {
    ...
    public class AllowedMembersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.team.primaryChannel.sharedWithTeams.item.allowedMembers.item collection</summary>
        ...
        public AllowedMembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/allowedMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
