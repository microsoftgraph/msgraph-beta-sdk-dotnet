using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.SharedWithTeams.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.SharedWithTeams.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.SharedWithTeams {
    ...
    public class SharedWithTeamsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.team.primaryChannel.sharedWithTeams.item collection</summary>
        ...
        public SharedWithTeamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/primaryChannel/sharedWithTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
