using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.CompleteMigration;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalName;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.FilesFolder;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.Members;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.Messages;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.ProvisionEmail;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.RemoveEmail;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.SharedWithTeams;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel.Tabs;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.PrimaryChannel {
    ...
    public class PrimaryChannelRequestBuilder {
        ...
        public PrimaryChannelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/primaryChannel{?%24select,%24expand}";
