...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Team.Group {
    ...
    public class GroupRequestBuilder {
        ...
        public GroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/group{?%24select,%24expand}";
        ...
        /// <summary>Get group from me</summary>
