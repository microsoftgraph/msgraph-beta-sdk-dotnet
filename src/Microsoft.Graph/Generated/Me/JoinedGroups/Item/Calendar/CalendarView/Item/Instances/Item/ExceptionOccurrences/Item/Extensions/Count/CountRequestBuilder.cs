...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Extensions.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/extensions/$count";
