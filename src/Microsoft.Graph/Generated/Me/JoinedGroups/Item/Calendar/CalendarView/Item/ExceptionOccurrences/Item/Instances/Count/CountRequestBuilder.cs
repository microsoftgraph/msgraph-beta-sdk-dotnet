...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Instances.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/$count";
