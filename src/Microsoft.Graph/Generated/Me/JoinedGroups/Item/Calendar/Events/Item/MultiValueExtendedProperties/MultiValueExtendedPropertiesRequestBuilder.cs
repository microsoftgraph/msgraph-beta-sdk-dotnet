using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.MultiValueExtendedProperties.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.MultiValueExtendedProperties.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.calendar.events.item.multiValueExtendedProperties.item collection</summary>
        ...
        public MultiValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
