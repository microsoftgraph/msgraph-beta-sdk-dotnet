using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.SingleValueExtendedProperties.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.SingleValueExtendedProperties.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.calendar.events.item.instances.item.exceptionOccurrences.item.singleValueExtendedProperties.item collection</summary>
        ...
        public SingleValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
