using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.Accept;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.Attachments;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.Calendar;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.Cancel;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.Decline;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.DismissReminder;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.Extensions;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.Forward;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.MultiValueExtendedProperties;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.SingleValueExtendedProperties;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.SnoozeReminder;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.TentativelyAccept;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.Calendar.CalendarRequestBuilder Calendar { get =>
            new Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.Calendar.CalendarRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}{?%24select,%24expand}";
