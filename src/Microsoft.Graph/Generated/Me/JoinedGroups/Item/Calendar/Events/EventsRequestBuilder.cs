using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Delta;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events {
    ...
    public class EventsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.calendar.events.item collection</summary>
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/events{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
