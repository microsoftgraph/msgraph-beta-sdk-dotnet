using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.Extensions.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.Extensions.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.calendar.events.item.exceptionOccurrences.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
