using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.CalendarPermissions.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.CalendarPermissions.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.CalendarPermissions {
    ...
    public class CalendarPermissionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.calendar.calendarPermissions.item collection</summary>
        ...
        public CalendarPermissionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/calendarPermissions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
