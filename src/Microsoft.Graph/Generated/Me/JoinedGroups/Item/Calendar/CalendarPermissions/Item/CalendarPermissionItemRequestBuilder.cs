...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.Calendar.CalendarPermissions.Item {
    ...
    public class CalendarPermissionItemRequestBuilder {
        ...
        public CalendarPermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/calendarPermissions/{calendarPermission%2Did}{?%24select}";
