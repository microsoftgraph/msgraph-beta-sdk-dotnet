using Microsoft.Graph.Beta.Me.JoinedGroups.Item.AcceptedSenders.Count;
using Microsoft.Graph.Beta.Me.JoinedGroups.Item.AcceptedSenders.Item;
...
namespace Microsoft.Graph.Beta.Me.JoinedGroups.Item.AcceptedSenders {
    ...
    public class AcceptedSendersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.joinedGroups.item.acceptedSenders.item collection</summary>
        ...
        public AcceptedSendersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/acceptedSenders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
