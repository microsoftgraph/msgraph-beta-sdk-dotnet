...
namespace MicrosoftGraphSdk.Me.JoinedGroups.Item {
    /// <summary>Builds and executes requests for operations under \me\joinedGroups\{group-id}</summary>
    public class GroupItemRequestBuilder {
        ...
        public GroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedGroups/{group_id}{?select}";
