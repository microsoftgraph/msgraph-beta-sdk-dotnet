...
namespace Microsoft.Graph.Beta.Me.JoinedGroups {
    ...
    public class JoinedGroupsRequestBuilder : BaseRequestBuilder {
        ...
        public JoinedGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedGroups{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="JoinedGroupsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public JoinedGroupsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedGroups{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<GroupCollectionResponse?> GetAsync(Action<RequestConfiguration<JoinedGroupsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<GroupCollectionResponse> GetAsync(Action<RequestConfiguration<JoinedGroupsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="JoinedGroupsRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public JoinedGroupsRequestBuilder WithUrl(string rawUrl) {
            return new JoinedGroupsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get joinedGroups from me
        /// </summary>
...
#nullable restore
        ...
        public class JoinedGroupsRequestBuilderGetRequestConfiguration : RequestConfiguration<JoinedGroupsRequestBuilderGetQueryParameters> {
        }
    }
}
