...
namespace Microsoft.Graph.Beta.Me.JoinedGroups {
    ...
    public class JoinedGroupsRequestBuilder {
        ...
        /// </summary>
        public async Task<GroupCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<JoinedGroupsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Group> PostAsync(Microsoft.Graph.Beta.Models.Group body, CancellationToken cancellationToken = default, Action<JoinedGroupsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
