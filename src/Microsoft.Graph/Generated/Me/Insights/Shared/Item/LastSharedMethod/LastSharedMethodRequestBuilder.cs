...
using System;
namespace Microsoft.Graph.Beta.Me.Insights.Shared.Item.LastSharedMethod {
    /// <summary>
    /// Provides operations to manage the lastSharedMethod property of the microsoft.graph.sharedInsight entity.
    /// </summary>
    public class LastSharedMethodRequestBuilder : BaseRequestBuilder {
        /// <summary>
...
#nullable enable
        public async Task<Entity?> GetAsync(CancellationToken cancellationToken = default, Action<LastSharedMethodRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Entity> GetAsync(CancellationToken cancellationToken = default, Action<LastSharedMethodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<LastSharedMethodRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<LastSharedMethodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new LastSharedMethodRequestBuilderGetRequestConfiguration();
        ...
        /// Get lastSharedMethod from me
        /// </summary>
        public class LastSharedMethodRequestBuilderGetQueryParameters {
...
#nullable restore
        ...
        /// </summary>
        public class LastSharedMethodRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public LastSharedMethodRequestBuilderGetQueryParameters QueryParameters { get; set; } = new LastSharedMethodRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new lastSharedMethodRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public LastSharedMethodRequestBuilderGetRequestConfiguration() {
