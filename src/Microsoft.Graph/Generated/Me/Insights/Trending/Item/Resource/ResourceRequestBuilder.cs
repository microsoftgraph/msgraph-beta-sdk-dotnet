...
using System;
namespace Microsoft.Graph.Beta.Me.Insights.Trending.Item.Resource {
    /// <summary>
...
#nullable enable
        public async Task<Entity?> GetAsync(CancellationToken cancellationToken = default, Action<ResourceRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Entity> GetAsync(CancellationToken cancellationToken = default, Action<ResourceRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
