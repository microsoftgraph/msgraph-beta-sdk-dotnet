...
#nullable enable
        public async Task<Entity?> GetAsync(Action<RequestConfiguration<ResourceRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Entity> GetAsync(Action<RequestConfiguration<ResourceRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
