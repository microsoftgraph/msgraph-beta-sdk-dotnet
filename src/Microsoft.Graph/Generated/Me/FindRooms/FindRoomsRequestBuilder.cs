...
#nullable enable
        public async Task<FindRoomsResponse?> GetAsync(CancellationToken cancellationToken = default, Action<FindRoomsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<FindRoomsResponse> GetAsync(CancellationToken cancellationToken = default, Action<FindRoomsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
