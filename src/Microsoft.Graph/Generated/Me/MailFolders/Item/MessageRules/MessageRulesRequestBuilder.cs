...
namespace Microsoft.Graph.Beta.Me.MailFolders.Item.MessageRules {
    ...
    public class MessageRulesRequestBuilder : BaseRequestBuilder {
        ...
        public MessageRulesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messageRules{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="MessageRulesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MessageRulesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messageRules{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl) {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <cref="MessageRuleCollectionResponse"></returns>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="MessageRulesRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
