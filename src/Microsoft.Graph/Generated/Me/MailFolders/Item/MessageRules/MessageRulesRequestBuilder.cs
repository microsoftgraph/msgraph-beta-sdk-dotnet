...
namespace Microsoft.Graph.Beta.Me.MailFolders.Item.MessageRules {
    ...
    public class MessageRulesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.mailFolders.item.messageRules.item collection</summary>
        ...
        public MessageRulesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder_id}/messageRules{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
