...
namespace Microsoft.Graph.Beta.Me.MailFolders.Item.Messages.Item.MicrosoftGraphMove {
    /// <summary>
    ...
    public class MicrosoftGraphMoveRequestBuilder {
        ...
        public MicrosoftGraphMoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphMoveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Message?> PostAsync(MovePostRequestBody body, Action<MicrosoftGraphMoveRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Message> PostAsync(MovePostRequestBody body, Action<MicrosoftGraphMoveRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
