...
namespace MicrosoftGraphSdk.Me.MailFolders.Item.Messages.Item.Unsubscribe {
    /// <summary>Builds and executes requests for operations under \me\mailFolders\{mailFolder-id}\messages\{message-id}\microsoft.graph.unsubscribe</summary>
    public class UnsubscribeRequestBuilder {
        ...
        public UnsubscribeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder_id}/messages/{message_id}/microsoft.graph.unsubscribe";
