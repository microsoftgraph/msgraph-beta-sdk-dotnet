...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Message?> PostAsync(MovePostRequestBody body, CancellationToken cancellationToken = default, Action<MoveRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Message> PostAsync(MovePostRequestBody body, CancellationToken cancellationToken = default, Action<MoveRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
