...
using MicrosoftGraphSdk.Me.MailFolders.Item.ChildFolders.Count;
...
namespace MicrosoftGraphSdk.Me.MailFolders.Item.ChildFolders {
    ...
    public class ChildFoldersRequestBuilder {
        ...
        public MicrosoftGraphSdk.Me.MailFolders.Item.ChildFolders.Item.MailFolderItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("mailFolder_id1", position);
            return new MicrosoftGraphSdk.Me.MailFolders.Item.ChildFolders.Item.MailFolderItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
