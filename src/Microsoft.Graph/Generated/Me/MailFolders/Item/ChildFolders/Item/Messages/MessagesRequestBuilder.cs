...
using Microsoft.Graph.Beta.Me.MailFolders.Item.ChildFolders.Item.Messages.MicrosoftGraphDelta;
...
namespace Microsoft.Graph.Beta.Me.MailFolders.Item.ChildFolders.Item.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        public MessagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
