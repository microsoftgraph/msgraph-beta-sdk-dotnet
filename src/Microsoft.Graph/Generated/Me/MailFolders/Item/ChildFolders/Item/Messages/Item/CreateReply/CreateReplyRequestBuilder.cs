...
namespace Microsoft.Graph.Beta.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateReply {
    ...
    public class CreateReplyRequestBuilder : BaseRequestBuilder {
        ...
        public CreateReplyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/createReply", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreateReplyRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateReplyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/createReply", rawUrl) {
        }
        /// <summary>
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/message-createreply?view=graph-rest-1.0" />
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Message?> PostAsync(CreateReplyPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateReplyRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Message> PostAsync(CreateReplyPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateReplyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
