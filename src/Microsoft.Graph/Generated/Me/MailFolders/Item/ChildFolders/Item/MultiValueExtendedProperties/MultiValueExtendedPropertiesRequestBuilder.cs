...
using MicrosoftGraphSdk.Me.MailFolders.Item.ChildFolders.Item.MultiValueExtendedProperties.Count;
using MicrosoftGraphSdk.Me.MailFolders.Item.ChildFolders.Item.MultiValueExtendedProperties.Item;
...
namespace MicrosoftGraphSdk.Me.MailFolders.Item.ChildFolders.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.mailFolders.item.childFolders.item.multiValueExtendedProperties.item collection</summary>
