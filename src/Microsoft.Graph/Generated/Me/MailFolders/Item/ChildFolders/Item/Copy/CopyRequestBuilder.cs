...
namespace Microsoft.Graph.Beta.Me.MailFolders.Item.ChildFolders.Item.Copy {
    ...
    public class CopyRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CopyRequestBody body, Action<CopyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<MailFolder> PostAsync(CopyRequestBody body, Action<CopyRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
