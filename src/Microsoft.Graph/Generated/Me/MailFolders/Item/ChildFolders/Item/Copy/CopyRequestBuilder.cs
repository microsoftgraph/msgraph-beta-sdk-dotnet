...
#nullable enable
        public async Task<MailFolder?> PostAsync(CopyPostRequestBody body, CancellationToken cancellationToken = default, Action<CopyRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MailFolder> PostAsync(CopyPostRequestBody body, CancellationToken cancellationToken = default, Action<CopyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
