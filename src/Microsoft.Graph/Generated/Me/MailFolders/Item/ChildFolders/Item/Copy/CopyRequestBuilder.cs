...
namespace MicrosoftGraphSdk.Me.MailFolders.Item.ChildFolders.Item.Copy {
    ...
    public class CopyRequestBuilder {
        ...
        /// </summary>
        public async Task<MailFolder> PostAsync(CopyRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
