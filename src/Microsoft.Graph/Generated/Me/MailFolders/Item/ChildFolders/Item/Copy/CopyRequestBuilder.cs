...
namespace MicrosoftGraphSdk.Me.MailFolders.Item.ChildFolders.Item.Copy {
    /// <summary>Builds and executes requests for operations under \me\mailFolders\{mailFolder-id}\childFolders\{mailFolder-id1}\microsoft.graph.copy</summary>
    public class CopyRequestBuilder {
        ...
        public CopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder_id}/childFolders/{mailFolder_id1}/microsoft.graph.copy";
        ...
        public class CopyResponse : IParsable {
            ...
            public MicrosoftGraphSdk.Models.Microsoft.Graph.MailFolder MailFolder { get; set; }
            /// <summary>
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"mailFolder", (o,n) => { (o as CopyResponse).MailFolder = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.MailFolder>(MicrosoftGraphSdk.Models.Microsoft.Graph.MailFolder.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
            ...
            public void Serialize(ISerializationWriter writer) {
                ...
                writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.MailFolder>("mailFolder", MailFolder);
