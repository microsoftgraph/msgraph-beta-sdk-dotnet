...
using MicrosoftGraphSdk.Me.MailFolders.Count;
...
namespace MicrosoftGraphSdk.Me.MailFolders {
    ...
    public class MailFoldersRequestBuilder {
        ...
        /// </summary>
        public async Task<MailFolderCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
