...
using Microsoft.Graph.Beta.Me.ContactFolders.MicrosoftGraphDelta;
...
namespace Microsoft.Graph.Beta.Me.ContactFolders {
    ...
    public class ContactFoldersRequestBuilder {
        ...
        public ContactFoldersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/contactFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
