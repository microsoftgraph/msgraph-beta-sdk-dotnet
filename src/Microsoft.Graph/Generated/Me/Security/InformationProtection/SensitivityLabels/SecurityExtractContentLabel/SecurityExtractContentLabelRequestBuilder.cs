...
using System;
namespace Microsoft.Graph.Beta.Me.Security.InformationProtection.SensitivityLabels.SecurityExtractContentLabel {
    /// <summary>
    ...
    public class SecurityExtractContentLabelRequestBuilder : BaseRequestBuilder {
        ...
        public SecurityExtractContentLabelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/security/informationProtection/sensitivityLabels/security.extractContentLabel", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SecurityExtractContentLabelRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecurityExtractContentLabelRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/security/informationProtection/sensitivityLabels/security.extractContentLabel", rawUrl) {
        }
        /// <summary>
