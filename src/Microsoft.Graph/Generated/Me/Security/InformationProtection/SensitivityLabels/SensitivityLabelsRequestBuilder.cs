...
using MicrosoftGraphSdk.Me.Security.InformationProtection.SensitivityLabels.EvaluateApplication;
using MicrosoftGraphSdk.Me.Security.InformationProtection.SensitivityLabels.EvaluateClassificationResults;
using MicrosoftGraphSdk.Me.Security.InformationProtection.SensitivityLabels.EvaluateRemoval;
using MicrosoftGraphSdk.Me.Security.InformationProtection.SensitivityLabels.ExtractContentLabel;
using MicrosoftGraphSdk.Me.Security.InformationProtection.SensitivityLabels.Item;
...
namespace MicrosoftGraphSdk.Me.Security.InformationProtection.SensitivityLabels {
    /// <summary>Builds and executes requests for operations under \me\security\informationProtection\sensitivityLabels</summary>
    public class SensitivityLabelsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.security.informationProtection.sensitivityLabels.item collection</summary>
        ...
        public SensitivityLabelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/security/informationProtection/sensitivityLabels{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>Get sensitivityLabels from me</summary>
