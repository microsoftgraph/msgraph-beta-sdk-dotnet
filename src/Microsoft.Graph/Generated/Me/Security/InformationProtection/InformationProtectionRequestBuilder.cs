...
using MicrosoftGraphSdk.Me.Security.InformationProtection.LabelPolicySettings;
using MicrosoftGraphSdk.Me.Security.InformationProtection.SensitivityLabels;
...
namespace MicrosoftGraphSdk.Me.Security.InformationProtection {
    /// <summary>Builds and executes requests for operations under \me\security\informationProtection</summary>
    public class InformationProtectionRequestBuilder {
        ...
        public InformationProtectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/security/informationProtection{?select,expand}";
