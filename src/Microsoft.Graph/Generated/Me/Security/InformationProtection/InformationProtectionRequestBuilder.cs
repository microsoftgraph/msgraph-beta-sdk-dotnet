...
namespace Microsoft.Graph.Beta.Me.Security.InformationProtection
{
    ...
    public class InformationProtectionRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.Me.Security.InformationProtection.LabelPolicySettings.LabelPolicySettingsRequestBuilder LabelPolicySettings
        {
            get => new Microsoft.Graph.Beta.Me.Security.InformationProtection.LabelPolicySettings.LabelPolicySettingsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Microsoft.Graph.Beta.Me.Security.InformationProtection.SensitivityLabels.SensitivityLabelsRequestBuilder SensitivityLabels
        {
            get => new Microsoft.Graph.Beta.Me.Security.InformationProtection.SensitivityLabels.SensitivityLabelsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Me.Security.InformationProtection.InformationProtectionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.InformationProtection?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Me.Security.InformationProtection.InformationProtectionRequestBuilder.InformationProtectionRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.InformationProtection> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Me.Security.InformationProtection.InformationProtectionRequestBuilder.InformationProtectionRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Me.Security.InformationProtection.InformationProtectionRequestBuilder.InformationProtectionRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Me.Security.InformationProtection.InformationProtectionRequestBuilder.InformationProtectionRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Me.Security.InformationProtection.InformationProtectionRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Me.Security.InformationProtection.InformationProtectionRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Me.Security.InformationProtection.InformationProtectionRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class InformationProtectionRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.Me.Security.InformationProtection.InformationProtectionRequestBuilder.InformationProtectionRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
