...
using System;
namespace Microsoft.Graph.Beta.Me.DirectReports.Item.GraphOrgContact {
    /// <summary>
    ...
    public class GraphOrgContactRequestBuilder : BaseRequestBuilder {
        ...
        public GraphOrgContactRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/directReports/{directoryObject%2Did}/graph.orgContact{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphOrgContactRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphOrgContactRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/directReports/{directoryObject%2Did}/graph.orgContact{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
