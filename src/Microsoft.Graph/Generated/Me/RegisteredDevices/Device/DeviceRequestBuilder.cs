using Microsoft.Graph.Beta.Me.RegisteredDevices.Device.Count;
...
namespace Microsoft.Graph.Beta.Me.RegisteredDevices.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        public DeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/registeredDevices/microsoft.graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
