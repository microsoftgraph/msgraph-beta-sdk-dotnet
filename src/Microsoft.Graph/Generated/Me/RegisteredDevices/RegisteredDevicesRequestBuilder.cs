...
using Microsoft.Graph.Beta.Me.RegisteredDevices.GraphDevice;
using Microsoft.Graph.Beta.Me.RegisteredDevices.GraphEndpoint;
...
using System;
namespace Microsoft.Graph.Beta.Me.RegisteredDevices {
    /// <summary>
    ...
    public class RegisteredDevicesRequestBuilder : BaseRequestBuilder {
        ...
        public RegisteredDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/registeredDevices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RegisteredDevicesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RegisteredDevicesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/registeredDevices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DirectoryObjectCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<RegisteredDevicesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectoryObjectCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RegisteredDevicesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
