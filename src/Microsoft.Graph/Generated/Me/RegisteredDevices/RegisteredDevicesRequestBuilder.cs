...
using MicrosoftGraphSdk.Me.RegisteredDevices.Ref;
using System;
...
namespace MicrosoftGraphSdk.Me.RegisteredDevices {
    ...
    public class RegisteredDevicesRequestBuilder {
        ...
        public RegisteredDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/registeredDevices{?top,skip,search,filter,count,orderby,select,expand}";
        ...
        public async Task<RegisteredDevicesResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<RegisteredDevicesResponse>(requestInfo, RegisteredDevicesResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
