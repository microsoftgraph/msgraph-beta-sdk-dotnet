...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Me.Activities.Item.HistoryItems {
    public class HistoryItemsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as HistoryItemsResponse).Value = n.GetCollectionOfObjectValues<ActivityHistoryItem>().ToList(); } },
            };
        }
        /// <summary>
