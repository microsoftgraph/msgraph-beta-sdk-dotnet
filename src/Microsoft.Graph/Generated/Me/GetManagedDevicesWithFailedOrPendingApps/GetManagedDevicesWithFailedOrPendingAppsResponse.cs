...
namespace MicrosoftGraphSdk.Me.GetManagedDevicesWithFailedOrPendingApps {
    ...
    public class GetManagedDevicesWithFailedOrPendingAppsResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetManagedDevicesWithFailedOrPendingAppsResponse).Value = n.GetCollectionOfObjectValues<ManagedDeviceSummarizedAppState>(ManagedDeviceSummarizedAppState.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
