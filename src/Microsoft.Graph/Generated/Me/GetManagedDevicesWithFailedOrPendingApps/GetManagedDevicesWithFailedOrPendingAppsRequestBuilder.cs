...
namespace Microsoft.Graph.Beta.Me.GetManagedDevicesWithFailedOrPendingApps {
    ...
    public class GetManagedDevicesWithFailedOrPendingAppsRequestBuilder : BaseRequestBuilder {
        ...
        public GetManagedDevicesWithFailedOrPendingAppsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/getManagedDevicesWithFailedOrPendingApps(){?%24top,%24skip,%24search,%24filter,%24count}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetManagedDevicesWithFailedOrPendingAppsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetManagedDevicesWithFailedOrPendingAppsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/getManagedDevicesWithFailedOrPendingApps(){?%24top,%24skip,%24search,%24filter,%24count}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<GetManagedDevicesWithFailedOrPendingAppsResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetManagedDevicesWithFailedOrPendingAppsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetManagedDevicesWithFailedOrPendingAppsResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetManagedDevicesWithFailedOrPendingAppsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<GetManagedDevicesWithFailedOrPendingAppsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<GetManagedDevicesWithFailedOrPendingAppsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
