...
namespace Microsoft.Graph.Beta.Me.GetManagedDevicesWithFailedOrPendingApps {
    ...
    public class GetManagedDevicesWithFailedOrPendingAppsRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetManagedDevicesWithFailedOrPendingAppsGetResponse"></returns>
...
#nullable restore
        ...
        /// Retrieves the list of devices with failed or pending apps
        /// </summary>
        /// <returns>A <cref="GetManagedDevicesWithFailedOrPendingAppsResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetManagedDevicesWithFailedOrPendingAppsRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
