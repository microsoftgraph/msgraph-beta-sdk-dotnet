...
namespace Microsoft.Graph.Beta.Me.Chats.Item.MarkChatReadForUser {
    ...
    public class MarkChatReadForUserRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(MarkChatReadForUserPostRequestBody body, Action<MarkChatReadForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
