...
using System;
namespace Microsoft.Graph.Beta.Me.Chats.Item.MarkChatReadForUser {
    /// <summary>
    /// Provides operations to call the markChatReadForUser method.
    /// </summary>
    public class MarkChatReadForUserRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new MarkChatReadForUserRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MarkChatReadForUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/markChatReadForUser", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MarkChatReadForUserRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MarkChatReadForUserRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/markChatReadForUser", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(MarkChatReadForUserPostRequestBody body, Action<MarkChatReadForUserRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(MarkChatReadForUserPostRequestBody body, Action<MarkChatReadForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
