...
namespace Microsoft.Graph.Beta.Me.Chats.Item.MarkChatReadForUser {
    ...
    public class MarkChatReadForUserRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public MarkChatReadForUserRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MarkChatReadForUserPostRequestBody body, Action<MarkChatReadForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(MarkChatReadForUserPostRequestBody body, CancellationToken cancellationToken = default, Action<MarkChatReadForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
