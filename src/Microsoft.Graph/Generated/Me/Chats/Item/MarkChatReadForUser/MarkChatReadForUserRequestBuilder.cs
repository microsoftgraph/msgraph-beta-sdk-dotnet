...
#nullable enable
        public async Task PostAsync(MarkChatReadForUserPostRequestBody body, CancellationToken cancellationToken = default, Action<MarkChatReadForUserRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(MarkChatReadForUserPostRequestBody body, CancellationToken cancellationToken = default, Action<MarkChatReadForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
