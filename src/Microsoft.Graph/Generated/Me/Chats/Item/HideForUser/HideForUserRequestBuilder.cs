...
#nullable enable
        public async Task PostAsync(HideForUserPostRequestBody body, CancellationToken cancellationToken = default, Action<HideForUserRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(HideForUserPostRequestBody body, CancellationToken cancellationToken = default, Action<HideForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
