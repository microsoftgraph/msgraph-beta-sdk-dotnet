...
namespace Microsoft.Graph.Beta.Me.Chats.Item.SendActivityNotification {
    ...
    public class SendActivityNotificationRequestBuilder : BaseRequestBuilder {
        ...
        public SendActivityNotificationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/sendActivityNotification", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SendActivityNotificationRequestBuilder and sets the default values.
        /// </summary>
