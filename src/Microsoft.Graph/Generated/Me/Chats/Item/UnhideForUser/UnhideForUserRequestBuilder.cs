...
namespace Microsoft.Graph.Beta.Me.Chats.Item.UnhideForUser {
    ...
    public class UnhideForUserRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(UnhideForUserPostRequestBody body, CancellationToken cancellationToken = default, Action<UnhideForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
