...
namespace Microsoft.Graph.Beta.Me.Chats.Item.UnhideForUser {
    ...
    public class UnhideForUserRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(UnhideForUserPostRequestBody body, Action<UnhideForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
