...
namespace MicrosoftGraphSdk.Me.CalendarView.Item.Calendar.AllowedCalendarSharingRolesWithUser {
    /// <summary>Builds and executes requests for operations under \me\calendarView\{event-id}\calendar\microsoft.graph.allowedCalendarSharingRoles(User='{User}')</summary>
    public class AllowedCalendarSharingRolesWithUserRequestBuilder {
        ...
        public AllowedCalendarSharingRolesWithUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string user = default) {
            ...
            UrlTemplate = "{+baseurl}/me/calendarView/{event_id}/calendar/microsoft.graph.allowedCalendarSharingRoles(User='{User}')";
