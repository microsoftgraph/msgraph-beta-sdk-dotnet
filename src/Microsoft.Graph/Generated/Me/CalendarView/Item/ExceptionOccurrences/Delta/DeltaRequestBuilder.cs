...
namespace MicrosoftGraph.Me.CalendarView.Item.ExceptionOccurrences.Delta {
    /// <summary>Builds and executes requests for operations under \me\calendarView\{event-id}\exceptionOccurrences\microsoft.graph.delta()</summary>
    public class DeltaRequestBuilder {
        ...
        public DeltaRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendarView/{event_id}/exceptionOccurrences/microsoft.graph.delta()";
