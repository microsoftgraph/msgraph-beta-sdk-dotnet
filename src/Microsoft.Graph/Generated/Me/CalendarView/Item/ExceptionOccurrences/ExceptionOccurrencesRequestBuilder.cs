...
using MicrosoftGraph.Me.CalendarView.Item.ExceptionOccurrences.Delta;
using MicrosoftGraph.Me.CalendarView.Item.ExceptionOccurrences.Item;
...
namespace MicrosoftGraph.Me.CalendarView.Item.ExceptionOccurrences {
    ...
    public class ExceptionOccurrencesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.calendarView.item.exceptionOccurrences.item collection</summary>
