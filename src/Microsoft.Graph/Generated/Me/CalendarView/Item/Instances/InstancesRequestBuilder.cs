...
using MicrosoftGraph.Me.CalendarView.Item.Instances.Delta;
using MicrosoftGraph.Me.CalendarView.Item.Instances.Item;
...
namespace MicrosoftGraph.Me.CalendarView.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.calendarView.item.instances.item collection</summary>
