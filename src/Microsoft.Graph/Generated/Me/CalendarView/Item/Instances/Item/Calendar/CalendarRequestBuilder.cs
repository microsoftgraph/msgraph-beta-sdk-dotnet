...
namespace Microsoft.Graph.Beta.Me.CalendarView.Item.Instances.Item.Calendar {
    /// <summary>
    ...
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendarView/{event%2Did}/instances/{event%2Did1}/calendar{?%24select}";
