...
using MicrosoftGraphSdk.Me.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Accept;
using MicrosoftGraphSdk.Me.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Attachments;
using MicrosoftGraphSdk.Me.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Calendar;
using MicrosoftGraphSdk.Me.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Cancel;
using MicrosoftGraphSdk.Me.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Decline;
using MicrosoftGraphSdk.Me.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.DismissReminder;
using MicrosoftGraphSdk.Me.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Extensions;
using MicrosoftGraphSdk.Me.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Forward;
using MicrosoftGraphSdk.Me.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.MultiValueExtendedProperties;
using MicrosoftGraphSdk.Me.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.SingleValueExtendedProperties;
using MicrosoftGraphSdk.Me.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.SnoozeReminder;
using MicrosoftGraphSdk.Me.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.TentativelyAccept;
...
namespace MicrosoftGraphSdk.Me.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendarView/{event_id}/instances/{event_id1}/exceptionOccurrences/{event_id2}{?select,expand}";
