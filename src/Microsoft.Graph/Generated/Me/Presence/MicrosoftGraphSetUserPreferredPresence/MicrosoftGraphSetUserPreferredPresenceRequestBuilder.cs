...
namespace Microsoft.Graph.Beta.Me.Presence.MicrosoftGraphSetUserPreferredPresence {
    /// <summary>
    ...
    public class MicrosoftGraphSetUserPreferredPresenceRequestBuilder {
        ...
        public MicrosoftGraphSetUserPreferredPresenceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/me/presence/microsoft.graph.setUserPreferredPresence";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphSetUserPreferredPresenceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(SetUserPreferredPresencePostRequestBody body, Action<MicrosoftGraphSetUserPreferredPresenceRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(SetUserPreferredPresencePostRequestBody body, Action<MicrosoftGraphSetUserPreferredPresenceRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
