...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Presence?> GetAsync(CancellationToken cancellationToken = default, Action<PresenceRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Presence> GetAsync(CancellationToken cancellationToken = default, Action<PresenceRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Presence?> PatchAsync(Microsoft.Graph.Beta.Models.Presence body, CancellationToken cancellationToken = default, Action<PresenceRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Presence> PatchAsync(Microsoft.Graph.Beta.Models.Presence body, CancellationToken cancellationToken = default, Action<PresenceRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
