...
namespace Microsoft.Graph.Beta.Me.Planner.Plans.Item.Buckets.Item.Tasks.Item.AssignedToTaskBoardFormat {
    ...
    public class AssignedToTaskBoardFormatRequestBuilder {
        ...
        public AssignedToTaskBoardFormatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/assignedToTaskBoardFormat{?%24select,%24expand}";
