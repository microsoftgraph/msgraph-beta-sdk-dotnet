...
namespace Microsoft.Graph.Beta.Me.Planner.Plans.Item.Tasks.Item.AssignedToTaskBoardFormat {
    /// <summary>
    ...
    public class AssignedToTaskBoardFormatRequestBuilder {
        ...
        public AssignedToTaskBoardFormatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/assignedToTaskBoardFormat{?%24select,%24expand}";
