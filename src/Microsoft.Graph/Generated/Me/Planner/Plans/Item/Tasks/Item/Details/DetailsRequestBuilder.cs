...
namespace Microsoft.Graph.Beta.Me.Planner.Plans.Item.Tasks.Item.Details {
    ...
    public class DetailsRequestBuilder {
        ...
        public DetailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/details{?%24select,%24expand}";
