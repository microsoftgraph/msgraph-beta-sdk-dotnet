...
using MicrosoftGraph.Me.Planner.Plans.Item.Tasks.Item.AssignedToTaskBoardFormat;
using MicrosoftGraph.Me.Planner.Plans.Item.Tasks.Item.BucketTaskBoardFormat;
using MicrosoftGraph.Me.Planner.Plans.Item.Tasks.Item.Details;
using MicrosoftGraph.Me.Planner.Plans.Item.Tasks.Item.ProgressTaskBoardFormat;
...
namespace MicrosoftGraph.Me.Planner.Plans.Item.Tasks.Item {
    /// <summary>Builds and executes requests for operations under \me\planner\plans\{plannerPlan-id}\tasks\{plannerTask-id}</summary>
    public class PlannerTaskRequestBuilder {
        ...
        public PlannerTaskRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/planner/plans/{plannerPlan_id}/tasks/{plannerTask_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public PlannerTaskRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
