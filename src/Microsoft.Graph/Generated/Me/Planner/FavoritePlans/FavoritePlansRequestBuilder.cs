using Microsoft.Graph.Beta.Me.Planner.FavoritePlans.Count;
using Microsoft.Graph.Beta.Me.Planner.FavoritePlans.Item;
...
namespace Microsoft.Graph.Beta.Me.Planner.FavoritePlans {
    ...
    public class FavoritePlansRequestBuilder : BaseRequestBuilder {
        ...
        public FavoritePlansRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/planner/favoritePlans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new FavoritePlansRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FavoritePlansRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/planner/favoritePlans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
