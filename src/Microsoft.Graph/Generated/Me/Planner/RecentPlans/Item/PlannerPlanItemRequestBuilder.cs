...
using System;
namespace Microsoft.Graph.Beta.Me.Planner.RecentPlans.Item {
    /// <summary>
    ...
    public class PlannerPlanItemRequestBuilder : BaseRequestBuilder {
        ...
        public PlannerPlanItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/planner/recentPlans/{plannerPlan%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PlannerPlanItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PlannerPlanItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/planner/recentPlans/{plannerPlan%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
