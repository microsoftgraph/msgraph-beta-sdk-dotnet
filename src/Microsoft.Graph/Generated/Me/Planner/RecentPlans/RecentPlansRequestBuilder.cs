using Microsoft.Graph.Beta.Me.Planner.RecentPlans.Count;
using Microsoft.Graph.Beta.Me.Planner.RecentPlans.Item;
...
namespace Microsoft.Graph.Beta.Me.Planner.RecentPlans {
    ...
    public class RecentPlansRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.planner.recentPlans.item collection</summary>
        ...
        public RecentPlansRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/planner/recentPlans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<RecentPlansRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<PlannerPlanCollectionResponse> GetAsync(Action<RecentPlansRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <summary>Retrieve a list of plannerPlans recently viewed by a user. You can update recently viewed plans by updating the plannerUser resource.</summary>
