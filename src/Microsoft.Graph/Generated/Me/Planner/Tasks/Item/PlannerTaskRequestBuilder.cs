...
using MicrosoftGraph.Me.Planner.Tasks.Item.AssignedToTaskBoardFormat;
using MicrosoftGraph.Me.Planner.Tasks.Item.BucketTaskBoardFormat;
using MicrosoftGraph.Me.Planner.Tasks.Item.Details;
using MicrosoftGraph.Me.Planner.Tasks.Item.ProgressTaskBoardFormat;
...
namespace MicrosoftGraph.Me.Planner.Tasks.Item {
    /// <summary>Builds and executes requests for operations under \me\planner\tasks\{plannerTask-id}</summary>
    public class PlannerTaskRequestBuilder {
        ...
        public PlannerTaskRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/planner/tasks/{plannerTask_id}{?select,expand}";
