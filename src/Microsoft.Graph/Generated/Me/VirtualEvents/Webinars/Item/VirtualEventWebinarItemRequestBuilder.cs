...
namespace Microsoft.Graph.Beta.Me.VirtualEvents.Webinars.Item {
    ...
    public class VirtualEventWebinarItemRequestBuilder : BaseRequestBuilder {
        ...
        public VirtualEventWebinarItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/virtualEvents/webinars/{virtualEventWebinar%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new VirtualEventWebinarItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public VirtualEventWebinarItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/virtualEvents/webinars/{virtualEventWebinar%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
