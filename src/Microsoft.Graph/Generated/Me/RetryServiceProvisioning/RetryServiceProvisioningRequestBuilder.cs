...
using System;
namespace Microsoft.Graph.Beta.Me.RetryServiceProvisioning {
    /// <summary>
    ...
    public class RetryServiceProvisioningRequestBuilder : BaseRequestBuilder {
        ...
        public RetryServiceProvisioningRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/retryServiceProvisioning", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RetryServiceProvisioningRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/user-retryserviceprovisioning?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<RetryServiceProvisioningRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<RetryServiceProvisioningRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
