...
namespace Microsoft.Graph.Beta.Me.CalendarGroups.Item.Calendars.Item.CalendarPermissions.Item {
    ...
    public class CalendarPermissionItemRequestBuilder : BaseRequestBuilder {
        ...
        public CalendarPermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarPermissions/{calendarPermission%2Did}{?%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CalendarPermissionItemRequestBuilder and sets the default values.
        /// </summary>
