...
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Count;
...
namespace MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        public MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.EventItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("event_id1", position);
            return new MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.EventItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
