...
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Delta;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item;
...
namespace MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.calendarGroups.item.calendars.item.calendarView.item collection</summary>
