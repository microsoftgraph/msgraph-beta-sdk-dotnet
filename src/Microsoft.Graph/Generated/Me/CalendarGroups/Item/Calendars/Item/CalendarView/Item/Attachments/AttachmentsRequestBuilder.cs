...
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Attachments.CreateUploadSession;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Attachments.Item;
...
namespace MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.calendarGroups.item.calendars.item.calendarView.item.attachments.item collection</summary>
