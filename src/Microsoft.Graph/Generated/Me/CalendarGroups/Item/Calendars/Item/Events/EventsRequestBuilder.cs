...
namespace Microsoft.Graph.Beta.Me.CalendarGroups.Item.Calendars.Item.Events {
    ...
    public class EventsRequestBuilder {
        ...
        /// </summary>
        public async Task<EventCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<EventsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Event> PostAsync(Event body, CancellationToken cancellationToken = default, Action<EventsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
