...
namespace MicrosoftGraphSdk.Me.CalendarGroups {
    ...
    public class CalendarGroupsRequestBuilder {
        ...
        public async Task<CalendarGroupsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<CalendarGroupsResponse>(requestInfo, CalendarGroupsResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// The user's calendar groups. Read-only. Nullable.
        /// <param name="body"></param>
