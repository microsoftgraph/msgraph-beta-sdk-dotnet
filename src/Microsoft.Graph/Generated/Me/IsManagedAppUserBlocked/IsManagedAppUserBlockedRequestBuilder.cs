...
namespace Microsoft.Graph.Beta.Me.IsManagedAppUserBlocked {
    ...
    public class IsManagedAppUserBlockedRequestBuilder {
        ...
        /// </summary>
        public async Task<IsManagedAppUserBlockedResponse> GetAsync(CancellationToken cancellationToken = default, Action<IsManagedAppUserBlockedRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<IsManagedAppUserBlockedResponse>(requestInfo, IsManagedAppUserBlockedResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
