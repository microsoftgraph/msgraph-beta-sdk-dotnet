...
namespace MicrosoftGraph.Me.IsManagedAppUserBlocked {
    /// <summary>Builds and executes requests for operations under \me\microsoft.graph.isManagedAppUserBlocked()</summary>
