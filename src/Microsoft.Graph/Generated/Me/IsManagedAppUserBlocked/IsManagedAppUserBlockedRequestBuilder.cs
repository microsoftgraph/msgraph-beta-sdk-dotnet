...
#nullable enable
        public async Task<IsManagedAppUserBlockedResponse?> GetAsync(CancellationToken cancellationToken = default, Action<IsManagedAppUserBlockedRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IsManagedAppUserBlockedResponse> GetAsync(CancellationToken cancellationToken = default, Action<IsManagedAppUserBlockedRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
