...
using System;
namespace Microsoft.Graph.Beta.Me.AgreementAcceptances.Item {
    /// <summary>
    ...
    public class AgreementAcceptanceItemRequestBuilder : BaseRequestBuilder {
        ...
        public AgreementAcceptanceItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/agreementAcceptances/{agreementAcceptance%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AgreementAcceptanceItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AgreementAcceptanceItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/agreementAcceptances/{agreementAcceptance%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<AgreementAcceptance?> GetAsync(CancellationToken cancellationToken = default, Action<AgreementAcceptanceItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AgreementAcceptance> GetAsync(CancellationToken cancellationToken = default, Action<AgreementAcceptanceItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
