...
#nullable enable
        public async Task<FindRoomListsResponse?> GetAsync(CancellationToken cancellationToken = default, Action<FindRoomListsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<FindRoomListsResponse> GetAsync(CancellationToken cancellationToken = default, Action<FindRoomListsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
