using Microsoft.Graph.Beta.Me.PermissionGrants.Count;
using Microsoft.Graph.Beta.Me.PermissionGrants.Delta;
using Microsoft.Graph.Beta.Me.PermissionGrants.GetByIds;
using Microsoft.Graph.Beta.Me.PermissionGrants.GetUserOwnedObjects;
using Microsoft.Graph.Beta.Me.PermissionGrants.Item;
using Microsoft.Graph.Beta.Me.PermissionGrants.ValidateProperties;
...
using System;
namespace Microsoft.Graph.Beta.Me.PermissionGrants {
    /// <summary>
    ...
    public class PermissionGrantsRequestBuilder : BaseRequestBuilder {
        ...
        public PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PermissionGrantsRequestBuilder and sets the default values.
        /// </summary>
