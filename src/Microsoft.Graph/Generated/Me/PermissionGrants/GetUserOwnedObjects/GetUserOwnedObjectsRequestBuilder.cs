...
namespace Microsoft.Graph.Beta.Me.PermissionGrants.GetUserOwnedObjects {
    ...
    public class GetUserOwnedObjectsRequestBuilder : BaseRequestBuilder {
        ...
        public GetUserOwnedObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/permissionGrants/getUserOwnedObjects", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetUserOwnedObjectsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetUserOwnedObjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/permissionGrants/getUserOwnedObjects", rawUrl) {
        }
        /// <summary>
