using Microsoft.Graph.Beta.Me.PermissionGrants.Item.CheckMemberGroups;
using Microsoft.Graph.Beta.Me.PermissionGrants.Item.CheckMemberObjects;
using Microsoft.Graph.Beta.Me.PermissionGrants.Item.GetMemberGroups;
using Microsoft.Graph.Beta.Me.PermissionGrants.Item.GetMemberObjects;
using Microsoft.Graph.Beta.Me.PermissionGrants.Item.Restore;
...
using System;
namespace Microsoft.Graph.Beta.Me.PermissionGrants.Item {
    /// <summary>
    ...
    public class ResourceSpecificPermissionGrantItemRequestBuilder : BaseRequestBuilder {
        ...
        public ResourceSpecificPermissionGrantItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/permissionGrants/{resourceSpecificPermissionGrant%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ResourceSpecificPermissionGrantItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ResourceSpecificPermissionGrantItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/permissionGrants/{resourceSpecificPermissionGrant%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
