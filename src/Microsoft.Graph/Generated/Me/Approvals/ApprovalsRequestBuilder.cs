using Microsoft.Graph.Beta.Me.Approvals.Count;
using Microsoft.Graph.Beta.Me.Approvals.FilterByCurrentUserWithOn;
using Microsoft.Graph.Beta.Me.Approvals.Item;
...
namespace Microsoft.Graph.Beta.Me.Approvals {
    /// <summary>
    ...
    public class ApprovalsRequestBuilder : BaseRequestBuilder {
        ...
        public ApprovalsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/approvals{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ApprovalsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ApprovalsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/approvals{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
