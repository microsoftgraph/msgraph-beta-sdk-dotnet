...
namespace MicrosoftGraphSdk.Me.Settings.RegionalAndLanguageSettings {
    /// <summary>Builds and executes requests for operations under \me\settings\regionalAndLanguageSettings</summary>
    public class RegionalAndLanguageSettingsRequestBuilder {
        ...
        public RegionalAndLanguageSettingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/settings/regionalAndLanguageSettings{?select,expand}";
