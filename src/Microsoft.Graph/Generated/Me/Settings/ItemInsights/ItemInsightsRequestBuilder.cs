...
using System;
namespace Microsoft.Graph.Beta.Me.Settings.ItemInsights {
    /// <summary>
    ...
    public class ItemInsightsRequestBuilder : BaseRequestBuilder {
        ...
        public ItemInsightsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/settings/itemInsights{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ItemInsightsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ItemInsightsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/settings/itemInsights{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
