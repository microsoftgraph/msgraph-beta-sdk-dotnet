...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ShiftPreferences?> GetAsync(CancellationToken cancellationToken = default, Action<ShiftPreferencesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ShiftPreferences> GetAsync(CancellationToken cancellationToken = default, Action<ShiftPreferencesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ShiftPreferences?> PatchAsync(Microsoft.Graph.Beta.Models.ShiftPreferences body, CancellationToken cancellationToken = default, Action<ShiftPreferencesRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ShiftPreferences> PatchAsync(Microsoft.Graph.Beta.Models.ShiftPreferences body, CancellationToken cancellationToken = default, Action<ShiftPreferencesRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
