...
namespace Microsoft.Graph.Beta.Me.Settings.ShiftPreferences {
    ...
    public class ShiftPreferencesRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.ShiftPreferences> GetAsync(CancellationToken cancellationToken = default, Action<ShiftPreferencesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.ShiftPreferences body, CancellationToken cancellationToken = default, Action<ShiftPreferencesRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
