...
namespace Microsoft.Graph.Beta.Me.Settings.ContactMergeSuggestions {
    ...
    public class ContactMergeSuggestionsRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(Action<ContactMergeSuggestionsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.ContactMergeSuggestions> GetAsync(Action<ContactMergeSuggestionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
