...
namespace MicrosoftGraph.Me.Messages.Item.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \me\messages\{message-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.messages.item.multiValueExtendedProperties.item collection</summary>
