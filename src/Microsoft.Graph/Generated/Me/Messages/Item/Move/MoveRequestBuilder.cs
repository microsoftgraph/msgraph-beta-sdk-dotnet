...
using System;
namespace Microsoft.Graph.Beta.Me.Messages.Item.Move {
    /// <summary>
    ...
    public class MoveRequestBuilder : BaseRequestBuilder {
        ...
        public MoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/messages/{message%2Did}/move", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MoveRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MoveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/messages/{message%2Did}/move", rawUrl) {
        }
        /// <summary>
