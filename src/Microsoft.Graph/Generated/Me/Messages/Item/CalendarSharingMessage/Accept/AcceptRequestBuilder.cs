...
namespace Microsoft.Graph.Beta.Me.Messages.Item.CalendarSharingMessage.Accept {
    ...
    public class AcceptRequestBuilder {
        ...
        public AcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/messages/{message%2Did}/microsoft.graph.calendarSharingMessage/microsoft.graph.accept";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Action<AcceptRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Calendar> PostAsync(Action<AcceptRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
