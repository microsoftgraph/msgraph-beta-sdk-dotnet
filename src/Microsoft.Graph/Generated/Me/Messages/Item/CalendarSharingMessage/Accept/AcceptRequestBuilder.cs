...
namespace MicrosoftGraphSdk.Me.Messages.Item.CalendarSharingMessage.Accept {
    /// <summary>Builds and executes requests for operations under \me\messages\{message-id}\microsoft.graph.calendarSharingMessage\microsoft.graph.accept</summary>
    public class AcceptRequestBuilder {
        ...
        public AcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/messages/{message_id}/microsoft.graph.calendarSharingMessage/microsoft.graph.accept";
