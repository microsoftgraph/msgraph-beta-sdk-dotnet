...
namespace Microsoft.Graph.Beta.Me.Messages.Item.CreateReply
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Me.Messages.Item.CreateReply.CreateReplyRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Microsoft.Graph.Beta.Models.Message?> PostAsync(global::Microsoft.Graph.Beta.Me.Messages.Item.CreateReply.CreateReplyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Microsoft.Graph.Beta.Models.Message> PostAsync(global::Microsoft.Graph.Beta.Me.Messages.Item.CreateReply.CreateReplyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Microsoft.Graph.Beta.Me.Messages.Item.CreateReply.CreateReplyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Microsoft.Graph.Beta.Me.Messages.Item.CreateReply.CreateReplyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Me.Messages.Item.CreateReply.CreateReplyRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete(" as of 2024-07/PrivatePreview:copilotExportAPI")]
        public global::Microsoft.Graph.Beta.Me.Messages.Item.CreateReply.CreateReplyRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Beta.Me.Messages.Item.CreateReply.CreateReplyRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
