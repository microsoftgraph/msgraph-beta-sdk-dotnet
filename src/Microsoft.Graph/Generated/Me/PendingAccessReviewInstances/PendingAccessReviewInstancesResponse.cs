...
namespace MicrosoftGraphSdk.Me.PendingAccessReviewInstances {
    public class PendingAccessReviewInstancesResponse : IParsable {
        ...
        /// </summary>
        public static PendingAccessReviewInstancesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PendingAccessReviewInstancesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as PendingAccessReviewInstancesResponse).Value = n.GetCollectionOfObjectValues<AccessReviewInstance>(AccessReviewInstance.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
