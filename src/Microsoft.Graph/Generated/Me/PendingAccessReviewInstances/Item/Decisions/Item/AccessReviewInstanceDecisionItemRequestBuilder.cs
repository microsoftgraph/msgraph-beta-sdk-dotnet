...
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.Decisions.Item.Insights;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.Decisions.Item.Instance;
...
namespace MicrosoftGraph.Me.PendingAccessReviewInstances.Item.Decisions.Item {
    /// <summary>Builds and executes requests for operations under \me\pendingAccessReviewInstances\{accessReviewInstance-id}\decisions\{accessReviewInstanceDecisionItem-id}</summary>
    public class AccessReviewInstanceDecisionItemRequestBuilder {
        ...
        public AccessReviewInstanceDecisionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance_id}/decisions/{accessReviewInstanceDecisionItem_id}{?select,expand}";
