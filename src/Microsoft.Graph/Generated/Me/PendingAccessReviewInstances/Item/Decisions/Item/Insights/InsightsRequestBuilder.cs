...
using MicrosoftGraphSdk.Me.PendingAccessReviewInstances.Item.Decisions.Item.Insights.Item;
...
namespace MicrosoftGraphSdk.Me.PendingAccessReviewInstances.Item.Decisions.Item.Insights {
    /// <summary>Builds and executes requests for operations under \me\pendingAccessReviewInstances\{accessReviewInstance-id}\decisions\{accessReviewInstanceDecisionItem-id}\insights</summary>
    public class InsightsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.pendingAccessReviewInstances.item.decisions.item.insights.item collection</summary>
