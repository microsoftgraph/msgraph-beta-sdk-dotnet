...
namespace Microsoft.Graph.Beta.Me.PendingAccessReviewInstances.Item.Decisions.Item.Instance.ResetDecisions {
    ...
    public class ResetDecisionsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>
        /// Resets decisions of all accessReviewInstanceDecisionItem objects on an accessReviewInstance to notReviewed. This API is supported in the following national cloud deployments.
...
#nullable restore
        ...
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public ResetDecisionsRequestBuilder WithUrl(string rawUrl) {
