...
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.Decisions.Item.Instance.AcceptRecommendations;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.Decisions.Item.Instance.ApplyDecisions;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.Decisions.Item.Instance.BatchRecordDecisions;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.Decisions.Item.Instance.ResetDecisions;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.Decisions.Item.Instance.SendReminder;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.Decisions.Item.Instance.Stop;
...
namespace MicrosoftGraph.Me.PendingAccessReviewInstances.Item.Decisions.Item.Instance {
    /// <summary>Builds and executes requests for operations under \me\pendingAccessReviewInstances\{accessReviewInstance-id}\decisions\{accessReviewInstanceDecisionItem-id}\instance</summary>
    public class InstanceRequestBuilder {
        ...
        public InstanceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance_id}/decisions/{accessReviewInstanceDecisionItem_id}/instance{?select,expand}";
