...
using System;
namespace Microsoft.Graph.Beta.Me.PendingAccessReviewInstances.Item.AcceptRecommendations {
    /// <summary>
    ...
    public class AcceptRecommendationsRequestBuilder : BaseRequestBuilder {
        ...
        public AcceptRecommendationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/acceptRecommendations", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AcceptRecommendationsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AcceptRecommendationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/acceptRecommendations", rawUrl) {
        }
        /// <summary>
