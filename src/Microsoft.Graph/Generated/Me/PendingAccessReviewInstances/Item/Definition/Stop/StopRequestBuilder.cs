...
namespace MicrosoftGraphSdk.Me.PendingAccessReviewInstances.Item.Definition.Stop {
    /// <summary>Builds and executes requests for operations under \me\pendingAccessReviewInstances\{accessReviewInstance-id}\definition\microsoft.graph.stop</summary>
    public class StopRequestBuilder {
        ...
        public StopRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance_id}/definition/microsoft.graph.stop";
