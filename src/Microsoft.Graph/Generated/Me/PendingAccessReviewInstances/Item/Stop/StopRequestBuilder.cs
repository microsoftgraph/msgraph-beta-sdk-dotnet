...
namespace MicrosoftGraphSdk.Me.PendingAccessReviewInstances.Item.Stop {
    /// <summary>Builds and executes requests for operations under \me\pendingAccessReviewInstances\{accessReviewInstance-id}\microsoft.graph.stop</summary>
    public class StopRequestBuilder {
        ...
        public StopRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance_id}/microsoft.graph.stop";
