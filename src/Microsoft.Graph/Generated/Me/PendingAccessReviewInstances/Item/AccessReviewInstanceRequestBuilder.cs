...
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.AcceptRecommendations;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.ApplyDecisions;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.BatchRecordDecisions;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.ContactedReviewers;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.Decisions;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.Definition;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.ResetDecisions;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.SendReminder;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.Stages;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item.Stop;
...
namespace MicrosoftGraph.Me.PendingAccessReviewInstances.Item {
    ...
    public class AccessReviewInstanceRequestBuilder {
        ...
        public AccessReviewInstanceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance_id}{?select,expand}";
