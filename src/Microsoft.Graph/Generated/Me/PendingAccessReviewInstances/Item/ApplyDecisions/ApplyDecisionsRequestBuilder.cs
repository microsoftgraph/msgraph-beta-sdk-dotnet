...
using System;
namespace Microsoft.Graph.Beta.Me.PendingAccessReviewInstances.Item.ApplyDecisions {
    /// <summary>
    ...
    public class ApplyDecisionsRequestBuilder : BaseRequestBuilder {
        ...
        public ApplyDecisionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/applyDecisions", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ApplyDecisionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ApplyDecisionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/applyDecisions", rawUrl) {
        }
        /// <summary>
