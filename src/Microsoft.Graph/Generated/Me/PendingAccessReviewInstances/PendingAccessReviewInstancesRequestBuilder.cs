...
using MicrosoftGraph.Me.PendingAccessReviewInstances.FilterByCurrentUserWithOn;
using MicrosoftGraph.Me.PendingAccessReviewInstances.Item;
...
namespace MicrosoftGraph.Me.PendingAccessReviewInstances {
    /// <summary>Builds and executes requests for operations under \me\pendingAccessReviewInstances</summary>
    public class PendingAccessReviewInstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.pendingAccessReviewInstances.item collection</summary>
        ...
        public PendingAccessReviewInstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/pendingAccessReviewInstances{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
