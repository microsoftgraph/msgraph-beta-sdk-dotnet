...
namespace MicrosoftGraphSdk.Me.OnlineMeetings.Item.MeetingAttendanceReport {
    ...
    public class MeetingAttendanceReportRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.MeetingAttendanceReport body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
