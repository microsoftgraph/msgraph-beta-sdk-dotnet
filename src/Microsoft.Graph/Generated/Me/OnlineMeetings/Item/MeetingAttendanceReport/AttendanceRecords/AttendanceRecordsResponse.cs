...
namespace MicrosoftGraphSdk.Me.OnlineMeetings.Item.MeetingAttendanceReport.AttendanceRecords {
    public class AttendanceRecordsResponse : IParsable {
        ...
        /// </summary>
        public static AttendanceRecordsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as AttendanceRecordsResponse).Value = n.GetCollectionOfObjectValues<AttendanceRecord>(AttendanceRecord.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
