...
namespace MicrosoftGraphSdk.Me.OnlineMeetings.Item.MeetingAttendanceReport.AttendanceRecords.Item {
    /// <summary>Builds and executes requests for operations under \me\onlineMeetings\{onlineMeeting-id}\meetingAttendanceReport\attendanceRecords\{attendanceRecord-id}</summary>
    public class AttendanceRecordItemRequestBuilder {
        ...
        public AttendanceRecordItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onlineMeetings/{onlineMeeting_id}/meetingAttendanceReport/attendanceRecords/{attendanceRecord_id}{?select,expand}";
