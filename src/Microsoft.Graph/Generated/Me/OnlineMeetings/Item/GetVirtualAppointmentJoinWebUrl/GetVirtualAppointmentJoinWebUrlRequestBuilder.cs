...
using System;
namespace Microsoft.Graph.Beta.Me.OnlineMeetings.Item.GetVirtualAppointmentJoinWebUrl {
    /// <summary>
    ...
    public class GetVirtualAppointmentJoinWebUrlRequestBuilder : BaseRequestBuilder {
        ...
        public GetVirtualAppointmentJoinWebUrlRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/getVirtualAppointmentJoinWebUrl()", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetVirtualAppointmentJoinWebUrlRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetVirtualAppointmentJoinWebUrlRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/getVirtualAppointmentJoinWebUrl()", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<GetVirtualAppointmentJoinWebUrlResponse?> GetAsync(Action<GetVirtualAppointmentJoinWebUrlRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<GetVirtualAppointmentJoinWebUrlResponse> GetAsync(Action<GetVirtualAppointmentJoinWebUrlRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
