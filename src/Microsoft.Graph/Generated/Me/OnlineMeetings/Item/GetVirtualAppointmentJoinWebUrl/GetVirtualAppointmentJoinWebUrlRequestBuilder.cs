...
namespace Microsoft.Graph.Beta.Me.OnlineMeetings.Item.GetVirtualAppointmentJoinWebUrl {
    ...
    public class GetVirtualAppointmentJoinWebUrlRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetVirtualAppointmentJoinWebUrlGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function getVirtualAppointmentJoinWebUrl
        /// </summary>
        /// <returns>A <cref="GetVirtualAppointmentJoinWebUrlResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetVirtualAppointmentJoinWebUrlRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
