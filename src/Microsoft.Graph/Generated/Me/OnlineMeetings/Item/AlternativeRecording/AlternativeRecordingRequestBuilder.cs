...
namespace Microsoft.Graph.Beta.Me.OnlineMeetings.Item.AlternativeRecording {
    ...
    public class AlternativeRecordingRequestBuilder : BaseRequestBuilder {
        ...
        public AlternativeRecordingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/alternativeRecording", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AlternativeRecordingRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AlternativeRecordingRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/alternativeRecording", rawUrl) {
        }
        /// <summary>
