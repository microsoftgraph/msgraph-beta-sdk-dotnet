    ...
    public class AttendanceReportsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as AttendanceReportsResponse).Value = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.MeetingAttendanceReport>(MicrosoftGraphSdk.Models.Microsoft.Graph.MeetingAttendanceReport.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
