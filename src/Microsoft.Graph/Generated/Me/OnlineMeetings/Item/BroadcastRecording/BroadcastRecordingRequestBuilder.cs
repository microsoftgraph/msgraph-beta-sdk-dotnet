...
using System;
namespace Microsoft.Graph.Beta.Me.OnlineMeetings.Item.BroadcastRecording {
    /// <summary>
    ...
    public class BroadcastRecordingRequestBuilder : BaseRequestBuilder {
        ...
        public BroadcastRecordingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/broadcastRecording", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new BroadcastRecordingRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BroadcastRecordingRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/broadcastRecording", rawUrl) {
        }
        /// <summary>
