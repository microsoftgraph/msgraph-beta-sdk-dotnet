...
using System;
namespace Microsoft.Graph.Beta.Me.OnlineMeetings.Item.VirtualAppointment {
    /// <summary>
    ...
    public class VirtualAppointmentRequestBuilder : BaseRequestBuilder {
        ...
        public VirtualAppointmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/virtualAppointment{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new VirtualAppointmentRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public VirtualAppointmentRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/virtualAppointment{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
