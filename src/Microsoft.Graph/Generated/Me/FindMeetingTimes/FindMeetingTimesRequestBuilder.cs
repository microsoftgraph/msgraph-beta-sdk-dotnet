...
namespace MicrosoftGraphSdk.Me.FindMeetingTimes {
    ...
    public class FindMeetingTimesRequestBuilder {
        ...
        /// </summary>
        public async Task<MeetingTimeSuggestionsResult> PostAsync(FindMeetingTimesRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
