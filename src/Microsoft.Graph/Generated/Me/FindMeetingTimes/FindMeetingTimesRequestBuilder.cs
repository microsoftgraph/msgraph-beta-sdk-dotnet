...
namespace Microsoft.Graph.Beta.Me.FindMeetingTimes {
    ...
    public class FindMeetingTimesRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(FindMeetingTimesRequestBody body, Action<FindMeetingTimesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<MeetingTimeSuggestionsResult> PostAsync(FindMeetingTimesRequestBody body, Action<FindMeetingTimesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
