...
namespace Microsoft.Graph.Beta.Me.MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTop {
    /// <summary>
    ...
    public class MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder {
        ...
        public MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? skip = default, int? top = default) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<DeviceAndAppManagementData?> GetAsync(Action<MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<DeviceAndAppManagementData> GetAsync(Action<MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
