...
namespace Microsoft.Graph.Beta.Me.MemberOf.Item.User.GetManagedDevicesWithFailedOrPendingApps {
    ...
    public class GetManagedDevicesWithFailedOrPendingAppsRequestBuilder {
        ...
        public GetManagedDevicesWithFailedOrPendingAppsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/memberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.getManagedDevicesWithFailedOrPendingApps()";
