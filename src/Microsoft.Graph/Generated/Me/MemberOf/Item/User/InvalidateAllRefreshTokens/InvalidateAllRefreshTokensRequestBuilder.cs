...
namespace Microsoft.Graph.Beta.Me.MemberOf.Item.User.InvalidateAllRefreshTokens {
    ...
    public class InvalidateAllRefreshTokensRequestBuilder {
        ...
        public InvalidateAllRefreshTokensRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/memberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.invalidateAllRefreshTokens";
