...
using System;
namespace Microsoft.Graph.Beta.Me.ManagedDevices.BulkReprovisionCloudPc {
    /// <summary>
    ...
    public class BulkReprovisionCloudPcRequestBuilder : BaseRequestBuilder {
        ...
        public BulkReprovisionCloudPcRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/bulkReprovisionCloudPc", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new BulkReprovisionCloudPcRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BulkReprovisionCloudPcRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/bulkReprovisionCloudPc", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<CloudPcBulkRemoteActionResult?> PostAsync(BulkReprovisionCloudPcPostRequestBody body, CancellationToken cancellationToken = default, Action<BulkReprovisionCloudPcRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CloudPcBulkRemoteActionResult> PostAsync(BulkReprovisionCloudPcPostRequestBody body, CancellationToken cancellationToken = default, Action<BulkReprovisionCloudPcRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
