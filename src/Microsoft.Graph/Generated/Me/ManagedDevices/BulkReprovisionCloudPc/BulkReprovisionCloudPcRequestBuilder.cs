...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.BulkReprovisionCloudPc {
    ...
    public class BulkReprovisionCloudPcRequestBuilder {
        ...
        /// </summary>
        public async Task<CloudPcBulkRemoteActionResult> PostAsync(BulkReprovisionCloudPcPostRequestBody body, CancellationToken cancellationToken = default, Action<BulkReprovisionCloudPcRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
