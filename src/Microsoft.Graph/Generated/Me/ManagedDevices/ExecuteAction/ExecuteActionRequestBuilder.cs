...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.ExecuteAction {
    ...
    public class ExecuteActionRequestBuilder : BaseRequestBuilder {
        ...
        public ExecuteActionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/executeAction", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ExecuteActionRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExecuteActionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/executeAction", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<BulkManagedDeviceActionResult?> PostAsync(ExecuteActionPostRequestBody body, CancellationToken cancellationToken = default, Action<ExecuteActionRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BulkManagedDeviceActionResult> PostAsync(ExecuteActionPostRequestBody body, CancellationToken cancellationToken = default, Action<ExecuteActionRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
