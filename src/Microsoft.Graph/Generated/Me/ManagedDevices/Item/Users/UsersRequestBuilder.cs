...
using MicrosoftGraphSdk.Me.ManagedDevices.Item.Users.Ref;
using System;
...
namespace MicrosoftGraphSdk.Me.ManagedDevices.Item.Users {
    /// <summary>Builds and executes requests for operations under \me\managedDevices\{managedDevice-id}\users</summary>
    public class UsersRequestBuilder {
        ...
        public UsersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/managedDevices/{managedDevice_id}/users{?top,skip,search,filter,count,orderby,select,expand}";
