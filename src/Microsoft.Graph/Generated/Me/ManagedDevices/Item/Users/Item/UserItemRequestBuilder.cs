...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.Item.Users.Item {
    ...
    public class UserItemRequestBuilder {
        ...
        public UserItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/users/{user%2Did}{?%24select,%24expand}";
