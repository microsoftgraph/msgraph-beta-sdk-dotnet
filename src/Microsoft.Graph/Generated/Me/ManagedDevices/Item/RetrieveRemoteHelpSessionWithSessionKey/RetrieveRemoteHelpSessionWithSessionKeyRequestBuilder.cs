...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.Item.RetrieveRemoteHelpSessionWithSessionKey {
    /// <summary>
    ...
    public class RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder : BaseRequestBuilder {
        ...
        public RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string sessionKey = "") : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/retrieveRemoteHelpSession(sessionKey='{sessionKey}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/retrieveRemoteHelpSession(sessionKey='{sessionKey}')", rawUrl) {
        }
        /// <summary>
