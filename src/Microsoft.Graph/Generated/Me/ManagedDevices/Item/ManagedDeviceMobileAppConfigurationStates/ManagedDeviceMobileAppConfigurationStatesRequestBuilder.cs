...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.Item.ManagedDeviceMobileAppConfigurationStates {
    ...
    public class ManagedDeviceMobileAppConfigurationStatesRequestBuilder : BaseRequestBuilder {
        ...
        public ManagedDeviceMobileAppConfigurationStatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/managedDeviceMobileAppConfigurationStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ManagedDeviceMobileAppConfigurationStatesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ManagedDeviceMobileAppConfigurationStatesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/managedDeviceMobileAppConfigurationStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ManagedDeviceMobileAppConfigurationStateCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceMobileAppConfigurationStatesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedDeviceMobileAppConfigurationStateCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceMobileAppConfigurationStatesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedDeviceMobileAppConfigurationState?> PostAsync(ManagedDeviceMobileAppConfigurationState body, CancellationToken cancellationToken = default, Action<ManagedDeviceMobileAppConfigurationStatesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedDeviceMobileAppConfigurationState> PostAsync(ManagedDeviceMobileAppConfigurationState body, CancellationToken cancellationToken = default, Action<ManagedDeviceMobileAppConfigurationStatesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
