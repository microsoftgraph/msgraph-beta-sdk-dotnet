...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.Item.Retire {
    ...
    public class RetireRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<RetireRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
