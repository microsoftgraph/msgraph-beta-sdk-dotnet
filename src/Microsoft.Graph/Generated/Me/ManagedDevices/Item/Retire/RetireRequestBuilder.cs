...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.Item.Retire {
    ...
    public class RetireRequestBuilder {
        ...
        public RetireRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/retire";
...
#nullable enable
        public async Task PostAsync(Action<RetireRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(Action<RetireRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
