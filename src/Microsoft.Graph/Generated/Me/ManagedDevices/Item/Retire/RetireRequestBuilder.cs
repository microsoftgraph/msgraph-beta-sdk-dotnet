...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.Item.Retire {
    ...
    public class RetireRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<RetireRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
