...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.Item.GetCloudPcRemoteActionResults {
    ...
    public class GetCloudPcRemoteActionResultsRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetCloudPcRemoteActionResultsGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function getCloudPcRemoteActionResults
        /// </summary>
        /// <returns>A <cref="GetCloudPcRemoteActionResultsResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetCloudPcRemoteActionResultsRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
