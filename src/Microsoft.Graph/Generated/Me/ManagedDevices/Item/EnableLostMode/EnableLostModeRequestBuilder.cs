...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.Item.EnableLostMode {
    ...
    public class EnableLostModeRequestBuilder : BaseRequestBuilder {
        ...
        public EnableLostModeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/enableLostMode", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EnableLostModeRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EnableLostModeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/enableLostMode", rawUrl) {
        }
        /// <summary>
        /// Enable lost mode
        /// </summary>
