...
using MicrosoftGraph.Me.ManagedDevices.Item.ActivateDeviceEsim;
using MicrosoftGraph.Me.ManagedDevices.Item.AssignmentFilterEvaluationStatusDetails;
...
using MicrosoftGraph.Me.ManagedDevices.Item.CreateDeviceLogCollectionRequest;
using MicrosoftGraph.Me.ManagedDevices.Item.DeleteUserFromSharedAppleDevice;
using MicrosoftGraph.Me.ManagedDevices.Item.Deprovision;
using MicrosoftGraph.Me.ManagedDevices.Item.DetectedApps;
...
using MicrosoftGraph.Me.ManagedDevices.Item.Disable;
using MicrosoftGraph.Me.ManagedDevices.Item.DisableLostMode;
using MicrosoftGraph.Me.ManagedDevices.Item.EnableLostMode;
using MicrosoftGraph.Me.ManagedDevices.Item.GetCloudPcRemoteActionResults;
using MicrosoftGraph.Me.ManagedDevices.Item.GetFileVaultKey;
using MicrosoftGraph.Me.ManagedDevices.Item.GetNonCompliantSettings;
using MicrosoftGraph.Me.ManagedDevices.Item.GetOemWarranty;
using MicrosoftGraph.Me.ManagedDevices.Item.LocateDevice;
using MicrosoftGraph.Me.ManagedDevices.Item.LogCollectionRequests;
using MicrosoftGraph.Me.ManagedDevices.Item.LogoutSharedAppleDeviceActiveUser;
using MicrosoftGraph.Me.ManagedDevices.Item.ManagedDeviceMobileAppConfigurationStates;
using MicrosoftGraph.Me.ManagedDevices.Item.OverrideComplianceState;
using MicrosoftGraph.Me.ManagedDevices.Item.PlayLostModeSound;
using MicrosoftGraph.Me.ManagedDevices.Item.RebootNow;
using MicrosoftGraph.Me.ManagedDevices.Item.RecoverPasscode;
using MicrosoftGraph.Me.ManagedDevices.Item.Reenable;
using MicrosoftGraph.Me.ManagedDevices.Item.RemoteLock;
using MicrosoftGraph.Me.ManagedDevices.Item.ReprovisionCloudPc;
...
using MicrosoftGraph.Me.ManagedDevices.Item.ResizeCloudPc;
using MicrosoftGraph.Me.ManagedDevices.Item.RestoreCloudPc;
using MicrosoftGraph.Me.ManagedDevices.Item.Retire;
using MicrosoftGraph.Me.ManagedDevices.Item.RevokeAppleVppLicenses;
using MicrosoftGraph.Me.ManagedDevices.Item.RotateBitLockerKeys;
using MicrosoftGraph.Me.ManagedDevices.Item.RotateFileVaultKey;
using MicrosoftGraph.Me.ManagedDevices.Item.SecurityBaselineStates;
using MicrosoftGraph.Me.ManagedDevices.Item.SendCustomNotificationToCompanyPortal;
using MicrosoftGraph.Me.ManagedDevices.Item.SetDeviceName;
using MicrosoftGraph.Me.ManagedDevices.Item.ShutDown;
using MicrosoftGraph.Me.ManagedDevices.Item.SyncDevice;
using MicrosoftGraph.Me.ManagedDevices.Item.TriggerConfigurationManagerAction;
using MicrosoftGraph.Me.ManagedDevices.Item.UpdateWindowsDeviceAccount;
using MicrosoftGraph.Me.ManagedDevices.Item.Users;
...
using MicrosoftGraph.Me.ManagedDevices.Item.WindowsProtectionState;
