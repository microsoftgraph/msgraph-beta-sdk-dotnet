...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.Item.ResetPasscode {
    ...
    public class ResetPasscodeRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<ResetPasscodeRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
