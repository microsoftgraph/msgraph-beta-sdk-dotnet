...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceLogCollectionResponseItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceLogCollectionResponseItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceLogCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceLogCollectionResponseItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceLogCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DeviceLogCollectionResponseItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceLogCollectionResponse?> PatchAsync(DeviceLogCollectionResponse body, CancellationToken cancellationToken = default, Action<DeviceLogCollectionResponseItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceLogCollectionResponse> PatchAsync(DeviceLogCollectionResponse body, CancellationToken cancellationToken = default, Action<DeviceLogCollectionResponseItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
