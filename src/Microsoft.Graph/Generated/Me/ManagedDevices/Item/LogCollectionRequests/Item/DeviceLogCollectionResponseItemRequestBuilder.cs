...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.Item.LogCollectionRequests.Item {
    ...
    public class DeviceLogCollectionResponseItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DeviceLogCollectionResponse body, Action<DeviceLogCollectionResponseItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
