...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.Item.LogCollectionRequests.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/logCollectionRequests/$count{?%24search,%24filter}";
