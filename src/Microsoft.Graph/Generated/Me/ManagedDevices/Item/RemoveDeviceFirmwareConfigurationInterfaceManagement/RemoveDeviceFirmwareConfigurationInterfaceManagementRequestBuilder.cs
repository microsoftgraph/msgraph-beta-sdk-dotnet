...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.Item.RemoveDeviceFirmwareConfigurationInterfaceManagement {
    ...
    public class RemoveDeviceFirmwareConfigurationInterfaceManagementRequestBuilder : BaseRequestBuilder {
        ...
        public RemoveDeviceFirmwareConfigurationInterfaceManagementRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/removeDeviceFirmwareConfigurationInterfaceManagement", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RemoveDeviceFirmwareConfigurationInterfaceManagementRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoveDeviceFirmwareConfigurationInterfaceManagementRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/removeDeviceFirmwareConfigurationInterfaceManagement", rawUrl) {
        }
        /// <summary>
