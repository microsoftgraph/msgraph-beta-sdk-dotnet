...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.Item.TriggerConfigurationManagerAction {
    ...
    public class TriggerConfigurationManagerActionRequestBuilder : BaseRequestBuilder {
        ...
        public TriggerConfigurationManagerActionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/triggerConfigurationManagerAction", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TriggerConfigurationManagerActionRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TriggerConfigurationManagerActionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/triggerConfigurationManagerAction", rawUrl) {
        }
        /// <summary>
