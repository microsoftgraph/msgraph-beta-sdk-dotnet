...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.Item.UpdateWindowsDeviceAccount {
    ...
    public class UpdateWindowsDeviceAccountPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public Microsoft.Graph.Beta.Models.UpdateWindowsDeviceAccountActionParameter UpdateWindowsDeviceAccountActionParameter {
            get { return BackingStore?.Get<Microsoft.Graph.Beta.Models.UpdateWindowsDeviceAccountActionParameter>(nameof(UpdateWindowsDeviceAccountActionParameter)); }
            set { BackingStore?.Set(nameof(UpdateWindowsDeviceAccountActionParameter), value); }
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"updateWindowsDeviceAccountActionParameter", n => { UpdateWindowsDeviceAccountActionParameter = n.GetObjectValue<Microsoft.Graph.Beta.Models.UpdateWindowsDeviceAccountActionParameter>(Microsoft.Graph.Beta.Models.UpdateWindowsDeviceAccountActionParameter.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
