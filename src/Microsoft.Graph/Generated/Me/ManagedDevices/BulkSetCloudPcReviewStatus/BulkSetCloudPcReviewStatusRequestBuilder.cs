...
namespace Microsoft.Graph.Beta.Me.ManagedDevices.BulkSetCloudPcReviewStatus {
    ...
    public class BulkSetCloudPcReviewStatusRequestBuilder : BaseRequestBuilder {
        ...
        public BulkSetCloudPcReviewStatusRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/bulkSetCloudPcReviewStatus", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new BulkSetCloudPcReviewStatusRequestBuilder and sets the default values.
        /// </summary>
