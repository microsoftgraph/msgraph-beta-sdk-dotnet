using Microsoft.Graph.Beta.Me.Tasks.Alltasks.Item.Extensions.Count;
using Microsoft.Graph.Beta.Me.Tasks.Alltasks.Item.Extensions.Item;
...
namespace Microsoft.Graph.Beta.Me.Tasks.Alltasks.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.tasks.alltasks.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/tasks/alltasks/{baseTask%2Did}/extensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
