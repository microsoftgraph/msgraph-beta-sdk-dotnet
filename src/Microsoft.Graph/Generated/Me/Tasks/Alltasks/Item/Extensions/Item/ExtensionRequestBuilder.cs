...
namespace MicrosoftGraph.Me.Tasks.Alltasks.Item.Extensions.Item {
    /// <summary>Builds and executes requests for operations under \me\tasks\alltasks\{baseTask-id}\extensions\{extension-id}</summary>
    public class ExtensionRequestBuilder {
        ...
        public ExtensionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/tasks/alltasks/{baseTask_id}/extensions/{extension_id}{?select,expand}";
