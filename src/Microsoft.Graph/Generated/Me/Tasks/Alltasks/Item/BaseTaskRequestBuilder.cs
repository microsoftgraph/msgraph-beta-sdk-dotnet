...
using MicrosoftGraph.Me.Tasks.Alltasks.Item.ChecklistItems;
using MicrosoftGraph.Me.Tasks.Alltasks.Item.Extensions;
using MicrosoftGraph.Me.Tasks.Alltasks.Item.LinkedResources;
using MicrosoftGraph.Me.Tasks.Alltasks.Item.Move;
using MicrosoftGraph.Me.Tasks.Alltasks.Item.ParentList;
...
namespace MicrosoftGraph.Me.Tasks.Alltasks.Item {
    ...
    public class BaseTaskRequestBuilder {
        ...
        public ParentListRequestBuilder ParentList { get =>
            new ParentListRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        /// <summary>
        /// Instantiates a new BaseTaskRequestBuilder and sets the default values.
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public BaseTaskRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/me/tasks/alltasks/{baseTask_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public BaseTaskRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(BaseTask body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
