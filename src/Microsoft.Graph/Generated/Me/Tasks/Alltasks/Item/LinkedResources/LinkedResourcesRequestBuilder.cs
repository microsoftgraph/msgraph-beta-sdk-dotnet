...
using MicrosoftGraphSdk.Me.Tasks.Alltasks.Item.LinkedResources.Item;
...
namespace MicrosoftGraphSdk.Me.Tasks.Alltasks.Item.LinkedResources {
    /// <summary>Builds and executes requests for operations under \me\tasks\alltasks\{baseTask-id}\linkedResources</summary>
    public class LinkedResourcesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.tasks.alltasks.item.linkedResources.item collection</summary>
