...
using MicrosoftGraphSdk.Me.Tasks.Lists.Item.Tasks.Delta;
using MicrosoftGraphSdk.Me.Tasks.Lists.Item.Tasks.Item;
...
namespace MicrosoftGraphSdk.Me.Tasks.Lists.Item.Tasks {
    /// <summary>Builds and executes requests for operations under \me\tasks\lists\{baseTaskList-id}\tasks</summary>
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.tasks.lists.item.tasks.item collection</summary>
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/tasks/lists/{baseTaskList_id}/tasks{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>
        /// Builds and executes requests for operations under \me\tasks\lists\{baseTaskList-id}\tasks\microsoft.graph.delta()
        /// </summary>
