...
namespace MicrosoftGraphSdk.Me.Tasks.Lists.Item.Tasks.Item.Move {
    /// <summary>Builds and executes requests for operations under \me\tasks\lists\{baseTaskList-id}\tasks\{baseTask-id}\microsoft.graph.move</summary>
