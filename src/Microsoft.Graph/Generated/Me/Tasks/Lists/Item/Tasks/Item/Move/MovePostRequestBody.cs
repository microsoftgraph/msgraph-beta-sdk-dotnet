...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Me.Tasks.Lists.Item.Tasks.Item.Move {
    ...
    public class MovePostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"destinationTaskListId", n => { DestinationTaskListId = n.GetStringValue(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteStringValue("destinationTaskListId", DestinationTaskListId);
