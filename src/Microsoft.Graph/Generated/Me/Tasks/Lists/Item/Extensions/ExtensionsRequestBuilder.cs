...
using MicrosoftGraphSdk.Me.Tasks.Lists.Item.Extensions.Item;
...
namespace MicrosoftGraphSdk.Me.Tasks.Lists.Item.Extensions {
    /// <summary>Builds and executes requests for operations under \me\tasks\lists\{baseTaskList-id}\extensions</summary>
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.tasks.lists.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/tasks/lists/{baseTaskList_id}/extensions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
