...
namespace MicrosoftGraphSdk.Me.Tasks.Lists.Item.Extensions.Item {
    /// <summary>Builds and executes requests for operations under \me\tasks\lists\{baseTaskList-id}\extensions\{extension-id}</summary>
    public class ExtensionItemRequestBuilder {
        ...
        public ExtensionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/tasks/lists/{baseTaskList_id}/extensions/{extension_id}{?select,expand}";
