...
namespace Microsoft.Graph.Beta.Me.Tasks.Lists.Item.Extensions.Item {
    /// <summary>Provides operations to manage the extensions property of the microsoft.graph.baseTaskList entity.</summary>
    public class ExtensionItemRequestBuilder {
        ...
        public ExtensionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/tasks/lists/{baseTaskList%2Did}/extensions/{extension%2Did}{?%24select,%24expand}";
