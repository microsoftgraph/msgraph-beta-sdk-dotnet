...
namespace Microsoft.Graph.Beta.Me.Tasks.Lists {
    ...
    public class ListsRequestBuilder {
        ...
        /// </summary>
        public async Task<BaseTaskListCollectionResponse> GetAsync(Action<ListsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<BaseTaskList> PostAsync(BaseTaskList body, Action<ListsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
