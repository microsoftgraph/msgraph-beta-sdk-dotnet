...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<InferenceClassificationOverrideItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<InferenceClassificationOverrideItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<InferenceClassificationOverride?> GetAsync(CancellationToken cancellationToken = default, Action<InferenceClassificationOverrideItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<InferenceClassificationOverride> GetAsync(CancellationToken cancellationToken = default, Action<InferenceClassificationOverrideItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<InferenceClassificationOverride?> PatchAsync(InferenceClassificationOverride body, CancellationToken cancellationToken = default, Action<InferenceClassificationOverrideItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<InferenceClassificationOverride> PatchAsync(InferenceClassificationOverride body, CancellationToken cancellationToken = default, Action<InferenceClassificationOverrideItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
