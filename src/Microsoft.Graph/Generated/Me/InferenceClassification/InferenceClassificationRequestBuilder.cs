...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.InferenceClassification?> GetAsync(CancellationToken cancellationToken = default, Action<InferenceClassificationRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.InferenceClassification> GetAsync(CancellationToken cancellationToken = default, Action<InferenceClassificationRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.InferenceClassification?> PatchAsync(Microsoft.Graph.Beta.Models.InferenceClassification body, CancellationToken cancellationToken = default, Action<InferenceClassificationRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.InferenceClassification> PatchAsync(Microsoft.Graph.Beta.Models.InferenceClassification body, CancellationToken cancellationToken = default, Action<InferenceClassificationRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
