...
using MicrosoftGraphSdk.Me.MobileAppTroubleshootingEvents.Item.AppLogCollectionRequests;
...
namespace MicrosoftGraphSdk.Me.MobileAppTroubleshootingEvents.Item {
    /// <summary>Builds and executes requests for operations under \me\mobileAppTroubleshootingEvents\{mobileAppTroubleshootingEvent-id}</summary>
    public class MobileAppTroubleshootingEventItemRequestBuilder {
        ...
        public MobileAppTroubleshootingEventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent_id}{?select,expand}";
