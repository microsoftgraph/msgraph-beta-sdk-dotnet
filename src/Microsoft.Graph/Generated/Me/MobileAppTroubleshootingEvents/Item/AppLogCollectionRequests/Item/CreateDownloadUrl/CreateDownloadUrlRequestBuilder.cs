...
namespace Microsoft.Graph.Beta.Me.MobileAppTroubleshootingEvents.Item.AppLogCollectionRequests.Item.CreateDownloadUrl {
    ...
    public class CreateDownloadUrlRequestBuilder {
        ...
        public async Task<AppLogCollectionDownloadDetails> PostAsync(Action<CreateDownloadUrlRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<AppLogCollectionDownloadDetails>(requestInfo, AppLogCollectionDownloadDetails.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
