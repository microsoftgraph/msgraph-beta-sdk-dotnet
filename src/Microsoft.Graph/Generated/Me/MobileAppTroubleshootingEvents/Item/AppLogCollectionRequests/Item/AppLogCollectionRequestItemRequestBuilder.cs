...
namespace MicrosoftGraphSdk.Me.MobileAppTroubleshootingEvents.Item.AppLogCollectionRequests.Item {
    ...
    public class AppLogCollectionRequestItemRequestBuilder {
        ...
        public AppLogCollectionRequestItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent_id}/appLogCollectionRequests/{appLogCollectionRequest_id}{?select,expand}";
