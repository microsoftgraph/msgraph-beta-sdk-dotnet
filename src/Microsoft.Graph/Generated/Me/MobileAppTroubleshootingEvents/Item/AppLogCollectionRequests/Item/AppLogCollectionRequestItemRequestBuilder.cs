...
namespace Microsoft.Graph.Beta.Me.MobileAppTroubleshootingEvents.Item.AppLogCollectionRequests.Item {
    ...
    public class AppLogCollectionRequestItemRequestBuilder : BaseRequestBuilder {
        ...
        public AppLogCollectionRequestItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}/appLogCollectionRequests/{appLogCollectionRequest%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AppLogCollectionRequestItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AppLogCollectionRequestItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}/appLogCollectionRequests/{appLogCollectionRequest%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AppLogCollectionRequestItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AppLogCollectionRequestItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AppLogCollectionRequest?> GetAsync(CancellationToken cancellationToken = default, Action<AppLogCollectionRequestItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AppLogCollectionRequest> GetAsync(CancellationToken cancellationToken = default, Action<AppLogCollectionRequestItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AppLogCollectionRequest?> PatchAsync(AppLogCollectionRequest body, CancellationToken cancellationToken = default, Action<AppLogCollectionRequestItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AppLogCollectionRequest> PatchAsync(AppLogCollectionRequest body, CancellationToken cancellationToken = default, Action<AppLogCollectionRequestItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
