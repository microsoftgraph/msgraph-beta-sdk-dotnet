...
using MicrosoftGraphSdk.Me.InformationProtection.SensitivityLabels.Count;
using MicrosoftGraphSdk.Me.InformationProtection.SensitivityLabels.Evaluate;
using MicrosoftGraphSdk.Me.InformationProtection.SensitivityLabels.Item;
...
namespace MicrosoftGraphSdk.Me.InformationProtection.SensitivityLabels {
    ...
    public class SensitivityLabelsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.informationProtection.sensitivityLabels.item collection</summary>
        ...
        public SensitivityLabelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/informationProtection/sensitivityLabels{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
