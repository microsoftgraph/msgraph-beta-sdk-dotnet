...
namespace Microsoft.Graph.Beta.Me.InformationProtection.SensitivityLabels {
    ...
    public class SensitivityLabelsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.informationProtection.sensitivityLabels.item collection</summary>
        ...
        public SensitivityLabelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/informationProtection/sensitivityLabels{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
