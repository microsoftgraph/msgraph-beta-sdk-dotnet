...
using MicrosoftGraphSdk.Me.InformationProtection.SensitivityLabels.Item.Sublabels.Count;
using MicrosoftGraphSdk.Me.InformationProtection.SensitivityLabels.Item.Sublabels.Evaluate;
using MicrosoftGraphSdk.Me.InformationProtection.SensitivityLabels.Item.Sublabels.Item;
...
namespace MicrosoftGraphSdk.Me.InformationProtection.SensitivityLabels.Item.Sublabels {
    ...
    public class SublabelsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.informationProtection.sensitivityLabels.item.sublabels.item collection</summary>
        public MicrosoftGraphSdk.Me.InformationProtection.SensitivityLabels.Item.Sublabels.Item.SensitivityLabelItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("sensitivityLabel_id1", position);
            return new MicrosoftGraphSdk.Me.InformationProtection.SensitivityLabels.Item.Sublabels.Item.SensitivityLabelItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
