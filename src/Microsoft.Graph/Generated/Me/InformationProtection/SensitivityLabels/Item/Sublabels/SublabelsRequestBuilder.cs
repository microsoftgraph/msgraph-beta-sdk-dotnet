...
namespace MicrosoftGraphSdk.Me.InformationProtection.SensitivityLabels.Item.Sublabels {
    ...
    public class SublabelsRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SensitivityLabel body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
