...
namespace MicrosoftGraphSdk.Me.InformationProtection.Policy.Labels.EvaluateClassificationResults {
    ...
    public class EvaluateClassificationResultsResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public EvaluateClassificationResultsResponse() {
        ...
        /// </summary>
        public static EvaluateClassificationResultsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as EvaluateClassificationResultsResponse).Value = n.GetCollectionOfObjectValues<InformationProtectionAction>(InformationProtectionAction.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
