...
namespace Microsoft.Graph.Beta.Me.InformationProtection.Policy.Labels {
    ...
    public class LabelsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.informationProtection.policy.labels.item collection</summary>
        ...
        public LabelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/informationProtection/policy/labels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
