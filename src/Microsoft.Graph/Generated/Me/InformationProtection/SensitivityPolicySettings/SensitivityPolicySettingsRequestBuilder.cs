...
namespace Microsoft.Graph.Beta.Me.InformationProtection.SensitivityPolicySettings {
    ...
    public class SensitivityPolicySettingsRequestBuilder : BaseRequestBuilder {
        ...
        public SensitivityPolicySettingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/informationProtection/sensitivityPolicySettings{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SensitivityPolicySettingsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SensitivityPolicySettingsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/informationProtection/sensitivityPolicySettings{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SensitivityPolicySettingsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SensitivityPolicySettingsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.SensitivityPolicySettings?> GetAsync(CancellationToken cancellationToken = default, Action<SensitivityPolicySettingsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.SensitivityPolicySettings> GetAsync(CancellationToken cancellationToken = default, Action<SensitivityPolicySettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.SensitivityPolicySettings?> PatchAsync(Microsoft.Graph.Beta.Models.SensitivityPolicySettings body, CancellationToken cancellationToken = default, Action<SensitivityPolicySettingsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.SensitivityPolicySettings> PatchAsync(Microsoft.Graph.Beta.Models.SensitivityPolicySettings body, CancellationToken cancellationToken = default, Action<SensitivityPolicySettingsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
