...
using MicrosoftGraphSdk.Me.InformationProtection.Bitlocker;
using MicrosoftGraphSdk.Me.InformationProtection.DataLossPreventionPolicies;
using MicrosoftGraphSdk.Me.InformationProtection.Policy;
using MicrosoftGraphSdk.Me.InformationProtection.SensitivityLabels;
using MicrosoftGraphSdk.Me.InformationProtection.SensitivityPolicySettings;
using MicrosoftGraphSdk.Me.InformationProtection.ThreatAssessmentRequests;
...
namespace MicrosoftGraphSdk.Me.InformationProtection {
    ...
    public class InformationProtectionRequestBuilder {
        ...
        public InformationProtectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/informationProtection{?select,expand}";
