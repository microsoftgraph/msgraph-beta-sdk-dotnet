...
namespace Microsoft.Graph.Beta.Me.InformationProtection.EncryptBuffer {
    ...
    public class EncryptBufferRequestBuilder : BaseRequestBuilder {
        ...
        public EncryptBufferRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/informationProtection/encryptBuffer", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EncryptBufferRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EncryptBufferRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/informationProtection/encryptBuffer", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<BufferEncryptionResult?> PostAsync(EncryptBufferPostRequestBody body, CancellationToken cancellationToken = default, Action<EncryptBufferRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BufferEncryptionResult> PostAsync(EncryptBufferPostRequestBody body, CancellationToken cancellationToken = default, Action<EncryptBufferRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
