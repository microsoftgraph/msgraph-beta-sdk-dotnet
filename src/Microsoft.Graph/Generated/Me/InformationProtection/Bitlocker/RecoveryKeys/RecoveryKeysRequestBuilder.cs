using Microsoft.Graph.Beta.Me.InformationProtection.Bitlocker.RecoveryKeys.Count;
using Microsoft.Graph.Beta.Me.InformationProtection.Bitlocker.RecoveryKeys.Item;
...
using System;
namespace Microsoft.Graph.Beta.Me.InformationProtection.Bitlocker.RecoveryKeys {
    /// <summary>
    ...
    public class RecoveryKeysRequestBuilder : BaseRequestBuilder {
        ...
        public RecoveryKeysRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/informationProtection/bitlocker/recoveryKeys{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RecoveryKeysRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecoveryKeysRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/informationProtection/bitlocker/recoveryKeys{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
