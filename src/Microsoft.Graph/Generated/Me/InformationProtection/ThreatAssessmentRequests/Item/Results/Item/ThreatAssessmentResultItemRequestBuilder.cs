...
namespace Microsoft.Graph.Beta.Me.InformationProtection.ThreatAssessmentRequests.Item.Results.Item {
    ...
    public class ThreatAssessmentResultItemRequestBuilder {
        ...
        public ThreatAssessmentResultItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}/results/{threatAssessmentResult%2Did}{?%24select,%24expand}";
