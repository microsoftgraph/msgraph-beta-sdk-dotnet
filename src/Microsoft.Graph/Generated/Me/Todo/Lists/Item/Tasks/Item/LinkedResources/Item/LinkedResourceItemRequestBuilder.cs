...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<LinkedResourceItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<LinkedResourceItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<LinkedResource?> GetAsync(CancellationToken cancellationToken = default, Action<LinkedResourceItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<LinkedResource> GetAsync(CancellationToken cancellationToken = default, Action<LinkedResourceItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<LinkedResource?> PatchAsync(LinkedResource body, CancellationToken cancellationToken = default, Action<LinkedResourceItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<LinkedResource> PatchAsync(LinkedResource body, CancellationToken cancellationToken = default, Action<LinkedResourceItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
