...
namespace Microsoft.Graph.Beta.Me.Todo.Lists.Item.Tasks.Item.Extensions.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/extensions/$count{?%24search,%24filter}";
