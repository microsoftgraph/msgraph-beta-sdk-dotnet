...
namespace Microsoft.Graph.Beta.Me.Todo.Lists.Item.Tasks.Delta {
    /// <summary>
    ...
    public class DeltaRequestBuilder {
        ...
        public DeltaRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/todo/lists/{todoTaskList%2Did}/tasks/microsoft.graph.delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
