...
namespace Microsoft.Graph.Beta.Me.CloudPCs.Item.EndGracePeriod {
    ...
    public class EndGracePeriodRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<EndGracePeriodRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
