...
using MicrosoftGraphSdk.Me.CloudPCs.Item.ChangeUserAccountType;
using MicrosoftGraphSdk.Me.CloudPCs.Item.EndGracePeriod;
using MicrosoftGraphSdk.Me.CloudPCs.Item.GetCloudPcLaunchInfo;
using MicrosoftGraphSdk.Me.CloudPCs.Item.Reboot;
using MicrosoftGraphSdk.Me.CloudPCs.Item.Rename;
using MicrosoftGraphSdk.Me.CloudPCs.Item.Reprovision;
using MicrosoftGraphSdk.Me.CloudPCs.Item.Troubleshoot;
...
namespace MicrosoftGraphSdk.Me.CloudPCs.Item {
    ...
    public class CloudPCItemRequestBuilder {
        ...
        public CloudPCItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/cloudPCs/{cloudPC_id}{?select,expand}";
