...
using MicrosoftGraphSdk.Me.Drives.Item.Items.Item.Subscriptions.Count;
using MicrosoftGraphSdk.Me.Drives.Item.Items.Item.Subscriptions.Item;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Items.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.drives.item.items.item.subscriptions.item collection</summary>
