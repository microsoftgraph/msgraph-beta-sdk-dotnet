...
using MicrosoftGraphSdk.Me.Drives.Item.Special.Item.Versions.Item.Content;
using MicrosoftGraphSdk.Me.Drives.Item.Special.Item.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Special.Item.Versions.Item {
    ...
    public class DriveItemVersionItemRequestBuilder {
        ...
        public DriveItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/special/{driveItem_id}/versions/{driveItemVersion_id}{?select,expand}";
