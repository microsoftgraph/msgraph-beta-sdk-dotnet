...
using MicrosoftGraphSdk.Me.Drives.Item.Special.Item.ListItem.Activities;
using MicrosoftGraphSdk.Me.Drives.Item.Special.Item.ListItem.Analytics;
using MicrosoftGraphSdk.Me.Drives.Item.Special.Item.ListItem.CreateLink;
using MicrosoftGraphSdk.Me.Drives.Item.Special.Item.ListItem.DriveItem;
using MicrosoftGraphSdk.Me.Drives.Item.Special.Item.ListItem.Fields;
using MicrosoftGraphSdk.Me.Drives.Item.Special.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Me.Drives.Item.Special.Item.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Special.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/special/{driveItem_id}/listItem{?select,expand}";
