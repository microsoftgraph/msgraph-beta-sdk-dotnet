...
using MicrosoftGraphSdk.Me.Drives.Item.Special.Item.Subscriptions.Count;
using MicrosoftGraphSdk.Me.Drives.Item.Special.Item.Subscriptions.Item;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Special.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.drives.item.special.item.subscriptions.item collection</summary>
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/special/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
