...
namespace MicrosoftGraphSdk.Me.Drives.Item.Following.Item.Permissions.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/following/{driveItem_id}/permissions/$count";
