...
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem.Versions.Item.Fields;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/following/{driveItem_id}/listItem/versions/{listItemVersion_id}{?select,expand}";
