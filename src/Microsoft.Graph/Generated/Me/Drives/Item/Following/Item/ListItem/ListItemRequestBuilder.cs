...
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem.Activities;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem.Analytics;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem.CreateLink;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem.DriveItem;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem.Fields;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/following/{driveItem_id}/listItem{?select,expand}";
