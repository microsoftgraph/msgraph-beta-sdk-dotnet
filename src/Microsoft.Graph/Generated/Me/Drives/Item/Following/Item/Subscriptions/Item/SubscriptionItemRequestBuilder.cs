...
namespace MicrosoftGraphSdk.Me.Drives.Item.Following.Item.Subscriptions.Item {
    ...
    public class SubscriptionItemRequestBuilder {
        ...
        public SubscriptionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/following/{driveItem_id}/subscriptions/{subscription_id}{?select,expand}";
