...
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.Versions.Item.Content;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Following.Item.Versions.Item {
    ...
    public class DriveItemVersionItemRequestBuilder {
        ...
        public DriveItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/following/{driveItem_id}/versions/{driveItemVersion_id}{?select,expand}";
