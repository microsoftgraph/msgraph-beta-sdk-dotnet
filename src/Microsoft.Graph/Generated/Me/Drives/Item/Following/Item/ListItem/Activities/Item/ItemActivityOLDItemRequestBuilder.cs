...
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem.Activities.Item.DriveItem;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem.Activities.Item.ListItem;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem.Activities.Item {
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/following/{driveItem_id}/listItem/activities/{itemActivityOLD_id}{?select,expand}";
