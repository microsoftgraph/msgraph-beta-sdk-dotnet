...
namespace Microsoft.Graph.Beta.Me.Drives.Item.Activities.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}/listItem{?%24select,%24expand}";
