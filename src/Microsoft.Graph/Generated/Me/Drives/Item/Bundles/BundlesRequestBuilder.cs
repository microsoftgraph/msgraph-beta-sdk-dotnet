...
namespace Microsoft.Graph.Beta.Me.Drives.Item.Bundles {
    ...
    public class BundlesRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<DriveItemCollectionResponse> GetAsync(Action<BundlesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
