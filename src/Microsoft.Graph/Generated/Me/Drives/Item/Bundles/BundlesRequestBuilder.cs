...
namespace Microsoft.Graph.Beta.Me.Drives.Item.Bundles {
    ...
    public class BundlesRequestBuilder {
        ...
        /// </summary>
        public async Task<DriveItemCollectionResponse> GetAsync(Action<BundlesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
