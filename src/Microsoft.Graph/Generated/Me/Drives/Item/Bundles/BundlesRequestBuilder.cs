...
namespace Microsoft.Graph.Beta.Me.Drives.Item.Bundles {
    ...
    public class BundlesRequestBuilder {
        ...
        /// </summary>
        public async Task<DriveItemCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<BundlesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
