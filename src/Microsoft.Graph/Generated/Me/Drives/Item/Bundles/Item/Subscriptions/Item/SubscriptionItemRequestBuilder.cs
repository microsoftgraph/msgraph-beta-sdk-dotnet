...
namespace MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.Subscriptions.Item {
    ...
    public class SubscriptionItemRequestBuilder {
        ...
        public SubscriptionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/bundles/{driveItem_id}/subscriptions/{subscription_id}{?select,expand}";
