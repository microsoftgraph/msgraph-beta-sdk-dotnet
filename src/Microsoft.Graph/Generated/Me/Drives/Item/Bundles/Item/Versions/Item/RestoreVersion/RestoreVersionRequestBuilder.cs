...
namespace MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.Versions.Item.RestoreVersion {
    ...
    public class RestoreVersionRequestBuilder {
        ...
        public RestoreVersionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/bundles/{driveItem_id}/versions/{driveItemVersion_id}/microsoft.graph.restoreVersion";
