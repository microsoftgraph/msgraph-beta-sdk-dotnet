...
namespace MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.ListItem.Activities.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/bundles/{driveItem_id}/listItem/activities/$count";
