...
using MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.Permissions.Item.Grant;
using MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.Permissions.Item.RevokeGrants;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.Permissions.Item {
    ...
    public class PermissionItemRequestBuilder {
        ...
        public PermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/bundles/{driveItem_id}/permissions/{permission_id}{?select,expand}";
