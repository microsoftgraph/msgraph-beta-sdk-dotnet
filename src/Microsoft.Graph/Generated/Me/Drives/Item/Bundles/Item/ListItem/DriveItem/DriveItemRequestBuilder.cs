...
using MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.ListItem.DriveItem.Content;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/bundles/{driveItem_id}/listItem/driveItem{?select,expand}";
