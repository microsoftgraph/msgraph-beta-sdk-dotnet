using Microsoft.Graph.Beta.Me.Drives.Item.Root.Permissions.Item.Grant;
using Microsoft.Graph.Beta.Me.Drives.Item.Root.Permissions.Item.RevokeGrants;
...
namespace Microsoft.Graph.Beta.Me.Drives.Item.Root.Permissions.Item {
    ...
    public class PermissionItemRequestBuilder {
        ...
        public PermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/root/permissions/{permission%2Did}{?%24select,%24expand}";
