using Microsoft.Graph.Beta.Me.Drives.Item.Root.ListItem.DriveItem.Content;
...
namespace Microsoft.Graph.Beta.Me.Drives.Item.Root.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/root/listItem/driveItem{?%24select,%24expand}";
