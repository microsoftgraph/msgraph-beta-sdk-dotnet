using Microsoft.Graph.Beta.Me.Drives.Item.Root.ListItem.Activities.Item.DriveItem.Content;
...
namespace Microsoft.Graph.Beta.Me.Drives.Item.Root.ListItem.Activities.Item.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/root/listItem/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}";
