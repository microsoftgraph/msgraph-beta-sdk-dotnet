...
using MicrosoftGraphSdk.Me.Drives.Item.Root.ListItem.Activities;
using MicrosoftGraphSdk.Me.Drives.Item.Root.ListItem.Analytics;
using MicrosoftGraphSdk.Me.Drives.Item.Root.ListItem.CreateLink;
using MicrosoftGraphSdk.Me.Drives.Item.Root.ListItem.DriveItem;
using MicrosoftGraphSdk.Me.Drives.Item.Root.ListItem.Fields;
using MicrosoftGraphSdk.Me.Drives.Item.Root.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Me.Drives.Item.Root.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Root.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public MicrosoftGraphSdk.Me.Drives.Item.Root.ListItem.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new MicrosoftGraphSdk.Me.Drives.Item.Root.ListItem.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
