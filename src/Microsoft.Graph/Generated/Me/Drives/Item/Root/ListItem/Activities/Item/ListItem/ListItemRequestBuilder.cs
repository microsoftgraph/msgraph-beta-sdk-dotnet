...
namespace Microsoft.Graph.Beta.Me.Drives.Item.Root.ListItem.Activities.Item.ListItem {
    /// <summary>
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/root/listItem/activities/{itemActivityOLD%2Did}/listItem{?%24select,%24expand}";
