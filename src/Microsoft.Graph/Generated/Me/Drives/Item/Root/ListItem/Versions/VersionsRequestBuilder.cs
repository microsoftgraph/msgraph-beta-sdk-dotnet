using Microsoft.Graph.Beta.Me.Drives.Item.Root.ListItem.Versions.Count;
using Microsoft.Graph.Beta.Me.Drives.Item.Root.ListItem.Versions.Item;
...
namespace Microsoft.Graph.Beta.Me.Drives.Item.Root.ListItem.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.drives.item.root.listItem.versions.item collection</summary>
        ...
        public VersionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/root/listItem/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
