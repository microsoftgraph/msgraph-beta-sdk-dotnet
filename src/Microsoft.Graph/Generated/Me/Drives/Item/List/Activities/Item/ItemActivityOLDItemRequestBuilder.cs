...
using MicrosoftGraphSdk.Me.Drives.Item.List.Activities.Item.DriveItem;
using MicrosoftGraphSdk.Me.Drives.Item.List.Activities.Item.ListItem;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.List.Activities.Item {
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/list/activities/{itemActivityOLD_id}{?select,expand}";
