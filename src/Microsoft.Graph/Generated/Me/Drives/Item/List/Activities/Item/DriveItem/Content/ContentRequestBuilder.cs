...
namespace MicrosoftGraphSdk.Me.Drives.Item.List.Activities.Item.DriveItem.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/list/activities/{itemActivityOLD_id}/driveItem/content";
