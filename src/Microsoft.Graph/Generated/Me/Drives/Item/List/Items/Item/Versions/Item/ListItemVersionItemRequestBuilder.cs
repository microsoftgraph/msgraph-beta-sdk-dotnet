using Microsoft.Graph.Beta.Me.Drives.Item.List.Items.Item.Versions.Item.Fields;
using Microsoft.Graph.Beta.Me.Drives.Item.List.Items.Item.Versions.Item.RestoreVersion;
...
namespace Microsoft.Graph.Beta.Me.Drives.Item.List.Items.Item.Versions.Item {
    /// <summary>
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/items/{listItem%2Did}/versions/{listItemVersion%2Did}{?%24select,%24expand}";
