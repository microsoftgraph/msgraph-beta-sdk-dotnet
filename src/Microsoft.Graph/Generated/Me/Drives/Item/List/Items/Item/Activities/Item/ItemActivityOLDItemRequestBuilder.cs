using Microsoft.Graph.Beta.Me.Drives.Item.List.Items.Item.Activities.Item.DriveItem;
using Microsoft.Graph.Beta.Me.Drives.Item.List.Items.Item.Activities.Item.ListItem;
...
namespace Microsoft.Graph.Beta.Me.Drives.Item.List.Items.Item.Activities.Item {
    /// <summary>
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Me.Drives.Item.List.Items.Item.Activities.Item.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new Microsoft.Graph.Beta.Me.Drives.Item.List.Items.Item.Activities.Item.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}";
