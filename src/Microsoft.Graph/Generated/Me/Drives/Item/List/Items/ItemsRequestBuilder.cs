using Microsoft.Graph.Beta.Me.Drives.Item.List.Items.Count;
using Microsoft.Graph.Beta.Me.Drives.Item.List.Items.Delta;
using Microsoft.Graph.Beta.Me.Drives.Item.List.Items.DeltaWithToken;
using Microsoft.Graph.Beta.Me.Drives.Item.List.Items.Item;
...
namespace Microsoft.Graph.Beta.Me.Drives.Item.List.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.me.drives.item.list.items.item collection</summary>
        ...
        public ItemsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/items{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
