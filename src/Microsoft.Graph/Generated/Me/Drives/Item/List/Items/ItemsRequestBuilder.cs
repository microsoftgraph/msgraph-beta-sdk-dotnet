...
using MicrosoftGraphSdk.Me.Drives.Item.List.Items.Count;
using MicrosoftGraphSdk.Me.Drives.Item.List.Items.Delta;
using MicrosoftGraphSdk.Me.Drives.Item.List.Items.DeltaWithToken;
using MicrosoftGraphSdk.Me.Drives.Item.List.Items.Item;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.List.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.drives.item.list.items.item collection</summary>
