...
using MicrosoftGraphSdk.Me.Drives.Item.List.Items.Item.Activities;
using MicrosoftGraphSdk.Me.Drives.Item.List.Items.Item.Analytics;
using MicrosoftGraphSdk.Me.Drives.Item.List.Items.Item.CreateLink;
using MicrosoftGraphSdk.Me.Drives.Item.List.Items.Item.DriveItem;
using MicrosoftGraphSdk.Me.Drives.Item.List.Items.Item.Fields;
using MicrosoftGraphSdk.Me.Drives.Item.List.Items.Item.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Me.Drives.Item.List.Items.Item.Versions;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.List.Items.Item {
    ...
    public class ListItemItemRequestBuilder {
        ...
        public MicrosoftGraphSdk.Me.Drives.Item.List.Items.Item.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new MicrosoftGraphSdk.Me.Drives.Item.List.Items.Item.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
