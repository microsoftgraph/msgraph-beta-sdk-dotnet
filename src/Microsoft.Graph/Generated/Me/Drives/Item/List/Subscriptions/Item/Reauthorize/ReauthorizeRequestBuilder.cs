...
namespace Microsoft.Graph.Beta.Me.Drives.Item.List.Subscriptions.Item.Reauthorize {
    ...
    public class ReauthorizeRequestBuilder {
        ...
        public ReauthorizeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize";
