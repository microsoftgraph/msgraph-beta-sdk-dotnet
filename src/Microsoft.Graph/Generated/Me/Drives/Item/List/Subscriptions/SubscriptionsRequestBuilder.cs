...
using MicrosoftGraphSdk.Me.Drives.Item.List.Subscriptions.Count;
using MicrosoftGraphSdk.Me.Drives.Item.List.Subscriptions.Item;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.List.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.drives.item.list.subscriptions.item collection</summary>
