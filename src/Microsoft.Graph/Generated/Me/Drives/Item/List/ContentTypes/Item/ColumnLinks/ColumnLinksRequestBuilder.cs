...
namespace Microsoft.Graph.Beta.Me.Drives.Item.List.ContentTypes.Item.ColumnLinks {
    ...
    public class ColumnLinksRequestBuilder {
        ...
        /// </summary>
        public async Task<ColumnLinkCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ColumnLinksRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ColumnLink> PostAsync(ColumnLink body, CancellationToken cancellationToken = default, Action<ColumnLinksRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
