...
namespace MicrosoftGraphSdk.Me.InvalidateAllRefreshTokens {
    ...
    public class InvalidateAllRefreshTokensRequestBuilder {
        ...
        /// </summary>
        public async Task<InvalidateAllRefreshTokensResponse> PostAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
