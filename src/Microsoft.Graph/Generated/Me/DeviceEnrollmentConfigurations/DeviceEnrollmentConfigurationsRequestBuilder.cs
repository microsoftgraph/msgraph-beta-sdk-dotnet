...
namespace MicrosoftGraphSdk.Me.DeviceEnrollmentConfigurations {
    /// <summary>Builds and executes requests for operations under \me\deviceEnrollmentConfigurations</summary>
    public class DeviceEnrollmentConfigurationsRequestBuilder {
        ...
        public DeviceEnrollmentConfigurationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/deviceEnrollmentConfigurations{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
