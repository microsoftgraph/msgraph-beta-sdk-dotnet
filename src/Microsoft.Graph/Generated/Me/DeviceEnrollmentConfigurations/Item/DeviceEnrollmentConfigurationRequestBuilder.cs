...
using MicrosoftGraph.Me.DeviceEnrollmentConfigurations.Item.Assign;
using MicrosoftGraph.Me.DeviceEnrollmentConfigurations.Item.Assignments;
using MicrosoftGraph.Me.DeviceEnrollmentConfigurations.Item.SetPriority;
...
namespace MicrosoftGraph.Me.DeviceEnrollmentConfigurations.Item {
    /// <summary>Builds and executes requests for operations under \me\deviceEnrollmentConfigurations\{deviceEnrollmentConfiguration-id}</summary>
    public class DeviceEnrollmentConfigurationRequestBuilder {
        ...
        public DeviceEnrollmentConfigurationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration_id}{?select,expand}";
