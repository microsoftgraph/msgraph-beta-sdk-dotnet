using Microsoft.Graph.Beta.Me.DeviceEnrollmentConfigurations.Item.Assign;
using Microsoft.Graph.Beta.Me.DeviceEnrollmentConfigurations.Item.Assignments;
using Microsoft.Graph.Beta.Me.DeviceEnrollmentConfigurations.Item.SetPriority;
...
using System;
namespace Microsoft.Graph.Beta.Me.DeviceEnrollmentConfigurations.Item {
    /// <summary>
    ...
    public class DeviceEnrollmentConfigurationItemRequestBuilder : BaseRequestBuilder {
        ...
        public DeviceEnrollmentConfigurationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DeviceEnrollmentConfigurationItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeviceEnrollmentConfigurationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
