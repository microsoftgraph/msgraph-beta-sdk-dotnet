using Microsoft.Graph.Beta.Chats.Item.InstalledApps.Count;
using Microsoft.Graph.Beta.Chats.Item.InstalledApps.Item;
...
namespace Microsoft.Graph.Beta.Chats.Item.InstalledApps {
    ...
    public class InstalledAppsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.chats.item.installedApps.item collection</summary>
        ...
        public InstalledAppsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/chats/{chat%2Did}/installedApps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
