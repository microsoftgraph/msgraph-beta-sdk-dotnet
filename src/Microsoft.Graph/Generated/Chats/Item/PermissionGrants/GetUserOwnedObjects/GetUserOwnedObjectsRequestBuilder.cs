...
namespace Microsoft.Graph.Beta.Chats.Item.PermissionGrants.GetUserOwnedObjects {
    ...
    public class GetUserOwnedObjectsRequestBuilder : BaseRequestBuilder {
        ...
        public GetUserOwnedObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/chats/{chat%2Did}/permissionGrants/getUserOwnedObjects", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetUserOwnedObjectsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetUserOwnedObjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/chats/{chat%2Did}/permissionGrants/getUserOwnedObjects", rawUrl) {
        }
        /// <summary>
