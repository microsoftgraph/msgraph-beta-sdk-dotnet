using Microsoft.Graph.Beta.Chats.Item.PermissionGrants.Item.CheckMemberGroups;
using Microsoft.Graph.Beta.Chats.Item.PermissionGrants.Item.CheckMemberObjects;
using Microsoft.Graph.Beta.Chats.Item.PermissionGrants.Item.GetMemberGroups;
using Microsoft.Graph.Beta.Chats.Item.PermissionGrants.Item.GetMemberObjects;
using Microsoft.Graph.Beta.Chats.Item.PermissionGrants.Item.Restore;
...
namespace Microsoft.Graph.Beta.Chats.Item.PermissionGrants.Item {
    ...
    public class ResourceSpecificPermissionGrantItemRequestBuilder {
        ...
        public ResourceSpecificPermissionGrantItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/chats/{chat%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ResourceSpecificPermissionGrantItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ResourceSpecificPermissionGrant> GetAsync(CancellationToken cancellationToken = default, Action<ResourceSpecificPermissionGrantItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ResourceSpecificPermissionGrant body, CancellationToken cancellationToken = default, Action<ResourceSpecificPermissionGrantItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
