...
namespace Microsoft.Graph.Beta.Chats.Item.HideForUser {
    ...
    public class HideForUserRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static HideForUserRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
