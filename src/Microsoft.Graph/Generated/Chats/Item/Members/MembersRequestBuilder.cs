...
using MicrosoftGraphSdk.Chats.Item.Members.Add;
using MicrosoftGraphSdk.Chats.Item.Members.Count;
using MicrosoftGraphSdk.Chats.Item.Members.Item;
...
namespace MicrosoftGraphSdk.Chats.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.chats.item.members.item collection</summary>
