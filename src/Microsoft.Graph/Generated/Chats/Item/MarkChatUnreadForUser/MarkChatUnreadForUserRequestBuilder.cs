...
namespace Microsoft.Graph.Beta.Chats.Item.MarkChatUnreadForUser {
    ...
    public class MarkChatUnreadForUserRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MarkChatUnreadForUserRequestBody body, Action<MarkChatUnreadForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(MarkChatUnreadForUserRequestBody body, Action<MarkChatUnreadForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
