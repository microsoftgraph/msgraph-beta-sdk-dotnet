...
namespace Microsoft.Graph.Beta.Chats.Item.UnhideForUser {
    ...
    public class UnhideForUserRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(UnhideForUserRequestBody body, Action<UnhideForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(UnhideForUserRequestBody body, Action<UnhideForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
