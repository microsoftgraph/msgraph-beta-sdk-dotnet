...
using Microsoft.Graph.Beta.Chats.Item.Messages.Item.SetReaction;
...
using Microsoft.Graph.Beta.Chats.Item.Messages.Item.UnsetReaction;
...
namespace Microsoft.Graph.Beta.Chats.Item.Messages.Item {
    ...
    public class ChatMessageItemRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/chats/{chat%2Did}/messages/{chatMessage%2Did}{?%24select,%24expand}";
