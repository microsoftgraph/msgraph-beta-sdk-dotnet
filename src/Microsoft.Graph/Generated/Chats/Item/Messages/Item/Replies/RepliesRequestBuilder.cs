...
namespace Microsoft.Graph.Beta.Chats.Item.Messages.Item.Replies {
    ...
    public class RepliesRequestBuilder : BaseRequestBuilder {
        ...
        public RepliesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RepliesRequestBuilder and sets the default values.
        /// </summary>
