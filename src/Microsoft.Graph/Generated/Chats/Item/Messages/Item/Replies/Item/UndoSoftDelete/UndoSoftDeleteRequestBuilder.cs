...
namespace Microsoft.Graph.Beta.Chats.Item.Messages.Item.Replies.Item.UndoSoftDelete {
    ...
    public class UndoSoftDeleteRequestBuilder {
        ...
        public UndoSoftDeleteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/chats/{chat_id}/messages/{chatMessage_id}/replies/{chatMessage_id1}/microsoft.graph.undoSoftDelete";
