...
namespace Microsoft.Graph.Beta.Chats.Item.MarkChatReadForUser {
    ...
    public class MarkChatReadForUserRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MarkChatReadForUserRequestBody body, Action<MarkChatReadForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(MarkChatReadForUserRequestBody body, Action<MarkChatReadForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
