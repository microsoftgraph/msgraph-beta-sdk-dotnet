...
namespace Microsoft.Graph.Beta.Domains.Item.SharedEmailDomainInvitations.Item {
    ...
    public class SharedEmailDomainInvitationItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SharedEmailDomainInvitationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SharedEmailDomainInvitation> GetAsync(CancellationToken cancellationToken = default, Action<SharedEmailDomainInvitationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SharedEmailDomainInvitation body, CancellationToken cancellationToken = default, Action<SharedEmailDomainInvitationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
