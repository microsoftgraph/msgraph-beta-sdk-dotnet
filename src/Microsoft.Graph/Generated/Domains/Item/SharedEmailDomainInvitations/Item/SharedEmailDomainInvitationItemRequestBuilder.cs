...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SharedEmailDomainInvitationItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SharedEmailDomainInvitationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SharedEmailDomainInvitation?> GetAsync(CancellationToken cancellationToken = default, Action<SharedEmailDomainInvitationItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SharedEmailDomainInvitation> GetAsync(CancellationToken cancellationToken = default, Action<SharedEmailDomainInvitationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SharedEmailDomainInvitation?> PatchAsync(SharedEmailDomainInvitation body, CancellationToken cancellationToken = default, Action<SharedEmailDomainInvitationItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SharedEmailDomainInvitation> PatchAsync(SharedEmailDomainInvitation body, CancellationToken cancellationToken = default, Action<SharedEmailDomainInvitationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
