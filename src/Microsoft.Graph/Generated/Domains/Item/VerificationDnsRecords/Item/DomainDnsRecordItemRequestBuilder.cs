...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DomainDnsRecordItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DomainDnsRecordItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DomainDnsRecord?> GetAsync(CancellationToken cancellationToken = default, Action<DomainDnsRecordItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DomainDnsRecord> GetAsync(CancellationToken cancellationToken = default, Action<DomainDnsRecordItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DomainDnsRecord?> PatchAsync(DomainDnsRecord body, CancellationToken cancellationToken = default, Action<DomainDnsRecordItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DomainDnsRecord> PatchAsync(DomainDnsRecord body, CancellationToken cancellationToken = default, Action<DomainDnsRecordItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
