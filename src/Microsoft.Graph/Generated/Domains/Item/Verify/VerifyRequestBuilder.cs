...
namespace Microsoft.Graph.Beta.Domains.Item.Verify {
    ...
    public class VerifyRequestBuilder {
        ...
        /// </summary>
        public async Task<Domain> PostAsync(CancellationToken cancellationToken = default, Action<VerifyRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
