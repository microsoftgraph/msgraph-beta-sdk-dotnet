...
namespace Microsoft.Graph.Beta.Domains.Item.Verify {
    ...
    public class VerifyRequestBuilder {
        ...
        /// </summary>
        public async Task<Domain> PostAsync(Action<VerifyRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
