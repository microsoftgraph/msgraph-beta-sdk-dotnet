...
namespace MicrosoftGraphSdk.Domains.Item.Verify {
    ...
    public class VerifyRequestBuilder {
        ...
        public class VerifyResponse : IParsable, IAdditionalDataHolder {
            ...
            public MicrosoftGraphSdk.Models.Microsoft.Graph.Domain Domain { get; set; }
            /// <summary>
            ...
            public static VerifyResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"domain", (o,n) => { (o as VerifyResponse).Domain = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Domain>(MicrosoftGraphSdk.Models.Microsoft.Graph.Domain.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
            ...
            public void Serialize(ISerializationWriter writer) {
                ...
                writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Domain>("domain", Domain);
