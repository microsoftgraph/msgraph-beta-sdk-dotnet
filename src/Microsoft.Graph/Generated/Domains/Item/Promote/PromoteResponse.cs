...
namespace Microsoft.Graph.Beta.Domains.Item.Promote {
    public class PromoteResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public static PromoteResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
