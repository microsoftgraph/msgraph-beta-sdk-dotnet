...
namespace Microsoft.Graph.Beta.Domains.Item.Promote {
    ...
    public class PromoteRequestBuilder {
        ...
        public async Task<PromoteResponse> PostAsync(Action<PromoteRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<PromoteResponse>(requestInfo, PromoteResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
