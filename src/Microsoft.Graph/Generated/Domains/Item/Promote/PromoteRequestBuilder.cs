...
namespace Microsoft.Graph.Beta.Domains.Item.Promote {
    ...
    public class PromoteRequestBuilder {
        ...
        /// </summary>
        public async Task<PromoteResponse> PostAsync(CancellationToken cancellationToken = default, Action<PromoteRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
