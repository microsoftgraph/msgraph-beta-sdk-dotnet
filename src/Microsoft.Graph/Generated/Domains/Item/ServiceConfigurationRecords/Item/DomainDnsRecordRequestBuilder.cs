...
namespace MicrosoftGraph.Domains.Item.ServiceConfigurationRecords.Item {
    ...
    public class DomainDnsRecordRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public DomainDnsRecordRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
