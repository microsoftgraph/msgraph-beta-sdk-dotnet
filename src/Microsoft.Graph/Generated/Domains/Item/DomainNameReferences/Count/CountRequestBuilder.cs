...
namespace Microsoft.Graph.Beta.Domains.Item.DomainNameReferences.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/domains/{domain%2Did}/domainNameReferences/$count{?%24search,%24filter}";
