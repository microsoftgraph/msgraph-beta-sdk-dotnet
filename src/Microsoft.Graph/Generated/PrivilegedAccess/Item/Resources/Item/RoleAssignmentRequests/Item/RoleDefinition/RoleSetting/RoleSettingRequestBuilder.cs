...
namespace Microsoft.Graph.Beta.PrivilegedAccess.Item.Resources.Item.RoleAssignmentRequests.Item.RoleDefinition.RoleSetting {
    ...
    public class RoleSettingRequestBuilder {
        ...
        /// </summary>
        public async Task<GovernanceRoleSetting> GetAsync(CancellationToken cancellationToken = default, Action<RoleSettingRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
