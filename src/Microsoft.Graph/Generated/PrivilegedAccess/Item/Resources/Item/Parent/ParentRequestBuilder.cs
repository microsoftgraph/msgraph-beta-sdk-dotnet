...
namespace Microsoft.Graph.Beta.PrivilegedAccess.Item.Resources.Item.Parent {
    ...
    public class ParentRequestBuilder {
        ...
        /// </summary>
        public async Task<GovernanceResource> GetAsync(Action<ParentRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
