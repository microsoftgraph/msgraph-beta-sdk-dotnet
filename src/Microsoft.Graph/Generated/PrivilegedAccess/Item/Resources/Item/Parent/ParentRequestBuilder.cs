...
namespace Microsoft.Graph.Beta.PrivilegedAccess.Item.Resources.Item.Parent {
    ...
    public class ParentRequestBuilder {
        ...
        public ParentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/parent{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<GovernanceResource> GetAsync(CancellationToken cancellationToken = default, Action<ParentRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
