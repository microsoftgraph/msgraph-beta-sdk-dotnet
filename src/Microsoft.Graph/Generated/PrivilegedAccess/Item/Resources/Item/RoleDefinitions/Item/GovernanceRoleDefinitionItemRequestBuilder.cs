...
using Microsoft.Graph.Beta.PrivilegedAccess.Item.Resources.Item.RoleDefinitions.Item.Resource;
using Microsoft.Graph.Beta.PrivilegedAccess.Item.Resources.Item.RoleDefinitions.Item.RoleSetting;
...
using System;
namespace Microsoft.Graph.Beta.PrivilegedAccess.Item.Resources.Item.RoleDefinitions.Item {
    /// <summary>
    ...
    public class GovernanceRoleDefinitionItemRequestBuilder : BaseRequestBuilder {
        ...
        public GovernanceRoleDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleDefinitions/{governanceRoleDefinition%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GovernanceRoleDefinitionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GovernanceRoleDefinitionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleDefinitions/{governanceRoleDefinition%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
