...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<GovernanceResourceItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<GovernanceResourceItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<GovernanceResource?> GetAsync(CancellationToken cancellationToken = default, Action<GovernanceResourceItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GovernanceResource> GetAsync(CancellationToken cancellationToken = default, Action<GovernanceResourceItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<GovernanceResource?> PatchAsync(GovernanceResource body, CancellationToken cancellationToken = default, Action<GovernanceResourceItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GovernanceResource> PatchAsync(GovernanceResource body, CancellationToken cancellationToken = default, Action<GovernanceResourceItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
