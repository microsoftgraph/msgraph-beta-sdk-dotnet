...
namespace Microsoft.Graph.Beta.PrivilegedAccess.Item.Resources.Item.RoleAssignments.Item.LinkedEligibleRoleAssignment {
    ...
    public class LinkedEligibleRoleAssignmentRequestBuilder {
        ...
        public LinkedEligibleRoleAssignmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess_id}/resources/{governanceResource_id}/roleAssignments/{governanceRoleAssignment_id}/linkedEligibleRoleAssignment{?select,expand}";
