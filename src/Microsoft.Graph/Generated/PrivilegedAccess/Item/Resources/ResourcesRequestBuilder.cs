...
namespace Microsoft.Graph.Beta.PrivilegedAccess.Item.Resources {
    ...
    public class ResourcesRequestBuilder {
        ...
        /// </summary>
        public async Task<GovernanceResourceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ResourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GovernanceResource> PostAsync(GovernanceResource body, CancellationToken cancellationToken = default, Action<ResourcesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
