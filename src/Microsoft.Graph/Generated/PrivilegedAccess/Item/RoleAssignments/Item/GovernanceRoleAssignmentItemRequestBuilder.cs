...
namespace MicrosoftGraphSdk.PrivilegedAccess.Item.RoleAssignments.Item {
    /// <summary>Builds and executes requests for operations under \privilegedAccess\{privilegedAccess-id}\roleAssignments\{governanceRoleAssignment-id}</summary>
    public class GovernanceRoleAssignmentItemRequestBuilder {
        ...
        public GovernanceRoleAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess_id}/roleAssignments/{governanceRoleAssignment_id}{?select,expand}";
