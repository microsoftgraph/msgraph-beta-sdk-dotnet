...
namespace Microsoft.Graph.Beta.PrivilegedAccess.Item.RoleAssignments.Item.LinkedEligibleRoleAssignment {
    ...
    public class LinkedEligibleRoleAssignmentRequestBuilder {
        ...
        public LinkedEligibleRoleAssignmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignments/{governanceRoleAssignment%2Did}/linkedEligibleRoleAssignment{?%24select,%24expand}";
