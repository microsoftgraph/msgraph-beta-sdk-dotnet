...
namespace MicrosoftGraphSdk.PrivilegedAccess.Item.RoleAssignments.Item.LinkedEligibleRoleAssignment {
    ...
    public class LinkedEligibleRoleAssignmentRequestBuilder {
        ...
        public LinkedEligibleRoleAssignmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess_id}/roleAssignments/{governanceRoleAssignment_id}/linkedEligibleRoleAssignment{?select,expand}";
