...
namespace Microsoft.Graph.Beta.PrivilegedAccess.Item.RoleAssignmentRequests.Item.RoleDefinition {
    ...
    public class RoleDefinitionRequestBuilder {
        ...
        public RoleDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}/roleDefinition{?%24select,%24expand}";
