...
namespace Microsoft.Graph.Beta.GovernanceRoleSettings {
    ...
    public class GovernanceRoleSettingsRequestBuilder {
        ...
        /// </summary>
        public async Task<GovernanceRoleSettingCollectionResponse> GetAsync(Action<GovernanceRoleSettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GovernanceRoleSetting> PostAsync(GovernanceRoleSetting body, Action<GovernanceRoleSettingsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
