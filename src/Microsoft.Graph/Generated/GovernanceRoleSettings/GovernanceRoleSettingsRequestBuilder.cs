...
#nullable enable
        public async Task<GovernanceRoleSettingCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GovernanceRoleSettingsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GovernanceRoleSettingCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<GovernanceRoleSettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<GovernanceRoleSetting?> PostAsync(GovernanceRoleSetting body, CancellationToken cancellationToken = default, Action<GovernanceRoleSettingsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GovernanceRoleSetting> PostAsync(GovernanceRoleSetting body, CancellationToken cancellationToken = default, Action<GovernanceRoleSettingsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
