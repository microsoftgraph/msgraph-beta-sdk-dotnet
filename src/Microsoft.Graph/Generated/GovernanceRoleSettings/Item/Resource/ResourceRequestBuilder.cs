...
using MicrosoftGraphSdk.GovernanceRoleSettings.Item.Resource.Ref;
...
namespace MicrosoftGraphSdk.GovernanceRoleSettings.Item.Resource {
    /// <summary>Builds and executes requests for operations under \governanceRoleSettings\{governanceRoleSetting-id}\resource</summary>
    public class ResourceRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/governanceRoleSettings/{governanceRoleSetting_id}/resource{?select,expand}";
