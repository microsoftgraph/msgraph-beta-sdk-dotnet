...
using MicrosoftGraph.GovernanceRoleSettings.Item.Resource;
using MicrosoftGraph.GovernanceRoleSettings.Item.RoleDefinition;
...
namespace MicrosoftGraph.GovernanceRoleSettings.Item {
    /// <summary>Builds and executes requests for operations under \governanceRoleSettings\{governanceRoleSetting-id}</summary>
    public class GovernanceRoleSettingRequestBuilder {
        ...
        public GovernanceRoleSettingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/governanceRoleSettings/{governanceRoleSetting_id}{?select,expand}";
        ...
        /// <summary>Get entity from governanceRoleSettings by key</summary>
