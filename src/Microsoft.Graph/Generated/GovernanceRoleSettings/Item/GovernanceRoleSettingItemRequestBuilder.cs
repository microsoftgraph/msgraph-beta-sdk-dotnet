...
namespace Microsoft.Graph.Beta.GovernanceRoleSettings.Item {
    ...
    public class GovernanceRoleSettingItemRequestBuilder : BaseRequestBuilder {
        ...
        public GovernanceRoleSettingItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/governanceRoleSettings/{governanceRoleSetting%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GovernanceRoleSettingItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GovernanceRoleSettingItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/governanceRoleSettings/{governanceRoleSetting%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
