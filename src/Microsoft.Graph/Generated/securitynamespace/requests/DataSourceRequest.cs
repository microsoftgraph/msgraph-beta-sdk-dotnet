...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    public partial class DataSourceRequest : Microsoft.Graph.BaseRequest, IDataSourceRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<DataSource> PutAsync(DataSource dataSourceToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="dataSourceToUpdate">The DataSource object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{DataSource}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DataSource>> PutResponseAsync(DataSource dataSourceToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<DataSource>(dataSourceToUpdate, cancellationToken);
