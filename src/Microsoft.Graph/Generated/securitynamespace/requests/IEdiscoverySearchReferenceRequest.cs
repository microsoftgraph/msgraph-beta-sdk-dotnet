...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// </summary>
    public partial interface IEdiscoverySearchReferenceRequest : Microsoft.Graph.IBaseRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Puts the specified EdiscoverySearch reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The EdiscoverySearch reference reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
