...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// </summary>
    public partial class DataSourceWithReferenceRequest : Microsoft.Graph.BaseRequest, IDataSourceWithReferenceRequest
    {
        /// <summary>
        ...
        public DataSourceWithReferenceRequest(
            string requestUrl,
        ...
        public async System.Threading.Tasks.Task<DataSource> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DataSource>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<DataSource> CreateAsync(DataSource dataSourceToCreate, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DataSource}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DataSource>> CreateResponseAsync(DataSource dataSourceToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<DataSource> UpdateAsync(DataSource dataSourceToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="Microsoft.Graph.ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DataSource}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DataSource>> UpdateResponseAsync(DataSource dataSourceToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        public IDataSourceWithReferenceRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDataSourceWithReferenceRequest Expand(Expression<Func<DataSource, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDataSourceWithReferenceRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDataSourceWithReferenceRequest Select(Expression<Func<DataSource, object>> selectExpression)
        {
