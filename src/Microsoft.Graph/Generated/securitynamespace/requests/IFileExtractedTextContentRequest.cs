...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// <summary>
    /// The interface IFileExtractedTextContentRequest.
    /// </summary>
    public partial interface IFileExtractedTextContentRequest : Microsoft.Graph.IBaseRequest
    {
        ...
        /// <param name="extractedTextContent">The stream to PUT.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="Microsoft.Graph.IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream extractedTextContent, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : File;
        ...
        System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream extractedTextContent, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : File;
