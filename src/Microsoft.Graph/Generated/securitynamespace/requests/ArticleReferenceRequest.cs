...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// <summary>
    /// The type ArticleReferenceRequest.
    /// </summary>
    public partial class ArticleReferenceRequest : Microsoft.Graph.BaseRequest, IArticleReferenceRequest
    {
        /// <summary>
        /// Constructs a new ArticleReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ArticleReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified Article reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified Article reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified Article reference.
        /// </summary>
        /// <param name="id">The Article reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified Article reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The Article reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
