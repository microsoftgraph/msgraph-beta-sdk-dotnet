...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// <summary>
    /// The type WhoisHistoryRecordReferenceRequest.
    /// </summary>
    public partial class WhoisHistoryRecordReferenceRequest : Microsoft.Graph.BaseRequest, IWhoisHistoryRecordReferenceRequest
    {
        /// <summary>
        /// Constructs a new WhoisHistoryRecordReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public WhoisHistoryRecordReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified WhoisHistoryRecord reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified WhoisHistoryRecord reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified WhoisHistoryRecord reference.
        /// </summary>
        /// <param name="id">The WhoisHistoryRecord reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified WhoisHistoryRecord reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The WhoisHistoryRecord reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
