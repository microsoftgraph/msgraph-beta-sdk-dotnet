...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// </summary>
    public partial interface IEdiscoveryCaseOperationsCollectionRequestBuilder : Microsoft.Graph.IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IEdiscoveryCaseOperationsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IEdiscoveryCaseOperationsCollectionRequest Request(IEnumerable<Microsoft.Graph.Option> options);
