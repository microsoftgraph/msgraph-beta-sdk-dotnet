...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// <summary>
    /// The type RetentionEventTypeReferenceRequest.
    /// </summary>
    public partial class RetentionEventTypeReferenceRequest : Microsoft.Graph.BaseRequest, IRetentionEventTypeReferenceRequest
    {
        /// <summary>
        /// Constructs a new RetentionEventTypeReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public RetentionEventTypeReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified RetentionEventType reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified RetentionEventType reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified RetentionEventType reference.
        /// </summary>
        /// <param name="id">The RetentionEventType reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified RetentionEventType reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The RetentionEventType reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
