...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// <summary>
    /// The type CategoryTemplateReferenceRequest.
    /// </summary>
    public partial class CategoryTemplateReferenceRequest : Microsoft.Graph.BaseRequest, ICategoryTemplateReferenceRequest
    {
        /// <summary>
        /// Constructs a new CategoryTemplateReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public CategoryTemplateReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified CategoryTemplate reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified CategoryTemplate reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified CategoryTemplate reference.
        /// </summary>
        /// <param name="id">The CategoryTemplate reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified CategoryTemplate reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The CategoryTemplate reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
