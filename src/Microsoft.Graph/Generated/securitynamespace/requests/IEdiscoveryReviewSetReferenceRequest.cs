...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// </summary>
    public partial interface IEdiscoveryReviewSetReferenceRequest : Microsoft.Graph.IBaseRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Deletes the specified EdiscoveryReviewSet reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified EdiscoveryReviewSet reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The EdiscoveryReviewSet reference reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
