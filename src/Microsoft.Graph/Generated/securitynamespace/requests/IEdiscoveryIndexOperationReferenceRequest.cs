...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// </summary>
    public partial interface IEdiscoveryIndexOperationReferenceRequest : Microsoft.Graph.IBaseRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Deletes the specified EdiscoveryIndexOperation reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified EdiscoveryIndexOperation reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The EdiscoveryIndexOperation reference reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
