...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// <summary>
    /// The type FileExtractedTextContentRequest.
    /// </summary>
    public partial class FileExtractedTextContentRequest : Microsoft.Graph.BaseRequest, IFileExtractedTextContentRequest
    {
        /// <summary>
        /// Constructs a new FileExtractedTextContentRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public FileExtractedTextContentRequest(
            string requestUrl,
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream extractedTextContent, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : File
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
            return this.SendAsync<T>(extractedTextContent, cancellationToken, completionOption);
        }
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream extractedTextContent, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : File
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<T>(extractedTextContent, cancellationToken, completionOption);
        }
