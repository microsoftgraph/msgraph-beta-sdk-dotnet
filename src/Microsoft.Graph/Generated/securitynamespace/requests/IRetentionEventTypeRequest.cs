...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// <summary>
    /// The interface IRetentionEventTypeRequest.
    /// </summary>
    public partial interface IRetentionEventTypeRequest : Microsoft.Graph.IBaseRequest
    {
        /// <summary>
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<RetentionEventType> PutAsync(RetentionEventType retentionEventTypeToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="retentionEventTypeToUpdate">The RetentionEventType object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{RetentionEventType}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<RetentionEventType>> PutResponseAsync(RetentionEventType retentionEventTypeToUpdate, CancellationToken cancellationToken = default);
        ...
        IRetentionEventTypeRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IRetentionEventTypeRequest Expand(Expression<Func<RetentionEventType, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IRetentionEventTypeRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IRetentionEventTypeRequest Select(Expression<Func<RetentionEventType, object>> selectExpression);
