...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// <summary>
    /// The type EdiscoveryCustodianReferenceRequest.
    /// </summary>
    public partial class EdiscoveryCustodianReferenceRequest : Microsoft.Graph.BaseRequest, IEdiscoveryCustodianReferenceRequest
    {
        /// <summary>
        /// Constructs a new EdiscoveryCustodianReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public EdiscoveryCustodianReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified EdiscoveryCustodian reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified EdiscoveryCustodian reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified EdiscoveryCustodian reference.
        /// </summary>
        /// <param name="id">The EdiscoveryCustodian reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified EdiscoveryCustodian reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The EdiscoveryCustodian reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
