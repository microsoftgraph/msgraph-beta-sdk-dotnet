...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// <summary>
    /// The type RetentionEventTypeRequest.
    /// </summary>
    public partial class RetentionEventTypeRequest : Microsoft.Graph.BaseRequest, IRetentionEventTypeRequest
    {
        /// <summary>
        /// Constructs a new RetentionEventTypeRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public RetentionEventTypeRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Updates the specified RetentionEventType using PUT.
        /// </summary>
        /// <param name="retentionEventTypeToUpdate">The RetentionEventType object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<RetentionEventType> PutAsync(RetentionEventType retentionEventTypeToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <summary>
        /// Updates the specified RetentionEventType using PUT and returns a <see cref="GraphResponse{RetentionEventType}"/> object.
        /// </summary>
        /// <param name="retentionEventTypeToUpdate">The RetentionEventType object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{RetentionEventType}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<RetentionEventType>> PutResponseAsync(RetentionEventType retentionEventTypeToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<RetentionEventType>(retentionEventTypeToUpdate, cancellationToken);
        ...
        public IRetentionEventTypeRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IRetentionEventTypeRequest Expand(Expression<Func<RetentionEventType, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IRetentionEventTypeRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IRetentionEventTypeRequest Select(Expression<Func<RetentionEventType, object>> selectExpression)
        {
        ...
        /// </summary>
        /// <param name="retentionEventTypeToInitialize">The <see cref="RetentionEventType"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(RetentionEventType retentionEventTypeToInitialize)
        {
