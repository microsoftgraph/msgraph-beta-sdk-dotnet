...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// <summary>
    /// The interface IFileContentRequest.
    /// </summary>
    public partial interface IFileContentRequest : Microsoft.Graph.IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream content, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : File;
        ...
        System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream content, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : File;
