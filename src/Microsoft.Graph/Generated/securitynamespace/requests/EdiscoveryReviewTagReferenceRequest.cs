...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// </summary>
    public partial class EdiscoveryReviewTagReferenceRequest : Microsoft.Graph.BaseRequest, IEdiscoveryReviewTagReferenceRequest
    {
        /// <summary>
        ...
        public EdiscoveryReviewTagReferenceRequest(
            string requestUrl,
        ...
        public async System.Threading.Tasks.Task DeleteAsync(CancellationToken cancellationToken = default)
        {
            ...
            await this.SendAsync<EdiscoveryReviewTag>(null, cancellationToken).ConfigureAwait(false);
        }

        /// <summary>
        /// Deletes the specified EdiscoveryReviewTag reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified EdiscoveryReviewTag reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The EdiscoveryReviewTag reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
