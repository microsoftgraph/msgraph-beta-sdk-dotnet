...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// </summary>
    public partial interface IEdiscoveryReviewTagReferenceRequest : Microsoft.Graph.IBaseRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Puts the specified EdiscoveryReviewTag reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The EdiscoveryReviewTag reference reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
