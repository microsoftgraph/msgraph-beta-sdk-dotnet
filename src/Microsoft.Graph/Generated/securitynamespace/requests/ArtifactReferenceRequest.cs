...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// <summary>
    /// The type ArtifactReferenceRequest.
    /// </summary>
    public partial class ArtifactReferenceRequest : Microsoft.Graph.BaseRequest, IArtifactReferenceRequest
    {
        /// <summary>
        /// Constructs a new ArtifactReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ArtifactReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified Artifact reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified Artifact reference.
        /// </summary>
        /// <param name="id">The Artifact reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified Artifact reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The Artifact reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
