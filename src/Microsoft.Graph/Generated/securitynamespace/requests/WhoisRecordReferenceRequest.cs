...
namespace Microsoft.Graph.SecurityNamespace
{
    ...
    /// <summary>
    /// The type WhoisRecordReferenceRequest.
    /// </summary>
    public partial class WhoisRecordReferenceRequest : Microsoft.Graph.BaseRequest, IWhoisRecordReferenceRequest
    {
        /// <summary>
        /// Constructs a new WhoisRecordReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public WhoisRecordReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified WhoisRecord reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified WhoisRecord reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified WhoisRecord reference.
        /// </summary>
        /// <param name="id">The WhoisRecord reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified WhoisRecord reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The WhoisRecord reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
