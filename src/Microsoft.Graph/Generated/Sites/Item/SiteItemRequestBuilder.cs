...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Site?> GetAsync(CancellationToken cancellationToken = default, Action<SiteItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Site> GetAsync(CancellationToken cancellationToken = default, Action<SiteItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Site?> PatchAsync(Microsoft.Graph.Beta.Models.Site body, CancellationToken cancellationToken = default, Action<SiteItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Site> PatchAsync(Microsoft.Graph.Beta.Models.Site body, CancellationToken cancellationToken = default, Action<SiteItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
