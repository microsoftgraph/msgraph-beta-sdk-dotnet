...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Sites.Item.Items {
    public class ItemsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ItemsResponse).Value = n.GetCollectionOfObjectValues<BaseItem>(BaseItem.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
