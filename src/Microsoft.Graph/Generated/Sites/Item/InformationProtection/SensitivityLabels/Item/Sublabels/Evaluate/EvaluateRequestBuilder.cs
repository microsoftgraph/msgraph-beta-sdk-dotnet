...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.InformationProtection.SensitivityLabels.Item.Sublabels.Evaluate {
    /// <summary>
    ...
    public class EvaluateRequestBuilder : BaseRequestBuilder {
        ...
        public EvaluateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/evaluate", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EvaluateRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EvaluateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/evaluate", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<EvaluateLabelJobResponse?> PostAsync(EvaluatePostRequestBody body, Action<EvaluateRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<EvaluateLabelJobResponse> PostAsync(EvaluatePostRequestBody body, Action<EvaluateRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
