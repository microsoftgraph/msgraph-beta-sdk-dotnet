...
using Microsoft.Graph.Beta.Sites.Item.InformationProtection.Policy.Labels;
...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.InformationProtection.Policy {
    /// <summary>
    ...
    public class PolicyRequestBuilder : BaseRequestBuilder {
        ...
        public PolicyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/policy{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PolicyRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PolicyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/policy{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
