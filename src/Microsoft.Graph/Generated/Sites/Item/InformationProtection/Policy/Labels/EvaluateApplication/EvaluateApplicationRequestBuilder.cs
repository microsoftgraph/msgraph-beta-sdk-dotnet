...
namespace Microsoft.Graph.Beta.Sites.Item.InformationProtection.Policy.Labels.EvaluateApplication {
    ...
    public class EvaluateApplicationRequestBuilder : BaseRequestBuilder {
        ...
        public EvaluateApplicationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/policy/labels/evaluateApplication", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EvaluateApplicationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EvaluateApplicationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/policy/labels/evaluateApplication", rawUrl) {
        }
        /// <summary>
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/informationprotectionlabel-evaluateapplication?view=graph-rest-1.0" />
        /// </summary>
...
#nullable enable
        public async Task<EvaluateApplicationResponse?> PostAsync(EvaluateApplicationPostRequestBody body, CancellationToken cancellationToken = default, Action<EvaluateApplicationRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EvaluateApplicationResponse> PostAsync(EvaluateApplicationPostRequestBody body, CancellationToken cancellationToken = default, Action<EvaluateApplicationRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
