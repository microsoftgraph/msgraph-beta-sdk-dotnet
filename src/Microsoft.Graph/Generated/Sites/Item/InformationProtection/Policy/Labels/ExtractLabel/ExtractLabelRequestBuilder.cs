...
#nullable enable
        public async Task<InformationProtectionContentLabel?> PostAsync(ExtractLabelPostRequestBody body, CancellationToken cancellationToken = default, Action<ExtractLabelRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<InformationProtectionContentLabel> PostAsync(ExtractLabelPostRequestBody body, CancellationToken cancellationToken = default, Action<ExtractLabelRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
