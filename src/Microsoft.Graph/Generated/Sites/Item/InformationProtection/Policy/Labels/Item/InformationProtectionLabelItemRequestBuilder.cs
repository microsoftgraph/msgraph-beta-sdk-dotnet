...
namespace Microsoft.Graph.Beta.Sites.Item.InformationProtection.Policy.Labels.Item
{
    ...
    public partial class InformationProtectionLabelItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public InformationProtectionLabelItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/policy/labels/{informationProtectionLabel%2Did}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Sites.Item.InformationProtection.Policy.Labels.Item.InformationProtectionLabelItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InformationProtectionLabelItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/policy/labels/{informationProtectionLabel%2Did}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/sites/{site%2Did}/informationProtection/policy/labels/{informationProtectionLabel%2Did}{?%24expand,%24select}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
