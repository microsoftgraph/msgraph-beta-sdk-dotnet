...
namespace Microsoft.Graph.Beta.Sites.Item.InformationProtection.ThreatAssessmentRequests.Item.Results {
    ...
    public class ResultsRequestBuilder : BaseRequestBuilder {
        ...
        public ThreatAssessmentResultItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("threatAssessmentResult%2Did", position);
...
#nullable enable
        public async Task<ThreatAssessmentResultCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ResultsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ThreatAssessmentResultCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ResultsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<ThreatAssessmentResultCollectionResponse>(requestInfo, ThreatAssessmentResultCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ThreatAssessmentResult?> PostAsync(ThreatAssessmentResult body, CancellationToken cancellationToken = default, Action<ResultsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ThreatAssessmentResult> PostAsync(ThreatAssessmentResult body, CancellationToken cancellationToken = default, Action<ResultsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
