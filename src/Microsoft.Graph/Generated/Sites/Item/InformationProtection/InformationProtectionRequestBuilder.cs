...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<InformationProtectionRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<InformationProtectionRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.InformationProtection?> GetAsync(CancellationToken cancellationToken = default, Action<InformationProtectionRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.InformationProtection> GetAsync(CancellationToken cancellationToken = default, Action<InformationProtectionRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.InformationProtection?> PatchAsync(Microsoft.Graph.Beta.Models.InformationProtection body, CancellationToken cancellationToken = default, Action<InformationProtectionRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.InformationProtection> PatchAsync(Microsoft.Graph.Beta.Models.InformationProtection body, CancellationToken cancellationToken = default, Action<InformationProtectionRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
