...
using MicrosoftGraph.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentNotebook;
using MicrosoftGraph.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentSectionGroup;
using MicrosoftGraph.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups;
using MicrosoftGraph.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections;
using System;
...
namespace MicrosoftGraph.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public SectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}{?select,expand}";
