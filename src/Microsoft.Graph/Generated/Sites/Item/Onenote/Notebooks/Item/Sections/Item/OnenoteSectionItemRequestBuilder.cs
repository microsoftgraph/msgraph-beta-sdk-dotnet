...
using MicrosoftGraphSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.CopyToNotebook;
using MicrosoftGraphSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.CopyToSectionGroup;
using MicrosoftGraphSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.Pages;
using MicrosoftGraphSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.ParentNotebook;
using MicrosoftGraphSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item {
    ...
    public class OnenoteSectionItemRequestBuilder {
        ...
        public OnenoteSectionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}{?select,expand}";
