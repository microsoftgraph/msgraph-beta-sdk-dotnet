...
namespace MicrosoftGraphSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.ParentSection.CopyToNotebook {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\onenote\notebooks\{notebook-id}\sections\{onenoteSection-id}\pages\{onenotePage-id}\parentSection\microsoft.graph.copyToNotebook</summary>
    public class CopyToNotebookRequestBuilder {
        ...
        public CopyToNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentSection/microsoft.graph.copyToNotebook";
