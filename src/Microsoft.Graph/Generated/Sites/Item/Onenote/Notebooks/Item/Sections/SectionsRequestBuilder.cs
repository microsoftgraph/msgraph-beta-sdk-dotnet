...
namespace MicrosoftGraph.Sites.Item.Onenote.Notebooks.Item.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.sites.item.onenote.notebooks.item.sections.item collection</summary>
