...
namespace Microsoft.Graph.Beta.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages.Item.OnenotePatchContent {
    ...
    public class OnenotePatchContentRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(OnenotePatchContentPostRequestBody body, Action<OnenotePatchContentRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
