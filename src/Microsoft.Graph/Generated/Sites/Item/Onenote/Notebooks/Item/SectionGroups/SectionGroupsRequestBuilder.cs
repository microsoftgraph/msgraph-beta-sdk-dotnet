...
using MicrosoftGraph.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item;
using System;
...
namespace MicrosoftGraph.Sites.Item.Onenote.Notebooks.Item.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.sites.item.onenote.notebooks.item.sectionGroups.item collection</summary>
