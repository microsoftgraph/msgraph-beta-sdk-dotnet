...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup {
    /// <summary>
    ...
    public class ParentSectionGroupRequestBuilder : BaseRequestBuilder {
        ...
        public ParentSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/parentSectionGroup{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ParentSectionGroupRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ParentSectionGroupRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/parentSectionGroup{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
