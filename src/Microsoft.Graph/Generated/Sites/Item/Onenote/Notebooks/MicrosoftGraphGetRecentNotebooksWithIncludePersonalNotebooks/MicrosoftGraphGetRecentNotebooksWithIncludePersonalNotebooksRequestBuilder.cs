...
namespace Microsoft.Graph.Beta.Sites.Item.Onenote.Notebooks.MicrosoftGraphGetRecentNotebooksWithIncludePersonalNotebooks {
    /// <summary>
    ...
    public class MicrosoftGraphGetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder {
        ...
        public MicrosoftGraphGetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, bool? includePersonalNotebooks = default) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/onenote/notebooks/microsoft.graph.getRecentNotebooks(includePersonalNotebooks={includePersonalNotebooks}){?%24top,%24skip,%24search,%24filter,%24count}";
