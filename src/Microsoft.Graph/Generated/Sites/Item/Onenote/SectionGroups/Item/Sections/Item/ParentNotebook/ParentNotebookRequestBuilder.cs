...
using MicrosoftGraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.ParentNotebook.CopyNotebook;
using MicrosoftGraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.ParentNotebook.Ref;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.ParentNotebook {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\onenote\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id}\parentNotebook</summary>
