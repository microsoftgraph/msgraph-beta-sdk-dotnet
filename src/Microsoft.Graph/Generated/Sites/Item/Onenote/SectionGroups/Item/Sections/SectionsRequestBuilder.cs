...
using MicrosoftGraph.Sites.Item.Onenote.SectionGroups.Item.Sections.Item;
using System;
...
namespace MicrosoftGraph.Sites.Item.Onenote.SectionGroups.Item.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.sites.item.onenote.sectionGroups.item.sections.item collection</summary>
