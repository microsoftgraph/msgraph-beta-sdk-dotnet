...
using MicrosoftGraph.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.Content;
using MicrosoftGraph.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.CopyToSection;
using MicrosoftGraph.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.OnenotePatchContent;
using MicrosoftGraph.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.ParentNotebook;
using MicrosoftGraph.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.ParentSection;
using MicrosoftGraph.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.Preview;
using System;
...
namespace MicrosoftGraph.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/onenote/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}{?select,expand}";
