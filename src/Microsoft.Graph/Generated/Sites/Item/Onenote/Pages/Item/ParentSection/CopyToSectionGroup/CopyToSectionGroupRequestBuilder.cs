...
namespace MicrosoftGraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.CopyToSectionGroup {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\onenote\pages\{onenotePage-id}\parentSection\microsoft.graph.copyToSectionGroup</summary>
    public class CopyToSectionGroupRequestBuilder {
        ...
        public CopyToSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/onenote/pages/{onenotePage_id}/parentSection/microsoft.graph.copyToSectionGroup";
