...
namespace MicrosoftGraph.Sites.Item.Onenote.Pages.Item.Preview {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\onenote\pages\{onenotePage-id}\microsoft.graph.preview()</summary>
