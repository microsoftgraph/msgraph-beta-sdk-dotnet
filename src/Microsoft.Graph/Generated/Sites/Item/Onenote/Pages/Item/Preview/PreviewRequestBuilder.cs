...
namespace Microsoft.Graph.Beta.Sites.Item.Onenote.Pages.Item.Preview {
    ...
    public class PreviewRequestBuilder : BaseRequestBuilder {
        ...
        public PreviewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/pages/{onenotePage%2Did}/preview()", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PreviewRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PreviewRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/pages/{onenotePage%2Did}/preview()", rawUrl) {
        }
        /// <summary>
