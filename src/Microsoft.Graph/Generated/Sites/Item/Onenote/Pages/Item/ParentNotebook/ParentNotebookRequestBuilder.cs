...
using MicrosoftGraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.CopyNotebook;
using MicrosoftGraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.Ref;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\onenote\pages\{onenotePage-id}\parentNotebook</summary>
