...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.Onenote.Pages.Item.ParentNotebook {
    /// <summary>
    ...
    public class ParentNotebookRequestBuilder : BaseRequestBuilder {
        ...
        public ParentNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/pages/{onenotePage%2Did}/parentNotebook{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ParentNotebookRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ParentNotebookRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/pages/{onenotePage%2Did}/parentNotebook{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
