...
using MicrosoftGraph.Sites.Item.Onenote.Sections.Item.CopyToNotebook;
using MicrosoftGraph.Sites.Item.Onenote.Sections.Item.CopyToSectionGroup;
using MicrosoftGraph.Sites.Item.Onenote.Sections.Item.Pages;
using MicrosoftGraph.Sites.Item.Onenote.Sections.Item.ParentNotebook;
using MicrosoftGraph.Sites.Item.Onenote.Sections.Item.ParentSectionGroup;
using System;
...
namespace MicrosoftGraph.Sites.Item.Onenote.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/onenote/sections/{onenoteSection_id}{?select,expand}";
