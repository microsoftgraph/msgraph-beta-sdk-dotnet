...
namespace MicrosoftGraphSdk.Sites.Item.Onenote.Sections.Item.Pages.Item.ParentSection.CopyToSectionGroup {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\onenote\sections\{onenoteSection-id}\pages\{onenotePage-id}\parentSection\microsoft.graph.copyToSectionGroup</summary>
    public class CopyToSectionGroupRequestBuilder {
        ...
        public CopyToSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentSection/microsoft.graph.copyToSectionGroup";
