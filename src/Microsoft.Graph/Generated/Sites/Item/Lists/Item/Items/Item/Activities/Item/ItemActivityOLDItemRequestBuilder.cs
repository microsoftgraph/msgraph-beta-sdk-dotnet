...
namespace MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item.Activities.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\lists\{list-id}\items\{listItem-id}\activities\{itemActivityOLD-id}</summary>
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/lists/{list_id}/items/{listItem_id}/activities/{itemActivityOLD_id}{?select,expand}";
