...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.Lists.Item.Items.Item.LastModifiedByUser.MailboxSettings {
    /// <summary>
    ...
    public class MailboxSettingsRequestBuilder : BaseRequestBuilder {
        ...
        public MailboxSettingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/lastModifiedByUser/mailboxSettings{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MailboxSettingsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MailboxSettingsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/lastModifiedByUser/mailboxSettings{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
