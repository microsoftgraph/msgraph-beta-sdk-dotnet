...
using MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item.Activities.Item.ListItem.CreateLink;
using MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item.Activities.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item.Activities.Item.ListItem.Ref;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item.Activities.Item.ListItem {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\lists\{list-id}\items\{listItem-id}\activities\{itemActivityOLD-id}\listItem</summary>
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/lists/{list_id}/items/{listItem_id}/activities/{itemActivityOLD_id}/listItem{?select,expand}";
