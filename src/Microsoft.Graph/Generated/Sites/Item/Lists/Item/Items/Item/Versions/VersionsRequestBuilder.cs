...
using MicrosoftGraph.Sites.Item.Lists.Item.Items.Item.Versions.Item;
using System;
...
namespace MicrosoftGraph.Sites.Item.Lists.Item.Items.Item.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.sites.item.lists.item.items.item.versions.item collection</summary>
