...
using Microsoft.Graph.Beta.Sites.Item.Lists.Item.Items.Item.Activities.Item.DriveItem.Content;
...
namespace Microsoft.Graph.Beta.Sites.Item.Lists.Item.Items.Item.Activities.Item.DriveItem {
    /// <summary>
    ...
    public class DriveItemRequestBuilder : BaseRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DriveItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DriveItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
