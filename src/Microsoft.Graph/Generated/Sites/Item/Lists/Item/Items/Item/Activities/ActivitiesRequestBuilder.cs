...
using MicrosoftGraph.Sites.Item.Lists.Item.Items.Item.Activities.Item;
using System;
...
namespace MicrosoftGraph.Sites.Item.Lists.Item.Items.Item.Activities {
    ...
    public class ActivitiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.sites.item.lists.item.items.item.activities.item collection</summary>
