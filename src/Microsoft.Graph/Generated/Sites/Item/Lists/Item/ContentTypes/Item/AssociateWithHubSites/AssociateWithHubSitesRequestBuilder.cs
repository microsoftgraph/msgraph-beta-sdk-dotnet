...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.Lists.Item.ContentTypes.Item.AssociateWithHubSites {
    /// <summary>
    ...
    public class AssociateWithHubSitesRequestBuilder : BaseRequestBuilder {
        ...
        public AssociateWithHubSitesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/associateWithHubSites", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AssociateWithHubSitesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AssociateWithHubSitesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/associateWithHubSites", rawUrl) {
        }
        /// <summary>
