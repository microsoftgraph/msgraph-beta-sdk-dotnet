...
using Microsoft.Graph.Beta.Sites.Item.Lists.Item.ContentTypes.Item.Columns.Count;
using Microsoft.Graph.Beta.Sites.Item.Lists.Item.ContentTypes.Item.Columns.Item;
...
namespace Microsoft.Graph.Beta.Sites.Item.Lists.Item.ContentTypes.Item.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.sites.item.lists.item.contentTypes.item.columns.item collection</summary>
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/columns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
