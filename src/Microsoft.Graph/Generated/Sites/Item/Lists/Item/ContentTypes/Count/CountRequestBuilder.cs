...
namespace Microsoft.Graph.Beta.Sites.Item.Lists.Item.ContentTypes.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/$count{?%24search,%24filter}";
