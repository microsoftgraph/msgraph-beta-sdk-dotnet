...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.Lists.Item.ContentTypes.Item.CopyToDefaultContentLocation {
    /// <summary>
    ...
    public class CopyToDefaultContentLocationRequestBuilder : BaseRequestBuilder {
        ...
        public CopyToDefaultContentLocationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/copyToDefaultContentLocation", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CopyToDefaultContentLocationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CopyToDefaultContentLocationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/copyToDefaultContentLocation", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(CopyToDefaultContentLocationPostRequestBody body, CancellationToken cancellationToken = default, Action<CopyToDefaultContentLocationRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(CopyToDefaultContentLocationPostRequestBody body, CancellationToken cancellationToken = default, Action<CopyToDefaultContentLocationRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
