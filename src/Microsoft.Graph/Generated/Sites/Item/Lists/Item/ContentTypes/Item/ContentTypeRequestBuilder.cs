...
using MicrosoftGraph.Sites.Item.Lists.Item.ContentTypes.Item.AssociateWithHubSites;
using MicrosoftGraph.Sites.Item.Lists.Item.ContentTypes.Item.Base;
using MicrosoftGraph.Sites.Item.Lists.Item.ContentTypes.Item.BaseTypes;
using MicrosoftGraph.Sites.Item.Lists.Item.ContentTypes.Item.ColumnLinks;
using MicrosoftGraph.Sites.Item.Lists.Item.ContentTypes.Item.ColumnPositions;
using MicrosoftGraph.Sites.Item.Lists.Item.ContentTypes.Item.Columns;
using MicrosoftGraph.Sites.Item.Lists.Item.ContentTypes.Item.CopyToDefaultContentLocation;
using MicrosoftGraph.Sites.Item.Lists.Item.ContentTypes.Item.IsPublished;
using MicrosoftGraph.Sites.Item.Lists.Item.ContentTypes.Item.Publish;
using MicrosoftGraph.Sites.Item.Lists.Item.ContentTypes.Item.Unpublish;
using System;
...
namespace MicrosoftGraph.Sites.Item.Lists.Item.ContentTypes.Item {
