...
namespace MicrosoftGraph.Sites.Item.Lists.Item.Subscriptions.Item {
    ...
    public class SubscriptionRequestBuilder {
        ...
        /// </summary>
        public SubscriptionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public SubscriptionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
