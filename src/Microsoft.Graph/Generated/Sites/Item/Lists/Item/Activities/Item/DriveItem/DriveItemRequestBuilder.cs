...
using MicrosoftGraphSdk.Sites.Item.Lists.Item.Activities.Item.DriveItem.Ref;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.Lists.Item.Activities.Item.DriveItem {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\lists\{list-id}\activities\{itemActivityOLD-id}\driveItem</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/lists/{list_id}/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
