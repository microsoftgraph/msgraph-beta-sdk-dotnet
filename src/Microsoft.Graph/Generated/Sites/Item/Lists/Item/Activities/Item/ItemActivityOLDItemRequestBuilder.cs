...
using MicrosoftGraphSdk.Sites.Item.Lists.Item.Activities.Item.DriveItem;
using MicrosoftGraphSdk.Sites.Item.Lists.Item.Activities.Item.ListItem;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.Lists.Item.Activities.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\lists\{list-id}\activities\{itemActivityOLD-id}</summary>
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/lists/{list_id}/activities/{itemActivityOLD_id}{?select,expand}";
