...
namespace MicrosoftGraphSdk.Sites.Item.Lists.Item.Activities.Item.ListItem.CreateLink {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\lists\{list-id}\activities\{itemActivityOLD-id}\listItem\microsoft.graph.createLink</summary>
    public class CreateLinkRequestBuilder {
        ...
        public CreateLinkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/lists/{list_id}/activities/{itemActivityOLD_id}/listItem/microsoft.graph.createLink";
