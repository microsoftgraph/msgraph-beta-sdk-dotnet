...
using Microsoft.Graph.Beta.Sites.Item.Columns.Count;
using Microsoft.Graph.Beta.Sites.Item.Columns.Item;
...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.Columns {
    /// <summary>
    ...
    public class ColumnsRequestBuilder : BaseRequestBuilder {
        ...
        public ColumnDefinitionItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("columnDefinition%2Did", position);
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/columns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ColumnsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ColumnsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/columns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the collection of columns, represented as [columnDefinition][columnDefinition] resources, in a [site][site].
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/site-list-columns?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ColumnDefinitionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ColumnsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ColumnDefinitionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ColumnsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/site-post-columns?view=graph-rest-1.0" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ColumnDefinition?> PostAsync(ColumnDefinition body, CancellationToken cancellationToken = default, Action<ColumnsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ColumnDefinition> PostAsync(ColumnDefinition body, CancellationToken cancellationToken = default, Action<ColumnsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
