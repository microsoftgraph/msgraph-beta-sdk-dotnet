...
using MicrosoftGraph.Sites.Item.Columns.Item;
using System;
...
namespace MicrosoftGraph.Sites.Item.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.sites.item.columns.item collection</summary>
