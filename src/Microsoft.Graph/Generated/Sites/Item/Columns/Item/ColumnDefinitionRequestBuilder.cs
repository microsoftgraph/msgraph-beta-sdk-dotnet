...
using MicrosoftGraph.Sites.Item.Columns.Item.SourceColumn;
using System;
...
namespace MicrosoftGraph.Sites.Item.Columns.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\columns\{columnDefinition-id}</summary>
    public class ColumnDefinitionRequestBuilder {
        ...
        public ColumnDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/columns/{columnDefinition_id}{?select,expand}";
