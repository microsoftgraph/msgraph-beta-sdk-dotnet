...
using Microsoft.Graph.Beta.Sites.Item.Pages.Item.WebParts.Item.GetPositionOfWebPart;
...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.Pages.Item.WebParts.Item {
    /// <summary>
    ...
    public class WebPartItemRequestBuilder : BaseRequestBuilder {
        ...
        public WebPartItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/webParts/{webPart%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WebPartItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WebPartItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/webParts/{webPart%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
