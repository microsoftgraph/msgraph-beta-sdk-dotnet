...
using Microsoft.Graph.Beta.Sites.Item.Pages.Item.CanvasLayout.HorizontalSections;
using Microsoft.Graph.Beta.Sites.Item.Pages.Item.CanvasLayout.VerticalSection;
...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.Pages.Item.CanvasLayout {
    /// <summary>
    ...
    public class CanvasLayoutRequestBuilder : BaseRequestBuilder {
        ...
        public CanvasLayoutRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CanvasLayoutRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CanvasLayoutRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CanvasLayoutRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CanvasLayoutRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.CanvasLayout?> GetAsync(CancellationToken cancellationToken = default, Action<CanvasLayoutRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.CanvasLayout> GetAsync(CancellationToken cancellationToken = default, Action<CanvasLayoutRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.CanvasLayout?> PatchAsync(Microsoft.Graph.Beta.Models.CanvasLayout body, CancellationToken cancellationToken = default, Action<CanvasLayoutRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.CanvasLayout> PatchAsync(Microsoft.Graph.Beta.Models.CanvasLayout body, CancellationToken cancellationToken = default, Action<CanvasLayoutRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
