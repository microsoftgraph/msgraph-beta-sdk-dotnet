...
namespace Microsoft.Graph.Beta.Sites.Item.Pages.Item.CanvasLayout.HorizontalSections.Item.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation CreatePostRequestInformation(HorizontalSectionColumn body, Action<ColumnsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
