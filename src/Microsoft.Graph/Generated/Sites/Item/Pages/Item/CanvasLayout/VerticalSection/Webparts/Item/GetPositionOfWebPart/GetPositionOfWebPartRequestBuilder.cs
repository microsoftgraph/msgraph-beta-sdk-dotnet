...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.Pages.Item.CanvasLayout.VerticalSection.Webparts.Item.GetPositionOfWebPart {
    /// <summary>
    ...
    public class GetPositionOfWebPartRequestBuilder : BaseRequestBuilder {
        ...
        public GetPositionOfWebPartRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout/verticalSection/webparts/{webPart%2Did}/getPositionOfWebPart", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetPositionOfWebPartRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetPositionOfWebPartRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout/verticalSection/webparts/{webPart%2Did}/getPositionOfWebPart", rawUrl) {
        }
        /// <summary>
