...
using Microsoft.Graph.Beta.Sites.Item.Pages.Item.CanvasLayout.HorizontalSections.Count;
using Microsoft.Graph.Beta.Sites.Item.Pages.Item.CanvasLayout.HorizontalSections.Item;
...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.Pages.Item.CanvasLayout.HorizontalSections {
    /// <summary>
    ...
    public class HorizontalSectionsRequestBuilder : BaseRequestBuilder {
        ...
        public HorizontalSectionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout/horizontalSections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HorizontalSectionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HorizontalSectionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout/horizontalSections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<HorizontalSectionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<HorizontalSectionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<HorizontalSectionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<HorizontalSectionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<HorizontalSection?> PostAsync(HorizontalSection body, CancellationToken cancellationToken = default, Action<HorizontalSectionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<HorizontalSection> PostAsync(HorizontalSection body, CancellationToken cancellationToken = default, Action<HorizontalSectionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
