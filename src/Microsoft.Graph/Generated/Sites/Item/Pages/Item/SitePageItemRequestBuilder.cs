...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SitePageItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SitePageItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SitePage?> GetAsync(CancellationToken cancellationToken = default, Action<SitePageItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SitePage> GetAsync(CancellationToken cancellationToken = default, Action<SitePageItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SitePage?> PatchAsync(SitePage body, CancellationToken cancellationToken = default, Action<SitePageItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SitePage> PatchAsync(SitePage body, CancellationToken cancellationToken = default, Action<SitePageItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
