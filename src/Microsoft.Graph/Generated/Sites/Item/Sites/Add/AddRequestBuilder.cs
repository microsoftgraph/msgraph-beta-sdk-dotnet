...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.Sites.Add {
    /// <summary>
    ...
    public class AddRequestBuilder : BaseRequestBuilder {
        ...
        public AddRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/sites/add", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="AddRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/sites/add", rawUrl) {
        }
        /// <summary>
