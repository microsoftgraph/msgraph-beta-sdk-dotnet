...
using MicrosoftGraphSdk.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children;
using MicrosoftGraphSdk.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Relations;
using MicrosoftGraphSdk.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Set;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item {
    ...
    public class TermItemRequestBuilder {
        ...
        public MicrosoftGraphSdk.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.ChildrenRequestBuilder Children { get =>
            new MicrosoftGraphSdk.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.ChildrenRequestBuilder(PathParameters, RequestAdapter);
        }
