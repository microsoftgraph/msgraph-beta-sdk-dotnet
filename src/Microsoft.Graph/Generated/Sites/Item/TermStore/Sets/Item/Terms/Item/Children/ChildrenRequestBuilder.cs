...
using Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Terms.Item.Children.Count;
using Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Terms.Item.Children.Item;
...
namespace Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Terms.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.sites.item.termStore.sets.item.terms.item.children.item collection</summary>
        public Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Terms.Item.Children.Item.TermItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("term%2Did1", position);
            return new Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Terms.Item.Children.Item.TermItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
