...
namespace Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.ParentGroup {
    ...
    public class ParentGroupRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.SetsRequestBuilder Sets { get =>
            new Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.SetsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ParentGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup{?%24select,%24expand}";
