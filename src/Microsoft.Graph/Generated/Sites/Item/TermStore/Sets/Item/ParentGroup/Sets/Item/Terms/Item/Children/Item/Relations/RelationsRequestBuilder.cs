...
using MicrosoftGraphSdk.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Terms.Item.Children.Item.Relations.Count;
using MicrosoftGraphSdk.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Terms.Item.Children.Item.Relations.Item;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Terms.Item.Children.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.sites.item.termStore.sets.item.parentGroup.sets.item.terms.item.children.item.relations.item collection</summary>
