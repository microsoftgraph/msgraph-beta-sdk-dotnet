...
using Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Children.Item.Children.Count;
using Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Children.Item.Children.Item;
...
namespace Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Children.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.sites.item.termStore.sets.item.children.item.children.item collection</summary>
        public Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Children.Item.Children.Item.TermItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("term%2Did1", position);
            return new Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Children.Item.Children.Item.TermItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public ChildrenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
