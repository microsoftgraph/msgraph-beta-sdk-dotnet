...
using Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Terms.Item.Children;
using Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Terms.Item.Relations;
using Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Terms.Item.Set;
...
namespace Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Terms.Item {
    ...
    public class TermItemRequestBuilder {
        ...
        public TermItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms/{term%2Did}{?%24select,%24expand}";
