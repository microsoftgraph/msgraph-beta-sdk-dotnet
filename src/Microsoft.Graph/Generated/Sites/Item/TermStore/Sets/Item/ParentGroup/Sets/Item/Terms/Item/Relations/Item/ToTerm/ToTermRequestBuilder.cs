...
namespace Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Terms.Item.Relations.Item.ToTerm {
    ...
    public class ToTermRequestBuilder {
        ...
        /// </summary>
        public async Task<Term> GetAsync(CancellationToken cancellationToken = default, Action<ToTermRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
