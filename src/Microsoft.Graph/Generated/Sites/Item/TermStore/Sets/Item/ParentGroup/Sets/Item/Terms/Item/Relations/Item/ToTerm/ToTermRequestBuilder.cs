...
#nullable enable
        public async Task<Term?> GetAsync(CancellationToken cancellationToken = default, Action<ToTermRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Term> GetAsync(CancellationToken cancellationToken = default, Action<ToTermRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
