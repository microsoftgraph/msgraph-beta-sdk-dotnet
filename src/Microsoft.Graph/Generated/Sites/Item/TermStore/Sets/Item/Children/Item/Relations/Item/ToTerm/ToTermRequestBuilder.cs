...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.ToTerm {
    /// <summary>
    ...
    public class ToTermRequestBuilder : BaseRequestBuilder {
        ...
        public ToTermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}/relations/{relation%2Did}/toTerm{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ToTermRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ToTermRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}/relations/{relation%2Did}/toTerm{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
