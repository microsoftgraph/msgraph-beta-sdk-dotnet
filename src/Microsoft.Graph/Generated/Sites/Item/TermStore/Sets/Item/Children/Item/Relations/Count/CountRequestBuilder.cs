...
namespace Microsoft.Graph.Beta.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}/relations/$count{?%24search,%24filter}";
