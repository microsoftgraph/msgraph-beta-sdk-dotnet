...
using Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item.Children.Item.Children.Item.Relations;
using Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item.Children.Item.Children.Item.Set;
...
namespace Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item.Children.Item.Children.Item {
    ...
    public class TermItemRequestBuilder {
        ...
        public TermItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}/children/{term%2Did}/children/{term%2Did1}{?%24select,%24expand}";
