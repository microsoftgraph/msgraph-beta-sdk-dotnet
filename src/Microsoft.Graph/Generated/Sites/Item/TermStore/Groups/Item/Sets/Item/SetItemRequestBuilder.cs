...
using Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item.Children;
using Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item.ParentGroup;
using Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item.Relations;
using Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms;
...
namespace Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item {
    /// <summary>
    ...
    public class SetItemRequestBuilder {
        ...
        public SetItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}{?%24select,%24expand}";
