...
namespace Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Set {
    ...
    public class SetRequestBuilder {
        ...
        public SetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms/{term%2Did}/set{?%24select,%24expand}";
