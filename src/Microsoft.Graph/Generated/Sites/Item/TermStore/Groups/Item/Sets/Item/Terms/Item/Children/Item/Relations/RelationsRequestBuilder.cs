...
using MicrosoftGraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Children.Item.Relations.Count;
using MicrosoftGraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Children.Item.Relations.Item;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Children.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.sites.item.termStore.groups.item.sets.item.terms.item.children.item.relations.item collection</summary>
