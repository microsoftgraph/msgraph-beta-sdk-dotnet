...
using Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Children.Count;
using Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Children.Item;
...
namespace Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.sites.item.termStore.groups.item.sets.item.terms.item.children.item collection</summary>
