...
using Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item.Children.Item.Relations.Count;
using Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item.Children.Item.Relations.Item;
...
namespace Microsoft.Graph.Beta.Sites.Item.TermStore.Groups.Item.Sets.Item.Children.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.sites.item.termStore.groups.item.sets.item.children.item.relations.item collection</summary>
        ...
        public RelationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}/children/{term%2Did}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
