...
using MicrosoftGraphSdk.Sites.Item.TermStore.Groups.Count;
using MicrosoftGraphSdk.Sites.Item.TermStore.Groups.Item;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.TermStore.Groups {
    ...
    public class GroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.sites.item.termStore.groups.item collection</summary>
