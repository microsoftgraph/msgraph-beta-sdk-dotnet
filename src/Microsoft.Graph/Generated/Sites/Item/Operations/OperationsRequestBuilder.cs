...
namespace Microsoft.Graph.Beta.Sites.Item.Operations
{
    ...
    public class OperationsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.Sites.Item.Operations.Count.CountRequestBuilder Count
        {
            get => new Microsoft.Graph.Beta.Sites.Item.Operations.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        /// <returns>A <see cref="Microsoft.Graph.Beta.Sites.Item.Operations.Item.RichLongRunningOperationItemRequestBuilder"/></returns>
        public Microsoft.Graph.Beta.Sites.Item.Operations.Item.RichLongRunningOperationItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("richLongRunningOperation%2Did", position);
                return new Microsoft.Graph.Beta.Sites.Item.Operations.Item.RichLongRunningOperationItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Sites.Item.Operations.OperationsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.RichLongRunningOperationCollectionResponse?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.Operations.OperationsRequestBuilder.OperationsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.RichLongRunningOperationCollectionResponse> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.Operations.OperationsRequestBuilder.OperationsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.Operations.OperationsRequestBuilder.OperationsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.Operations.OperationsRequestBuilder.OperationsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Sites.Item.Operations.OperationsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Sites.Item.Operations.OperationsRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Sites.Item.Operations.OperationsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get the list of richLongRunningOperations associated with a site.
        /// </summary>
...
#nullable restore
        ...
        public class OperationsRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.Operations.OperationsRequestBuilder.OperationsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
