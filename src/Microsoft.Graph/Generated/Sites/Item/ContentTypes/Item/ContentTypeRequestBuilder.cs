...
using MicrosoftGraph.Sites.Item.ContentTypes.Item.AssociateWithHubSites;
using MicrosoftGraph.Sites.Item.ContentTypes.Item.Base;
using MicrosoftGraph.Sites.Item.ContentTypes.Item.BaseTypes;
using MicrosoftGraph.Sites.Item.ContentTypes.Item.ColumnLinks;
using MicrosoftGraph.Sites.Item.ContentTypes.Item.ColumnPositions;
using MicrosoftGraph.Sites.Item.ContentTypes.Item.Columns;
using MicrosoftGraph.Sites.Item.ContentTypes.Item.CopyToDefaultContentLocation;
using MicrosoftGraph.Sites.Item.ContentTypes.Item.IsPublished;
using MicrosoftGraph.Sites.Item.ContentTypes.Item.Publish;
using MicrosoftGraph.Sites.Item.ContentTypes.Item.Unpublish;
using System;
...
namespace MicrosoftGraph.Sites.Item.ContentTypes.Item {
