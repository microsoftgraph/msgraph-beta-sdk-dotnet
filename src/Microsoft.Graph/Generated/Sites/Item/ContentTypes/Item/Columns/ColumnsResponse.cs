...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Sites.Item.ContentTypes.Item.Columns {
    public class ColumnsResponse : IParsable {
        ...
        /// </summary>
        public static ColumnsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ColumnsResponse).Value = n.GetCollectionOfObjectValues<ColumnDefinition>(ColumnDefinition.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
