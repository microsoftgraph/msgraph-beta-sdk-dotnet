...
using MicrosoftGraph.Sites.Item.ContentTypes.Item.Columns.Item;
using System;
...
namespace MicrosoftGraph.Sites.Item.ContentTypes.Item.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.sites.item.contentTypes.item.columns.item collection</summary>
