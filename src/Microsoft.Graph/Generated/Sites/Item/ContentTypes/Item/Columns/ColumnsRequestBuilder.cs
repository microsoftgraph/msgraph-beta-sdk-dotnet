...
namespace Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns
{
    ...
    public class ColumnsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns.Count.CountRequestBuilder Count
        {
            get => new Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        /// <returns>A <see cref="Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns.Item.ColumnDefinitionItemRequestBuilder"/></returns>
        public Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns.Item.ColumnDefinitionItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("columnDefinition%2Did", position);
                return new Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns.Item.ColumnDefinitionItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns.ColumnsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ColumnDefinitionCollectionResponse?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns.ColumnsRequestBuilder.ColumnsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ColumnDefinitionCollectionResponse> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns.ColumnsRequestBuilder.ColumnsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns.ColumnsRequestBuilder.ColumnsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns.ColumnsRequestBuilder.ColumnsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns.ColumnsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns.ColumnsRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns.ColumnsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// The collection of column definitions for this content type.
        /// </summary>
...
#nullable restore
        ...
        public class ColumnsRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.Columns.ColumnsRequestBuilder.ColumnsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
