...
namespace MicrosoftGraphSdk.Sites.Item.ContentTypes.Item.Base.IsPublished {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\contentTypes\{contentType-id}\base\microsoft.graph.isPublished()</summary>
    public class IsPublishedRequestBuilder {
        ...
        public IsPublishedRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/contentTypes/{contentType_id}/base/microsoft.graph.isPublished()";
