...
using MicrosoftGraph.Sites.Item.ContentTypes.Item.Base.AssociateWithHubSites;
using MicrosoftGraph.Sites.Item.ContentTypes.Item.Base.CopyToDefaultContentLocation;
using MicrosoftGraph.Sites.Item.ContentTypes.Item.Base.IsPublished;
using MicrosoftGraph.Sites.Item.ContentTypes.Item.Base.Publish;
using MicrosoftGraph.Sites.Item.ContentTypes.Item.Base.Ref;
using MicrosoftGraph.Sites.Item.ContentTypes.Item.Base.Unpublish;
using System;
...
namespace MicrosoftGraph.Sites.Item.ContentTypes.Item.Base {
