...
namespace MicrosoftGraphSdk.Sites.Item.ContentTypes.Item.BaseTypes.AddCopy {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\contentTypes\{contentType-id}\baseTypes\microsoft.graph.addCopy</summary>
    public class AddCopyRequestBuilder {
        ...
        public AddCopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/contentTypes/{contentType_id}/baseTypes/microsoft.graph.addCopy";
