...
using Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.BaseTypes.Count;
using Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.BaseTypes.Item;
...
using System;
namespace Microsoft.Graph.Beta.Sites.Item.ContentTypes.Item.BaseTypes {
    /// <summary>
    ...
    public class BaseTypesRequestBuilder : BaseRequestBuilder {
        ...
        public BaseTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}/baseTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new BaseTypesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BaseTypesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}/baseTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ContentTypeCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<BaseTypesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ContentTypeCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<BaseTypesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
