...
namespace Microsoft.Graph.Beta.Sites.Item.RecycleBin.LastModifiedByUser.MailboxSettings {
    ...
    public class MailboxSettingsRequestBuilder : BaseRequestBuilder {
        ...
        public MailboxSettingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/recycleBin/lastModifiedByUser/mailboxSettings{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MailboxSettingsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MailboxSettingsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/recycleBin/lastModifiedByUser/mailboxSettings{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
