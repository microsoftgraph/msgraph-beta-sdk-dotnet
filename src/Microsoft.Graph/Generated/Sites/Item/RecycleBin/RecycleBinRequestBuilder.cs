...
namespace Microsoft.Graph.Beta.Sites.Item.RecycleBin {
    ...
    public class RecycleBinRequestBuilder : BaseRequestBuilder {
        ...
        public RecycleBinRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/recycleBin{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RecycleBinRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecycleBinRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/recycleBin{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
