...
namespace Microsoft.Graph.Beta.Sites.Item.RecycleBin
{
    ...
    public class RecycleBinRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.Sites.Item.RecycleBin.CreatedByUser.CreatedByUserRequestBuilder CreatedByUser
        {
            get => new Microsoft.Graph.Beta.Sites.Item.RecycleBin.CreatedByUser.CreatedByUserRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the items property of the microsoft.graph.recycleBin entity.</summary>
        public Microsoft.Graph.Beta.Sites.Item.RecycleBin.Items.ItemsRequestBuilder Items
        {
            get => new Microsoft.Graph.Beta.Sites.Item.RecycleBin.Items.ItemsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the lastModifiedByUser property of the microsoft.graph.baseItem entity.</summary>
        public Microsoft.Graph.Beta.Sites.Item.RecycleBin.LastModifiedByUser.LastModifiedByUserRequestBuilder LastModifiedByUser
        {
            get => new Microsoft.Graph.Beta.Sites.Item.RecycleBin.LastModifiedByUser.LastModifiedByUserRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Sites.Item.RecycleBin.RecycleBinRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.RecycleBin?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.RecycleBin.RecycleBinRequestBuilder.RecycleBinRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.RecycleBin> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.RecycleBin.RecycleBinRequestBuilder.RecycleBinRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.RecycleBin.RecycleBinRequestBuilder.RecycleBinRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.RecycleBin.RecycleBinRequestBuilder.RecycleBinRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Sites.Item.RecycleBin.RecycleBinRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Sites.Item.RecycleBin.RecycleBinRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Sites.Item.RecycleBin.RecycleBinRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class RecycleBinRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.Sites.Item.RecycleBin.RecycleBinRequestBuilder.RecycleBinRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
