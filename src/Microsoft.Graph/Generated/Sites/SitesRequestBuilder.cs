...
namespace Microsoft.Graph.Beta.Sites
{
    ...
    public partial class SitesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Microsoft.Graph.Beta.Sites.Add.AddRequestBuilder Add
        {
            get => new global::Microsoft.Graph.Beta.Sites.Add.AddRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to count the resources in the collection.</summary>
        public global::Microsoft.Graph.Beta.Sites.Count.CountRequestBuilder Count
        {
            get => new global::Microsoft.Graph.Beta.Sites.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the delta method.</summary>
        public global::Microsoft.Graph.Beta.Sites.Delta.DeltaRequestBuilder Delta
        {
            get => new global::Microsoft.Graph.Beta.Sites.Delta.DeltaRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the getAllSites method.</summary>
        public global::Microsoft.Graph.Beta.Sites.GetAllSites.GetAllSitesRequestBuilder GetAllSites
        {
            get => new global::Microsoft.Graph.Beta.Sites.GetAllSites.GetAllSitesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the remove method.</summary>
        public global::Microsoft.Graph.Beta.Sites.Remove.RemoveRequestBuilder Remove
        {
            get => new global::Microsoft.Graph.Beta.Sites.Remove.RemoveRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public global::Microsoft.Graph.Beta.Sites.Item.SiteItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("site%2Did", position);
                return new global::Microsoft.Graph.Beta.Sites.Item.SiteItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Sites.SitesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Microsoft.Graph.Beta.Models.SiteCollectionResponse?> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Sites.SitesRequestBuilder.SitesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Microsoft.Graph.Beta.Models.SiteCollectionResponse> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Sites.SitesRequestBuilder.SitesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Sites.SitesRequestBuilder.SitesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Sites.SitesRequestBuilder.SitesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/sites{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", PathParameters);
...
#nullable restore
...
#endif
            if(ReferenceEquals(body, null)) throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/sites", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Beta.Sites.SitesRequestBuilder WithUrl(string rawUrl)
        {
