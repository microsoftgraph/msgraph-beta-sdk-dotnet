...
namespace MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsDeviceStartupHistory {
    public class UserExperienceAnalyticsDeviceStartupHistoryResponse : IParsable {
        ...
        /// </summary>
        public static UserExperienceAnalyticsDeviceStartupHistoryResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UserExperienceAnalyticsDeviceStartupHistoryResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UserExperienceAnalyticsDeviceStartupHistoryResponse).Value = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsDeviceStartupHistory>(MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsDeviceStartupHistory.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
