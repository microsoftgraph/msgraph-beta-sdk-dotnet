...
using MicrosoftGraph.DeviceManagement.Templates.Item.Categories;
using MicrosoftGraph.DeviceManagement.Templates.Item.CompareWithTemplateId;
using MicrosoftGraph.DeviceManagement.Templates.Item.CreateInstance;
using MicrosoftGraph.DeviceManagement.Templates.Item.MigratableTo;
using MicrosoftGraph.DeviceManagement.Templates.Item.Settings;
...
namespace MicrosoftGraph.DeviceManagement.Templates.Item {
    ...
    public class DeviceManagementTemplateRequestBuilder {
        ...
        public DeviceManagementTemplateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate_id}{?select,expand}";
