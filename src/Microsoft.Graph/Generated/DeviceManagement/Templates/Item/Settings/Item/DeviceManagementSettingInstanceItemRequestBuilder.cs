...
namespace Microsoft.Graph.Beta.DeviceManagement.Templates.Item.Settings.Item {
    /// <summary>
    ...
    public class DeviceManagementSettingInstanceItemRequestBuilder : BaseRequestBuilder {
        ...
        public DeviceManagementSettingInstanceItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/settings/{deviceManagementSettingInstance%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DeviceManagementSettingInstanceItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeviceManagementSettingInstanceItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/settings/{deviceManagementSettingInstance%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
