...
using MicrosoftGraph.DeviceManagement.Templates.Item.Settings.Item;
...
namespace MicrosoftGraph.DeviceManagement.Templates.Item.Settings {
    ...
    public class SettingsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.deviceManagement.templates.item.settings.item collection</summary>
