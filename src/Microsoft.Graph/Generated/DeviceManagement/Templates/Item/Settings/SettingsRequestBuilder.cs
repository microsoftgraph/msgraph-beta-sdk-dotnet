...
using MicrosoftGraphSdk.DeviceManagement.Templates.Item.Settings.Item;
...
namespace MicrosoftGraphSdk.DeviceManagement.Templates.Item.Settings {
    /// <summary>Builds and executes requests for operations under \deviceManagement\templates\{deviceManagementTemplate-id}\settings</summary>
    public class SettingsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.deviceManagement.templates.item.settings.item collection</summary>
