...
namespace Microsoft.Graph.Beta.DeviceManagement.Templates.Item.CompareWithTemplateId {
    ...
    public class CompareWithTemplateIdRequestBuilder {
        ...
        public CompareWithTemplateIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string templateId = default) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/microsoft.graph.compare(templateId='{templateId}'){?%24top,%24skip,%24search,%24filter,%24count}";
