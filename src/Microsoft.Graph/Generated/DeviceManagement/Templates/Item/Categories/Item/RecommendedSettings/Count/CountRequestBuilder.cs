...
namespace Microsoft.Graph.Beta.DeviceManagement.Templates.Item.Categories.Item.RecommendedSettings.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate_id}/categories/{deviceManagementTemplateSettingCategory_id}/recommendedSettings/$count";
