...
#nullable enable
        public async Task<DeviceManagementTemplateCollectionResponse?> GetAsync(Action<MigratableToRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<DeviceManagementTemplateCollectionResponse> GetAsync(Action<MigratableToRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
