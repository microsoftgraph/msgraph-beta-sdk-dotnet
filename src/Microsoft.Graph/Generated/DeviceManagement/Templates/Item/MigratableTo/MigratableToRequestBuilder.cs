...
namespace Microsoft.Graph.Beta.DeviceManagement.Templates.Item.MigratableTo {
    ...
    public class MigratableToRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceManagementTemplateCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MigratableToRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceManagementTemplate> PostAsync(DeviceManagementTemplate body, CancellationToken cancellationToken = default, Action<MigratableToRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
