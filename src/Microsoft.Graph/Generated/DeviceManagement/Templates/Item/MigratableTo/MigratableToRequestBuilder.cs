...
namespace Microsoft.Graph.Beta.DeviceManagement.Templates.Item.MigratableTo {
    ...
    /// </summary>
    public class MigratableToRequestBuilder : BaseRequestBuilder {
        ...
        public MigratableToRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/migratableTo{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MigratableToRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MigratableToRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/migratableTo{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DeviceManagementTemplateCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<MigratableToRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementTemplateCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MigratableToRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementTemplate?> PostAsync(DeviceManagementTemplate body, CancellationToken cancellationToken = default, Action<MigratableToRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementTemplate> PostAsync(DeviceManagementTemplate body, CancellationToken cancellationToken = default, Action<MigratableToRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<MigratableToRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<MigratableToRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new MigratableToRequestBuilderGetRequestConfiguration();
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(DeviceManagementTemplate body, Action<MigratableToRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(DeviceManagementTemplate body, Action<MigratableToRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new MigratableToRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
...
#nullable restore
        ...
        public class MigratableToRequestBuilderGetRequestConfiguration {
            ...
            public MigratableToRequestBuilderGetQueryParameters QueryParameters { get; set; } = new MigratableToRequestBuilderGetQueryParameters();
            /// <summary>
        ...
        public class MigratableToRequestBuilderPostRequestConfiguration {
            ...
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new migratableToRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
