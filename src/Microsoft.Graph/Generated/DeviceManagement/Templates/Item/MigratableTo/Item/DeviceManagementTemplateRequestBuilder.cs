...
using MicrosoftGraph.DeviceManagement.Templates.Item.MigratableTo.Item.CompareWithTemplateId;
using MicrosoftGraph.DeviceManagement.Templates.Item.MigratableTo.Item.CreateInstance;
...
namespace MicrosoftGraph.DeviceManagement.Templates.Item.MigratableTo.Item {
    ...
    public class DeviceManagementTemplateRequestBuilder {
        ...
        /// </summary>
        public DeviceManagementTemplateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public DeviceManagementTemplateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(DeviceManagementTemplate body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
