...
namespace MicrosoftGraph.DeviceManagement.Templates.Item.MigratableTo.Item.CompareWithTemplateId {
    ...
    public class CompareWithTemplateIdRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<MicrosoftGraph.DeviceManagement.Templates.Item.MigratableTo.Item.CompareWithTemplateId.CompareWithTemplateId>> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await RequestAdapter.SendCollectionAsync<MicrosoftGraph.DeviceManagement.Templates.Item.MigratableTo.Item.CompareWithTemplateId.CompareWithTemplateId>(requestInfo, responseHandler, default, cancellationToken);
        }
    }
}
