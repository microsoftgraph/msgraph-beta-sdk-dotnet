...
namespace Microsoft.Graph.Beta.DeviceManagement.Templates.Item.MigratableTo.Item.CompareWithTemplateId {
    ...
    public class CompareWithTemplateIdRequestBuilder {
        ...
        /// </summary>
        public async Task<CompareWithTemplateIdResponse> GetAsync(CancellationToken cancellationToken = default, Action<CompareWithTemplateIdRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
