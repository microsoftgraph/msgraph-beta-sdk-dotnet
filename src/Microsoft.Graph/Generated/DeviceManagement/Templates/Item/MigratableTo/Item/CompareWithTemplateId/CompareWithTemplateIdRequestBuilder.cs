...
namespace Microsoft.Graph.Beta.DeviceManagement.Templates.Item.MigratableTo.Item.CompareWithTemplateId {
    ...
    public class CompareWithTemplateIdRequestBuilder {
        ...
        public async Task<CompareWithTemplateIdResponse> GetAsync(Action<CompareWithTemplateIdRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<CompareWithTemplateIdResponse>(requestInfo, CompareWithTemplateIdResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
