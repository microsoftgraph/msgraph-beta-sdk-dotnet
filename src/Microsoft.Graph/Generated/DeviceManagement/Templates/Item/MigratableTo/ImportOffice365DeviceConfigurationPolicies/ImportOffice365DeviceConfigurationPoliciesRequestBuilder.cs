...
namespace Microsoft.Graph.Beta.DeviceManagement.Templates.Item.MigratableTo.ImportOffice365DeviceConfigurationPolicies {
    ...
    public class ImportOffice365DeviceConfigurationPoliciesRequestBuilder {
        ...
        /// </summary>
        public async Task<ImportOffice365DeviceConfigurationPoliciesResponse> PostAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
