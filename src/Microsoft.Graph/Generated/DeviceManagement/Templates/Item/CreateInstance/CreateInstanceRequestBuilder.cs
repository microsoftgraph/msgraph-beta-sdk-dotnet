...
namespace Microsoft.Graph.Beta.DeviceManagement.Templates.Item.CreateInstance {
    ...
    public class CreateInstanceRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CreateInstancePostRequestBody body, Action<CreateInstanceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<DeviceManagementIntent> PostAsync(CreateInstancePostRequestBody body, CancellationToken cancellationToken = default, Action<CreateInstanceRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
