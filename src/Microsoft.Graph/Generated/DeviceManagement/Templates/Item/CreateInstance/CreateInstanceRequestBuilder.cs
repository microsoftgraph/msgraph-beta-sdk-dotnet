...
namespace Microsoft.Graph.Beta.DeviceManagement.Templates.Item.CreateInstance {
    ...
    public class CreateInstanceRequestBuilder : BaseRequestBuilder {
        ...
        public CreateInstanceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/createInstance", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreateInstanceRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateInstanceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/createInstance", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DeviceManagementIntent?> PostAsync(CreateInstancePostRequestBody body, CancellationToken cancellationToken = default, Action<CreateInstanceRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementIntent> PostAsync(CreateInstancePostRequestBody body, CancellationToken cancellationToken = default, Action<CreateInstanceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
