...
#nullable enable
        public async Task<DeviceManagementTemplateCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TemplatesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementTemplateCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TemplatesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementTemplate?> PostAsync(DeviceManagementTemplate body, CancellationToken cancellationToken = default, Action<TemplatesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementTemplate> PostAsync(DeviceManagementTemplate body, CancellationToken cancellationToken = default, Action<TemplatesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
