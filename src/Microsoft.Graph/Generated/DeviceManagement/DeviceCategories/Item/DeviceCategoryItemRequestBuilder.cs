...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.DeviceCategory?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceCategoryItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.DeviceCategory> GetAsync(CancellationToken cancellationToken = default, Action<DeviceCategoryItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.DeviceCategory?> PatchAsync(Microsoft.Graph.Beta.Models.DeviceCategory body, CancellationToken cancellationToken = default, Action<DeviceCategoryItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.DeviceCategory> PatchAsync(Microsoft.Graph.Beta.Models.DeviceCategory body, CancellationToken cancellationToken = default, Action<DeviceCategoryItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
