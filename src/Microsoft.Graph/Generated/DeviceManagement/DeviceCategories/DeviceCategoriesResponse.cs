    ...
    public class DeviceCategoriesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DeviceCategoriesResponse).Value = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.DeviceCategory>(MicrosoftGraphSdk.Models.Microsoft.Graph.DeviceCategory.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
