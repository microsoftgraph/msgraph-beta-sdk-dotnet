...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceConfigurationConflictSummaryItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceConfigurationConflictSummaryItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.DeviceConfigurationConflictSummary?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceConfigurationConflictSummaryItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.DeviceConfigurationConflictSummary> GetAsync(CancellationToken cancellationToken = default, Action<DeviceConfigurationConflictSummaryItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.DeviceConfigurationConflictSummary?> PatchAsync(Microsoft.Graph.Beta.Models.DeviceConfigurationConflictSummary body, CancellationToken cancellationToken = default, Action<DeviceConfigurationConflictSummaryItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.DeviceConfigurationConflictSummary> PatchAsync(Microsoft.Graph.Beta.Models.DeviceConfigurationConflictSummary body, CancellationToken cancellationToken = default, Action<DeviceConfigurationConflictSummaryItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
