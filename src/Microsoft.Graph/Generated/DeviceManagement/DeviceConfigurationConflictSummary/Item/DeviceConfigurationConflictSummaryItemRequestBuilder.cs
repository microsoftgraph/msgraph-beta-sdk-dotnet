...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceConfigurationConflictSummary.Item {
    ...
    public class DeviceConfigurationConflictSummaryItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.DeviceConfigurationConflictSummary> PatchAsync(Microsoft.Graph.Beta.Models.DeviceConfigurationConflictSummary body, Action<DeviceConfigurationConflictSummaryItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
