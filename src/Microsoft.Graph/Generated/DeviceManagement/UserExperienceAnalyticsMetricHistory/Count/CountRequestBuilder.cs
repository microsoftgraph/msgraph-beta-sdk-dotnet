...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsMetricHistory.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsMetricHistory/$count{?%24search,%24filter}";
