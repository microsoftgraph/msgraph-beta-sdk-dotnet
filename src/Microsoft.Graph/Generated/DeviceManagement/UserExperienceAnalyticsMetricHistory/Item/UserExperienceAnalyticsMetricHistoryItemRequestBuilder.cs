...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsMetricHistory.Item {
    ...
    public class UserExperienceAnalyticsMetricHistoryItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.UserExperienceAnalyticsMetricHistory> PatchAsync(Microsoft.Graph.Beta.Models.UserExperienceAnalyticsMetricHistory body, Action<UserExperienceAnalyticsMetricHistoryItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
