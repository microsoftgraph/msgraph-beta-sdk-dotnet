...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsMetricHistory.Item {
    ...
    public class UserExperienceAnalyticsMetricHistoryItemRequestBuilder : BaseRequestBuilder {
        ...
        public UserExperienceAnalyticsMetricHistoryItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsMetricHistory/{userExperienceAnalyticsMetricHistory%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UserExperienceAnalyticsMetricHistoryItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UserExperienceAnalyticsMetricHistoryItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsMetricHistory/{userExperienceAnalyticsMetricHistory%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UserExperienceAnalyticsMetricHistoryItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UserExperienceAnalyticsMetricHistoryItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.UserExperienceAnalyticsMetricHistory?> GetAsync(CancellationToken cancellationToken = default, Action<UserExperienceAnalyticsMetricHistoryItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.UserExperienceAnalyticsMetricHistory> GetAsync(CancellationToken cancellationToken = default, Action<UserExperienceAnalyticsMetricHistoryItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.UserExperienceAnalyticsMetricHistory?> PatchAsync(Microsoft.Graph.Beta.Models.UserExperienceAnalyticsMetricHistory body, CancellationToken cancellationToken = default, Action<UserExperienceAnalyticsMetricHistoryItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.UserExperienceAnalyticsMetricHistory> PatchAsync(Microsoft.Graph.Beta.Models.UserExperienceAnalyticsMetricHistory body, CancellationToken cancellationToken = default, Action<UserExperienceAnalyticsMetricHistoryItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
