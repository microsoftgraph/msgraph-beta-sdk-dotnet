...
namespace MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsMetricHistory {
    public class UserExperienceAnalyticsMetricHistoryResponse : IParsable {
        ...
        /// </summary>
        public static UserExperienceAnalyticsMetricHistoryResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UserExperienceAnalyticsMetricHistoryResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UserExperienceAnalyticsMetricHistoryResponse).Value = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsMetricHistory>(MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsMetricHistory.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
