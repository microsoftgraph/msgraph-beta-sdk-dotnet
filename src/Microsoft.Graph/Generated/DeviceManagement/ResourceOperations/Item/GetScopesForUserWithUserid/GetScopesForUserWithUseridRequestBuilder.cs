...
#nullable enable
        public async Task<GetScopesForUserWithUseridResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetScopesForUserWithUseridRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetScopesForUserWithUseridResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetScopesForUserWithUseridRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
