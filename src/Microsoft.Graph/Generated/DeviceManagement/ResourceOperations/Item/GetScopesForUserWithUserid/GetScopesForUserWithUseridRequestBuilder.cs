...
namespace Microsoft.Graph.Beta.DeviceManagement.ResourceOperations.Item.GetScopesForUserWithUserid {
    ...
    public class GetScopesForUserWithUseridRequestBuilder {
        ...
        /// </summary>
        public async Task<GetScopesForUserWithUseridResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetScopesForUserWithUseridRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<GetScopesForUserWithUseridResponse>(requestInfo, GetScopesForUserWithUseridResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
