...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceManagementTemplateInsightsDefinitionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceManagementTemplateInsightsDefinitionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementTemplateInsightsDefinition?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceManagementTemplateInsightsDefinitionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementTemplateInsightsDefinition> GetAsync(CancellationToken cancellationToken = default, Action<DeviceManagementTemplateInsightsDefinitionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementTemplateInsightsDefinition?> PatchAsync(DeviceManagementTemplateInsightsDefinition body, CancellationToken cancellationToken = default, Action<DeviceManagementTemplateInsightsDefinitionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementTemplateInsightsDefinition> PatchAsync(DeviceManagementTemplateInsightsDefinition body, CancellationToken cancellationToken = default, Action<DeviceManagementTemplateInsightsDefinitionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
