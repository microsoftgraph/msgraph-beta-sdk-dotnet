...
#nullable enable
        public async Task<AndroidForWorkEnrollmentProfileCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AndroidForWorkEnrollmentProfilesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AndroidForWorkEnrollmentProfileCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AndroidForWorkEnrollmentProfilesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AndroidForWorkEnrollmentProfile?> PostAsync(AndroidForWorkEnrollmentProfile body, CancellationToken cancellationToken = default, Action<AndroidForWorkEnrollmentProfilesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AndroidForWorkEnrollmentProfile> PostAsync(AndroidForWorkEnrollmentProfile body, CancellationToken cancellationToken = default, Action<AndroidForWorkEnrollmentProfilesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
