...
#nullable enable
        public async Task<GenerateDownloadUrlResponse?> PostAsync(CancellationToken cancellationToken = default, Action<GenerateDownloadUrlRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GenerateDownloadUrlResponse> PostAsync(CancellationToken cancellationToken = default, Action<GenerateDownloadUrlRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
