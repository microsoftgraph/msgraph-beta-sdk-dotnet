    ...
    public class MicrosoftTunnelServerLogCollectionResponsesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as MicrosoftTunnelServerLogCollectionResponsesResponse).Value = n.GetCollectionOfObjectValues<MicrosoftTunnelServerLogCollectionResponse>().ToList(); } },
            };
        }
        /// <summary>
