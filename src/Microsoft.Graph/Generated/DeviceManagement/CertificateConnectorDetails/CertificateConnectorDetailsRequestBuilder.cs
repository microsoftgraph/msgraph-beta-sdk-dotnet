...
namespace MicrosoftGraphSdk.DeviceManagement.CertificateConnectorDetails {
    ...
    public class CertificateConnectorDetailsRequestBuilder {
        ...
        /// </summary>
        public async Task<CertificateConnectorDetailsCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
