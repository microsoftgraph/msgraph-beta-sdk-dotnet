...
using MicrosoftGraphSdk.DeviceManagement.CertificateConnectorDetails.Count;
...
namespace MicrosoftGraphSdk.DeviceManagement.CertificateConnectorDetails {
    ...
    public class CertificateConnectorDetailsRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.CertificateConnectorDetails body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
