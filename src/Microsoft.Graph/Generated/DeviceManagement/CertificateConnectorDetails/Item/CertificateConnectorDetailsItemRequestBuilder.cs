...
namespace MicrosoftGraphSdk.DeviceManagement.CertificateConnectorDetails.Item {
    ...
    public class CertificateConnectorDetailsItemRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.CertificateConnectorDetails body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
