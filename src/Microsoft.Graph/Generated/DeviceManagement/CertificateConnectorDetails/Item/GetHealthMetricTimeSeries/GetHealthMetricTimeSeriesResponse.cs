    ...
    public class GetHealthMetricTimeSeriesResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetHealthMetricTimeSeriesResponse).Value = n.GetCollectionOfObjectValues<CertificateConnectorHealthMetricValue>(CertificateConnectorHealthMetricValue.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
