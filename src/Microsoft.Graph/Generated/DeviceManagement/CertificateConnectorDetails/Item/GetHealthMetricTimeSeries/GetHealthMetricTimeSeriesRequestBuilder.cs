...
#nullable enable
        public async Task<GetHealthMetricTimeSeriesResponse?> PostAsync(GetHealthMetricTimeSeriesPostRequestBody body, CancellationToken cancellationToken = default, Action<GetHealthMetricTimeSeriesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetHealthMetricTimeSeriesResponse> PostAsync(GetHealthMetricTimeSeriesPostRequestBody body, CancellationToken cancellationToken = default, Action<GetHealthMetricTimeSeriesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
