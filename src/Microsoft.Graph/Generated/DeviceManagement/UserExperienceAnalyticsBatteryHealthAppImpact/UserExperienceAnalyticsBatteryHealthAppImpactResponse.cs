...
namespace MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsBatteryHealthAppImpact {
    public class UserExperienceAnalyticsBatteryHealthAppImpactResponse : IParsable {
        ...
        /// </summary>
        public UserExperienceAnalyticsBatteryHealthAppImpactResponse() {
        ...
        /// </summary>
        public static UserExperienceAnalyticsBatteryHealthAppImpactResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UserExperienceAnalyticsBatteryHealthAppImpactResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UserExperienceAnalyticsBatteryHealthAppImpactResponse).Value = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsBatteryHealthAppImpact>(MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsBatteryHealthAppImpact.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
