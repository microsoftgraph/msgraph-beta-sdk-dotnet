...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceManagementPartners.Item.Terminate {
    ...
    public class TerminateRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TerminateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreatePostRequestInformation(Action<TerminateRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
