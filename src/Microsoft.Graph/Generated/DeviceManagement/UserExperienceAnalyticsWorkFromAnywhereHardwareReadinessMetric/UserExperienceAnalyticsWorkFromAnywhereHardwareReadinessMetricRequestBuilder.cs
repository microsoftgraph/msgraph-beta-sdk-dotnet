...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric {
    ...
    public class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(Microsoft.Graph.Beta.Models.UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
