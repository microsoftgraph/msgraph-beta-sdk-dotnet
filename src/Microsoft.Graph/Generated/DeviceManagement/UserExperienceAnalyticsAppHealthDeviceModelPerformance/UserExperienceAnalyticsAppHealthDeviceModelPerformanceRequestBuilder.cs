...
using MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsAppHealthDeviceModelPerformance.Count;
using MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsAppHealthDeviceModelPerformance.Item;
...
namespace MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsAppHealthDeviceModelPerformance {
    ...
    public class UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.deviceManagement.userExperienceAnalyticsAppHealthDeviceModelPerformance.item collection</summary>
        public UserExperienceAnalyticsAppHealthDeviceModelPerformanceItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("userExperienceAnalyticsAppHealthDeviceModelPerformance_id", position);
        ...
        public UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthDeviceModelPerformance{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsAppHealthDeviceModelPerformance body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsAppHealthDeviceModelPerformance> PostAsync(MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsAppHealthDeviceModelPerformance body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
