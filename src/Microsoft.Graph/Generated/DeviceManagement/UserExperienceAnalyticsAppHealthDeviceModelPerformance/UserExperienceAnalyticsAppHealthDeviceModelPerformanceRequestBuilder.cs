...
namespace MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsAppHealthDeviceModelPerformance {
    ...
    public class UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsAppHealthDeviceModelPerformance body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// </summary>
        public async Task<UserExperienceAnalyticsAppHealthDeviceModelPerformanceCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
