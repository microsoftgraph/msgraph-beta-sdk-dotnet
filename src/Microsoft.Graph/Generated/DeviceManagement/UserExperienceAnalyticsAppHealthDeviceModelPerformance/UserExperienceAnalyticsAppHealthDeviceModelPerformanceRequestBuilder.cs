...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsAppHealthDeviceModelPerformance {
    ...
    public class UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilder : BaseRequestBuilder {
        ...
        public UserExperienceAnalyticsAppHealthDeviceModelPerformanceItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("userExperienceAnalyticsAppHealthDeviceModelPerformance%2Did", position);
        ...
        public UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthDeviceModelPerformance{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthDeviceModelPerformance{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<UserExperienceAnalyticsAppHealthDeviceModelPerformanceCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserExperienceAnalyticsAppHealthDeviceModelPerformanceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
