...
using System;
namespace Microsoft.Graph.Beta.DeviceManagement.ReusableSettings.Item {
    /// <summary>
    ...
    public class DeviceManagementConfigurationSettingDefinitionItemRequestBuilder : BaseRequestBuilder {
        ...
        public DeviceManagementConfigurationSettingDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/reusableSettings/{deviceManagementConfigurationSettingDefinition%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DeviceManagementConfigurationSettingDefinitionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeviceManagementConfigurationSettingDefinitionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/reusableSettings/{deviceManagementConfigurationSettingDefinition%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
