...
namespace MicrosoftGraphSdk.DeviceManagement.ReusableSettings {
    public class ReusableSettingsResponse : IParsable {
        ...
        /// </summary>
        public static ReusableSettingsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ReusableSettingsResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ReusableSettingsResponse).Value = n.GetCollectionOfObjectValues<DeviceManagementConfigurationSettingDefinition>(DeviceManagementConfigurationSettingDefinition.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
