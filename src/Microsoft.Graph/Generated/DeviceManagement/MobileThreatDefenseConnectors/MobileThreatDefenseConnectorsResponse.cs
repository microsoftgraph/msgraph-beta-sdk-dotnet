...
namespace MicrosoftGraphSdk.DeviceManagement.MobileThreatDefenseConnectors {
    public class MobileThreatDefenseConnectorsResponse : IParsable {
        ...
        /// </summary>
        public static MobileThreatDefenseConnectorsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new MobileThreatDefenseConnectorsResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as MobileThreatDefenseConnectorsResponse).Value = n.GetCollectionOfObjectValues<MobileThreatDefenseConnector>(MobileThreatDefenseConnector.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
