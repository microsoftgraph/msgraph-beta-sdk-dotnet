...
namespace Microsoft.Graph.Beta.DeviceManagement.AppleUserInitiatedEnrollmentProfiles.Item {
    ...
    public class AppleUserInitiatedEnrollmentProfileItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AppleUserInitiatedEnrollmentProfile> PatchAsync(AppleUserInitiatedEnrollmentProfile body, Action<AppleUserInitiatedEnrollmentProfileItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
