...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AppleUserInitiatedEnrollmentProfileItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AppleUserInitiatedEnrollmentProfileItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AppleUserInitiatedEnrollmentProfile?> GetAsync(CancellationToken cancellationToken = default, Action<AppleUserInitiatedEnrollmentProfileItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AppleUserInitiatedEnrollmentProfile> GetAsync(CancellationToken cancellationToken = default, Action<AppleUserInitiatedEnrollmentProfileItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AppleUserInitiatedEnrollmentProfile?> PatchAsync(AppleUserInitiatedEnrollmentProfile body, CancellationToken cancellationToken = default, Action<AppleUserInitiatedEnrollmentProfileItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AppleUserInitiatedEnrollmentProfile> PatchAsync(AppleUserInitiatedEnrollmentProfile body, CancellationToken cancellationToken = default, Action<AppleUserInitiatedEnrollmentProfileItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
