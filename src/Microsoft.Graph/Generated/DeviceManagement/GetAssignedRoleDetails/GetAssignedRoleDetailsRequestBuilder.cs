...
namespace Microsoft.Graph.Beta.DeviceManagement.GetAssignedRoleDetails {
    ...
    public class GetAssignedRoleDetailsRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetAssignedRoleDetailsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<DeviceAndAppManagementAssignedRoleDetails> GetAsync(CancellationToken cancellationToken = default, Action<GetAssignedRoleDetailsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<DeviceAndAppManagementAssignedRoleDetails>(requestInfo, DeviceAndAppManagementAssignedRoleDetails.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
