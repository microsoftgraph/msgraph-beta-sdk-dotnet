...
#nullable enable
        public async Task<DeviceAndAppManagementAssignedRoleDetails?> GetAsync(CancellationToken cancellationToken = default, Action<GetAssignedRoleDetailsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceAndAppManagementAssignedRoleDetails> GetAsync(CancellationToken cancellationToken = default, Action<GetAssignedRoleDetailsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
