...
namespace Microsoft.Graph.Beta.DeviceManagement.GetAssignedRoleDetails {
    ...
    public class GetAssignedRoleDetailsRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceAndAppManagementAssignedRoleDetails> GetAsync(Action<GetAssignedRoleDetailsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
