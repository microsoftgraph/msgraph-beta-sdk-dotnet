...
namespace Microsoft.Graph.Beta.DeviceManagement.GetComanagedDevicesSummary {
    ...
    public class GetComanagedDevicesSummaryRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<ComanagedDevicesSummary> GetAsync(Action<GetComanagedDevicesSummaryRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
