...
namespace Microsoft.Graph.Beta.DeviceManagement.ReusablePolicySettings {
    ...
    public class ReusablePolicySettingsRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceManagementReusablePolicySettingCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ReusablePolicySettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceManagementReusablePolicySetting> PostAsync(DeviceManagementReusablePolicySetting body, CancellationToken cancellationToken = default, Action<ReusablePolicySettingsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
