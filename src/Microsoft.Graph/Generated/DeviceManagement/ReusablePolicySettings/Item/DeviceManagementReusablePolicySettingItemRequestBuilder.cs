...
namespace Microsoft.Graph.Beta.DeviceManagement.ReusablePolicySettings.Item
{
    ...
    public class DeviceManagementReusablePolicySettingItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.DeviceManagement.ReusablePolicySettings.Item.Clone.CloneRequestBuilder Clone
        {
            get => new Microsoft.Graph.Beta.DeviceManagement.ReusablePolicySettings.Item.Clone.CloneRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Microsoft.Graph.Beta.DeviceManagement.ReusablePolicySettings.Item.ReferencingConfigurationPolicies.ReferencingConfigurationPoliciesRequestBuilder ReferencingConfigurationPolicies
        {
            get => new Microsoft.Graph.Beta.DeviceManagement.ReusablePolicySettings.Item.ReferencingConfigurationPolicies.ReferencingConfigurationPoliciesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.DeviceManagement.ReusablePolicySettings.Item.DeviceManagementReusablePolicySettingItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.DeviceManagementReusablePolicySetting?> PatchAsync(Microsoft.Graph.Beta.Models.DeviceManagementReusablePolicySetting body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.DeviceManagementReusablePolicySetting> PatchAsync(Microsoft.Graph.Beta.Models.DeviceManagementReusablePolicySetting body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Beta.Models.DeviceManagementReusablePolicySetting body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Beta.Models.DeviceManagementReusablePolicySetting body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.DeviceManagement.ReusablePolicySettings.Item.DeviceManagementReusablePolicySettingItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.DeviceManagement.ReusablePolicySettings.Item.DeviceManagementReusablePolicySettingItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class DeviceManagementReusablePolicySettingItemRequestBuilderDeleteRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
        /// <summary>
        /// List of all reusable settings that can be referred in a policy
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class DeviceManagementReusablePolicySettingItemRequestBuilderPatchRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
