...
namespace Microsoft.Graph.Beta.DeviceManagement.ReusablePolicySettings.Item.ReferencingConfigurationPolicies {
    ...
    public class ReferencingConfigurationPoliciesRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceManagementConfigurationPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ReferencingConfigurationPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceManagementConfigurationPolicy> PostAsync(DeviceManagementConfigurationPolicy body, CancellationToken cancellationToken = default, Action<ReferencingConfigurationPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
