...
#nullable enable
        public async Task<DeviceManagementConfigurationPolicyCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ReferencingConfigurationPoliciesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementConfigurationPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ReferencingConfigurationPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementConfigurationPolicy?> PostAsync(DeviceManagementConfigurationPolicy body, CancellationToken cancellationToken = default, Action<ReferencingConfigurationPoliciesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementConfigurationPolicy> PostAsync(DeviceManagementConfigurationPolicy body, CancellationToken cancellationToken = default, Action<ReferencingConfigurationPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
