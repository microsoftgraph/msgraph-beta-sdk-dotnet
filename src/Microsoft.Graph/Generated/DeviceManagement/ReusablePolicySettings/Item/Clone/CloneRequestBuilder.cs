...
namespace MicrosoftGraphSdk.DeviceManagement.ReusablePolicySettings.Item.Clone {
    ...
    public class CloneRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceManagementReusablePolicySetting> PostAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
