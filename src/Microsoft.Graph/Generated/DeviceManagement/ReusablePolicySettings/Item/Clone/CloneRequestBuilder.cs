...
namespace Microsoft.Graph.Beta.DeviceManagement.ReusablePolicySettings.Item.Clone {
    ...
    public class CloneRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Action<CloneRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<DeviceManagementReusablePolicySetting> PostAsync(Action<CloneRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
