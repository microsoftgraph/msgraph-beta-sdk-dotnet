...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceManagementDerivedCredentialSettingsItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceManagementDerivedCredentialSettingsItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementDerivedCredentialSettings?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceManagementDerivedCredentialSettingsItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementDerivedCredentialSettings> GetAsync(CancellationToken cancellationToken = default, Action<DeviceManagementDerivedCredentialSettingsItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementDerivedCredentialSettings?> PatchAsync(DeviceManagementDerivedCredentialSettings body, CancellationToken cancellationToken = default, Action<DeviceManagementDerivedCredentialSettingsItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementDerivedCredentialSettings> PatchAsync(DeviceManagementDerivedCredentialSettings body, CancellationToken cancellationToken = default, Action<DeviceManagementDerivedCredentialSettingsItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
