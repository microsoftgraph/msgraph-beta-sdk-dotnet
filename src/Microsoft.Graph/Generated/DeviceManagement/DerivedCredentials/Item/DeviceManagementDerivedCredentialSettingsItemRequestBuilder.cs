...
namespace Microsoft.Graph.Beta.DeviceManagement.DerivedCredentials.Item {
    ...
    public class DeviceManagementDerivedCredentialSettingsItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DeviceManagementDerivedCredentialSettings body, Action<DeviceManagementDerivedCredentialSettingsItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
