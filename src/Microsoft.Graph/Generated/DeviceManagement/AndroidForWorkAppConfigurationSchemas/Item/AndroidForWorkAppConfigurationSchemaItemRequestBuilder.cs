...
#nullable restore
        ...
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public AndroidForWorkAppConfigurationSchemaItemRequestBuilder WithUrl(string rawUrl) {
            return new AndroidForWorkAppConfigurationSchemaItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
