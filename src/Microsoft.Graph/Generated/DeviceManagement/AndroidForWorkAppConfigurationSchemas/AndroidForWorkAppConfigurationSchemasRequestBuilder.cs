...
namespace Microsoft.Graph.Beta.DeviceManagement.AndroidForWorkAppConfigurationSchemas {
    ...
    public class AndroidForWorkAppConfigurationSchemasRequestBuilder {
        ...
        /// </summary>
        public async Task<AndroidForWorkAppConfigurationSchemaCollectionResponse> GetAsync(Action<AndroidForWorkAppConfigurationSchemasRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AndroidForWorkAppConfigurationSchema> PostAsync(AndroidForWorkAppConfigurationSchema body, Action<AndroidForWorkAppConfigurationSchemasRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
