...
namespace Microsoft.Graph.Beta.DeviceManagement.AndroidForWorkAppConfigurationSchemas {
    ...
    public class AndroidForWorkAppConfigurationSchemasRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.deviceManagement.androidForWorkAppConfigurationSchemas.item collection</summary>
        ...
        /// </summary>
        public AndroidForWorkAppConfigurationSchemasRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/deviceManagement/androidForWorkAppConfigurationSchemas{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AndroidForWorkAppConfigurationSchemasRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<AndroidForWorkAppConfigurationSchemasRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AndroidForWorkAppConfigurationSchema body, Action<AndroidForWorkAppConfigurationSchemasRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<AndroidForWorkAppConfigurationSchemaCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AndroidForWorkAppConfigurationSchemasRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<AndroidForWorkAppConfigurationSchemaCollectionResponse>(requestInfo, AndroidForWorkAppConfigurationSchemaCollectionResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to androidForWorkAppConfigurationSchemas for deviceManagement
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AndroidForWorkAppConfigurationSchema> PostAsync(AndroidForWorkAppConfigurationSchema body, CancellationToken cancellationToken = default, Action<AndroidForWorkAppConfigurationSchemasRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<AndroidForWorkAppConfigurationSchema>(requestInfo, AndroidForWorkAppConfigurationSchema.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
