...
namespace Microsoft.Graph.Beta.DeviceManagement.AndroidForWorkAppConfigurationSchemas {
    ...
    public class AndroidForWorkAppConfigurationSchemasRequestBuilder : BaseRequestBuilder {
        ...
        public AndroidForWorkAppConfigurationSchemaItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("androidForWorkAppConfigurationSchema%2Did", position);
...
#nullable enable
        public async Task<AndroidForWorkAppConfigurationSchemaCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AndroidForWorkAppConfigurationSchemasRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AndroidForWorkAppConfigurationSchemaCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AndroidForWorkAppConfigurationSchemasRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AndroidForWorkAppConfigurationSchema?> PostAsync(AndroidForWorkAppConfigurationSchema body, CancellationToken cancellationToken = default, Action<AndroidForWorkAppConfigurationSchemasRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AndroidForWorkAppConfigurationSchema> PostAsync(AndroidForWorkAppConfigurationSchema body, CancellationToken cancellationToken = default, Action<AndroidForWorkAppConfigurationSchemasRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
