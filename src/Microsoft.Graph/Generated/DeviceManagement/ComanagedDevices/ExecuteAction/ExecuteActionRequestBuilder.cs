...
namespace MicrosoftGraphSdk.DeviceManagement.ComanagedDevices.ExecuteAction {
    /// <summary>Builds and executes requests for operations under \deviceManagement\comanagedDevices\microsoft.graph.executeAction</summary>
    public class ExecuteActionRequestBuilder {
        ...
        public ExecuteActionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/comanagedDevices/microsoft.graph.executeAction";
