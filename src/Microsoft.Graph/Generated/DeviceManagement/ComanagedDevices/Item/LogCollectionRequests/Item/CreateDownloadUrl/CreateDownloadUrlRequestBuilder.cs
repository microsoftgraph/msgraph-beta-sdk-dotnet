...
#nullable enable
        public async Task<CreateDownloadUrlPostResponse?> PostAsCreateDownloadUrlPostResponseAsync(Action<CreateDownloadUrlRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CreateDownloadUrlPostResponse> PostAsCreateDownloadUrlPostResponseAsync(Action<CreateDownloadUrlRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
