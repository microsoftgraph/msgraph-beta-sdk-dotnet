...
using MicrosoftGraphSdk.DeviceManagement.ComanagedDevices.Item.LogCollectionRequests.Item;
...
namespace MicrosoftGraphSdk.DeviceManagement.ComanagedDevices.Item.LogCollectionRequests {
    /// <summary>Builds and executes requests for operations under \deviceManagement\comanagedDevices\{managedDevice-id}\logCollectionRequests</summary>
    public class LogCollectionRequestsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.deviceManagement.comanagedDevices.item.logCollectionRequests.item collection</summary>
        ...
        public LogCollectionRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice_id}/logCollectionRequests{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
