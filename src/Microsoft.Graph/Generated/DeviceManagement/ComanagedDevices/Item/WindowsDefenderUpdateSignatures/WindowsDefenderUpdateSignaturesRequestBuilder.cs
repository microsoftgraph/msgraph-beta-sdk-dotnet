...
using System;
namespace Microsoft.Graph.Beta.DeviceManagement.ComanagedDevices.Item.WindowsDefenderUpdateSignatures {
    /// <summary>
    ...
    public class WindowsDefenderUpdateSignaturesRequestBuilder : BaseRequestBuilder {
        ...
        public WindowsDefenderUpdateSignaturesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/windowsDefenderUpdateSignatures", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WindowsDefenderUpdateSignaturesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WindowsDefenderUpdateSignaturesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/windowsDefenderUpdateSignatures", rawUrl) {
        }
        /// <summary>
