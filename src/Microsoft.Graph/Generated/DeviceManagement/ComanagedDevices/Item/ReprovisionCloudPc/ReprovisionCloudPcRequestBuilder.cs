...
namespace Microsoft.Graph.Beta.DeviceManagement.ComanagedDevices.Item.ReprovisionCloudPc {
    ...
    public class ReprovisionCloudPcRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Action<ReprovisionCloudPcRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(Action<ReprovisionCloudPcRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
