...
namespace Microsoft.Graph.Beta.DeviceManagement.ComanagedDevices.Item.EndRemoteHelpSession {
    ...
    public class EndRemoteHelpSessionRequestBuilder : BaseRequestBuilder {
        ...
        public EndRemoteHelpSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/endRemoteHelpSession", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EndRemoteHelpSessionRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EndRemoteHelpSessionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/endRemoteHelpSession", rawUrl) {
        }
        /// <summary>
