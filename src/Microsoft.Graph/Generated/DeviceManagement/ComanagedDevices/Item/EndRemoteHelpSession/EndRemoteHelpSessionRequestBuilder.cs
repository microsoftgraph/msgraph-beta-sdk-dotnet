...
namespace Microsoft.Graph.Beta.DeviceManagement.ComanagedDevices.Item.EndRemoteHelpSession {
    /// <summary>Provides operations to call the endRemoteHelpSession method.</summary>
    public class EndRemoteHelpSessionRequestBuilder {
        ...
        public EndRemoteHelpSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EndRemoteHelpSessionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreatePostRequestInformation(EndRemoteHelpSessionPostRequestBody body, Action<EndRemoteHelpSessionRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
