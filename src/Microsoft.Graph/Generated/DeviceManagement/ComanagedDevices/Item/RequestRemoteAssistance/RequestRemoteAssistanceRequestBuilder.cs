...
namespace Microsoft.Graph.Beta.DeviceManagement.ComanagedDevices.Item.RequestRemoteAssistance {
    ...
    public class RequestRemoteAssistanceRequestBuilder {
        ...
        public RequestRemoteAssistanceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/microsoft.graph.requestRemoteAssistance";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Action<RequestRemoteAssistanceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<RequestRemoteAssistanceRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
