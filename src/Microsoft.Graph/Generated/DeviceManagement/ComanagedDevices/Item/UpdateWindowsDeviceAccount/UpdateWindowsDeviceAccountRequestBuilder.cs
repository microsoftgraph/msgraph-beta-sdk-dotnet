...
namespace Microsoft.Graph.Beta.DeviceManagement.ComanagedDevices.Item.UpdateWindowsDeviceAccount {
    ...
    public class UpdateWindowsDeviceAccountRequestBuilder : BaseRequestBuilder {
        ...
        public UpdateWindowsDeviceAccountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/updateWindowsDeviceAccount", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UpdateWindowsDeviceAccountRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UpdateWindowsDeviceAccountRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/updateWindowsDeviceAccount", rawUrl) {
        }
        /// <summary>
