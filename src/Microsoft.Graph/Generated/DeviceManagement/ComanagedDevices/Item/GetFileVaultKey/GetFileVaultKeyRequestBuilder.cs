...
namespace Microsoft.Graph.Beta.DeviceManagement.ComanagedDevices.Item.GetFileVaultKey {
    ...
    public class GetFileVaultKeyRequestBuilder : BaseRequestBuilder {
        ...
        public GetFileVaultKeyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/getFileVaultKey()", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetFileVaultKeyRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetFileVaultKeyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/getFileVaultKey()", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<GetFileVaultKeyResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetFileVaultKeyRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetFileVaultKeyResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetFileVaultKeyRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
