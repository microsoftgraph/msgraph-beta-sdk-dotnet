...
namespace Microsoft.Graph.Beta.DeviceManagement.ComanagedDevices.Item.RemoteLock {
    /// <summary>
    ...
    public class RemoteLockRequestBuilder : BaseRequestBuilder {
        ...
        public RemoteLockRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/remoteLock", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RemoteLockRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoteLockRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/remoteLock", rawUrl) {
        }
        /// <summary>
        /// Remote lock
        /// </summary>
