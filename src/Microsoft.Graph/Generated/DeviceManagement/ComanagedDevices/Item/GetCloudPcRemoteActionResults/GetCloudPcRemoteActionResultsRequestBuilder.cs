...
namespace Microsoft.Graph.Beta.DeviceManagement.ComanagedDevices.Item.GetCloudPcRemoteActionResults {
    ...
    public class GetCloudPcRemoteActionResultsRequestBuilder {
        ...
        public GetCloudPcRemoteActionResultsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/microsoft.graph.getCloudPcRemoteActionResults(){?%24top,%24skip,%24search,%24filter,%24count}";
