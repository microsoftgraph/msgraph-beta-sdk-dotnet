...
namespace Microsoft.Graph.Beta.DeviceManagement.ComanagedDevices.Item.EnableLostMode {
    ...
    public class EnableLostModeRequestBuilder : BaseRequestBuilder {
        ...
        public EnableLostModeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/enableLostMode", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EnableLostModeRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EnableLostModeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/enableLostMode", rawUrl) {
        }
        /// <summary>
        /// Enable lost mode
        /// </summary>
...
#nullable enable
        public async Task PostAsync(EnableLostModePostRequestBody body, CancellationToken cancellationToken = default, Action<EnableLostModeRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(EnableLostModePostRequestBody body, CancellationToken cancellationToken = default, Action<EnableLostModeRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
