...
using System;
namespace Microsoft.Graph.Beta.DeviceManagement.ComanagedDevices.Item.ShutDown {
    /// <summary>
    ...
    public class ShutDownRequestBuilder : BaseRequestBuilder {
        ...
        public ShutDownRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/shutDown", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ShutDownRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ShutDownRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/shutDown", rawUrl) {
        }
        /// <summary>
        /// Shut down device
        /// </summary>
