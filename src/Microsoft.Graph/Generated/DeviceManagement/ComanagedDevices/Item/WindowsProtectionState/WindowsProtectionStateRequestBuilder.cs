...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<WindowsProtectionStateRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<WindowsProtectionStateRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.WindowsProtectionState?> GetAsync(CancellationToken cancellationToken = default, Action<WindowsProtectionStateRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.WindowsProtectionState> GetAsync(CancellationToken cancellationToken = default, Action<WindowsProtectionStateRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.WindowsProtectionState?> PatchAsync(Microsoft.Graph.Beta.Models.WindowsProtectionState body, CancellationToken cancellationToken = default, Action<WindowsProtectionStateRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.WindowsProtectionState> PatchAsync(Microsoft.Graph.Beta.Models.WindowsProtectionState body, CancellationToken cancellationToken = default, Action<WindowsProtectionStateRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
