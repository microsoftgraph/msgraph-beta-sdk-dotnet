...
namespace Microsoft.Graph.Beta.DeviceManagement.ComanagedDevices.Item.InitiateOnDemandProactiveRemediation {
    ...
    public class InitiateOnDemandProactiveRemediationRequestBuilder : BaseRequestBuilder {
        ...
        public InitiateOnDemandProactiveRemediationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/initiateOnDemandProactiveRemediation", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new InitiateOnDemandProactiveRemediationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InitiateOnDemandProactiveRemediationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/initiateOnDemandProactiveRemediation", rawUrl) {
        }
        /// <summary>
