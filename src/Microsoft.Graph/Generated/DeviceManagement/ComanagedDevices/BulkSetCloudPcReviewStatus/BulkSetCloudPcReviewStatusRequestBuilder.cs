...
namespace Microsoft.Graph.Beta.DeviceManagement.ComanagedDevices.BulkSetCloudPcReviewStatus {
    ...
    public class BulkSetCloudPcReviewStatusRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(BulkSetCloudPcReviewStatusRequestBody body, Action<BulkSetCloudPcReviewStatusRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<CloudPcBulkRemoteActionResult> PostAsync(BulkSetCloudPcReviewStatusRequestBody body, Action<BulkSetCloudPcReviewStatusRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
