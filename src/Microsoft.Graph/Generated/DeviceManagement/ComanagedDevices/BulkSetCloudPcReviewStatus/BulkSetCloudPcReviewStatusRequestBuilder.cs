...
#nullable enable
        public async Task<CloudPcBulkRemoteActionResult?> PostAsync(BulkSetCloudPcReviewStatusPostRequestBody body, CancellationToken cancellationToken = default, Action<BulkSetCloudPcReviewStatusRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CloudPcBulkRemoteActionResult> PostAsync(BulkSetCloudPcReviewStatusPostRequestBody body, CancellationToken cancellationToken = default, Action<BulkSetCloudPcReviewStatusRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
