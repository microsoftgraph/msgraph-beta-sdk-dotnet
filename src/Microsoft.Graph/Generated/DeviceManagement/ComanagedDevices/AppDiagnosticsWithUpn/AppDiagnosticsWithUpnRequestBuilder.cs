...
namespace Microsoft.Graph.Beta.DeviceManagement.ComanagedDevices.AppDiagnosticsWithUpn {
    ...
    public class AppDiagnosticsWithUpnRequestBuilder {
        ...
        public AppDiagnosticsWithUpnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string upn = default) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/comanagedDevices/microsoft.graph.appDiagnostics(upn='{upn}')";
        ...
        /// </summary>
        public async Task<AppDiagnosticsWithUpnResponse> GetAsync(CancellationToken cancellationToken = default, Action<AppDiagnosticsWithUpnRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
