...
#nullable enable
        public async Task<AppDiagnosticsWithUpnResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AppDiagnosticsWithUpnRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AppDiagnosticsWithUpnResponse> GetAsync(CancellationToken cancellationToken = default, Action<AppDiagnosticsWithUpnRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
