...
#nullable enable
        public async Task<ManagedDeviceCollectionResponse?> GetAsync(Action<RequestConfiguration<ComanagedDevicesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ManagedDeviceCollectionResponse> GetAsync(Action<RequestConfiguration<ComanagedDevicesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ComanagedDevicesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class ComanagedDevicesRequestBuilderGetRequestConfiguration : RequestConfiguration<ComanagedDevicesRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
