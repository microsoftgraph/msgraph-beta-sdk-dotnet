...
namespace Microsoft.Graph.Beta.DeviceManagement.RemoteAssistancePartners.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/remoteAssistancePartners/$count{?%24search,%24filter}";
