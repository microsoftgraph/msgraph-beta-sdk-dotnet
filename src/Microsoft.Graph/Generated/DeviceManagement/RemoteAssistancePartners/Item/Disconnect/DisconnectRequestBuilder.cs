...
namespace Microsoft.Graph.Beta.DeviceManagement.RemoteAssistancePartners.Item.Disconnect {
    ...
    public class DisconnectRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<DisconnectRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
