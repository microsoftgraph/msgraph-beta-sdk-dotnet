...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsRegressionSummary.ManufacturerRegression.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsRegressionSummary/manufacturerRegression/$count";
