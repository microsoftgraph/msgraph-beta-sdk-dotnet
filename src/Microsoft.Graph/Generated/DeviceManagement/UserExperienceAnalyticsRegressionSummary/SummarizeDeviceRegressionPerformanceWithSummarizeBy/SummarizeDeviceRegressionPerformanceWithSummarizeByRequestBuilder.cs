...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsRegressionSummary.SummarizeDeviceRegressionPerformanceWithSummarizeBy {
    ...
    public class SummarizeDeviceRegressionPerformanceWithSummarizeByRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<SummarizeDeviceRegressionPerformanceWithSummarizeByRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new SummarizeDeviceRegressionPerformanceWithSummarizeByRequestBuilderGetRequestConfiguration();
        ...
        public class SummarizeDeviceRegressionPerformanceWithSummarizeByRequestBuilderGetRequestConfiguration {
