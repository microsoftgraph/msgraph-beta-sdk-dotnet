...
namespace MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsRegressionSummary.OperatingSystemRegression {
    public class OperatingSystemRegressionResponse : IParsable {
        ...
        /// </summary>
        public static OperatingSystemRegressionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new OperatingSystemRegressionResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as OperatingSystemRegressionResponse).Value = n.GetCollectionOfObjectValues<UserExperienceAnalyticsMetric>(UserExperienceAnalyticsMetric.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
