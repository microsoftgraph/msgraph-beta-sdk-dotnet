...
using MicrosoftGraph.DeviceManagement.UserExperienceAnalyticsRegressionSummary.ManufacturerRegression;
using MicrosoftGraph.DeviceManagement.UserExperienceAnalyticsRegressionSummary.ModelRegression;
using MicrosoftGraph.DeviceManagement.UserExperienceAnalyticsRegressionSummary.OperatingSystemRegression;
using MicrosoftGraph.DeviceManagement.UserExperienceAnalyticsRegressionSummary.SummarizeDeviceRegressionPerformanceWithSummarizeBy;
...
namespace MicrosoftGraph.DeviceManagement.UserExperienceAnalyticsRegressionSummary {
    ...
    public class UserExperienceAnalyticsRegressionSummaryRequestBuilder {
        ...
        public UserExperienceAnalyticsRegressionSummaryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsRegressionSummary{?select,expand}";
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraph.Models.Microsoft.Graph.UserExperienceAnalyticsRegressionSummary body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        public async Task<MicrosoftGraph.Models.Microsoft.Graph.UserExperienceAnalyticsRegressionSummary> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<MicrosoftGraph.Models.Microsoft.Graph.UserExperienceAnalyticsRegressionSummary>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// User experience analytics regression summary
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MicrosoftGraph.Models.Microsoft.Graph.UserExperienceAnalyticsRegressionSummary body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
