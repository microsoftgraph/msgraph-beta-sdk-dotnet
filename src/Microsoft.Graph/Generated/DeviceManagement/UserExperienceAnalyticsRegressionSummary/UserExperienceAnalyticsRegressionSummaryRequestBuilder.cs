...
using MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsRegressionSummary.ManufacturerRegression;
using MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsRegressionSummary.ModelRegression;
...
namespace MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsRegressionSummary {
    ...
    public class UserExperienceAnalyticsRegressionSummaryRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsRegressionSummary body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsRegressionSummary body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
