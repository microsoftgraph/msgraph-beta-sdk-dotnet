...
namespace MicrosoftGraphSdk.DeviceManagement.RoleAssignments.Item.RoleScopeTags {
    ...
    public class RoleScopeTagsRequestBuilder {
        ...
        public RoleScopeTagsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/roleAssignments/{deviceAndAppManagementRoleAssignment_id}/roleScopeTags{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
