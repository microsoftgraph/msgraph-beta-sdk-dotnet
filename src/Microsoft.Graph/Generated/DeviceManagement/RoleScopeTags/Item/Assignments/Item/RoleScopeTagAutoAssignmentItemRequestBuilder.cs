...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<RoleScopeTagAutoAssignmentItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<RoleScopeTagAutoAssignmentItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<RoleScopeTagAutoAssignment?> GetAsync(CancellationToken cancellationToken = default, Action<RoleScopeTagAutoAssignmentItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RoleScopeTagAutoAssignment> GetAsync(CancellationToken cancellationToken = default, Action<RoleScopeTagAutoAssignmentItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<RoleScopeTagAutoAssignment?> PatchAsync(RoleScopeTagAutoAssignment body, CancellationToken cancellationToken = default, Action<RoleScopeTagAutoAssignmentItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RoleScopeTagAutoAssignment> PatchAsync(RoleScopeTagAutoAssignment body, CancellationToken cancellationToken = default, Action<RoleScopeTagAutoAssignmentItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
