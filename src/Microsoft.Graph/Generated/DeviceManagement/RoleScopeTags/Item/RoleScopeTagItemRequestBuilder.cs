...
namespace MicrosoftGraphSdk.DeviceManagement.RoleScopeTags.Item {
    ...
    public class RoleScopeTagItemRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(RoleScopeTag body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
