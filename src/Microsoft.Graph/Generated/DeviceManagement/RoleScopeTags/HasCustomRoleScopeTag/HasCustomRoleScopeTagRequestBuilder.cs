...
namespace Microsoft.Graph.Beta.DeviceManagement.RoleScopeTags.HasCustomRoleScopeTag {
    ...
    public class HasCustomRoleScopeTagRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="HasCustomRoleScopeTagGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function hasCustomRoleScopeTag
        /// </summary>
        /// <returns>A <cref="HasCustomRoleScopeTagResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="HasCustomRoleScopeTagRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
