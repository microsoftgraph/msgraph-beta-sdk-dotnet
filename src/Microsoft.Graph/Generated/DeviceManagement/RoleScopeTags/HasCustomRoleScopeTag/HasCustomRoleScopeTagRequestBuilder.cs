...
#nullable enable
        public async Task<HasCustomRoleScopeTagResponse?> GetAsync(CancellationToken cancellationToken = default, Action<HasCustomRoleScopeTagRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<HasCustomRoleScopeTagResponse> GetAsync(CancellationToken cancellationToken = default, Action<HasCustomRoleScopeTagRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
