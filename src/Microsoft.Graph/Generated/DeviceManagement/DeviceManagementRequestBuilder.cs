...
using Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsRegressionSummary;
...
namespace Microsoft.Graph.Beta.DeviceManagement {
    ...
    public class DeviceManagementRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.DeviceManagement> GetAsync(CancellationToken cancellationToken = default, Action<DeviceManagementRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.DeviceManagement body, CancellationToken cancellationToken = default, Action<DeviceManagementRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
