...
namespace Microsoft.Graph.Beta.DeviceManagement.HardwareConfigurations.Item.DeviceRunStates {
    ...
    public class DeviceRunStatesRequestBuilder : BaseRequestBuilder 
    {
        ...
        public HardwareConfigurationDeviceStateItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<HardwareConfigurationDeviceStateCollectionResponse?> GetAsync(Action<RequestConfiguration<DeviceRunStatesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<HardwareConfigurationDeviceStateCollectionResponse> GetAsync(Action<RequestConfiguration<DeviceRunStatesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<HardwareConfigurationDeviceStateCollectionResponse>(requestInfo, HardwareConfigurationDeviceStateCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<HardwareConfigurationDeviceState?> PostAsync(HardwareConfigurationDeviceState body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<HardwareConfigurationDeviceState> PostAsync(HardwareConfigurationDeviceState body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
