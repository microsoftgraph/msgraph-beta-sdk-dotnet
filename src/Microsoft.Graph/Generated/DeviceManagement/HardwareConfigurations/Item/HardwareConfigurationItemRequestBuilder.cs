// <auto-generated/>
using Microsoft.Graph.Beta.DeviceManagement.HardwareConfigurations.Item.Assign;
using Microsoft.Graph.Beta.DeviceManagement.HardwareConfigurations.Item.Assignments;
using Microsoft.Graph.Beta.DeviceManagement.HardwareConfigurations.Item.DeviceRunStates;
using Microsoft.Graph.Beta.DeviceManagement.HardwareConfigurations.Item.RunSummary;
...
using System;
namespace Microsoft.Graph.Beta.DeviceManagement.HardwareConfigurations.Item {
    /// <summary>
    ...
    public class HardwareConfigurationItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        public HardwareConfigurationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/hardwareConfigurations/{hardwareConfiguration%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="HardwareConfigurationItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HardwareConfigurationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/hardwareConfigurations/{hardwareConfiguration%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<HardwareConfiguration?> GetAsync(Action<RequestConfiguration<HardwareConfigurationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<HardwareConfiguration> GetAsync(Action<RequestConfiguration<HardwareConfigurationItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<HardwareConfiguration?> PatchAsync(HardwareConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<HardwareConfiguration> PatchAsync(HardwareConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public HardwareConfigurationItemRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class HardwareConfigurationItemRequestBuilderGetRequestConfiguration : RequestConfiguration<HardwareConfigurationItemRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
