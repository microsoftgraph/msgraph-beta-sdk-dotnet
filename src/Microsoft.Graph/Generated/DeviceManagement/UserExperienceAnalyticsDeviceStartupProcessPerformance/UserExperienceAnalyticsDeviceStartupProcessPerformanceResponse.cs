...
namespace MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsDeviceStartupProcessPerformance {
    public class UserExperienceAnalyticsDeviceStartupProcessPerformanceResponse : IParsable {
        ...
        /// </summary>
        public UserExperienceAnalyticsDeviceStartupProcessPerformanceResponse() {
        ...
        /// </summary>
        public static UserExperienceAnalyticsDeviceStartupProcessPerformanceResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UserExperienceAnalyticsDeviceStartupProcessPerformanceResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UserExperienceAnalyticsDeviceStartupProcessPerformanceResponse).Value = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsDeviceStartupProcessPerformance>(MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsDeviceStartupProcessPerformance.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
