...
using MicrosoftGraphSdk.DeviceManagement.OemWarrantyInformationOnboarding.Count;
...
namespace MicrosoftGraphSdk.DeviceManagement.OemWarrantyInformationOnboarding {
    ...
    public class OemWarrantyInformationOnboardingRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.OemWarrantyInformationOnboarding body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
