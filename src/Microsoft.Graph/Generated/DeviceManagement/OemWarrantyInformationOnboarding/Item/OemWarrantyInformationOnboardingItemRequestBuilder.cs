...
namespace Microsoft.Graph.Beta.DeviceManagement.OemWarrantyInformationOnboarding.Item {
    ...
    public class OemWarrantyInformationOnboardingItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<OemWarrantyInformationOnboardingItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.OemWarrantyInformationOnboarding> GetAsync(CancellationToken cancellationToken = default, Action<OemWarrantyInformationOnboardingItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.OemWarrantyInformationOnboarding body, CancellationToken cancellationToken = default, Action<OemWarrantyInformationOnboardingItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
