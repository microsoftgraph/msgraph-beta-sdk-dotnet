...
namespace Microsoft.Graph.Beta.DeviceManagement.WindowsInformationProtectionNetworkLearningSummaries {
    ...
    public class WindowsInformationProtectionNetworkLearningSummariesRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(WindowsInformationProtectionNetworkLearningSummary body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
