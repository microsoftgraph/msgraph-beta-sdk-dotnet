...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.DeviceManagement.WindowsQualityUpdateProfiles {
    public class WindowsQualityUpdateProfilesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as WindowsQualityUpdateProfilesResponse).Value = n.GetCollectionOfObjectValues<WindowsQualityUpdateProfile>().ToList(); } },
            };
        }
        /// <summary>
