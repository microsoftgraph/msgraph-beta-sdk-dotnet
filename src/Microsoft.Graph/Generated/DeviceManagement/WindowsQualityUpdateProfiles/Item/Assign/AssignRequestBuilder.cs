...
namespace Microsoft.Graph.Beta.DeviceManagement.WindowsQualityUpdateProfiles.Item.Assign {
    ...
    public class AssignRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(AssignRequestBody body, Action<AssignRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
