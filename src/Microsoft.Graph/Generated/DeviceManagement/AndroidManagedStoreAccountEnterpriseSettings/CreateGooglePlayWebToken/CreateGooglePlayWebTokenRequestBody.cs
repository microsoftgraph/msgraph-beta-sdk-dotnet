...
namespace MicrosoftGraphSdk.DeviceManagement.AndroidManagedStoreAccountEnterpriseSettings.CreateGooglePlayWebToken {
    ...
    public class CreateGooglePlayWebTokenRequestBody : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static CreateGooglePlayWebTokenRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
