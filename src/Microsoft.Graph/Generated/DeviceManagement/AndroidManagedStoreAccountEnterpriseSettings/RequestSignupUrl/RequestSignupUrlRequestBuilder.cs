...
namespace Microsoft.Graph.Beta.DeviceManagement.AndroidManagedStoreAccountEnterpriseSettings.RequestSignupUrl {
    ...
    public class RequestSignupUrlRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="RequestSignupUrlPostResponse"></returns>
...
#nullable restore
        ...
        /// Invoke action requestSignupUrl
        /// </summary>
        /// <returns>A <cref="RequestSignupUrlResponse"></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="RequestSignupUrlRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
