...
namespace Microsoft.Graph.Beta.DeviceManagement.ApplePushNotificationCertificate {
    ...
    public class ApplePushNotificationCertificateRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ApplePushNotificationCertificateRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.ApplePushNotificationCertificate> GetAsync(CancellationToken cancellationToken = default, Action<ApplePushNotificationCertificateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.ApplePushNotificationCertificate body, CancellationToken cancellationToken = default, Action<ApplePushNotificationCertificateRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
