...
namespace MicrosoftGraphSdk.DeviceManagement.ApplePushNotificationCertificate.DownloadApplePushNotificationCertificateSigningRequest {
    ...
    public class DownloadApplePushNotificationCertificateSigningRequestRequestBuilder {
        ...
        /// </summary>
        public async Task<DownloadApplePushNotificationCertificateSigningRequestResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
