...
namespace Microsoft.Graph.Beta.DeviceManagement.AssignmentFilters.Item.GetSupportedProperties {
    ...
    public class GetSupportedPropertiesRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetSupportedPropertiesGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function getSupportedProperties
        /// </summary>
        /// <returns>A <cref="GetSupportedPropertiesResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetSupportedPropertiesRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
