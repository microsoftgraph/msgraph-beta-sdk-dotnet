...
namespace Microsoft.Graph.Beta.DeviceManagement.AssignmentFilters.GetPlatformSupportedPropertiesWithPlatform {
    ...
    public class GetPlatformSupportedPropertiesWithPlatformResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AssignmentFilterSupportedProperty> Value {
            get { return BackingStore?.Get<List<AssignmentFilterSupportedProperty>>(nameof(Value)); }
