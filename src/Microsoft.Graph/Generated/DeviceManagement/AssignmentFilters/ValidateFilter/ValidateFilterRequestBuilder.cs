...
#nullable enable
        public async Task<AssignmentFilterValidationResult?> PostAsync(ValidateFilterPostRequestBody body, CancellationToken cancellationToken = default, Action<ValidateFilterRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AssignmentFilterValidationResult> PostAsync(ValidateFilterPostRequestBody body, CancellationToken cancellationToken = default, Action<ValidateFilterRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
