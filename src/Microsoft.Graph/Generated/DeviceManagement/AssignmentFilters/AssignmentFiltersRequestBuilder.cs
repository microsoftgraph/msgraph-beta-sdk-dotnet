...
namespace Microsoft.Graph.Beta.DeviceManagement.AssignmentFilters {
    ...
    public class AssignmentFiltersRequestBuilder : BaseRequestBuilder 
    {
        ...
        {
            get => new GetStateRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the validateFilter method.</summary>
        public ValidateFilterRequestBuilder ValidateFilter
        {
            get => new ValidateFilterRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public DeviceAndAppManagementAssignmentFilterItemRequestBuilder this[string position]
        {
            get
            {
