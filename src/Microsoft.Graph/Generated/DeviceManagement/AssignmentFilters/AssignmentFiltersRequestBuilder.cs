...
namespace Microsoft.Graph.Beta.DeviceManagement.AssignmentFilters {
    ...
    public class AssignmentFiltersRequestBuilder : BaseRequestBuilder {
        ...
        public AssignmentFiltersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/assignmentFilters{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AssignmentFiltersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AssignmentFiltersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/assignmentFilters{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public async Task<DeviceAndAppManagementAssignmentFilterCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AssignmentFiltersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            return await RequestAdapter.SendAsync<DeviceAndAppManagementAssignmentFilterCollectionResponse>(requestInfo, DeviceAndAppManagementAssignmentFilterCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<AssignmentFiltersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<AssignmentFiltersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(DeviceAndAppManagementAssignmentFilter body, Action<AssignmentFiltersRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(DeviceAndAppManagementAssignmentFilter body, Action<AssignmentFiltersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#nullable restore
        ...
        public class AssignmentFiltersRequestBuilderGetRequestConfiguration {
            ...
            public AssignmentFiltersRequestBuilderGetQueryParameters QueryParameters { get; set; } = new AssignmentFiltersRequestBuilderGetQueryParameters();
            /// <summary>
