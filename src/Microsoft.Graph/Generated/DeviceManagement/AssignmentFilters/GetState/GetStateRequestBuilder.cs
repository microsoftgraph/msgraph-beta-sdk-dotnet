...
namespace MicrosoftGraph.DeviceManagement.AssignmentFilters.GetState {
    /// <summary>Builds and executes requests for operations under \deviceManagement\assignmentFilters\microsoft.graph.getState()</summary>
