...
#nullable enable
        public async Task<UserExperienceAnalyticsCategory?> GetAsync(CancellationToken cancellationToken = default, Action<WorkFromAnywhereMetricsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserExperienceAnalyticsCategory> GetAsync(CancellationToken cancellationToken = default, Action<WorkFromAnywhereMetricsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
