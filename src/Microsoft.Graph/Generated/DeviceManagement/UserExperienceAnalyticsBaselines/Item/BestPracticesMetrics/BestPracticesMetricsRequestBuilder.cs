...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsBaselines.Item.BestPracticesMetrics {
    ...
    public class BestPracticesMetricsRequestBuilder {
        ...
        /// </summary>
        public async Task<UserExperienceAnalyticsCategory> GetAsync(Action<BestPracticesMetricsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
