...
#nullable enable
        public async Task<UserExperienceAnalyticsCategory?> GetAsync(CancellationToken cancellationToken = default, Action<BestPracticesMetricsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserExperienceAnalyticsCategory> GetAsync(CancellationToken cancellationToken = default, Action<BestPracticesMetricsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
