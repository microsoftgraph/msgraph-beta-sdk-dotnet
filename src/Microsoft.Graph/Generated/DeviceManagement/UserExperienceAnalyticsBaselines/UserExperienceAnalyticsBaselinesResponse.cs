...
namespace MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsBaselines {
    public class UserExperienceAnalyticsBaselinesResponse : IParsable {
        ...
        /// </summary>
        public static UserExperienceAnalyticsBaselinesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UserExperienceAnalyticsBaselinesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UserExperienceAnalyticsBaselinesResponse).Value = n.GetCollectionOfObjectValues<UserExperienceAnalyticsBaseline>(UserExperienceAnalyticsBaseline.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
