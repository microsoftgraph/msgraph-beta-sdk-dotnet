...
namespace MicrosoftGraphSdk.DeviceManagement.DeviceConfigurationRestrictedAppsViolations {
    ...
    public class DeviceConfigurationRestrictedAppsViolationsRequestBuilder {
        ...
        /// </summary>
        public async Task<RestrictedAppsViolationCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
