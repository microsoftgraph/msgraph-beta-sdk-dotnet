...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<RestrictedAppsViolationItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<RestrictedAppsViolationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<RestrictedAppsViolation?> GetAsync(CancellationToken cancellationToken = default, Action<RestrictedAppsViolationItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RestrictedAppsViolation> GetAsync(CancellationToken cancellationToken = default, Action<RestrictedAppsViolationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<RestrictedAppsViolation?> PatchAsync(RestrictedAppsViolation body, CancellationToken cancellationToken = default, Action<RestrictedAppsViolationItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RestrictedAppsViolation> PatchAsync(RestrictedAppsViolation body, CancellationToken cancellationToken = default, Action<RestrictedAppsViolationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
