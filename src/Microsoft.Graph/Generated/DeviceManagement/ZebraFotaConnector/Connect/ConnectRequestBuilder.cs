...
namespace Microsoft.Graph.Beta.DeviceManagement.ZebraFotaConnector.Connect {
    ...
    public class ConnectRequestBuilder {
        ...
        public ConnectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/zebraFotaConnector/microsoft.graph.connect";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Action<ConnectRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<ConnectResponse> PostAsync(CancellationToken cancellationToken = default, Action<ConnectRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<ConnectResponse>(requestInfo, ConnectResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
