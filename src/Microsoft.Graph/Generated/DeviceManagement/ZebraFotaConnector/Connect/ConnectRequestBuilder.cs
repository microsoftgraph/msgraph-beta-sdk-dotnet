...
namespace Microsoft.Graph.Beta.DeviceManagement.ZebraFotaConnector.Connect {
    ...
    public class ConnectRequestBuilder {
        ...
        /// </summary>
        public async Task<ConnectResponse> PostAsync(Action<ConnectRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
