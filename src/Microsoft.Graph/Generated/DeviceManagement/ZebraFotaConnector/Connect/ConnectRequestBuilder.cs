...
#nullable enable
        public async Task<ConnectResponse?> PostAsync(CancellationToken cancellationToken = default, Action<ConnectRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ConnectResponse> PostAsync(CancellationToken cancellationToken = default, Action<ConnectRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
