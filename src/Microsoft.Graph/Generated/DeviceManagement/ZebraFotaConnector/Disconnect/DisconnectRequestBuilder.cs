...
namespace Microsoft.Graph.Beta.DeviceManagement.ZebraFotaConnector.Disconnect {
    ...
    public class DisconnectRequestBuilder {
        ...
        /// </summary>
        public async Task<DisconnectResponse> PostAsync(CancellationToken cancellationToken = default, Action<DisconnectRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<DisconnectResponse>(requestInfo, DisconnectResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
