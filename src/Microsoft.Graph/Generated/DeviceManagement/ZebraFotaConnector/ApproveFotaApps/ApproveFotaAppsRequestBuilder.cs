...
#nullable enable
        public async Task<ApproveFotaAppsResponse?> PostAsync(CancellationToken cancellationToken = default, Action<ApproveFotaAppsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ApproveFotaAppsResponse> PostAsync(CancellationToken cancellationToken = default, Action<ApproveFotaAppsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
