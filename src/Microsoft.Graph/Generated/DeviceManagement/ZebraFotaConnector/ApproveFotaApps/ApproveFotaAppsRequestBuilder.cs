...
namespace Microsoft.Graph.Beta.DeviceManagement.ZebraFotaConnector.ApproveFotaApps {
    ...
    public class ApproveFotaAppsRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="ApproveFotaAppsPostResponse"></returns>
...
#nullable restore
        ...
        /// Invoke action approveFotaApps
        /// </summary>
        /// <returns>A <cref="ApproveFotaAppsResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="ApproveFotaAppsRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        ...
        public class ApproveFotaAppsRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
