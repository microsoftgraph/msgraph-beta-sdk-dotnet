...
namespace MicrosoftGraphSdk.DeviceManagement.WindowsDriverUpdateProfiles.Item {
    ...
    public class WindowsDriverUpdateProfileItemRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(WindowsDriverUpdateProfile body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
