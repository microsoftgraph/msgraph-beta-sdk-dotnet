...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="SyncInventoryRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public SyncInventoryRequestBuilder WithUrl(string rawUrl) {
            return new SyncInventoryRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
