...
namespace MicrosoftGraph.DeviceManagement.WindowsDriverUpdateProfiles.Item.SyncInventory {
    ...
    public class SyncInventoryRequestBuilder {
        ...
        public SyncInventoryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/windowsDriverUpdateProfiles/{windowsDriverUpdateProfile_id}/microsoft.graph.syncInventory";
