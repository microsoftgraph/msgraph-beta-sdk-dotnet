...
namespace Microsoft.Graph.Beta.DeviceManagement.WindowsDriverUpdateProfiles.Item.ExecuteAction {
    ...
    public class ExecuteActionRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="BulkDriverActionResult"></returns>
...
#nullable enable
        public async Task<BulkDriverActionResult?> PostAsync(ExecuteActionPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<BulkDriverActionResult> PostAsync(ExecuteActionPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
