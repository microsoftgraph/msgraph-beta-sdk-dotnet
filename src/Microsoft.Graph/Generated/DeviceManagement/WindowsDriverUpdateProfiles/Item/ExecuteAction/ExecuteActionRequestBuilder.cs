...
namespace Microsoft.Graph.Beta.DeviceManagement.WindowsDriverUpdateProfiles.Item.ExecuteAction {
    ...
    public class ExecuteActionRequestBuilder {
        ...
        /// </summary>
        public async Task<BulkDriverActionResult> PostAsync(ExecuteActionRequestBody body, Action<ExecuteActionRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
