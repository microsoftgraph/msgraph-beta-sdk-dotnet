...
using MicrosoftGraph.DeviceManagement.WindowsDriverUpdateProfiles.Item.Assign;
using MicrosoftGraph.DeviceManagement.WindowsDriverUpdateProfiles.Item.Assignments;
using MicrosoftGraph.DeviceManagement.WindowsDriverUpdateProfiles.Item.DriverInventories;
using MicrosoftGraph.DeviceManagement.WindowsDriverUpdateProfiles.Item.ExecuteAction;
using MicrosoftGraph.DeviceManagement.WindowsDriverUpdateProfiles.Item.SyncInventory;
...
namespace MicrosoftGraph.DeviceManagement.WindowsDriverUpdateProfiles.Item {
    ...
    public class WindowsDriverUpdateProfileRequestBuilder {
        ...
        /// </summary>
        public WindowsDriverUpdateProfileRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public WindowsDriverUpdateProfileRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
