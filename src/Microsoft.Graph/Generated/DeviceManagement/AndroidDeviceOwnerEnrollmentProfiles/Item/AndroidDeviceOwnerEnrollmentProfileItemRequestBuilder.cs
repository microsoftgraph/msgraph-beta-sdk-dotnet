...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AndroidDeviceOwnerEnrollmentProfileItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AndroidDeviceOwnerEnrollmentProfileItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AndroidDeviceOwnerEnrollmentProfile?> GetAsync(CancellationToken cancellationToken = default, Action<AndroidDeviceOwnerEnrollmentProfileItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AndroidDeviceOwnerEnrollmentProfile> GetAsync(CancellationToken cancellationToken = default, Action<AndroidDeviceOwnerEnrollmentProfileItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AndroidDeviceOwnerEnrollmentProfile?> PatchAsync(AndroidDeviceOwnerEnrollmentProfile body, CancellationToken cancellationToken = default, Action<AndroidDeviceOwnerEnrollmentProfileItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AndroidDeviceOwnerEnrollmentProfile> PatchAsync(AndroidDeviceOwnerEnrollmentProfile body, CancellationToken cancellationToken = default, Action<AndroidDeviceOwnerEnrollmentProfileItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
