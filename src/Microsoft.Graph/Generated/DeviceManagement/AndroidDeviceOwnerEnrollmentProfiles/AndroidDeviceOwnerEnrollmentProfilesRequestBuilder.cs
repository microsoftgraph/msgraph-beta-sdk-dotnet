...
namespace MicrosoftGraph.DeviceManagement.AndroidDeviceOwnerEnrollmentProfiles {
    ...
    public class AndroidDeviceOwnerEnrollmentProfilesRequestBuilder {
        ...
        public AndroidDeviceOwnerEnrollmentProfilesRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("androidDeviceOwnerEnrollmentProfile_id", position);
            return new AndroidDeviceOwnerEnrollmentProfilesRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AndroidDeviceOwnerEnrollmentProfile body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
