...
namespace Microsoft.Graph.Beta.DeviceManagement.OrganizationalMessageGuidedContents.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/organizationalMessageGuidedContents/$count";
