...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceCompliancePolicyDeviceStateSummary {
    ...
    public class DeviceCompliancePolicyDeviceStateSummaryRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.DeviceCompliancePolicyDeviceStateSummary> GetAsync(CancellationToken cancellationToken = default, Action<DeviceCompliancePolicyDeviceStateSummaryRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
