...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsDevicePerformance {
    ...
    public class UserExperienceAnalyticsDevicePerformanceRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Microsoft.Graph.Beta.Models.UserExperienceAnalyticsDevicePerformance body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
