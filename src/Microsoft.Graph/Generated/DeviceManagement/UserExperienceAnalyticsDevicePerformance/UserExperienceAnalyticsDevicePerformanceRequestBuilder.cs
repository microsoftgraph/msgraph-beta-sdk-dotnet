...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsDevicePerformance {
    ...
    public class UserExperienceAnalyticsDevicePerformanceRequestBuilder {
        ...
        /// </summary>
        public async Task<UserExperienceAnalyticsDevicePerformanceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UserExperienceAnalyticsDevicePerformanceRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
