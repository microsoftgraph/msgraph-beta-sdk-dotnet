...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsDevicePerformance.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsDevicePerformance/$count{?%24search,%24filter}";
