...
namespace MicrosoftGraphSdk.DeviceManagement.MicrosoftTunnelSites {
    ...
    public class MicrosoftTunnelSitesRequestBuilder {
        ...
        /// </summary>
        public async Task<MicrosoftTunnelSiteCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
