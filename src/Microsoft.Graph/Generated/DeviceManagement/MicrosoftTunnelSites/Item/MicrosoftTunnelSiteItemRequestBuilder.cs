...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<MicrosoftTunnelSiteItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<MicrosoftTunnelSiteItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MicrosoftTunnelSite?> GetAsync(CancellationToken cancellationToken = default, Action<MicrosoftTunnelSiteItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MicrosoftTunnelSite> GetAsync(CancellationToken cancellationToken = default, Action<MicrosoftTunnelSiteItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MicrosoftTunnelSite?> PatchAsync(MicrosoftTunnelSite body, CancellationToken cancellationToken = default, Action<MicrosoftTunnelSiteItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MicrosoftTunnelSite> PatchAsync(MicrosoftTunnelSite body, CancellationToken cancellationToken = default, Action<MicrosoftTunnelSiteItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
