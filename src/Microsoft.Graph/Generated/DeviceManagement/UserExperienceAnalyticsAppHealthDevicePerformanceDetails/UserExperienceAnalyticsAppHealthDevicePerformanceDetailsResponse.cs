    ...
    public class UserExperienceAnalyticsAppHealthDevicePerformanceDetailsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UserExperienceAnalyticsAppHealthDevicePerformanceDetailsResponse).Value = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.UserExperienceAnalyticsAppHealthDevicePerformanceDetails>().ToList(); } },
            };
        }
        /// <summary>
