...
namespace Microsoft.Graph.Beta.DeviceManagement.GetRoleScopeTagsByResourceWithResource {
    ...
    public class GetRoleScopeTagsByResourceWithResourceRequestBuilder {
        ...
        /// </summary>
        public async Task<GetRoleScopeTagsByResourceWithResourceResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetRoleScopeTagsByResourceWithResourceRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<GetRoleScopeTagsByResourceWithResourceResponse>(requestInfo, GetRoleScopeTagsByResourceWithResourceResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
