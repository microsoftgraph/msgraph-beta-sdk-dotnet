...
namespace MicrosoftGraphSdk.DeviceManagement.GetRoleScopeTagsByResourceWithResource {
    ...
    public class GetRoleScopeTagsByResourceWithResourceRequestBuilder {
        ...
        /// </summary>
        public async Task<GetRoleScopeTagsByResourceWithResourceResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
