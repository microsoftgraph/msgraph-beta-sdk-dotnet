...
#nullable enable
        public async Task<GetRoleScopeTagsByResourceWithResourceResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetRoleScopeTagsByResourceWithResourceRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetRoleScopeTagsByResourceWithResourceResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetRoleScopeTagsByResourceWithResourceRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
