...
namespace Microsoft.Graph.Beta.DeviceManagement.GetEffectivePermissions {
    ...
    public class GetEffectivePermissionsRequestBuilder {
        ...
        public GetEffectivePermissionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/microsoft.graph.getEffectivePermissions()";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetEffectivePermissionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<GetEffectivePermissionsResponse> GetAsync(Action<GetEffectivePermissionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<GetEffectivePermissionsResponse>(requestInfo, GetEffectivePermissionsResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
