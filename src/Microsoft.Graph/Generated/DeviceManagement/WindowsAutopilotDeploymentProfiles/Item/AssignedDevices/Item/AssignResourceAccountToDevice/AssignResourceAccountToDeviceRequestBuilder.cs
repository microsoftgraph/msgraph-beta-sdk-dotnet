...
#nullable enable
        public async Task PostAsync(AssignResourceAccountToDevicePostRequestBody body, CancellationToken cancellationToken = default, Action<AssignResourceAccountToDeviceRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(AssignResourceAccountToDevicePostRequestBody body, CancellationToken cancellationToken = default, Action<AssignResourceAccountToDeviceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
