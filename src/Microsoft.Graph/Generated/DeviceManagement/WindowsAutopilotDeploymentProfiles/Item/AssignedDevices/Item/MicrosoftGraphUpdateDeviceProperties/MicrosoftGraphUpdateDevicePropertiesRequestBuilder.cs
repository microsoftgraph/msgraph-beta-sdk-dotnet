...
namespace Microsoft.Graph.Beta.DeviceManagement.WindowsAutopilotDeploymentProfiles.Item.AssignedDevices.Item.MicrosoftGraphUpdateDeviceProperties {
    ...
    public class MicrosoftGraphUpdateDevicePropertiesRequestBuilder {
        ...
        public MicrosoftGraphUpdateDevicePropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphUpdateDevicePropertiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(UpdateDevicePropertiesPostRequestBody body, Action<MicrosoftGraphUpdateDevicePropertiesRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(UpdateDevicePropertiesPostRequestBody body, Action<MicrosoftGraphUpdateDevicePropertiesRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
