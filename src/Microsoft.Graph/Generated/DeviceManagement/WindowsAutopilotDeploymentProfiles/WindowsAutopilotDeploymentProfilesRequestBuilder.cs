...
namespace MicrosoftGraphSdk.DeviceManagement.WindowsAutopilotDeploymentProfiles {
    ...
    public class WindowsAutopilotDeploymentProfilesRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(WindowsAutopilotDeploymentProfile body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
