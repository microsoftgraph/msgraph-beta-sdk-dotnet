...
#nullable enable
        public async Task PostAsync(CompleteSignupPostRequestBody body, CancellationToken cancellationToken = default, Action<CompleteSignupRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(CompleteSignupPostRequestBody body, CancellationToken cancellationToken = default, Action<CompleteSignupRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
