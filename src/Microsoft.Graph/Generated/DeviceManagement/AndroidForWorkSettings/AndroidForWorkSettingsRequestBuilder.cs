...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AndroidForWorkSettingsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AndroidForWorkSettingsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.AndroidForWorkSettings?> GetAsync(CancellationToken cancellationToken = default, Action<AndroidForWorkSettingsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.AndroidForWorkSettings> GetAsync(CancellationToken cancellationToken = default, Action<AndroidForWorkSettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.AndroidForWorkSettings?> PatchAsync(Microsoft.Graph.Beta.Models.AndroidForWorkSettings body, CancellationToken cancellationToken = default, Action<AndroidForWorkSettingsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.AndroidForWorkSettings> PatchAsync(Microsoft.Graph.Beta.Models.AndroidForWorkSettings body, CancellationToken cancellationToken = default, Action<AndroidForWorkSettingsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
