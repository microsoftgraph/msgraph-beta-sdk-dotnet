...
namespace MicrosoftGraphSdk.DeviceManagement.WindowsFeatureUpdateProfiles.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder {
        ...
        public async Task<WindowsFeatureUpdateProfileAssignment> PostAsync(WindowsFeatureUpdateProfileAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<WindowsFeatureUpdateProfileAssignment>(requestInfo, WindowsFeatureUpdateProfileAssignment.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
