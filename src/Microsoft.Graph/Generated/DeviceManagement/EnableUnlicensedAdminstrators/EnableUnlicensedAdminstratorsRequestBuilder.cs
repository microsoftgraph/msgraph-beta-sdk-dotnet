...
namespace MicrosoftGraph.DeviceManagement.EnableUnlicensedAdminstrators {
    /// <summary>Builds and executes requests for operations under \deviceManagement\microsoft.graph.enableUnlicensedAdminstrators</summary>
