...
namespace MicrosoftGraph.DeviceManagement.ManagementConditions.GetManagementConditionsForPlatformWithPlatform {
    ...
    public class GetManagementConditionsForPlatformWithPlatformRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<MicrosoftGraph.DeviceManagement.ManagementConditions.GetManagementConditionsForPlatformWithPlatform.GetManagementConditionsForPlatformWithPlatform>> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await RequestAdapter.SendCollectionAsync<MicrosoftGraph.DeviceManagement.ManagementConditions.GetManagementConditionsForPlatformWithPlatform.GetManagementConditionsForPlatformWithPlatform>(requestInfo, responseHandler, default, cancellationToken);
        }
    }
}
