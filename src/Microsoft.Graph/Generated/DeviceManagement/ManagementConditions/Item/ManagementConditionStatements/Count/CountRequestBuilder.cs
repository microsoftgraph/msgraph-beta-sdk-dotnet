...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagementConditions.Item.ManagementConditionStatements.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/managementConditions/{managementCondition%2Did}/managementConditionStatements/$count";
