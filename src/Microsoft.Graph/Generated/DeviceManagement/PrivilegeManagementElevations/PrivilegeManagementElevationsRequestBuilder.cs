...
#nullable enable
        public async Task<PrivilegeManagementElevationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<PrivilegeManagementElevationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrivilegeManagementElevationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PrivilegeManagementElevationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PrivilegeManagementElevation?> PostAsync(PrivilegeManagementElevation body, CancellationToken cancellationToken = default, Action<PrivilegeManagementElevationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrivilegeManagementElevation> PostAsync(PrivilegeManagementElevation body, CancellationToken cancellationToken = default, Action<PrivilegeManagementElevationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
