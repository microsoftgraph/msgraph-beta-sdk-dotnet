...
#nullable enable
        public async Task<ScopedForResourceWithResourceResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ScopedForResourceWithResourceRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ScopedForResourceWithResourceResponse> GetAsync(CancellationToken cancellationToken = default, Action<ScopedForResourceWithResourceRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
