...
namespace Microsoft.Graph.Beta.DeviceManagement.ScopedForResourceWithResource {
    ...
    public class ScopedForResourceWithResourceRequestBuilder {
        ...
        /// </summary>
        public async Task<ScopedForResourceWithResourceResponse> GetAsync(Action<ScopedForResourceWithResourceRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
