...
namespace Microsoft.Graph.Beta.DeviceManagement.ScopedForResourceWithResource {
    ...
    public class ScopedForResourceWithResourceRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<ScopedForResourceWithResourceRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<ScopedForResourceWithResourceResponse> GetAsync(CancellationToken cancellationToken = default, Action<ScopedForResourceWithResourceRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<ScopedForResourceWithResourceResponse>(requestInfo, ScopedForResourceWithResourceResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
