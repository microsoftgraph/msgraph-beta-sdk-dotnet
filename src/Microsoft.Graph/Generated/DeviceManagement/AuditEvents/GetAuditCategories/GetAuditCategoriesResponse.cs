...
namespace MicrosoftGraphSdk.DeviceManagement.AuditEvents.GetAuditCategories {
    ...
    public class GetAuditCategoriesResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static GetAuditCategoriesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetAuditCategoriesResponse).Value = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
            };
        }
        /// <summary>
