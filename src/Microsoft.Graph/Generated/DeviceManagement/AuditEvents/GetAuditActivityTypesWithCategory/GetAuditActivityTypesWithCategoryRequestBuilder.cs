...
namespace Microsoft.Graph.Beta.DeviceManagement.AuditEvents.GetAuditActivityTypesWithCategory {
    ...
    public class GetAuditActivityTypesWithCategoryRequestBuilder {
        ...
        /// </summary>
        public async Task<GetAuditActivityTypesWithCategoryResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetAuditActivityTypesWithCategoryRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
