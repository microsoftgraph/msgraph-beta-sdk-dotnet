...
namespace MicrosoftGraphSdk.DeviceManagement.GroupPolicyDefinitionFiles {
    public class GroupPolicyDefinitionFilesResponse : IParsable {
        ...
        /// </summary>
        public static GroupPolicyDefinitionFilesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GroupPolicyDefinitionFilesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as GroupPolicyDefinitionFilesResponse).Value = n.GetCollectionOfObjectValues<GroupPolicyDefinitionFile>(GroupPolicyDefinitionFile.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
