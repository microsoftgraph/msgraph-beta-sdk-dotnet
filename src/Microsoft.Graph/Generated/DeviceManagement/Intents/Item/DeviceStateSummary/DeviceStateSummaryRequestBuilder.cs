...
namespace Microsoft.Graph.Beta.DeviceManagement.Intents.Item.DeviceStateSummary {
    ...
    public class DeviceStateSummaryRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DeviceManagementIntentDeviceStateSummary body, Action<DeviceStateSummaryRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
