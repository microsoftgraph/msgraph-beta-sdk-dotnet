...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UserStateSummaryRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UserStateSummaryRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementIntentUserStateSummary?> GetAsync(CancellationToken cancellationToken = default, Action<UserStateSummaryRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementIntentUserStateSummary> GetAsync(CancellationToken cancellationToken = default, Action<UserStateSummaryRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementIntentUserStateSummary?> PatchAsync(DeviceManagementIntentUserStateSummary body, CancellationToken cancellationToken = default, Action<UserStateSummaryRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementIntentUserStateSummary> PatchAsync(DeviceManagementIntentUserStateSummary body, CancellationToken cancellationToken = default, Action<UserStateSummaryRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
