...
namespace Microsoft.Graph.Beta.DeviceManagement.Intents.Item.CreateCopy {
    ...
    public class CreateCopyRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceManagementIntent> PostAsync(CreateCopyRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
