...
namespace Microsoft.Graph.Beta.DeviceManagement.Intents.Item.CreateCopy {
    ...
    public class CreateCopyRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceManagementIntent> PostAsync(CreateCopyPostRequestBody body, Action<CreateCopyRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
