...
namespace MicrosoftGraphSdk.DeviceManagement.Intents.Item.CreateCopy {
    /// <summary>Builds and executes requests for operations under \deviceManagement\intents\{deviceManagementIntent-id}\microsoft.graph.createCopy</summary>
    public class CreateCopyRequestBuilder {
        ...
        public CreateCopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/intents/{deviceManagementIntent_id}/microsoft.graph.createCopy";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CreateCopyRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        public class CreateCopyResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"deviceManagementIntent", (o,n) => { (o as CreateCopyResponse).DeviceManagementIntent = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.DeviceManagementIntent>(MicrosoftGraphSdk.Models.Microsoft.Graph.DeviceManagementIntent.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
