...
#nullable restore
        ...
        public async Task<DeviceManagementIntentAssignmentCollectionResponse> GetAsync(Action<AssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<DeviceManagementIntentAssignmentCollectionResponse>(requestInfo, DeviceManagementIntentAssignmentCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
