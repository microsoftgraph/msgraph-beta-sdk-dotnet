...
using MicrosoftGraphSdk.DeviceManagement.Intents.Item.Categories.Item.Settings.Item;
...
namespace MicrosoftGraphSdk.DeviceManagement.Intents.Item.Categories.Item.Settings {
    /// <summary>Builds and executes requests for operations under \deviceManagement\intents\{deviceManagementIntent-id}\categories\{deviceManagementIntentSettingCategory-id}\settings</summary>
    public class SettingsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.deviceManagement.intents.item.categories.item.settings.item collection</summary>
