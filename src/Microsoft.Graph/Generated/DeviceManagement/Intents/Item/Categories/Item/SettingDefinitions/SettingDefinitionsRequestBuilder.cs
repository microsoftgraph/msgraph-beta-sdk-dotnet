...
namespace Microsoft.Graph.Beta.DeviceManagement.Intents.Item.Categories.Item.SettingDefinitions {
    ...
    public class SettingDefinitionsRequestBuilder : BaseRequestBuilder {
        ...
        public DeviceManagementSettingDefinitionItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("deviceManagementSettingDefinition%2Did", position);
...
#nullable enable
        public async Task<DeviceManagementSettingDefinitionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SettingDefinitionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementSettingDefinitionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SettingDefinitionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<DeviceManagementSettingDefinitionCollectionResponse>(requestInfo, DeviceManagementSettingDefinitionCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementSettingDefinition?> PostAsync(DeviceManagementSettingDefinition body, CancellationToken cancellationToken = default, Action<SettingDefinitionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementSettingDefinition> PostAsync(DeviceManagementSettingDefinition body, CancellationToken cancellationToken = default, Action<SettingDefinitionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
