...
namespace Microsoft.Graph.Beta.DeviceManagement.Intents.Item.DeviceSettingStateSummaries.Item {
    ...
    public class DeviceManagementIntentDeviceSettingStateSummaryItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceManagementIntentDeviceSettingStateSummary> PatchAsync(DeviceManagementIntentDeviceSettingStateSummary body, Action<DeviceManagementIntentDeviceSettingStateSummaryItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
