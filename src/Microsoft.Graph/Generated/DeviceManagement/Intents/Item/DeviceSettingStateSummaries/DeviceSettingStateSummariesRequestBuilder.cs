...
namespace Microsoft.Graph.Beta.DeviceManagement.Intents.Item.DeviceSettingStateSummaries {
    ...
    public class DeviceSettingStateSummariesRequestBuilder : BaseRequestBuilder {
        ...
        public DeviceManagementIntentDeviceSettingStateSummaryItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("deviceManagementIntentDeviceSettingStateSummary%2Did", position);
        ...
        public DeviceSettingStateSummariesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/intents/{deviceManagementIntent%2Did}/deviceSettingStateSummaries{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DeviceSettingStateSummariesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeviceSettingStateSummariesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/intents/{deviceManagementIntent%2Did}/deviceSettingStateSummaries{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceSettingStateSummariesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DeviceSettingStateSummariesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementIntentDeviceSettingStateSummary?> PostAsync(DeviceManagementIntentDeviceSettingStateSummary body, CancellationToken cancellationToken = default, Action<DeviceSettingStateSummariesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementIntentDeviceSettingStateSummary> PostAsync(DeviceManagementIntentDeviceSettingStateSummary body, CancellationToken cancellationToken = default, Action<DeviceSettingStateSummariesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
