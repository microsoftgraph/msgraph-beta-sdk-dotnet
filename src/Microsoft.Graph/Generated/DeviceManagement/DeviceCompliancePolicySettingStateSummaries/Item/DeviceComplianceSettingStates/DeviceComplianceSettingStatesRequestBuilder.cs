...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceCompliancePolicySettingStateSummaries.Item.DeviceComplianceSettingStates {
    ...
    public class DeviceComplianceSettingStatesRequestBuilder : BaseRequestBuilder {
        ...
        public DeviceComplianceSettingStateItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("deviceComplianceSettingState%2Did", position);
...
#nullable enable
        public async Task<DeviceComplianceSettingStateCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceComplianceSettingStatesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceComplianceSettingStateCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DeviceComplianceSettingStatesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceComplianceSettingState?> PostAsync(DeviceComplianceSettingState body, CancellationToken cancellationToken = default, Action<DeviceComplianceSettingStatesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceComplianceSettingState> PostAsync(DeviceComplianceSettingState body, CancellationToken cancellationToken = default, Action<DeviceComplianceSettingStatesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
