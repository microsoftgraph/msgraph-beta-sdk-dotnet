...
namespace MicrosoftGraphSdk.DeviceManagement.Reports.GetHistoricalReport {
    ...
    public class GetHistoricalReportRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GetHistoricalReportRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// </summary>
        public async Task<GetHistoricalReportResponse> PostAsync(GetHistoricalReportRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
