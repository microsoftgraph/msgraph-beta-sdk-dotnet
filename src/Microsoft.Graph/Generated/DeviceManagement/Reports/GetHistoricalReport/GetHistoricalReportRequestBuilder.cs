...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetHistoricalReport {
    ...
    public class GetHistoricalReportRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetHistoricalReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetHistoricalReportRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
