...
namespace MicrosoftGraph.DeviceManagement.Reports.GetHistoricalReport {
    ...
    public class GetHistoricalReportRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetHistoricalReportRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
