...
#nullable enable
        public async Task<Stream?> PostAsync(GetCompliancePolicyDevicesReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetCompliancePolicyDevicesReportRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetCompliancePolicyDevicesReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetCompliancePolicyDevicesReportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
