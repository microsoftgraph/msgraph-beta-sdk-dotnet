...
namespace MicrosoftGraph.DeviceManagement.Reports.GetCompliancePolicyDeviceSummaryReport {
    ...
    public class GetCompliancePolicyDeviceSummaryReportRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetCompliancePolicyDeviceSummaryReportRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
