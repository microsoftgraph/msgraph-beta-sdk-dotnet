...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetPolicyNonComplianceSummaryReport {
    ...
    public class GetPolicyNonComplianceSummaryReportRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetPolicyNonComplianceSummaryReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetPolicyNonComplianceSummaryReportRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
