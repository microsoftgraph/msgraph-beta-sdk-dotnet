...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetPolicyNonComplianceSummaryReport {
    ...
    public class GetPolicyNonComplianceSummaryReportRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GetPolicyNonComplianceSummaryReportRequestBody body, Action<GetPolicyNonComplianceSummaryReportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<GetPolicyNonComplianceSummaryReportResponse> PostAsync(GetPolicyNonComplianceSummaryReportRequestBody body, Action<GetPolicyNonComplianceSummaryReportRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
