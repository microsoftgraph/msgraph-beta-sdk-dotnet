...
namespace MicrosoftGraphSdk.DeviceManagement.Reports.GetCachedReport {
    ...
    public class GetCachedReportResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public GetCachedReportResponse() {
        ...
        /// </summary>
        public static GetCachedReportResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetCachedReportResponse).Value = n.GetByteArrayValue(); } },
            };
        }
        /// <summary>
