...
#nullable enable
        public async Task<Stream?> PostAsync(GetComplianceSettingDetailsReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetComplianceSettingDetailsReportRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetComplianceSettingDetailsReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetComplianceSettingDetailsReportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
