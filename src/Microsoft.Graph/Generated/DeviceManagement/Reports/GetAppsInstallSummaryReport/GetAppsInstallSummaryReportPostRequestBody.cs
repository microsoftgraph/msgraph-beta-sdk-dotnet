...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetAppsInstallSummaryReport {
    public class GetAppsInstallSummaryReportPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public static GetAppsInstallSummaryReportPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GetAppsInstallSummaryReportPostRequestBody();
        }
        /// <summary>
