...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.MicrosoftGraphGetCompliancePolicyDeviceSummaryReport {
    public class GetCompliancePolicyDeviceSummaryReportPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable restore
        ...
        public static GetCompliancePolicyDeviceSummaryReportPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GetCompliancePolicyDeviceSummaryReportPostRequestBody();
        }
        /// <summary>
