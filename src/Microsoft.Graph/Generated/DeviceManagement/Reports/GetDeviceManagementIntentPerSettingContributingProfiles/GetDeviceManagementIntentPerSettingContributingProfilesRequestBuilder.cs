...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetDeviceManagementIntentPerSettingContributingProfiles {
    ...
    public class GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GetDeviceManagementIntentPerSettingContributingProfilesRequestBody body, Action<GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<GetDeviceManagementIntentPerSettingContributingProfilesResponse> PostAsync(GetDeviceManagementIntentPerSettingContributingProfilesRequestBody body, Action<GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, requestConfiguration);
            return await RequestAdapter.SendAsync<GetDeviceManagementIntentPerSettingContributingProfilesResponse>(requestInfo, GetDeviceManagementIntentPerSettingContributingProfilesResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
