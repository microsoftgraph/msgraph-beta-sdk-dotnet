...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetDeviceManagementIntentPerSettingContributingProfiles {
    ...
    /// </summary>
    public class GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder : BaseRequestBuilder {
        /// <summary>
        ...
        public GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/reports/getDeviceManagementIntentPerSettingContributingProfiles", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Stream?> PostAsync(GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody body, Action<GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody body, Action<GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
