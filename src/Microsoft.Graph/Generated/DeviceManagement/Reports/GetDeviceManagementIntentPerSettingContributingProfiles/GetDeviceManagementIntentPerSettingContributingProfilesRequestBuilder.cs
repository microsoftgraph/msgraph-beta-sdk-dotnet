...
#nullable enable
        public async Task<Stream?> PostAsync(GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody body, CancellationToken cancellationToken = default, Action<GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody body, CancellationToken cancellationToken = default, Action<GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
