...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.MicrosoftGraphGetConfigurationSettingDetailsReport {
    public class GetConfigurationSettingDetailsReportPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable restore
        ...
        public static GetConfigurationSettingDetailsReportPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GetConfigurationSettingDetailsReportPostRequestBody();
        }
        /// <summary>
