...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.MicrosoftGraphGetPolicyNonComplianceMetadata {
    /// <summary>
    ...
    public class MicrosoftGraphGetPolicyNonComplianceMetadataRequestBuilder {
        ...
        public MicrosoftGraphGetPolicyNonComplianceMetadataRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphGetPolicyNonComplianceMetadataRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<Stream?> PostAsync(GetPolicyNonComplianceMetadataPostRequestBody body, Action<MicrosoftGraphGetPolicyNonComplianceMetadataRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetPolicyNonComplianceMetadataPostRequestBody body, Action<MicrosoftGraphGetPolicyNonComplianceMetadataRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
