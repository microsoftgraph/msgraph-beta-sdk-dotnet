...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetWindowsUpdateAlertSummaryReport {
    ...
    public class GetWindowsUpdateAlertSummaryReportRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetWindowsUpdateAlertSummaryReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetWindowsUpdateAlertSummaryReportRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
