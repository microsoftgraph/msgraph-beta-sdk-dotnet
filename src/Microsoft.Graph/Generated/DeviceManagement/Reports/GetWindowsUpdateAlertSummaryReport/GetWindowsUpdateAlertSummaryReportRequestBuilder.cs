...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetWindowsUpdateAlertSummaryReport {
    ...
    public class GetWindowsUpdateAlertSummaryReportRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GetWindowsUpdateAlertSummaryReportPostRequestBody body, Action<GetWindowsUpdateAlertSummaryReportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetWindowsUpdateAlertSummaryReportPostRequestBody body, Action<GetWindowsUpdateAlertSummaryReportRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
