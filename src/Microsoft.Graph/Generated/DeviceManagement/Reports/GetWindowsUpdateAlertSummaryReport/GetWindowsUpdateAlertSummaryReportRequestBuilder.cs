...
#nullable enable
        public async Task<Stream?> PostAsync(GetWindowsUpdateAlertSummaryReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetWindowsUpdateAlertSummaryReportRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetWindowsUpdateAlertSummaryReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetWindowsUpdateAlertSummaryReportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
