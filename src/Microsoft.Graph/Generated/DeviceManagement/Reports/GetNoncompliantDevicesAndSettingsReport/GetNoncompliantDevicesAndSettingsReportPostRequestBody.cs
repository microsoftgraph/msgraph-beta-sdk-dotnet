...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetNoncompliantDevicesAndSettingsReport {
    /// <summary>Provides operations to call the getNoncompliantDevicesAndSettingsReport method.</summary>
    public class GetNoncompliantDevicesAndSettingsReportPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        /// </summary>
        public static GetNoncompliantDevicesAndSettingsReportPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
