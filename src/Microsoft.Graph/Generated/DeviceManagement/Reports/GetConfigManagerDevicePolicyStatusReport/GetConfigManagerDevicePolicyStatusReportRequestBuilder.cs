...
namespace MicrosoftGraphSdk.DeviceManagement.Reports.GetConfigManagerDevicePolicyStatusReport {
    ...
    public class GetConfigManagerDevicePolicyStatusReportRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GetConfigManagerDevicePolicyStatusReportRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
