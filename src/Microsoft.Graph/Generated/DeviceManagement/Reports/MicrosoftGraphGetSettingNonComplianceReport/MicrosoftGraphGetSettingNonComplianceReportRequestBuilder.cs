...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.MicrosoftGraphGetSettingNonComplianceReport {
    /// <summary>
    ...
    public class MicrosoftGraphGetSettingNonComplianceReportRequestBuilder {
        ...
        public MicrosoftGraphGetSettingNonComplianceReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphGetSettingNonComplianceReportRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<Stream?> PostAsync(GetSettingNonComplianceReportPostRequestBody body, Action<MicrosoftGraphGetSettingNonComplianceReportRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetSettingNonComplianceReportPostRequestBody body, Action<MicrosoftGraphGetSettingNonComplianceReportRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
