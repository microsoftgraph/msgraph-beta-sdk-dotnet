...
namespace MicrosoftGraphSdk.DeviceManagement.Reports.GetPolicyNonComplianceMetadata {
    ...
    public class GetPolicyNonComplianceMetadataResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetPolicyNonComplianceMetadataResponse).Value = n.GetByteArrayValue(); } },
            };
        }
        /// <summary>
