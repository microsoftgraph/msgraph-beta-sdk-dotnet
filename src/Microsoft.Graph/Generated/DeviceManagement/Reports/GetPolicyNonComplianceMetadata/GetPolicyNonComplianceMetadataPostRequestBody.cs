...
using System.Linq;
using System;
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetPolicyNonComplianceMetadata {
    public class GetPolicyNonComplianceMetadataPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable restore
        ...
        public static GetPolicyNonComplianceMetadataPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
