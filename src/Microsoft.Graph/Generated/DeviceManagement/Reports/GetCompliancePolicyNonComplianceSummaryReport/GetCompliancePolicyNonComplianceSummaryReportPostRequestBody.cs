...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetCompliancePolicyNonComplianceSummaryReport {
    public class GetCompliancePolicyNonComplianceSummaryReportPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        /// </summary>
        public GetCompliancePolicyNonComplianceSummaryReportPostRequestBody() {
        ...
        public static GetCompliancePolicyNonComplianceSummaryReportPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
