...
namespace MicrosoftGraphSdk.DeviceManagement.Reports.GetFailedMobileAppsSummaryReport {
    ...
    public class GetFailedMobileAppsSummaryReportResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public GetFailedMobileAppsSummaryReportResponse() {
        ...
        /// </summary>
        public static GetFailedMobileAppsSummaryReportResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetFailedMobileAppsSummaryReportResponse).Value = n.GetByteArrayValue(); } },
            };
        }
        /// <summary>
