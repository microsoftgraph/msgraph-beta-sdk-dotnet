...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetPolicyNonComplianceReport {
    public class GetPolicyNonComplianceReportPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public static GetPolicyNonComplianceReportPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
