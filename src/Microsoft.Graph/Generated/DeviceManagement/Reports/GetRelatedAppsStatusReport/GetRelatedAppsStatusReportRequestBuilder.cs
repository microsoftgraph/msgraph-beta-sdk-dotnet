...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetRelatedAppsStatusReport {
    ...
    public class GetRelatedAppsStatusReportRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetRelatedAppsStatusReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetRelatedAppsStatusReportRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
