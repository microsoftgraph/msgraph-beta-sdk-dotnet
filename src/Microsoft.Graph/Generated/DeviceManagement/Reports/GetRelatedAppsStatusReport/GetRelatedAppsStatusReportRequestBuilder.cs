...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetRelatedAppsStatusReport {
    ...
    public class GetRelatedAppsStatusReportRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GetRelatedAppsStatusReportPostRequestBody body, Action<GetRelatedAppsStatusReportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetRelatedAppsStatusReportPostRequestBody body, Action<GetRelatedAppsStatusReportRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
