...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.MicrosoftGraphGetConfigurationPolicyNonComplianceSummaryReport {
    ...
    public class MicrosoftGraphGetConfigurationPolicyNonComplianceSummaryReportRequestBuilder {
        ...
        public MicrosoftGraphGetConfigurationPolicyNonComplianceSummaryReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphGetConfigurationPolicyNonComplianceSummaryReportRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<Stream?> PostAsync(GetConfigurationPolicyNonComplianceSummaryReportPostRequestBody body, Action<MicrosoftGraphGetConfigurationPolicyNonComplianceSummaryReportRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetConfigurationPolicyNonComplianceSummaryReportPostRequestBody body, Action<MicrosoftGraphGetConfigurationPolicyNonComplianceSummaryReportRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
