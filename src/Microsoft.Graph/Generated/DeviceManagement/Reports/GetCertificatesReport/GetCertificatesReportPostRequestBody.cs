...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetCertificatesReport {
    public class GetCertificatesReportPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new getCertificatesReportPostRequestBody and sets the default values.
        /// </summary>
        ...
        public static GetCertificatesReportPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GetCertificatesReportPostRequestBody();
        }
        /// <summary>
