...
#nullable enable
        public async Task<Stream?> PostAsync(GetDeviceStatusByCompliacePolicyReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetDeviceStatusByCompliacePolicyReportRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetDeviceStatusByCompliacePolicyReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetDeviceStatusByCompliacePolicyReportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
