...
#nullable enable
        public async Task<DeviceManagementCachedReportConfigurationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<CachedReportConfigurationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementCachedReportConfigurationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CachedReportConfigurationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementCachedReportConfiguration?> PostAsync(DeviceManagementCachedReportConfiguration body, CancellationToken cancellationToken = default, Action<CachedReportConfigurationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementCachedReportConfiguration> PostAsync(DeviceManagementCachedReportConfiguration body, CancellationToken cancellationToken = default, Action<CachedReportConfigurationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
