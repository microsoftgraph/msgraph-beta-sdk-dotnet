...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.CachedReportConfigurations {
    ...
    public class CachedReportConfigurationsRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceManagementCachedReportConfigurationCollectionResponse> GetAsync(Action<CachedReportConfigurationsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
