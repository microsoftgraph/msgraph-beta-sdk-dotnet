...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.MicrosoftGraphGetComplianceSettingNonComplianceReport {
    /// <summary>
    ...
    public class MicrosoftGraphGetComplianceSettingNonComplianceReportRequestBuilder {
        ...
        public MicrosoftGraphGetComplianceSettingNonComplianceReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphGetComplianceSettingNonComplianceReportRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<Stream?> PostAsync(GetComplianceSettingNonComplianceReportPostRequestBody body, Action<MicrosoftGraphGetComplianceSettingNonComplianceReportRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetComplianceSettingNonComplianceReportPostRequestBody body, Action<MicrosoftGraphGetComplianceSettingNonComplianceReportRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
