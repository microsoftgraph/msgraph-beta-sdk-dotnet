...
namespace Microsoft.Graph.Beta.DeviceManagement.Reports.GetQuietTimePolicyUsersReport {
    ...
    public class GetQuietTimePolicyUsersReportPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public string SkipToken {
            get { return BackingStore?.Get<string>(nameof(SkipToken)); }
            set { BackingStore?.Set(nameof(SkipToken), value); }
        }
