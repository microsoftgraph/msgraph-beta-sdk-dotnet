...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceCompliancePolicies.GetDevicesScheduledToRetire {
    ...
    public class GetDevicesScheduledToRetireResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static GetDevicesScheduledToRetireResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetDevicesScheduledToRetireResponse).Value = n.GetCollectionOfObjectValues<RetireScheduledManagedDevice>(RetireScheduledManagedDevice.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
