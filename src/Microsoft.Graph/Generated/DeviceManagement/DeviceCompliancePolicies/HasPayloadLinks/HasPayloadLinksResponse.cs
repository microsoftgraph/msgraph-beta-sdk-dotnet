...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceCompliancePolicies.HasPayloadLinks {
    ...
    public class HasPayloadLinksResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<HasPayloadLinkResultItem> Value {
            get { return BackingStore?.Get<List<HasPayloadLinkResultItem>>(nameof(Value)); }
