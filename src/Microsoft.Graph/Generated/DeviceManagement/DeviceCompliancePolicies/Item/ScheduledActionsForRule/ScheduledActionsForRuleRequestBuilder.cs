...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceCompliancePolicies.Item.ScheduledActionsForRule {
    ...
    public class ScheduledActionsForRuleRequestBuilder : BaseRequestBuilder {
        ...
        public DeviceComplianceScheduledActionForRuleItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("deviceComplianceScheduledActionForRule%2Did", position);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ScheduledActionsForRuleRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/scheduledActionsForRule{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DeviceComplianceScheduledActionForRuleCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ScheduledActionsForRuleRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceComplianceScheduledActionForRuleCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ScheduledActionsForRuleRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceComplianceScheduledActionForRule?> PostAsync(DeviceComplianceScheduledActionForRule body, CancellationToken cancellationToken = default, Action<ScheduledActionsForRuleRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceComplianceScheduledActionForRule> PostAsync(DeviceComplianceScheduledActionForRule body, CancellationToken cancellationToken = default, Action<ScheduledActionsForRuleRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(DeviceComplianceScheduledActionForRule body, Action<ScheduledActionsForRuleRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(DeviceComplianceScheduledActionForRule body, Action<ScheduledActionsForRuleRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
