...
namespace MicrosoftGraphSdk.DeviceManagement.DeviceCompliancePolicies.Item.DeviceStatuses {
    ...
    public class DeviceStatusesRequestBuilder {
        ...
        public async Task<DeviceComplianceDeviceStatus> PostAsync(DeviceComplianceDeviceStatus body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<DeviceComplianceDeviceStatus>(requestInfo, DeviceComplianceDeviceStatus.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
