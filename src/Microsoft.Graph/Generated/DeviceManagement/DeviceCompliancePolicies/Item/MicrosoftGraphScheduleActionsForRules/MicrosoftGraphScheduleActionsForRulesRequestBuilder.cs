...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceCompliancePolicies.Item.MicrosoftGraphScheduleActionsForRules {
    /// <summary>
    ...
    public class MicrosoftGraphScheduleActionsForRulesRequestBuilder {
        ...
        public MicrosoftGraphScheduleActionsForRulesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphScheduleActionsForRulesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(ScheduleActionsForRulesPostRequestBody body, Action<MicrosoftGraphScheduleActionsForRulesRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(ScheduleActionsForRulesPostRequestBody body, Action<MicrosoftGraphScheduleActionsForRulesRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
