...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceCompliancePolicies.Item.Assign {
    ...
    public class AssignResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceCompliancePolicyAssignment> Value {
            get { return BackingStore?.Get<List<DeviceCompliancePolicyAssignment>>(nameof(Value)); }
