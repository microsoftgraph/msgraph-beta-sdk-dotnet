...
#nullable enable
        public async Task<SettingStateDeviceSummaryCollectionResponse?> GetAsync(Action<DeviceSettingStateSummariesRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<SettingStateDeviceSummaryCollectionResponse> GetAsync(Action<DeviceSettingStateSummariesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SettingStateDeviceSummary?> PostAsync(SettingStateDeviceSummary body, Action<DeviceSettingStateSummariesRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<SettingStateDeviceSummary> PostAsync(SettingStateDeviceSummary body, Action<DeviceSettingStateSummariesRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
