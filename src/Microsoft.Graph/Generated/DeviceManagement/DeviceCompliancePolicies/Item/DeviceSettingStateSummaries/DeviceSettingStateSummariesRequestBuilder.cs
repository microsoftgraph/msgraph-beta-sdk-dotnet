...
namespace MicrosoftGraphSdk.DeviceManagement.DeviceCompliancePolicies.Item.DeviceSettingStateSummaries {
    ...
    public class DeviceSettingStateSummariesRequestBuilder {
        ...
        /// </summary>
        public async Task<SettingStateDeviceSummaryCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
