...
using MicrosoftGraph.DeviceManagement.DeviceCompliancePolicies.Item.Assign;
using MicrosoftGraph.DeviceManagement.DeviceCompliancePolicies.Item.Assignments;
using MicrosoftGraph.DeviceManagement.DeviceCompliancePolicies.Item.DeviceSettingStateSummaries;
using MicrosoftGraph.DeviceManagement.DeviceCompliancePolicies.Item.DeviceStatuses;
using MicrosoftGraph.DeviceManagement.DeviceCompliancePolicies.Item.DeviceStatusOverview;
using MicrosoftGraph.DeviceManagement.DeviceCompliancePolicies.Item.ScheduleActionsForRules;
using MicrosoftGraph.DeviceManagement.DeviceCompliancePolicies.Item.ScheduledActionsForRule;
using MicrosoftGraph.DeviceManagement.DeviceCompliancePolicies.Item.UserStatuses;
using MicrosoftGraph.DeviceManagement.DeviceCompliancePolicies.Item.UserStatusOverview;
...
namespace MicrosoftGraph.DeviceManagement.DeviceCompliancePolicies.Item {
    ...
    public class DeviceCompliancePolicyRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DeviceCompliancePolicy body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
