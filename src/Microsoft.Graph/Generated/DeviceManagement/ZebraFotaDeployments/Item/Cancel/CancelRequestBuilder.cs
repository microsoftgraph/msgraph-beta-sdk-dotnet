...
namespace Microsoft.Graph.Beta.DeviceManagement.ZebraFotaDeployments.Item.Cancel {
    ...
    public class CancelRequestBuilder {
        ...
        /// </summary>
        public async Task<CancelResponse> PostAsync(Action<CancelRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
