...
namespace Microsoft.Graph.Beta.DeviceManagement.ZebraFotaDeployments.Item.Cancel {
    ...
    public class CancelRequestBuilder {
        ...
        public CancelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/zebraFotaDeployments/{zebraFotaDeployment%2Did}/microsoft.graph.cancel";
        ...
        /// </summary>
        public async Task<CancelResponse> PostAsync(CancellationToken cancellationToken = default, Action<CancelRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<CancelResponse>(requestInfo, CancelResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
