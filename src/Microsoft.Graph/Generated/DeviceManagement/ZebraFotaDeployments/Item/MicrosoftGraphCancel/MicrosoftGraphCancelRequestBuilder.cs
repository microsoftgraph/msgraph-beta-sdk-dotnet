...
#nullable enable
        public async Task<CancelResponse?> PostAsync(Action<MicrosoftGraphCancelRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CancelResponse> PostAsync(Action<MicrosoftGraphCancelRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
