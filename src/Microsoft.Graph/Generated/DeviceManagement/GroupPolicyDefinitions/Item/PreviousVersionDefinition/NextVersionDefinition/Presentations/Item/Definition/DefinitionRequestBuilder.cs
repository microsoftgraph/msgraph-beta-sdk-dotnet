...
#nullable enable
        public async Task<GroupPolicyDefinition?> GetAsync(CancellationToken cancellationToken = default, Action<DefinitionRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GroupPolicyDefinition> GetAsync(CancellationToken cancellationToken = default, Action<DefinitionRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
