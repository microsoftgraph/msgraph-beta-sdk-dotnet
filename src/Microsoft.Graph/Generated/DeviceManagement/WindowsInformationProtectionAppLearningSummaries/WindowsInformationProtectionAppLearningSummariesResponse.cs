...
namespace MicrosoftGraphSdk.DeviceManagement.WindowsInformationProtectionAppLearningSummaries {
    public class WindowsInformationProtectionAppLearningSummariesResponse : IParsable {
        ...
        /// </summary>
        public static WindowsInformationProtectionAppLearningSummariesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WindowsInformationProtectionAppLearningSummariesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as WindowsInformationProtectionAppLearningSummariesResponse).Value = n.GetCollectionOfObjectValues<WindowsInformationProtectionAppLearningSummary>(WindowsInformationProtectionAppLearningSummary.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
