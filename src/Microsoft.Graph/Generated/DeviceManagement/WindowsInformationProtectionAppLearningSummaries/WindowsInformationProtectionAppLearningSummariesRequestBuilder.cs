...
using MicrosoftGraphSdk.DeviceManagement.WindowsInformationProtectionAppLearningSummaries.Count;
...
namespace MicrosoftGraphSdk.DeviceManagement.WindowsInformationProtectionAppLearningSummaries {
    ...
    public class WindowsInformationProtectionAppLearningSummariesRequestBuilder {
        ...
        /// </summary>
        public async Task<WindowsInformationProtectionAppLearningSummaryCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
