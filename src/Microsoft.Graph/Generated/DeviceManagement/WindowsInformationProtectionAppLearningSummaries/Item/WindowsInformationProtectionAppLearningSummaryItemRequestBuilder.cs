...
namespace Microsoft.Graph.Beta.DeviceManagement.WindowsInformationProtectionAppLearningSummaries.Item {
    ...
    public class WindowsInformationProtectionAppLearningSummaryItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<WindowsInformationProtectionAppLearningSummary> PatchAsync(WindowsInformationProtectionAppLearningSummary body, Action<WindowsInformationProtectionAppLearningSummaryItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
