...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsBatteryHealthDeviceAppImpact {
    ...
    public class UserExperienceAnalyticsBatteryHealthDeviceAppImpactRequestBuilder {
        ...
        /// </summary>
        public async Task<UserExperienceAnalyticsBatteryHealthDeviceAppImpactCollectionResponse> GetAsync(Action<UserExperienceAnalyticsBatteryHealthDeviceAppImpactRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
