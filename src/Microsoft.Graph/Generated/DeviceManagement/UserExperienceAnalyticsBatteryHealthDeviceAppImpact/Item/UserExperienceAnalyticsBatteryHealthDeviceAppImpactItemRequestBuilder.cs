...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsBatteryHealthDeviceAppImpact.Item {
    ...
    public class UserExperienceAnalyticsBatteryHealthDeviceAppImpactItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(Action<UserExperienceAnalyticsBatteryHealthDeviceAppImpactItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
