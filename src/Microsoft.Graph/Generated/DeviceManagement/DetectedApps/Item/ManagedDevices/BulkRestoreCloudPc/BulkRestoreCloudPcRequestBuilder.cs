...
namespace MicrosoftGraphSdk.DeviceManagement.DetectedApps.Item.ManagedDevices.BulkRestoreCloudPc {
    /// <summary>Builds and executes requests for operations under \deviceManagement\detectedApps\{detectedApp-id}\managedDevices\microsoft.graph.bulkRestoreCloudPc</summary>
    public class BulkRestoreCloudPcRequestBuilder {
        ...
        public BulkRestoreCloudPcRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/detectedApps/{detectedApp_id}/managedDevices/microsoft.graph.bulkRestoreCloudPc";
