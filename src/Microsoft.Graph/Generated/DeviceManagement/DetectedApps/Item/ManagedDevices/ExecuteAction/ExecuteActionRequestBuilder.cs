...
namespace MicrosoftGraphSdk.DeviceManagement.DetectedApps.Item.ManagedDevices.ExecuteAction {
    /// <summary>Builds and executes requests for operations under \deviceManagement\detectedApps\{detectedApp-id}\managedDevices\microsoft.graph.executeAction</summary>
    public class ExecuteActionRequestBuilder {
        ...
        public ExecuteActionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/detectedApps/{detectedApp_id}/managedDevices/microsoft.graph.executeAction";
