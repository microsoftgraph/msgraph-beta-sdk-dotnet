...
namespace MicrosoftGraph.DeviceManagement.DetectedApps.Item.ManagedDevices.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public RefRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/detectedApps/{detectedApp_id}/managedDevices/$ref{?top,skip,search,filter,count,orderby}";
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftGraph.DeviceManagement.DetectedApps.Item.ManagedDevices.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftGraph.DeviceManagement.DetectedApps.Item.ManagedDevices.Ref.Ref> PostAsync(MicrosoftGraph.DeviceManagement.DetectedApps.Item.ManagedDevices.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<MicrosoftGraph.DeviceManagement.DetectedApps.Item.ManagedDevices.Ref.Ref>(requestInfo, responseHandler, default, cancellationToken);
        }
