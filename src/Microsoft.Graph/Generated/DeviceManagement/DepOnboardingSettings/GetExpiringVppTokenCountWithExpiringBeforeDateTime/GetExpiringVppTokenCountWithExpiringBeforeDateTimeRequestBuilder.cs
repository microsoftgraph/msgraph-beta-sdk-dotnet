...
#nullable enable
        public async Task<GetExpiringVppTokenCountWithExpiringBeforeDateTimeResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetExpiringVppTokenCountWithExpiringBeforeDateTimeResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
