...
#nullable enable
        public async Task<DepOnboardingSettingCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DepOnboardingSettingsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DepOnboardingSettingCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DepOnboardingSettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DepOnboardingSetting?> PostAsync(DepOnboardingSetting body, CancellationToken cancellationToken = default, Action<DepOnboardingSettingsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DepOnboardingSetting> PostAsync(DepOnboardingSetting body, CancellationToken cancellationToken = default, Action<DepOnboardingSettingsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
