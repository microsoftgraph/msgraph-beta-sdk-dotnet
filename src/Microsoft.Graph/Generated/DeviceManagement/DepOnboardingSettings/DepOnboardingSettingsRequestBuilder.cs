...
namespace Microsoft.Graph.Beta.DeviceManagement.DepOnboardingSettings {
    ...
    public class DepOnboardingSettingsRequestBuilder {
        ...
        /// </summary>
        public async Task<DepOnboardingSettingCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DepOnboardingSettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DepOnboardingSetting> PostAsync(DepOnboardingSetting body, CancellationToken cancellationToken = default, Action<DepOnboardingSettingsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
