...
#nullable enable
        public async Task<GetEncryptionPublicKeyGetResponse?> GetAsGetEncryptionPublicKeyGetResponseAsync(Action<GetEncryptionPublicKeyRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<GetEncryptionPublicKeyGetResponse> GetAsGetEncryptionPublicKeyGetResponseAsync(Action<GetEncryptionPublicKeyRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
