...
#nullable enable
        public async Task<GetEncryptionPublicKeyResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetEncryptionPublicKeyRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetEncryptionPublicKeyResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetEncryptionPublicKeyRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
