...
using MicrosoftGraph.DeviceManagement.DepOnboardingSettings.Item.DefaultIosEnrollmentProfile;
using MicrosoftGraph.DeviceManagement.DepOnboardingSettings.Item.DefaultMacOsEnrollmentProfile;
using MicrosoftGraph.DeviceManagement.DepOnboardingSettings.Item.EnrollmentProfiles;
using MicrosoftGraph.DeviceManagement.DepOnboardingSettings.Item.GenerateEncryptionPublicKey;
using MicrosoftGraph.DeviceManagement.DepOnboardingSettings.Item.GetEncryptionPublicKey;
using MicrosoftGraph.DeviceManagement.DepOnboardingSettings.Item.ImportedAppleDeviceIdentities;
using MicrosoftGraph.DeviceManagement.DepOnboardingSettings.Item.ShareForSchoolDataSyncService;
using MicrosoftGraph.DeviceManagement.DepOnboardingSettings.Item.SyncWithAppleDeviceEnrollmentProgram;
using MicrosoftGraph.DeviceManagement.DepOnboardingSettings.Item.UnshareForSchoolDataSyncService;
using MicrosoftGraph.DeviceManagement.DepOnboardingSettings.Item.UploadDepToken;
...
namespace MicrosoftGraph.DeviceManagement.DepOnboardingSettings.Item {
    ...
    public class DepOnboardingSettingRequestBuilder {
        ...
        /// </summary>
        public DepOnboardingSettingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public DepOnboardingSettingRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
