...
namespace MicrosoftGraphSdk.DeviceManagement.DepOnboardingSettings.Item.UploadDepToken {
    ...
    public class UploadDepTokenRequestBody : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public UploadDepTokenRequestBody() {
        ...
        /// </summary>
        public static UploadDepTokenRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UploadDepTokenRequestBody();
        }
        /// <summary>
