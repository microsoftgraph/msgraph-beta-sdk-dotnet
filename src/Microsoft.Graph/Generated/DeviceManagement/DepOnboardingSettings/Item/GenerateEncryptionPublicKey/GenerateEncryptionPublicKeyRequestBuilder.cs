...
#nullable enable
        public async Task<GenerateEncryptionPublicKeyResponse?> PostAsync(CancellationToken cancellationToken = default, Action<GenerateEncryptionPublicKeyRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GenerateEncryptionPublicKeyResponse> PostAsync(CancellationToken cancellationToken = default, Action<GenerateEncryptionPublicKeyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
