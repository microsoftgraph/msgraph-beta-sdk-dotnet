...
namespace Microsoft.Graph.Beta.DeviceManagement.DepOnboardingSettings.Item.GenerateEncryptionPublicKey {
    ...
    public class GenerateEncryptionPublicKeyRequestBuilder {
        ...
        /// </summary>
        public async Task<GenerateEncryptionPublicKeyResponse> PostAsync(CancellationToken cancellationToken = default, Action<GenerateEncryptionPublicKeyRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<GenerateEncryptionPublicKeyResponse>(requestInfo, GenerateEncryptionPublicKeyResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
