...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.DeviceManagement.DepOnboardingSettings.Item.ImportedAppleDeviceIdentities {
    public class ImportedAppleDeviceIdentitiesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ImportedAppleDeviceIdentitiesResponse).Value = n.GetCollectionOfObjectValues<ImportedAppleDeviceIdentity>().ToList(); } },
            };
        }
        /// <summary>
