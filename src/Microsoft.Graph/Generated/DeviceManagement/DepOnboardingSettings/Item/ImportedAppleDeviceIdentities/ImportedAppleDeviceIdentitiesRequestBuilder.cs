...
#nullable enable
        public async Task<ImportedAppleDeviceIdentityCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ImportedAppleDeviceIdentitiesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ImportedAppleDeviceIdentityCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ImportedAppleDeviceIdentitiesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ImportedAppleDeviceIdentity?> PostAsync(ImportedAppleDeviceIdentity body, CancellationToken cancellationToken = default, Action<ImportedAppleDeviceIdentitiesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ImportedAppleDeviceIdentity> PostAsync(ImportedAppleDeviceIdentity body, CancellationToken cancellationToken = default, Action<ImportedAppleDeviceIdentitiesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
