...
namespace Microsoft.Graph.Beta.DeviceManagement.DepOnboardingSettings.Item.ImportedAppleDeviceIdentities.ImportAppleDeviceIdentityList {
    ...
    public class ImportAppleDeviceIdentityListRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ImportAppleDeviceIdentityListRequestBody body, Action<ImportAppleDeviceIdentityListRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<ImportAppleDeviceIdentityListResponse> PostAsync(ImportAppleDeviceIdentityListRequestBody body, Action<ImportAppleDeviceIdentityListRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
