...
namespace MicrosoftGraphSdk.DeviceManagement.DepOnboardingSettings.Item.ImportedAppleDeviceIdentities.ImportAppleDeviceIdentityList {
    ...
    public class ImportAppleDeviceIdentityListResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public ImportAppleDeviceIdentityListResponse() {
        ...
        /// </summary>
        public static ImportAppleDeviceIdentityListResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as ImportAppleDeviceIdentityListResponse).Value = n.GetCollectionOfObjectValues<ImportedAppleDeviceIdentityResult>(ImportedAppleDeviceIdentityResult.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
