...
#nullable enable
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<ShareForSchoolDataSyncServiceRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<ShareForSchoolDataSyncServiceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
