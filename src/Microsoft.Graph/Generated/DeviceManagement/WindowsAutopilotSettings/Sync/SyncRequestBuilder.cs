...
namespace Microsoft.Graph.Beta.DeviceManagement.WindowsAutopilotSettings.Sync {
    ...
    public class SyncRequestBuilder {
        ...
        public SyncRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/windowsAutopilotSettings/microsoft.graph.sync";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Action<SyncRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(Action<SyncRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
