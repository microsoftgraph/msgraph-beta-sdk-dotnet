...
namespace Microsoft.Graph.Beta.DeviceManagement.WindowsAutopilotSettings.Sync {
    /// <summary>
    ...
    public class SyncRequestBuilder : BaseRequestBuilder {
        ...
        public SyncRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/windowsAutopilotSettings/sync", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SyncRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SyncRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/windowsAutopilotSettings/sync", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(Action<SyncRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(Action<SyncRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Action<SyncRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Action<SyncRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
