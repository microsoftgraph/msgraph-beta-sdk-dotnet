...
namespace Microsoft.Graph.Beta.DeviceManagement.WindowsAutopilotSettings.Sync {
    ...
    public class SyncRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<SyncRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
