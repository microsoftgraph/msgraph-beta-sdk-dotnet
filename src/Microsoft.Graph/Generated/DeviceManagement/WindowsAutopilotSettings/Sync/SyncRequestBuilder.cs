...
namespace MicrosoftGraphSdk.DeviceManagement.WindowsAutopilotSettings.Sync {
    /// <summary>Builds and executes requests for operations under \deviceManagement\windowsAutopilotSettings\microsoft.graph.sync</summary>
