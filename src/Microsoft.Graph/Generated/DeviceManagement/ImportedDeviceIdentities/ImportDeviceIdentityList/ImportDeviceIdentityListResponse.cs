...
namespace Microsoft.Graph.Beta.DeviceManagement.ImportedDeviceIdentities.ImportDeviceIdentityList {
    ...
    public class ImportDeviceIdentityListResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ImportedDeviceIdentityResult> Value {
            get { return BackingStore?.Get<List<ImportedDeviceIdentityResult>>(nameof(Value)); }
