...
namespace Microsoft.Graph.Beta.DeviceManagement.ImportedDeviceIdentities.ImportDeviceIdentityList {
    ...
    public class ImportDeviceIdentityListRequestBuilder {
        ...
        /// </summary>
        public async Task<ImportDeviceIdentityListResponse> PostAsync(ImportDeviceIdentityListPostRequestBody body, Action<ImportDeviceIdentityListRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<ImportDeviceIdentityListResponse>(requestInfo, ImportDeviceIdentityListResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
