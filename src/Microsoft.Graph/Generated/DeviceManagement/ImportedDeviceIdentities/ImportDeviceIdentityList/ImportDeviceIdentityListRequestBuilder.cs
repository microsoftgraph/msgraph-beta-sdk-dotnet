...
namespace Microsoft.Graph.Beta.DeviceManagement.ImportedDeviceIdentities.ImportDeviceIdentityList {
    ...
    public class ImportDeviceIdentityListRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ImportDeviceIdentityListRequestBody body, Action<ImportDeviceIdentityListRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<ImportDeviceIdentityListResponse> PostAsync(ImportDeviceIdentityListRequestBody body, Action<ImportDeviceIdentityListRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, requestConfiguration);
            return await RequestAdapter.SendAsync<ImportDeviceIdentityListResponse>(requestInfo, ImportDeviceIdentityListResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
