...
namespace Microsoft.Graph.Beta.DeviceManagement.ImportedDeviceIdentities.ImportDeviceIdentityList {
    ...
    public class ImportDeviceIdentityListRequestBuilder {
        ...
        /// </summary>
        public async Task<ImportDeviceIdentityListResponse> PostAsync(ImportDeviceIdentityListPostRequestBody body, CancellationToken cancellationToken = default, Action<ImportDeviceIdentityListRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
