    ...
    public class ImportDeviceIdentityListRequestBody : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"importedDeviceIdentities", (o,n) => { (o as ImportDeviceIdentityListRequestBody).ImportedDeviceIdentities = n.GetCollectionOfObjectValues<ImportedDeviceIdentity>().ToList(); } },
