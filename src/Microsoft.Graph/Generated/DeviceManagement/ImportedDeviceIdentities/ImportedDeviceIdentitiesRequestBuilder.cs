...
#nullable enable
        public async Task<ImportedDeviceIdentityCollectionResponse?> GetAsync(Action<ImportedDeviceIdentitiesRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ImportedDeviceIdentityCollectionResponse> GetAsync(Action<ImportedDeviceIdentitiesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
