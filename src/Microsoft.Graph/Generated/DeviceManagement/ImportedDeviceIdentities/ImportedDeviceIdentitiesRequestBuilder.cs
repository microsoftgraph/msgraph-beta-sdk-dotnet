...
namespace Microsoft.Graph.Beta.DeviceManagement.ImportedDeviceIdentities {
    ...
    /// </summary>
    public class ImportedDeviceIdentitiesRequestBuilder : BaseRequestBuilder {
        ...
        public ImportedDeviceIdentityItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("importedDeviceIdentity%2Did", position);
        ...
        public ImportedDeviceIdentitiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/importedDeviceIdentities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ImportedDeviceIdentitiesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ImportedDeviceIdentitiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/importedDeviceIdentities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ImportedDeviceIdentityCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ImportedDeviceIdentitiesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ImportedDeviceIdentityCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ImportedDeviceIdentitiesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ImportedDeviceIdentity?> PostAsync(ImportedDeviceIdentity body, CancellationToken cancellationToken = default, Action<ImportedDeviceIdentitiesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ImportedDeviceIdentity> PostAsync(ImportedDeviceIdentity body, CancellationToken cancellationToken = default, Action<ImportedDeviceIdentitiesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<ImportedDeviceIdentitiesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<ImportedDeviceIdentitiesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ImportedDeviceIdentitiesRequestBuilderGetRequestConfiguration();
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ImportedDeviceIdentity body, Action<ImportedDeviceIdentitiesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ImportedDeviceIdentity body, Action<ImportedDeviceIdentitiesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ImportedDeviceIdentitiesRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
...
#nullable restore
        ...
        public class ImportedDeviceIdentitiesRequestBuilderGetRequestConfiguration {
            ...
            public ImportedDeviceIdentitiesRequestBuilderGetQueryParameters QueryParameters { get; set; } = new ImportedDeviceIdentitiesRequestBuilderGetQueryParameters();
            /// <summary>
