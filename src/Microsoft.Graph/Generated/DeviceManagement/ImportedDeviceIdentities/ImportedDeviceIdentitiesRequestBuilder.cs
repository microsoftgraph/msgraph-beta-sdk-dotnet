...
namespace MicrosoftGraph.DeviceManagement.ImportedDeviceIdentities {
    ...
    public class ImportedDeviceIdentitiesRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ImportedDeviceIdentity body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
