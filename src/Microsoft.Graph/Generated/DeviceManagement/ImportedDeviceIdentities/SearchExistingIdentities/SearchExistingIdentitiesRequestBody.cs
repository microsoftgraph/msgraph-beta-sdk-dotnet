...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.DeviceManagement.ImportedDeviceIdentities.SearchExistingIdentities {
    public class SearchExistingIdentitiesRequestBody : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"importedDeviceIdentities", (o,n) => { (o as SearchExistingIdentitiesRequestBody).ImportedDeviceIdentities = n.GetCollectionOfObjectValues<ImportedDeviceIdentity>().ToList(); } },
            };
        }
        /// <summary>
