...
namespace Microsoft.Graph.Beta.DeviceManagement.ImportedDeviceIdentities.SearchExistingIdentities {
    ...
    public class SearchExistingIdentitiesResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ImportedDeviceIdentity> Value {
            get { return BackingStore?.Get<List<ImportedDeviceIdentity>>(nameof(Value)); }
