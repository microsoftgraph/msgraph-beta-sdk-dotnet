...
namespace MicrosoftGraphSdk.DeviceManagement.AdvancedThreatProtectionOnboardingStateSummary {
    ...
    public class AdvancedThreatProtectionOnboardingStateSummaryRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.AdvancedThreatProtectionOnboardingStateSummary body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        public async Task<MicrosoftGraphSdk.Models.Microsoft.Graph.AdvancedThreatProtectionOnboardingStateSummary> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<MicrosoftGraphSdk.Models.Microsoft.Graph.AdvancedThreatProtectionOnboardingStateSummary>(requestInfo, MicrosoftGraphSdk.Models.Microsoft.Graph.AdvancedThreatProtectionOnboardingStateSummary.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Update the navigation property advancedThreatProtectionOnboardingStateSummary in deviceManagement
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MicrosoftGraphSdk.Models.Microsoft.Graph.AdvancedThreatProtectionOnboardingStateSummary body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
