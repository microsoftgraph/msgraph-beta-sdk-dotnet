...
namespace Microsoft.Graph.Beta.DeviceManagement.AdvancedThreatProtectionOnboardingStateSummary {
    ...
    public class AdvancedThreatProtectionOnboardingStateSummaryRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AdvancedThreatProtectionOnboardingStateSummaryRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.AdvancedThreatProtectionOnboardingStateSummary> GetAsync(CancellationToken cancellationToken = default, Action<AdvancedThreatProtectionOnboardingStateSummaryRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.AdvancedThreatProtectionOnboardingStateSummary body, CancellationToken cancellationToken = default, Action<AdvancedThreatProtectionOnboardingStateSummaryRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
