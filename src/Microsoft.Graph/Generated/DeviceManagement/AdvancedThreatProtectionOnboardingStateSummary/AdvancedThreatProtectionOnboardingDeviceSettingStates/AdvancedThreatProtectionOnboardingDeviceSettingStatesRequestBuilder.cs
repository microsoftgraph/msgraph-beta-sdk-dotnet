...
namespace Microsoft.Graph.Beta.DeviceManagement.AdvancedThreatProtectionOnboardingStateSummary.AdvancedThreatProtectionOnboardingDeviceSettingStates {
    ...
    public class AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilder : BaseRequestBuilder {
        ...
        public AdvancedThreatProtectionOnboardingDeviceSettingStateItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("advancedThreatProtectionOnboardingDeviceSettingState%2Did", position);
...
#nullable enable
        public async Task<AdvancedThreatProtectionOnboardingDeviceSettingStateCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AdvancedThreatProtectionOnboardingDeviceSettingStateCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(AdvancedThreatProtectionOnboardingDeviceSettingState body, Action<AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(AdvancedThreatProtectionOnboardingDeviceSettingState body, Action<AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
