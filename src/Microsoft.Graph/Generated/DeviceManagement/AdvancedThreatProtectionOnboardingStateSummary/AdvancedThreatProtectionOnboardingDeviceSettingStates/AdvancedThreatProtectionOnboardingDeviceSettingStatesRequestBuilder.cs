...
namespace Microsoft.Graph.Beta.DeviceManagement.AdvancedThreatProtectionOnboardingStateSummary.AdvancedThreatProtectionOnboardingDeviceSettingStates {
    ...
    public class AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilder {
        ...
        public AdvancedThreatProtectionOnboardingDeviceSettingStateItemRequestBuilder this[string position] { get {
            ...
            urlTplParams.Add("advancedThreatProtectionOnboardingDeviceSettingState_id", position);
        ...
        public AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/advancedThreatProtectionOnboardingStateSummary/advancedThreatProtectionOnboardingDeviceSettingStates{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AdvancedThreatProtectionOnboardingDeviceSettingState body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AdvancedThreatProtectionOnboardingDeviceSettingState> PostAsync(AdvancedThreatProtectionOnboardingDeviceSettingState body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
