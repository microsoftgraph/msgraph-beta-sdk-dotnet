...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsCategories.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsCategories/$count{?%24search,%24filter}";
