...
namespace MicrosoftGraphSdk.DeviceManagement.TermsAndConditions.Item.AcceptanceStatuses {
    ...
    public class AcceptanceStatusesRequestBuilder {
        ...
        /// </summary>
        public async Task<TermsAndConditionsAcceptanceStatusCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
