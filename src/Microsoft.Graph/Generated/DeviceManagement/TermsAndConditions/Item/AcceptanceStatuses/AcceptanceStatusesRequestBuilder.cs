using Microsoft.Graph.Beta.DeviceManagement.TermsAndConditions.Item.AcceptanceStatuses.Count;
using Microsoft.Graph.Beta.DeviceManagement.TermsAndConditions.Item.AcceptanceStatuses.Item;
...
namespace Microsoft.Graph.Beta.DeviceManagement.TermsAndConditions.Item.AcceptanceStatuses {
    ...
    public class AcceptanceStatusesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.deviceManagement.termsAndConditions.item.acceptanceStatuses.item collection</summary>
        ...
        public AcceptanceStatusesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}/acceptanceStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<AcceptanceStatusesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(TermsAndConditionsAcceptanceStatus body, Action<AcceptanceStatusesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<TermsAndConditionsAcceptanceStatusCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AcceptanceStatusesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TermsAndConditionsAcceptanceStatus> PostAsync(TermsAndConditionsAcceptanceStatus body, CancellationToken cancellationToken = default, Action<AcceptanceStatusesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
