...
namespace Microsoft.Graph.Beta.DeviceManagement.TermsAndConditions.Item.GroupAssignments {
    ...
    public class GroupAssignmentsRequestBuilder : BaseRequestBuilder {
        ...
        public TermsAndConditionsGroupAssignmentItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("termsAndConditionsGroupAssignment%2Did", position);
        ...
        public GroupAssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}/groupAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GroupAssignmentsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GroupAssignmentsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}/groupAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<TermsAndConditionsGroupAssignmentCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GroupAssignmentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TermsAndConditionsGroupAssignmentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<GroupAssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TermsAndConditionsGroupAssignment?> PostAsync(TermsAndConditionsGroupAssignment body, CancellationToken cancellationToken = default, Action<GroupAssignmentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TermsAndConditionsGroupAssignment> PostAsync(TermsAndConditionsGroupAssignment body, CancellationToken cancellationToken = default, Action<GroupAssignmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(TermsAndConditionsGroupAssignment body, Action<GroupAssignmentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(TermsAndConditionsGroupAssignment body, Action<GroupAssignmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
