...
#nullable enable
        public async Task<TermsAndConditionsGroupAssignmentCollectionResponse?> GetAsync(Action<GroupAssignmentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<TermsAndConditionsGroupAssignmentCollectionResponse> GetAsync(Action<GroupAssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TermsAndConditionsGroupAssignment?> PostAsync(TermsAndConditionsGroupAssignment body, Action<GroupAssignmentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<TermsAndConditionsGroupAssignment> PostAsync(TermsAndConditionsGroupAssignment body, Action<GroupAssignmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
