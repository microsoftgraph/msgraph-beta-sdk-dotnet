...
using MicrosoftGraphSdk.DeviceManagement.TermsAndConditions.Count;
...
namespace MicrosoftGraphSdk.DeviceManagement.TermsAndConditions {
    ...
    public class TermsAndConditionsRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.TermsAndConditions body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftGraphSdk.Models.Microsoft.Graph.TermsAndConditions> PostAsync(MicrosoftGraphSdk.Models.Microsoft.Graph.TermsAndConditions body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
