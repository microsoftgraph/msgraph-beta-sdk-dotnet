...
#nullable enable
        public async Task<DeviceManagementScriptCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceManagementScriptsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementScriptCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DeviceManagementScriptsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementScript?> PostAsync(DeviceManagementScript body, CancellationToken cancellationToken = default, Action<DeviceManagementScriptsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementScript> PostAsync(DeviceManagementScript body, CancellationToken cancellationToken = default, Action<DeviceManagementScriptsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
