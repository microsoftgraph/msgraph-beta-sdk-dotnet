...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceManagementScripts.HasPayloadLinks {
    ...
    public class HasPayloadLinksRequestBuilder : BaseRequestBuilder {
        ...
        public HasPayloadLinksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/deviceManagementScripts/hasPayloadLinks", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HasPayloadLinksRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HasPayloadLinksRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/deviceManagementScripts/hasPayloadLinks", rawUrl) {
        }
        /// <summary>
