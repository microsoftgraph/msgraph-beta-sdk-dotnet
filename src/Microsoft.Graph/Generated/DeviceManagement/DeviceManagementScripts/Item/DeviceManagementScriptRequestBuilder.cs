...
using MicrosoftGraph.DeviceManagement.DeviceManagementScripts.Item.Assign;
using MicrosoftGraph.DeviceManagement.DeviceManagementScripts.Item.Assignments;
using MicrosoftGraph.DeviceManagement.DeviceManagementScripts.Item.DeviceRunStates;
using MicrosoftGraph.DeviceManagement.DeviceManagementScripts.Item.GroupAssignments;
using MicrosoftGraph.DeviceManagement.DeviceManagementScripts.Item.RunSummary;
using MicrosoftGraph.DeviceManagement.DeviceManagementScripts.Item.UserRunStates;
...
namespace MicrosoftGraph.DeviceManagement.DeviceManagementScripts.Item {
    ...
    public class DeviceManagementScriptRequestBuilder {
        ...
        /// </summary>
        public DeviceManagementScriptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public DeviceManagementScriptRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(DeviceManagementScript body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
