...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.DeviceManagement.DeviceManagementScripts.Item.Assign {
    public class AssignRequestBody : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"deviceManagementScriptAssignments", (o,n) => { (o as AssignRequestBody).DeviceManagementScriptAssignments = n.GetCollectionOfObjectValues<DeviceManagementScriptAssignment>().ToList(); } },
                {"deviceManagementScriptGroupAssignments", (o,n) => { (o as AssignRequestBody).DeviceManagementScriptGroupAssignments = n.GetCollectionOfObjectValues<DeviceManagementScriptGroupAssignment>().ToList(); } },
            };
        }
        /// <summary>
