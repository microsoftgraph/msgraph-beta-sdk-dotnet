...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceManagementScripts.Item.DeviceRunStates.Item {
    ...
    public class DeviceManagementScriptDeviceStateItemRequestBuilder {
        ...
        public DeviceManagementScriptDeviceStateItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/deviceManagementScripts/{deviceManagementScript%2Did}/deviceRunStates/{deviceManagementScriptDeviceState%2Did}{?%24select,%24expand}";
