...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceManagementScripts.Item.UserRunStates.Item.DeviceRunStates.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/deviceManagementScripts/{deviceManagementScript_id}/userRunStates/{deviceManagementScriptUserState_id}/deviceRunStates/$count";
