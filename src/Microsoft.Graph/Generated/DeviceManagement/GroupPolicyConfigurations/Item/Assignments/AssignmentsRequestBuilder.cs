...
namespace Microsoft.Graph.Beta.DeviceManagement.GroupPolicyConfigurations.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder {
        ...
        /// </summary>
        public async Task<GroupPolicyConfigurationAssignmentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GroupPolicyConfigurationAssignment> PostAsync(GroupPolicyConfigurationAssignment body, CancellationToken cancellationToken = default, Action<AssignmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
