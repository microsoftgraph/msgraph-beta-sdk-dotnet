...
namespace MicrosoftGraphSdk.DeviceManagement.GroupPolicyConfigurations.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder {
        ...
        public async Task<GroupPolicyConfigurationAssignment> PostAsync(GroupPolicyConfigurationAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<GroupPolicyConfigurationAssignment>(requestInfo, GroupPolicyConfigurationAssignment.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
