...
namespace Microsoft.Graph.Beta.DeviceManagement.GroupPolicyConfigurations.Item.DefinitionValues.Item.PresentationValues.Item.Presentation {
    ...
    public class PresentationRequestBuilder {
        ...
        /// </summary>
        public async Task<GroupPolicyPresentation> GetAsync(CancellationToken cancellationToken = default, Action<PresentationRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
