...
namespace Microsoft.Graph.Beta.DeviceManagement.GroupPolicyConfigurations.Item.DefinitionValues.Item.PresentationValues {
    ...
    public class PresentationValuesRequestBuilder {
        ...
        /// </summary>
        public async Task<GroupPolicyPresentationValueCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PresentationValuesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GroupPolicyPresentationValue> PostAsync(GroupPolicyPresentationValue body, CancellationToken cancellationToken = default, Action<PresentationValuesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
