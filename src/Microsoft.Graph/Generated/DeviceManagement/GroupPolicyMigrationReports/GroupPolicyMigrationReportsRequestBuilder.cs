...
namespace MicrosoftGraphSdk.DeviceManagement.GroupPolicyMigrationReports {
    ...
    public class GroupPolicyMigrationReportsRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GroupPolicyMigrationReport body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
