...
#nullable enable
        public async Task<UpdateScopeTagsResponse?> PostAsync(UpdateScopeTagsPostRequestBody body, CancellationToken cancellationToken = default, Action<UpdateScopeTagsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UpdateScopeTagsResponse> PostAsync(UpdateScopeTagsPostRequestBody body, CancellationToken cancellationToken = default, Action<UpdateScopeTagsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
