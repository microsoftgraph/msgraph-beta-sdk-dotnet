...
namespace Microsoft.Graph.Beta.DeviceManagement.GroupPolicyMigrationReports.Item {
    ...
    public class GroupPolicyMigrationReportItemRequestBuilder : BaseRequestBuilder {
        ...
        public GroupPolicyMigrationReportItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyMigrationReports/{groupPolicyMigrationReport%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GroupPolicyMigrationReportItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GroupPolicyMigrationReportItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyMigrationReports/{groupPolicyMigrationReport%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<GroupPolicyMigrationReportItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<GroupPolicyMigrationReportItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<GroupPolicyMigrationReport?> GetAsync(CancellationToken cancellationToken = default, Action<GroupPolicyMigrationReportItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GroupPolicyMigrationReport> GetAsync(CancellationToken cancellationToken = default, Action<GroupPolicyMigrationReportItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<GroupPolicyMigrationReport?> PatchAsync(GroupPolicyMigrationReport body, CancellationToken cancellationToken = default, Action<GroupPolicyMigrationReportItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GroupPolicyMigrationReport> PatchAsync(GroupPolicyMigrationReport body, CancellationToken cancellationToken = default, Action<GroupPolicyMigrationReportItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
