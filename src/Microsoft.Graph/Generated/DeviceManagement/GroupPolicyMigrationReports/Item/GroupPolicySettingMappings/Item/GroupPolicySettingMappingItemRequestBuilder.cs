...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<GroupPolicySettingMappingItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<GroupPolicySettingMappingItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<GroupPolicySettingMapping?> GetAsync(CancellationToken cancellationToken = default, Action<GroupPolicySettingMappingItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GroupPolicySettingMapping> GetAsync(CancellationToken cancellationToken = default, Action<GroupPolicySettingMappingItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<GroupPolicySettingMapping?> PatchAsync(GroupPolicySettingMapping body, CancellationToken cancellationToken = default, Action<GroupPolicySettingMappingItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GroupPolicySettingMapping> PatchAsync(GroupPolicySettingMapping body, CancellationToken cancellationToken = default, Action<GroupPolicySettingMappingItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
