...
namespace MicrosoftGraphSdk.DeviceManagement.GroupPolicyMigrationReports.Item.GroupPolicySettingMappings {
    public class GroupPolicySettingMappingsResponse : IParsable {
        ...
        /// </summary>
        public static GroupPolicySettingMappingsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GroupPolicySettingMappingsResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as GroupPolicySettingMappingsResponse).Value = n.GetCollectionOfObjectValues<GroupPolicySettingMapping>(GroupPolicySettingMapping.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
