...
namespace Microsoft.Graph.Beta.DeviceManagement.GroupPolicyMigrationReports.Item.UnsupportedGroupPolicyExtensions {
    ...
    public class UnsupportedGroupPolicyExtensionsRequestBuilder {
        ...
        /// </summary>
        public async Task<UnsupportedGroupPolicyExtensionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UnsupportedGroupPolicyExtensionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UnsupportedGroupPolicyExtension> PostAsync(UnsupportedGroupPolicyExtension body, CancellationToken cancellationToken = default, Action<UnsupportedGroupPolicyExtensionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
