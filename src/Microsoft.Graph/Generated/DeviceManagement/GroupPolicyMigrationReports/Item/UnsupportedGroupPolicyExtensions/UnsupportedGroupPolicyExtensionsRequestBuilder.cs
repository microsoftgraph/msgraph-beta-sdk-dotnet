...
namespace Microsoft.Graph.Beta.DeviceManagement.GroupPolicyMigrationReports.Item.UnsupportedGroupPolicyExtensions {
    ...
    public class UnsupportedGroupPolicyExtensionsRequestBuilder : BaseRequestBuilder {
        ...
        /// <returns>A <cref="UnsupportedGroupPolicyExtensionItemRequestBuilder"></returns>
        ...
        /// </summary>
        /// <returns>A <cref="UnsupportedGroupPolicyExtensionCollectionResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnsupportedGroupPolicyExtensionCollectionResponse?> GetAsync(Action<RequestConfiguration<UnsupportedGroupPolicyExtensionsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<UnsupportedGroupPolicyExtensionCollectionResponse> GetAsync(Action<RequestConfiguration<UnsupportedGroupPolicyExtensionsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<UnsupportedGroupPolicyExtensionCollectionResponse>(requestInfo, UnsupportedGroupPolicyExtensionCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Create new navigation property to unsupportedGroupPolicyExtensions for deviceManagement
        /// </summary>
        /// <returns>A <cref="UnsupportedGroupPolicyExtension"></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnsupportedGroupPolicyExtension?> PostAsync(UnsupportedGroupPolicyExtension body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<UnsupportedGroupPolicyExtension> PostAsync(UnsupportedGroupPolicyExtension body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<UnsupportedGroupPolicyExtension>(requestInfo, UnsupportedGroupPolicyExtension.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// A list of unsupported group policy extensions inside the Group Policy Object.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="UnsupportedGroupPolicyExtensionsRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class UnsupportedGroupPolicyExtensionsRequestBuilderGetRequestConfiguration : RequestConfiguration<UnsupportedGroupPolicyExtensionsRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
