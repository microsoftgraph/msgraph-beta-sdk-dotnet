...
using MicrosoftGraphSdk.DeviceManagement.GroupPolicyMigrationReports.Item.UnsupportedGroupPolicyExtensions.Count;
using MicrosoftGraphSdk.DeviceManagement.GroupPolicyMigrationReports.Item.UnsupportedGroupPolicyExtensions.Item;
...
namespace MicrosoftGraphSdk.DeviceManagement.GroupPolicyMigrationReports.Item.UnsupportedGroupPolicyExtensions {
    ...
    public class UnsupportedGroupPolicyExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.deviceManagement.groupPolicyMigrationReports.item.unsupportedGroupPolicyExtensions.item collection</summary>
        public UnsupportedGroupPolicyExtensionItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("unsupportedGroupPolicyExtension_id", position);
        ...
        public UnsupportedGroupPolicyExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/groupPolicyMigrationReports/{groupPolicyMigrationReport_id}/unsupportedGroupPolicyExtensions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(UnsupportedGroupPolicyExtension body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UnsupportedGroupPolicyExtension> PostAsync(UnsupportedGroupPolicyExtension body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
