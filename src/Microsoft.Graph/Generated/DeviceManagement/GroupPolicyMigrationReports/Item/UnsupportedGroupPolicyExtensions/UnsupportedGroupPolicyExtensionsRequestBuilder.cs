...
#nullable enable
        public async Task<UnsupportedGroupPolicyExtensionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<UnsupportedGroupPolicyExtensionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnsupportedGroupPolicyExtensionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UnsupportedGroupPolicyExtensionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnsupportedGroupPolicyExtension?> PostAsync(UnsupportedGroupPolicyExtension body, CancellationToken cancellationToken = default, Action<UnsupportedGroupPolicyExtensionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnsupportedGroupPolicyExtension> PostAsync(UnsupportedGroupPolicyExtension body, CancellationToken cancellationToken = default, Action<UnsupportedGroupPolicyExtensionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
