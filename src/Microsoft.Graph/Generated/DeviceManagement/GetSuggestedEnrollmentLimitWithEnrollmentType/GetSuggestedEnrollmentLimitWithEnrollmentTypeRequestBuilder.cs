...
#nullable enable
        public async Task<SuggestedEnrollmentLimit?> GetAsync(CancellationToken cancellationToken = default, Action<GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SuggestedEnrollmentLimit> GetAsync(CancellationToken cancellationToken = default, Action<GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
