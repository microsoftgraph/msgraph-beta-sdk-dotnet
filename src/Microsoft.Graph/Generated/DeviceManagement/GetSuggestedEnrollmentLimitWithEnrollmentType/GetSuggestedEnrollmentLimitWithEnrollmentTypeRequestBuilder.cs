...
namespace Microsoft.Graph.Beta.DeviceManagement.GetSuggestedEnrollmentLimitWithEnrollmentType {
    ...
    public class GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilder {
        ...
        /// </summary>
        public GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string enrollmentType = default) {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<SuggestedEnrollmentLimit> GetAsync(CancellationToken cancellationToken = default, Action<GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<SuggestedEnrollmentLimit>(requestInfo, SuggestedEnrollmentLimit.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
