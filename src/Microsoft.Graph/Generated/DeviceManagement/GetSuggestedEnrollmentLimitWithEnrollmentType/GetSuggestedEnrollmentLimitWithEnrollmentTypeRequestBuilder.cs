...
namespace Microsoft.Graph.Beta.DeviceManagement.GetSuggestedEnrollmentLimitWithEnrollmentType {
    ...
    public class GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilder {
        ...
        /// </summary>
        public async Task<SuggestedEnrollmentLimit> GetAsync(Action<GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
