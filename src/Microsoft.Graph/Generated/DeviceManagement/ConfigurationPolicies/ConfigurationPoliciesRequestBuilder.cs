...
#nullable enable
        public async Task<DeviceManagementConfigurationPolicyCollectionResponse?> GetAsync(Action<RequestConfiguration<ConfigurationPoliciesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<DeviceManagementConfigurationPolicyCollectionResponse> GetAsync(Action<RequestConfiguration<ConfigurationPoliciesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        public class ConfigurationPoliciesRequestBuilderGetRequestConfiguration : RequestConfiguration<ConfigurationPoliciesRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
