...
#nullable enable
        public async Task<DeviceManagementConfigurationPolicy?> PostAsync(CreateCopyPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateCopyRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementConfigurationPolicy> PostAsync(CreateCopyPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateCopyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
