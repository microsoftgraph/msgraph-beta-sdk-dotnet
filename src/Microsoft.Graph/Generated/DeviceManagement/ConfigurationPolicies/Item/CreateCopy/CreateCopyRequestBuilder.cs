...
namespace Microsoft.Graph.Beta.DeviceManagement.ConfigurationPolicies.Item.CreateCopy {
    ...
    public class CreateCopyRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceManagementConfigurationPolicy> PostAsync(CreateCopyPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateCopyRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
