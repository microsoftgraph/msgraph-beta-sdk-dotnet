...
namespace Microsoft.Graph.Beta.DeviceManagement.ConfigurationPolicies.Item.CreateCopy
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.DeviceManagement.ConfigurationPolicies.Item.CreateCopy.CreateCopyRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.DeviceManagement.ConfigurationPolicies.Item.CreateCopy.CreateCopyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.DeviceManagement.ConfigurationPolicies.Item.CreateCopy.CreateCopyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.DeviceManagement.ConfigurationPolicies.Item.CreateCopy.CreateCopyRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.DeviceManagement.ConfigurationPolicies.Item.CreateCopy.CreateCopyRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.DeviceManagement.ConfigurationPolicies.Item.CreateCopy.CreateCopyRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
