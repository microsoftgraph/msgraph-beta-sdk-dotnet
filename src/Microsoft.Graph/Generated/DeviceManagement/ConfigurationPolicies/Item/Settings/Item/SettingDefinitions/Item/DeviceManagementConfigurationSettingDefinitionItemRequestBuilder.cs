...
namespace MicrosoftGraphSdk.DeviceManagement.ConfigurationPolicies.Item.Settings.Item.SettingDefinitions.Item {
    ...
    public class DeviceManagementConfigurationSettingDefinitionItemRequestBuilder {
        ...
        public DeviceManagementConfigurationSettingDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/configurationPolicies/{deviceManagementConfigurationPolicy_id}/settings/{deviceManagementConfigurationSetting_id}/settingDefinitions/{deviceManagementConfigurationSettingDefinition_id}{?select,expand}";
