...
using MicrosoftGraphSdk.DeviceManagement.ConfigurationPolicies.Item.Settings.Item.SettingDefinitions.Count;
using MicrosoftGraphSdk.DeviceManagement.ConfigurationPolicies.Item.Settings.Item.SettingDefinitions.Item;
...
namespace MicrosoftGraphSdk.DeviceManagement.ConfigurationPolicies.Item.Settings.Item.SettingDefinitions {
    ...
    public class SettingDefinitionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.deviceManagement.configurationPolicies.item.settings.item.settingDefinitions.item collection</summary>
