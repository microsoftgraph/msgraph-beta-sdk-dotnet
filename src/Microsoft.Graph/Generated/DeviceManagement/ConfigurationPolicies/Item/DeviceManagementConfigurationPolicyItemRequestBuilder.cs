...
using Microsoft.Graph.Beta.DeviceManagement.ConfigurationPolicies.Item.AssignJustInTimeConfiguration;
...
using Microsoft.Graph.Beta.DeviceManagement.ConfigurationPolicies.Item.RetrieveJustInTimeConfiguration;
...
namespace Microsoft.Graph.Beta.DeviceManagement.ConfigurationPolicies.Item {
    ...
    public class DeviceManagementConfigurationPolicyItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <summary>Provides operations to call the assignJustInTimeConfiguration method.</summary>
        public AssignJustInTimeConfigurationRequestBuilder AssignJustInTimeConfiguration
        {
            get => new AssignJustInTimeConfigurationRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new ReorderRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the retrieveJustInTimeConfiguration method.</summary>
        public RetrieveJustInTimeConfigurationRequestBuilder RetrieveJustInTimeConfiguration
        {
            get => new RetrieveJustInTimeConfigurationRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new RetrieveLatestUpgradeDefaultBaselinePolicyRequestBuilder(PathParameters, RequestAdapter);
        }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementConfigurationPolicy?> GetAsync(Action<RequestConfiguration<DeviceManagementConfigurationPolicyItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<DeviceManagementConfigurationPolicy> GetAsync(Action<RequestConfiguration<DeviceManagementConfigurationPolicyItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementConfigurationPolicy?> PatchAsync(DeviceManagementConfigurationPolicy body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<DeviceManagementConfigurationPolicy> PatchAsync(DeviceManagementConfigurationPolicy body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class DeviceManagementConfigurationPolicyItemRequestBuilderGetRequestConfiguration : RequestConfiguration<DeviceManagementConfigurationPolicyItemRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
