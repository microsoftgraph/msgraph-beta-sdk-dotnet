...
#nullable enable
        public async Task<ComanagementEligibleDevicesSummary?> GetAsync(CancellationToken cancellationToken = default, Action<GetComanagementEligibleDevicesSummaryRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ComanagementEligibleDevicesSummary> GetAsync(CancellationToken cancellationToken = default, Action<GetComanagementEligibleDevicesSummaryRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
