...
namespace MicrosoftGraph.DeviceManagement.DeviceComplianceScripts.Item.DeviceRunStates.Item.ManagedDevice.CleanWindowsDevice {
    ...
    public class CleanWindowsDeviceRequestBuilder {
        ...
        public CleanWindowsDeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/deviceComplianceScripts/{deviceComplianceScript_id}/deviceRunStates/{deviceComplianceScriptDeviceState_id}/managedDevice/microsoft.graph.cleanWindowsDevice";
