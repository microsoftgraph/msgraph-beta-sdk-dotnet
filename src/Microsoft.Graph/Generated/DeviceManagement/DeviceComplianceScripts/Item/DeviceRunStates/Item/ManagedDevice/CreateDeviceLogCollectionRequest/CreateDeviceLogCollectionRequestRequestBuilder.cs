...
namespace MicrosoftGraphSdk.DeviceManagement.DeviceComplianceScripts.Item.DeviceRunStates.Item.ManagedDevice.CreateDeviceLogCollectionRequest {
    /// <summary>Builds and executes requests for operations under \deviceManagement\deviceComplianceScripts\{deviceComplianceScript-id}\deviceRunStates\{deviceComplianceScriptDeviceState-id}\managedDevice\microsoft.graph.createDeviceLogCollectionRequest</summary>
    public class CreateDeviceLogCollectionRequestRequestBuilder {
        ...
        public CreateDeviceLogCollectionRequestRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/deviceComplianceScripts/{deviceComplianceScript_id}/deviceRunStates/{deviceComplianceScriptDeviceState_id}/managedDevice/microsoft.graph.createDeviceLogCollectionRequest";
