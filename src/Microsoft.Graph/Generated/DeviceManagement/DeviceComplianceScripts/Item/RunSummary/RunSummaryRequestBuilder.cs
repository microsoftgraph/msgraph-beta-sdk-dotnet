...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceComplianceScriptRunSummary?> GetAsync(CancellationToken cancellationToken = default, Action<RunSummaryRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceComplianceScriptRunSummary> GetAsync(CancellationToken cancellationToken = default, Action<RunSummaryRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceComplianceScriptRunSummary?> PatchAsync(DeviceComplianceScriptRunSummary body, CancellationToken cancellationToken = default, Action<RunSummaryRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceComplianceScriptRunSummary> PatchAsync(DeviceComplianceScriptRunSummary body, CancellationToken cancellationToken = default, Action<RunSummaryRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
