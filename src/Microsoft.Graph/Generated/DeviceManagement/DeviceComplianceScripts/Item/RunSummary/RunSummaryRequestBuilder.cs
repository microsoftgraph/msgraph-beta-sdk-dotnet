...
#nullable restore
        ...
        public async Task<DeviceComplianceScriptRunSummary> GetAsync(Action<RunSummaryRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<DeviceComplianceScriptRunSummary>(requestInfo, DeviceComplianceScriptRunSummary.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
