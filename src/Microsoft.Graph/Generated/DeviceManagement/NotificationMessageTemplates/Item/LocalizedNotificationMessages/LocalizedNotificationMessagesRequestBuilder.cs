...
namespace MicrosoftGraph.DeviceManagement.NotificationMessageTemplates.Item.LocalizedNotificationMessages {
    ...
    public class LocalizedNotificationMessagesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.deviceManagement.notificationMessageTemplates.item.localizedNotificationMessages.item collection</summary>
        public LocalizedNotificationMessagesRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("localizedNotificationMessage_id", position);
            return new LocalizedNotificationMessagesRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
