...
namespace Microsoft.Graph.Beta.DeviceManagement.Monitoring.AlertRules {
    ...
    public class AlertRulesRequestBuilder : BaseRequestBuilder {
        ...
        public AlertRulesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/monitoring/alertRules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AlertRulesRequestBuilder and sets the default values.
        /// </summary>
