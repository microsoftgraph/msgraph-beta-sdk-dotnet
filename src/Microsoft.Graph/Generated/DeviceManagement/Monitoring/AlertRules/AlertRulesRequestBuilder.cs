...
namespace Microsoft.Graph.Beta.DeviceManagement.Monitoring.AlertRules {
    ...
    public class AlertRulesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.deviceManagement.monitoring.alertRules.item collection</summary>
        ...
        public AlertRulesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/monitoring/alertRules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
