...
namespace Microsoft.Graph.Beta.DeviceManagement.Monitoring.AlertRecords.GetPortalNotifications {
    ...
    public class GetPortalNotificationsRequestBuilder {
        ...
        public GetPortalNotificationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/monitoring/alertRecords/microsoft.graph.deviceManagement.getPortalNotifications(){?%24top,%24skip,%24search,%24filter,%24count}";
        ...
        public RequestInformation CreateGetRequestInformation(Action<GetPortalNotificationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new GetPortalNotificationsRequestBuilderGetRequestConfiguration();
        ...
        /// </summary>
        public async Task<GetPortalNotificationsResponse> GetAsync(Action<GetPortalNotificationsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<GetPortalNotificationsResponse>(requestInfo, GetPortalNotificationsResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        ...
        public class GetPortalNotificationsRequestBuilderGetRequestConfiguration {
            ...
            public GetPortalNotificationsRequestBuilderGetQueryParameters QueryParameters { get; set; } = new GetPortalNotificationsRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new getPortalNotificationsRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
