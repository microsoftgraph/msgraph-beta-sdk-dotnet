...
namespace Microsoft.Graph.Beta.DeviceManagement.Monitoring.AlertRecords.Item.DeviceManagementSetPortalNotificationAsSent {
    ...
    /// </summary>
    public class DeviceManagementSetPortalNotificationAsSentRequestBuilder {
        ...
        public DeviceManagementSetPortalNotificationAsSentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/deviceManagement/monitoring/alertRecords/{alertRecord%2Did}/deviceManagement.setPortalNotificationAsSent";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeviceManagementSetPortalNotificationAsSentRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
