...
namespace MicrosoftGraphSdk.DeviceManagement.DeviceCustomAttributeShellScripts {
    public class DeviceCustomAttributeShellScriptsResponse : IParsable {
        ...
        /// </summary>
        public static DeviceCustomAttributeShellScriptsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DeviceCustomAttributeShellScriptsResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DeviceCustomAttributeShellScriptsResponse).Value = n.GetCollectionOfObjectValues<DeviceCustomAttributeShellScript>(DeviceCustomAttributeShellScript.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
