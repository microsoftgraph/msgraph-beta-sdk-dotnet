...
namespace Microsoft.Graph.Beta.DeviceManagement.CloudCertificationAuthority.Item
{
    ...
    public partial class CloudCertificationAuthorityItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>Provides operations to manage the activeVersion property of the microsoft.graph.cloudCertificationAuthority entity.</summary>
        ...
        /// <summary>Provides operations to call the getCloudCertificationAuthorityVersion method.</summary>
        ...
        /// <summary>Provides operations to call the getCloudCertificationAuthorityVersions method.</summary>
        ...
        public CloudCertificationAuthorityItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/cloudCertificationAuthority/{cloudCertificationAuthority%2Did}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.DeviceManagement.CloudCertificationAuthority.Item.CloudCertificationAuthorityItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CloudCertificationAuthorityItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/cloudCertificationAuthority/{cloudCertificationAuthority%2Did}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/deviceManagement/cloudCertificationAuthority/{cloudCertificationAuthority%2Did}{?%24expand,%24select}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
