...
namespace Microsoft.Graph.Beta.DeviceManagement.ConfigManagerCollections.GetPolicySummaryWithPolicyId {
    ...
    public class GetPolicySummaryWithPolicyIdRequestBuilder {
        ...
        /// </summary>
        public async Task<ConfigManagerPolicySummary> GetAsync(Action<GetPolicySummaryWithPolicyIdRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<ConfigManagerPolicySummary>(requestInfo, ConfigManagerPolicySummary.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
