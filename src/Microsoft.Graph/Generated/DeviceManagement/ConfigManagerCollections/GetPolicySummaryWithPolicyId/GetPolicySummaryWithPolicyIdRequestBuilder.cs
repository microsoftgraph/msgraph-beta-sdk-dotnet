...
namespace MicrosoftGraphSdk.DeviceManagement.ConfigManagerCollections.GetPolicySummaryWithPolicyId {
    ...
    public class GetPolicySummaryWithPolicyIdRequestBuilder {
        ...
        /// </summary>
        public async Task<ConfigManagerPolicySummary> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
