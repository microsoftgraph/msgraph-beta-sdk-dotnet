...
namespace Microsoft.Graph.Beta.DeviceManagement.ConfigManagerCollections.GetPolicySummaryWithPolicyId {
    ...
    public class GetPolicySummaryWithPolicyIdRequestBuilder {
        ...
        /// </summary>
        public async Task<ConfigManagerPolicySummary> GetAsync(CancellationToken cancellationToken = default, Action<GetPolicySummaryWithPolicyIdRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
