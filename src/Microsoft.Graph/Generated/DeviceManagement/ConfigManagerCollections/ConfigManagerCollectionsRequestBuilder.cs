...
namespace MicrosoftGraphSdk.DeviceManagement.ConfigManagerCollections {
    ...
    public class ConfigManagerCollectionsRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ConfigManagerCollection body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
