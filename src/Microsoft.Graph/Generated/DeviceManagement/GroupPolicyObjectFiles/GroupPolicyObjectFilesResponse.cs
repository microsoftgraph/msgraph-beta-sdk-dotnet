...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.DeviceManagement.GroupPolicyObjectFiles {
    public class GroupPolicyObjectFilesResponse : IParsable {
        ...
        /// </summary>
        public static GroupPolicyObjectFilesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GroupPolicyObjectFilesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as GroupPolicyObjectFilesResponse).Value = n.GetCollectionOfObjectValues<GroupPolicyObjectFile>(GroupPolicyObjectFile.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
