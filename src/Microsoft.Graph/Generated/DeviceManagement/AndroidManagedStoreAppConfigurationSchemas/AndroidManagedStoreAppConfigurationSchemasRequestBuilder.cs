...
namespace MicrosoftGraphSdk.DeviceManagement.AndroidManagedStoreAppConfigurationSchemas {
    ...
    public class AndroidManagedStoreAppConfigurationSchemasRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AndroidManagedStoreAppConfigurationSchema body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
