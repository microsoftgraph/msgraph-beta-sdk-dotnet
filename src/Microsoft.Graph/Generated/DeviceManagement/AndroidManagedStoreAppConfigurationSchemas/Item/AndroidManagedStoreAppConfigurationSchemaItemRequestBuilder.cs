...
namespace Microsoft.Graph.Beta.DeviceManagement.AndroidManagedStoreAppConfigurationSchemas.Item {
    ...
    public class AndroidManagedStoreAppConfigurationSchemaItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AndroidManagedStoreAppConfigurationSchemaItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AndroidManagedStoreAppConfigurationSchema> GetAsync(CancellationToken cancellationToken = default, Action<AndroidManagedStoreAppConfigurationSchemaItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AndroidManagedStoreAppConfigurationSchema body, CancellationToken cancellationToken = default, Action<AndroidManagedStoreAppConfigurationSchemaItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
