...
namespace MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsWorkFromAnywhereMetrics {
    public class UserExperienceAnalyticsWorkFromAnywhereMetricsResponse : IParsable {
        ...
        /// </summary>
        public static UserExperienceAnalyticsWorkFromAnywhereMetricsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UserExperienceAnalyticsWorkFromAnywhereMetricsResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UserExperienceAnalyticsWorkFromAnywhereMetricsResponse).Value = n.GetCollectionOfObjectValues<UserExperienceAnalyticsWorkFromAnywhereMetric>(UserExperienceAnalyticsWorkFromAnywhereMetric.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
