...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsWorkFromAnywhereMetrics.Item.MetricDevices {
    ...
    public class MetricDevicesRequestBuilder {
        ...
        public async Task<UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse> GetAsync(Action<MetricDevicesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse>(requestInfo, UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to metricDevices for deviceManagement
        /// <param name="body"></param>
