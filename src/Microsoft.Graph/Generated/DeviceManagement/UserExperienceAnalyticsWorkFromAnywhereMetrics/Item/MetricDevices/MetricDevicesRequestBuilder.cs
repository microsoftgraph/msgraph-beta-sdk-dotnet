...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsWorkFromAnywhereMetrics.Item.MetricDevices {
    ...
    public class MetricDevicesRequestBuilder : BaseRequestBuilder {
        ...
        public UserExperienceAnalyticsWorkFromAnywhereDeviceItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("userExperienceAnalyticsWorkFromAnywhereDevice%2Did", position);
...
#nullable enable
        public async Task<UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<MetricDevicesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MetricDevicesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UserExperienceAnalyticsWorkFromAnywhereDevice?> PostAsync(UserExperienceAnalyticsWorkFromAnywhereDevice body, CancellationToken cancellationToken = default, Action<MetricDevicesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserExperienceAnalyticsWorkFromAnywhereDevice> PostAsync(UserExperienceAnalyticsWorkFromAnywhereDevice body, CancellationToken cancellationToken = default, Action<MetricDevicesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
