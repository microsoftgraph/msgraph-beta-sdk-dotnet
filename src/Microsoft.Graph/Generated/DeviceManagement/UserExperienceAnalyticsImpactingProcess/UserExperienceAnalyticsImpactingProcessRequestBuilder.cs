...
#nullable enable
        public async Task<UserExperienceAnalyticsImpactingProcessCollectionResponse?> GetAsync(Action<UserExperienceAnalyticsImpactingProcessRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<UserExperienceAnalyticsImpactingProcessCollectionResponse> GetAsync(Action<UserExperienceAnalyticsImpactingProcessRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
