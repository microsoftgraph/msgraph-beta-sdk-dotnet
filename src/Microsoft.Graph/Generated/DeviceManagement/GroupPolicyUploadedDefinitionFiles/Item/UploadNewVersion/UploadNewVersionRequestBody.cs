...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.DeviceManagement.GroupPolicyUploadedDefinitionFiles.Item.UploadNewVersion {
    public class UploadNewVersionRequestBody : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"groupPolicyUploadedLanguageFiles", (o,n) => { (o as UploadNewVersionRequestBody).GroupPolicyUploadedLanguageFiles = n.GetCollectionOfObjectValues<GroupPolicyUploadedLanguageFile>().ToList(); } },
            };
        }
        /// <summary>
