...
#nullable enable
        public async Task PostAsync(UploadNewVersionPostRequestBody body, CancellationToken cancellationToken = default, Action<UploadNewVersionRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(UploadNewVersionPostRequestBody body, CancellationToken cancellationToken = default, Action<UploadNewVersionRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
