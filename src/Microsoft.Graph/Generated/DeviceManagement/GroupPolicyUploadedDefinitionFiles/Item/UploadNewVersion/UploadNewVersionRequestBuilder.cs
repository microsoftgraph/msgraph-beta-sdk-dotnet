...
namespace Microsoft.Graph.Beta.DeviceManagement.GroupPolicyUploadedDefinitionFiles.Item.UploadNewVersion {
    ...
    public class UploadNewVersionRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(UploadNewVersionPostRequestBody body, Action<UploadNewVersionRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
