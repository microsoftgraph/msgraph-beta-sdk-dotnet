...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceManagementComplianceActionItemItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceManagementComplianceActionItemItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementComplianceActionItem?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceManagementComplianceActionItemItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementComplianceActionItem> GetAsync(CancellationToken cancellationToken = default, Action<DeviceManagementComplianceActionItemItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementComplianceActionItem?> PatchAsync(DeviceManagementComplianceActionItem body, CancellationToken cancellationToken = default, Action<DeviceManagementComplianceActionItemItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementComplianceActionItem> PatchAsync(DeviceManagementComplianceActionItem body, CancellationToken cancellationToken = default, Action<DeviceManagementComplianceActionItemItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
