...
namespace Microsoft.Graph.Beta.DeviceManagement.CompliancePolicies.Item.SetScheduledActions {
    ...
    public class SetScheduledActionsResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceManagementComplianceScheduledActionForRule> Value {
            get { return BackingStore?.Get<List<DeviceManagementComplianceScheduledActionForRule>>(nameof(Value)); }
