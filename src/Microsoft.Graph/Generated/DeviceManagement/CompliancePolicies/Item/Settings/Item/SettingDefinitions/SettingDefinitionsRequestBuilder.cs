...
namespace Microsoft.Graph.Beta.DeviceManagement.CompliancePolicies.Item.Settings.Item.SettingDefinitions {
    ...
    public class SettingDefinitionsRequestBuilder {
        ...
        public SettingDefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy_id}/settings/{deviceManagementConfigurationSetting_id}/settingDefinitions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
