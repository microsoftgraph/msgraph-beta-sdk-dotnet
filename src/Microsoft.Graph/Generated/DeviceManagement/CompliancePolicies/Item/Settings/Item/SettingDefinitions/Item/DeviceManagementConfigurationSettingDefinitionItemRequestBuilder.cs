...
namespace Microsoft.Graph.Beta.DeviceManagement.CompliancePolicies.Item.Settings.Item.SettingDefinitions.Item {
    ...
    public class DeviceManagementConfigurationSettingDefinitionItemRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceManagementConfigurationSettingDefinition> GetAsync(CancellationToken cancellationToken = default, Action<DeviceManagementConfigurationSettingDefinitionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
