...
namespace Microsoft.Graph.Beta.DeviceManagement.CompliancePolicies.Item.Settings.Item.SettingDefinitions.Item {
    ...
    public class DeviceManagementConfigurationSettingDefinitionItemRequestBuilder {
        ...
        public DeviceManagementConfigurationSettingDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy_id}/settings/{deviceManagementConfigurationSetting_id}/settingDefinitions/{deviceManagementConfigurationSettingDefinition_id}{?select,expand}";
