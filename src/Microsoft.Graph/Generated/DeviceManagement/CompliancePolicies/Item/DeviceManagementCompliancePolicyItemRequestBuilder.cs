...
#nullable restore
        ...
        public async Task<DeviceManagementCompliancePolicy> GetAsync(Action<DeviceManagementCompliancePolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<DeviceManagementCompliancePolicy>(requestInfo, DeviceManagementCompliancePolicy.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public DeviceManagementCompliancePolicyItemRequestBuilder WithUrl(string rawUrl) {
            return new DeviceManagementCompliancePolicyItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
