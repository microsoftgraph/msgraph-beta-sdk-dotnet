...
namespace MicrosoftGraphSdk.DeviceManagement.CompliancePolicies {
    public class CompliancePoliciesResponse : IParsable {
        ...
        /// </summary>
        public static CompliancePoliciesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CompliancePoliciesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as CompliancePoliciesResponse).Value = n.GetCollectionOfObjectValues<DeviceManagementCompliancePolicy>(DeviceManagementCompliancePolicy.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
