...
namespace MicrosoftGraph.DeviceManagement.DeviceShellScripts.Item.DeviceRunStates.Item.ManagedDevice.RequestRemoteAssistance {
    ...
    public class RequestRemoteAssistanceRequestBuilder {
        ...
        public RequestRemoteAssistanceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/deviceShellScripts/{deviceShellScript_id}/deviceRunStates/{deviceManagementScriptDeviceState_id}/managedDevice/microsoft.graph.requestRemoteAssistance";
