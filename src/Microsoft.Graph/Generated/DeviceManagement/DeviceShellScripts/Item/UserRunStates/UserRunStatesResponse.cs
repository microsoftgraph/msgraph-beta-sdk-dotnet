...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.DeviceManagement.DeviceShellScripts.Item.UserRunStates {
    public class UserRunStatesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UserRunStatesResponse).Value = n.GetCollectionOfObjectValues<DeviceManagementScriptUserState>().ToList(); } },
            };
        }
        /// <summary>
