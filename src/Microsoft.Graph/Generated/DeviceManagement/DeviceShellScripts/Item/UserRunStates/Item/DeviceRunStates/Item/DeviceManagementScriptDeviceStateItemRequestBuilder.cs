...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceShellScripts.Item.UserRunStates.Item.DeviceRunStates.Item {
    ...
    public class DeviceManagementScriptDeviceStateItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceManagementScriptDeviceState> PatchAsync(DeviceManagementScriptDeviceState body, Action<DeviceManagementScriptDeviceStateItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
