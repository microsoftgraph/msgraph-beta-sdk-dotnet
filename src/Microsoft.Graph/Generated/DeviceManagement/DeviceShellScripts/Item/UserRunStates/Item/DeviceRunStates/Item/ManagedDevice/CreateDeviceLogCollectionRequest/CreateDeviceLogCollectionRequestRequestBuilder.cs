...
namespace MicrosoftGraph.DeviceManagement.DeviceShellScripts.Item.UserRunStates.Item.DeviceRunStates.Item.ManagedDevice.CreateDeviceLogCollectionRequest {
    /// <summary>Builds and executes requests for operations under \deviceManagement\deviceShellScripts\{deviceShellScript-id}\userRunStates\{deviceManagementScriptUserState-id}\deviceRunStates\{deviceManagementScriptDeviceState-id}\managedDevice\microsoft.graph.createDeviceLogCollectionRequest</summary>
    public class CreateDeviceLogCollectionRequestRequestBuilder {
        ...
        public CreateDeviceLogCollectionRequestRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/deviceShellScripts/{deviceShellScript_id}/userRunStates/{deviceManagementScriptUserState_id}/deviceRunStates/{deviceManagementScriptDeviceState_id}/managedDevice/microsoft.graph.createDeviceLogCollectionRequest";
