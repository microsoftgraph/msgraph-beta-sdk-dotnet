...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceShellScripts.Item.UserRunStates.Item {
    ...
    public class DeviceManagementScriptUserStateItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceManagementScriptUserStateItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceManagementScriptUserState> GetAsync(CancellationToken cancellationToken = default, Action<DeviceManagementScriptUserStateItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DeviceManagementScriptUserState body, CancellationToken cancellationToken = default, Action<DeviceManagementScriptUserStateItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
