...
namespace Microsoft.Graph.Beta.DeviceManagement.OperationApprovalRequests {
    ...
    public class OperationApprovalRequestsRequestBuilder : BaseRequestBuilder {
        ...
        public CancelMyRequestRequestBuilder CancelMyRequest { get =>
            new CancelMyRequestRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public RetrieveMyRequestsRequestBuilder RetrieveMyRequests { get =>
            new RetrieveMyRequestsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the retrieveRequestStatus method.</summary>
        public RetrieveRequestStatusRequestBuilder RetrieveRequestStatus { get =>
            new RetrieveRequestStatusRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public OperationApprovalRequestItemRequestBuilder this[string position] { get {
        ...
        public OperationApprovalRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/operationApprovalRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OperationApprovalRequestsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OperationApprovalRequestsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/operationApprovalRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
