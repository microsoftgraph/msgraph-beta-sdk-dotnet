...
namespace Microsoft.Graph.Beta.DeviceManagement.OrganizationalMessageDetails.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/organizationalMessageDetails/$count";
