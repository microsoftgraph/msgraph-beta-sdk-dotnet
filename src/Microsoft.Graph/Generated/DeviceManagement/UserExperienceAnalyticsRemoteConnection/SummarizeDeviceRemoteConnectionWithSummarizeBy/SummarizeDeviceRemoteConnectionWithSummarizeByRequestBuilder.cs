...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsRemoteConnection.SummarizeDeviceRemoteConnectionWithSummarizeBy {
    ...
    public class SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="SummarizeDeviceRemoteConnectionWithSummarizeByGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function summarizeDeviceRemoteConnection
        /// </summary>
        /// <returns>A <cref="SummarizeDeviceRemoteConnectionWithSummarizeByResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
