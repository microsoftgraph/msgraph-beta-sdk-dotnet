...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsRemoteConnection.SummarizeDeviceRemoteConnectionWithSummarizeBy {
    ...
    public class SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilder {
        ...
        /// </summary>
        public async Task<SummarizeDeviceRemoteConnectionWithSummarizeByResponse> GetAsync(CancellationToken cancellationToken = default, Action<SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
