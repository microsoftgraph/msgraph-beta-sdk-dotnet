...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsRemoteConnection.SummarizeDeviceRemoteConnectionWithSummarizeBy {
    ...
    public class SummarizeDeviceRemoteConnectionWithSummarizeByResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Microsoft.Graph.Beta.Models.UserExperienceAnalyticsRemoteConnection> Value {
            get { return BackingStore?.Get<List<Microsoft.Graph.Beta.Models.UserExperienceAnalyticsRemoteConnection>>(nameof(Value)); }
