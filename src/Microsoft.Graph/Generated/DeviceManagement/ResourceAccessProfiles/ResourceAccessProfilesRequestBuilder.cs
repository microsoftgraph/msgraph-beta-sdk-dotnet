...
namespace Microsoft.Graph.Beta.DeviceManagement.ResourceAccessProfiles {
    ...
    public class ResourceAccessProfilesRequestBuilder {
        ...
        public async Task<DeviceManagementResourceAccessProfileBaseCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ResourceAccessProfilesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            ...
            return await RequestAdapter.SendAsync<DeviceManagementResourceAccessProfileBaseCollectionResponse>(requestInfo, DeviceManagementResourceAccessProfileBaseCollectionResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to resourceAccessProfiles for deviceManagement
        /// <param name="body"></param>
