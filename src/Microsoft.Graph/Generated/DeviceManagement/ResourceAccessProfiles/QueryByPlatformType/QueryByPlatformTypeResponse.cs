...
namespace Microsoft.Graph.Beta.DeviceManagement.ResourceAccessProfiles.QueryByPlatformType {
    ...
    public class QueryByPlatformTypeResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceManagementResourceAccessProfileBase> Value {
            get { return BackingStore?.Get<List<DeviceManagementResourceAccessProfileBase>>(nameof(Value)); }
