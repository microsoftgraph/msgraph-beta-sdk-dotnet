...
#nullable restore
        ...
        public async Task<DeviceManagementResourceAccessProfileAssignmentCollectionResponse> GetAsync(Action<AssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<DeviceManagementResourceAccessProfileAssignmentCollectionResponse>(requestInfo, DeviceManagementResourceAccessProfileAssignmentCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
