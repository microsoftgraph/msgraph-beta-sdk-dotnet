...
namespace MicrosoftGraphSdk.DeviceManagement.UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersion {
    public class UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionResponse : IParsable {
        ...
        /// </summary>
        public static UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionResponse).Value = n.GetCollectionOfObjectValues<UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion>(UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
