...
#nullable enable
        public async Task<TelecomExpenseManagementPartnerCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TelecomExpenseManagementPartnersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TelecomExpenseManagementPartnerCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TelecomExpenseManagementPartnersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TelecomExpenseManagementPartner?> PostAsync(TelecomExpenseManagementPartner body, CancellationToken cancellationToken = default, Action<TelecomExpenseManagementPartnersRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TelecomExpenseManagementPartner> PostAsync(TelecomExpenseManagementPartner body, CancellationToken cancellationToken = default, Action<TelecomExpenseManagementPartnersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
