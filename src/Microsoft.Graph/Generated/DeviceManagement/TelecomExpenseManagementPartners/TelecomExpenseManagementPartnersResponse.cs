...
namespace MicrosoftGraphSdk.DeviceManagement.TelecomExpenseManagementPartners {
    public class TelecomExpenseManagementPartnersResponse : IParsable {
        ...
        /// </summary>
        public static TelecomExpenseManagementPartnersResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new TelecomExpenseManagementPartnersResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as TelecomExpenseManagementPartnersResponse).Value = n.GetCollectionOfObjectValues<TelecomExpenseManagementPartner>(TelecomExpenseManagementPartner.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
