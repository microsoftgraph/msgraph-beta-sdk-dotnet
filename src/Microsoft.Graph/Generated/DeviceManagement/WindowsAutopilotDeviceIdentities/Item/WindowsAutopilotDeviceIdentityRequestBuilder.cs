...
using MicrosoftGraph.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.AssignResourceAccountToDevice;
using MicrosoftGraph.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.AssignUserToDevice;
using MicrosoftGraph.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.DeploymentProfile;
using MicrosoftGraph.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.IntendedDeploymentProfile;
using MicrosoftGraph.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.UnassignResourceAccountFromDevice;
