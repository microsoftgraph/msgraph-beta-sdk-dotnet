...
namespace Microsoft.Graph.Beta.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.AssignUserToDevice {
    ...
    public class AssignUserToDeviceRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(AssignUserToDevicePostRequestBody body, CancellationToken cancellationToken = default, Action<AssignUserToDeviceRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
