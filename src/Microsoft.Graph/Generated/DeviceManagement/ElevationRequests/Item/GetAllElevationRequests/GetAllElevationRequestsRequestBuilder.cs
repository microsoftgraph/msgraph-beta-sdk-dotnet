...
namespace Microsoft.Graph.Beta.DeviceManagement.ElevationRequests.Item.GetAllElevationRequests {
    ...
    public class GetAllElevationRequestsRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new <see cref="GetAllElevationRequestsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <cref="GetAllElevationRequestsPostResponse"></returns>
...
#nullable restore
        ...
        /// Invoke action getAllElevationRequests
        /// </summary>
        /// <returns>A <cref="GetAllElevationRequestsResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetAllElevationRequestsRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
