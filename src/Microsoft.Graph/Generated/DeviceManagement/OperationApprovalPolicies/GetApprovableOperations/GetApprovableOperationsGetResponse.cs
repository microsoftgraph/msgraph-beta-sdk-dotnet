...
namespace Microsoft.Graph.Beta.DeviceManagement.OperationApprovalPolicies.GetApprovableOperations {
    ...
    public class GetApprovableOperationsGetResponse : BaseCollectionPaginationCountResponse, IParsable 
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="GetApprovableOperationsGetResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new GetApprovableOperationsGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GetApprovableOperationsGetResponse();
        }
        /// <summary>
