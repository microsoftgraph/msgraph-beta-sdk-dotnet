...
namespace MicrosoftGraph.DeviceManagement.EmbeddedSIMActivationCodePools.Item.DeviceStates.Item {
    ...
    public class EmbeddedSIMDeviceStateRequestBuilder {
        ...
        /// </summary>
        public EmbeddedSIMDeviceStateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public EmbeddedSIMDeviceStateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
