...
namespace MicrosoftGraphSdk.DeviceManagement.EmbeddedSIMActivationCodePools.Item.DeviceStates.Item {
    ...
    public class EmbeddedSIMDeviceStateItemRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(EmbeddedSIMDeviceState body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
