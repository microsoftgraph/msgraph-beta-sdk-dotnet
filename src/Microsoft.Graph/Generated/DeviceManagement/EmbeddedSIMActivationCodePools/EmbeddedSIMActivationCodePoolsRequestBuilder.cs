...
namespace Microsoft.Graph.Beta.DeviceManagement.EmbeddedSIMActivationCodePools {
    ...
    /// </summary>
    public class EmbeddedSIMActivationCodePoolsRequestBuilder : BaseRequestBuilder {
        ...
        public EmbeddedSIMActivationCodePoolItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("embeddedSIMActivationCodePool%2Did", position);
        ...
        public EmbeddedSIMActivationCodePoolsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/embeddedSIMActivationCodePools{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EmbeddedSIMActivationCodePoolsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EmbeddedSIMActivationCodePoolsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/embeddedSIMActivationCodePools{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public async Task<EmbeddedSIMActivationCodePoolCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<EmbeddedSIMActivationCodePoolsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            return await RequestAdapter.SendAsync<EmbeddedSIMActivationCodePoolCollectionResponse>(requestInfo, EmbeddedSIMActivationCodePoolCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<EmbeddedSIMActivationCodePoolsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<EmbeddedSIMActivationCodePoolsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(EmbeddedSIMActivationCodePool body, Action<EmbeddedSIMActivationCodePoolsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(EmbeddedSIMActivationCodePool body, Action<EmbeddedSIMActivationCodePoolsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
