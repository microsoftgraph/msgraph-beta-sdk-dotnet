...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<WindowsUpdateCatalogItemItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<WindowsUpdateCatalogItemItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WindowsUpdateCatalogItem?> GetAsync(CancellationToken cancellationToken = default, Action<WindowsUpdateCatalogItemItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WindowsUpdateCatalogItem> GetAsync(CancellationToken cancellationToken = default, Action<WindowsUpdateCatalogItemItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WindowsUpdateCatalogItem?> PatchAsync(WindowsUpdateCatalogItem body, CancellationToken cancellationToken = default, Action<WindowsUpdateCatalogItemItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WindowsUpdateCatalogItem> PatchAsync(WindowsUpdateCatalogItem body, CancellationToken cancellationToken = default, Action<WindowsUpdateCatalogItemItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
