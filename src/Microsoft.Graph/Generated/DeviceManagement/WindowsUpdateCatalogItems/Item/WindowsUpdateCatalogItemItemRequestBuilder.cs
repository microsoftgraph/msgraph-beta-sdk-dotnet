...
namespace Microsoft.Graph.Beta.DeviceManagement.WindowsUpdateCatalogItems.Item {
    ...
    public class WindowsUpdateCatalogItemItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(WindowsUpdateCatalogItem body, Action<WindowsUpdateCatalogItemItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
