...
namespace MicrosoftGraphSdk.DeviceManagement.WindowsUpdateCatalogItems {
    ...
    public class WindowsUpdateCatalogItemsRequestBuilder {
        ...
        /// </summary>
        public async Task<WindowsUpdateCatalogItemCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
