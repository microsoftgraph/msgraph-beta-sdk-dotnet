...
namespace Microsoft.Graph.Beta.DeviceManagement.WindowsUpdateCatalogItems {
    ...
    public class WindowsUpdateCatalogItemsRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<WindowsUpdateCatalogItemsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(WindowsUpdateCatalogItem body, Action<WindowsUpdateCatalogItemsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
