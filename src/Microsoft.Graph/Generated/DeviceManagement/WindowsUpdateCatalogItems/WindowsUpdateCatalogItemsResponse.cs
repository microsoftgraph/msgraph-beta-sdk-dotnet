...
namespace MicrosoftGraphSdk.DeviceManagement.WindowsUpdateCatalogItems {
    public class WindowsUpdateCatalogItemsResponse : IParsable {
        ...
        /// </summary>
        public static WindowsUpdateCatalogItemsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WindowsUpdateCatalogItemsResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as WindowsUpdateCatalogItemsResponse).Value = n.GetCollectionOfObjectValues<WindowsUpdateCatalogItem>(WindowsUpdateCatalogItem.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
