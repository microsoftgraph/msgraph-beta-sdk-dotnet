...
using MicrosoftGraphSdk.DeviceManagement.SettingDefinitions.Item;
...
namespace MicrosoftGraphSdk.DeviceManagement.SettingDefinitions {
    /// <summary>Builds and executes requests for operations under \deviceManagement\settingDefinitions</summary>
    public class SettingDefinitionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.deviceManagement.settingDefinitions.item collection</summary>
