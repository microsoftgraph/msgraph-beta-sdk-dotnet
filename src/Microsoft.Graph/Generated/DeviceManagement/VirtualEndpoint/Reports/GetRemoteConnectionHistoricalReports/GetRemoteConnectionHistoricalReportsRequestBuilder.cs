...
#nullable enable
        public async Task<Stream?> PostAsync(GetRemoteConnectionHistoricalReportsPostRequestBody body, CancellationToken cancellationToken = default, Action<GetRemoteConnectionHistoricalReportsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetRemoteConnectionHistoricalReportsPostRequestBody body, CancellationToken cancellationToken = default, Action<GetRemoteConnectionHistoricalReportsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
