...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetRealTimeRemoteConnectionStatusWithCloudPcIdRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public GetRealTimeRemoteConnectionStatusWithCloudPcIdRequestBuilder WithUrl(string rawUrl) {
