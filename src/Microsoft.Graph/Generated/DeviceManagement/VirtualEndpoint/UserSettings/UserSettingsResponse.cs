...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.DeviceManagement.VirtualEndpoint.UserSettings {
    public class UserSettingsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UserSettingsResponse).Value = n.GetCollectionOfObjectValues<CloudPcUserSetting>().ToList(); } },
            };
        }
        /// <summary>
