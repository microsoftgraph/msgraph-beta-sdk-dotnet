...
namespace Microsoft.Graph.Beta.DeviceManagement.VirtualEndpoint.CrossCloudGovernmentOrganizationMapping {
    ...
    /// </summary>
    public class CrossCloudGovernmentOrganizationMappingRequestBuilder : BaseRequestBuilder {
        /// <summary>
        ...
        public CrossCloudGovernmentOrganizationMappingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/crossCloudGovernmentOrganizationMapping{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CrossCloudGovernmentOrganizationMappingRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CrossCloudGovernmentOrganizationMappingRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/crossCloudGovernmentOrganizationMapping{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CrossCloudGovernmentOrganizationMappingRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CrossCloudGovernmentOrganizationMappingRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CloudPcCrossCloudGovernmentOrganizationMapping?> GetAsync(CancellationToken cancellationToken = default, Action<CrossCloudGovernmentOrganizationMappingRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CloudPcCrossCloudGovernmentOrganizationMapping> GetAsync(CancellationToken cancellationToken = default, Action<CrossCloudGovernmentOrganizationMappingRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CloudPcCrossCloudGovernmentOrganizationMapping?> PatchAsync(CloudPcCrossCloudGovernmentOrganizationMapping body, CancellationToken cancellationToken = default, Action<CrossCloudGovernmentOrganizationMappingRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CloudPcCrossCloudGovernmentOrganizationMapping> PatchAsync(CloudPcCrossCloudGovernmentOrganizationMapping body, CancellationToken cancellationToken = default, Action<CrossCloudGovernmentOrganizationMappingRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
