...
#nullable enable
        public async Task PostAsync(ApplyConfigPostRequestBody body, CancellationToken cancellationToken = default, Action<ApplyConfigRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(ApplyConfigPostRequestBody body, CancellationToken cancellationToken = default, Action<ApplyConfigRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
