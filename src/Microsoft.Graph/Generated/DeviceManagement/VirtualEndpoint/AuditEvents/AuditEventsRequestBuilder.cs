...
#nullable enable
        public async Task<CloudPcAuditEventCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AuditEventsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CloudPcAuditEventCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AuditEventsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CloudPcAuditEvent?> PostAsync(CloudPcAuditEvent body, CancellationToken cancellationToken = default, Action<AuditEventsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CloudPcAuditEvent> PostAsync(CloudPcAuditEvent body, CancellationToken cancellationToken = default, Action<AuditEventsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
