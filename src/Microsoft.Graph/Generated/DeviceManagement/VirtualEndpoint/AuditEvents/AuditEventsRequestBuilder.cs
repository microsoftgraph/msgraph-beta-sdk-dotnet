...
namespace Microsoft.Graph.Beta.DeviceManagement.VirtualEndpoint.AuditEvents {
    ...
    public class AuditEventsRequestBuilder {
        ...
        /// </summary>
        public async Task<CloudPcAuditEventCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AuditEventsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<CloudPcAuditEvent> PostAsync(CloudPcAuditEvent body, CancellationToken cancellationToken = default, Action<AuditEventsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
