...
namespace Microsoft.Graph.Beta.DeviceManagement.VirtualEndpoint.CloudPCs.BulkResize {
    ...
    public class BulkResizeRequestBuilder : BaseRequestBuilder {
        ...
        public BulkResizeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/bulkResize", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new BulkResizeRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BulkResizeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/bulkResize", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<BulkResizeResponse?> PostAsync(BulkResizePostRequestBody body, CancellationToken cancellationToken = default, Action<BulkResizeRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BulkResizeResponse> PostAsync(BulkResizePostRequestBody body, CancellationToken cancellationToken = default, Action<BulkResizeRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
