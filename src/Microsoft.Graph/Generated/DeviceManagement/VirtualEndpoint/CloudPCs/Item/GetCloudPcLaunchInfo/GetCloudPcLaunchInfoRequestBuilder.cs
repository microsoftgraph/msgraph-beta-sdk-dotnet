...
namespace MicrosoftGraphSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.GetCloudPcLaunchInfo {
    ...
    public class GetCloudPcLaunchInfoRequestBuilder {
        ...
        public GetCloudPcLaunchInfoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC_id}/microsoft.graph.getCloudPcLaunchInfo()";
