...
namespace Microsoft.Graph.Beta.DeviceManagement.VirtualEndpoint.Snapshots.GetSubscriptions {
    ...
    public class GetSubscriptionsResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<CloudPcSubscription> Value {
            get { return BackingStore?.Get<List<CloudPcSubscription>>(nameof(Value)); }
        ...
        /// </summary>
        public static GetSubscriptionsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
