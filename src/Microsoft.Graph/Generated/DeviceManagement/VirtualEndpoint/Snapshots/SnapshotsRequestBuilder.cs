...
namespace Microsoft.Graph.Beta.DeviceManagement.VirtualEndpoint.Snapshots {
    ...
    public class SnapshotsRequestBuilder {
        ...
        /// </summary>
        public async Task<CloudPcSnapshotCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SnapshotsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<CloudPcSnapshot> PostAsync(CloudPcSnapshot body, CancellationToken cancellationToken = default, Action<SnapshotsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
