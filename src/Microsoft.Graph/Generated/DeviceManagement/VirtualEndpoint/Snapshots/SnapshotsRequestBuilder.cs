...
namespace Microsoft.Graph.Beta.DeviceManagement.VirtualEndpoint.Snapshots {
    ...
    public class SnapshotsRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<SnapshotsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new SnapshotsRequestBuilderGetRequestConfiguration();
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CloudPcSnapshot body, Action<SnapshotsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<CloudPcSnapshotCollectionResponse> GetAsync(Action<SnapshotsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<CloudPcSnapshot> PostAsync(CloudPcSnapshot body, Action<SnapshotsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
        ...
        /// <summary>Get a list of cloudPcSnapshot objects and their properties.</summary>
        ...
        public class SnapshotsRequestBuilderGetRequestConfiguration {
            ...
            public SnapshotsRequestBuilderGetQueryParameters QueryParameters { get; set; } = new SnapshotsRequestBuilderGetQueryParameters();
            /// <summary>
