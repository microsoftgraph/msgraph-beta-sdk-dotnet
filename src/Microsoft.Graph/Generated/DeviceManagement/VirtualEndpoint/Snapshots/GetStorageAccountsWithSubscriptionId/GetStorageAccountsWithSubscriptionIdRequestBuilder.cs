...
#nullable enable
        public async Task<GetStorageAccountsWithSubscriptionIdResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetStorageAccountsWithSubscriptionIdRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetStorageAccountsWithSubscriptionIdResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetStorageAccountsWithSubscriptionIdRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
