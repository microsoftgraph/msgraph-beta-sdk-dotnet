...
namespace Microsoft.Graph.Beta.DeviceManagement.VirtualEndpoint.SharedUseServicePlans {
    ...
    public class SharedUseServicePlansRequestBuilder : BaseRequestBuilder {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/virtualendpoint-list-shareduseserviceplans?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CloudPcSharedUseServicePlanCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SharedUseServicePlansRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CloudPcSharedUseServicePlanCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SharedUseServicePlansRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CloudPcSharedUseServicePlan?> PostAsync(CloudPcSharedUseServicePlan body, CancellationToken cancellationToken = default, Action<SharedUseServicePlansRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CloudPcSharedUseServicePlan> PostAsync(CloudPcSharedUseServicePlan body, CancellationToken cancellationToken = default, Action<SharedUseServicePlansRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
