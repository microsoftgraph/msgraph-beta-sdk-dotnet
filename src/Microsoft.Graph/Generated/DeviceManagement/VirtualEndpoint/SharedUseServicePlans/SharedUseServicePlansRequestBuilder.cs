...
namespace Microsoft.Graph.Beta.DeviceManagement.VirtualEndpoint.SharedUseServicePlans {
    ...
    public class SharedUseServicePlansRequestBuilder {
        ...
        public SharedUseServicePlansRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/deviceManagement/virtualEndpoint/sharedUseServicePlans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SharedUseServicePlansRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreateGetRequestInformation(Action<SharedUseServicePlansRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
