...
namespace Microsoft.Graph.Beta.DeviceManagement.VirtualEndpoint.GalleryImages.Item {
    ...
    public class CloudPcGalleryImageItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(CloudPcGalleryImage body, Action<CloudPcGalleryImageItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
