...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsDeviceScopes {
    ...
    public class UserExperienceAnalyticsDeviceScopesRequestBuilder {
        ...
        /// </summary>
        public async Task<UserExperienceAnalyticsDeviceScopeCollectionResponse> GetAsync(Action<UserExperienceAnalyticsDeviceScopesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
