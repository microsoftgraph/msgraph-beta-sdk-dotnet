...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.DeviceManagement.AutopilotEvents.Item.PolicyStatusDetails {
    public class PolicyStatusDetailsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as PolicyStatusDetailsResponse).Value = n.GetCollectionOfObjectValues<DeviceManagementAutopilotPolicyStatusDetail>().ToList(); } },
            };
        }
        /// <summary>
