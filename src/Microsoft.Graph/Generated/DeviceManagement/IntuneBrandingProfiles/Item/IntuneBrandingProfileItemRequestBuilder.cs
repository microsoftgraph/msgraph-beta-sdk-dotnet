...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<IntuneBrandingProfileItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<IntuneBrandingProfileItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IntuneBrandingProfile?> GetAsync(CancellationToken cancellationToken = default, Action<IntuneBrandingProfileItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IntuneBrandingProfile> GetAsync(CancellationToken cancellationToken = default, Action<IntuneBrandingProfileItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IntuneBrandingProfile?> PatchAsync(IntuneBrandingProfile body, CancellationToken cancellationToken = default, Action<IntuneBrandingProfileItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IntuneBrandingProfile> PatchAsync(IntuneBrandingProfile body, CancellationToken cancellationToken = default, Action<IntuneBrandingProfileItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
