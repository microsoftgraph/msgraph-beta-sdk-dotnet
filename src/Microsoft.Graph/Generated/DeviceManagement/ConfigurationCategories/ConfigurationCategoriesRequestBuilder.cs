...
namespace MicrosoftGraph.DeviceManagement.ConfigurationCategories {
    /// <summary>Builds and executes requests for operations under \deviceManagement\configurationCategories</summary>
    public class ConfigurationCategoriesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.deviceManagement.configurationCategories.item collection</summary>
        public ConfigurationCategoriesRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("deviceManagementConfigurationCategory_id", position);
            return new ConfigurationCategoriesRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public ConfigurationCategoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/configurationCategories{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
