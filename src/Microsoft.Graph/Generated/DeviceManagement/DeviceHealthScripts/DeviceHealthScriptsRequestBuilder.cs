...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceHealthScripts {
    ...
    public class DeviceHealthScriptsRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceHealthScriptCollectionResponse> GetAsync(Action<DeviceHealthScriptsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceHealthScript> PostAsync(DeviceHealthScript body, Action<DeviceHealthScriptsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
