...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceHealthScripts {
    ...
    public class DeviceHealthScriptsRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<DeviceHealthScriptsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DeviceHealthScript body, Action<DeviceHealthScriptsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<DeviceHealthScriptCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DeviceHealthScriptsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceHealthScript> PostAsync(DeviceHealthScript body, CancellationToken cancellationToken = default, Action<DeviceHealthScriptsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
