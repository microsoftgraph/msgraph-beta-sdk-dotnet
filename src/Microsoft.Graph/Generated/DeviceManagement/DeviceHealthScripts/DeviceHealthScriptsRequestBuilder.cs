...
#nullable enable
        public async Task<DeviceHealthScriptCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceHealthScriptsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceHealthScriptCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DeviceHealthScriptsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceHealthScript?> PostAsync(DeviceHealthScript body, CancellationToken cancellationToken = default, Action<DeviceHealthScriptsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceHealthScript> PostAsync(DeviceHealthScript body, CancellationToken cancellationToken = default, Action<DeviceHealthScriptsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
