...
namespace MicrosoftGraph.DeviceManagement.DeviceHealthScripts.AreGlobalScriptsAvailable {
    /// <summary>Builds and executes requests for operations under \deviceManagement\deviceHealthScripts\microsoft.graph.areGlobalScriptsAvailable()</summary>
        ...
        public class AreGlobalScriptsAvailableResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"globalDeviceHealthScriptState", (o,n) => { (o as AreGlobalScriptsAvailableResponse).GlobalDeviceHealthScriptState = n.GetEnumValue<GlobalDeviceHealthScriptState>(); } },
                };
            }
            /// <summary>
