...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceHealthScripts.AreGlobalScriptsAvailable {
    ...
    public class AreGlobalScriptsAvailableRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<AreGlobalScriptsAvailableRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<GlobalDeviceHealthScriptState?> GetAsync(CancellationToken cancellationToken = default, Action<AreGlobalScriptsAvailableRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendPrimitiveAsync<GlobalDeviceHealthScriptState?>(requestInfo, responseHandler, errorMapping, cancellationToken);
        }
