...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceHealthScripts.Item.GetRemediationHistory {
    ...
    public class GetRemediationHistoryRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceHealthScriptRemediationHistory> GetAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
