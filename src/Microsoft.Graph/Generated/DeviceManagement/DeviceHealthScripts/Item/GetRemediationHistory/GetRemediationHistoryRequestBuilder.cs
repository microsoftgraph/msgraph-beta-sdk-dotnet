...
#nullable enable
        public async Task<DeviceHealthScriptRemediationHistory?> GetAsync(CancellationToken cancellationToken = default, Action<GetRemediationHistoryRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceHealthScriptRemediationHistory> GetAsync(CancellationToken cancellationToken = default, Action<GetRemediationHistoryRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
