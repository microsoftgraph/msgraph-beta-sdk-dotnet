...
using MicrosoftGraph.DeviceManagement.DeviceHealthScripts.Item.Assign;
using MicrosoftGraph.DeviceManagement.DeviceHealthScripts.Item.Assignments;
using MicrosoftGraph.DeviceManagement.DeviceHealthScripts.Item.DeviceRunStates;
using MicrosoftGraph.DeviceManagement.DeviceHealthScripts.Item.GetGlobalScriptHighestAvailableVersion;
using MicrosoftGraph.DeviceManagement.DeviceHealthScripts.Item.GetRemediationHistory;
using MicrosoftGraph.DeviceManagement.DeviceHealthScripts.Item.RunSummary;
using MicrosoftGraph.DeviceManagement.DeviceHealthScripts.Item.UpdateGlobalScript;
...
namespace MicrosoftGraph.DeviceManagement.DeviceHealthScripts.Item {
    ...
    public class DeviceHealthScriptRequestBuilder {
        ...
        /// </summary>
        public DeviceHealthScriptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/deviceManagement/deviceHealthScripts/{deviceHealthScript_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public DeviceHealthScriptRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(DeviceHealthScript body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
