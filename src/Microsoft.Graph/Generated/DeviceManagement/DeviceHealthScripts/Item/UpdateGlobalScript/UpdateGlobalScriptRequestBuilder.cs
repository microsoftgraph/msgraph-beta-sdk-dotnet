...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceHealthScripts.Item.UpdateGlobalScript {
    ...
    public class UpdateGlobalScriptRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="UpdateGlobalScriptPostResponse"></returns>
...
#nullable restore
        ...
        /// Update the Proprietary Device Health Script
        /// </summary>
        /// <returns>A <cref="UpdateGlobalScriptResponse"></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="UpdateGlobalScriptRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
