...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceHealthScripts.Item.UpdateGlobalScript {
    ...
    public class UpdateGlobalScriptRequestBuilder {
        ...
        /// </summary>
        public async Task<UpdateGlobalScriptResponse> PostAsync(UpdateGlobalScriptPostRequestBody body, Action<UpdateGlobalScriptRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
