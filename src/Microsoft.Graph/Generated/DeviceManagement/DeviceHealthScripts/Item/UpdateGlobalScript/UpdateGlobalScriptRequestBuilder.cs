...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceHealthScripts.Item.UpdateGlobalScript {
    ...
    public class UpdateGlobalScriptRequestBuilder {
        ...
        /// </summary>
        public async Task<UpdateGlobalScriptResponse> PostAsync(UpdateGlobalScriptPostRequestBody body, CancellationToken cancellationToken = default, Action<UpdateGlobalScriptRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<UpdateGlobalScriptResponse>(requestInfo, UpdateGlobalScriptResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
