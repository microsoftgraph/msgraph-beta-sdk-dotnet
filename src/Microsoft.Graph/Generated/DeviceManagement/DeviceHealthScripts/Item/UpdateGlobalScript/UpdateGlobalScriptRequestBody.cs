...
namespace MicrosoftGraphSdk.DeviceManagement.DeviceHealthScripts.Item.UpdateGlobalScript {
    ...
    public class UpdateGlobalScriptRequestBody : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static UpdateGlobalScriptRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UpdateGlobalScriptRequestBody();
        }
        /// <summary>
