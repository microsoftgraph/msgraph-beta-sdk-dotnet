...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceHealthScripts.Item.GetGlobalScriptHighestAvailableVersion {
    ...
    public class GetGlobalScriptHighestAvailableVersionRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Action<GetGlobalScriptHighestAvailableVersionRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<GetGlobalScriptHighestAvailableVersionResponse> PostAsync(CancellationToken cancellationToken = default, Action<GetGlobalScriptHighestAvailableVersionRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
