...
#nullable enable
        public async Task<GetGlobalScriptHighestAvailableVersionResponse?> PostAsync(CancellationToken cancellationToken = default, Action<GetGlobalScriptHighestAvailableVersionRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetGlobalScriptHighestAvailableVersionResponse> PostAsync(CancellationToken cancellationToken = default, Action<GetGlobalScriptHighestAvailableVersionRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
