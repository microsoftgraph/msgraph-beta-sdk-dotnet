...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsSummarizeWorkFromAnywhereDevices {
    ...
    public class UserExperienceAnalyticsSummarizeWorkFromAnywhereDevicesRequestBuilder {
        ...
        /// </summary>
        public async Task<UserExperienceAnalyticsWorkFromAnywhereDevicesSummary> GetAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
