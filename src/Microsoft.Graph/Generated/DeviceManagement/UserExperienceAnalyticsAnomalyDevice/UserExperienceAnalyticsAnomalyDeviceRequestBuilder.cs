...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsAnomalyDevice {
    ...
    public class UserExperienceAnalyticsAnomalyDeviceRequestBuilder : BaseRequestBuilder {
        ...
        public UserExperienceAnalyticsAnomalyDeviceItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("userExperienceAnalyticsAnomalyDevice%2Did", position);
...
#nullable enable
        public async Task<UserExperienceAnalyticsAnomalyDeviceCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<UserExperienceAnalyticsAnomalyDeviceRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserExperienceAnalyticsAnomalyDeviceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UserExperienceAnalyticsAnomalyDeviceRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.UserExperienceAnalyticsAnomalyDevice?> PostAsync(Microsoft.Graph.Beta.Models.UserExperienceAnalyticsAnomalyDevice body, CancellationToken cancellationToken = default, Action<UserExperienceAnalyticsAnomalyDeviceRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.UserExperienceAnalyticsAnomalyDevice> PostAsync(Microsoft.Graph.Beta.Models.UserExperienceAnalyticsAnomalyDevice body, CancellationToken cancellationToken = default, Action<UserExperienceAnalyticsAnomalyDeviceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
