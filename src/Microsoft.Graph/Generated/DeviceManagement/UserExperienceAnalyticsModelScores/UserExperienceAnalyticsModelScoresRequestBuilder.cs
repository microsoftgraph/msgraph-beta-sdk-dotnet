...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsModelScores {
    ...
    public class UserExperienceAnalyticsModelScoresRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Microsoft.Graph.Beta.Models.UserExperienceAnalyticsModelScores body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
