...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsModelScores.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsModelScores/$count{?%24search,%24filter}";
