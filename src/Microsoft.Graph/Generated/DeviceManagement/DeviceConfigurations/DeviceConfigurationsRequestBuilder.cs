...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.DeviceConfiguration?> PostAsync(Microsoft.Graph.Beta.Models.DeviceConfiguration body, CancellationToken cancellationToken = default, Action<DeviceConfigurationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.DeviceConfiguration> PostAsync(Microsoft.Graph.Beta.Models.DeviceConfiguration body, CancellationToken cancellationToken = default, Action<DeviceConfigurationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
