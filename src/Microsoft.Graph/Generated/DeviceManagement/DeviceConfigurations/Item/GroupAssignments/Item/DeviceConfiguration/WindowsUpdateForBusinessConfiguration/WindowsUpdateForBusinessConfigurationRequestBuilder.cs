...
namespace MicrosoftGraph.DeviceManagement.DeviceConfigurations.Item.GroupAssignments.Item.DeviceConfiguration.WindowsUpdateForBusinessConfiguration {
    ...
    public class WindowsUpdateForBusinessConfigurationRequestBuilder {
        ...
        public WindowsUpdateForBusinessConfigurationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration_id}/groupAssignments/{deviceConfigurationGroupAssignment_id}/deviceConfiguration/microsoft.graph.windowsUpdateForBusinessConfiguration";
