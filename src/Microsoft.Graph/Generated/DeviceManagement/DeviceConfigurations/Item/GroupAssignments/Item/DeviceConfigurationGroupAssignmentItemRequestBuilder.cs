...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceConfigurationGroupAssignmentItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceConfigurationGroupAssignmentItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceConfigurationGroupAssignment?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceConfigurationGroupAssignmentItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceConfigurationGroupAssignment> GetAsync(CancellationToken cancellationToken = default, Action<DeviceConfigurationGroupAssignmentItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceConfigurationGroupAssignment?> PatchAsync(DeviceConfigurationGroupAssignment body, CancellationToken cancellationToken = default, Action<DeviceConfigurationGroupAssignmentItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceConfigurationGroupAssignment> PatchAsync(DeviceConfigurationGroupAssignment body, CancellationToken cancellationToken = default, Action<DeviceConfigurationGroupAssignmentItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
