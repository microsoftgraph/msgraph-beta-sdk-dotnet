...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceConfigurations.Item.GroupAssignments.Item.DeviceConfiguration {
    ...
    public class DeviceConfigurationRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.DeviceConfiguration> GetAsync(CancellationToken cancellationToken = default, Action<DeviceConfigurationRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
