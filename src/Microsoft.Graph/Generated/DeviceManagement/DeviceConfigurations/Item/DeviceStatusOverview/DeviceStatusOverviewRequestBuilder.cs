...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceStatusOverviewRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceStatusOverviewRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceConfigurationDeviceOverview?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceStatusOverviewRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceConfigurationDeviceOverview> GetAsync(CancellationToken cancellationToken = default, Action<DeviceStatusOverviewRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceConfigurationDeviceOverview?> PatchAsync(DeviceConfigurationDeviceOverview body, CancellationToken cancellationToken = default, Action<DeviceStatusOverviewRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceConfigurationDeviceOverview> PatchAsync(DeviceConfigurationDeviceOverview body, CancellationToken cancellationToken = default, Action<DeviceStatusOverviewRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
