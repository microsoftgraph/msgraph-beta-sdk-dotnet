...
namespace MicrosoftGraphSdk.DeviceManagement.DeviceConfigurations.Item.DeviceStatuses {
    ...
    public class DeviceStatusesRequestBuilder {
        ...
        public async Task<DeviceConfigurationDeviceStatus> PostAsync(DeviceConfigurationDeviceStatus body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<DeviceConfigurationDeviceStatus>(requestInfo, DeviceConfigurationDeviceStatus.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
