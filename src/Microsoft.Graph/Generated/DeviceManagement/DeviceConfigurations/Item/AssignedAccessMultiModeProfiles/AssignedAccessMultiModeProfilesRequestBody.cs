...
namespace MicrosoftGraphSdk.DeviceManagement.DeviceConfigurations.Item.AssignedAccessMultiModeProfiles {
    public class AssignedAccessMultiModeProfilesRequestBody : IParsable {
        ...
        /// </summary>
        public static AssignedAccessMultiModeProfilesRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new AssignedAccessMultiModeProfilesRequestBody();
        }
        /// <summary>
