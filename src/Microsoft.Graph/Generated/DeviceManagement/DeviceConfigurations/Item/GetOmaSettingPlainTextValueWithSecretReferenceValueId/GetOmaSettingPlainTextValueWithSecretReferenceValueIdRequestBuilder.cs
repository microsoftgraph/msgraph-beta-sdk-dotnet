...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceConfigurations.Item.GetOmaSettingPlainTextValueWithSecretReferenceValueId {
    ...
    public class GetOmaSettingPlainTextValueWithSecretReferenceValueIdRequestBuilder {
        ...
        /// </summary>
        public async Task<GetOmaSettingPlainTextValueWithSecretReferenceValueIdResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetOmaSettingPlainTextValueWithSecretReferenceValueIdRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
