...
#nullable enable
        public async Task<GetOmaSettingPlainTextValueWithSecretReferenceValueIdGetResponse?> GetAsGetOmaSettingPlainTextValueWithSecretReferenceValueIdGetResponseAsync(Action<GetOmaSettingPlainTextValueWithSecretReferenceValueIdRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<GetOmaSettingPlainTextValueWithSecretReferenceValueIdGetResponse> GetAsGetOmaSettingPlainTextValueWithSecretReferenceValueIdGetResponseAsync(Action<GetOmaSettingPlainTextValueWithSecretReferenceValueIdRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
