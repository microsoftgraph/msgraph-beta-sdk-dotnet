...
namespace MicrosoftGraphSdk.DeviceManagement.DeviceConfigurations.Item.Assignments.Item {
    ...
    public class DeviceConfigurationAssignmentItemRequestBuilder {
        ...
        public async Task<DeviceConfigurationAssignment> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<DeviceConfigurationAssignment>(requestInfo, DeviceConfigurationAssignment.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// The list of assignments for the device configuration profile.
        /// <param name="body"></param>
