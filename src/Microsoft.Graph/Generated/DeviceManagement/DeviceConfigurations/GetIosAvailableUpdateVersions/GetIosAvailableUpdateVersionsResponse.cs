...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceConfigurations.GetIosAvailableUpdateVersions {
    ...
    public class GetIosAvailableUpdateVersionsResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<IosAvailableUpdateVersion> Value {
            get { return BackingStore?.Get<List<IosAvailableUpdateVersion>>(nameof(Value)); }
