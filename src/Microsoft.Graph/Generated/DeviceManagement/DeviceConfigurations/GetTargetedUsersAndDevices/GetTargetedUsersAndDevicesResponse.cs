...
namespace Microsoft.Graph.Beta.DeviceManagement.DeviceConfigurations.GetTargetedUsersAndDevices {
    ...
    public class GetTargetedUsersAndDevicesResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static GetTargetedUsersAndDevicesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetTargetedUsersAndDevicesResponse).Value = n.GetCollectionOfObjectValues<DeviceConfigurationTargetedUserAndDevice>(DeviceConfigurationTargetedUserAndDevice.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
