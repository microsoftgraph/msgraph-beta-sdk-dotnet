...
#nullable enable
        public async Task<GetTargetedUsersAndDevicesResponse?> PostAsync(GetTargetedUsersAndDevicesPostRequestBody body, CancellationToken cancellationToken = default, Action<GetTargetedUsersAndDevicesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetTargetedUsersAndDevicesResponse> PostAsync(GetTargetedUsersAndDevicesPostRequestBody body, CancellationToken cancellationToken = default, Action<GetTargetedUsersAndDevicesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
