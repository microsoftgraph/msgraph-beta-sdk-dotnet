...
namespace Microsoft.Graph.Beta.DeviceManagement.GroupPolicyCategories.Item.Parent {
    ...
    public class ParentRequestBuilder {
        ...
        public ParentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/groupPolicyCategories/{groupPolicyCategory%2Did}/parent{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<GroupPolicyCategory> GetAsync(Action<ParentRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
