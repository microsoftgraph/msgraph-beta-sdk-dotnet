...
#nullable enable
        public async Task<GroupPolicyCategory?> GetAsync(Action<ParentRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<GroupPolicyCategory> GetAsync(Action<ParentRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
