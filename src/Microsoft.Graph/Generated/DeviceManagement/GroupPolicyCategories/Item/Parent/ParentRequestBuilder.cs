...
namespace Microsoft.Graph.Beta.DeviceManagement.GroupPolicyCategories.Item.Parent {
    ...
    public class ParentRequestBuilder {
        ...
        /// </summary>
        public async Task<GroupPolicyCategory> GetAsync(CancellationToken cancellationToken = default, Action<ParentRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
