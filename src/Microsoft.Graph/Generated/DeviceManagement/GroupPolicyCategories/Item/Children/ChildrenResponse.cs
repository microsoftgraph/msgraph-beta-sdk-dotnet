...
namespace MicrosoftGraphSdk.DeviceManagement.GroupPolicyCategories.Item.Children {
    public class ChildrenResponse : IParsable {
        ...
        public List<GroupPolicyCategory> Value { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ChildrenResponse).Value = n.GetCollectionOfObjectValues<GroupPolicyCategory>(GroupPolicyCategory.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<GroupPolicyCategory>("value", Value);
