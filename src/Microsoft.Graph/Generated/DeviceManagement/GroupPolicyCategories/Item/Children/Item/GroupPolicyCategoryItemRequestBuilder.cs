...
#nullable enable
        public async Task<GroupPolicyCategory?> GetAsync(CancellationToken cancellationToken = default, Action<GroupPolicyCategoryItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GroupPolicyCategory> GetAsync(CancellationToken cancellationToken = default, Action<GroupPolicyCategoryItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
