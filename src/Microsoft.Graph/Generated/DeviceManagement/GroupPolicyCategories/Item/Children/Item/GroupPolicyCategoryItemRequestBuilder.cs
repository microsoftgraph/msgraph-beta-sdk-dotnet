...
namespace Microsoft.Graph.Beta.DeviceManagement.GroupPolicyCategories.Item.Children.Item {
    ...
    public class GroupPolicyCategoryItemRequestBuilder {
        ...
        public GroupPolicyCategoryItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/groupPolicyCategories/{groupPolicyCategory%2Did}/children/{groupPolicyCategory%2Did1}{?%24select,%24expand}";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GroupPolicyCategoryItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<GroupPolicyCategory> GetAsync(Action<GroupPolicyCategoryItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
