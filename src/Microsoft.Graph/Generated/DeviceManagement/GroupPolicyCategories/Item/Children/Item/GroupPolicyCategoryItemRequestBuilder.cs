...
namespace Microsoft.Graph.Beta.DeviceManagement.GroupPolicyCategories.Item.Children.Item {
    ...
    public class GroupPolicyCategoryItemRequestBuilder {
        ...
        /// </summary>
        public async Task<GroupPolicyCategory> GetAsync(CancellationToken cancellationToken = default, Action<GroupPolicyCategoryItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
