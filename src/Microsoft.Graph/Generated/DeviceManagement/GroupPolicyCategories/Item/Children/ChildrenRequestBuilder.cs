...
namespace Microsoft.Graph.Beta.DeviceManagement.GroupPolicyCategories.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        /// </summary>
        public async Task<GroupPolicyCategoryCollectionResponse> GetAsync(Action<ChildrenRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
