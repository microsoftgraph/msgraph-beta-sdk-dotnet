...
namespace Microsoft.Graph.Beta.DeviceManagement.RoleDefinitions.Item {
    ...
    public class RoleDefinitionItemRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.RoleDefinition> GetAsync(Action<RoleDefinitionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.RoleDefinition> PatchAsync(Microsoft.Graph.Beta.Models.RoleDefinition body, Action<RoleDefinitionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
