...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.DeviceManagement.RoleDefinitions.Item.RoleAssignments {
    public class RoleAssignmentsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as RoleAssignmentsResponse).Value = n.GetCollectionOfObjectValues<RoleAssignment>(RoleAssignment.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
