...
namespace Microsoft.Graph.Beta.DeviceManagement.RoleDefinitions.Item.RoleAssignments.Item.RoleDefinition {
    ...
    public class RoleDefinitionRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.RoleDefinition> GetAsync(CancellationToken cancellationToken = default, Action<RoleDefinitionRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
