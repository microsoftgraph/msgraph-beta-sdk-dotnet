...
using MicrosoftGraph.DeviceManagement.RoleDefinitions.Item;
...
namespace MicrosoftGraph.DeviceManagement.RoleDefinitions {
    ...
    public class RoleDefinitionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.deviceManagement.roleDefinitions.item collection</summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftGraph.Models.Microsoft.Graph.RoleDefinition body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftGraph.Models.Microsoft.Graph.RoleDefinition> PostAsync(MicrosoftGraph.Models.Microsoft.Graph.RoleDefinition body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<MicrosoftGraph.Models.Microsoft.Graph.RoleDefinition>(requestInfo, responseHandler, default, cancellationToken);
        }
