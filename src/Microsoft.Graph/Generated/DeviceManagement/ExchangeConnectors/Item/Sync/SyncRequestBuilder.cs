...
#nullable enable
        public async Task PostAsync(SyncPostRequestBody body, CancellationToken cancellationToken = default, Action<SyncRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(SyncPostRequestBody body, CancellationToken cancellationToken = default, Action<SyncRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
