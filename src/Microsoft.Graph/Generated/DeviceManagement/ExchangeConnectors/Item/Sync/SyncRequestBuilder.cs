...
namespace Microsoft.Graph.Beta.DeviceManagement.ExchangeConnectors.Item.Sync {
    ...
    public class SyncRequestBuilder : BaseRequestBuilder {
        ...
        public SyncRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/exchangeConnectors/{deviceManagementExchangeConnector%2Did}/sync", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SyncRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SyncRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/exchangeConnectors/{deviceManagementExchangeConnector%2Did}/sync", rawUrl) {
        }
        /// <summary>
        /// Invoke action sync
        /// </summary>
