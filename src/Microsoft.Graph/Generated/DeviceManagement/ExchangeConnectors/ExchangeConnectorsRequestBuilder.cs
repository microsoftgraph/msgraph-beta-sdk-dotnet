...
namespace Microsoft.Graph.Beta.DeviceManagement.ExchangeConnectors {
    ...
    public class ExchangeConnectorsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<DeviceManagementExchangeConnectorCollectionResponse> GetAsync(Action<ExchangeConnectorsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<DeviceManagementExchangeConnector> PostAsync(DeviceManagementExchangeConnector body, Action<ExchangeConnectorsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
