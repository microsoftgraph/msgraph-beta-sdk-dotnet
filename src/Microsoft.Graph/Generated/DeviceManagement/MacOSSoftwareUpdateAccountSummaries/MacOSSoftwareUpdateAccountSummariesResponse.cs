...
namespace MicrosoftGraphSdk.DeviceManagement.MacOSSoftwareUpdateAccountSummaries {
    public class MacOSSoftwareUpdateAccountSummariesResponse : IParsable {
        ...
        /// </summary>
        public static MacOSSoftwareUpdateAccountSummariesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new MacOSSoftwareUpdateAccountSummariesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as MacOSSoftwareUpdateAccountSummariesResponse).Value = n.GetCollectionOfObjectValues<MacOSSoftwareUpdateAccountSummary>(MacOSSoftwareUpdateAccountSummary.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
