...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.DeviceManagement.MacOSSoftwareUpdateAccountSummaries.Item.CategorySummaries {
    public class CategorySummariesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as CategorySummariesResponse).Value = n.GetCollectionOfObjectValues<MacOSSoftwareUpdateCategorySummary>().ToList(); } },
            };
        }
        /// <summary>
