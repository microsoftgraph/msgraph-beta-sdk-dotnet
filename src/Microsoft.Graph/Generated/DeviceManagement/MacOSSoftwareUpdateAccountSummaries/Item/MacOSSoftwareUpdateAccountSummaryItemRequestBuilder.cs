...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<MacOSSoftwareUpdateAccountSummaryItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<MacOSSoftwareUpdateAccountSummaryItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MacOSSoftwareUpdateAccountSummary?> GetAsync(CancellationToken cancellationToken = default, Action<MacOSSoftwareUpdateAccountSummaryItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MacOSSoftwareUpdateAccountSummary> GetAsync(CancellationToken cancellationToken = default, Action<MacOSSoftwareUpdateAccountSummaryItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MacOSSoftwareUpdateAccountSummary?> PatchAsync(MacOSSoftwareUpdateAccountSummary body, CancellationToken cancellationToken = default, Action<MacOSSoftwareUpdateAccountSummaryItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MacOSSoftwareUpdateAccountSummary> PatchAsync(MacOSSoftwareUpdateAccountSummary body, CancellationToken cancellationToken = default, Action<MacOSSoftwareUpdateAccountSummaryItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
