...
namespace Microsoft.Graph.Beta.DeviceManagement.MacOSSoftwareUpdateAccountSummaries.Item {
    ...
    public class MacOSSoftwareUpdateAccountSummaryItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<MacOSSoftwareUpdateAccountSummaryItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MacOSSoftwareUpdateAccountSummary> GetAsync(CancellationToken cancellationToken = default, Action<MacOSSoftwareUpdateAccountSummaryItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MacOSSoftwareUpdateAccountSummary body, CancellationToken cancellationToken = default, Action<MacOSSoftwareUpdateAccountSummaryItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
