...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.BulkReprovisionCloudPc
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.BulkReprovisionCloudPc.BulkReprovisionCloudPcRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.BulkReprovisionCloudPc.BulkReprovisionCloudPcPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.BulkReprovisionCloudPc.BulkReprovisionCloudPcPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.BulkReprovisionCloudPc.BulkReprovisionCloudPcRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("The bulkReprovisionCloudPc action is deprecated and will stop supporting on September 24, 2023. Please use bulk action entity api. as of 2023-05/bulkReprovisionCloudPc")]
        public Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.BulkReprovisionCloudPc.BulkReprovisionCloudPcRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.BulkReprovisionCloudPc.BulkReprovisionCloudPcRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
