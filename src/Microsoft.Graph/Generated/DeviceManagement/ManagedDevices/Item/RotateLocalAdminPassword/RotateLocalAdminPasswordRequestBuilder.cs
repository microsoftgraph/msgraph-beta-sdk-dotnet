...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.RotateLocalAdminPassword {
    ...
    /// </summary>
    public class RotateLocalAdminPasswordRequestBuilder {
        ...
        public RotateLocalAdminPasswordRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/rotateLocalAdminPassword";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RotateLocalAdminPasswordRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
