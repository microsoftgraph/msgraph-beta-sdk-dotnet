using Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.LogCollectionRequests.Item.MicrosoftGraphCreateDownloadUrl;
...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.LogCollectionRequests.Item {
    /// <summary>
    ...
    public class DeviceLogCollectionResponseItemRequestBuilder {
        ...
        public DeviceLogCollectionResponseItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/logCollectionRequests/{deviceLogCollectionResponse%2Did}{?%24select,%24expand}";
