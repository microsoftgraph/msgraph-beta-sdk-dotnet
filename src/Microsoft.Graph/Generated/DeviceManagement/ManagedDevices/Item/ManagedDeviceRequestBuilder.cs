...
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.ActivateDeviceEsim;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.AssignmentFilterEvaluationStatusDetails;
...
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.CreateDeviceLogCollectionRequest;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.DeleteUserFromSharedAppleDevice;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.Deprovision;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.DetectedApps;
...
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.Disable;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.DisableLostMode;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.EnableLostMode;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.GetCloudPcRemoteActionResults;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.GetFileVaultKey;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.GetNonCompliantSettings;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.GetOemWarranty;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.LocateDevice;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.LogCollectionRequests;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.LogoutSharedAppleDeviceActiveUser;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.ManagedDeviceMobileAppConfigurationStates;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.OverrideComplianceState;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.PlayLostModeSound;
...
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.Reenable;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.RemoteLock;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.ReprovisionCloudPc;
...
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.ResizeCloudPc;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.RestoreCloudPc;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.Retire;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.RevokeAppleVppLicenses;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.RotateBitLockerKeys;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.RotateFileVaultKey;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.SecurityBaselineStates;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.SendCustomNotificationToCompanyPortal;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.SetDeviceName;
...
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.TriggerConfigurationManagerAction;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.UpdateWindowsDeviceAccount;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.Users;
...
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.WindowsProtectionState;
