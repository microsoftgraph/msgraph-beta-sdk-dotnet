...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.InitiateOnDemandProactiveRemediation {
    ...
    /// </summary>
    public class InitiateOnDemandProactiveRemediationRequestBuilder {
        ...
        public InitiateOnDemandProactiveRemediationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/initiateOnDemandProactiveRemediation";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InitiateOnDemandProactiveRemediationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
