...
using System;
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.InitiateOnDemandProactiveRemediation {
    /// <summary>
    ...
    public class InitiateOnDemandProactiveRemediationRequestBuilder : BaseRequestBuilder {
        ...
        public InitiateOnDemandProactiveRemediationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/initiateOnDemandProactiveRemediation", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new InitiateOnDemandProactiveRemediationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InitiateOnDemandProactiveRemediationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/initiateOnDemandProactiveRemediation", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(InitiateOnDemandProactiveRemediationPostRequestBody body, CancellationToken cancellationToken = default, Action<InitiateOnDemandProactiveRemediationRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(InitiateOnDemandProactiveRemediationPostRequestBody body, CancellationToken cancellationToken = default, Action<InitiateOnDemandProactiveRemediationRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
