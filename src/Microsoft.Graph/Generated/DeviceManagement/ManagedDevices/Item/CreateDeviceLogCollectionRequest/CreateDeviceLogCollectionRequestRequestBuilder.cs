...
namespace MicrosoftGraphSdk.DeviceManagement.ManagedDevices.Item.CreateDeviceLogCollectionRequest {
    /// <summary>Builds and executes requests for operations under \deviceManagement\managedDevices\{managedDevice-id}\microsoft.graph.createDeviceLogCollectionRequest</summary>
    public class CreateDeviceLogCollectionRequestRequestBuilder {
        ...
        public CreateDeviceLogCollectionRequestRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice_id}/microsoft.graph.createDeviceLogCollectionRequest";
