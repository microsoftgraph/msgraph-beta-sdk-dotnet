using Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.SecurityBaselineStates.Item.SettingStates;
...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.SecurityBaselineStates.Item {
    /// <summary>
    ...
    public class SecurityBaselineStateItemRequestBuilder : BaseRequestBuilder {
        ...
        public SecurityBaselineStateItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/securityBaselineStates/{securityBaselineState%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SecurityBaselineStateItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecurityBaselineStateItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/securityBaselineStates/{securityBaselineState%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
