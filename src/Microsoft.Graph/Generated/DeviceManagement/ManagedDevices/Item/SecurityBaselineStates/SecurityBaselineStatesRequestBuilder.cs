...
using MicrosoftGraphSdk.DeviceManagement.ManagedDevices.Item.SecurityBaselineStates.Item;
...
namespace MicrosoftGraphSdk.DeviceManagement.ManagedDevices.Item.SecurityBaselineStates {
    /// <summary>Builds and executes requests for operations under \deviceManagement\managedDevices\{managedDevice-id}\securityBaselineStates</summary>
    public class SecurityBaselineStatesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.deviceManagement.managedDevices.item.securityBaselineStates.item collection</summary>
        ...
        public SecurityBaselineStatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice_id}/securityBaselineStates{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
