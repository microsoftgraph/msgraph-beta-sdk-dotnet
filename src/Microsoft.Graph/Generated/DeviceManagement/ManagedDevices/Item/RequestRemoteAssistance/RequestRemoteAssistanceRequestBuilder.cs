...
namespace MicrosoftGraphSdk.DeviceManagement.ManagedDevices.Item.RequestRemoteAssistance {
    ...
    public class RequestRemoteAssistanceRequestBuilder {
        ...
        public RequestRemoteAssistanceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice_id}/microsoft.graph.requestRemoteAssistance";
