...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.InitiateMobileDeviceManagementKeyRecovery {
    ...
    public class InitiateMobileDeviceManagementKeyRecoveryRequestBuilder {
        ...
        public InitiateMobileDeviceManagementKeyRecoveryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/microsoft.graph.initiateMobileDeviceManagementKeyRecovery";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InitiateMobileDeviceManagementKeyRecoveryRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreatePostRequestInformation(Action<InitiateMobileDeviceManagementKeyRecoveryRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
