...
namespace MicrosoftGraphSdk.DeviceManagement.ManagedDevices.Item {
    ...
    public class ManagedDeviceItemRequestBuilder {
        ...
        /// <summary>
        /// Builds and executes requests for operations under \deviceManagement\managedDevices\{managedDevice-id}\microsoft.graph.getCloudPcRemoteActionResults()
        /// </summary>
        ...
        /// <summary>
        /// Builds and executes requests for operations under \deviceManagement\managedDevices\{managedDevice-id}\microsoft.graph.getFileVaultKey()
        /// </summary>
        ...
        /// <summary>
        /// Builds and executes requests for operations under \deviceManagement\managedDevices\{managedDevice-id}\microsoft.graph.getNonCompliantSettings()
        /// </summary>
        ...
        /// <summary>
        /// Builds and executes requests for operations under \deviceManagement\managedDevices\{managedDevice-id}\microsoft.graph.getOemWarranty()
        /// </summary>
