...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.GetNonCompliantSettings {
    ...
    public class GetNonCompliantSettingsRequestBuilder {
        ...
        public GetNonCompliantSettingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/microsoft.graph.getNonCompliantSettings()";
        ...
        /// </summary>
        public async Task<GetNonCompliantSettingsResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetNonCompliantSettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
