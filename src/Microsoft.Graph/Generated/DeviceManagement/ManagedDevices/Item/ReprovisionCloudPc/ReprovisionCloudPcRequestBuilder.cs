...
using System;
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.ReprovisionCloudPc {
    /// <summary>
    ...
    public class ReprovisionCloudPcRequestBuilder : BaseRequestBuilder {
        ...
        public ReprovisionCloudPcRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/reprovisionCloudPc", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ReprovisionCloudPcRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ReprovisionCloudPcRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/reprovisionCloudPc", rawUrl) {
        }
        /// <summary>
