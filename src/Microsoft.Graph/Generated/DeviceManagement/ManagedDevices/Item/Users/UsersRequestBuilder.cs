using Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.Users.Count;
using Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.Users.Item;
...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.Users {
    ...
    public class UsersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.deviceManagement.managedDevices.item.users.item collection</summary>
        ...
        public UsersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/users{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
