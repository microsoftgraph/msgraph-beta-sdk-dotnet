...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.DeviceHealthScriptStates {
    ...
    public class DeviceHealthScriptStatesRequestBuilder {
        ...
        public DeviceHealthScriptStatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/deviceHealthScriptStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
