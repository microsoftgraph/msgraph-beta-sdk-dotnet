...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.Wipe {
    ...
    public class WipePostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public bool? UseProtectedWipe {
            get { return BackingStore?.Get<bool?>(nameof(UseProtectedWipe)); }
            set { BackingStore?.Set(nameof(UseProtectedWipe), value); }
        }
        /// <summary>
