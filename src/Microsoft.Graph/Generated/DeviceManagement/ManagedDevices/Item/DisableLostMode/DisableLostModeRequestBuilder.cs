...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.DisableLostMode {
    ...
    public class DisableLostModeRequestBuilder {
        ...
        public DisableLostModeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/microsoft.graph.disableLostMode";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Action<DisableLostModeRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(Action<DisableLostModeRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
