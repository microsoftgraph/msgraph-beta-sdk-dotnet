...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.DisableLostMode {
    ...
    public class DisableLostModeRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<DisableLostModeRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
