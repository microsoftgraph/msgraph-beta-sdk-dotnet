...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.CreateRemoteHelpSession {
    ...
    public class CreateRemoteHelpSessionRequestBuilder : BaseRequestBuilder {
        ...
        public CreateRemoteHelpSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/createRemoteHelpSession", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreateRemoteHelpSessionRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateRemoteHelpSessionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/createRemoteHelpSession", rawUrl) {
        }
        /// <summary>
