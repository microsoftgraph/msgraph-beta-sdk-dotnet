...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.Item.RetrieveRemoteHelpSessionWithSessionKey {
    /// <summary>Provides operations to call the retrieveRemoteHelpSession method.</summary>
    public class RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder {
        ...
        public RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string sessionKey = default) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/microsoft.graph.retrieveRemoteHelpSession(sessionKey='{sessionKey}')";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
            urlTplParams.Add("sessionKey", sessionKey);
        ...
        /// </summary>
        public async Task<RetrieveRemoteHelpSessionResponse> GetAsync(Action<RetrieveRemoteHelpSessionWithSessionKeyRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<RetrieveRemoteHelpSessionResponse>(requestInfo, RetrieveRemoteHelpSessionResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
