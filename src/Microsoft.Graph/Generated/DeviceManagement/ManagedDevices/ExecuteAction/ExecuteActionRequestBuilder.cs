...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.ExecuteAction {
    ...
    public class ExecuteActionRequestBuilder : BaseRequestBuilder {
        ...
        public ExecuteActionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/executeAction", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ExecuteActionRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExecuteActionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/executeAction", rawUrl) {
        }
        /// <summary>
