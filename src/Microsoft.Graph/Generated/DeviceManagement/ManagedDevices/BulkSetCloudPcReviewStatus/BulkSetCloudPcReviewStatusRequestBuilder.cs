...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.BulkSetCloudPcReviewStatus {
    ...
    public class BulkSetCloudPcReviewStatusRequestBuilder : BaseRequestBuilder {
        ...
        public BulkSetCloudPcReviewStatusRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/bulkSetCloudPcReviewStatus", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new BulkSetCloudPcReviewStatusRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BulkSetCloudPcReviewStatusRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/bulkSetCloudPcReviewStatus", rawUrl) {
        }
        /// <summary>
