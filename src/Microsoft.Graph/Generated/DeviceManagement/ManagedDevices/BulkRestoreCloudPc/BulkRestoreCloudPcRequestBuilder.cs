...
namespace MicrosoftGraphSdk.DeviceManagement.ManagedDevices.BulkRestoreCloudPc {
    ...
    public class BulkRestoreCloudPcRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(BulkRestoreCloudPcRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// </summary>
        public async Task<CloudPcBulkRemoteActionResult> PostAsync(BulkRestoreCloudPcRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
