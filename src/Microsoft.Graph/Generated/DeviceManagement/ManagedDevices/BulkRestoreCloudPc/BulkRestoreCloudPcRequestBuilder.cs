...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagedDevices.BulkRestoreCloudPc {
    ...
    public class BulkRestoreCloudPcRequestBuilder {
        ...
        /// </summary>
        public async Task<CloudPcBulkRemoteActionResult> PostAsync(BulkRestoreCloudPcPostRequestBody body, CancellationToken cancellationToken = default, Action<BulkRestoreCloudPcRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
