...
namespace MicrosoftGraphSdk.DeviceManagement.TemplateSettings.Item.SettingDefinitions.Item {
    /// <summary>Builds and executes requests for operations under \deviceManagement\templateSettings\{deviceManagementConfigurationSettingTemplate-id}\settingDefinitions\{deviceManagementConfigurationSettingDefinition-id}</summary>
