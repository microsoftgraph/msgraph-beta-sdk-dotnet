...
namespace Microsoft.Graph.Beta.DeviceManagement.TemplateSettings.Item.SettingDefinitions {
    ...
    public class SettingDefinitionsRequestBuilder : BaseRequestBuilder {
        ...
        public SettingDefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/templateSettings/{deviceManagementConfigurationSettingTemplate%2Did}/settingDefinitions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SettingDefinitionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SettingDefinitionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/templateSettings/{deviceManagementConfigurationSettingTemplate%2Did}/settingDefinitions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DeviceManagementConfigurationSettingDefinitionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SettingDefinitionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementConfigurationSettingDefinitionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SettingDefinitionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementConfigurationSettingDefinition?> PostAsync(DeviceManagementConfigurationSettingDefinition body, CancellationToken cancellationToken = default, Action<SettingDefinitionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementConfigurationSettingDefinition> PostAsync(DeviceManagementConfigurationSettingDefinition body, CancellationToken cancellationToken = default, Action<SettingDefinitionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(DeviceManagementConfigurationSettingDefinition body, Action<SettingDefinitionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(DeviceManagementConfigurationSettingDefinition body, Action<SettingDefinitionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
