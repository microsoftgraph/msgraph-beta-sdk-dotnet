...
namespace Microsoft.Graph.Beta.DeviceManagement.GetRoleScopeTagsByIdsWithIds {
    ...
    public class GetRoleScopeTagsByIdsWithIdsRequestBuilder {
        ...
        public GetRoleScopeTagsByIdsWithIdsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string ids = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/deviceManagement/getRoleScopeTagsByIds(ids={ids}){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
