...
namespace Microsoft.Graph.Beta.DeviceManagement.GetRoleScopeTagsByIdsWithIds {
    ...
    public class GetRoleScopeTagsByIdsWithIdsRequestBuilder {
        ...
        /// </summary>
        public async Task<GetRoleScopeTagsByIdsWithIdsResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetRoleScopeTagsByIdsWithIdsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<GetRoleScopeTagsByIdsWithIdsResponse>(requestInfo, GetRoleScopeTagsByIdsWithIdsResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
