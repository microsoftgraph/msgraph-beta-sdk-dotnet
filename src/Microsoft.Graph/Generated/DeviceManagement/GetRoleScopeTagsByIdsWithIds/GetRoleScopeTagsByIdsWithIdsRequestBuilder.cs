...
namespace MicrosoftGraph.DeviceManagement.GetRoleScopeTagsByIdsWithIds {
    ...
    public class GetRoleScopeTagsByIdsWithIdsRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<MicrosoftGraph.DeviceManagement.GetRoleScopeTagsByIdsWithIds.GetRoleScopeTagsByIdsWithIds>> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendCollectionAsync<MicrosoftGraph.DeviceManagement.GetRoleScopeTagsByIdsWithIds.GetRoleScopeTagsByIdsWithIds>(requestInfo, responseHandler, default, cancellationToken);
        }
