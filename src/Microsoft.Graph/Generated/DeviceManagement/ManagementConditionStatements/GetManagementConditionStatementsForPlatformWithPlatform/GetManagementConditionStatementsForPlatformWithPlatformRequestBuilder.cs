...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagementConditionStatements.GetManagementConditionStatementsForPlatformWithPlatform {
    ...
    public class GetManagementConditionStatementsForPlatformWithPlatformRequestBuilder {
        ...
        /// </summary>
        public async Task<GetManagementConditionStatementsForPlatformWithPlatformResponse> GetAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(headers, options);
            return await RequestAdapter.SendAsync<GetManagementConditionStatementsForPlatformWithPlatformResponse>(requestInfo, GetManagementConditionStatementsForPlatformWithPlatformResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
    }
}
