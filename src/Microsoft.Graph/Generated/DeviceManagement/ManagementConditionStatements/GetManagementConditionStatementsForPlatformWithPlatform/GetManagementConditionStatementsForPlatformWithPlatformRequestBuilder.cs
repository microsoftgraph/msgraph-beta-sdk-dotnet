...
namespace MicrosoftGraph.DeviceManagement.ManagementConditionStatements.GetManagementConditionStatementsForPlatformWithPlatform {
    /// <summary>Builds and executes requests for operations under \deviceManagement\managementConditionStatements\microsoft.graph.getManagementConditionStatementsForPlatform(platform={platform})</summary>
    public class GetManagementConditionStatementsForPlatformWithPlatformRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<MicrosoftGraph.DeviceManagement.ManagementConditionStatements.GetManagementConditionStatementsForPlatformWithPlatform.GetManagementConditionStatementsForPlatformWithPlatform>> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await RequestAdapter.SendCollectionAsync<MicrosoftGraph.DeviceManagement.ManagementConditionStatements.GetManagementConditionStatementsForPlatformWithPlatform.GetManagementConditionStatementsForPlatformWithPlatform>(requestInfo, responseHandler, default, cancellationToken);
        }
    }
}
