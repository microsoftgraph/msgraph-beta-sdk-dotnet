...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.DeviceManagement.ManagementConditionStatements {
    public class ManagementConditionStatementsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ManagementConditionStatementsResponse).Value = n.GetCollectionOfObjectValues<ManagementConditionStatement>().ToList(); } },
            };
        }
        /// <summary>
