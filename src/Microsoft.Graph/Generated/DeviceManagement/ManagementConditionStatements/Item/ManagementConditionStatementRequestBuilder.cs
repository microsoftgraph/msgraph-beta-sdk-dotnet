...
using MicrosoftGraph.DeviceManagement.ManagementConditionStatements.Item.GetManagementConditionStatementExpressionString;
using MicrosoftGraph.DeviceManagement.ManagementConditionStatements.Item.ManagementConditions;
...
namespace MicrosoftGraph.DeviceManagement.ManagementConditionStatements.Item {
    ...
    public class ManagementConditionStatementRequestBuilder {
        ...
        /// <summary>
        /// Instantiates a new ManagementConditionStatementRequestBuilder and sets the default values.
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ManagementConditionStatementRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ManagementConditionStatementRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
