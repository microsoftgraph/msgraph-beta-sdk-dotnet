...
namespace MicrosoftGraphSdk.DeviceManagement.ManagementConditionStatements.Item {
    ...
    public class ManagementConditionStatementItemRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ManagementConditionStatement body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
