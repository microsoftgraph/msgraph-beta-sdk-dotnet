...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.DeviceManagement.ManagementConditionStatements.Item.ManagementConditions {
    public class ManagementConditionsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ManagementConditionsResponse).Value = n.GetCollectionOfObjectValues<ManagementCondition>().ToList(); } },
            };
        }
        /// <summary>
