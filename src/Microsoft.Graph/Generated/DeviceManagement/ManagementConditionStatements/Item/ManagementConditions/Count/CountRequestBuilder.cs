...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagementConditionStatements.Item.ManagementConditions.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/managementConditionStatements/{managementConditionStatement%2Did}/managementConditions/$count";
