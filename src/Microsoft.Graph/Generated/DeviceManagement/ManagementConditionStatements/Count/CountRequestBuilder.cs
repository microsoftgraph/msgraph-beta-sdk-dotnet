...
namespace Microsoft.Graph.Beta.DeviceManagement.ManagementConditionStatements.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/managementConditionStatements/$count";
