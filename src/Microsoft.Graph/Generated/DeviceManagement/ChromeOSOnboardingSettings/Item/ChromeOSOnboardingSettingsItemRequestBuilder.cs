...
namespace Microsoft.Graph.Beta.DeviceManagement.ChromeOSOnboardingSettings.Item {
    ...
    public class ChromeOSOnboardingSettingsItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.ChromeOSOnboardingSettings> PatchAsync(Microsoft.Graph.Beta.Models.ChromeOSOnboardingSettings body, Action<ChromeOSOnboardingSettingsItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
