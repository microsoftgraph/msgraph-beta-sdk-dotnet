...
namespace Microsoft.Graph.Beta.DeviceManagement.ChromeOSOnboardingSettings {
    ...
    public class ChromeOSOnboardingSettingsRequestBuilder {
        ...
        /// </summary>
        public async Task<ChromeOSOnboardingSettingsCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ChromeOSOnboardingSettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.ChromeOSOnboardingSettings> PostAsync(Microsoft.Graph.Beta.Models.ChromeOSOnboardingSettings body, CancellationToken cancellationToken = default, Action<ChromeOSOnboardingSettingsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
