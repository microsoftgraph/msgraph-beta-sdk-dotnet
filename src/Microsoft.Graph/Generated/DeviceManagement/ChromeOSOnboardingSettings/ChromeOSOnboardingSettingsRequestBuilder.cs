...
namespace Microsoft.Graph.Beta.DeviceManagement.ChromeOSOnboardingSettings {
    ...
    public class ChromeOSOnboardingSettingsRequestBuilder : BaseRequestBuilder {
        ...
        public ChromeOSOnboardingSettingsItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("chromeOSOnboardingSettings%2Did", position);
...
#nullable enable
        public async Task<ChromeOSOnboardingSettingsCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ChromeOSOnboardingSettingsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ChromeOSOnboardingSettingsCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ChromeOSOnboardingSettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ChromeOSOnboardingSettings?> PostAsync(Microsoft.Graph.Beta.Models.ChromeOSOnboardingSettings body, CancellationToken cancellationToken = default, Action<ChromeOSOnboardingSettingsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ChromeOSOnboardingSettings> PostAsync(Microsoft.Graph.Beta.Models.ChromeOSOnboardingSettings body, CancellationToken cancellationToken = default, Action<ChromeOSOnboardingSettingsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
