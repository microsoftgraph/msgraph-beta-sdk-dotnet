    ...
    public class ChromeOSOnboardingSettingsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ChromeOSOnboardingSettingsResponse).Value = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.ChromeOSOnboardingSettings>().ToList(); } },
            };
        }
        /// <summary>
