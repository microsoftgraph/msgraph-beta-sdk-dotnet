...
namespace Microsoft.Graph.Beta.DeviceManagement.ChromeOSOnboardingSettings.Connect {
    ...
    public class ConnectRequestBuilder {
        ...
        /// </summary>
        public async Task<ChromeOSOnboardingStatus?> PostAsync(ChromeOSOnboardingStatusPostRequestBody body, Action<ConnectRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
