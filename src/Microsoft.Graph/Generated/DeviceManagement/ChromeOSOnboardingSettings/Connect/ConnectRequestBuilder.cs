...
namespace Microsoft.Graph.Beta.DeviceManagement.ChromeOSOnboardingSettings.Connect {
    ...
    public class ConnectRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ChromeOSOnboardingStatusPostRequestBody body, Action<ConnectRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<ChromeOSOnboardingStatus?> PostAsync(ChromeOSOnboardingStatusPostRequestBody body, CancellationToken cancellationToken = default, Action<ConnectRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendPrimitiveAsync<ChromeOSOnboardingStatus?>(requestInfo, responseHandler, errorMapping, cancellationToken);
        }
