...
namespace Microsoft.Graph.Beta.DeviceManagement.ChromeOSOnboardingSettings.Connect {
    ...
    public class ChromeOSOnboardingStatusPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        /// </summary>
        public static ChromeOSOnboardingStatusPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
