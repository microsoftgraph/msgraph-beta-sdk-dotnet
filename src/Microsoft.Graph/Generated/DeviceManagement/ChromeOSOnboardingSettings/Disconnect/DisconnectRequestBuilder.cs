...
namespace Microsoft.Graph.Beta.DeviceManagement.ChromeOSOnboardingSettings.Disconnect {
    ...
    public class DisconnectRequestBuilder {
        ...
        /// </summary>
        public async Task<ChromeOSOnboardingStatus?> PostAsync(CancellationToken cancellationToken = default, Action<DisconnectRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
