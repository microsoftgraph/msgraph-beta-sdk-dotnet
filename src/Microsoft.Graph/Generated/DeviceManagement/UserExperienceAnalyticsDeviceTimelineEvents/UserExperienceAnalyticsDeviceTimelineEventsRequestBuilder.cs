...
namespace Microsoft.Graph.Beta.DeviceManagement.UserExperienceAnalyticsDeviceTimelineEvents {
    ...
    public class UserExperienceAnalyticsDeviceTimelineEventsRequestBuilder {
        ...
        public UserExperienceAnalyticsDeviceTimelineEventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        public async Task<UserExperienceAnalyticsDeviceTimelineEventsCollectionResponse> GetAsync(Action<UserExperienceAnalyticsDeviceTimelineEventsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<UserExperienceAnalyticsDeviceTimelineEventsCollectionResponse>(requestInfo, UserExperienceAnalyticsDeviceTimelineEventsCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        ...
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public async Task<Microsoft.Graph.Beta.Models.UserExperienceAnalyticsDeviceTimelineEvents> PostAsync(Microsoft.Graph.Beta.Models.UserExperienceAnalyticsDeviceTimelineEvents body, Action<UserExperienceAnalyticsDeviceTimelineEventsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
        ...
        /// </summary>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation ToGetRequestInformation(Action<UserExperienceAnalyticsDeviceTimelineEventsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="body">The request body</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Models.UserExperienceAnalyticsDeviceTimelineEvents body, Action<UserExperienceAnalyticsDeviceTimelineEventsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation {
