...
using MicrosoftGraph.DeviceManagement.ExchangeOnPremisesPolicies.Item.ConditionalAccessSettings;
...
namespace MicrosoftGraph.DeviceManagement.ExchangeOnPremisesPolicies.Item {
    /// <summary>Builds and executes requests for operations under \deviceManagement\exchangeOnPremisesPolicies\{deviceManagementExchangeOnPremisesPolicy-id}</summary>
    public class DeviceManagementExchangeOnPremisesPolicyRequestBuilder {
        ...
        /// </summary>
        public DeviceManagementExchangeOnPremisesPolicyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/deviceManagement/exchangeOnPremisesPolicies/{deviceManagementExchangeOnPremisesPolicy_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public DeviceManagementExchangeOnPremisesPolicyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(DeviceManagementExchangeOnPremisesPolicy body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
