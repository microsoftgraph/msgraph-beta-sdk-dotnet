...
namespace MicrosoftGraphSdk.DeviceManagement.ComanagementEligibleDevices {
    public class ComanagementEligibleDevicesResponse : IParsable {
        ...
        /// </summary>
        public static ComanagementEligibleDevicesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ComanagementEligibleDevicesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ComanagementEligibleDevicesResponse).Value = n.GetCollectionOfObjectValues<ComanagementEligibleDevice>(ComanagementEligibleDevice.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
