...
#nullable enable
        public async Task<ComanagementEligibleDeviceCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ComanagementEligibleDevicesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ComanagementEligibleDeviceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ComanagementEligibleDevicesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ComanagementEligibleDevice?> PostAsync(ComanagementEligibleDevice body, CancellationToken cancellationToken = default, Action<ComanagementEligibleDevicesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ComanagementEligibleDevice> PostAsync(ComanagementEligibleDevice body, CancellationToken cancellationToken = default, Action<ComanagementEligibleDevicesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
