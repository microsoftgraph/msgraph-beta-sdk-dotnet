...
namespace Microsoft.Graph.Beta.EmployeeExperience.LearningProviders {
    ...
    public class LearningProvidersRequestBuilder {
        ...
        /// </summary>
        public async Task<LearningProviderCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<LearningProvidersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<LearningProvider> PostAsync(LearningProvider body, CancellationToken cancellationToken = default, Action<LearningProvidersRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
