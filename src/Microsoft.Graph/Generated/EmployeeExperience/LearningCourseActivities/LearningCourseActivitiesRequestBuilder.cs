...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<LearningCourseActivity?> PostAsync(LearningCourseActivity body, CancellationToken cancellationToken = default, Action<LearningCourseActivitiesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<LearningCourseActivity> PostAsync(LearningCourseActivity body, CancellationToken cancellationToken = default, Action<LearningCourseActivitiesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
