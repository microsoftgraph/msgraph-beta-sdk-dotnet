...
namespace Microsoft.Graph.Beta.EmployeeExperience.Communities.Item.Owners.Item.MailboxSettings
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.EmployeeExperience.Communities.Item.Owners.Item.MailboxSettings.MailboxSettingsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Microsoft.Graph.Beta.Models.MailboxSettings?> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Beta.EmployeeExperience.Communities.Item.Owners.Item.MailboxSettings.MailboxSettingsRequestBuilder.MailboxSettingsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Microsoft.Graph.Beta.Models.MailboxSettings> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Beta.EmployeeExperience.Communities.Item.Owners.Item.MailboxSettings.MailboxSettingsRequestBuilder.MailboxSettingsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.EmployeeExperience.Communities.Item.Owners.Item.MailboxSettings.MailboxSettingsRequestBuilder.MailboxSettingsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.EmployeeExperience.Communities.Item.Owners.Item.MailboxSettings.MailboxSettingsRequestBuilder.MailboxSettingsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.EmployeeExperience.Communities.Item.Owners.Item.MailboxSettings.MailboxSettingsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Beta.EmployeeExperience.Communities.Item.Owners.Item.MailboxSettings.MailboxSettingsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Beta.EmployeeExperience.Communities.Item.Owners.Item.MailboxSettings.MailboxSettingsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Settings for the primary mailbox of the signed-in user. You can get or update settings for sending automatic replies to incoming messages, locale, and time zone. For more information, see User preferences for languages and regional formats. Returned only on $select.
        /// </summary>
...
#nullable restore
        ...
        public partial class MailboxSettingsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Microsoft.Graph.Beta.EmployeeExperience.Communities.Item.Owners.Item.MailboxSettings.MailboxSettingsRequestBuilder.MailboxSettingsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
