...
namespace MicrosoftGraph.InformationProtection.SensitivityLabels.Evaluate {
    /// <summary>Builds and executes requests for operations under \informationProtection\sensitivityLabels\microsoft.graph.evaluate</summary>
    public class EvaluateRequestBuilder {
        ...
        public EvaluateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/informationProtection/sensitivityLabels/microsoft.graph.evaluate";
