...
using MicrosoftGraphSdk.InformationProtection.SensitivityLabels.Item.Sublabels.Count;
...
namespace MicrosoftGraphSdk.InformationProtection.SensitivityLabels.Item.Sublabels {
    ...
    public class SublabelsRequestBuilder {
        ...
        public MicrosoftGraphSdk.InformationProtection.SensitivityLabels.Item.Sublabels.Item.SensitivityLabelItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("sensitivityLabel_id1", position);
            return new MicrosoftGraphSdk.InformationProtection.SensitivityLabels.Item.Sublabels.Item.SensitivityLabelItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
