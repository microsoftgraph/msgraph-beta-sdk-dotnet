...
namespace Microsoft.Graph.Beta.InformationProtection.SensitivityLabels.Item.Sublabels.Evaluate {
    ...
    public class EvaluateRequestBuilder : BaseRequestBuilder {
        ...
        public EvaluateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/evaluate", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EvaluateRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EvaluateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/evaluate", rawUrl) {
        }
        /// <summary>
