...
namespace MicrosoftGraph.InformationProtection.SensitivityLabels.Item.Sublabels.Evaluate {
    /// <summary>Builds and executes requests for operations under \informationProtection\sensitivityLabels\{sensitivityLabel-id}\sublabels\microsoft.graph.evaluate</summary>
    public class EvaluateRequestBuilder {
        ...
        public EvaluateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/informationProtection/sensitivityLabels/{sensitivityLabel_id}/sublabels/microsoft.graph.evaluate";
