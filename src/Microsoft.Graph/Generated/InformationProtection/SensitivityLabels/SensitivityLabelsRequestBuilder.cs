...
namespace Microsoft.Graph.Beta.InformationProtection.SensitivityLabels {
    ...
    public class SensitivityLabelsRequestBuilder : BaseRequestBuilder {
        ...
        public SensitivityLabelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/informationProtection/sensitivityLabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SensitivityLabelsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SensitivityLabelsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/informationProtection/sensitivityLabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<SensitivityLabelCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SensitivityLabelsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SensitivityLabelCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SensitivityLabelsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SensitivityLabel?> PostAsync(SensitivityLabel body, CancellationToken cancellationToken = default, Action<SensitivityLabelsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SensitivityLabel> PostAsync(SensitivityLabel body, CancellationToken cancellationToken = default, Action<SensitivityLabelsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
