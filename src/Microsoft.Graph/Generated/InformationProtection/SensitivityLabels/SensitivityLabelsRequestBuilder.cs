...
using MicrosoftGraph.InformationProtection.SensitivityLabels.Evaluate;
using MicrosoftGraph.InformationProtection.SensitivityLabels.Item;
...
namespace MicrosoftGraph.InformationProtection.SensitivityLabels {
    /// <summary>Builds and executes requests for operations under \informationProtection\sensitivityLabels</summary>
    public class SensitivityLabelsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.informationProtection.sensitivityLabels.item collection</summary>
        ...
        public SensitivityLabelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/informationProtection/sensitivityLabels{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
