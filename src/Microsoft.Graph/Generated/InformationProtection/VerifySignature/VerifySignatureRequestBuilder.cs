...
namespace Microsoft.Graph.Beta.InformationProtection.VerifySignature {
    ...
    public class VerifySignatureRequestBuilder : BaseRequestBuilder {
        ...
        public VerifySignatureRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/informationProtection/verifySignature", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new VerifySignatureRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public VerifySignatureRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/informationProtection/verifySignature", rawUrl) {
        }
        /// <summary>
