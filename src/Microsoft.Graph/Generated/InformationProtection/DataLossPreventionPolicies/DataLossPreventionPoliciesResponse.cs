...
namespace MicrosoftGraphSdk.InformationProtection.DataLossPreventionPolicies {
    public class DataLossPreventionPoliciesResponse : IParsable {
        ...
        /// </summary>
        public static DataLossPreventionPoliciesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DataLossPreventionPoliciesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DataLossPreventionPoliciesResponse).Value = n.GetCollectionOfObjectValues<DataLossPreventionPolicy>(DataLossPreventionPolicy.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
