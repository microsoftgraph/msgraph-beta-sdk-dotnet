...
namespace Microsoft.Graph.Beta.InformationProtection.Policy.Labels.EvaluateRemoval {
    ...
    public class EvaluateRemovalRequestBuilder : BaseRequestBuilder {
        ...
        public EvaluateRemovalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/informationProtection/policy/labels/evaluateRemoval", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EvaluateRemovalRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EvaluateRemovalRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/informationProtection/policy/labels/evaluateRemoval", rawUrl) {
        }
        /// <summary>
