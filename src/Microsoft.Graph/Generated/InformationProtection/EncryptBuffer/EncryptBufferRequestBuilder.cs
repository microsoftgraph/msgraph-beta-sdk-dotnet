...
namespace Microsoft.Graph.Beta.InformationProtection.EncryptBuffer {
    ...
    public class EncryptBufferRequestBuilder : BaseRequestBuilder {
        ...
        public EncryptBufferRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/informationProtection/encryptBuffer", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EncryptBufferRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EncryptBufferRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/informationProtection/encryptBuffer", rawUrl) {
        }
        /// <summary>
