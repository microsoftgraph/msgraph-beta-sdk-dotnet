...
namespace Microsoft.Graph.Beta.InformationProtection.ThreatAssessmentRequests.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/informationProtection/threatAssessmentRequests/$count{?%24search,%24filter}";
