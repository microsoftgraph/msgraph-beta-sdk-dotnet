...
namespace Microsoft.Graph.Beta.PrivilegedSignupStatus {
    ...
    public class PrivilegedSignupStatusRequestBuilder {
        ...
        /// </summary>
        public async Task<PrivilegedSignupStatusCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PrivilegedSignupStatusRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.PrivilegedSignupStatus> PostAsync(Microsoft.Graph.Beta.Models.PrivilegedSignupStatus body, CancellationToken cancellationToken = default, Action<PrivilegedSignupStatusRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
