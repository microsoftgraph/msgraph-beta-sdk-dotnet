    ...
    public class PrivilegedSignupStatusResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as PrivilegedSignupStatusResponse).Value = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.PrivilegedSignupStatus>().ToList(); } },
            };
        }
        /// <summary>
