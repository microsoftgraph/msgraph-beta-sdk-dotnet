...
#nullable enable
        public async Task<AuthenticationStrengthUsage?> GetAsync(CancellationToken cancellationToken = default, Action<UsageRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AuthenticationStrengthUsage> GetAsync(CancellationToken cancellationToken = default, Action<UsageRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
