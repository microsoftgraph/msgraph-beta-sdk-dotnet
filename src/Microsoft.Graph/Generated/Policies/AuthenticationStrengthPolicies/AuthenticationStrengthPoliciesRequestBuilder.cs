...
namespace Microsoft.Graph.Beta.Policies.AuthenticationStrengthPolicies {
    ...
    public class AuthenticationStrengthPoliciesRequestBuilder {
        ...
        /// </summary>
        public async Task<AuthenticationStrengthPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AuthenticationStrengthPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AuthenticationStrengthPolicy> PostAsync(AuthenticationStrengthPolicy body, CancellationToken cancellationToken = default, Action<AuthenticationStrengthPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
