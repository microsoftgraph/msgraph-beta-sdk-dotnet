...
namespace Microsoft.Graph.Beta.Policies.AuthenticationStrengthPolicies.FindByMethodModeWithAuthenticationMethodModes {
    /// <summary>Provides operations to call the findByMethodMode method.</summary>
    public class FindByMethodModeWithAuthenticationMethodModesResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        /// </summary>
        public static FindByMethodModeWithAuthenticationMethodModesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
