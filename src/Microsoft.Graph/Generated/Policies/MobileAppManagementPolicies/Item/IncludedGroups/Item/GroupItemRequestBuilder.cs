...
namespace MicrosoftGraphSdk.Policies.MobileAppManagementPolicies.Item.IncludedGroups.Item {
    ...
    public class GroupItemRequestBuilder {
        ...
        public GroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/policies/mobileAppManagementPolicies/{mobilityManagementPolicy_id}/includedGroups/{group_id}{?select,expand}";
