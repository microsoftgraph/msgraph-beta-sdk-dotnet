...
namespace MicrosoftGraph.Policies.MobileAppManagementPolicies {
    /// <summary>Builds and executes requests for operations under \policies\mobileAppManagementPolicies</summary>
    public class MobileAppManagementPoliciesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.policies.mobileAppManagementPolicies.item collection</summary>
        public MobileAppManagementPoliciesRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("mobilityManagementPolicy_id", position);
            return new MobileAppManagementPoliciesRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public MobileAppManagementPoliciesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/policies/mobileAppManagementPolicies{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
