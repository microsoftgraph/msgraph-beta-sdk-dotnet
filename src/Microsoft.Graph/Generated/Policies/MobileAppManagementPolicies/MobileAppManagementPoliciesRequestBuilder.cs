...
#nullable enable
        public async Task<MobilityManagementPolicyCollectionResponse?> GetAsync(Action<RequestConfiguration<MobileAppManagementPoliciesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<MobilityManagementPolicyCollectionResponse> GetAsync(Action<RequestConfiguration<MobileAppManagementPoliciesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        public class MobileAppManagementPoliciesRequestBuilderGetRequestConfiguration : RequestConfiguration<MobileAppManagementPoliciesRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
