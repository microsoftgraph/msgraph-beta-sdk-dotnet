...
#nullable enable
        public async Task<ConditionalAccessPolicyCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ConditionalAccessPoliciesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ConditionalAccessPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ConditionalAccessPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ConditionalAccessPolicy?> PostAsync(ConditionalAccessPolicy body, CancellationToken cancellationToken = default, Action<ConditionalAccessPoliciesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ConditionalAccessPolicy> PostAsync(ConditionalAccessPolicy body, CancellationToken cancellationToken = default, Action<ConditionalAccessPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
