...
namespace Microsoft.Graph.Beta.Policies.RoleManagementPolicies.Item.Rules {
    ...
    public class RulesRequestBuilder {
        ...
        /// </summary>
        public async Task<UnifiedRoleManagementPolicyRuleCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RulesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UnifiedRoleManagementPolicyRule> PostAsync(UnifiedRoleManagementPolicyRule body, CancellationToken cancellationToken = default, Action<RulesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
