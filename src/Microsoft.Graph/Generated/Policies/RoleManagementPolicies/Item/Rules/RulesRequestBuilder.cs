...
namespace Microsoft.Graph.Beta.Policies.RoleManagementPolicies.Item.Rules {
    ...
    public class RulesRequestBuilder : BaseRequestBuilder {
        ...
        public UnifiedRoleManagementPolicyRuleItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("unifiedRoleManagementPolicyRule%2Did", position);
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/unifiedrolemanagementpolicy-list-rules?view=graph-rest-1.0" />
        /// </summary>
