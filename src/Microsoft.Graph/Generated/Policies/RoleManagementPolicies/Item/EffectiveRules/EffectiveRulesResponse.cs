...
namespace MicrosoftGraphSdk.Policies.RoleManagementPolicies.Item.EffectiveRules {
    public class EffectiveRulesResponse : IParsable {
        ...
        /// </summary>
        public static EffectiveRulesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as EffectiveRulesResponse).Value = n.GetCollectionOfObjectValues<UnifiedRoleManagementPolicyRule>(UnifiedRoleManagementPolicyRule.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
