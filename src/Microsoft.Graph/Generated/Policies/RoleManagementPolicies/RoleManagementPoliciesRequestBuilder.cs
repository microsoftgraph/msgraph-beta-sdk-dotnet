...
namespace Microsoft.Graph.Beta.Policies.RoleManagementPolicies {
    ...
    public class RoleManagementPoliciesRequestBuilder {
        ...
        /// </summary>
        public async Task<UnifiedRoleManagementPolicyCollectionResponse> GetAsync(Action<RoleManagementPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UnifiedRoleManagementPolicy> PostAsync(UnifiedRoleManagementPolicy body, Action<RoleManagementPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
