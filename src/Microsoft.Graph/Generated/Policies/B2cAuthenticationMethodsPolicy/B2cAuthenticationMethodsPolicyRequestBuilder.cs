...
namespace Microsoft.Graph.Beta.Policies.B2cAuthenticationMethodsPolicy {
    ...
    public class B2cAuthenticationMethodsPolicyRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(Action<B2cAuthenticationMethodsPolicyRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.B2cAuthenticationMethodsPolicy> GetAsync(Action<B2cAuthenticationMethodsPolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
