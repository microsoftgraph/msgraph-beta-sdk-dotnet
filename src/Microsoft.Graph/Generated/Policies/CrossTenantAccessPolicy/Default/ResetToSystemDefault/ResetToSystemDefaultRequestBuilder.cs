...
namespace Microsoft.Graph.Beta.Policies.CrossTenantAccessPolicy.Default.ResetToSystemDefault {
    ...
    public class ResetToSystemDefaultRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<ResetToSystemDefaultRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
