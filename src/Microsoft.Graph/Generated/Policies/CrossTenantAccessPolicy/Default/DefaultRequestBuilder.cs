...
namespace Microsoft.Graph.Beta.Policies.CrossTenantAccessPolicy.Default {
    ...
    public class DefaultRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(Action<DefaultRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<CrossTenantAccessPolicyConfigurationDefault> GetAsync(Action<DefaultRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
