...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DefaultRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DefaultRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CrossTenantAccessPolicyConfigurationDefault?> GetAsync(CancellationToken cancellationToken = default, Action<DefaultRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CrossTenantAccessPolicyConfigurationDefault> GetAsync(CancellationToken cancellationToken = default, Action<DefaultRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CrossTenantAccessPolicyConfigurationDefault?> PatchAsync(CrossTenantAccessPolicyConfigurationDefault body, CancellationToken cancellationToken = default, Action<DefaultRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CrossTenantAccessPolicyConfigurationDefault> PatchAsync(CrossTenantAccessPolicyConfigurationDefault body, CancellationToken cancellationToken = default, Action<DefaultRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
