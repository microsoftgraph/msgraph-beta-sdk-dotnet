...
namespace MicrosoftGraphSdk.Policies.CrossTenantAccessPolicy.Default {
    ...
    public class DefaultRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(CrossTenantAccessPolicyConfigurationDefault body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
