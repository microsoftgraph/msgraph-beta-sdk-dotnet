...
namespace Microsoft.Graph.Beta.Policies.CrossTenantAccessPolicy.Partners.Item.IdentitySynchronization {
    ...
    /// </summary>
    public class IdentitySynchronizationRequestBuilder {
        ...
        public IdentitySynchronizationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner%2DtenantId}/identitySynchronization{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IdentitySynchronizationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
