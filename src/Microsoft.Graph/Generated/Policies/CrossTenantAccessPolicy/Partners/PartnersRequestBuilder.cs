...
namespace MicrosoftGraphSdk.Policies.CrossTenantAccessPolicy.Partners {
    ...
    public class PartnersRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CrossTenantAccessPolicyConfigurationPartner body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// </summary>
        public async Task<CrossTenantAccessPolicyConfigurationPartnerCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
