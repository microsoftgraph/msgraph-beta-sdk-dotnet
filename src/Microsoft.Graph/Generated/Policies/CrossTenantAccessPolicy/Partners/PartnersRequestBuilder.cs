...
using MicrosoftGraphSdk.Policies.CrossTenantAccessPolicy.Partners.Count;
using MicrosoftGraphSdk.Policies.CrossTenantAccessPolicy.Partners.Item;
using System;
...
namespace MicrosoftGraphSdk.Policies.CrossTenantAccessPolicy.Partners {
    ...
    public class PartnersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.policies.crossTenantAccessPolicy.partners.item collection</summary>
        public CrossTenantAccessPolicyConfigurationPartnerItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("crossTenantAccessPolicyConfigurationPartner_tenantId", position);
        ...
        public PartnersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/policies/crossTenantAccessPolicy/partners{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CrossTenantAccessPolicyConfigurationPartner body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<CrossTenantAccessPolicyConfigurationPartner> PostAsync(CrossTenantAccessPolicyConfigurationPartner body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
