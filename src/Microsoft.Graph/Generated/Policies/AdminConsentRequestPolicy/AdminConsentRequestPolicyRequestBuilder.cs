...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AdminConsentRequestPolicyRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AdminConsentRequestPolicyRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.AdminConsentRequestPolicy?> GetAsync(CancellationToken cancellationToken = default, Action<AdminConsentRequestPolicyRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.AdminConsentRequestPolicy> GetAsync(CancellationToken cancellationToken = default, Action<AdminConsentRequestPolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.AdminConsentRequestPolicy?> PatchAsync(Microsoft.Graph.Beta.Models.AdminConsentRequestPolicy body, CancellationToken cancellationToken = default, Action<AdminConsentRequestPolicyRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.AdminConsentRequestPolicy> PatchAsync(Microsoft.Graph.Beta.Models.AdminConsentRequestPolicy body, CancellationToken cancellationToken = default, Action<AdminConsentRequestPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
