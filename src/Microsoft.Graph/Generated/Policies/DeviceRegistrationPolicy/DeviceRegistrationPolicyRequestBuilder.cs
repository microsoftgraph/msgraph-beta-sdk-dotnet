...
namespace Microsoft.Graph.Beta.Policies.DeviceRegistrationPolicy {
    ...
    public class DeviceRegistrationPolicyRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.DeviceRegistrationPolicy> GetAsync(CancellationToken cancellationToken = default, Action<DeviceRegistrationPolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.DeviceRegistrationPolicy body, CancellationToken cancellationToken = default, Action<DeviceRegistrationPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
