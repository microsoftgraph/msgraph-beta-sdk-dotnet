...
namespace Microsoft.Graph.Beta.Policies.ActivityBasedTimeoutPolicies.Item {
    ...
    public class ActivityBasedTimeoutPolicyItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ActivityBasedTimeoutPolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ActivityBasedTimeoutPolicy> GetAsync(CancellationToken cancellationToken = default, Action<ActivityBasedTimeoutPolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ActivityBasedTimeoutPolicy body, CancellationToken cancellationToken = default, Action<ActivityBasedTimeoutPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
