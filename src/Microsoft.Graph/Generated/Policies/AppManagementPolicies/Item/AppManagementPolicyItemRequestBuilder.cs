...
namespace Microsoft.Graph.Beta.Policies.AppManagementPolicies.Item {
    ...
    public class AppManagementPolicyItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(Action<AppManagementPolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AppManagementPolicy body, Action<AppManagementPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
