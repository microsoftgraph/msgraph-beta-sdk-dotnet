...
namespace Microsoft.Graph.Beta.Policies.AppManagementPolicies.Item.AppliesTo.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/policies/appManagementPolicies/{appManagementPolicy%2Did}/appliesTo/$count";
