...
namespace Microsoft.Graph.Beta.Policies.AppManagementPolicies.Item.AppliesTo {
    ...
    public class AppliesToRequestBuilder {
        ...
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AppliesToRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
