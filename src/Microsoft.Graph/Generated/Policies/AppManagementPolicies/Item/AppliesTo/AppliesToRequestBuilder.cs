...
using Microsoft.Graph.Beta.Policies.AppManagementPolicies.Item.AppliesTo.Count;
using Microsoft.Graph.Beta.Policies.AppManagementPolicies.Item.AppliesTo.Item;
...
namespace Microsoft.Graph.Beta.Policies.AppManagementPolicies.Item.AppliesTo {
    ...
    public class AppliesToRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.policies.appManagementPolicies.item.appliesTo.item collection</summary>
        ...
        public AppliesToRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/policies/appManagementPolicies/{appManagementPolicy%2Did}/appliesTo{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
