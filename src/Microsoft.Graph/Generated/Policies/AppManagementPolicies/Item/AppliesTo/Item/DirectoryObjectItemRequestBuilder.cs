...
namespace MicrosoftGraphSdk.Policies.AppManagementPolicies.Item.AppliesTo.Item {
    ...
    public class DirectoryObjectItemRequestBuilder {
        ...
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/policies/appManagementPolicies/{appManagementPolicy_id}/appliesTo/{directoryObject_id}{?select,expand}";
