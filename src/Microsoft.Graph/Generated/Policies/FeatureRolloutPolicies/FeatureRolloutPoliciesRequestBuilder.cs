...
namespace Microsoft.Graph.Beta.Policies.FeatureRolloutPolicies {
    ...
    public class FeatureRolloutPoliciesRequestBuilder {
        ...
        /// </summary>
        public async Task<FeatureRolloutPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<FeatureRolloutPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<FeatureRolloutPolicy> PostAsync(FeatureRolloutPolicy body, CancellationToken cancellationToken = default, Action<FeatureRolloutPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
