...
namespace MicrosoftGraphSdk.Policies.MobileDeviceManagementPolicies.Item.IncludedGroups.Item {
    ...
    public class GroupItemRequestBuilder {
        ...
        public GroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/policies/mobileDeviceManagementPolicies/{mobilityManagementPolicy_id}/includedGroups/{group_id}{?select,expand}";
