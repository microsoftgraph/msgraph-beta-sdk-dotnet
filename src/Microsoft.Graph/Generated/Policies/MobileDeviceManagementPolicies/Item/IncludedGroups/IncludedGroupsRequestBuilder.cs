...
namespace MicrosoftGraphSdk.Policies.MobileDeviceManagementPolicies.Item.IncludedGroups {
    ...
    public class IncludedGroupsRequestBuilder {
        ...
        public IncludedGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/policies/mobileDeviceManagementPolicies/{mobilityManagementPolicy_id}/includedGroups{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
