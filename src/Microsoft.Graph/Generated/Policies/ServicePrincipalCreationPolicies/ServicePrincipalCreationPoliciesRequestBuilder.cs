...
namespace MicrosoftGraph.Policies.ServicePrincipalCreationPolicies {
    ...
    public class ServicePrincipalCreationPoliciesRequestBuilder {
        ...
        public ServicePrincipalCreationPoliciesRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("servicePrincipalCreationPolicy_id", position);
            return new ServicePrincipalCreationPoliciesRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
