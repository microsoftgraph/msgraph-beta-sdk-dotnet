...
namespace Microsoft.Graph.Beta.Policies.ServicePrincipalCreationPolicies.Item.Includes {
    ...
    public class IncludesRequestBuilder {
        ...
        /// </summary>
        public async Task<ServicePrincipalCreationConditionSetCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<IncludesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ServicePrincipalCreationConditionSet> PostAsync(ServicePrincipalCreationConditionSet body, CancellationToken cancellationToken = default, Action<IncludesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
