...
namespace MicrosoftGraphSdk.Policies.ServicePrincipalCreationPolicies.Item.Includes {
    ...
    public class IncludesRequestBuilder {
        ...
        public IncludesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/policies/servicePrincipalCreationPolicies/{servicePrincipalCreationPolicy_id}/includes{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
