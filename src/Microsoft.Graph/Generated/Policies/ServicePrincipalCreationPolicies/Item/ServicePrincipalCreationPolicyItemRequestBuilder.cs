...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalCreationPolicyItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalCreationPolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ServicePrincipalCreationPolicy?> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalCreationPolicyItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServicePrincipalCreationPolicy> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalCreationPolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ServicePrincipalCreationPolicy?> PatchAsync(ServicePrincipalCreationPolicy body, CancellationToken cancellationToken = default, Action<ServicePrincipalCreationPolicyItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServicePrincipalCreationPolicy> PatchAsync(ServicePrincipalCreationPolicy body, CancellationToken cancellationToken = default, Action<ServicePrincipalCreationPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
