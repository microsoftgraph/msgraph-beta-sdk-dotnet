...
namespace Microsoft.Graph.Beta.Policies.ServicePrincipalCreationPolicies.Item.Excludes {
    ...
    public class ExcludesRequestBuilder : BaseRequestBuilder {
        ...
        public ServicePrincipalCreationConditionSetItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("servicePrincipalCreationConditionSet%2Did", position);
...
#nullable enable
        public async Task<ServicePrincipalCreationConditionSetCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ExcludesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServicePrincipalCreationConditionSetCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ExcludesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ServicePrincipalCreationConditionSet?> PostAsync(ServicePrincipalCreationConditionSet body, CancellationToken cancellationToken = default, Action<ExcludesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServicePrincipalCreationConditionSet> PostAsync(ServicePrincipalCreationConditionSet body, CancellationToken cancellationToken = default, Action<ExcludesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
