...
using MicrosoftGraph.Policies.ServicePrincipalCreationPolicies.Item.Excludes.Item;
using System;
...
namespace MicrosoftGraph.Policies.ServicePrincipalCreationPolicies.Item.Excludes {
    ...
    public class ExcludesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.policies.servicePrincipalCreationPolicies.item.excludes.item collection</summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ServicePrincipalCreationConditionSet body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
