...
namespace Microsoft.Graph.Beta.Policies.ServicePrincipalCreationPolicies.Item.Excludes.Item {
    ...
    public class ServicePrincipalCreationConditionSetItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ServicePrincipalCreationConditionSet> PatchAsync(ServicePrincipalCreationConditionSet body, Action<ServicePrincipalCreationConditionSetItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
