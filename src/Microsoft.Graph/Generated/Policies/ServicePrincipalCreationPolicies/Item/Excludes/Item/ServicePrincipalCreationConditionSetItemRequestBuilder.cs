...
namespace Microsoft.Graph.Beta.Policies.ServicePrincipalCreationPolicies.Item.Excludes.Item {
    ...
    public class ServicePrincipalCreationConditionSetItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalCreationConditionSetItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ServicePrincipalCreationConditionSet> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalCreationConditionSetItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ServicePrincipalCreationConditionSet body, CancellationToken cancellationToken = default, Action<ServicePrincipalCreationConditionSetItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
