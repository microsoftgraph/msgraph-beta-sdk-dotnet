...
namespace Microsoft.Graph.Beta.Policies.RoleManagementPolicyAssignments.Item {
    ...
    public class UnifiedRoleManagementPolicyAssignmentItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UnifiedRoleManagementPolicyAssignment> PatchAsync(UnifiedRoleManagementPolicyAssignment body, Action<UnifiedRoleManagementPolicyAssignmentItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
