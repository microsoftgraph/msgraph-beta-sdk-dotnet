...
namespace Microsoft.Graph.Beta.Policies.PermissionGrantPolicies.Item.Includes.Item {
    ...
    public class PermissionGrantConditionSetItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(Action<PermissionGrantConditionSetItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PermissionGrantConditionSet> GetAsync(Action<PermissionGrantConditionSetItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PermissionGrantConditionSet> PatchAsync(PermissionGrantConditionSet body, Action<PermissionGrantConditionSetItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
