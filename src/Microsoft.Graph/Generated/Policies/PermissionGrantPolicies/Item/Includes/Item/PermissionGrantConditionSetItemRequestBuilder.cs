...
namespace Microsoft.Graph.Beta.Policies.PermissionGrantPolicies.Item.Includes.Item {
    ...
    public class PermissionGrantConditionSetItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PermissionGrantConditionSetItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PermissionGrantConditionSet> GetAsync(CancellationToken cancellationToken = default, Action<PermissionGrantConditionSetItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(PermissionGrantConditionSet body, CancellationToken cancellationToken = default, Action<PermissionGrantConditionSetItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
