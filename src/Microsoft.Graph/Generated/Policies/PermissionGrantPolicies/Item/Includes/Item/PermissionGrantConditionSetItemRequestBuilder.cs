...
namespace MicrosoftGraphSdk.Policies.PermissionGrantPolicies.Item.Includes.Item {
    /// <summary>Builds and executes requests for operations under \policies\permissionGrantPolicies\{permissionGrantPolicy-id}\includes\{permissionGrantConditionSet-id}</summary>
