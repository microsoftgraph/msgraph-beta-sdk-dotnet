...
namespace Microsoft.Graph.Beta.Print.Printers.Item.TaskTriggers.Item.Definition {
    ...
    public class DefinitionRequestBuilder : BaseRequestBuilder {
        ...
        public DefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/taskTriggers/{printTaskTrigger%2Did}/definition{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DefinitionRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<PrintTaskDefinition?> GetAsync(CancellationToken cancellationToken = default, Action<DefinitionRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintTaskDefinition> GetAsync(CancellationToken cancellationToken = default, Action<DefinitionRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
