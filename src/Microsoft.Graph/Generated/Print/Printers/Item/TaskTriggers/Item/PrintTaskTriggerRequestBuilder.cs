...
using MicrosoftGraph.Print.Printers.Item.TaskTriggers.Item.Definition;
using System;
...
namespace MicrosoftGraph.Print.Printers.Item.TaskTriggers.Item {
    ...
    public class PrintTaskTriggerRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public PrintTaskTriggerRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
