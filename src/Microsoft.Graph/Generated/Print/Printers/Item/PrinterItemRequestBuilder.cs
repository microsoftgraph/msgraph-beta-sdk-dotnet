...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Printer?> GetAsync(CancellationToken cancellationToken = default, Action<PrinterItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Printer> GetAsync(CancellationToken cancellationToken = default, Action<PrinterItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Printer?> PatchAsync(Microsoft.Graph.Beta.Models.Printer body, CancellationToken cancellationToken = default, Action<PrinterItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Printer> PatchAsync(Microsoft.Graph.Beta.Models.Printer body, CancellationToken cancellationToken = default, Action<PrinterItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
