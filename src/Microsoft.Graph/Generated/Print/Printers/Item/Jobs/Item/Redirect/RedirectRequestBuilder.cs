...
#nullable enable
        public async Task<PrintJob?> PostAsync(RedirectPostRequestBody body, CancellationToken cancellationToken = default, Action<RedirectRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintJob> PostAsync(RedirectPostRequestBody body, CancellationToken cancellationToken = default, Action<RedirectRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
