...
using System;
namespace Microsoft.Graph.Beta.Print.Printers.Item.Jobs.Item.Redirect {
    /// <summary>
    ...
    public class RedirectRequestBuilder : BaseRequestBuilder {
        ...
        public RedirectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/redirect", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RedirectRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RedirectRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/redirect", rawUrl) {
        }
        /// <summary>
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/printjob-redirect?view=graph-rest-1.0" />
        /// </summary>
...
#nullable enable
        public async Task<PrintJob?> PostAsync(RedirectPostRequestBody body, Action<RedirectRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<PrintJob> PostAsync(RedirectPostRequestBody body, Action<RedirectRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
