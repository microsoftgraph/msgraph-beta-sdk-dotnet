...
using System;
namespace Microsoft.Graph.Beta.Print.Printers.Item.Jobs.Item.Abort {
    /// <summary>
    ...
    public class AbortRequestBuilder : BaseRequestBuilder {
        ...
        public AbortRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/abort", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AbortRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AbortRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/abort", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(AbortPostRequestBody body, CancellationToken cancellationToken = default, Action<AbortRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(AbortPostRequestBody body, CancellationToken cancellationToken = default, Action<AbortRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
