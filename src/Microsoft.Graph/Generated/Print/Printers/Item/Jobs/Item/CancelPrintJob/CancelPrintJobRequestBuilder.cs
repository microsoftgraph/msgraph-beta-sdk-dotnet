...
namespace Microsoft.Graph.Beta.Print.Printers.Item.Jobs.Item.CancelPrintJob
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Print.Printers.Item.Jobs.Item.CancelPrintJob.CancelPrintJobRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Print.Printers.Item.Jobs.Item.CancelPrintJob.CancelPrintJobRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("The cancelPrintJob API is deprecated and will stop returning data on July 31, 2023. Please use the cancel API instead of this. as of 2023-06/Tasks_And_Plans")]
        public Microsoft.Graph.Beta.Print.Printers.Item.Jobs.Item.CancelPrintJob.CancelPrintJobRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Print.Printers.Item.Jobs.Item.CancelPrintJob.CancelPrintJobRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
