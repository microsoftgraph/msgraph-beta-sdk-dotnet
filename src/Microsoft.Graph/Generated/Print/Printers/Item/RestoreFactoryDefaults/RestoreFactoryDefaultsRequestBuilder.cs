...
namespace Microsoft.Graph.Beta.Print.Printers.Item.RestoreFactoryDefaults {
    ...
    public class RestoreFactoryDefaultsRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<RestoreFactoryDefaultsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
