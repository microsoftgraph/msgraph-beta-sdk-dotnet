...
namespace Microsoft.Graph.Beta.Print.Printers.Item.ResetDefaults {
    ...
    public class ResetDefaultsRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<ResetDefaultsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
