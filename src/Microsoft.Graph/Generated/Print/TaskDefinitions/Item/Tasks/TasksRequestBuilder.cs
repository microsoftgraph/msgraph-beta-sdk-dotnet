...
using Microsoft.Graph.Beta.Print.TaskDefinitions.Item.Tasks.Count;
using Microsoft.Graph.Beta.Print.TaskDefinitions.Item.Tasks.Item;
...
namespace Microsoft.Graph.Beta.Print.TaskDefinitions.Item.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.print.taskDefinitions.item.tasks.item collection</summary>
