...
using Microsoft.Graph.Beta.Print.PrinterShares.Item.Jobs.Item.Tasks.Item.Definition;
using Microsoft.Graph.Beta.Print.PrinterShares.Item.Jobs.Item.Tasks.Item.Trigger;
...
using System;
namespace Microsoft.Graph.Beta.Print.PrinterShares.Item.Jobs.Item.Tasks.Item {
    /// <summary>
    ...
    public class PrintTaskItemRequestBuilder : BaseRequestBuilder {
        ...
        public PrintTaskItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/printerShares/{printerShare%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PrintTaskItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PrintTaskItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/printerShares/{printerShare%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
