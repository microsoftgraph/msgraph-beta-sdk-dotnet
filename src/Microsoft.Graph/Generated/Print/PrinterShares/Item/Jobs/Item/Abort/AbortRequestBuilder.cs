...
namespace Microsoft.Graph.Beta.Print.PrinterShares.Item.Jobs.Item.Abort
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Print.PrinterShares.Item.Jobs.Item.Abort.AbortRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(Microsoft.Graph.Beta.Print.PrinterShares.Item.Jobs.Item.Abort.AbortPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(Microsoft.Graph.Beta.Print.PrinterShares.Item.Jobs.Item.Abort.AbortPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Print.PrinterShares.Item.Jobs.Item.Abort.AbortPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Print.PrinterShares.Item.Jobs.Item.Abort.AbortPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Print.PrinterShares.Item.Jobs.Item.Abort.AbortRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("The printerShares navigation property is deprecated and will stop returning data on July 31, 2023. Please use the shares navigation property instead of this. as of 2023-06/Tasks_And_Plans")]
        public Microsoft.Graph.Beta.Print.PrinterShares.Item.Jobs.Item.Abort.AbortRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Print.PrinterShares.Item.Jobs.Item.Abort.AbortRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
