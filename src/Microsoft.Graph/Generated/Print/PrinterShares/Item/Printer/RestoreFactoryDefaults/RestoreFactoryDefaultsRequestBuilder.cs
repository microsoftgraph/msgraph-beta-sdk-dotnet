...
namespace MicrosoftGraphSdk.Print.PrinterShares.Item.Printer.RestoreFactoryDefaults {
    /// <summary>Builds and executes requests for operations under \print\printerShares\{printerShare-id}\printer\microsoft.graph.restoreFactoryDefaults</summary>
    public class RestoreFactoryDefaultsRequestBuilder {
        ...
        public RestoreFactoryDefaultsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/print/printerShares/{printerShare_id}/printer/microsoft.graph.restoreFactoryDefaults";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public RestoreFactoryDefaultsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
