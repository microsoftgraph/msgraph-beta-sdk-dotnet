...
namespace MicrosoftGraphSdk.Print.PrinterShares.Item.AllowedUsers.Item {
    ...
    public class UserItemRequestBuilder {
        ...
        public UserItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/print/printerShares/{printerShare_id}/allowedUsers/{user_id}{?select,expand}";
