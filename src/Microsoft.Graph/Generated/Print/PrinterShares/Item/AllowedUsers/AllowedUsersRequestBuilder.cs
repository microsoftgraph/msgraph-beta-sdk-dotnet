...
using Microsoft.Graph.Beta.Print.PrinterShares.Item.AllowedUsers.Count;
using Microsoft.Graph.Beta.Print.PrinterShares.Item.AllowedUsers.Item;
using Microsoft.Graph.Beta.Print.PrinterShares.Item.AllowedUsers.Ref;
...
namespace Microsoft.Graph.Beta.Print.PrinterShares.Item.AllowedUsers {
    ...
    public class AllowedUsersRequestBuilder : BaseRequestBuilder {
        ...
        public AllowedUsersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AllowedUsersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AllowedUsersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
