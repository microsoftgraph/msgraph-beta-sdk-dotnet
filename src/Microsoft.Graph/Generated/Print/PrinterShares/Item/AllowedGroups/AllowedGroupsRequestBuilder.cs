...
namespace Microsoft.Graph.Beta.Print.PrinterShares.Item.AllowedGroups {
    ...
    public class AllowedGroupsRequestBuilder {
        ...
        /// </summary>
        public async Task<GroupCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AllowedGroupsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
