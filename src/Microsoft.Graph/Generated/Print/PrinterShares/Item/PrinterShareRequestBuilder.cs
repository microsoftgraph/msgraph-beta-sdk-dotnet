...
using MicrosoftGraph.Print.PrinterShares.Item.AllowedGroups;
using MicrosoftGraph.Print.PrinterShares.Item.AllowedUsers;
using MicrosoftGraph.Print.PrinterShares.Item.Printer;
using System;
...
namespace MicrosoftGraph.Print.PrinterShares.Item {
    /// <summary>Builds and executes requests for operations under \print\printerShares\{printerShare-id}</summary>
    public class PrinterShareRequestBuilder {
        ...
        public PrinterShareRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/print/printerShares/{printerShare_id}{?select,expand}";
