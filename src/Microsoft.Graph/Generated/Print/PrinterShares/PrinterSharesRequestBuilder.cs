...
#nullable enable
        public async Task<PrinterShareCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<PrinterSharesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrinterShareCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PrinterSharesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PrinterShare?> PostAsync(PrinterShare body, CancellationToken cancellationToken = default, Action<PrinterSharesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrinterShare> PostAsync(PrinterShare body, CancellationToken cancellationToken = default, Action<PrinterSharesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
