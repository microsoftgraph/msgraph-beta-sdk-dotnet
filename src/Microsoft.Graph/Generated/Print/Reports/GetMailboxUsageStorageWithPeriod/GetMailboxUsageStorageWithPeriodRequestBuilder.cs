...
using System;
namespace Microsoft.Graph.Beta.Print.Reports.GetMailboxUsageStorageWithPeriod {
    /// <summary>
    ...
    public class GetMailboxUsageStorageWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetMailboxUsageStorageWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getMailboxUsageStorage(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetMailboxUsageStorageWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getMailboxUsageStorage(period='{period}')", rawUrl) {
        }
        /// <summary>
