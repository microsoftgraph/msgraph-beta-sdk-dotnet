...
namespace Microsoft.Graph.Beta.Print.Reports.GetM365AppUserDetailWithDate {
    ...
    public class GetM365AppUserDetailWithDateRequestBuilder : BaseRequestBuilder {
        ...
        public GetM365AppUserDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Date? date = default) : base(requestAdapter, "{+baseurl}/print/reports/getM365AppUserDetail(date={date})", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetM365AppUserDetailWithDateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getM365AppUserDetail(date={date})", rawUrl) {
        }
        /// <summary>
