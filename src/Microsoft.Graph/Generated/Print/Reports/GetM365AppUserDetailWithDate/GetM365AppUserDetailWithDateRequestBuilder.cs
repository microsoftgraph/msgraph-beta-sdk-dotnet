...
namespace Microsoft.Graph.Beta.Print.Reports.GetM365AppUserDetailWithDate {
    ...
    public class GetM365AppUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetM365AppUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
