...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Print.Reports.Security.GetAttackSimulationTrainingUserCoverage {
    ...
    public class GetAttackSimulationTrainingUserCoverageResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AttackSimulationTrainingUserCoverage> Value {
            get { return BackingStore?.Get<List<AttackSimulationTrainingUserCoverage>>(nameof(Value)); }
