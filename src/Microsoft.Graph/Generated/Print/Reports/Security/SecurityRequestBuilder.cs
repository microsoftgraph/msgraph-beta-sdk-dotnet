...
using Microsoft.Graph.Beta.Print.Reports.Security.MicrosoftGraphGetAttackSimulationRepeatOffenders;
using Microsoft.Graph.Beta.Print.Reports.Security.MicrosoftGraphGetAttackSimulationSimulationUserCoverage;
using Microsoft.Graph.Beta.Print.Reports.Security.MicrosoftGraphGetAttackSimulationTrainingUserCoverage;
...
namespace Microsoft.Graph.Beta.Print.Reports.Security {
    ...
    public class SecurityRequestBuilder {
        ...
        public SecurityRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/security{?%24select,%24expand}";
