...
namespace Microsoft.Graph.Beta.Print.Reports.Security.GetAttackSimulationRepeatOffenders {
    ...
    public class GetAttackSimulationRepeatOffendersResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AttackSimulationRepeatOffender> Value {
            get { return BackingStore?.Get<List<AttackSimulationRepeatOffender>>(nameof(Value)); }
        ...
        /// </summary>
        public static GetAttackSimulationRepeatOffendersResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
