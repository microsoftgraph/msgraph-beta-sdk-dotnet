...
using Microsoft.Graph.Beta.Print.Reports.CredentialUserRegistrationDetails.Count;
using Microsoft.Graph.Beta.Print.Reports.CredentialUserRegistrationDetails.Item;
...
using System;
namespace Microsoft.Graph.Beta.Print.Reports.CredentialUserRegistrationDetails {
    /// <summary>
    ...
    public class CredentialUserRegistrationDetailsRequestBuilder : BaseRequestBuilder {
        ...
        public CredentialUserRegistrationDetailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/credentialUserRegistrationDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CredentialUserRegistrationDetailsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CredentialUserRegistrationDetailsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/credentialUserRegistrationDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
