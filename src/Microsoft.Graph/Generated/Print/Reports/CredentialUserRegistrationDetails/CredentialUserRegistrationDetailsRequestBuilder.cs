...
namespace Microsoft.Graph.Beta.Print.Reports.CredentialUserRegistrationDetails {
    ...
    public class CredentialUserRegistrationDetailsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.print.reports.credentialUserRegistrationDetails.item collection</summary>
        ...
        public CredentialUserRegistrationDetailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/credentialUserRegistrationDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
