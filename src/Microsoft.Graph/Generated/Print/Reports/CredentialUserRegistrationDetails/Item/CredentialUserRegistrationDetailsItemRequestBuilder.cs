...
namespace Microsoft.Graph.Beta.Print.Reports.CredentialUserRegistrationDetails.Item {
    ...
    public class CredentialUserRegistrationDetailsItemRequestBuilder {
        ...
        public CredentialUserRegistrationDetailsItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/credentialUserRegistrationDetails/{credentialUserRegistrationDetails%2Did}{?%24select,%24expand}";
        ...
        /// <summary>
        /// Delete navigation property credentialUserRegistrationDetails for print
        ...
        /// <summary>
        /// Update the navigation property credentialUserRegistrationDetails in print
        ...
        /// </summary>
        public async Task DeleteAsync(Action<CredentialUserRegistrationDetailsItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.CredentialUserRegistrationDetails> GetAsync(Action<CredentialUserRegistrationDetailsItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.CredentialUserRegistrationDetails body, Action<CredentialUserRegistrationDetailsItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
