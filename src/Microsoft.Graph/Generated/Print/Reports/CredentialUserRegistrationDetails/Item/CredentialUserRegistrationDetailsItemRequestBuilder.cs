...
namespace Microsoft.Graph.Beta.Print.Reports.CredentialUserRegistrationDetails.Item {
    ...
    public class CredentialUserRegistrationDetailsItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CredentialUserRegistrationDetailsItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.CredentialUserRegistrationDetails> GetAsync(CancellationToken cancellationToken = default, Action<CredentialUserRegistrationDetailsItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.CredentialUserRegistrationDetails body, CancellationToken cancellationToken = default, Action<CredentialUserRegistrationDetailsItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
