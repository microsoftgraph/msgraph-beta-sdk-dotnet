...
namespace Microsoft.Graph.Beta.Print.Reports.AuthenticationMethods.UsersRegisteredByFeature {
    ...
    public class UsersRegisteredByFeatureRequestBuilder : BaseRequestBuilder {
        ...
        public UsersRegisteredByFeatureRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/authenticationMethods/usersRegisteredByFeature()", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UsersRegisteredByFeatureRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UsersRegisteredByFeatureRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/authenticationMethods/usersRegisteredByFeature()", rawUrl) {
        }
        /// <summary>
