...
namespace Microsoft.Graph.Beta.Print.Reports.GetEmailActivityUserCountsWithPeriod {
    ...
    public class GetEmailActivityUserCountsWithPeriodRequestBuilder {
        ...
        public GetEmailActivityUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.getEmailActivityUserCounts(period='{period}')";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetEmailActivityUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(Action<GetEmailActivityUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
