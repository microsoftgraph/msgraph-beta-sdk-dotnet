...
namespace Microsoft.Graph.Beta.Print.Reports.GetEmailActivityUserCountsWithPeriod {
    ...
    public class GetEmailActivityUserCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetEmailActivityUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getEmailActivityUserCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetEmailActivityUserCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getEmailActivityUserCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
