...
namespace Microsoft.Graph.Beta.Print.Reports.GetOneDriveUsageAccountCountsWithPeriod {
    ...
    public class GetOneDriveUsageAccountCountsWithPeriodRequestBuilder {
        ...
        public GetOneDriveUsageAccountCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/print/reports/getOneDriveUsageAccountCounts(period='{period}')";
