...
namespace Microsoft.Graph.Beta.Print.Reports.GetOneDriveUsageAccountCountsWithPeriod {
    ...
    public class GetOneDriveUsageAccountCountsWithPeriodRequestBuilder {
        ...
        public GetOneDriveUsageAccountCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.getOneDriveUsageAccountCounts(period='{period}')";
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetOneDriveUsageAccountCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
