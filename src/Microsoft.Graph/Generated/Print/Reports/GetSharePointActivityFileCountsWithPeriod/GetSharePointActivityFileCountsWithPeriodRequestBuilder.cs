...
namespace Microsoft.Graph.Beta.Print.Reports.GetSharePointActivityFileCountsWithPeriod {
    ...
    public class GetSharePointActivityFileCountsWithPeriodRequestBuilder {
        ...
        public GetSharePointActivityFileCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.getSharePointActivityFileCounts(period='{period}')";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetSharePointActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetSharePointActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
