...
namespace Microsoft.Graph.Beta.Print.Reports.GetSharePointActivityFileCountsWithPeriod {
    ...
    public class GetSharePointActivityFileCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetSharePointActivityFileCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getSharePointActivityFileCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetSharePointActivityFileCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getSharePointActivityFileCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
