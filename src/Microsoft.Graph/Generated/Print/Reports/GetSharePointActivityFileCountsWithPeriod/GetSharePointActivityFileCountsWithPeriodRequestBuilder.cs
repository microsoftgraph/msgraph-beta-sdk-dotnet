...
namespace Microsoft.Graph.Beta.Print.Reports.GetSharePointActivityFileCountsWithPeriod {
    ...
    public class GetSharePointActivityFileCountsWithPeriodRequestBuilder {
        ...
        public GetSharePointActivityFileCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/print/reports/getSharePointActivityFileCounts(period='{period}')";
