...
namespace Microsoft.Graph.Beta.Print.Reports.GetCredentialUserRegistrationCount {
    ...
    public class GetCredentialUserRegistrationCountRequestBuilder : BaseRequestBuilder {
        ...
        public GetCredentialUserRegistrationCountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getCredentialUserRegistrationCount(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetCredentialUserRegistrationCountRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetCredentialUserRegistrationCountRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getCredentialUserRegistrationCount(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<GetCredentialUserRegistrationCountRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new GetCredentialUserRegistrationCountRequestBuilderGetRequestConfiguration();
...
#nullable restore
        ...
        public class GetCredentialUserRegistrationCountRequestBuilderGetRequestConfiguration {
            ...
            public GetCredentialUserRegistrationCountRequestBuilderGetQueryParameters QueryParameters { get; set; } = new GetCredentialUserRegistrationCountRequestBuilderGetQueryParameters();
            /// <summary>
