...
namespace Microsoft.Graph.Beta.Print.Reports.GetEmailAppUsageVersionsUserCountsWithPeriod {
    ...
    public class GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getEmailAppUsageVersionsUserCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getEmailAppUsageVersionsUserCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
