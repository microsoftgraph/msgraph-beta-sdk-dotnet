...
namespace Microsoft.Graph.Beta.Print.Reports.GetEmailAppUsageVersionsUserCountsWithPeriod {
    ...
    public class GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder {
        ...
        public GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.getEmailAppUsageVersionsUserCounts(period='{period}')";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
