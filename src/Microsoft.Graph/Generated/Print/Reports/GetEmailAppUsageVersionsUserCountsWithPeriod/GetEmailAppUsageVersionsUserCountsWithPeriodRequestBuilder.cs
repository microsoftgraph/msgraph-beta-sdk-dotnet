...
namespace Microsoft.Graph.Beta.Print.Reports.GetEmailAppUsageVersionsUserCountsWithPeriod {
    ...
    public class GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder {
        ...
        public GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/print/reports/getEmailAppUsageVersionsUserCounts(period='{period}')";
