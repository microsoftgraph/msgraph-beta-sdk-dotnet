...
using System;
namespace Microsoft.Graph.Beta.Print.Reports.ManagedDeviceEnrollmentTopFailures {
    /// <summary>
    ...
    public class ManagedDeviceEnrollmentTopFailuresRequestBuilder : BaseRequestBuilder {
        ...
        public ManagedDeviceEnrollmentTopFailuresRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/managedDeviceEnrollmentTopFailures()", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ManagedDeviceEnrollmentTopFailuresRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ManagedDeviceEnrollmentTopFailuresRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/managedDeviceEnrollmentTopFailures()", rawUrl) {
        }
        /// <summary>
