...
namespace Microsoft.Graph.Beta.Print.Reports.GetYammerActivityUserDetailWithDate {
    ...
    public class GetYammerActivityUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(Action<GetYammerActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
