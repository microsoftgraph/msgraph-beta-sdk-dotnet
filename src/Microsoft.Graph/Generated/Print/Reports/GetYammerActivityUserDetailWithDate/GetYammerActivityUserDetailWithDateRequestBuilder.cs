...
namespace Microsoft.Graph.Beta.Print.Reports.GetYammerActivityUserDetailWithDate {
    ...
    public class GetYammerActivityUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetYammerActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
