...
namespace Microsoft.Graph.Beta.Print.Reports.GetTeamsTeamActivityDetailWithDate {
    ...
    public class GetTeamsTeamActivityDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public GetTeamsTeamActivityDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Date? date = default) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.getTeamsTeamActivityDetail(date={date})";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public GetTeamsTeamActivityDetailWithDateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetTeamsTeamActivityDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(Action<GetTeamsTeamActivityDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
