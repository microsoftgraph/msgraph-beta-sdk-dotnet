...
namespace Microsoft.Graph.Beta.Print.Reports.GetTeamsTeamActivityDetailWithDate {
    ...
    public class GetTeamsTeamActivityDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetTeamsTeamActivityDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
