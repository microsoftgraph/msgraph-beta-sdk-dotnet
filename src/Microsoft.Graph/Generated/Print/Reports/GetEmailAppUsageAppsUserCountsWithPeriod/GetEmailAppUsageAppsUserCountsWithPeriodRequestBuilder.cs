...
using System;
namespace Microsoft.Graph.Beta.Print.Reports.GetEmailAppUsageAppsUserCountsWithPeriod {
    /// <summary>
    ...
    public class GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getEmailAppUsageAppsUserCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getEmailAppUsageAppsUserCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
