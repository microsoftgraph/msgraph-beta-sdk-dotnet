...
namespace Microsoft.Graph.Beta.Print.Reports.GetSharePointSiteUsageSiteCountsWithPeriod {
    ...
    public class GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilder {
        ...
        public GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/print/reports/getSharePointSiteUsageSiteCounts(period='{period}')";
