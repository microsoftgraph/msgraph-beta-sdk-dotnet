...
namespace Microsoft.Graph.Beta.Print.Reports.GetSharePointSiteUsageSiteCountsWithPeriod {
    ...
    public class GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getSharePointSiteUsageSiteCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getSharePointSiteUsageSiteCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
