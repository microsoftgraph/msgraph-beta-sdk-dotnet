...
namespace Microsoft.Graph.Beta.Print.Reports.GetAzureADApplicationSignInSummaryWithPeriod {
    /// <summary>
    ...
    public class GetAzureADApplicationSignInSummaryWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetAzureADApplicationSignInSummaryWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getAzureADApplicationSignInSummary(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetAzureADApplicationSignInSummaryWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getAzureADApplicationSignInSummary(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", rawUrl) {
        }
        /// <summary>
