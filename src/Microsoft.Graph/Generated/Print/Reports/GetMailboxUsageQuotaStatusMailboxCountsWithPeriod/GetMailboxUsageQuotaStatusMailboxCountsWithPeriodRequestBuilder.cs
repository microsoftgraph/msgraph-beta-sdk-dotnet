...
namespace Microsoft.Graph.Beta.Print.Reports.GetMailboxUsageQuotaStatusMailboxCountsWithPeriod {
    ...
    public class GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getMailboxUsageQuotaStatusMailboxCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getMailboxUsageQuotaStatusMailboxCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
