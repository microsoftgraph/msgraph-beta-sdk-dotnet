...
namespace Microsoft.Graph.Beta.Print.Reports.GetMailboxUsageQuotaStatusMailboxCountsWithPeriod {
    ...
    public class GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
