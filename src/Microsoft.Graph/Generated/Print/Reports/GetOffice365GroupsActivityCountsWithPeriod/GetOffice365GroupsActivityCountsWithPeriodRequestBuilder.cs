...
namespace Microsoft.Graph.Beta.Print.Reports.GetOffice365GroupsActivityCountsWithPeriod {
    ...
    public class GetOffice365GroupsActivityCountsWithPeriodRequestBuilder {
        ...
        public GetOffice365GroupsActivityCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.getOffice365GroupsActivityCounts(period='{period}')";
        ...
        /// </summary>
        public async Task<GetOffice365GroupsActivityCountsWithPeriodResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetOffice365GroupsActivityCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
