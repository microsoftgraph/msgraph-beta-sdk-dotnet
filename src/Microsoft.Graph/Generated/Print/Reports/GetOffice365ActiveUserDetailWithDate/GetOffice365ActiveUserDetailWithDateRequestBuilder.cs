...
namespace Microsoft.Graph.Beta.Print.Reports.GetOffice365ActiveUserDetailWithDate {
    ...
    public class GetOffice365ActiveUserDetailWithDateRequestBuilder {
        ...
        public GetOffice365ActiveUserDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Date? date = default) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.getOffice365ActiveUserDetail(date={date})";
        ...
        /// </summary>
        public async Task<GetOffice365ActiveUserDetailWithDateResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetOffice365ActiveUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
