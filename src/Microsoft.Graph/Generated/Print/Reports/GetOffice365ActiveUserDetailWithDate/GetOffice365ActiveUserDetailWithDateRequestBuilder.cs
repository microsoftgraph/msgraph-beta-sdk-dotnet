...
using System;
namespace Microsoft.Graph.Beta.Print.Reports.GetOffice365ActiveUserDetailWithDate {
    /// <summary>
    ...
    public class GetOffice365ActiveUserDetailWithDateRequestBuilder : BaseRequestBuilder {
        ...
        public GetOffice365ActiveUserDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Date? date = default) : base(requestAdapter, "{+baseurl}/print/reports/getOffice365ActiveUserDetail(date={date}){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetOffice365ActiveUserDetailWithDateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getOffice365ActiveUserDetail(date={date}){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        /// Invoke function getOffice365ActiveUserDetail
        /// </summary>
        public class GetOffice365ActiveUserDetailWithDateRequestBuilderGetQueryParameters {
...
#nullable restore
        ...
        public class GetOffice365ActiveUserDetailWithDateRequestBuilderGetRequestConfiguration {
            ...
            public GetOffice365ActiveUserDetailWithDateRequestBuilderGetQueryParameters QueryParameters { get; set; } = new GetOffice365ActiveUserDetailWithDateRequestBuilderGetQueryParameters();
            /// <summary>
