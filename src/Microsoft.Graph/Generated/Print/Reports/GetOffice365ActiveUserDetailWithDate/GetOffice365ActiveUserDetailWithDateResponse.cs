...
namespace Microsoft.Graph.Beta.Print.Reports.GetOffice365ActiveUserDetailWithDate {
    ...
    public class GetOffice365ActiveUserDetailWithDateResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Office365ActiveUserDetail> Value {
            get { return BackingStore?.Get<List<Office365ActiveUserDetail>>(nameof(Value)); }
