...
namespace Microsoft.Graph.Beta.Print.Reports.GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriod {
    ...
    public class GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getSkypeForBusinessParticipantActivityMinuteCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getSkypeForBusinessParticipantActivityMinuteCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
