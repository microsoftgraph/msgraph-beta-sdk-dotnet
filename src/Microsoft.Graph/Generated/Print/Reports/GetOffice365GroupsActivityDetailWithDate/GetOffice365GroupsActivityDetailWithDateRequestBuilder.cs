...
namespace Microsoft.Graph.Beta.Print.Reports.GetOffice365GroupsActivityDetailWithDate {
    ...
    public class GetOffice365GroupsActivityDetailWithDateRequestBuilder {
        ...
        public GetOffice365GroupsActivityDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Date? date = default) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.getOffice365GroupsActivityDetail(date={date}){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetOffice365GroupsActivityDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<GetOffice365GroupsActivityDetailWithDateResponse> GetAsync(Action<GetOffice365GroupsActivityDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<GetOffice365GroupsActivityDetailWithDateResponse>(requestInfo, GetOffice365GroupsActivityDetailWithDateResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
