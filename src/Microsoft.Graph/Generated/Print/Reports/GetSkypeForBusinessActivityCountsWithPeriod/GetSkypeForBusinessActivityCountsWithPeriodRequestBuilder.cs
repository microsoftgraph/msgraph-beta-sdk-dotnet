...
namespace Microsoft.Graph.Beta.Print.Reports.GetSkypeForBusinessActivityCountsWithPeriod {
    ...
    public class GetSkypeForBusinessActivityCountsWithPeriodRequestBuilder {
        ...
        public GetSkypeForBusinessActivityCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/print/reports/getSkypeForBusinessActivityCounts(period='{period}')";
