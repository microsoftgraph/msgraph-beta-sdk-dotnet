...
namespace Microsoft.Graph.Beta.Print.Reports.GetMailboxUsageMailboxCountsWithPeriod {
    ...
    public class GetMailboxUsageMailboxCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(Action<GetMailboxUsageMailboxCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
