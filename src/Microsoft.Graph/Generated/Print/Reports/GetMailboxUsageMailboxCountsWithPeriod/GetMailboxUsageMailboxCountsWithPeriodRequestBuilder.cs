...
namespace Microsoft.Graph.Beta.Print.Reports.GetMailboxUsageMailboxCountsWithPeriod {
    ...
    public class GetMailboxUsageMailboxCountsWithPeriodRequestBuilder {
        ...
        public GetMailboxUsageMailboxCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/print/reports/getMailboxUsageMailboxCounts(period='{period}')";
