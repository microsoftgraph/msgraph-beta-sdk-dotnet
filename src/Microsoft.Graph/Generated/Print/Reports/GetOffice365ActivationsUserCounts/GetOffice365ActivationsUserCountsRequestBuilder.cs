...
namespace Microsoft.Graph.Beta.Print.Reports.GetOffice365ActivationsUserCounts {
    /// <summary>
    ...
    public class GetOffice365ActivationsUserCountsRequestBuilder : BaseRequestBuilder {
        ...
        public GetOffice365ActivationsUserCountsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getOffice365ActivationsUserCounts()", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetOffice365ActivationsUserCountsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetOffice365ActivationsUserCountsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getOffice365ActivationsUserCounts()", rawUrl) {
        }
        /// <summary>
