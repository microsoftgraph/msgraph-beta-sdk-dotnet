...
using System;
namespace Microsoft.Graph.Beta.Print.Reports.GetM365AppUserDetailWithPeriod {
    /// <summary>
    ...
    public class GetM365AppUserDetailWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetM365AppUserDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getM365AppUserDetail(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetM365AppUserDetailWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getM365AppUserDetail(period='{period}')", rawUrl) {
        }
        /// <summary>
