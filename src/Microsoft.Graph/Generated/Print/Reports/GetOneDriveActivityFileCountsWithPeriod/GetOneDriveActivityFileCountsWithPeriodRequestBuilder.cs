...
namespace Microsoft.Graph.Beta.Print.Reports.GetOneDriveActivityFileCountsWithPeriod {
    /// <summary>
    ...
    public class GetOneDriveActivityFileCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetOneDriveActivityFileCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getOneDriveActivityFileCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetOneDriveActivityFileCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getOneDriveActivityFileCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
