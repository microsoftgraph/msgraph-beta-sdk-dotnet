...
namespace Microsoft.Graph.Beta.Print.Reports.GetSharePointActivityUserDetailWithDate {
    ...
    public class GetSharePointActivityUserDetailWithDateRequestBuilder {
        ...
        public GetSharePointActivityUserDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Date? date = default) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.getSharePointActivityUserDetail(date={date})";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetSharePointActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetSharePointActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
