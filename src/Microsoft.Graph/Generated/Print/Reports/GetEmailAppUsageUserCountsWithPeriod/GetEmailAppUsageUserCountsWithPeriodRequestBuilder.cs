...
namespace Microsoft.Graph.Beta.Print.Reports.GetEmailAppUsageUserCountsWithPeriod {
    ...
    public class GetEmailAppUsageUserCountsWithPeriodRequestBuilder {
        ...
        public GetEmailAppUsageUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/print/reports/getEmailAppUsageUserCounts(period='{period}')";
