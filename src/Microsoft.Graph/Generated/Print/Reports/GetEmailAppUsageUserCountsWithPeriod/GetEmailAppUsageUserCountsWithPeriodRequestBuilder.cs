...
namespace Microsoft.Graph.Beta.Print.Reports.GetEmailAppUsageUserCountsWithPeriod {
    ...
    public class GetEmailAppUsageUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetEmailAppUsageUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
