...
namespace Microsoft.Graph.Beta.Print.Reports.GetEmailAppUsageUserCountsWithPeriod {
    /// <summary>Provides operations to call the getEmailAppUsageUserCounts method.</summary>
    public class GetEmailAppUsageUserCountsWithPeriodRequestBuilder {
        ...
        public GetEmailAppUsageUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.getEmailAppUsageUserCounts(period='{period}')";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public GetEmailAppUsageUserCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetEmailAppUsageUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(Action<GetEmailAppUsageUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
