...
namespace Microsoft.Graph.Beta.Print.Reports.GetYammerDeviceUsageDistributionUserCountsWithPeriod {
    ...
    public class GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
