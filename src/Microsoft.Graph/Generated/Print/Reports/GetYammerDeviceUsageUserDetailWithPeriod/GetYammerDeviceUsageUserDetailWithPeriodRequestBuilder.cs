...
namespace Microsoft.Graph.Beta.Print.Reports.GetYammerDeviceUsageUserDetailWithPeriod {
    /// <summary>
    ...
    public class GetYammerDeviceUsageUserDetailWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetYammerDeviceUsageUserDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getYammerDeviceUsageUserDetail(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetYammerDeviceUsageUserDetailWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getYammerDeviceUsageUserDetail(period='{period}')", rawUrl) {
        }
        /// <summary>
