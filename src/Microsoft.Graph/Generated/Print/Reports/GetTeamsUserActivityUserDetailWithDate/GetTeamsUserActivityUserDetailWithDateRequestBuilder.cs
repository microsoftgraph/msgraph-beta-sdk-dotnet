...
namespace Microsoft.Graph.Beta.Print.Reports.GetTeamsUserActivityUserDetailWithDate {
    ...
    public class GetTeamsUserActivityUserDetailWithDateRequestBuilder : BaseRequestBuilder {
        ...
        public GetTeamsUserActivityUserDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Date? date = default) : base(requestAdapter, "{+baseurl}/print/reports/getTeamsUserActivityUserDetail(date={date})", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetTeamsUserActivityUserDetailWithDateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getTeamsUserActivityUserDetail(date={date})", rawUrl) {
        }
        /// <summary>
