...
namespace Microsoft.Graph.Beta.Print.Reports.GetOffice365ActiveUserCountsWithPeriod {
    ...
    public class GetOffice365ActiveUserCountsWithPeriodResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Office365ActiveUserCounts> Value {
            get { return BackingStore?.Get<List<Office365ActiveUserCounts>>(nameof(Value)); }
        ...
        /// </summary>
        public static GetOffice365ActiveUserCountsWithPeriodResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
