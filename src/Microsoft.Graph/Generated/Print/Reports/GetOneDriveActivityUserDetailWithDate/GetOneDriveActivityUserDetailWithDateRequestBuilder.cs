...
namespace Microsoft.Graph.Beta.Print.Reports.GetOneDriveActivityUserDetailWithDate {
    /// <summary>
    ...
    public class GetOneDriveActivityUserDetailWithDateRequestBuilder : BaseRequestBuilder {
        ...
        public GetOneDriveActivityUserDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Date? date = default) : base(requestAdapter, "{+baseurl}/print/reports/getOneDriveActivityUserDetail(date={date})", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetOneDriveActivityUserDetailWithDateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getOneDriveActivityUserDetail(date={date})", rawUrl) {
        }
        /// <summary>
