...
namespace Microsoft.Graph.Beta.Print.Reports.GetYammerDeviceUsageUserDetailWithDate {
    ...
    public class GetYammerDeviceUsageUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(Action<GetYammerDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
