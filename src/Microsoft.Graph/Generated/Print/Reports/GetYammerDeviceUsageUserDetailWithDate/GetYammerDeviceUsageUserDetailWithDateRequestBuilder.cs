...
namespace Microsoft.Graph.Beta.Print.Reports.GetYammerDeviceUsageUserDetailWithDate {
    ...
    public class GetYammerDeviceUsageUserDetailWithDateRequestBuilder {
        ...
        public GetYammerDeviceUsageUserDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Date? date = default) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.getYammerDeviceUsageUserDetail(date={date})";
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetYammerDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
