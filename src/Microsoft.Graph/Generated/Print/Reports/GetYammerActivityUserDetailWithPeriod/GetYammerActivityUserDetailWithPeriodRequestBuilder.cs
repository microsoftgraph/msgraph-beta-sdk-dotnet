...
using System;
namespace Microsoft.Graph.Beta.Print.Reports.GetYammerActivityUserDetailWithPeriod {
    /// <summary>
    ...
    public class GetYammerActivityUserDetailWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetYammerActivityUserDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getYammerActivityUserDetail(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetYammerActivityUserDetailWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getYammerActivityUserDetail(period='{period}')", rawUrl) {
        }
        /// <summary>
