...
namespace Microsoft.Graph.Beta.Print.Reports.MicrosoftGraphGetOffice365ActivationCounts {
    /// <summary>
    ...
    public class MicrosoftGraphGetOffice365ActivationCountsRequestBuilder {
        ...
        public MicrosoftGraphGetOffice365ActivationCountsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.getOffice365ActivationCounts()";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphGetOffice365ActivationCountsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<MicrosoftGraphGetOffice365ActivationCountsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<MicrosoftGraphGetOffice365ActivationCountsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
