...
namespace Microsoft.Graph.Beta.Print.Reports.GetTeamsDeviceUsageUserCountsWithPeriod {
    /// <summary>
    ...
    public class GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getTeamsDeviceUsageUserCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getTeamsDeviceUsageUserCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
