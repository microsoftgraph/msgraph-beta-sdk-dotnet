...
namespace Microsoft.Graph.Beta.Print.Reports.GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriod {
    ...
    public class GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilder {
        ...
        public GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/print/reports/getSkypeForBusinessPeerToPeerActivityMinuteCounts(period='{period}')";
