...
namespace Microsoft.Graph.Beta.Print.Reports.GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriod {
    ...
    public class GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getSkypeForBusinessPeerToPeerActivityMinuteCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getSkypeForBusinessPeerToPeerActivityMinuteCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
