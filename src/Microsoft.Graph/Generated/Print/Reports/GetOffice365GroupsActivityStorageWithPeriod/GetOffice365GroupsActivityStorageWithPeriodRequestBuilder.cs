...
namespace Microsoft.Graph.Beta.Print.Reports.GetOffice365GroupsActivityStorageWithPeriod {
    ...
    public class GetOffice365GroupsActivityStorageWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetOffice365GroupsActivityStorageWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getOffice365GroupsActivityStorage(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetOffice365GroupsActivityStorageWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getOffice365GroupsActivityStorage(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", rawUrl) {
        }
        /// <summary>
