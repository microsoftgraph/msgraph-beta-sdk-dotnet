...
namespace Microsoft.Graph.Beta.Print.Reports.MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriod {
    /// <summary>
    ...
    public class MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriodRequestBuilder {
        ...
        public MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.getOffice365GroupsActivityStorage(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<GetOffice365GroupsActivityStorageWithPeriodResponse?> GetAsync(Action<MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<GetOffice365GroupsActivityStorageWithPeriodResponse> GetAsync(Action<MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// Invoke function getOffice365GroupsActivityStorage
        /// </summary>
        public class MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetQueryParameters {
...
#nullable restore
        ...
        public class MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetRequestConfiguration {
            ...
            public MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetQueryParameters QueryParameters { get; set; } = new MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetQueryParameters();
            /// <summary>
