...
namespace Microsoft.Graph.Beta.Print.Reports.GetOffice365GroupsActivityDetailWithPeriod {
    ...
    public class GetOffice365GroupsActivityDetailWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetOffice365GroupsActivityDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getOffice365GroupsActivityDetail(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetOffice365GroupsActivityDetailWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getOffice365GroupsActivityDetail(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", rawUrl) {
        }
        /// <summary>
