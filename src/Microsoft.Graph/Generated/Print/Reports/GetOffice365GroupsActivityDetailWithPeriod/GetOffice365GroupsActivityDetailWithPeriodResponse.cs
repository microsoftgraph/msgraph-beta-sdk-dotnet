...
namespace Microsoft.Graph.Beta.Print.Reports.GetOffice365GroupsActivityDetailWithPeriod {
    ...
    public class GetOffice365GroupsActivityDetailWithPeriodResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Office365GroupsActivityDetail> Value {
            get { return BackingStore?.Get<List<Office365GroupsActivityDetail>>(nameof(Value)); }
