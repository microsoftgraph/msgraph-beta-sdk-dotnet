...
using System;
namespace Microsoft.Graph.Beta.Print.Reports.DailyPrintUsageSummariesByUser.Item {
    /// <summary>
    ...
    public class PrintUsageByUserItemRequestBuilder : BaseRequestBuilder {
        ...
        public PrintUsageByUserItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/dailyPrintUsageSummariesByUser/{printUsageByUser%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PrintUsageByUserItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PrintUsageByUserItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/dailyPrintUsageSummariesByUser/{printUsageByUser%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
