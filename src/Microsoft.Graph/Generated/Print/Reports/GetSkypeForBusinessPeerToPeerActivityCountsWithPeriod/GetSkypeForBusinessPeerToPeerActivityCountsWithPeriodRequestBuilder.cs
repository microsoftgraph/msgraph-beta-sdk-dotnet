...
namespace Microsoft.Graph.Beta.Print.Reports.GetSkypeForBusinessPeerToPeerActivityCountsWithPeriod {
    /// <summary>
    ...
    public class GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getSkypeForBusinessPeerToPeerActivityCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getSkypeForBusinessPeerToPeerActivityCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
