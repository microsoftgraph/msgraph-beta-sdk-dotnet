...
using Microsoft.Graph.Beta.Print.Reports.DailyPrintUsageByPrinter.Count;
using Microsoft.Graph.Beta.Print.Reports.DailyPrintUsageByPrinter.Item;
...
namespace Microsoft.Graph.Beta.Print.Reports.DailyPrintUsageByPrinter {
    /// <summary>
    ...
    public class DailyPrintUsageByPrinterRequestBuilder : BaseRequestBuilder {
        ...
        public DailyPrintUsageByPrinterRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/dailyPrintUsageByPrinter{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DailyPrintUsageByPrinterRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DailyPrintUsageByPrinterRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/dailyPrintUsageByPrinter{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
