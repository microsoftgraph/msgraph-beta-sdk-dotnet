...
namespace Microsoft.Graph.Beta.Print.Reports.DailyPrintUsageByPrinter {
    ...
    public class DailyPrintUsageByPrinterRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.print.reports.dailyPrintUsageByPrinter.item collection</summary>
        ...
        public DailyPrintUsageByPrinterRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/dailyPrintUsageByPrinter{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>Get dailyPrintUsageByPrinter from print</summary>
