...
using System;
namespace Microsoft.Graph.Beta.Print.Reports.GetEmailActivityUserDetailWithDate {
    /// <summary>
    ...
    public class GetEmailActivityUserDetailWithDateRequestBuilder : BaseRequestBuilder {
        ...
        public GetEmailActivityUserDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Date? date = default) : base(requestAdapter, "{+baseurl}/print/reports/getEmailActivityUserDetail(date={date})", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetEmailActivityUserDetailWithDateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getEmailActivityUserDetail(date={date})", rawUrl) {
        }
        /// <summary>
