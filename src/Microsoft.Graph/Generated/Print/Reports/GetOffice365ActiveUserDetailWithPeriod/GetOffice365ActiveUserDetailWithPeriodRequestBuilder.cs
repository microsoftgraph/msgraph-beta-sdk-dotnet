...
namespace Microsoft.Graph.Beta.Print.Reports.GetOffice365ActiveUserDetailWithPeriod {
    ...
    public class GetOffice365ActiveUserDetailWithPeriodRequestBuilder {
        ...
        public GetOffice365ActiveUserDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/print/reports/getOffice365ActiveUserDetail(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
