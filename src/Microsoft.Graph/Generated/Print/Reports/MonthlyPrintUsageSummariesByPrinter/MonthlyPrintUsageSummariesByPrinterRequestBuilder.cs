...
using MicrosoftGraphSdk.Print.Reports.MonthlyPrintUsageSummariesByPrinter.Count;
using MicrosoftGraphSdk.Print.Reports.MonthlyPrintUsageSummariesByPrinter.Item;
using System;
...
namespace MicrosoftGraphSdk.Print.Reports.MonthlyPrintUsageSummariesByPrinter {
    ...
    public class MonthlyPrintUsageSummariesByPrinterRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.print.reports.monthlyPrintUsageSummariesByPrinter.item collection</summary>
        ...
        public MonthlyPrintUsageSummariesByPrinterRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/monthlyPrintUsageSummariesByPrinter{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
