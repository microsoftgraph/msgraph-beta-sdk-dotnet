...
namespace Microsoft.Graph.Beta.Print.Reports.MonthlyPrintUsageSummariesByPrinter {
    ...
    public class MonthlyPrintUsageSummariesByPrinterRequestBuilder {
        ...
        /// </summary>
        public async Task<PrintUsageByPrinterCollectionResponse> GetAsync(Action<MonthlyPrintUsageSummariesByPrinterRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PrintUsageByPrinter> PostAsync(PrintUsageByPrinter body, Action<MonthlyPrintUsageSummariesByPrinterRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
