...
namespace Microsoft.Graph.Beta.Print.Reports.MonthlyPrintUsageSummariesByPrinter {
    ...
    public class MonthlyPrintUsageSummariesByPrinterRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.print.reports.monthlyPrintUsageSummariesByPrinter.item collection</summary>
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<MonthlyPrintUsageSummariesByPrinterRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(PrintUsageByPrinter body, Action<MonthlyPrintUsageSummariesByPrinterRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<PrintUsageByPrinterCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MonthlyPrintUsageSummariesByPrinterRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PrintUsageByPrinter> PostAsync(PrintUsageByPrinter body, CancellationToken cancellationToken = default, Action<MonthlyPrintUsageSummariesByPrinterRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
        ...
        /// <summary>Get monthlyPrintUsageSummariesByPrinter from print</summary>
