...
namespace Microsoft.Graph.Beta.Print.Reports.GetOneDriveUsageFileCountsWithPeriod {
    ...
    public class GetOneDriveUsageFileCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetOneDriveUsageFileCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getOneDriveUsageFileCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetOneDriveUsageFileCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getOneDriveUsageFileCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
