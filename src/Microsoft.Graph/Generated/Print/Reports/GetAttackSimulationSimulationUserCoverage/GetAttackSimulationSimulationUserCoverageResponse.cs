...
namespace Microsoft.Graph.Beta.Print.Reports.GetAttackSimulationSimulationUserCoverage {
    ...
    public class GetAttackSimulationSimulationUserCoverageResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AttackSimulationSimulationUserCoverage> Value {
            get { return BackingStore?.Get<List<AttackSimulationSimulationUserCoverage>>(nameof(Value)); }
