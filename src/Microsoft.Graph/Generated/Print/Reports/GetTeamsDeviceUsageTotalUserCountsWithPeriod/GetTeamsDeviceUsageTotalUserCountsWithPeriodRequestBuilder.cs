...
namespace Microsoft.Graph.Beta.Print.Reports.GetTeamsDeviceUsageTotalUserCountsWithPeriod {
    /// <summary>
    ...
    public class GetTeamsDeviceUsageTotalUserCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetTeamsDeviceUsageTotalUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/print/reports/getTeamsDeviceUsageTotalUserCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetTeamsDeviceUsageTotalUserCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/reports/getTeamsDeviceUsageTotalUserCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
