...
namespace Microsoft.Graph.Beta.Print.Reports.GetBrowserUserDetailWithPeriod {
    ...
    public class GetBrowserUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(Action<GetBrowserUserDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
