...
namespace Microsoft.Graph.Beta.Print.Reports.GetBrowserUserDetailWithPeriod {
    ...
    public class GetBrowserUserDetailWithPeriodRequestBuilder {
        ...
        public GetBrowserUserDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/print/reports/getBrowserUserDetail(period='{period}')";
