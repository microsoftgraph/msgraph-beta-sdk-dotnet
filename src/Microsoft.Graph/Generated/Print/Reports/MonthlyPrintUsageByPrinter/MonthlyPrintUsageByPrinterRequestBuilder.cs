...
namespace Microsoft.Graph.Beta.Print.Reports.MonthlyPrintUsageByPrinter {
    ...
    public class MonthlyPrintUsageByPrinterRequestBuilder {
        ...
        /// </summary>
        public async Task<PrintUsageByPrinterCollectionResponse> GetAsync(Action<MonthlyPrintUsageByPrinterRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PrintUsageByPrinter> PostAsync(PrintUsageByPrinter body, Action<MonthlyPrintUsageByPrinterRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
