...
using Microsoft.Graph.Beta.Print.Reports.MonthlyPrintUsageByPrinter.Count;
using Microsoft.Graph.Beta.Print.Reports.MonthlyPrintUsageByPrinter.Item;
...
namespace Microsoft.Graph.Beta.Print.Reports.MonthlyPrintUsageByPrinter {
    ...
    public class MonthlyPrintUsageByPrinterRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.print.reports.monthlyPrintUsageByPrinter.item collection</summary>
        ...
        public MonthlyPrintUsageByPrinterRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/monthlyPrintUsageByPrinter{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<MonthlyPrintUsageByPrinterRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(PrintUsageByPrinter body, Action<MonthlyPrintUsageByPrinterRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<PrintUsageByPrinterCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MonthlyPrintUsageByPrinterRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PrintUsageByPrinter> PostAsync(PrintUsageByPrinter body, CancellationToken cancellationToken = default, Action<MonthlyPrintUsageByPrinterRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
