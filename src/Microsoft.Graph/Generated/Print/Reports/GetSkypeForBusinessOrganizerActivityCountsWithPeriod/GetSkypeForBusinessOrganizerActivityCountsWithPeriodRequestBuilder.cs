...
namespace Microsoft.Graph.Beta.Print.Reports.GetSkypeForBusinessOrganizerActivityCountsWithPeriod {
    ...
    public class GetSkypeForBusinessOrganizerActivityCountsWithPeriodRequestBuilder {
        ...
        public GetSkypeForBusinessOrganizerActivityCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.getSkypeForBusinessOrganizerActivityCounts(period='{period}')";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetSkypeForBusinessOrganizerActivityCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(Action<GetSkypeForBusinessOrganizerActivityCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
