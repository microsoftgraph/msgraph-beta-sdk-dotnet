...
namespace Microsoft.Graph.Beta.Print.Reports.DeviceConfigurationUserActivity {
    ...
    public class DeviceConfigurationUserActivityRequestBuilder {
        ...
        public DeviceConfigurationUserActivityRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/print/reports/microsoft.graph.deviceConfigurationUserActivity()";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<DeviceConfigurationUserActivityRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<DeviceConfigurationUserActivityRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
