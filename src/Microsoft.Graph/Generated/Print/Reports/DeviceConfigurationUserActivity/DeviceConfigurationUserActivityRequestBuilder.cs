...
namespace Microsoft.Graph.Beta.Print.Reports.DeviceConfigurationUserActivity {
    ...
    public class DeviceConfigurationUserActivityRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<Stream> GetAsync(Action<DeviceConfigurationUserActivityRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
