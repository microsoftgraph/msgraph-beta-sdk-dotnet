...
namespace Microsoft.Graph.Beta.Print.Reports.DeviceConfigurationUserActivity {
    ...
    public class DeviceConfigurationUserActivityRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<DeviceConfigurationUserActivityRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
