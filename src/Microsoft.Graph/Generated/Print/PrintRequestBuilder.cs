...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Print?> GetAsync(CancellationToken cancellationToken = default, Action<PrintRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Print> GetAsync(CancellationToken cancellationToken = default, Action<PrintRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Print?> PatchAsync(Microsoft.Graph.Beta.Models.Print body, CancellationToken cancellationToken = default, Action<PrintRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Print> PatchAsync(Microsoft.Graph.Beta.Models.Print body, CancellationToken cancellationToken = default, Action<PrintRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
