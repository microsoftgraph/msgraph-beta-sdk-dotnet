...
#nullable enable
        public async Task<PrintJobStatus?> PostAsync(CancellationToken cancellationToken = default, Action<StartPrintJobRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintJobStatus> PostAsync(CancellationToken cancellationToken = default, Action<StartPrintJobRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
