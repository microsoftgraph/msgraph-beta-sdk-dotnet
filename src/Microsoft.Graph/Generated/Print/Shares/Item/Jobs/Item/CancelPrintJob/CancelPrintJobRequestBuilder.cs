...
using System;
namespace Microsoft.Graph.Beta.Print.Shares.Item.Jobs.Item.CancelPrintJob {
    /// <summary>
    ...
    public class CancelPrintJobRequestBuilder : BaseRequestBuilder {
        ...
        public CancelPrintJobRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/cancelPrintJob", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CancelPrintJobRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CancelPrintJobRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/cancelPrintJob", rawUrl) {
        }
        /// <summary>
