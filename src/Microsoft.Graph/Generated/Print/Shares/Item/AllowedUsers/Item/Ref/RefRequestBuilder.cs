...
namespace Microsoft.Graph.Beta.Print.Shares.Item.AllowedUsers.Item.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public RefRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/print/shares/{printerShare%2Did}/allowedUsers/{user%2Did}/$ref{?%40id}";
        ...
        /// <summary>Delete ref of navigation property allowedUsers for print</summary>
