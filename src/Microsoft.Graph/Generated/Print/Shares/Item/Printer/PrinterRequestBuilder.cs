...
namespace Microsoft.Graph.Beta.Print.Shares.Item.Printer {
    ...
    public class PrinterRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Printer> GetAsync(CancellationToken cancellationToken = default, Action<PrinterRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
