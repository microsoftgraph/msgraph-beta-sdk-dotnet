...
namespace Microsoft.Graph.Beta.Print.Shares.Item
{
    ...
    public class PrinterShareItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.Print.Shares.Item.AllowedGroups.AllowedGroupsRequestBuilder AllowedGroups
        {
            get => new Microsoft.Graph.Beta.Print.Shares.Item.AllowedGroups.AllowedGroupsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the allowedUsers property of the microsoft.graph.printerShare entity.</summary>
        public Microsoft.Graph.Beta.Print.Shares.Item.AllowedUsers.AllowedUsersRequestBuilder AllowedUsers
        {
            get => new Microsoft.Graph.Beta.Print.Shares.Item.AllowedUsers.AllowedUsersRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the jobs property of the microsoft.graph.printerBase entity.</summary>
        public Microsoft.Graph.Beta.Print.Shares.Item.Jobs.JobsRequestBuilder Jobs
        {
            get => new Microsoft.Graph.Beta.Print.Shares.Item.Jobs.JobsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the printer property of the microsoft.graph.printerShare entity.</summary>
        public Microsoft.Graph.Beta.Print.Shares.Item.Printer.PrinterRequestBuilder Printer
        {
            get => new Microsoft.Graph.Beta.Print.Shares.Item.Printer.PrinterRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Print.Shares.Item.PrinterShareItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.PrinterShare?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Print.Shares.Item.PrinterShareItemRequestBuilder.PrinterShareItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.PrinterShare> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Print.Shares.Item.PrinterShareItemRequestBuilder.PrinterShareItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Print.Shares.Item.PrinterShareItemRequestBuilder.PrinterShareItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Print.Shares.Item.PrinterShareItemRequestBuilder.PrinterShareItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Print.Shares.Item.PrinterShareItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Print.Shares.Item.PrinterShareItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class PrinterShareItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.Print.Shares.Item.PrinterShareItemRequestBuilder.PrinterShareItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
