...
namespace Microsoft.Graph.Beta.Identity.AuthenticationEventsFlows.GraphExternalUsersSelfServiceSignUpEventsFlow {
    ...
    public class GraphExternalUsersSelfServiceSignUpEventsFlowRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphExternalUsersSelfServiceSignUpEventsFlowRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identity/authenticationEventsFlows/graph.externalUsersSelfServiceSignUpEventsFlow{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ExternalUsersSelfServiceSignUpEventsFlowCollectionResponse?> GetAsync(Action<GraphExternalUsersSelfServiceSignUpEventsFlowRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ExternalUsersSelfServiceSignUpEventsFlowCollectionResponse> GetAsync(Action<GraphExternalUsersSelfServiceSignUpEventsFlowRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
