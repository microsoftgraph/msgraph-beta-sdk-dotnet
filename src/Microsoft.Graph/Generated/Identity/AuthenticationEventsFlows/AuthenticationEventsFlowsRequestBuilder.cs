...
#nullable enable
        public async Task<AuthenticationEventsFlowCollectionResponse?> GetAsync(Action<AuthenticationEventsFlowsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<AuthenticationEventsFlowCollectionResponse> GetAsync(Action<AuthenticationEventsFlowsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AuthenticationEventsFlow?> PostAsync(AuthenticationEventsFlow body, Action<AuthenticationEventsFlowsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<AuthenticationEventsFlow> PostAsync(AuthenticationEventsFlow body, Action<AuthenticationEventsFlowsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
