...
namespace Microsoft.Graph.Beta.Identity.AuthenticationEventsFlows.Item.GraphExternalUsersSelfServiceSignUpEventsFlow.OnAttributeCollection.GraphOnAttributeCollectionExternalUsersSelfServiceSignUp {
    ...
    public class GraphOnAttributeCollectionExternalUsersSelfServiceSignUpRequestBuilder : BaseRequestBuilder 
    {
        ...
        {
            get =>             new AttributesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="GraphOnAttributeCollectionExternalUsersSelfServiceSignUpRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
