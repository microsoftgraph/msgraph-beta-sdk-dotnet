...
#nullable enable
        public async Task<IdentityUserFlowAttributeCollectionResponse?> GetAsync(Action<AttributesRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<IdentityUserFlowAttributeCollectionResponse> GetAsync(Action<AttributesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<AttributesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<AttributesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new AttributesRequestBuilderGetRequestConfiguration();
...
#nullable restore
        ...
        public class AttributesRequestBuilderGetRequestConfiguration {
            ...
            public AttributesRequestBuilderGetQueryParameters QueryParameters { get; set; } = new AttributesRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new attributesRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public AttributesRequestBuilderGetRequestConfiguration() {
