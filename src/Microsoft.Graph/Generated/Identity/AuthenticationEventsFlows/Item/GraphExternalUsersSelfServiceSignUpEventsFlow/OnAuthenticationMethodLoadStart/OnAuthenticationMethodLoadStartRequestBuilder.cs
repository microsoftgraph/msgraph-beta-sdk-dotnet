...
namespace Microsoft.Graph.Beta.Identity.AuthenticationEventsFlows.Item.GraphExternalUsersSelfServiceSignUpEventsFlow.OnAuthenticationMethodLoadStart {
    ...
    public class OnAuthenticationMethodLoadStartRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OnAuthenticationMethodLoadStartRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identity/authenticationEventsFlows/{authenticationEventsFlow%2Did}/graph.externalUsersSelfServiceSignUpEventsFlow/onAuthenticationMethodLoadStart{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<OnAuthenticationMethodLoadStartHandler?> GetAsync(Action<OnAuthenticationMethodLoadStartRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<OnAuthenticationMethodLoadStartHandler> GetAsync(Action<OnAuthenticationMethodLoadStartRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<OnAuthenticationMethodLoadStartRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<OnAuthenticationMethodLoadStartRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new OnAuthenticationMethodLoadStartRequestBuilderGetRequestConfiguration();
...
#nullable restore
        ...
        public class OnAuthenticationMethodLoadStartRequestBuilderGetRequestConfiguration {
            ...
            public OnAuthenticationMethodLoadStartRequestBuilderGetQueryParameters QueryParameters { get; set; } = new OnAuthenticationMethodLoadStartRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new onAuthenticationMethodLoadStartRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public OnAuthenticationMethodLoadStartRequestBuilderGetRequestConfiguration() {
