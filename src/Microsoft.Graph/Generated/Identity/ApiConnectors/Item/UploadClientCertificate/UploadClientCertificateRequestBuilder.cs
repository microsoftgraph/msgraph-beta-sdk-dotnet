...
namespace Microsoft.Graph.Beta.Identity.ApiConnectors.Item.UploadClientCertificate {
    ...
    public class UploadClientCertificateRequestBuilder {
        ...
        /// </summary>
        public async Task<IdentityApiConnector> PostAsync(UploadClientCertificateRequestBody body, Action<UploadClientCertificateRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
