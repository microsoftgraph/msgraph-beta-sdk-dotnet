...
namespace Microsoft.Graph.Beta.Identity.IdentityProviders
{
    ...
    public class IdentityProvidersRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.Identity.IdentityProviders.AvailableProviderTypes.AvailableProviderTypesRequestBuilder AvailableProviderTypes
        {
            get => new Microsoft.Graph.Beta.Identity.IdentityProviders.AvailableProviderTypes.AvailableProviderTypesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to count the resources in the collection.</summary>
        public Microsoft.Graph.Beta.Identity.IdentityProviders.Count.CountRequestBuilder Count
        {
            get => new Microsoft.Graph.Beta.Identity.IdentityProviders.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Microsoft.Graph.Beta.Identity.IdentityProviders.Item.IdentityProviderBaseItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("identityProviderBase%2Did", position);
                return new Microsoft.Graph.Beta.Identity.IdentityProviders.Item.IdentityProviderBaseItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Identity.IdentityProviders.IdentityProvidersRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Identity.IdentityProviders.IdentityProvidersRequestBuilder.IdentityProvidersRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Identity.IdentityProviders.IdentityProvidersRequestBuilder.IdentityProvidersRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Identity.IdentityProviders.IdentityProvidersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Identity.IdentityProviders.IdentityProvidersRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Identity.IdentityProviders.IdentityProvidersRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get a collection of identity provider resources that are configured for a tenant, and that are derived from identityProviderBase. For a Microsoft Entra tenant, the providers can be socialIdentityProviders or builtinIdentityProviders objects. For an Azure AD B2C, the providers can be socialIdentityProvider, openIdConnectIdentityProvider, or appleManagedIdentityProvider objects.
        /// </summary>
...
#nullable restore
        ...
        public class IdentityProvidersRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.Identity.IdentityProviders.IdentityProvidersRequestBuilder.IdentityProvidersRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
