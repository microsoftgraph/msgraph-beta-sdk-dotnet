...
#nullable enable
        public async Task<AuthenticationConfigurationValidation?> PostAsync(ValidateAuthenticationConfigurationPostRequestBody body, CancellationToken cancellationToken = default, Action<ValidateAuthenticationConfigurationRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AuthenticationConfigurationValidation> PostAsync(ValidateAuthenticationConfigurationPostRequestBody body, CancellationToken cancellationToken = default, Action<ValidateAuthenticationConfigurationRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
