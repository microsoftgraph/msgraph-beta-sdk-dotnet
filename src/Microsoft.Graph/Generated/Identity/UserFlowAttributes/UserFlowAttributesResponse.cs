...
namespace MicrosoftGraphSdk.Identity.UserFlowAttributes {
    public class UserFlowAttributesResponse : IParsable {
        ...
        /// </summary>
        public static UserFlowAttributesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UserFlowAttributesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UserFlowAttributesResponse).Value = n.GetCollectionOfObjectValues<IdentityUserFlowAttribute>(IdentityUserFlowAttribute.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
