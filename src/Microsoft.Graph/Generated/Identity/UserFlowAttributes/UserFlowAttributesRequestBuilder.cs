...
namespace MicrosoftGraphSdk.Identity.UserFlowAttributes {
    ...
    public class UserFlowAttributesRequestBuilder {
        ...
        public async Task<UserFlowAttributesResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<UserFlowAttributesResponse>(requestInfo, UserFlowAttributesResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// Represents entry point for identity userflow attributes.
        /// <param name="body"></param>
