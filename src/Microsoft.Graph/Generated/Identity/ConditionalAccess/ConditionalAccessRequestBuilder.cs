...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ConditionalAccessRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ConditionalAccessRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ConditionalAccessRoot?> GetAsync(CancellationToken cancellationToken = default, Action<ConditionalAccessRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ConditionalAccessRoot> GetAsync(CancellationToken cancellationToken = default, Action<ConditionalAccessRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ConditionalAccessRoot?> PatchAsync(ConditionalAccessRoot body, CancellationToken cancellationToken = default, Action<ConditionalAccessRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ConditionalAccessRoot> PatchAsync(ConditionalAccessRoot body, CancellationToken cancellationToken = default, Action<ConditionalAccessRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
