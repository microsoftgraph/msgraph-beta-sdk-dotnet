...
namespace MicrosoftGraphSdk.Identity.ConditionalAccess.NamedLocations {
    ...
    public class NamedLocationsRequestBuilder {
        ...
        /// </summary>
        public async Task<NamedLocationCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
