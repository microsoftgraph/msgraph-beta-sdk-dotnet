...
namespace MicrosoftGraph.Identity.ConditionalAccess.NamedLocations {
    ...
    public class NamedLocationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.identity.conditionalAccess.namedLocations.item collection</summary>
        public NamedLocationsRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("namedLocation_id", position);
            return new NamedLocationsRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
