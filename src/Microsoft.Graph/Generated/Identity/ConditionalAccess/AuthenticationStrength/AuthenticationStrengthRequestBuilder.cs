...
namespace Microsoft.Graph.Beta.Identity.ConditionalAccess.AuthenticationStrength {
    ...
    public class AuthenticationStrengthRequestBuilder : BaseRequestBuilder 
    {
        ...
        {
            get =>             new AuthenticationMethodModesRequestBuilder(PathParameters, RequestAdapter);
        }
...
#nullable restore
        ...
        public async Task<AuthenticationStrengthRoot> GetAsync(Action<RequestConfiguration<AuthenticationStrengthRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<AuthenticationStrengthRoot>(requestInfo, AuthenticationStrengthRoot.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="AuthenticationStrengthRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class AuthenticationStrengthRequestBuilderGetRequestConfiguration : RequestConfiguration<AuthenticationStrengthRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
