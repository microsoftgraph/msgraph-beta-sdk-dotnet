...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AuthenticationStrengthRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AuthenticationStrengthRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AuthenticationStrengthRoot?> GetAsync(CancellationToken cancellationToken = default, Action<AuthenticationStrengthRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AuthenticationStrengthRoot> GetAsync(CancellationToken cancellationToken = default, Action<AuthenticationStrengthRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AuthenticationStrengthRoot?> PatchAsync(AuthenticationStrengthRoot body, CancellationToken cancellationToken = default, Action<AuthenticationStrengthRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AuthenticationStrengthRoot> PatchAsync(AuthenticationStrengthRoot body, CancellationToken cancellationToken = default, Action<AuthenticationStrengthRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
