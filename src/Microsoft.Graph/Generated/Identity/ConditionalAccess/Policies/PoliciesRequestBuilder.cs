...
namespace Microsoft.Graph.Beta.Identity.ConditionalAccess.Policies {
    ...
    public class PoliciesRequestBuilder {
        ...
        /// </summary>
        public async Task<ConditionalAccessPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ConditionalAccessPolicy> PostAsync(ConditionalAccessPolicy body, CancellationToken cancellationToken = default, Action<PoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
