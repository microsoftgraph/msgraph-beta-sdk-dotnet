...
#nullable enable
        public async Task<ConditionalAccessPolicyCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<PoliciesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ConditionalAccessPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ConditionalAccessPolicy?> PostAsync(ConditionalAccessPolicy body, CancellationToken cancellationToken = default, Action<PoliciesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ConditionalAccessPolicy> PostAsync(ConditionalAccessPolicy body, CancellationToken cancellationToken = default, Action<PoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
