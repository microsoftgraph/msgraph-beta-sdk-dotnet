...
namespace Microsoft.Graph.Beta.Identity.ConditionalAccess.AuthenticationStrengths {
    ...
    public class AuthenticationStrengthsRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AuthenticationStrengthsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AuthenticationStrengthRoot> GetAsync(CancellationToken cancellationToken = default, Action<AuthenticationStrengthsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AuthenticationStrengthRoot body, CancellationToken cancellationToken = default, Action<AuthenticationStrengthsRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
