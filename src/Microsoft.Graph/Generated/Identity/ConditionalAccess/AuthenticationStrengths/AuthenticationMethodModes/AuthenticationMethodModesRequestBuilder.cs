...
#nullable enable
        public async Task<AuthenticationMethodModeDetailCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AuthenticationMethodModesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AuthenticationMethodModeDetailCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AuthenticationMethodModesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AuthenticationMethodModeDetail?> PostAsync(AuthenticationMethodModeDetail body, CancellationToken cancellationToken = default, Action<AuthenticationMethodModesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AuthenticationMethodModeDetail> PostAsync(AuthenticationMethodModeDetail body, CancellationToken cancellationToken = default, Action<AuthenticationMethodModesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
