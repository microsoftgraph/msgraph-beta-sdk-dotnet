...
namespace Microsoft.Graph.Beta.Identity.ConditionalAccess.AuthenticationStrengths.Policies {
    ...
    public class PoliciesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.identity.conditionalAccess.authenticationStrengths.policies.item collection</summary>
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AuthenticationStrengthPolicy body, Action<PoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<AuthenticationStrengthPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AuthenticationStrengthPolicy> PostAsync(AuthenticationStrengthPolicy body, CancellationToken cancellationToken = default, Action<PoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
