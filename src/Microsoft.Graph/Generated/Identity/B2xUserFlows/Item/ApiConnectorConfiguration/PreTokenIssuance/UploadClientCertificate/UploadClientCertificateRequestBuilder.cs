...
namespace Microsoft.Graph.Beta.Identity.B2xUserFlows.Item.ApiConnectorConfiguration.PreTokenIssuance.UploadClientCertificate {
    ...
    public class UploadClientCertificateRequestBuilder : BaseRequestBuilder {
        ...
        public UploadClientCertificateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/apiConnectorConfiguration/preTokenIssuance/uploadClientCertificate", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UploadClientCertificateRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UploadClientCertificateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/apiConnectorConfiguration/preTokenIssuance/uploadClientCertificate", rawUrl) {
        }
        /// <summary>
