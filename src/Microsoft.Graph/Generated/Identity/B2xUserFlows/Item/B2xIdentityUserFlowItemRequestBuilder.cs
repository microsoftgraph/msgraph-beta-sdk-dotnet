...
namespace Microsoft.Graph.Beta.Identity.B2xUserFlows.Item {
    ...
    public class B2xIdentityUserFlowItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        {
            get => new ApiConnectorConfigurationRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new UserAttributeAssignmentsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new UserFlowIdentityProvidersRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="B2xIdentityUserFlowItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class B2xIdentityUserFlowItemRequestBuilderGetRequestConfiguration : RequestConfiguration<B2xIdentityUserFlowItemRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
