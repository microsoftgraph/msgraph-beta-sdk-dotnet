...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<B2xIdentityUserFlowItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<B2xIdentityUserFlowItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<B2xIdentityUserFlow?> GetAsync(CancellationToken cancellationToken = default, Action<B2xIdentityUserFlowItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<B2xIdentityUserFlow> GetAsync(CancellationToken cancellationToken = default, Action<B2xIdentityUserFlowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<B2xIdentityUserFlow?> PatchAsync(B2xIdentityUserFlow body, CancellationToken cancellationToken = default, Action<B2xIdentityUserFlowItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<B2xIdentityUserFlow> PatchAsync(B2xIdentityUserFlow body, CancellationToken cancellationToken = default, Action<B2xIdentityUserFlowItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
