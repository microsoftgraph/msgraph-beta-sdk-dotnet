...
namespace Microsoft.Graph.Beta.Identity.B2xUserFlows.Item.UserFlowIdentityProviders {
    ...
    public class UserFlowIdentityProvidersRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<UserFlowIdentityProvidersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<IdentityProviderBaseCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UserFlowIdentityProvidersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
