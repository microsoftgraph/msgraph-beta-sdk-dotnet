...
using MicrosoftGraph.Identity.B2xUserFlows.Item.UserAttributeAssignments.GetOrder;
using MicrosoftGraph.Identity.B2xUserFlows.Item.UserAttributeAssignments.Item;
using MicrosoftGraph.Identity.B2xUserFlows.Item.UserAttributeAssignments.SetOrder;
...
namespace MicrosoftGraph.Identity.B2xUserFlows.Item.UserAttributeAssignments {
    ...
    public class UserAttributeAssignmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.identity.b2xUserFlows.item.userAttributeAssignments.item collection</summary>
