...
#nullable enable
        public async Task PostAsync(SetOrderPostRequestBody body, CancellationToken cancellationToken = default, Action<SetOrderRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(SetOrderPostRequestBody body, CancellationToken cancellationToken = default, Action<SetOrderRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
