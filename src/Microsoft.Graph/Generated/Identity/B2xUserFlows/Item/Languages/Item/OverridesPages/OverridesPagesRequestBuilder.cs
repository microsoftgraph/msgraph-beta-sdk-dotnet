...
using MicrosoftGraph.Identity.B2xUserFlows.Item.Languages.Item.OverridesPages.Item;
...
namespace MicrosoftGraph.Identity.B2xUserFlows.Item.Languages.Item.OverridesPages {
    ...
    public class OverridesPagesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.identity.b2xUserFlows.item.languages.item.overridesPages.item collection</summary>
