...
namespace Microsoft.Graph.Beta.Identity.B2xUserFlows.Item.Languages.Item.DefaultPages {
    ...
    public class DefaultPagesRequestBuilder {
        ...
        /// </summary>
        public async Task<UserFlowLanguagePageCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DefaultPagesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UserFlowLanguagePage> PostAsync(UserFlowLanguagePage body, CancellationToken cancellationToken = default, Action<DefaultPagesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
