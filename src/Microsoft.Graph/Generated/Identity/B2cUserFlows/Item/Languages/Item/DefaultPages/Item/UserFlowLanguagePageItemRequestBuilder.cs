...
using MicrosoftGraphSdk.Identity.B2cUserFlows.Item.Languages.Item.DefaultPages.Item.Value;
...
namespace MicrosoftGraphSdk.Identity.B2cUserFlows.Item.Languages.Item.DefaultPages.Item {
    /// <summary>Builds and executes requests for operations under \identity\b2cUserFlows\{b2cIdentityUserFlow-id}\languages\{userFlowLanguageConfiguration-id}\defaultPages\{userFlowLanguagePage-id}</summary>
    public class UserFlowLanguagePageItemRequestBuilder {
        ...
        public UserFlowLanguagePageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow_id}/languages/{userFlowLanguageConfiguration_id}/defaultPages/{userFlowLanguagePage_id}{?select,expand}";
