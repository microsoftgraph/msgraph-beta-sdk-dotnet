...
namespace Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.Languages.Item.DefaultPages.Item {
    ...
    public class UserFlowLanguagePageItemRequestBuilder {
        ...
        public UserFlowLanguagePageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/languages/{userFlowLanguageConfiguration%2Did}/defaultPages/{userFlowLanguagePage%2Did}{?%24select,%24expand}";
