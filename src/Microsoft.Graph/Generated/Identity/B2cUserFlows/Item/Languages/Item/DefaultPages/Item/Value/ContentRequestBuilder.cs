...
namespace MicrosoftGraphSdk.Identity.B2cUserFlows.Item.Languages.Item.DefaultPages.Item.Value {
    /// <summary>Builds and executes requests for operations under \identity\b2cUserFlows\{b2cIdentityUserFlow-id}\languages\{userFlowLanguageConfiguration-id}\defaultPages\{userFlowLanguagePage-id}\$value</summary>
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow_id}/languages/{userFlowLanguageConfiguration_id}/defaultPages/{userFlowLanguagePage_id}/$value";
