...
using MicrosoftGraphSdk.Identity.B2cUserFlows.Item.Languages.Item.DefaultPages.Item;
...
namespace MicrosoftGraphSdk.Identity.B2cUserFlows.Item.Languages.Item.DefaultPages {
    /// <summary>Builds and executes requests for operations under \identity\b2cUserFlows\{b2cIdentityUserFlow-id}\languages\{userFlowLanguageConfiguration-id}\defaultPages</summary>
    public class DefaultPagesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.identity.b2cUserFlows.item.languages.item.defaultPages.item collection</summary>
        ...
        public DefaultPagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow_id}/languages/{userFlowLanguageConfiguration_id}/defaultPages{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
