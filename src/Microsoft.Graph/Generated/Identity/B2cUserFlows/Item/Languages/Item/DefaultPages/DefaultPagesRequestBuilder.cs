...
using MicrosoftGraph.Identity.B2cUserFlows.Item.Languages.Item.DefaultPages.Item;
...
namespace MicrosoftGraph.Identity.B2cUserFlows.Item.Languages.Item.DefaultPages {
    ...
    public class DefaultPagesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.identity.b2cUserFlows.item.languages.item.defaultPages.item collection</summary>
