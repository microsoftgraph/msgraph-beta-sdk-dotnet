...
using MicrosoftGraphSdk.Identity.B2cUserFlows.Item.IdentityProviders.Count;
using MicrosoftGraphSdk.Identity.B2cUserFlows.Item.IdentityProviders.Item;
...
namespace MicrosoftGraphSdk.Identity.B2cUserFlows.Item.IdentityProviders {
    ...
    public class IdentityProvidersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.identity.b2cUserFlows.item.identityProviders.item collection</summary>
        ...
        public IdentityProvidersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow_id}/identityProviders{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public async Task<IdentityProviderCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
