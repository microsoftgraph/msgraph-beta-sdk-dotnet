...
namespace Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.IdentityProviders {
    ...
    public class IdentityProvidersRequestBuilder : BaseRequestBuilder {
        ...
        public IdentityProvidersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/identityProviders{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new IdentityProvidersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/b2cidentityuserflow-list-identityproviders?view=graph-rest-1.0" />
        /// </summary>
