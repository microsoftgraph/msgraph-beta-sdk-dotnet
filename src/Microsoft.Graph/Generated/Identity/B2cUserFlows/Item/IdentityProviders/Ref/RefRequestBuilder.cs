...
namespace Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.IdentityProviders.Ref
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.IdentityProviders.Ref.RefRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task DeleteAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.IdentityProviders.Ref.RefRequestBuilder.RefRequestBuilderDeleteQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task DeleteAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.IdentityProviders.Ref.RefRequestBuilder.RefRequestBuilderDeleteQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.IdentityProviders.Ref.RefRequestBuilder.RefRequestBuilderDeleteQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.IdentityProviders.Ref.RefRequestBuilder.RefRequestBuilderDeleteQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.IdentityProviders.Ref.RefRequestBuilder.RefRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.IdentityProviders.Ref.RefRequestBuilder.RefRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.IdentityProviders.Ref.RefRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("The identityProvider API is deprecated and will stop returning data on March 2023. Please use the new identityProviderBase API. as of 2021-05/identityProvider")]
        public Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.IdentityProviders.Ref.RefRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.IdentityProviders.Ref.RefRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Delete an identity provider from a b2cIdentityUserFlow object. For more information about identity providers available for user flows, see the identityProviders API reference.
        /// </summary>
...
#nullable restore
        ...
        public class RefRequestBuilderDeleteRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.IdentityProviders.Ref.RefRequestBuilder.RefRequestBuilderDeleteQueryParameters>
        {
        }
        /// <summary>
        /// Get the identity providers in a b2cIdentityUserFlow object.
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class RefRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.IdentityProviders.Ref.RefRequestBuilder.RefRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
