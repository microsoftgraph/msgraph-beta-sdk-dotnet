...
namespace MicrosoftGraphSdk.Identity.B2cUserFlows.Item.UserFlowIdentityProviders.Item {
    ...
    public class IdentityProviderBaseItemRequestBuilder {
        ...
        public IdentityProviderBaseItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow_id}/userFlowIdentityProviders/{identityProviderBase_id}{?select,expand}";
