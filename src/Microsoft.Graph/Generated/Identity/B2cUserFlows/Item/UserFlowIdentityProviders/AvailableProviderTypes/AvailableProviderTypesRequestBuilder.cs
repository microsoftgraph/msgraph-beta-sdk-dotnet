...
namespace MicrosoftGraphSdk.Identity.B2cUserFlows.Item.UserFlowIdentityProviders.AvailableProviderTypes {
    /// <summary>Builds and executes requests for operations under \identity\b2cUserFlows\{b2cIdentityUserFlow-id}\userFlowIdentityProviders\microsoft.graph.availableProviderTypes()</summary>
    public class AvailableProviderTypesRequestBuilder {
        ...
        public AvailableProviderTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow_id}/userFlowIdentityProviders/microsoft.graph.availableProviderTypes()";
