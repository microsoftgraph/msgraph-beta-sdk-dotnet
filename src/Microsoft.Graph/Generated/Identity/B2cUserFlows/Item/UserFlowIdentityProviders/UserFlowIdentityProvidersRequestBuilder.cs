...
namespace MicrosoftGraph.Identity.B2cUserFlows.Item.UserFlowIdentityProviders {
    ...
    public class UserFlowIdentityProvidersRequestBuilder {
        ...
        /// <summary>
        /// Builds and executes requests for operations under \identity\b2cUserFlows\{b2cIdentityUserFlow-id}\userFlowIdentityProviders\microsoft.graph.availableProviderTypes()
        /// </summary>
