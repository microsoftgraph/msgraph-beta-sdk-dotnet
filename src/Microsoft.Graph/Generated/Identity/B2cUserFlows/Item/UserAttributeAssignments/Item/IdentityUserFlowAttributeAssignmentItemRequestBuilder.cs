...
using MicrosoftGraphSdk.Identity.B2cUserFlows.Item.UserAttributeAssignments.Item.UserAttribute;
...
namespace MicrosoftGraphSdk.Identity.B2cUserFlows.Item.UserAttributeAssignments.Item {
    /// <summary>Builds and executes requests for operations under \identity\b2cUserFlows\{b2cIdentityUserFlow-id}\userAttributeAssignments\{identityUserFlowAttributeAssignment-id}</summary>
    public class IdentityUserFlowAttributeAssignmentItemRequestBuilder {
        ...
        public IdentityUserFlowAttributeAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow_id}/userAttributeAssignments/{identityUserFlowAttributeAssignment_id}{?select,expand}";
