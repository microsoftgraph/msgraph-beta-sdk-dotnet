...
namespace Microsoft.Graph.Beta.Identity.B2cUserFlows.Item.UserAttributeAssignments.GetOrder {
    ...
    public class GetOrderRequestBuilder : BaseRequestBuilder {
        ...
        public GetOrderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments/getOrder()", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetOrderRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetOrderRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments/getOrder()", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<AssignmentOrder?> GetAsync(CancellationToken cancellationToken = default, Action<GetOrderRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AssignmentOrder> GetAsync(CancellationToken cancellationToken = default, Action<GetOrderRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
