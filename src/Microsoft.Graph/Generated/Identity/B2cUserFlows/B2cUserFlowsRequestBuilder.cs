...
namespace Microsoft.Graph.Beta.Identity.B2cUserFlows
{
    ...
    public class B2cUserFlowsRequestBuilder : BaseRequestBuilder
    {
        ...
        public B2cIdentityUserFlowItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="B2cUserFlowsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class B2cUserFlowsRequestBuilderGetRequestConfiguration : RequestConfiguration<B2cUserFlowsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
