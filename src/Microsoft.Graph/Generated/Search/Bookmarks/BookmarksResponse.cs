...
namespace MicrosoftGraphSdk.Search.Bookmarks {
    public class BookmarksResponse : IParsable {
        ...
        /// </summary>
        public static BookmarksResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as BookmarksResponse).Value = n.GetCollectionOfObjectValues<Bookmark>(Bookmark.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
