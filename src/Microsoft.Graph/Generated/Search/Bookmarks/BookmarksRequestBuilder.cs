...
namespace Microsoft.Graph.Beta.Search.Bookmarks {
    ...
    public class BookmarksRequestBuilder {
        ...
        /// </summary>
        public async Task<BookmarkCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<BookmarksRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Bookmark> PostAsync(Bookmark body, CancellationToken cancellationToken = default, Action<BookmarksRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
