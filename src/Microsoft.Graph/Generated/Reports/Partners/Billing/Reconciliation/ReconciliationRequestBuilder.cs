...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Microsoft.Graph.Beta.Models.Partners.Billing.BillingReconciliation?> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Reports.Partners.Billing.Reconciliation.ReconciliationRequestBuilder.ReconciliationRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Microsoft.Graph.Beta.Models.Partners.Billing.BillingReconciliation> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Reports.Partners.Billing.Reconciliation.ReconciliationRequestBuilder.ReconciliationRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Microsoft.Graph.Beta.Models.Partners.Billing.BillingReconciliation>(requestInfo, global::Microsoft.Graph.Beta.Models.Partners.Billing.BillingReconciliation.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Reports.Partners.Billing.Reconciliation.ReconciliationRequestBuilder.ReconciliationRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Reports.Partners.Billing.Reconciliation.ReconciliationRequestBuilder.ReconciliationRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Reports.Partners.Billing.Reconciliation.ReconciliationRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Beta.Reports.Partners.Billing.Reconciliation.ReconciliationRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Beta.Reports.Partners.Billing.Reconciliation.ReconciliationRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
