...
namespace Microsoft.Graph.Beta.Reports.Partners.Billing.Usage.Unbilled {
    ...
    public class UnbilledRequestBuilder : BaseRequestBuilder {
        ...
        public UnbilledRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/partners/billing/usage/unbilled{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UnbilledRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnbilledRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/partners/billing/usage/unbilled{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
