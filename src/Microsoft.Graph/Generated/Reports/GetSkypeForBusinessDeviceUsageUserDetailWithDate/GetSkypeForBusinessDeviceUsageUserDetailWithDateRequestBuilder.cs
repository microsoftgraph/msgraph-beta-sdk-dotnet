...
namespace Microsoft.Graph.Beta.Reports.GetSkypeForBusinessDeviceUsageUserDetailWithDate {
    ...
    public class GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<GetSkypeForBusinessDeviceUsageUserDetailWithDateResponse> GetAsync(Action<GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<GetSkypeForBusinessDeviceUsageUserDetailWithDateResponse>(requestInfo, GetSkypeForBusinessDeviceUsageUserDetailWithDateResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
