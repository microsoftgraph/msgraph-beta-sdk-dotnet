...
namespace Microsoft.Graph.Beta.Reports.GetSkypeForBusinessDeviceUsageUserDetailWithDate {
    ...
    public class GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new <see cref="GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder WithUrl(string rawUrl) {
            return new GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
