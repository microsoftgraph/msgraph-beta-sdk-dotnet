...
namespace Microsoft.Graph.Beta.Reports.GetTeamsDeviceUsageUserCountsWithPeriod {
    ...
    /// </summary>
    public class GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        /// <summary>
        ...
        public GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/reports/getTeamsDeviceUsageUserCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/getTeamsDeviceUsageUserCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(CancellationToken cancellationToken = default, Action<GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
