...
namespace Microsoft.Graph.Beta.Reports.GetTeamsDeviceUsageUserCountsWithPeriod {
    ...
    public class GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder {
        ...
        public GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/reports/getTeamsDeviceUsageUserCounts(period='{period}')";
