...
namespace Microsoft.Graph.Beta.Reports.GetTeamsDeviceUsageUserCountsWithPeriod {
    ...
    public class GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
