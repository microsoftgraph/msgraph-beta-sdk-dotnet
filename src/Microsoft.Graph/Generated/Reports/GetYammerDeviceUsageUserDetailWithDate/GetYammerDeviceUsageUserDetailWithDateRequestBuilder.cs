...
namespace Microsoft.Graph.Beta.Reports.GetYammerDeviceUsageUserDetailWithDate {
    ...
    public class GetYammerDeviceUsageUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<GetYammerDeviceUsageUserDetailWithDateResponse> GetAsync(Action<GetYammerDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<GetYammerDeviceUsageUserDetailWithDateResponse>(requestInfo, GetYammerDeviceUsageUserDetailWithDateResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
