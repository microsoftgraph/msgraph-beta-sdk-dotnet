...
namespace MicrosoftGraphSdk.Reports.GetAttackSimulationTrainingUserCoverage {
    ...
    public class GetAttackSimulationTrainingUserCoverageRequestBuilder {
        ...
        public GetAttackSimulationTrainingUserCoverageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/reports/microsoft.graph.getAttackSimulationTrainingUserCoverage()";
        ...
        /// </summary>
        public async Task<GetAttackSimulationTrainingUserCoverageResponse> GetAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
