...
namespace Microsoft.Graph.Beta.Reports.GetOneDriveUsageAccountCountsWithPeriod {
    ...
    public class GetOneDriveUsageAccountCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetOneDriveUsageAccountCountsWithPeriodResponse> GetAsync(Action<GetOneDriveUsageAccountCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<GetOneDriveUsageAccountCountsWithPeriodResponse>(requestInfo, GetOneDriveUsageAccountCountsWithPeriodResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
