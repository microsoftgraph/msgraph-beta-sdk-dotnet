...
namespace Microsoft.Graph.Beta.Reports.GetSkypeForBusinessOrganizerActivityCountsWithPeriod {
    ...
    public class GetSkypeForBusinessOrganizerActivityCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetSkypeForBusinessOrganizerActivityCountsWithPeriodResponse> GetAsync(Action<GetSkypeForBusinessOrganizerActivityCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
