...
namespace Microsoft.Graph.Beta.Reports.GetOneDriveActivityUserDetailWithDate {
    ...
    public class GetOneDriveActivityUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetOneDriveActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
