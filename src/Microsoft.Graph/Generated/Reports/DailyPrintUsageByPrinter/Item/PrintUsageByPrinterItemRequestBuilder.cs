...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PrintUsageByPrinterItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PrintUsageByPrinterItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PrintUsageByPrinter?> GetAsync(CancellationToken cancellationToken = default, Action<PrintUsageByPrinterItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintUsageByPrinter> GetAsync(CancellationToken cancellationToken = default, Action<PrintUsageByPrinterItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PrintUsageByPrinter?> PatchAsync(PrintUsageByPrinter body, CancellationToken cancellationToken = default, Action<PrintUsageByPrinterItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintUsageByPrinter> PatchAsync(PrintUsageByPrinter body, CancellationToken cancellationToken = default, Action<PrintUsageByPrinterItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
