...
namespace MicrosoftGraphSdk.Reports.DailyPrintUsageByPrinter.Item {
    ...
    public class PrintUsageByPrinterItemRequestBuilder {
        ...
        public async Task<PrintUsageByPrinter> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<PrintUsageByPrinter>(requestInfo, PrintUsageByPrinter.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// Update the navigation property dailyPrintUsageByPrinter in reports
        /// <param name="body"></param>
