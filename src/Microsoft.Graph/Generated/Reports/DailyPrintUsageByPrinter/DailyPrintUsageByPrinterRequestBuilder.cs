...
namespace Microsoft.Graph.Beta.Reports.DailyPrintUsageByPrinter {
    ...
    public class DailyPrintUsageByPrinterRequestBuilder {
        ...
        /// </summary>
        public async Task<PrintUsageByPrinterCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DailyPrintUsageByPrinterRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PrintUsageByPrinter> PostAsync(PrintUsageByPrinter body, CancellationToken cancellationToken = default, Action<DailyPrintUsageByPrinterRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
