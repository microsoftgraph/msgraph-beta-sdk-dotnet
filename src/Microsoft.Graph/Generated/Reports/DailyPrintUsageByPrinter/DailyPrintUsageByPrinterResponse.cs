...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Reports.DailyPrintUsageByPrinter {
    public class DailyPrintUsageByPrinterResponse : IParsable {
        ...
        /// </summary>
        public static DailyPrintUsageByPrinterResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DailyPrintUsageByPrinterResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DailyPrintUsageByPrinterResponse).Value = n.GetCollectionOfObjectValues<PrintUsageByPrinter>(PrintUsageByPrinter.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
