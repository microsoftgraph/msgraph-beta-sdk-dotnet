...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalSignInActivityItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalSignInActivityItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ServicePrincipalSignInActivity?> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalSignInActivityItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServicePrincipalSignInActivity> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalSignInActivityItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ServicePrincipalSignInActivity?> PatchAsync(ServicePrincipalSignInActivity body, CancellationToken cancellationToken = default, Action<ServicePrincipalSignInActivityItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServicePrincipalSignInActivity> PatchAsync(ServicePrincipalSignInActivity body, CancellationToken cancellationToken = default, Action<ServicePrincipalSignInActivityItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
