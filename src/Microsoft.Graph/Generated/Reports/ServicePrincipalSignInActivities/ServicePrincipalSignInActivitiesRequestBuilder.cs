...
namespace Microsoft.Graph.Beta.Reports.ServicePrincipalSignInActivities {
    ...
    public class ServicePrincipalSignInActivitiesRequestBuilder : BaseRequestBuilder {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/reportroot-list-serviceprincipalsigninactivities?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ServicePrincipalSignInActivityCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalSignInActivitiesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServicePrincipalSignInActivityCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalSignInActivitiesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ServicePrincipalSignInActivity?> PostAsync(ServicePrincipalSignInActivity body, CancellationToken cancellationToken = default, Action<ServicePrincipalSignInActivitiesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServicePrincipalSignInActivity> PostAsync(ServicePrincipalSignInActivity body, CancellationToken cancellationToken = default, Action<ServicePrincipalSignInActivitiesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
