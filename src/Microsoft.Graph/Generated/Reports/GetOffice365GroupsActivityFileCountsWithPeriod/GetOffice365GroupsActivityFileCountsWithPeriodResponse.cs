...
namespace Microsoft.Graph.Beta.Reports.GetOffice365GroupsActivityFileCountsWithPeriod {
    ...
    public class GetOffice365GroupsActivityFileCountsWithPeriodResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Office365GroupsActivityFileCounts> Value {
            get { return BackingStore?.Get<List<Office365GroupsActivityFileCounts>>(nameof(Value)); }
