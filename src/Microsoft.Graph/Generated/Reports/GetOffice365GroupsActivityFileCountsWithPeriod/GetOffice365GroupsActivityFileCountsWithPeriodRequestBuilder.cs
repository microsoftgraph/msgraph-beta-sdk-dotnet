...
namespace Microsoft.Graph.Beta.Reports.GetOffice365GroupsActivityFileCountsWithPeriod {
    ...
    public class GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/getOffice365GroupsActivityFileCounts(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<GetOffice365GroupsActivityFileCountsWithPeriodResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetOffice365GroupsActivityFileCountsWithPeriodResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
