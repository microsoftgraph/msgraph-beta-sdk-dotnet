...
namespace Microsoft.Graph.Beta.Reports.GetOffice365GroupsActivityFileCountsWithPeriod {
    ...
    public class GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetOffice365GroupsActivityFileCountsWithPeriodResponse> GetAsync(Action<GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<GetOffice365GroupsActivityFileCountsWithPeriodResponse>(requestInfo, GetOffice365GroupsActivityFileCountsWithPeriodResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>Invoke function getOffice365GroupsActivityFileCounts</summary>
        ...
        public class GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration {
            ...
            public GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilderGetQueryParameters QueryParameters { get; set; } = new GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilderGetQueryParameters();
            /// <summary>
