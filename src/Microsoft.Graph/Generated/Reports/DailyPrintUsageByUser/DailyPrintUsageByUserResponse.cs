...
namespace MicrosoftGraphSdk.Reports.DailyPrintUsageByUser {
    public class DailyPrintUsageByUserResponse : IParsable {
        ...
        /// </summary>
        public static DailyPrintUsageByUserResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DailyPrintUsageByUserResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DailyPrintUsageByUserResponse).Value = n.GetCollectionOfObjectValues<PrintUsageByUser>(PrintUsageByUser.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
