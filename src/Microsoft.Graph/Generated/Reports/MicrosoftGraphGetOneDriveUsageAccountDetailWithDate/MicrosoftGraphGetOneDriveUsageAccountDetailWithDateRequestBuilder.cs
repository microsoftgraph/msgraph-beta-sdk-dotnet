...
namespace Microsoft.Graph.Beta.Reports.MicrosoftGraphGetOneDriveUsageAccountDetailWithDate {
    /// <summary>
    ...
    public class MicrosoftGraphGetOneDriveUsageAccountDetailWithDateRequestBuilder {
        ...
        public MicrosoftGraphGetOneDriveUsageAccountDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Date? date = default) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphGetOneDriveUsageAccountDetailWithDateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<MicrosoftGraphGetOneDriveUsageAccountDetailWithDateRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<MicrosoftGraphGetOneDriveUsageAccountDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
