...
namespace Microsoft.Graph.Beta.Reports.GetOffice365GroupsActivityGroupCountsWithPeriod {
    ...
    public class GetOffice365GroupsActivityGroupCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetOffice365GroupsActivityGroupCountsWithPeriodGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function getOffice365GroupsActivityGroupCounts
        /// </summary>
        /// <returns>A <cref="GetOffice365GroupsActivityGroupCountsWithPeriodResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
