...
using Microsoft.Graph.Beta.Reports.MonthlyPrintUsageSummariesByPrinter.Count;
using Microsoft.Graph.Beta.Reports.MonthlyPrintUsageSummariesByPrinter.Item;
...
using System;
namespace Microsoft.Graph.Beta.Reports.MonthlyPrintUsageSummariesByPrinter {
    /// <summary>
    ...
    public class MonthlyPrintUsageSummariesByPrinterRequestBuilder : BaseRequestBuilder {
        ...
        public MonthlyPrintUsageSummariesByPrinterRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/monthlyPrintUsageSummariesByPrinter{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MonthlyPrintUsageSummariesByPrinterRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MonthlyPrintUsageSummariesByPrinterRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/monthlyPrintUsageSummariesByPrinter{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<PrintUsageByPrinterCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<MonthlyPrintUsageSummariesByPrinterRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintUsageByPrinterCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MonthlyPrintUsageSummariesByPrinterRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PrintUsageByPrinter?> PostAsync(PrintUsageByPrinter body, CancellationToken cancellationToken = default, Action<MonthlyPrintUsageSummariesByPrinterRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintUsageByPrinter> PostAsync(PrintUsageByPrinter body, CancellationToken cancellationToken = default, Action<MonthlyPrintUsageSummariesByPrinterRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
