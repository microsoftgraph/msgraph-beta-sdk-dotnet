...
namespace Microsoft.Graph.Beta.Reports.MonthlyPrintUsageSummariesByPrinter {
    ...
    public class MonthlyPrintUsageSummariesByPrinterRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.reports.monthlyPrintUsageSummariesByPrinter.item collection</summary>
        ...
        public MonthlyPrintUsageSummariesByPrinterRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/reports/monthlyPrintUsageSummariesByPrinter{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
