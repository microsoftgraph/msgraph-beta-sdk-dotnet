...
namespace MicrosoftGraph.Reports.MonthlyPrintUsageSummariesByPrinter.Item {
    /// <summary>Builds and executes requests for operations under \reports\monthlyPrintUsageSummariesByPrinter\{printUsageByPrinter-id}</summary>
    public class PrintUsageByPrinterRequestBuilder {
        ...
        public PrintUsageByPrinterRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/reports/monthlyPrintUsageSummariesByPrinter/{printUsageByPrinter_id}{?select,expand}";
        ...
        /// <summary>Get monthlyPrintUsageSummariesByPrinter from reports</summary>
