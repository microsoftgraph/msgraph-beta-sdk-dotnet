...
using System;
namespace Microsoft.Graph.Beta.Reports.MonthlyPrintUsageSummariesByPrinter.Item {
    /// <summary>
    ...
    public class PrintUsageByPrinterItemRequestBuilder : BaseRequestBuilder {
        ...
        public PrintUsageByPrinterItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/monthlyPrintUsageSummariesByPrinter/{printUsageByPrinter%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PrintUsageByPrinterItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PrintUsageByPrinterItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/monthlyPrintUsageSummariesByPrinter/{printUsageByPrinter%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
