...
namespace MicrosoftGraph.Reports.DailyPrintUsageSummariesByPrinter.Item {
    /// <summary>Builds and executes requests for operations under \reports\dailyPrintUsageSummariesByPrinter\{printUsageByPrinter-id}</summary>
    public class PrintUsageByPrinterRequestBuilder {
        ...
        /// </summary>
        public PrintUsageByPrinterRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/reports/dailyPrintUsageSummariesByPrinter/{printUsageByPrinter_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public PrintUsageByPrinterRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <summary>Get dailyPrintUsageSummariesByPrinter from reports</summary>
