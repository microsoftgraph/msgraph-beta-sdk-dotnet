...
namespace Microsoft.Graph.Beta.Reports.GetOffice365ActivationsUserDetail {
    ...
    public class GetOffice365ActivationsUserDetailRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetOffice365ActivationsUserDetailRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
