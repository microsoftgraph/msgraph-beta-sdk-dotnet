...
namespace Microsoft.Graph.Beta.Reports.GetOffice365GroupsActivityDetailWithPeriod {
    ...
    public class GetOffice365GroupsActivityDetailWithPeriodRequestBuilder {
        ...
        public GetOffice365GroupsActivityDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/reports/getOffice365GroupsActivityDetail(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
