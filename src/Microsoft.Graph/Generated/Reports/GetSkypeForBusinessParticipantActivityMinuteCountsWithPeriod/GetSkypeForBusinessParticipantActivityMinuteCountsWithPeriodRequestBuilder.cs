...
namespace Microsoft.Graph.Beta.Reports.GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriod {
    ...
    public class GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodResponse> GetAsync(Action<GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
