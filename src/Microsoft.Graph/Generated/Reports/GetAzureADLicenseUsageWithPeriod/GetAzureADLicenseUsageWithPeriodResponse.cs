    ...
    public class GetAzureADLicenseUsageWithPeriodResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetAzureADLicenseUsageWithPeriodResponse).Value = n.GetCollectionOfObjectValues<AzureADLicenseUsage>(AzureADLicenseUsage.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
