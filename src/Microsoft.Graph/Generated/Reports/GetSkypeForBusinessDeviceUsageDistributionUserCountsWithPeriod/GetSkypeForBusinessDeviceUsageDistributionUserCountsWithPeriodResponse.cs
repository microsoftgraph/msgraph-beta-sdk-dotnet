...
namespace MicrosoftGraphSdk.Reports.GetSkypeForBusinessDeviceUsageDistributionUserCountsWithPeriod {
    ...
    public class GetSkypeForBusinessDeviceUsageDistributionUserCountsWithPeriodResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetSkypeForBusinessDeviceUsageDistributionUserCountsWithPeriodResponse).Value = n.GetByteArrayValue(); } },
            };
        }
        /// <summary>
