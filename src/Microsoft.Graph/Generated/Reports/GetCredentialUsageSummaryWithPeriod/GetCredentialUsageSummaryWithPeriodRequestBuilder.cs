...
namespace Microsoft.Graph.Beta.Reports.GetCredentialUsageSummaryWithPeriod {
    ...
    public class GetCredentialUsageSummaryWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetCredentialUsageSummaryWithPeriodResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetCredentialUsageSummaryWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
