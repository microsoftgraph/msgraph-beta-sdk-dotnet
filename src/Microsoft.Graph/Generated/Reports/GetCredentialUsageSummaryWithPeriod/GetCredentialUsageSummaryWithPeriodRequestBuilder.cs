...
namespace MicrosoftGraphSdk.Reports.GetCredentialUsageSummaryWithPeriod {
    ...
    public class GetCredentialUsageSummaryWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetCredentialUsageSummaryWithPeriodResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
