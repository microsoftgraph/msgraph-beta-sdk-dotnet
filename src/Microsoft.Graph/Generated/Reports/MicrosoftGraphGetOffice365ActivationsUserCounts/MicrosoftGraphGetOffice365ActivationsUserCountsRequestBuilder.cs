...
namespace Microsoft.Graph.Beta.Reports.MicrosoftGraphGetOffice365ActivationsUserCounts {
    /// <summary>
    ...
    public class MicrosoftGraphGetOffice365ActivationsUserCountsRequestBuilder {
        ...
        public MicrosoftGraphGetOffice365ActivationsUserCountsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphGetOffice365ActivationsUserCountsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<MicrosoftGraphGetOffice365ActivationsUserCountsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<MicrosoftGraphGetOffice365ActivationsUserCountsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
