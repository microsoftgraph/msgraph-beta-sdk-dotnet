...
using MicrosoftGraphSdk.Reports.MonthlyPrintUsageByPrinter.Item;
using System;
...
namespace MicrosoftGraphSdk.Reports.MonthlyPrintUsageByPrinter {
    ...
    public class MonthlyPrintUsageByPrinterRequestBuilder {
        ...
        public async Task<MonthlyPrintUsageByPrinterResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<MonthlyPrintUsageByPrinterResponse>(requestInfo, MonthlyPrintUsageByPrinterResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to monthlyPrintUsageByPrinter for reports
        /// <param name="body"></param>
