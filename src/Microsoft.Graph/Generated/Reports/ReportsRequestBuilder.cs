...
using MicrosoftGraph.Reports.ApplicationSignInDetailedSummary;
using MicrosoftGraph.Reports.AuthenticationMethods;
using MicrosoftGraph.Reports.CredentialUserRegistrationDetails;
using MicrosoftGraph.Reports.DailyPrintUsageByPrinter;
using MicrosoftGraph.Reports.DailyPrintUsageByUser;
using MicrosoftGraph.Reports.DailyPrintUsageSummariesByPrinter;
using MicrosoftGraph.Reports.DailyPrintUsageSummariesByUser;
...
using MicrosoftGraph.Reports.GetAttackSimulationRepeatOffenders;
using MicrosoftGraph.Reports.GetAttackSimulationSimulationUserCoverage;
using MicrosoftGraph.Reports.GetAttackSimulationTrainingUserCoverage;
using MicrosoftGraph.Reports.GetAzureADApplicationSignInSummaryWithPeriod;
using MicrosoftGraph.Reports.GetAzureADFeatureUsageWithPeriod;
using MicrosoftGraph.Reports.GetAzureADLicenseUsageWithPeriod;
using MicrosoftGraph.Reports.GetAzureADUserFeatureUsage;
using MicrosoftGraph.Reports.GetCredentialUsageSummaryWithPeriod;
using MicrosoftGraph.Reports.GetCredentialUserRegistrationCount;
...
using MicrosoftGraph.Reports.GetM365AppPlatformUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetM365AppUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetM365AppUserDetailWithDate;
using MicrosoftGraph.Reports.GetM365AppUserDetailWithPeriod;
...
using MicrosoftGraph.Reports.GetRelyingPartyDetailedSummaryWithPeriod;
...
using MicrosoftGraph.Reports.GetTeamsDeviceUsageDistributionTotalUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetTeamsDeviceUsageDistributionUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetTeamsDeviceUsageTotalUserCountsWithPeriod;
...
using MicrosoftGraph.Reports.GetTeamsUserActivityDistributionTotalUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetTeamsUserActivityDistributionUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetTeamsUserActivityTotalCountsWithPeriod;
using MicrosoftGraph.Reports.GetTeamsUserActivityTotalUserCountsWithPeriod;
...
using MicrosoftGraph.Reports.GetTenantSecureScoresWithPeriod;
...
using MicrosoftGraph.Reports.ManagedDeviceEnrollmentAbandonmentDetailsWithSkipWithTopWithFilterWithSkipToken;
using MicrosoftGraph.Reports.ManagedDeviceEnrollmentAbandonmentSummaryWithSkipWithTopWithFilterWithSkipToken;
...
using MicrosoftGraph.Reports.ManagedDeviceEnrollmentFailureTrends;
...
using MicrosoftGraph.Reports.MonthlyPrintUsageSummariesByPrinter;
using MicrosoftGraph.Reports.MonthlyPrintUsageSummariesByUser;
using MicrosoftGraph.Reports.UserCredentialUsageDetails;
using System;
