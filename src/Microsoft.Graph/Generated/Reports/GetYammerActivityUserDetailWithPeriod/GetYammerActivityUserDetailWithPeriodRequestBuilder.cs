...
namespace MicrosoftGraphSdk.Reports.GetYammerActivityUserDetailWithPeriod {
    ...
    public class GetYammerActivityUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetYammerActivityUserDetailWithPeriodResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
