...
namespace Microsoft.Graph.Beta.Reports.GetYammerDeviceUsageDistributionUserCountsWithPeriod {
    ...
    public class GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetYammerDeviceUsageDistributionUserCountsWithPeriodResponse> GetAsync(Action<GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<GetYammerDeviceUsageDistributionUserCountsWithPeriodResponse>(requestInfo, GetYammerDeviceUsageDistributionUserCountsWithPeriodResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
