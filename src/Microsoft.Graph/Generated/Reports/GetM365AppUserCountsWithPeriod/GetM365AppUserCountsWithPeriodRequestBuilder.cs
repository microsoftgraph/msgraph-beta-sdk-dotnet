...
namespace Microsoft.Graph.Beta.Reports.GetM365AppUserCountsWithPeriod {
    ...
    public class GetM365AppUserCountsWithPeriodRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<Stream> GetAsync(Action<GetM365AppUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
