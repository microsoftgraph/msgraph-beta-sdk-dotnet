...
namespace MicrosoftGraph.Reports.GetM365AppUserCountsWithPeriod {
    /// <summary>Builds and executes requests for operations under \reports\microsoft.graph.getM365AppUserCounts(period='{period}')</summary>
