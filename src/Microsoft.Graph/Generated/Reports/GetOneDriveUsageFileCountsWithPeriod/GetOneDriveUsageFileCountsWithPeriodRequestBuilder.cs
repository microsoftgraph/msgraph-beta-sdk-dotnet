...
namespace Microsoft.Graph.Beta.Reports.GetOneDriveUsageFileCountsWithPeriod {
    ...
    public class GetOneDriveUsageFileCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetOneDriveUsageFileCountsWithPeriodResponse> GetAsync(Action<GetOneDriveUsageFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<GetOneDriveUsageFileCountsWithPeriodResponse>(requestInfo, GetOneDriveUsageFileCountsWithPeriodResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
