...
namespace MicrosoftGraphSdk.Reports.GetTeamsDeviceUsageUserDetailWithPeriod {
    ...
    public class GetTeamsDeviceUsageUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetTeamsDeviceUsageUserDetailWithPeriodResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
