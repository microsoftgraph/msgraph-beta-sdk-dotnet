...
namespace Microsoft.Graph.Beta.Reports.GetOffice365ActiveUserCountsWithPeriod {
    ...
    public class GetOffice365ActiveUserCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetOffice365ActiveUserCountsWithPeriodGetResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<GetOffice365ActiveUserCountsWithPeriodGetResponse?> GetAsGetOffice365ActiveUserCountsWithPeriodGetResponseAsync(Action<RequestConfiguration<GetOffice365ActiveUserCountsWithPeriodRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<GetOffice365ActiveUserCountsWithPeriodGetResponse> GetAsGetOffice365ActiveUserCountsWithPeriodGetResponseAsync(Action<RequestConfiguration<GetOffice365ActiveUserCountsWithPeriodRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
        ...
        /// Invoke function getOffice365ActiveUserCounts
        /// </summary>
        /// <returns>A <cref="GetOffice365ActiveUserCountsWithPeriodResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<GetOffice365ActiveUserCountsWithPeriodResponse?> GetAsync(Action<RequestConfiguration<GetOffice365ActiveUserCountsWithPeriodRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<GetOffice365ActiveUserCountsWithPeriodResponse> GetAsync(Action<RequestConfiguration<GetOffice365ActiveUserCountsWithPeriodRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        public class GetOffice365ActiveUserCountsWithPeriodRequestBuilderGetRequestConfiguration : RequestConfiguration<GetOffice365ActiveUserCountsWithPeriodRequestBuilderGetQueryParameters> {
        }
    }
}
