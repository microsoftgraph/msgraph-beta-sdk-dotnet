...
#nullable enable
        public async Task<GetOffice365ActiveUserCountsWithPeriodResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetOffice365ActiveUserCountsWithPeriodRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetOffice365ActiveUserCountsWithPeriodResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetOffice365ActiveUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
