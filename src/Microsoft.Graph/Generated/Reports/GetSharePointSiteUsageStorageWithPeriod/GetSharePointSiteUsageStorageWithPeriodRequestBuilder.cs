...
#nullable restore
        ...
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public GetSharePointSiteUsageStorageWithPeriodRequestBuilder WithUrl(string rawUrl) {
            return new GetSharePointSiteUsageStorageWithPeriodRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
