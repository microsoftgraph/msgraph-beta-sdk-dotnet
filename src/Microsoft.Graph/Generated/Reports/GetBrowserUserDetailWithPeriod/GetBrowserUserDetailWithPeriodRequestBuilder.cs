...
namespace Microsoft.Graph.Beta.Reports.GetBrowserUserDetailWithPeriod {
    ...
    public class GetBrowserUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetBrowserUserDetailWithPeriodResponse> GetAsync(Action<GetBrowserUserDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<GetBrowserUserDetailWithPeriodResponse>(requestInfo, GetBrowserUserDetailWithPeriodResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
