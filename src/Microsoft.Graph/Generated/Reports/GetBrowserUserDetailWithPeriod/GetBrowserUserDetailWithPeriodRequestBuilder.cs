...
namespace MicrosoftGraphSdk.Reports.GetBrowserUserDetailWithPeriod {
    ...
    public class GetBrowserUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetBrowserUserDetailWithPeriodResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
