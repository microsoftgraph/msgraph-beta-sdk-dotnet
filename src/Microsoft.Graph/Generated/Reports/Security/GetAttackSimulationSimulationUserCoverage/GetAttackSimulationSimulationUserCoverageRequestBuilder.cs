...
namespace Microsoft.Graph.Beta.Reports.Security.GetAttackSimulationSimulationUserCoverage {
    ...
    public class GetAttackSimulationSimulationUserCoverageRequestBuilder : BaseRequestBuilder {
        ...
        public GetAttackSimulationSimulationUserCoverageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/security/getAttackSimulationSimulationUserCoverage(){?%24top,%24skip,%24search,%24filter,%24count}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetAttackSimulationSimulationUserCoverageRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetAttackSimulationSimulationUserCoverageRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/security/getAttackSimulationSimulationUserCoverage(){?%24top,%24skip,%24search,%24filter,%24count}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<GetAttackSimulationSimulationUserCoverageResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetAttackSimulationSimulationUserCoverageRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetAttackSimulationSimulationUserCoverageResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetAttackSimulationSimulationUserCoverageRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
