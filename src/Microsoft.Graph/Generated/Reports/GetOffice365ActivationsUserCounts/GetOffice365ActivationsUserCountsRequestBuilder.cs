...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="GetOffice365ActivationsUserCountsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public GetOffice365ActivationsUserCountsRequestBuilder WithUrl(string rawUrl)
        {
