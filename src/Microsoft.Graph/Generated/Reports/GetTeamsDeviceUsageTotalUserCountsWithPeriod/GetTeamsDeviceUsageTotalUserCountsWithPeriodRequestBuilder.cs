...
#nullable restore
        ...
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public GetTeamsDeviceUsageTotalUserCountsWithPeriodRequestBuilder WithUrl(string rawUrl) {
            return new GetTeamsDeviceUsageTotalUserCountsWithPeriodRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
