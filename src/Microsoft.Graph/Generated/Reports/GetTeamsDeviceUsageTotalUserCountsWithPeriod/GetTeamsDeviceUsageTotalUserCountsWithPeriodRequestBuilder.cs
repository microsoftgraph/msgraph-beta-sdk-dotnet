...
namespace Microsoft.Graph.Beta.Reports.GetTeamsDeviceUsageTotalUserCountsWithPeriod {
    ...
    public class GetTeamsDeviceUsageTotalUserCountsWithPeriodRequestBuilder {
        ...
        public GetTeamsDeviceUsageTotalUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/reports/getTeamsDeviceUsageTotalUserCounts(period='{period}')";
