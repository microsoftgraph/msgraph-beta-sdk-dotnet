...
namespace Microsoft.Graph.Beta.Reports.GetSkypeForBusinessActivityUserDetailWithDate {
    ...
    public class GetSkypeForBusinessActivityUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<GetSkypeForBusinessActivityUserDetailWithDateResponse> GetAsync(Action<GetSkypeForBusinessActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<GetSkypeForBusinessActivityUserDetailWithDateResponse>(requestInfo, GetSkypeForBusinessActivityUserDetailWithDateResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
