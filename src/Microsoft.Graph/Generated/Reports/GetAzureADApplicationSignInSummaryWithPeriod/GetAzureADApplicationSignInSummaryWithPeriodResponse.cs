...
namespace Microsoft.Graph.Beta.Reports.GetAzureADApplicationSignInSummaryWithPeriod {
    ...
    public class GetAzureADApplicationSignInSummaryWithPeriodResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ApplicationSignInSummary> Value {
            get { return BackingStore?.Get<List<ApplicationSignInSummary>>(nameof(Value)); }
