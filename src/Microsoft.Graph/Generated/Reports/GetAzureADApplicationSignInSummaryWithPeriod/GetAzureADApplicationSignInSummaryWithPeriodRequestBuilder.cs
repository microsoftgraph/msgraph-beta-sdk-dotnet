...
namespace Microsoft.Graph.Beta.Reports.GetAzureADApplicationSignInSummaryWithPeriod {
    ...
    public class GetAzureADApplicationSignInSummaryWithPeriodRequestBuilder {
        ...
        public GetAzureADApplicationSignInSummaryWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            ...
            UrlTemplate = "{+baseurl}/reports/microsoft.graph.getAzureADApplicationSignInSummary(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
        ...
        public RequestInformation CreateGetRequestInformation(Action<GetAzureADApplicationSignInSummaryWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new GetAzureADApplicationSignInSummaryWithPeriodRequestBuilderGetRequestConfiguration();
        ...
        public async Task<GetAzureADApplicationSignInSummaryWithPeriodResponse> GetAsync(Action<GetAzureADApplicationSignInSummaryWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<GetAzureADApplicationSignInSummaryWithPeriodResponse>(requestInfo, GetAzureADApplicationSignInSummaryWithPeriodResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>Invoke function getAzureADApplicationSignInSummary</summary>
        ...
        public class GetAzureADApplicationSignInSummaryWithPeriodRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public IDictionary<string, string> Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public GetAzureADApplicationSignInSummaryWithPeriodRequestBuilderGetQueryParameters QueryParameters { get; set; } = new GetAzureADApplicationSignInSummaryWithPeriodRequestBuilderGetQueryParameters();
            /// <summary>
            ...
            /// </summary>
            public GetAzureADApplicationSignInSummaryWithPeriodRequestBuilderGetRequestConfiguration() {
