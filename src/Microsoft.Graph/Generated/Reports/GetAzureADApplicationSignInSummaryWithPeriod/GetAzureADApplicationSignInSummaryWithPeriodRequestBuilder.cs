...
namespace Microsoft.Graph.Beta.Reports.GetAzureADApplicationSignInSummaryWithPeriod {
    ...
    public class GetAzureADApplicationSignInSummaryWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetAzureADApplicationSignInSummaryWithPeriodGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function getAzureADApplicationSignInSummary
        /// </summary>
        /// <returns>A <cref="GetAzureADApplicationSignInSummaryWithPeriodResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
