...
namespace Microsoft.Graph.Beta.Reports.GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriod {
    ...
    public class GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodResponse> GetAsync(Action<GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
