...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CredentialUserRegistrationDetailsItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CredentialUserRegistrationDetailsItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.CredentialUserRegistrationDetails?> GetAsync(CancellationToken cancellationToken = default, Action<CredentialUserRegistrationDetailsItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.CredentialUserRegistrationDetails> GetAsync(CancellationToken cancellationToken = default, Action<CredentialUserRegistrationDetailsItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.CredentialUserRegistrationDetails?> PatchAsync(Microsoft.Graph.Beta.Models.CredentialUserRegistrationDetails body, CancellationToken cancellationToken = default, Action<CredentialUserRegistrationDetailsItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.CredentialUserRegistrationDetails> PatchAsync(Microsoft.Graph.Beta.Models.CredentialUserRegistrationDetails body, CancellationToken cancellationToken = default, Action<CredentialUserRegistrationDetailsItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
