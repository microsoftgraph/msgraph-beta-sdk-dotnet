...
namespace Microsoft.Graph.Beta.Reports.CredentialUserRegistrationDetails {
    ...
    public class CredentialUserRegistrationDetailsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.reports.credentialUserRegistrationDetails.item collection</summary>
        ...
        public CredentialUserRegistrationDetailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/reports/credentialUserRegistrationDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<CredentialUserRegistrationDetailsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Microsoft.Graph.Beta.Models.CredentialUserRegistrationDetails body, Action<CredentialUserRegistrationDetailsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<CredentialUserRegistrationDetailsCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CredentialUserRegistrationDetailsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.CredentialUserRegistrationDetails> PostAsync(Microsoft.Graph.Beta.Models.CredentialUserRegistrationDetails body, CancellationToken cancellationToken = default, Action<CredentialUserRegistrationDetailsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
