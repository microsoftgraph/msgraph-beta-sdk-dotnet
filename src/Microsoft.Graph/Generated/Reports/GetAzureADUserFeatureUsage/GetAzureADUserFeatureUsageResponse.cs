...
namespace MicrosoftGraphSdk.Reports.GetAzureADUserFeatureUsage {
    ...
    public class GetAzureADUserFeatureUsageResponse : IAdditionalDataHolder, IParsable {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        public List<AzureADUserFeatureUsage> Value { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetAzureADUserFeatureUsageResponse).Value = n.GetCollectionOfObjectValues<AzureADUserFeatureUsage>(AzureADUserFeatureUsage.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
