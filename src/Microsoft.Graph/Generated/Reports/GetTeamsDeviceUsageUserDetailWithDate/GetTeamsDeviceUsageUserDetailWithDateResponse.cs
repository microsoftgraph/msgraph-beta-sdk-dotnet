...
namespace MicrosoftGraphSdk.Reports.GetTeamsDeviceUsageUserDetailWithDate {
    ...
    public class GetTeamsDeviceUsageUserDetailWithDateResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public GetTeamsDeviceUsageUserDetailWithDateResponse() {
        ...
        /// </summary>
        public static GetTeamsDeviceUsageUserDetailWithDateResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetTeamsDeviceUsageUserDetailWithDateResponse).Value = n.GetByteArrayValue(); } },
            };
        }
        /// <summary>
