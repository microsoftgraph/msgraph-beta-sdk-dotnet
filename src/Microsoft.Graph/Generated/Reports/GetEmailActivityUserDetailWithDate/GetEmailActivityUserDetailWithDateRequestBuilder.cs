...
namespace MicrosoftGraphSdk.Reports.GetEmailActivityUserDetailWithDate {
    ...
    public class GetEmailActivityUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<GetEmailActivityUserDetailWithDateResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
