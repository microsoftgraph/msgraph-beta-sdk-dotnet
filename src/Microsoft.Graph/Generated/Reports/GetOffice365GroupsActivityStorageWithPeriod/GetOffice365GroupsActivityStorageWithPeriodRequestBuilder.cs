...
namespace Microsoft.Graph.Beta.Reports.GetOffice365GroupsActivityStorageWithPeriod {
    ...
    public class GetOffice365GroupsActivityStorageWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetOffice365GroupsActivityStorageWithPeriodResponse> GetAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(headers, options);
            return await RequestAdapter.SendAsync<GetOffice365GroupsActivityStorageWithPeriodResponse>(requestInfo, GetOffice365GroupsActivityStorageWithPeriodResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
    }
}
