...
namespace MicrosoftGraphSdk.Reports.GetOffice365GroupsActivityStorageWithPeriod {
    ...
    public class GetOffice365GroupsActivityStorageWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetOffice365GroupsActivityStorageWithPeriodResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
