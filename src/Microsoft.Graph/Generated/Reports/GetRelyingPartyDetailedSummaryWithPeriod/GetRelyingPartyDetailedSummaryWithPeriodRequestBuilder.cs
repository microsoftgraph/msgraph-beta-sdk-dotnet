...
namespace Microsoft.Graph.Beta.Reports.GetRelyingPartyDetailedSummaryWithPeriod {
    ...
    public class GetRelyingPartyDetailedSummaryWithPeriodRequestBuilder {
        ...
        public GetRelyingPartyDetailedSummaryWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            ...
            UrlTemplate = "{+baseurl}/reports/microsoft.graph.getRelyingPartyDetailedSummary(period='{period}')";
        ...
        /// </summary>
        public async Task<GetRelyingPartyDetailedSummaryWithPeriodResponse> GetAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
