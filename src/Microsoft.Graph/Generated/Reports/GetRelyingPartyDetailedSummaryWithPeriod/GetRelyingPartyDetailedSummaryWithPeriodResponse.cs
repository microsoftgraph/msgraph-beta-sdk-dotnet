...
namespace Microsoft.Graph.Beta.Reports.GetRelyingPartyDetailedSummaryWithPeriod {
    ...
    public class GetRelyingPartyDetailedSummaryWithPeriodResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<RelyingPartyDetailedSummary> Value {
            get { return BackingStore?.Get<List<RelyingPartyDetailedSummary>>(nameof(Value)); }
        ...
        /// </summary>
        public static GetRelyingPartyDetailedSummaryWithPeriodResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GetRelyingPartyDetailedSummaryWithPeriodResponse();
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<RelyingPartyDetailedSummary>("value", Value);
