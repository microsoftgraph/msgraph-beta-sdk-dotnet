...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AuthenticationMethodsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AuthenticationMethodsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AuthenticationMethodsRoot?> GetAsync(CancellationToken cancellationToken = default, Action<AuthenticationMethodsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AuthenticationMethodsRoot> GetAsync(CancellationToken cancellationToken = default, Action<AuthenticationMethodsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AuthenticationMethodsRoot?> PatchAsync(AuthenticationMethodsRoot body, CancellationToken cancellationToken = default, Action<AuthenticationMethodsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AuthenticationMethodsRoot> PatchAsync(AuthenticationMethodsRoot body, CancellationToken cancellationToken = default, Action<AuthenticationMethodsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
