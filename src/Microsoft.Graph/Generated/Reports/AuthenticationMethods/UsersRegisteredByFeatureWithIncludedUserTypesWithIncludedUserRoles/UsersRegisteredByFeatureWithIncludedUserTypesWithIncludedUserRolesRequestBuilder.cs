...
#nullable enable
        public async Task<UserRegistrationFeatureSummary?> GetAsync(CancellationToken cancellationToken = default, Action<UsersRegisteredByFeatureWithIncludedUserTypesWithIncludedUserRolesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserRegistrationFeatureSummary> GetAsync(CancellationToken cancellationToken = default, Action<UsersRegisteredByFeatureWithIncludedUserTypesWithIncludedUserRolesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
