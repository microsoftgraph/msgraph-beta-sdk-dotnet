...
namespace Microsoft.Graph.Beta.Reports.AuthenticationMethods.UsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRoles {
    ...
    public class UsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilder {
        ...
        /// </summary>
        public async Task<UserRegistrationMethodSummary> GetAsync(CancellationToken cancellationToken = default, Action<UsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
