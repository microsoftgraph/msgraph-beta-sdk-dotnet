...
#nullable enable
        public async Task<UserRegistrationMethodSummary?> GetAsync(CancellationToken cancellationToken = default, Action<UsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserRegistrationMethodSummary> GetAsync(CancellationToken cancellationToken = default, Action<UsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
