...
using System;
namespace Microsoft.Graph.Beta.Reports.AuthenticationMethods.UserRegistrationDetails.Item {
    /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UserRegistrationDetailsItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UserRegistrationDetailsItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.UserRegistrationDetails?> GetAsync(CancellationToken cancellationToken = default, Action<UserRegistrationDetailsItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.UserRegistrationDetails> GetAsync(CancellationToken cancellationToken = default, Action<UserRegistrationDetailsItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.UserRegistrationDetails?> PatchAsync(Microsoft.Graph.Beta.Models.UserRegistrationDetails body, CancellationToken cancellationToken = default, Action<UserRegistrationDetailsItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.UserRegistrationDetails> PatchAsync(Microsoft.Graph.Beta.Models.UserRegistrationDetails body, CancellationToken cancellationToken = default, Action<UserRegistrationDetailsItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
