...
using MicrosoftGraphSdk.Reports.AuthenticationMethods.UserRegistrationDetails.Count;
using MicrosoftGraphSdk.Reports.AuthenticationMethods.UserRegistrationDetails.Item;
using System;
...
namespace MicrosoftGraphSdk.Reports.AuthenticationMethods.UserRegistrationDetails {
    ...
    public class UserRegistrationDetailsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.reports.authenticationMethods.userRegistrationDetails.item collection</summary>
        ...
        public UserRegistrationDetailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/reports/authenticationMethods/userRegistrationDetails{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.UserRegistrationDetails body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// </summary>
        public async Task<UserRegistrationDetailsCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
