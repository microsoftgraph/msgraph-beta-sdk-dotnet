...
#nullable enable
        public async Task<UserRegistrationFeatureSummary?> GetAsync(CancellationToken cancellationToken = default, Action<UsersRegisteredByFeatureRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserRegistrationFeatureSummary> GetAsync(CancellationToken cancellationToken = default, Action<UsersRegisteredByFeatureRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
