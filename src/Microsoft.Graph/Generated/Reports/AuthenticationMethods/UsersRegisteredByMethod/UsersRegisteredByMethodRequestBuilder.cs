...
using System;
namespace Microsoft.Graph.Beta.Reports.AuthenticationMethods.UsersRegisteredByMethod {
    /// <summary>
...
#nullable enable
        public async Task<UserRegistrationMethodSummary?> GetAsync(CancellationToken cancellationToken = default, Action<UsersRegisteredByMethodRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserRegistrationMethodSummary> GetAsync(CancellationToken cancellationToken = default, Action<UsersRegisteredByMethodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
