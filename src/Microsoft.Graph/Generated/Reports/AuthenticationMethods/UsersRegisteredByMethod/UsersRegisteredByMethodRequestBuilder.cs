...
namespace MicrosoftGraphSdk.Reports.AuthenticationMethods.UsersRegisteredByMethod {
    /// <summary>Builds and executes requests for operations under \reports\authenticationMethods\microsoft.graph.usersRegisteredByMethod()</summary>
