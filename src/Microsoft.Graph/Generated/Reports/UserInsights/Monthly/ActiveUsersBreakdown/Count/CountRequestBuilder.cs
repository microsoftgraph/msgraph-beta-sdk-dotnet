...
using System;
namespace Microsoft.Graph.Beta.Reports.UserInsights.Monthly.ActiveUsersBreakdown.Count {
    /// <summary>
    ...
    public class CountRequestBuilder : BaseRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/userInsights/monthly/activeUsersBreakdown/$count{?%24filter,%24search}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="CountRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CountRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/userInsights/monthly/activeUsersBreakdown/$count{?%24filter,%24search}", rawUrl) {
        }
        /// <summary>
