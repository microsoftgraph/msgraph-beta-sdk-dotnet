...
namespace Microsoft.Graph.Beta.Reports.UserInsights.Monthly.ActiveUsersBreakdown {
    ...
    public class ActiveUsersBreakdownRequestBuilder : BaseRequestBuilder {
        ...
        /// <returns>A <cref="ActiveUsersBreakdownMetricItemRequestBuilder"></returns>
        ...
        /// <summary>
        /// Instantiates a new <see cref="ActiveUsersBreakdownRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ActiveUsersBreakdownRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/userInsights/monthly/activeUsersBreakdown{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="ActiveUsersBreakdownRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ActiveUsersBreakdownRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/userInsights/monthly/activeUsersBreakdown{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl) {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <cref="ActiveUsersBreakdownMetricCollectionResponse"></returns>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="ActiveUsersBreakdownRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class ActiveUsersBreakdownRequestBuilderGetRequestConfiguration : RequestConfiguration<ActiveUsersBreakdownRequestBuilderGetQueryParameters> {
        }
    }
}
