...
namespace Microsoft.Graph.Beta.Reports.UserInsights.Monthly.InactiveUsersByApplication {
    ...
    public class InactiveUsersByApplicationRequestBuilder : BaseRequestBuilder {
        ...
        public MonthlyInactiveUsersByApplicationMetricItemRequestBuilder this[string position] { get {
        ...
        public InactiveUsersByApplicationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/userInsights/monthly/inactiveUsersByApplication{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new InactiveUsersByApplicationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InactiveUsersByApplicationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/userInsights/monthly/inactiveUsersByApplication{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<MonthlyInactiveUsersByApplicationMetricCollectionResponse?> GetAsync(Action<InactiveUsersByApplicationRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<MonthlyInactiveUsersByApplicationMetricCollectionResponse> GetAsync(Action<InactiveUsersByApplicationRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<InactiveUsersByApplicationRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<InactiveUsersByApplicationRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new InactiveUsersByApplicationRequestBuilderGetRequestConfiguration();
...
#nullable restore
        ...
        /// </summary>
        public class InactiveUsersByApplicationRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public InactiveUsersByApplicationRequestBuilderGetQueryParameters QueryParameters { get; set; } = new InactiveUsersByApplicationRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new inactiveUsersByApplicationRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public InactiveUsersByApplicationRequestBuilderGetRequestConfiguration() {
