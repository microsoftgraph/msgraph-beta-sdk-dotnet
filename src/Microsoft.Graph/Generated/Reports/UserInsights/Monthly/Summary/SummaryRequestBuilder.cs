...
namespace Microsoft.Graph.Beta.Reports.UserInsights.Monthly.Summary {
    ...
    public class SummaryRequestBuilder : BaseRequestBuilder {
        ...
        public SummaryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/userInsights/monthly/summary{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SummaryRequestBuilder and sets the default values.
        /// </summary>
