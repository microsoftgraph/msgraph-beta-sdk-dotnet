...
namespace Microsoft.Graph.Beta.Reports.UserInsights.Daily.Authentications.Item {
    ...
    public class AuthenticationsMetricItemRequestBuilder : BaseRequestBuilder {
        ...
        public AuthenticationsMetricItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/userInsights/daily/authentications/{authenticationsMetric%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AuthenticationsMetricItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AuthenticationsMetricItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/userInsights/daily/authentications/{authenticationsMetric%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
