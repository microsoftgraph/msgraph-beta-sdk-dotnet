...
namespace Microsoft.Graph.Beta.Reports.UserInsights.Daily.ActiveUsersBreakdown.Item {
    ...
    public class ActiveUsersBreakdownMetricItemRequestBuilder : BaseRequestBuilder {
        ...
        public ActiveUsersBreakdownMetricItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/userInsights/daily/activeUsersBreakdown/{activeUsersBreakdownMetric%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ActiveUsersBreakdownMetricItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ActiveUsersBreakdownMetricItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/userInsights/daily/activeUsersBreakdown/{activeUsersBreakdownMetric%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
