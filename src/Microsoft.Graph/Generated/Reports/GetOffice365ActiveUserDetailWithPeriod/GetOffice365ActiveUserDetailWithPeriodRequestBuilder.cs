...
#nullable enable
        public async Task<GetOffice365ActiveUserDetailWithPeriodResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetOffice365ActiveUserDetailWithPeriodRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetOffice365ActiveUserDetailWithPeriodResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetOffice365ActiveUserDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
