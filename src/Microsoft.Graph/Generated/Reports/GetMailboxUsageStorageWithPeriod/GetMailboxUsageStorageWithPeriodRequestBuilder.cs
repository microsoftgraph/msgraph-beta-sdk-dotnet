...
namespace Microsoft.Graph.Beta.Reports.GetMailboxUsageStorageWithPeriod {
    ...
    public class GetMailboxUsageStorageWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetMailboxUsageStorageWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
