...
namespace MicrosoftGraphSdk.Reports.GetMailboxUsageStorageWithPeriod {
    ...
    public class GetMailboxUsageStorageWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetMailboxUsageStorageWithPeriodResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
