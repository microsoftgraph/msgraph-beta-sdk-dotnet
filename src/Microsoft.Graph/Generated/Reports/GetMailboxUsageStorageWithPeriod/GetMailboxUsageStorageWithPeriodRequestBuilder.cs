...
namespace Microsoft.Graph.Beta.Reports.GetMailboxUsageStorageWithPeriod {
    ...
    public class GetMailboxUsageStorageWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetMailboxUsageStorageWithPeriodResponse> GetAsync(Action<GetMailboxUsageStorageWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<GetMailboxUsageStorageWithPeriodResponse>(requestInfo, GetMailboxUsageStorageWithPeriodResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
