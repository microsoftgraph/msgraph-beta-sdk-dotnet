...
namespace Microsoft.Graph.Beta.Reports.GetMailboxUsageStorageWithPeriod {
    ...
    public class GetMailboxUsageStorageWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(Action<GetMailboxUsageStorageWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
