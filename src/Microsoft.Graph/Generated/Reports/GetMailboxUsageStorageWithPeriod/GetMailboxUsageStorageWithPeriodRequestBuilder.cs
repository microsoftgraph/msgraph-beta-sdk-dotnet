...
namespace Microsoft.Graph.Beta.Reports.GetMailboxUsageStorageWithPeriod {
    ...
    public class GetMailboxUsageStorageWithPeriodRequestBuilder {
        ...
        public GetMailboxUsageStorageWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/reports/getMailboxUsageStorage(period='{period}')";
