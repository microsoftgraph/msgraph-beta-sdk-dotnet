...
using System;
namespace Microsoft.Graph.Beta.Reports.ApplicationSignInDetailedSummary.Item {
    /// <summary>
    ...
    public class ApplicationSignInDetailedSummaryItemRequestBuilder : BaseRequestBuilder {
        ...
        public ApplicationSignInDetailedSummaryItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/applicationSignInDetailedSummary/{applicationSignInDetailedSummary%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ApplicationSignInDetailedSummaryItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ApplicationSignInDetailedSummaryItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/applicationSignInDetailedSummary/{applicationSignInDetailedSummary%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ApplicationSignInDetailedSummaryItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ApplicationSignInDetailedSummaryItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/applicationsignindetailedsummary-get?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ApplicationSignInDetailedSummary?> GetAsync(CancellationToken cancellationToken = default, Action<ApplicationSignInDetailedSummaryItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ApplicationSignInDetailedSummary> GetAsync(CancellationToken cancellationToken = default, Action<ApplicationSignInDetailedSummaryItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ApplicationSignInDetailedSummary?> PatchAsync(Microsoft.Graph.Beta.Models.ApplicationSignInDetailedSummary body, CancellationToken cancellationToken = default, Action<ApplicationSignInDetailedSummaryItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ApplicationSignInDetailedSummary> PatchAsync(Microsoft.Graph.Beta.Models.ApplicationSignInDetailedSummary body, CancellationToken cancellationToken = default, Action<ApplicationSignInDetailedSummaryItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
