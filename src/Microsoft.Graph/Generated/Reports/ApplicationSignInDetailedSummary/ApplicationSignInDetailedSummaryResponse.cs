...
namespace MicrosoftGraphSdk.Reports.ApplicationSignInDetailedSummary {
    public class ApplicationSignInDetailedSummaryResponse : IParsable {
        ...
        /// </summary>
        public ApplicationSignInDetailedSummaryResponse() {
        ...
        /// </summary>
        public static ApplicationSignInDetailedSummaryResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApplicationSignInDetailedSummaryResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ApplicationSignInDetailedSummaryResponse).Value = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.ApplicationSignInDetailedSummary>(MicrosoftGraphSdk.Models.Microsoft.Graph.ApplicationSignInDetailedSummary.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
