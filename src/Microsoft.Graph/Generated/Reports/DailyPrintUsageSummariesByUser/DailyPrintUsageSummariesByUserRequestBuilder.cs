...
namespace MicrosoftGraph.Reports.DailyPrintUsageSummariesByUser {
    /// <summary>Builds and executes requests for operations under \reports\dailyPrintUsageSummariesByUser</summary>
    public class DailyPrintUsageSummariesByUserRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.reports.dailyPrintUsageSummariesByUser.item collection</summary>
        public DailyPrintUsageSummariesByUserRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("printUsageByUser_id", position);
            return new DailyPrintUsageSummariesByUserRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public DailyPrintUsageSummariesByUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/reports/dailyPrintUsageSummariesByUser{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
