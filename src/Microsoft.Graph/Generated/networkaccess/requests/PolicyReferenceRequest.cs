...
namespace Microsoft.Graph.Networkaccess
{
    ...
    /// <summary>
    /// The type PolicyReferenceRequest.
    /// </summary>
    public partial class PolicyReferenceRequest : Microsoft.Graph.BaseRequest, IPolicyReferenceRequest
    {
        /// <summary>
        /// Constructs a new PolicyReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public PolicyReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified Policy reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified Policy reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified Policy reference.
        /// </summary>
        /// <param name="id">The Policy reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified Policy reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The Policy reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
