...
namespace Microsoft.Graph.Networkaccess
{
    ...
    /// </summary>
    public partial class ProfileRequest : Microsoft.Graph.BaseRequest, IProfileRequest
    {
        /// <summary>
        ...
        private void InitializeCollectionProperties(Profile profileToInitialize)
        {
            ...
            {
                if (profileToInitialize.Policies != null && profileToInitialize.Policies.CurrentPage != null)
                {
                    profileToInitialize.Policies.InitializeNextPageRequest(this.Client, profileToInitialize.PoliciesNextLink);
                    // Copy the additional data collection to the page itself so that information is not lost
                    profileToInitialize.Policies.AdditionalData = profileToInitialize.AdditionalData;
                }
