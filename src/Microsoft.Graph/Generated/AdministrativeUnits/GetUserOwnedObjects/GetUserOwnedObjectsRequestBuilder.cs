...
namespace MicrosoftGraphSdk.AdministrativeUnits.GetUserOwnedObjects {
    /// <summary>Builds and executes requests for operations under \administrativeUnits\microsoft.graph.getUserOwnedObjects</summary>
    public class GetUserOwnedObjectsRequestBuilder {
        ...
        public GetUserOwnedObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/administrativeUnits/microsoft.graph.getUserOwnedObjects";
