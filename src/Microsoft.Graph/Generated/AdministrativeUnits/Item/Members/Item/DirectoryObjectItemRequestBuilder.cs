using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.Item.Application;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.Item.Device;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.Item.Group;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.Item.OrgContact;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.Item.Ref;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.Item.ServicePrincipal;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.Item.User;
...
namespace Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.Item {
    /// <summary>Builds and executes requests for operations under \administrativeUnits\{administrativeUnit-id}\members\{directoryObject-id}</summary>
