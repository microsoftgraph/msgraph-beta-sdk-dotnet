...
namespace Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.Item.GraphApplication {
    /// <summary>
    ...
    public class GraphApplicationRequestBuilder : BaseRequestBuilder {
        ...
        public GraphApplicationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/graph.application{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphApplicationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphApplicationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/graph.application{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
