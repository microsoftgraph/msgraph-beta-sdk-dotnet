...
namespace Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.MicrosoftGraphDevice.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.device/$count{?%24search,%24filter}";
