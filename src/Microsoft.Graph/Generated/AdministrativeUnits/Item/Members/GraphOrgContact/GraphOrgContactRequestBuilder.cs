...
#nullable enable
        public async Task<OrgContactCollectionResponse?> GetAsync(Action<GraphOrgContactRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<OrgContactCollectionResponse> GetAsync(Action<GraphOrgContactRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
