...
namespace Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.User.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.user/$count";
