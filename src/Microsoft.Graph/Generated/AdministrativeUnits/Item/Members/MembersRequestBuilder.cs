...
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.GraphApplication;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.GraphDevice;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.GraphGroup;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.GraphOrgContact;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.GraphServicePrincipal;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.GraphUser;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.Item;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.Ref;
...
namespace Microsoft.Graph.Beta.AdministrativeUnits.Item.Members {
    ...
    public class MembersRequestBuilder : BaseRequestBuilder {
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MembersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MembersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
