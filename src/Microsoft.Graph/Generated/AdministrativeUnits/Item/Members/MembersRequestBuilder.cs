...
using MicrosoftGraphSdk.AdministrativeUnits.Item.Members.Ref;
using System;
...
namespace MicrosoftGraphSdk.AdministrativeUnits.Item.Members {
    /// <summary>Builds and executes requests for operations under \administrativeUnits\{administrativeUnit-id}\members</summary>
    public class MembersRequestBuilder {
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit_id}/members{?top,skip,search,filter,count,orderby,select,expand}";
