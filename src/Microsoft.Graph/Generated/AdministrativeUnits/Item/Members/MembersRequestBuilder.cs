...
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.MicrosoftGraphApplication;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.MicrosoftGraphDevice;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.MicrosoftGraphGroup;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.MicrosoftGraphOrgContact;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.MicrosoftGraphServicePrincipal;
using Microsoft.Graph.Beta.AdministrativeUnits.Item.Members.MicrosoftGraphUser;
...
namespace Microsoft.Graph.Beta.AdministrativeUnits.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
