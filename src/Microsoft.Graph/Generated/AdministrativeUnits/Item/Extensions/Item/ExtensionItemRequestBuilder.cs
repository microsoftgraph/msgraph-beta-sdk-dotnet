...
namespace MicrosoftGraphSdk.AdministrativeUnits.Item.Extensions.Item {
    /// <summary>Builds and executes requests for operations under \administrativeUnits\{administrativeUnit-id}\extensions\{extension-id}</summary>
    public class ExtensionItemRequestBuilder {
        ...
        public ExtensionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit_id}/extensions/{extension_id}{?select,expand}";
