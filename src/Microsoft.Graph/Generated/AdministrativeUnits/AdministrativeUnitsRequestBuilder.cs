...
using Microsoft.Graph.Beta.AdministrativeUnits.MicrosoftGraphDelta;
using Microsoft.Graph.Beta.AdministrativeUnits.MicrosoftGraphGetByIds;
using Microsoft.Graph.Beta.AdministrativeUnits.MicrosoftGraphGetUserOwnedObjects;
using Microsoft.Graph.Beta.AdministrativeUnits.MicrosoftGraphValidateProperties;
...
namespace Microsoft.Graph.Beta.AdministrativeUnits {
    ...
    public class AdministrativeUnitsRequestBuilder {
        ...
        public AdministrativeUnitsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/administrativeUnits{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
