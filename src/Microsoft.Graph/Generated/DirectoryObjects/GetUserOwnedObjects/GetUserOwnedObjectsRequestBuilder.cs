...
namespace MicrosoftGraphSdk.DirectoryObjects.GetUserOwnedObjects {
    /// <summary>Builds and executes requests for operations under \directoryObjects\microsoft.graph.getUserOwnedObjects</summary>
    public class GetUserOwnedObjectsRequestBuilder {
        ...
        public GetUserOwnedObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directoryObjects/microsoft.graph.getUserOwnedObjects";
