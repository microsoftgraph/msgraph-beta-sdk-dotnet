...
namespace Microsoft.Graph.Beta.Storage.FileStorage.DeletedContainers.Item.Drive.Activities.Item.DriveItem.Content
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Storage.FileStorage.DeletedContainers.Item.Drive.Activities.Item.DriveItem.Content.ContentRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Storage.FileStorage.DeletedContainers.Item.Drive.Activities.Item.DriveItem.Content.ContentRequestBuilder.ContentRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Storage.FileStorage.DeletedContainers.Item.Drive.Activities.Item.DriveItem.Content.ContentRequestBuilder.ContentRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Storage.FileStorage.DeletedContainers.Item.Drive.Activities.Item.DriveItem.Content.ContentRequestBuilder.ContentRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Storage.FileStorage.DeletedContainers.Item.Drive.Activities.Item.DriveItem.Content.ContentRequestBuilder.ContentRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Storage.FileStorage.DeletedContainers.Item.Drive.Activities.Item.DriveItem.Content.ContentRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Beta.Storage.FileStorage.DeletedContainers.Item.Drive.Activities.Item.DriveItem.Content.ContentRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Beta.Storage.FileStorage.DeletedContainers.Item.Drive.Activities.Item.DriveItem.Content.ContentRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.17.0")]
        public partial class ContentRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Microsoft.Graph.Beta.Storage.FileStorage.DeletedContainers.Item.Drive.Activities.Item.DriveItem.Content.ContentRequestBuilder.ContentRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
