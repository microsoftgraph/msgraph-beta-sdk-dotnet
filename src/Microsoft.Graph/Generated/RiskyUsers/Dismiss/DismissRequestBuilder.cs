...
namespace Microsoft.Graph.Beta.RiskyUsers.Dismiss {
    ...
    public class DismissRequestBuilder : BaseRequestBuilder {
        ...
        public DismissRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/riskyUsers/dismiss", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DismissRequestBuilder and sets the default values.
        /// </summary>
