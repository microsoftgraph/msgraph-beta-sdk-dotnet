...
namespace Microsoft.Graph.Beta.RiskyUsers.ConfirmCompromised {
    ...
    public class ConfirmCompromisedRequestBuilder : BaseRequestBuilder {
        ...
        public ConfirmCompromisedRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/riskyUsers/confirmCompromised", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ConfirmCompromisedRequestBuilder and sets the default values.
        /// </summary>
