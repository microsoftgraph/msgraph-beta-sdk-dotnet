...
namespace Microsoft.Graph.Beta.RiskyUsers.MicrosoftGraphDismiss {
    /// <summary>
    ...
    public class MicrosoftGraphDismissRequestBuilder {
        ...
        public MicrosoftGraphDismissRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/riskyUsers/microsoft.graph.dismiss";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphDismissRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/riskyusers-dismiss?view=graph-rest-1.0" />
        /// </summary>
...
#nullable enable
        public async Task PostAsync(DismissPostRequestBody body, Action<MicrosoftGraphDismissRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(DismissPostRequestBody body, Action<MicrosoftGraphDismissRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
