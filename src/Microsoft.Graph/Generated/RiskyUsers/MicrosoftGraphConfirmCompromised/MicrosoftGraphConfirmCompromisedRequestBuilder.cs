...
namespace Microsoft.Graph.Beta.RiskyUsers.MicrosoftGraphConfirmCompromised {
    /// <summary>
    ...
    public class MicrosoftGraphConfirmCompromisedRequestBuilder {
        ...
        public MicrosoftGraphConfirmCompromisedRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/riskyUsers/microsoft.graph.confirmCompromised";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphConfirmCompromisedRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/riskyusers-confirmcompromised?view=graph-rest-1.0" />
        /// </summary>
...
#nullable enable
        public async Task PostAsync(ConfirmCompromisedPostRequestBody body, Action<MicrosoftGraphConfirmCompromisedRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(ConfirmCompromisedPostRequestBody body, Action<MicrosoftGraphConfirmCompromisedRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
