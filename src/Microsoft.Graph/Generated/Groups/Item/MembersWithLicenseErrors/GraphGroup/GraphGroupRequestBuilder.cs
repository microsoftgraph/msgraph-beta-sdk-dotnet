using Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.GraphGroup.Count;
...
namespace Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.GraphGroup {
    /// <summary>
    ...
    public class GraphGroupRequestBuilder {
        ...
        public GraphGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
