...
namespace Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.MicrosoftGraphGroup.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/microsoft.graph.group/$count{?%24search,%24filter}";
