using Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.GraphUser.Count;
...
namespace Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.GraphUser {
    /// <summary>
    ...
    public class GraphUserRequestBuilder {
        ...
        public GraphUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
