using Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.GraphApplication.Count;
...
namespace Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.GraphApplication {
    /// <summary>
    ...
    public class GraphApplicationRequestBuilder {
        ...
        public GraphApplicationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/graph.application{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
