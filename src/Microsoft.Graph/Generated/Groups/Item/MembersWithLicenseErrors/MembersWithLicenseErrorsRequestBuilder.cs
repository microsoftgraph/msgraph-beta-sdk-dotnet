using Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.Application;
using Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.Count;
using Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.Device;
using Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.Group;
using Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.Item;
using Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.OrgContact;
using Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.ServicePrincipal;
using Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.User;
...
namespace Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors {
    ...
    public class MembersWithLicenseErrorsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.groups.item.membersWithLicenseErrors.item collection</summary>
        ...
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MembersWithLicenseErrorsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
