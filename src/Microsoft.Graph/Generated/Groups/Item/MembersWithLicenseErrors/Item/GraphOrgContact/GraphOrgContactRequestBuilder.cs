...
using System;
namespace Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.Item.GraphOrgContact {
    /// <summary>
    ...
    public class GraphOrgContactRequestBuilder : BaseRequestBuilder {
        ...
        public GraphOrgContactRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/{directoryObject%2Did}/graph.orgContact{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphOrgContactRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphOrgContactRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/{directoryObject%2Did}/graph.orgContact{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
