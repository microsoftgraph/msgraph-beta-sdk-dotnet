...
namespace Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.Item.GraphDevice {
    /// <summary>
    ...
    public class GraphDeviceRequestBuilder {
        ...
        public GraphDeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/{directoryObject%2Did}/graph.device{?%24select,%24expand}";
