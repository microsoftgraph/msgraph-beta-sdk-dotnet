using Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.User.Count;
...
namespace Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.User {
    ...
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/microsoft.graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
