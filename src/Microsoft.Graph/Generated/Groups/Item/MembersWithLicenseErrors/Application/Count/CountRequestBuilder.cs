...
namespace Microsoft.Graph.Beta.Groups.Item.MembersWithLicenseErrors.Application.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/microsoft.graph.application/$count";
