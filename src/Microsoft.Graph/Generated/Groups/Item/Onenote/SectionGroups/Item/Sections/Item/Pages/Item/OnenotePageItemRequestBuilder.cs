...
using MicrosoftGraphSdk.Groups.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.Content;
using MicrosoftGraphSdk.Groups.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.CopyToSection;
using MicrosoftGraphSdk.Groups.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.OnenotePatchContent;
using MicrosoftGraphSdk.Groups.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.ParentNotebook;
using MicrosoftGraphSdk.Groups.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.ParentSection;
using MicrosoftGraphSdk.Groups.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.Preview;
...
namespace MicrosoftGraphSdk.Groups.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item {
    ...
    public class OnenotePageItemRequestBuilder {
        ...
        public OnenotePageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/onenote/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}{?select,expand}";
