...
using MicrosoftGraph.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item;
...
namespace MicrosoftGraph.Groups.Item.Onenote.Notebooks.Item.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.onenote.notebooks.item.sectionGroups.item collection</summary>
