...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages {
    public class PagesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as PagesResponse).Value = n.GetCollectionOfObjectValues<OnenotePage>().ToList(); } },
            };
        }
        /// <summary>
