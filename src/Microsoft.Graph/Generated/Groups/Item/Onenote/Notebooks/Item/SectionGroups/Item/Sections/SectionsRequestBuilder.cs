...
using MicrosoftGraph.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item;
...
namespace MicrosoftGraph.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.onenote.notebooks.item.sectionGroups.item.sections.item collection</summary>
