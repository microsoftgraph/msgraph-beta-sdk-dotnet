...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.CopyToNotebook {
    /// <summary>Provides operations to call the copyToNotebook method.</summary>
    public class CopyToNotebookRequestBody : IParsable, IAdditionalDataHolder {
