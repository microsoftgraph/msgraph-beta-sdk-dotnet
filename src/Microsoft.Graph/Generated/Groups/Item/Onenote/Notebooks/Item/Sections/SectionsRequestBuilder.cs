...
using MicrosoftGraph.Groups.Item.Onenote.Notebooks.Item.Sections.Item;
...
namespace MicrosoftGraph.Groups.Item.Onenote.Notebooks.Item.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.onenote.notebooks.item.sections.item collection</summary>
