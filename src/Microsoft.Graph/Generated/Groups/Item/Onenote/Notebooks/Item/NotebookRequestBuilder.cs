...
using MicrosoftGraph.Groups.Item.Onenote.Notebooks.Item.CopyNotebook;
using MicrosoftGraph.Groups.Item.Onenote.Notebooks.Item.SectionGroups;
using MicrosoftGraph.Groups.Item.Onenote.Notebooks.Item.Sections;
...
namespace MicrosoftGraph.Groups.Item.Onenote.Notebooks.Item {
    ...
    public class NotebookRequestBuilder {
        ...
        /// </summary>
        public NotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public NotebookRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
