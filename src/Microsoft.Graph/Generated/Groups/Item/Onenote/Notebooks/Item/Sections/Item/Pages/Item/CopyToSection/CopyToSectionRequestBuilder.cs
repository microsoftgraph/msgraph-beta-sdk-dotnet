...
namespace MicrosoftGraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.CopyToSection {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\onenote\notebooks\{notebook-id}\sections\{onenoteSection-id}\pages\{onenotePage-id}\microsoft.graph.copyToSection</summary>
    public class CopyToSectionRequestBuilder {
        ...
        public CopyToSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}/microsoft.graph.copyToSection";
