...
namespace Microsoft.Graph.Beta.Groups.Item.Onenote.Notebooks.GetRecentNotebooksWithIncludePersonalNotebooks {
    ...
    public class GetRecentNotebooksWithIncludePersonalNotebooksResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<RecentNotebook> Value {
            get { return BackingStore?.Get<List<RecentNotebook>>(nameof(Value)); }
