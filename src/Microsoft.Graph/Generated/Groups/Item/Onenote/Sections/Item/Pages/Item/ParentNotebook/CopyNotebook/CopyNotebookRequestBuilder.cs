...
namespace MicrosoftGraphSdk.Groups.Item.Onenote.Sections.Item.Pages.Item.ParentNotebook.CopyNotebook {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\onenote\sections\{onenoteSection-id}\pages\{onenotePage-id}\parentNotebook\microsoft.graph.copyNotebook</summary>
    public class CopyNotebookRequestBuilder {
        ...
        public CopyNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook/microsoft.graph.copyNotebook";
