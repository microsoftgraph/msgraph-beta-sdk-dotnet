...
using MicrosoftGraph.Groups.Item.Onenote.Sections.Item.CopyToNotebook;
using MicrosoftGraph.Groups.Item.Onenote.Sections.Item.CopyToSectionGroup;
using MicrosoftGraph.Groups.Item.Onenote.Sections.Item.Pages;
using MicrosoftGraph.Groups.Item.Onenote.Sections.Item.ParentNotebook;
using MicrosoftGraph.Groups.Item.Onenote.Sections.Item.ParentSectionGroup;
...
namespace MicrosoftGraph.Groups.Item.Onenote.Sections.Item {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\onenote\sections\{onenoteSection-id}</summary>
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/onenote/sections/{onenoteSection_id}{?select,expand}";
