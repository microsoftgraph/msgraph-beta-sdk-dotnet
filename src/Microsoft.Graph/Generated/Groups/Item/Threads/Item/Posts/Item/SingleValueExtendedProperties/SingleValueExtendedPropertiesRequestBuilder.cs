...
using MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.SingleValueExtendedProperties.Item;
...
namespace MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.threads.item.posts.item.singleValueExtendedProperties.item collection</summary>
