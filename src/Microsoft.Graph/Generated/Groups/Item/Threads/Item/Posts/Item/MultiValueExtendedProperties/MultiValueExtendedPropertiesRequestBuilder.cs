...
namespace MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\threads\{conversationThread-id}\posts\{post-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.threads.item.posts.item.multiValueExtendedProperties.item collection</summary>
