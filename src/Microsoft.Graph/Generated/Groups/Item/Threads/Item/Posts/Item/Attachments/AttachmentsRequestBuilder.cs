...
using MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.Attachments.CreateUploadSession;
using MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.Attachments.Item;
...
namespace MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.threads.item.posts.item.attachments.item collection</summary>
