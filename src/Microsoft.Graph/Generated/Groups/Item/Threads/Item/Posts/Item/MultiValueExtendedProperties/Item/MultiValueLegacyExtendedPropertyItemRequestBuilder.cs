...
namespace MicrosoftGraphSdk.Groups.Item.Threads.Item.Posts.Item.MultiValueExtendedProperties.Item {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\threads\{conversationThread-id}\posts\{post-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}</summary>
