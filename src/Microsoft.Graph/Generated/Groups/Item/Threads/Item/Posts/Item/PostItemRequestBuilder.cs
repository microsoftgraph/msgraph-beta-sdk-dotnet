...
using Microsoft.Graph.Beta.Groups.Item.Threads.Item.Posts.Item.MicrosoftGraphForward;
using Microsoft.Graph.Beta.Groups.Item.Threads.Item.Posts.Item.MicrosoftGraphReply;
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Post?> PatchAsync(Post body, Action<PostItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Post> PatchAsync(Post body, Action<PostItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
