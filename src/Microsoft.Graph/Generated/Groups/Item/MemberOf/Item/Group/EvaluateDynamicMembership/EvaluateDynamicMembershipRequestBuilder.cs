...
namespace Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.EvaluateDynamicMembership {
    ...
    public class EvaluateDynamicMembershipRequestBuilder {
        ...
        public EvaluateDynamicMembershipRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.evaluateDynamicMembership";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(EvaluateDynamicMembershipPostRequestBody body, Action<EvaluateDynamicMembershipRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<EvaluateDynamicMembershipResult> PostAsync(EvaluateDynamicMembershipPostRequestBody body, Action<EvaluateDynamicMembershipRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
