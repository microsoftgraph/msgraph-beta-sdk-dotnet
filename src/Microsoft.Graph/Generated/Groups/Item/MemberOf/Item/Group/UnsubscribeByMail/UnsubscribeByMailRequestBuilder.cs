...
namespace Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.UnsubscribeByMail {
    ...
    public class UnsubscribeByMailRequestBuilder {
        ...
        public UnsubscribeByMailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.unsubscribeByMail";
