...
namespace Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.SubscribeByMail {
    ...
    public class SubscribeByMailRequestBuilder {
        ...
        public SubscribeByMailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.subscribeByMail";
