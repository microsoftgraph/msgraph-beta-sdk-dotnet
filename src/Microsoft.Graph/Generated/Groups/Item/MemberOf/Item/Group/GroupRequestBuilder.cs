using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.AddFavorite;
using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.AssignLicense;
using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.CheckGrantedPermissionsForApp;
using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.CheckMemberGroups;
using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.CheckMemberObjects;
using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.EvaluateDynamicMembership;
using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.GetMemberGroups;
using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.GetMemberObjects;
using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.RemoveFavorite;
using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.Renew;
using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.ResetUnseenCount;
using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.Restore;
using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.SubscribeByMail;
using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.UnsubscribeByMail;
using Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group.ValidateProperties;
...
namespace Microsoft.Graph.Beta.Groups.Item.MemberOf.Item.Group {
    ...
    public class GroupRequestBuilder {
        ...
        public GroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.group{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Group> GetAsync(Action<GroupRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
