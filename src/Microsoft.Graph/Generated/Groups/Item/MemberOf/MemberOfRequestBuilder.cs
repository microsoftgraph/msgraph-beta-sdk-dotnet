...
using MicrosoftGraphSdk.Groups.Item.MemberOf.Count;
using MicrosoftGraphSdk.Groups.Item.MemberOf.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.memberOf.item collection</summary>
