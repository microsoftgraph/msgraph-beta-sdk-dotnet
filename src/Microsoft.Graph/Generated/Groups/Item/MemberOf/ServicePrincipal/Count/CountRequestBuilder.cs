...
namespace Microsoft.Graph.Beta.Groups.Item.MemberOf.ServicePrincipal.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/memberOf/microsoft.graph.servicePrincipal/$count";
