...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Permissions.Item.RevokeGrants
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Groups.Item.Sites.Item.Permissions.Item.RevokeGrants.RevokeGrantsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Permission?> PostAsync(Microsoft.Graph.Beta.Groups.Item.Sites.Item.Permissions.Item.RevokeGrants.RevokeGrantsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Permission> PostAsync(Microsoft.Graph.Beta.Groups.Item.Sites.Item.Permissions.Item.RevokeGrants.RevokeGrantsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Groups.Item.Sites.Item.Permissions.Item.RevokeGrants.RevokeGrantsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Groups.Item.Sites.Item.Permissions.Item.RevokeGrants.RevokeGrantsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Groups.Item.Sites.Item.Permissions.Item.RevokeGrants.RevokeGrantsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Groups.Item.Sites.Item.Permissions.Item.RevokeGrants.RevokeGrantsRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Groups.Item.Sites.Item.Permissions.Item.RevokeGrants.RevokeGrantsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
