...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Permission?> PostAsync(RevokeGrantsPostRequestBody body, CancellationToken cancellationToken = default, Action<RevokeGrantsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Permission> PostAsync(RevokeGrantsPostRequestBody body, CancellationToken cancellationToken = default, Action<RevokeGrantsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
