...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.Permissions.Item.RevokeGrants {
    ...
    public class RevokeGrantsRequestBuilder {
        ...
        public RevokeGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/permissions/{permission_id}/microsoft.graph.revokeGrants";
