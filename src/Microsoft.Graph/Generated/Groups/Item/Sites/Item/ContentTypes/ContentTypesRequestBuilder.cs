...
using MicrosoftGraphSdk.Groups.Item.Sites.Item.ContentTypes.AddCopy;
using MicrosoftGraphSdk.Groups.Item.Sites.Item.ContentTypes.AddCopyFromContentTypeHub;
using MicrosoftGraphSdk.Groups.Item.Sites.Item.ContentTypes.Count;
using MicrosoftGraphSdk.Groups.Item.Sites.Item.ContentTypes.GetCompatibleHubContentTypes;
using MicrosoftGraphSdk.Groups.Item.Sites.Item.ContentTypes.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.ContentTypes {
    ...
    public class ContentTypesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.sites.item.contentTypes.item collection</summary>
        ...
        public ContentTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/contentTypes{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
