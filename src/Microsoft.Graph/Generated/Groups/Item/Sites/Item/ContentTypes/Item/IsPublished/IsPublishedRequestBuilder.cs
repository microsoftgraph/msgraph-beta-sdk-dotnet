...
#nullable enable
        public async Task<IsPublishedResponse?> GetAsync(CancellationToken cancellationToken = default, Action<IsPublishedRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IsPublishedResponse> GetAsync(CancellationToken cancellationToken = default, Action<IsPublishedRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
