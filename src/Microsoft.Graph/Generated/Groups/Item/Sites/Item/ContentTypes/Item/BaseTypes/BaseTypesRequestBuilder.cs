using Microsoft.Graph.Beta.Groups.Item.Sites.Item.ContentTypes.Item.BaseTypes.Count;
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.ContentTypes.Item.BaseTypes.Item;
...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.groups.item.sites.item.contentTypes.item.baseTypes.item collection</summary>
        public Microsoft.Graph.Beta.Groups.Item.Sites.Item.ContentTypes.Item.BaseTypes.Item.ContentTypeItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("contentType%2Did1", position);
            return new Microsoft.Graph.Beta.Groups.Item.Sites.Item.ContentTypes.Item.BaseTypes.Item.ContentTypeItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
