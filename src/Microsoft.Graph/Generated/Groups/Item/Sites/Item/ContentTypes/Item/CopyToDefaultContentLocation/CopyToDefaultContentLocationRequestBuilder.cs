...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.ContentTypes.Item.CopyToDefaultContentLocation {
    ...
    public class CopyToDefaultContentLocationRequestBuilder {
        ...
        public CopyToDefaultContentLocationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/contentTypes/{contentType_id}/microsoft.graph.copyToDefaultContentLocation";
        ...
        /// </summary>
        public async Task PostAsync(CopyToDefaultContentLocationRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
