...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.ContentTypes.Item.CopyToDefaultContentLocation {
    ...
    public class CopyToDefaultContentLocationRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CopyToDefaultContentLocationPostRequestBody body, Action<CopyToDefaultContentLocationRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
