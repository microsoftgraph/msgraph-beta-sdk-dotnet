...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.ContentTypes.Item.CopyToDefaultContentLocation {
    ...
    public class CopyToDefaultContentLocationRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CopyToDefaultContentLocationPostRequestBody body, CancellationToken cancellationToken = default, Action<CopyToDefaultContentLocationRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
