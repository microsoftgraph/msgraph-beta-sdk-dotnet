...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.ContentTypes.Item.AssociateWithHubSites {
    ...
    public class AssociateWithHubSitesRequestBuilder {
        ...
        public AssociateWithHubSitesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/microsoft.graph.associateWithHubSites";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AssociateWithHubSitesPostRequestBody body, Action<AssociateWithHubSitesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(AssociateWithHubSitesPostRequestBody body, Action<AssociateWithHubSitesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
