...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.ContentTypes.Item.AssociateWithHubSites {
    ...
    public class AssociateWithHubSitesRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(AssociateWithHubSitesPostRequestBody body, CancellationToken cancellationToken = default, Action<AssociateWithHubSitesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
