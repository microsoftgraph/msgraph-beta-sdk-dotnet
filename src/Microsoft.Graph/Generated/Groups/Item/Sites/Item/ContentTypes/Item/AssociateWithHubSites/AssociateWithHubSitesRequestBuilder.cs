...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.ContentTypes.Item.AssociateWithHubSites {
    ...
    public class AssociateWithHubSitesRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(AssociateWithHubSitesRequestBody body, Action<AssociateWithHubSitesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
