...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.Lists.Item.ContentTypes.GetCompatibleHubContentTypes {
    ...
    public class GetCompatibleHubContentTypesResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetCompatibleHubContentTypesResponse).Value = n.GetCollectionOfObjectValues<ContentType>(ContentType.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
