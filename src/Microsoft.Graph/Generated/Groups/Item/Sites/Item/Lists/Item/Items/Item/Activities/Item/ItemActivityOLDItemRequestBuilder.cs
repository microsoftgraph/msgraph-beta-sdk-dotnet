using Microsoft.Graph.Beta.Groups.Item.Sites.Item.Lists.Item.Items.Item.Activities.Item.DriveItem;
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.Lists.Item.Items.Item.Activities.Item.ListItem;
...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Lists.Item.Items.Item.Activities.Item {
    /// <summary>
    ...
    public class ItemActivityOLDItemRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Groups.Item.Sites.Item.Lists.Item.Items.Item.Activities.Item.ListItem.ListItemRequestBuilder ListItem { get =>
            new Microsoft.Graph.Beta.Groups.Item.Sites.Item.Lists.Item.Items.Item.Activities.Item.ListItem.ListItemRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ItemActivityOLDItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ItemActivityOLDItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
