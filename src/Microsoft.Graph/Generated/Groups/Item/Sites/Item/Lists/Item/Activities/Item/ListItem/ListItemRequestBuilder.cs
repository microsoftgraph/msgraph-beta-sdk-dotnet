...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.Lists.Item.Activities.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/lists/{list_id}/activities/{itemActivityOLD_id}/listItem{?select,expand}";
