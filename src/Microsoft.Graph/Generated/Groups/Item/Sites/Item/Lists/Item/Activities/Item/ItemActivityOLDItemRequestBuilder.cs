...
using MicrosoftGraphSdk.Groups.Item.Sites.Item.Lists.Item.Activities.Item.DriveItem;
using MicrosoftGraphSdk.Groups.Item.Sites.Item.Lists.Item.Activities.Item.ListItem;
...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.Lists.Item.Activities.Item {
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/lists/{list_id}/activities/{itemActivityOLD_id}{?select,expand}";
