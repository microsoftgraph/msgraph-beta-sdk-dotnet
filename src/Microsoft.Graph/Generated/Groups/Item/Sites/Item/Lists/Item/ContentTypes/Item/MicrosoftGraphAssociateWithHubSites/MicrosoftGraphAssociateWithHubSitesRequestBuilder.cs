...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.MicrosoftGraphAssociateWithHubSites {
    /// <summary>
    ...
    public class MicrosoftGraphAssociateWithHubSitesRequestBuilder {
        ...
        public MicrosoftGraphAssociateWithHubSitesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphAssociateWithHubSitesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(AssociateWithHubSitesPostRequestBody body, Action<MicrosoftGraphAssociateWithHubSitesRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(AssociateWithHubSitesPostRequestBody body, Action<MicrosoftGraphAssociateWithHubSitesRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
