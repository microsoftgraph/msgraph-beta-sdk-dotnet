using Microsoft.Graph.Beta.Groups.Item.Sites.Item.Lists.Item.Items.Item.DocumentSetVersions.Item.MicrosoftGraphRestore;
...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Lists.Item.Items.Item.DocumentSetVersions.Item {
    /// <summary>
    ...
    public class DocumentSetVersionItemRequestBuilder {
        ...
        public DocumentSetVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}";
