...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Lists {
    ...
    public class ListsRequestBuilder {
        ...
        /// </summary>
        public async Task<ListCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ListsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.List> PostAsync(Microsoft.Graph.Beta.Models.List body, CancellationToken cancellationToken = default, Action<ListsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
