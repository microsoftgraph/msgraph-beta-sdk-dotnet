...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Lists.Item.Items.Item.CreateLink {
    ...
    public class CreateLinkRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CreateLinkPostRequestBody body, Action<CreateLinkRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Permission> PostAsync(CreateLinkPostRequestBody body, Action<CreateLinkRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
