...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Lists.Item.Items.Item.CreateLink {
    ...
    public class CreateLinkRequestBuilder : BaseRequestBuilder {
        ...
        public CreateLinkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/createLink", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreateLinkRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateLinkRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/createLink", rawUrl) {
        }
        /// <summary>
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/listitem-createlink?view=graph-rest-1.0" />
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Permission?> PostAsync(CreateLinkPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateLinkRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Permission> PostAsync(CreateLinkPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateLinkRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
