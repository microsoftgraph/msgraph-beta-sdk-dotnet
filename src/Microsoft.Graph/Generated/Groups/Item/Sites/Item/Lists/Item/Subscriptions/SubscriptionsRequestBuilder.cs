...
using MicrosoftGraphSdk.Groups.Item.Sites.Item.Lists.Item.Subscriptions.Count;
using MicrosoftGraphSdk.Groups.Item.Sites.Item.Lists.Item.Subscriptions.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.Lists.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.sites.item.lists.item.subscriptions.item collection</summary>
