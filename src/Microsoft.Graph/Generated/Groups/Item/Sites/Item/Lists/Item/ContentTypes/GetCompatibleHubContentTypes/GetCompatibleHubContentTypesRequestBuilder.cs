...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Lists.Item.ContentTypes.GetCompatibleHubContentTypes {
    ...
    public class GetCompatibleHubContentTypesRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetCompatibleHubContentTypesGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function getCompatibleHubContentTypes
        /// </summary>
        /// <returns>A <cref="GetCompatibleHubContentTypesResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetCompatibleHubContentTypesRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
