...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.Lists.Item.Activities.Item.DriveItem.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/lists/{list_id}/activities/{itemActivityOLD_id}/driveItem/content";
