...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<BaseItemCollectionResponse> GetAsync(Action<ItemsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
