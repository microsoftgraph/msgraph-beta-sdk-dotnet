...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// </summary>
        public async Task<BaseItemCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ItemsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
