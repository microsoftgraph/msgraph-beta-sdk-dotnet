...
#nullable enable
        public async Task<BaseItem?> GetAsync(CancellationToken cancellationToken = default, Action<BaseItemItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BaseItem> GetAsync(CancellationToken cancellationToken = default, Action<BaseItemItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
