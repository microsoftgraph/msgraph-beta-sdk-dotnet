...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Items.Item {
    ...
    public class BaseItemItemRequestBuilder {
        ...
        /// </summary>
        public async Task<BaseItem> GetAsync(CancellationToken cancellationToken = default, Action<BaseItemItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
