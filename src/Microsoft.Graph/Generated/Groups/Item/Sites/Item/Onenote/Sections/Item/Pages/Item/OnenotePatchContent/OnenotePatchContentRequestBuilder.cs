...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Onenote.Sections.Item.Pages.Item.OnenotePatchContent {
    ...
    public class OnenotePatchContentRequestBuilder : BaseRequestBuilder {
        ...
        public OnenotePatchContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/onenotePatchContent", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OnenotePatchContentRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OnenotePatchContentRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/onenotePatchContent", rawUrl) {
        }
        /// <summary>
