...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item {
    ...
    public class OnenoteSectionItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        {
            get => new CopyToNotebookRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new CopyToSectionGroupRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        /// <summary>
        /// Instantiates a new <see cref="OnenoteSectionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}", PathParameters);
...
#endif
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
