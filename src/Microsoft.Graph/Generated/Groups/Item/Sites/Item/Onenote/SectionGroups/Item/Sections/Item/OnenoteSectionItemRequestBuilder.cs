using Microsoft.Graph.Beta.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToNotebook;
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToSectionGroup;
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.Pages;
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.ParentNotebook;
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.ParentSectionGroup;
...
using System;
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item {
    /// <summary>
    ...
    public class OnenoteSectionItemRequestBuilder : BaseRequestBuilder {
        ...
        public OnenoteSectionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OnenoteSectionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OnenoteSectionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<OnenoteSectionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<OnenoteSectionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OnenoteSection?> GetAsync(CancellationToken cancellationToken = default, Action<OnenoteSectionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OnenoteSection> GetAsync(CancellationToken cancellationToken = default, Action<OnenoteSectionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OnenoteSection?> PatchAsync(OnenoteSection body, CancellationToken cancellationToken = default, Action<OnenoteSectionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OnenoteSection> PatchAsync(OnenoteSection body, CancellationToken cancellationToken = default, Action<OnenoteSectionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
