...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages.Item.CopyToSection {
    ...
    public class CopyToSectionRequestBuilder {
        ...
        /// </summary>
        public async Task<OnenoteOperation> PostAsync(CopyToSectionPostRequestBody body, CancellationToken cancellationToken = default, Action<CopyToSectionRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
