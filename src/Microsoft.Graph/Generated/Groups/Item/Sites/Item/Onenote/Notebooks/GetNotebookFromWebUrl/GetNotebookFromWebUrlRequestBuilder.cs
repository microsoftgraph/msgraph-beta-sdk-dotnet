...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.Onenote.Notebooks.GetNotebookFromWebUrl {
    ...
    public class GetNotebookFromWebUrlRequestBuilder {
        ...
        /// </summary>
        public async Task<CopyNotebookModel> PostAsync(GetNotebookFromWebUrlRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
