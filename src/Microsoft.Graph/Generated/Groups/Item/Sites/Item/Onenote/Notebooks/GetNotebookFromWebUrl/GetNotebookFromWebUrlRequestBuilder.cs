...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Onenote.Notebooks.GetNotebookFromWebUrl {
    ...
    public class GetNotebookFromWebUrlRequestBuilder {
        ...
        /// </summary>
        public async Task<CopyNotebookModel> PostAsync(GetNotebookFromWebUrlPostRequestBody body, CancellationToken cancellationToken = default, Action<GetNotebookFromWebUrlRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
