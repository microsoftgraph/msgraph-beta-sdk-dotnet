...
using System;
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Onenote.Notebooks.GetNotebookFromWebUrl {
    /// <summary>
    ...
    public class GetNotebookFromWebUrlRequestBuilder : BaseRequestBuilder {
        ...
        public GetNotebookFromWebUrlRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/getNotebookFromWebUrl", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetNotebookFromWebUrlRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetNotebookFromWebUrlRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/getNotebookFromWebUrl", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<CopyNotebookModel?> PostAsync(GetNotebookFromWebUrlPostRequestBody body, CancellationToken cancellationToken = default, Action<GetNotebookFromWebUrlRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CopyNotebookModel> PostAsync(GetNotebookFromWebUrlPostRequestBody body, CancellationToken cancellationToken = default, Action<GetNotebookFromWebUrlRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
