...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.Onenote.Notebooks.Item.CopyNotebook {
    /// <summary>Provides operations to call the copyNotebook method.</summary>
    public class CopyNotebookRequestBody : IParsable, IAdditionalDataHolder {
