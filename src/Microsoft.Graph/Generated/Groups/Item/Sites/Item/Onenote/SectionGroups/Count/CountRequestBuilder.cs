...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Onenote.SectionGroups.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/$count{?%24search,%24filter}";
