...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.Onenote.Pages.Item.OnenotePatchContent {
    ...
    public class OnenotePatchContentRequestBuilder {
        ...
        public OnenotePatchContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/onenote/pages/{onenotePage_id}/microsoft.graph.onenotePatchContent";
