...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.Pages.Item.CopyToSection {
    ...
    public class CopyToSectionRequestBuilder {
        ...
        public CopyToSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/microsoft.graph.copyToSection";
