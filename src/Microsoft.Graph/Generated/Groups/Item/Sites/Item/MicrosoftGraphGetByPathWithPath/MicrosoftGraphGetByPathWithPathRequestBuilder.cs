...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.MicrosoftGraphGetByPathWithPath {
    /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Site?> GetAsync(Action<MicrosoftGraphGetByPathWithPathRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Site> GetAsync(Action<MicrosoftGraphGetByPathWithPathRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
