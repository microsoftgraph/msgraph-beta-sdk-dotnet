...
using MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets;
...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.ParentGroup {
    ...
    public class ParentGroupRequestBuilder {
        ...
        public MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.SetsRequestBuilder Sets { get =>
            new MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.SetsRequestBuilder(PathParameters, RequestAdapter);
        }
