...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Children.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// </summary>
        public async Task<RelationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RelationsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Relation> PostAsync(Relation body, CancellationToken cancellationToken = default, Action<RelationsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
