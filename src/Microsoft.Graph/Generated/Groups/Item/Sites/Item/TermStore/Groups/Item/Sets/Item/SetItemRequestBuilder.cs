...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item {
    ...
    public class SetItemRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.TermStore.Set body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
