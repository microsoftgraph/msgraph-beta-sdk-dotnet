...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SetItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SetItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.TermStore.Set?> GetAsync(CancellationToken cancellationToken = default, Action<SetItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.TermStore.Set> GetAsync(CancellationToken cancellationToken = default, Action<SetItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.TermStore.Set?> PatchAsync(Microsoft.Graph.Beta.Models.TermStore.Set body, CancellationToken cancellationToken = default, Action<SetItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.TermStore.Set> PatchAsync(Microsoft.Graph.Beta.Models.TermStore.Set body, CancellationToken cancellationToken = default, Action<SetItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
