...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.TermStore {
    ...
    public class TermStoreRequestBuilder : BaseRequestBuilder {
        ...
        public TermStoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TermStoreRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TermStoreRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<TermStoreRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<TermStoreRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Store?> GetAsync(CancellationToken cancellationToken = default, Action<TermStoreRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Store> GetAsync(CancellationToken cancellationToken = default, Action<TermStoreRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Store?> PatchAsync(Store body, CancellationToken cancellationToken = default, Action<TermStoreRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Store> PatchAsync(Store body, CancellationToken cancellationToken = default, Action<TermStoreRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
