using Microsoft.Graph.Beta.Groups.Item.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Count;
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item;
...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.TermStore.Sets.Item.Children.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.groups.item.sites.item.termStore.sets.item.children.item.relations.item collection</summary>
