...
using MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Count;
using MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.sites.item.termStore.groups.item.sets.item.terms.item.relations.item collection</summary>
