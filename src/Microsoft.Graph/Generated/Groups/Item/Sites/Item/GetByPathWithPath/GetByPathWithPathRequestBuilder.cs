...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.GetByPathWithPath {
    ...
    public class GetByPathWithPathRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Site> GetAsync(CancellationToken cancellationToken = default, Action<GetByPathWithPathRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
