...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.GetApplicableContentTypesForListWithListId {
    /// <summary>Provides operations to call the getApplicableContentTypesForList method.</summary>
    public class GetApplicableContentTypesForListWithListIdResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ContentType> Value {
            get { return BackingStore?.Get<List<ContentType>>(nameof(Value)); }
