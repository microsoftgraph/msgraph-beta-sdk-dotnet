...
using System;
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.InformationProtection.SensitivityPolicySettings {
    /// <summary>
    ...
    public class SensitivityPolicySettingsRequestBuilder : BaseRequestBuilder {
        ...
        public SensitivityPolicySettingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/sensitivityPolicySettings{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SensitivityPolicySettingsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SensitivityPolicySettingsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/sensitivityPolicySettings{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
