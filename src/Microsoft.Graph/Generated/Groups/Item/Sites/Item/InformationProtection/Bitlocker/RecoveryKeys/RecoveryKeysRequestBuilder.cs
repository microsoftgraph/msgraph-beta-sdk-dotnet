...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.InformationProtection.Bitlocker.RecoveryKeys {
    ...
    public class RecoveryKeysRequestBuilder : BaseRequestBuilder {
        ...
        public RecoveryKeysRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/bitlocker/recoveryKeys{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RecoveryKeysRequestBuilder and sets the default values.
        /// </summary>
