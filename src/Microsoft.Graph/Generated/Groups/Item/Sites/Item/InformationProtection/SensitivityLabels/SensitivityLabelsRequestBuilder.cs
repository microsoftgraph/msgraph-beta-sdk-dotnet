...
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.InformationProtection.SensitivityLabels.MicrosoftGraphEvaluate;
...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.InformationProtection.SensitivityLabels {
    ...
    public class SensitivityLabelsRequestBuilder {
        ...
        public SensitivityLabelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/sensitivityLabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
