...
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.InformationProtection.Policy.Labels.MicrosoftGraphEvaluateApplication;
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.InformationProtection.Policy.Labels.MicrosoftGraphEvaluateClassificationResults;
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.InformationProtection.Policy.Labels.MicrosoftGraphEvaluateRemoval;
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.InformationProtection.Policy.Labels.MicrosoftGraphExtractLabel;
...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.InformationProtection.Policy.Labels {
    ...
    public class LabelsRequestBuilder {
        ...
        public LabelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/policy/labels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
