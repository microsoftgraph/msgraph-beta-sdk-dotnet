...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.InformationProtection.SensitivityLabels.Evaluate {
    ...
    public class EvaluateRequestBuilder : BaseRequestBuilder {
        ...
        public EvaluateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/sensitivityLabels/evaluate", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EvaluateRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EvaluateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/sensitivityLabels/evaluate", rawUrl) {
        }
        /// <summary>
