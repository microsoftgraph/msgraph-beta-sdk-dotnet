...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.InformationProtection.ThreatAssessmentRequests.Item.Results.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}/results/$count{?%24search,%24filter}";
