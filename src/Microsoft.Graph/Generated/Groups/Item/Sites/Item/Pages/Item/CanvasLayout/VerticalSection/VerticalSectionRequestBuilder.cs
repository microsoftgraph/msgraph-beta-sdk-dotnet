using Microsoft.Graph.Beta.Groups.Item.Sites.Item.Pages.Item.CanvasLayout.VerticalSection.Webparts;
...
using System;
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Pages.Item.CanvasLayout.VerticalSection {
    /// <summary>
    ...
    public class VerticalSectionRequestBuilder : BaseRequestBuilder {
        ...
        public VerticalSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout/verticalSection{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new VerticalSectionRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public VerticalSectionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout/verticalSection{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<VerticalSectionRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<VerticalSectionRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.VerticalSection?> GetAsync(CancellationToken cancellationToken = default, Action<VerticalSectionRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.VerticalSection> GetAsync(CancellationToken cancellationToken = default, Action<VerticalSectionRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.VerticalSection?> PatchAsync(Microsoft.Graph.Beta.Models.VerticalSection body, CancellationToken cancellationToken = default, Action<VerticalSectionRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.VerticalSection> PatchAsync(Microsoft.Graph.Beta.Models.VerticalSection body, CancellationToken cancellationToken = default, Action<VerticalSectionRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
