...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Pages.Item.CanvasLayout.VerticalSection.Webparts.Item.GetPositionOfWebPart {
    ...
    public class GetPositionOfWebPartRequestBuilder {
        ...
        public GetPositionOfWebPartRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout/verticalSection/webparts/{webPart%2Did}/microsoft.graph.getPositionOfWebPart";
        ...
        public RequestInformation CreatePostRequestInformation(Action<GetPositionOfWebPartRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
