using Microsoft.Graph.Beta.Groups.Item.Sites.Item.Analytics.AllTime;
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.Analytics.ItemActivityStats;
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.Analytics.LastSevenDays;
...
using System;
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.Analytics {
    /// <summary>
    ...
    public class AnalyticsRequestBuilder : BaseRequestBuilder {
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/analytics{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AnalyticsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AnalyticsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/analytics{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AnalyticsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AnalyticsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ItemAnalytics?> GetAsync(CancellationToken cancellationToken = default, Action<AnalyticsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ItemAnalytics> GetAsync(CancellationToken cancellationToken = default, Action<AnalyticsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ItemAnalytics?> PatchAsync(ItemAnalytics body, CancellationToken cancellationToken = default, Action<AnalyticsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ItemAnalytics> PatchAsync(ItemAnalytics body, CancellationToken cancellationToken = default, Action<AnalyticsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
