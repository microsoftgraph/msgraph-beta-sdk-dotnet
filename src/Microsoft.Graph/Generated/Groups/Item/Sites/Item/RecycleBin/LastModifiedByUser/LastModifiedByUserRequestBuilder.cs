// <auto-generated/>
using Microsoft.Graph.Beta.Groups.Item.Sites.Item.RecycleBin.LastModifiedByUser.MailboxSettings;
...
using System;
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Item.RecycleBin.LastModifiedByUser
{
    /// <summary>
    ...
    public class LastModifiedByUserRequestBuilder : BaseRequestBuilder
    {
        ...
        public LastModifiedByUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/recycleBin/lastModifiedByUser{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Groups.Item.Sites.Item.RecycleBin.LastModifiedByUser.LastModifiedByUserRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LastModifiedByUserRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/recycleBin/lastModifiedByUser{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
