...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Remove {
    ...
    public class RemoveRequestBuilder {
        ...
        /// </summary>
        public async Task<RemoveResponse> PostAsync(RemovePostRequestBody body, Action<RemoveRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<RemoveResponse>(requestInfo, RemoveResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
