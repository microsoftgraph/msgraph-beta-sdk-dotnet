...
#nullable enable
        public async Task<RemovePostResponse?> PostAsRemovePostResponseAsync(RemovePostRequestBody body, Action<RemoveRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<RemovePostResponse> PostAsRemovePostResponseAsync(RemovePostRequestBody body, Action<RemoveRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<RemovePostResponse>(requestInfo, RemovePostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Unfollow a user&apos;s site or multiple sites.
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/site-unfollow?view=graph-rest-1.0" />
...
#nullable restore
        ...
        public async Task<RemoveResponse> PostAsync(RemovePostRequestBody body, Action<RemoveRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<RemoveResponse>(requestInfo, RemoveResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Unfollow a user&apos;s site or multiple sites.
        /// </summary>
