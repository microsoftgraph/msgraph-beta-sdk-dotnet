...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Remove {
    ...
    public class RemoveRequestBuilder {
        ...
        /// </summary>
        public async Task<RemoveResponse> PostAsync(RemovePostRequestBody body, CancellationToken cancellationToken = default, Action<RemoveRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
