...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.Remove {
    ...
    public class RemoveRequestBuilder : BaseRequestBuilder {
        ...
        public RemoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/remove", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RemoveRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/remove", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<RemoveResponse?> PostAsync(RemovePostRequestBody body, CancellationToken cancellationToken = default, Action<RemoveRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RemoveResponse> PostAsync(RemovePostRequestBody body, CancellationToken cancellationToken = default, Action<RemoveRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
