...
namespace Microsoft.Graph.Beta.Groups.Item.Sites {
    ...
    public class SitesRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Site> PostAsync(Microsoft.Graph.Beta.Models.Site body, CancellationToken cancellationToken = default, Action<SitesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
