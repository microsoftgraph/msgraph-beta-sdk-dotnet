...
namespace Microsoft.Graph.Beta.Groups.Item.Sites.GetOperationStatusWithOperationId
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Groups.Item.Sites.GetOperationStatusWithOperationId.GetOperationStatusWithOperationIdRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="operationId">Usage: operationId=&apos;{operationId}&apos;</param>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetOperationStatusWithOperationIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string operationId = "") : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/getOperationStatus(operationId='{operationId}')", pathParameters)
        {
