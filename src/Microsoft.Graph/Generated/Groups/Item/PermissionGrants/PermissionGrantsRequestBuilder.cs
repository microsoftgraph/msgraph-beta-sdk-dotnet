...
using MicrosoftGraph.Groups.Item.PermissionGrants.Item;
...
namespace MicrosoftGraph.Groups.Item.PermissionGrants {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\permissionGrants</summary>
    public class PermissionGrantsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.permissionGrants.item collection</summary>
