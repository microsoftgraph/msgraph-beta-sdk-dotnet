...
namespace Microsoft.Graph.Beta.Groups.Item.TransitiveMembers.Group.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMembers/microsoft.graph.group/$count";
