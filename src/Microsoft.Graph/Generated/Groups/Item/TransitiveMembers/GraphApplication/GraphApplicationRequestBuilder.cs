...
namespace Microsoft.Graph.Beta.Groups.Item.TransitiveMembers.GraphApplication {
    ...
    /// </summary>
    public class GraphApplicationRequestBuilder {
        ...
        public GraphApplicationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMembers/graph.application{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphApplicationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
