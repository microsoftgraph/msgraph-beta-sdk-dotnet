...
namespace Microsoft.Graph.Beta.Groups.Item.TransitiveMembers.GraphApplication.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMembers/graph.application/$count{?%24search,%24filter}";
