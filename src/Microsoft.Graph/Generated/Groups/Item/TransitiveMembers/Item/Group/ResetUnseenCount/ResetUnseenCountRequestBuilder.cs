...
namespace Microsoft.Graph.Beta.Groups.Item.TransitiveMembers.Item.Group.ResetUnseenCount {
    ...
    public class ResetUnseenCountRequestBuilder {
        ...
        public ResetUnseenCountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMembers/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.resetUnseenCount";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ResetUnseenCountRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public async Task PostAsync(Action<ResetUnseenCountRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
