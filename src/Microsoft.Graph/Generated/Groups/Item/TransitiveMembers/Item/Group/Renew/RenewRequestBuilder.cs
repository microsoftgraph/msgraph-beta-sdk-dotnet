...
namespace Microsoft.Graph.Beta.Groups.Item.TransitiveMembers.Item.Group.Renew {
    ...
    public class RenewRequestBuilder {
        ...
        public RenewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMembers/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.renew";
