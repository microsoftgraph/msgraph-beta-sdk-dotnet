...
namespace Microsoft.Graph.Beta.Groups.Item.TransitiveMembers.Item.Group.EvaluateDynamicMembership {
    ...
    public class EvaluateDynamicMembershipRequestBuilder {
        ...
        public EvaluateDynamicMembershipRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMembers/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.evaluateDynamicMembership";
