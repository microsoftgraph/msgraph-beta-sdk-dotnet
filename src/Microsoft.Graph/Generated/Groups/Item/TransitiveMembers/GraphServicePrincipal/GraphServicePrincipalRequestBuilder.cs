using Microsoft.Graph.Beta.Groups.Item.TransitiveMembers.GraphServicePrincipal.Count;
...
namespace Microsoft.Graph.Beta.Groups.Item.TransitiveMembers.GraphServicePrincipal {
    /// <summary>
    ...
    public class GraphServicePrincipalRequestBuilder {
        ...
        public GraphServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMembers/graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
