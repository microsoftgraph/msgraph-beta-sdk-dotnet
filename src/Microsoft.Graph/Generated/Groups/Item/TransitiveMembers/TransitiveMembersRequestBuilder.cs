...
using MicrosoftGraphSdk.Groups.Item.TransitiveMembers.Count;
using MicrosoftGraphSdk.Groups.Item.TransitiveMembers.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.TransitiveMembers {
    ...
    public class TransitiveMembersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.transitiveMembers.item collection</summary>
