...
using MicrosoftGraph.Groups.Item.CalendarView.Item.Instances.Delta;
using MicrosoftGraph.Groups.Item.CalendarView.Item.Instances.Item;
...
namespace MicrosoftGraph.Groups.Item.CalendarView.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.calendarView.item.instances.item collection</summary>
