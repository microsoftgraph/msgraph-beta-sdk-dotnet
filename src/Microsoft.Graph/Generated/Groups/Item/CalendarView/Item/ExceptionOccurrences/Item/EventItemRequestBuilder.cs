...
using Microsoft.Graph.Beta.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.MicrosoftGraphAccept;
using Microsoft.Graph.Beta.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.MicrosoftGraphCancel;
using Microsoft.Graph.Beta.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.MicrosoftGraphDecline;
using Microsoft.Graph.Beta.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.MicrosoftGraphDismissReminder;
using Microsoft.Graph.Beta.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.MicrosoftGraphForward;
using Microsoft.Graph.Beta.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.MicrosoftGraphSnoozeReminder;
using Microsoft.Graph.Beta.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.MicrosoftGraphTentativelyAccept;
...
namespace Microsoft.Graph.Beta.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}{?%24select,%24expand}";
