...
using MicrosoftGraph.Groups.Item.CalendarView.Item.ExceptionOccurrences.Delta;
using MicrosoftGraph.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item;
...
namespace MicrosoftGraph.Groups.Item.CalendarView.Item.ExceptionOccurrences {
    ...
    public class ExceptionOccurrencesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.calendarView.item.exceptionOccurrences.item collection</summary>
