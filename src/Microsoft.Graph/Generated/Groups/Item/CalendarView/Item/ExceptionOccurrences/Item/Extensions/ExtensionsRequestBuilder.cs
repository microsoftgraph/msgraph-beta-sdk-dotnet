...
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.Extensions.Count;
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.Extensions.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.calendarView.item.exceptionOccurrences.item.extensions.item collection</summary>
