...
using MicrosoftGraph.Groups.Item.CalendarView.Item.Extensions.Item;
...
namespace MicrosoftGraph.Groups.Item.CalendarView.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.calendarView.item.extensions.item collection</summary>
