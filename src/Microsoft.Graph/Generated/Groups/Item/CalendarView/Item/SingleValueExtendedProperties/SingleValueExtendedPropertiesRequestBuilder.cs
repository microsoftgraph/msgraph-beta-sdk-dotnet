...
using MicrosoftGraph.Groups.Item.CalendarView.Item.SingleValueExtendedProperties.Item;
...
namespace MicrosoftGraph.Groups.Item.CalendarView.Item.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.calendarView.item.singleValueExtendedProperties.item collection</summary>
