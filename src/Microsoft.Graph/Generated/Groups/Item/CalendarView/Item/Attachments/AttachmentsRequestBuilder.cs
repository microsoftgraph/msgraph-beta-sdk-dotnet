...
using MicrosoftGraph.Groups.Item.CalendarView.Item.Attachments.CreateUploadSession;
using MicrosoftGraph.Groups.Item.CalendarView.Item.Attachments.Item;
...
namespace MicrosoftGraph.Groups.Item.CalendarView.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.calendarView.item.attachments.item collection</summary>
