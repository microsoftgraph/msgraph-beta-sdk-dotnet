using Microsoft.Graph.Beta.Groups.Item.CalendarView.Item.Attachments.Count;
using Microsoft.Graph.Beta.Groups.Item.CalendarView.Item.Attachments.CreateUploadSession;
using Microsoft.Graph.Beta.Groups.Item.CalendarView.Item.Attachments.Item;
...
namespace Microsoft.Graph.Beta.Groups.Item.CalendarView.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.groups.item.calendarView.item.attachments.item collection</summary>
