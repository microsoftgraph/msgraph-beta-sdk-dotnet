...
namespace MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Attachments.CreateUploadSession {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendarView\{event-id}\attachments\microsoft.graph.createUploadSession</summary>
