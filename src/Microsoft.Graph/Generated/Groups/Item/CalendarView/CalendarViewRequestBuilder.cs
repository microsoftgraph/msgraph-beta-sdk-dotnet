...
using MicrosoftGraph.Groups.Item.CalendarView.Delta;
using MicrosoftGraph.Groups.Item.CalendarView.Item;
...
namespace MicrosoftGraph.Groups.Item.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.calendarView.item collection</summary>
