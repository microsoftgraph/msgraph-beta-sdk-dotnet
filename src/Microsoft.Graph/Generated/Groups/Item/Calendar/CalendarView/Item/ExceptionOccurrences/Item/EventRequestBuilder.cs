...
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Accept;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Cancel;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Decline;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.DismissReminder;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Forward;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.SnoozeReminder;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.TentativelyAccept;
...
namespace MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendar\calendarView\{event-id}\exceptionOccurrences\{event-id1}</summary>
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/calendar/calendarView/{event_id}/exceptionOccurrences/{event_id1}{?select,expand}";
