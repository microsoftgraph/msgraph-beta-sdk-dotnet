...
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.Attachments.CreateUploadSession;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.Attachments.Item;
...
namespace MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.calendar.calendarView.item.attachments.item collection</summary>
