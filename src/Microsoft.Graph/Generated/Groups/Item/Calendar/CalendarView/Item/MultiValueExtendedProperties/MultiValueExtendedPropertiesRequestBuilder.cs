...
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.MultiValueExtendedProperties.Item;
...
namespace MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.calendar.calendarView.item.multiValueExtendedProperties.item collection</summary>
