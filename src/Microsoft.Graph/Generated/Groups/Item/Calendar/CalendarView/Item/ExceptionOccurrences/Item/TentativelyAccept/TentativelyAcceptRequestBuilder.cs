...
namespace MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.TentativelyAccept {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendar\calendarView\{event-id}\exceptionOccurrences\{event-id1}\microsoft.graph.tentativelyAccept</summary>
    public class TentativelyAcceptRequestBuilder {
        ...
        public TentativelyAcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/calendar/calendarView/{event_id}/exceptionOccurrences/{event_id1}/microsoft.graph.tentativelyAccept";
