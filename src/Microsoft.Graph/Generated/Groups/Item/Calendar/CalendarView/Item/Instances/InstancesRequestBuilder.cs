...
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.Instances.Delta;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.Instances.Item;
...
namespace MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.calendar.calendarView.item.instances.item collection</summary>
