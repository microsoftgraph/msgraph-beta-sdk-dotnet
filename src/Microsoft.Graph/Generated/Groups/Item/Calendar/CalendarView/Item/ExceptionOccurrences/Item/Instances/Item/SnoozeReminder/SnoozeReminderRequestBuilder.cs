...
namespace Microsoft.Graph.Beta.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.SnoozeReminder {
    ...
    public class SnoozeReminderRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(SnoozeReminderPostRequestBody body, Action<SnoozeReminderRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
