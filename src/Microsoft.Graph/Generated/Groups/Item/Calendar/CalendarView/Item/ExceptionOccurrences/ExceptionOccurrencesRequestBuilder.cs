...
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Delta;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item;
...
namespace MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences {
    ...
    public class ExceptionOccurrencesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.calendar.calendarView.item.exceptionOccurrences.item collection</summary>
