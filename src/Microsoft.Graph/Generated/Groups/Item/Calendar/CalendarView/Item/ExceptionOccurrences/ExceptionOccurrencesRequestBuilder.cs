...
namespace MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendar\calendarView\{event-id}\exceptionOccurrences</summary>
    public class ExceptionOccurrencesRequestBuilder {
        ...
        /// <summary>
        /// Builds and executes requests for operations under \groups\{group-id}\calendar\calendarView\{event-id}\exceptionOccurrences\microsoft.graph.delta()
        /// </summary>
