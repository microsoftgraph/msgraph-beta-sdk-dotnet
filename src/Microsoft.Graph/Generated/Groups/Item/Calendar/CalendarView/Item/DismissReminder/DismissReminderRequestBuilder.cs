...
namespace Microsoft.Graph.Beta.Groups.Item.Calendar.CalendarView.Item.DismissReminder {
    ...
    public class DismissReminderRequestBuilder : BaseRequestBuilder {
        ...
        public DismissReminderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/dismissReminder", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DismissReminderRequestBuilder and sets the default values.
        /// </summary>
