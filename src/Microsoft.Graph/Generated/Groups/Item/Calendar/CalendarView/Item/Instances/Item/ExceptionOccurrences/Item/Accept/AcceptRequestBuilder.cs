...
namespace MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Accept {
    ...
    public class AcceptRequestBuilder {
        ...
        public AcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/calendar/calendarView/{event_id}/instances/{event_id1}/exceptionOccurrences/{event_id2}/microsoft.graph.accept";
