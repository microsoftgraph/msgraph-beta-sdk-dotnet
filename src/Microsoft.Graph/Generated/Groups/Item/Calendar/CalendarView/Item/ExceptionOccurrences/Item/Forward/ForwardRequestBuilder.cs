...
using System;
namespace Microsoft.Graph.Beta.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Forward {
    /// <summary>
    ...
    public class ForwardRequestBuilder : BaseRequestBuilder {
        ...
        public ForwardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/forward", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ForwardRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ForwardRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/forward", rawUrl) {
        }
        /// <summary>
