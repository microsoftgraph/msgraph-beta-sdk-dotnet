...
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Accept;
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Attachments;
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Calendar;
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Cancel;
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Decline;
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.DismissReminder;
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences;
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Extensions;
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Forward;
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Instances;
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.MultiValueExtendedProperties;
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.SingleValueExtendedProperties;
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.SnoozeReminder;
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.TentativelyAccept;
...
namespace MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Calendar.CalendarRequestBuilder Calendar { get =>
            new MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Calendar.CalendarRequestBuilder(PathParameters, RequestAdapter);
        }
