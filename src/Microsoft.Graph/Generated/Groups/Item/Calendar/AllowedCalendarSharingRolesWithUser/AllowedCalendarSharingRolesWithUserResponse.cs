...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Groups.Item.Calendar.AllowedCalendarSharingRolesWithUser {
    /// <summary>Provides operations to call the allowedCalendarSharingRoles method.</summary>
    public class AllowedCalendarSharingRolesWithUserResponse : IParsable, IAdditionalDataHolder {
