...
namespace MicrosoftGraphSdk.Groups.Item.Calendar.SingleValueExtendedProperties.Item {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendar\singleValueExtendedProperties\{singleValueLegacyExtendedProperty-id}</summary>
