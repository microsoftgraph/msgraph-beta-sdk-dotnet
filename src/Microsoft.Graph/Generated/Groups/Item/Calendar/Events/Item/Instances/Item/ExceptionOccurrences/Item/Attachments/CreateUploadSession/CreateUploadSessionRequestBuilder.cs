...
namespace Microsoft.Graph.Beta.Groups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.Attachments.CreateUploadSession {
    ...
    public class CreateUploadSessionRequestBuilder {
        ...
        public CreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/attachments/createUploadSession";
