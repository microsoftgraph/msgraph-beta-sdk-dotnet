...
using MicrosoftGraph.Groups.Item.Calendar.Events.Item.SingleValueExtendedProperties.Item;
...
namespace MicrosoftGraph.Groups.Item.Calendar.Events.Item.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.calendar.events.item.singleValueExtendedProperties.item collection</summary>
