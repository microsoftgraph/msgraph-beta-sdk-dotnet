...
using MicrosoftGraph.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Delta;
using MicrosoftGraph.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item;
...
namespace MicrosoftGraph.Groups.Item.Calendar.Events.Item.ExceptionOccurrences {
    ...
    public class ExceptionOccurrencesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.calendar.events.item.exceptionOccurrences.item collection</summary>
