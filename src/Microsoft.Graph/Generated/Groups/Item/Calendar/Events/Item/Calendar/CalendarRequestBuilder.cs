...
namespace Microsoft.Graph.Beta.Groups.Item.Calendar.Events.Item.Calendar {
    /// <summary>
    ...
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/calendar{?%24select}";
