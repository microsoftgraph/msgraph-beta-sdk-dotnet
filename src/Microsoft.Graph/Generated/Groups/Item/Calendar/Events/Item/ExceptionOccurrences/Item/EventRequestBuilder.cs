...
using MicrosoftGraph.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.Accept;
using MicrosoftGraph.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.Cancel;
using MicrosoftGraph.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.Decline;
using MicrosoftGraph.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.DismissReminder;
using MicrosoftGraph.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.Forward;
using MicrosoftGraph.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.SnoozeReminder;
using MicrosoftGraph.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.TentativelyAccept;
...
namespace MicrosoftGraph.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendar\events\{event-id}\exceptionOccurrences\{event-id1}</summary>
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/calendar/events/{event_id}/exceptionOccurrences/{event_id1}{?select,expand}";
