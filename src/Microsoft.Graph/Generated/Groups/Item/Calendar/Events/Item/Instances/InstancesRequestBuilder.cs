...
using MicrosoftGraph.Groups.Item.Calendar.Events.Item.Instances.Delta;
using MicrosoftGraph.Groups.Item.Calendar.Events.Item.Instances.Item;
...
namespace MicrosoftGraph.Groups.Item.Calendar.Events.Item.Instances {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendar\events\{event-id}\instances</summary>
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.calendar.events.item.instances.item collection</summary>
        ...
        public InstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/calendar/events/{event_id}/instances{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>
        /// Builds and executes requests for operations under \groups\{group-id}\calendar\events\{event-id}\instances\microsoft.graph.delta()
        /// </summary>
