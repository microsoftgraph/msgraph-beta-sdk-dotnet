...
#nullable enable
        public async Task<GetScheduleResponse?> PostAsync(GetSchedulePostRequestBody body, CancellationToken cancellationToken = default, Action<GetScheduleRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetScheduleResponse> PostAsync(GetSchedulePostRequestBody body, CancellationToken cancellationToken = default, Action<GetScheduleRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
