...
namespace Microsoft.Graph.Beta.Groups.Item.CheckGrantedPermissionsForApp {
    ...
    public class CheckGrantedPermissionsForAppRequestBuilder {
        ...
        public CheckGrantedPermissionsForAppRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/checkGrantedPermissionsForApp";
...
#nullable enable
        public async Task<CheckGrantedPermissionsForAppResponse?> PostAsync(Action<CheckGrantedPermissionsForAppRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CheckGrantedPermissionsForAppResponse> PostAsync(Action<CheckGrantedPermissionsForAppRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
