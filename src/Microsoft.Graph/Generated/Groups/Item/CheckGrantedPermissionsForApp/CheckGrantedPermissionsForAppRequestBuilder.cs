...
namespace Microsoft.Graph.Beta.Groups.Item.CheckGrantedPermissionsForApp {
    ...
    public class CheckGrantedPermissionsForAppRequestBuilder {
        ...
        /// </summary>
        public async Task<CheckGrantedPermissionsForAppResponse> PostAsync(CancellationToken cancellationToken = default, Action<CheckGrantedPermissionsForAppRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<CheckGrantedPermissionsForAppResponse>(requestInfo, CheckGrantedPermissionsForAppResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
