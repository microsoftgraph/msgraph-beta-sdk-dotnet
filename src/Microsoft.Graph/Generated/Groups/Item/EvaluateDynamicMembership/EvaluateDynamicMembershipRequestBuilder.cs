...
namespace Microsoft.Graph.Beta.Groups.Item.EvaluateDynamicMembership {
    ...
    public class EvaluateDynamicMembershipRequestBuilder {
        ...
        /// </summary>
        public async Task<EvaluateDynamicMembershipResult> PostAsync(EvaluateDynamicMembershipPostRequestBody body, CancellationToken cancellationToken = default, Action<EvaluateDynamicMembershipRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<EvaluateDynamicMembershipResult>(requestInfo, EvaluateDynamicMembershipResult.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
