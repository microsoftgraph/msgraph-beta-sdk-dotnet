...
namespace Microsoft.Graph.Beta.Groups.Item.EvaluateDynamicMembership {
    ...
    public class EvaluateDynamicMembershipRequestBuilder {
        ...
        public EvaluateDynamicMembershipRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/microsoft.graph.evaluateDynamicMembership";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(EvaluateDynamicMembershipRequestBody body, Action<EvaluateDynamicMembershipRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<EvaluateDynamicMembershipResult> PostAsync(EvaluateDynamicMembershipRequestBody body, Action<EvaluateDynamicMembershipRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
