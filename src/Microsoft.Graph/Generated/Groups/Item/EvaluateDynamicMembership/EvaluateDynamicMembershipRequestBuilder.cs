...
namespace MicrosoftGraph.Groups.Item.EvaluateDynamicMembership {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\microsoft.graph.evaluateDynamicMembership</summary>
    public class EvaluateDynamicMembershipRequestBuilder {
        ...
        public EvaluateDynamicMembershipRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/microsoft.graph.evaluateDynamicMembership";
        ...
        public async Task<EvaluateDynamicMembershipResponse> PostAsync(EvaluateDynamicMembershipRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<EvaluateDynamicMembershipResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>Union type wrapper for classes evaluateDynamicMembershipResult</summary>
        public class EvaluateDynamicMembershipResponse : IParsable {
            ...
            public EvaluateDynamicMembershipResult EvaluateDynamicMembershipResult { get; set; }
            /// <summary>
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"evaluateDynamicMembershipResult", (o,n) => { (o as EvaluateDynamicMembershipResponse).EvaluateDynamicMembershipResult = n.GetObjectValue<EvaluateDynamicMembershipResult>(); } },
                };
            }
            /// <summary>
            ...
            public void Serialize(ISerializationWriter writer) {
                ...
                writer.WriteObjectValue<EvaluateDynamicMembershipResult>("evaluateDynamicMembershipResult", EvaluateDynamicMembershipResult);
