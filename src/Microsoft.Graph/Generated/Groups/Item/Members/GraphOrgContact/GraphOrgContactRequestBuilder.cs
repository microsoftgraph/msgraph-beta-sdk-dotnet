using Microsoft.Graph.Beta.Groups.Item.Members.GraphOrgContact.Count;
...
namespace Microsoft.Graph.Beta.Groups.Item.Members.GraphOrgContact {
    /// <summary>
    ...
    public class GraphOrgContactRequestBuilder {
        ...
        public GraphOrgContactRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/members/graph.orgContact{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
