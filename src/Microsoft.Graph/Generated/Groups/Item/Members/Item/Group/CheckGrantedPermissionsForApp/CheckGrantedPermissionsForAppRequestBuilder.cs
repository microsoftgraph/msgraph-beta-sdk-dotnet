...
namespace Microsoft.Graph.Beta.Groups.Item.Members.Item.Group.CheckGrantedPermissionsForApp {
    ...
    public class CheckGrantedPermissionsForAppRequestBuilder {
        ...
        public CheckGrantedPermissionsForAppRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/members/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.checkGrantedPermissionsForApp";
