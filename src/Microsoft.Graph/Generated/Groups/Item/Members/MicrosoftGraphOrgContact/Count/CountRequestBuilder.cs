...
namespace Microsoft.Graph.Beta.Groups.Item.Members.MicrosoftGraphOrgContact.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/members/microsoft.graph.orgContact/$count{?%24search,%24filter}";
