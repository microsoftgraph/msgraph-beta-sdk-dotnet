...
using MicrosoftGraph.Groups.Item.AppRoleAssignments.Item;
...
namespace MicrosoftGraph.Groups.Item.AppRoleAssignments {
    ...
    public class AppRoleAssignmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.appRoleAssignments.item collection</summary>
