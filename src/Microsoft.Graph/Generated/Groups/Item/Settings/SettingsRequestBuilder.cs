...
#nullable enable
        public async Task<DirectorySettingCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SettingsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectorySettingCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DirectorySetting?> PostAsync(DirectorySetting body, CancellationToken cancellationToken = default, Action<SettingsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectorySetting> PostAsync(DirectorySetting body, CancellationToken cancellationToken = default, Action<SettingsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
