...
using MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Extensions.Item;
...
namespace MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.conversations.item.threads.item.posts.item.extensions.item collection</summary>
