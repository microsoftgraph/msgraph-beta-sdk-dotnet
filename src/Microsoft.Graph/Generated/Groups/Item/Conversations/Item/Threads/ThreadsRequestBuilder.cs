...
using MicrosoftGraphSdk.Groups.Item.Conversations.Item.Threads.Count;
...
namespace MicrosoftGraphSdk.Groups.Item.Conversations.Item.Threads {
    ...
    public class ThreadsRequestBuilder {
        ...
        /// </summary>
        public async Task<ConversationThreadCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
