...
using MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.SingleValueExtendedProperties.Item;
...
namespace MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.conversations.item.threads.item.posts.item.singleValueExtendedProperties.item collection</summary>
