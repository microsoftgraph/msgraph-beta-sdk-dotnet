...
using MicrosoftGraphSdk.Groups.Item.TransitiveMemberOf.Ref;
using System;
...
namespace MicrosoftGraphSdk.Groups.Item.TransitiveMemberOf {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\transitiveMemberOf</summary>
