...
namespace Microsoft.Graph.Beta.Groups.Item.TransitiveMemberOf.Group.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMemberOf/microsoft.graph.group/$count";
