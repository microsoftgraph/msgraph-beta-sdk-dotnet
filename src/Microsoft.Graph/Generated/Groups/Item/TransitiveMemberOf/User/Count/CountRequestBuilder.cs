...
namespace Microsoft.Graph.Beta.Groups.Item.TransitiveMemberOf.User.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMemberOf/microsoft.graph.user/$count";
