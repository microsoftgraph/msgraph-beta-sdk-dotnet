...
namespace Microsoft.Graph.Beta.Groups.Item.Owners.MicrosoftGraphGroup.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/owners/microsoft.graph.group/$count{?%24search,%24filter}";
