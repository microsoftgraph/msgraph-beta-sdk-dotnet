...
namespace Microsoft.Graph.Beta.Groups.Item.Owners.MicrosoftGraphUser.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/owners/microsoft.graph.user/$count{?%24search,%24filter}";
