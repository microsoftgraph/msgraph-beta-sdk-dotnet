...
namespace MicrosoftGraph.Groups.Item.Owners.Ref {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\owners\$ref</summary>
    public class RefRequestBuilder {
        ...
        public RefRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/owners/$ref{?top,skip,search,filter,count,orderby}";
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftGraph.Groups.Item.Owners.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftGraph.Groups.Item.Owners.Ref.Ref> PostAsync(MicrosoftGraph.Groups.Item.Owners.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<MicrosoftGraph.Groups.Item.Owners.Ref.Ref>(requestInfo, responseHandler, default, cancellationToken);
        }
