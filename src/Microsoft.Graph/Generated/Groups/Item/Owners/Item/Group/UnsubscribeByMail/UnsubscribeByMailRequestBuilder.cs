...
namespace Microsoft.Graph.Beta.Groups.Item.Owners.Item.Group.UnsubscribeByMail {
    ...
    public class UnsubscribeByMailRequestBuilder {
        ...
        public UnsubscribeByMailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/owners/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.unsubscribeByMail";
