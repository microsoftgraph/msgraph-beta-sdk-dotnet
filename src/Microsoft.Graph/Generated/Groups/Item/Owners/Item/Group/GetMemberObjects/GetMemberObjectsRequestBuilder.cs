...
namespace Microsoft.Graph.Beta.Groups.Item.Owners.Item.Group.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder {
        ...
        public GetMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/owners/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.getMemberObjects";
