...
using MicrosoftGraphSdk.Groups.Item.Owners.Count;
using MicrosoftGraphSdk.Groups.Item.Owners.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Owners {
    ...
    public class OwnersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.owners.item collection</summary>
