...
namespace Microsoft.Graph.Beta.Groups.Item.CreatedOnBehalfOf
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Groups.Item.CreatedOnBehalfOf.CreatedOnBehalfOfRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Groups.Item.CreatedOnBehalfOf.CreatedOnBehalfOfRequestBuilder.CreatedOnBehalfOfRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Groups.Item.CreatedOnBehalfOf.CreatedOnBehalfOfRequestBuilder.CreatedOnBehalfOfRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Groups.Item.CreatedOnBehalfOf.CreatedOnBehalfOfRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Groups.Item.CreatedOnBehalfOf.CreatedOnBehalfOfRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Groups.Item.CreatedOnBehalfOf.CreatedOnBehalfOfRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// The user (or application) that created the group. Note: This isn&apos;t set if the user is an administrator. Read-only.
        /// </summary>
...
#nullable restore
        ...
        public class CreatedOnBehalfOfRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.Groups.Item.CreatedOnBehalfOf.CreatedOnBehalfOfRequestBuilder.CreatedOnBehalfOfRequestBuilderGetQueryParameters>
        {
        }
    }
}
