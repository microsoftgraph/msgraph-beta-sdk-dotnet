...
namespace Microsoft.Graph.Beta.Groups.Item.CreatedOnBehalfOf {
    ...
    public class CreatedOnBehalfOfRequestBuilder {
        ...
        public CreatedOnBehalfOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/createdOnBehalfOf{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<DirectoryObject> GetAsync(CancellationToken cancellationToken = default, Action<CreatedOnBehalfOfRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
