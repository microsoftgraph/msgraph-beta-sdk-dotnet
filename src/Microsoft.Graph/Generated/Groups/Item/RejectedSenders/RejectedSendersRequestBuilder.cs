...
namespace MicrosoftGraphSdk.Groups.Item.RejectedSenders {
    ...
    public class RejectedSendersRequestBuilder {
        ...
        public RejectedSendersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/rejectedSenders{?top,skip,filter,count,orderby,select}";
        ...
        public async Task<RejectedSendersResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<RejectedSendersResponse>(requestInfo, RejectedSendersResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
