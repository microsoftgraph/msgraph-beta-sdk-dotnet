...
using MicrosoftGraph.Groups.Item.Planner.Plans.Item.Buckets;
using MicrosoftGraph.Groups.Item.Planner.Plans.Item.Details;
using MicrosoftGraph.Groups.Item.Planner.Plans.Item.Tasks;
...
namespace MicrosoftGraph.Groups.Item.Planner.Plans.Item {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\planner\plans\{plannerPlan-id}</summary>
    public class PlannerPlanRequestBuilder {
        ...
        /// </summary>
        public PlannerPlanRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public PlannerPlanRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
