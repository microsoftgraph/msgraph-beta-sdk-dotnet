...
using MicrosoftGraph.Groups.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item;
...
namespace MicrosoftGraph.Groups.Item.Planner.Plans.Item.Buckets.Item.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.planner.plans.item.buckets.item.tasks.item collection</summary>
