...
namespace MicrosoftGraph.Groups.Item.Planner.Plans.Item.Buckets {
    ...
    public class BucketsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.planner.plans.item.buckets.item collection</summary>
