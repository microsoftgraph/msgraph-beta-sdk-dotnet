...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Items.Item.Subscriptions.Item.Reauthorize {
    ...
    public class ReauthorizeRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<ReauthorizeRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
