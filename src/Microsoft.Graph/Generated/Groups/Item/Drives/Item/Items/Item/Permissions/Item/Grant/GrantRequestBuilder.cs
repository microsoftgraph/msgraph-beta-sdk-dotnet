...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Items.Item.Permissions.Item.Grant {
    ...
    public class GrantRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GrantRequestBody body, Action<GrantRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<GrantResponse> PostAsync(GrantRequestBody body, Action<GrantRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
