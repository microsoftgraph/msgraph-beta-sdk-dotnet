...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Items.Item.Permissions.Item.Grant {
    ...
    public class GrantRequestBuilder {
        ...
        /// </summary>
        public async Task<GrantResponse> PostAsync(GrantPostRequestBody body, CancellationToken cancellationToken = default, Action<GrantRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
