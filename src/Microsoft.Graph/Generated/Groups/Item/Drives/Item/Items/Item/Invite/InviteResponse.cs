...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Items.Item.Invite {
    ...
    public class InviteResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Microsoft.Graph.Beta.Models.Permission> Value {
            get { return BackingStore?.Get<List<Microsoft.Graph.Beta.Models.Permission>>(nameof(Value)); }
