using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Items.Item.ListItem.DocumentSetVersions.Count;
using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Items.Item.ListItem.DocumentSetVersions.Item;
...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Items.Item.ListItem.DocumentSetVersions {
    ...
    public class DocumentSetVersionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.groups.item.drives.item.items.item.listItem.documentSetVersions.item collection</summary>
        ...
        public DocumentSetVersionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
