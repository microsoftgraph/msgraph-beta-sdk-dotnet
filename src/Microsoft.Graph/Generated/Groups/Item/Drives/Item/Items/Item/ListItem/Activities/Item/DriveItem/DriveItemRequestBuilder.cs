using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Items.Item.ListItem.Activities.Item.DriveItem.Content;
...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Items.Item.ListItem.Activities.Item.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}";
