...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Items.Item.ListItem.Activities {
    ...
    public class ActivitiesRequestBuilder {
        ...
        /// </summary>
        public async Task<ItemActivityOLDCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ActivitiesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ItemActivityOLD> PostAsync(ItemActivityOLD body, CancellationToken cancellationToken = default, Action<ActivitiesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
