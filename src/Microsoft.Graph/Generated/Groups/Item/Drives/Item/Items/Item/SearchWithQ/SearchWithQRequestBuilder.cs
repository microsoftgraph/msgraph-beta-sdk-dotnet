...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Items.Item.SearchWithQ {
    ...
    public class SearchWithQRequestBuilder {
        ...
        public SearchWithQRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string q = default) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.search(q='{q}')";
        ...
        /// </summary>
        public async Task<SearchWithQResponse> GetAsync(CancellationToken cancellationToken = default, Action<SearchWithQRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
