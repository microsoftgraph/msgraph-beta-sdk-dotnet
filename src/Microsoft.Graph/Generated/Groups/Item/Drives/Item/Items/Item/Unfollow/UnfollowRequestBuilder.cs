...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Items.Item.Unfollow {
    /// <summary>
    ...
    public class UnfollowRequestBuilder {
        ...
        public UnfollowRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.unfollow";
