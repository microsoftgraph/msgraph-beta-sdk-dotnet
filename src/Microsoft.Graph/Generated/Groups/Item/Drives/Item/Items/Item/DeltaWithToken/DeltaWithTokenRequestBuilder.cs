...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Items.Item.DeltaWithToken {
    ...
    public class DeltaWithTokenRequestBuilder {
        ...
        public DeltaWithTokenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string token = default) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.delta(token='{token}')";
        ...
        /// </summary>
        public async Task<DeltaWithTokenResponse> GetAsync(CancellationToken cancellationToken = default, Action<DeltaWithTokenRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
