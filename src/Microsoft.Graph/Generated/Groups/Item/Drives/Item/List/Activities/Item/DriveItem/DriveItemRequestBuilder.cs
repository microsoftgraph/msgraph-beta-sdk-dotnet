...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.List.Activities.Item.DriveItem.Content;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.List.Activities.Item.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/list/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
