using Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Items.Item.DocumentSetVersions.Item.Restore;
...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Items.Item.DocumentSetVersions.Item {
    ...
    public class DocumentSetVersionItemRequestBuilder {
        ...
        public DocumentSetVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}";
