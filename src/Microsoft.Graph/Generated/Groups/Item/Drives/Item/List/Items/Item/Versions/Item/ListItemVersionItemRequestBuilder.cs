...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Items.Item.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ListItemVersion> PatchAsync(ListItemVersion body, Action<ListItemVersionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
