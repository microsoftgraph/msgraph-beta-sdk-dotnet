...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.ContentTypes.Item.Columns.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columns/$count{?%24search,%24filter}";
