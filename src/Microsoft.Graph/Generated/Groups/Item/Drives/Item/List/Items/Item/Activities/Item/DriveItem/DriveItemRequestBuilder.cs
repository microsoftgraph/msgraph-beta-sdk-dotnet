using Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Items.Item.Activities.Item.DriveItem.Content;
...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Items.Item.Activities.Item.DriveItem {
    /// <summary>
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}";
