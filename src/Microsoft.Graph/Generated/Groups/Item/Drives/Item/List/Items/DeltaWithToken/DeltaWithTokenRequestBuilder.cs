...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Items.DeltaWithToken {
    ...
    public class DeltaWithTokenRequestBuilder {
        ...
        public DeltaWithTokenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string token = default) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/items/microsoft.graph.delta(token='{token}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
