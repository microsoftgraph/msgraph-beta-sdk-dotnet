...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.List.Subscriptions.Count;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.List.Subscriptions.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.List.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.drives.item.list.subscriptions.item collection</summary>
