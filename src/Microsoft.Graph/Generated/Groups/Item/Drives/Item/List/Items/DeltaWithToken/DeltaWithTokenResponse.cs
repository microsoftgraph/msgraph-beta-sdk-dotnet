...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Items.DeltaWithToken {
    ...
    public class DeltaWithTokenResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Microsoft.Graph.Beta.Models.ListItem> Value {
            get { return BackingStore?.Get<List<Microsoft.Graph.Beta.Models.ListItem>>(nameof(Value)); }
