...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.List.Activities.Item.DriveItem;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.List.Activities.Item.ListItem;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.List.Activities.Item {
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/list/activities/{itemActivityOLD_id}{?select,expand}";
