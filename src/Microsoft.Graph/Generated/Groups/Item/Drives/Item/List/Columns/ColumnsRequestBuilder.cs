using Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Columns.Count;
using Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Columns.Item;
...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.groups.item.drives.item.list.columns.item collection</summary>
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/columns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>Get columns from groups</summary>
