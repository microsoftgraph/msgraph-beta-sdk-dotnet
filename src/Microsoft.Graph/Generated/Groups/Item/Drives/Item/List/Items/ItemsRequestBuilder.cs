using Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Items.Count;
using Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Items.Delta;
using Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Items.DeltaWithToken;
using Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Items.Item;
...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.groups.item.drives.item.list.items.item collection</summary>
