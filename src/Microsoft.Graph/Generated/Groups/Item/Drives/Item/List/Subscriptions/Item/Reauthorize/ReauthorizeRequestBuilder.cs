...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Subscriptions.Item.Reauthorize {
    ...
    public class ReauthorizeRequestBuilder {
        ...
        public ReauthorizeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize";
