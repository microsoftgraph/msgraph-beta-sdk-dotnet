...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.List.Items.Item.Analytics {
    ...
    public class AnalyticsRequestBuilder {
        ...
        /// </summary>
        public async Task<ItemAnalytics> GetAsync(CancellationToken cancellationToken = default, Action<AnalyticsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
