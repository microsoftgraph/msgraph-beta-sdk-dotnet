...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Activities.Item.DriveItem;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Activities.Item.ListItem;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Activities.Item {
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public MicrosoftGraphSdk.Groups.Item.Drives.Item.Activities.Item.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new MicrosoftGraphSdk.Groups.Item.Drives.Item.Activities.Item.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/activities/{itemActivityOLD_id}{?select,expand}";
