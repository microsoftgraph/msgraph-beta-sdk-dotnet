using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Activities.Item.DriveItem;
using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Activities.Item.ListItem;
...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Activities.Item {
    /// <summary>
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}";
