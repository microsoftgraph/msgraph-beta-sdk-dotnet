...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.ListItem.Activities;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.ListItem.Analytics;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.ListItem.CreateLink;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.ListItem.DriveItem;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.ListItem.Fields;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/special/{driveItem_id}/listItem{?select,expand}";
