...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.ListItem.DriveItem.Content;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/special/{driveItem_id}/listItem/driveItem{?select,expand}";
