...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.Children.Item.Content;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.Children.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/special/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
