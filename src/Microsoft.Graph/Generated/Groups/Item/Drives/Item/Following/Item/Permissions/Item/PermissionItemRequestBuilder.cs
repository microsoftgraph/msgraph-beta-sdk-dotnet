...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Following.Item.Permissions.Item.Grant;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Following.Item.Permissions.Item.RevokeGrants;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Following.Item.Permissions.Item {
    ...
    public class PermissionItemRequestBuilder {
        ...
        public PermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/following/{driveItem_id}/permissions/{permission_id}{?select,expand}";
