...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Following.Item.ListItem.Fields {
    ...
    public class FieldsRequestBuilder {
        ...
        public FieldsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/following/{driveItem_id}/listItem/fields{?select,expand}";
