...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Following.Item.ListItem.Activities.Item.DriveItem.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/following/{driveItem_id}/listItem/activities/{itemActivityOLD_id}/driveItem/content";
