...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Following.Item.Subscriptions.Count;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Following.Item.Subscriptions.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Following.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.drives.item.following.item.subscriptions.item collection</summary>
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/following/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
