...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Following.Item.Versions.Item.RestoreVersion {
    ...
    public class RestoreVersionRequestBuilder {
        ...
        public RestoreVersionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/following/{driveItem_id}/versions/{driveItemVersion_id}/microsoft.graph.restoreVersion";
