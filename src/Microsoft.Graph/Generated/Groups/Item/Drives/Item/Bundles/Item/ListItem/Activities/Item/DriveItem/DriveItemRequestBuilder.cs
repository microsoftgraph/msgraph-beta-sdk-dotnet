...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.ListItem.Activities.Item.DriveItem.Content;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.ListItem.Activities.Item.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/bundles/{driveItem_id}/listItem/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
