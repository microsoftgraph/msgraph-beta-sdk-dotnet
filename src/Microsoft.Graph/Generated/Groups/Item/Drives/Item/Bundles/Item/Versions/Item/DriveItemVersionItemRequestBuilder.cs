...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.Versions.Item.Content;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.Versions.Item {
    ...
    public class DriveItemVersionItemRequestBuilder {
        ...
        public DriveItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/bundles/{driveItem_id}/versions/{driveItemVersion_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DriveItemVersion body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
