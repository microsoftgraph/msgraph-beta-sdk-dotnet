...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.ListItem.Versions.Item.Fields;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.ListItem.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.ListItem.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/bundles/{driveItem_id}/listItem/versions/{listItemVersion_id}{?select,expand}";
