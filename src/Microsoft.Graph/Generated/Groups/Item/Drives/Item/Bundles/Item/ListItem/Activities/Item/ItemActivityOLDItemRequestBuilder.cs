...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.ListItem.Activities.Item.DriveItem;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.ListItem.Activities.Item.ListItem;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.ListItem.Activities.Item {
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/bundles/{driveItem_id}/listItem/activities/{itemActivityOLD_id}{?select,expand}";
