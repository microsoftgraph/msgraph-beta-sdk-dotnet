...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem.Activities.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root/listItem/activities/$count{?%24search,%24filter}";
