using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem.Activities;
using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem.Analytics;
using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem.CreateLink;
using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem.DocumentSetVersions;
using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem.DriveItem;
using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem.Fields;
using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem.Versions;
...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
