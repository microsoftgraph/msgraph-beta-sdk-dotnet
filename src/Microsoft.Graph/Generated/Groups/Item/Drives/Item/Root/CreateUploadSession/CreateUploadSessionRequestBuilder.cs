...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.CreateUploadSession {
    ...
    public class CreateUploadSessionRequestBuilder {
        ...
        public CreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root/microsoft.graph.createUploadSession";
