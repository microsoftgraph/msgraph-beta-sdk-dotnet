...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Root.Subscriptions.Count;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Root.Subscriptions.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Root.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.drives.item.root.subscriptions.item collection</summary>
