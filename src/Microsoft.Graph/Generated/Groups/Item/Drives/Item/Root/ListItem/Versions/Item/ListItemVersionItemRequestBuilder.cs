using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem.Versions.Item.Fields;
using Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem.Versions.Item.RestoreVersion;
...
namespace Microsoft.Graph.Beta.Groups.Item.Drives.Item.Root.ListItem.Versions.Item {
    /// <summary>
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root/listItem/versions/{listItemVersion%2Did}{?%24select,%24expand}";
