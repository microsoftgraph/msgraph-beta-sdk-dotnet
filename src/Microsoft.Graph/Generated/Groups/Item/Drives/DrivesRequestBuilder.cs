...
namespace Microsoft.Graph.Beta.Groups.Item.Drives {
    ...
    public class DrivesRequestBuilder : BaseRequestBuilder {
        ...
        public DrivesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/drives{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DrivesRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<DriveCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DrivesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DriveCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DrivesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
