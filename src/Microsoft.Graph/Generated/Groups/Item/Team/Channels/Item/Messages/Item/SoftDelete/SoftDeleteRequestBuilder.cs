...
namespace Microsoft.Graph.Beta.Groups.Item.Team.Channels.Item.Messages.Item.SoftDelete {
    ...
    public class SoftDeleteRequestBuilder {
        ...
        public SoftDeleteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/team/channels/{channel_id}/messages/{chatMessage_id}/microsoft.graph.softDelete";
