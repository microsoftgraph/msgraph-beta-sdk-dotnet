...
namespace Microsoft.Graph.Beta.Groups.Item.Team.Channels.Item.Messages.Item.UndoSoftDelete {
    ...
    public class UndoSoftDeleteRequestBuilder {
        ...
        public UndoSoftDeleteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/team/channels/{channel_id}/messages/{chatMessage_id}/microsoft.graph.undoSoftDelete";
