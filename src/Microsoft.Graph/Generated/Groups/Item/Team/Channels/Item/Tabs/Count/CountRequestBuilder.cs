...
namespace Microsoft.Graph.Beta.Groups.Item.Team.Channels.Item.Tabs.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/tabs/$count{?%24search,%24filter}";
