using Microsoft.Graph.Beta.Groups.Item.Team.Channels.Item.SharedWithTeams.Item.AllowedMembers.Count;
using Microsoft.Graph.Beta.Groups.Item.Team.Channels.Item.SharedWithTeams.Item.AllowedMembers.Item;
...
namespace Microsoft.Graph.Beta.Groups.Item.Team.Channels.Item.SharedWithTeams.Item.AllowedMembers {
    ...
    public class AllowedMembersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.groups.item.team.channels.item.sharedWithTeams.item.allowedMembers.item collection</summary>
        ...
        public AllowedMembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/allowedMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
