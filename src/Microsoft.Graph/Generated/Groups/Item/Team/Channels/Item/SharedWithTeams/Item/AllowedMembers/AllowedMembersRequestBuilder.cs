...
using MicrosoftGraphSdk.Groups.Item.Team.Channels.Item.SharedWithTeams.Item.AllowedMembers.Count;
using MicrosoftGraphSdk.Groups.Item.Team.Channels.Item.SharedWithTeams.Item.AllowedMembers.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Team.Channels.Item.SharedWithTeams.Item.AllowedMembers {
    ...
    public class AllowedMembersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.team.channels.item.sharedWithTeams.item.allowedMembers.item collection</summary>
