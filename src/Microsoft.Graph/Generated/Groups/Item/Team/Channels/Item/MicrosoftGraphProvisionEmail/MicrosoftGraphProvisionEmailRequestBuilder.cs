...
namespace Microsoft.Graph.Beta.Groups.Item.Team.Channels.Item.MicrosoftGraphProvisionEmail {
    /// <summary>
    ...
    public class MicrosoftGraphProvisionEmailRequestBuilder {
        ...
        public MicrosoftGraphProvisionEmailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/microsoft.graph.provisionEmail";
