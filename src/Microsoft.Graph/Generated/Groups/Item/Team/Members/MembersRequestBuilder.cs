...
using MicrosoftGraphSdk.Groups.Item.Team.Members.Add;
using MicrosoftGraphSdk.Groups.Item.Team.Members.Count;
using MicrosoftGraphSdk.Groups.Item.Team.Members.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Team.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.team.members.item collection</summary>
