...
using MicrosoftGraphSdk.Groups.Item.Team.Owners.Count;
using MicrosoftGraphSdk.Groups.Item.Team.Owners.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Team.Owners {
    ...
    public class OwnersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.team.owners.item collection</summary>
