...
using MicrosoftGraphSdk.Groups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item.HostedContents;
using MicrosoftGraphSdk.Groups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item.SoftDelete;
using MicrosoftGraphSdk.Groups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item.UndoSoftDelete;
...
namespace MicrosoftGraphSdk.Groups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item {
    ...
    public class ChatMessageItemRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/team/primaryChannel/messages/{chatMessage_id}/replies/{chatMessage_id1}{?select,expand}";
