using Microsoft.Graph.Beta.Groups.Item.Team.PrimaryChannel.Tabs.Item.TeamsApp;
...
namespace Microsoft.Graph.Beta.Groups.Item.Team.PrimaryChannel.Tabs.Item {
    /// <summary>
    ...
    public class TeamsTabItemRequestBuilder {
        ...
        public TeamsTabItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/primaryChannel/tabs/{teamsTab%2Did}{?%24select,%24expand}";
