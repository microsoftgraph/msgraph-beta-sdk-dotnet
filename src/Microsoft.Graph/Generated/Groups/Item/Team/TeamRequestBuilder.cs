...
using Microsoft.Graph.Beta.Groups.Item.Team.MicrosoftGraphArchive;
using Microsoft.Graph.Beta.Groups.Item.Team.MicrosoftGraphClone;
using Microsoft.Graph.Beta.Groups.Item.Team.MicrosoftGraphCompleteMigration;
using Microsoft.Graph.Beta.Groups.Item.Team.MicrosoftGraphSendActivityNotification;
using Microsoft.Graph.Beta.Groups.Item.Team.MicrosoftGraphUnarchive;
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Team?> PatchAsync(Microsoft.Graph.Beta.Models.Team body, Action<TeamRequestBuilderPatchRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Team> PatchAsync(Microsoft.Graph.Beta.Models.Team body, Action<TeamRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Beta.Models.Team body, Action<TeamRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Beta.Models.Team body, Action<TeamRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
