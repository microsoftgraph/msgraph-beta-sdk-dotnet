...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Team?> PutAsync(Microsoft.Graph.Beta.Models.Team body, CancellationToken cancellationToken = default, Action<TeamRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Team> PutAsync(Microsoft.Graph.Beta.Models.Team body, CancellationToken cancellationToken = default, Action<TeamRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
