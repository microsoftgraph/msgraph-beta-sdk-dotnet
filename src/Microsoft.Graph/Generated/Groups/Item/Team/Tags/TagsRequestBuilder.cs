...
using MicrosoftGraphSdk.Groups.Item.Team.Tags.Count;
using MicrosoftGraphSdk.Groups.Item.Team.Tags.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Team.Tags {
    ...
    public class TagsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.team.tags.item collection</summary>
