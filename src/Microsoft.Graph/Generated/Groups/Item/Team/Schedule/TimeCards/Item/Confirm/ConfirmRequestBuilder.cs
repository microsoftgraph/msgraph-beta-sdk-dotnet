...
namespace Microsoft.Graph.Beta.Groups.Item.Team.Schedule.TimeCards.Item.Confirm {
    ...
    public class ConfirmRequestBuilder {
        ...
        public ConfirmRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/schedule/timeCards/{timeCard%2Did}/microsoft.graph.confirm";
        ...
        /// </summary>
        public async Task<TimeCard> PostAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
