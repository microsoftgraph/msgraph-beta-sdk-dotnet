...
namespace Microsoft.Graph.Beta.Groups.Item.Team.Schedule.TimeCards {
    ...
    public class TimeCardsRequestBuilder : BaseRequestBuilder {
        ...
        public TimeCardsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/schedule/timeCards{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TimeCardsRequestBuilder and sets the default values.
        /// </summary>
