...
namespace Microsoft.Graph.Beta.Groups.Item.Team.Schedule.TimeCards.Item.EndBreak
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Groups.Item.Team.Schedule.TimeCards.Item.EndBreak.EndBreakRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Microsoft.Graph.Beta.Groups.Item.Team.Schedule.TimeCards.Item.EndBreak.EndBreakPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Microsoft.Graph.Beta.Groups.Item.Team.Schedule.TimeCards.Item.EndBreak.EndBreakPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Groups.Item.Team.Schedule.TimeCards.Item.EndBreak.EndBreakRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Beta.Groups.Item.Team.Schedule.TimeCards.Item.EndBreak.EndBreakRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Beta.Groups.Item.Team.Schedule.TimeCards.Item.EndBreak.EndBreakRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
