...
namespace Microsoft.Graph.Beta.Groups.Item.Team.Schedule.TimeCards.Item.EndBreak {
    ...
    public class EndBreakRequestBuilder {
        ...
        /// </summary>
        public async Task<TimeCard> PostAsync(EndBreakPostRequestBody body, Action<EndBreakRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
