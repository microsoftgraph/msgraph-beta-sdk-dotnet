...
#nullable enable
        public async Task<TimeCard?> PostAsync(EndBreakPostRequestBody body, CancellationToken cancellationToken = default, Action<EndBreakRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TimeCard> PostAsync(EndBreakPostRequestBody body, CancellationToken cancellationToken = default, Action<EndBreakRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
