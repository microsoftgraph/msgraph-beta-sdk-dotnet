...
namespace Microsoft.Graph.Beta.Groups.Item.Team.Schedule.TimeCards.Item.EndBreak {
    ...
    public class EndBreakRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(EndBreakRequestBody body, Action<EndBreakRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<TimeCard> PostAsync(EndBreakRequestBody body, Action<EndBreakRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
