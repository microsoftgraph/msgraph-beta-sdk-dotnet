...
namespace Microsoft.Graph.Beta.Groups.Item.Team.Schedule.SwapShiftsChangeRequests.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/schedule/swapShiftsChangeRequests/$count{?%24search,%24filter}";
