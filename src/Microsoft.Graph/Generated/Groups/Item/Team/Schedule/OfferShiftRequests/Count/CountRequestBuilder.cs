...
namespace Microsoft.Graph.Beta.Groups.Item.Team.Schedule.OfferShiftRequests.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/schedule/offerShiftRequests/$count{?%24search,%24filter}";
