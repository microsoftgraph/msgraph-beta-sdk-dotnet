...
namespace Microsoft.Graph.Beta.Groups.Item.Team.PermissionGrants.ValidateProperties {
    /// <summary>
    ...
    public class ValidatePropertiesRequestBuilder {
        ...
        public ValidatePropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/permissionGrants/validateProperties";
