using Microsoft.Graph.Beta.Groups.Item.Team.PermissionGrants.Count;
using Microsoft.Graph.Beta.Groups.Item.Team.PermissionGrants.GetByIds;
using Microsoft.Graph.Beta.Groups.Item.Team.PermissionGrants.GetUserOwnedObjects;
using Microsoft.Graph.Beta.Groups.Item.Team.PermissionGrants.Item;
using Microsoft.Graph.Beta.Groups.Item.Team.PermissionGrants.ValidateProperties;
...
namespace Microsoft.Graph.Beta.Groups.Item.Team.PermissionGrants {
    ...
    public class PermissionGrantsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.groups.item.team.permissionGrants.item collection</summary>
        ...
        public PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/permissionGrants{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
