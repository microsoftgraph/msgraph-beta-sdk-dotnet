...
using MicrosoftGraphSdk.Groups.Item.Team.PermissionGrants.Count;
using MicrosoftGraphSdk.Groups.Item.Team.PermissionGrants.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Team.PermissionGrants {
    ...
    public class PermissionGrantsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.team.permissionGrants.item collection</summary>
