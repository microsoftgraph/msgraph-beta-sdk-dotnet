...
namespace Microsoft.Graph.Beta.Groups.Item.Team.PermissionGrants.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/permissionGrants/$count{?%24search,%24filter}";
