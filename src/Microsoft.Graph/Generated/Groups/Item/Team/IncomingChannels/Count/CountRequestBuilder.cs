...
namespace Microsoft.Graph.Beta.Groups.Item.Team.IncomingChannels.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/incomingChannels/$count{?%24search,%24filter}";
