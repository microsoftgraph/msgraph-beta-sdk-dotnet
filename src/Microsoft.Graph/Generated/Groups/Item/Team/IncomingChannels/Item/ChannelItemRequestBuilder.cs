...
namespace Microsoft.Graph.Beta.Groups.Item.Team.IncomingChannels.Item {
    ...
    public class ChannelItemRequestBuilder {
        ...
        public ChannelItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/team/incomingChannels/{channel_id}{?select,expand}";
