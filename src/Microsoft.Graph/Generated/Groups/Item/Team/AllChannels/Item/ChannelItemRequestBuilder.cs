...
namespace Microsoft.Graph.Beta.Groups.Item.Team.AllChannels.Item {
    ...
    public class ChannelItemRequestBuilder {
        ...
        public ChannelItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/team/allChannels/{channel_id}{?select,expand}";
        ...
        /// <summary>Get allChannels from groups</summary>
