...
namespace Microsoft.Graph.Beta.Groups.Item.SubscribeByMail {
    ...
    public class SubscribeByMailRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<SubscribeByMailRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
