...
namespace Microsoft.Graph.Beta.Groups.Item.ResetUnseenCount {
    ...
    public class ResetUnseenCountRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<ResetUnseenCountRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
