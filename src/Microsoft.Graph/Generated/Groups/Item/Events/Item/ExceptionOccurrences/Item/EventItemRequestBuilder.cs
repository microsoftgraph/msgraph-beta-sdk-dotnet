...
using MicrosoftGraphSdk.Groups.Item.Events.Item.ExceptionOccurrences.Item.Accept;
using MicrosoftGraphSdk.Groups.Item.Events.Item.ExceptionOccurrences.Item.Attachments;
using MicrosoftGraphSdk.Groups.Item.Events.Item.ExceptionOccurrences.Item.Calendar;
using MicrosoftGraphSdk.Groups.Item.Events.Item.ExceptionOccurrences.Item.Cancel;
using MicrosoftGraphSdk.Groups.Item.Events.Item.ExceptionOccurrences.Item.Decline;
using MicrosoftGraphSdk.Groups.Item.Events.Item.ExceptionOccurrences.Item.DismissReminder;
using MicrosoftGraphSdk.Groups.Item.Events.Item.ExceptionOccurrences.Item.Extensions;
using MicrosoftGraphSdk.Groups.Item.Events.Item.ExceptionOccurrences.Item.Forward;
using MicrosoftGraphSdk.Groups.Item.Events.Item.ExceptionOccurrences.Item.Instances;
using MicrosoftGraphSdk.Groups.Item.Events.Item.ExceptionOccurrences.Item.MultiValueExtendedProperties;
using MicrosoftGraphSdk.Groups.Item.Events.Item.ExceptionOccurrences.Item.SingleValueExtendedProperties;
using MicrosoftGraphSdk.Groups.Item.Events.Item.ExceptionOccurrences.Item.SnoozeReminder;
using MicrosoftGraphSdk.Groups.Item.Events.Item.ExceptionOccurrences.Item.TentativelyAccept;
...
namespace MicrosoftGraphSdk.Groups.Item.Events.Item.ExceptionOccurrences.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/events/{event_id}/exceptionOccurrences/{event_id1}{?select,expand}";
