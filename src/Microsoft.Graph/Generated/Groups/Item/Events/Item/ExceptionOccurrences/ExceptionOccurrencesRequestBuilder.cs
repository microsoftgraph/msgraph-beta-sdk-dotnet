using Microsoft.Graph.Beta.Groups.Item.Events.Item.ExceptionOccurrences.Count;
using Microsoft.Graph.Beta.Groups.Item.Events.Item.ExceptionOccurrences.Delta;
using Microsoft.Graph.Beta.Groups.Item.Events.Item.ExceptionOccurrences.Item;
...
namespace Microsoft.Graph.Beta.Groups.Item.Events.Item.ExceptionOccurrences {
    /// <summary>
    ...
    public class ExceptionOccurrencesRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Groups.Item.Events.Item.ExceptionOccurrences.Item.EventItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("event%2Did1", position);
            return new Microsoft.Graph.Beta.Groups.Item.Events.Item.ExceptionOccurrences.Item.EventItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public ExceptionOccurrencesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/exceptionOccurrences{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ExceptionOccurrencesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExceptionOccurrencesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/exceptionOccurrences{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
