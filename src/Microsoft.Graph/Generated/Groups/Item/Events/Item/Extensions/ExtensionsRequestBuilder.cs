...
using MicrosoftGraph.Groups.Item.Events.Item.Extensions.Item;
...
namespace MicrosoftGraph.Groups.Item.Events.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.events.item.extensions.item collection</summary>
