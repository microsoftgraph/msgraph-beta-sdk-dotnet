...
using MicrosoftGraphSdk.Groups.Item.Events.Item.MultiValueExtendedProperties.Count;
using MicrosoftGraphSdk.Groups.Item.Events.Item.MultiValueExtendedProperties.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Events.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.events.item.multiValueExtendedProperties.item collection</summary>
