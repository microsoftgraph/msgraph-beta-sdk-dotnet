...
using MicrosoftGraph.Groups.Item.Events.Item.MultiValueExtendedProperties.Item;
...
namespace MicrosoftGraph.Groups.Item.Events.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.events.item.multiValueExtendedProperties.item collection</summary>
