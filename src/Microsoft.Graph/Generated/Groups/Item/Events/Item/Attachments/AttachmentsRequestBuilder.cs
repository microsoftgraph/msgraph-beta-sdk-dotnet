...
using MicrosoftGraph.Groups.Item.Events.Item.Attachments.CreateUploadSession;
using MicrosoftGraph.Groups.Item.Events.Item.Attachments.Item;
...
namespace MicrosoftGraph.Groups.Item.Events.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.events.item.attachments.item collection</summary>
