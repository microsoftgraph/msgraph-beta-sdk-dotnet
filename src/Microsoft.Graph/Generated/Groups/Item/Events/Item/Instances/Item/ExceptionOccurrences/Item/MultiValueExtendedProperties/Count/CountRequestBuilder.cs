...
namespace Microsoft.Graph.Beta.Groups.Item.Events.Item.Instances.Item.ExceptionOccurrences.Item.MultiValueExtendedProperties.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/multiValueExtendedProperties/$count{?%24search,%24filter}";
