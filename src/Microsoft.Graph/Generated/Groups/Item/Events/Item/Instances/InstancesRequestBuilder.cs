...
using MicrosoftGraph.Groups.Item.Events.Item.Instances.Delta;
using MicrosoftGraph.Groups.Item.Events.Item.Instances.Item;
...
namespace MicrosoftGraph.Groups.Item.Events.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groups.item.events.item.instances.item collection</summary>
