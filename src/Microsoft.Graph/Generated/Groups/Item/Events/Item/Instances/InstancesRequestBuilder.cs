using Microsoft.Graph.Beta.Groups.Item.Events.Item.Instances.Count;
using Microsoft.Graph.Beta.Groups.Item.Events.Item.Instances.Delta;
using Microsoft.Graph.Beta.Groups.Item.Events.Item.Instances.Item;
...
namespace Microsoft.Graph.Beta.Groups.Item.Events.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.groups.item.events.item.instances.item collection</summary>
        public Microsoft.Graph.Beta.Groups.Item.Events.Item.Instances.Item.EventItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("event%2Did1", position);
            return new Microsoft.Graph.Beta.Groups.Item.Events.Item.Instances.Item.EventItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
