...
namespace MicrosoftGraph.Groups.EvaluateDynamicMembership {
    /// <summary>Builds and executes requests for operations under \groups\microsoft.graph.evaluateDynamicMembership</summary>
