...
namespace Microsoft.Graph.Beta.AppRoleAssignments.Item {
    ...
    public class AppRoleAssignmentItemRequestBuilder : BaseRequestBuilder {
        ...
        public AppRoleAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/appRoleAssignments/{appRoleAssignment%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AppRoleAssignmentItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AppRoleAssignmentItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/appRoleAssignments/{appRoleAssignment%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
