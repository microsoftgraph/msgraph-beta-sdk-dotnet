...
namespace MicrosoftGraphSdk.AppRoleAssignments.Item {
    /// <summary>Builds and executes requests for operations under \appRoleAssignments\{appRoleAssignment-id}</summary>
    public class AppRoleAssignmentItemRequestBuilder {
        ...
        public AppRoleAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/appRoleAssignments/{appRoleAssignment_id}{?select,expand}";
