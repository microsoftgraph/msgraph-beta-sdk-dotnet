...
namespace Microsoft.Graph.ExternalConnectors
{
    ...
    /// <summary>
    /// The type ConnectionQuotaReferenceRequest.
    /// </summary>
    public partial class ConnectionQuotaReferenceRequest : Microsoft.Graph.BaseRequest, IConnectionQuotaReferenceRequest
    {
        /// <summary>
        /// Constructs a new ConnectionQuotaReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ConnectionQuotaReferenceRequest(
            string requestUrl,
        ...
        public async System.Threading.Tasks.Task DeleteAsync(CancellationToken cancellationToken = default)
        {
            ...
            await this.SendAsync<ConnectionQuota>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <param name="id">The ConnectionQuota reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified ConnectionQuota reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The ConnectionQuota reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
