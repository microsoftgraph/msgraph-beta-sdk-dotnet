...
namespace Microsoft.Graph.ExternalConnectors
{
    ...
    public partial class SchemaRequest : Microsoft.Graph.BaseRequest, ISchemaRequest
    {
        ...
        public async System.Threading.Tasks.Task<Schema> UpdateAsync(Schema schemaToUpdate, CancellationToken cancellationToken)
        {
			...
			{
				if (schemaToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.ResponseHeaders) ||
					schemaToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.StatusCode))
				{
					throw new Microsoft.Graph.ClientException(
						new Microsoft.Graph.Error
						{
							Code = Microsoft.Graph.GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(Microsoft.Graph.GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, schemaToUpdate.GetType().Name)
						});
				}
			}
            if (schemaToUpdate.AdditionalData != null)
