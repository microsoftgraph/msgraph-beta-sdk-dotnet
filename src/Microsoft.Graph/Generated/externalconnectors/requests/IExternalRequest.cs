...
namespace Microsoft.Graph.ExternalConnectors
{
    ...
    public partial interface IExternalRequest : Microsoft.Graph.IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<External> CreateAsync(External externalToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<External>> CreateResponseAsync(External externalToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<External> UpdateAsync(External externalToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="Microsoft.Graph.ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{External}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<External>> UpdateResponseAsync(External externalToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<External> PutAsync(External externalToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<External>> PutResponseAsync(External externalToUpdate, CancellationToken cancellationToken = default(CancellationToken));
