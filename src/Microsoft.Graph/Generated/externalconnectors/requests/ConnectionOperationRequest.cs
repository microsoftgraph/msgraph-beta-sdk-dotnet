...
namespace Microsoft.Graph.ExternalConnectors
{
    ...
    public partial class ConnectionOperationRequest : Microsoft.Graph.BaseRequest, IConnectionOperationRequest
    {
        ...
        public async System.Threading.Tasks.Task<ConnectionOperation> UpdateAsync(ConnectionOperation connectionOperationToUpdate, CancellationToken cancellationToken)
        {
			...
			{
				if (connectionOperationToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.ResponseHeaders) ||
					connectionOperationToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.StatusCode))
				{
					throw new Microsoft.Graph.ClientException(
						new Microsoft.Graph.Error
						{
							Code = Microsoft.Graph.GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(Microsoft.Graph.GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, connectionOperationToUpdate.GetType().Name)
						});
				}
			}
            if (connectionOperationToUpdate.AdditionalData != null)
