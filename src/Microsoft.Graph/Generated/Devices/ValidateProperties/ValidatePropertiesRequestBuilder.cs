...
namespace Microsoft.Graph.Beta.Devices.ValidateProperties {
    ...
    public class ValidatePropertiesRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ValidatePropertiesRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
