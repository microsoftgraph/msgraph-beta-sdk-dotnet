...
#nullable enable
        public async Task<UserCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GraphUserRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<GraphUserRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
