...
using MicrosoftGraphSdk.Devices.Item.RegisteredUsers.Count;
using MicrosoftGraphSdk.Devices.Item.RegisteredUsers.Item;
...
namespace MicrosoftGraphSdk.Devices.Item.RegisteredUsers {
    ...
    public class RegisteredUsersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.devices.item.registeredUsers.item collection</summary>
