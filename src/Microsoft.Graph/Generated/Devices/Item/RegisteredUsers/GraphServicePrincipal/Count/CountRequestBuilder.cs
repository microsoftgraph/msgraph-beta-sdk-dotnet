...
namespace Microsoft.Graph.Beta.Devices.Item.RegisteredUsers.GraphServicePrincipal.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/registeredUsers/graph.servicePrincipal/$count{?%24search,%24filter}";
