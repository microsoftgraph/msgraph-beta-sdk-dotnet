using Microsoft.Graph.Beta.Devices.Item.RegisteredUsers.User.Count;
...
namespace Microsoft.Graph.Beta.Devices.Item.RegisteredUsers.User {
    ...
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/registeredUsers/microsoft.graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
