using Microsoft.Graph.Beta.Devices.Item.TransitiveMemberOf.Group.Count;
...
namespace Microsoft.Graph.Beta.Devices.Item.TransitiveMemberOf.Group {
    ...
    public class GroupRequestBuilder {
        ...
        public GroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/transitiveMemberOf/microsoft.graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
