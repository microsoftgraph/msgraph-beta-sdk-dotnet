...
using MicrosoftGraphSdk.Devices.Item.TransitiveMemberOf.Count;
using MicrosoftGraphSdk.Devices.Item.TransitiveMemberOf.Item;
...
namespace MicrosoftGraphSdk.Devices.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.devices.item.transitiveMemberOf.item collection</summary>
