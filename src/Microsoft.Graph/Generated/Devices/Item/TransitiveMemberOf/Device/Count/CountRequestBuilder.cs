...
namespace Microsoft.Graph.Beta.Devices.Item.TransitiveMemberOf.Device.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/transitiveMemberOf/microsoft.graph.device/$count";
