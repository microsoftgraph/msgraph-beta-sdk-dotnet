...
namespace Microsoft.Graph.Beta.Devices.Item.RegisteredOwners.MicrosoftGraphServicePrincipal.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/registeredOwners/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}";
