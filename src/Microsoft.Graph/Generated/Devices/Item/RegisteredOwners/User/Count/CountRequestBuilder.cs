...
namespace Microsoft.Graph.Beta.Devices.Item.RegisteredOwners.User.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/registeredOwners/microsoft.graph.user/$count";
