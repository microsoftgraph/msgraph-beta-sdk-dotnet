using Microsoft.Graph.Beta.Devices.Item.RegisteredOwners.GraphUser.Count;
...
namespace Microsoft.Graph.Beta.Devices.Item.RegisteredOwners.GraphUser {
    /// <summary>
    ...
    public class GraphUserRequestBuilder {
        ...
        public GraphUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/registeredOwners/graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
