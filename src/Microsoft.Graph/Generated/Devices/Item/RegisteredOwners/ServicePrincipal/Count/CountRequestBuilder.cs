...
namespace Microsoft.Graph.Beta.Devices.Item.RegisteredOwners.ServicePrincipal.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/registeredOwners/microsoft.graph.servicePrincipal/$count";
