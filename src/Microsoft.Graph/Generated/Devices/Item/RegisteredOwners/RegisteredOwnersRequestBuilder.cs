...
using Microsoft.Graph.Beta.Devices.Item.RegisteredOwners.GraphEndpoint;
using Microsoft.Graph.Beta.Devices.Item.RegisteredOwners.GraphServicePrincipal;
using Microsoft.Graph.Beta.Devices.Item.RegisteredOwners.GraphUser;
...
#nullable enable
        public async Task<DirectoryObjectCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<RegisteredOwnersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectoryObjectCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RegisteredOwnersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
