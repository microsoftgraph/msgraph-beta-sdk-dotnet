using Microsoft.Graph.Beta.Devices.Item.MemberOf.Item.Device.CheckMemberGroups;
using Microsoft.Graph.Beta.Devices.Item.MemberOf.Item.Device.CheckMemberObjects;
using Microsoft.Graph.Beta.Devices.Item.MemberOf.Item.Device.GetMemberGroups;
using Microsoft.Graph.Beta.Devices.Item.MemberOf.Item.Device.GetMemberObjects;
using Microsoft.Graph.Beta.Devices.Item.MemberOf.Item.Device.Restore;
...
namespace Microsoft.Graph.Beta.Devices.Item.MemberOf.Item.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        public DeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.device{?%24select,%24expand}";
