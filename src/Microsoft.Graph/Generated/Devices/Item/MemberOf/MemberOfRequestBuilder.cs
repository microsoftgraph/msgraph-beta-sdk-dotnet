...
using MicrosoftGraphSdk.Devices.Item.MemberOf.Count;
using MicrosoftGraphSdk.Devices.Item.MemberOf.Item;
...
namespace MicrosoftGraphSdk.Devices.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.devices.item.memberOf.item collection</summary>
