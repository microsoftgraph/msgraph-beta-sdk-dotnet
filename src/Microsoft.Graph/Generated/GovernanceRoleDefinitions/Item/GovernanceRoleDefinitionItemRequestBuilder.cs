...
namespace Microsoft.Graph.Beta.GovernanceRoleDefinitions.Item {
    ...
    public class GovernanceRoleDefinitionItemRequestBuilder {
        ...
        public GovernanceRoleDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/governanceRoleDefinitions/{governanceRoleDefinition%2Did}{?%24select,%24expand}";
        ...
        /// <summary>
        /// Delete entity from governanceRoleDefinitions by key (id)
        /// </summary>
        ...
        /// <summary>
        /// Get entity from governanceRoleDefinitions by key (id)
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
        ...
        /// <summary>
        /// Update entity in governanceRoleDefinitions by key (id)
        /// </summary>
