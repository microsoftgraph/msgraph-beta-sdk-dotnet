...
using MicrosoftGraphSdk.GovernanceRoleDefinitions.Item.Resource.Ref;
...
namespace MicrosoftGraphSdk.GovernanceRoleDefinitions.Item.Resource {
    /// <summary>Builds and executes requests for operations under \governanceRoleDefinitions\{governanceRoleDefinition-id}\resource</summary>
    public class ResourceRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/governanceRoleDefinitions/{governanceRoleDefinition_id}/resource{?select,expand}";
