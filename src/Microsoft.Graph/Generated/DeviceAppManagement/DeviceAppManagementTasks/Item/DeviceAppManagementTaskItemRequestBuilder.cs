...
namespace Microsoft.Graph.Beta.DeviceAppManagement.DeviceAppManagementTasks.Item {
    ...
    public class DeviceAppManagementTaskItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceAppManagementTaskItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceAppManagementTask> GetAsync(CancellationToken cancellationToken = default, Action<DeviceAppManagementTaskItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DeviceAppManagementTask body, CancellationToken cancellationToken = default, Action<DeviceAppManagementTaskItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
