...
namespace Microsoft.Graph.Beta.DeviceAppManagement.WindowsInformationProtectionDeviceRegistrations {
    ...
    public class WindowsInformationProtectionDeviceRegistrationsRequestBuilder : BaseRequestBuilder {
        ...
        public WindowsInformationProtectionDeviceRegistrationItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("windowsInformationProtectionDeviceRegistration%2Did", position);
        ...
        public WindowsInformationProtectionDeviceRegistrationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/windowsInformationProtectionDeviceRegistrations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WindowsInformationProtectionDeviceRegistrationsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WindowsInformationProtectionDeviceRegistrationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/windowsInformationProtectionDeviceRegistrations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<WindowsInformationProtectionDeviceRegistrationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<WindowsInformationProtectionDeviceRegistrationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WindowsInformationProtectionDeviceRegistrationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<WindowsInformationProtectionDeviceRegistrationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WindowsInformationProtectionDeviceRegistration?> PostAsync(WindowsInformationProtectionDeviceRegistration body, CancellationToken cancellationToken = default, Action<WindowsInformationProtectionDeviceRegistrationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WindowsInformationProtectionDeviceRegistration> PostAsync(WindowsInformationProtectionDeviceRegistration body, CancellationToken cancellationToken = default, Action<WindowsInformationProtectionDeviceRegistrationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(WindowsInformationProtectionDeviceRegistration body, Action<WindowsInformationProtectionDeviceRegistrationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(WindowsInformationProtectionDeviceRegistration body, Action<WindowsInformationProtectionDeviceRegistrationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
