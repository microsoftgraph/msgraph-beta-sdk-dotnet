...
namespace MicrosoftGraphSdk.DeviceAppManagement.SideLoadingKeys {
    public class SideLoadingKeysResponse : IParsable {
        ...
        /// </summary>
        public static SideLoadingKeysResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SideLoadingKeysResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as SideLoadingKeysResponse).Value = n.GetCollectionOfObjectValues<SideLoadingKey>(SideLoadingKey.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
