...
namespace Microsoft.Graph.Beta.DeviceAppManagement.ManagedAppRegistrations.GetUserIdsWithFlaggedAppRegistration {
    ...
    public class GetUserIdsWithFlaggedAppRegistrationRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetUserIdsWithFlaggedAppRegistrationGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function getUserIdsWithFlaggedAppRegistration
        /// </summary>
        /// <returns>A <cref="GetUserIdsWithFlaggedAppRegistrationResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetUserIdsWithFlaggedAppRegistrationRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
