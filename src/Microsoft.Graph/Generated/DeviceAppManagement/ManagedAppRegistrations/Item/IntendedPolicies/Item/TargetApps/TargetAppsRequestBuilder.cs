...
namespace Microsoft.Graph.Beta.DeviceAppManagement.ManagedAppRegistrations.Item.IntendedPolicies.Item.TargetApps {
    ...
    public class TargetAppsRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(TargetAppsRequestBody body, Action<TargetAppsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
