...
namespace Microsoft.Graph.Beta.DeviceAppManagement.ManagedAppRegistrations.Item.IntendedPolicies.Item.TargetApps {
    ...
    /// </summary>
    public class TargetAppsRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new TargetAppsRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TargetAppsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/managedAppRegistrations/{managedAppRegistration%2Did}/intendedPolicies/{managedAppPolicy%2Did}/targetApps", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TargetAppsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(TargetAppsPostRequestBody body, CancellationToken cancellationToken = default, Action<TargetAppsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(TargetAppsPostRequestBody body, CancellationToken cancellationToken = default, Action<TargetAppsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
