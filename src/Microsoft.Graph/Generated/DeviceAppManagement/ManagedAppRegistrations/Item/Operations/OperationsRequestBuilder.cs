...
namespace MicrosoftGraphSdk.DeviceAppManagement.ManagedAppRegistrations.Item.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        /// </summary>
        public async Task<ManagedAppOperationCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
