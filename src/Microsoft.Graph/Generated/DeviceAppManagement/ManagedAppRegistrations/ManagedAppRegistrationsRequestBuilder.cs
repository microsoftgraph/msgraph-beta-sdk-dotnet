...
namespace Microsoft.Graph.Beta.DeviceAppManagement.ManagedAppRegistrations {
    ...
    public class ManagedAppRegistrationsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ManagedAppRegistration> PostAsync(ManagedAppRegistration body, Action<ManagedAppRegistrationsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
