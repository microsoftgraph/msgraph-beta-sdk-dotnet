...
namespace Microsoft.Graph.Beta.DeviceAppManagement.IosManagedAppProtections.HasPayloadLinks {
    ...
    public class HasPayloadLinksRequestBuilder : BaseRequestBuilder {
        ...
        public HasPayloadLinksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/iosManagedAppProtections/hasPayloadLinks", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HasPayloadLinksRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HasPayloadLinksRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/iosManagedAppProtections/hasPayloadLinks", rawUrl) {
        }
        /// <summary>
