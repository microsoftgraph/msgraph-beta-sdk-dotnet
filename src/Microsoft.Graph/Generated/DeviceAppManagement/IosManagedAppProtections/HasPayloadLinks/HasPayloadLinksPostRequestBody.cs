...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.DeviceAppManagement.IosManagedAppProtections.HasPayloadLinks {
    ...
    public class HasPayloadLinksPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<string> PayloadIds {
            get { return BackingStore?.Get<List<string>>(nameof(PayloadIds)); }
            set { BackingStore?.Set(nameof(PayloadIds), value); }
        }
        /// <summary>
        ...
        /// </summary>
        public static HasPayloadLinksPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
