...
namespace Microsoft.Graph.Beta.DeviceAppManagement.IosManagedAppProtections {
    ...
    public class IosManagedAppProtectionsRequestBuilder {
        ...
        /// </summary>
        public async Task<IosManagedAppProtectionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<IosManagedAppProtectionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<IosManagedAppProtection> PostAsync(IosManagedAppProtection body, CancellationToken cancellationToken = default, Action<IosManagedAppProtectionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
