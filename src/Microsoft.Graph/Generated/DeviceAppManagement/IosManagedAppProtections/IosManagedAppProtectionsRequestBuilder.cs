...
namespace Microsoft.Graph.Beta.DeviceAppManagement.IosManagedAppProtections {
    ...
    public class IosManagedAppProtectionsRequestBuilder {
        ...
        /// </summary>
        public async Task<IosManagedAppProtectionCollectionResponse> GetAsync(Action<IosManagedAppProtectionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<IosManagedAppProtection> PostAsync(IosManagedAppProtection body, Action<IosManagedAppProtectionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
