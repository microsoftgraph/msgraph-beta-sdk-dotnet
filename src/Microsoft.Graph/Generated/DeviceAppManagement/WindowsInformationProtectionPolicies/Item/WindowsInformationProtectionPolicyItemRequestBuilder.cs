...
namespace Microsoft.Graph.Beta.DeviceAppManagement.WindowsInformationProtectionPolicies.Item {
    ...
    public class WindowsInformationProtectionPolicyItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<WindowsInformationProtectionPolicy> PatchAsync(WindowsInformationProtectionPolicy body, Action<WindowsInformationProtectionPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
