...
using MicrosoftGraph.DeviceAppManagement.AndroidManagedAppProtections.Item.Apps;
using MicrosoftGraph.DeviceAppManagement.AndroidManagedAppProtections.Item.DeploymentSummary;
...
namespace MicrosoftGraph.DeviceAppManagement.AndroidManagedAppProtections.Item {
    /// <summary>Builds and executes requests for operations under \deviceAppManagement\androidManagedAppProtections\{androidManagedAppProtection-id}</summary>
    public class AndroidManagedAppProtectionRequestBuilder {
        ...
        /// </summary>
        public AndroidManagedAppProtectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AndroidManagedAppProtection body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
