...
namespace Microsoft.Graph.Beta.DeviceAppManagement.IosLobAppProvisioningConfigurations.HasPayloadLinks {
    ...
    public class HasPayloadLinksRequestBuilder : BaseRequestBuilder {
        ...
        public HasPayloadLinksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/iosLobAppProvisioningConfigurations/hasPayloadLinks", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HasPayloadLinksRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HasPayloadLinksRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/iosLobAppProvisioningConfigurations/hasPayloadLinks", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<HasPayloadLinksResponse?> PostAsync(HasPayloadLinksPostRequestBody body, CancellationToken cancellationToken = default, Action<HasPayloadLinksRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<HasPayloadLinksResponse> PostAsync(HasPayloadLinksPostRequestBody body, CancellationToken cancellationToken = default, Action<HasPayloadLinksRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
