...
namespace Microsoft.Graph.Beta.DeviceAppManagement.WdacSupplementalPolicies {
    ...
    public class WdacSupplementalPoliciesRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<WdacSupplementalPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(WindowsDefenderApplicationControlSupplementalPolicy body, Action<WdacSupplementalPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<WdacSupplementalPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse>(requestInfo, WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to wdacSupplementalPolicies for deviceAppManagement
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<WindowsDefenderApplicationControlSupplementalPolicy> PostAsync(WindowsDefenderApplicationControlSupplementalPolicy body, CancellationToken cancellationToken = default, Action<WdacSupplementalPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
