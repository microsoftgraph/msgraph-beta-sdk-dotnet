...
namespace MicrosoftGraph.DeviceAppManagement.WdacSupplementalPolicies.Item.DeviceStatuses.Item.Policy.Assign {
    ...
    public class AssignRequestBuilder {
        ...
        public AssignRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceAppManagement/wdacSupplementalPolicies/{windowsDefenderApplicationControlSupplementalPolicy_id}/deviceStatuses/{windowsDefenderApplicationControlSupplementalPolicyDeploymentStatus_id}/policy/microsoft.graph.assign";
