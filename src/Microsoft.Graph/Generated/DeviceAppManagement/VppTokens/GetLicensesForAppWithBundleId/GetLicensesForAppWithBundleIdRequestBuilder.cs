...
#nullable enable
        public async Task<GetLicensesForAppWithBundleIdResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetLicensesForAppWithBundleIdRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetLicensesForAppWithBundleIdResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetLicensesForAppWithBundleIdRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
