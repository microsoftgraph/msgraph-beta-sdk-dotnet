...
namespace Microsoft.Graph.Beta.DeviceAppManagement.VppTokens.GetLicensesForAppWithBundleId {
    ...
    public class GetLicensesForAppWithBundleIdResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<VppTokenLicenseSummary> Value {
            get { return BackingStore?.Get<List<VppTokenLicenseSummary>>(nameof(Value)); }
