...
namespace Microsoft.Graph.Beta.DeviceAppManagement.WindowsInformationProtectionWipeActions.Item {
    ...
    public class WindowsInformationProtectionWipeActionItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<WindowsInformationProtectionWipeAction> PatchAsync(WindowsInformationProtectionWipeAction body, Action<WindowsInformationProtectionWipeActionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
