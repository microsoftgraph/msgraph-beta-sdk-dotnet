...
namespace MicrosoftGraphSdk.DeviceAppManagement.WindowsInformationProtectionWipeActions {
    ...
    public class WindowsInformationProtectionWipeActionsRequestBuilder {
        ...
        /// </summary>
        public async Task<WindowsInformationProtectionWipeActionCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
