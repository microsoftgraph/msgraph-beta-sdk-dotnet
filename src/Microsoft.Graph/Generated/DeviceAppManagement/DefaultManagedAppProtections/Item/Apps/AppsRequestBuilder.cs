...
using MicrosoftGraph.DeviceAppManagement.DefaultManagedAppProtections.Item.Apps.Item;
...
namespace MicrosoftGraph.DeviceAppManagement.DefaultManagedAppProtections.Item.Apps {
    ...
    public class AppsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.deviceAppManagement.defaultManagedAppProtections.item.apps.item collection</summary>
