...
namespace Microsoft.Graph.Beta.DeviceAppManagement.MobileAppConfigurations.Item {
    ...
    public class ManagedDeviceMobileAppConfigurationItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceMobileAppConfigurationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ManagedDeviceMobileAppConfiguration> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceMobileAppConfigurationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ManagedDeviceMobileAppConfiguration body, CancellationToken cancellationToken = default, Action<ManagedDeviceMobileAppConfigurationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
