...
namespace MicrosoftGraphSdk.DeviceAppManagement.WindowsManagementApp.SetAsManagedInstaller {
    ...
    public class SetAsManagedInstallerRequestBuilder {
        ...
        /// <summary>
        /// Instantiates a new SetAsManagedInstallerRequestBuilder and sets the default values.
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public SetAsManagedInstallerRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/deviceAppManagement/windowsManagementApp/microsoft.graph.setAsManagedInstaller";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public SetAsManagedInstallerRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
