...
#nullable enable
        public async Task<ValidateXmlResponse?> PostAsync(ValidateXmlPostRequestBody body, CancellationToken cancellationToken = default, Action<ValidateXmlRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ValidateXmlResponse> PostAsync(ValidateXmlPostRequestBody body, CancellationToken cancellationToken = default, Action<ValidateXmlRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
