...
namespace Microsoft.Graph.Beta.DeviceAppManagement.MobileApps.GetTopMobileAppsWithStatusWithCount {
    ...
    public class GetTopMobileAppsWithStatusWithCountRequestBuilder {
        ...
        public async Task<GetTopMobileAppsWithStatusWithCountResponse> GetAsync(Action<GetTopMobileAppsWithStatusWithCountRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<GetTopMobileAppsWithStatusWithCountResponse>(requestInfo, GetTopMobileAppsWithStatusWithCountResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
