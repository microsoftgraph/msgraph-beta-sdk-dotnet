...
namespace Microsoft.Graph.Beta.DeviceAppManagement.MobileApps {
    ...
    public class MobileAppsRequestBuilder {
        ...
        /// </summary>
        public async Task<MobileAppCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MobileAppsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MobileApp> PostAsync(MobileApp body, CancellationToken cancellationToken = default, Action<MobileAppsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
