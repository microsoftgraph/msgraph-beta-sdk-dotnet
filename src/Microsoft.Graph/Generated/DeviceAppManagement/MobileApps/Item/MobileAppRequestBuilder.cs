...
using MicrosoftGraph.DeviceAppManagement.MobileApps.Item.DeviceStatuses;
using MicrosoftGraph.DeviceAppManagement.MobileApps.Item.GetRelatedAppStatesWithUserPrincipalNameWithDeviceId;
using MicrosoftGraph.DeviceAppManagement.MobileApps.Item.InstallSummary;
using MicrosoftGraph.DeviceAppManagement.MobileApps.Item.IosVppApp;
using MicrosoftGraph.DeviceAppManagement.MobileApps.Item.Relationships;
using MicrosoftGraph.DeviceAppManagement.MobileApps.Item.UpdateRelationships;
using MicrosoftGraph.DeviceAppManagement.MobileApps.Item.UserStatuses;
