...
namespace Microsoft.Graph.Beta.DeviceAppManagement.MobileApps.Item.UserStatuses.Item.DeviceStatuses.Item.App {
    ...
    public class AppRequestBuilder {
        ...
        public AppRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/userStatuses/{userAppInstallStatus%2Did}/deviceStatuses/{mobileAppInstallStatus%2Did}/app{?%24select,%24expand}";
