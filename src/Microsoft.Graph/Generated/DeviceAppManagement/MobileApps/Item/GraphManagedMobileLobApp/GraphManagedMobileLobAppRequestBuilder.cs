...
#nullable enable
        public async Task<ManagedMobileLobApp?> GetAsync(CancellationToken cancellationToken = default, Action<GraphManagedMobileLobAppRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedMobileLobApp> GetAsync(CancellationToken cancellationToken = default, Action<GraphManagedMobileLobAppRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
