    ...
    public class GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdResponse).Value = n.GetCollectionOfObjectValues<MobileAppRelationshipState>(MobileAppRelationshipState.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
