...
namespace Microsoft.Graph.Beta.DeviceAppManagement.MobileApps.Item.GetRelatedAppStatesWithUserPrincipalNameWithDeviceId {
    ...
    public class GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<MobileAppRelationshipState> Value {
            get { return BackingStore?.Get<List<MobileAppRelationshipState>>(nameof(Value)); }
