...
namespace MicrosoftGraph.DeviceAppManagement.MobileApps.Item.DeviceStatuses.Item.App.GetRelatedAppStatesWithUserPrincipalNameWithDeviceId {
    /// <summary>Builds and executes requests for operations under \deviceAppManagement\mobileApps\{mobileApp-id}\deviceStatuses\{mobileAppInstallStatus-id}\app\microsoft.graph.getRelatedAppStates(userPrincipalName='{userPrincipalName}',deviceId='{deviceId}')</summary>
    public class GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder {
        ...
        public GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string userPrincipalName = default, string deviceId = default) {
            ...
            UrlTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp_id}/deviceStatuses/{mobileAppInstallStatus_id}/app/microsoft.graph.getRelatedAppStates(userPrincipalName='{userPrincipalName}',deviceId='{deviceId}')";
        ...
        public async Task<IEnumerable<MicrosoftGraph.DeviceAppManagement.MobileApps.Item.DeviceStatuses.Item.App.GetRelatedAppStatesWithUserPrincipalNameWithDeviceId.GetRelatedAppStatesWithUserPrincipalNameWithDeviceId>> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendCollectionAsync<MicrosoftGraph.DeviceAppManagement.MobileApps.Item.DeviceStatuses.Item.App.GetRelatedAppStatesWithUserPrincipalNameWithDeviceId.GetRelatedAppStatesWithUserPrincipalNameWithDeviceId>(requestInfo, responseHandler, default, cancellationToken);
        }
    }
}
