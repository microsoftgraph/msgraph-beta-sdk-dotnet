...
namespace Microsoft.Graph.Beta.DeviceAppManagement.MobileApps.Item.DeviceStatuses.Item.App {
    ...
    public class AppRequestBuilder {
        ...
        /// </summary>
        public async Task<MobileApp> GetAsync(CancellationToken cancellationToken = default, Action<AppRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
