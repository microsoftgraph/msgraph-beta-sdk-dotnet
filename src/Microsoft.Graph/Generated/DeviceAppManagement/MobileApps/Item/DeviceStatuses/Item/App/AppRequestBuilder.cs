...
namespace Microsoft.Graph.Beta.DeviceAppManagement.MobileApps.Item.DeviceStatuses.Item.App {
    ...
    public class AppRequestBuilder {
        ...
        public AppRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/deviceStatuses/{mobileAppInstallStatus%2Did}/app{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<MobileApp> GetAsync(Action<AppRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
