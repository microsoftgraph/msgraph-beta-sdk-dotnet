...
using MicrosoftGraphSdk.DeviceAppManagement.MobileApps.Item.DeviceStatuses.Item.App.Assign;
using MicrosoftGraphSdk.DeviceAppManagement.MobileApps.Item.DeviceStatuses.Item.App.GetRelatedAppStatesWithUserPrincipalNameWithDeviceId;
using MicrosoftGraphSdk.DeviceAppManagement.MobileApps.Item.DeviceStatuses.Item.App.IosVppApp;
using MicrosoftGraphSdk.DeviceAppManagement.MobileApps.Item.DeviceStatuses.Item.App.Ref;
using MicrosoftGraphSdk.DeviceAppManagement.MobileApps.Item.DeviceStatuses.Item.App.UpdateRelationships;
...
namespace MicrosoftGraphSdk.DeviceAppManagement.MobileApps.Item.DeviceStatuses.Item.App {
    /// <summary>Builds and executes requests for operations under \deviceAppManagement\mobileApps\{mobileApp-id}\deviceStatuses\{mobileAppInstallStatus-id}\app</summary>
    public class AppRequestBuilder {
        ...
        public AppRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp_id}/deviceStatuses/{mobileAppInstallStatus_id}/app{?select,expand}";
        ...
        /// <summary>
        /// Builds and executes requests for operations under \deviceAppManagement\mobileApps\{mobileApp-id}\deviceStatuses\{mobileAppInstallStatus-id}\app\microsoft.graph.getRelatedAppStates(userPrincipalName='{userPrincipalName}',deviceId='{deviceId}')
