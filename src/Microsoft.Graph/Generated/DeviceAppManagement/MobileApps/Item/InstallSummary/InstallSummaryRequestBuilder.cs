...
namespace Microsoft.Graph.Beta.DeviceAppManagement.MobileApps.Item.InstallSummary {
    ...
    public class InstallSummaryRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MobileAppInstallSummary> GetAsync(CancellationToken cancellationToken = default, Action<InstallSummaryRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MobileAppInstallSummary body, CancellationToken cancellationToken = default, Action<InstallSummaryRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
