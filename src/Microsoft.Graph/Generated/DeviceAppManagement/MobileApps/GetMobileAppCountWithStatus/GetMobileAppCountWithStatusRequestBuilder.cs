...
namespace Microsoft.Graph.Beta.DeviceAppManagement.MobileApps.GetMobileAppCountWithStatus {
    ...
    public class GetMobileAppCountWithStatusRequestBuilder {
        ...
        /// </summary>
        public async Task<GetMobileAppCountWithStatusResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetMobileAppCountWithStatusRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
