...
namespace Microsoft.Graph.Beta.DeviceAppManagement.MobileApps.GetMobileAppCountWithStatus {
    ...
    public class GetMobileAppCountWithStatusRequestBuilder {
        ...
        /// </summary>
        public GetMobileAppCountWithStatusRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string status = default) {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetMobileAppCountWithStatusRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<GetMobileAppCountWithStatusResponse> GetAsync(Action<GetMobileAppCountWithStatusRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<GetMobileAppCountWithStatusResponse>(requestInfo, GetMobileAppCountWithStatusResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
