...
namespace MicrosoftGraphSdk.DeviceAppManagement.ManagedAppStatuses {
    public class ManagedAppStatusesResponse : IParsable {
        ...
        /// </summary>
        public static ManagedAppStatusesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ManagedAppStatusesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ManagedAppStatusesResponse).Value = n.GetCollectionOfObjectValues<ManagedAppStatus>(ManagedAppStatus.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
