...
using MicrosoftGraphSdk.DeviceAppManagement.ManagedEBooks.Item.UserStateSummary.Count;
...
namespace MicrosoftGraphSdk.DeviceAppManagement.ManagedEBooks.Item.UserStateSummary {
    ...
    public class UserStateSummaryRequestBuilder {
        ...
        /// </summary>
        public async Task<UserInstallStateSummaryCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
