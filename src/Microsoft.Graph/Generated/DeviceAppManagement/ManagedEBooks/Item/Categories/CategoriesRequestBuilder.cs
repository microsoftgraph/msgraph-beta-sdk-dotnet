...
namespace Microsoft.Graph.Beta.DeviceAppManagement.ManagedEBooks.Item.Categories {
    ...
    public class CategoriesRequestBuilder {
        ...
        /// </summary>
        public async Task<ManagedEBookCategoryCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CategoriesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
