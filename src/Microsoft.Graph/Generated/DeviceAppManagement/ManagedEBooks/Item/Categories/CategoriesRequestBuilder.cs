...
#nullable enable
        public async Task<ManagedEBookCategoryCollectionResponse?> GetAsync(Action<CategoriesRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ManagedEBookCategoryCollectionResponse> GetAsync(Action<CategoriesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
