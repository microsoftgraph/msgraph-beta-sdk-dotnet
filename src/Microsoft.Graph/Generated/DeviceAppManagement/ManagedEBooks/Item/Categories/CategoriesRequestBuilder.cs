...
namespace Microsoft.Graph.Beta.DeviceAppManagement.ManagedEBooks.Item.Categories {
    ...
    public class CategoriesRequestBuilder : BaseRequestBuilder 
    {
        ...
        public ManagedEBookCategoryItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<ManagedEBookCategoryCollectionResponse?> GetAsync(Action<RequestConfiguration<CategoriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ManagedEBookCategoryCollectionResponse> GetAsync(Action<RequestConfiguration<CategoriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<ManagedEBookCategoryCollectionResponse>(requestInfo, ManagedEBookCategoryCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// The list of categories for this eBook.
        /// </summary>
