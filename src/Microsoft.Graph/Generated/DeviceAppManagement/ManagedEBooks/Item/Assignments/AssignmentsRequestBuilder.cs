...
namespace MicrosoftGraphSdk.DeviceAppManagement.ManagedEBooks.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder {
        ...
        public async Task<ManagedEBookAssignment> PostAsync(ManagedEBookAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<ManagedEBookAssignment>(requestInfo, ManagedEBookAssignment.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
