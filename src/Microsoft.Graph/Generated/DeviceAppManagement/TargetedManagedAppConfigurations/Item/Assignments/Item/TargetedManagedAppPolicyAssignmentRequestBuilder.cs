...
namespace MicrosoftGraph.DeviceAppManagement.TargetedManagedAppConfigurations.Item.Assignments.Item {
    ...
    public class TargetedManagedAppPolicyAssignmentRequestBuilder {
        ...
        /// <summary>
        /// Instantiates a new TargetedManagedAppPolicyAssignmentRequestBuilder and sets the default values.
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public TargetedManagedAppPolicyAssignmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public TargetedManagedAppPolicyAssignmentRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
