...
namespace Microsoft.Graph.Beta.BookingBusinesses.Item.StaffMembers {
    ...
    public class StaffMembersRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(BookingStaffMember body, Action<StaffMembersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<BookingStaffMemberCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<StaffMembersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<BookingStaffMember> PostAsync(BookingStaffMember body, CancellationToken cancellationToken = default, Action<StaffMembersRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
