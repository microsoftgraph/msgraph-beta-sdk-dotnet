...
#nullable enable
        public async Task<BookingStaffMemberCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<StaffMembersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BookingStaffMemberCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<StaffMembersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BookingStaffMember?> PostAsync(BookingStaffMember body, CancellationToken cancellationToken = default, Action<StaffMembersRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BookingStaffMember> PostAsync(BookingStaffMember body, CancellationToken cancellationToken = default, Action<StaffMembersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
