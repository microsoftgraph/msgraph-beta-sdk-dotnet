using Microsoft.Graph.Beta.BookingBusinesses.Item.CalendarView.Count;
using Microsoft.Graph.Beta.BookingBusinesses.Item.CalendarView.Item;
...
namespace Microsoft.Graph.Beta.BookingBusinesses.Item.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.bookingBusinesses.item.calendarView.item collection</summary>
        ...
        public CalendarViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/calendarView{?start,end,%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public async Task<BookingAppointmentCollectionResponse> GetAsync(Action<CalendarViewRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<BookingAppointment> PostAsync(BookingAppointment body, Action<CalendarViewRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
