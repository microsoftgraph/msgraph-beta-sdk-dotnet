...
namespace Microsoft.Graph.Beta.BookingBusinesses.Item.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        /// </summary>
        public async Task<BookingAppointmentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CalendarViewRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<BookingAppointment> PostAsync(BookingAppointment body, CancellationToken cancellationToken = default, Action<CalendarViewRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
