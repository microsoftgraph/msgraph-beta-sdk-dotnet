using Microsoft.Graph.Beta.BookingBusinesses.Item.Appointments.Count;
using Microsoft.Graph.Beta.BookingBusinesses.Item.Appointments.Item;
...
namespace Microsoft.Graph.Beta.BookingBusinesses.Item.Appointments {
    ...
    public class AppointmentsRequestBuilder : BaseRequestBuilder {
        ...
        public AppointmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/appointments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AppointmentsRequestBuilder and sets the default values.
        /// </summary>
