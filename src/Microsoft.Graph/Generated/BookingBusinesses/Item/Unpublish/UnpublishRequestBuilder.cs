...
using System;
namespace Microsoft.Graph.Beta.BookingBusinesses.Item.Unpublish {
    /// <summary>
    ...
    public class UnpublishRequestBuilder : BaseRequestBuilder {
        ...
        public UnpublishRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/unpublish", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UnpublishRequestBuilder and sets the default values.
        /// </summary>
