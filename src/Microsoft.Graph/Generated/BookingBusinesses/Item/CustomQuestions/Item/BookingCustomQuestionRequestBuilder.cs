...
namespace MicrosoftGraph.BookingBusinesses.Item.CustomQuestions.Item {
    /// <summary>Builds and executes requests for operations under \bookingBusinesses\{bookingBusiness-id}\customQuestions\{bookingCustomQuestion-id}</summary>
    public class BookingCustomQuestionRequestBuilder {
        ...
        public BookingCustomQuestionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/bookingBusinesses/{bookingBusiness_id}/customQuestions/{bookingCustomQuestion_id}{?select,expand}";
