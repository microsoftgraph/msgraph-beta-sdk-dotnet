...
namespace Microsoft.Graph.Beta.BookingBusinesses.Item.GetStaffAvailability {
    ...
    public class GetStaffAvailabilityRequestBuilder {
        ...
        /// </summary>
        public async Task<GetStaffAvailabilityResponse> PostAsync(GetStaffAvailabilityPostRequestBody body, Action<GetStaffAvailabilityRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<GetStaffAvailabilityResponse>(requestInfo, GetStaffAvailabilityResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
