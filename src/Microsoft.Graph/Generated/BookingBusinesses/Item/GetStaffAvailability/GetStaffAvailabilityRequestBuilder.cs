...
namespace Microsoft.Graph.Beta.BookingBusinesses.Item.GetStaffAvailability {
    ...
    public class GetStaffAvailabilityRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GetStaffAvailabilityRequestBody body, Action<GetStaffAvailabilityRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<GetStaffAvailabilityResponse> PostAsync(GetStaffAvailabilityRequestBody body, Action<GetStaffAvailabilityRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
