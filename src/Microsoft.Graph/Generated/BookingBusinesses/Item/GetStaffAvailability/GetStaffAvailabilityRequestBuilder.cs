...
namespace Microsoft.Graph.Beta.BookingBusinesses.Item.GetStaffAvailability {
    ...
    public class GetStaffAvailabilityRequestBuilder {
        ...
        /// </summary>
        public async Task<GetStaffAvailabilityResponse> PostAsync(GetStaffAvailabilityPostRequestBody body, CancellationToken cancellationToken = default, Action<GetStaffAvailabilityRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
