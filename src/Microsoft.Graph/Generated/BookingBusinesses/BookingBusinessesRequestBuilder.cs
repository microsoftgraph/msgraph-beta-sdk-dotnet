...
namespace MicrosoftGraph.BookingBusinesses {
    ...
    public class BookingBusinessesRequestBuilder {
        ...
        public BookingBusinessesRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("bookingBusiness_id", position);
            return new BookingBusinessesRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public BookingBusinessesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/bookingBusinesses{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
