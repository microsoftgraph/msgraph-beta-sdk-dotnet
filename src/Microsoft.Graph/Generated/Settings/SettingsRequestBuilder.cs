...
namespace Microsoft.Graph.Beta.Settings {
    ...
    public class SettingsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.settings.item collection</summary>
        ...
        public SettingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/settings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>Get entities from settings</summary>
