...
namespace Microsoft.Graph.Beta.RiskDetections {
    ...
    public class RiskDetectionsRequestBuilder {
        ...
        /// </summary>
        public async Task<RiskDetectionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RiskDetectionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<RiskDetection> PostAsync(RiskDetection body, CancellationToken cancellationToken = default, Action<RiskDetectionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
