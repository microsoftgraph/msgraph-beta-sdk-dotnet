...
namespace Microsoft.Graph.Beta.Organization {
    ...
    public class OrganizationRequestBuilder {
        ...
        /// </summary>
        public async Task<OrganizationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<OrganizationRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Organization> PostAsync(Microsoft.Graph.Beta.Models.Organization body, CancellationToken cancellationToken = default, Action<OrganizationRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
