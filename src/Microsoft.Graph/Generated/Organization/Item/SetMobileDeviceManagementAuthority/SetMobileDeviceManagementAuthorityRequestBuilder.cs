...
namespace MicrosoftGraphSdk.Organization.Item.SetMobileDeviceManagementAuthority {
    ...
    public class SetMobileDeviceManagementAuthorityRequestBuilder {
        ...
        /// </summary>
        public async Task<SetMobileDeviceManagementAuthorityResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
