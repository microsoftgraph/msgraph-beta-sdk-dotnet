...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.CertificateBasedAuthConfiguration?> GetAsync(CancellationToken cancellationToken = default, Action<CertificateBasedAuthConfigurationItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.CertificateBasedAuthConfiguration> GetAsync(CancellationToken cancellationToken = default, Action<CertificateBasedAuthConfigurationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
