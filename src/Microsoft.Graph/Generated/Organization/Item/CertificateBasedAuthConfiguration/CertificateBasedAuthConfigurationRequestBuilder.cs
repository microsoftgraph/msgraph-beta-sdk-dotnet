...
using MicrosoftGraphSdk.Organization.Item.CertificateBasedAuthConfiguration.Count;
using MicrosoftGraphSdk.Organization.Item.CertificateBasedAuthConfiguration.Item;
using System;
...
namespace MicrosoftGraphSdk.Organization.Item.CertificateBasedAuthConfiguration {
    ...
    public class CertificateBasedAuthConfigurationRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.organization.item.certificateBasedAuthConfiguration.item collection</summary>
