...
namespace Microsoft.Graph.Beta.Organization.Item.Branding.Localizations {
    ...
    public class LocalizationsRequestBuilder {
        ...
        /// </summary>
        public async Task<OrganizationalBrandingLocalizationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<LocalizationsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OrganizationalBrandingLocalization> PostAsync(OrganizationalBrandingLocalization body, CancellationToken cancellationToken = default, Action<LocalizationsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
