...
namespace Microsoft.Graph.Beta.Organization.Item.Branding.Localizations.Item.CustomCSS {
    /// <summary>
    ...
    public class CustomCSSRequestBuilder {
        ...
        public CustomCSSRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/organization/{organization%2Did}/branding/localizations/{organizationalBrandingLocalization%2Did}/customCSS";
