...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ContactInsightsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ContactInsightsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<InsightsSettings?> GetAsync(CancellationToken cancellationToken = default, Action<ContactInsightsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<InsightsSettings> GetAsync(CancellationToken cancellationToken = default, Action<ContactInsightsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<InsightsSettings?> PatchAsync(InsightsSettings body, CancellationToken cancellationToken = default, Action<ContactInsightsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<InsightsSettings> PatchAsync(InsightsSettings body, CancellationToken cancellationToken = default, Action<ContactInsightsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
