...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<InsightsSettings?> GetAsync(CancellationToken cancellationToken = default, Action<ItemInsightsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<InsightsSettings> GetAsync(CancellationToken cancellationToken = default, Action<ItemInsightsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<InsightsSettings?> PatchAsync(InsightsSettings body, CancellationToken cancellationToken = default, Action<ItemInsightsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<InsightsSettings> PatchAsync(InsightsSettings body, CancellationToken cancellationToken = default, Action<ItemInsightsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
