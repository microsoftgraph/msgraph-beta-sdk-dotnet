...
namespace Microsoft.Graph.Beta.Organization.Item.Settings.ItemInsights {
    ...
    public class ItemInsightsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<InsightsSettings> GetAsync(CancellationToken cancellationToken = default, Action<ItemInsightsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(InsightsSettings body, CancellationToken cancellationToken = default, Action<ItemInsightsRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
