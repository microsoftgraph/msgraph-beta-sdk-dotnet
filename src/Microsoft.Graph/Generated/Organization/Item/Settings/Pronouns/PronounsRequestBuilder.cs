...
namespace Microsoft.Graph.Beta.Organization.Item.Settings.Pronouns {
    ...
    public class PronounsRequestBuilder {
        ...
        public PronounsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/organization/{organization%2Did}/settings/pronouns{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PronounsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
