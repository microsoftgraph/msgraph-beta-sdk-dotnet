...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PronounsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PronounsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PronounsSettings?> GetAsync(CancellationToken cancellationToken = default, Action<PronounsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PronounsSettings> GetAsync(CancellationToken cancellationToken = default, Action<PronounsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PronounsSettings?> PatchAsync(PronounsSettings body, CancellationToken cancellationToken = default, Action<PronounsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PronounsSettings> PatchAsync(PronounsSettings body, CancellationToken cancellationToken = default, Action<PronounsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
