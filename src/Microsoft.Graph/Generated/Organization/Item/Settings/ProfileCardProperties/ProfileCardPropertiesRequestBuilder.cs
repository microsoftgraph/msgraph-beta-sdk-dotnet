...
namespace Microsoft.Graph.Beta.Organization.Item.Settings.ProfileCardProperties {
    ...
    public class ProfileCardPropertiesRequestBuilder {
        ...
        /// </summary>
        public async Task<ProfileCardPropertyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ProfileCardPropertiesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ProfileCardProperty> PostAsync(ProfileCardProperty body, CancellationToken cancellationToken = default, Action<ProfileCardPropertiesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
