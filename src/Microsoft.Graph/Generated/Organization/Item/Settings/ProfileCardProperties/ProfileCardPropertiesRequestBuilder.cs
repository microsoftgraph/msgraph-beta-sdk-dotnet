...
namespace Microsoft.Graph.Beta.Organization.Item.Settings.ProfileCardProperties {
    ...
    public class ProfileCardPropertiesRequestBuilder : BaseRequestBuilder {
        ...
        public ProfileCardPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/organization/{organization%2Did}/settings/profileCardProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ProfileCardPropertiesRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<ProfileCardPropertyCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ProfileCardPropertiesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ProfileCardPropertyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ProfileCardPropertiesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ProfileCardProperty?> PostAsync(ProfileCardProperty body, CancellationToken cancellationToken = default, Action<ProfileCardPropertiesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ProfileCardProperty> PostAsync(ProfileCardProperty body, CancellationToken cancellationToken = default, Action<ProfileCardPropertiesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
