...
namespace Microsoft.Graph.Beta.Organization.Item.Settings {
    ...
    public class SettingsRequestBuilder : BaseRequestBuilder 
    {
        ...
        {
            get => new ContactInsightsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new MicrosoftApplicationDataAccessRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new PeopleInsightsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.OrganizationSettings?> GetAsync(Action<RequestConfiguration<SettingsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.OrganizationSettings> GetAsync(Action<RequestConfiguration<SettingsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
