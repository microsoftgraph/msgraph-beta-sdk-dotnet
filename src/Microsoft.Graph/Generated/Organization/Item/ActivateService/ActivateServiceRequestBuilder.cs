...
namespace Microsoft.Graph.Beta.Organization.Item.ActivateService {
    ...
    public class ActivateServiceRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ActivateServicePostRequestBody body, Action<ActivateServiceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(ActivateServicePostRequestBody body, Action<ActivateServiceRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
