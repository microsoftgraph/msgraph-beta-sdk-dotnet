...
namespace Microsoft.Graph.Beta.Organization.Item.ActivateService {
    ...
    public class ActivateServiceRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ActivateServicePostRequestBody body, CancellationToken cancellationToken = default, Action<ActivateServiceRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
