...
namespace MicrosoftGraphSdk.Functions {
    public class FunctionsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as FunctionsResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as FunctionsResponse).Value = n.GetCollectionOfObjectValues<AttributeMappingFunctionSchema>().ToList(); } },
            };
        }
        /// <summary>
