...
using MicrosoftGraph.Planner.Buckets.Item.Tasks.Item.AssignedToTaskBoardFormat;
using MicrosoftGraph.Planner.Buckets.Item.Tasks.Item.BucketTaskBoardFormat;
using MicrosoftGraph.Planner.Buckets.Item.Tasks.Item.Details;
using MicrosoftGraph.Planner.Buckets.Item.Tasks.Item.ProgressTaskBoardFormat;
using System;
...
namespace MicrosoftGraph.Planner.Buckets.Item.Tasks.Item {
    /// <summary>Builds and executes requests for operations under \planner\buckets\{plannerBucket-id}\tasks\{plannerTask-id}</summary>
