...
using Microsoft.Graph.Beta.Planner.Buckets.Item.Tasks.Item.AssignedToTaskBoardFormat;
using Microsoft.Graph.Beta.Planner.Buckets.Item.Tasks.Item.BucketTaskBoardFormat;
using Microsoft.Graph.Beta.Planner.Buckets.Item.Tasks.Item.Details;
using Microsoft.Graph.Beta.Planner.Buckets.Item.Tasks.Item.ProgressTaskBoardFormat;
...
using System;
namespace Microsoft.Graph.Beta.Planner.Buckets.Item.Tasks.Item {
    /// <summary>
    ...
    public class PlannerTaskItemRequestBuilder : BaseRequestBuilder {
        ...
        public PlannerTaskItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/planner/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PlannerTaskItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PlannerTaskItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/planner/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PlannerTaskItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PlannerTaskItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PlannerTask?> GetAsync(CancellationToken cancellationToken = default, Action<PlannerTaskItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlannerTask> GetAsync(CancellationToken cancellationToken = default, Action<PlannerTaskItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PlannerTask?> PatchAsync(PlannerTask body, CancellationToken cancellationToken = default, Action<PlannerTaskItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlannerTask> PatchAsync(PlannerTask body, CancellationToken cancellationToken = default, Action<PlannerTaskItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
