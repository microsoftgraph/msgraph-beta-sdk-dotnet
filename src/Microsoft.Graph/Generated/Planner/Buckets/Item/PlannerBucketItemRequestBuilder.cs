...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PlannerBucketItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PlannerBucketItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PlannerBucket?> GetAsync(CancellationToken cancellationToken = default, Action<PlannerBucketItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlannerBucket> GetAsync(CancellationToken cancellationToken = default, Action<PlannerBucketItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PlannerBucket?> PatchAsync(PlannerBucket body, CancellationToken cancellationToken = default, Action<PlannerBucketItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlannerBucket> PatchAsync(PlannerBucket body, CancellationToken cancellationToken = default, Action<PlannerBucketItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
