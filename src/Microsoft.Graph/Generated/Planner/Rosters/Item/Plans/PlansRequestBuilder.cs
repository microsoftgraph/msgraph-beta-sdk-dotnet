...
using Microsoft.Graph.Beta.Planner.Rosters.Item.Plans.Count;
using Microsoft.Graph.Beta.Planner.Rosters.Item.Plans.Item;
...
namespace Microsoft.Graph.Beta.Planner.Rosters.Item.Plans {
    ...
    public class PlansRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.planner.rosters.item.plans.item collection</summary>
        ...
        public PlansRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/planner/rosters/{plannerRoster%2Did}/plans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>Get the plannerPlans contained by the plannerRoster.</summary>
