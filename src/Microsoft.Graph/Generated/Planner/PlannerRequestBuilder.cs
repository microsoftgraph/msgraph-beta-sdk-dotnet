...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Planner?> GetAsync(CancellationToken cancellationToken = default, Action<PlannerRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Planner> GetAsync(CancellationToken cancellationToken = default, Action<PlannerRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Planner?> PatchAsync(Microsoft.Graph.Beta.Models.Planner body, CancellationToken cancellationToken = default, Action<PlannerRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Planner> PatchAsync(Microsoft.Graph.Beta.Models.Planner body, CancellationToken cancellationToken = default, Action<PlannerRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
