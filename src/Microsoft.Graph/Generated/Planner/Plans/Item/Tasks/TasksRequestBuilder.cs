...
using MicrosoftGraph.Planner.Plans.Item.Tasks.Item;
using System;
...
namespace MicrosoftGraph.Planner.Plans.Item.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.planner.plans.item.tasks.item collection</summary>
