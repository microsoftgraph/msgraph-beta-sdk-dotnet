...
namespace Microsoft.Graph.Beta.Planner.Plans.Item.Tasks.Item.ProgressTaskBoardFormat {
    ...
    public class ProgressTaskBoardFormatRequestBuilder {
        ...
        public ProgressTaskBoardFormatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/progressTaskBoardFormat{?%24select,%24expand}";
