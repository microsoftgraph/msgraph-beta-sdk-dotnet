...
using Microsoft.Graph.Beta.Planner.Plans.Item.Buckets.Item.Tasks.Count;
using Microsoft.Graph.Beta.Planner.Plans.Item.Buckets.Item.Tasks.Item;
...
namespace Microsoft.Graph.Beta.Planner.Plans.Item.Buckets.Item.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.planner.plans.item.buckets.item.tasks.item collection</summary>
