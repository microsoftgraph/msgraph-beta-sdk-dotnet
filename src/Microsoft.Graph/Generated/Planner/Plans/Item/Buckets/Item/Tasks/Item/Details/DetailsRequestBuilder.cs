...
namespace Microsoft.Graph.Beta.Planner.Plans.Item.Buckets.Item.Tasks.Item.Details {
    ...
    public class DetailsRequestBuilder : BaseRequestBuilder {
        ...
        public DetailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/details{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DetailsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DetailsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/details{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PlannerTaskDetails?> GetAsync(CancellationToken cancellationToken = default, Action<DetailsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlannerTaskDetails> GetAsync(CancellationToken cancellationToken = default, Action<DetailsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PlannerTaskDetails?> PatchAsync(PlannerTaskDetails body, CancellationToken cancellationToken = default, Action<DetailsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlannerTaskDetails> PatchAsync(PlannerTaskDetails body, CancellationToken cancellationToken = default, Action<DetailsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
