...
using System;
namespace Microsoft.Graph.Beta.DirectoryRoles.GetUserOwnedObjects {
    /// <summary>
    ...
    public class GetUserOwnedObjectsRequestBuilder : BaseRequestBuilder {
        ...
        public GetUserOwnedObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directoryRoles/getUserOwnedObjects", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetUserOwnedObjectsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetUserOwnedObjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directoryRoles/getUserOwnedObjects", rawUrl) {
        }
        /// <summary>
