...
using MicrosoftGraphSdk.DirectoryRoles.Item.Members.Count;
using MicrosoftGraphSdk.DirectoryRoles.Item.Members.Item;
...
namespace MicrosoftGraphSdk.DirectoryRoles.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.directoryRoles.item.members.item collection</summary>
