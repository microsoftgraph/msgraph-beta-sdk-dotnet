using Microsoft.Graph.Beta.DirectoryRoles.Item.Members.GraphUser.Count;
...
namespace Microsoft.Graph.Beta.DirectoryRoles.Item.Members.GraphUser {
    /// <summary>
    ...
    public class GraphUserRequestBuilder {
        ...
        public GraphUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
