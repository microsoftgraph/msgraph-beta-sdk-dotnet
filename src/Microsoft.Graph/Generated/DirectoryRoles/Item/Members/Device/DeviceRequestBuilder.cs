using Microsoft.Graph.Beta.DirectoryRoles.Item.Members.Device.Count;
...
namespace Microsoft.Graph.Beta.DirectoryRoles.Item.Members.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        public DeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/microsoft.graph.device{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
