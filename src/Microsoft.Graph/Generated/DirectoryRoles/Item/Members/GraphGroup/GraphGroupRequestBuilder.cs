using Microsoft.Graph.Beta.DirectoryRoles.Item.Members.GraphGroup.Count;
...
namespace Microsoft.Graph.Beta.DirectoryRoles.Item.Members.GraphGroup {
    /// <summary>
    ...
    public class GraphGroupRequestBuilder {
        ...
        public GraphGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
