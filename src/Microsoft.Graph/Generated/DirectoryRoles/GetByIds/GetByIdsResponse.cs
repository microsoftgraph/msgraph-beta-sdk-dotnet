...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.DirectoryRoles.GetByIds {
    /// <summary>Provides operations to call the getByIds method.</summary>
    public class GetByIdsResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetByIdsResponse).Value = n.GetCollectionOfObjectValues<DirectoryObject>(DirectoryObject.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
