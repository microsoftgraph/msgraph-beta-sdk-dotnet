...
namespace Microsoft.Graph
{
    ...
    public partial class TargetedManagedAppConfigurationPolicySetItemRequest : BaseRequest, ITargetedManagedAppConfigurationPolicySetItemRequest
    {
        ...
        public System.Threading.Tasks.Task<TargetedManagedAppConfigurationPolicySetItem> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The TargetedManagedAppConfigurationPolicySetItem.</returns>
        public async System.Threading.Tasks.Task<TargetedManagedAppConfigurationPolicySetItem> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{TargetedManagedAppConfigurationPolicySetItem}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TargetedManagedAppConfigurationPolicySetItem>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TargetedManagedAppConfigurationPolicySetItem}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<TargetedManagedAppConfigurationPolicySetItem>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<TargetedManagedAppConfigurationPolicySetItem>(null, cancellationToken).ConfigureAwait(false);
        }
