...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ServicePrincipalReferenceRequest : BaseRequest, IServicePrincipalReferenceRequest
    {
        /// <summary>
        ...
        public ServicePrincipalReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Puts the specified ServicePrincipal reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The ServicePrincipal reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
