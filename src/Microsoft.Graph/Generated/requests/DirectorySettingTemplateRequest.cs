...
namespace Microsoft.Graph
{
    ...
    public partial class DirectorySettingTemplateRequest : BaseRequest, IDirectorySettingTemplateRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DirectorySettingTemplate>> CreateResponseAsync(DirectorySettingTemplate directorySettingTemplateToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DirectorySettingTemplate}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DirectorySettingTemplate>> UpdateResponseAsync(DirectorySettingTemplate directorySettingTemplateToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
