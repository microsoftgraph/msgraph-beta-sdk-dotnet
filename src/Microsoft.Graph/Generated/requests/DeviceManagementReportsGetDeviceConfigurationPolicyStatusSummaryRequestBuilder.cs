...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetDeviceConfigurationPolicyStatusSummaryRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetDeviceConfigurationPolicyStatusSummaryRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetDeviceConfigurationPolicyStatusSummaryRequest>, IDeviceManagementReportsGetDeviceConfigurationPolicyStatusSummaryRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetDeviceConfigurationPolicyStatusSummaryRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetDeviceConfigurationPolicyStatusSummaryRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetDeviceConfigurationPolicyStatusSummaryRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetDeviceConfigurationPolicyStatusSummaryRequest(functionUrl, this.Client, options);
