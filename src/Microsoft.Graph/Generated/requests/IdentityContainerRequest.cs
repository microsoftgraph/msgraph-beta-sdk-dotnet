...
namespace Microsoft.Graph
{
    ...
    public partial class IdentityContainerRequest : BaseRequest, IIdentityContainerRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<IdentityContainer>> CreateResponseAsync(IdentityContainer identityContainerToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IdentityContainer}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IdentityContainer>> UpdateResponseAsync(IdentityContainer identityContainerToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
