...
namespace Microsoft.Graph
{
    ...
    public partial class IdentityContainerRequest : BaseRequest, IIdentityContainerRequest
    {
        ...
        public System.Threading.Tasks.Task<IdentityContainer> CreateAsync(IdentityContainer identityContainerToCreate)
        {
            return this.CreateAsync(identityContainerToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created IdentityContainer.</returns>
        public async System.Threading.Tasks.Task<IdentityContainer> CreateAsync(IdentityContainer identityContainerToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<IdentityContainer> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The IdentityContainer.</returns>
        public async System.Threading.Tasks.Task<IdentityContainer> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{IdentityContainer}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IdentityContainer>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IdentityContainer}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IdentityContainer>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<IdentityContainer>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<IdentityContainer> UpdateAsync(IdentityContainer identityContainerToUpdate)
        {
            return this.UpdateAsync(identityContainerToUpdate, CancellationToken.None);
        }
        ...
        /// <returns>The updated IdentityContainer.</returns>
        public async System.Threading.Tasks.Task<IdentityContainer> UpdateAsync(IdentityContainer identityContainerToUpdate, CancellationToken cancellationToken)
        {
			if (identityContainerToUpdate.AdditionalData != null)
			{
				if (identityContainerToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					identityContainerToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, identityContainerToUpdate.GetType().Name)
						});
				}
			}
            if (identityContainerToUpdate.AdditionalData != null)
        ...
        /// <param name="identityContainerToUpdate">The IdentityContainer to update.</param>
        /// <returns>The <see cref="GraphResponse{IdentityContainer}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IdentityContainer>> UpdateResponseAsync(IdentityContainer identityContainerToUpdate)
        {
            return this.UpdateResponseAsync(identityContainerToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IdentityContainer}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IdentityContainer>> UpdateResponseAsync(IdentityContainer identityContainerToUpdate, CancellationToken cancellationToken)
        {
			if (identityContainerToUpdate.AdditionalData != null)
			{
				if (identityContainerToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<IdentityContainer>(identityContainerToUpdate, cancellationToken).ConfigureAwait(false);
        }
