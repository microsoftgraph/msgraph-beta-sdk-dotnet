...
namespace Microsoft.Graph
{
    ...
    public partial interface ISalesOrderLineRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SalesOrderLine> CreateAsync(SalesOrderLine salesOrderLineToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<SalesOrderLine>> CreateResponseAsync(SalesOrderLine salesOrderLineToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<SalesOrderLine> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SalesOrderLine}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SalesOrderLine>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<SalesOrderLine> UpdateAsync(SalesOrderLine salesOrderLineToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SalesOrderLine}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SalesOrderLine>> UpdateResponseAsync(SalesOrderLine salesOrderLineToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<SalesOrderLine> PutAsync(SalesOrderLine salesOrderLineToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<SalesOrderLine>> PutResponseAsync(SalesOrderLine salesOrderLineToUpdate, CancellationToken cancellationToken = default);
