...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class UnifiedGroupSourceRequest : BaseRequest, IUnifiedGroupSourceRequest
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<UnifiedGroupSource> UpdateAsync(UnifiedGroupSource unifiedGroupSourceToUpdate, CancellationToken cancellationToken)
        {
			...
			{
				if (unifiedGroupSourceToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					unifiedGroupSourceToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, unifiedGroupSourceToUpdate.GetType().Name)
						});
				}
			}
            if (unifiedGroupSourceToUpdate.AdditionalData != null)
