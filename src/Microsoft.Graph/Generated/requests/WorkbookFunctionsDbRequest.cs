...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsDbRequest : BaseRequest, IWorkbookFunctionsDbRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsDbRequest.
        /// </summary>
        public WorkbookFunctionsDbRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsDbRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsDbRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsDbRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsDbRequest Select(string value)
        {
