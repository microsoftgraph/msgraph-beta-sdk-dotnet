...
namespace Microsoft.Graph
{
    ...
    public partial interface IIdentityCustomUserFlowAttributeRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<IdentityCustomUserFlowAttribute> CreateAsync(IdentityCustomUserFlowAttribute identityCustomUserFlowAttributeToCreate);
        ...
        /// <returns>The created IdentityCustomUserFlowAttribute.</returns>
        System.Threading.Tasks.Task<IdentityCustomUserFlowAttribute> CreateAsync(IdentityCustomUserFlowAttribute identityCustomUserFlowAttributeToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<IdentityCustomUserFlowAttribute>> CreateResponseAsync(IdentityCustomUserFlowAttribute identityCustomUserFlowAttributeToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IdentityCustomUserFlowAttribute}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IdentityCustomUserFlowAttribute>> CreateResponseAsync(IdentityCustomUserFlowAttribute identityCustomUserFlowAttributeToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<IdentityCustomUserFlowAttribute> UpdateAsync(IdentityCustomUserFlowAttribute identityCustomUserFlowAttributeToUpdate);
        ...
        /// <returns>The updated IdentityCustomUserFlowAttribute.</returns>
        System.Threading.Tasks.Task<IdentityCustomUserFlowAttribute> UpdateAsync(IdentityCustomUserFlowAttribute identityCustomUserFlowAttributeToUpdate, CancellationToken cancellationToken);
        ...
        /// <param name="identityCustomUserFlowAttributeToUpdate">The IdentityCustomUserFlowAttribute to update.</param>
        /// <returns>The <see cref="GraphResponse{IdentityCustomUserFlowAttribute}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IdentityCustomUserFlowAttribute>> UpdateResponseAsync(IdentityCustomUserFlowAttribute identityCustomUserFlowAttributeToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IdentityCustomUserFlowAttribute}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IdentityCustomUserFlowAttribute>> UpdateResponseAsync(IdentityCustomUserFlowAttribute identityCustomUserFlowAttributeToUpdate, CancellationToken cancellationToken);
