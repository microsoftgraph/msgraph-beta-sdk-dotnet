...
namespace Microsoft.Graph
{
    ...
    public partial class MacOSSoftwareUpdateCategorySummaryRequest : BaseRequest, IMacOSSoftwareUpdateCategorySummaryRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MacOSSoftwareUpdateCategorySummary>> CreateResponseAsync(MacOSSoftwareUpdateCategorySummary macOSSoftwareUpdateCategorySummaryToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<MacOSSoftwareUpdateCategorySummary> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MacOSSoftwareUpdateCategorySummary}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MacOSSoftwareUpdateCategorySummary>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MacOSSoftwareUpdateCategorySummary}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MacOSSoftwareUpdateCategorySummary>> UpdateResponseAsync(MacOSSoftwareUpdateCategorySummary macOSSoftwareUpdateCategorySummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<MacOSSoftwareUpdateCategorySummary> PutAsync(MacOSSoftwareUpdateCategorySummary macOSSoftwareUpdateCategorySummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<MacOSSoftwareUpdateCategorySummary>> PutResponseAsync(MacOSSoftwareUpdateCategorySummary macOSSoftwareUpdateCategorySummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<MacOSSoftwareUpdateCategorySummary>(macOSSoftwareUpdateCategorySummaryToUpdate, cancellationToken);
