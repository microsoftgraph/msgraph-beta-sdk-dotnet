...
namespace Microsoft.Graph
{
    ...
    public partial class MacOSSoftwareUpdateCategorySummaryRequest : BaseRequest, IMacOSSoftwareUpdateCategorySummaryRequest
    {
        ...
        public async System.Threading.Tasks.Task<MacOSSoftwareUpdateCategorySummary> CreateAsync(MacOSSoftwareUpdateCategorySummary macOSSoftwareUpdateCategorySummaryToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<MacOSSoftwareUpdateCategorySummary>> CreateResponseAsync(MacOSSoftwareUpdateCategorySummary macOSSoftwareUpdateCategorySummaryToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        public async System.Threading.Tasks.Task<MacOSSoftwareUpdateCategorySummary> UpdateAsync(MacOSSoftwareUpdateCategorySummary macOSSoftwareUpdateCategorySummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MacOSSoftwareUpdateCategorySummary}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MacOSSoftwareUpdateCategorySummary>> UpdateResponseAsync(MacOSSoftwareUpdateCategorySummary macOSSoftwareUpdateCategorySummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
