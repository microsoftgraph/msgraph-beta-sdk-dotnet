...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsFvRequest : BaseRequest, IWorkbookFunctionsFvRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsFvRequest.
        /// </summary>
        public WorkbookFunctionsFvRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsFvRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsFvRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsFvRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsFvRequest Select(string value)
        {
