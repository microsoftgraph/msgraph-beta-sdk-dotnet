...
namespace Microsoft.Graph
{
    ...
    public partial interface IOfficeClientConfigurationUserPreferencePayloadRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream userPreferencePayload) where T : OfficeClientConfiguration;
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The <see cref="GraphResponse"/> object returned by the PUT call.</returns>
        System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream userPreferencePayload, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OfficeClientConfiguration;
