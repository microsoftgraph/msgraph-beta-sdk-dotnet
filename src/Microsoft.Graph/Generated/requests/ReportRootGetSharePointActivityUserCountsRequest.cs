...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetSharePointActivityUserCountsRequest : BaseRequest, IReportRootGetSharePointActivityUserCountsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointActivityUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="sharepointactivityusercounts">The SharePointActivityUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointActivityUserCountsCollectionResponse>> PatchResponseAsync(SharePointActivityUserCounts sharepointactivityusercounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="sharepointactivityusercounts">The SharePointActivityUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointActivityUserCountsCollectionResponse>> PutResponseAsync(SharePointActivityUserCounts sharepointactivityusercounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetSharePointActivityUserCountsCollectionResponse>(sharepointactivityusercounts, cancellationToken);
        }
