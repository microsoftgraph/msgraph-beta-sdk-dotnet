...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetSharePointActivityUserCountsRequest : BaseRequest, IReportRootGetSharePointActivityUserCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointActivityUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSharePointActivityUserCountsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="sharepointactivityusercounts">The SharePointActivityUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointActivityUserCountsCollectionResponse>> PatchResponseAsync(SharePointActivityUserCounts sharepointactivityusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSharePointActivityUserCountsCollectionResponse>(sharepointactivityusercounts, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="sharepointactivityusercounts">The SharePointActivityUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointActivityUserCountsCollectionResponse>> PutResponseAsync(SharePointActivityUserCounts sharepointactivityusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSharePointActivityUserCountsCollectionResponse>(sharepointactivityusercounts, cancellationToken).ConfigureAwait(false);
        }
