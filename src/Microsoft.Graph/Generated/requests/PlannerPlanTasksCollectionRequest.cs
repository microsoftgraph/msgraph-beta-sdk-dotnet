...
namespace Microsoft.Graph
{
    ...
    public partial class PlannerPlanTasksCollectionRequest : BaseRequest, IPlannerPlanTasksCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PlannerTask>> AddResponseAsync(PlannerTask plannerTask)
        {
            return this.AddResponseAsync(plannerTask, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PlannerTask}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PlannerTask>> AddResponseAsync(PlannerTask plannerTask, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<PlannerTask>(plannerTask, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <summary>
        /// Gets the collection page and returns a <see cref="GraphResponse{PlannerPlanTasksCollectionResponse}"/> object.
        /// </summary>
        /// <returns>The <see cref="GraphResponse{PlannerPlanTasksCollectionResponse}"/> object.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PlannerPlanTasksCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PlannerPlanTasksCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PlannerPlanTasksCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<PlannerPlanTasksCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
