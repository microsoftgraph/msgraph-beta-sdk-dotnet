...
namespace Microsoft.Graph
{
    ...
    public partial class UserActivityRequest : BaseRequest, IUserActivityRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<UserActivity> PutAsync(UserActivity userActivityToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="userActivityToUpdate">The UserActivity object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{UserActivity}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserActivity>> PutResponseAsync(UserActivity userActivityToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<UserActivity>(userActivityToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(UserActivity userActivityToInitialize)
        {
            ...
            if (userActivityToInitialize != null)
            {
                if (userActivityToInitialize.HistoryItems != null && userActivityToInitialize.HistoryItems.CurrentPage != null)
                {
                    userActivityToInitialize.HistoryItems.InitializeNextPageRequest(this.Client, userActivityToInitialize.HistoryItemsNextLink);
