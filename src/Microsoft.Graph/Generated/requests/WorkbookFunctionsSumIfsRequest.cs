...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsSumIfsRequest : BaseRequest, IWorkbookFunctionsSumIfsRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsSumIfsRequest.
        /// </summary>
        public WorkbookFunctionsSumIfsRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsSumIfsRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsSumIfsRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsSumIfsRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsSumIfsRequest Select(string value)
        {
