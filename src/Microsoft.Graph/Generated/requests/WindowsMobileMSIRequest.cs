...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsMobileMSIRequest : BaseRequest, IWindowsMobileMSIRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WindowsMobileMSI>> CreateResponseAsync(WindowsMobileMSI windowsMobileMSIToCreate)
        {
            return this.CreateResponseAsync(windowsMobileMSIToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsMobileMSI}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsMobileMSI>> CreateResponseAsync(WindowsMobileMSI windowsMobileMSIToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<WindowsMobileMSI>(windowsMobileMSIToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WindowsMobileMSI}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsMobileMSI>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsMobileMSI}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsMobileMSI>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WindowsMobileMSI>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="windowsMobileMSIToUpdate">The WindowsMobileMSI to update.</param>
        /// <returns>The <see cref="GraphResponse{WindowsMobileMSI}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsMobileMSI>> UpdateResponseAsync(WindowsMobileMSI windowsMobileMSIToUpdate)
        {
            return this.UpdateResponseAsync(windowsMobileMSIToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsMobileMSI}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsMobileMSI>> UpdateResponseAsync(WindowsMobileMSI windowsMobileMSIToUpdate, CancellationToken cancellationToken)
        {
			if (windowsMobileMSIToUpdate.AdditionalData != null)
			{
				if (windowsMobileMSIToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<WindowsMobileMSI>(windowsMobileMSIToUpdate, cancellationToken).ConfigureAwait(false);
        }
