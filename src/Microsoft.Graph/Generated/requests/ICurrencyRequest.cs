...
namespace Microsoft.Graph
{
    ...
    public partial interface ICurrencyRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<Currency> CreateAsync(Currency currencyToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<Currency>> CreateResponseAsync(Currency currencyToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<Currency> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Currency}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Currency>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<Currency> UpdateAsync(Currency currencyToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Currency}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Currency>> UpdateResponseAsync(Currency currencyToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<Currency> PutAsync(Currency currencyToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<Currency>> PutResponseAsync(Currency currencyToUpdate, CancellationToken cancellationToken = default);
