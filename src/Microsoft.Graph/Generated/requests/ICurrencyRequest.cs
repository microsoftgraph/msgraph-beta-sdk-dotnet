...
namespace Microsoft.Graph
{
    ...
    public partial interface ICurrencyRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<Currency> CreateAsync(Currency currencyToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<Currency>> CreateResponseAsync(Currency currencyToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Currency}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Currency>> CreateResponseAsync(Currency currencyToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="currencyToUpdate">The Currency to update.</param>
        /// <returns>The <see cref="GraphResponse{Currency}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Currency>> UpdateResponseAsync(Currency currencyToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Currency}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Currency>> UpdateResponseAsync(Currency currencyToUpdate, CancellationToken cancellationToken);
