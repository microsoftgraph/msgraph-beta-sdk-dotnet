...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookRangeSortRequest : BaseRequest, IWorkbookRangeSortRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WorkbookRangeSort>> CreateResponseAsync(WorkbookRangeSort workbookRangeSortToCreate)
        {
            return this.CreateResponseAsync(workbookRangeSortToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookRangeSort}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookRangeSort>> CreateResponseAsync(WorkbookRangeSort workbookRangeSortToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<WorkbookRangeSort>(workbookRangeSortToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="workbookRangeSortToUpdate">The WorkbookRangeSort to update.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookRangeSort}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookRangeSort>> UpdateResponseAsync(WorkbookRangeSort workbookRangeSortToUpdate)
        {
            return this.UpdateResponseAsync(workbookRangeSortToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookRangeSort}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookRangeSort>> UpdateResponseAsync(WorkbookRangeSort workbookRangeSortToUpdate, CancellationToken cancellationToken)
        {
			if (workbookRangeSortToUpdate.AdditionalData != null)
			{
				if (workbookRangeSortToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<WorkbookRangeSort>(workbookRangeSortToUpdate, cancellationToken).ConfigureAwait(false);
        }
