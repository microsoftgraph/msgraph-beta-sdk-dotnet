...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookRangeSortRequest : BaseRequest, IWorkbookRangeSortRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookRangeSort>> CreateResponseAsync(WorkbookRangeSort workbookRangeSortToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookRangeSort}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookRangeSort>> UpdateResponseAsync(WorkbookRangeSort workbookRangeSortToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
