...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookNamedItemAddRequest : BaseRequest, IWorkbookNamedItemAddRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookNamedItem>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<WorkbookNamedItem>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
