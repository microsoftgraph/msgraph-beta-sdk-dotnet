...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsBin2HexRequest : BaseRequest, IWorkbookFunctionsBin2HexRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsBin2HexRequest.
        /// </summary>
        public WorkbookFunctionsBin2HexRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsBin2HexRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsBin2HexRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsBin2HexRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsBin2HexRequest Select(string value)
        {
