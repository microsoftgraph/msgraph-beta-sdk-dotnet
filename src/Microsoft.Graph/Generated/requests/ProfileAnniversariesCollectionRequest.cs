...
namespace Microsoft.Graph
{
    ...
    public partial class ProfileAnniversariesCollectionRequest : BaseRequest, IProfileAnniversariesCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<PersonAnniversary>> AddResponseAsync(PersonAnniversary personAnniversary, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ProfileAnniversariesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
