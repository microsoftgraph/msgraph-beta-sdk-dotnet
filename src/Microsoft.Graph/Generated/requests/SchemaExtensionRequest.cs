...
namespace Microsoft.Graph
{
    ...
    public partial class SchemaExtensionRequest : BaseRequest, ISchemaExtensionRequest
    {
        ...
        /// <param name="schemaExtensionToUpdate">The SchemaExtension to update.</param>
        /// <returns>The <see cref="GraphResponse{SchemaExtension}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SchemaExtension>> UpdateResponseAsync(SchemaExtension schemaExtensionToUpdate)
        {
            return this.UpdateResponseAsync(schemaExtensionToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SchemaExtension}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SchemaExtension>> UpdateResponseAsync(SchemaExtension schemaExtensionToUpdate, CancellationToken cancellationToken)
        {
			if (schemaExtensionToUpdate.AdditionalData != null)
			{
				if (schemaExtensionToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
