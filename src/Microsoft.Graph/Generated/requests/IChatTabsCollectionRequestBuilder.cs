...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IChatTabsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IChatTabsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IChatTabsCollectionRequest Request(IEnumerable<Option> options);
