...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type OrganizationalBrandingPropertiesCustomCSSRequest.
    /// </summary>
    public partial class OrganizationalBrandingPropertiesCustomCSSRequest : BaseRequest, IOrganizationalBrandingPropertiesCustomCSSRequest
    {
        /// <summary>
        /// Constructs a new OrganizationalBrandingPropertiesCustomCSSRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public OrganizationalBrandingPropertiesCustomCSSRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream customCSS, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
            return this.SendAsync<T>(customCSS, cancellationToken, completionOption);
        }
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream customCSS, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<T>(customCSS, cancellationToken, completionOption);
        }
