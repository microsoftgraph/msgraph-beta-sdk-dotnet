...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ReportRootDailyPrintUsageByPrinterCollectionRequestBuilder : BaseRequestBuilder, IReportRootDailyPrintUsageByPrinterCollectionRequestBuilder
    {
        /// <summary>
        ...
        public ReportRootDailyPrintUsageByPrinterCollectionRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public IReportRootDailyPrintUsageByPrinterCollectionRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public IReportRootDailyPrintUsageByPrinterCollectionRequest Request(IEnumerable<Option> options)
        {
            return new ReportRootDailyPrintUsageByPrinterCollectionRequest(this.RequestUrl, this.Client, options);
        }
