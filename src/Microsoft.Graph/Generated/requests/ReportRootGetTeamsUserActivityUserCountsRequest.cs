...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetTeamsUserActivityUserCountsRequest : BaseRequest, IReportRootGetTeamsUserActivityUserCountsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetTeamsUserActivityUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="teamsuseractivityusercounts">The TeamsUserActivityUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetTeamsUserActivityUserCountsCollectionResponse>> PatchResponseAsync(TeamsUserActivityUserCounts teamsuseractivityusercounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="teamsuseractivityusercounts">The TeamsUserActivityUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetTeamsUserActivityUserCountsCollectionResponse>> PutResponseAsync(TeamsUserActivityUserCounts teamsuseractivityusercounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetTeamsUserActivityUserCountsCollectionResponse>(teamsuseractivityusercounts, cancellationToken);
        }
