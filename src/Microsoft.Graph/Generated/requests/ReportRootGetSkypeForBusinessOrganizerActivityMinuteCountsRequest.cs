...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequest : BaseRequest, IReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="skypeforbusinessorganizeractivityminutecounts">The SkypeForBusinessOrganizerActivityMinuteCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsCollectionResponse>> PatchResponseAsync(SkypeForBusinessOrganizerActivityMinuteCounts skypeforbusinessorganizeractivityminutecounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsCollectionResponse>(skypeforbusinessorganizeractivityminutecounts, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="skypeforbusinessorganizeractivityminutecounts">The SkypeForBusinessOrganizerActivityMinuteCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsCollectionResponse>> PutResponseAsync(SkypeForBusinessOrganizerActivityMinuteCounts skypeforbusinessorganizeractivityminutecounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsCollectionResponse>(skypeforbusinessorganizeractivityminutecounts, cancellationToken).ConfigureAwait(false);
        }
