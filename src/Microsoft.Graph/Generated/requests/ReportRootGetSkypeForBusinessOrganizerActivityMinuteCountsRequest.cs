...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequest : BaseRequest, IReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="skypeforbusinessorganizeractivityminutecounts">The SkypeForBusinessOrganizerActivityMinuteCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsCollectionResponse>> PatchResponseAsync(SkypeForBusinessOrganizerActivityMinuteCounts skypeforbusinessorganizeractivityminutecounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="skypeforbusinessorganizeractivityminutecounts">The SkypeForBusinessOrganizerActivityMinuteCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsCollectionResponse>> PutResponseAsync(SkypeForBusinessOrganizerActivityMinuteCounts skypeforbusinessorganizeractivityminutecounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsCollectionResponse>(skypeforbusinessorganizeractivityminutecounts, cancellationToken);
        }
