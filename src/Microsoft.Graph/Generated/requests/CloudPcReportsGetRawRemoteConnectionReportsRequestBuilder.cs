...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type CloudPcReportsGetRawRemoteConnectionReportsRequestBuilder.
    /// </summary>
    public partial class CloudPcReportsGetRawRemoteConnectionReportsRequestBuilder : BaseActionMethodRequestBuilder<ICloudPcReportsGetRawRemoteConnectionReportsRequest>, ICloudPcReportsGetRawRemoteConnectionReportsRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="CloudPcReportsGetRawRemoteConnectionReportsRequestBuilder"/>.
        /// </summary>
        ...
        public CloudPcReportsGetRawRemoteConnectionReportsRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string filter,
        ...
        protected override ICloudPcReportsGetRawRemoteConnectionReportsRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new CloudPcReportsGetRawRemoteConnectionReportsRequest(functionUrl, this.Client, options);
