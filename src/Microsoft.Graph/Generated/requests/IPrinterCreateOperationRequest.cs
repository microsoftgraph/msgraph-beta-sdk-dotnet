...
namespace Microsoft.Graph
{
    ...
    public partial interface IPrinterCreateOperationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<PrinterCreateOperation> CreateAsync(PrinterCreateOperation printerCreateOperationToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<PrinterCreateOperation>> CreateResponseAsync(PrinterCreateOperation printerCreateOperationToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PrinterCreateOperation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<PrinterCreateOperation>> CreateResponseAsync(PrinterCreateOperation printerCreateOperationToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="printerCreateOperationToUpdate">The PrinterCreateOperation to update.</param>
        /// <returns>The <see cref="GraphResponse{PrinterCreateOperation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<PrinterCreateOperation>> UpdateResponseAsync(PrinterCreateOperation printerCreateOperationToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PrinterCreateOperation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<PrinterCreateOperation>> UpdateResponseAsync(PrinterCreateOperation printerCreateOperationToUpdate, CancellationToken cancellationToken);
