...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidEasEmailProfileConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AndroidEasEmailProfileConfiguration> CreateAsync(AndroidEasEmailProfileConfiguration androidEasEmailProfileConfigurationToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidEasEmailProfileConfiguration>> CreateResponseAsync(AndroidEasEmailProfileConfiguration androidEasEmailProfileConfigurationToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<AndroidEasEmailProfileConfiguration> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidEasEmailProfileConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidEasEmailProfileConfiguration>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<AndroidEasEmailProfileConfiguration> UpdateAsync(AndroidEasEmailProfileConfiguration androidEasEmailProfileConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidEasEmailProfileConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidEasEmailProfileConfiguration>> UpdateResponseAsync(AndroidEasEmailProfileConfiguration androidEasEmailProfileConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<AndroidEasEmailProfileConfiguration> PutAsync(AndroidEasEmailProfileConfiguration androidEasEmailProfileConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidEasEmailProfileConfiguration>> PutResponseAsync(AndroidEasEmailProfileConfiguration androidEasEmailProfileConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
