...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementConfigurationPolicyAssignmentRequest : BaseRequest, IDeviceManagementConfigurationPolicyAssignmentRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationPolicyAssignment>> CreateResponseAsync(DeviceManagementConfigurationPolicyAssignment deviceManagementConfigurationPolicyAssignmentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementConfigurationPolicyAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationPolicyAssignment>> UpdateResponseAsync(DeviceManagementConfigurationPolicyAssignment deviceManagementConfigurationPolicyAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
