...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IEducationClassAssignmentsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IEducationClassAssignmentsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IEducationClassAssignmentsCollectionRequest Request(IEnumerable<Option> options);
