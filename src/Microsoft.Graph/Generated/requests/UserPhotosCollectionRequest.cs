...
namespace Microsoft.Graph
{
    ...
    public partial class UserPhotosCollectionRequest : BaseRequest, IUserPhotosCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UserPhotosCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserPhotosCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserPhotosCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<UserPhotosCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
