...
namespace Microsoft.Graph
{
    ...
    public partial interface IConnectorGroupRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ConnectorGroup> CreateAsync(ConnectorGroup connectorGroupToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<ConnectorGroup>> CreateResponseAsync(ConnectorGroup connectorGroupToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ConnectorGroup}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ConnectorGroup>> CreateResponseAsync(ConnectorGroup connectorGroupToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="connectorGroupToUpdate">The ConnectorGroup to update.</param>
        /// <returns>The <see cref="GraphResponse{ConnectorGroup}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ConnectorGroup>> UpdateResponseAsync(ConnectorGroup connectorGroupToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ConnectorGroup}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ConnectorGroup>> UpdateResponseAsync(ConnectorGroup connectorGroupToUpdate, CancellationToken cancellationToken);
