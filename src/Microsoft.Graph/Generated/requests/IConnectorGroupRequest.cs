...
namespace Microsoft.Graph
{
    ...
    public partial interface IConnectorGroupRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<ConnectorGroup> PutAsync(ConnectorGroup connectorGroupToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<ConnectorGroup>> PutResponseAsync(ConnectorGroup connectorGroupToUpdate, CancellationToken cancellationToken = default);
