...
namespace Microsoft.Graph
{
    ...
    public partial class UserExperienceAnalyticsMetricWithReferenceRequest : BaseRequest, IUserExperienceAnalyticsMetricWithReferenceRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserExperienceAnalyticsMetric}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsMetric>> CreateResponseAsync(UserExperienceAnalyticsMetric userExperienceAnalyticsMetricToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserExperienceAnalyticsMetric}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsMetric>> UpdateResponseAsync(UserExperienceAnalyticsMetric userExperienceAnalyticsMetricToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
