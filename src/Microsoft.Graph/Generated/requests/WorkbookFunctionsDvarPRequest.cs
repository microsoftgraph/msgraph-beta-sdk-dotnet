...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsDvarPRequest : BaseRequest, IWorkbookFunctionsDvarPRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsDvarPRequest.
        /// </summary>
        public WorkbookFunctionsDvarPRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsDvarPRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsDvarPRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsDvarPRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsDvarPRequest Select(string value)
        {
