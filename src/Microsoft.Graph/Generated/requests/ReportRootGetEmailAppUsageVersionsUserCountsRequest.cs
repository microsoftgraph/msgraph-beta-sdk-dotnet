...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetEmailAppUsageVersionsUserCountsRequest : BaseRequest, IReportRootGetEmailAppUsageVersionsUserCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetEmailAppUsageVersionsUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetEmailAppUsageVersionsUserCountsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="emailappusageversionsusercounts">The EmailAppUsageVersionsUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetEmailAppUsageVersionsUserCountsCollectionResponse>> PatchResponseAsync(EmailAppUsageVersionsUserCounts emailappusageversionsusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetEmailAppUsageVersionsUserCountsCollectionResponse>(emailappusageversionsusercounts, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="emailappusageversionsusercounts">The EmailAppUsageVersionsUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetEmailAppUsageVersionsUserCountsCollectionResponse>> PutResponseAsync(EmailAppUsageVersionsUserCounts emailappusageversionsusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetEmailAppUsageVersionsUserCountsCollectionResponse>(emailappusageversionsusercounts, cancellationToken).ConfigureAwait(false);
        }
