...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type UserCloudPCsCollectionRequestBuilder.
    /// </summary>
    public partial class UserCloudPCsCollectionRequestBuilder : BaseRequestBuilder, IUserCloudPCsCollectionRequestBuilder
    {
        /// <summary>
        /// Constructs a new UserCloudPCsCollectionRequestBuilder.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        public UserCloudPCsCollectionRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public IUserCloudPCsCollectionRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public IUserCloudPCsCollectionRequest Request(IEnumerable<Option> options)
        {
            return new UserCloudPCsCollectionRequest(this.RequestUrl, this.Client, options);
        }

        /// <summary>
        /// Gets an <see cref="ICloudPCRequestBuilder"/> for the specified UserCloudPC.
        /// </summary>
        /// <param name="id">The ID for the UserCloudPC.</param>
