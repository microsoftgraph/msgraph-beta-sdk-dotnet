...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface ISitePermissionsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        ISitePermissionsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        ISitePermissionsCollectionRequest Request(IEnumerable<Option> options);
