...
namespace Microsoft.Graph
{
    ...
    public partial class ProfileCardPropertyRequest : BaseRequest, IProfileCardPropertyRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<ProfileCardProperty> PutAsync(ProfileCardProperty profileCardPropertyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<ProfileCardProperty>> PutResponseAsync(ProfileCardProperty profileCardPropertyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ProfileCardProperty>(profileCardPropertyToUpdate, cancellationToken);
