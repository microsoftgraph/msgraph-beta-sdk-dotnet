...
namespace Microsoft.Graph
{
    ...
    public partial class ProfileCardPropertyRequest : BaseRequest, IProfileCardPropertyRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ProfileCardProperty>> CreateResponseAsync(ProfileCardProperty profileCardPropertyToCreate)
        {
            return this.CreateResponseAsync(profileCardPropertyToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ProfileCardProperty}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ProfileCardProperty>> CreateResponseAsync(ProfileCardProperty profileCardPropertyToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="profileCardPropertyToUpdate">The ProfileCardProperty to update.</param>
        /// <returns>The <see cref="GraphResponse{ProfileCardProperty}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ProfileCardProperty>> UpdateResponseAsync(ProfileCardProperty profileCardPropertyToUpdate)
        {
            return this.UpdateResponseAsync(profileCardPropertyToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ProfileCardProperty}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ProfileCardProperty>> UpdateResponseAsync(ProfileCardProperty profileCardPropertyToUpdate, CancellationToken cancellationToken)
        {
			if (profileCardPropertyToUpdate.AdditionalData != null)
			{
				if (profileCardPropertyToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
