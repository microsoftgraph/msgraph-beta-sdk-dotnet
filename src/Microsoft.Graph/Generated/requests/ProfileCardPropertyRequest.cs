...
namespace Microsoft.Graph
{
    ...
    public partial class ProfileCardPropertyRequest : BaseRequest, IProfileCardPropertyRequest
    {
        ...
        public async System.Threading.Tasks.Task<ProfileCardProperty> CreateAsync(ProfileCardProperty profileCardPropertyToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ProfileCardProperty>> CreateResponseAsync(ProfileCardProperty profileCardPropertyToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<ProfileCardProperty> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ProfileCardProperty}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ProfileCardProperty>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<ProfileCardProperty> UpdateAsync(ProfileCardProperty profileCardPropertyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ProfileCardProperty}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ProfileCardProperty>> UpdateResponseAsync(ProfileCardProperty profileCardPropertyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<ProfileCardProperty> PutAsync(ProfileCardProperty profileCardPropertyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="profileCardPropertyToUpdate">The ProfileCardProperty object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{ProfileCardProperty}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ProfileCardProperty>> PutResponseAsync(ProfileCardProperty profileCardPropertyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ProfileCardProperty>(profileCardPropertyToUpdate, cancellationToken);
