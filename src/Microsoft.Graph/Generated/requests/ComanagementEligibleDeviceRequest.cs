...
namespace Microsoft.Graph
{
    ...
    public partial class ComanagementEligibleDeviceRequest : BaseRequest, IComanagementEligibleDeviceRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ComanagementEligibleDevice}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ComanagementEligibleDevice>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ComanagementEligibleDevice}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ComanagementEligibleDevice>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ComanagementEligibleDevice>(null, cancellationToken).ConfigureAwait(false);
        }
