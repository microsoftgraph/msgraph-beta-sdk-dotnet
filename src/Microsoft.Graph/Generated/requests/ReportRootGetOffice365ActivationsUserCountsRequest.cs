...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetOffice365ActivationsUserCountsRequest : BaseRequest, IReportRootGetOffice365ActivationsUserCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ActivationsUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365ActivationsUserCountsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="office365activationsusercounts">The Office365ActivationsUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ActivationsUserCountsCollectionResponse>> PatchResponseAsync(Office365ActivationsUserCounts office365activationsusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365ActivationsUserCountsCollectionResponse>(office365activationsusercounts, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="office365activationsusercounts">The Office365ActivationsUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ActivationsUserCountsCollectionResponse>> PutResponseAsync(Office365ActivationsUserCounts office365activationsusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365ActivationsUserCountsCollectionResponse>(office365activationsusercounts, cancellationToken).ConfigureAwait(false);
        }
