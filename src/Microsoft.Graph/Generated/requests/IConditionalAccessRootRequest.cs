...
namespace Microsoft.Graph
{
    ...
    public partial interface IConditionalAccessRootRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<ConditionalAccessRoot> PutAsync(ConditionalAccessRoot conditionalAccessRootToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<ConditionalAccessRoot>> PutResponseAsync(ConditionalAccessRoot conditionalAccessRootToUpdate, CancellationToken cancellationToken = default(CancellationToken));
