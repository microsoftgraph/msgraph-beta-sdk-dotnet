...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementDerivedCredentialSettingsWithReferenceRequest : BaseRequest, IDeviceManagementDerivedCredentialSettingsWithReferenceRequest
    {
        ...
        public async System.Threading.Tasks.Task<DeviceManagementDerivedCredentialSettings> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementDerivedCredentialSettings>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<DeviceManagementDerivedCredentialSettings> CreateAsync(DeviceManagementDerivedCredentialSettings deviceManagementDerivedCredentialSettingsToCreate, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementDerivedCredentialSettings}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementDerivedCredentialSettings>> CreateResponseAsync(DeviceManagementDerivedCredentialSettings deviceManagementDerivedCredentialSettingsToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<DeviceManagementDerivedCredentialSettings> UpdateAsync(DeviceManagementDerivedCredentialSettings deviceManagementDerivedCredentialSettingsToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementDerivedCredentialSettings}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementDerivedCredentialSettings>> UpdateResponseAsync(DeviceManagementDerivedCredentialSettings deviceManagementDerivedCredentialSettingsToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
