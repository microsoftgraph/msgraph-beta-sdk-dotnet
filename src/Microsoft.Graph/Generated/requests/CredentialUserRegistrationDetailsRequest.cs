...
namespace Microsoft.Graph
{
    ...
    public partial class CredentialUserRegistrationDetailsRequest : BaseRequest, ICredentialUserRegistrationDetailsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<CredentialUserRegistrationDetails>> CreateResponseAsync(CredentialUserRegistrationDetails credentialUserRegistrationDetailsToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CredentialUserRegistrationDetails}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CredentialUserRegistrationDetails>> UpdateResponseAsync(CredentialUserRegistrationDetails credentialUserRegistrationDetailsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
