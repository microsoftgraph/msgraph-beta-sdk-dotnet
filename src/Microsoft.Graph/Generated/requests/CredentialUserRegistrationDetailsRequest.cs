...
namespace Microsoft.Graph
{
    ...
    public partial class CredentialUserRegistrationDetailsRequest : BaseRequest, ICredentialUserRegistrationDetailsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<CredentialUserRegistrationDetails>> CreateResponseAsync(CredentialUserRegistrationDetails credentialUserRegistrationDetailsToCreate)
        {
            return this.CreateResponseAsync(credentialUserRegistrationDetailsToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{CredentialUserRegistrationDetails}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CredentialUserRegistrationDetails>> CreateResponseAsync(CredentialUserRegistrationDetails credentialUserRegistrationDetailsToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<CredentialUserRegistrationDetails>(credentialUserRegistrationDetailsToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{CredentialUserRegistrationDetails}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<CredentialUserRegistrationDetails>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{CredentialUserRegistrationDetails}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CredentialUserRegistrationDetails>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<CredentialUserRegistrationDetails>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="credentialUserRegistrationDetailsToUpdate">The CredentialUserRegistrationDetails to update.</param>
        /// <returns>The <see cref="GraphResponse{CredentialUserRegistrationDetails}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<CredentialUserRegistrationDetails>> UpdateResponseAsync(CredentialUserRegistrationDetails credentialUserRegistrationDetailsToUpdate)
        {
            return this.UpdateResponseAsync(credentialUserRegistrationDetailsToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CredentialUserRegistrationDetails}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CredentialUserRegistrationDetails>> UpdateResponseAsync(CredentialUserRegistrationDetails credentialUserRegistrationDetailsToUpdate, CancellationToken cancellationToken)
        {
			if (credentialUserRegistrationDetailsToUpdate.AdditionalData != null)
			{
				if (credentialUserRegistrationDetailsToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<CredentialUserRegistrationDetails>(credentialUserRegistrationDetailsToUpdate, cancellationToken).ConfigureAwait(false);
        }
