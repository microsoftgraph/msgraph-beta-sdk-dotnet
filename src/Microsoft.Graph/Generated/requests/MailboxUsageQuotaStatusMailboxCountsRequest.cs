...
namespace Microsoft.Graph
{
    ...
    public partial class MailboxUsageQuotaStatusMailboxCountsRequest : BaseRequest, IMailboxUsageQuotaStatusMailboxCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<MailboxUsageQuotaStatusMailboxCounts>> CreateResponseAsync(MailboxUsageQuotaStatusMailboxCounts mailboxUsageQuotaStatusMailboxCountsToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MailboxUsageQuotaStatusMailboxCounts}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MailboxUsageQuotaStatusMailboxCounts>> UpdateResponseAsync(MailboxUsageQuotaStatusMailboxCounts mailboxUsageQuotaStatusMailboxCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
