...
namespace Microsoft.Graph
{
    ...
    public partial class ApplicationSignInDetailedSummaryRequest : BaseRequest, IApplicationSignInDetailedSummaryRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<ApplicationSignInDetailedSummary> PutAsync(ApplicationSignInDetailedSummary applicationSignInDetailedSummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<ApplicationSignInDetailedSummary>> PutResponseAsync(ApplicationSignInDetailedSummary applicationSignInDetailedSummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ApplicationSignInDetailedSummary>(applicationSignInDetailedSummaryToUpdate, cancellationToken);
