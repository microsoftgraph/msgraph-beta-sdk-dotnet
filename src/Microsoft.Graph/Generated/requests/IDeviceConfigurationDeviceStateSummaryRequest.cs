...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceConfigurationDeviceStateSummaryRequest : IBaseRequest
    {
        ...
        /// <param name="deviceConfigurationDeviceStateSummaryToUpdate">The DeviceConfigurationDeviceStateSummary to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceConfigurationDeviceStateSummary}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationDeviceStateSummary>> UpdateResponseAsync(DeviceConfigurationDeviceStateSummary deviceConfigurationDeviceStateSummaryToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceConfigurationDeviceStateSummary}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationDeviceStateSummary>> UpdateResponseAsync(DeviceConfigurationDeviceStateSummary deviceConfigurationDeviceStateSummaryToUpdate, CancellationToken cancellationToken);
