...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceConfigurationDeviceStateSummaryRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DeviceConfigurationDeviceStateSummary> CreateAsync(DeviceConfigurationDeviceStateSummary deviceConfigurationDeviceStateSummaryToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationDeviceStateSummary>> CreateResponseAsync(DeviceConfigurationDeviceStateSummary deviceConfigurationDeviceStateSummaryToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<DeviceConfigurationDeviceStateSummary> UpdateAsync(DeviceConfigurationDeviceStateSummary deviceConfigurationDeviceStateSummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceConfigurationDeviceStateSummary}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationDeviceStateSummary>> UpdateResponseAsync(DeviceConfigurationDeviceStateSummary deviceConfigurationDeviceStateSummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<DeviceConfigurationDeviceStateSummary> PutAsync(DeviceConfigurationDeviceStateSummary deviceConfigurationDeviceStateSummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationDeviceStateSummary>> PutResponseAsync(DeviceConfigurationDeviceStateSummary deviceConfigurationDeviceStateSummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
