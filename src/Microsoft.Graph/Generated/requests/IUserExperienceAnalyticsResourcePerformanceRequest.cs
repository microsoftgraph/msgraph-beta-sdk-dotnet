...
namespace Microsoft.Graph
{
    ...
    public partial interface IUserExperienceAnalyticsResourcePerformanceRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<UserExperienceAnalyticsResourcePerformance> CreateAsync(UserExperienceAnalyticsResourcePerformance userExperienceAnalyticsResourcePerformanceToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsResourcePerformance>> CreateResponseAsync(UserExperienceAnalyticsResourcePerformance userExperienceAnalyticsResourcePerformanceToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<UserExperienceAnalyticsResourcePerformance> UpdateAsync(UserExperienceAnalyticsResourcePerformance userExperienceAnalyticsResourcePerformanceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserExperienceAnalyticsResourcePerformance}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsResourcePerformance>> UpdateResponseAsync(UserExperienceAnalyticsResourcePerformance userExperienceAnalyticsResourcePerformanceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<UserExperienceAnalyticsResourcePerformance> PutAsync(UserExperienceAnalyticsResourcePerformance userExperienceAnalyticsResourcePerformanceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsResourcePerformance>> PutResponseAsync(UserExperienceAnalyticsResourcePerformance userExperienceAnalyticsResourcePerformanceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
