...
namespace Microsoft.Graph
{
    ...
    public partial class IosUpdateConfigurationRequest : BaseRequest, IIosUpdateConfigurationRequest
    {
        ...
        /// <param name="iosUpdateConfigurationToUpdate">The IosUpdateConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{IosUpdateConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosUpdateConfiguration>> UpdateResponseAsync(IosUpdateConfiguration iosUpdateConfigurationToUpdate)
        {
            return this.UpdateResponseAsync(iosUpdateConfigurationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosUpdateConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosUpdateConfiguration>> UpdateResponseAsync(IosUpdateConfiguration iosUpdateConfigurationToUpdate, CancellationToken cancellationToken)
        {
			if (iosUpdateConfigurationToUpdate.AdditionalData != null)
			{
				if (iosUpdateConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
