...
namespace Microsoft.Graph
{
    ...
    public partial class InferenceClassificationOverrideRequest : BaseRequest, IInferenceClassificationOverrideRequest
    {
        ...
        /// <param name="inferenceClassificationOverrideToUpdate">The InferenceClassificationOverride to update.</param>
        /// <returns>The <see cref="GraphResponse{InferenceClassificationOverride}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<InferenceClassificationOverride>> UpdateResponseAsync(InferenceClassificationOverride inferenceClassificationOverrideToUpdate)
        {
            return this.UpdateResponseAsync(inferenceClassificationOverrideToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{InferenceClassificationOverride}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<InferenceClassificationOverride>> UpdateResponseAsync(InferenceClassificationOverride inferenceClassificationOverrideToUpdate, CancellationToken cancellationToken)
        {
			if (inferenceClassificationOverrideToUpdate.AdditionalData != null)
			{
				if (inferenceClassificationOverrideToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
