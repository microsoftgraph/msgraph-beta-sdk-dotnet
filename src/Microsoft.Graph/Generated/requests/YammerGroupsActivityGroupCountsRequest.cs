...
namespace Microsoft.Graph
{
    ...
    public partial class YammerGroupsActivityGroupCountsRequest : BaseRequest, IYammerGroupsActivityGroupCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<YammerGroupsActivityGroupCounts>> CreateResponseAsync(YammerGroupsActivityGroupCounts yammerGroupsActivityGroupCountsToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{YammerGroupsActivityGroupCounts}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<YammerGroupsActivityGroupCounts>> UpdateResponseAsync(YammerGroupsActivityGroupCounts yammerGroupsActivityGroupCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
