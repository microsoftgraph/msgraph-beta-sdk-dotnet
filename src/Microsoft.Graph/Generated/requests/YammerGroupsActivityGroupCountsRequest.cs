...
namespace Microsoft.Graph
{
    ...
    public partial class YammerGroupsActivityGroupCountsRequest : BaseRequest, IYammerGroupsActivityGroupCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<YammerGroupsActivityGroupCounts> CreateAsync(YammerGroupsActivityGroupCounts yammerGroupsActivityGroupCountsToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<YammerGroupsActivityGroupCounts>> CreateResponseAsync(YammerGroupsActivityGroupCounts yammerGroupsActivityGroupCountsToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<YammerGroupsActivityGroupCounts> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{YammerGroupsActivityGroupCounts}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<YammerGroupsActivityGroupCounts>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<YammerGroupsActivityGroupCounts> UpdateAsync(YammerGroupsActivityGroupCounts yammerGroupsActivityGroupCountsToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{YammerGroupsActivityGroupCounts}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<YammerGroupsActivityGroupCounts>> UpdateResponseAsync(YammerGroupsActivityGroupCounts yammerGroupsActivityGroupCountsToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<YammerGroupsActivityGroupCounts> PutAsync(YammerGroupsActivityGroupCounts yammerGroupsActivityGroupCountsToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="yammerGroupsActivityGroupCountsToUpdate">The YammerGroupsActivityGroupCounts object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{YammerGroupsActivityGroupCounts}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<YammerGroupsActivityGroupCounts>> PutResponseAsync(YammerGroupsActivityGroupCounts yammerGroupsActivityGroupCountsToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<YammerGroupsActivityGroupCounts>(yammerGroupsActivityGroupCountsToUpdate, cancellationToken);
