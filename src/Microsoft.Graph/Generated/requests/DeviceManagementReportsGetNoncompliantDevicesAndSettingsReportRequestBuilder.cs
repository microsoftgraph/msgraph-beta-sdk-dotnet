...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DeviceManagementReportsGetNoncompliantDevicesAndSettingsReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetNoncompliantDevicesAndSettingsReportRequest>, IDeviceManagementReportsGetNoncompliantDevicesAndSettingsReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetNoncompliantDevicesAndSettingsReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetNoncompliantDevicesAndSettingsReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetNoncompliantDevicesAndSettingsReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetNoncompliantDevicesAndSettingsReportRequest(functionUrl, this.Client, options);
