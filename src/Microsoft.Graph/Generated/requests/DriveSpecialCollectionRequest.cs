...
namespace Microsoft.Graph
{
    ...
    public partial class DriveSpecialCollectionRequest : BaseRequest, IDriveSpecialCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DriveSpecialCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.Get;
            return this.SendAsyncWithGraphResponse<DriveSpecialCollectionResponse>(null, cancellationToken);
        }
