...
namespace Microsoft.Graph
{
    ...
    public partial class DriveSpecialCollectionRequest : BaseRequest, IDriveSpecialCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DriveSpecialCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DriveSpecialCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DriveSpecialCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DriveSpecialCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
