...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidForWorkNineWorkEasConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AndroidForWorkNineWorkEasConfiguration> CreateAsync(AndroidForWorkNineWorkEasConfiguration androidForWorkNineWorkEasConfigurationToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkNineWorkEasConfiguration>> CreateResponseAsync(AndroidForWorkNineWorkEasConfiguration androidForWorkNineWorkEasConfigurationToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkNineWorkEasConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkNineWorkEasConfiguration>> CreateResponseAsync(AndroidForWorkNineWorkEasConfiguration androidForWorkNineWorkEasConfigurationToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="androidForWorkNineWorkEasConfigurationToUpdate">The AndroidForWorkNineWorkEasConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkNineWorkEasConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkNineWorkEasConfiguration>> UpdateResponseAsync(AndroidForWorkNineWorkEasConfiguration androidForWorkNineWorkEasConfigurationToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkNineWorkEasConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkNineWorkEasConfiguration>> UpdateResponseAsync(AndroidForWorkNineWorkEasConfiguration androidForWorkNineWorkEasConfigurationToUpdate, CancellationToken cancellationToken);
