...
namespace Microsoft.Graph
{
    ...
    public partial class GroupPolicyDefinitionFileDefinitionsCollectionReferencesRequest : BaseRequest, IGroupPolicyDefinitionFileDefinitionsCollectionReferencesRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(GroupPolicyDefinition groupPolicyDefinition)
        {
            return this.AddResponseAsync(groupPolicyDefinition, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
        public System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(GroupPolicyDefinition groupPolicyDefinition, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
