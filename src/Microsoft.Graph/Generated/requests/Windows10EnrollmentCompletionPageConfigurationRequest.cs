...
namespace Microsoft.Graph
{
    ...
    public partial class Windows10EnrollmentCompletionPageConfigurationRequest : BaseRequest, IWindows10EnrollmentCompletionPageConfigurationRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<Windows10EnrollmentCompletionPageConfiguration>> CreateResponseAsync(Windows10EnrollmentCompletionPageConfiguration windows10EnrollmentCompletionPageConfigurationToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Windows10EnrollmentCompletionPageConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Windows10EnrollmentCompletionPageConfiguration>> UpdateResponseAsync(Windows10EnrollmentCompletionPageConfiguration windows10EnrollmentCompletionPageConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
