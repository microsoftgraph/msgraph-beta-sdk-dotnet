...
namespace Microsoft.Graph
{
    ...
    public partial class Windows10EnrollmentCompletionPageConfigurationRequest : BaseRequest, IWindows10EnrollmentCompletionPageConfigurationRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<Windows10EnrollmentCompletionPageConfiguration> PutAsync(Windows10EnrollmentCompletionPageConfiguration windows10EnrollmentCompletionPageConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows10EnrollmentCompletionPageConfiguration>> PutResponseAsync(Windows10EnrollmentCompletionPageConfiguration windows10EnrollmentCompletionPageConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<Windows10EnrollmentCompletionPageConfiguration>(windows10EnrollmentCompletionPageConfigurationToUpdate, cancellationToken);
