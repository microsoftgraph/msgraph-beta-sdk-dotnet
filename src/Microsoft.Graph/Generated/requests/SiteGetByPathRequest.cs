...
namespace Microsoft.Graph
{
    ...
    public partial class SiteGetByPathRequest : BaseRequest, ISiteGetByPathRequest
    {
        ...
        /// <param name="site">The Site object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<Site>> PatchResponseAsync(Site site, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="site">The Site object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<Site>> PutResponseAsync(Site site, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<Site>(site, cancellationToken);
        }
