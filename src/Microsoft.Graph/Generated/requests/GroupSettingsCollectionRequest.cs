...
namespace Microsoft.Graph
{
    ...
    public partial class GroupSettingsCollectionRequest : BaseRequest, IGroupSettingsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<GroupSettingsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<GroupSettingsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
