...
namespace Microsoft.Graph
{
    ...
    public partial class GroupSettingsCollectionRequest : BaseRequest, IGroupSettingsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<DirectorySetting> AddAsync(DirectorySetting directorySetting, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DirectorySetting>> AddResponseAsync(DirectorySetting directorySetting, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<DirectorySetting>(directorySetting, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<IGroupSettingsCollectionPage> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary>
        /// Gets the collection page and returns a <see cref="GraphResponse{GroupSettingsCollectionResponse}"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupSettingsCollectionResponse}"/> object.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupSettingsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<GroupSettingsCollectionResponse>(null, cancellationToken);
        }
