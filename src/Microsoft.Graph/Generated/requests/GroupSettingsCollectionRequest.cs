...
namespace Microsoft.Graph
{
    ...
    public partial class GroupSettingsCollectionRequest : BaseRequest, IGroupSettingsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<GroupSettingsCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupSettingsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupSettingsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
