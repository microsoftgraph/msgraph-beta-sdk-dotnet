...
namespace Microsoft.Graph
{
    ...
    public partial class ExactMatchLookupJobRequest : BaseRequest, IExactMatchLookupJobRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ExactMatchLookupJob>> CreateResponseAsync(ExactMatchLookupJob exactMatchLookupJobToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<ExactMatchLookupJob> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ExactMatchLookupJob}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ExactMatchLookupJob>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ExactMatchLookupJob}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ExactMatchLookupJob>> UpdateResponseAsync(ExactMatchLookupJob exactMatchLookupJobToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<ExactMatchLookupJob> PutAsync(ExactMatchLookupJob exactMatchLookupJobToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<ExactMatchLookupJob>> PutResponseAsync(ExactMatchLookupJob exactMatchLookupJobToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ExactMatchLookupJob>(exactMatchLookupJobToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(ExactMatchLookupJob exactMatchLookupJobToInitialize)
        {
            ...
            if (exactMatchLookupJobToInitialize != null && exactMatchLookupJobToInitialize.AdditionalData != null)
            {
                ...
                if (exactMatchLookupJobToInitialize.MatchingRows != null && exactMatchLookupJobToInitialize.MatchingRows.CurrentPage != null)
                {
                    ...
                    if(exactMatchLookupJobToInitialize.AdditionalData.TryGetValue("matchingRows@odata.nextLink", out var nextPageLink))
                    {
