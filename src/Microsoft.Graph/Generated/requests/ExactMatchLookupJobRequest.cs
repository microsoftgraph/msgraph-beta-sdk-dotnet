...
namespace Microsoft.Graph
{
    ...
    public partial class ExactMatchLookupJobRequest : BaseRequest, IExactMatchLookupJobRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ExactMatchLookupJob>> CreateResponseAsync(ExactMatchLookupJob exactMatchLookupJobToCreate)
        {
            return this.CreateResponseAsync(exactMatchLookupJobToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ExactMatchLookupJob}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ExactMatchLookupJob>> CreateResponseAsync(ExactMatchLookupJob exactMatchLookupJobToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="exactMatchLookupJobToUpdate">The ExactMatchLookupJob to update.</param>
        /// <returns>The <see cref="GraphResponse{ExactMatchLookupJob}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ExactMatchLookupJob>> UpdateResponseAsync(ExactMatchLookupJob exactMatchLookupJobToUpdate)
        {
            return this.UpdateResponseAsync(exactMatchLookupJobToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ExactMatchLookupJob}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ExactMatchLookupJob>> UpdateResponseAsync(ExactMatchLookupJob exactMatchLookupJobToUpdate, CancellationToken cancellationToken)
        {
			if (exactMatchLookupJobToUpdate.AdditionalData != null)
			{
				if (exactMatchLookupJobToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
