...
namespace Microsoft.Graph
{
    ...
    public partial class SecureScoreControlProfileRequest : BaseRequest, ISecureScoreControlProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<SecureScoreControlProfile> CreateAsync(SecureScoreControlProfile secureScoreControlProfileToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SecureScoreControlProfile>> CreateResponseAsync(SecureScoreControlProfile secureScoreControlProfileToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<SecureScoreControlProfile>(secureScoreControlProfileToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<SecureScoreControlProfile> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SecureScoreControlProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SecureScoreControlProfile>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<SecureScoreControlProfile>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<SecureScoreControlProfile> UpdateAsync(SecureScoreControlProfile secureScoreControlProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SecureScoreControlProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SecureScoreControlProfile>> UpdateResponseAsync(SecureScoreControlProfile secureScoreControlProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<SecureScoreControlProfile>(secureScoreControlProfileToUpdate, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<SecureScoreControlProfile> PutAsync(SecureScoreControlProfile secureScoreControlProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="secureScoreControlProfileToUpdate">The SecureScoreControlProfile object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{SecureScoreControlProfile}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SecureScoreControlProfile>> PutResponseAsync(SecureScoreControlProfile secureScoreControlProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SecureScoreControlProfile>(secureScoreControlProfileToUpdate, cancellationToken);
