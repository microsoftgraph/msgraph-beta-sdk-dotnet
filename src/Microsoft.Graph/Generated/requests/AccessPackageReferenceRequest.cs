...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class AccessPackageReferenceRequest : BaseRequest, IAccessPackageReferenceRequest
    {
        /// <summary>
        ...
        public AccessPackageReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified AccessPackage reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified AccessPackage reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The AccessPackage reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
