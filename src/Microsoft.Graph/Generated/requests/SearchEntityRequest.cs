...
namespace Microsoft.Graph
{
    ...
    public partial class SearchEntityRequest : BaseRequest, ISearchEntityRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<SearchEntity> PutAsync(SearchEntity searchEntityToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="searchEntityToUpdate">The SearchEntity object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{SearchEntity}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SearchEntity>> PutResponseAsync(SearchEntity searchEntityToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SearchEntity>(searchEntityToUpdate, cancellationToken);
