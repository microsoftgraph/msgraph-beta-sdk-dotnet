...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class UserInstallStateSummaryRequest : BaseRequest, IUserInstallStateSummaryRequest
    {
        /// <summary>
        ...
        public UserInstallStateSummaryRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public async System.Threading.Tasks.Task<UserInstallStateSummary> CreateAsync(UserInstallStateSummary userInstallStateSummaryToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UserInstallStateSummary>> CreateResponseAsync(UserInstallStateSummary userInstallStateSummaryToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<UserInstallStateSummary> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserInstallStateSummary}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserInstallStateSummary>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<UserInstallStateSummary> UpdateAsync(UserInstallStateSummary userInstallStateSummaryToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserInstallStateSummary}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserInstallStateSummary>> UpdateResponseAsync(UserInstallStateSummary userInstallStateSummaryToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<UserInstallStateSummary> PutAsync(UserInstallStateSummary userInstallStateSummaryToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<UserInstallStateSummary>> PutResponseAsync(UserInstallStateSummary userInstallStateSummaryToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<UserInstallStateSummary>(userInstallStateSummaryToUpdate, cancellationToken);
        ...
        public IUserInstallStateSummaryRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IUserInstallStateSummaryRequest Expand(Expression<Func<UserInstallStateSummary, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IUserInstallStateSummaryRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IUserInstallStateSummaryRequest Select(Expression<Func<UserInstallStateSummary, object>> selectExpression)
        {
        ...
        /// </summary>
        /// <param name="userInstallStateSummaryToInitialize">The <see cref="UserInstallStateSummary"/> with the collection properties to initialize.</param>
