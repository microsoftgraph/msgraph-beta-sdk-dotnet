...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetSkypeForBusinessActivityCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessActivityCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="skypeforbusinessactivitycounts">The SkypeForBusinessActivityCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessActivityCountsCollectionResponse>> PatchResponseAsync(SkypeForBusinessActivityCounts skypeforbusinessactivitycounts, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="skypeforbusinessactivitycounts">The SkypeForBusinessActivityCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessActivityCountsCollectionResponse>> PutResponseAsync(SkypeForBusinessActivityCounts skypeforbusinessactivitycounts, CancellationToken cancellationToken = default(CancellationToken));
