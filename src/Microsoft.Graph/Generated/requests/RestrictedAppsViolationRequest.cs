...
namespace Microsoft.Graph
{
    ...
    public partial class RestrictedAppsViolationRequest : BaseRequest, IRestrictedAppsViolationRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<RestrictedAppsViolation> PutAsync(RestrictedAppsViolation restrictedAppsViolationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<RestrictedAppsViolation>> PutResponseAsync(RestrictedAppsViolation restrictedAppsViolationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<RestrictedAppsViolation>(restrictedAppsViolationToUpdate, cancellationToken);
