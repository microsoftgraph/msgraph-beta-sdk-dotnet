...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetCompliancePoliciesReportForDeviceRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetCompliancePoliciesReportForDeviceRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetCompliancePoliciesReportForDeviceRequest>, IDeviceManagementReportsGetCompliancePoliciesReportForDeviceRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetCompliancePoliciesReportForDeviceRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetCompliancePoliciesReportForDeviceRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetCompliancePoliciesReportForDeviceRequest(functionUrl, this.Client, options);
