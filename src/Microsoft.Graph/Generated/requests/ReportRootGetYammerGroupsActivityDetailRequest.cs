...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetYammerGroupsActivityDetailRequest : BaseRequest, IReportRootGetYammerGroupsActivityDetailRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerGroupsActivityDetailCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="yammergroupsactivitydetail">The YammerGroupsActivityDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerGroupsActivityDetailCollectionResponse>> PatchResponseAsync(YammerGroupsActivityDetail yammergroupsactivitydetail, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="yammergroupsactivitydetail">The YammerGroupsActivityDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerGroupsActivityDetailCollectionResponse>> PutResponseAsync(YammerGroupsActivityDetail yammergroupsactivitydetail, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetYammerGroupsActivityDetailCollectionResponse>(yammergroupsactivitydetail, cancellationToken);
        }
