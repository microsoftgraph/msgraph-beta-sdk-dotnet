...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IConnectedOrganizationInternalSponsorsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IConnectedOrganizationInternalSponsorsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IConnectedOrganizationInternalSponsorsCollectionRequest Request(IEnumerable<Option> options);
