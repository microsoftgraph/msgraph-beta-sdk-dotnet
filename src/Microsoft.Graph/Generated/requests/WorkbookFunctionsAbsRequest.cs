...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsAbsRequest : BaseRequest, IWorkbookFunctionsAbsRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsAbsRequest.
        /// </summary>
        public WorkbookFunctionsAbsRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsAbsRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsAbsRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsAbsRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsAbsRequest Select(string value)
        {
