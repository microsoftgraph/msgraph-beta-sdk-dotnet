...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IDeviceShellScriptDeviceRunStatesCollectionRequestBuilder.
    /// </summary>
    public partial interface IDeviceShellScriptDeviceRunStatesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IDeviceShellScriptDeviceRunStatesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IDeviceShellScriptDeviceRunStatesCollectionRequest Request(IEnumerable<Option> options);
