...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidForWorkEasEmailProfileBaseRequest : BaseRequest, IAndroidForWorkEasEmailProfileBaseRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEasEmailProfileBase>> CreateResponseAsync(AndroidForWorkEasEmailProfileBase androidForWorkEasEmailProfileBaseToCreate)
        {
            return this.CreateResponseAsync(androidForWorkEasEmailProfileBaseToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkEasEmailProfileBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEasEmailProfileBase>> CreateResponseAsync(AndroidForWorkEasEmailProfileBase androidForWorkEasEmailProfileBaseToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<AndroidForWorkEasEmailProfileBase>(androidForWorkEasEmailProfileBaseToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkEasEmailProfileBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEasEmailProfileBase>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkEasEmailProfileBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEasEmailProfileBase>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<AndroidForWorkEasEmailProfileBase>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="androidForWorkEasEmailProfileBaseToUpdate">The AndroidForWorkEasEmailProfileBase to update.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkEasEmailProfileBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEasEmailProfileBase>> UpdateResponseAsync(AndroidForWorkEasEmailProfileBase androidForWorkEasEmailProfileBaseToUpdate)
        {
            return this.UpdateResponseAsync(androidForWorkEasEmailProfileBaseToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkEasEmailProfileBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEasEmailProfileBase>> UpdateResponseAsync(AndroidForWorkEasEmailProfileBase androidForWorkEasEmailProfileBaseToUpdate, CancellationToken cancellationToken)
        {
			if (androidForWorkEasEmailProfileBaseToUpdate.AdditionalData != null)
			{
				if (androidForWorkEasEmailProfileBaseToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<AndroidForWorkEasEmailProfileBase>(androidForWorkEasEmailProfileBaseToUpdate, cancellationToken).ConfigureAwait(false);
        }
