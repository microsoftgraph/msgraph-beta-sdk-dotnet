...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidForWorkEasEmailProfileBaseRequest : BaseRequest, IAndroidForWorkEasEmailProfileBaseRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEasEmailProfileBase>> CreateResponseAsync(AndroidForWorkEasEmailProfileBase androidForWorkEasEmailProfileBaseToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkEasEmailProfileBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEasEmailProfileBase>> UpdateResponseAsync(AndroidForWorkEasEmailProfileBase androidForWorkEasEmailProfileBaseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
