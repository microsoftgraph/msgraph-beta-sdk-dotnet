...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidForWorkEasEmailProfileBaseRequest : BaseRequest, IAndroidForWorkEasEmailProfileBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<AndroidForWorkEasEmailProfileBase> PutAsync(AndroidForWorkEasEmailProfileBase androidForWorkEasEmailProfileBaseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEasEmailProfileBase>> PutResponseAsync(AndroidForWorkEasEmailProfileBase androidForWorkEasEmailProfileBaseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<AndroidForWorkEasEmailProfileBase>(androidForWorkEasEmailProfileBaseToUpdate, cancellationToken);
