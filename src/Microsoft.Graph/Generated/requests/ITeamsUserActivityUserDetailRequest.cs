...
namespace Microsoft.Graph
{
    ...
    public partial interface ITeamsUserActivityUserDetailRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<TeamsUserActivityUserDetail> CreateAsync(TeamsUserActivityUserDetail teamsUserActivityUserDetailToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<TeamsUserActivityUserDetail>> CreateResponseAsync(TeamsUserActivityUserDetail teamsUserActivityUserDetailToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TeamsUserActivityUserDetail}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<TeamsUserActivityUserDetail>> CreateResponseAsync(TeamsUserActivityUserDetail teamsUserActivityUserDetailToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="teamsUserActivityUserDetailToUpdate">The TeamsUserActivityUserDetail to update.</param>
        /// <returns>The <see cref="GraphResponse{TeamsUserActivityUserDetail}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<TeamsUserActivityUserDetail>> UpdateResponseAsync(TeamsUserActivityUserDetail teamsUserActivityUserDetailToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{TeamsUserActivityUserDetail}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<TeamsUserActivityUserDetail>> UpdateResponseAsync(TeamsUserActivityUserDetail teamsUserActivityUserDetailToUpdate, CancellationToken cancellationToken);
