...
namespace Microsoft.Graph
{
    ...
    public partial class OutlookTaskGroupRequest : BaseRequest, IOutlookTaskGroupRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<OutlookTaskGroup>> CreateResponseAsync(OutlookTaskGroup outlookTaskGroupToCreate)
        {
            return this.CreateResponseAsync(outlookTaskGroupToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OutlookTaskGroup}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OutlookTaskGroup>> CreateResponseAsync(OutlookTaskGroup outlookTaskGroupToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<OutlookTaskGroup>(outlookTaskGroupToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{OutlookTaskGroup}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OutlookTaskGroup>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OutlookTaskGroup}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OutlookTaskGroup>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<OutlookTaskGroup>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="outlookTaskGroupToUpdate">The OutlookTaskGroup to update.</param>
        /// <returns>The <see cref="GraphResponse{OutlookTaskGroup}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OutlookTaskGroup>> UpdateResponseAsync(OutlookTaskGroup outlookTaskGroupToUpdate)
        {
            return this.UpdateResponseAsync(outlookTaskGroupToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{OutlookTaskGroup}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OutlookTaskGroup>> UpdateResponseAsync(OutlookTaskGroup outlookTaskGroupToUpdate, CancellationToken cancellationToken)
        {
			if (outlookTaskGroupToUpdate.AdditionalData != null)
			{
				if (outlookTaskGroupToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<OutlookTaskGroup>(outlookTaskGroupToUpdate, cancellationToken).ConfigureAwait(false);
        }
