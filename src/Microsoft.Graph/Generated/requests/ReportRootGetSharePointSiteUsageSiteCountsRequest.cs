...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetSharePointSiteUsageSiteCountsRequest : BaseRequest, IReportRootGetSharePointSiteUsageSiteCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointSiteUsageSiteCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSharePointSiteUsageSiteCountsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="sharepointsiteusagesitecounts">The SharePointSiteUsageSiteCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointSiteUsageSiteCountsCollectionResponse>> PatchResponseAsync(SharePointSiteUsageSiteCounts sharepointsiteusagesitecounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSharePointSiteUsageSiteCountsCollectionResponse>(sharepointsiteusagesitecounts, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="sharepointsiteusagesitecounts">The SharePointSiteUsageSiteCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointSiteUsageSiteCountsCollectionResponse>> PutResponseAsync(SharePointSiteUsageSiteCounts sharepointsiteusagesitecounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSharePointSiteUsageSiteCountsCollectionResponse>(sharepointsiteusagesitecounts, cancellationToken).ConfigureAwait(false);
        }
