...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest : BaseRequest, IReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="skypeforbusinessdeviceusagedistributionusercounts">The SkypeForBusinessDeviceUsageDistributionUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsCollectionResponse>> PatchResponseAsync(SkypeForBusinessDeviceUsageDistributionUserCounts skypeforbusinessdeviceusagedistributionusercounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="skypeforbusinessdeviceusagedistributionusercounts">The SkypeForBusinessDeviceUsageDistributionUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsCollectionResponse>> PutResponseAsync(SkypeForBusinessDeviceUsageDistributionUserCounts skypeforbusinessdeviceusagedistributionusercounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsCollectionResponse>(skypeforbusinessdeviceusagedistributionusercounts, cancellationToken);
        }
