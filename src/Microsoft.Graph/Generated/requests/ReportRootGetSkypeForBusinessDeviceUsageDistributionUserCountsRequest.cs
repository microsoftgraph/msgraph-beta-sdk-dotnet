...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest : BaseRequest, IReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="skypeforbusinessdeviceusagedistributionusercounts">The SkypeForBusinessDeviceUsageDistributionUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsCollectionResponse>> PatchResponseAsync(SkypeForBusinessDeviceUsageDistributionUserCounts skypeforbusinessdeviceusagedistributionusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsCollectionResponse>(skypeforbusinessdeviceusagedistributionusercounts, cancellationToken).ConfigureAwait(false);
        }
