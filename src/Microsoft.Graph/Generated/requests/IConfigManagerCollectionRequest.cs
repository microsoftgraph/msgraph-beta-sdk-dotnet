...
namespace Microsoft.Graph
{
    ...
    public partial interface IConfigManagerCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ConfigManagerCollection> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ConfigManagerCollection}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ConfigManagerCollection>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<ConfigManagerCollection> PutAsync(ConfigManagerCollection configManagerCollectionToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<ConfigManagerCollection>> PutResponseAsync(ConfigManagerCollection configManagerCollectionToUpdate, CancellationToken cancellationToken = default(CancellationToken));
