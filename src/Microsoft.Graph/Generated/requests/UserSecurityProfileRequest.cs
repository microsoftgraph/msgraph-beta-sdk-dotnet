...
namespace Microsoft.Graph
{
    ...
    public partial class UserSecurityProfileRequest : BaseRequest, IUserSecurityProfileRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UserSecurityProfile>> CreateResponseAsync(UserSecurityProfile userSecurityProfileToCreate)
        {
            return this.CreateResponseAsync(userSecurityProfileToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserSecurityProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserSecurityProfile>> CreateResponseAsync(UserSecurityProfile userSecurityProfileToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<UserSecurityProfile>(userSecurityProfileToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{UserSecurityProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserSecurityProfile>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserSecurityProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserSecurityProfile>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<UserSecurityProfile>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="userSecurityProfileToUpdate">The UserSecurityProfile to update.</param>
        /// <returns>The <see cref="GraphResponse{UserSecurityProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserSecurityProfile>> UpdateResponseAsync(UserSecurityProfile userSecurityProfileToUpdate)
        {
            return this.UpdateResponseAsync(userSecurityProfileToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserSecurityProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserSecurityProfile>> UpdateResponseAsync(UserSecurityProfile userSecurityProfileToUpdate, CancellationToken cancellationToken)
        {
			if (userSecurityProfileToUpdate.AdditionalData != null)
			{
				if (userSecurityProfileToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<UserSecurityProfile>(userSecurityProfileToUpdate, cancellationToken).ConfigureAwait(false);
        }
