...
namespace Microsoft.Graph
{
    ...
    public partial class UserSecurityProfileRequest : BaseRequest, IUserSecurityProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<UserSecurityProfile>> CreateResponseAsync(UserSecurityProfile userSecurityProfileToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserSecurityProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserSecurityProfile>> UpdateResponseAsync(UserSecurityProfile userSecurityProfileToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
