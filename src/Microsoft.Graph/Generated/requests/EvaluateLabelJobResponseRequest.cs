...
namespace Microsoft.Graph
{
    ...
    public partial class EvaluateLabelJobResponseRequest : BaseRequest, IEvaluateLabelJobResponseRequest
    {
        ...
        public async System.Threading.Tasks.Task<EvaluateLabelJobResponse> CreateAsync(EvaluateLabelJobResponse evaluateLabelJobResponseToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<EvaluateLabelJobResponse>> CreateResponseAsync(EvaluateLabelJobResponse evaluateLabelJobResponseToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<EvaluateLabelJobResponse> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EvaluateLabelJobResponse}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<EvaluateLabelJobResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<EvaluateLabelJobResponse> UpdateAsync(EvaluateLabelJobResponse evaluateLabelJobResponseToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{EvaluateLabelJobResponse}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<EvaluateLabelJobResponse>> UpdateResponseAsync(EvaluateLabelJobResponse evaluateLabelJobResponseToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<EvaluateLabelJobResponse> PutAsync(EvaluateLabelJobResponse evaluateLabelJobResponseToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<EvaluateLabelJobResponse>> PutResponseAsync(EvaluateLabelJobResponse evaluateLabelJobResponseToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<EvaluateLabelJobResponse>(evaluateLabelJobResponseToUpdate, cancellationToken);
