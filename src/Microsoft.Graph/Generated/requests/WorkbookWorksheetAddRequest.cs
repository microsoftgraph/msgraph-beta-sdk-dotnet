...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookWorksheetAddRequest : BaseRequest, IWorkbookWorksheetAddRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookWorksheet>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<WorkbookWorksheet>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
