...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DataSourceRequest : BaseRequest, IDataSourceRequest
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<DataSource> UpdateAsync(DataSource dataSourceToUpdate, CancellationToken cancellationToken)
        {
			...
			{
				if (dataSourceToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					dataSourceToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, dataSourceToUpdate.GetType().Name)
						});
				}
			}
            if (dataSourceToUpdate.AdditionalData != null)
