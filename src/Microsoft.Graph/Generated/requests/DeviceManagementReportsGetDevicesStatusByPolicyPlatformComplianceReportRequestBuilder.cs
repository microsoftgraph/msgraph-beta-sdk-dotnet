...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetDevicesStatusByPolicyPlatformComplianceReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetDevicesStatusByPolicyPlatformComplianceReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetDevicesStatusByPolicyPlatformComplianceReportRequest>, IDeviceManagementReportsGetDevicesStatusByPolicyPlatformComplianceReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetDevicesStatusByPolicyPlatformComplianceReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetDevicesStatusByPolicyPlatformComplianceReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IDeviceManagementReportsGetDevicesStatusByPolicyPlatformComplianceReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetDevicesStatusByPolicyPlatformComplianceReportRequest(functionUrl, this.Client, options);
