...
namespace Microsoft.Graph
{
    ...
    public partial interface IWorkbookFilterRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<WorkbookFilter> PutAsync(WorkbookFilter workbookFilterToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<WorkbookFilter>> PutResponseAsync(WorkbookFilter workbookFilterToUpdate, CancellationToken cancellationToken = default(CancellationToken));
