...
namespace Microsoft.Graph
{
    ...
    public partial interface IWorkbookFilterRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WorkbookFilter> CreateAsync(WorkbookFilter workbookFilterToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<WorkbookFilter>> CreateResponseAsync(WorkbookFilter workbookFilterToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<WorkbookFilter> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookFilter}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookFilter>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<WorkbookFilter> UpdateAsync(WorkbookFilter workbookFilterToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookFilter}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookFilter>> UpdateResponseAsync(WorkbookFilter workbookFilterToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<WorkbookFilter> PutAsync(WorkbookFilter workbookFilterToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="workbookFilterToUpdate">The WorkbookFilter object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{WorkbookFilter}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookFilter>> PutResponseAsync(WorkbookFilter workbookFilterToUpdate, CancellationToken cancellationToken = default);
