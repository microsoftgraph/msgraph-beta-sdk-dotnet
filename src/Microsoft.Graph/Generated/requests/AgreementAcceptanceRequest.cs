...
namespace Microsoft.Graph
{
    ...
    public partial class AgreementAcceptanceRequest : BaseRequest, IAgreementAcceptanceRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AgreementAcceptance>> CreateResponseAsync(AgreementAcceptance agreementAcceptanceToCreate)
        {
            return this.CreateResponseAsync(agreementAcceptanceToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AgreementAcceptance}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AgreementAcceptance>> CreateResponseAsync(AgreementAcceptance agreementAcceptanceToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<AgreementAcceptance>(agreementAcceptanceToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AgreementAcceptance}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AgreementAcceptance>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AgreementAcceptance}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AgreementAcceptance>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<AgreementAcceptance>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="agreementAcceptanceToUpdate">The AgreementAcceptance to update.</param>
        /// <returns>The <see cref="GraphResponse{AgreementAcceptance}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AgreementAcceptance>> UpdateResponseAsync(AgreementAcceptance agreementAcceptanceToUpdate)
        {
            return this.UpdateResponseAsync(agreementAcceptanceToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AgreementAcceptance}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AgreementAcceptance>> UpdateResponseAsync(AgreementAcceptance agreementAcceptanceToUpdate, CancellationToken cancellationToken)
        {
			if (agreementAcceptanceToUpdate.AdditionalData != null)
			{
				if (agreementAcceptanceToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<AgreementAcceptance>(agreementAcceptanceToUpdate, cancellationToken).ConfigureAwait(false);
        }
