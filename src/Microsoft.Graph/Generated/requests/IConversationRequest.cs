...
namespace Microsoft.Graph
{
    ...
    public partial interface IConversationRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<Conversation> PutAsync(Conversation conversationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<Conversation>> PutResponseAsync(Conversation conversationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
