...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IAuthenticationStrengthRootPoliciesCollectionRequestBuilder.
    /// </summary>
    public partial interface IAuthenticationStrengthRootPoliciesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IAuthenticationStrengthRootPoliciesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IAuthenticationStrengthRootPoliciesCollectionRequest Request(IEnumerable<Option> options);
