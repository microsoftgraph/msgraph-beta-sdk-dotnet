...
namespace Microsoft.Graph
{
    ...
    public partial interface ISecurityActionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SecurityAction> CreateAsync(SecurityAction securityActionToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<SecurityAction>> CreateResponseAsync(SecurityAction securityActionToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SecurityAction}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SecurityAction>> CreateResponseAsync(SecurityAction securityActionToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{SecurityAction}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SecurityAction>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SecurityAction}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SecurityAction>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="securityActionToUpdate">The SecurityAction to update.</param>
        /// <returns>The <see cref="GraphResponse{SecurityAction}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SecurityAction>> UpdateResponseAsync(SecurityAction securityActionToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SecurityAction}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SecurityAction>> UpdateResponseAsync(SecurityAction securityActionToUpdate, CancellationToken cancellationToken);
