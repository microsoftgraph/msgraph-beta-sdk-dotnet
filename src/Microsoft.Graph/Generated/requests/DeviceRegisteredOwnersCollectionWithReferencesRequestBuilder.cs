...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DeviceRegisteredOwnersCollectionWithReferencesRequestBuilder : BaseRequestBuilder, IDeviceRegisteredOwnersCollectionWithReferencesRequestBuilder
    {
        ...
        /// <returns>The built request.</returns>
        public IDeviceRegisteredOwnersCollectionWithReferencesRequest Request(IEnumerable<Option> options)
        {
        ...
        public IDeviceRegisteredOwnersCollectionReferencesRequestBuilder References
        {
            get
            {
                return new DeviceRegisteredOwnersCollectionReferencesRequestBuilder(this.AppendSegmentToRequestUrl("$ref"), this.Client);
            }
        }
