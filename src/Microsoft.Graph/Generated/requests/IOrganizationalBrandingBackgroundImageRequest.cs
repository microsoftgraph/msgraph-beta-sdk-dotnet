...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IOrganizationalBrandingBackgroundImageRequest.
    /// </summary>
    public partial interface IOrganizationalBrandingBackgroundImageRequest : IBaseRequest
    {
        /// <summary>
        /// Gets the stream.
        /// </summary>
        ...
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream backgroundImage) where T : OrganizationalBranding;
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream backgroundImage, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBranding;
