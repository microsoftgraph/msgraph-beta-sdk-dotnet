...
namespace Microsoft.Graph
{
    ...
    public partial interface IManagedAppRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ManagedApp> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ManagedApp}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ManagedApp>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<ManagedApp> PutAsync(ManagedApp managedAppToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<ManagedApp>> PutResponseAsync(ManagedApp managedAppToUpdate, CancellationToken cancellationToken = default(CancellationToken));
