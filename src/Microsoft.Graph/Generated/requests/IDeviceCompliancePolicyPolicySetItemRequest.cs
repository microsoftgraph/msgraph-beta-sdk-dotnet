...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceCompliancePolicyPolicySetItemRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DeviceCompliancePolicyPolicySetItem> CreateAsync(DeviceCompliancePolicyPolicySetItem deviceCompliancePolicyPolicySetItemToCreate);
        ...
        /// <returns>The created DeviceCompliancePolicyPolicySetItem.</returns>
        System.Threading.Tasks.Task<DeviceCompliancePolicyPolicySetItem> CreateAsync(DeviceCompliancePolicyPolicySetItem deviceCompliancePolicyPolicySetItemToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceCompliancePolicyPolicySetItem>> CreateResponseAsync(DeviceCompliancePolicyPolicySetItem deviceCompliancePolicyPolicySetItemToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceCompliancePolicyPolicySetItem}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceCompliancePolicyPolicySetItem>> CreateResponseAsync(DeviceCompliancePolicyPolicySetItem deviceCompliancePolicyPolicySetItemToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<DeviceCompliancePolicyPolicySetItem> UpdateAsync(DeviceCompliancePolicyPolicySetItem deviceCompliancePolicyPolicySetItemToUpdate);
        ...
        /// <returns>The updated DeviceCompliancePolicyPolicySetItem.</returns>
        System.Threading.Tasks.Task<DeviceCompliancePolicyPolicySetItem> UpdateAsync(DeviceCompliancePolicyPolicySetItem deviceCompliancePolicyPolicySetItemToUpdate, CancellationToken cancellationToken);
        ...
        /// <param name="deviceCompliancePolicyPolicySetItemToUpdate">The DeviceCompliancePolicyPolicySetItem to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceCompliancePolicyPolicySetItem}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceCompliancePolicyPolicySetItem>> UpdateResponseAsync(DeviceCompliancePolicyPolicySetItem deviceCompliancePolicyPolicySetItemToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceCompliancePolicyPolicySetItem}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceCompliancePolicyPolicySetItem>> UpdateResponseAsync(DeviceCompliancePolicyPolicySetItem deviceCompliancePolicyPolicySetItemToUpdate, CancellationToken cancellationToken);
