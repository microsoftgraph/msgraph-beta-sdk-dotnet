...
namespace Microsoft.Graph
{
    ...
    public partial class MacOsVppAppAssignedLicenseRequest : BaseRequest, IMacOsVppAppAssignedLicenseRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MacOsVppAppAssignedLicense>> CreateResponseAsync(MacOsVppAppAssignedLicense macOsVppAppAssignedLicenseToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<MacOsVppAppAssignedLicense>(macOsVppAppAssignedLicenseToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<MacOsVppAppAssignedLicense> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MacOsVppAppAssignedLicense}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MacOsVppAppAssignedLicense>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<MacOsVppAppAssignedLicense>(null, cancellationToken);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MacOsVppAppAssignedLicense}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MacOsVppAppAssignedLicense>> UpdateResponseAsync(MacOsVppAppAssignedLicense macOsVppAppAssignedLicenseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<MacOsVppAppAssignedLicense>(macOsVppAppAssignedLicenseToUpdate, cancellationToken);
        }

        /// <summary>
        /// Updates the specified MacOsVppAppAssignedLicense using PUT.
        /// </summary>
        /// <param name="macOsVppAppAssignedLicenseToUpdate">The MacOsVppAppAssignedLicense object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<MacOsVppAppAssignedLicense> PutAsync(MacOsVppAppAssignedLicense macOsVppAppAssignedLicenseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <summary>
        /// Updates the specified MacOsVppAppAssignedLicense using PUT and returns a <see cref="GraphResponse{MacOsVppAppAssignedLicense}"/> object.
        /// </summary>
        /// <param name="macOsVppAppAssignedLicenseToUpdate">The MacOsVppAppAssignedLicense object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{MacOsVppAppAssignedLicense}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MacOsVppAppAssignedLicense>> PutResponseAsync(MacOsVppAppAssignedLicense macOsVppAppAssignedLicenseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<MacOsVppAppAssignedLicense>(macOsVppAppAssignedLicenseToUpdate, cancellationToken);
