...
namespace Microsoft.Graph
{
    ...
    public partial class AuditLogRootRequest : BaseRequest, IAuditLogRootRequest
    {
        ...
        /// <param name="auditLogRootToUpdate">The AuditLogRoot to update.</param>
        /// <returns>The <see cref="GraphResponse{AuditLogRoot}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AuditLogRoot>> UpdateResponseAsync(AuditLogRoot auditLogRootToUpdate)
        {
            return this.UpdateResponseAsync(auditLogRootToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AuditLogRoot}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AuditLogRoot>> UpdateResponseAsync(AuditLogRoot auditLogRootToUpdate, CancellationToken cancellationToken)
        {
			if (auditLogRootToUpdate.AdditionalData != null)
			{
				if (auditLogRootToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
