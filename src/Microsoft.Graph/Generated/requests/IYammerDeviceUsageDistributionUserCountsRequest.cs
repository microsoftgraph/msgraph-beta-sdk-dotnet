...
namespace Microsoft.Graph
{
    ...
    public partial interface IYammerDeviceUsageDistributionUserCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<YammerDeviceUsageDistributionUserCounts> CreateAsync(YammerDeviceUsageDistributionUserCounts yammerDeviceUsageDistributionUserCountsToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<YammerDeviceUsageDistributionUserCounts>> CreateResponseAsync(YammerDeviceUsageDistributionUserCounts yammerDeviceUsageDistributionUserCountsToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{YammerDeviceUsageDistributionUserCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<YammerDeviceUsageDistributionUserCounts>> CreateResponseAsync(YammerDeviceUsageDistributionUserCounts yammerDeviceUsageDistributionUserCountsToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{YammerDeviceUsageDistributionUserCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<YammerDeviceUsageDistributionUserCounts>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{YammerDeviceUsageDistributionUserCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<YammerDeviceUsageDistributionUserCounts>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="yammerDeviceUsageDistributionUserCountsToUpdate">The YammerDeviceUsageDistributionUserCounts to update.</param>
        /// <returns>The <see cref="GraphResponse{YammerDeviceUsageDistributionUserCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<YammerDeviceUsageDistributionUserCounts>> UpdateResponseAsync(YammerDeviceUsageDistributionUserCounts yammerDeviceUsageDistributionUserCountsToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{YammerDeviceUsageDistributionUserCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<YammerDeviceUsageDistributionUserCounts>> UpdateResponseAsync(YammerDeviceUsageDistributionUserCounts yammerDeviceUsageDistributionUserCountsToUpdate, CancellationToken cancellationToken);
