...
namespace Microsoft.Graph
{
    ...
    public partial interface IImportedAppleDeviceIdentityResultRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ImportedAppleDeviceIdentityResult> CreateAsync(ImportedAppleDeviceIdentityResult importedAppleDeviceIdentityResultToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<ImportedAppleDeviceIdentityResult>> CreateResponseAsync(ImportedAppleDeviceIdentityResult importedAppleDeviceIdentityResultToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ImportedAppleDeviceIdentityResult> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ImportedAppleDeviceIdentityResult}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ImportedAppleDeviceIdentityResult>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ImportedAppleDeviceIdentityResult> UpdateAsync(ImportedAppleDeviceIdentityResult importedAppleDeviceIdentityResultToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ImportedAppleDeviceIdentityResult}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ImportedAppleDeviceIdentityResult>> UpdateResponseAsync(ImportedAppleDeviceIdentityResult importedAppleDeviceIdentityResultToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<ImportedAppleDeviceIdentityResult> PutAsync(ImportedAppleDeviceIdentityResult importedAppleDeviceIdentityResultToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<ImportedAppleDeviceIdentityResult>> PutResponseAsync(ImportedAppleDeviceIdentityResult importedAppleDeviceIdentityResultToUpdate, CancellationToken cancellationToken = default(CancellationToken));
