...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsZ_TestRequest : BaseRequest, IWorkbookFunctionsZ_TestRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsZ_TestRequest.
        /// </summary>
        public WorkbookFunctionsZ_TestRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsZ_TestRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsZ_TestRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsZ_TestRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsZ_TestRequest Select(string value)
        {
