...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceManagementConfigurationCategoryRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DeviceManagementConfigurationCategory> CreateAsync(DeviceManagementConfigurationCategory deviceManagementConfigurationCategoryToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationCategory>> CreateResponseAsync(DeviceManagementConfigurationCategory deviceManagementConfigurationCategoryToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<DeviceManagementConfigurationCategory> UpdateAsync(DeviceManagementConfigurationCategory deviceManagementConfigurationCategoryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementConfigurationCategory}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationCategory>> UpdateResponseAsync(DeviceManagementConfigurationCategory deviceManagementConfigurationCategoryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<DeviceManagementConfigurationCategory> PutAsync(DeviceManagementConfigurationCategory deviceManagementConfigurationCategoryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationCategory>> PutResponseAsync(DeviceManagementConfigurationCategory deviceManagementConfigurationCategoryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
