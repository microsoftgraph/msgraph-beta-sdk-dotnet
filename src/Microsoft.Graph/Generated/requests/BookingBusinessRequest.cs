...
namespace Microsoft.Graph
{
    ...
    public partial class BookingBusinessRequest : BaseRequest, IBookingBusinessRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<BookingBusiness>> CreateResponseAsync(BookingBusiness bookingBusinessToCreate)
        {
            return this.CreateResponseAsync(bookingBusinessToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{BookingBusiness}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<BookingBusiness>> CreateResponseAsync(BookingBusiness bookingBusinessToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<BookingBusiness>(bookingBusinessToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{BookingBusiness}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<BookingBusiness>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{BookingBusiness}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<BookingBusiness>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<BookingBusiness>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="bookingBusinessToUpdate">The BookingBusiness to update.</param>
        /// <returns>The <see cref="GraphResponse{BookingBusiness}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<BookingBusiness>> UpdateResponseAsync(BookingBusiness bookingBusinessToUpdate)
        {
            return this.UpdateResponseAsync(bookingBusinessToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{BookingBusiness}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<BookingBusiness>> UpdateResponseAsync(BookingBusiness bookingBusinessToUpdate, CancellationToken cancellationToken)
        {
			if (bookingBusinessToUpdate.AdditionalData != null)
			{
				if (bookingBusinessToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<BookingBusiness>(bookingBusinessToUpdate, cancellationToken).ConfigureAwait(false);
        }
