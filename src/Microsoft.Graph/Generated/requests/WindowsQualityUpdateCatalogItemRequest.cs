...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsQualityUpdateCatalogItemRequest : BaseRequest, IWindowsQualityUpdateCatalogItemRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateCatalogItem>> CreateResponseAsync(WindowsQualityUpdateCatalogItem windowsQualityUpdateCatalogItemToCreate)
        {
            return this.CreateResponseAsync(windowsQualityUpdateCatalogItemToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsQualityUpdateCatalogItem}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateCatalogItem>> CreateResponseAsync(WindowsQualityUpdateCatalogItem windowsQualityUpdateCatalogItemToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<WindowsQualityUpdateCatalogItem>(windowsQualityUpdateCatalogItemToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WindowsQualityUpdateCatalogItem}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateCatalogItem>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsQualityUpdateCatalogItem}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateCatalogItem>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WindowsQualityUpdateCatalogItem>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="windowsQualityUpdateCatalogItemToUpdate">The WindowsQualityUpdateCatalogItem to update.</param>
        /// <returns>The <see cref="GraphResponse{WindowsQualityUpdateCatalogItem}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateCatalogItem>> UpdateResponseAsync(WindowsQualityUpdateCatalogItem windowsQualityUpdateCatalogItemToUpdate)
        {
            return this.UpdateResponseAsync(windowsQualityUpdateCatalogItemToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsQualityUpdateCatalogItem}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateCatalogItem>> UpdateResponseAsync(WindowsQualityUpdateCatalogItem windowsQualityUpdateCatalogItemToUpdate, CancellationToken cancellationToken)
        {
			if (windowsQualityUpdateCatalogItemToUpdate.AdditionalData != null)
			{
				if (windowsQualityUpdateCatalogItemToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<WindowsQualityUpdateCatalogItem>(windowsQualityUpdateCatalogItemToUpdate, cancellationToken).ConfigureAwait(false);
        }
