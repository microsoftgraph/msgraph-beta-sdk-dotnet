...
namespace Microsoft.Graph
{
    ...
    public partial class SecurityConfigurationTaskRequest : BaseRequest, ISecurityConfigurationTaskRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<SecurityConfigurationTask>> CreateResponseAsync(SecurityConfigurationTask securityConfigurationTaskToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SecurityConfigurationTask}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SecurityConfigurationTask>> UpdateResponseAsync(SecurityConfigurationTask securityConfigurationTaskToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
