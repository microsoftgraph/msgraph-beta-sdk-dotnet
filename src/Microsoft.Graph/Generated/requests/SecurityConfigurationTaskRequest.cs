...
namespace Microsoft.Graph
{
    ...
    public partial class SecurityConfigurationTaskRequest : BaseRequest, ISecurityConfigurationTaskRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SecurityConfigurationTask>> CreateResponseAsync(SecurityConfigurationTask securityConfigurationTaskToCreate)
        {
            return this.CreateResponseAsync(securityConfigurationTaskToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SecurityConfigurationTask}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SecurityConfigurationTask>> CreateResponseAsync(SecurityConfigurationTask securityConfigurationTaskToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<SecurityConfigurationTask>(securityConfigurationTaskToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{SecurityConfigurationTask}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SecurityConfigurationTask>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SecurityConfigurationTask}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SecurityConfigurationTask>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<SecurityConfigurationTask>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="securityConfigurationTaskToUpdate">The SecurityConfigurationTask to update.</param>
        /// <returns>The <see cref="GraphResponse{SecurityConfigurationTask}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SecurityConfigurationTask>> UpdateResponseAsync(SecurityConfigurationTask securityConfigurationTaskToUpdate)
        {
            return this.UpdateResponseAsync(securityConfigurationTaskToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SecurityConfigurationTask}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SecurityConfigurationTask>> UpdateResponseAsync(SecurityConfigurationTask securityConfigurationTaskToUpdate, CancellationToken cancellationToken)
        {
			if (securityConfigurationTaskToUpdate.AdditionalData != null)
			{
				if (securityConfigurationTaskToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<SecurityConfigurationTask>(securityConfigurationTaskToUpdate, cancellationToken).ConfigureAwait(false);
        }
