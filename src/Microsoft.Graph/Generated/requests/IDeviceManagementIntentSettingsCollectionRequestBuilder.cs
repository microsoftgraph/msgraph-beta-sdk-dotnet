...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IDeviceManagementIntentSettingsCollectionRequestBuilder.
    /// </summary>
    public partial interface IDeviceManagementIntentSettingsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IDeviceManagementIntentSettingsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IDeviceManagementIntentSettingsCollectionRequest Request(IEnumerable<Option> options);
