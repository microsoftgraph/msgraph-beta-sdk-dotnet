...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IServicePrincipalHomeRealmDiscoveryPoliciesCollectionWithReferencesRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IServicePrincipalHomeRealmDiscoveryPoliciesCollectionWithReferencesRequest Request();
        ...
        /// <returns>The built request.</returns>
        IServicePrincipalHomeRealmDiscoveryPoliciesCollectionWithReferencesRequest Request(IEnumerable<Option> options);
        ...
        IServicePrincipalHomeRealmDiscoveryPoliciesCollectionReferencesRequestBuilder References { get; }
