...
namespace Microsoft.Graph
{
    ...
    public partial interface IUnifiedRoleAssignmentRequestRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<UnifiedRoleAssignmentRequestObject> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleAssignmentRequestObject}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleAssignmentRequestObject>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <summary>
        /// Updates the specified UnifiedRoleAssignmentRequestObject using PUT.
        /// </summary>
        /// <param name="unifiedRoleAssignmentRequestObjectToUpdate">The UnifiedRoleAssignmentRequestObject object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<UnifiedRoleAssignmentRequestObject> PutAsync(UnifiedRoleAssignmentRequestObject unifiedRoleAssignmentRequestObjectToUpdate, CancellationToken cancellationToken = default(CancellationToken));

        /// <summary>
        /// Updates the specified UnifiedRoleAssignmentRequestObject using PUT and returns a <see cref="GraphResponse{UnifiedRoleAssignmentRequestObject}"/> object.
        /// </summary>
        /// <param name="unifiedRoleAssignmentRequestObjectToUpdate">The UnifiedRoleAssignmentRequestObject object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{UnifiedRoleAssignmentRequestObject}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleAssignmentRequestObject>> PutResponseAsync(UnifiedRoleAssignmentRequestObject unifiedRoleAssignmentRequestObjectToUpdate, CancellationToken cancellationToken = default(CancellationToken));
