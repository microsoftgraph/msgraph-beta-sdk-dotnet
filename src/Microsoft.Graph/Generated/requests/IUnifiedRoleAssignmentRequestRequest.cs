...
namespace Microsoft.Graph
{
    ...
    public partial interface IUnifiedRoleAssignmentRequestRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<UnifiedRoleAssignmentRequestObject> CreateAsync(UnifiedRoleAssignmentRequestObject unifiedRoleAssignmentRequestObjectToCreate);
        ...
        /// <returns>The created UnifiedRoleAssignmentRequestObject.</returns>
        System.Threading.Tasks.Task<UnifiedRoleAssignmentRequestObject> CreateAsync(UnifiedRoleAssignmentRequestObject unifiedRoleAssignmentRequestObjectToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleAssignmentRequestObject>> CreateResponseAsync(UnifiedRoleAssignmentRequestObject unifiedRoleAssignmentRequestObjectToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleAssignmentRequestObject}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleAssignmentRequestObject>> CreateResponseAsync(UnifiedRoleAssignmentRequestObject unifiedRoleAssignmentRequestObjectToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<UnifiedRoleAssignmentRequestObject> UpdateAsync(UnifiedRoleAssignmentRequestObject unifiedRoleAssignmentRequestObjectToUpdate);
        ...
        /// <returns>The updated UnifiedRoleAssignmentRequestObject.</returns>
        System.Threading.Tasks.Task<UnifiedRoleAssignmentRequestObject> UpdateAsync(UnifiedRoleAssignmentRequestObject unifiedRoleAssignmentRequestObjectToUpdate, CancellationToken cancellationToken);
        ...
        /// <param name="unifiedRoleAssignmentRequestObjectToUpdate">The UnifiedRoleAssignmentRequestObject to update.</param>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleAssignmentRequestObject}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleAssignmentRequestObject>> UpdateResponseAsync(UnifiedRoleAssignmentRequestObject unifiedRoleAssignmentRequestObjectToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleAssignmentRequestObject}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleAssignmentRequestObject>> UpdateResponseAsync(UnifiedRoleAssignmentRequestObject unifiedRoleAssignmentRequestObjectToUpdate, CancellationToken cancellationToken);
