...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceComplianceScheduledActionForRuleRequest : BaseRequest, IDeviceComplianceScheduledActionForRuleRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DeviceComplianceScheduledActionForRule}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceComplianceScheduledActionForRule>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceComplianceScheduledActionForRule}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceComplianceScheduledActionForRule>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceComplianceScheduledActionForRule>(null, cancellationToken).ConfigureAwait(false);
        }
