...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetConfigurationPolicyDeviceSummaryReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetConfigurationPolicyDeviceSummaryReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetConfigurationPolicyDeviceSummaryReportRequest>, IDeviceManagementReportsGetConfigurationPolicyDeviceSummaryReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetConfigurationPolicyDeviceSummaryReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetConfigurationPolicyDeviceSummaryReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetConfigurationPolicyDeviceSummaryReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetConfigurationPolicyDeviceSummaryReportRequest(functionUrl, this.Client, options);
