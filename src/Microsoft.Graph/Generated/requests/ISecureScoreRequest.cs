...
namespace Microsoft.Graph
{
    ...
    public partial interface ISecureScoreRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SecureScore> CreateAsync(SecureScore secureScoreToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<SecureScore>> CreateResponseAsync(SecureScore secureScoreToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SecureScore}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SecureScore>> CreateResponseAsync(SecureScore secureScoreToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{SecureScore}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SecureScore>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SecureScore}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SecureScore>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="secureScoreToUpdate">The SecureScore to update.</param>
        /// <returns>The <see cref="GraphResponse{SecureScore}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SecureScore>> UpdateResponseAsync(SecureScore secureScoreToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SecureScore}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SecureScore>> UpdateResponseAsync(SecureScore secureScoreToUpdate, CancellationToken cancellationToken);
