...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceExtensionsCollectionRequest : BaseRequest, IDeviceExtensionsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<IDeviceExtensionsCollectionPage> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary>
        /// Gets the collection page and returns a <see cref="GraphResponse{DeviceExtensionsCollectionResponse}"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceExtensionsCollectionResponse}"/> object.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceExtensionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<DeviceExtensionsCollectionResponse>(null, cancellationToken);
        }
