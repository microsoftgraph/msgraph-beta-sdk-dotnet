...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceExtensionsCollectionRequest : BaseRequest, IDeviceExtensionsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceExtensionsCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceExtensionsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceExtensionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
