...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceExtensionsCollectionRequest : BaseRequest, IDeviceExtensionsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<IDeviceExtensionsCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DeviceExtensionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceExtensionsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
