...
namespace Microsoft.Graph
{
    ...
    public partial class UserAppInstallStatusRequest : BaseRequest, IUserAppInstallStatusRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UserAppInstallStatus>> CreateResponseAsync(UserAppInstallStatus userAppInstallStatusToCreate)
        {
            return this.CreateResponseAsync(userAppInstallStatusToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserAppInstallStatus}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserAppInstallStatus>> CreateResponseAsync(UserAppInstallStatus userAppInstallStatusToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<UserAppInstallStatus>(userAppInstallStatusToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{UserAppInstallStatus}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserAppInstallStatus>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserAppInstallStatus}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserAppInstallStatus>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<UserAppInstallStatus>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="userAppInstallStatusToUpdate">The UserAppInstallStatus to update.</param>
        /// <returns>The <see cref="GraphResponse{UserAppInstallStatus}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserAppInstallStatus>> UpdateResponseAsync(UserAppInstallStatus userAppInstallStatusToUpdate)
        {
            return this.UpdateResponseAsync(userAppInstallStatusToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserAppInstallStatus}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserAppInstallStatus>> UpdateResponseAsync(UserAppInstallStatus userAppInstallStatusToUpdate, CancellationToken cancellationToken)
        {
			if (userAppInstallStatusToUpdate.AdditionalData != null)
			{
				if (userAppInstallStatusToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<UserAppInstallStatus>(userAppInstallStatusToUpdate, cancellationToken).ConfigureAwait(false);
        }
