...
namespace Microsoft.Graph
{
    ...
    public partial class EducationSubmissionRequest : BaseRequest, IEducationSubmissionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<EducationSubmission>> CreateResponseAsync(EducationSubmission educationSubmissionToCreate)
        {
            return this.CreateResponseAsync(educationSubmissionToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EducationSubmission}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EducationSubmission>> CreateResponseAsync(EducationSubmission educationSubmissionToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<EducationSubmission>(educationSubmissionToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{EducationSubmission}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<EducationSubmission>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EducationSubmission}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EducationSubmission>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<EducationSubmission>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="educationSubmissionToUpdate">The EducationSubmission to update.</param>
        /// <returns>The <see cref="GraphResponse{EducationSubmission}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<EducationSubmission>> UpdateResponseAsync(EducationSubmission educationSubmissionToUpdate)
        {
            return this.UpdateResponseAsync(educationSubmissionToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{EducationSubmission}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EducationSubmission>> UpdateResponseAsync(EducationSubmission educationSubmissionToUpdate, CancellationToken cancellationToken)
        {
			if (educationSubmissionToUpdate.AdditionalData != null)
			{
				if (educationSubmissionToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<EducationSubmission>(educationSubmissionToUpdate, cancellationToken).ConfigureAwait(false);
        }
