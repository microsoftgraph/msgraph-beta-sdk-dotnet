...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetCompliancePolicyDevicesReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetCompliancePolicyDevicesReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetCompliancePolicyDevicesReportRequest>, IDeviceManagementReportsGetCompliancePolicyDevicesReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetCompliancePolicyDevicesReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetCompliancePolicyDevicesReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetCompliancePolicyDevicesReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetCompliancePolicyDevicesReportRequest(functionUrl, this.Client, options);
