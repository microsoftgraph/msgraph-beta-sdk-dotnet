...
namespace Microsoft.Graph
{
    ...
    public partial class IosScepCertificateProfileRequest : BaseRequest, IIosScepCertificateProfileRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<IosScepCertificateProfile>> CreateResponseAsync(IosScepCertificateProfile iosScepCertificateProfileToCreate)
        {
            return this.CreateResponseAsync(iosScepCertificateProfileToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosScepCertificateProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosScepCertificateProfile>> CreateResponseAsync(IosScepCertificateProfile iosScepCertificateProfileToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<IosScepCertificateProfile>(iosScepCertificateProfileToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{IosScepCertificateProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosScepCertificateProfile>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosScepCertificateProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosScepCertificateProfile>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<IosScepCertificateProfile>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="iosScepCertificateProfileToUpdate">The IosScepCertificateProfile to update.</param>
        /// <returns>The <see cref="GraphResponse{IosScepCertificateProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosScepCertificateProfile>> UpdateResponseAsync(IosScepCertificateProfile iosScepCertificateProfileToUpdate)
        {
            return this.UpdateResponseAsync(iosScepCertificateProfileToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosScepCertificateProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosScepCertificateProfile>> UpdateResponseAsync(IosScepCertificateProfile iosScepCertificateProfileToUpdate, CancellationToken cancellationToken)
        {
			if (iosScepCertificateProfileToUpdate.AdditionalData != null)
			{
				if (iosScepCertificateProfileToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<IosScepCertificateProfile>(iosScepCertificateProfileToUpdate, cancellationToken).ConfigureAwait(false);
        }
