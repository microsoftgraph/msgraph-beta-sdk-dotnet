...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface ICalendarSingleValueExtendedPropertiesCollectionRequest : IBaseRequest
    {
        /// <summary>
        ...
        System.Threading.Tasks.Task<ICalendarSingleValueExtendedPropertiesCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<CalendarSingleValueExtendedPropertiesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        ICalendarSingleValueExtendedPropertiesCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        ICalendarSingleValueExtendedPropertiesCollectionRequest Expand(Expression<Func<SingleValueLegacyExtendedProperty, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        ICalendarSingleValueExtendedPropertiesCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        ICalendarSingleValueExtendedPropertiesCollectionRequest Select(Expression<Func<SingleValueLegacyExtendedProperty, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        ICalendarSingleValueExtendedPropertiesCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        ICalendarSingleValueExtendedPropertiesCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        ICalendarSingleValueExtendedPropertiesCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        ICalendarSingleValueExtendedPropertiesCollectionRequest OrderBy(string value);
    }
}
