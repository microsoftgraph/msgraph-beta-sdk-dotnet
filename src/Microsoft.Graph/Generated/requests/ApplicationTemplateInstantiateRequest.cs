...
namespace Microsoft.Graph
{
    ...
    public partial class ApplicationTemplateInstantiateRequest : BaseRequest, IApplicationTemplateInstantiateRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ApplicationServicePrincipal>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<ApplicationServicePrincipal>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
