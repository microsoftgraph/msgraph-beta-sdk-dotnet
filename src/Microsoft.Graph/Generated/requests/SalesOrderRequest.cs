...
namespace Microsoft.Graph
{
    ...
    public partial class SalesOrderRequest : BaseRequest, ISalesOrderRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SalesOrder>> CreateResponseAsync(SalesOrder salesOrderToCreate)
        {
            return this.CreateResponseAsync(salesOrderToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SalesOrder}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SalesOrder>> CreateResponseAsync(SalesOrder salesOrderToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<SalesOrder>(salesOrderToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{SalesOrder}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SalesOrder>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SalesOrder}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SalesOrder>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<SalesOrder>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="salesOrderToUpdate">The SalesOrder to update.</param>
        /// <returns>The <see cref="GraphResponse{SalesOrder}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SalesOrder>> UpdateResponseAsync(SalesOrder salesOrderToUpdate)
        {
            return this.UpdateResponseAsync(salesOrderToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SalesOrder}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SalesOrder>> UpdateResponseAsync(SalesOrder salesOrderToUpdate, CancellationToken cancellationToken)
        {
			if (salesOrderToUpdate.AdditionalData != null)
			{
				if (salesOrderToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<SalesOrder>(salesOrderToUpdate, cancellationToken).ConfigureAwait(false);
        }
