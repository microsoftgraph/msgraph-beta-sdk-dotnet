...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceHealthScriptPolicyStateReferenceRequest : IBaseRequest
    {
        ...
        /// </summary>
        /// <param name="id">The DeviceHealthScriptPolicyState reference reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task PutAsync(string id, CancellationToken cancellationToken = default);

        /// <summary>
        /// Puts the specified DeviceHealthScriptPolicyState reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The DeviceHealthScriptPolicyState reference reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
