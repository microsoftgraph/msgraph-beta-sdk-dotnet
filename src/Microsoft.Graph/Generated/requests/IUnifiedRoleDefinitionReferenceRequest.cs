...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IUnifiedRoleDefinitionReferenceRequest : IBaseRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Deletes the specified UnifiedRoleDefinition reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified UnifiedRoleDefinition reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The UnifiedRoleDefinition reference reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
