...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsPrivacyDataAccessControlItemRequest : BaseRequest, IWindowsPrivacyDataAccessControlItemRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<WindowsPrivacyDataAccessControlItem>> CreateResponseAsync(WindowsPrivacyDataAccessControlItem windowsPrivacyDataAccessControlItemToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsPrivacyDataAccessControlItem}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsPrivacyDataAccessControlItem>> UpdateResponseAsync(WindowsPrivacyDataAccessControlItem windowsPrivacyDataAccessControlItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
