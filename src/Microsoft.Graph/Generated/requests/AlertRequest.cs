...
namespace Microsoft.Graph
{
    ...
    public partial class AlertRequest : BaseRequest, IAlertRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Alert>> CreateResponseAsync(Alert alertToCreate)
        {
            return this.CreateResponseAsync(alertToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Alert}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Alert>> CreateResponseAsync(Alert alertToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="alertToUpdate">The Alert to update.</param>
        /// <returns>The <see cref="GraphResponse{Alert}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Alert>> UpdateResponseAsync(Alert alertToUpdate)
        {
            return this.UpdateResponseAsync(alertToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Alert}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Alert>> UpdateResponseAsync(Alert alertToUpdate, CancellationToken cancellationToken)
        {
			if (alertToUpdate.AdditionalData != null)
			{
				if (alertToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
