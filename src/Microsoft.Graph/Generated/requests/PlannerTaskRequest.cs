...
namespace Microsoft.Graph
{
    ...
    public partial class PlannerTaskRequest : BaseRequest, IPlannerTaskRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PlannerTask>> CreateResponseAsync(PlannerTask plannerTaskToCreate)
        {
            return this.CreateResponseAsync(plannerTaskToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PlannerTask}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PlannerTask>> CreateResponseAsync(PlannerTask plannerTaskToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<PlannerTask>(plannerTaskToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{PlannerTask}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PlannerTask>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PlannerTask}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PlannerTask>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<PlannerTask>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="plannerTaskToUpdate">The PlannerTask to update.</param>
        /// <returns>The <see cref="GraphResponse{PlannerTask}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PlannerTask>> UpdateResponseAsync(PlannerTask plannerTaskToUpdate)
        {
            return this.UpdateResponseAsync(plannerTaskToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PlannerTask}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PlannerTask>> UpdateResponseAsync(PlannerTask plannerTaskToUpdate, CancellationToken cancellationToken)
        {
			if (plannerTaskToUpdate.AdditionalData != null)
			{
				if (plannerTaskToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<PlannerTask>(plannerTaskToUpdate, cancellationToken).ConfigureAwait(false);
        }
