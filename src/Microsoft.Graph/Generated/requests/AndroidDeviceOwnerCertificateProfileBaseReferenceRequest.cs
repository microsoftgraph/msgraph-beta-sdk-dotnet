...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AndroidDeviceOwnerCertificateProfileBaseReferenceRequest.
    /// </summary>
    public partial class AndroidDeviceOwnerCertificateProfileBaseReferenceRequest : BaseRequest, IAndroidDeviceOwnerCertificateProfileBaseReferenceRequest
    {
        /// <summary>
        /// Constructs a new AndroidDeviceOwnerCertificateProfileBaseReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public AndroidDeviceOwnerCertificateProfileBaseReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// </summary>
        /// <param name="id">The AndroidDeviceOwnerCertificateProfileBase reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified AndroidDeviceOwnerCertificateProfileBase reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The AndroidDeviceOwnerCertificateProfileBase reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
