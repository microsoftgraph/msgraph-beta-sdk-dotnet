...
namespace Microsoft.Graph
{
    ...
    public partial interface ISynchronizationTemplateRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SynchronizationTemplate> CreateAsync(SynchronizationTemplate synchronizationTemplateToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<SynchronizationTemplate>> CreateResponseAsync(SynchronizationTemplate synchronizationTemplateToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<SynchronizationTemplate> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SynchronizationTemplate}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SynchronizationTemplate>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<SynchronizationTemplate> UpdateAsync(SynchronizationTemplate synchronizationTemplateToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SynchronizationTemplate}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SynchronizationTemplate>> UpdateResponseAsync(SynchronizationTemplate synchronizationTemplateToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<SynchronizationTemplate> PutAsync(SynchronizationTemplate synchronizationTemplateToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<SynchronizationTemplate>> PutResponseAsync(SynchronizationTemplate synchronizationTemplateToUpdate, CancellationToken cancellationToken = default(CancellationToken));
