...
namespace Microsoft.Graph
{
    ...
    public partial class SynchronizationJobRequest : BaseRequest, ISynchronizationJobRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SynchronizationJob>> CreateResponseAsync(SynchronizationJob synchronizationJobToCreate)
        {
            return this.CreateResponseAsync(synchronizationJobToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SynchronizationJob}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SynchronizationJob>> CreateResponseAsync(SynchronizationJob synchronizationJobToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<SynchronizationJob>(synchronizationJobToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{SynchronizationJob}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SynchronizationJob>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SynchronizationJob}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SynchronizationJob>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<SynchronizationJob>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="synchronizationJobToUpdate">The SynchronizationJob to update.</param>
        /// <returns>The <see cref="GraphResponse{SynchronizationJob}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SynchronizationJob>> UpdateResponseAsync(SynchronizationJob synchronizationJobToUpdate)
        {
            return this.UpdateResponseAsync(synchronizationJobToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SynchronizationJob}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SynchronizationJob>> UpdateResponseAsync(SynchronizationJob synchronizationJobToUpdate, CancellationToken cancellationToken)
        {
			if (synchronizationJobToUpdate.AdditionalData != null)
			{
				if (synchronizationJobToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<SynchronizationJob>(synchronizationJobToUpdate, cancellationToken).ConfigureAwait(false);
        }
