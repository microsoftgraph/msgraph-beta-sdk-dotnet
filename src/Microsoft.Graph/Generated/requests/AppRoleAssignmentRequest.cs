...
namespace Microsoft.Graph
{
    ...
    public partial class AppRoleAssignmentRequest : BaseRequest, IAppRoleAssignmentRequest
    {
        ...
        {
			if (appRoleAssignmentToUpdate.AdditionalData != null)
			{
				if (appRoleAssignmentToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					appRoleAssignmentToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, appRoleAssignmentToUpdate.GetType().Name)
						});
				}
			}
            if (appRoleAssignmentToUpdate.AdditionalData != null)
        ...
        /// <param name="appRoleAssignmentToUpdate">The AppRoleAssignment to update.</param>
        /// <returns>The <see cref="GraphResponse{AppRoleAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AppRoleAssignment>> UpdateResponseAsync(AppRoleAssignment appRoleAssignmentToUpdate)
        {
            return this.UpdateResponseAsync(appRoleAssignmentToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AppRoleAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AppRoleAssignment>> UpdateResponseAsync(AppRoleAssignment appRoleAssignmentToUpdate, CancellationToken cancellationToken)
        {
			if (appRoleAssignmentToUpdate.AdditionalData != null)
			{
				if (appRoleAssignmentToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
