...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetDevicePoliciesComplianceReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetDevicePoliciesComplianceReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetDevicePoliciesComplianceReportRequest>, IDeviceManagementReportsGetDevicePoliciesComplianceReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetDevicePoliciesComplianceReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetDevicePoliciesComplianceReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IDeviceManagementReportsGetDevicePoliciesComplianceReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetDevicePoliciesComplianceReportRequest(functionUrl, this.Client, options);
