...
namespace Microsoft.Graph
{
    ...
    public partial interface IDlpEvaluatePoliciesJobResponseRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DlpEvaluatePoliciesJobResponse> CreateAsync(DlpEvaluatePoliciesJobResponse dlpEvaluatePoliciesJobResponseToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<DlpEvaluatePoliciesJobResponse>> CreateResponseAsync(DlpEvaluatePoliciesJobResponse dlpEvaluatePoliciesJobResponseToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DlpEvaluatePoliciesJobResponse}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DlpEvaluatePoliciesJobResponse>> CreateResponseAsync(DlpEvaluatePoliciesJobResponse dlpEvaluatePoliciesJobResponseToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DlpEvaluatePoliciesJobResponse}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DlpEvaluatePoliciesJobResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DlpEvaluatePoliciesJobResponse}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DlpEvaluatePoliciesJobResponse>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="dlpEvaluatePoliciesJobResponseToUpdate">The DlpEvaluatePoliciesJobResponse to update.</param>
        /// <returns>The <see cref="GraphResponse{DlpEvaluatePoliciesJobResponse}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DlpEvaluatePoliciesJobResponse>> UpdateResponseAsync(DlpEvaluatePoliciesJobResponse dlpEvaluatePoliciesJobResponseToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DlpEvaluatePoliciesJobResponse}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DlpEvaluatePoliciesJobResponse>> UpdateResponseAsync(DlpEvaluatePoliciesJobResponse dlpEvaluatePoliciesJobResponseToUpdate, CancellationToken cancellationToken);
