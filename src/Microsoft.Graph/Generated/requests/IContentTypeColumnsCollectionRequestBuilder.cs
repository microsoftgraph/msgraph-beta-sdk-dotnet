...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IContentTypeColumnsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IContentTypeColumnsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IContentTypeColumnsCollectionRequest Request(IEnumerable<Option> options);
