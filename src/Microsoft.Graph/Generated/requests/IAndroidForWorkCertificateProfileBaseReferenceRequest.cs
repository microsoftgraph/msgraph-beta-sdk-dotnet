...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidForWorkCertificateProfileBaseReferenceRequest : IBaseRequest
    {
        ...
        /// <summary>
        /// Deletes the specified AndroidForWorkCertificateProfileBase reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified AndroidForWorkCertificateProfileBase reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The AndroidForWorkCertificateProfileBase reference reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
