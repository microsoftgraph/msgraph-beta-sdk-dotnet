...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type CloudPcReportsGetRemoteConnectionHistoricalReportsRequestBuilder.
    /// </summary>
    public partial class CloudPcReportsGetRemoteConnectionHistoricalReportsRequestBuilder : BaseActionMethodRequestBuilder<ICloudPcReportsGetRemoteConnectionHistoricalReportsRequest>, ICloudPcReportsGetRemoteConnectionHistoricalReportsRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="CloudPcReportsGetRemoteConnectionHistoricalReportsRequestBuilder"/>.
        /// </summary>
        ...
        protected override ICloudPcReportsGetRemoteConnectionHistoricalReportsRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new CloudPcReportsGetRemoteConnectionHistoricalReportsRequest(functionUrl, this.Client, options);
