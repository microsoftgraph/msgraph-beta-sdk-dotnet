...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidForWorkNineWorkEasConfigurationRequest : BaseRequest, IAndroidForWorkNineWorkEasConfigurationRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkNineWorkEasConfiguration>> CreateResponseAsync(AndroidForWorkNineWorkEasConfiguration androidForWorkNineWorkEasConfigurationToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkNineWorkEasConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkNineWorkEasConfiguration>> UpdateResponseAsync(AndroidForWorkNineWorkEasConfiguration androidForWorkNineWorkEasConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
