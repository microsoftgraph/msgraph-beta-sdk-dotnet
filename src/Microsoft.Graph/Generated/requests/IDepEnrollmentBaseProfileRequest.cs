...
namespace Microsoft.Graph
{
    ...
    public partial interface IDepEnrollmentBaseProfileRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DepEnrollmentBaseProfile> CreateAsync(DepEnrollmentBaseProfile depEnrollmentBaseProfileToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<DepEnrollmentBaseProfile>> CreateResponseAsync(DepEnrollmentBaseProfile depEnrollmentBaseProfileToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DepEnrollmentBaseProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DepEnrollmentBaseProfile>> CreateResponseAsync(DepEnrollmentBaseProfile depEnrollmentBaseProfileToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="depEnrollmentBaseProfileToUpdate">The DepEnrollmentBaseProfile to update.</param>
        /// <returns>The <see cref="GraphResponse{DepEnrollmentBaseProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DepEnrollmentBaseProfile>> UpdateResponseAsync(DepEnrollmentBaseProfile depEnrollmentBaseProfileToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DepEnrollmentBaseProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DepEnrollmentBaseProfile>> UpdateResponseAsync(DepEnrollmentBaseProfile depEnrollmentBaseProfileToUpdate, CancellationToken cancellationToken);
