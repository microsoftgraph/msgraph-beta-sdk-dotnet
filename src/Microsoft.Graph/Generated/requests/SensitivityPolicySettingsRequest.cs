...
namespace Microsoft.Graph
{
    ...
    public partial class SensitivityPolicySettingsRequest : BaseRequest, ISensitivityPolicySettingsRequest
    {
        ...
        public async System.Threading.Tasks.Task<SensitivityPolicySettings> CreateAsync(SensitivityPolicySettings sensitivityPolicySettingsToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SensitivityPolicySettings>> CreateResponseAsync(SensitivityPolicySettings sensitivityPolicySettingsToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<SensitivityPolicySettings> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SensitivityPolicySettings}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SensitivityPolicySettings>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<SensitivityPolicySettings> UpdateAsync(SensitivityPolicySettings sensitivityPolicySettingsToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SensitivityPolicySettings}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SensitivityPolicySettings>> UpdateResponseAsync(SensitivityPolicySettings sensitivityPolicySettingsToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<SensitivityPolicySettings> PutAsync(SensitivityPolicySettings sensitivityPolicySettingsToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="sensitivityPolicySettingsToUpdate">The SensitivityPolicySettings object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{SensitivityPolicySettings}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SensitivityPolicySettings>> PutResponseAsync(SensitivityPolicySettings sensitivityPolicySettingsToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SensitivityPolicySettings>(sensitivityPolicySettingsToUpdate, cancellationToken);
