...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IServicePrincipalAppRoleAssignedToCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IServicePrincipalAppRoleAssignedToCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IServicePrincipalAppRoleAssignedToCollectionRequest Request(IEnumerable<Option> options);
