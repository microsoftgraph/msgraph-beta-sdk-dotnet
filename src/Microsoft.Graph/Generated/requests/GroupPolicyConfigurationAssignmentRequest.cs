...
namespace Microsoft.Graph
{
    ...
    public partial class GroupPolicyConfigurationAssignmentRequest : BaseRequest, IGroupPolicyConfigurationAssignmentRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyConfigurationAssignment>> CreateResponseAsync(GroupPolicyConfigurationAssignment groupPolicyConfigurationAssignmentToCreate)
        {
            return this.CreateResponseAsync(groupPolicyConfigurationAssignmentToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyConfigurationAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyConfigurationAssignment>> CreateResponseAsync(GroupPolicyConfigurationAssignment groupPolicyConfigurationAssignmentToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<GroupPolicyConfigurationAssignment>(groupPolicyConfigurationAssignmentToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{GroupPolicyConfigurationAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyConfigurationAssignment>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyConfigurationAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyConfigurationAssignment>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<GroupPolicyConfigurationAssignment>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="groupPolicyConfigurationAssignmentToUpdate">The GroupPolicyConfigurationAssignment to update.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyConfigurationAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyConfigurationAssignment>> UpdateResponseAsync(GroupPolicyConfigurationAssignment groupPolicyConfigurationAssignmentToUpdate)
        {
            return this.UpdateResponseAsync(groupPolicyConfigurationAssignmentToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{GroupPolicyConfigurationAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyConfigurationAssignment>> UpdateResponseAsync(GroupPolicyConfigurationAssignment groupPolicyConfigurationAssignmentToUpdate, CancellationToken cancellationToken)
        {
			if (groupPolicyConfigurationAssignmentToUpdate.AdditionalData != null)
			{
				if (groupPolicyConfigurationAssignmentToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<GroupPolicyConfigurationAssignment>(groupPolicyConfigurationAssignmentToUpdate, cancellationToken).ConfigureAwait(false);
        }
