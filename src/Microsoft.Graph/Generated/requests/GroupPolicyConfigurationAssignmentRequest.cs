...
namespace Microsoft.Graph
{
    ...
    public partial class GroupPolicyConfigurationAssignmentRequest : BaseRequest, IGroupPolicyConfigurationAssignmentRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyConfigurationAssignment>> CreateResponseAsync(GroupPolicyConfigurationAssignment groupPolicyConfigurationAssignmentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{GroupPolicyConfigurationAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyConfigurationAssignment>> UpdateResponseAsync(GroupPolicyConfigurationAssignment groupPolicyConfigurationAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
