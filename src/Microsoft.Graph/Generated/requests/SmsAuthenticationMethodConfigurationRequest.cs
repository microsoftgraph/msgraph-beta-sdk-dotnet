...
namespace Microsoft.Graph
{
    ...
    public partial class SmsAuthenticationMethodConfigurationRequest : BaseRequest, ISmsAuthenticationMethodConfigurationRequest
    {
        ...
        public async System.Threading.Tasks.Task<SmsAuthenticationMethodConfiguration> CreateAsync(SmsAuthenticationMethodConfiguration smsAuthenticationMethodConfigurationToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SmsAuthenticationMethodConfiguration>> CreateResponseAsync(SmsAuthenticationMethodConfiguration smsAuthenticationMethodConfigurationToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<SmsAuthenticationMethodConfiguration> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SmsAuthenticationMethodConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SmsAuthenticationMethodConfiguration>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<SmsAuthenticationMethodConfiguration> UpdateAsync(SmsAuthenticationMethodConfiguration smsAuthenticationMethodConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SmsAuthenticationMethodConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SmsAuthenticationMethodConfiguration>> UpdateResponseAsync(SmsAuthenticationMethodConfiguration smsAuthenticationMethodConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<SmsAuthenticationMethodConfiguration> PutAsync(SmsAuthenticationMethodConfiguration smsAuthenticationMethodConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<SmsAuthenticationMethodConfiguration>> PutResponseAsync(SmsAuthenticationMethodConfiguration smsAuthenticationMethodConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SmsAuthenticationMethodConfiguration>(smsAuthenticationMethodConfigurationToUpdate, cancellationToken);
