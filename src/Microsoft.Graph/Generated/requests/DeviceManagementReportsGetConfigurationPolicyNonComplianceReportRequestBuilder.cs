...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DeviceManagementReportsGetConfigurationPolicyNonComplianceReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetConfigurationPolicyNonComplianceReportRequest>, IDeviceManagementReportsGetConfigurationPolicyNonComplianceReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetConfigurationPolicyNonComplianceReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetConfigurationPolicyNonComplianceReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetConfigurationPolicyNonComplianceReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetConfigurationPolicyNonComplianceReportRequest(functionUrl, this.Client, options);
