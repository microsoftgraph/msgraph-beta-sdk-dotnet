...
namespace Microsoft.Graph
{
    ...
    public partial class ItemPhoneRequest : BaseRequest, IItemPhoneRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ItemPhone>> CreateResponseAsync(ItemPhone itemPhoneToCreate)
        {
            return this.CreateResponseAsync(itemPhoneToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ItemPhone}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ItemPhone>> CreateResponseAsync(ItemPhone itemPhoneToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="itemPhoneToUpdate">The ItemPhone to update.</param>
        /// <returns>The <see cref="GraphResponse{ItemPhone}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ItemPhone>> UpdateResponseAsync(ItemPhone itemPhoneToUpdate)
        {
            return this.UpdateResponseAsync(itemPhoneToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ItemPhone}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ItemPhone>> UpdateResponseAsync(ItemPhone itemPhoneToUpdate, CancellationToken cancellationToken)
        {
			if (itemPhoneToUpdate.AdditionalData != null)
			{
				if (itemPhoneToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
