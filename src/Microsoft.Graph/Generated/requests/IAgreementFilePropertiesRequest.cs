...
namespace Microsoft.Graph
{
    ...
    public partial interface IAgreementFilePropertiesRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AgreementFileProperties> CreateAsync(AgreementFileProperties agreementFilePropertiesToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<AgreementFileProperties>> CreateResponseAsync(AgreementFileProperties agreementFilePropertiesToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AgreementFileProperties}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AgreementFileProperties>> CreateResponseAsync(AgreementFileProperties agreementFilePropertiesToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AgreementFileProperties}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AgreementFileProperties>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AgreementFileProperties}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AgreementFileProperties>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="agreementFilePropertiesToUpdate">The AgreementFileProperties to update.</param>
        /// <returns>The <see cref="GraphResponse{AgreementFileProperties}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AgreementFileProperties>> UpdateResponseAsync(AgreementFileProperties agreementFilePropertiesToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AgreementFileProperties}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AgreementFileProperties>> UpdateResponseAsync(AgreementFileProperties agreementFilePropertiesToUpdate, CancellationToken cancellationToken);
