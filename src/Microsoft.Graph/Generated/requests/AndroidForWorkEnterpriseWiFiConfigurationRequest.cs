...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidForWorkEnterpriseWiFiConfigurationRequest : BaseRequest, IAndroidForWorkEnterpriseWiFiConfigurationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEnterpriseWiFiConfiguration>> CreateResponseAsync(AndroidForWorkEnterpriseWiFiConfiguration androidForWorkEnterpriseWiFiConfigurationToCreate)
        {
            return this.CreateResponseAsync(androidForWorkEnterpriseWiFiConfigurationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEnterpriseWiFiConfiguration>> CreateResponseAsync(AndroidForWorkEnterpriseWiFiConfiguration androidForWorkEnterpriseWiFiConfigurationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<AndroidForWorkEnterpriseWiFiConfiguration>(androidForWorkEnterpriseWiFiConfigurationToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEnterpriseWiFiConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEnterpriseWiFiConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<AndroidForWorkEnterpriseWiFiConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
			if (androidForWorkEnterpriseWiFiConfigurationToUpdate.AdditionalData != null)
			{
				if (androidForWorkEnterpriseWiFiConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					androidForWorkEnterpriseWiFiConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, androidForWorkEnterpriseWiFiConfigurationToUpdate.GetType().Name)
						});
				}
			}
            if (androidForWorkEnterpriseWiFiConfigurationToUpdate.AdditionalData != null)
        ...
        /// <param name="androidForWorkEnterpriseWiFiConfigurationToUpdate">The AndroidForWorkEnterpriseWiFiConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEnterpriseWiFiConfiguration>> UpdateResponseAsync(AndroidForWorkEnterpriseWiFiConfiguration androidForWorkEnterpriseWiFiConfigurationToUpdate)
        {
            return this.UpdateResponseAsync(androidForWorkEnterpriseWiFiConfigurationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEnterpriseWiFiConfiguration>> UpdateResponseAsync(AndroidForWorkEnterpriseWiFiConfiguration androidForWorkEnterpriseWiFiConfigurationToUpdate, CancellationToken cancellationToken)
        {
			if (androidForWorkEnterpriseWiFiConfigurationToUpdate.AdditionalData != null)
			{
				if (androidForWorkEnterpriseWiFiConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<AndroidForWorkEnterpriseWiFiConfiguration>(androidForWorkEnterpriseWiFiConfigurationToUpdate, cancellationToken).ConfigureAwait(false);
        }
