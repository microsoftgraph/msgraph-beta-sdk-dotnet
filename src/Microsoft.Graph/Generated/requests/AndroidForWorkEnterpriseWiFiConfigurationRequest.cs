...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidForWorkEnterpriseWiFiConfigurationRequest : BaseRequest, IAndroidForWorkEnterpriseWiFiConfigurationRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEnterpriseWiFiConfiguration>> CreateResponseAsync(AndroidForWorkEnterpriseWiFiConfiguration androidForWorkEnterpriseWiFiConfigurationToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEnterpriseWiFiConfiguration>> UpdateResponseAsync(AndroidForWorkEnterpriseWiFiConfiguration androidForWorkEnterpriseWiFiConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
