...
namespace Microsoft.Graph
{
    ...
    public partial class DriveRecentRequest : BaseRequest, IDriveRecentRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DriveRecentCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DriveRecentCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
