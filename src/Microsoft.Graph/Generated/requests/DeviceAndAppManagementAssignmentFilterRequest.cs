...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceAndAppManagementAssignmentFilterRequest : BaseRequest, IDeviceAndAppManagementAssignmentFilterRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceAndAppManagementAssignmentFilter>> CreateResponseAsync(DeviceAndAppManagementAssignmentFilter deviceAndAppManagementAssignmentFilterToCreate)
        {
            return this.CreateResponseAsync(deviceAndAppManagementAssignmentFilterToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceAndAppManagementAssignmentFilter}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceAndAppManagementAssignmentFilter>> CreateResponseAsync(DeviceAndAppManagementAssignmentFilter deviceAndAppManagementAssignmentFilterToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DeviceAndAppManagementAssignmentFilter>(deviceAndAppManagementAssignmentFilterToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DeviceAndAppManagementAssignmentFilter}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceAndAppManagementAssignmentFilter>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceAndAppManagementAssignmentFilter}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceAndAppManagementAssignmentFilter>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceAndAppManagementAssignmentFilter>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="deviceAndAppManagementAssignmentFilterToUpdate">The DeviceAndAppManagementAssignmentFilter to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceAndAppManagementAssignmentFilter}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceAndAppManagementAssignmentFilter>> UpdateResponseAsync(DeviceAndAppManagementAssignmentFilter deviceAndAppManagementAssignmentFilterToUpdate)
        {
            return this.UpdateResponseAsync(deviceAndAppManagementAssignmentFilterToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceAndAppManagementAssignmentFilter}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceAndAppManagementAssignmentFilter>> UpdateResponseAsync(DeviceAndAppManagementAssignmentFilter deviceAndAppManagementAssignmentFilterToUpdate, CancellationToken cancellationToken)
        {
			if (deviceAndAppManagementAssignmentFilterToUpdate.AdditionalData != null)
			{
				if (deviceAndAppManagementAssignmentFilterToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<DeviceAndAppManagementAssignmentFilter>(deviceAndAppManagementAssignmentFilterToUpdate, cancellationToken).ConfigureAwait(false);
        }
