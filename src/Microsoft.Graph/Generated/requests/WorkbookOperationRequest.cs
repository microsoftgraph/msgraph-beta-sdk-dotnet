...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookOperationRequest : BaseRequest, IWorkbookOperationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WorkbookOperation>> CreateResponseAsync(WorkbookOperation workbookOperationToCreate)
        {
            return this.CreateResponseAsync(workbookOperationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookOperation>> CreateResponseAsync(WorkbookOperation workbookOperationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<WorkbookOperation>(workbookOperationToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WorkbookOperation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookOperation>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookOperation>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WorkbookOperation>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="workbookOperationToUpdate">The WorkbookOperation to update.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookOperation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookOperation>> UpdateResponseAsync(WorkbookOperation workbookOperationToUpdate)
        {
            return this.UpdateResponseAsync(workbookOperationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookOperation>> UpdateResponseAsync(WorkbookOperation workbookOperationToUpdate, CancellationToken cancellationToken)
        {
			if (workbookOperationToUpdate.AdditionalData != null)
			{
				if (workbookOperationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<WorkbookOperation>(workbookOperationToUpdate, cancellationToken).ConfigureAwait(false);
        }
