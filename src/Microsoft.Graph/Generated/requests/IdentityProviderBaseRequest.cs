...
namespace Microsoft.Graph
{
    ...
    public partial class IdentityProviderBaseRequest : BaseRequest, IIdentityProviderBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<IdentityProviderBase> PutAsync(IdentityProviderBase identityProviderBaseToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<IdentityProviderBase>> PutResponseAsync(IdentityProviderBase identityProviderBaseToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<IdentityProviderBase>(identityProviderBaseToUpdate, cancellationToken);
