...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IEventExceptionOccurrencesCollectionRequestBuilder.
    /// </summary>
    public partial interface IEventExceptionOccurrencesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IEventExceptionOccurrencesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IEventExceptionOccurrencesCollectionRequest Request(IEnumerable<Option> options);
