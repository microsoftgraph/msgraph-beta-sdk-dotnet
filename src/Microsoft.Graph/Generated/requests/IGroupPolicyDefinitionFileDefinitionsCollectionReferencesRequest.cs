...
namespace Microsoft.Graph
{
    ...
    public partial interface IGroupPolicyDefinitionFileDefinitionsCollectionReferencesRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task AddAsync(GroupPolicyDefinition groupPolicyDefinition, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="groupPolicyDefinition">The GroupPolicyDefinition to add.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(GroupPolicyDefinition groupPolicyDefinition, CancellationToken cancellationToken = default(CancellationToken));
