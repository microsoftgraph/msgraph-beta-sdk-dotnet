...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class UnifiedRoleScheduleBaseRequestBuilder : EntityRequestBuilder, IUnifiedRoleScheduleBaseRequestBuilder
    {
        ...
        public UnifiedRoleScheduleBaseRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public new IUnifiedRoleScheduleBaseRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public new IUnifiedRoleScheduleBaseRequest Request(IEnumerable<Option> options)
        {
            return new UnifiedRoleScheduleBaseRequest(this.RequestUrl, this.Client, options);
        }
