...
namespace Microsoft.Graph
{
    ...
    public partial class EBookInstallSummaryRequest : BaseRequest, IEBookInstallSummaryRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{EBookInstallSummary}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<EBookInstallSummary>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EBookInstallSummary}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EBookInstallSummary>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<EBookInstallSummary>(null, cancellationToken).ConfigureAwait(false);
        }
