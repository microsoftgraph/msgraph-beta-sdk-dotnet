...
namespace Microsoft.Graph
{
    ...
    public partial interface IContactFolderContactsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ContactFolderContactsCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ContactFolderContactsCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<ContactFolderContactsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
