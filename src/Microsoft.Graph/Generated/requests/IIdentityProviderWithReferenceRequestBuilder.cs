...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IIdentityProviderWithReferenceRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IIdentityProviderWithReferenceRequest Request();
        ...
        /// <returns>The built request.</returns>
        IIdentityProviderWithReferenceRequest Request(IEnumerable<Option> options);
        ...
        IIdentityProviderReferenceRequestBuilder Reference { get; }
