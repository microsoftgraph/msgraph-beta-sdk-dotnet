...
namespace Microsoft.Graph
{
    ...
    public partial class CloudPcProvisioningPolicyAssignmentRequest : BaseRequest, ICloudPcProvisioningPolicyAssignmentRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<CloudPcProvisioningPolicyAssignment>> CreateResponseAsync(CloudPcProvisioningPolicyAssignment cloudPcProvisioningPolicyAssignmentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<CloudPcProvisioningPolicyAssignment> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{CloudPcProvisioningPolicyAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<CloudPcProvisioningPolicyAssignment>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CloudPcProvisioningPolicyAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<CloudPcProvisioningPolicyAssignment>> UpdateResponseAsync(CloudPcProvisioningPolicyAssignment cloudPcProvisioningPolicyAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<CloudPcProvisioningPolicyAssignment> PutAsync(CloudPcProvisioningPolicyAssignment cloudPcProvisioningPolicyAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<CloudPcProvisioningPolicyAssignment>> PutResponseAsync(CloudPcProvisioningPolicyAssignment cloudPcProvisioningPolicyAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<CloudPcProvisioningPolicyAssignment>(cloudPcProvisioningPolicyAssignmentToUpdate, cancellationToken);
