...
namespace Microsoft.Graph
{
    ...
    public partial class CloudPcProvisioningPolicyAssignmentRequest : BaseRequest, ICloudPcProvisioningPolicyAssignmentRequest
    {
        ...
        public async System.Threading.Tasks.Task<CloudPcProvisioningPolicyAssignment> CreateAsync(CloudPcProvisioningPolicyAssignment cloudPcProvisioningPolicyAssignmentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<CloudPcProvisioningPolicyAssignment>> CreateResponseAsync(CloudPcProvisioningPolicyAssignment cloudPcProvisioningPolicyAssignmentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        public async System.Threading.Tasks.Task<CloudPcProvisioningPolicyAssignment> UpdateAsync(CloudPcProvisioningPolicyAssignment cloudPcProvisioningPolicyAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CloudPcProvisioningPolicyAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CloudPcProvisioningPolicyAssignment>> UpdateResponseAsync(CloudPcProvisioningPolicyAssignment cloudPcProvisioningPolicyAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
