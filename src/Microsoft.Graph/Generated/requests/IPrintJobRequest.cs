...
namespace Microsoft.Graph
{
    ...
    public partial interface IPrintJobRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<PrintJob> PutAsync(PrintJob printJobToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<PrintJob>> PutResponseAsync(PrintJob printJobToUpdate, CancellationToken cancellationToken = default(CancellationToken));
