...
namespace Microsoft.Graph
{
    ...
    public partial class MacOSLobAppRequest : BaseRequest, IMacOSLobAppRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<MacOSLobApp>> CreateResponseAsync(MacOSLobApp macOSLobAppToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MacOSLobApp}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MacOSLobApp>> UpdateResponseAsync(MacOSLobApp macOSLobAppToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
