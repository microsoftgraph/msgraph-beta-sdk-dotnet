...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ReportRootGetOffice365ActiveUserDetailRequest : BaseRequest, IReportRootGetOffice365ActiveUserDetailRequest
    {
        /// <summary>
        /// Constructs a new ReportRootGetOffice365ActiveUserDetailRequest.
        /// </summary>
        public ReportRootGetOffice365ActiveUserDetailRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ActiveUserDetailCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365ActiveUserDetailCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="office365activeuserdetail">The Office365ActiveUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ActiveUserDetailCollectionResponse>> PatchResponseAsync(Office365ActiveUserDetail office365activeuserdetail, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365ActiveUserDetailCollectionResponse>(office365activeuserdetail, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="office365activeuserdetail">The Office365ActiveUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ActiveUserDetailCollectionResponse>> PutResponseAsync(Office365ActiveUserDetail office365activeuserdetail, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365ActiveUserDetailCollectionResponse>(office365activeuserdetail, cancellationToken).ConfigureAwait(false);
        }
        ...
        public IReportRootGetOffice365ActiveUserDetailRequest Expand(string value)
        {
