...
namespace Microsoft.Graph
{
    ...
    public partial interface IOutlookTaskGroupRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<OutlookTaskGroup> PutAsync(OutlookTaskGroup outlookTaskGroupToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<OutlookTaskGroup>> PutResponseAsync(OutlookTaskGroup outlookTaskGroupToUpdate, CancellationToken cancellationToken = default(CancellationToken));
