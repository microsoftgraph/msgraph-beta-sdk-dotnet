...
namespace Microsoft.Graph
{
    ...
    public partial class IosikEv2VpnConfigurationRequest : BaseRequest, IIosikEv2VpnConfigurationRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{IosikEv2VpnConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosikEv2VpnConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosikEv2VpnConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosikEv2VpnConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<IosikEv2VpnConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
