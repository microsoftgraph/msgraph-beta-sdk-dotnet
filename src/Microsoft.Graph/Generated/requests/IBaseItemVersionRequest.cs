...
namespace Microsoft.Graph
{
    ...
    public partial interface IBaseItemVersionRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<BaseItemVersion> PutAsync(BaseItemVersion baseItemVersionToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<BaseItemVersion>> PutResponseAsync(BaseItemVersion baseItemVersionToUpdate, CancellationToken cancellationToken = default(CancellationToken));
