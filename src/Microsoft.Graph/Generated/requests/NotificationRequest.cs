...
namespace Microsoft.Graph
{
    ...
    public partial class NotificationRequest : BaseRequest, INotificationRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Notification}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Notification>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Notification}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Notification>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Notification>(null, cancellationToken).ConfigureAwait(false);
        }
