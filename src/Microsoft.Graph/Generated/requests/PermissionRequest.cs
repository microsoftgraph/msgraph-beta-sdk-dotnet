...
namespace Microsoft.Graph
{
    ...
    public partial class PermissionRequest : BaseRequest, IPermissionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Permission>> CreateResponseAsync(Permission permissionToCreate)
        {
            return this.CreateResponseAsync(permissionToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Permission}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Permission>> CreateResponseAsync(Permission permissionToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<Permission>(permissionToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Permission}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Permission>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Permission}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Permission>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Permission>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="permissionToUpdate">The Permission to update.</param>
        /// <returns>The <see cref="GraphResponse{Permission}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Permission>> UpdateResponseAsync(Permission permissionToUpdate)
        {
            return this.UpdateResponseAsync(permissionToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Permission}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Permission>> UpdateResponseAsync(Permission permissionToUpdate, CancellationToken cancellationToken)
        {
			if (permissionToUpdate.AdditionalData != null)
			{
				if (permissionToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<Permission>(permissionToUpdate, cancellationToken).ConfigureAwait(false);
        }
