...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IGraphServiceRiskyUsersCollectionRequestBuilder.
    /// </summary>
    public partial interface IGraphServiceRiskyUsersCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IGraphServiceRiskyUsersCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IGraphServiceRiskyUsersCollectionRequest Request(IEnumerable<Option> options);
