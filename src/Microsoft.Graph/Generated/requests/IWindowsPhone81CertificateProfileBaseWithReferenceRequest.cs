...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsPhone81CertificateProfileBaseWithReferenceRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WindowsPhone81CertificateProfileBase> CreateAsync(WindowsPhone81CertificateProfileBase windowsPhone81CertificateProfileBaseToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsPhone81CertificateProfileBase}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhone81CertificateProfileBase>> CreateResponseAsync(WindowsPhone81CertificateProfileBase windowsPhone81CertificateProfileBaseToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<WindowsPhone81CertificateProfileBase> UpdateAsync(WindowsPhone81CertificateProfileBase windowsPhone81CertificateProfileBaseToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsPhone81CertificateProfileBase}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhone81CertificateProfileBase>> UpdateResponseAsync(WindowsPhone81CertificateProfileBase windowsPhone81CertificateProfileBaseToUpdate, CancellationToken cancellationToken = default(CancellationToken));
