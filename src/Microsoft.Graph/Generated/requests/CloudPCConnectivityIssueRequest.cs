...
namespace Microsoft.Graph
{
    ...
    public partial class CloudPCConnectivityIssueRequest : BaseRequest, ICloudPCConnectivityIssueRequest
    {
        ...
        public async System.Threading.Tasks.Task<CloudPCConnectivityIssue> CreateAsync(CloudPCConnectivityIssue cloudPCConnectivityIssueToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<CloudPCConnectivityIssue>> CreateResponseAsync(CloudPCConnectivityIssue cloudPCConnectivityIssueToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<CloudPCConnectivityIssue> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{CloudPCConnectivityIssue}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<CloudPCConnectivityIssue>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<CloudPCConnectivityIssue> UpdateAsync(CloudPCConnectivityIssue cloudPCConnectivityIssueToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CloudPCConnectivityIssue}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<CloudPCConnectivityIssue>> UpdateResponseAsync(CloudPCConnectivityIssue cloudPCConnectivityIssueToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<CloudPCConnectivityIssue> PutAsync(CloudPCConnectivityIssue cloudPCConnectivityIssueToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<CloudPCConnectivityIssue>> PutResponseAsync(CloudPCConnectivityIssue cloudPCConnectivityIssueToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<CloudPCConnectivityIssue>(cloudPCConnectivityIssueToUpdate, cancellationToken);
