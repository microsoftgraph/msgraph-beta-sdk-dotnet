...
namespace Microsoft.Graph
{
    ...
    public partial class IdentityGovernanceRequest : BaseRequest, IIdentityGovernanceRequest
    {
        ...
        public async System.Threading.Tasks.Task<IdentityGovernance> CreateAsync(IdentityGovernance identityGovernanceToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<IdentityGovernance>> CreateResponseAsync(IdentityGovernance identityGovernanceToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<IdentityGovernance> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IdentityGovernance}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IdentityGovernance>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<IdentityGovernance> UpdateAsync(IdentityGovernance identityGovernanceToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IdentityGovernance}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IdentityGovernance>> UpdateResponseAsync(IdentityGovernance identityGovernanceToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<IdentityGovernance> PutAsync(IdentityGovernance identityGovernanceToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<IdentityGovernance>> PutResponseAsync(IdentityGovernance identityGovernanceToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<IdentityGovernance>(identityGovernanceToUpdate, cancellationToken);
