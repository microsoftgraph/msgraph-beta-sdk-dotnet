...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsIsNumberRequest : BaseRequest, IWorkbookFunctionsIsNumberRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsIsNumberRequest.
        /// </summary>
        public WorkbookFunctionsIsNumberRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsIsNumberRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsIsNumberRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsIsNumberRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsIsNumberRequest Select(string value)
        {
