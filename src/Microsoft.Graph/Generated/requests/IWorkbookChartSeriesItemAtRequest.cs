...
namespace Microsoft.Graph
{
    ...
    public partial interface IWorkbookChartSeriesItemAtRequest : IBaseRequest
    {
        ...
        /// <param name="workbookchartseries">The WorkbookChartSeries object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookChartSeries>> PatchResponseAsync(WorkbookChartSeries workbookchartseries, CancellationToken cancellationToken = default);
        ...
        /// <param name="workbookchartseries">The WorkbookChartSeries object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookChartSeries>> PutResponseAsync(WorkbookChartSeries workbookchartseries, CancellationToken cancellationToken = default);
