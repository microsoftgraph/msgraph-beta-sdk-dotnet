...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetSharePointSiteUsageDetailRequest : BaseRequest, IReportRootGetSharePointSiteUsageDetailRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointSiteUsageDetailCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSharePointSiteUsageDetailCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="sharepointsiteusagedetail">The SharePointSiteUsageDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointSiteUsageDetailCollectionResponse>> PatchResponseAsync(SharePointSiteUsageDetail sharepointsiteusagedetail, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSharePointSiteUsageDetailCollectionResponse>(sharepointsiteusagedetail, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="sharepointsiteusagedetail">The SharePointSiteUsageDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointSiteUsageDetailCollectionResponse>> PutResponseAsync(SharePointSiteUsageDetail sharepointsiteusagedetail, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSharePointSiteUsageDetailCollectionResponse>(sharepointsiteusagedetail, cancellationToken).ConfigureAwait(false);
        }
