...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsDgetRequest : BaseRequest, IWorkbookFunctionsDgetRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsDgetRequest.
        /// </summary>
        public WorkbookFunctionsDgetRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsDgetRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsDgetRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsDgetRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsDgetRequest Select(string value)
        {
