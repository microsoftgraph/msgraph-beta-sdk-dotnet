...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceManagementTemplateRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DeviceManagementTemplate> CreateAsync(DeviceManagementTemplate deviceManagementTemplateToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementTemplate>> CreateResponseAsync(DeviceManagementTemplate deviceManagementTemplateToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<DeviceManagementTemplate> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementTemplate}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementTemplate>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<DeviceManagementTemplate> UpdateAsync(DeviceManagementTemplate deviceManagementTemplateToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementTemplate}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementTemplate>> UpdateResponseAsync(DeviceManagementTemplate deviceManagementTemplateToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<DeviceManagementTemplate> PutAsync(DeviceManagementTemplate deviceManagementTemplateToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementTemplate>> PutResponseAsync(DeviceManagementTemplate deviceManagementTemplateToUpdate, CancellationToken cancellationToken = default);
