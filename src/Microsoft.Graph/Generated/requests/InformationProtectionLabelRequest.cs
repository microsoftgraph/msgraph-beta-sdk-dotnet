...
namespace Microsoft.Graph
{
    ...
    public partial class InformationProtectionLabelRequest : BaseRequest, IInformationProtectionLabelRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<InformationProtectionLabel>> CreateResponseAsync(InformationProtectionLabel informationProtectionLabelToCreate)
        {
            return this.CreateResponseAsync(informationProtectionLabelToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{InformationProtectionLabel}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<InformationProtectionLabel>> CreateResponseAsync(InformationProtectionLabel informationProtectionLabelToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<InformationProtectionLabel>(informationProtectionLabelToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{InformationProtectionLabel}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<InformationProtectionLabel>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{InformationProtectionLabel}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<InformationProtectionLabel>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<InformationProtectionLabel>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="informationProtectionLabelToUpdate">The InformationProtectionLabel to update.</param>
        /// <returns>The <see cref="GraphResponse{InformationProtectionLabel}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<InformationProtectionLabel>> UpdateResponseAsync(InformationProtectionLabel informationProtectionLabelToUpdate)
        {
            return this.UpdateResponseAsync(informationProtectionLabelToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{InformationProtectionLabel}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<InformationProtectionLabel>> UpdateResponseAsync(InformationProtectionLabel informationProtectionLabelToUpdate, CancellationToken cancellationToken)
        {
			if (informationProtectionLabelToUpdate.AdditionalData != null)
			{
				if (informationProtectionLabelToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<InformationProtectionLabel>(informationProtectionLabelToUpdate, cancellationToken).ConfigureAwait(false);
        }
