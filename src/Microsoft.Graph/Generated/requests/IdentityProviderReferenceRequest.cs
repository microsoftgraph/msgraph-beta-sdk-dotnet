...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class IdentityProviderReferenceRequest : BaseRequest, IIdentityProviderReferenceRequest
    {
        /// <summary>
        ...
        public IdentityProviderReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Puts the specified IdentityProvider reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The IdentityProvider reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
