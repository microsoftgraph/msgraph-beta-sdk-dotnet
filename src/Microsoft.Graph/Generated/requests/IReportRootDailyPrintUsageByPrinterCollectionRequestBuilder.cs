...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IReportRootDailyPrintUsageByPrinterCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IReportRootDailyPrintUsageByPrinterCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IReportRootDailyPrintUsageByPrinterCollectionRequest Request(IEnumerable<Option> options);
