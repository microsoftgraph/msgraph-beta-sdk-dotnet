...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceCompliancePolicyGetNoncompliantDevicesToRetireRequestBuilder.
    /// </summary>
    public partial class DeviceCompliancePolicyGetNoncompliantDevicesToRetireRequestBuilder : BaseActionMethodRequestBuilder<IDeviceCompliancePolicyGetNoncompliantDevicesToRetireRequest>, IDeviceCompliancePolicyGetNoncompliantDevicesToRetireRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceCompliancePolicyGetNoncompliantDevicesToRetireRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceCompliancePolicyGetNoncompliantDevicesToRetireRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceCompliancePolicyGetNoncompliantDevicesToRetireRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceCompliancePolicyGetNoncompliantDevicesToRetireRequest(functionUrl, this.Client, options);
