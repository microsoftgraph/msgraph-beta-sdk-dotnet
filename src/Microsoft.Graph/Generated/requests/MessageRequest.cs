...
namespace Microsoft.Graph
{
    ...
    public partial class MessageRequest : BaseRequest, IMessageRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Message>> CreateResponseAsync(Message messageToCreate)
        {
            return this.CreateResponseAsync(messageToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Message}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Message>> CreateResponseAsync(Message messageToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<Message>(messageToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="messageToUpdate">The Message to update.</param>
        /// <returns>The <see cref="GraphResponse{Message}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Message>> UpdateResponseAsync(Message messageToUpdate)
        {
            return this.UpdateResponseAsync(messageToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Message}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Message>> UpdateResponseAsync(Message messageToUpdate, CancellationToken cancellationToken)
        {
			if (messageToUpdate.AdditionalData != null)
			{
				if (messageToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<Message>(messageToUpdate, cancellationToken).ConfigureAwait(false);
        }
