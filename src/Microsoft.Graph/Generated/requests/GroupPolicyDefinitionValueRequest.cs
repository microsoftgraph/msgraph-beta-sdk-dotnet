...
namespace Microsoft.Graph
{
    ...
    public partial class GroupPolicyDefinitionValueRequest : BaseRequest, IGroupPolicyDefinitionValueRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<GroupPolicyDefinitionValue> PutAsync(GroupPolicyDefinitionValue groupPolicyDefinitionValueToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyDefinitionValue>> PutResponseAsync(GroupPolicyDefinitionValue groupPolicyDefinitionValueToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<GroupPolicyDefinitionValue>(groupPolicyDefinitionValueToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(GroupPolicyDefinitionValue groupPolicyDefinitionValueToInitialize)
        {
            ...
            if (groupPolicyDefinitionValueToInitialize != null && groupPolicyDefinitionValueToInitialize.AdditionalData != null)
            {
                ...
                if (groupPolicyDefinitionValueToInitialize.PresentationValues != null && groupPolicyDefinitionValueToInitialize.PresentationValues.CurrentPage != null)
                {
                    ...
                    if(groupPolicyDefinitionValueToInitialize.AdditionalData.TryGetValue("presentationValues@odata.nextLink", out var nextPageLink))
                    {
