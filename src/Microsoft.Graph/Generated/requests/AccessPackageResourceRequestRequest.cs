...
namespace Microsoft.Graph
{
    ...
    public partial class AccessPackageResourceRequestRequest : BaseRequest, IAccessPackageResourceRequestRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AccessPackageResourceRequestObject>> CreateResponseAsync(AccessPackageResourceRequestObject accessPackageResourceRequestObjectToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<AccessPackageResourceRequestObject> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AccessPackageResourceRequestObject}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AccessPackageResourceRequestObject>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AccessPackageResourceRequestObject}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AccessPackageResourceRequestObject>> UpdateResponseAsync(AccessPackageResourceRequestObject accessPackageResourceRequestObjectToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<AccessPackageResourceRequestObject> PutAsync(AccessPackageResourceRequestObject accessPackageResourceRequestObjectToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<AccessPackageResourceRequestObject>> PutResponseAsync(AccessPackageResourceRequestObject accessPackageResourceRequestObjectToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<AccessPackageResourceRequestObject>(accessPackageResourceRequestObjectToUpdate, cancellationToken);
