...
namespace Microsoft.Graph
{
    ...
    public partial class AccessPackageResourceRequestRequest : BaseRequest, IAccessPackageResourceRequestRequest
    {
        ...
        public async System.Threading.Tasks.Task<AccessPackageResourceRequestObject> CreateAsync(AccessPackageResourceRequestObject accessPackageResourceRequestObjectToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<AccessPackageResourceRequestObject>> CreateResponseAsync(AccessPackageResourceRequestObject accessPackageResourceRequestObjectToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        public async System.Threading.Tasks.Task<AccessPackageResourceRequestObject> UpdateAsync(AccessPackageResourceRequestObject accessPackageResourceRequestObjectToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AccessPackageResourceRequestObject}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AccessPackageResourceRequestObject>> UpdateResponseAsync(AccessPackageResourceRequestObject accessPackageResourceRequestObjectToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
