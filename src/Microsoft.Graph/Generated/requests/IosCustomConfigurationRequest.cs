...
namespace Microsoft.Graph
{
    ...
    public partial class IosCustomConfigurationRequest : BaseRequest, IIosCustomConfigurationRequest
    {
        ...
        /// <param name="iosCustomConfigurationToUpdate">The IosCustomConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{IosCustomConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosCustomConfiguration>> UpdateResponseAsync(IosCustomConfiguration iosCustomConfigurationToUpdate)
        {
            return this.UpdateResponseAsync(iosCustomConfigurationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosCustomConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosCustomConfiguration>> UpdateResponseAsync(IosCustomConfiguration iosCustomConfigurationToUpdate, CancellationToken cancellationToken)
        {
			if (iosCustomConfigurationToUpdate.AdditionalData != null)
			{
				if (iosCustomConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
