...
namespace Microsoft.Graph
{
    ...
    public partial class EmployeeRequest : BaseRequest, IEmployeeRequest
    {
        ...
        public async System.Threading.Tasks.Task<Employee> CreateAsync(Employee employeeToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Employee>> CreateResponseAsync(Employee employeeToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<Employee>(employeeToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<Employee> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Employee}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Employee>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<Employee>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<Employee> UpdateAsync(Employee employeeToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Employee}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Employee>> UpdateResponseAsync(Employee employeeToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<Employee>(employeeToUpdate, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<Employee> PutAsync(Employee employeeToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="employeeToUpdate">The Employee object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{Employee}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Employee>> PutResponseAsync(Employee employeeToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<Employee>(employeeToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(Employee employeeToInitialize)
        {
            ...
            if (employeeToInitialize != null)
            {
                if (employeeToInitialize.Picture != null && employeeToInitialize.Picture.CurrentPage != null)
                {
                    employeeToInitialize.Picture.InitializeNextPageRequest(this.Client, employeeToInitialize.PictureNextLink);
