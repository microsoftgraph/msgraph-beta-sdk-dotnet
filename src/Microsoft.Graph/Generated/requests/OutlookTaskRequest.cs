...
namespace Microsoft.Graph
{
    ...
    public partial class OutlookTaskRequest : BaseRequest, IOutlookTaskRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<OutlookTask> PutAsync(OutlookTask outlookTaskToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<OutlookTask>> PutResponseAsync(OutlookTask outlookTaskToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<OutlookTask>(outlookTaskToUpdate, cancellationToken);
