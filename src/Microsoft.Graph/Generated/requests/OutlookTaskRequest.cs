...
namespace Microsoft.Graph
{
    ...
    public partial class OutlookTaskRequest : BaseRequest, IOutlookTaskRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<OutlookTask>> CreateResponseAsync(OutlookTask outlookTaskToCreate)
        {
            return this.CreateResponseAsync(outlookTaskToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OutlookTask}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OutlookTask>> CreateResponseAsync(OutlookTask outlookTaskToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="outlookTaskToUpdate">The OutlookTask to update.</param>
        /// <returns>The <see cref="GraphResponse{OutlookTask}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OutlookTask>> UpdateResponseAsync(OutlookTask outlookTaskToUpdate)
        {
            return this.UpdateResponseAsync(outlookTaskToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{OutlookTask}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OutlookTask>> UpdateResponseAsync(OutlookTask outlookTaskToUpdate, CancellationToken cancellationToken)
        {
			if (outlookTaskToUpdate.AdditionalData != null)
			{
				if (outlookTaskToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
