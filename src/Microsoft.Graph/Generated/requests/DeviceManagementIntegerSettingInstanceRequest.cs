...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementIntegerSettingInstanceRequest : BaseRequest, IDeviceManagementIntegerSettingInstanceRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntegerSettingInstance>> CreateResponseAsync(DeviceManagementIntegerSettingInstance deviceManagementIntegerSettingInstanceToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementIntegerSettingInstance}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntegerSettingInstance>> UpdateResponseAsync(DeviceManagementIntegerSettingInstance deviceManagementIntegerSettingInstanceToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
