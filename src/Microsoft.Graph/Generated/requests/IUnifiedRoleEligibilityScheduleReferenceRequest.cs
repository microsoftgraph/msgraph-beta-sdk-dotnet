...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IUnifiedRoleEligibilityScheduleReferenceRequest : IBaseRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Puts the specified UnifiedRoleEligibilitySchedule reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The UnifiedRoleEligibilitySchedule reference reference to update.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
