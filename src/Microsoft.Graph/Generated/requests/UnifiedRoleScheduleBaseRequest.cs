...
namespace Microsoft.Graph
{
    ...
    public partial class UnifiedRoleScheduleBaseRequest : BaseRequest, IUnifiedRoleScheduleBaseRequest
    {
        ...
        public async System.Threading.Tasks.Task<UnifiedRoleScheduleBase> CreateAsync(UnifiedRoleScheduleBase unifiedRoleScheduleBaseToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UnifiedRoleScheduleBase>> CreateResponseAsync(UnifiedRoleScheduleBase unifiedRoleScheduleBaseToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<UnifiedRoleScheduleBase> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleScheduleBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UnifiedRoleScheduleBase>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<UnifiedRoleScheduleBase> UpdateAsync(UnifiedRoleScheduleBase unifiedRoleScheduleBaseToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleScheduleBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UnifiedRoleScheduleBase>> UpdateResponseAsync(UnifiedRoleScheduleBase unifiedRoleScheduleBaseToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<UnifiedRoleScheduleBase> PutAsync(UnifiedRoleScheduleBase unifiedRoleScheduleBaseToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<UnifiedRoleScheduleBase>> PutResponseAsync(UnifiedRoleScheduleBase unifiedRoleScheduleBaseToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<UnifiedRoleScheduleBase>(unifiedRoleScheduleBaseToUpdate, cancellationToken);
