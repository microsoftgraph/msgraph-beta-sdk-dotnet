...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ChatUnhideForUserRequestBuilder : BaseActionMethodRequestBuilder<IChatUnhideForUserRequest>, IChatUnhideForUserRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="ChatUnhideForUserRequestBuilder"/>.
        /// </summary>
        ...
        public ChatUnhideForUserRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IChatUnhideForUserRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new ChatUnhideForUserRequest(functionUrl, this.Client, options);
