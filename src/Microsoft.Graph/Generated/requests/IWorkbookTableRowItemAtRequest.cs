...
namespace Microsoft.Graph
{
    ...
    public partial interface IWorkbookTableRowItemAtRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<WorkbookTableRow>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="workbooktablerow">The WorkbookTableRow object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookTableRow>> PatchResponseAsync(WorkbookTableRow workbooktablerow, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="workbooktablerow">The WorkbookTableRow object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookTableRow>> PutResponseAsync(WorkbookTableRow workbooktablerow, CancellationToken cancellationToken = default(CancellationToken));
