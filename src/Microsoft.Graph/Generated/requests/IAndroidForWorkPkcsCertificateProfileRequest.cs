...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidForWorkPkcsCertificateProfileRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AndroidForWorkPkcsCertificateProfile> CreateAsync(AndroidForWorkPkcsCertificateProfile androidForWorkPkcsCertificateProfileToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkPkcsCertificateProfile>> CreateResponseAsync(AndroidForWorkPkcsCertificateProfile androidForWorkPkcsCertificateProfileToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkPkcsCertificateProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkPkcsCertificateProfile>> CreateResponseAsync(AndroidForWorkPkcsCertificateProfile androidForWorkPkcsCertificateProfileToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="androidForWorkPkcsCertificateProfileToUpdate">The AndroidForWorkPkcsCertificateProfile to update.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkPkcsCertificateProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkPkcsCertificateProfile>> UpdateResponseAsync(AndroidForWorkPkcsCertificateProfile androidForWorkPkcsCertificateProfileToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkPkcsCertificateProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkPkcsCertificateProfile>> UpdateResponseAsync(AndroidForWorkPkcsCertificateProfile androidForWorkPkcsCertificateProfileToUpdate, CancellationToken cancellationToken);
