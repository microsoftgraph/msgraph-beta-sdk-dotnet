...
namespace Microsoft.Graph
{
    ...
    public partial class PolicySetItemRequest : BaseRequest, IPolicySetItemRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PolicySetItem>> CreateResponseAsync(PolicySetItem policySetItemToCreate)
        {
            return this.CreateResponseAsync(policySetItemToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PolicySetItem}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PolicySetItem>> CreateResponseAsync(PolicySetItem policySetItemToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<PolicySetItem>(policySetItemToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{PolicySetItem}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PolicySetItem>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PolicySetItem}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PolicySetItem>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<PolicySetItem>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="policySetItemToUpdate">The PolicySetItem to update.</param>
        /// <returns>The <see cref="GraphResponse{PolicySetItem}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PolicySetItem>> UpdateResponseAsync(PolicySetItem policySetItemToUpdate)
        {
            return this.UpdateResponseAsync(policySetItemToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PolicySetItem}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PolicySetItem>> UpdateResponseAsync(PolicySetItem policySetItemToUpdate, CancellationToken cancellationToken)
        {
			if (policySetItemToUpdate.AdditionalData != null)
			{
				if (policySetItemToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<PolicySetItem>(policySetItemToUpdate, cancellationToken).ConfigureAwait(false);
        }
