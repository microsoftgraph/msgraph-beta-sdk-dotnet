...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PolicySetItemRequest.
    /// </summary>
    public partial class PolicySetItemRequest : BaseRequest, IPolicySetItemRequest
    {
        /// <summary>
        /// Constructs a new PolicySetItemRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public PolicySetItemRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public async System.Threading.Tasks.Task<PolicySetItem> CreateAsync(PolicySetItem policySetItemToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PolicySetItem>> CreateResponseAsync(PolicySetItem policySetItemToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<PolicySetItem> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PolicySetItem}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PolicySetItem>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<PolicySetItem> UpdateAsync(PolicySetItem policySetItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PolicySetItem}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PolicySetItem>> UpdateResponseAsync(PolicySetItem policySetItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<PolicySetItem> PutAsync(PolicySetItem policySetItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<PolicySetItem>> PutResponseAsync(PolicySetItem policySetItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<PolicySetItem>(policySetItemToUpdate, cancellationToken);
        ...
        public IPolicySetItemRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPolicySetItemRequest Expand(Expression<Func<PolicySetItem, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPolicySetItemRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPolicySetItemRequest Select(Expression<Func<PolicySetItem, object>> selectExpression)
        {
