...
namespace Microsoft.Graph
{
    ...
    public partial class InferenceClassificationRequest : BaseRequest, IInferenceClassificationRequest
    {
        ...
        /// <param name="inferenceClassificationToUpdate">The InferenceClassification to update.</param>
        /// <returns>The <see cref="GraphResponse{InferenceClassification}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<InferenceClassification>> UpdateResponseAsync(InferenceClassification inferenceClassificationToUpdate)
        {
            return this.UpdateResponseAsync(inferenceClassificationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{InferenceClassification}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<InferenceClassification>> UpdateResponseAsync(InferenceClassification inferenceClassificationToUpdate, CancellationToken cancellationToken)
        {
			if (inferenceClassificationToUpdate.AdditionalData != null)
			{
				if (inferenceClassificationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
