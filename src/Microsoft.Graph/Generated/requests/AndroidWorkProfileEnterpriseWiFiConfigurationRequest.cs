...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidWorkProfileEnterpriseWiFiConfigurationRequest : BaseRequest, IAndroidWorkProfileEnterpriseWiFiConfigurationRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<AndroidWorkProfileEnterpriseWiFiConfiguration> PutAsync(AndroidWorkProfileEnterpriseWiFiConfiguration androidWorkProfileEnterpriseWiFiConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<AndroidWorkProfileEnterpriseWiFiConfiguration>> PutResponseAsync(AndroidWorkProfileEnterpriseWiFiConfiguration androidWorkProfileEnterpriseWiFiConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<AndroidWorkProfileEnterpriseWiFiConfiguration>(androidWorkProfileEnterpriseWiFiConfigurationToUpdate, cancellationToken);
