...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsCombinRequest : BaseRequest, IWorkbookFunctionsCombinRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsCombinRequest.
        /// </summary>
        public WorkbookFunctionsCombinRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsCombinRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsCombinRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsCombinRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsCombinRequest Select(string value)
        {
