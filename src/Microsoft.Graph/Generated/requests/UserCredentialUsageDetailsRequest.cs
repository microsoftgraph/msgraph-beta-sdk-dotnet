...
namespace Microsoft.Graph
{
    ...
    public partial class UserCredentialUsageDetailsRequest : BaseRequest, IUserCredentialUsageDetailsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UserCredentialUsageDetails>> CreateResponseAsync(UserCredentialUsageDetails userCredentialUsageDetailsToCreate)
        {
            return this.CreateResponseAsync(userCredentialUsageDetailsToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserCredentialUsageDetails}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserCredentialUsageDetails>> CreateResponseAsync(UserCredentialUsageDetails userCredentialUsageDetailsToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<UserCredentialUsageDetails>(userCredentialUsageDetailsToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{UserCredentialUsageDetails}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserCredentialUsageDetails>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserCredentialUsageDetails}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserCredentialUsageDetails>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<UserCredentialUsageDetails>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="userCredentialUsageDetailsToUpdate">The UserCredentialUsageDetails to update.</param>
        /// <returns>The <see cref="GraphResponse{UserCredentialUsageDetails}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserCredentialUsageDetails>> UpdateResponseAsync(UserCredentialUsageDetails userCredentialUsageDetailsToUpdate)
        {
            return this.UpdateResponseAsync(userCredentialUsageDetailsToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserCredentialUsageDetails}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserCredentialUsageDetails>> UpdateResponseAsync(UserCredentialUsageDetails userCredentialUsageDetailsToUpdate, CancellationToken cancellationToken)
        {
			if (userCredentialUsageDetailsToUpdate.AdditionalData != null)
			{
				if (userCredentialUsageDetailsToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<UserCredentialUsageDetails>(userCredentialUsageDetailsToUpdate, cancellationToken).ConfigureAwait(false);
        }
