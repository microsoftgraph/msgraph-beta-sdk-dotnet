...
namespace Microsoft.Graph
{
    ...
    public partial class OrganizationalBrandingPropertiesBannerLogoRequest : BaseRequest, IOrganizationalBrandingPropertiesBannerLogoRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream bannerLogo, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = "PUT";
