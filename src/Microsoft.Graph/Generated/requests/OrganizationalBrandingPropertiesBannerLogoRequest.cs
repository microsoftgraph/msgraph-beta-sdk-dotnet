...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class OrganizationalBrandingPropertiesBannerLogoRequest : BaseRequest, IOrganizationalBrandingPropertiesBannerLogoRequest
    {
        /// <summary>
        ...
        /// </summary>
        public OrganizationalBrandingPropertiesBannerLogoRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream bannerLogo) where T : OrganizationalBrandingProperties
        {
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream bannerLogo, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream bannerLogo) where T : OrganizationalBrandingProperties
        {
            return this.PutResponseAsync<T>(bannerLogo, CancellationToken.None);
        }
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The <see cref="GraphResponse"/> object returned by the PUT call.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream bannerLogo, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
            this.ContentType = "application/octet-stream";
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<T>(bannerLogo, cancellationToken, completionOption).ConfigureAwait(false);
        }
