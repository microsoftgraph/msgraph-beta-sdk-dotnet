...
namespace Microsoft.Graph
{
    ...
    public partial interface IGraphServiceOrganizationCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<Organization>> AddResponseAsync(Organization organization);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Organization}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Organization>> AddResponseAsync(Organization organization, CancellationToken cancellationToken);
