...
namespace Microsoft.Graph
{
    ...
    public partial class ManagedEBookAssignmentRequest : BaseRequest, IManagedEBookAssignmentRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ManagedEBookAssignment>> CreateResponseAsync(ManagedEBookAssignment managedEBookAssignmentToCreate)
        {
            return this.CreateResponseAsync(managedEBookAssignmentToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ManagedEBookAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ManagedEBookAssignment>> CreateResponseAsync(ManagedEBookAssignment managedEBookAssignmentToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<ManagedEBookAssignment>(managedEBookAssignmentToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ManagedEBookAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ManagedEBookAssignment>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ManagedEBookAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ManagedEBookAssignment>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ManagedEBookAssignment>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="managedEBookAssignmentToUpdate">The ManagedEBookAssignment to update.</param>
        /// <returns>The <see cref="GraphResponse{ManagedEBookAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ManagedEBookAssignment>> UpdateResponseAsync(ManagedEBookAssignment managedEBookAssignmentToUpdate)
        {
            return this.UpdateResponseAsync(managedEBookAssignmentToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ManagedEBookAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ManagedEBookAssignment>> UpdateResponseAsync(ManagedEBookAssignment managedEBookAssignmentToUpdate, CancellationToken cancellationToken)
        {
			if (managedEBookAssignmentToUpdate.AdditionalData != null)
			{
				if (managedEBookAssignmentToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ManagedEBookAssignment>(managedEBookAssignmentToUpdate, cancellationToken).ConfigureAwait(false);
        }
