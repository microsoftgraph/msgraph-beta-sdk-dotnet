...
namespace Microsoft.Graph
{
    ...
    public partial class OfficeClientConfigurationRequest : BaseRequest, IOfficeClientConfigurationRequest
    {
        ...
        public async System.Threading.Tasks.Task<OfficeClientConfiguration> CreateAsync(OfficeClientConfiguration officeClientConfigurationToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<OfficeClientConfiguration>> CreateResponseAsync(OfficeClientConfiguration officeClientConfigurationToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<OfficeClientConfiguration>(officeClientConfigurationToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<OfficeClientConfiguration> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OfficeClientConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OfficeClientConfiguration>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<OfficeClientConfiguration>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<OfficeClientConfiguration> UpdateAsync(OfficeClientConfiguration officeClientConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{OfficeClientConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OfficeClientConfiguration>> UpdateResponseAsync(OfficeClientConfiguration officeClientConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<OfficeClientConfiguration>(officeClientConfigurationToUpdate, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<OfficeClientConfiguration> PutAsync(OfficeClientConfiguration officeClientConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="officeClientConfigurationToUpdate">The OfficeClientConfiguration object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{OfficeClientConfiguration}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OfficeClientConfiguration>> PutResponseAsync(OfficeClientConfiguration officeClientConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<OfficeClientConfiguration>(officeClientConfigurationToUpdate, cancellationToken);
