...
namespace Microsoft.Graph
{
    ...
    public partial class OfficeClientConfigurationRequest : BaseRequest, IOfficeClientConfigurationRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{OfficeClientConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OfficeClientConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OfficeClientConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OfficeClientConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<OfficeClientConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
