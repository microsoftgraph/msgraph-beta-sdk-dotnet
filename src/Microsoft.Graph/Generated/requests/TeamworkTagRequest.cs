...
namespace Microsoft.Graph
{
    ...
    public partial class TeamworkTagRequest : BaseRequest, ITeamworkTagRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{TeamworkTag}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TeamworkTag>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TeamworkTag}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<TeamworkTag>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<TeamworkTag>(null, cancellationToken).ConfigureAwait(false);
        }
