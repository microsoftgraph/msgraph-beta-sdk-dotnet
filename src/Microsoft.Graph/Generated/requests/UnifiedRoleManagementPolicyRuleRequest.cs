...
namespace Microsoft.Graph
{
    ...
    public partial class UnifiedRoleManagementPolicyRuleRequest : BaseRequest, IUnifiedRoleManagementPolicyRuleRequest
    {
        ...
        public async System.Threading.Tasks.Task<UnifiedRoleManagementPolicyRule> CreateAsync(UnifiedRoleManagementPolicyRule unifiedRoleManagementPolicyRuleToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UnifiedRoleManagementPolicyRule>> CreateResponseAsync(UnifiedRoleManagementPolicyRule unifiedRoleManagementPolicyRuleToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<UnifiedRoleManagementPolicyRule> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleManagementPolicyRule}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UnifiedRoleManagementPolicyRule>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<UnifiedRoleManagementPolicyRule> UpdateAsync(UnifiedRoleManagementPolicyRule unifiedRoleManagementPolicyRuleToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleManagementPolicyRule}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UnifiedRoleManagementPolicyRule>> UpdateResponseAsync(UnifiedRoleManagementPolicyRule unifiedRoleManagementPolicyRuleToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<UnifiedRoleManagementPolicyRule> PutAsync(UnifiedRoleManagementPolicyRule unifiedRoleManagementPolicyRuleToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<UnifiedRoleManagementPolicyRule>> PutResponseAsync(UnifiedRoleManagementPolicyRule unifiedRoleManagementPolicyRuleToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<UnifiedRoleManagementPolicyRule>(unifiedRoleManagementPolicyRuleToUpdate, cancellationToken);
