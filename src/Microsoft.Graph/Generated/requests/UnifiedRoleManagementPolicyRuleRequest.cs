...
namespace Microsoft.Graph
{
    ...
    public partial class UnifiedRoleManagementPolicyRuleRequest : BaseRequest, IUnifiedRoleManagementPolicyRuleRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<UnifiedRoleManagementPolicyRule>> CreateResponseAsync(UnifiedRoleManagementPolicyRule unifiedRoleManagementPolicyRuleToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleManagementPolicyRule}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UnifiedRoleManagementPolicyRule>> UpdateResponseAsync(UnifiedRoleManagementPolicyRule unifiedRoleManagementPolicyRuleToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
