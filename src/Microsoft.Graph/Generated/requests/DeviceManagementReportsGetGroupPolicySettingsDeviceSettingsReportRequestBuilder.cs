...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetGroupPolicySettingsDeviceSettingsReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetGroupPolicySettingsDeviceSettingsReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetGroupPolicySettingsDeviceSettingsReportRequest>, IDeviceManagementReportsGetGroupPolicySettingsDeviceSettingsReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetGroupPolicySettingsDeviceSettingsReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetGroupPolicySettingsDeviceSettingsReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetGroupPolicySettingsDeviceSettingsReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetGroupPolicySettingsDeviceSettingsReportRequest(functionUrl, this.Client, options);
