...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class CustodianRequest : BaseRequest, ICustodianRequest
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Custodian> UpdateAsync(Custodian custodianToUpdate, CancellationToken cancellationToken)
        {
			...
			{
				if (custodianToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					custodianToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, custodianToUpdate.GetType().Name)
						});
				}
			}
            if (custodianToUpdate.AdditionalData != null)
