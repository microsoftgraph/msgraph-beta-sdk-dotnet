...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookChartPointRequest : BaseRequest, IWorkbookChartPointRequest
    {
        ...
        public async System.Threading.Tasks.Task<WorkbookChartPoint> CreateAsync(WorkbookChartPoint workbookChartPointToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartPoint>> CreateResponseAsync(WorkbookChartPoint workbookChartPointToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<WorkbookChartPoint> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        public async System.Threading.Tasks.Task<WorkbookChartPoint> UpdateAsync(WorkbookChartPoint workbookChartPointToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookChartPoint}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartPoint>> UpdateResponseAsync(WorkbookChartPoint workbookChartPointToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<WorkbookChartPoint> PutAsync(WorkbookChartPoint workbookChartPointToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartPoint>> PutResponseAsync(WorkbookChartPoint workbookChartPointToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<WorkbookChartPoint>(workbookChartPointToUpdate, cancellationToken);
