...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookChartPointRequest : BaseRequest, IWorkbookChartPointRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartPoint>> CreateResponseAsync(WorkbookChartPoint workbookChartPointToCreate)
        {
            return this.CreateResponseAsync(workbookChartPointToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookChartPoint}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookChartPoint>> CreateResponseAsync(WorkbookChartPoint workbookChartPointToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<WorkbookChartPoint>(workbookChartPointToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WorkbookChartPoint}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartPoint>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookChartPoint}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookChartPoint>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WorkbookChartPoint>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="workbookChartPointToUpdate">The WorkbookChartPoint to update.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookChartPoint}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartPoint>> UpdateResponseAsync(WorkbookChartPoint workbookChartPointToUpdate)
        {
            return this.UpdateResponseAsync(workbookChartPointToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookChartPoint}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookChartPoint>> UpdateResponseAsync(WorkbookChartPoint workbookChartPointToUpdate, CancellationToken cancellationToken)
        {
			if (workbookChartPointToUpdate.AdditionalData != null)
			{
				if (workbookChartPointToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<WorkbookChartPoint>(workbookChartPointToUpdate, cancellationToken).ConfigureAwait(false);
        }
