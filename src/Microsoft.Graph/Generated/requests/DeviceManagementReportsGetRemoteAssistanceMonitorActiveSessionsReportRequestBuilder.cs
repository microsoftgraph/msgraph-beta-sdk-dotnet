...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetRemoteAssistanceMonitorActiveSessionsReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetRemoteAssistanceMonitorActiveSessionsReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetRemoteAssistanceMonitorActiveSessionsReportRequest>, IDeviceManagementReportsGetRemoteAssistanceMonitorActiveSessionsReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetRemoteAssistanceMonitorActiveSessionsReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetRemoteAssistanceMonitorActiveSessionsReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetRemoteAssistanceMonitorActiveSessionsReportRequest(functionUrl, this.Client, options);
