...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type UnifiedRoleAssignmentMultiplePrincipalsCollectionReferencesRequest.
    /// </summary>
    public partial class UnifiedRoleAssignmentMultiplePrincipalsCollectionReferencesRequest : BaseRequest, IUnifiedRoleAssignmentMultiplePrincipalsCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new UnifiedRoleAssignmentMultiplePrincipalsCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public UnifiedRoleAssignmentMultiplePrincipalsCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
