...
namespace Microsoft.Graph
{
    ...
    public partial interface IEventMessageRequest : IBaseRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{EventMessage}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EventMessage>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EventMessage}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EventMessage>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="eventMessageToUpdate">The EventMessage to update.</param>
        /// <returns>The <see cref="GraphResponse{EventMessage}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EventMessage>> UpdateResponseAsync(EventMessage eventMessageToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{EventMessage}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EventMessage>> UpdateResponseAsync(EventMessage eventMessageToUpdate, CancellationToken cancellationToken);
