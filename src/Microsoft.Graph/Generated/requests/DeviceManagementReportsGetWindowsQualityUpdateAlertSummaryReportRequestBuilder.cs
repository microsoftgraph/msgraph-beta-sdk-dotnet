...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetWindowsQualityUpdateAlertSummaryReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetWindowsQualityUpdateAlertSummaryReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetWindowsQualityUpdateAlertSummaryReportRequest>, IDeviceManagementReportsGetWindowsQualityUpdateAlertSummaryReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetWindowsQualityUpdateAlertSummaryReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetWindowsQualityUpdateAlertSummaryReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetWindowsQualityUpdateAlertSummaryReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetWindowsQualityUpdateAlertSummaryReportRequest(functionUrl, this.Client, options);
