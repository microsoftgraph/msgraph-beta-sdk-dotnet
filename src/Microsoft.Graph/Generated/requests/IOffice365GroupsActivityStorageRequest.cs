...
namespace Microsoft.Graph
{
    ...
    public partial interface IOffice365GroupsActivityStorageRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<Office365GroupsActivityStorage> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Office365GroupsActivityStorage}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityStorage>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<Office365GroupsActivityStorage> PutAsync(Office365GroupsActivityStorage office365GroupsActivityStorageToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityStorage>> PutResponseAsync(Office365GroupsActivityStorage office365GroupsActivityStorageToUpdate, CancellationToken cancellationToken = default(CancellationToken));
