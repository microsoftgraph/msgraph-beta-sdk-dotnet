...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceManagementConfigurationPolicyTemplateSettingTemplatesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DeviceManagementConfigurationSettingTemplate> AddAsync(DeviceManagementConfigurationSettingTemplate deviceManagementConfigurationSettingTemplate);
        ...
        /// <returns>The created DeviceManagementConfigurationSettingTemplate.</returns>
        System.Threading.Tasks.Task<DeviceManagementConfigurationSettingTemplate> AddAsync(DeviceManagementConfigurationSettingTemplate deviceManagementConfigurationSettingTemplate, CancellationToken cancellationToken);
        /// <summary>
        /// Gets the collection page.
        /// </summary>
        /// <returns>The collection page.</returns>
        System.Threading.Tasks.Task<IDeviceManagementConfigurationPolicyTemplateSettingTemplatesCollectionPage> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        System.Threading.Tasks.Task<IDeviceManagementConfigurationPolicyTemplateSettingTemplatesCollectionPage> GetAsync(CancellationToken cancellationToken);
