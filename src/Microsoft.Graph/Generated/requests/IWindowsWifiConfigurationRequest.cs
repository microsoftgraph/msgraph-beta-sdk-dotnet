...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsWifiConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WindowsWifiConfiguration> CreateAsync(WindowsWifiConfiguration windowsWifiConfigurationToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsWifiConfiguration>> CreateResponseAsync(WindowsWifiConfiguration windowsWifiConfigurationToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<WindowsWifiConfiguration> UpdateAsync(WindowsWifiConfiguration windowsWifiConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsWifiConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsWifiConfiguration>> UpdateResponseAsync(WindowsWifiConfiguration windowsWifiConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<WindowsWifiConfiguration> PutAsync(WindowsWifiConfiguration windowsWifiConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsWifiConfiguration>> PutResponseAsync(WindowsWifiConfiguration windowsWifiConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
