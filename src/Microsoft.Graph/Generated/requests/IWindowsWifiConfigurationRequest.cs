...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsWifiConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WindowsWifiConfiguration> CreateAsync(WindowsWifiConfiguration windowsWifiConfigurationToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsWifiConfiguration>> CreateResponseAsync(WindowsWifiConfiguration windowsWifiConfigurationToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsWifiConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsWifiConfiguration>> CreateResponseAsync(WindowsWifiConfiguration windowsWifiConfigurationToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="windowsWifiConfigurationToUpdate">The WindowsWifiConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{WindowsWifiConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsWifiConfiguration>> UpdateResponseAsync(WindowsWifiConfiguration windowsWifiConfigurationToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsWifiConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsWifiConfiguration>> UpdateResponseAsync(WindowsWifiConfiguration windowsWifiConfigurationToUpdate, CancellationToken cancellationToken);
