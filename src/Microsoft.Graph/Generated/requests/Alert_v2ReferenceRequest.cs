...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type Alert_v2ReferenceRequest.
    /// </summary>
    public partial class Alert_v2ReferenceRequest : BaseRequest, IAlert_v2ReferenceRequest
    {
        /// <summary>
        /// Constructs a new Alert_v2ReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public Alert_v2ReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified Alert_v2 reference.
        /// </summary>
        ...
        public async System.Threading.Tasks.Task DeleteAsync(CancellationToken cancellationToken = default)
        {
            ...
            await this.SendAsync<Alert_v2>(null, cancellationToken).ConfigureAwait(false);
        }

        /// <summary>
        /// Deletes the specified Alert_v2 reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified Alert_v2 reference.
        /// </summary>
        /// <param name="id">The Alert_v2 reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified Alert_v2 reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The Alert_v2 reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
