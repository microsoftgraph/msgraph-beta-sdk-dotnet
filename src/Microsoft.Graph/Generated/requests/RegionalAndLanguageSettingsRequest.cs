...
namespace Microsoft.Graph
{
    ...
    public partial class RegionalAndLanguageSettingsRequest : BaseRequest, IRegionalAndLanguageSettingsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<RegionalAndLanguageSettings>> CreateResponseAsync(RegionalAndLanguageSettings regionalAndLanguageSettingsToCreate)
        {
            return this.CreateResponseAsync(regionalAndLanguageSettingsToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{RegionalAndLanguageSettings}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<RegionalAndLanguageSettings>> CreateResponseAsync(RegionalAndLanguageSettings regionalAndLanguageSettingsToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<RegionalAndLanguageSettings>(regionalAndLanguageSettingsToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{RegionalAndLanguageSettings}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<RegionalAndLanguageSettings>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{RegionalAndLanguageSettings}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<RegionalAndLanguageSettings>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<RegionalAndLanguageSettings>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="regionalAndLanguageSettingsToUpdate">The RegionalAndLanguageSettings to update.</param>
        /// <returns>The <see cref="GraphResponse{RegionalAndLanguageSettings}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<RegionalAndLanguageSettings>> UpdateResponseAsync(RegionalAndLanguageSettings regionalAndLanguageSettingsToUpdate)
        {
            return this.UpdateResponseAsync(regionalAndLanguageSettingsToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{RegionalAndLanguageSettings}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<RegionalAndLanguageSettings>> UpdateResponseAsync(RegionalAndLanguageSettings regionalAndLanguageSettingsToUpdate, CancellationToken cancellationToken)
        {
			if (regionalAndLanguageSettingsToUpdate.AdditionalData != null)
			{
				if (regionalAndLanguageSettingsToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<RegionalAndLanguageSettings>(regionalAndLanguageSettingsToUpdate, cancellationToken).ConfigureAwait(false);
        }
