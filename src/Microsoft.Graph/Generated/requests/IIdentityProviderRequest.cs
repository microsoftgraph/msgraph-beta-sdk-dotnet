...
namespace Microsoft.Graph
{
    ...
    public partial interface IIdentityProviderRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<IdentityProvider> PutAsync(IdentityProvider identityProviderToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<IdentityProvider>> PutResponseAsync(IdentityProvider identityProviderToUpdate, CancellationToken cancellationToken = default);
