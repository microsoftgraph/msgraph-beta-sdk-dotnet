...
namespace Microsoft.Graph
{
    ...
    public partial interface IIdentityProviderRequest : IBaseRequest
    {
        ...
        /// <param name="identityProviderToUpdate">The IdentityProvider to update.</param>
        /// <returns>The <see cref="GraphResponse{IdentityProvider}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IdentityProvider>> UpdateResponseAsync(IdentityProvider identityProviderToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IdentityProvider}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IdentityProvider>> UpdateResponseAsync(IdentityProvider identityProviderToUpdate, CancellationToken cancellationToken);
