...
namespace Microsoft.Graph
{
    ...
    public partial class ProfilePhotoRequest : BaseRequest, IProfilePhotoRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<ProfilePhoto> PutAsync(ProfilePhoto profilePhotoToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<ProfilePhoto>> PutResponseAsync(ProfilePhoto profilePhotoToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ProfilePhoto>(profilePhotoToUpdate, cancellationToken);
