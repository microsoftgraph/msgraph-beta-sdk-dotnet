...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsPhone81AppXBundleRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WindowsPhone81AppXBundle> CreateAsync(WindowsPhone81AppXBundle windowsPhone81AppXBundleToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsPhone81AppXBundle>> CreateResponseAsync(WindowsPhone81AppXBundle windowsPhone81AppXBundleToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsPhone81AppXBundle}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhone81AppXBundle>> CreateResponseAsync(WindowsPhone81AppXBundle windowsPhone81AppXBundleToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WindowsPhone81AppXBundle}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhone81AppXBundle>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsPhone81AppXBundle}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhone81AppXBundle>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="windowsPhone81AppXBundleToUpdate">The WindowsPhone81AppXBundle to update.</param>
        /// <returns>The <see cref="GraphResponse{WindowsPhone81AppXBundle}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhone81AppXBundle>> UpdateResponseAsync(WindowsPhone81AppXBundle windowsPhone81AppXBundleToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsPhone81AppXBundle}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhone81AppXBundle>> UpdateResponseAsync(WindowsPhone81AppXBundle windowsPhone81AppXBundleToUpdate, CancellationToken cancellationToken);
