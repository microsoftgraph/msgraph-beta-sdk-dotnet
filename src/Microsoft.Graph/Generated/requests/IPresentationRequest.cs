...
namespace Microsoft.Graph
{
    ...
    public partial interface IPresentationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<Presentation> CreateAsync(Presentation presentationToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<Presentation>> CreateResponseAsync(Presentation presentationToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<Presentation> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Presentation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Presentation>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<Presentation> UpdateAsync(Presentation presentationToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Presentation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Presentation>> UpdateResponseAsync(Presentation presentationToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<Presentation> PutAsync(Presentation presentationToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="presentationToUpdate">The Presentation object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{Presentation}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<Presentation>> PutResponseAsync(Presentation presentationToUpdate, CancellationToken cancellationToken = default);
