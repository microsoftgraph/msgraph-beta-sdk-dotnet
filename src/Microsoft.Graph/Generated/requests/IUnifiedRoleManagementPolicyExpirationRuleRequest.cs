...
namespace Microsoft.Graph
{
    ...
    public partial interface IUnifiedRoleManagementPolicyExpirationRuleRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<UnifiedRoleManagementPolicyExpirationRule> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleManagementPolicyExpirationRule}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleManagementPolicyExpirationRule>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<UnifiedRoleManagementPolicyExpirationRule> PutAsync(UnifiedRoleManagementPolicyExpirationRule unifiedRoleManagementPolicyExpirationRuleToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleManagementPolicyExpirationRule>> PutResponseAsync(UnifiedRoleManagementPolicyExpirationRule unifiedRoleManagementPolicyExpirationRuleToUpdate, CancellationToken cancellationToken = default(CancellationToken));
