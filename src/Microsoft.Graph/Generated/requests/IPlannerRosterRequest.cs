...
namespace Microsoft.Graph
{
    ...
    public partial interface IPlannerRosterRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<PlannerRoster> CreateAsync(PlannerRoster plannerRosterToCreate);
        ...
        /// <returns>The created PlannerRoster.</returns>
        System.Threading.Tasks.Task<PlannerRoster> CreateAsync(PlannerRoster plannerRosterToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<PlannerRoster>> CreateResponseAsync(PlannerRoster plannerRosterToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PlannerRoster}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<PlannerRoster>> CreateResponseAsync(PlannerRoster plannerRosterToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<PlannerRoster> UpdateAsync(PlannerRoster plannerRosterToUpdate);
        ...
        /// <returns>The updated PlannerRoster.</returns>
        System.Threading.Tasks.Task<PlannerRoster> UpdateAsync(PlannerRoster plannerRosterToUpdate, CancellationToken cancellationToken);
        ...
        /// <param name="plannerRosterToUpdate">The PlannerRoster to update.</param>
        /// <returns>The <see cref="GraphResponse{PlannerRoster}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<PlannerRoster>> UpdateResponseAsync(PlannerRoster plannerRosterToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PlannerRoster}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<PlannerRoster>> UpdateResponseAsync(PlannerRoster plannerRosterToUpdate, CancellationToken cancellationToken);
