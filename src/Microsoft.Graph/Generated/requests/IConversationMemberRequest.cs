...
namespace Microsoft.Graph
{
    ...
    public partial interface IConversationMemberRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ConversationMember> CreateAsync(ConversationMember conversationMemberToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<ConversationMember>> CreateResponseAsync(ConversationMember conversationMemberToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ConversationMember}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ConversationMember>> CreateResponseAsync(ConversationMember conversationMemberToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ConversationMember}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ConversationMember>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ConversationMember}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ConversationMember>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="conversationMemberToUpdate">The ConversationMember to update.</param>
        /// <returns>The <see cref="GraphResponse{ConversationMember}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ConversationMember>> UpdateResponseAsync(ConversationMember conversationMemberToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ConversationMember}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ConversationMember>> UpdateResponseAsync(ConversationMember conversationMemberToUpdate, CancellationToken cancellationToken);
        ...
        IConversationMemberRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IConversationMemberRequest Expand(Expression<Func<ConversationMember, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IConversationMemberRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IConversationMemberRequest Select(Expression<Func<ConversationMember, object>> selectExpression);
