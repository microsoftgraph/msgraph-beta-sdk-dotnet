...
namespace Microsoft.Graph
{
    ...
    public partial interface IDomainDnsTxtRecordRequest : IBaseRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DomainDnsTxtRecord}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DomainDnsTxtRecord>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DomainDnsTxtRecord}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DomainDnsTxtRecord>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="domainDnsTxtRecordToUpdate">The DomainDnsTxtRecord to update.</param>
        /// <returns>The <see cref="GraphResponse{DomainDnsTxtRecord}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DomainDnsTxtRecord>> UpdateResponseAsync(DomainDnsTxtRecord domainDnsTxtRecordToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DomainDnsTxtRecord}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DomainDnsTxtRecord>> UpdateResponseAsync(DomainDnsTxtRecord domainDnsTxtRecordToUpdate, CancellationToken cancellationToken);
