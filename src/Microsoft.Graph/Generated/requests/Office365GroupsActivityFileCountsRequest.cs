...
namespace Microsoft.Graph
{
    ...
    public partial class Office365GroupsActivityFileCountsRequest : BaseRequest, IOffice365GroupsActivityFileCountsRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<Office365GroupsActivityFileCounts> PutAsync(Office365GroupsActivityFileCounts office365GroupsActivityFileCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityFileCounts>> PutResponseAsync(Office365GroupsActivityFileCounts office365GroupsActivityFileCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<Office365GroupsActivityFileCounts>(office365GroupsActivityFileCountsToUpdate, cancellationToken);
