...
namespace Microsoft.Graph
{
    ...
    public partial class Office365GroupsActivityFileCountsRequest : BaseRequest, IOffice365GroupsActivityFileCountsRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Office365GroupsActivityFileCounts}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityFileCounts>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Office365GroupsActivityFileCounts}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityFileCounts>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Office365GroupsActivityFileCounts>(null, cancellationToken).ConfigureAwait(false);
        }
