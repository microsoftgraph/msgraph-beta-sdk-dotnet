...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsQualityUpdateProfileAssignmentRequest : BaseRequest, IWindowsQualityUpdateProfileAssignmentRequest
    {
        ...
        public async System.Threading.Tasks.Task<WindowsQualityUpdateProfileAssignment> CreateAsync(WindowsQualityUpdateProfileAssignment windowsQualityUpdateProfileAssignmentToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateProfileAssignment>> CreateResponseAsync(WindowsQualityUpdateProfileAssignment windowsQualityUpdateProfileAssignmentToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<WindowsQualityUpdateProfileAssignment> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsQualityUpdateProfileAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateProfileAssignment>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<WindowsQualityUpdateProfileAssignment> UpdateAsync(WindowsQualityUpdateProfileAssignment windowsQualityUpdateProfileAssignmentToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsQualityUpdateProfileAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateProfileAssignment>> UpdateResponseAsync(WindowsQualityUpdateProfileAssignment windowsQualityUpdateProfileAssignmentToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<WindowsQualityUpdateProfileAssignment> PutAsync(WindowsQualityUpdateProfileAssignment windowsQualityUpdateProfileAssignmentToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="windowsQualityUpdateProfileAssignmentToUpdate">The WindowsQualityUpdateProfileAssignment object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{WindowsQualityUpdateProfileAssignment}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateProfileAssignment>> PutResponseAsync(WindowsQualityUpdateProfileAssignment windowsQualityUpdateProfileAssignmentToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<WindowsQualityUpdateProfileAssignment>(windowsQualityUpdateProfileAssignmentToUpdate, cancellationToken);
