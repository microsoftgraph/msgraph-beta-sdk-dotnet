...
namespace Microsoft.Graph
{
    ...
    public partial class MobileAppAssignmentRequest : BaseRequest, IMobileAppAssignmentRequest
    {
        ...
        /// <param name="mobileAppAssignmentToUpdate">The MobileAppAssignment to update.</param>
        /// <returns>The <see cref="GraphResponse{MobileAppAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MobileAppAssignment>> UpdateResponseAsync(MobileAppAssignment mobileAppAssignmentToUpdate)
        {
            return this.UpdateResponseAsync(mobileAppAssignmentToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MobileAppAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MobileAppAssignment>> UpdateResponseAsync(MobileAppAssignment mobileAppAssignmentToUpdate, CancellationToken cancellationToken)
        {
			if (mobileAppAssignmentToUpdate.AdditionalData != null)
			{
				if (mobileAppAssignmentToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
