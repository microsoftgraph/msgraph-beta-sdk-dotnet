...
namespace Microsoft.Graph
{
    ...
    public partial class TermsAndConditionsAssignmentRequest : BaseRequest, ITermsAndConditionsAssignmentRequest
    {
        ...
        public async System.Threading.Tasks.Task<TermsAndConditionsAssignment> CreateAsync(TermsAndConditionsAssignment termsAndConditionsAssignmentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<TermsAndConditionsAssignment>> CreateResponseAsync(TermsAndConditionsAssignment termsAndConditionsAssignmentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<TermsAndConditionsAssignment> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TermsAndConditionsAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TermsAndConditionsAssignment>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<TermsAndConditionsAssignment> UpdateAsync(TermsAndConditionsAssignment termsAndConditionsAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{TermsAndConditionsAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TermsAndConditionsAssignment>> UpdateResponseAsync(TermsAndConditionsAssignment termsAndConditionsAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<TermsAndConditionsAssignment> PutAsync(TermsAndConditionsAssignment termsAndConditionsAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<TermsAndConditionsAssignment>> PutResponseAsync(TermsAndConditionsAssignment termsAndConditionsAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<TermsAndConditionsAssignment>(termsAndConditionsAssignmentToUpdate, cancellationToken);
