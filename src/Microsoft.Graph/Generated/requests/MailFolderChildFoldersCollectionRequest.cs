...
namespace Microsoft.Graph
{
    ...
    public partial class MailFolderChildFoldersCollectionRequest : BaseRequest, IMailFolderChildFoldersCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MailFolderChildFoldersCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MailFolderChildFoldersCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MailFolderChildFoldersCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
