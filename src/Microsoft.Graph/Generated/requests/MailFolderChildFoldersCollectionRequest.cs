...
namespace Microsoft.Graph
{
    ...
    public partial class MailFolderChildFoldersCollectionRequest : BaseRequest, IMailFolderChildFoldersCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<MailFolderChildFoldersCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<MailFolderChildFoldersCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
