...
namespace Microsoft.Graph
{
    ...
    public partial interface IApplicationHomeRealmDiscoveryPoliciesCollectionReferencesRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task AddAsync(HomeRealmDiscoveryPolicy homeRealmDiscoveryPolicy, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="homeRealmDiscoveryPolicy">The HomeRealmDiscoveryPolicy to add.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(HomeRealmDiscoveryPolicy homeRealmDiscoveryPolicy, CancellationToken cancellationToken = default(CancellationToken));
