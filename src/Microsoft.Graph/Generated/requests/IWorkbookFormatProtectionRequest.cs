...
namespace Microsoft.Graph
{
    ...
    public partial interface IWorkbookFormatProtectionRequest : IBaseRequest
    {
        ...
        /// <param name="workbookFormatProtectionToUpdate">The WorkbookFormatProtection to update.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookFormatProtection}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookFormatProtection>> UpdateResponseAsync(WorkbookFormatProtection workbookFormatProtectionToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookFormatProtection}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookFormatProtection>> UpdateResponseAsync(WorkbookFormatProtection workbookFormatProtectionToUpdate, CancellationToken cancellationToken);
