...
namespace Microsoft.Graph
{
    ...
    public partial interface IMicrosoftStoreForBusinessContainedAppRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<MicrosoftStoreForBusinessContainedApp> CreateAsync(MicrosoftStoreForBusinessContainedApp microsoftStoreForBusinessContainedAppToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<MicrosoftStoreForBusinessContainedApp>> CreateResponseAsync(MicrosoftStoreForBusinessContainedApp microsoftStoreForBusinessContainedAppToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MicrosoftStoreForBusinessContainedApp}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MicrosoftStoreForBusinessContainedApp>> CreateResponseAsync(MicrosoftStoreForBusinessContainedApp microsoftStoreForBusinessContainedAppToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="microsoftStoreForBusinessContainedAppToUpdate">The MicrosoftStoreForBusinessContainedApp to update.</param>
        /// <returns>The <see cref="GraphResponse{MicrosoftStoreForBusinessContainedApp}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MicrosoftStoreForBusinessContainedApp>> UpdateResponseAsync(MicrosoftStoreForBusinessContainedApp microsoftStoreForBusinessContainedAppToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MicrosoftStoreForBusinessContainedApp}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MicrosoftStoreForBusinessContainedApp>> UpdateResponseAsync(MicrosoftStoreForBusinessContainedApp microsoftStoreForBusinessContainedAppToUpdate, CancellationToken cancellationToken);
