...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetSkypeForBusinessOrganizerActivityCountsRequest : BaseRequest, IReportRootGetSkypeForBusinessOrganizerActivityCountsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="skypeforbusinessorganizeractivitycounts">The SkypeForBusinessOrganizerActivityCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityCountsCollectionResponse>> PatchResponseAsync(SkypeForBusinessOrganizerActivityCounts skypeforbusinessorganizeractivitycounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="skypeforbusinessorganizeractivitycounts">The SkypeForBusinessOrganizerActivityCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityCountsCollectionResponse>> PutResponseAsync(SkypeForBusinessOrganizerActivityCounts skypeforbusinessorganizeractivitycounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityCountsCollectionResponse>(skypeforbusinessorganizeractivitycounts, cancellationToken);
        }
