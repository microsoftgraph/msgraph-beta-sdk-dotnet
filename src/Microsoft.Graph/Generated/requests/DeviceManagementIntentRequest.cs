...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementIntentRequest : BaseRequest, IDeviceManagementIntentRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntent>> CreateResponseAsync(DeviceManagementIntent deviceManagementIntentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementIntent}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntent>> UpdateResponseAsync(DeviceManagementIntent deviceManagementIntentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
