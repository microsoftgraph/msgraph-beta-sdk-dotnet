...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementIntentRequest : BaseRequest, IDeviceManagementIntentRequest
    {
        ...
        public async System.Threading.Tasks.Task<DeviceManagementIntent> CreateAsync(DeviceManagementIntent deviceManagementIntentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntent>> CreateResponseAsync(DeviceManagementIntent deviceManagementIntentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<DeviceManagementIntent> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementIntent}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntent>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<DeviceManagementIntent> UpdateAsync(DeviceManagementIntent deviceManagementIntentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementIntent}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntent>> UpdateResponseAsync(DeviceManagementIntent deviceManagementIntentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementIntent> PutAsync(DeviceManagementIntent deviceManagementIntentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntent>> PutResponseAsync(DeviceManagementIntent deviceManagementIntentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<DeviceManagementIntent>(deviceManagementIntentToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(DeviceManagementIntent deviceManagementIntentToInitialize)
        {
            ...
            if (deviceManagementIntentToInitialize != null && deviceManagementIntentToInitialize.AdditionalData != null)
            {
                ...
                if (deviceManagementIntentToInitialize.Assignments != null && deviceManagementIntentToInitialize.Assignments.CurrentPage != null)
                {
                    ...
                    if(deviceManagementIntentToInitialize.AdditionalData.TryGetValue("assignments@odata.nextLink", out var nextPageLink))
                    {
                ...
                if (deviceManagementIntentToInitialize.Categories != null && deviceManagementIntentToInitialize.Categories.CurrentPage != null)
                {
                    ...
                    if(deviceManagementIntentToInitialize.AdditionalData.TryGetValue("categories@odata.nextLink", out var nextPageLink))
                    {
                        // Ensure it is a non empty JsonElement string
                        if (nextPageLink is System.Text.Json.JsonElement element
                            && element.ValueKind == System.Text.Json.JsonValueKind.String
                ...
                if (deviceManagementIntentToInitialize.DeviceSettingStateSummaries != null && deviceManagementIntentToInitialize.DeviceSettingStateSummaries.CurrentPage != null)
                {
                    ...
                    if(deviceManagementIntentToInitialize.AdditionalData.TryGetValue("deviceSettingStateSummaries@odata.nextLink", out var nextPageLink))
                    {
                        // Ensure it is a non empty JsonElement string
                        if (nextPageLink is System.Text.Json.JsonElement element
                            && element.ValueKind == System.Text.Json.JsonValueKind.String
                ...
                if (deviceManagementIntentToInitialize.DeviceStates != null && deviceManagementIntentToInitialize.DeviceStates.CurrentPage != null)
                {
                    ...
                    if(deviceManagementIntentToInitialize.AdditionalData.TryGetValue("deviceStates@odata.nextLink", out var nextPageLink))
                    {
                        // Ensure it is a non empty JsonElement string
                        if (nextPageLink is System.Text.Json.JsonElement element
                            && element.ValueKind == System.Text.Json.JsonValueKind.String
                ...
                if (deviceManagementIntentToInitialize.Settings != null && deviceManagementIntentToInitialize.Settings.CurrentPage != null)
                {
                    ...
                    if(deviceManagementIntentToInitialize.AdditionalData.TryGetValue("settings@odata.nextLink", out var nextPageLink))
                    {
                        // Ensure it is a non empty JsonElement string
                        if (nextPageLink is System.Text.Json.JsonElement element
                            && element.ValueKind == System.Text.Json.JsonValueKind.String
                ...
                if (deviceManagementIntentToInitialize.UserStates != null && deviceManagementIntentToInitialize.UserStates.CurrentPage != null)
                {
                    ...
                    if(deviceManagementIntentToInitialize.AdditionalData.TryGetValue("userStates@odata.nextLink", out var nextPageLink))
                    {
                        // Ensure it is a non empty JsonElement string
                        if (nextPageLink is System.Text.Json.JsonElement element
                            && element.ValueKind == System.Text.Json.JsonValueKind.String
