...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementIntentRequest : BaseRequest, IDeviceManagementIntentRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntent>> CreateResponseAsync(DeviceManagementIntent deviceManagementIntentToCreate)
        {
            return this.CreateResponseAsync(deviceManagementIntentToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementIntent}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntent>> CreateResponseAsync(DeviceManagementIntent deviceManagementIntentToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DeviceManagementIntent>(deviceManagementIntentToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DeviceManagementIntent}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntent>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementIntent}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntent>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceManagementIntent>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="deviceManagementIntentToUpdate">The DeviceManagementIntent to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementIntent}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntent>> UpdateResponseAsync(DeviceManagementIntent deviceManagementIntentToUpdate)
        {
            return this.UpdateResponseAsync(deviceManagementIntentToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementIntent}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntent>> UpdateResponseAsync(DeviceManagementIntent deviceManagementIntentToUpdate, CancellationToken cancellationToken)
        {
			if (deviceManagementIntentToUpdate.AdditionalData != null)
			{
				if (deviceManagementIntentToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<DeviceManagementIntent>(deviceManagementIntentToUpdate, cancellationToken).ConfigureAwait(false);
        }
