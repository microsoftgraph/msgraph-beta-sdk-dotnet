...
namespace Microsoft.Graph
{
    ...
    public partial class UserConfigurationRequest : BaseRequest, IUserConfigurationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UserConfiguration>> CreateResponseAsync(UserConfiguration userConfigurationToCreate)
        {
            return this.CreateResponseAsync(userConfigurationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserConfiguration>> CreateResponseAsync(UserConfiguration userConfigurationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<UserConfiguration>(userConfigurationToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{UserConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<UserConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="userConfigurationToUpdate">The UserConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{UserConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserConfiguration>> UpdateResponseAsync(UserConfiguration userConfigurationToUpdate)
        {
            return this.UpdateResponseAsync(userConfigurationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserConfiguration>> UpdateResponseAsync(UserConfiguration userConfigurationToUpdate, CancellationToken cancellationToken)
        {
			if (userConfigurationToUpdate.AdditionalData != null)
			{
				if (userConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<UserConfiguration>(userConfigurationToUpdate, cancellationToken).ConfigureAwait(false);
        }
