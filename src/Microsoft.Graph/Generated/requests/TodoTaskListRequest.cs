...
namespace Microsoft.Graph
{
    ...
    public partial class TodoTaskListRequest : BaseRequest, ITodoTaskListRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<TodoTaskList> PutAsync(TodoTaskList todoTaskListToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<TodoTaskList>> PutResponseAsync(TodoTaskList todoTaskListToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<TodoTaskList>(todoTaskListToUpdate, cancellationToken);
