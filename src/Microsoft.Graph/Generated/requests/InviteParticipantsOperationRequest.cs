...
namespace Microsoft.Graph
{
    ...
    public partial class InviteParticipantsOperationRequest : BaseRequest, IInviteParticipantsOperationRequest
    {
        ...
        {
			if (inviteParticipantsOperationToUpdate.AdditionalData != null)
			{
				if (inviteParticipantsOperationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					inviteParticipantsOperationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, inviteParticipantsOperationToUpdate.GetType().Name)
						});
				}
			}
            if (inviteParticipantsOperationToUpdate.AdditionalData != null)
        ...
        /// <param name="inviteParticipantsOperationToUpdate">The InviteParticipantsOperation to update.</param>
        /// <returns>The <see cref="GraphResponse{InviteParticipantsOperation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<InviteParticipantsOperation>> UpdateResponseAsync(InviteParticipantsOperation inviteParticipantsOperationToUpdate)
        {
            return this.UpdateResponseAsync(inviteParticipantsOperationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{InviteParticipantsOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<InviteParticipantsOperation>> UpdateResponseAsync(InviteParticipantsOperation inviteParticipantsOperationToUpdate, CancellationToken cancellationToken)
        {
			if (inviteParticipantsOperationToUpdate.AdditionalData != null)
			{
				if (inviteParticipantsOperationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
