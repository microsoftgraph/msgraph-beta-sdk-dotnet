...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IDeviceManagementTemplateSettingsCollectionRequestBuilder.
    /// </summary>
    public partial interface IDeviceManagementTemplateSettingsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IDeviceManagementTemplateSettingsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IDeviceManagementTemplateSettingsCollectionRequest Request(IEnumerable<Option> options);
