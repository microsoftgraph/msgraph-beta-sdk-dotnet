...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetRelyingPartyDetailedSummaryRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetRelyingPartyDetailedSummaryCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="relyingpartydetailedsummary">The RelyingPartyDetailedSummary object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetRelyingPartyDetailedSummaryCollectionResponse>> PatchResponseAsync(RelyingPartyDetailedSummary relyingpartydetailedsummary, CancellationToken cancellationToken = default);
        ...
        /// <param name="relyingpartydetailedsummary">The RelyingPartyDetailedSummary object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetRelyingPartyDetailedSummaryCollectionResponse>> PutResponseAsync(RelyingPartyDetailedSummary relyingpartydetailedsummary, CancellationToken cancellationToken = default);
