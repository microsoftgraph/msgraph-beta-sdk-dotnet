...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type OrganizationalBrandingSquareLogoRequest.
    /// </summary>
    public partial class OrganizationalBrandingSquareLogoRequest : BaseRequest, IOrganizationalBrandingSquareLogoRequest
    {
        /// <summary>
        /// Constructs a new OrganizationalBrandingSquareLogoRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public OrganizationalBrandingSquareLogoRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream squareLogo) where T : OrganizationalBranding
        {
