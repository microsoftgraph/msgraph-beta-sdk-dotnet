...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class PrinterShareReferenceRequest : BaseRequest, IPrinterShareReferenceRequest
    {
        /// <summary>
        ...
        public PrinterShareReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified PrinterShare reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified PrinterShare reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The PrinterShare reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
