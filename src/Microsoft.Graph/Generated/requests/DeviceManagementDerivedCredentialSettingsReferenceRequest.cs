...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementDerivedCredentialSettingsReferenceRequest.
    /// </summary>
    public partial class DeviceManagementDerivedCredentialSettingsReferenceRequest : BaseRequest, IDeviceManagementDerivedCredentialSettingsReferenceRequest
    {
        /// <summary>
        /// Constructs a new DeviceManagementDerivedCredentialSettingsReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public DeviceManagementDerivedCredentialSettingsReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// </summary>
        /// <param name="id">The DeviceManagementDerivedCredentialSettings reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified DeviceManagementDerivedCredentialSettings reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The DeviceManagementDerivedCredentialSettings reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
