...
namespace Microsoft.Graph
{
    ...
    public partial interface IWorkbookChartItemRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<WorkbookChart>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="workbookchart">The WorkbookChart object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookChart>> PatchResponseAsync(WorkbookChart workbookchart, CancellationToken cancellationToken = default);
        ...
        /// <param name="workbookchart">The WorkbookChart object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookChart>> PutResponseAsync(WorkbookChart workbookchart, CancellationToken cancellationToken = default);
