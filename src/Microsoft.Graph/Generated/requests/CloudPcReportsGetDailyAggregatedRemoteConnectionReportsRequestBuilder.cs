...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type CloudPcReportsGetDailyAggregatedRemoteConnectionReportsRequestBuilder.
    /// </summary>
    public partial class CloudPcReportsGetDailyAggregatedRemoteConnectionReportsRequestBuilder : BaseActionMethodRequestBuilder<ICloudPcReportsGetDailyAggregatedRemoteConnectionReportsRequest>, ICloudPcReportsGetDailyAggregatedRemoteConnectionReportsRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="CloudPcReportsGetDailyAggregatedRemoteConnectionReportsRequestBuilder"/>.
        /// </summary>
        ...
        public CloudPcReportsGetDailyAggregatedRemoteConnectionReportsRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string filter,
        ...
        protected override ICloudPcReportsGetDailyAggregatedRemoteConnectionReportsRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new CloudPcReportsGetDailyAggregatedRemoteConnectionReportsRequest(functionUrl, this.Client, options);
