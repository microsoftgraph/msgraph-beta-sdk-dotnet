...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class SiteSourceRequest : BaseRequest, ISiteSourceRequest
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<SiteSource> UpdateAsync(SiteSource siteSourceToUpdate, CancellationToken cancellationToken)
        {
			...
			{
				if (siteSourceToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					siteSourceToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, siteSourceToUpdate.GetType().Name)
						});
				}
			}
            if (siteSourceToUpdate.AdditionalData != null)
