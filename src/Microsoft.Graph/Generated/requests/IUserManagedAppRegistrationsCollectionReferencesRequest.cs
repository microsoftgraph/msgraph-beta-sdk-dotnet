...
namespace Microsoft.Graph
{
    ...
    public partial interface IUserManagedAppRegistrationsCollectionReferencesRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task AddAsync(ManagedAppRegistration managedAppRegistration, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="managedAppRegistration">The ManagedAppRegistration to add.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(ManagedAppRegistration managedAppRegistration, CancellationToken cancellationToken = default(CancellationToken));
