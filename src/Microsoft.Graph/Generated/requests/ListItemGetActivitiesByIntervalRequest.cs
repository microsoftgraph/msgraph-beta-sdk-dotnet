...
namespace Microsoft.Graph
{
    ...
    public partial class ListItemGetActivitiesByIntervalRequest : BaseRequest, IListItemGetActivitiesByIntervalRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ListItemGetActivitiesByIntervalCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ListItemGetActivitiesByIntervalCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
