...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class PrintTaskDefinitionReferenceRequest : BaseRequest, IPrintTaskDefinitionReferenceRequest
    {
        /// <summary>
        ...
        public PrintTaskDefinitionReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Puts the specified PrintTaskDefinition reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The PrintTaskDefinition reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
