...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceCompliancePolicyDeviceStatusesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceComplianceDeviceStatus>> AddResponseAsync(DeviceComplianceDeviceStatus deviceComplianceDeviceStatus);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceComplianceDeviceStatus}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceComplianceDeviceStatus>> AddResponseAsync(DeviceComplianceDeviceStatus deviceComplianceDeviceStatus, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceCompliancePolicyDeviceStatusesCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceCompliancePolicyDeviceStatusesCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceCompliancePolicyDeviceStatusesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
