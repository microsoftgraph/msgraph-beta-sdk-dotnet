...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidDeviceOwnerGeneralDeviceConfigurationRequest : BaseRequest, IAndroidDeviceOwnerGeneralDeviceConfigurationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerGeneralDeviceConfiguration>> CreateResponseAsync(AndroidDeviceOwnerGeneralDeviceConfiguration androidDeviceOwnerGeneralDeviceConfigurationToCreate)
        {
            return this.CreateResponseAsync(androidDeviceOwnerGeneralDeviceConfigurationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceOwnerGeneralDeviceConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerGeneralDeviceConfiguration>> CreateResponseAsync(AndroidDeviceOwnerGeneralDeviceConfiguration androidDeviceOwnerGeneralDeviceConfigurationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="androidDeviceOwnerGeneralDeviceConfigurationToUpdate">The AndroidDeviceOwnerGeneralDeviceConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceOwnerGeneralDeviceConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerGeneralDeviceConfiguration>> UpdateResponseAsync(AndroidDeviceOwnerGeneralDeviceConfiguration androidDeviceOwnerGeneralDeviceConfigurationToUpdate)
        {
            return this.UpdateResponseAsync(androidDeviceOwnerGeneralDeviceConfigurationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceOwnerGeneralDeviceConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerGeneralDeviceConfiguration>> UpdateResponseAsync(AndroidDeviceOwnerGeneralDeviceConfiguration androidDeviceOwnerGeneralDeviceConfigurationToUpdate, CancellationToken cancellationToken)
        {
			if (androidDeviceOwnerGeneralDeviceConfigurationToUpdate.AdditionalData != null)
			{
				if (androidDeviceOwnerGeneralDeviceConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
