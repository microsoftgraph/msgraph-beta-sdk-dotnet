...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidDeviceOwnerGeneralDeviceConfigurationRequest : BaseRequest, IAndroidDeviceOwnerGeneralDeviceConfigurationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerGeneralDeviceConfiguration>> CreateResponseAsync(AndroidDeviceOwnerGeneralDeviceConfiguration androidDeviceOwnerGeneralDeviceConfigurationToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<AndroidDeviceOwnerGeneralDeviceConfiguration>(androidDeviceOwnerGeneralDeviceConfigurationToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<AndroidDeviceOwnerGeneralDeviceConfiguration> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceOwnerGeneralDeviceConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerGeneralDeviceConfiguration>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<AndroidDeviceOwnerGeneralDeviceConfiguration>(null, cancellationToken);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceOwnerGeneralDeviceConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerGeneralDeviceConfiguration>> UpdateResponseAsync(AndroidDeviceOwnerGeneralDeviceConfiguration androidDeviceOwnerGeneralDeviceConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<AndroidDeviceOwnerGeneralDeviceConfiguration>(androidDeviceOwnerGeneralDeviceConfigurationToUpdate, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<AndroidDeviceOwnerGeneralDeviceConfiguration> PutAsync(AndroidDeviceOwnerGeneralDeviceConfiguration androidDeviceOwnerGeneralDeviceConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="androidDeviceOwnerGeneralDeviceConfigurationToUpdate">The AndroidDeviceOwnerGeneralDeviceConfiguration object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{AndroidDeviceOwnerGeneralDeviceConfiguration}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerGeneralDeviceConfiguration>> PutResponseAsync(AndroidDeviceOwnerGeneralDeviceConfiguration androidDeviceOwnerGeneralDeviceConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<AndroidDeviceOwnerGeneralDeviceConfiguration>(androidDeviceOwnerGeneralDeviceConfigurationToUpdate, cancellationToken);
