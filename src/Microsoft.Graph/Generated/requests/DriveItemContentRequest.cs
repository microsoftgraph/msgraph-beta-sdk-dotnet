...
namespace Microsoft.Graph
{
    ...
    public partial class DriveItemContentRequest : BaseRequest, IDriveItemContentRequest
    {
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream content, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : DriveItem
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream content, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : DriveItem
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
