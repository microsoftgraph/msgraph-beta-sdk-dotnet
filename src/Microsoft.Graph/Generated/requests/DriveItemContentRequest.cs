...
namespace Microsoft.Graph
{
    ...
    public partial class DriveItemContentRequest : BaseRequest, IDriveItemContentRequest
    {
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream content, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : DriveItem
        {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream content, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : DriveItem
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = "PUT";
