...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type OnlineMeetingRecordingRequest.
    /// </summary>
    public partial class OnlineMeetingRecordingRequest : BaseRequest, IOnlineMeetingRecordingRequest
    {
        /// <summary>
        /// Constructs a new OnlineMeetingRecordingRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public OnlineMeetingRecordingRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream recording) where T : OnlineMeeting
        {
            return this.PutAsync<T>(recording, CancellationToken.None);
        }
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream recording, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnlineMeeting
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream recording) where T : OnlineMeeting
        {
            return this.PutResponseAsync<T>(recording, CancellationToken.None);
        }
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The <see cref="GraphResponse"/> object returned by the PUT call.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream recording, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnlineMeeting
        {
            this.ContentType = "application/octet-stream";
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<T>(recording, cancellationToken, completionOption).ConfigureAwait(false);
        }
