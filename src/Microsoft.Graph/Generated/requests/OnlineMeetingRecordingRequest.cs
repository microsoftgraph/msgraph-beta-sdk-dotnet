...
namespace Microsoft.Graph
{
    ...
    public partial class OnlineMeetingRecordingRequest : BaseRequest, IOnlineMeetingRecordingRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream recording, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnlineMeeting
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = Constants.HttpMethods.Put;
