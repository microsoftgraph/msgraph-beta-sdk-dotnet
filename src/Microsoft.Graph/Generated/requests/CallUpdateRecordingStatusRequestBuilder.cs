...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class CallUpdateRecordingStatusRequestBuilder : BaseActionMethodRequestBuilder<ICallUpdateRecordingStatusRequest>, ICallUpdateRecordingStatusRequestBuilder
    {
        /// <summary>
        ...
        protected override ICallUpdateRecordingStatusRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new CallUpdateRecordingStatusRequest(functionUrl, this.Client, options);

            if (this.HasParameter("status"))
            {
                request.RequestBody.Status = this.GetParameter<RecordingStatus>("status");
            }
