...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface ICallTranscriptMetadataContentRequest.
    /// </summary>
    public partial interface ICallTranscriptMetadataContentRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream metadataContent, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : CallTranscript;
        ...
        System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream metadataContent, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : CallTranscript;
