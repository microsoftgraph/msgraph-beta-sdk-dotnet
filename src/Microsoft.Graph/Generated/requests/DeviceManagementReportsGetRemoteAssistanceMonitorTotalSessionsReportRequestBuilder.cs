...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetRemoteAssistanceMonitorTotalSessionsReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetRemoteAssistanceMonitorTotalSessionsReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetRemoteAssistanceMonitorTotalSessionsReportRequest>, IDeviceManagementReportsGetRemoteAssistanceMonitorTotalSessionsReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetRemoteAssistanceMonitorTotalSessionsReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetRemoteAssistanceMonitorTotalSessionsReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetRemoteAssistanceMonitorTotalSessionsReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetRemoteAssistanceMonitorTotalSessionsReportRequest(functionUrl, this.Client, options);
