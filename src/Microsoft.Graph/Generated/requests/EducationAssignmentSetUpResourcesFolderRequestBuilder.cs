...
namespace Microsoft.Graph
{
    ...
    public partial class EducationAssignmentSetUpResourcesFolderRequestBuilder : BaseActionMethodRequestBuilder<IEducationAssignmentSetUpResourcesFolderRequest>, IEducationAssignmentSetUpResourcesFolderRequestBuilder
    {
        ...
        public EducationAssignmentSetUpResourcesFolderRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        protected override IEducationAssignmentSetUpResourcesFolderRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new EducationAssignmentSetUpResourcesFolderRequest(functionUrl, this.Client, options);
