...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceCustomAttributeShellScriptRequest : BaseRequest, IDeviceCustomAttributeShellScriptRequest
    {
        ...
        public System.Threading.Tasks.Task<DeviceCustomAttributeShellScript> CreateAsync(DeviceCustomAttributeShellScript deviceCustomAttributeShellScriptToCreate)
        {
            return this.CreateAsync(deviceCustomAttributeShellScriptToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created DeviceCustomAttributeShellScript.</returns>
        public async System.Threading.Tasks.Task<DeviceCustomAttributeShellScript> CreateAsync(DeviceCustomAttributeShellScript deviceCustomAttributeShellScriptToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceCustomAttributeShellScript>> CreateResponseAsync(DeviceCustomAttributeShellScript deviceCustomAttributeShellScriptToCreate)
        {
            return this.CreateResponseAsync(deviceCustomAttributeShellScriptToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceCustomAttributeShellScript}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceCustomAttributeShellScript>> CreateResponseAsync(DeviceCustomAttributeShellScript deviceCustomAttributeShellScriptToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DeviceCustomAttributeShellScript>(deviceCustomAttributeShellScriptToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<DeviceCustomAttributeShellScript> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The DeviceCustomAttributeShellScript.</returns>
        public async System.Threading.Tasks.Task<DeviceCustomAttributeShellScript> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DeviceCustomAttributeShellScript}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceCustomAttributeShellScript>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceCustomAttributeShellScript}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceCustomAttributeShellScript>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceCustomAttributeShellScript>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<DeviceCustomAttributeShellScript> UpdateAsync(DeviceCustomAttributeShellScript deviceCustomAttributeShellScriptToUpdate)
        {
            return this.UpdateAsync(deviceCustomAttributeShellScriptToUpdate, CancellationToken.None);
        }
        ...
        /// <returns>The updated DeviceCustomAttributeShellScript.</returns>
        public async System.Threading.Tasks.Task<DeviceCustomAttributeShellScript> UpdateAsync(DeviceCustomAttributeShellScript deviceCustomAttributeShellScriptToUpdate, CancellationToken cancellationToken)
        {
			if (deviceCustomAttributeShellScriptToUpdate.AdditionalData != null)
			{
				if (deviceCustomAttributeShellScriptToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					deviceCustomAttributeShellScriptToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, deviceCustomAttributeShellScriptToUpdate.GetType().Name)
						});
				}
			}
            if (deviceCustomAttributeShellScriptToUpdate.AdditionalData != null)
        ...
        /// <param name="deviceCustomAttributeShellScriptToUpdate">The DeviceCustomAttributeShellScript to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceCustomAttributeShellScript}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceCustomAttributeShellScript>> UpdateResponseAsync(DeviceCustomAttributeShellScript deviceCustomAttributeShellScriptToUpdate)
        {
            return this.UpdateResponseAsync(deviceCustomAttributeShellScriptToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceCustomAttributeShellScript}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceCustomAttributeShellScript>> UpdateResponseAsync(DeviceCustomAttributeShellScript deviceCustomAttributeShellScriptToUpdate, CancellationToken cancellationToken)
        {
			if (deviceCustomAttributeShellScriptToUpdate.AdditionalData != null)
			{
				if (deviceCustomAttributeShellScriptToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<DeviceCustomAttributeShellScript>(deviceCustomAttributeShellScriptToUpdate, cancellationToken).ConfigureAwait(false);
        }
