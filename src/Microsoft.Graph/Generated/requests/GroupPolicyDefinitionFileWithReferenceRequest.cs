...
namespace Microsoft.Graph
{
    ...
    public partial class GroupPolicyDefinitionFileWithReferenceRequest : BaseRequest, IGroupPolicyDefinitionFileWithReferenceRequest
    {
        ...
        /// <param name="groupPolicyDefinitionFileToCreate">The GroupPolicyDefinitionFile to create.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyDefinitionFile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyDefinitionFile>> CreateResponseAsync(GroupPolicyDefinitionFile groupPolicyDefinitionFileToCreate)
        {
            return this.CreateResponseAsync(groupPolicyDefinitionFileToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyDefinitionFile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyDefinitionFile>> CreateResponseAsync(GroupPolicyDefinitionFile groupPolicyDefinitionFileToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="groupPolicyDefinitionFileToUpdate">The GroupPolicyDefinitionFile to update.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyDefinitionFile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyDefinitionFile>> UpdateResponseAsync(GroupPolicyDefinitionFile groupPolicyDefinitionFileToUpdate)
        {
            return this.UpdateResponseAsync(groupPolicyDefinitionFileToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{GroupPolicyDefinitionFile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyDefinitionFile>> UpdateResponseAsync(GroupPolicyDefinitionFile groupPolicyDefinitionFileToUpdate, CancellationToken cancellationToken)
        {
			if (groupPolicyDefinitionFileToUpdate.AdditionalData != null)
			{
				if (groupPolicyDefinitionFileToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
