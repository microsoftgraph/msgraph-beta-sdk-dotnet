...
namespace Microsoft.Graph
{
    ...
    {
        /// <summary>
        /// Constructs a new UserActivateServicePlanRequest.
        /// </summary>
        public UserActivateServicePlanRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new UserActivateServicePlanRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public UserActivateServicePlanRequestBody RequestBody { get; private set; }
        ...
        public IUserActivateServicePlanRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IUserActivateServicePlanRequest Select(string value)
        {
