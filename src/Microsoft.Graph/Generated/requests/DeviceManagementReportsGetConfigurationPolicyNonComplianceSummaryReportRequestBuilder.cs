...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequest>, IDeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequest(functionUrl, this.Client, options);
