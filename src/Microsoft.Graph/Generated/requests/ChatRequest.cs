        ...
        private void InitializeCollectionProperties(Chat chatToInitialize)
        {
            ...
            if (chatToInitialize != null && chatToInitialize.AdditionalData != null)
            {
                ...
                if (chatToInitialize.Operations != null && chatToInitialize.Operations.CurrentPage != null)
                {
                    ...
                    object nextPageLink;
                    chatToInitialize.AdditionalData.TryGetValue("operations@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        chatToInitialize.Operations.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
                ...
                if (chatToInitialize.PermissionGrants != null && chatToInitialize.PermissionGrants.CurrentPage != null)
                {
                    ...
                    object nextPageLink;
                    chatToInitialize.AdditionalData.TryGetValue("permissionGrants@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        chatToInitialize.PermissionGrants.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
