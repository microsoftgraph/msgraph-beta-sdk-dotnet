...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidForWorkCertificateProfileBaseWithReferenceRequest : BaseRequest, IAndroidForWorkCertificateProfileBaseWithReferenceRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkCertificateProfileBase>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkCertificateProfileBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkCertificateProfileBase>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<AndroidForWorkCertificateProfileBase>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="androidForWorkCertificateProfileBaseToCreate">The AndroidForWorkCertificateProfileBase to create.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkCertificateProfileBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkCertificateProfileBase>> CreateResponseAsync(AndroidForWorkCertificateProfileBase androidForWorkCertificateProfileBaseToCreate)
        {
            return this.CreateResponseAsync(androidForWorkCertificateProfileBaseToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkCertificateProfileBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkCertificateProfileBase>> CreateResponseAsync(AndroidForWorkCertificateProfileBase androidForWorkCertificateProfileBaseToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<AndroidForWorkCertificateProfileBase>(androidForWorkCertificateProfileBaseToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
			if (androidForWorkCertificateProfileBaseToUpdate.AdditionalData != null)
			{
				if (androidForWorkCertificateProfileBaseToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					androidForWorkCertificateProfileBaseToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, androidForWorkCertificateProfileBaseToUpdate.GetType().Name)
						});
				}
			}
            if (androidForWorkCertificateProfileBaseToUpdate.AdditionalData != null)
        ...
        /// <param name="androidForWorkCertificateProfileBaseToUpdate">The AndroidForWorkCertificateProfileBase to update.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkCertificateProfileBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkCertificateProfileBase>> UpdateResponseAsync(AndroidForWorkCertificateProfileBase androidForWorkCertificateProfileBaseToUpdate)
        {
            return this.UpdateResponseAsync(androidForWorkCertificateProfileBaseToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkCertificateProfileBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkCertificateProfileBase>> UpdateResponseAsync(AndroidForWorkCertificateProfileBase androidForWorkCertificateProfileBaseToUpdate, CancellationToken cancellationToken)
        {
			if (androidForWorkCertificateProfileBaseToUpdate.AdditionalData != null)
			{
				if (androidForWorkCertificateProfileBaseToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<AndroidForWorkCertificateProfileBase>(androidForWorkCertificateProfileBaseToUpdate, cancellationToken).ConfigureAwait(false);
        }
