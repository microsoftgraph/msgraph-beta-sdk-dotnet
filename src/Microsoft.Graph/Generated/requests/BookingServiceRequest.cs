...
namespace Microsoft.Graph
{
    ...
    public partial class BookingServiceRequest : BaseRequest, IBookingServiceRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{BookingService}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<BookingService>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{BookingService}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<BookingService>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<BookingService>(null, cancellationToken).ConfigureAwait(false);
        }
