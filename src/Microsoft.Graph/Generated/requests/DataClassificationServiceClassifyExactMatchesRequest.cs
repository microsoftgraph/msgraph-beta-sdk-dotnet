...
namespace Microsoft.Graph
{
    ...
    public partial class DataClassificationServiceClassifyExactMatchesRequest : BaseRequest, IDataClassificationServiceClassifyExactMatchesRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ExactMatchClassificationResult>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<ExactMatchClassificationResult>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
