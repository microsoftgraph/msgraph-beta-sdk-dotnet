...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceManagementResourceAccessProfileAssignmentRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DeviceManagementResourceAccessProfileAssignment> CreateAsync(DeviceManagementResourceAccessProfileAssignment deviceManagementResourceAccessProfileAssignmentToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementResourceAccessProfileAssignment>> CreateResponseAsync(DeviceManagementResourceAccessProfileAssignment deviceManagementResourceAccessProfileAssignmentToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<DeviceManagementResourceAccessProfileAssignment> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementResourceAccessProfileAssignment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementResourceAccessProfileAssignment>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<DeviceManagementResourceAccessProfileAssignment> UpdateAsync(DeviceManagementResourceAccessProfileAssignment deviceManagementResourceAccessProfileAssignmentToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementResourceAccessProfileAssignment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementResourceAccessProfileAssignment>> UpdateResponseAsync(DeviceManagementResourceAccessProfileAssignment deviceManagementResourceAccessProfileAssignmentToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<DeviceManagementResourceAccessProfileAssignment> PutAsync(DeviceManagementResourceAccessProfileAssignment deviceManagementResourceAccessProfileAssignmentToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementResourceAccessProfileAssignment>> PutResponseAsync(DeviceManagementResourceAccessProfileAssignment deviceManagementResourceAccessProfileAssignmentToUpdate, CancellationToken cancellationToken = default);
