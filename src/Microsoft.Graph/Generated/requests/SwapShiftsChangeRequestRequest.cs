...
namespace Microsoft.Graph
{
    ...
    public partial class SwapShiftsChangeRequestRequest : BaseRequest, ISwapShiftsChangeRequestRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SwapShiftsChangeRequestObject>> CreateResponseAsync(SwapShiftsChangeRequestObject swapShiftsChangeRequestObjectToCreate)
        {
            return this.CreateResponseAsync(swapShiftsChangeRequestObjectToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SwapShiftsChangeRequestObject}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SwapShiftsChangeRequestObject>> CreateResponseAsync(SwapShiftsChangeRequestObject swapShiftsChangeRequestObjectToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="swapShiftsChangeRequestObjectToUpdate">The SwapShiftsChangeRequestObject to update.</param>
        /// <returns>The <see cref="GraphResponse{SwapShiftsChangeRequestObject}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SwapShiftsChangeRequestObject>> UpdateResponseAsync(SwapShiftsChangeRequestObject swapShiftsChangeRequestObjectToUpdate)
        {
            return this.UpdateResponseAsync(swapShiftsChangeRequestObjectToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SwapShiftsChangeRequestObject}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SwapShiftsChangeRequestObject>> UpdateResponseAsync(SwapShiftsChangeRequestObject swapShiftsChangeRequestObjectToUpdate, CancellationToken cancellationToken)
        {
			if (swapShiftsChangeRequestObjectToUpdate.AdditionalData != null)
			{
				if (swapShiftsChangeRequestObjectToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
