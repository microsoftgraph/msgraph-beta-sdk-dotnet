...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceCompliancePolicyGroupAssignmentRequest : BaseRequest, IDeviceCompliancePolicyGroupAssignmentRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DeviceCompliancePolicyGroupAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceCompliancePolicyGroupAssignment>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceCompliancePolicyGroupAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceCompliancePolicyGroupAssignment>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceCompliancePolicyGroupAssignment>(null, cancellationToken).ConfigureAwait(false);
        }
