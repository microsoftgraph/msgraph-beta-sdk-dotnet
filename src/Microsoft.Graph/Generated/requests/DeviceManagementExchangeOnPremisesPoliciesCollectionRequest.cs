...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementExchangeOnPremisesPoliciesCollectionRequest : BaseRequest, IDeviceManagementExchangeOnPremisesPoliciesCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<DeviceManagementExchangeOnPremisesPolicy> AddAsync(DeviceManagementExchangeOnPremisesPolicy deviceManagementExchangeOnPremisesPolicy, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementExchangeOnPremisesPolicy>> AddResponseAsync(DeviceManagementExchangeOnPremisesPolicy deviceManagementExchangeOnPremisesPolicy, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = Constants.HttpMethods.POST.ToString();
            return this.SendAsyncWithGraphResponse<DeviceManagementExchangeOnPremisesPolicy>(deviceManagementExchangeOnPremisesPolicy, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<IDeviceManagementExchangeOnPremisesPoliciesCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementExchangeOnPremisesPoliciesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.GET.ToString();
            return this.SendAsyncWithGraphResponse<DeviceManagementExchangeOnPremisesPoliciesCollectionResponse>(null, cancellationToken);
        }
