...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementExchangeOnPremisesPoliciesCollectionRequest : BaseRequest, IDeviceManagementExchangeOnPremisesPoliciesCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementExchangeOnPremisesPolicy>> AddResponseAsync(DeviceManagementExchangeOnPremisesPolicy deviceManagementExchangeOnPremisesPolicy, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementExchangeOnPremisesPoliciesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
