...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface ISoftwareUpdateStatusSummaryReferenceRequest : IBaseRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Deletes the specified SoftwareUpdateStatusSummary reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified SoftwareUpdateStatusSummary reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The SoftwareUpdateStatusSummary reference reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
