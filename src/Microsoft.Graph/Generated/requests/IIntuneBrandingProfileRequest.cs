...
namespace Microsoft.Graph
{
    ...
    public partial interface IIntuneBrandingProfileRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<IntuneBrandingProfile> CreateAsync(IntuneBrandingProfile intuneBrandingProfileToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<IntuneBrandingProfile>> CreateResponseAsync(IntuneBrandingProfile intuneBrandingProfileToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IntuneBrandingProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IntuneBrandingProfile>> CreateResponseAsync(IntuneBrandingProfile intuneBrandingProfileToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{IntuneBrandingProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IntuneBrandingProfile>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IntuneBrandingProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IntuneBrandingProfile>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="intuneBrandingProfileToUpdate">The IntuneBrandingProfile to update.</param>
        /// <returns>The <see cref="GraphResponse{IntuneBrandingProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IntuneBrandingProfile>> UpdateResponseAsync(IntuneBrandingProfile intuneBrandingProfileToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IntuneBrandingProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IntuneBrandingProfile>> UpdateResponseAsync(IntuneBrandingProfile intuneBrandingProfileToUpdate, CancellationToken cancellationToken);
