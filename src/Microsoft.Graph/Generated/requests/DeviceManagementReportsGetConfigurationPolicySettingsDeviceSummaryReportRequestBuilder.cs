...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetConfigurationPolicySettingsDeviceSummaryReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetConfigurationPolicySettingsDeviceSummaryReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetConfigurationPolicySettingsDeviceSummaryReportRequest>, IDeviceManagementReportsGetConfigurationPolicySettingsDeviceSummaryReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetConfigurationPolicySettingsDeviceSummaryReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetConfigurationPolicySettingsDeviceSummaryReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetConfigurationPolicySettingsDeviceSummaryReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetConfigurationPolicySettingsDeviceSummaryReportRequest(functionUrl, this.Client, options);
