...
namespace Microsoft.Graph
{
    ...
    public partial class DirectoryObjectCheckMemberGroupsRequest : BaseRequest, IDirectoryObjectCheckMemberGroupsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DirectoryObjectCheckMemberGroupsCollectionResponse>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DirectoryObjectCheckMemberGroupsCollectionResponse>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
