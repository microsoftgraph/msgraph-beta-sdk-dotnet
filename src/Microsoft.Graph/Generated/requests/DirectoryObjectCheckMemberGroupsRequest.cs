...
namespace Microsoft.Graph
{
    ...
    public partial class DirectoryObjectCheckMemberGroupsRequest : BaseRequest, IDirectoryObjectCheckMemberGroupsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DirectoryObjectCheckMemberGroupsCollectionResponse>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<DirectoryObjectCheckMemberGroupsCollectionResponse>(this.RequestBody, cancellationToken);
        }
