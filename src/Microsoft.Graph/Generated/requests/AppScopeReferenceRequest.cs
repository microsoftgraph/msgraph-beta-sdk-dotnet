...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class AppScopeReferenceRequest : BaseRequest, IAppScopeReferenceRequest
    {
        /// <summary>
        ...
        public AppScopeReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified AppScope reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified AppScope reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The AppScope reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
