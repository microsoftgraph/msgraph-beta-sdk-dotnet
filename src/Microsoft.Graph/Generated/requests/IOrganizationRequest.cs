...
namespace Microsoft.Graph
{
    ...
    public partial interface IOrganizationRequest : IBaseRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Organization}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Organization>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Organization}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Organization>> GetResponseAsync(CancellationToken cancellationToken);
