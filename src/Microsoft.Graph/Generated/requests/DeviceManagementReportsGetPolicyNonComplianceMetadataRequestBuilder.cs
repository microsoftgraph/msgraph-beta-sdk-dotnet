...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DeviceManagementReportsGetPolicyNonComplianceMetadataRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetPolicyNonComplianceMetadataRequest>, IDeviceManagementReportsGetPolicyNonComplianceMetadataRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetPolicyNonComplianceMetadataRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetPolicyNonComplianceMetadataRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetPolicyNonComplianceMetadataRequest(functionUrl, this.Client, options);
