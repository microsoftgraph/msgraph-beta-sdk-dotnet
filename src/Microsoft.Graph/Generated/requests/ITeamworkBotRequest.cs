...
namespace Microsoft.Graph
{
    ...
    public partial interface ITeamworkBotRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<TeamworkBot> PutAsync(TeamworkBot teamworkBotToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<TeamworkBot>> PutResponseAsync(TeamworkBot teamworkBotToUpdate, CancellationToken cancellationToken = default(CancellationToken));
