...
namespace Microsoft.Graph
{
    ...
    {
        /// <summary>
        /// Constructs a new ManagedDeviceRestoreCloudPcRequest.
        /// </summary>
        public ManagedDeviceRestoreCloudPcRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new ManagedDeviceRestoreCloudPcRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public ManagedDeviceRestoreCloudPcRequestBody RequestBody { get; private set; }
        ...
        public IManagedDeviceRestoreCloudPcRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IManagedDeviceRestoreCloudPcRequest Select(string value)
        {
