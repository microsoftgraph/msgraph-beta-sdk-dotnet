...
namespace Microsoft.Graph
{
    ...
    public partial class CalendarCalendarViewCollectionRequest : BaseRequest, ICalendarCalendarViewCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<ICalendarCalendarViewCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
        ...
        /// <summary>
        /// Gets the collection page and returns a <see cref="GraphResponse{CalendarCalendarViewCollectionResponse}"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{CalendarCalendarViewCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CalendarCalendarViewCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<CalendarCalendarViewCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
