...
namespace Microsoft.Graph
{
    ...
    public partial class CalendarCalendarViewCollectionRequest : BaseRequest, ICalendarCalendarViewCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<CalendarCalendarViewCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<CalendarCalendarViewCollectionResponse>(null, cancellationToken);
        }
