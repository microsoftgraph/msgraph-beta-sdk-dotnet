...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class PresenceSetUserPreferredPresenceRequest : BaseRequest, IPresenceSetUserPreferredPresenceRequest
    {
        /// <summary>
        /// Constructs a new PresenceSetUserPreferredPresenceRequest.
        /// </summary>
        public PresenceSetUserPreferredPresenceRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new PresenceSetUserPreferredPresenceRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public PresenceSetUserPreferredPresenceRequestBody RequestBody { get; private set; }
        ...
        public IPresenceSetUserPreferredPresenceRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPresenceSetUserPreferredPresenceRequest Select(string value)
        {
