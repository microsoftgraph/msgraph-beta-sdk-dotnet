...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ColumnDefinitionReferenceRequest : BaseRequest, IColumnDefinitionReferenceRequest
    {
        /// <summary>
        ...
        public ColumnDefinitionReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Puts the specified ColumnDefinition reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The ColumnDefinition reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
