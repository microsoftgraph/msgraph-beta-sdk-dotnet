...
namespace Microsoft.Graph
{
    ...
    public partial class ApprovalRequest : BaseRequest, IApprovalRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<Approval> PutAsync(Approval approvalToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<Approval>> PutResponseAsync(Approval approvalToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<Approval>(approvalToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(Approval approvalToInitialize)
        {
            ...
            if (approvalToInitialize != null)
            {
                ...
                {
                    approvalToInitialize.Steps.InitializeNextPageRequest(this.Client, approvalToInitialize.StepsNextLink);
