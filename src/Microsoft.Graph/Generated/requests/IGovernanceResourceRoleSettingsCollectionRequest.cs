...
namespace Microsoft.Graph
{
    ...
    public partial interface IGovernanceResourceRoleSettingsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<GovernanceResourceRoleSettingsCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GovernanceResourceRoleSettingsCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<GovernanceResourceRoleSettingsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
