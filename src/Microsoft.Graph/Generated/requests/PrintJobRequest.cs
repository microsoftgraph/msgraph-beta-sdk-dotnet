...
namespace Microsoft.Graph
{
    ...
    public partial class PrintJobRequest : BaseRequest, IPrintJobRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PrintJob>> CreateResponseAsync(PrintJob printJobToCreate)
        {
            return this.CreateResponseAsync(printJobToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PrintJob}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PrintJob>> CreateResponseAsync(PrintJob printJobToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="printJobToUpdate">The PrintJob to update.</param>
        /// <returns>The <see cref="GraphResponse{PrintJob}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PrintJob>> UpdateResponseAsync(PrintJob printJobToUpdate)
        {
            return this.UpdateResponseAsync(printJobToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PrintJob}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PrintJob>> UpdateResponseAsync(PrintJob printJobToUpdate, CancellationToken cancellationToken)
        {
			if (printJobToUpdate.AdditionalData != null)
			{
				if (printJobToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
