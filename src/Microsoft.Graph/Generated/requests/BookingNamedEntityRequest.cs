...
namespace Microsoft.Graph
{
    ...
    public partial class BookingNamedEntityRequest : BaseRequest, IBookingNamedEntityRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{BookingNamedEntity}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<BookingNamedEntity>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{BookingNamedEntity}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<BookingNamedEntity>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<BookingNamedEntity>(null, cancellationToken).ConfigureAwait(false);
        }
