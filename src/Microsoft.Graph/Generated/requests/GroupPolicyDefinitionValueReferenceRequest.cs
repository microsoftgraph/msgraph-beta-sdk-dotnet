...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type GroupPolicyDefinitionValueReferenceRequest.
    /// </summary>
    public partial class GroupPolicyDefinitionValueReferenceRequest : BaseRequest, IGroupPolicyDefinitionValueReferenceRequest
    {
        /// <summary>
        /// Constructs a new GroupPolicyDefinitionValueReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public GroupPolicyDefinitionValueReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified GroupPolicyDefinitionValue reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified GroupPolicyDefinitionValue reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified GroupPolicyDefinitionValue reference.
        /// </summary>
        /// <param name="id">The GroupPolicyDefinitionValue reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified GroupPolicyDefinitionValue reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The GroupPolicyDefinitionValue reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
