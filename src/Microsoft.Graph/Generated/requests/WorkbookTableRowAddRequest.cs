...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookTableRowAddRequest : BaseRequest, IWorkbookTableRowAddRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookTableRow>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<WorkbookTableRow>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
