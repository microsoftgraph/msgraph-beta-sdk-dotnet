...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookTableRowAddRequest : BaseRequest, IWorkbookTableRowAddRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WorkbookTableRow>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = CoreConstants.HttpMethods.POST.ToString();
            return this.SendAsyncWithGraphResponse<WorkbookTableRow>(this.RequestBody, cancellationToken);
        }
