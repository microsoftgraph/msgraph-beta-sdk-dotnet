...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetComplianceSettingsReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetComplianceSettingsReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetComplianceSettingsReportRequest>, IDeviceManagementReportsGetComplianceSettingsReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetComplianceSettingsReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetComplianceSettingsReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetComplianceSettingsReportRequest(functionUrl, this.Client, options);
