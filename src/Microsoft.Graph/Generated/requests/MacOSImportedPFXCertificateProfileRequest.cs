...
namespace Microsoft.Graph
{
    ...
    public partial class MacOSImportedPFXCertificateProfileRequest : BaseRequest, IMacOSImportedPFXCertificateProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<MacOSImportedPFXCertificateProfile>> CreateResponseAsync(MacOSImportedPFXCertificateProfile macOSImportedPFXCertificateProfileToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MacOSImportedPFXCertificateProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MacOSImportedPFXCertificateProfile>> UpdateResponseAsync(MacOSImportedPFXCertificateProfile macOSImportedPFXCertificateProfileToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
