...
namespace Microsoft.Graph
{
    ...
    public partial interface INotificationMessageTemplateLocalizedNotificationMessagesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<LocalizedNotificationMessage>> AddResponseAsync(LocalizedNotificationMessage localizedNotificationMessage);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{LocalizedNotificationMessage}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<LocalizedNotificationMessage>> AddResponseAsync(LocalizedNotificationMessage localizedNotificationMessage, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<NotificationMessageTemplateLocalizedNotificationMessagesCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{NotificationMessageTemplateLocalizedNotificationMessagesCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<NotificationMessageTemplateLocalizedNotificationMessagesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
