...
namespace Microsoft.Graph
{
    ...
    public partial interface IMobileAppContentContainedAppsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<MobileAppContentContainedAppsCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MobileAppContentContainedAppsCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<MobileAppContentContainedAppsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
