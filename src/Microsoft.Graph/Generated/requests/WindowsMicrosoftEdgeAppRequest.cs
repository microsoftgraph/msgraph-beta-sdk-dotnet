...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsMicrosoftEdgeAppRequest : BaseRequest, IWindowsMicrosoftEdgeAppRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<WindowsMicrosoftEdgeApp> PutAsync(WindowsMicrosoftEdgeApp windowsMicrosoftEdgeAppToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<WindowsMicrosoftEdgeApp>> PutResponseAsync(WindowsMicrosoftEdgeApp windowsMicrosoftEdgeAppToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<WindowsMicrosoftEdgeApp>(windowsMicrosoftEdgeAppToUpdate, cancellationToken);
