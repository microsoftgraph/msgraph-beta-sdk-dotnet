...
namespace Microsoft.Graph
{
    ...
    public partial interface ICommandRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<Command> CreateAsync(Command commandToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<Command>> CreateResponseAsync(Command commandToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Command}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Command>> CreateResponseAsync(Command commandToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="commandToUpdate">The Command to update.</param>
        /// <returns>The <see cref="GraphResponse{Command}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Command>> UpdateResponseAsync(Command commandToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Command}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Command>> UpdateResponseAsync(Command commandToUpdate, CancellationToken cancellationToken);
