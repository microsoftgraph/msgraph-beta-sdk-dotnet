...
namespace Microsoft.Graph
{
    ...
    public partial class ManagedAppConfigurationRequest : BaseRequest, IManagedAppConfigurationRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<ManagedAppConfiguration> PutAsync(ManagedAppConfiguration managedAppConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<ManagedAppConfiguration>> PutResponseAsync(ManagedAppConfiguration managedAppConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ManagedAppConfiguration>(managedAppConfigurationToUpdate, cancellationToken);
