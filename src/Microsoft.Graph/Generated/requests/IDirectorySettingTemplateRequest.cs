...
namespace Microsoft.Graph
{
    ...
    public partial interface IDirectorySettingTemplateRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DirectorySettingTemplate> CreateAsync(DirectorySettingTemplate directorySettingTemplateToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<DirectorySettingTemplate>> CreateResponseAsync(DirectorySettingTemplate directorySettingTemplateToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<DirectorySettingTemplate> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DirectorySettingTemplate}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DirectorySettingTemplate>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<DirectorySettingTemplate> UpdateAsync(DirectorySettingTemplate directorySettingTemplateToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DirectorySettingTemplate}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DirectorySettingTemplate>> UpdateResponseAsync(DirectorySettingTemplate directorySettingTemplateToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<DirectorySettingTemplate> PutAsync(DirectorySettingTemplate directorySettingTemplateToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<DirectorySettingTemplate>> PutResponseAsync(DirectorySettingTemplate directorySettingTemplateToUpdate, CancellationToken cancellationToken = default);
