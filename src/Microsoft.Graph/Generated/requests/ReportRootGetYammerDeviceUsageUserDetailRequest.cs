...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetYammerDeviceUsageUserDetailRequest : BaseRequest, IReportRootGetYammerDeviceUsageUserDetailRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerDeviceUsageUserDetailCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetYammerDeviceUsageUserDetailCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="yammerdeviceusageuserdetail">The YammerDeviceUsageUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerDeviceUsageUserDetailCollectionResponse>> PatchResponseAsync(YammerDeviceUsageUserDetail yammerdeviceusageuserdetail, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetYammerDeviceUsageUserDetailCollectionResponse>(yammerdeviceusageuserdetail, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="yammerdeviceusageuserdetail">The YammerDeviceUsageUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerDeviceUsageUserDetailCollectionResponse>> PutResponseAsync(YammerDeviceUsageUserDetail yammerdeviceusageuserdetail, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetYammerDeviceUsageUserDetailCollectionResponse>(yammerdeviceusageuserdetail, cancellationToken).ConfigureAwait(false);
        }
