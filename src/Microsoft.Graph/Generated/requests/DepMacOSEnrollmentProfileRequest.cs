...
namespace Microsoft.Graph
{
    ...
    public partial class DepMacOSEnrollmentProfileRequest : BaseRequest, IDepMacOSEnrollmentProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<DepMacOSEnrollmentProfile> CreateAsync(DepMacOSEnrollmentProfile depMacOSEnrollmentProfileToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DepMacOSEnrollmentProfile>> CreateResponseAsync(DepMacOSEnrollmentProfile depMacOSEnrollmentProfileToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<DepMacOSEnrollmentProfile>(depMacOSEnrollmentProfileToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<DepMacOSEnrollmentProfile> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DepMacOSEnrollmentProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DepMacOSEnrollmentProfile>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<DepMacOSEnrollmentProfile>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<DepMacOSEnrollmentProfile> UpdateAsync(DepMacOSEnrollmentProfile depMacOSEnrollmentProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DepMacOSEnrollmentProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DepMacOSEnrollmentProfile>> UpdateResponseAsync(DepMacOSEnrollmentProfile depMacOSEnrollmentProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<DepMacOSEnrollmentProfile>(depMacOSEnrollmentProfileToUpdate, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<DepMacOSEnrollmentProfile> PutAsync(DepMacOSEnrollmentProfile depMacOSEnrollmentProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="depMacOSEnrollmentProfileToUpdate">The DepMacOSEnrollmentProfile object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{DepMacOSEnrollmentProfile}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DepMacOSEnrollmentProfile>> PutResponseAsync(DepMacOSEnrollmentProfile depMacOSEnrollmentProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<DepMacOSEnrollmentProfile>(depMacOSEnrollmentProfileToUpdate, cancellationToken);
