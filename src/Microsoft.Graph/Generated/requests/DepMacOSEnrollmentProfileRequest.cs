...
namespace Microsoft.Graph
{
    ...
    public partial class DepMacOSEnrollmentProfileRequest : BaseRequest, IDepMacOSEnrollmentProfileRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DepMacOSEnrollmentProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DepMacOSEnrollmentProfile>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DepMacOSEnrollmentProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DepMacOSEnrollmentProfile>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DepMacOSEnrollmentProfile>(null, cancellationToken).ConfigureAwait(false);
        }
