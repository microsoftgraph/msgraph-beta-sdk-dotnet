...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceSetupConfigurationRequest : BaseRequest, IDeviceSetupConfigurationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceSetupConfiguration>> CreateResponseAsync(DeviceSetupConfiguration deviceSetupConfigurationToCreate)
        {
            return this.CreateResponseAsync(deviceSetupConfigurationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceSetupConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceSetupConfiguration>> CreateResponseAsync(DeviceSetupConfiguration deviceSetupConfigurationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        {
			if (deviceSetupConfigurationToUpdate.AdditionalData != null)
			{
				if (deviceSetupConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					deviceSetupConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, deviceSetupConfigurationToUpdate.GetType().Name)
						});
				}
			}
            if (deviceSetupConfigurationToUpdate.AdditionalData != null)
        ...
        /// <param name="deviceSetupConfigurationToUpdate">The DeviceSetupConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceSetupConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceSetupConfiguration>> UpdateResponseAsync(DeviceSetupConfiguration deviceSetupConfigurationToUpdate)
        {
            return this.UpdateResponseAsync(deviceSetupConfigurationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceSetupConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceSetupConfiguration>> UpdateResponseAsync(DeviceSetupConfiguration deviceSetupConfigurationToUpdate, CancellationToken cancellationToken)
        {
			if (deviceSetupConfigurationToUpdate.AdditionalData != null)
			{
				if (deviceSetupConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
