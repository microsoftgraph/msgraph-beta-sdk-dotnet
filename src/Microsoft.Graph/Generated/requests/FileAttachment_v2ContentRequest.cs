...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type FileAttachment_v2ContentRequest.
    /// </summary>
    public partial class FileAttachment_v2ContentRequest : BaseRequest, IFileAttachment_v2ContentRequest
    {
        /// <summary>
        /// Constructs a new FileAttachment_v2ContentRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public FileAttachment_v2ContentRequest(
            string requestUrl,
            IBaseClient client,
