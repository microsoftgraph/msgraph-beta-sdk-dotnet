...
namespace Microsoft.Graph
{
    ...
    public partial interface IAppScopeRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AppScope> CreateAsync(AppScope appScopeToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<AppScope>> CreateResponseAsync(AppScope appScopeToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AppScope}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AppScope>> CreateResponseAsync(AppScope appScopeToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="appScopeToUpdate">The AppScope to update.</param>
        /// <returns>The <see cref="GraphResponse{AppScope}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AppScope>> UpdateResponseAsync(AppScope appScopeToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AppScope}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AppScope>> UpdateResponseAsync(AppScope appScopeToUpdate, CancellationToken cancellationToken);
