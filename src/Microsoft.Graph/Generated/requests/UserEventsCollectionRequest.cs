...
namespace Microsoft.Graph
{
    ...
    public partial class UserEventsCollectionRequest : BaseRequest, IUserEventsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<IUserEventsCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
        ...
        public async System.Threading.Tasks.Task<GraphResponse<UserEventsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<UserEventsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
