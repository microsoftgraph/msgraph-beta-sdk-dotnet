...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DirectoryDefinitionRequest.
    /// </summary>
    public partial class DirectoryDefinitionRequest : BaseRequest, IDirectoryDefinitionRequest
    {
        /// <summary>
        /// Constructs a new DirectoryDefinitionRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public DirectoryDefinitionRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public async System.Threading.Tasks.Task<DirectoryDefinition> CreateAsync(DirectoryDefinition directoryDefinitionToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DirectoryDefinition>> CreateResponseAsync(DirectoryDefinition directoryDefinitionToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<DirectoryDefinition> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DirectoryDefinition}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DirectoryDefinition>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<DirectoryDefinition> UpdateAsync(DirectoryDefinition directoryDefinitionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DirectoryDefinition}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DirectoryDefinition>> UpdateResponseAsync(DirectoryDefinition directoryDefinitionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<DirectoryDefinition> PutAsync(DirectoryDefinition directoryDefinitionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<DirectoryDefinition>> PutResponseAsync(DirectoryDefinition directoryDefinitionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<DirectoryDefinition>(directoryDefinitionToUpdate, cancellationToken);
        ...
        public IDirectoryDefinitionRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDirectoryDefinitionRequest Expand(Expression<Func<DirectoryDefinition, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDirectoryDefinitionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDirectoryDefinitionRequest Select(Expression<Func<DirectoryDefinition, object>> selectExpression)
        {
        ...
        /// </summary>
        /// <param name="directoryDefinitionToInitialize">The <see cref="DirectoryDefinition"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(DirectoryDefinition directoryDefinitionToInitialize)
        {
