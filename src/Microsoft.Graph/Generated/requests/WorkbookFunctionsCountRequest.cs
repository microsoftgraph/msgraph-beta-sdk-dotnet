...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsCountRequest : BaseRequest, IWorkbookFunctionsCountRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsCountRequest.
        /// </summary>
        public WorkbookFunctionsCountRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsCountRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsCountRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsCountRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsCountRequest Select(string value)
        {
