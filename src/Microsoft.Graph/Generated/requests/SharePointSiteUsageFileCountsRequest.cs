...
namespace Microsoft.Graph
{
    ...
    public partial class SharePointSiteUsageFileCountsRequest : BaseRequest, ISharePointSiteUsageFileCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<SharePointSiteUsageFileCounts> CreateAsync(SharePointSiteUsageFileCounts sharePointSiteUsageFileCountsToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SharePointSiteUsageFileCounts>> CreateResponseAsync(SharePointSiteUsageFileCounts sharePointSiteUsageFileCountsToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<SharePointSiteUsageFileCounts> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SharePointSiteUsageFileCounts}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SharePointSiteUsageFileCounts>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<SharePointSiteUsageFileCounts> UpdateAsync(SharePointSiteUsageFileCounts sharePointSiteUsageFileCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SharePointSiteUsageFileCounts}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SharePointSiteUsageFileCounts>> UpdateResponseAsync(SharePointSiteUsageFileCounts sharePointSiteUsageFileCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<SharePointSiteUsageFileCounts> PutAsync(SharePointSiteUsageFileCounts sharePointSiteUsageFileCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<SharePointSiteUsageFileCounts>> PutResponseAsync(SharePointSiteUsageFileCounts sharePointSiteUsageFileCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SharePointSiteUsageFileCounts>(sharePointSiteUsageFileCountsToUpdate, cancellationToken);
