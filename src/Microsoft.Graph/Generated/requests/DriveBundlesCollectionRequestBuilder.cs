...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DriveBundlesCollectionRequestBuilder : BaseRequestBuilder, IDriveBundlesCollectionRequestBuilder
    {
        /// <summary>
        ...
        public DriveBundlesCollectionRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public IDriveBundlesCollectionRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public IDriveBundlesCollectionRequest Request(IEnumerable<Option> options)
        {
            return new DriveBundlesCollectionRequest(this.RequestUrl, this.Client, options);
        }
