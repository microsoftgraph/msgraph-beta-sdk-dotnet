...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class CaseOperationRequest : BaseRequest, ICaseOperationRequest
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<CaseOperation> UpdateAsync(CaseOperation caseOperationToUpdate, CancellationToken cancellationToken)
        {
			...
			{
				if (caseOperationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					caseOperationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, caseOperationToUpdate.GetType().Name)
						});
				}
			}
            if (caseOperationToUpdate.AdditionalData != null)
