...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceManagementWindowsInformationProtectionAppLearningSummariesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsInformationProtectionAppLearningSummary>> AddResponseAsync(WindowsInformationProtectionAppLearningSummary windowsInformationProtectionAppLearningSummary);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsInformationProtectionAppLearningSummary}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsInformationProtectionAppLearningSummary>> AddResponseAsync(WindowsInformationProtectionAppLearningSummary windowsInformationProtectionAppLearningSummary, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementWindowsInformationProtectionAppLearningSummariesCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementWindowsInformationProtectionAppLearningSummariesCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementWindowsInformationProtectionAppLearningSummariesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
