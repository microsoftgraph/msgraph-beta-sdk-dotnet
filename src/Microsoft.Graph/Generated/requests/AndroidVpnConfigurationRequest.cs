...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidVpnConfigurationRequest : BaseRequest, IAndroidVpnConfigurationRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AndroidVpnConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidVpnConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidVpnConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidVpnConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<AndroidVpnConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
