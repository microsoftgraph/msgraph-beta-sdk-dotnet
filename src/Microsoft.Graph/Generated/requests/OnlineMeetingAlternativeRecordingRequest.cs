...
namespace Microsoft.Graph
{
    ...
    public partial class OnlineMeetingAlternativeRecordingRequest : BaseRequest, IOnlineMeetingAlternativeRecordingRequest
    {
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream alternativeRecording, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnlineMeeting
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream alternativeRecording, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnlineMeeting
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
