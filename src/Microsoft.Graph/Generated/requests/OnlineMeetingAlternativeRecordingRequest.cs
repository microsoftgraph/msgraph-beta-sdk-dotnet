...
namespace Microsoft.Graph
{
    ...
    public partial class OnlineMeetingAlternativeRecordingRequest : BaseRequest, IOnlineMeetingAlternativeRecordingRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream alternativeRecording, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnlineMeeting
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = Constants.HttpMethods.PUT.ToString();
            return this.SendAsyncWithGraphResponse<T>(alternativeRecording, cancellationToken, completionOption);
        }
