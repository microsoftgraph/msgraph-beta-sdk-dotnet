...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsArabicRequest : BaseRequest, IWorkbookFunctionsArabicRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsArabicRequest.
        /// </summary>
        public WorkbookFunctionsArabicRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsArabicRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsArabicRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsArabicRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsArabicRequest Select(string value)
        {
