...
namespace Microsoft.Graph
{
    ...
    public partial interface IConnectedOrganizationRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<ConnectedOrganization> PutAsync(ConnectedOrganization connectedOrganizationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<ConnectedOrganization>> PutResponseAsync(ConnectedOrganization connectedOrganizationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
