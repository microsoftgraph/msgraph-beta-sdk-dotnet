...
namespace Microsoft.Graph
{
    ...
    public partial class MacOSTrustedRootCertificateWithReferenceRequest : BaseRequest, IMacOSTrustedRootCertificateWithReferenceRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MacOSTrustedRootCertificate>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MacOSTrustedRootCertificate}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MacOSTrustedRootCertificate>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<MacOSTrustedRootCertificate>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<MacOSTrustedRootCertificate> CreateAsync(MacOSTrustedRootCertificate macOSTrustedRootCertificateToCreate)
        {
            return this.CreateAsync(macOSTrustedRootCertificateToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The created MacOSTrustedRootCertificate.</returns>
        public async System.Threading.Tasks.Task<MacOSTrustedRootCertificate> CreateAsync(MacOSTrustedRootCertificate macOSTrustedRootCertificateToCreate, CancellationToken cancellationToken)
        {
        ...
        /// <param name="macOSTrustedRootCertificateToCreate">The MacOSTrustedRootCertificate to create.</param>
        /// <returns>The <see cref="GraphResponse{MacOSTrustedRootCertificate}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MacOSTrustedRootCertificate>> CreateResponseAsync(MacOSTrustedRootCertificate macOSTrustedRootCertificateToCreate)
        {
            return this.CreateResponseAsync(macOSTrustedRootCertificateToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MacOSTrustedRootCertificate}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MacOSTrustedRootCertificate>> CreateResponseAsync(MacOSTrustedRootCertificate macOSTrustedRootCertificateToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<MacOSTrustedRootCertificate>(macOSTrustedRootCertificateToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<MacOSTrustedRootCertificate> UpdateAsync(MacOSTrustedRootCertificate macOSTrustedRootCertificateToUpdate)
        {
            return this.UpdateAsync(macOSTrustedRootCertificateToUpdate, CancellationToken.None);
        }
        ...
        /// <param name="macOSTrustedRootCertificateToUpdate">The MacOSTrustedRootCertificate to update.</param>
        /// <returns>The <see cref="GraphResponse{MacOSTrustedRootCertificate}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MacOSTrustedRootCertificate>> UpdateResponseAsync(MacOSTrustedRootCertificate macOSTrustedRootCertificateToUpdate)
        {
            return this.UpdateResponseAsync(macOSTrustedRootCertificateToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MacOSTrustedRootCertificate}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MacOSTrustedRootCertificate>> UpdateResponseAsync(MacOSTrustedRootCertificate macOSTrustedRootCertificateToUpdate, CancellationToken cancellationToken)
        {
			if (macOSTrustedRootCertificateToUpdate.AdditionalData != null)
			{
				if (macOSTrustedRootCertificateToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<MacOSTrustedRootCertificate>(macOSTrustedRootCertificateToUpdate, cancellationToken).ConfigureAwait(false);
        }
