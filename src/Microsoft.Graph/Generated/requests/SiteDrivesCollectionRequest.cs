...
namespace Microsoft.Graph
{
    ...
    public partial class SiteDrivesCollectionRequest : BaseRequest, ISiteDrivesCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<ISiteDrivesCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SiteDrivesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<SiteDrivesCollectionResponse>(null, cancellationToken);
        }
