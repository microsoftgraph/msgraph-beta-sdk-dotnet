...
namespace Microsoft.Graph
{
    ...
    public partial interface IRestrictedSignInRequest : IBaseRequest
    {
        ...
        /// <param name="restrictedSignInToUpdate">The RestrictedSignIn to update.</param>
        /// <returns>The <see cref="GraphResponse{RestrictedSignIn}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<RestrictedSignIn>> UpdateResponseAsync(RestrictedSignIn restrictedSignInToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{RestrictedSignIn}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<RestrictedSignIn>> UpdateResponseAsync(RestrictedSignIn restrictedSignInToUpdate, CancellationToken cancellationToken);
