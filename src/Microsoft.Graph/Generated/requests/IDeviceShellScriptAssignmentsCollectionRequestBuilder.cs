...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IDeviceShellScriptAssignmentsCollectionRequestBuilder.
    /// </summary>
    public partial interface IDeviceShellScriptAssignmentsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IDeviceShellScriptAssignmentsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IDeviceShellScriptAssignmentsCollectionRequest Request(IEnumerable<Option> options);
