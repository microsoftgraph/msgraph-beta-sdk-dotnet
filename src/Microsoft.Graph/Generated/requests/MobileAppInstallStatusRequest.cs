...
namespace Microsoft.Graph
{
    ...
    public partial class MobileAppInstallStatusRequest : BaseRequest, IMobileAppInstallStatusRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<MobileAppInstallStatus>> CreateResponseAsync(MobileAppInstallStatus mobileAppInstallStatusToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MobileAppInstallStatus}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MobileAppInstallStatus>> UpdateResponseAsync(MobileAppInstallStatus mobileAppInstallStatusToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
