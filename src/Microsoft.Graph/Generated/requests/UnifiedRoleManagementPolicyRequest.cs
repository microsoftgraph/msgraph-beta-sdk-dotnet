...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class UnifiedRoleManagementPolicyRequest : BaseRequest, IUnifiedRoleManagementPolicyRequest
    {
        /// <summary>
        ...
        public UnifiedRoleManagementPolicyRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<UnifiedRoleManagementPolicy> PutAsync(UnifiedRoleManagementPolicy unifiedRoleManagementPolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <summary>
        /// Updates the specified UnifiedRoleManagementPolicy using PUT and returns a <see cref="GraphResponse{UnifiedRoleManagementPolicy}"/> object.
        /// </summary>
        /// <param name="unifiedRoleManagementPolicyToUpdate">The UnifiedRoleManagementPolicy object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{UnifiedRoleManagementPolicy}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UnifiedRoleManagementPolicy>> PutResponseAsync(UnifiedRoleManagementPolicy unifiedRoleManagementPolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<UnifiedRoleManagementPolicy>(unifiedRoleManagementPolicyToUpdate, cancellationToken);
        ...
        public IUnifiedRoleManagementPolicyRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IUnifiedRoleManagementPolicyRequest Expand(Expression<Func<UnifiedRoleManagementPolicy, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IUnifiedRoleManagementPolicyRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IUnifiedRoleManagementPolicyRequest Select(Expression<Func<UnifiedRoleManagementPolicy, object>> selectExpression)
        {
        ...
        /// </summary>
        /// <param name="unifiedRoleManagementPolicyToInitialize">The <see cref="UnifiedRoleManagementPolicy"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(UnifiedRoleManagementPolicy unifiedRoleManagementPolicyToInitialize)
        {
            ...
            if (unifiedRoleManagementPolicyToInitialize != null && unifiedRoleManagementPolicyToInitialize.AdditionalData != null)
            {
                ...
                if (unifiedRoleManagementPolicyToInitialize.EffectiveRules != null && unifiedRoleManagementPolicyToInitialize.EffectiveRules.CurrentPage != null)
                {
                    ...
                    if(unifiedRoleManagementPolicyToInitialize.AdditionalData.TryGetValue("effectiveRules@odata.nextLink", out var nextPageLink))
                    {
                ...
                if (unifiedRoleManagementPolicyToInitialize.Rules != null && unifiedRoleManagementPolicyToInitialize.Rules.CurrentPage != null)
                {
                    ...
                    if(unifiedRoleManagementPolicyToInitialize.AdditionalData.TryGetValue("rules@odata.nextLink", out var nextPageLink))
                    {
                        // Ensure it is a non empty JsonElement string
                        if (nextPageLink is System.Text.Json.JsonElement element
                            && element.ValueKind == System.Text.Json.JsonValueKind.String
