...
namespace Microsoft.Graph
{
    ...
    public partial class ConversationMemberRequest : BaseRequest, IConversationMemberRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<ConversationMember> PutAsync(ConversationMember conversationMemberToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<ConversationMember>> PutResponseAsync(ConversationMember conversationMemberToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ConversationMember>(conversationMemberToUpdate, cancellationToken);
