...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsMultiNomialRequest : BaseRequest, IWorkbookFunctionsMultiNomialRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsMultiNomialRequest.
        /// </summary>
        public WorkbookFunctionsMultiNomialRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsMultiNomialRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsMultiNomialRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsMultiNomialRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsMultiNomialRequest Select(string value)
        {
