...
namespace Microsoft.Graph
{
    ...
    public partial class PictureContentRequest : BaseRequest, IPictureContentRequest
    {
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream content, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : Picture
        {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream content, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : Picture
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = "PUT";
