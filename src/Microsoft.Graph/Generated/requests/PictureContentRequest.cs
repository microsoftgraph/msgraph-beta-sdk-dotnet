...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PictureContentRequest.
    /// </summary>
    public partial class PictureContentRequest : BaseRequest, IPictureContentRequest
    {
        /// <summary>
        /// Constructs a new PictureContentRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public PictureContentRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream content) where T : Picture
        {
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream content, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : Picture
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream content) where T : Picture
        {
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The <see cref="GraphResponse"/> object returned by the PUT call.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream content, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : Picture
        {
            this.ContentType = "application/octet-stream";
            this.Method = "PUT";
