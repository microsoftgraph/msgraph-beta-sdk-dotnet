...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementScriptRequest : BaseRequest, IDeviceManagementScriptRequest
    {
        ...
        public async System.Threading.Tasks.Task<DeviceManagementScript> CreateAsync(DeviceManagementScript deviceManagementScriptToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementScript>> CreateResponseAsync(DeviceManagementScript deviceManagementScriptToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<DeviceManagementScript> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementScript}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementScript>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<DeviceManagementScript> UpdateAsync(DeviceManagementScript deviceManagementScriptToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementScript}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementScript>> UpdateResponseAsync(DeviceManagementScript deviceManagementScriptToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementScript> PutAsync(DeviceManagementScript deviceManagementScriptToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="deviceManagementScriptToUpdate">The DeviceManagementScript object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{DeviceManagementScript}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementScript>> PutResponseAsync(DeviceManagementScript deviceManagementScriptToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<DeviceManagementScript>(deviceManagementScriptToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(DeviceManagementScript deviceManagementScriptToInitialize)
        {
            ...
            if (deviceManagementScriptToInitialize != null)
            {
                if (deviceManagementScriptToInitialize.Assignments != null && deviceManagementScriptToInitialize.Assignments.CurrentPage != null)
                {
                    deviceManagementScriptToInitialize.Assignments.InitializeNextPageRequest(this.Client, deviceManagementScriptToInitialize.AssignmentsNextLink);
                ...
                {
                    deviceManagementScriptToInitialize.DeviceRunStates.InitializeNextPageRequest(this.Client, deviceManagementScriptToInitialize.DeviceRunStatesNextLink);
                    // Copy the additional data collection to the page itself so that information is not lost
                ...
                {
                    deviceManagementScriptToInitialize.GroupAssignments.InitializeNextPageRequest(this.Client, deviceManagementScriptToInitialize.GroupAssignmentsNextLink);
                    // Copy the additional data collection to the page itself so that information is not lost
                ...
                {
                    deviceManagementScriptToInitialize.UserRunStates.InitializeNextPageRequest(this.Client, deviceManagementScriptToInitialize.UserRunStatesNextLink);
                    // Copy the additional data collection to the page itself so that information is not lost
