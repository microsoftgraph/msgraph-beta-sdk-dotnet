...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementScriptRequest : BaseRequest, IDeviceManagementScriptRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementScript>> CreateResponseAsync(DeviceManagementScript deviceManagementScriptToCreate)
        {
            return this.CreateResponseAsync(deviceManagementScriptToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementScript}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementScript>> CreateResponseAsync(DeviceManagementScript deviceManagementScriptToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DeviceManagementScript>(deviceManagementScriptToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DeviceManagementScript}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementScript>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementScript}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementScript>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceManagementScript>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="deviceManagementScriptToUpdate">The DeviceManagementScript to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementScript}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementScript>> UpdateResponseAsync(DeviceManagementScript deviceManagementScriptToUpdate)
        {
            return this.UpdateResponseAsync(deviceManagementScriptToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementScript}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementScript>> UpdateResponseAsync(DeviceManagementScript deviceManagementScriptToUpdate, CancellationToken cancellationToken)
        {
			if (deviceManagementScriptToUpdate.AdditionalData != null)
			{
				if (deviceManagementScriptToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<DeviceManagementScript>(deviceManagementScriptToUpdate, cancellationToken).ConfigureAwait(false);
        }
