...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetAppsInstallSummaryReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetAppsInstallSummaryReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetAppsInstallSummaryReportRequest>, IDeviceManagementReportsGetAppsInstallSummaryReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetAppsInstallSummaryReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetAppsInstallSummaryReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetAppsInstallSummaryReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetAppsInstallSummaryReportRequest(functionUrl, this.Client, options);
