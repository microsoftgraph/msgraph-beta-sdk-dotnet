...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementScriptAssignmentRequest : BaseRequest, IDeviceManagementScriptAssignmentRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementScriptAssignment>> CreateResponseAsync(DeviceManagementScriptAssignment deviceManagementScriptAssignmentToCreate)
        {
            return this.CreateResponseAsync(deviceManagementScriptAssignmentToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementScriptAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementScriptAssignment>> CreateResponseAsync(DeviceManagementScriptAssignment deviceManagementScriptAssignmentToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="deviceManagementScriptAssignmentToUpdate">The DeviceManagementScriptAssignment to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementScriptAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementScriptAssignment>> UpdateResponseAsync(DeviceManagementScriptAssignment deviceManagementScriptAssignmentToUpdate)
        {
            return this.UpdateResponseAsync(deviceManagementScriptAssignmentToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementScriptAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementScriptAssignment>> UpdateResponseAsync(DeviceManagementScriptAssignment deviceManagementScriptAssignmentToUpdate, CancellationToken cancellationToken)
        {
			if (deviceManagementScriptAssignmentToUpdate.AdditionalData != null)
			{
				if (deviceManagementScriptAssignmentToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
