...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsEvenRequest : BaseRequest, IWorkbookFunctionsEvenRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsEvenRequest.
        /// </summary>
        public WorkbookFunctionsEvenRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsEvenRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsEvenRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsEvenRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsEvenRequest Select(string value)
        {
