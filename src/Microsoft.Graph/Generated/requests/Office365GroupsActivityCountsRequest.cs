...
namespace Microsoft.Graph
{
    ...
    public partial class Office365GroupsActivityCountsRequest : BaseRequest, IOffice365GroupsActivityCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityCounts>> CreateResponseAsync(Office365GroupsActivityCounts office365GroupsActivityCountsToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Office365GroupsActivityCounts}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityCounts>> UpdateResponseAsync(Office365GroupsActivityCounts office365GroupsActivityCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
