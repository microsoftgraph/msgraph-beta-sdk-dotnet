...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ServiceUpdateMessageAttachmentsArchiveRequest : BaseRequest, IServiceUpdateMessageAttachmentsArchiveRequest
    {
        /// <summary>
        ...
        /// </summary>
        public ServiceUpdateMessageAttachmentsArchiveRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream attachmentsArchive, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : ServiceUpdateMessage
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
            return this.SendAsync<T>(attachmentsArchive, cancellationToken, completionOption);
        }
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream attachmentsArchive, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : ServiceUpdateMessage
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<T>(attachmentsArchive, cancellationToken, completionOption);
        }
