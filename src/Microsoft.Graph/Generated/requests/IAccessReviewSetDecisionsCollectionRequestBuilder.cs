...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IAccessReviewSetDecisionsCollectionRequestBuilder.
    /// </summary>
    public partial interface IAccessReviewSetDecisionsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IAccessReviewSetDecisionsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IAccessReviewSetDecisionsCollectionRequest Request(IEnumerable<Option> options);
