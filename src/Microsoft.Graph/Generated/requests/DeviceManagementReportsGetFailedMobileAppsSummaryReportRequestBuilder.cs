...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetFailedMobileAppsSummaryReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetFailedMobileAppsSummaryReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetFailedMobileAppsSummaryReportRequest>, IDeviceManagementReportsGetFailedMobileAppsSummaryReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetFailedMobileAppsSummaryReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetFailedMobileAppsSummaryReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetFailedMobileAppsSummaryReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetFailedMobileAppsSummaryReportRequest(functionUrl, this.Client, options);
