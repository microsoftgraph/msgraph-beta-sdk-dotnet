...
namespace Microsoft.Graph
{
    ...
    public partial interface IPrintUsageByPrinterRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<PrintUsageByPrinter> CreateAsync(PrintUsageByPrinter printUsageByPrinterToCreate);
        ...
        /// <returns>The created PrintUsageByPrinter.</returns>
        System.Threading.Tasks.Task<PrintUsageByPrinter> CreateAsync(PrintUsageByPrinter printUsageByPrinterToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<PrintUsageByPrinter>> CreateResponseAsync(PrintUsageByPrinter printUsageByPrinterToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PrintUsageByPrinter}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<PrintUsageByPrinter>> CreateResponseAsync(PrintUsageByPrinter printUsageByPrinterToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<PrintUsageByPrinter> UpdateAsync(PrintUsageByPrinter printUsageByPrinterToUpdate);
        ...
        /// <returns>The updated PrintUsageByPrinter.</returns>
        System.Threading.Tasks.Task<PrintUsageByPrinter> UpdateAsync(PrintUsageByPrinter printUsageByPrinterToUpdate, CancellationToken cancellationToken);
        ...
        /// <param name="printUsageByPrinterToUpdate">The PrintUsageByPrinter to update.</param>
        /// <returns>The <see cref="GraphResponse{PrintUsageByPrinter}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<PrintUsageByPrinter>> UpdateResponseAsync(PrintUsageByPrinter printUsageByPrinterToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PrintUsageByPrinter}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<PrintUsageByPrinter>> UpdateResponseAsync(PrintUsageByPrinter printUsageByPrinterToUpdate, CancellationToken cancellationToken);
