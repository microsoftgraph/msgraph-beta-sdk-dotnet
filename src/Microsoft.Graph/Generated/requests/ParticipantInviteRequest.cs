...
namespace Microsoft.Graph
{
    ...
    public partial class ParticipantInviteRequest : BaseRequest, IParticipantInviteRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<InviteParticipantsOperation>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<InviteParticipantsOperation>(this.RequestBody, cancellationToken);
        }
