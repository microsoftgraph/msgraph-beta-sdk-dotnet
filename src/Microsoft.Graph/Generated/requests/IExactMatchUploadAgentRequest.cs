...
namespace Microsoft.Graph
{
    ...
    public partial interface IExactMatchUploadAgentRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ExactMatchUploadAgent> CreateAsync(ExactMatchUploadAgent exactMatchUploadAgentToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<ExactMatchUploadAgent>> CreateResponseAsync(ExactMatchUploadAgent exactMatchUploadAgentToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ExactMatchUploadAgent> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ExactMatchUploadAgent}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ExactMatchUploadAgent>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ExactMatchUploadAgent> UpdateAsync(ExactMatchUploadAgent exactMatchUploadAgentToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ExactMatchUploadAgent}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ExactMatchUploadAgent>> UpdateResponseAsync(ExactMatchUploadAgent exactMatchUploadAgentToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<ExactMatchUploadAgent> PutAsync(ExactMatchUploadAgent exactMatchUploadAgentToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<ExactMatchUploadAgent>> PutResponseAsync(ExactMatchUploadAgent exactMatchUploadAgentToUpdate, CancellationToken cancellationToken = default);
