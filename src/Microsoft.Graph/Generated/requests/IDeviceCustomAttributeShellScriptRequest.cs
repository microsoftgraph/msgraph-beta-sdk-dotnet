...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceCustomAttributeShellScriptRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DeviceCustomAttributeShellScript> CreateAsync(DeviceCustomAttributeShellScript deviceCustomAttributeShellScriptToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceCustomAttributeShellScript>> CreateResponseAsync(DeviceCustomAttributeShellScript deviceCustomAttributeShellScriptToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceCustomAttributeShellScript}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceCustomAttributeShellScript>> CreateResponseAsync(DeviceCustomAttributeShellScript deviceCustomAttributeShellScriptToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DeviceCustomAttributeShellScript}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceCustomAttributeShellScript>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceCustomAttributeShellScript}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceCustomAttributeShellScript>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="deviceCustomAttributeShellScriptToUpdate">The DeviceCustomAttributeShellScript to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceCustomAttributeShellScript}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceCustomAttributeShellScript>> UpdateResponseAsync(DeviceCustomAttributeShellScript deviceCustomAttributeShellScriptToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceCustomAttributeShellScript}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceCustomAttributeShellScript>> UpdateResponseAsync(DeviceCustomAttributeShellScript deviceCustomAttributeShellScriptToUpdate, CancellationToken cancellationToken);
