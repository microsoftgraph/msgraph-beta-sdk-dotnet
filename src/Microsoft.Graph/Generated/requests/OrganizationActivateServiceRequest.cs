...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    [Obsolete("The activateService API will be deprecated and will stop returning data on Oct-15, 2022")]
    public partial class OrganizationActivateServiceRequest : BaseRequest, IOrganizationActivateServiceRequest
    {
        /// <summary>
        /// Constructs a new OrganizationActivateServiceRequest.
        /// </summary>
        public OrganizationActivateServiceRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new OrganizationActivateServiceRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public OrganizationActivateServiceRequestBody RequestBody { get; private set; }
        ...
        public IOrganizationActivateServiceRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IOrganizationActivateServiceRequest Select(string value)
        {
