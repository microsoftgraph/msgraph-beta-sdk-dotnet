...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceCategoryRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<DeviceCategory> PutAsync(DeviceCategory deviceCategoryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceCategory>> PutResponseAsync(DeviceCategory deviceCategoryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
