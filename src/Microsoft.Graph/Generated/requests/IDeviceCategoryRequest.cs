...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceCategoryRequest : IBaseRequest
    {
        ...
        /// <param name="deviceCategoryToUpdate">The DeviceCategory to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceCategory}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceCategory>> UpdateResponseAsync(DeviceCategory deviceCategoryToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceCategory}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceCategory>> UpdateResponseAsync(DeviceCategory deviceCategoryToUpdate, CancellationToken cancellationToken);
