...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetFailedMobileAppsReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetFailedMobileAppsReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetFailedMobileAppsReportRequest>, IDeviceManagementReportsGetFailedMobileAppsReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetFailedMobileAppsReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetFailedMobileAppsReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetFailedMobileAppsReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetFailedMobileAppsReportRequest(functionUrl, this.Client, options);
