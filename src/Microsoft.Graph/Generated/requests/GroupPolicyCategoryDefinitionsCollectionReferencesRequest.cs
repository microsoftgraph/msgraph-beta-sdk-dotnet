...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type GroupPolicyCategoryDefinitionsCollectionReferencesRequest.
    /// </summary>
    public partial class GroupPolicyCategoryDefinitionsCollectionReferencesRequest : BaseRequest, IGroupPolicyCategoryDefinitionsCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new GroupPolicyCategoryDefinitionsCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public GroupPolicyCategoryDefinitionsCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
