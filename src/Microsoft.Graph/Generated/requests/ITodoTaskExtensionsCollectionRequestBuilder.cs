...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface ITodoTaskExtensionsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        ITodoTaskExtensionsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        ITodoTaskExtensionsCollectionRequest Request(IEnumerable<Option> options);
