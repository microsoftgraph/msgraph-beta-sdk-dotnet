...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsBitorRequest : BaseRequest, IWorkbookFunctionsBitorRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsBitorRequest.
        /// </summary>
        public WorkbookFunctionsBitorRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsBitorRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsBitorRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsBitorRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsBitorRequest Select(string value)
        {
