...
namespace Microsoft.Graph
{
    ...
    public partial class MobileAppCategoriesCollectionReferencesRequest : BaseRequest, IMobileAppCategoriesCollectionReferencesRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(MobileAppCategory mobileAppCategory)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
        public System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(MobileAppCategory mobileAppCategory, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
