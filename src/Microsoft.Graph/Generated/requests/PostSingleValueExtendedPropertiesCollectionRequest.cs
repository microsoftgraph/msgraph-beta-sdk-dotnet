...
namespace Microsoft.Graph
{
    ...
    public partial class PostSingleValueExtendedPropertiesCollectionRequest : BaseRequest, IPostSingleValueExtendedPropertiesCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<IPostSingleValueExtendedPropertiesCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
        ...
        /// <summary>
        /// Gets the collection page and returns a <see cref="GraphResponse{PostSingleValueExtendedPropertiesCollectionResponse}"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PostSingleValueExtendedPropertiesCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PostSingleValueExtendedPropertiesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<PostSingleValueExtendedPropertiesCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
