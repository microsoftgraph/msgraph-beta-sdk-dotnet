...
namespace Microsoft.Graph
{
    ...
    public partial class PostSingleValueExtendedPropertiesCollectionRequest : BaseRequest, IPostSingleValueExtendedPropertiesCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PostSingleValueExtendedPropertiesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.GET.ToString();
            return this.SendAsyncWithGraphResponse<PostSingleValueExtendedPropertiesCollectionResponse>(null, cancellationToken);
        }
