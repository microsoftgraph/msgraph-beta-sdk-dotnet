...
namespace Microsoft.Graph
{
    ...
    public partial class PrivilegedRoleRequest : BaseRequest, IPrivilegedRoleRequest
    {
        ...
        public async System.Threading.Tasks.Task<PrivilegedRole> CreateAsync(PrivilegedRole privilegedRoleToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PrivilegedRole>> CreateResponseAsync(PrivilegedRole privilegedRoleToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<PrivilegedRole>(privilegedRoleToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<PrivilegedRole> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary>
        /// Gets the specified PrivilegedRole and returns a <see cref="GraphResponse{PrivilegedRole}"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PrivilegedRole}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PrivilegedRole>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<PrivilegedRole>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<PrivilegedRole> UpdateAsync(PrivilegedRole privilegedRoleToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PrivilegedRole}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PrivilegedRole>> UpdateResponseAsync(PrivilegedRole privilegedRoleToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<PrivilegedRole>(privilegedRoleToUpdate, cancellationToken);
        }

        /// <summary>
        /// Updates the specified PrivilegedRole using PUT.
        /// </summary>
        /// <param name="privilegedRoleToUpdate">The PrivilegedRole object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<PrivilegedRole> PutAsync(PrivilegedRole privilegedRoleToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <summary>
        /// Updates the specified PrivilegedRole using PUT and returns a <see cref="GraphResponse{PrivilegedRole}"/> object.
        /// </summary>
        /// <param name="privilegedRoleToUpdate">The PrivilegedRole object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{PrivilegedRole}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PrivilegedRole>> PutResponseAsync(PrivilegedRole privilegedRoleToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<PrivilegedRole>(privilegedRoleToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(PrivilegedRole privilegedRoleToInitialize)
        {
            ...
            if (privilegedRoleToInitialize != null)
            {
                if (privilegedRoleToInitialize.Assignments != null && privilegedRoleToInitialize.Assignments.CurrentPage != null)
                {
                    privilegedRoleToInitialize.Assignments.InitializeNextPageRequest(this.Client, privilegedRoleToInitialize.AssignmentsNextLink);
