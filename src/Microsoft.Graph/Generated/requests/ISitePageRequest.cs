...
namespace Microsoft.Graph
{
    ...
    public partial interface ISitePageRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SitePage> CreateAsync(SitePage sitePageToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<SitePage>> CreateResponseAsync(SitePage sitePageToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<SitePage> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SitePage}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SitePage>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<SitePage> UpdateAsync(SitePage sitePageToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SitePage}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SitePage>> UpdateResponseAsync(SitePage sitePageToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<SitePage> PutAsync(SitePage sitePageToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="sitePageToUpdate">The SitePage object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{SitePage}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<SitePage>> PutResponseAsync(SitePage sitePageToUpdate, CancellationToken cancellationToken = default);
