...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IIdentityProviderBaseReferenceRequest : IBaseRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Puts the specified IdentityProviderBase reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The IdentityProviderBase reference reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
