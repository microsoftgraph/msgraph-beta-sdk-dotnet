...
namespace Microsoft.Graph
{
    ...
    public partial class CalendarGroupRequest : BaseRequest, ICalendarGroupRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<CalendarGroup> PutAsync(CalendarGroup calendarGroupToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<CalendarGroup>> PutResponseAsync(CalendarGroup calendarGroupToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<CalendarGroup>(calendarGroupToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(CalendarGroup calendarGroupToInitialize)
        {
            ...
            if (calendarGroupToInitialize != null && calendarGroupToInitialize.AdditionalData != null)
            {
                ...
                if (calendarGroupToInitialize.Calendars != null && calendarGroupToInitialize.Calendars.CurrentPage != null)
                {
                    ...
                    if(calendarGroupToInitialize.AdditionalData.TryGetValue("calendars@odata.nextLink", out var nextPageLink))
                    {
