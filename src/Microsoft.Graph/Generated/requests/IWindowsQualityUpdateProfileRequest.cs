...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsQualityUpdateProfileRequest : IBaseRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WindowsQualityUpdateProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateProfile>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsQualityUpdateProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateProfile>> GetResponseAsync(CancellationToken cancellationToken);
