...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type SalesQuoteLineRequestBuilder.
    /// </summary>
    public partial class SalesQuoteLineRequestBuilder : EntityRequestBuilder, ISalesQuoteLineRequestBuilder
    {

        /// <summary>
        /// Constructs a new SalesQuoteLineRequestBuilder.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        public SalesQuoteLineRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public new ISalesQuoteLineRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public new ISalesQuoteLineRequest Request(IEnumerable<Option> options)
        {
            return new SalesQuoteLineRequest(this.RequestUrl, this.Client, options);
        }
