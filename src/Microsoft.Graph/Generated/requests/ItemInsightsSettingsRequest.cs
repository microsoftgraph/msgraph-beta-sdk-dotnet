...
namespace Microsoft.Graph
{
    ...
    public partial class ItemInsightsSettingsRequest : BaseRequest, IItemInsightsSettingsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ItemInsightsSettings>> CreateResponseAsync(ItemInsightsSettings itemInsightsSettingsToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ItemInsightsSettings}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ItemInsightsSettings>> UpdateResponseAsync(ItemInsightsSettings itemInsightsSettingsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
