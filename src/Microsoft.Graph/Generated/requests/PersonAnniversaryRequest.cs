...
namespace Microsoft.Graph
{
    ...
    public partial class PersonAnniversaryRequest : BaseRequest, IPersonAnniversaryRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<PersonAnniversary>> CreateResponseAsync(PersonAnniversary personAnniversaryToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PersonAnniversary}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PersonAnniversary>> UpdateResponseAsync(PersonAnniversary personAnniversaryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
