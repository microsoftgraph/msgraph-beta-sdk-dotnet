...
namespace Microsoft.Graph
{
    ...
    public partial class PersonAnniversaryRequest : BaseRequest, IPersonAnniversaryRequest
    {
        ...
        public async System.Threading.Tasks.Task<PersonAnniversary> CreateAsync(PersonAnniversary personAnniversaryToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PersonAnniversary>> CreateResponseAsync(PersonAnniversary personAnniversaryToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = Constants.HttpMethods.POST.ToString();
            return this.SendAsyncWithGraphResponse<PersonAnniversary>(personAnniversaryToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<PersonAnniversary> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PersonAnniversary}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PersonAnniversary>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.GET.ToString();
            return this.SendAsyncWithGraphResponse<PersonAnniversary>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<PersonAnniversary> UpdateAsync(PersonAnniversary personAnniversaryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PersonAnniversary}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PersonAnniversary>> UpdateResponseAsync(PersonAnniversary personAnniversaryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = Constants.HttpMethods.PATCH.ToString();
            return this.SendAsyncWithGraphResponse<PersonAnniversary>(personAnniversaryToUpdate, cancellationToken);
        }
