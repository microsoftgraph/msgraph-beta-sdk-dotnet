...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ConditionalAccessPolicyReferenceRequest.
    /// </summary>
    public partial class ConditionalAccessPolicyReferenceRequest : BaseRequest, IConditionalAccessPolicyReferenceRequest
    {
        /// <summary>
        /// Constructs a new ConditionalAccessPolicyReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ConditionalAccessPolicyReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified ConditionalAccessPolicy reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified ConditionalAccessPolicy reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified ConditionalAccessPolicy reference.
        /// </summary>
        /// <param name="id">The ConditionalAccessPolicy reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified ConditionalAccessPolicy reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The ConditionalAccessPolicy reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
