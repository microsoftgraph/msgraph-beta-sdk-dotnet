...
namespace Microsoft.Graph
{
    ...
    public partial interface IMicrosoftTunnelHealthThresholdRequest : IBaseRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{MicrosoftTunnelHealthThreshold}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelHealthThreshold>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MicrosoftTunnelHealthThreshold}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelHealthThreshold>> GetResponseAsync(CancellationToken cancellationToken);
