...
namespace Microsoft.Graph
{
    ...
    public partial interface IWebAccountRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WebAccount> CreateAsync(WebAccount webAccountToCreate);
        ...
        /// <returns>The created WebAccount.</returns>
        System.Threading.Tasks.Task<WebAccount> CreateAsync(WebAccount webAccountToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<WebAccount>> CreateResponseAsync(WebAccount webAccountToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WebAccount}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WebAccount>> CreateResponseAsync(WebAccount webAccountToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<WebAccount> UpdateAsync(WebAccount webAccountToUpdate);
        ...
        /// <returns>The updated WebAccount.</returns>
        System.Threading.Tasks.Task<WebAccount> UpdateAsync(WebAccount webAccountToUpdate, CancellationToken cancellationToken);
        ...
        /// <param name="webAccountToUpdate">The WebAccount to update.</param>
        /// <returns>The <see cref="GraphResponse{WebAccount}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WebAccount>> UpdateResponseAsync(WebAccount webAccountToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WebAccount}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WebAccount>> UpdateResponseAsync(WebAccount webAccountToUpdate, CancellationToken cancellationToken);
