...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetConfigManagerDevicePolicyStatusReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetConfigManagerDevicePolicyStatusReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetConfigManagerDevicePolicyStatusReportRequest>, IDeviceManagementReportsGetConfigManagerDevicePolicyStatusReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetConfigManagerDevicePolicyStatusReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetConfigManagerDevicePolicyStatusReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetConfigManagerDevicePolicyStatusReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetConfigManagerDevicePolicyStatusReportRequest(functionUrl, this.Client, options);
