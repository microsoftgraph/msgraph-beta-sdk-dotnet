...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetRemoteAssistanceSessionsReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetRemoteAssistanceSessionsReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetRemoteAssistanceSessionsReportRequest>, IDeviceManagementReportsGetRemoteAssistanceSessionsReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetRemoteAssistanceSessionsReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetRemoteAssistanceSessionsReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetRemoteAssistanceSessionsReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetRemoteAssistanceSessionsReportRequest(functionUrl, this.Client, options);
