...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookWorksheetProtectionRequest : BaseRequest, IWorkbookWorksheetProtectionRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WorkbookWorksheetProtection}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookWorksheetProtection>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookWorksheetProtection}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookWorksheetProtection>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WorkbookWorksheetProtection>(null, cancellationToken).ConfigureAwait(false);
        }
