...
namespace Microsoft.Graph
{
    ...
    public partial class Windows10XSCEPCertificateProfileRequest : BaseRequest, IWindows10XSCEPCertificateProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<Windows10XSCEPCertificateProfile> CreateAsync(Windows10XSCEPCertificateProfile windows10XSCEPCertificateProfileToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows10XSCEPCertificateProfile>> CreateResponseAsync(Windows10XSCEPCertificateProfile windows10XSCEPCertificateProfileToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<Windows10XSCEPCertificateProfile> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows10XSCEPCertificateProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows10XSCEPCertificateProfile>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<Windows10XSCEPCertificateProfile> UpdateAsync(Windows10XSCEPCertificateProfile windows10XSCEPCertificateProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Windows10XSCEPCertificateProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows10XSCEPCertificateProfile>> UpdateResponseAsync(Windows10XSCEPCertificateProfile windows10XSCEPCertificateProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<Windows10XSCEPCertificateProfile> PutAsync(Windows10XSCEPCertificateProfile windows10XSCEPCertificateProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows10XSCEPCertificateProfile>> PutResponseAsync(Windows10XSCEPCertificateProfile windows10XSCEPCertificateProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<Windows10XSCEPCertificateProfile>(windows10XSCEPCertificateProfileToUpdate, cancellationToken);
