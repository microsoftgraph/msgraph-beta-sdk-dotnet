...
namespace Microsoft.Graph
{
    ...
    public partial class WebAppRequest : BaseRequest, IWebAppRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WebApp}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WebApp>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WebApp}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WebApp>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WebApp>(null, cancellationToken).ConfigureAwait(false);
        }
