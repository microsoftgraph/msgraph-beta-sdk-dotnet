...
namespace Microsoft.Graph
{
    ...
    public partial class ExternalGroupRequest : BaseRequest, IExternalGroupRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ExternalGroup>> CreateResponseAsync(ExternalGroup externalGroupToCreate)
        {
            return this.CreateResponseAsync(externalGroupToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ExternalGroup}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ExternalGroup>> CreateResponseAsync(ExternalGroup externalGroupToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<ExternalGroup>(externalGroupToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ExternalGroup}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ExternalGroup>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ExternalGroup}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ExternalGroup>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ExternalGroup>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="externalGroupToUpdate">The ExternalGroup to update.</param>
        /// <returns>The <see cref="GraphResponse{ExternalGroup}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ExternalGroup>> UpdateResponseAsync(ExternalGroup externalGroupToUpdate)
        {
            return this.UpdateResponseAsync(externalGroupToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ExternalGroup}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ExternalGroup>> UpdateResponseAsync(ExternalGroup externalGroupToUpdate, CancellationToken cancellationToken)
        {
			if (externalGroupToUpdate.AdditionalData != null)
			{
				if (externalGroupToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ExternalGroup>(externalGroupToUpdate, cancellationToken).ConfigureAwait(false);
        }
