...
namespace Microsoft.Graph
{
    ...
    public partial interface IDepEnrollmentProfileRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DepEnrollmentProfile> CreateAsync(DepEnrollmentProfile depEnrollmentProfileToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<DepEnrollmentProfile>> CreateResponseAsync(DepEnrollmentProfile depEnrollmentProfileToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DepEnrollmentProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DepEnrollmentProfile>> CreateResponseAsync(DepEnrollmentProfile depEnrollmentProfileToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="depEnrollmentProfileToUpdate">The DepEnrollmentProfile to update.</param>
        /// <returns>The <see cref="GraphResponse{DepEnrollmentProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DepEnrollmentProfile>> UpdateResponseAsync(DepEnrollmentProfile depEnrollmentProfileToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DepEnrollmentProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DepEnrollmentProfile>> UpdateResponseAsync(DepEnrollmentProfile depEnrollmentProfileToUpdate, CancellationToken cancellationToken);
