...
namespace Microsoft.Graph
{
    ...
    public partial class FileClassificationRequestFileRequest : BaseRequest, IFileClassificationRequestFileRequest
    {
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream file, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : FileClassificationRequestObject
        {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream file, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : FileClassificationRequestObject
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<T>(file, cancellationToken, completionOption).ConfigureAwait(false);
        }
