...
namespace Microsoft.Graph
{
    ...
    public partial class FileClassificationRequestFileRequest : BaseRequest, IFileClassificationRequestFileRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream file, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : FileClassificationRequestObject
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<T>(file, cancellationToken, completionOption);
        }
