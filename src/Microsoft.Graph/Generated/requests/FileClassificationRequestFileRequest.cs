...
namespace Microsoft.Graph
{
    ...
    public partial class FileClassificationRequestFileRequest : BaseRequest, IFileClassificationRequestFileRequest
    {
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream file, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : FileClassificationRequestObject
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream file, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : FileClassificationRequestObject
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
