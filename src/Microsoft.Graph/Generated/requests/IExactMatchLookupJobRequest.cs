...
namespace Microsoft.Graph
{
    ...
    public partial interface IExactMatchLookupJobRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ExactMatchLookupJob> CreateAsync(ExactMatchLookupJob exactMatchLookupJobToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<ExactMatchLookupJob>> CreateResponseAsync(ExactMatchLookupJob exactMatchLookupJobToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ExactMatchLookupJob}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ExactMatchLookupJob>> CreateResponseAsync(ExactMatchLookupJob exactMatchLookupJobToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ExactMatchLookupJob}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ExactMatchLookupJob>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ExactMatchLookupJob}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ExactMatchLookupJob>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="exactMatchLookupJobToUpdate">The ExactMatchLookupJob to update.</param>
        /// <returns>The <see cref="GraphResponse{ExactMatchLookupJob}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ExactMatchLookupJob>> UpdateResponseAsync(ExactMatchLookupJob exactMatchLookupJobToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ExactMatchLookupJob}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ExactMatchLookupJob>> UpdateResponseAsync(ExactMatchLookupJob exactMatchLookupJobToUpdate, CancellationToken cancellationToken);
