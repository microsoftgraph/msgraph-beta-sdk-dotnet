...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidDeviceOwnerCompliancePolicyRequest : BaseRequest, IAndroidDeviceOwnerCompliancePolicyRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceOwnerCompliancePolicy}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerCompliancePolicy>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceOwnerCompliancePolicy}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerCompliancePolicy>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<AndroidDeviceOwnerCompliancePolicy>(null, cancellationToken).ConfigureAwait(false);
        }
