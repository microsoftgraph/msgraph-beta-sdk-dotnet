...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IOrganizationalBrandingPropertiesSquareLogoDarkRequest.
    /// </summary>
    public partial interface IOrganizationalBrandingPropertiesSquareLogoDarkRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream squareLogoDark, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties;
        ...
        System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream squareLogoDark, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties;
