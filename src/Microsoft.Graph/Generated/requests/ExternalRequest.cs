...
namespace Microsoft.Graph
{
    ...
    public partial class ExternalRequest : BaseRequest, IExternalRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<External>> CreateResponseAsync(External externalToCreate)
        {
            return this.CreateResponseAsync(externalToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{External}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<External>> CreateResponseAsync(External externalToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="externalToUpdate">The External to update.</param>
        /// <returns>The <see cref="GraphResponse{External}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<External>> UpdateResponseAsync(External externalToUpdate)
        {
            return this.UpdateResponseAsync(externalToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{External}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<External>> UpdateResponseAsync(External externalToUpdate, CancellationToken cancellationToken)
        {
			if (externalToUpdate.AdditionalData != null)
			{
				if (externalToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
