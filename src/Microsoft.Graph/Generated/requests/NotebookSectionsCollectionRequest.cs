...
namespace Microsoft.Graph
{
    ...
    public partial class NotebookSectionsCollectionRequest : BaseRequest, INotebookSectionsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<NotebookSectionsCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{NotebookSectionsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<NotebookSectionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<NotebookSectionsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
