...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AccessPackageResourceReferenceRequest.
    /// </summary>
    public partial class AccessPackageResourceReferenceRequest : BaseRequest, IAccessPackageResourceReferenceRequest
    {
        /// <summary>
        /// Constructs a new AccessPackageResourceReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public AccessPackageResourceReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified AccessPackageResource reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified AccessPackageResource reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified AccessPackageResource reference.
        /// </summary>
        /// <param name="id">The AccessPackageResource reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified AccessPackageResource reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The AccessPackageResource reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
