...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidDeviceOwnerScepCertificateProfileRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AndroidDeviceOwnerScepCertificateProfile> CreateAsync(AndroidDeviceOwnerScepCertificateProfile androidDeviceOwnerScepCertificateProfileToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerScepCertificateProfile>> CreateResponseAsync(AndroidDeviceOwnerScepCertificateProfile androidDeviceOwnerScepCertificateProfileToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<AndroidDeviceOwnerScepCertificateProfile> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceOwnerScepCertificateProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerScepCertificateProfile>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<AndroidDeviceOwnerScepCertificateProfile> UpdateAsync(AndroidDeviceOwnerScepCertificateProfile androidDeviceOwnerScepCertificateProfileToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceOwnerScepCertificateProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerScepCertificateProfile>> UpdateResponseAsync(AndroidDeviceOwnerScepCertificateProfile androidDeviceOwnerScepCertificateProfileToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<AndroidDeviceOwnerScepCertificateProfile> PutAsync(AndroidDeviceOwnerScepCertificateProfile androidDeviceOwnerScepCertificateProfileToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerScepCertificateProfile>> PutResponseAsync(AndroidDeviceOwnerScepCertificateProfile androidDeviceOwnerScepCertificateProfileToUpdate, CancellationToken cancellationToken = default);
