...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsPhoneEASEmailProfileConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WindowsPhoneEASEmailProfileConfiguration> CreateAsync(WindowsPhoneEASEmailProfileConfiguration windowsPhoneEASEmailProfileConfigurationToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsPhoneEASEmailProfileConfiguration>> CreateResponseAsync(WindowsPhoneEASEmailProfileConfiguration windowsPhoneEASEmailProfileConfigurationToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsPhoneEASEmailProfileConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhoneEASEmailProfileConfiguration>> CreateResponseAsync(WindowsPhoneEASEmailProfileConfiguration windowsPhoneEASEmailProfileConfigurationToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WindowsPhoneEASEmailProfileConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhoneEASEmailProfileConfiguration>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsPhoneEASEmailProfileConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhoneEASEmailProfileConfiguration>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="windowsPhoneEASEmailProfileConfigurationToUpdate">The WindowsPhoneEASEmailProfileConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{WindowsPhoneEASEmailProfileConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhoneEASEmailProfileConfiguration>> UpdateResponseAsync(WindowsPhoneEASEmailProfileConfiguration windowsPhoneEASEmailProfileConfigurationToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsPhoneEASEmailProfileConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhoneEASEmailProfileConfiguration>> UpdateResponseAsync(WindowsPhoneEASEmailProfileConfiguration windowsPhoneEASEmailProfileConfigurationToUpdate, CancellationToken cancellationToken);
