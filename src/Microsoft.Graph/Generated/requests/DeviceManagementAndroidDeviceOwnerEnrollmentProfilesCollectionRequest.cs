...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementAndroidDeviceOwnerEnrollmentProfilesCollectionRequest : BaseRequest, IDeviceManagementAndroidDeviceOwnerEnrollmentProfilesCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerEnrollmentProfile>> AddResponseAsync(AndroidDeviceOwnerEnrollmentProfile androidDeviceOwnerEnrollmentProfile, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = Constants.HttpMethods.POST.ToString();
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementAndroidDeviceOwnerEnrollmentProfilesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.GET.ToString();
