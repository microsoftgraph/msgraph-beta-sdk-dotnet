...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookChartFillSetSolidColorRequest : BaseRequest, IWorkbookChartFillSetSolidColorRequest
    {
        /// <summary>
        /// Constructs a new WorkbookChartFillSetSolidColorRequest.
        /// </summary>
        public WorkbookChartFillSetSolidColorRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookChartFillSetSolidColorRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookChartFillSetSolidColorRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookChartFillSetSolidColorRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookChartFillSetSolidColorRequest Select(string value)
        {
