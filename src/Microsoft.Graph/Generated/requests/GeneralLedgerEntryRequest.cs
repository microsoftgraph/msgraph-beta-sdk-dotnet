...
namespace Microsoft.Graph
{
    ...
    public partial class GeneralLedgerEntryRequest : BaseRequest, IGeneralLedgerEntryRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<GeneralLedgerEntry> PutAsync(GeneralLedgerEntry generalLedgerEntryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<GeneralLedgerEntry>> PutResponseAsync(GeneralLedgerEntry generalLedgerEntryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<GeneralLedgerEntry>(generalLedgerEntryToUpdate, cancellationToken);
