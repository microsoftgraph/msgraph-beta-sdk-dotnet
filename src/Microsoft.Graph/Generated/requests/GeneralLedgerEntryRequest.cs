...
namespace Microsoft.Graph
{
    ...
    public partial class GeneralLedgerEntryRequest : BaseRequest, IGeneralLedgerEntryRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<GeneralLedgerEntry>> CreateResponseAsync(GeneralLedgerEntry generalLedgerEntryToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{GeneralLedgerEntry}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GeneralLedgerEntry>> UpdateResponseAsync(GeneralLedgerEntry generalLedgerEntryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
