...
namespace Microsoft.Graph
{
    ...
    public partial interface IReferenceAttachmentRequest : IBaseRequest
    {
        ...
        /// <param name="referenceAttachmentToUpdate">The ReferenceAttachment to update.</param>
        /// <returns>The <see cref="GraphResponse{ReferenceAttachment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ReferenceAttachment>> UpdateResponseAsync(ReferenceAttachment referenceAttachmentToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ReferenceAttachment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ReferenceAttachment>> UpdateResponseAsync(ReferenceAttachment referenceAttachmentToUpdate, CancellationToken cancellationToken);
