...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IDocumentSetWelcomePageColumnsCollectionReferencesRequest : IBaseRequest
    {
        /// <summary>
        ...
        System.Threading.Tasks.Task AddAsync(ReferenceRequestBody columnDefinitionReference, CancellationToken cancellationToken = default);
        ...
        /// <param name="columnDefinitionReference">The ReferenceRequestBody to add.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(ReferenceRequestBody columnDefinitionReference, CancellationToken cancellationToken = default);
