...
namespace Microsoft.Graph
{
    ...
    public partial interface ISkypeForBusinessActivityCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SkypeForBusinessActivityCounts> CreateAsync(SkypeForBusinessActivityCounts skypeForBusinessActivityCountsToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<SkypeForBusinessActivityCounts>> CreateResponseAsync(SkypeForBusinessActivityCounts skypeForBusinessActivityCountsToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SkypeForBusinessActivityCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SkypeForBusinessActivityCounts>> CreateResponseAsync(SkypeForBusinessActivityCounts skypeForBusinessActivityCountsToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="skypeForBusinessActivityCountsToUpdate">The SkypeForBusinessActivityCounts to update.</param>
        /// <returns>The <see cref="GraphResponse{SkypeForBusinessActivityCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SkypeForBusinessActivityCounts>> UpdateResponseAsync(SkypeForBusinessActivityCounts skypeForBusinessActivityCountsToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SkypeForBusinessActivityCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SkypeForBusinessActivityCounts>> UpdateResponseAsync(SkypeForBusinessActivityCounts skypeForBusinessActivityCountsToUpdate, CancellationToken cancellationToken);
