...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidManagedAppRegistrationRequest : BaseRequest, IAndroidManagedAppRegistrationRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<AndroidManagedAppRegistration>> CreateResponseAsync(AndroidManagedAppRegistration androidManagedAppRegistrationToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidManagedAppRegistration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidManagedAppRegistration>> UpdateResponseAsync(AndroidManagedAppRegistration androidManagedAppRegistrationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
