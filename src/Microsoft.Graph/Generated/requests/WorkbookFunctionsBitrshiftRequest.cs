...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsBitrshiftRequest : BaseRequest, IWorkbookFunctionsBitrshiftRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsBitrshiftRequest.
        /// </summary>
        public WorkbookFunctionsBitrshiftRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsBitrshiftRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsBitrshiftRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsBitrshiftRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsBitrshiftRequest Select(string value)
        {
