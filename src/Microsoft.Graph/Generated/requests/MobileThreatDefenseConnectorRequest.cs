...
namespace Microsoft.Graph
{
    ...
    public partial class MobileThreatDefenseConnectorRequest : BaseRequest, IMobileThreatDefenseConnectorRequest
    {
        ...
        /// <param name="mobileThreatDefenseConnectorToUpdate">The MobileThreatDefenseConnector to update.</param>
        /// <returns>The <see cref="GraphResponse{MobileThreatDefenseConnector}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MobileThreatDefenseConnector>> UpdateResponseAsync(MobileThreatDefenseConnector mobileThreatDefenseConnectorToUpdate)
        {
            return this.UpdateResponseAsync(mobileThreatDefenseConnectorToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MobileThreatDefenseConnector}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MobileThreatDefenseConnector>> UpdateResponseAsync(MobileThreatDefenseConnector mobileThreatDefenseConnectorToUpdate, CancellationToken cancellationToken)
        {
			if (mobileThreatDefenseConnectorToUpdate.AdditionalData != null)
			{
				if (mobileThreatDefenseConnectorToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
