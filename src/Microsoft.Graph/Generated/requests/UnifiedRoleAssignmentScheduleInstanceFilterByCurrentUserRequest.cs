...
namespace Microsoft.Graph
{
    ...
    public partial class UnifiedRoleAssignmentScheduleInstanceFilterByCurrentUserRequest : BaseRequest, IUnifiedRoleAssignmentScheduleInstanceFilterByCurrentUserRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<UnifiedRoleAssignmentScheduleInstanceFilterByCurrentUserCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<UnifiedRoleAssignmentScheduleInstanceFilterByCurrentUserCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
