...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsVlookupRequest : BaseRequest, IWorkbookFunctionsVlookupRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsVlookupRequest.
        /// </summary>
        public WorkbookFunctionsVlookupRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsVlookupRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsVlookupRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsVlookupRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsVlookupRequest Select(string value)
        {
