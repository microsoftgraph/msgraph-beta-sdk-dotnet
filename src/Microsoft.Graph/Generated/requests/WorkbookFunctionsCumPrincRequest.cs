...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsCumPrincRequest : BaseRequest, IWorkbookFunctionsCumPrincRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsCumPrincRequest.
        /// </summary>
        public WorkbookFunctionsCumPrincRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsCumPrincRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsCumPrincRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsCumPrincRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsCumPrincRequest Select(string value)
        {
