...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IContactExtensionsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IContactExtensionsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IContactExtensionsCollectionRequest Request(IEnumerable<Option> options);
