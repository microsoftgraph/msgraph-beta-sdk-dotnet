...
namespace Microsoft.Graph
{
    ...
    public partial class SalesCreditMemoSalesCreditMemoLinesCollectionRequest : BaseRequest, ISalesCreditMemoSalesCreditMemoLinesCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<SalesCreditMemoLine> AddAsync(SalesCreditMemoLine salesCreditMemoLine)
        {
            return this.AddAsync(salesCreditMemoLine, CancellationToken.None);
        }
        ...
        /// <returns>The created SalesCreditMemoLine.</returns>
        public System.Threading.Tasks.Task<SalesCreditMemoLine> AddAsync(SalesCreditMemoLine salesCreditMemoLine, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SalesCreditMemoLine>> AddResponseAsync(SalesCreditMemoLine salesCreditMemoLine)
        {
            return this.AddResponseAsync(salesCreditMemoLine, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SalesCreditMemoLine}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SalesCreditMemoLine>> AddResponseAsync(SalesCreditMemoLine salesCreditMemoLine, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<SalesCreditMemoLine>(salesCreditMemoLine, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<ISalesCreditMemoSalesCreditMemoLinesCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async System.Threading.Tasks.Task<ISalesCreditMemoSalesCreditMemoLinesCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        public System.Threading.Tasks.Task<GraphResponse<SalesCreditMemoSalesCreditMemoLinesCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SalesCreditMemoSalesCreditMemoLinesCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SalesCreditMemoSalesCreditMemoLinesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<SalesCreditMemoSalesCreditMemoLinesCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
