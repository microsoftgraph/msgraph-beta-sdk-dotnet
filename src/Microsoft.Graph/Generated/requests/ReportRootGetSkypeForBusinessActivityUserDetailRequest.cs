...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetSkypeForBusinessActivityUserDetailRequest : BaseRequest, IReportRootGetSkypeForBusinessActivityUserDetailRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessActivityUserDetailCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="skypeforbusinessactivityuserdetail">The SkypeForBusinessActivityUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessActivityUserDetailCollectionResponse>> PatchResponseAsync(SkypeForBusinessActivityUserDetail skypeforbusinessactivityuserdetail, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="skypeforbusinessactivityuserdetail">The SkypeForBusinessActivityUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessActivityUserDetailCollectionResponse>> PutResponseAsync(SkypeForBusinessActivityUserDetail skypeforbusinessactivityuserdetail, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessActivityUserDetailCollectionResponse>(skypeforbusinessactivityuserdetail, cancellationToken);
        }
