...
namespace Microsoft.Graph
{
    ...
    public partial class UserMessagesCollectionRequest : BaseRequest, IUserMessagesCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<UserMessagesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<UserMessagesCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
