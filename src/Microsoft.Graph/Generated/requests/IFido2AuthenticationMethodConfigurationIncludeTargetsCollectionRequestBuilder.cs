...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IFido2AuthenticationMethodConfigurationIncludeTargetsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IFido2AuthenticationMethodConfigurationIncludeTargetsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IFido2AuthenticationMethodConfigurationIncludeTargetsCollectionRequest Request(IEnumerable<Option> options);
