...
namespace Microsoft.Graph
{
    ...
    public partial interface ITeamworkTagMemberRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<TeamworkTagMember> PutAsync(TeamworkTagMember teamworkTagMemberToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<TeamworkTagMember>> PutResponseAsync(TeamworkTagMember teamworkTagMemberToUpdate, CancellationToken cancellationToken = default(CancellationToken));
