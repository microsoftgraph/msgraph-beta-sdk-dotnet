...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetYammerActivityUserCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerActivityUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="yammeractivitysummary">The YammerActivitySummary object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerActivityUserCountsCollectionResponse>> PatchResponseAsync(YammerActivitySummary yammeractivitysummary, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="yammeractivitysummary">The YammerActivitySummary object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerActivityUserCountsCollectionResponse>> PutResponseAsync(YammerActivitySummary yammeractivitysummary, CancellationToken cancellationToken = default(CancellationToken));
