...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetCertificatesReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetCertificatesReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetCertificatesReportRequest>, IDeviceManagementReportsGetCertificatesReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetCertificatesReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetCertificatesReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetCertificatesReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetCertificatesReportRequest(functionUrl, this.Client, options);
