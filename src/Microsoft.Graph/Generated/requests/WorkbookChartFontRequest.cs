...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookChartFontRequest : BaseRequest, IWorkbookChartFontRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartFont>> CreateResponseAsync(WorkbookChartFont workbookChartFontToCreate)
        {
            return this.CreateResponseAsync(workbookChartFontToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookChartFont}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookChartFont>> CreateResponseAsync(WorkbookChartFont workbookChartFontToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<WorkbookChartFont>(workbookChartFontToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WorkbookChartFont}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartFont>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookChartFont}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookChartFont>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WorkbookChartFont>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="workbookChartFontToUpdate">The WorkbookChartFont to update.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookChartFont}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartFont>> UpdateResponseAsync(WorkbookChartFont workbookChartFontToUpdate)
        {
            return this.UpdateResponseAsync(workbookChartFontToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookChartFont}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookChartFont>> UpdateResponseAsync(WorkbookChartFont workbookChartFontToUpdate, CancellationToken cancellationToken)
        {
			if (workbookChartFontToUpdate.AdditionalData != null)
			{
				if (workbookChartFontToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<WorkbookChartFont>(workbookChartFontToUpdate, cancellationToken).ConfigureAwait(false);
        }
