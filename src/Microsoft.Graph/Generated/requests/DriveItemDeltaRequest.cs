...
namespace Microsoft.Graph
{
    ...
    public partial class DriveItemDeltaRequest : BaseRequest, IDriveItemDeltaRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DriveItemDeltaCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DriveItemDeltaCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
