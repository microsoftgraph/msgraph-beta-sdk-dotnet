...
namespace Microsoft.Graph
{
    ...
    public partial class ItemAnalyticsRequest : BaseRequest, IItemAnalyticsRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ItemAnalytics}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ItemAnalytics>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ItemAnalytics}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ItemAnalytics>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ItemAnalytics>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
			if (itemAnalyticsToUpdate.AdditionalData != null)
			{
				if (itemAnalyticsToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					itemAnalyticsToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, itemAnalyticsToUpdate.GetType().Name)
						});
				}
			}
            if (itemAnalyticsToUpdate.AdditionalData != null)
        ...
        /// <param name="itemAnalyticsToUpdate">The ItemAnalytics to update.</param>
        /// <returns>The <see cref="GraphResponse{ItemAnalytics}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ItemAnalytics>> UpdateResponseAsync(ItemAnalytics itemAnalyticsToUpdate)
        {
            return this.UpdateResponseAsync(itemAnalyticsToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ItemAnalytics}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ItemAnalytics>> UpdateResponseAsync(ItemAnalytics itemAnalyticsToUpdate, CancellationToken cancellationToken)
        {
			if (itemAnalyticsToUpdate.AdditionalData != null)
			{
				if (itemAnalyticsToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ItemAnalytics>(itemAnalyticsToUpdate, cancellationToken).ConfigureAwait(false);
        }
