...
namespace Microsoft.Graph
{
    ...
    public partial class Windows81TrustedRootCertificateRequest : BaseRequest, IWindows81TrustedRootCertificateRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows81TrustedRootCertificate>> CreateResponseAsync(Windows81TrustedRootCertificate windows81TrustedRootCertificateToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<Windows81TrustedRootCertificate> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows81TrustedRootCertificate}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows81TrustedRootCertificate>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Windows81TrustedRootCertificate}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows81TrustedRootCertificate>> UpdateResponseAsync(Windows81TrustedRootCertificate windows81TrustedRootCertificateToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <summary>
        /// Updates the specified Windows81TrustedRootCertificate using PUT.
        /// </summary>
        /// <param name="windows81TrustedRootCertificateToUpdate">The Windows81TrustedRootCertificate object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<Windows81TrustedRootCertificate> PutAsync(Windows81TrustedRootCertificate windows81TrustedRootCertificateToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <summary>
        /// Updates the specified Windows81TrustedRootCertificate using PUT and returns a <see cref="GraphResponse{Windows81TrustedRootCertificate}"/> object.
        /// </summary>
        /// <param name="windows81TrustedRootCertificateToUpdate">The Windows81TrustedRootCertificate object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{Windows81TrustedRootCertificate}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows81TrustedRootCertificate>> PutResponseAsync(Windows81TrustedRootCertificate windows81TrustedRootCertificateToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<Windows81TrustedRootCertificate>(windows81TrustedRootCertificateToUpdate, cancellationToken);
