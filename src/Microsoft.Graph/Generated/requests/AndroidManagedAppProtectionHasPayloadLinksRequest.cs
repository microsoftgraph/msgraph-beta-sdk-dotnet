...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidManagedAppProtectionHasPayloadLinksRequest : BaseRequest, IAndroidManagedAppProtectionHasPayloadLinksRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<AndroidManagedAppProtectionHasPayloadLinksCollectionResponse>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<AndroidManagedAppProtectionHasPayloadLinksCollectionResponse>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
