...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsManagementAppHealthSummaryRequest : BaseRequest, IWindowsManagementAppHealthSummaryRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WindowsManagementAppHealthSummary}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsManagementAppHealthSummary>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsManagementAppHealthSummary}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsManagementAppHealthSummary>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WindowsManagementAppHealthSummary>(null, cancellationToken).ConfigureAwait(false);
        }
