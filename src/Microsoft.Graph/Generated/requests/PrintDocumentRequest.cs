...
namespace Microsoft.Graph
{
    ...
    public partial class PrintDocumentRequest : BaseRequest, IPrintDocumentRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{PrintDocument}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PrintDocument>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PrintDocument}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PrintDocument>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<PrintDocument>(null, cancellationToken).ConfigureAwait(false);
        }
