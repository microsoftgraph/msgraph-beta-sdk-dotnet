...
namespace Microsoft.Graph
{
    ...
    public partial class AuthenticationMethodsRootRequest : BaseRequest, IAuthenticationMethodsRootRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AuthenticationMethodsRoot}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AuthenticationMethodsRoot>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AuthenticationMethodsRoot}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AuthenticationMethodsRoot>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<AuthenticationMethodsRoot>(null, cancellationToken).ConfigureAwait(false);
        }
