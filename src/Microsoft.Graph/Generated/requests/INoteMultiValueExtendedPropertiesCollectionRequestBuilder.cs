...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface INoteMultiValueExtendedPropertiesCollectionRequestBuilder.
    /// </summary>
    public partial interface INoteMultiValueExtendedPropertiesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        INoteMultiValueExtendedPropertiesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        INoteMultiValueExtendedPropertiesCollectionRequest Request(IEnumerable<Option> options);
