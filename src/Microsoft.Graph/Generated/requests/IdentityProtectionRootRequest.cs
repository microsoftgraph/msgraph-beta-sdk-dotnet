...
namespace Microsoft.Graph
{
    ...
    public partial class IdentityProtectionRootRequest : BaseRequest, IIdentityProtectionRootRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{IdentityProtectionRoot}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IdentityProtectionRoot>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IdentityProtectionRoot}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IdentityProtectionRoot>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<IdentityProtectionRoot>(null, cancellationToken).ConfigureAwait(false);
        }
