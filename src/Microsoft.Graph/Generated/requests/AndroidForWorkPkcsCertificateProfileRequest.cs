...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidForWorkPkcsCertificateProfileRequest : BaseRequest, IAndroidForWorkPkcsCertificateProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkPkcsCertificateProfile>> CreateResponseAsync(AndroidForWorkPkcsCertificateProfile androidForWorkPkcsCertificateProfileToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkPkcsCertificateProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkPkcsCertificateProfile>> UpdateResponseAsync(AndroidForWorkPkcsCertificateProfile androidForWorkPkcsCertificateProfileToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
