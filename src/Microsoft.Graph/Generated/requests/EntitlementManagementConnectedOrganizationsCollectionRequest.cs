...
namespace Microsoft.Graph
{
    ...
    public partial class EntitlementManagementConnectedOrganizationsCollectionRequest : BaseRequest, IEntitlementManagementConnectedOrganizationsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<ConnectedOrganization> AddAsync(ConnectedOrganization connectedOrganization)
        {
            return this.AddAsync(connectedOrganization, CancellationToken.None);
        }
        ...
        /// <returns>The created ConnectedOrganization.</returns>
        public System.Threading.Tasks.Task<ConnectedOrganization> AddAsync(ConnectedOrganization connectedOrganization, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ConnectedOrganization>> AddResponseAsync(ConnectedOrganization connectedOrganization)
        {
            return this.AddResponseAsync(connectedOrganization, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ConnectedOrganization}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ConnectedOrganization>> AddResponseAsync(ConnectedOrganization connectedOrganization, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<ConnectedOrganization>(connectedOrganization, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<IEntitlementManagementConnectedOrganizationsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async System.Threading.Tasks.Task<IEntitlementManagementConnectedOrganizationsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        public System.Threading.Tasks.Task<GraphResponse<EntitlementManagementConnectedOrganizationsCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EntitlementManagementConnectedOrganizationsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EntitlementManagementConnectedOrganizationsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<EntitlementManagementConnectedOrganizationsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
