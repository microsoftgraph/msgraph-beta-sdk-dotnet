...
namespace Microsoft.Graph
{
    ...
    public partial class GroupPolicyMigrationReportRequest : BaseRequest, IGroupPolicyMigrationReportRequest
    {
        ...
        public System.Threading.Tasks.Task<GroupPolicyMigrationReport> CreateAsync(GroupPolicyMigrationReport groupPolicyMigrationReportToCreate)
        {
            return this.CreateAsync(groupPolicyMigrationReportToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created GroupPolicyMigrationReport.</returns>
        public async System.Threading.Tasks.Task<GroupPolicyMigrationReport> CreateAsync(GroupPolicyMigrationReport groupPolicyMigrationReportToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyMigrationReport>> CreateResponseAsync(GroupPolicyMigrationReport groupPolicyMigrationReportToCreate)
        {
            return this.CreateResponseAsync(groupPolicyMigrationReportToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyMigrationReport}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyMigrationReport>> CreateResponseAsync(GroupPolicyMigrationReport groupPolicyMigrationReportToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<GroupPolicyMigrationReport>(groupPolicyMigrationReportToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<GroupPolicyMigrationReport> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The GroupPolicyMigrationReport.</returns>
        public async System.Threading.Tasks.Task<GroupPolicyMigrationReport> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{GroupPolicyMigrationReport}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyMigrationReport>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyMigrationReport}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyMigrationReport>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<GroupPolicyMigrationReport>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<GroupPolicyMigrationReport> UpdateAsync(GroupPolicyMigrationReport groupPolicyMigrationReportToUpdate)
        {
            return this.UpdateAsync(groupPolicyMigrationReportToUpdate, CancellationToken.None);
        }
        ...
        /// <returns>The updated GroupPolicyMigrationReport.</returns>
        public async System.Threading.Tasks.Task<GroupPolicyMigrationReport> UpdateAsync(GroupPolicyMigrationReport groupPolicyMigrationReportToUpdate, CancellationToken cancellationToken)
        {
			if (groupPolicyMigrationReportToUpdate.AdditionalData != null)
			{
				if (groupPolicyMigrationReportToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					groupPolicyMigrationReportToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, groupPolicyMigrationReportToUpdate.GetType().Name)
						});
				}
			}
            if (groupPolicyMigrationReportToUpdate.AdditionalData != null)
        ...
        /// <param name="groupPolicyMigrationReportToUpdate">The GroupPolicyMigrationReport to update.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyMigrationReport}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyMigrationReport>> UpdateResponseAsync(GroupPolicyMigrationReport groupPolicyMigrationReportToUpdate)
        {
            return this.UpdateResponseAsync(groupPolicyMigrationReportToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{GroupPolicyMigrationReport}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyMigrationReport>> UpdateResponseAsync(GroupPolicyMigrationReport groupPolicyMigrationReportToUpdate, CancellationToken cancellationToken)
        {
			if (groupPolicyMigrationReportToUpdate.AdditionalData != null)
			{
				if (groupPolicyMigrationReportToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<GroupPolicyMigrationReport>(groupPolicyMigrationReportToUpdate, cancellationToken).ConfigureAwait(false);
        }
