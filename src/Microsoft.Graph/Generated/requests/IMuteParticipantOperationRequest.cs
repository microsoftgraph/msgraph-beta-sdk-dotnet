...
namespace Microsoft.Graph
{
    ...
    public partial interface IMuteParticipantOperationRequest : IBaseRequest
    {
        ...
        /// <param name="muteParticipantOperationToUpdate">The MuteParticipantOperation to update.</param>
        /// <returns>The <see cref="GraphResponse{MuteParticipantOperation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MuteParticipantOperation>> UpdateResponseAsync(MuteParticipantOperation muteParticipantOperationToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MuteParticipantOperation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MuteParticipantOperation>> UpdateResponseAsync(MuteParticipantOperation muteParticipantOperationToUpdate, CancellationToken cancellationToken);
