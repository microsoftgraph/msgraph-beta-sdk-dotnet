...
namespace Microsoft.Graph
{
    ...
    public partial interface ISharePointActivityUserDetailRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SharePointActivityUserDetail> CreateAsync(SharePointActivityUserDetail sharePointActivityUserDetailToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<SharePointActivityUserDetail>> CreateResponseAsync(SharePointActivityUserDetail sharePointActivityUserDetailToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<SharePointActivityUserDetail> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SharePointActivityUserDetail}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SharePointActivityUserDetail>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<SharePointActivityUserDetail> UpdateAsync(SharePointActivityUserDetail sharePointActivityUserDetailToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SharePointActivityUserDetail}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SharePointActivityUserDetail>> UpdateResponseAsync(SharePointActivityUserDetail sharePointActivityUserDetailToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<SharePointActivityUserDetail> PutAsync(SharePointActivityUserDetail sharePointActivityUserDetailToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="sharePointActivityUserDetailToUpdate">The SharePointActivityUserDetail object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{SharePointActivityUserDetail}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<SharePointActivityUserDetail>> PutResponseAsync(SharePointActivityUserDetail sharePointActivityUserDetailToUpdate, CancellationToken cancellationToken = default);
