...
namespace Microsoft.Graph
{
    ...
    public partial interface ISharePointActivityUserDetailRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SharePointActivityUserDetail> CreateAsync(SharePointActivityUserDetail sharePointActivityUserDetailToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<SharePointActivityUserDetail>> CreateResponseAsync(SharePointActivityUserDetail sharePointActivityUserDetailToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SharePointActivityUserDetail}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SharePointActivityUserDetail>> CreateResponseAsync(SharePointActivityUserDetail sharePointActivityUserDetailToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="sharePointActivityUserDetailToUpdate">The SharePointActivityUserDetail to update.</param>
        /// <returns>The <see cref="GraphResponse{SharePointActivityUserDetail}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SharePointActivityUserDetail>> UpdateResponseAsync(SharePointActivityUserDetail sharePointActivityUserDetailToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SharePointActivityUserDetail}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SharePointActivityUserDetail>> UpdateResponseAsync(SharePointActivityUserDetail sharePointActivityUserDetailToUpdate, CancellationToken cancellationToken);
