...
namespace Microsoft.Graph
{
    ...
    public partial interface INotificationRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<Notification> PutAsync(Notification notificationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<Notification>> PutResponseAsync(Notification notificationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
