...
namespace Microsoft.Graph
{
    ...
    public partial class ConfigManagerCollectionRequest : BaseRequest, IConfigManagerCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<ConfigManagerCollection> CreateAsync(ConfigManagerCollection configManagerCollectionToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ConfigManagerCollection>> CreateResponseAsync(ConfigManagerCollection configManagerCollectionToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<ConfigManagerCollection> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ConfigManagerCollection}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ConfigManagerCollection>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<ConfigManagerCollection> UpdateAsync(ConfigManagerCollection configManagerCollectionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ConfigManagerCollection}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ConfigManagerCollection>> UpdateResponseAsync(ConfigManagerCollection configManagerCollectionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<ConfigManagerCollection> PutAsync(ConfigManagerCollection configManagerCollectionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<ConfigManagerCollection>> PutResponseAsync(ConfigManagerCollection configManagerCollectionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ConfigManagerCollection>(configManagerCollectionToUpdate, cancellationToken);
