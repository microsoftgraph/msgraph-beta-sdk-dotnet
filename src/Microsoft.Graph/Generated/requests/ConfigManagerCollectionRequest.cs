...
namespace Microsoft.Graph
{
    ...
    public partial class ConfigManagerCollectionRequest : BaseRequest, IConfigManagerCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ConfigManagerCollection>> CreateResponseAsync(ConfigManagerCollection configManagerCollectionToCreate)
        {
            return this.CreateResponseAsync(configManagerCollectionToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ConfigManagerCollection}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ConfigManagerCollection>> CreateResponseAsync(ConfigManagerCollection configManagerCollectionToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<ConfigManagerCollection>(configManagerCollectionToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ConfigManagerCollection}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ConfigManagerCollection>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ConfigManagerCollection}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ConfigManagerCollection>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ConfigManagerCollection>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="configManagerCollectionToUpdate">The ConfigManagerCollection to update.</param>
        /// <returns>The <see cref="GraphResponse{ConfigManagerCollection}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ConfigManagerCollection>> UpdateResponseAsync(ConfigManagerCollection configManagerCollectionToUpdate)
        {
            return this.UpdateResponseAsync(configManagerCollectionToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ConfigManagerCollection}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ConfigManagerCollection>> UpdateResponseAsync(ConfigManagerCollection configManagerCollectionToUpdate, CancellationToken cancellationToken)
        {
			if (configManagerCollectionToUpdate.AdditionalData != null)
			{
				if (configManagerCollectionToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ConfigManagerCollection>(configManagerCollectionToUpdate, cancellationToken).ConfigureAwait(false);
        }
