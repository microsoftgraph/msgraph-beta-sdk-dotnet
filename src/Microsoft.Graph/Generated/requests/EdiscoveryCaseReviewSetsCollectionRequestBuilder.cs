...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class EdiscoveryCaseReviewSetsCollectionRequestBuilder : BaseRequestBuilder, IEdiscoveryCaseReviewSetsCollectionRequestBuilder
    {
        /// <summary>
        ...
        /// <returns>The built request.</returns>
        public IEdiscoveryCaseReviewSetsCollectionRequest Request(IEnumerable<Option> options)
        {
            return new EdiscoveryCaseReviewSetsCollectionRequest(this.RequestUrl, this.Client, options);
        }

        /// <summary>
        /// Gets an <see cref="IReviewSetRequestBuilder"/> for the specified EdiscoveryCaseReviewSet.
        /// </summary>
        /// <param name="id">The ID for the EdiscoveryCaseReviewSet.</param>
