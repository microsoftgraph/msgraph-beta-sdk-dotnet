...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type OrganizationalBrandingPropertiesHeaderLogoRequest.
    /// </summary>
    public partial class OrganizationalBrandingPropertiesHeaderLogoRequest : BaseRequest, IOrganizationalBrandingPropertiesHeaderLogoRequest
    {
        /// <summary>
        /// Constructs a new OrganizationalBrandingPropertiesHeaderLogoRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public OrganizationalBrandingPropertiesHeaderLogoRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <param name="headerLogo">The stream to PUT.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream headerLogo, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
            return this.SendAsync<T>(headerLogo, cancellationToken, completionOption);
        }
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream headerLogo, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<T>(headerLogo, cancellationToken, completionOption);
        }
