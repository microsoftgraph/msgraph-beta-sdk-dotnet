...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface ITemporaryAccessPassAuthenticationMethodConfigurationIncludeTargetsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        ITemporaryAccessPassAuthenticationMethodConfigurationIncludeTargetsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        ITemporaryAccessPassAuthenticationMethodConfigurationIncludeTargetsCollectionRequest Request(IEnumerable<Option> options);
