...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsTruncRequest : BaseRequest, IWorkbookFunctionsTruncRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsTruncRequest.
        /// </summary>
        public WorkbookFunctionsTruncRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsTruncRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsTruncRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsTruncRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsTruncRequest Select(string value)
        {
