...
namespace Microsoft.Graph
{
    ...
    public partial interface IBookingStaffMemberRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<BookingStaffMember> CreateAsync(BookingStaffMember bookingStaffMemberToCreate);
        ...
        /// <returns>The created BookingStaffMember.</returns>
        System.Threading.Tasks.Task<BookingStaffMember> CreateAsync(BookingStaffMember bookingStaffMemberToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<BookingStaffMember>> CreateResponseAsync(BookingStaffMember bookingStaffMemberToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{BookingStaffMember}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<BookingStaffMember>> CreateResponseAsync(BookingStaffMember bookingStaffMemberToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<BookingStaffMember> UpdateAsync(BookingStaffMember bookingStaffMemberToUpdate);
        ...
        /// <returns>The updated BookingStaffMember.</returns>
        System.Threading.Tasks.Task<BookingStaffMember> UpdateAsync(BookingStaffMember bookingStaffMemberToUpdate, CancellationToken cancellationToken);
        ...
        /// <param name="bookingStaffMemberToUpdate">The BookingStaffMember to update.</param>
        /// <returns>The <see cref="GraphResponse{BookingStaffMember}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<BookingStaffMember>> UpdateResponseAsync(BookingStaffMember bookingStaffMemberToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{BookingStaffMember}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<BookingStaffMember>> UpdateResponseAsync(BookingStaffMember bookingStaffMemberToUpdate, CancellationToken cancellationToken);
