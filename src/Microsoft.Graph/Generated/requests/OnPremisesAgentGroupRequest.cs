...
namespace Microsoft.Graph
{
    ...
    public partial class OnPremisesAgentGroupRequest : BaseRequest, IOnPremisesAgentGroupRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{OnPremisesAgentGroup}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OnPremisesAgentGroup>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OnPremisesAgentGroup}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OnPremisesAgentGroup>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<OnPremisesAgentGroup>(null, cancellationToken).ConfigureAwait(false);
        }
