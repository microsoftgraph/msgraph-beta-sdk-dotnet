...
namespace Microsoft.Graph
{
    ...
    public partial class PrivilegedAccessRoleSettingsCollectionRequest : BaseRequest, IPrivilegedAccessRoleSettingsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<IPrivilegedAccessRoleSettingsCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PrivilegedAccessRoleSettingsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<PrivilegedAccessRoleSettingsCollectionResponse>(null, cancellationToken);
        }
