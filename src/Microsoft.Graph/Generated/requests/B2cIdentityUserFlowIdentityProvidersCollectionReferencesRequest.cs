...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type B2cIdentityUserFlowIdentityProvidersCollectionReferencesRequest.
    /// </summary>
    public partial class B2cIdentityUserFlowIdentityProvidersCollectionReferencesRequest : BaseRequest, IB2cIdentityUserFlowIdentityProvidersCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new B2cIdentityUserFlowIdentityProvidersCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public B2cIdentityUserFlowIdentityProvidersCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(IdentityProvider identityProvider)
        {
            return this.AddResponseAsync(identityProvider, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
        public System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(IdentityProvider identityProvider, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
