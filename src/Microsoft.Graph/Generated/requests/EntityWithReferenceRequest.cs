...
namespace Microsoft.Graph
{
    ...
    public partial class EntityWithReferenceRequest : BaseRequest, IEntityWithReferenceRequest
    {
        ...
        /// <param name="entityToCreate">The Entity to create.</param>
        /// <returns>The <see cref="GraphResponse{Entity}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Entity>> CreateResponseAsync(Entity entityToCreate)
        {
            return this.CreateResponseAsync(entityToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Entity}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Entity>> CreateResponseAsync(Entity entityToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
