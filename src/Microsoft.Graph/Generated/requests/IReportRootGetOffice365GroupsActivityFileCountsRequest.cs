...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetOffice365GroupsActivityFileCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityFileCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="office365groupsactivityfilecounts">The Office365GroupsActivityFileCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityFileCountsCollectionResponse>> PatchResponseAsync(Office365GroupsActivityFileCounts office365groupsactivityfilecounts, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="office365groupsactivityfilecounts">The Office365GroupsActivityFileCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityFileCountsCollectionResponse>> PutResponseAsync(Office365GroupsActivityFileCounts office365groupsactivityfilecounts, CancellationToken cancellationToken = default(CancellationToken));
