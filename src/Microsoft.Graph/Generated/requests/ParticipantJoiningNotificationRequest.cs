...
namespace Microsoft.Graph
{
    ...
    public partial class ParticipantJoiningNotificationRequest : BaseRequest, IParticipantJoiningNotificationRequest
    {
        ...
        public async System.Threading.Tasks.Task<ParticipantJoiningNotification> CreateAsync(ParticipantJoiningNotification participantJoiningNotificationToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ParticipantJoiningNotification>> CreateResponseAsync(ParticipantJoiningNotification participantJoiningNotificationToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<ParticipantJoiningNotification> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ParticipantJoiningNotification}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ParticipantJoiningNotification>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<ParticipantJoiningNotification> UpdateAsync(ParticipantJoiningNotification participantJoiningNotificationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ParticipantJoiningNotification}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ParticipantJoiningNotification>> UpdateResponseAsync(ParticipantJoiningNotification participantJoiningNotificationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<ParticipantJoiningNotification> PutAsync(ParticipantJoiningNotification participantJoiningNotificationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="participantJoiningNotificationToUpdate">The ParticipantJoiningNotification object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{ParticipantJoiningNotification}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ParticipantJoiningNotification>> PutResponseAsync(ParticipantJoiningNotification participantJoiningNotificationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ParticipantJoiningNotification>(participantJoiningNotificationToUpdate, cancellationToken);
