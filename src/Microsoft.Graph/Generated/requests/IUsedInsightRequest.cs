...
namespace Microsoft.Graph
{
    ...
    public partial interface IUsedInsightRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<UsedInsight> PutAsync(UsedInsight usedInsightToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<UsedInsight>> PutResponseAsync(UsedInsight usedInsightToUpdate, CancellationToken cancellationToken = default(CancellationToken));
