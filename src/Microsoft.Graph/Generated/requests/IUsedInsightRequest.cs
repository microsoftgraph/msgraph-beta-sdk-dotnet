...
namespace Microsoft.Graph
{
    ...
    public partial interface IUsedInsightRequest : IBaseRequest
    {
        ...
        /// <param name="usedInsightToUpdate">The UsedInsight to update.</param>
        /// <returns>The <see cref="GraphResponse{UsedInsight}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UsedInsight>> UpdateResponseAsync(UsedInsight usedInsightToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UsedInsight}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UsedInsight>> UpdateResponseAsync(UsedInsight usedInsightToUpdate, CancellationToken cancellationToken);
