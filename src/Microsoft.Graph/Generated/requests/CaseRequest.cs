...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class CaseRequest : BaseRequest, ICaseRequest
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Case> UpdateAsync(Case caseToUpdate, CancellationToken cancellationToken)
        {
			...
			{
				if (caseToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					caseToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, caseToUpdate.GetType().Name)
						});
				}
			}
            if (caseToUpdate.AdditionalData != null)
