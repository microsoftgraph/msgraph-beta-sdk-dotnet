...
namespace Microsoft.Graph
{
    ...
    public partial class AzureADLicenseUsageRequest : BaseRequest, IAzureADLicenseUsageRequest
    {
        ...
        public async System.Threading.Tasks.Task<AzureADLicenseUsage> CreateAsync(AzureADLicenseUsage azureADLicenseUsageToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AzureADLicenseUsage>> CreateResponseAsync(AzureADLicenseUsage azureADLicenseUsageToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<AzureADLicenseUsage>(azureADLicenseUsageToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<AzureADLicenseUsage> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AzureADLicenseUsage}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AzureADLicenseUsage>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<AzureADLicenseUsage>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<AzureADLicenseUsage> UpdateAsync(AzureADLicenseUsage azureADLicenseUsageToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AzureADLicenseUsage}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AzureADLicenseUsage>> UpdateResponseAsync(AzureADLicenseUsage azureADLicenseUsageToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<AzureADLicenseUsage>(azureADLicenseUsageToUpdate, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<AzureADLicenseUsage> PutAsync(AzureADLicenseUsage azureADLicenseUsageToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="azureADLicenseUsageToUpdate">The AzureADLicenseUsage object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{AzureADLicenseUsage}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AzureADLicenseUsage>> PutResponseAsync(AzureADLicenseUsage azureADLicenseUsageToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<AzureADLicenseUsage>(azureADLicenseUsageToUpdate, cancellationToken);
