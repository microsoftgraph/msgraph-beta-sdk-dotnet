...
namespace Microsoft.Graph
{
    ...
    public partial class AzureADFeatureUsageRequest : BaseRequest, IAzureADFeatureUsageRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<AzureADFeatureUsage> PutAsync(AzureADFeatureUsage azureADFeatureUsageToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="azureADFeatureUsageToUpdate">The AzureADFeatureUsage object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{AzureADFeatureUsage}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AzureADFeatureUsage>> PutResponseAsync(AzureADFeatureUsage azureADFeatureUsageToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<AzureADFeatureUsage>(azureADFeatureUsageToUpdate, cancellationToken);
