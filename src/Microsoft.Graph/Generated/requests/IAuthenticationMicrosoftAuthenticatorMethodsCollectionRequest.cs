...
namespace Microsoft.Graph
{
    ...
    public partial interface IAuthenticationMicrosoftAuthenticatorMethodsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<MicrosoftAuthenticatorAuthenticationMethod> AddAsync(MicrosoftAuthenticatorAuthenticationMethod microsoftAuthenticatorAuthenticationMethod);
        ...
        /// <returns>The created MicrosoftAuthenticatorAuthenticationMethod.</returns>
        System.Threading.Tasks.Task<MicrosoftAuthenticatorAuthenticationMethod> AddAsync(MicrosoftAuthenticatorAuthenticationMethod microsoftAuthenticatorAuthenticationMethod, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<MicrosoftAuthenticatorAuthenticationMethod>> AddResponseAsync(MicrosoftAuthenticatorAuthenticationMethod microsoftAuthenticatorAuthenticationMethod);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MicrosoftAuthenticatorAuthenticationMethod}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MicrosoftAuthenticatorAuthenticationMethod>> AddResponseAsync(MicrosoftAuthenticatorAuthenticationMethod microsoftAuthenticatorAuthenticationMethod, CancellationToken cancellationToken);

        /// <summary>
        /// Gets the collection page.
        /// </summary>
        /// <returns>The collection page.</returns>
        System.Threading.Tasks.Task<IAuthenticationMicrosoftAuthenticatorMethodsCollectionPage> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        System.Threading.Tasks.Task<IAuthenticationMicrosoftAuthenticatorMethodsCollectionPage> GetAsync(CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<AuthenticationMicrosoftAuthenticatorMethodsCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AuthenticationMicrosoftAuthenticatorMethodsCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<AuthenticationMicrosoftAuthenticatorMethodsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
