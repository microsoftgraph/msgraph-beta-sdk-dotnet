...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsPhone81SCEPCertificateProfileManagedDeviceCertificateStatesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<IWindowsPhone81SCEPCertificateProfileManagedDeviceCertificateStatesCollectionPage> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        System.Threading.Tasks.Task<IWindowsPhone81SCEPCertificateProfileManagedDeviceCertificateStatesCollectionPage> GetAsync(CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsPhone81SCEPCertificateProfileManagedDeviceCertificateStatesCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsPhone81SCEPCertificateProfileManagedDeviceCertificateStatesCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhone81SCEPCertificateProfileManagedDeviceCertificateStatesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
