...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetRelatedAppsStatusReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetRelatedAppsStatusReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetRelatedAppsStatusReportRequest>, IDeviceManagementReportsGetRelatedAppsStatusReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetRelatedAppsStatusReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetRelatedAppsStatusReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetRelatedAppsStatusReportRequest(functionUrl, this.Client, options);
