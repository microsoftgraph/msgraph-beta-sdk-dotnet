...
namespace Microsoft.Graph
{
    ...
    public partial class CustomerPaymentJournalRequest : BaseRequest, ICustomerPaymentJournalRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<CustomerPaymentJournal>> CreateResponseAsync(CustomerPaymentJournal customerPaymentJournalToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CustomerPaymentJournal}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CustomerPaymentJournal>> UpdateResponseAsync(CustomerPaymentJournal customerPaymentJournalToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
