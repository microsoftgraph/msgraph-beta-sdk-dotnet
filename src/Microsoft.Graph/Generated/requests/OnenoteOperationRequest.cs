...
namespace Microsoft.Graph
{
    ...
    public partial class OnenoteOperationRequest : BaseRequest, IOnenoteOperationRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<OnenoteOperation> PutAsync(OnenoteOperation onenoteOperationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<OnenoteOperation>> PutResponseAsync(OnenoteOperation onenoteOperationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<OnenoteOperation>(onenoteOperationToUpdate, cancellationToken);
