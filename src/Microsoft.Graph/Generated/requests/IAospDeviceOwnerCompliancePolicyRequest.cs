...
namespace Microsoft.Graph
{
    ...
    public partial interface IAospDeviceOwnerCompliancePolicyRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AospDeviceOwnerCompliancePolicy> CreateAsync(AospDeviceOwnerCompliancePolicy aospDeviceOwnerCompliancePolicyToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<AospDeviceOwnerCompliancePolicy>> CreateResponseAsync(AospDeviceOwnerCompliancePolicy aospDeviceOwnerCompliancePolicyToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<AospDeviceOwnerCompliancePolicy> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AospDeviceOwnerCompliancePolicy}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AospDeviceOwnerCompliancePolicy>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<AospDeviceOwnerCompliancePolicy> UpdateAsync(AospDeviceOwnerCompliancePolicy aospDeviceOwnerCompliancePolicyToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AospDeviceOwnerCompliancePolicy}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AospDeviceOwnerCompliancePolicy>> UpdateResponseAsync(AospDeviceOwnerCompliancePolicy aospDeviceOwnerCompliancePolicyToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<AospDeviceOwnerCompliancePolicy> PutAsync(AospDeviceOwnerCompliancePolicy aospDeviceOwnerCompliancePolicyToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<AospDeviceOwnerCompliancePolicy>> PutResponseAsync(AospDeviceOwnerCompliancePolicy aospDeviceOwnerCompliancePolicyToUpdate, CancellationToken cancellationToken = default);
