...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsManagementAppRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<WindowsManagementApp> PutAsync(WindowsManagementApp windowsManagementAppToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsManagementApp>> PutResponseAsync(WindowsManagementApp windowsManagementAppToUpdate, CancellationToken cancellationToken = default(CancellationToken));
