...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AccessReviewInstanceDecisionItemRecordAllDecisionsRequestBuilder.
    /// </summary>
    public partial class AccessReviewInstanceDecisionItemRecordAllDecisionsRequestBuilder : BaseActionMethodRequestBuilder<IAccessReviewInstanceDecisionItemRecordAllDecisionsRequest>, IAccessReviewInstanceDecisionItemRecordAllDecisionsRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="AccessReviewInstanceDecisionItemRecordAllDecisionsRequestBuilder"/>.
        /// </summary>
        ...
        protected override IAccessReviewInstanceDecisionItemRecordAllDecisionsRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new AccessReviewInstanceDecisionItemRecordAllDecisionsRequest(functionUrl, this.Client, options);
