...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidForWorkImportedPFXCertificateProfileRequestBuilder : AndroidCertificateProfileBaseRequestBuilder, IAndroidForWorkImportedPFXCertificateProfileRequestBuilder
    {
        ...
        public IAndroidForWorkImportedPFXCertificateProfileManagedDeviceCertificateStatesCollectionRequestBuilder ManagedDeviceCertificateStates
        {
            get
            {
                return new AndroidForWorkImportedPFXCertificateProfileManagedDeviceCertificateStatesCollectionRequestBuilder(this.AppendSegmentToRequestUrl("managedDeviceCertificateStates"), this.Client);
            }
        }
