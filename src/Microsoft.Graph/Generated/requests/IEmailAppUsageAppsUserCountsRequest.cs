...
namespace Microsoft.Graph
{
    ...
    public partial interface IEmailAppUsageAppsUserCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<EmailAppUsageAppsUserCounts> CreateAsync(EmailAppUsageAppsUserCounts emailAppUsageAppsUserCountsToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<EmailAppUsageAppsUserCounts>> CreateResponseAsync(EmailAppUsageAppsUserCounts emailAppUsageAppsUserCountsToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EmailAppUsageAppsUserCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EmailAppUsageAppsUserCounts>> CreateResponseAsync(EmailAppUsageAppsUserCounts emailAppUsageAppsUserCountsToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="emailAppUsageAppsUserCountsToUpdate">The EmailAppUsageAppsUserCounts to update.</param>
        /// <returns>The <see cref="GraphResponse{EmailAppUsageAppsUserCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EmailAppUsageAppsUserCounts>> UpdateResponseAsync(EmailAppUsageAppsUserCounts emailAppUsageAppsUserCountsToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{EmailAppUsageAppsUserCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EmailAppUsageAppsUserCounts>> UpdateResponseAsync(EmailAppUsageAppsUserCounts emailAppUsageAppsUserCountsToUpdate, CancellationToken cancellationToken);
