...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetComplianceSettingDetailsReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetComplianceSettingDetailsReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetComplianceSettingDetailsReportRequest>, IDeviceManagementReportsGetComplianceSettingDetailsReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetComplianceSettingDetailsReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetComplianceSettingDetailsReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetComplianceSettingDetailsReportRequest(functionUrl, this.Client, options);
