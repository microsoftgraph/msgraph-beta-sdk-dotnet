...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetSkypeForBusinessActivityUserCountsRequest : BaseRequest, IReportRootGetSkypeForBusinessActivityUserCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessActivityUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessActivityUserCountsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="skypeforbusinessactivityusercounts">The SkypeForBusinessActivityUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessActivityUserCountsCollectionResponse>> PatchResponseAsync(SkypeForBusinessActivityUserCounts skypeforbusinessactivityusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessActivityUserCountsCollectionResponse>(skypeforbusinessactivityusercounts, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="skypeforbusinessactivityusercounts">The SkypeForBusinessActivityUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessActivityUserCountsCollectionResponse>> PutResponseAsync(SkypeForBusinessActivityUserCounts skypeforbusinessactivityusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessActivityUserCountsCollectionResponse>(skypeforbusinessactivityusercounts, cancellationToken).ConfigureAwait(false);
        }
