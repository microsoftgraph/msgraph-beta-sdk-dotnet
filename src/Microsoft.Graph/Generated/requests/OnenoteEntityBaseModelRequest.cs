...
namespace Microsoft.Graph
{
    ...
    public partial class OnenoteEntityBaseModelRequest : BaseRequest, IOnenoteEntityBaseModelRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{OnenoteEntityBaseModel}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OnenoteEntityBaseModel>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OnenoteEntityBaseModel}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OnenoteEntityBaseModel>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<OnenoteEntityBaseModel>(null, cancellationToken).ConfigureAwait(false);
        }
