...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IPlannerPlanWithReferenceRequest.
    /// </summary>
    public partial interface IPlannerPlanWithReferenceRequest : IBaseRequest
    {
        /// <summary>
        ...
        System.Threading.Tasks.Task<GraphResponse<PlannerPlan>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PlannerPlan}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<PlannerPlan>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="plannerPlanToUpdate">The PlannerPlan to update.</param>
        /// <returns>The <see cref="GraphResponse{PlannerPlan}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<PlannerPlan>> UpdateResponseAsync(PlannerPlan plannerPlanToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PlannerPlan}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<PlannerPlan>> UpdateResponseAsync(PlannerPlan plannerPlanToUpdate, CancellationToken cancellationToken);
        ...
        IPlannerPlanWithReferenceRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IPlannerPlanWithReferenceRequest Expand(Expression<Func<PlannerPlan, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IPlannerPlanWithReferenceRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IPlannerPlanWithReferenceRequest Select(Expression<Func<PlannerPlan, object>> selectExpression);
