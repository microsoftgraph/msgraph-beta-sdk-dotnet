...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceAndAppManagementDataContentRequest : BaseRequest, IDeviceAndAppManagementDataContentRequest
    {
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream content, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : DeviceAndAppManagementData
        {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream content, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : DeviceAndAppManagementData
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = "PUT";
