...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceAndAppManagementDataContentRequest : BaseRequest, IDeviceAndAppManagementDataContentRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream content, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : DeviceAndAppManagementData
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = CoreConstants.HttpMethods.PUT.ToString();
