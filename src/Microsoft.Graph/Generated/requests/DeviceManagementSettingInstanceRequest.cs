...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementSettingInstanceRequest : BaseRequest, IDeviceManagementSettingInstanceRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementSettingInstance>> CreateResponseAsync(DeviceManagementSettingInstance deviceManagementSettingInstanceToCreate)
        {
            return this.CreateResponseAsync(deviceManagementSettingInstanceToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementSettingInstance}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementSettingInstance>> CreateResponseAsync(DeviceManagementSettingInstance deviceManagementSettingInstanceToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DeviceManagementSettingInstance>(deviceManagementSettingInstanceToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DeviceManagementSettingInstance}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementSettingInstance>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementSettingInstance}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementSettingInstance>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceManagementSettingInstance>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="deviceManagementSettingInstanceToUpdate">The DeviceManagementSettingInstance to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementSettingInstance}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementSettingInstance>> UpdateResponseAsync(DeviceManagementSettingInstance deviceManagementSettingInstanceToUpdate)
        {
            return this.UpdateResponseAsync(deviceManagementSettingInstanceToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementSettingInstance}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementSettingInstance>> UpdateResponseAsync(DeviceManagementSettingInstance deviceManagementSettingInstanceToUpdate, CancellationToken cancellationToken)
        {
			if (deviceManagementSettingInstanceToUpdate.AdditionalData != null)
			{
				if (deviceManagementSettingInstanceToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<DeviceManagementSettingInstance>(deviceManagementSettingInstanceToUpdate, cancellationToken).ConfigureAwait(false);
        }
