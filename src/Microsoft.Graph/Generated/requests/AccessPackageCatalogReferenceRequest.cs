...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class AccessPackageCatalogReferenceRequest : BaseRequest, IAccessPackageCatalogReferenceRequest
    {
        /// <summary>
        ...
        public AccessPackageCatalogReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Puts the specified AccessPackageCatalog reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The AccessPackageCatalog reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
