...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DeviceManagementReportsGetCompliancePolicyNonComplianceSummaryReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetCompliancePolicyNonComplianceSummaryReportRequest>, IDeviceManagementReportsGetCompliancePolicyNonComplianceSummaryReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetCompliancePolicyNonComplianceSummaryReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetCompliancePolicyNonComplianceSummaryReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetCompliancePolicyNonComplianceSummaryReportRequest(functionUrl, this.Client, options);
