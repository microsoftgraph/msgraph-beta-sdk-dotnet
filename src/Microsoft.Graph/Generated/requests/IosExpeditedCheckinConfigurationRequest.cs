...
namespace Microsoft.Graph
{
    ...
    public partial class IosExpeditedCheckinConfigurationRequest : BaseRequest, IIosExpeditedCheckinConfigurationRequest
    {
        ...
        public async System.Threading.Tasks.Task<IosExpeditedCheckinConfiguration> CreateAsync(IosExpeditedCheckinConfiguration iosExpeditedCheckinConfigurationToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<IosExpeditedCheckinConfiguration>> CreateResponseAsync(IosExpeditedCheckinConfiguration iosExpeditedCheckinConfigurationToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<IosExpeditedCheckinConfiguration>(iosExpeditedCheckinConfigurationToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<IosExpeditedCheckinConfiguration> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosExpeditedCheckinConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosExpeditedCheckinConfiguration>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<IosExpeditedCheckinConfiguration>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<IosExpeditedCheckinConfiguration> UpdateAsync(IosExpeditedCheckinConfiguration iosExpeditedCheckinConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosExpeditedCheckinConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosExpeditedCheckinConfiguration>> UpdateResponseAsync(IosExpeditedCheckinConfiguration iosExpeditedCheckinConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<IosExpeditedCheckinConfiguration>(iosExpeditedCheckinConfigurationToUpdate, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<IosExpeditedCheckinConfiguration> PutAsync(IosExpeditedCheckinConfiguration iosExpeditedCheckinConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="iosExpeditedCheckinConfigurationToUpdate">The IosExpeditedCheckinConfiguration object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{IosExpeditedCheckinConfiguration}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosExpeditedCheckinConfiguration>> PutResponseAsync(IosExpeditedCheckinConfiguration iosExpeditedCheckinConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<IosExpeditedCheckinConfiguration>(iosExpeditedCheckinConfigurationToUpdate, cancellationToken);
