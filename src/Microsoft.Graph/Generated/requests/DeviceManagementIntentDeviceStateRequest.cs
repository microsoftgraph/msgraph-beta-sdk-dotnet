...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementIntentDeviceStateRequest : BaseRequest, IDeviceManagementIntentDeviceStateRequest
    {
        ...
        public async System.Threading.Tasks.Task<DeviceManagementIntentDeviceState> CreateAsync(DeviceManagementIntentDeviceState deviceManagementIntentDeviceStateToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntentDeviceState>> CreateResponseAsync(DeviceManagementIntentDeviceState deviceManagementIntentDeviceStateToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<DeviceManagementIntentDeviceState> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementIntentDeviceState}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntentDeviceState>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<DeviceManagementIntentDeviceState> UpdateAsync(DeviceManagementIntentDeviceState deviceManagementIntentDeviceStateToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementIntentDeviceState}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntentDeviceState>> UpdateResponseAsync(DeviceManagementIntentDeviceState deviceManagementIntentDeviceStateToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementIntentDeviceState> PutAsync(DeviceManagementIntentDeviceState deviceManagementIntentDeviceStateToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="deviceManagementIntentDeviceStateToUpdate">The DeviceManagementIntentDeviceState object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{DeviceManagementIntentDeviceState}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntentDeviceState>> PutResponseAsync(DeviceManagementIntentDeviceState deviceManagementIntentDeviceStateToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<DeviceManagementIntentDeviceState>(deviceManagementIntentDeviceStateToUpdate, cancellationToken);
