...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementIntentDeviceStateRequest : BaseRequest, IDeviceManagementIntentDeviceStateRequest
    {
        ...
        public System.Threading.Tasks.Task<DeviceManagementIntentDeviceState> CreateAsync(DeviceManagementIntentDeviceState deviceManagementIntentDeviceStateToCreate)
        {
            return this.CreateAsync(deviceManagementIntentDeviceStateToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created DeviceManagementIntentDeviceState.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementIntentDeviceState> CreateAsync(DeviceManagementIntentDeviceState deviceManagementIntentDeviceStateToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntentDeviceState>> CreateResponseAsync(DeviceManagementIntentDeviceState deviceManagementIntentDeviceStateToCreate)
        {
            return this.CreateResponseAsync(deviceManagementIntentDeviceStateToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementIntentDeviceState}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntentDeviceState>> CreateResponseAsync(DeviceManagementIntentDeviceState deviceManagementIntentDeviceStateToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        public System.Threading.Tasks.Task<DeviceManagementIntentDeviceState> UpdateAsync(DeviceManagementIntentDeviceState deviceManagementIntentDeviceStateToUpdate)
        {
            return this.UpdateAsync(deviceManagementIntentDeviceStateToUpdate, CancellationToken.None);
        }
        ...
        /// <returns>The updated DeviceManagementIntentDeviceState.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementIntentDeviceState> UpdateAsync(DeviceManagementIntentDeviceState deviceManagementIntentDeviceStateToUpdate, CancellationToken cancellationToken)
        {
			if (deviceManagementIntentDeviceStateToUpdate.AdditionalData != null)
			{
				if (deviceManagementIntentDeviceStateToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					deviceManagementIntentDeviceStateToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, deviceManagementIntentDeviceStateToUpdate.GetType().Name)
						});
				}
			}
            if (deviceManagementIntentDeviceStateToUpdate.AdditionalData != null)
        ...
        /// <param name="deviceManagementIntentDeviceStateToUpdate">The DeviceManagementIntentDeviceState to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementIntentDeviceState}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntentDeviceState>> UpdateResponseAsync(DeviceManagementIntentDeviceState deviceManagementIntentDeviceStateToUpdate)
        {
            return this.UpdateResponseAsync(deviceManagementIntentDeviceStateToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementIntentDeviceState}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntentDeviceState>> UpdateResponseAsync(DeviceManagementIntentDeviceState deviceManagementIntentDeviceStateToUpdate, CancellationToken cancellationToken)
        {
			if (deviceManagementIntentDeviceStateToUpdate.AdditionalData != null)
			{
				if (deviceManagementIntentDeviceStateToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
