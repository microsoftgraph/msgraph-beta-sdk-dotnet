...
namespace Microsoft.Graph
{
    ...
    public partial interface IManagementConditionStatementRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<ManagementConditionStatement> PutAsync(ManagementConditionStatement managementConditionStatementToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<ManagementConditionStatement>> PutResponseAsync(ManagementConditionStatement managementConditionStatementToUpdate, CancellationToken cancellationToken = default(CancellationToken));
