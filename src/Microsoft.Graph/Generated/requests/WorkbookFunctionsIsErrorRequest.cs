...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsIsErrorRequest : BaseRequest, IWorkbookFunctionsIsErrorRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsIsErrorRequest.
        /// </summary>
        public WorkbookFunctionsIsErrorRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsIsErrorRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsIsErrorRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsIsErrorRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsIsErrorRequest Select(string value)
        {
