...
namespace Microsoft.Graph
{
    ...
    public partial interface IEventMessageResponseRequest : IBaseRequest
    {
        ...
        /// <param name="eventMessageResponseToUpdate">The EventMessageResponse to update.</param>
        /// <returns>The <see cref="GraphResponse{EventMessageResponse}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EventMessageResponse>> UpdateResponseAsync(EventMessageResponse eventMessageResponseToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{EventMessageResponse}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EventMessageResponse>> UpdateResponseAsync(EventMessageResponse eventMessageResponseToUpdate, CancellationToken cancellationToken);
