...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AccessPackageCatalogAccessPackagesCollectionReferencesRequest.
    /// </summary>
    public partial class AccessPackageCatalogAccessPackagesCollectionReferencesRequest : BaseRequest, IAccessPackageCatalogAccessPackagesCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new AccessPackageCatalogAccessPackagesCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public AccessPackageCatalogAccessPackagesCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
