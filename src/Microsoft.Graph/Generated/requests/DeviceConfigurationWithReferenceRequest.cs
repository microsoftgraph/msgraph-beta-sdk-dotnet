...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceConfigurationWithReferenceRequest : BaseRequest, IDeviceConfigurationWithReferenceRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="deviceConfigurationToCreate">The DeviceConfiguration to create.</param>
        /// <returns>The <see cref="GraphResponse{DeviceConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceConfiguration>> CreateResponseAsync(DeviceConfiguration deviceConfigurationToCreate)
        {
            return this.CreateResponseAsync(deviceConfigurationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceConfiguration>> CreateResponseAsync(DeviceConfiguration deviceConfigurationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DeviceConfiguration>(deviceConfigurationToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="deviceConfigurationToUpdate">The DeviceConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceConfiguration>> UpdateResponseAsync(DeviceConfiguration deviceConfigurationToUpdate)
        {
            return this.UpdateResponseAsync(deviceConfigurationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceConfiguration>> UpdateResponseAsync(DeviceConfiguration deviceConfigurationToUpdate, CancellationToken cancellationToken)
        {
			if (deviceConfigurationToUpdate.AdditionalData != null)
			{
				if (deviceConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<DeviceConfiguration>(deviceConfigurationToUpdate, cancellationToken).ConfigureAwait(false);
        }
