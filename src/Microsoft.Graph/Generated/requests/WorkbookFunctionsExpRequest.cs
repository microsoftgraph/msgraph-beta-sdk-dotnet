...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsExpRequest : BaseRequest, IWorkbookFunctionsExpRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsExpRequest.
        /// </summary>
        public WorkbookFunctionsExpRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsExpRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsExpRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsExpRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsExpRequest Select(string value)
        {
