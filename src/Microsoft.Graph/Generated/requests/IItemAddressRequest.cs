...
namespace Microsoft.Graph
{
    ...
    public partial interface IItemAddressRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ItemAddress> CreateAsync(ItemAddress itemAddressToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<ItemAddress>> CreateResponseAsync(ItemAddress itemAddressToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ItemAddress> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ItemAddress}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ItemAddress>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ItemAddress> UpdateAsync(ItemAddress itemAddressToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ItemAddress}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ItemAddress>> UpdateResponseAsync(ItemAddress itemAddressToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<ItemAddress> PutAsync(ItemAddress itemAddressToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="itemAddressToUpdate">The ItemAddress object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{ItemAddress}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<ItemAddress>> PutResponseAsync(ItemAddress itemAddressToUpdate, CancellationToken cancellationToken = default);
