...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookFunctionsRequest : BaseRequest, IWorkbookFunctionsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WorkbookFunctions>> CreateResponseAsync(WorkbookFunctions workbookFunctionsToCreate)
        {
            return this.CreateResponseAsync(workbookFunctionsToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookFunctions}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookFunctions>> CreateResponseAsync(WorkbookFunctions workbookFunctionsToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="workbookFunctionsToUpdate">The WorkbookFunctions to update.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookFunctions}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookFunctions>> UpdateResponseAsync(WorkbookFunctions workbookFunctionsToUpdate)
        {
            return this.UpdateResponseAsync(workbookFunctionsToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookFunctions}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookFunctions>> UpdateResponseAsync(WorkbookFunctions workbookFunctionsToUpdate, CancellationToken cancellationToken)
        {
			if (workbookFunctionsToUpdate.AdditionalData != null)
			{
				if (workbookFunctionsToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
