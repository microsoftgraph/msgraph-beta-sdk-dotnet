...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookFunctionsRequest : BaseRequest, IWorkbookFunctionsRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<WorkbookFunctions> PutAsync(WorkbookFunctions workbookFunctionsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<WorkbookFunctions>> PutResponseAsync(WorkbookFunctions workbookFunctionsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<WorkbookFunctions>(workbookFunctionsToUpdate, cancellationToken);
