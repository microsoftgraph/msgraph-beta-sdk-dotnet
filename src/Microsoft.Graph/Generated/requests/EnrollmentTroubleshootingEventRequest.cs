...
namespace Microsoft.Graph
{
    ...
    public partial class EnrollmentTroubleshootingEventRequest : BaseRequest, IEnrollmentTroubleshootingEventRequest
    {
        ...
        /// <param name="enrollmentTroubleshootingEventToUpdate">The EnrollmentTroubleshootingEvent to update.</param>
        /// <returns>The <see cref="GraphResponse{EnrollmentTroubleshootingEvent}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<EnrollmentTroubleshootingEvent>> UpdateResponseAsync(EnrollmentTroubleshootingEvent enrollmentTroubleshootingEventToUpdate)
        {
            return this.UpdateResponseAsync(enrollmentTroubleshootingEventToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{EnrollmentTroubleshootingEvent}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EnrollmentTroubleshootingEvent>> UpdateResponseAsync(EnrollmentTroubleshootingEvent enrollmentTroubleshootingEventToUpdate, CancellationToken cancellationToken)
        {
			if (enrollmentTroubleshootingEventToUpdate.AdditionalData != null)
			{
				if (enrollmentTroubleshootingEventToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
