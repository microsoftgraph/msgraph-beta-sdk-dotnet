...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsOfficeClientConfigurationRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<WindowsOfficeClientConfiguration> PutAsync(WindowsOfficeClientConfiguration windowsOfficeClientConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsOfficeClientConfiguration>> PutResponseAsync(WindowsOfficeClientConfiguration windowsOfficeClientConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
