...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetConfigurationPoliciesReportForDeviceRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetConfigurationPoliciesReportForDeviceRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetConfigurationPoliciesReportForDeviceRequest>, IDeviceManagementReportsGetConfigurationPoliciesReportForDeviceRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetConfigurationPoliciesReportForDeviceRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetConfigurationPoliciesReportForDeviceRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetConfigurationPoliciesReportForDeviceRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetConfigurationPoliciesReportForDeviceRequest(functionUrl, this.Client, options);
