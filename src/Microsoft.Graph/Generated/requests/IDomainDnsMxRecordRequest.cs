...
namespace Microsoft.Graph
{
    ...
    public partial interface IDomainDnsMxRecordRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<DomainDnsMxRecord> PutAsync(DomainDnsMxRecord domainDnsMxRecordToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<DomainDnsMxRecord>> PutResponseAsync(DomainDnsMxRecord domainDnsMxRecordToUpdate, CancellationToken cancellationToken = default(CancellationToken));
