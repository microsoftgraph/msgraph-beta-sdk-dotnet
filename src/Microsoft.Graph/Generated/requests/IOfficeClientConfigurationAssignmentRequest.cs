...
namespace Microsoft.Graph
{
    ...
    public partial interface IOfficeClientConfigurationAssignmentRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<OfficeClientConfigurationAssignment> CreateAsync(OfficeClientConfigurationAssignment officeClientConfigurationAssignmentToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<OfficeClientConfigurationAssignment>> CreateResponseAsync(OfficeClientConfigurationAssignment officeClientConfigurationAssignmentToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OfficeClientConfigurationAssignment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<OfficeClientConfigurationAssignment>> CreateResponseAsync(OfficeClientConfigurationAssignment officeClientConfigurationAssignmentToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="officeClientConfigurationAssignmentToUpdate">The OfficeClientConfigurationAssignment to update.</param>
        /// <returns>The <see cref="GraphResponse{OfficeClientConfigurationAssignment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<OfficeClientConfigurationAssignment>> UpdateResponseAsync(OfficeClientConfigurationAssignment officeClientConfigurationAssignmentToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{OfficeClientConfigurationAssignment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<OfficeClientConfigurationAssignment>> UpdateResponseAsync(OfficeClientConfigurationAssignment officeClientConfigurationAssignmentToUpdate, CancellationToken cancellationToken);
