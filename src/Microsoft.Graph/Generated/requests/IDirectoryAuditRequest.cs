...
namespace Microsoft.Graph
{
    ...
    public partial interface IDirectoryAuditRequest : IBaseRequest
    {
        ...
        /// <param name="directoryAuditToUpdate">The DirectoryAudit to update.</param>
        /// <returns>The <see cref="GraphResponse{DirectoryAudit}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DirectoryAudit>> UpdateResponseAsync(DirectoryAudit directoryAuditToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DirectoryAudit}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DirectoryAudit>> UpdateResponseAsync(DirectoryAudit directoryAuditToUpdate, CancellationToken cancellationToken);
