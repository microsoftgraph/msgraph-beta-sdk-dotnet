...
namespace Microsoft.Graph
{
    ...
    public partial class ItemEmailRequest : BaseRequest, IItemEmailRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ItemEmail>> CreateResponseAsync(ItemEmail itemEmailToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ItemEmail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ItemEmail>> UpdateResponseAsync(ItemEmail itemEmailToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
