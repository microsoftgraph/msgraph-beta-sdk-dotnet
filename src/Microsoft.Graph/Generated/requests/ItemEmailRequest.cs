...
namespace Microsoft.Graph
{
    ...
    public partial class ItemEmailRequest : BaseRequest, IItemEmailRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ItemEmail>> CreateResponseAsync(ItemEmail itemEmailToCreate)
        {
            return this.CreateResponseAsync(itemEmailToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ItemEmail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ItemEmail>> CreateResponseAsync(ItemEmail itemEmailToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<ItemEmail>(itemEmailToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ItemEmail}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ItemEmail>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ItemEmail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ItemEmail>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ItemEmail>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="itemEmailToUpdate">The ItemEmail to update.</param>
        /// <returns>The <see cref="GraphResponse{ItemEmail}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ItemEmail>> UpdateResponseAsync(ItemEmail itemEmailToUpdate)
        {
            return this.UpdateResponseAsync(itemEmailToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ItemEmail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ItemEmail>> UpdateResponseAsync(ItemEmail itemEmailToUpdate, CancellationToken cancellationToken)
        {
			if (itemEmailToUpdate.AdditionalData != null)
			{
				if (itemEmailToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ItemEmail>(itemEmailToUpdate, cancellationToken).ConfigureAwait(false);
        }
