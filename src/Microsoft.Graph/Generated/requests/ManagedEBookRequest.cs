...
namespace Microsoft.Graph
{
    ...
    public partial class ManagedEBookRequest : BaseRequest, IManagedEBookRequest
    {
        ...
        /// <param name="managedEBookToUpdate">The ManagedEBook to update.</param>
        /// <returns>The <see cref="GraphResponse{ManagedEBook}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ManagedEBook>> UpdateResponseAsync(ManagedEBook managedEBookToUpdate)
        {
            return this.UpdateResponseAsync(managedEBookToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ManagedEBook}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ManagedEBook>> UpdateResponseAsync(ManagedEBook managedEBookToUpdate, CancellationToken cancellationToken)
        {
			if (managedEBookToUpdate.AdditionalData != null)
			{
				if (managedEBookToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
