...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IReportRootDailyPrintUsageByUserCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IReportRootDailyPrintUsageByUserCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IReportRootDailyPrintUsageByUserCollectionRequest Request(IEnumerable<Option> options);
