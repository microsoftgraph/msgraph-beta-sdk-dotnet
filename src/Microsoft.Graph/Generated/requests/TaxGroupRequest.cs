...
namespace Microsoft.Graph
{
    ...
    public partial class TaxGroupRequest : BaseRequest, ITaxGroupRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{TaxGroup}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TaxGroup>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TaxGroup}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<TaxGroup>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<TaxGroup>(null, cancellationToken).ConfigureAwait(false);
        }
