...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetUserInstallStatusReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetUserInstallStatusReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetUserInstallStatusReportRequest>, IDeviceManagementReportsGetUserInstallStatusReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetUserInstallStatusReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetUserInstallStatusReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetUserInstallStatusReportRequest(functionUrl, this.Client, options);
