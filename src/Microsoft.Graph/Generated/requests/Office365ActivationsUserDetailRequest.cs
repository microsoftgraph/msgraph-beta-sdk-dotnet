...
namespace Microsoft.Graph
{
    ...
    public partial class Office365ActivationsUserDetailRequest : BaseRequest, IOffice365ActivationsUserDetailRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Office365ActivationsUserDetail>> CreateResponseAsync(Office365ActivationsUserDetail office365ActivationsUserDetailToCreate)
        {
            return this.CreateResponseAsync(office365ActivationsUserDetailToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Office365ActivationsUserDetail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Office365ActivationsUserDetail>> CreateResponseAsync(Office365ActivationsUserDetail office365ActivationsUserDetailToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="office365ActivationsUserDetailToUpdate">The Office365ActivationsUserDetail to update.</param>
        /// <returns>The <see cref="GraphResponse{Office365ActivationsUserDetail}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Office365ActivationsUserDetail>> UpdateResponseAsync(Office365ActivationsUserDetail office365ActivationsUserDetailToUpdate)
        {
            return this.UpdateResponseAsync(office365ActivationsUserDetailToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Office365ActivationsUserDetail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Office365ActivationsUserDetail>> UpdateResponseAsync(Office365ActivationsUserDetail office365ActivationsUserDetailToUpdate, CancellationToken cancellationToken)
        {
			if (office365ActivationsUserDetailToUpdate.AdditionalData != null)
			{
				if (office365ActivationsUserDetailToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
