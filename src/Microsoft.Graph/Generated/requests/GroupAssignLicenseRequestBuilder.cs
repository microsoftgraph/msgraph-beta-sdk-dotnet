...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class GroupAssignLicenseRequestBuilder : BaseActionMethodRequestBuilder<IGroupAssignLicenseRequest>, IGroupAssignLicenseRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="GroupAssignLicenseRequestBuilder"/>.
        /// </summary>
        ...
        public GroupAssignLicenseRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IGroupAssignLicenseRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new GroupAssignLicenseRequest(functionUrl, this.Client, options);
