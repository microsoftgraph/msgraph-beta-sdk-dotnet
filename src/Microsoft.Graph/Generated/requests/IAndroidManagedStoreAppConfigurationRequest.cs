...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidManagedStoreAppConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AndroidManagedStoreAppConfiguration> CreateAsync(AndroidManagedStoreAppConfiguration androidManagedStoreAppConfigurationToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidManagedStoreAppConfiguration>> CreateResponseAsync(AndroidManagedStoreAppConfiguration androidManagedStoreAppConfigurationToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidManagedStoreAppConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidManagedStoreAppConfiguration>> CreateResponseAsync(AndroidManagedStoreAppConfiguration androidManagedStoreAppConfigurationToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AndroidManagedStoreAppConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidManagedStoreAppConfiguration>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidManagedStoreAppConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidManagedStoreAppConfiguration>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="androidManagedStoreAppConfigurationToUpdate">The AndroidManagedStoreAppConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{AndroidManagedStoreAppConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidManagedStoreAppConfiguration>> UpdateResponseAsync(AndroidManagedStoreAppConfiguration androidManagedStoreAppConfigurationToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidManagedStoreAppConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidManagedStoreAppConfiguration>> UpdateResponseAsync(AndroidManagedStoreAppConfiguration androidManagedStoreAppConfigurationToUpdate, CancellationToken cancellationToken);
