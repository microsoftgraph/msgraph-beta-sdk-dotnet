...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidManagedStoreAppConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AndroidManagedStoreAppConfiguration> CreateAsync(AndroidManagedStoreAppConfiguration androidManagedStoreAppConfigurationToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidManagedStoreAppConfiguration>> CreateResponseAsync(AndroidManagedStoreAppConfiguration androidManagedStoreAppConfigurationToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<AndroidManagedStoreAppConfiguration> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidManagedStoreAppConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidManagedStoreAppConfiguration>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<AndroidManagedStoreAppConfiguration> UpdateAsync(AndroidManagedStoreAppConfiguration androidManagedStoreAppConfigurationToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidManagedStoreAppConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidManagedStoreAppConfiguration>> UpdateResponseAsync(AndroidManagedStoreAppConfiguration androidManagedStoreAppConfigurationToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<AndroidManagedStoreAppConfiguration> PutAsync(AndroidManagedStoreAppConfiguration androidManagedStoreAppConfigurationToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidManagedStoreAppConfiguration>> PutResponseAsync(AndroidManagedStoreAppConfiguration androidManagedStoreAppConfigurationToUpdate, CancellationToken cancellationToken = default);
