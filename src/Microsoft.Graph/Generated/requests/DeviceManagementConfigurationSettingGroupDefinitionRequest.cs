...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementConfigurationSettingGroupDefinitionRequest : BaseRequest, IDeviceManagementConfigurationSettingGroupDefinitionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationSettingGroupDefinition>> CreateResponseAsync(DeviceManagementConfigurationSettingGroupDefinition deviceManagementConfigurationSettingGroupDefinitionToCreate)
        {
            return this.CreateResponseAsync(deviceManagementConfigurationSettingGroupDefinitionToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementConfigurationSettingGroupDefinition}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationSettingGroupDefinition>> CreateResponseAsync(DeviceManagementConfigurationSettingGroupDefinition deviceManagementConfigurationSettingGroupDefinitionToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DeviceManagementConfigurationSettingGroupDefinition>(deviceManagementConfigurationSettingGroupDefinitionToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DeviceManagementConfigurationSettingGroupDefinition}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationSettingGroupDefinition>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementConfigurationSettingGroupDefinition}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationSettingGroupDefinition>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceManagementConfigurationSettingGroupDefinition>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="deviceManagementConfigurationSettingGroupDefinitionToUpdate">The DeviceManagementConfigurationSettingGroupDefinition to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementConfigurationSettingGroupDefinition}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationSettingGroupDefinition>> UpdateResponseAsync(DeviceManagementConfigurationSettingGroupDefinition deviceManagementConfigurationSettingGroupDefinitionToUpdate)
        {
            return this.UpdateResponseAsync(deviceManagementConfigurationSettingGroupDefinitionToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementConfigurationSettingGroupDefinition}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationSettingGroupDefinition>> UpdateResponseAsync(DeviceManagementConfigurationSettingGroupDefinition deviceManagementConfigurationSettingGroupDefinitionToUpdate, CancellationToken cancellationToken)
        {
			if (deviceManagementConfigurationSettingGroupDefinitionToUpdate.AdditionalData != null)
			{
				if (deviceManagementConfigurationSettingGroupDefinitionToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<DeviceManagementConfigurationSettingGroupDefinition>(deviceManagementConfigurationSettingGroupDefinitionToUpdate, cancellationToken).ConfigureAwait(false);
        }
