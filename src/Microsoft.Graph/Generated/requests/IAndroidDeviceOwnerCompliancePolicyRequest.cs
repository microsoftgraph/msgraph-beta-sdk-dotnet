...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidDeviceOwnerCompliancePolicyRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<AndroidDeviceOwnerCompliancePolicy> PutAsync(AndroidDeviceOwnerCompliancePolicy androidDeviceOwnerCompliancePolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerCompliancePolicy>> PutResponseAsync(AndroidDeviceOwnerCompliancePolicy androidDeviceOwnerCompliancePolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken));
