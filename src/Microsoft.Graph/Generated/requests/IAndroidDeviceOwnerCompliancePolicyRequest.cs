...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidDeviceOwnerCompliancePolicyRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AndroidDeviceOwnerCompliancePolicy> CreateAsync(AndroidDeviceOwnerCompliancePolicy androidDeviceOwnerCompliancePolicyToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerCompliancePolicy>> CreateResponseAsync(AndroidDeviceOwnerCompliancePolicy androidDeviceOwnerCompliancePolicyToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceOwnerCompliancePolicy}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerCompliancePolicy>> CreateResponseAsync(AndroidDeviceOwnerCompliancePolicy androidDeviceOwnerCompliancePolicyToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceOwnerCompliancePolicy}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerCompliancePolicy>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceOwnerCompliancePolicy}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerCompliancePolicy>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="androidDeviceOwnerCompliancePolicyToUpdate">The AndroidDeviceOwnerCompliancePolicy to update.</param>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceOwnerCompliancePolicy}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerCompliancePolicy>> UpdateResponseAsync(AndroidDeviceOwnerCompliancePolicy androidDeviceOwnerCompliancePolicyToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceOwnerCompliancePolicy}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidDeviceOwnerCompliancePolicy>> UpdateResponseAsync(AndroidDeviceOwnerCompliancePolicy androidDeviceOwnerCompliancePolicyToUpdate, CancellationToken cancellationToken);
