...
namespace Microsoft.Graph
{
    ...
    public partial class UsageRightRequest : BaseRequest, IUsageRightRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{UsageRight}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UsageRight>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UsageRight}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UsageRight>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<UsageRight>(null, cancellationToken).ConfigureAwait(false);
        }
