...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IChannelMembersCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IChannelMembersCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IChannelMembersCollectionRequest Request(IEnumerable<Option> options);
