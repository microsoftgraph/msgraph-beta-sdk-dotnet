...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsFloor_PreciseRequest : BaseRequest, IWorkbookFunctionsFloor_PreciseRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsFloor_PreciseRequest.
        /// </summary>
        public WorkbookFunctionsFloor_PreciseRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsFloor_PreciseRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsFloor_PreciseRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsFloor_PreciseRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsFloor_PreciseRequest Select(string value)
        {
