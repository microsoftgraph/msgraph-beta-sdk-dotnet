...
namespace Microsoft.Graph
{
    ...
    public partial class PlannerTasksCollectionRequest : BaseRequest, IPlannerTasksCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PlannerTasksCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PlannerTasksCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PlannerTasksCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
