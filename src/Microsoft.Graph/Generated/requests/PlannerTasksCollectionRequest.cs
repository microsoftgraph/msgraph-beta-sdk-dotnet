...
namespace Microsoft.Graph
{
    ...
    public partial class PlannerTasksCollectionRequest : BaseRequest, IPlannerTasksCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<IPlannerTasksCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
        ...
        public async System.Threading.Tasks.Task<GraphResponse<PlannerTasksCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<PlannerTasksCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
