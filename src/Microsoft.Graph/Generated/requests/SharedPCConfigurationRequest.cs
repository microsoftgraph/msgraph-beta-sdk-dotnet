...
namespace Microsoft.Graph
{
    ...
    public partial class SharedPCConfigurationRequest : BaseRequest, ISharedPCConfigurationRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<SharedPCConfiguration> PutAsync(SharedPCConfiguration sharedPCConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="sharedPCConfigurationToUpdate">The SharedPCConfiguration object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{SharedPCConfiguration}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SharedPCConfiguration>> PutResponseAsync(SharedPCConfiguration sharedPCConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SharedPCConfiguration>(sharedPCConfigurationToUpdate, cancellationToken);
