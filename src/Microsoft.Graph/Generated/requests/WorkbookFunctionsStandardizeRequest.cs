...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsStandardizeRequest : BaseRequest, IWorkbookFunctionsStandardizeRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsStandardizeRequest.
        /// </summary>
        public WorkbookFunctionsStandardizeRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsStandardizeRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsStandardizeRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsStandardizeRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsStandardizeRequest Select(string value)
        {
