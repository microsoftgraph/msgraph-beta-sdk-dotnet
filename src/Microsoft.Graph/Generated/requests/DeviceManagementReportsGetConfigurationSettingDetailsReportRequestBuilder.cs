...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetConfigurationSettingDetailsReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetConfigurationSettingDetailsReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetConfigurationSettingDetailsReportRequest>, IDeviceManagementReportsGetConfigurationSettingDetailsReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetConfigurationSettingDetailsReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetConfigurationSettingDetailsReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetConfigurationSettingDetailsReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetConfigurationSettingDetailsReportRequest(functionUrl, this.Client, options);
