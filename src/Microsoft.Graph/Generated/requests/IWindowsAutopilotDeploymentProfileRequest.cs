...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsAutopilotDeploymentProfileRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<WindowsAutopilotDeploymentProfile> PutAsync(WindowsAutopilotDeploymentProfile windowsAutopilotDeploymentProfileToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsAutopilotDeploymentProfile>> PutResponseAsync(WindowsAutopilotDeploymentProfile windowsAutopilotDeploymentProfileToUpdate, CancellationToken cancellationToken = default(CancellationToken));
