...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest : BaseRequest, IReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest
    {
        /// <summary>
        /// Constructs a new ReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest.
        /// </summary>
        public ReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageQuotaStatusMailboxCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetMailboxUsageQuotaStatusMailboxCountsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="mailboxusagequotastatusmailboxcounts">The MailboxUsageQuotaStatusMailboxCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageQuotaStatusMailboxCountsCollectionResponse>> PatchResponseAsync(MailboxUsageQuotaStatusMailboxCounts mailboxusagequotastatusmailboxcounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetMailboxUsageQuotaStatusMailboxCountsCollectionResponse>(mailboxusagequotastatusmailboxcounts, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="mailboxusagequotastatusmailboxcounts">The MailboxUsageQuotaStatusMailboxCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageQuotaStatusMailboxCountsCollectionResponse>> PutResponseAsync(MailboxUsageQuotaStatusMailboxCounts mailboxusagequotastatusmailboxcounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetMailboxUsageQuotaStatusMailboxCountsCollectionResponse>(mailboxusagequotastatusmailboxcounts, cancellationToken).ConfigureAwait(false);
        }
        ...
        public IReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest Expand(string value)
        {
