...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceInstallStateRequest : BaseRequest, IDeviceInstallStateRequest
    {
        ...
        /// <param name="deviceInstallStateToUpdate">The DeviceInstallState to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceInstallState}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceInstallState>> UpdateResponseAsync(DeviceInstallState deviceInstallStateToUpdate)
        {
            return this.UpdateResponseAsync(deviceInstallStateToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceInstallState}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceInstallState>> UpdateResponseAsync(DeviceInstallState deviceInstallStateToUpdate, CancellationToken cancellationToken)
        {
			if (deviceInstallStateToUpdate.AdditionalData != null)
			{
				if (deviceInstallStateToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
