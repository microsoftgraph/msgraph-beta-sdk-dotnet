...
namespace Microsoft.Graph
{
    ...
    public partial interface IDataClassificationServiceClassifyFileJobsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<DataClassificationServiceClassifyFileJobsCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DataClassificationServiceClassifyFileJobsCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<DataClassificationServiceClassifyFileJobsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
