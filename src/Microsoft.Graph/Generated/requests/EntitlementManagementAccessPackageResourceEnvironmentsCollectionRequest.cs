...
namespace Microsoft.Graph
{
    ...
    public partial class EntitlementManagementAccessPackageResourceEnvironmentsCollectionRequest : BaseRequest, IEntitlementManagementAccessPackageResourceEnvironmentsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<AccessPackageResourceEnvironment> AddAsync(AccessPackageResourceEnvironment accessPackageResourceEnvironment)
        {
            return this.AddAsync(accessPackageResourceEnvironment, CancellationToken.None);
        }
        ...
        /// <returns>The created AccessPackageResourceEnvironment.</returns>
        public System.Threading.Tasks.Task<AccessPackageResourceEnvironment> AddAsync(AccessPackageResourceEnvironment accessPackageResourceEnvironment, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AccessPackageResourceEnvironment>> AddResponseAsync(AccessPackageResourceEnvironment accessPackageResourceEnvironment)
        {
            return this.AddResponseAsync(accessPackageResourceEnvironment, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AccessPackageResourceEnvironment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AccessPackageResourceEnvironment>> AddResponseAsync(AccessPackageResourceEnvironment accessPackageResourceEnvironment, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<AccessPackageResourceEnvironment>(accessPackageResourceEnvironment, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<IEntitlementManagementAccessPackageResourceEnvironmentsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async System.Threading.Tasks.Task<IEntitlementManagementAccessPackageResourceEnvironmentsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        public System.Threading.Tasks.Task<GraphResponse<EntitlementManagementAccessPackageResourceEnvironmentsCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EntitlementManagementAccessPackageResourceEnvironmentsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EntitlementManagementAccessPackageResourceEnvironmentsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<EntitlementManagementAccessPackageResourceEnvironmentsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
