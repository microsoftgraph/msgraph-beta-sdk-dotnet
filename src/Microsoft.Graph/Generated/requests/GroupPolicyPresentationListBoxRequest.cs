...
namespace Microsoft.Graph
{
    ...
    public partial class GroupPolicyPresentationListBoxRequest : BaseRequest, IGroupPolicyPresentationListBoxRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationListBox}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationListBox>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationListBox}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationListBox>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<GroupPolicyPresentationListBox>(null, cancellationToken).ConfigureAwait(false);
        }
