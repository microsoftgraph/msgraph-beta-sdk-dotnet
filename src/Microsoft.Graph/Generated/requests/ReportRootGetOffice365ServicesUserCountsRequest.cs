...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetOffice365ServicesUserCountsRequest : BaseRequest, IReportRootGetOffice365ServicesUserCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ServicesUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365ServicesUserCountsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="office365servicesusercounts">The Office365ServicesUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ServicesUserCountsCollectionResponse>> PatchResponseAsync(Office365ServicesUserCounts office365servicesusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365ServicesUserCountsCollectionResponse>(office365servicesusercounts, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="office365servicesusercounts">The Office365ServicesUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ServicesUserCountsCollectionResponse>> PutResponseAsync(Office365ServicesUserCounts office365servicesusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365ServicesUserCountsCollectionResponse>(office365servicesusercounts, cancellationToken).ConfigureAwait(false);
        }
