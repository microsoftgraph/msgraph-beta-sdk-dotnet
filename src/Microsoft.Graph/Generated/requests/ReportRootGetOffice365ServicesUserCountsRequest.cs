...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetOffice365ServicesUserCountsRequest : BaseRequest, IReportRootGetOffice365ServicesUserCountsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ServicesUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="office365servicesusercounts">The Office365ServicesUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ServicesUserCountsCollectionResponse>> PatchResponseAsync(Office365ServicesUserCounts office365servicesusercounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="office365servicesusercounts">The Office365ServicesUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ServicesUserCountsCollectionResponse>> PutResponseAsync(Office365ServicesUserCounts office365servicesusercounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetOffice365ServicesUserCountsCollectionResponse>(office365servicesusercounts, cancellationToken);
        }
