...
namespace Microsoft.Graph
{
    ...
    public partial interface IParticipantLeftNotificationRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<ParticipantLeftNotification> PutAsync(ParticipantLeftNotification participantLeftNotificationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<ParticipantLeftNotification>> PutResponseAsync(ParticipantLeftNotification participantLeftNotificationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
