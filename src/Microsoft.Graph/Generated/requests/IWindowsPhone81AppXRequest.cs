...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsPhone81AppXRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WindowsPhone81AppX> CreateAsync(WindowsPhone81AppX windowsPhone81AppXToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsPhone81AppX>> CreateResponseAsync(WindowsPhone81AppX windowsPhone81AppXToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsPhone81AppX}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhone81AppX>> CreateResponseAsync(WindowsPhone81AppX windowsPhone81AppXToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="windowsPhone81AppXToUpdate">The WindowsPhone81AppX to update.</param>
        /// <returns>The <see cref="GraphResponse{WindowsPhone81AppX}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhone81AppX>> UpdateResponseAsync(WindowsPhone81AppX windowsPhone81AppXToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsPhone81AppX}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsPhone81AppX>> UpdateResponseAsync(WindowsPhone81AppX windowsPhone81AppXToUpdate, CancellationToken cancellationToken);
