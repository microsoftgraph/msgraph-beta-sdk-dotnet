...
namespace Microsoft.Graph
{
    ...
    public partial interface IDriveItemVersionRequest : IBaseRequest
    {
        ...
        /// <param name="driveItemVersionToUpdate">The DriveItemVersion to update.</param>
        /// <returns>The <see cref="GraphResponse{DriveItemVersion}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DriveItemVersion>> UpdateResponseAsync(DriveItemVersion driveItemVersionToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DriveItemVersion}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DriveItemVersion>> UpdateResponseAsync(DriveItemVersion driveItemVersionToUpdate, CancellationToken cancellationToken);
