...
namespace Microsoft.Graph
{
    ...
    public partial class SensitiveTypeRequest : BaseRequest, ISensitiveTypeRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SensitiveType>> CreateResponseAsync(SensitiveType sensitiveTypeToCreate)
        {
            return this.CreateResponseAsync(sensitiveTypeToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SensitiveType}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SensitiveType>> CreateResponseAsync(SensitiveType sensitiveTypeToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<SensitiveType>(sensitiveTypeToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{SensitiveType}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SensitiveType>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SensitiveType}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SensitiveType>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<SensitiveType>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="sensitiveTypeToUpdate">The SensitiveType to update.</param>
        /// <returns>The <see cref="GraphResponse{SensitiveType}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SensitiveType>> UpdateResponseAsync(SensitiveType sensitiveTypeToUpdate)
        {
            return this.UpdateResponseAsync(sensitiveTypeToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SensitiveType}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SensitiveType>> UpdateResponseAsync(SensitiveType sensitiveTypeToUpdate, CancellationToken cancellationToken)
        {
			if (sensitiveTypeToUpdate.AdditionalData != null)
			{
				if (sensitiveTypeToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<SensitiveType>(sensitiveTypeToUpdate, cancellationToken).ConfigureAwait(false);
        }
