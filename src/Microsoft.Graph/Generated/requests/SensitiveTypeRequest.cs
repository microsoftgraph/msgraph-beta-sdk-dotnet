...
namespace Microsoft.Graph
{
    ...
    public partial class SensitiveTypeRequest : BaseRequest, ISensitiveTypeRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<SensitiveType>> CreateResponseAsync(SensitiveType sensitiveTypeToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SensitiveType}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SensitiveType>> UpdateResponseAsync(SensitiveType sensitiveTypeToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
