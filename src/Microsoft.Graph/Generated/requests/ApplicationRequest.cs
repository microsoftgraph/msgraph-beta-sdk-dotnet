...
namespace Microsoft.Graph
{
    ...
    public partial class ApplicationRequest : BaseRequest, IApplicationRequest
    {
        ...
        /// <param name="applicationToUpdate">The Application to update.</param>
        /// <returns>The <see cref="GraphResponse{Application}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Application>> UpdateResponseAsync(Application applicationToUpdate)
        {
            return this.UpdateResponseAsync(applicationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Application}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Application>> UpdateResponseAsync(Application applicationToUpdate, CancellationToken cancellationToken)
        {
			if (applicationToUpdate.AdditionalData != null)
			{
				if (applicationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
