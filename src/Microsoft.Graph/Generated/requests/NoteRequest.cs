...
namespace Microsoft.Graph
{
    ...
    public partial class NoteRequest : BaseRequest, INoteRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Note>> CreateResponseAsync(Note noteToCreate)
        {
            return this.CreateResponseAsync(noteToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Note}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Note>> CreateResponseAsync(Note noteToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<Note>(noteToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Note}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Note>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Note}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Note>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Note>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="noteToUpdate">The Note to update.</param>
        /// <returns>The <see cref="GraphResponse{Note}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Note>> UpdateResponseAsync(Note noteToUpdate)
        {
            return this.UpdateResponseAsync(noteToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Note}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Note>> UpdateResponseAsync(Note noteToUpdate, CancellationToken cancellationToken)
        {
			if (noteToUpdate.AdditionalData != null)
			{
				if (noteToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<Note>(noteToUpdate, cancellationToken).ConfigureAwait(false);
        }
