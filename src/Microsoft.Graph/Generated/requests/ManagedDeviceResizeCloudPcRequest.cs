...
namespace Microsoft.Graph
{
    ...
    {
        /// <summary>
        /// Constructs a new ManagedDeviceResizeCloudPcRequest.
        /// </summary>
        public ManagedDeviceResizeCloudPcRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new ManagedDeviceResizeCloudPcRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public ManagedDeviceResizeCloudPcRequestBody RequestBody { get; private set; }
        ...
        public IManagedDeviceResizeCloudPcRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IManagedDeviceResizeCloudPcRequest Select(string value)
        {
