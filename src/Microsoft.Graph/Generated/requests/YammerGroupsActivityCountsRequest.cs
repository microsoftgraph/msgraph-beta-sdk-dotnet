...
namespace Microsoft.Graph
{
    ...
    public partial class YammerGroupsActivityCountsRequest : BaseRequest, IYammerGroupsActivityCountsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<YammerGroupsActivityCounts>> CreateResponseAsync(YammerGroupsActivityCounts yammerGroupsActivityCountsToCreate)
        {
            return this.CreateResponseAsync(yammerGroupsActivityCountsToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{YammerGroupsActivityCounts}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<YammerGroupsActivityCounts>> CreateResponseAsync(YammerGroupsActivityCounts yammerGroupsActivityCountsToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<YammerGroupsActivityCounts>(yammerGroupsActivityCountsToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{YammerGroupsActivityCounts}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<YammerGroupsActivityCounts>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{YammerGroupsActivityCounts}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<YammerGroupsActivityCounts>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<YammerGroupsActivityCounts>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="yammerGroupsActivityCountsToUpdate">The YammerGroupsActivityCounts to update.</param>
        /// <returns>The <see cref="GraphResponse{YammerGroupsActivityCounts}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<YammerGroupsActivityCounts>> UpdateResponseAsync(YammerGroupsActivityCounts yammerGroupsActivityCountsToUpdate)
        {
            return this.UpdateResponseAsync(yammerGroupsActivityCountsToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{YammerGroupsActivityCounts}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<YammerGroupsActivityCounts>> UpdateResponseAsync(YammerGroupsActivityCounts yammerGroupsActivityCountsToUpdate, CancellationToken cancellationToken)
        {
			if (yammerGroupsActivityCountsToUpdate.AdditionalData != null)
			{
				if (yammerGroupsActivityCountsToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<YammerGroupsActivityCounts>(yammerGroupsActivityCountsToUpdate, cancellationToken).ConfigureAwait(false);
        }
