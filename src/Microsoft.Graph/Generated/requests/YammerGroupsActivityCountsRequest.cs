...
namespace Microsoft.Graph
{
    ...
    public partial class YammerGroupsActivityCountsRequest : BaseRequest, IYammerGroupsActivityCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<YammerGroupsActivityCounts>> CreateResponseAsync(YammerGroupsActivityCounts yammerGroupsActivityCountsToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{YammerGroupsActivityCounts}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<YammerGroupsActivityCounts>> UpdateResponseAsync(YammerGroupsActivityCounts yammerGroupsActivityCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
