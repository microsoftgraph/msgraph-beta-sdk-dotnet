...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetEncryptionReportForDevicesRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetEncryptionReportForDevicesRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetEncryptionReportForDevicesRequest>, IDeviceManagementReportsGetEncryptionReportForDevicesRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetEncryptionReportForDevicesRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetEncryptionReportForDevicesRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetEncryptionReportForDevicesRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetEncryptionReportForDevicesRequest(functionUrl, this.Client, options);
