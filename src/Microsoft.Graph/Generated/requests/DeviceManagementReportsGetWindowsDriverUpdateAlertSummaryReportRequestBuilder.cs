...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetWindowsDriverUpdateAlertSummaryReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetWindowsDriverUpdateAlertSummaryReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetWindowsDriverUpdateAlertSummaryReportRequest>, IDeviceManagementReportsGetWindowsDriverUpdateAlertSummaryReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetWindowsDriverUpdateAlertSummaryReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetWindowsDriverUpdateAlertSummaryReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetWindowsDriverUpdateAlertSummaryReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetWindowsDriverUpdateAlertSummaryReportRequest(functionUrl, this.Client, options);
