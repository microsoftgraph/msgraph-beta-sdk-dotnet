...
namespace Microsoft.Graph
{
    ...
    public partial interface IApplicationRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<Application> PutAsync(Application applicationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<Application>> PutResponseAsync(Application applicationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
