...
namespace Microsoft.Graph
{
    ...
    public partial interface ISharedEmailDomainInvitationRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<SharedEmailDomainInvitation> PutAsync(SharedEmailDomainInvitation sharedEmailDomainInvitationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<SharedEmailDomainInvitation>> PutResponseAsync(SharedEmailDomainInvitation sharedEmailDomainInvitationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
