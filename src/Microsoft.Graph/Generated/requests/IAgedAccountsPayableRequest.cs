...
namespace Microsoft.Graph
{
    ...
    public partial interface IAgedAccountsPayableRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AgedAccountsPayable> CreateAsync(AgedAccountsPayable agedAccountsPayableToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<AgedAccountsPayable>> CreateResponseAsync(AgedAccountsPayable agedAccountsPayableToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<AgedAccountsPayable> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AgedAccountsPayable}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AgedAccountsPayable>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<AgedAccountsPayable> UpdateAsync(AgedAccountsPayable agedAccountsPayableToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AgedAccountsPayable}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AgedAccountsPayable>> UpdateResponseAsync(AgedAccountsPayable agedAccountsPayableToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<AgedAccountsPayable> PutAsync(AgedAccountsPayable agedAccountsPayableToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<AgedAccountsPayable>> PutResponseAsync(AgedAccountsPayable agedAccountsPayableToUpdate, CancellationToken cancellationToken = default);
