...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IEventSingleValueExtendedPropertiesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IEventSingleValueExtendedPropertiesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IEventSingleValueExtendedPropertiesCollectionRequest Request(IEnumerable<Option> options);
