...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface ICloudCommunicationsCallsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        ICloudCommunicationsCallsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        ICloudCommunicationsCallsCollectionRequest Request(IEnumerable<Option> options);
