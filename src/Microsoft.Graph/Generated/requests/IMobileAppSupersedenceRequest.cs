...
namespace Microsoft.Graph
{
    ...
    public partial interface IMobileAppSupersedenceRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<MobileAppSupersedence> PutAsync(MobileAppSupersedence mobileAppSupersedenceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<MobileAppSupersedence>> PutResponseAsync(MobileAppSupersedence mobileAppSupersedenceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
