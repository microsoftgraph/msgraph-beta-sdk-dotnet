...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetDevicePolicySettingsComplianceReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetDevicePolicySettingsComplianceReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetDevicePolicySettingsComplianceReportRequest>, IDeviceManagementReportsGetDevicePolicySettingsComplianceReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetDevicePolicySettingsComplianceReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetDevicePolicySettingsComplianceReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IDeviceManagementReportsGetDevicePolicySettingsComplianceReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetDevicePolicySettingsComplianceReportRequest(functionUrl, this.Client, options);
