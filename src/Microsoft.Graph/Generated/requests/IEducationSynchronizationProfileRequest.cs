...
namespace Microsoft.Graph
{
    ...
    public partial interface IEducationSynchronizationProfileRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<EducationSynchronizationProfile> CreateAsync(EducationSynchronizationProfile educationSynchronizationProfileToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<EducationSynchronizationProfile>> CreateResponseAsync(EducationSynchronizationProfile educationSynchronizationProfileToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EducationSynchronizationProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EducationSynchronizationProfile>> CreateResponseAsync(EducationSynchronizationProfile educationSynchronizationProfileToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="educationSynchronizationProfileToUpdate">The EducationSynchronizationProfile to update.</param>
        /// <returns>The <see cref="GraphResponse{EducationSynchronizationProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EducationSynchronizationProfile>> UpdateResponseAsync(EducationSynchronizationProfile educationSynchronizationProfileToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{EducationSynchronizationProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EducationSynchronizationProfile>> UpdateResponseAsync(EducationSynchronizationProfile educationSynchronizationProfileToUpdate, CancellationToken cancellationToken);
