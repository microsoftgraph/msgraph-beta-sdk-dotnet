...
namespace Microsoft.Graph
{
    ...
    public partial class PermissionGrantPolicyRequest : BaseRequest, IPermissionGrantPolicyRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<PermissionGrantPolicy> PutAsync(PermissionGrantPolicy permissionGrantPolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<PermissionGrantPolicy>> PutResponseAsync(PermissionGrantPolicy permissionGrantPolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<PermissionGrantPolicy>(permissionGrantPolicyToUpdate, cancellationToken);
