...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WindowsInformationProtectionAssignRequest : BaseRequest, IWindowsInformationProtectionAssignRequest
    {
        /// <summary>
        /// Constructs a new WindowsInformationProtectionAssignRequest.
        /// </summary>
        public WindowsInformationProtectionAssignRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WindowsInformationProtectionAssignRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WindowsInformationProtectionAssignRequestBody RequestBody { get; private set; }
        ...
        public IWindowsInformationProtectionAssignRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindowsInformationProtectionAssignRequest Select(string value)
        {
