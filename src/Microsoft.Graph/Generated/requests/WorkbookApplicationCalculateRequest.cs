...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookApplicationCalculateRequest : BaseRequest, IWorkbookApplicationCalculateRequest
    {
        /// <summary>
        /// Constructs a new WorkbookApplicationCalculateRequest.
        /// </summary>
        public WorkbookApplicationCalculateRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookApplicationCalculateRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookApplicationCalculateRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookApplicationCalculateRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookApplicationCalculateRequest Select(string value)
        {
