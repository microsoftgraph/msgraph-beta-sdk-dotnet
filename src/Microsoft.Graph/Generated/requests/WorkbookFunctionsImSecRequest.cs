...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsImSecRequest : BaseRequest, IWorkbookFunctionsImSecRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsImSecRequest.
        /// </summary>
        public WorkbookFunctionsImSecRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsImSecRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsImSecRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsImSecRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsImSecRequest Select(string value)
        {
