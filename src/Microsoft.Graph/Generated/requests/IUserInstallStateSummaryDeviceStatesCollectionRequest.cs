...
namespace Microsoft.Graph
{
    ...
    public partial interface IUserInstallStateSummaryDeviceStatesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<UserInstallStateSummaryDeviceStatesCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserInstallStateSummaryDeviceStatesCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<UserInstallStateSummaryDeviceStatesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
