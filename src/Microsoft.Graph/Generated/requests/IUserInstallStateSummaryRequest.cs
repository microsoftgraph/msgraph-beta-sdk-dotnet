...
namespace Microsoft.Graph
{
    ...
    public partial interface IUserInstallStateSummaryRequest : IBaseRequest
    {
        ...
        /// <param name="userInstallStateSummaryToUpdate">The UserInstallStateSummary to update.</param>
        /// <returns>The <see cref="GraphResponse{UserInstallStateSummary}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UserInstallStateSummary>> UpdateResponseAsync(UserInstallStateSummary userInstallStateSummaryToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserInstallStateSummary}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UserInstallStateSummary>> UpdateResponseAsync(UserInstallStateSummary userInstallStateSummaryToUpdate, CancellationToken cancellationToken);
