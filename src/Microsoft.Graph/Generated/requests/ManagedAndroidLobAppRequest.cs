...
namespace Microsoft.Graph
{
    ...
    public partial class ManagedAndroidLobAppRequest : BaseRequest, IManagedAndroidLobAppRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<ManagedAndroidLobApp> PutAsync(ManagedAndroidLobApp managedAndroidLobAppToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<ManagedAndroidLobApp>> PutResponseAsync(ManagedAndroidLobApp managedAndroidLobAppToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ManagedAndroidLobApp>(managedAndroidLobAppToUpdate, cancellationToken);
