...
namespace Microsoft.Graph
{
    ...
    public partial class UserExperienceAnalyticsRegressionSummaryRequest : BaseRequest, IUserExperienceAnalyticsRegressionSummaryRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsRegressionSummary>> CreateResponseAsync(UserExperienceAnalyticsRegressionSummary userExperienceAnalyticsRegressionSummaryToCreate)
        {
            return this.CreateResponseAsync(userExperienceAnalyticsRegressionSummaryToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserExperienceAnalyticsRegressionSummary}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsRegressionSummary>> CreateResponseAsync(UserExperienceAnalyticsRegressionSummary userExperienceAnalyticsRegressionSummaryToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<UserExperienceAnalyticsRegressionSummary>(userExperienceAnalyticsRegressionSummaryToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{UserExperienceAnalyticsRegressionSummary}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsRegressionSummary>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserExperienceAnalyticsRegressionSummary}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsRegressionSummary>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<UserExperienceAnalyticsRegressionSummary>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="userExperienceAnalyticsRegressionSummaryToUpdate">The UserExperienceAnalyticsRegressionSummary to update.</param>
        /// <returns>The <see cref="GraphResponse{UserExperienceAnalyticsRegressionSummary}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsRegressionSummary>> UpdateResponseAsync(UserExperienceAnalyticsRegressionSummary userExperienceAnalyticsRegressionSummaryToUpdate)
        {
            return this.UpdateResponseAsync(userExperienceAnalyticsRegressionSummaryToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserExperienceAnalyticsRegressionSummary}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsRegressionSummary>> UpdateResponseAsync(UserExperienceAnalyticsRegressionSummary userExperienceAnalyticsRegressionSummaryToUpdate, CancellationToken cancellationToken)
        {
			if (userExperienceAnalyticsRegressionSummaryToUpdate.AdditionalData != null)
			{
				if (userExperienceAnalyticsRegressionSummaryToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<UserExperienceAnalyticsRegressionSummary>(userExperienceAnalyticsRegressionSummaryToUpdate, cancellationToken).ConfigureAwait(false);
        }
