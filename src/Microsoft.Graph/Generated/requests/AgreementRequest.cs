...
namespace Microsoft.Graph
{
    ...
    public partial class AgreementRequest : BaseRequest, IAgreementRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Agreement>> CreateResponseAsync(Agreement agreementToCreate)
        {
            return this.CreateResponseAsync(agreementToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Agreement}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Agreement>> CreateResponseAsync(Agreement agreementToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<Agreement>(agreementToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Agreement}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Agreement>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Agreement}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Agreement>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Agreement>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="agreementToUpdate">The Agreement to update.</param>
        /// <returns>The <see cref="GraphResponse{Agreement}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Agreement>> UpdateResponseAsync(Agreement agreementToUpdate)
        {
            return this.UpdateResponseAsync(agreementToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Agreement}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Agreement>> UpdateResponseAsync(Agreement agreementToUpdate, CancellationToken cancellationToken)
        {
			if (agreementToUpdate.AdditionalData != null)
			{
				if (agreementToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<Agreement>(agreementToUpdate, cancellationToken).ConfigureAwait(false);
        }
