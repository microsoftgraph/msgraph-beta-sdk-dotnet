...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidDeviceComplianceLocalActionLockDeviceRequest : BaseRequest, IAndroidDeviceComplianceLocalActionLockDeviceRequest
    {
        ...
        public async System.Threading.Tasks.Task<AndroidDeviceComplianceLocalActionLockDevice> CreateAsync(AndroidDeviceComplianceLocalActionLockDevice androidDeviceComplianceLocalActionLockDeviceToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AndroidDeviceComplianceLocalActionLockDevice>> CreateResponseAsync(AndroidDeviceComplianceLocalActionLockDevice androidDeviceComplianceLocalActionLockDeviceToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<AndroidDeviceComplianceLocalActionLockDevice> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceComplianceLocalActionLockDevice}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidDeviceComplianceLocalActionLockDevice>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<AndroidDeviceComplianceLocalActionLockDevice> UpdateAsync(AndroidDeviceComplianceLocalActionLockDevice androidDeviceComplianceLocalActionLockDeviceToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceComplianceLocalActionLockDevice}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidDeviceComplianceLocalActionLockDevice>> UpdateResponseAsync(AndroidDeviceComplianceLocalActionLockDevice androidDeviceComplianceLocalActionLockDeviceToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<AndroidDeviceComplianceLocalActionLockDevice> PutAsync(AndroidDeviceComplianceLocalActionLockDevice androidDeviceComplianceLocalActionLockDeviceToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<AndroidDeviceComplianceLocalActionLockDevice>> PutResponseAsync(AndroidDeviceComplianceLocalActionLockDevice androidDeviceComplianceLocalActionLockDeviceToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<AndroidDeviceComplianceLocalActionLockDevice>(androidDeviceComplianceLocalActionLockDeviceToUpdate, cancellationToken);
