...
namespace Microsoft.Graph
{
    ...
    public partial class DocumentRequest : BaseRequest, IDocumentRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Document>> CreateResponseAsync(Document documentToCreate)
        {
            return this.CreateResponseAsync(documentToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Document}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Document>> CreateResponseAsync(Document documentToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="documentToUpdate">The Document to update.</param>
        /// <returns>The <see cref="GraphResponse{Document}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Document>> UpdateResponseAsync(Document documentToUpdate)
        {
            return this.UpdateResponseAsync(documentToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Document}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Document>> UpdateResponseAsync(Document documentToUpdate, CancellationToken cancellationToken)
        {
			if (documentToUpdate.AdditionalData != null)
			{
				if (documentToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
