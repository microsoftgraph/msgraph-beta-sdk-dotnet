...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IConnectedOrganizationExternalSponsorsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IConnectedOrganizationExternalSponsorsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IConnectedOrganizationExternalSponsorsCollectionRequest Request(IEnumerable<Option> options);
