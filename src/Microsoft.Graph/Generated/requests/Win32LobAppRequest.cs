...
namespace Microsoft.Graph
{
    ...
    public partial class Win32LobAppRequest : BaseRequest, IWin32LobAppRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<Win32LobApp> PutAsync(Win32LobApp win32LobAppToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<Win32LobApp>> PutResponseAsync(Win32LobApp win32LobAppToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<Win32LobApp>(win32LobAppToUpdate, cancellationToken);
