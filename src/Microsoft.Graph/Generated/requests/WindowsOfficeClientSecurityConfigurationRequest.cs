...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsOfficeClientSecurityConfigurationRequest : BaseRequest, IWindowsOfficeClientSecurityConfigurationRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WindowsOfficeClientSecurityConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsOfficeClientSecurityConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsOfficeClientSecurityConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsOfficeClientSecurityConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WindowsOfficeClientSecurityConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
