...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookChartSeriesRequest : BaseRequest, IWorkbookChartSeriesRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WorkbookChartSeries}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartSeries>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookChartSeries}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookChartSeries>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
