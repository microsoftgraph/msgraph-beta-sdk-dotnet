...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsManagedDeviceRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WindowsManagedDevice> CreateAsync(WindowsManagedDevice windowsManagedDeviceToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsManagedDevice>> CreateResponseAsync(WindowsManagedDevice windowsManagedDeviceToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<WindowsManagedDevice> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsManagedDevice}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsManagedDevice>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<WindowsManagedDevice> UpdateAsync(WindowsManagedDevice windowsManagedDeviceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsManagedDevice}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsManagedDevice>> UpdateResponseAsync(WindowsManagedDevice windowsManagedDeviceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<WindowsManagedDevice> PutAsync(WindowsManagedDevice windowsManagedDeviceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsManagedDevice>> PutResponseAsync(WindowsManagedDevice windowsManagedDeviceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
