...
namespace Microsoft.Graph
{
    ...
    public partial interface IPersonRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<Person> PutAsync(Person personToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<Person>> PutResponseAsync(Person personToUpdate, CancellationToken cancellationToken = default(CancellationToken));
