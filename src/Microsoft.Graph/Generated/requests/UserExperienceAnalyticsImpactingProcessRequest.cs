...
namespace Microsoft.Graph
{
    ...
    public partial class UserExperienceAnalyticsImpactingProcessRequest : BaseRequest, IUserExperienceAnalyticsImpactingProcessRequest
    {
        ...
        public async System.Threading.Tasks.Task<UserExperienceAnalyticsImpactingProcess> CreateAsync(UserExperienceAnalyticsImpactingProcess userExperienceAnalyticsImpactingProcessToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsImpactingProcess>> CreateResponseAsync(UserExperienceAnalyticsImpactingProcess userExperienceAnalyticsImpactingProcessToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<UserExperienceAnalyticsImpactingProcess> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserExperienceAnalyticsImpactingProcess}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsImpactingProcess>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<UserExperienceAnalyticsImpactingProcess> UpdateAsync(UserExperienceAnalyticsImpactingProcess userExperienceAnalyticsImpactingProcessToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserExperienceAnalyticsImpactingProcess}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsImpactingProcess>> UpdateResponseAsync(UserExperienceAnalyticsImpactingProcess userExperienceAnalyticsImpactingProcessToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<UserExperienceAnalyticsImpactingProcess> PutAsync(UserExperienceAnalyticsImpactingProcess userExperienceAnalyticsImpactingProcessToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsImpactingProcess>> PutResponseAsync(UserExperienceAnalyticsImpactingProcess userExperienceAnalyticsImpactingProcessToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<UserExperienceAnalyticsImpactingProcess>(userExperienceAnalyticsImpactingProcessToUpdate, cancellationToken);
