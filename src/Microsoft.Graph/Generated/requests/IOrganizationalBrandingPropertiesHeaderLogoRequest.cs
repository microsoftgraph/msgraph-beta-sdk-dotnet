...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IOrganizationalBrandingPropertiesHeaderLogoRequest.
    /// </summary>
    public partial interface IOrganizationalBrandingPropertiesHeaderLogoRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream headerLogo, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties;
        ...
        System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream headerLogo, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties;
