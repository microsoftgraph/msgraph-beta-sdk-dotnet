...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceComplianceScriptRunSummaryRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<DeviceComplianceScriptRunSummary> PutAsync(DeviceComplianceScriptRunSummary deviceComplianceScriptRunSummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceComplianceScriptRunSummary>> PutResponseAsync(DeviceComplianceScriptRunSummary deviceComplianceScriptRunSummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
