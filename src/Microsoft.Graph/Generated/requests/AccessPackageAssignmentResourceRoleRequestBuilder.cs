...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AccessPackageAssignmentResourceRoleRequestBuilder.
    /// </summary>
    public partial class AccessPackageAssignmentResourceRoleRequestBuilder : EntityRequestBuilder, IAccessPackageAssignmentResourceRoleRequestBuilder
    {

        /// <summary>
        /// Constructs a new AccessPackageAssignmentResourceRoleRequestBuilder.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        public AccessPackageAssignmentResourceRoleRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public new IAccessPackageAssignmentResourceRoleRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public new IAccessPackageAssignmentResourceRoleRequest Request(IEnumerable<Option> options)
        {
            return new AccessPackageAssignmentResourceRoleRequest(this.RequestUrl, this.Client, options);
        }
