...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsBesselYRequest : BaseRequest, IWorkbookFunctionsBesselYRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsBesselYRequest.
        /// </summary>
        public WorkbookFunctionsBesselYRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsBesselYRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsBesselYRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsBesselYRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsBesselYRequest Select(string value)
        {
