...
namespace Microsoft.Graph
{
    ...
    public partial interface ITeamsDeviceUsageDistributionUserCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<TeamsDeviceUsageDistributionUserCounts> CreateAsync(TeamsDeviceUsageDistributionUserCounts teamsDeviceUsageDistributionUserCountsToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<TeamsDeviceUsageDistributionUserCounts>> CreateResponseAsync(TeamsDeviceUsageDistributionUserCounts teamsDeviceUsageDistributionUserCountsToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TeamsDeviceUsageDistributionUserCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<TeamsDeviceUsageDistributionUserCounts>> CreateResponseAsync(TeamsDeviceUsageDistributionUserCounts teamsDeviceUsageDistributionUserCountsToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="teamsDeviceUsageDistributionUserCountsToUpdate">The TeamsDeviceUsageDistributionUserCounts to update.</param>
        /// <returns>The <see cref="GraphResponse{TeamsDeviceUsageDistributionUserCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<TeamsDeviceUsageDistributionUserCounts>> UpdateResponseAsync(TeamsDeviceUsageDistributionUserCounts teamsDeviceUsageDistributionUserCountsToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{TeamsDeviceUsageDistributionUserCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<TeamsDeviceUsageDistributionUserCounts>> UpdateResponseAsync(TeamsDeviceUsageDistributionUserCounts teamsDeviceUsageDistributionUserCountsToUpdate, CancellationToken cancellationToken);
