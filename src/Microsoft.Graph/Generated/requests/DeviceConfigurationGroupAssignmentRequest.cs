...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceConfigurationGroupAssignmentRequest : BaseRequest, IDeviceConfigurationGroupAssignmentRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationGroupAssignment>> CreateResponseAsync(DeviceConfigurationGroupAssignment deviceConfigurationGroupAssignmentToCreate)
        {
            return this.CreateResponseAsync(deviceConfigurationGroupAssignmentToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceConfigurationGroupAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationGroupAssignment>> CreateResponseAsync(DeviceConfigurationGroupAssignment deviceConfigurationGroupAssignmentToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DeviceConfigurationGroupAssignment>(deviceConfigurationGroupAssignmentToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DeviceConfigurationGroupAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationGroupAssignment>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceConfigurationGroupAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationGroupAssignment>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceConfigurationGroupAssignment>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="deviceConfigurationGroupAssignmentToUpdate">The DeviceConfigurationGroupAssignment to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceConfigurationGroupAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationGroupAssignment>> UpdateResponseAsync(DeviceConfigurationGroupAssignment deviceConfigurationGroupAssignmentToUpdate)
        {
            return this.UpdateResponseAsync(deviceConfigurationGroupAssignmentToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceConfigurationGroupAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationGroupAssignment>> UpdateResponseAsync(DeviceConfigurationGroupAssignment deviceConfigurationGroupAssignmentToUpdate, CancellationToken cancellationToken)
        {
			if (deviceConfigurationGroupAssignmentToUpdate.AdditionalData != null)
			{
				if (deviceConfigurationGroupAssignmentToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<DeviceConfigurationGroupAssignment>(deviceConfigurationGroupAssignmentToUpdate, cancellationToken).ConfigureAwait(false);
        }
