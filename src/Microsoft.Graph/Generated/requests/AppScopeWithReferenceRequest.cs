...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class AppScopeWithReferenceRequest : BaseRequest, IAppScopeWithReferenceRequest
    {
        /// <summary>
        ...
        public AppScopeWithReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<GraphResponse<AppScope>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AppScope}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AppScope>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<AppScope>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="appScopeToCreate">The AppScope to create.</param>
        /// <returns>The <see cref="GraphResponse{AppScope}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AppScope>> CreateResponseAsync(AppScope appScopeToCreate)
        {
            return this.CreateResponseAsync(appScopeToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AppScope}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AppScope>> CreateResponseAsync(AppScope appScopeToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<AppScope>(appScopeToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="appScopeToUpdate">The AppScope to update.</param>
        /// <returns>The <see cref="GraphResponse{AppScope}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AppScope>> UpdateResponseAsync(AppScope appScopeToUpdate)
        {
            return this.UpdateResponseAsync(appScopeToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AppScope}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AppScope>> UpdateResponseAsync(AppScope appScopeToUpdate, CancellationToken cancellationToken)
        {
			if (appScopeToUpdate.AdditionalData != null)
			{
				if (appScopeToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<AppScope>(appScopeToUpdate, cancellationToken).ConfigureAwait(false);
        }
        ...
        public IAppScopeWithReferenceRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IAppScopeWithReferenceRequest Expand(Expression<Func<AppScope, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IAppScopeWithReferenceRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IAppScopeWithReferenceRequest Select(Expression<Func<AppScope, object>> selectExpression)
        {
