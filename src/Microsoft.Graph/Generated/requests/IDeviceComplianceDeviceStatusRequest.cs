...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceComplianceDeviceStatusRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DeviceComplianceDeviceStatus> CreateAsync(DeviceComplianceDeviceStatus deviceComplianceDeviceStatusToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceComplianceDeviceStatus>> CreateResponseAsync(DeviceComplianceDeviceStatus deviceComplianceDeviceStatusToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<DeviceComplianceDeviceStatus> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceComplianceDeviceStatus}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceComplianceDeviceStatus>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<DeviceComplianceDeviceStatus> UpdateAsync(DeviceComplianceDeviceStatus deviceComplianceDeviceStatusToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceComplianceDeviceStatus}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceComplianceDeviceStatus>> UpdateResponseAsync(DeviceComplianceDeviceStatus deviceComplianceDeviceStatusToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<DeviceComplianceDeviceStatus> PutAsync(DeviceComplianceDeviceStatus deviceComplianceDeviceStatusToUpdate, CancellationToken cancellationToken = default(CancellationToken));

        /// <summary>
        /// Updates the specified DeviceComplianceDeviceStatus using PUT and returns a <see cref="GraphResponse{DeviceComplianceDeviceStatus}"/> object.
        /// </summary>
        /// <param name="deviceComplianceDeviceStatusToUpdate">The DeviceComplianceDeviceStatus object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{DeviceComplianceDeviceStatus}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceComplianceDeviceStatus>> PutResponseAsync(DeviceComplianceDeviceStatus deviceComplianceDeviceStatusToUpdate, CancellationToken cancellationToken = default(CancellationToken));
