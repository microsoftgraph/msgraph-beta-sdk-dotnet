...
namespace Microsoft.Graph
{
    ...
    public partial interface IGraphServiceAdministrativeUnitsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<GraphServiceAdministrativeUnitsCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GraphServiceAdministrativeUnitsCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<GraphServiceAdministrativeUnitsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
