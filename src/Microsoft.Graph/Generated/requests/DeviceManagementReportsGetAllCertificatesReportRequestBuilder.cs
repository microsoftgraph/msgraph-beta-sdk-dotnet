...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetAllCertificatesReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetAllCertificatesReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetAllCertificatesReportRequest>, IDeviceManagementReportsGetAllCertificatesReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetAllCertificatesReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetAllCertificatesReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetAllCertificatesReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetAllCertificatesReportRequest(functionUrl, this.Client, options);
