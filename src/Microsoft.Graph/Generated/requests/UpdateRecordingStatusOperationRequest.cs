...
namespace Microsoft.Graph
{
    ...
    public partial class UpdateRecordingStatusOperationRequest : BaseRequest, IUpdateRecordingStatusOperationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UpdateRecordingStatusOperation>> CreateResponseAsync(UpdateRecordingStatusOperation updateRecordingStatusOperationToCreate)
        {
            return this.CreateResponseAsync(updateRecordingStatusOperationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UpdateRecordingStatusOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UpdateRecordingStatusOperation>> CreateResponseAsync(UpdateRecordingStatusOperation updateRecordingStatusOperationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<UpdateRecordingStatusOperation>(updateRecordingStatusOperationToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{UpdateRecordingStatusOperation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UpdateRecordingStatusOperation>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UpdateRecordingStatusOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UpdateRecordingStatusOperation>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<UpdateRecordingStatusOperation>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="updateRecordingStatusOperationToUpdate">The UpdateRecordingStatusOperation to update.</param>
        /// <returns>The <see cref="GraphResponse{UpdateRecordingStatusOperation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UpdateRecordingStatusOperation>> UpdateResponseAsync(UpdateRecordingStatusOperation updateRecordingStatusOperationToUpdate)
        {
            return this.UpdateResponseAsync(updateRecordingStatusOperationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UpdateRecordingStatusOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UpdateRecordingStatusOperation>> UpdateResponseAsync(UpdateRecordingStatusOperation updateRecordingStatusOperationToUpdate, CancellationToken cancellationToken)
        {
			if (updateRecordingStatusOperationToUpdate.AdditionalData != null)
			{
				if (updateRecordingStatusOperationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<UpdateRecordingStatusOperation>(updateRecordingStatusOperationToUpdate, cancellationToken).ConfigureAwait(false);
        }
