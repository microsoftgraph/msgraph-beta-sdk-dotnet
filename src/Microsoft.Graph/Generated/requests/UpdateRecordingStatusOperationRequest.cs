...
namespace Microsoft.Graph
{
    ...
    public partial class UpdateRecordingStatusOperationRequest : BaseRequest, IUpdateRecordingStatusOperationRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<UpdateRecordingStatusOperation> PutAsync(UpdateRecordingStatusOperation updateRecordingStatusOperationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="updateRecordingStatusOperationToUpdate">The UpdateRecordingStatusOperation object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{UpdateRecordingStatusOperation}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UpdateRecordingStatusOperation>> PutResponseAsync(UpdateRecordingStatusOperation updateRecordingStatusOperationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<UpdateRecordingStatusOperation>(updateRecordingStatusOperationToUpdate, cancellationToken);
