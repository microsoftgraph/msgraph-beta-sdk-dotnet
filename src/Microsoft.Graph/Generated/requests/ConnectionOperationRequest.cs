...
namespace Microsoft.Graph
{
    ...
    public partial class ConnectionOperationRequest : BaseRequest, IConnectionOperationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ConnectionOperation>> CreateResponseAsync(ConnectionOperation connectionOperationToCreate)
        {
            return this.CreateResponseAsync(connectionOperationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ConnectionOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ConnectionOperation>> CreateResponseAsync(ConnectionOperation connectionOperationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<ConnectionOperation>(connectionOperationToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ConnectionOperation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ConnectionOperation>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ConnectionOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ConnectionOperation>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ConnectionOperation>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="connectionOperationToUpdate">The ConnectionOperation to update.</param>
        /// <returns>The <see cref="GraphResponse{ConnectionOperation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ConnectionOperation>> UpdateResponseAsync(ConnectionOperation connectionOperationToUpdate)
        {
            return this.UpdateResponseAsync(connectionOperationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ConnectionOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ConnectionOperation>> UpdateResponseAsync(ConnectionOperation connectionOperationToUpdate, CancellationToken cancellationToken)
        {
			if (connectionOperationToUpdate.AdditionalData != null)
			{
				if (connectionOperationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ConnectionOperation>(connectionOperationToUpdate, cancellationToken).ConfigureAwait(false);
        }
