...
namespace Microsoft.Graph
{
    ...
    public partial class RiskyUserHistoryItemRequest : BaseRequest, IRiskyUserHistoryItemRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<RiskyUserHistoryItem> PutAsync(RiskyUserHistoryItem riskyUserHistoryItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="riskyUserHistoryItemToUpdate">The RiskyUserHistoryItem object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{RiskyUserHistoryItem}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<RiskyUserHistoryItem>> PutResponseAsync(RiskyUserHistoryItem riskyUserHistoryItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<RiskyUserHistoryItem>(riskyUserHistoryItemToUpdate, cancellationToken);
