...
namespace Microsoft.Graph
{
    ...
    public partial class EventRequest : BaseRequest, IEventRequest
    {
        ...
        /// <param name="eventToUpdate">The Event to update.</param>
        /// <returns>The <see cref="GraphResponse{Event}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Event>> UpdateResponseAsync(Event eventToUpdate)
        {
            return this.UpdateResponseAsync(eventToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Event}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Event>> UpdateResponseAsync(Event eventToUpdate, CancellationToken cancellationToken)
        {
			if (eventToUpdate.AdditionalData != null)
			{
				if (eventToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
