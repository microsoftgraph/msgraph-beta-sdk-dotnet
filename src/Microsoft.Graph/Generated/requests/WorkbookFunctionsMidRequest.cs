...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsMidRequest : BaseRequest, IWorkbookFunctionsMidRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsMidRequest.
        /// </summary>
        public WorkbookFunctionsMidRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsMidRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsMidRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsMidRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsMidRequest Select(string value)
        {
