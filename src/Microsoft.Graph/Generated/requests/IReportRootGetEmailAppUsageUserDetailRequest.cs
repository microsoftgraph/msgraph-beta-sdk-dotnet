...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetEmailAppUsageUserDetailRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetEmailAppUsageUserDetailCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="emailappusageuserdetail">The EmailAppUsageUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetEmailAppUsageUserDetailCollectionResponse>> PatchResponseAsync(EmailAppUsageUserDetail emailappusageuserdetail, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="emailappusageuserdetail">The EmailAppUsageUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetEmailAppUsageUserDetailCollectionResponse>> PutResponseAsync(EmailAppUsageUserDetail emailappusageuserdetail, CancellationToken cancellationToken = default(CancellationToken));
