...
namespace Microsoft.Graph
{
    ...
    public partial class SensitivityLabelRequest : BaseRequest, ISensitivityLabelRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<SensitivityLabel>> CreateResponseAsync(SensitivityLabel sensitivityLabelToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SensitivityLabel}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SensitivityLabel>> UpdateResponseAsync(SensitivityLabel sensitivityLabelToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
