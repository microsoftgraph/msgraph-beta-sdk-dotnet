...
namespace Microsoft.Graph
{
    ...
    public partial class GroupPolicyUploadedDefinitionFileRequest : BaseRequest, IGroupPolicyUploadedDefinitionFileRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{GroupPolicyUploadedDefinitionFile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyUploadedDefinitionFile>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyUploadedDefinitionFile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyUploadedDefinitionFile>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<GroupPolicyUploadedDefinitionFile>(null, cancellationToken).ConfigureAwait(false);
        }
