...
namespace Microsoft.Graph
{
    ...
    public partial class GroupPolicyUploadedDefinitionFileRequest : BaseRequest, IGroupPolicyUploadedDefinitionFileRequest
    {
        ...
        public async System.Threading.Tasks.Task<GroupPolicyUploadedDefinitionFile> CreateAsync(GroupPolicyUploadedDefinitionFile groupPolicyUploadedDefinitionFileToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyUploadedDefinitionFile>> CreateResponseAsync(GroupPolicyUploadedDefinitionFile groupPolicyUploadedDefinitionFileToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<GroupPolicyUploadedDefinitionFile>(groupPolicyUploadedDefinitionFileToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<GroupPolicyUploadedDefinitionFile> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyUploadedDefinitionFile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyUploadedDefinitionFile>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<GroupPolicyUploadedDefinitionFile>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<GroupPolicyUploadedDefinitionFile> UpdateAsync(GroupPolicyUploadedDefinitionFile groupPolicyUploadedDefinitionFileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{GroupPolicyUploadedDefinitionFile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyUploadedDefinitionFile>> UpdateResponseAsync(GroupPolicyUploadedDefinitionFile groupPolicyUploadedDefinitionFileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<GroupPolicyUploadedDefinitionFile>(groupPolicyUploadedDefinitionFileToUpdate, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<GroupPolicyUploadedDefinitionFile> PutAsync(GroupPolicyUploadedDefinitionFile groupPolicyUploadedDefinitionFileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="groupPolicyUploadedDefinitionFileToUpdate">The GroupPolicyUploadedDefinitionFile object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{GroupPolicyUploadedDefinitionFile}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyUploadedDefinitionFile>> PutResponseAsync(GroupPolicyUploadedDefinitionFile groupPolicyUploadedDefinitionFileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<GroupPolicyUploadedDefinitionFile>(groupPolicyUploadedDefinitionFileToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(GroupPolicyUploadedDefinitionFile groupPolicyUploadedDefinitionFileToInitialize)
        {
            ...
            if (groupPolicyUploadedDefinitionFileToInitialize != null)
            {
                ...
                {
                    groupPolicyUploadedDefinitionFileToInitialize.GroupPolicyOperations.InitializeNextPageRequest(this.Client, groupPolicyUploadedDefinitionFileToInitialize.GroupPolicyOperationsNextLink);
