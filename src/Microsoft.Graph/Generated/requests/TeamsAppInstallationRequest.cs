...
namespace Microsoft.Graph
{
    ...
    public partial class TeamsAppInstallationRequest : BaseRequest, ITeamsAppInstallationRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<TeamsAppInstallation> PutAsync(TeamsAppInstallation teamsAppInstallationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <summary>
        /// Updates the specified TeamsAppInstallation using PUT and returns a <see cref="GraphResponse{TeamsAppInstallation}"/> object.
        /// </summary>
        /// <param name="teamsAppInstallationToUpdate">The TeamsAppInstallation object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{TeamsAppInstallation}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TeamsAppInstallation>> PutResponseAsync(TeamsAppInstallation teamsAppInstallationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<TeamsAppInstallation>(teamsAppInstallationToUpdate, cancellationToken);
