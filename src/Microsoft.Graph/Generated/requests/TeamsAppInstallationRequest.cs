...
namespace Microsoft.Graph
{
    ...
    public partial class TeamsAppInstallationRequest : BaseRequest, ITeamsAppInstallationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<TeamsAppInstallation>> CreateResponseAsync(TeamsAppInstallation teamsAppInstallationToCreate)
        {
            return this.CreateResponseAsync(teamsAppInstallationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TeamsAppInstallation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<TeamsAppInstallation>> CreateResponseAsync(TeamsAppInstallation teamsAppInstallationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<TeamsAppInstallation>(teamsAppInstallationToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{TeamsAppInstallation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TeamsAppInstallation>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TeamsAppInstallation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<TeamsAppInstallation>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<TeamsAppInstallation>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="teamsAppInstallationToUpdate">The TeamsAppInstallation to update.</param>
        /// <returns>The <see cref="GraphResponse{TeamsAppInstallation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TeamsAppInstallation>> UpdateResponseAsync(TeamsAppInstallation teamsAppInstallationToUpdate)
        {
            return this.UpdateResponseAsync(teamsAppInstallationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{TeamsAppInstallation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<TeamsAppInstallation>> UpdateResponseAsync(TeamsAppInstallation teamsAppInstallationToUpdate, CancellationToken cancellationToken)
        {
			if (teamsAppInstallationToUpdate.AdditionalData != null)
			{
				if (teamsAppInstallationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<TeamsAppInstallation>(teamsAppInstallationToUpdate, cancellationToken).ConfigureAwait(false);
        }
