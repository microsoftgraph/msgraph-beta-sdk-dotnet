...
namespace Microsoft.Graph
{
    ...
    public partial interface IMicrosoftTunnelServerLogCollectionResponseRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<MicrosoftTunnelServerLogCollectionResponse> CreateAsync(MicrosoftTunnelServerLogCollectionResponse microsoftTunnelServerLogCollectionResponseToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelServerLogCollectionResponse>> CreateResponseAsync(MicrosoftTunnelServerLogCollectionResponse microsoftTunnelServerLogCollectionResponseToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<MicrosoftTunnelServerLogCollectionResponse> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MicrosoftTunnelServerLogCollectionResponse}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelServerLogCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<MicrosoftTunnelServerLogCollectionResponse> UpdateAsync(MicrosoftTunnelServerLogCollectionResponse microsoftTunnelServerLogCollectionResponseToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MicrosoftTunnelServerLogCollectionResponse}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelServerLogCollectionResponse>> UpdateResponseAsync(MicrosoftTunnelServerLogCollectionResponse microsoftTunnelServerLogCollectionResponseToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<MicrosoftTunnelServerLogCollectionResponse> PutAsync(MicrosoftTunnelServerLogCollectionResponse microsoftTunnelServerLogCollectionResponseToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelServerLogCollectionResponse>> PutResponseAsync(MicrosoftTunnelServerLogCollectionResponse microsoftTunnelServerLogCollectionResponseToUpdate, CancellationToken cancellationToken = default);
