...
namespace Microsoft.Graph
{
    ...
    public partial class SectionGroupRequest : BaseRequest, ISectionGroupRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SectionGroup>> CreateResponseAsync(SectionGroup sectionGroupToCreate)
        {
            return this.CreateResponseAsync(sectionGroupToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SectionGroup}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SectionGroup>> CreateResponseAsync(SectionGroup sectionGroupToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<SectionGroup>(sectionGroupToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{SectionGroup}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SectionGroup>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SectionGroup}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SectionGroup>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<SectionGroup>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="sectionGroupToUpdate">The SectionGroup to update.</param>
        /// <returns>The <see cref="GraphResponse{SectionGroup}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SectionGroup>> UpdateResponseAsync(SectionGroup sectionGroupToUpdate)
        {
            return this.UpdateResponseAsync(sectionGroupToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SectionGroup}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SectionGroup>> UpdateResponseAsync(SectionGroup sectionGroupToUpdate, CancellationToken cancellationToken)
        {
			if (sectionGroupToUpdate.AdditionalData != null)
			{
				if (sectionGroupToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<SectionGroup>(sectionGroupToUpdate, cancellationToken).ConfigureAwait(false);
        }
