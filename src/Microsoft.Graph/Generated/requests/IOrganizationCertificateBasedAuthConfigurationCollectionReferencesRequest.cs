...
namespace Microsoft.Graph
{
    ...
    public partial interface IOrganizationCertificateBasedAuthConfigurationCollectionReferencesRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task AddAsync(CertificateBasedAuthConfiguration certificateBasedAuthConfiguration, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="certificateBasedAuthConfiguration">The CertificateBasedAuthConfiguration to add.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(CertificateBasedAuthConfiguration certificateBasedAuthConfiguration, CancellationToken cancellationToken = default(CancellationToken));
