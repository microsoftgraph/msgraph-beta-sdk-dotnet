...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class CloudCommunicationsOnlineMeetingsCollectionRequestBuilder : BaseRequestBuilder, ICloudCommunicationsOnlineMeetingsCollectionRequestBuilder
    {
        /// <summary>
        ...
        public CloudCommunicationsOnlineMeetingsCollectionRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public ICloudCommunicationsOnlineMeetingsCollectionRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public ICloudCommunicationsOnlineMeetingsCollectionRequest Request(IEnumerable<Option> options)
        {
            return new CloudCommunicationsOnlineMeetingsCollectionRequest(this.RequestUrl, this.Client, options);
        }

        /// <summary>
        /// Gets an <see cref="IOnlineMeetingRequestBuilder"/> for the specified CloudCommunicationsOnlineMeeting.
        /// </summary>
