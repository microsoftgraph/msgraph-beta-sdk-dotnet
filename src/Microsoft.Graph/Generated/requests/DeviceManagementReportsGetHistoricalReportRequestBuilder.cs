...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DeviceManagementReportsGetHistoricalReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetHistoricalReportRequest>, IDeviceManagementReportsGetHistoricalReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetHistoricalReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetHistoricalReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetHistoricalReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetHistoricalReportRequest(functionUrl, this.Client, options);
