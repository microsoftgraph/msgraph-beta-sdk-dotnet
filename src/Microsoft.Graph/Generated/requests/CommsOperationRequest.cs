...
namespace Microsoft.Graph
{
    ...
    public partial class CommsOperationRequest : BaseRequest, ICommsOperationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<CommsOperation>> CreateResponseAsync(CommsOperation commsOperationToCreate)
        {
            return this.CreateResponseAsync(commsOperationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{CommsOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CommsOperation>> CreateResponseAsync(CommsOperation commsOperationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="commsOperationToUpdate">The CommsOperation to update.</param>
        /// <returns>The <see cref="GraphResponse{CommsOperation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<CommsOperation>> UpdateResponseAsync(CommsOperation commsOperationToUpdate)
        {
            return this.UpdateResponseAsync(commsOperationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CommsOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CommsOperation>> UpdateResponseAsync(CommsOperation commsOperationToUpdate, CancellationToken cancellationToken)
        {
			if (commsOperationToUpdate.AdditionalData != null)
			{
				if (commsOperationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
