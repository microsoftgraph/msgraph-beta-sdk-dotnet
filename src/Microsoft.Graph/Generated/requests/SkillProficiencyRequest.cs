...
namespace Microsoft.Graph
{
    ...
    public partial class SkillProficiencyRequest : BaseRequest, ISkillProficiencyRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<SkillProficiency>> CreateResponseAsync(SkillProficiency skillProficiencyToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SkillProficiency}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SkillProficiency>> UpdateResponseAsync(SkillProficiency skillProficiencyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
