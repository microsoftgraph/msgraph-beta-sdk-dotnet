...
namespace Microsoft.Graph
{
    ...
    public partial class SkillProficiencyRequest : BaseRequest, ISkillProficiencyRequest
    {
        ...
        public async System.Threading.Tasks.Task<SkillProficiency> CreateAsync(SkillProficiency skillProficiencyToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SkillProficiency>> CreateResponseAsync(SkillProficiency skillProficiencyToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<SkillProficiency> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SkillProficiency}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SkillProficiency>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<SkillProficiency> UpdateAsync(SkillProficiency skillProficiencyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SkillProficiency}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SkillProficiency>> UpdateResponseAsync(SkillProficiency skillProficiencyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <summary>
        /// Updates the specified SkillProficiency using PUT.
        /// </summary>
        /// <param name="skillProficiencyToUpdate">The SkillProficiency object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<SkillProficiency> PutAsync(SkillProficiency skillProficiencyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <summary>
        /// Updates the specified SkillProficiency using PUT and returns a <see cref="GraphResponse{SkillProficiency}"/> object.
        /// </summary>
        /// <param name="skillProficiencyToUpdate">The SkillProficiency object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{SkillProficiency}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SkillProficiency>> PutResponseAsync(SkillProficiency skillProficiencyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SkillProficiency>(skillProficiencyToUpdate, cancellationToken);
