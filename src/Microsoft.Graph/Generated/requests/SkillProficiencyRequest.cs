...
namespace Microsoft.Graph
{
    ...
    public partial class SkillProficiencyRequest : BaseRequest, ISkillProficiencyRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<SkillProficiency> PutAsync(SkillProficiency skillProficiencyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<SkillProficiency>> PutResponseAsync(SkillProficiency skillProficiencyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SkillProficiency>(skillProficiencyToUpdate, cancellationToken);
