...
namespace Microsoft.Graph
{
    ...
    public partial interface IMobileAppInstallSummaryRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<MobileAppInstallSummary> CreateAsync(MobileAppInstallSummary mobileAppInstallSummaryToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<MobileAppInstallSummary>> CreateResponseAsync(MobileAppInstallSummary mobileAppInstallSummaryToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MobileAppInstallSummary}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MobileAppInstallSummary>> CreateResponseAsync(MobileAppInstallSummary mobileAppInstallSummaryToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="mobileAppInstallSummaryToUpdate">The MobileAppInstallSummary to update.</param>
        /// <returns>The <see cref="GraphResponse{MobileAppInstallSummary}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MobileAppInstallSummary>> UpdateResponseAsync(MobileAppInstallSummary mobileAppInstallSummaryToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MobileAppInstallSummary}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MobileAppInstallSummary>> UpdateResponseAsync(MobileAppInstallSummary mobileAppInstallSummaryToUpdate, CancellationToken cancellationToken);
