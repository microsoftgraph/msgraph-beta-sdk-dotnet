...
namespace Microsoft.Graph
{
    ...
    public partial interface ISchemaExtensionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SchemaExtension> CreateAsync(SchemaExtension schemaExtensionToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<SchemaExtension>> CreateResponseAsync(SchemaExtension schemaExtensionToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<SchemaExtension> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SchemaExtension}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SchemaExtension>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<SchemaExtension> UpdateAsync(SchemaExtension schemaExtensionToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SchemaExtension}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SchemaExtension>> UpdateResponseAsync(SchemaExtension schemaExtensionToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<SchemaExtension> PutAsync(SchemaExtension schemaExtensionToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<SchemaExtension>> PutResponseAsync(SchemaExtension schemaExtensionToUpdate, CancellationToken cancellationToken = default);
