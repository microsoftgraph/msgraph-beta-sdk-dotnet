...
namespace Microsoft.Graph
{
    ...
    public partial class UnifiedRoleManagementPolicyExpirationRuleRequest : BaseRequest, IUnifiedRoleManagementPolicyExpirationRuleRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UnifiedRoleManagementPolicyExpirationRule>> CreateResponseAsync(UnifiedRoleManagementPolicyExpirationRule unifiedRoleManagementPolicyExpirationRuleToCreate)
        {
            return this.CreateResponseAsync(unifiedRoleManagementPolicyExpirationRuleToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleManagementPolicyExpirationRule}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UnifiedRoleManagementPolicyExpirationRule>> CreateResponseAsync(UnifiedRoleManagementPolicyExpirationRule unifiedRoleManagementPolicyExpirationRuleToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="unifiedRoleManagementPolicyExpirationRuleToUpdate">The UnifiedRoleManagementPolicyExpirationRule to update.</param>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleManagementPolicyExpirationRule}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UnifiedRoleManagementPolicyExpirationRule>> UpdateResponseAsync(UnifiedRoleManagementPolicyExpirationRule unifiedRoleManagementPolicyExpirationRuleToUpdate)
        {
            return this.UpdateResponseAsync(unifiedRoleManagementPolicyExpirationRuleToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleManagementPolicyExpirationRule}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UnifiedRoleManagementPolicyExpirationRule>> UpdateResponseAsync(UnifiedRoleManagementPolicyExpirationRule unifiedRoleManagementPolicyExpirationRuleToUpdate, CancellationToken cancellationToken)
        {
			if (unifiedRoleManagementPolicyExpirationRuleToUpdate.AdditionalData != null)
			{
				if (unifiedRoleManagementPolicyExpirationRuleToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
