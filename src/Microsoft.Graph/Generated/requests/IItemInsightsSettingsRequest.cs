...
namespace Microsoft.Graph
{
    ...
    public partial interface IItemInsightsSettingsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ItemInsightsSettings> CreateAsync(ItemInsightsSettings itemInsightsSettingsToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<ItemInsightsSettings>> CreateResponseAsync(ItemInsightsSettings itemInsightsSettingsToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ItemInsightsSettings}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ItemInsightsSettings>> CreateResponseAsync(ItemInsightsSettings itemInsightsSettingsToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="itemInsightsSettingsToUpdate">The ItemInsightsSettings to update.</param>
        /// <returns>The <see cref="GraphResponse{ItemInsightsSettings}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ItemInsightsSettings>> UpdateResponseAsync(ItemInsightsSettings itemInsightsSettingsToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ItemInsightsSettings}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ItemInsightsSettings>> UpdateResponseAsync(ItemInsightsSettings itemInsightsSettingsToUpdate, CancellationToken cancellationToken);
