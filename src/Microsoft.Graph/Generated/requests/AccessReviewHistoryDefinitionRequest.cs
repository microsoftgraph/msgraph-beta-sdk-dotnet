...
namespace Microsoft.Graph
{
    ...
    public partial class AccessReviewHistoryDefinitionRequest : BaseRequest, IAccessReviewHistoryDefinitionRequest
    {
        ...
        public async System.Threading.Tasks.Task<AccessReviewHistoryDefinition> CreateAsync(AccessReviewHistoryDefinition accessReviewHistoryDefinitionToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AccessReviewHistoryDefinition>> CreateResponseAsync(AccessReviewHistoryDefinition accessReviewHistoryDefinitionToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<AccessReviewHistoryDefinition> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AccessReviewHistoryDefinition}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AccessReviewHistoryDefinition>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<AccessReviewHistoryDefinition> UpdateAsync(AccessReviewHistoryDefinition accessReviewHistoryDefinitionToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AccessReviewHistoryDefinition}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AccessReviewHistoryDefinition>> UpdateResponseAsync(AccessReviewHistoryDefinition accessReviewHistoryDefinitionToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<AccessReviewHistoryDefinition> PutAsync(AccessReviewHistoryDefinition accessReviewHistoryDefinitionToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<AccessReviewHistoryDefinition>> PutResponseAsync(AccessReviewHistoryDefinition accessReviewHistoryDefinitionToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<AccessReviewHistoryDefinition>(accessReviewHistoryDefinitionToUpdate, cancellationToken);
