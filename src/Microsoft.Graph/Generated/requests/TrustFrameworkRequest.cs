...
namespace Microsoft.Graph
{
    ...
    public partial class TrustFrameworkRequest : BaseRequest, ITrustFrameworkRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<TrustFramework>> CreateResponseAsync(TrustFramework trustFrameworkToCreate)
        {
            return this.CreateResponseAsync(trustFrameworkToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TrustFramework}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<TrustFramework>> CreateResponseAsync(TrustFramework trustFrameworkToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<TrustFramework>(trustFrameworkToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{TrustFramework}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TrustFramework>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TrustFramework}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<TrustFramework>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<TrustFramework>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="trustFrameworkToUpdate">The TrustFramework to update.</param>
        /// <returns>The <see cref="GraphResponse{TrustFramework}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TrustFramework>> UpdateResponseAsync(TrustFramework trustFrameworkToUpdate)
        {
            return this.UpdateResponseAsync(trustFrameworkToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{TrustFramework}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<TrustFramework>> UpdateResponseAsync(TrustFramework trustFrameworkToUpdate, CancellationToken cancellationToken)
        {
			if (trustFrameworkToUpdate.AdditionalData != null)
			{
				if (trustFrameworkToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<TrustFramework>(trustFrameworkToUpdate, cancellationToken).ConfigureAwait(false);
        }
