...
namespace Microsoft.Graph
{
    ...
    public partial class TrustFrameworkRequest : BaseRequest, ITrustFrameworkRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<TrustFramework> PutAsync(TrustFramework trustFrameworkToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="trustFrameworkToUpdate">The TrustFramework object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{TrustFramework}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TrustFramework>> PutResponseAsync(TrustFramework trustFrameworkToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<TrustFramework>(trustFrameworkToUpdate, cancellationToken);
