...
namespace Microsoft.Graph
{
    ...
    public partial class GovernanceSubjectRequest : BaseRequest, IGovernanceSubjectRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<GovernanceSubject> PutAsync(GovernanceSubject governanceSubjectToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<GovernanceSubject>> PutResponseAsync(GovernanceSubject governanceSubjectToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<GovernanceSubject>(governanceSubjectToUpdate, cancellationToken);
