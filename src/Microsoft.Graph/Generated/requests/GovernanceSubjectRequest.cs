...
namespace Microsoft.Graph
{
    ...
    public partial class GovernanceSubjectRequest : BaseRequest, IGovernanceSubjectRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<GovernanceSubject>> CreateResponseAsync(GovernanceSubject governanceSubjectToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{GovernanceSubject}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GovernanceSubject>> UpdateResponseAsync(GovernanceSubject governanceSubjectToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
