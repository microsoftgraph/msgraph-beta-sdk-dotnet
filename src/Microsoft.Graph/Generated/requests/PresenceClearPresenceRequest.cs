...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class PresenceClearPresenceRequest : BaseRequest, IPresenceClearPresenceRequest
    {
        /// <summary>
        /// Constructs a new PresenceClearPresenceRequest.
        /// </summary>
        public PresenceClearPresenceRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new PresenceClearPresenceRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public PresenceClearPresenceRequestBody RequestBody { get; private set; }
        ...
        public IPresenceClearPresenceRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPresenceClearPresenceRequest Select(string value)
        {
