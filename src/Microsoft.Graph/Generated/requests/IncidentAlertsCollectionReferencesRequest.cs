...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class IncidentAlertsCollectionReferencesRequest : BaseRequest, IIncidentAlertsCollectionReferencesRequest
    {
        /// <summary>
        ...
        public System.Threading.Tasks.Task AddAsync(Alert_v2 alert_v2, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;

            if (string.IsNullOrEmpty(alert_v2.Id))
            {
                throw new ServiceException(new Error { Code = "invalidRequest", Message = "ID is required to add a reference." });
            }

            var requestBody = new ReferenceRequestBody { ODataId = string.Format("{0}/security/alerts/{1}", this.Client.BaseUrl, alert_v2.Id) };
        ...
        public System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(Alert_v2 alert_v2, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
