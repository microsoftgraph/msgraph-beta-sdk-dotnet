...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsManagementAppRequest : BaseRequest, IWindowsManagementAppRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<WindowsManagementApp> PutAsync(WindowsManagementApp windowsManagementAppToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<WindowsManagementApp>> PutResponseAsync(WindowsManagementApp windowsManagementAppToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<WindowsManagementApp>(windowsManagementAppToUpdate, cancellationToken);
