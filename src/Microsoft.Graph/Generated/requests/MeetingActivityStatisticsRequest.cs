...
namespace Microsoft.Graph
{
    ...
    public partial class MeetingActivityStatisticsRequest : BaseRequest, IMeetingActivityStatisticsRequest
    {
        ...
        public async System.Threading.Tasks.Task<MeetingActivityStatistics> CreateAsync(MeetingActivityStatistics meetingActivityStatisticsToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MeetingActivityStatistics>> CreateResponseAsync(MeetingActivityStatistics meetingActivityStatisticsToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<MeetingActivityStatistics> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MeetingActivityStatistics}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MeetingActivityStatistics>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<MeetingActivityStatistics> UpdateAsync(MeetingActivityStatistics meetingActivityStatisticsToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MeetingActivityStatistics}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MeetingActivityStatistics>> UpdateResponseAsync(MeetingActivityStatistics meetingActivityStatisticsToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<MeetingActivityStatistics> PutAsync(MeetingActivityStatistics meetingActivityStatisticsToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<MeetingActivityStatistics>> PutResponseAsync(MeetingActivityStatistics meetingActivityStatisticsToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<MeetingActivityStatistics>(meetingActivityStatisticsToUpdate, cancellationToken);
