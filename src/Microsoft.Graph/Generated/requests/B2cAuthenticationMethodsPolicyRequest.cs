...
namespace Microsoft.Graph
{
    ...
    public partial class B2cAuthenticationMethodsPolicyRequest : BaseRequest, IB2cAuthenticationMethodsPolicyRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<B2cAuthenticationMethodsPolicy> PutAsync(B2cAuthenticationMethodsPolicy b2cAuthenticationMethodsPolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<B2cAuthenticationMethodsPolicy>> PutResponseAsync(B2cAuthenticationMethodsPolicy b2cAuthenticationMethodsPolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<B2cAuthenticationMethodsPolicy>(b2cAuthenticationMethodsPolicyToUpdate, cancellationToken);
