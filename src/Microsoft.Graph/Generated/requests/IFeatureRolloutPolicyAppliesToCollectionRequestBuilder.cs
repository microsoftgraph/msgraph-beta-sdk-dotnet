...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IFeatureRolloutPolicyAppliesToCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IFeatureRolloutPolicyAppliesToCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IFeatureRolloutPolicyAppliesToCollectionRequest Request(IEnumerable<Option> options);
