...
namespace Microsoft.Graph
{
    ...
    public partial class IosPkcsCertificateProfileRequest : BaseRequest, IIosPkcsCertificateProfileRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<IosPkcsCertificateProfile>> CreateResponseAsync(IosPkcsCertificateProfile iosPkcsCertificateProfileToCreate)
        {
            return this.CreateResponseAsync(iosPkcsCertificateProfileToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosPkcsCertificateProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosPkcsCertificateProfile>> CreateResponseAsync(IosPkcsCertificateProfile iosPkcsCertificateProfileToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="iosPkcsCertificateProfileToUpdate">The IosPkcsCertificateProfile to update.</param>
        /// <returns>The <see cref="GraphResponse{IosPkcsCertificateProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosPkcsCertificateProfile>> UpdateResponseAsync(IosPkcsCertificateProfile iosPkcsCertificateProfileToUpdate)
        {
            return this.UpdateResponseAsync(iosPkcsCertificateProfileToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosPkcsCertificateProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosPkcsCertificateProfile>> UpdateResponseAsync(IosPkcsCertificateProfile iosPkcsCertificateProfileToUpdate, CancellationToken cancellationToken)
        {
			if (iosPkcsCertificateProfileToUpdate.AdditionalData != null)
			{
				if (iosPkcsCertificateProfileToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
