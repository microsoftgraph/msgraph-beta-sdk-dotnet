...
namespace Microsoft.Graph
{
    ...
    public partial class OfficeSuiteAppRequest : BaseRequest, IOfficeSuiteAppRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<OfficeSuiteApp> PutAsync(OfficeSuiteApp officeSuiteAppToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="officeSuiteAppToUpdate">The OfficeSuiteApp object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{OfficeSuiteApp}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OfficeSuiteApp>> PutResponseAsync(OfficeSuiteApp officeSuiteAppToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<OfficeSuiteApp>(officeSuiteAppToUpdate, cancellationToken);
