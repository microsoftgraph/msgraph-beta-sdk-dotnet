...
namespace Microsoft.Graph
{
    ...
    public partial class OfficeSuiteAppRequest : BaseRequest, IOfficeSuiteAppRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<OfficeSuiteApp>> CreateResponseAsync(OfficeSuiteApp officeSuiteAppToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{OfficeSuiteApp}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OfficeSuiteApp>> UpdateResponseAsync(OfficeSuiteApp officeSuiteAppToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
