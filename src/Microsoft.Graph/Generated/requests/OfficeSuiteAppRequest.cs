...
namespace Microsoft.Graph
{
    ...
    public partial class OfficeSuiteAppRequest : BaseRequest, IOfficeSuiteAppRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<OfficeSuiteApp>> CreateResponseAsync(OfficeSuiteApp officeSuiteAppToCreate)
        {
            return this.CreateResponseAsync(officeSuiteAppToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OfficeSuiteApp}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OfficeSuiteApp>> CreateResponseAsync(OfficeSuiteApp officeSuiteAppToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<OfficeSuiteApp>(officeSuiteAppToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{OfficeSuiteApp}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OfficeSuiteApp>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OfficeSuiteApp}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OfficeSuiteApp>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<OfficeSuiteApp>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="officeSuiteAppToUpdate">The OfficeSuiteApp to update.</param>
        /// <returns>The <see cref="GraphResponse{OfficeSuiteApp}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OfficeSuiteApp>> UpdateResponseAsync(OfficeSuiteApp officeSuiteAppToUpdate)
        {
            return this.UpdateResponseAsync(officeSuiteAppToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{OfficeSuiteApp}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OfficeSuiteApp>> UpdateResponseAsync(OfficeSuiteApp officeSuiteAppToUpdate, CancellationToken cancellationToken)
        {
			if (officeSuiteAppToUpdate.AdditionalData != null)
			{
				if (officeSuiteAppToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<OfficeSuiteApp>(officeSuiteAppToUpdate, cancellationToken).ConfigureAwait(false);
        }
