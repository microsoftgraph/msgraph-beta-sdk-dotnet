...
namespace Microsoft.Graph
{
    ...
    public partial class DriveItemsCollectionRequest : BaseRequest, IDriveItemsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<IDriveItemsCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <summary>
        /// Gets the collection page and returns a <see cref="GraphResponse{DriveItemsCollectionResponse}"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DriveItemsCollectionResponse}"/> object.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DriveItemsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = CoreConstants.HttpMethods.GET.ToString();
            return this.SendAsyncWithGraphResponse<DriveItemsCollectionResponse>(null, cancellationToken);
        }
