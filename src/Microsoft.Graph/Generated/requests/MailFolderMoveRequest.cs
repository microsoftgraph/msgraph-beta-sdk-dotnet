...
namespace Microsoft.Graph
{
    ...
    public partial class MailFolderMoveRequest : BaseRequest, IMailFolderMoveRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MailFolder>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = CoreConstants.HttpMethods.POST.ToString();
            return this.SendAsyncWithGraphResponse<MailFolder>(this.RequestBody, cancellationToken);
        }
