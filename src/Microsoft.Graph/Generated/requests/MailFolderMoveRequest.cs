...
namespace Microsoft.Graph
{
    ...
    public partial class MailFolderMoveRequest : BaseRequest, IMailFolderMoveRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<MailFolder>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<MailFolder>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
