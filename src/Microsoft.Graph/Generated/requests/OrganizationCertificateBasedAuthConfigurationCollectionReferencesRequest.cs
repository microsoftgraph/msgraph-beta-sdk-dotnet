...
namespace Microsoft.Graph
{
    ...
    public partial class OrganizationCertificateBasedAuthConfigurationCollectionReferencesRequest : BaseRequest, IOrganizationCertificateBasedAuthConfigurationCollectionReferencesRequest
    {
        ...
        public System.Threading.Tasks.Task AddAsync(CertificateBasedAuthConfiguration certificateBasedAuthConfiguration)
        {
        ...
        /// <returns>The task to await.</returns>
        public System.Threading.Tasks.Task AddAsync(CertificateBasedAuthConfiguration certificateBasedAuthConfiguration, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(CertificateBasedAuthConfiguration certificateBasedAuthConfiguration)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
        public System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(CertificateBasedAuthConfiguration certificateBasedAuthConfiguration, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
