...
namespace Microsoft.Graph
{
    ...
    public partial class OnPremisesAgentRequest : BaseRequest, IOnPremisesAgentRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<OnPremisesAgent>> CreateResponseAsync(OnPremisesAgent onPremisesAgentToCreate)
        {
            return this.CreateResponseAsync(onPremisesAgentToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OnPremisesAgent}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OnPremisesAgent>> CreateResponseAsync(OnPremisesAgent onPremisesAgentToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<OnPremisesAgent>(onPremisesAgentToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{OnPremisesAgent}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OnPremisesAgent>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OnPremisesAgent}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OnPremisesAgent>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<OnPremisesAgent>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="onPremisesAgentToUpdate">The OnPremisesAgent to update.</param>
        /// <returns>The <see cref="GraphResponse{OnPremisesAgent}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OnPremisesAgent>> UpdateResponseAsync(OnPremisesAgent onPremisesAgentToUpdate)
        {
            return this.UpdateResponseAsync(onPremisesAgentToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{OnPremisesAgent}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OnPremisesAgent>> UpdateResponseAsync(OnPremisesAgent onPremisesAgentToUpdate, CancellationToken cancellationToken)
        {
			if (onPremisesAgentToUpdate.AdditionalData != null)
			{
				if (onPremisesAgentToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<OnPremisesAgent>(onPremisesAgentToUpdate, cancellationToken).ConfigureAwait(false);
        }
