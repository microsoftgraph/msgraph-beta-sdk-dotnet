...
namespace Microsoft.Graph
{
    ...
    public partial class OnPremisesAgentRequest : BaseRequest, IOnPremisesAgentRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<OnPremisesAgent>> CreateResponseAsync(OnPremisesAgent onPremisesAgentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{OnPremisesAgent}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OnPremisesAgent>> UpdateResponseAsync(OnPremisesAgent onPremisesAgentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
