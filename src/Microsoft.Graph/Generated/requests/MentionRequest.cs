...
namespace Microsoft.Graph
{
    ...
    public partial class MentionRequest : BaseRequest, IMentionRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Mention}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Mention>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Mention}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Mention>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Mention>(null, cancellationToken).ConfigureAwait(false);
        }
