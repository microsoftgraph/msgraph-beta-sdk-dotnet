...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetOffice365ServicesUserCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ServicesUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="office365servicesusercounts">The Office365ServicesUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ServicesUserCountsCollectionResponse>> PatchResponseAsync(Office365ServicesUserCounts office365servicesusercounts, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="office365servicesusercounts">The Office365ServicesUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ServicesUserCountsCollectionResponse>> PutResponseAsync(Office365ServicesUserCounts office365servicesusercounts, CancellationToken cancellationToken = default(CancellationToken));
