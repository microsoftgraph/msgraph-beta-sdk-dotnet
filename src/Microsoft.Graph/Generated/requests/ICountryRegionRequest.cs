...
namespace Microsoft.Graph
{
    ...
    public partial interface ICountryRegionRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<CountryRegion> PutAsync(CountryRegion countryRegionToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<CountryRegion>> PutResponseAsync(CountryRegion countryRegionToUpdate, CancellationToken cancellationToken = default(CancellationToken));
