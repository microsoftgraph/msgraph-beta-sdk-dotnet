...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidPkcsCertificateProfileRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AndroidPkcsCertificateProfile> CreateAsync(AndroidPkcsCertificateProfile androidPkcsCertificateProfileToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidPkcsCertificateProfile>> CreateResponseAsync(AndroidPkcsCertificateProfile androidPkcsCertificateProfileToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<AndroidPkcsCertificateProfile> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidPkcsCertificateProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidPkcsCertificateProfile>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<AndroidPkcsCertificateProfile> UpdateAsync(AndroidPkcsCertificateProfile androidPkcsCertificateProfileToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidPkcsCertificateProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidPkcsCertificateProfile>> UpdateResponseAsync(AndroidPkcsCertificateProfile androidPkcsCertificateProfileToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<AndroidPkcsCertificateProfile> PutAsync(AndroidPkcsCertificateProfile androidPkcsCertificateProfileToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidPkcsCertificateProfile>> PutResponseAsync(AndroidPkcsCertificateProfile androidPkcsCertificateProfileToUpdate, CancellationToken cancellationToken = default);
