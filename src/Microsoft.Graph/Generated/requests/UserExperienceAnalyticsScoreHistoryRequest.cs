...
namespace Microsoft.Graph
{
    ...
    public partial class UserExperienceAnalyticsScoreHistoryRequest : BaseRequest, IUserExperienceAnalyticsScoreHistoryRequest
    {
        ...
        public async System.Threading.Tasks.Task<UserExperienceAnalyticsScoreHistory> CreateAsync(UserExperienceAnalyticsScoreHistory userExperienceAnalyticsScoreHistoryToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsScoreHistory>> CreateResponseAsync(UserExperienceAnalyticsScoreHistory userExperienceAnalyticsScoreHistoryToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<UserExperienceAnalyticsScoreHistory> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserExperienceAnalyticsScoreHistory}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsScoreHistory>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<UserExperienceAnalyticsScoreHistory> UpdateAsync(UserExperienceAnalyticsScoreHistory userExperienceAnalyticsScoreHistoryToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserExperienceAnalyticsScoreHistory}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsScoreHistory>> UpdateResponseAsync(UserExperienceAnalyticsScoreHistory userExperienceAnalyticsScoreHistoryToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<UserExperienceAnalyticsScoreHistory> PutAsync(UserExperienceAnalyticsScoreHistory userExperienceAnalyticsScoreHistoryToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="userExperienceAnalyticsScoreHistoryToUpdate">The UserExperienceAnalyticsScoreHistory object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{UserExperienceAnalyticsScoreHistory}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsScoreHistory>> PutResponseAsync(UserExperienceAnalyticsScoreHistory userExperienceAnalyticsScoreHistoryToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<UserExperienceAnalyticsScoreHistory>(userExperienceAnalyticsScoreHistoryToUpdate, cancellationToken);
