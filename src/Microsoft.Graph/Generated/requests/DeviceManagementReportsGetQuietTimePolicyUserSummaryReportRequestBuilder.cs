...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetQuietTimePolicyUserSummaryReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetQuietTimePolicyUserSummaryReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetQuietTimePolicyUserSummaryReportRequest>, IDeviceManagementReportsGetQuietTimePolicyUserSummaryReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetQuietTimePolicyUserSummaryReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetQuietTimePolicyUserSummaryReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetQuietTimePolicyUserSummaryReportRequest(functionUrl, this.Client, options);
