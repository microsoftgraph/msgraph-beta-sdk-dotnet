...
namespace Microsoft.Graph
{
    ...
    public partial interface IPlannerTaskRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<PlannerTask> PutAsync(PlannerTask plannerTaskToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<PlannerTask>> PutResponseAsync(PlannerTask plannerTaskToUpdate, CancellationToken cancellationToken = default(CancellationToken));
