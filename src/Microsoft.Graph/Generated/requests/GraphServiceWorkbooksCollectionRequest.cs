...
namespace Microsoft.Graph
{
    ...
    public partial class GraphServiceWorkbooksCollectionRequest : BaseRequest, IGraphServiceWorkbooksCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<GraphServiceWorkbooksCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<GraphServiceWorkbooksCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
