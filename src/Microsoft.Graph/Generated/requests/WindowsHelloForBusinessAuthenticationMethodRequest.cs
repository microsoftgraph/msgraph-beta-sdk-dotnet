...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WindowsHelloForBusinessAuthenticationMethodRequest : BaseRequest, IWindowsHelloForBusinessAuthenticationMethodRequest
    {
        /// <summary>
        ...
        public WindowsHelloForBusinessAuthenticationMethodRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<GraphResponse<WindowsHelloForBusinessAuthenticationMethod>> CreateResponseAsync(WindowsHelloForBusinessAuthenticationMethod windowsHelloForBusinessAuthenticationMethodToCreate)
        {
            return this.CreateResponseAsync(windowsHelloForBusinessAuthenticationMethodToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsHelloForBusinessAuthenticationMethod}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsHelloForBusinessAuthenticationMethod>> CreateResponseAsync(WindowsHelloForBusinessAuthenticationMethod windowsHelloForBusinessAuthenticationMethodToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WindowsHelloForBusinessAuthenticationMethod}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsHelloForBusinessAuthenticationMethod>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsHelloForBusinessAuthenticationMethod}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsHelloForBusinessAuthenticationMethod>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WindowsHelloForBusinessAuthenticationMethod>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="windowsHelloForBusinessAuthenticationMethodToUpdate">The WindowsHelloForBusinessAuthenticationMethod to update.</param>
        /// <returns>The <see cref="GraphResponse{WindowsHelloForBusinessAuthenticationMethod}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsHelloForBusinessAuthenticationMethod>> UpdateResponseAsync(WindowsHelloForBusinessAuthenticationMethod windowsHelloForBusinessAuthenticationMethodToUpdate)
        {
            return this.UpdateResponseAsync(windowsHelloForBusinessAuthenticationMethodToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsHelloForBusinessAuthenticationMethod}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsHelloForBusinessAuthenticationMethod>> UpdateResponseAsync(WindowsHelloForBusinessAuthenticationMethod windowsHelloForBusinessAuthenticationMethodToUpdate, CancellationToken cancellationToken)
        {
			if (windowsHelloForBusinessAuthenticationMethodToUpdate.AdditionalData != null)
			{
				if (windowsHelloForBusinessAuthenticationMethodToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
        ...
        public IWindowsHelloForBusinessAuthenticationMethodRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindowsHelloForBusinessAuthenticationMethodRequest Expand(Expression<Func<WindowsHelloForBusinessAuthenticationMethod, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindowsHelloForBusinessAuthenticationMethodRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindowsHelloForBusinessAuthenticationMethodRequest Select(Expression<Func<WindowsHelloForBusinessAuthenticationMethod, object>> selectExpression)
        {
        ...
        /// </summary>
        /// <param name="windowsHelloForBusinessAuthenticationMethodToInitialize">The <see cref="WindowsHelloForBusinessAuthenticationMethod"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(WindowsHelloForBusinessAuthenticationMethod windowsHelloForBusinessAuthenticationMethodToInitialize)
        {
