...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type B2xIdentityUserFlowReferenceRequest.
    /// </summary>
    public partial class B2xIdentityUserFlowReferenceRequest : BaseRequest, IB2xIdentityUserFlowReferenceRequest
    {
        /// <summary>
        /// Constructs a new B2xIdentityUserFlowReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public B2xIdentityUserFlowReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified B2xIdentityUserFlow reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified B2xIdentityUserFlow reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified B2xIdentityUserFlow reference.
        /// </summary>
        /// <param name="id">The B2xIdentityUserFlow reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified B2xIdentityUserFlow reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The B2xIdentityUserFlow reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
