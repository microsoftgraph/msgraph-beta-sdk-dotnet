...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsMdurationRequest : BaseRequest, IWorkbookFunctionsMdurationRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsMdurationRequest.
        /// </summary>
        public WorkbookFunctionsMdurationRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsMdurationRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsMdurationRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsMdurationRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsMdurationRequest Select(string value)
        {
