...
namespace Microsoft.Graph
{
    ...
    public partial interface IEducationSubmissionResourceRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<EducationSubmissionResource> CreateAsync(EducationSubmissionResource educationSubmissionResourceToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<EducationSubmissionResource>> CreateResponseAsync(EducationSubmissionResource educationSubmissionResourceToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<EducationSubmissionResource> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EducationSubmissionResource}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EducationSubmissionResource>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<EducationSubmissionResource> UpdateAsync(EducationSubmissionResource educationSubmissionResourceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{EducationSubmissionResource}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EducationSubmissionResource>> UpdateResponseAsync(EducationSubmissionResource educationSubmissionResourceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<EducationSubmissionResource> PutAsync(EducationSubmissionResource educationSubmissionResourceToUpdate, CancellationToken cancellationToken = default(CancellationToken));

        /// <summary>
        /// Updates the specified EducationSubmissionResource using PUT and returns a <see cref="GraphResponse{EducationSubmissionResource}"/> object.
        /// </summary>
        /// <param name="educationSubmissionResourceToUpdate">The EducationSubmissionResource object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{EducationSubmissionResource}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<EducationSubmissionResource>> PutResponseAsync(EducationSubmissionResource educationSubmissionResourceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
