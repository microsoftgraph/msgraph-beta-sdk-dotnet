...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface INoteAttachmentsCollectionRequestBuilder.
    /// </summary>
    public partial interface INoteAttachmentsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        INoteAttachmentsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        INoteAttachmentsCollectionRequest Request(IEnumerable<Option> options);
