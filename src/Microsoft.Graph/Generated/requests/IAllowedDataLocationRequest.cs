...
namespace Microsoft.Graph
{
    ...
    public partial interface IAllowedDataLocationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AllowedDataLocation> CreateAsync(AllowedDataLocation allowedDataLocationToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<AllowedDataLocation>> CreateResponseAsync(AllowedDataLocation allowedDataLocationToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AllowedDataLocation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AllowedDataLocation>> CreateResponseAsync(AllowedDataLocation allowedDataLocationToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="allowedDataLocationToUpdate">The AllowedDataLocation to update.</param>
        /// <returns>The <see cref="GraphResponse{AllowedDataLocation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AllowedDataLocation>> UpdateResponseAsync(AllowedDataLocation allowedDataLocationToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AllowedDataLocation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AllowedDataLocation>> UpdateResponseAsync(AllowedDataLocation allowedDataLocationToUpdate, CancellationToken cancellationToken);
