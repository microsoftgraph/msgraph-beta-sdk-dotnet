...
namespace Microsoft.Graph
{
    ...
    public partial interface IAllowedDataLocationRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<AllowedDataLocation> PutAsync(AllowedDataLocation allowedDataLocationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<AllowedDataLocation>> PutResponseAsync(AllowedDataLocation allowedDataLocationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
