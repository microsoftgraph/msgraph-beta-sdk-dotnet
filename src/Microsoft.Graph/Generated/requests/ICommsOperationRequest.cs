...
namespace Microsoft.Graph
{
    ...
    public partial interface ICommsOperationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<CommsOperation> CreateAsync(CommsOperation commsOperationToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<CommsOperation>> CreateResponseAsync(CommsOperation commsOperationToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<CommsOperation> UpdateAsync(CommsOperation commsOperationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CommsOperation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<CommsOperation>> UpdateResponseAsync(CommsOperation commsOperationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<CommsOperation> PutAsync(CommsOperation commsOperationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<CommsOperation>> PutResponseAsync(CommsOperation commsOperationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
