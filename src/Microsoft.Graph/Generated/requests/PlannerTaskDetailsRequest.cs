...
namespace Microsoft.Graph
{
    ...
    public partial class PlannerTaskDetailsRequest : BaseRequest, IPlannerTaskDetailsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PlannerTaskDetails>> CreateResponseAsync(PlannerTaskDetails plannerTaskDetailsToCreate)
        {
            return this.CreateResponseAsync(plannerTaskDetailsToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PlannerTaskDetails}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PlannerTaskDetails>> CreateResponseAsync(PlannerTaskDetails plannerTaskDetailsToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="plannerTaskDetailsToUpdate">The PlannerTaskDetails to update.</param>
        /// <returns>The <see cref="GraphResponse{PlannerTaskDetails}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PlannerTaskDetails>> UpdateResponseAsync(PlannerTaskDetails plannerTaskDetailsToUpdate)
        {
            return this.UpdateResponseAsync(plannerTaskDetailsToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PlannerTaskDetails}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PlannerTaskDetails>> UpdateResponseAsync(PlannerTaskDetails plannerTaskDetailsToUpdate, CancellationToken cancellationToken)
        {
			if (plannerTaskDetailsToUpdate.AdditionalData != null)
			{
				if (plannerTaskDetailsToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
