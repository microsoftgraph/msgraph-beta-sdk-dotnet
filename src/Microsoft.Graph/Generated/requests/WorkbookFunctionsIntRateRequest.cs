...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsIntRateRequest : BaseRequest, IWorkbookFunctionsIntRateRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsIntRateRequest.
        /// </summary>
        public WorkbookFunctionsIntRateRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsIntRateRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsIntRateRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsIntRateRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsIntRateRequest Select(string value)
        {
