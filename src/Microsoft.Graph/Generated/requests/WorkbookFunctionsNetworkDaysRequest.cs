...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsNetworkDaysRequest : BaseRequest, IWorkbookFunctionsNetworkDaysRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsNetworkDaysRequest.
        /// </summary>
        public WorkbookFunctionsNetworkDaysRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsNetworkDaysRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsNetworkDaysRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsNetworkDaysRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsNetworkDaysRequest Select(string value)
        {
