...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetCompliancePolicyDeviceSummaryReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetCompliancePolicyDeviceSummaryReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetCompliancePolicyDeviceSummaryReportRequest>, IDeviceManagementReportsGetCompliancePolicyDeviceSummaryReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetCompliancePolicyDeviceSummaryReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetCompliancePolicyDeviceSummaryReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetCompliancePolicyDeviceSummaryReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetCompliancePolicyDeviceSummaryReportRequest(functionUrl, this.Client, options);
