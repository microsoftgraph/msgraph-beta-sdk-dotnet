...
namespace Microsoft.Graph
{
    ...
    public partial class IosVpnConfigurationRequest : BaseRequest, IIosVpnConfigurationRequest
    {
        ...
        public async System.Threading.Tasks.Task<IosVpnConfiguration> CreateAsync(IosVpnConfiguration iosVpnConfigurationToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<IosVpnConfiguration>> CreateResponseAsync(IosVpnConfiguration iosVpnConfigurationToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<IosVpnConfiguration>(iosVpnConfigurationToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<IosVpnConfiguration> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosVpnConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosVpnConfiguration>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<IosVpnConfiguration>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<IosVpnConfiguration> UpdateAsync(IosVpnConfiguration iosVpnConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosVpnConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosVpnConfiguration>> UpdateResponseAsync(IosVpnConfiguration iosVpnConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<IosVpnConfiguration>(iosVpnConfigurationToUpdate, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<IosVpnConfiguration> PutAsync(IosVpnConfiguration iosVpnConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="iosVpnConfigurationToUpdate">The IosVpnConfiguration object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{IosVpnConfiguration}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosVpnConfiguration>> PutResponseAsync(IosVpnConfiguration iosVpnConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<IosVpnConfiguration>(iosVpnConfigurationToUpdate, cancellationToken);
