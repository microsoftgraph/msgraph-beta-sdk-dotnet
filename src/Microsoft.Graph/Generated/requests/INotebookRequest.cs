...
namespace Microsoft.Graph
{
    ...
    public partial interface INotebookRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<Notebook> PutAsync(Notebook notebookToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<Notebook>> PutResponseAsync(Notebook notebookToUpdate, CancellationToken cancellationToken = default(CancellationToken));
