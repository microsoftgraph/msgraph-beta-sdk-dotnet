...
namespace Microsoft.Graph
{
    ...
    public partial class EventInstancesCollectionRequest : BaseRequest, IEventInstancesCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Event>> AddResponseAsync(Event instancesEvent, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = CoreConstants.HttpMethods.POST.ToString();
            return this.SendAsyncWithGraphResponse<Event>(instancesEvent, cancellationToken);
        }
        ...
        public System.Threading.Tasks.Task<GraphResponse<EventInstancesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = CoreConstants.HttpMethods.GET.ToString();
            return this.SendAsyncWithGraphResponse<EventInstancesCollectionResponse>(null, cancellationToken);
        }
