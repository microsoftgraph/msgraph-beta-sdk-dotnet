...
namespace Microsoft.Graph
{
    ...
    public partial interface ICloudPcProvisioningPolicyAssignmentRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<CloudPcProvisioningPolicyAssignment> CreateAsync(CloudPcProvisioningPolicyAssignment cloudPcProvisioningPolicyAssignmentToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<CloudPcProvisioningPolicyAssignment>> CreateResponseAsync(CloudPcProvisioningPolicyAssignment cloudPcProvisioningPolicyAssignmentToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<CloudPcProvisioningPolicyAssignment> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{CloudPcProvisioningPolicyAssignment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<CloudPcProvisioningPolicyAssignment>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<CloudPcProvisioningPolicyAssignment> UpdateAsync(CloudPcProvisioningPolicyAssignment cloudPcProvisioningPolicyAssignmentToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CloudPcProvisioningPolicyAssignment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<CloudPcProvisioningPolicyAssignment>> UpdateResponseAsync(CloudPcProvisioningPolicyAssignment cloudPcProvisioningPolicyAssignmentToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<CloudPcProvisioningPolicyAssignment> PutAsync(CloudPcProvisioningPolicyAssignment cloudPcProvisioningPolicyAssignmentToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cloudPcProvisioningPolicyAssignmentToUpdate">The CloudPcProvisioningPolicyAssignment object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{CloudPcProvisioningPolicyAssignment}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<CloudPcProvisioningPolicyAssignment>> PutResponseAsync(CloudPcProvisioningPolicyAssignment cloudPcProvisioningPolicyAssignmentToUpdate, CancellationToken cancellationToken = default);
