...
namespace Microsoft.Graph
{
    ...
    public partial class GroupPolicyPresentationLongDecimalTextBoxRequest : BaseRequest, IGroupPolicyPresentationLongDecimalTextBoxRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationLongDecimalTextBox}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationLongDecimalTextBox>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationLongDecimalTextBox}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationLongDecimalTextBox>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<GroupPolicyPresentationLongDecimalTextBox>(null, cancellationToken).ConfigureAwait(false);
        }
