...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface ISalesOrderLineRequestBuilder.
    /// </summary>
    public partial interface ISalesOrderLineRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new ISalesOrderLineRequest Request();
        ...
        /// <returns>The built request.</returns>
        new ISalesOrderLineRequest Request(IEnumerable<Option> options);
