...
namespace Microsoft.Graph
{
    ...
    public partial class Windows81GeneralConfigurationRequest : BaseRequest, IWindows81GeneralConfigurationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows81GeneralConfiguration>> CreateResponseAsync(Windows81GeneralConfiguration windows81GeneralConfigurationToCreate)
        {
            return this.CreateResponseAsync(windows81GeneralConfigurationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows81GeneralConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Windows81GeneralConfiguration>> CreateResponseAsync(Windows81GeneralConfiguration windows81GeneralConfigurationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<Windows81GeneralConfiguration>(windows81GeneralConfigurationToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Windows81GeneralConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows81GeneralConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows81GeneralConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Windows81GeneralConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Windows81GeneralConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="windows81GeneralConfigurationToUpdate">The Windows81GeneralConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{Windows81GeneralConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows81GeneralConfiguration>> UpdateResponseAsync(Windows81GeneralConfiguration windows81GeneralConfigurationToUpdate)
        {
            return this.UpdateResponseAsync(windows81GeneralConfigurationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Windows81GeneralConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Windows81GeneralConfiguration>> UpdateResponseAsync(Windows81GeneralConfiguration windows81GeneralConfigurationToUpdate, CancellationToken cancellationToken)
        {
			if (windows81GeneralConfigurationToUpdate.AdditionalData != null)
			{
				if (windows81GeneralConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<Windows81GeneralConfiguration>(windows81GeneralConfigurationToUpdate, cancellationToken).ConfigureAwait(false);
        }
