...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ChatUnhideForUserRequest : BaseRequest, IChatUnhideForUserRequest
    {
        /// <summary>
        /// Constructs a new ChatUnhideForUserRequest.
        /// </summary>
        public ChatUnhideForUserRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new ChatUnhideForUserRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public ChatUnhideForUserRequestBody RequestBody { get; private set; }
        ...
        public IChatUnhideForUserRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IChatUnhideForUserRequest Select(string value)
        {
