...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetSkypeForBusinessPeerToPeerActivityCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessPeerToPeerActivityCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="skypeforbusinesspeertopeeractivitycounts">The SkypeForBusinessPeerToPeerActivityCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessPeerToPeerActivityCountsCollectionResponse>> PatchResponseAsync(SkypeForBusinessPeerToPeerActivityCounts skypeforbusinesspeertopeeractivitycounts, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="skypeforbusinesspeertopeeractivitycounts">The SkypeForBusinessPeerToPeerActivityCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessPeerToPeerActivityCountsCollectionResponse>> PutResponseAsync(SkypeForBusinessPeerToPeerActivityCounts skypeforbusinesspeertopeeractivitycounts, CancellationToken cancellationToken = default(CancellationToken));
