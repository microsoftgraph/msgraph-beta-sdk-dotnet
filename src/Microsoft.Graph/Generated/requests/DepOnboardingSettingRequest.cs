...
namespace Microsoft.Graph
{
    ...
    public partial class DepOnboardingSettingRequest : BaseRequest, IDepOnboardingSettingRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DepOnboardingSetting>> CreateResponseAsync(DepOnboardingSetting depOnboardingSettingToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DepOnboardingSetting}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DepOnboardingSetting>> UpdateResponseAsync(DepOnboardingSetting depOnboardingSettingToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
