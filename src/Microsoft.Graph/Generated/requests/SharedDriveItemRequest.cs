...
namespace Microsoft.Graph
{
    ...
    public partial class SharedDriveItemRequest : BaseRequest, ISharedDriveItemRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<SharedDriveItem> PutAsync(SharedDriveItem sharedDriveItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<SharedDriveItem>> PutResponseAsync(SharedDriveItem sharedDriveItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SharedDriveItem>(sharedDriveItemToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(SharedDriveItem sharedDriveItemToInitialize)
        {
            ...
            if (sharedDriveItemToInitialize != null && sharedDriveItemToInitialize.AdditionalData != null)
            {
                ...
                if (sharedDriveItemToInitialize.Items != null && sharedDriveItemToInitialize.Items.CurrentPage != null)
                {
                    ...
                    if(sharedDriveItemToInitialize.AdditionalData.TryGetValue("items@odata.nextLink", out var nextPageLink))
                    {
