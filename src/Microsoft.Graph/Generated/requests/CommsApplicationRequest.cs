...
namespace Microsoft.Graph
{
    ...
    public partial class CommsApplicationRequest : BaseRequest, ICommsApplicationRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{CommsApplication}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<CommsApplication>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{CommsApplication}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CommsApplication>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<CommsApplication>(null, cancellationToken).ConfigureAwait(false);
        }
