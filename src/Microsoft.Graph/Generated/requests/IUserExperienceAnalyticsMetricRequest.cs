...
namespace Microsoft.Graph
{
    ...
    public partial interface IUserExperienceAnalyticsMetricRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<UserExperienceAnalyticsMetric> PutAsync(UserExperienceAnalyticsMetric userExperienceAnalyticsMetricToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsMetric>> PutResponseAsync(UserExperienceAnalyticsMetric userExperienceAnalyticsMetricToUpdate, CancellationToken cancellationToken = default);
