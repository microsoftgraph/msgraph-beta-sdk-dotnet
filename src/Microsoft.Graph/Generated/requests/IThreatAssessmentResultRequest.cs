...
namespace Microsoft.Graph
{
    ...
    public partial interface IThreatAssessmentResultRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ThreatAssessmentResult> CreateAsync(ThreatAssessmentResult threatAssessmentResultToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<ThreatAssessmentResult>> CreateResponseAsync(ThreatAssessmentResult threatAssessmentResultToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ThreatAssessmentResult}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ThreatAssessmentResult>> CreateResponseAsync(ThreatAssessmentResult threatAssessmentResultToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ThreatAssessmentResult}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ThreatAssessmentResult>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ThreatAssessmentResult}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ThreatAssessmentResult>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="threatAssessmentResultToUpdate">The ThreatAssessmentResult to update.</param>
        /// <returns>The <see cref="GraphResponse{ThreatAssessmentResult}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ThreatAssessmentResult>> UpdateResponseAsync(ThreatAssessmentResult threatAssessmentResultToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ThreatAssessmentResult}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ThreatAssessmentResult>> UpdateResponseAsync(ThreatAssessmentResult threatAssessmentResultToUpdate, CancellationToken cancellationToken);
