...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceRequest : BaseRequest, IDeviceRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Device>> CreateResponseAsync(Device deviceToCreate)
        {
            return this.CreateResponseAsync(deviceToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Device}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Device>> CreateResponseAsync(Device deviceToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Device}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Device>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Device}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Device>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Device>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="deviceToUpdate">The Device to update.</param>
        /// <returns>The <see cref="GraphResponse{Device}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Device>> UpdateResponseAsync(Device deviceToUpdate)
        {
            return this.UpdateResponseAsync(deviceToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Device}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Device>> UpdateResponseAsync(Device deviceToUpdate, CancellationToken cancellationToken)
        {
			if (deviceToUpdate.AdditionalData != null)
			{
				if (deviceToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
