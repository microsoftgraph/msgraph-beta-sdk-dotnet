...
namespace Microsoft.Graph
{
    ...
    public partial interface IResourceSpecificPermissionGrantRequest : IBaseRequest
    {
        ...
        /// <param name="resourceSpecificPermissionGrantToUpdate">The ResourceSpecificPermissionGrant to update.</param>
        /// <returns>The <see cref="GraphResponse{ResourceSpecificPermissionGrant}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ResourceSpecificPermissionGrant>> UpdateResponseAsync(ResourceSpecificPermissionGrant resourceSpecificPermissionGrantToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ResourceSpecificPermissionGrant}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ResourceSpecificPermissionGrant>> UpdateResponseAsync(ResourceSpecificPermissionGrant resourceSpecificPermissionGrantToUpdate, CancellationToken cancellationToken);
