...
namespace Microsoft.Graph
{
    ...
    public partial class IosEnterpriseWiFiConfigurationRequest : BaseRequest, IIosEnterpriseWiFiConfigurationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<IosEnterpriseWiFiConfiguration>> CreateResponseAsync(IosEnterpriseWiFiConfiguration iosEnterpriseWiFiConfigurationToCreate)
        {
            return this.CreateResponseAsync(iosEnterpriseWiFiConfigurationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosEnterpriseWiFiConfiguration>> CreateResponseAsync(IosEnterpriseWiFiConfiguration iosEnterpriseWiFiConfigurationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<IosEnterpriseWiFiConfiguration>(iosEnterpriseWiFiConfigurationToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{IosEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosEnterpriseWiFiConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosEnterpriseWiFiConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<IosEnterpriseWiFiConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
			if (iosEnterpriseWiFiConfigurationToUpdate.AdditionalData != null)
			{
				if (iosEnterpriseWiFiConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					iosEnterpriseWiFiConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, iosEnterpriseWiFiConfigurationToUpdate.GetType().Name)
						});
				}
			}
            if (iosEnterpriseWiFiConfigurationToUpdate.AdditionalData != null)
        ...
        /// <param name="iosEnterpriseWiFiConfigurationToUpdate">The IosEnterpriseWiFiConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{IosEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosEnterpriseWiFiConfiguration>> UpdateResponseAsync(IosEnterpriseWiFiConfiguration iosEnterpriseWiFiConfigurationToUpdate)
        {
            return this.UpdateResponseAsync(iosEnterpriseWiFiConfigurationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosEnterpriseWiFiConfiguration>> UpdateResponseAsync(IosEnterpriseWiFiConfiguration iosEnterpriseWiFiConfigurationToUpdate, CancellationToken cancellationToken)
        {
			if (iosEnterpriseWiFiConfigurationToUpdate.AdditionalData != null)
			{
				if (iosEnterpriseWiFiConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<IosEnterpriseWiFiConfiguration>(iosEnterpriseWiFiConfigurationToUpdate, cancellationToken).ConfigureAwait(false);
        }
