...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetOffice365GroupsActivityFileCountsRequest : BaseRequest, IReportRootGetOffice365GroupsActivityFileCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityFileCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365GroupsActivityFileCountsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="office365groupsactivityfilecounts">The Office365GroupsActivityFileCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityFileCountsCollectionResponse>> PatchResponseAsync(Office365GroupsActivityFileCounts office365groupsactivityfilecounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365GroupsActivityFileCountsCollectionResponse>(office365groupsactivityfilecounts, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="office365groupsactivityfilecounts">The Office365GroupsActivityFileCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityFileCountsCollectionResponse>> PutResponseAsync(Office365GroupsActivityFileCounts office365groupsactivityfilecounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365GroupsActivityFileCountsCollectionResponse>(office365groupsactivityfilecounts, cancellationToken).ConfigureAwait(false);
        }
