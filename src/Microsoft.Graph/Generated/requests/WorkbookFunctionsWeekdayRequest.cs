...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsWeekdayRequest : BaseRequest, IWorkbookFunctionsWeekdayRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsWeekdayRequest.
        /// </summary>
        public WorkbookFunctionsWeekdayRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsWeekdayRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsWeekdayRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsWeekdayRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsWeekdayRequest Select(string value)
        {
