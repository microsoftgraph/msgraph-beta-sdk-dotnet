...
namespace Microsoft.Graph
{
    ...
    public partial class MessageAttachmentsCollectionRequest : BaseRequest, IMessageAttachmentsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MessageAttachmentsCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MessageAttachmentsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MessageAttachmentsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
