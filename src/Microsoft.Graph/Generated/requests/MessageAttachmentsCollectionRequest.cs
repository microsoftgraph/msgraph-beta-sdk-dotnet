...
namespace Microsoft.Graph
{
    ...
    public partial class MessageAttachmentsCollectionRequest : BaseRequest, IMessageAttachmentsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<IMessageAttachmentsCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
        ...
        public async System.Threading.Tasks.Task<GraphResponse<MessageAttachmentsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<MessageAttachmentsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
