...
namespace Microsoft.Graph
{
    ...
    public partial class MessageAttachmentsCollectionRequest : BaseRequest, IMessageAttachmentsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MessageAttachmentsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<MessageAttachmentsCollectionResponse>(null, cancellationToken);
        }
