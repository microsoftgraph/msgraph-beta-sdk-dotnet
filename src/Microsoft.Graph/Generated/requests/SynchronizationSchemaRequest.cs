...
namespace Microsoft.Graph
{
    ...
    public partial class SynchronizationSchemaRequest : BaseRequest, ISynchronizationSchemaRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SynchronizationSchema>> CreateResponseAsync(SynchronizationSchema synchronizationSchemaToCreate)
        {
            return this.CreateResponseAsync(synchronizationSchemaToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SynchronizationSchema}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SynchronizationSchema>> CreateResponseAsync(SynchronizationSchema synchronizationSchemaToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<SynchronizationSchema>(synchronizationSchemaToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{SynchronizationSchema}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SynchronizationSchema>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SynchronizationSchema}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SynchronizationSchema>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<SynchronizationSchema>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
			if (synchronizationSchemaToUpdate.AdditionalData != null)
			{
				if (synchronizationSchemaToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					synchronizationSchemaToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, synchronizationSchemaToUpdate.GetType().Name)
						});
				}
			}
            if (synchronizationSchemaToUpdate.AdditionalData != null)
        ...
        /// <param name="synchronizationSchemaToUpdate">The SynchronizationSchema to update.</param>
        /// <returns>The <see cref="GraphResponse{SynchronizationSchema}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SynchronizationSchema>> UpdateResponseAsync(SynchronizationSchema synchronizationSchemaToUpdate)
        {
            return this.UpdateResponseAsync(synchronizationSchemaToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SynchronizationSchema}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SynchronizationSchema>> UpdateResponseAsync(SynchronizationSchema synchronizationSchemaToUpdate, CancellationToken cancellationToken)
        {
			if (synchronizationSchemaToUpdate.AdditionalData != null)
			{
				if (synchronizationSchemaToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<SynchronizationSchema>(synchronizationSchemaToUpdate, cancellationToken).ConfigureAwait(false);
        }
