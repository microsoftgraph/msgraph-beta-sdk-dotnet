...
namespace Microsoft.Graph
{
    ...
    public partial class SynchronizationSchemaRequest : BaseRequest, ISynchronizationSchemaRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<SynchronizationSchema>> CreateResponseAsync(SynchronizationSchema synchronizationSchemaToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SynchronizationSchema}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SynchronizationSchema>> UpdateResponseAsync(SynchronizationSchema synchronizationSchemaToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
