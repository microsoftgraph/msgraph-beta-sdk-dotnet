...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookTableColumnItemAtRequest : BaseRequest, IWorkbookTableColumnItemAtRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookTableColumn>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WorkbookTableColumn>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="workbooktablecolumn">The WorkbookTableColumn object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookTableColumn>> PatchResponseAsync(WorkbookTableColumn workbooktablecolumn, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
        ...
        /// <param name="workbooktablecolumn">The WorkbookTableColumn object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookTableColumn>> PutResponseAsync(WorkbookTableColumn workbooktablecolumn, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<WorkbookTableColumn>(workbooktablecolumn, cancellationToken).ConfigureAwait(false);
        }
