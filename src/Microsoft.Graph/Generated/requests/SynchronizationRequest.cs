...
namespace Microsoft.Graph
{
    ...
    public partial class SynchronizationRequest : BaseRequest, ISynchronizationRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<Synchronization>> CreateResponseAsync(Synchronization synchronizationToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Synchronization}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Synchronization>> UpdateResponseAsync(Synchronization synchronizationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
