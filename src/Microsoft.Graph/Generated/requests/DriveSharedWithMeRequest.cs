...
namespace Microsoft.Graph
{
    ...
    public partial class DriveSharedWithMeRequest : BaseRequest, IDriveSharedWithMeRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DriveSharedWithMeCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DriveSharedWithMeCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
