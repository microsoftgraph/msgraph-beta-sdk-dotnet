...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetOffice365GroupsActivityStorageRequest : BaseRequest, IReportRootGetOffice365GroupsActivityStorageRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityStorageCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="office365groupsactivitystorage">The Office365GroupsActivityStorage object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityStorageCollectionResponse>> PatchResponseAsync(Office365GroupsActivityStorage office365groupsactivitystorage, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="office365groupsactivitystorage">The Office365GroupsActivityStorage object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityStorageCollectionResponse>> PutResponseAsync(Office365GroupsActivityStorage office365groupsactivitystorage, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetOffice365GroupsActivityStorageCollectionResponse>(office365groupsactivitystorage, cancellationToken);
        }
