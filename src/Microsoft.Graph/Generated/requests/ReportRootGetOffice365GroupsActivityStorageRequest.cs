...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetOffice365GroupsActivityStorageRequest : BaseRequest, IReportRootGetOffice365GroupsActivityStorageRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityStorageCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365GroupsActivityStorageCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="office365groupsactivitystorage">The Office365GroupsActivityStorage object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityStorageCollectionResponse>> PatchResponseAsync(Office365GroupsActivityStorage office365groupsactivitystorage, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365GroupsActivityStorageCollectionResponse>(office365groupsactivitystorage, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="office365groupsactivitystorage">The Office365GroupsActivityStorage object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityStorageCollectionResponse>> PutResponseAsync(Office365GroupsActivityStorage office365groupsactivitystorage, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOffice365GroupsActivityStorageCollectionResponse>(office365groupsactivitystorage, cancellationToken).ConfigureAwait(false);
        }
