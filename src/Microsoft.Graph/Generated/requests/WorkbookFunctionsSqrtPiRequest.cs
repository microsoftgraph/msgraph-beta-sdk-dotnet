...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsSqrtPiRequest : BaseRequest, IWorkbookFunctionsSqrtPiRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsSqrtPiRequest.
        /// </summary>
        public WorkbookFunctionsSqrtPiRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsSqrtPiRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsSqrtPiRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsSqrtPiRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsSqrtPiRequest Select(string value)
        {
