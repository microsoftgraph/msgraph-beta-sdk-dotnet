...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetUnhealthyFirewallSummaryReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetUnhealthyFirewallSummaryReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetUnhealthyFirewallSummaryReportRequest>, IDeviceManagementReportsGetUnhealthyFirewallSummaryReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetUnhealthyFirewallSummaryReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetUnhealthyFirewallSummaryReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetUnhealthyFirewallSummaryReportRequest(functionUrl, this.Client, options);
