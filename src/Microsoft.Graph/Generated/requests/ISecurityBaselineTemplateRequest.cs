...
namespace Microsoft.Graph
{
    ...
    public partial interface ISecurityBaselineTemplateRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<SecurityBaselineTemplate> PutAsync(SecurityBaselineTemplate securityBaselineTemplateToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<SecurityBaselineTemplate>> PutResponseAsync(SecurityBaselineTemplate securityBaselineTemplateToUpdate, CancellationToken cancellationToken = default(CancellationToken));
