...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceManagementDomainJoinConnectorRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DeviceManagementDomainJoinConnector> CreateAsync(DeviceManagementDomainJoinConnector deviceManagementDomainJoinConnectorToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementDomainJoinConnector>> CreateResponseAsync(DeviceManagementDomainJoinConnector deviceManagementDomainJoinConnectorToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<DeviceManagementDomainJoinConnector> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementDomainJoinConnector}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementDomainJoinConnector>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<DeviceManagementDomainJoinConnector> UpdateAsync(DeviceManagementDomainJoinConnector deviceManagementDomainJoinConnectorToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementDomainJoinConnector}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementDomainJoinConnector>> UpdateResponseAsync(DeviceManagementDomainJoinConnector deviceManagementDomainJoinConnectorToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<DeviceManagementDomainJoinConnector> PutAsync(DeviceManagementDomainJoinConnector deviceManagementDomainJoinConnectorToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementDomainJoinConnector>> PutResponseAsync(DeviceManagementDomainJoinConnector deviceManagementDomainJoinConnectorToUpdate, CancellationToken cancellationToken = default);
