...
namespace Microsoft.Graph
{
    ...
    public partial class ContinuousAccessEvaluationPolicyRequest : BaseRequest, IContinuousAccessEvaluationPolicyRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ContinuousAccessEvaluationPolicy>> CreateResponseAsync(ContinuousAccessEvaluationPolicy continuousAccessEvaluationPolicyToCreate)
        {
            return this.CreateResponseAsync(continuousAccessEvaluationPolicyToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ContinuousAccessEvaluationPolicy}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ContinuousAccessEvaluationPolicy>> CreateResponseAsync(ContinuousAccessEvaluationPolicy continuousAccessEvaluationPolicyToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<ContinuousAccessEvaluationPolicy>(continuousAccessEvaluationPolicyToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ContinuousAccessEvaluationPolicy}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ContinuousAccessEvaluationPolicy>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ContinuousAccessEvaluationPolicy}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ContinuousAccessEvaluationPolicy>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ContinuousAccessEvaluationPolicy>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="continuousAccessEvaluationPolicyToUpdate">The ContinuousAccessEvaluationPolicy to update.</param>
        /// <returns>The <see cref="GraphResponse{ContinuousAccessEvaluationPolicy}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ContinuousAccessEvaluationPolicy>> UpdateResponseAsync(ContinuousAccessEvaluationPolicy continuousAccessEvaluationPolicyToUpdate)
        {
            return this.UpdateResponseAsync(continuousAccessEvaluationPolicyToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ContinuousAccessEvaluationPolicy}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ContinuousAccessEvaluationPolicy>> UpdateResponseAsync(ContinuousAccessEvaluationPolicy continuousAccessEvaluationPolicyToUpdate, CancellationToken cancellationToken)
        {
			if (continuousAccessEvaluationPolicyToUpdate.AdditionalData != null)
			{
				if (continuousAccessEvaluationPolicyToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ContinuousAccessEvaluationPolicy>(continuousAccessEvaluationPolicyToUpdate, cancellationToken).ConfigureAwait(false);
        }
