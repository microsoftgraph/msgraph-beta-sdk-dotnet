...
namespace Microsoft.Graph
{
    ...
    public partial class ContinuousAccessEvaluationPolicyRequest : BaseRequest, IContinuousAccessEvaluationPolicyRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ContinuousAccessEvaluationPolicy>> CreateResponseAsync(ContinuousAccessEvaluationPolicy continuousAccessEvaluationPolicyToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ContinuousAccessEvaluationPolicy}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ContinuousAccessEvaluationPolicy>> UpdateResponseAsync(ContinuousAccessEvaluationPolicy continuousAccessEvaluationPolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
