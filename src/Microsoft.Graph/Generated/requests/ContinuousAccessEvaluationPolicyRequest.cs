...
namespace Microsoft.Graph
{
    ...
    public partial class ContinuousAccessEvaluationPolicyRequest : BaseRequest, IContinuousAccessEvaluationPolicyRequest
    {
        ...
        public async System.Threading.Tasks.Task<ContinuousAccessEvaluationPolicy> CreateAsync(ContinuousAccessEvaluationPolicy continuousAccessEvaluationPolicyToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ContinuousAccessEvaluationPolicy>> CreateResponseAsync(ContinuousAccessEvaluationPolicy continuousAccessEvaluationPolicyToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<ContinuousAccessEvaluationPolicy> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ContinuousAccessEvaluationPolicy}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ContinuousAccessEvaluationPolicy>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<ContinuousAccessEvaluationPolicy> UpdateAsync(ContinuousAccessEvaluationPolicy continuousAccessEvaluationPolicyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ContinuousAccessEvaluationPolicy}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ContinuousAccessEvaluationPolicy>> UpdateResponseAsync(ContinuousAccessEvaluationPolicy continuousAccessEvaluationPolicyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<ContinuousAccessEvaluationPolicy> PutAsync(ContinuousAccessEvaluationPolicy continuousAccessEvaluationPolicyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<ContinuousAccessEvaluationPolicy>> PutResponseAsync(ContinuousAccessEvaluationPolicy continuousAccessEvaluationPolicyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ContinuousAccessEvaluationPolicy>(continuousAccessEvaluationPolicyToUpdate, cancellationToken);
