...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IPrivilegedAccessGroupAssignmentScheduleRequestBuilder.
    /// </summary>
    public partial interface IPrivilegedAccessGroupAssignmentScheduleRequestBuilder : IPrivilegedAccessScheduleRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IPrivilegedAccessGroupAssignmentScheduleRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IPrivilegedAccessGroupAssignmentScheduleRequest Request(IEnumerable<Option> options);
