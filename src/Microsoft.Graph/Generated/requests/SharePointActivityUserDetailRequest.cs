...
namespace Microsoft.Graph
{
    ...
    public partial class SharePointActivityUserDetailRequest : BaseRequest, ISharePointActivityUserDetailRequest
    {
        ...
        public async System.Threading.Tasks.Task<SharePointActivityUserDetail> CreateAsync(SharePointActivityUserDetail sharePointActivityUserDetailToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SharePointActivityUserDetail>> CreateResponseAsync(SharePointActivityUserDetail sharePointActivityUserDetailToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<SharePointActivityUserDetail> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SharePointActivityUserDetail}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SharePointActivityUserDetail>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<SharePointActivityUserDetail> UpdateAsync(SharePointActivityUserDetail sharePointActivityUserDetailToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SharePointActivityUserDetail}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SharePointActivityUserDetail>> UpdateResponseAsync(SharePointActivityUserDetail sharePointActivityUserDetailToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<SharePointActivityUserDetail> PutAsync(SharePointActivityUserDetail sharePointActivityUserDetailToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<SharePointActivityUserDetail>> PutResponseAsync(SharePointActivityUserDetail sharePointActivityUserDetailToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SharePointActivityUserDetail>(sharePointActivityUserDetailToUpdate, cancellationToken);
