...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetEmailAppUsageUserCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetEmailAppUsageUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="emailappusageusercounts">The EmailAppUsageUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetEmailAppUsageUserCountsCollectionResponse>> PatchResponseAsync(EmailAppUsageUserCounts emailappusageusercounts, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="emailappusageusercounts">The EmailAppUsageUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetEmailAppUsageUserCountsCollectionResponse>> PutResponseAsync(EmailAppUsageUserCounts emailappusageusercounts, CancellationToken cancellationToken = default(CancellationToken));
