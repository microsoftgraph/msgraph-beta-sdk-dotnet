...
namespace Microsoft.Graph
{
    ...
    public partial interface ILearningProviderLearningContentsCollectionRequestBuilder : IBaseRequestBuilder
    {
        ...
        /// <returns>The built request.</returns>
        ILearningProviderLearningContentsCollectionRequest Request(IEnumerable<Option> options);

        /// <summary>
        /// Gets an <see cref="ILearningContentRequestBuilder"/> for the specified LearningContent.
        /// </summary>
        /// <param name="id">The ID for the LearningContent.</param>
