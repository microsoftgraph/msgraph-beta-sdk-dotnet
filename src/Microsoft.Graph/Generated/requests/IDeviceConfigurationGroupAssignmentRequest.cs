...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceConfigurationGroupAssignmentRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DeviceConfigurationGroupAssignment> CreateAsync(DeviceConfigurationGroupAssignment deviceConfigurationGroupAssignmentToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationGroupAssignment>> CreateResponseAsync(DeviceConfigurationGroupAssignment deviceConfigurationGroupAssignmentToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<DeviceConfigurationGroupAssignment> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceConfigurationGroupAssignment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationGroupAssignment>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<DeviceConfigurationGroupAssignment> UpdateAsync(DeviceConfigurationGroupAssignment deviceConfigurationGroupAssignmentToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceConfigurationGroupAssignment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationGroupAssignment>> UpdateResponseAsync(DeviceConfigurationGroupAssignment deviceConfigurationGroupAssignmentToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<DeviceConfigurationGroupAssignment> PutAsync(DeviceConfigurationGroupAssignment deviceConfigurationGroupAssignmentToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="deviceConfigurationGroupAssignmentToUpdate">The DeviceConfigurationGroupAssignment object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{DeviceConfigurationGroupAssignment}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationGroupAssignment>> PutResponseAsync(DeviceConfigurationGroupAssignment deviceConfigurationGroupAssignmentToUpdate, CancellationToken cancellationToken = default);
