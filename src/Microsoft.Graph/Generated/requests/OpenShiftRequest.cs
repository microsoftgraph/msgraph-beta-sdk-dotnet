...
namespace Microsoft.Graph
{
    ...
    public partial class OpenShiftRequest : BaseRequest, IOpenShiftRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<OpenShift> PutAsync(OpenShift openShiftToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<OpenShift>> PutResponseAsync(OpenShift openShiftToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<OpenShift>(openShiftToUpdate, cancellationToken);
