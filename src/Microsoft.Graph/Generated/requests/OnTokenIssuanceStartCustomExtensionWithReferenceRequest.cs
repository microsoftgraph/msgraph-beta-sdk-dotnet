...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type OnTokenIssuanceStartCustomExtensionWithReferenceRequest.
    /// </summary>
    public partial class OnTokenIssuanceStartCustomExtensionWithReferenceRequest : BaseRequest, IOnTokenIssuanceStartCustomExtensionWithReferenceRequest
    {
        /// <summary>
        /// Constructs a new OnTokenIssuanceStartCustomExtensionWithReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public OnTokenIssuanceStartCustomExtensionWithReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public IOnTokenIssuanceStartCustomExtensionWithReferenceRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IOnTokenIssuanceStartCustomExtensionWithReferenceRequest Expand(Expression<Func<OnTokenIssuanceStartCustomExtension, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IOnTokenIssuanceStartCustomExtensionWithReferenceRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IOnTokenIssuanceStartCustomExtensionWithReferenceRequest Select(Expression<Func<OnTokenIssuanceStartCustomExtension, object>> selectExpression)
        {
