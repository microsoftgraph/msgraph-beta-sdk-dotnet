...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsGeoMeanRequest : BaseRequest, IWorkbookFunctionsGeoMeanRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsGeoMeanRequest.
        /// </summary>
        public WorkbookFunctionsGeoMeanRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsGeoMeanRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsGeoMeanRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsGeoMeanRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsGeoMeanRequest Select(string value)
        {
