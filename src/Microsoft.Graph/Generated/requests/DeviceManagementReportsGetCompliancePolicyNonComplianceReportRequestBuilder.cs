...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DeviceManagementReportsGetCompliancePolicyNonComplianceReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetCompliancePolicyNonComplianceReportRequest>, IDeviceManagementReportsGetCompliancePolicyNonComplianceReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetCompliancePolicyNonComplianceReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetCompliancePolicyNonComplianceReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetCompliancePolicyNonComplianceReportRequest(functionUrl, this.Client, options);
