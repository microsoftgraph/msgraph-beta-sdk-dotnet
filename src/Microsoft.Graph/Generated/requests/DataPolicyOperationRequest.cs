...
namespace Microsoft.Graph
{
    ...
    public partial class DataPolicyOperationRequest : BaseRequest, IDataPolicyOperationRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<DataPolicyOperation> PutAsync(DataPolicyOperation dataPolicyOperationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<DataPolicyOperation>> PutResponseAsync(DataPolicyOperation dataPolicyOperationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<DataPolicyOperation>(dataPolicyOperationToUpdate, cancellationToken);
