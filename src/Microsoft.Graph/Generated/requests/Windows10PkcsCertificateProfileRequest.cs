...
namespace Microsoft.Graph
{
    ...
    public partial class Windows10PkcsCertificateProfileRequest : BaseRequest, IWindows10PkcsCertificateProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<Windows10PkcsCertificateProfile> CreateAsync(Windows10PkcsCertificateProfile windows10PkcsCertificateProfileToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows10PkcsCertificateProfile>> CreateResponseAsync(Windows10PkcsCertificateProfile windows10PkcsCertificateProfileToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<Windows10PkcsCertificateProfile>(windows10PkcsCertificateProfileToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<Windows10PkcsCertificateProfile> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows10PkcsCertificateProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows10PkcsCertificateProfile>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<Windows10PkcsCertificateProfile>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<Windows10PkcsCertificateProfile> UpdateAsync(Windows10PkcsCertificateProfile windows10PkcsCertificateProfileToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Windows10PkcsCertificateProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows10PkcsCertificateProfile>> UpdateResponseAsync(Windows10PkcsCertificateProfile windows10PkcsCertificateProfileToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<Windows10PkcsCertificateProfile>(windows10PkcsCertificateProfileToUpdate, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<Windows10PkcsCertificateProfile> PutAsync(Windows10PkcsCertificateProfile windows10PkcsCertificateProfileToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="windows10PkcsCertificateProfileToUpdate">The Windows10PkcsCertificateProfile object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{Windows10PkcsCertificateProfile}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows10PkcsCertificateProfile>> PutResponseAsync(Windows10PkcsCertificateProfile windows10PkcsCertificateProfileToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<Windows10PkcsCertificateProfile>(windows10PkcsCertificateProfileToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(Windows10PkcsCertificateProfile windows10PkcsCertificateProfileToInitialize)
        {
            ...
            if (windows10PkcsCertificateProfileToInitialize != null)
            {
                ...
                {
                    windows10PkcsCertificateProfileToInitialize.ManagedDeviceCertificateStates.InitializeNextPageRequest(this.Client, windows10PkcsCertificateProfileToInitialize.ManagedDeviceCertificateStatesNextLink);
