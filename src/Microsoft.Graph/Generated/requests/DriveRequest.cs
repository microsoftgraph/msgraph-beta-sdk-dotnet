...
namespace Microsoft.Graph
{
    ...
    public partial class DriveRequest : BaseRequest, IDriveRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Drive>> CreateResponseAsync(Drive driveToCreate)
        {
            return this.CreateResponseAsync(driveToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Drive}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Drive>> CreateResponseAsync(Drive driveToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
