...
namespace Microsoft.Graph
{
    ...
    public partial class CountryNamedLocationRequest : BaseRequest, ICountryNamedLocationRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<CountryNamedLocation>> CreateResponseAsync(CountryNamedLocation countryNamedLocationToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CountryNamedLocation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CountryNamedLocation>> UpdateResponseAsync(CountryNamedLocation countryNamedLocationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
