...
namespace Microsoft.Graph
{
    ...
    public partial class CountryNamedLocationRequest : BaseRequest, ICountryNamedLocationRequest
    {
        ...
        public System.Threading.Tasks.Task<CountryNamedLocation> CreateAsync(CountryNamedLocation countryNamedLocationToCreate)
        {
            return this.CreateAsync(countryNamedLocationToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created CountryNamedLocation.</returns>
        public async System.Threading.Tasks.Task<CountryNamedLocation> CreateAsync(CountryNamedLocation countryNamedLocationToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<CountryNamedLocation> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The CountryNamedLocation.</returns>
        public async System.Threading.Tasks.Task<CountryNamedLocation> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{CountryNamedLocation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<CountryNamedLocation>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{CountryNamedLocation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CountryNamedLocation>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<CountryNamedLocation>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<CountryNamedLocation> UpdateAsync(CountryNamedLocation countryNamedLocationToUpdate)
        {
            return this.UpdateAsync(countryNamedLocationToUpdate, CancellationToken.None);
        }
        ...
        /// <returns>The updated CountryNamedLocation.</returns>
        public async System.Threading.Tasks.Task<CountryNamedLocation> UpdateAsync(CountryNamedLocation countryNamedLocationToUpdate, CancellationToken cancellationToken)
        {
			if (countryNamedLocationToUpdate.AdditionalData != null)
			{
				if (countryNamedLocationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					countryNamedLocationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, countryNamedLocationToUpdate.GetType().Name)
						});
				}
			}
            if (countryNamedLocationToUpdate.AdditionalData != null)
        ...
        /// <param name="countryNamedLocationToUpdate">The CountryNamedLocation to update.</param>
        /// <returns>The <see cref="GraphResponse{CountryNamedLocation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<CountryNamedLocation>> UpdateResponseAsync(CountryNamedLocation countryNamedLocationToUpdate)
        {
            return this.UpdateResponseAsync(countryNamedLocationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CountryNamedLocation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CountryNamedLocation>> UpdateResponseAsync(CountryNamedLocation countryNamedLocationToUpdate, CancellationToken cancellationToken)
        {
			if (countryNamedLocationToUpdate.AdditionalData != null)
			{
				if (countryNamedLocationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<CountryNamedLocation>(countryNamedLocationToUpdate, cancellationToken).ConfigureAwait(false);
        }
