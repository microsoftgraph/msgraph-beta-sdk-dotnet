...
namespace Microsoft.Graph
{
    ...
    public partial class CountryNamedLocationRequest : BaseRequest, ICountryNamedLocationRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<CountryNamedLocation> PutAsync(CountryNamedLocation countryNamedLocationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<CountryNamedLocation>> PutResponseAsync(CountryNamedLocation countryNamedLocationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<CountryNamedLocation>(countryNamedLocationToUpdate, cancellationToken);
