...
namespace Microsoft.Graph
{
    ...
    public partial class OrganizationalBrandingPropertiesSquareLogoRequest : BaseRequest, IOrganizationalBrandingPropertiesSquareLogoRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream squareLogo, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = "PUT";
