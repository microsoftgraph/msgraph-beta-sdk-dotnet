...
namespace Microsoft.Graph
{
    ...
    public partial class OrganizationalBrandingPropertiesSquareLogoRequest : BaseRequest, IOrganizationalBrandingPropertiesSquareLogoRequest
    {
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream squareLogo, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream squareLogo, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
