...
namespace Microsoft.Graph
{
    ...
    public partial class OrganizationalBrandingPropertiesSquareLogoRequest : BaseRequest, IOrganizationalBrandingPropertiesSquareLogoRequest
    {
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream squareLogo) where T : OrganizationalBrandingProperties
        {
            return this.PutAsync<T>(squareLogo, CancellationToken.None);
        }
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream squareLogo, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream squareLogo) where T : OrganizationalBrandingProperties
        {
            return this.PutResponseAsync<T>(squareLogo, CancellationToken.None);
        }
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The <see cref="GraphResponse"/> object returned by the PUT call.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream squareLogo, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
            this.ContentType = "application/octet-stream";
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<T>(squareLogo, cancellationToken, completionOption).ConfigureAwait(false);
        }
