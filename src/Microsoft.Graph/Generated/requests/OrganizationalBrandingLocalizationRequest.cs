...
namespace Microsoft.Graph
{
    ...
    public partial class OrganizationalBrandingLocalizationRequest : BaseRequest, IOrganizationalBrandingLocalizationRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{OrganizationalBrandingLocalization}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OrganizationalBrandingLocalization>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OrganizationalBrandingLocalization}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OrganizationalBrandingLocalization>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<OrganizationalBrandingLocalization>(null, cancellationToken).ConfigureAwait(false);
        }
