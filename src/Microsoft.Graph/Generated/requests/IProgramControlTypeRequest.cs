...
namespace Microsoft.Graph
{
    ...
    public partial interface IProgramControlTypeRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ProgramControlType> CreateAsync(ProgramControlType programControlTypeToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<ProgramControlType>> CreateResponseAsync(ProgramControlType programControlTypeToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ProgramControlType}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ProgramControlType>> CreateResponseAsync(ProgramControlType programControlTypeToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="programControlTypeToUpdate">The ProgramControlType to update.</param>
        /// <returns>The <see cref="GraphResponse{ProgramControlType}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ProgramControlType>> UpdateResponseAsync(ProgramControlType programControlTypeToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ProgramControlType}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ProgramControlType>> UpdateResponseAsync(ProgramControlType programControlTypeToUpdate, CancellationToken cancellationToken);
