...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type InvitationInvitedUserSponsorsCollectionReferencesRequest.
    /// </summary>
    public partial class InvitationInvitedUserSponsorsCollectionReferencesRequest : BaseRequest, IInvitationInvitedUserSponsorsCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new InvitationInvitedUserSponsorsCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public InvitationInvitedUserSponsorsCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
