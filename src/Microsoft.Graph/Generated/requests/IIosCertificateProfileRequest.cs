...
namespace Microsoft.Graph
{
    ...
    public partial interface IIosCertificateProfileRequest : IBaseRequest
    {
        ...
        /// <param name="iosCertificateProfileToUpdate">The IosCertificateProfile to update.</param>
        /// <returns>The <see cref="GraphResponse{IosCertificateProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IosCertificateProfile>> UpdateResponseAsync(IosCertificateProfile iosCertificateProfileToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosCertificateProfile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IosCertificateProfile>> UpdateResponseAsync(IosCertificateProfile iosCertificateProfileToUpdate, CancellationToken cancellationToken);
