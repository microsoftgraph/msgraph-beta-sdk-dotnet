...
namespace Microsoft.Graph
{
    ...
    public partial interface IOffice365GroupsActivityCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<Office365GroupsActivityCounts> CreateAsync(Office365GroupsActivityCounts office365GroupsActivityCountsToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityCounts>> CreateResponseAsync(Office365GroupsActivityCounts office365GroupsActivityCountsToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Office365GroupsActivityCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityCounts>> CreateResponseAsync(Office365GroupsActivityCounts office365GroupsActivityCountsToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Office365GroupsActivityCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityCounts>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Office365GroupsActivityCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityCounts>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="office365GroupsActivityCountsToUpdate">The Office365GroupsActivityCounts to update.</param>
        /// <returns>The <see cref="GraphResponse{Office365GroupsActivityCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityCounts>> UpdateResponseAsync(Office365GroupsActivityCounts office365GroupsActivityCountsToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Office365GroupsActivityCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityCounts>> UpdateResponseAsync(Office365GroupsActivityCounts office365GroupsActivityCountsToUpdate, CancellationToken cancellationToken);
