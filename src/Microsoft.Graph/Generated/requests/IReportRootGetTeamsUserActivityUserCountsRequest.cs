...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetTeamsUserActivityUserCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetTeamsUserActivityUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="teamsuseractivityusercounts">The TeamsUserActivityUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetTeamsUserActivityUserCountsCollectionResponse>> PatchResponseAsync(TeamsUserActivityUserCounts teamsuseractivityusercounts, CancellationToken cancellationToken = default);
        ...
        /// <param name="teamsuseractivityusercounts">The TeamsUserActivityUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetTeamsUserActivityUserCountsCollectionResponse>> PutResponseAsync(TeamsUserActivityUserCounts teamsuseractivityusercounts, CancellationToken cancellationToken = default);
