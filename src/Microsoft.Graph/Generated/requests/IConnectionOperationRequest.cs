...
namespace Microsoft.Graph
{
    ...
    public partial interface IConnectionOperationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ConnectionOperation> CreateAsync(ConnectionOperation connectionOperationToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<ConnectionOperation>> CreateResponseAsync(ConnectionOperation connectionOperationToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ConnectionOperation> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ConnectionOperation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ConnectionOperation>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ConnectionOperation> UpdateAsync(ConnectionOperation connectionOperationToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ConnectionOperation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ConnectionOperation>> UpdateResponseAsync(ConnectionOperation connectionOperationToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<ConnectionOperation> PutAsync(ConnectionOperation connectionOperationToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<ConnectionOperation>> PutResponseAsync(ConnectionOperation connectionOperationToUpdate, CancellationToken cancellationToken = default);
