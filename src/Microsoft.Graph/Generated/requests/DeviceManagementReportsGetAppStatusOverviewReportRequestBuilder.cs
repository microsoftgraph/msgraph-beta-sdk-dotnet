...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetAppStatusOverviewReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetAppStatusOverviewReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetAppStatusOverviewReportRequest>, IDeviceManagementReportsGetAppStatusOverviewReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetAppStatusOverviewReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetAppStatusOverviewReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetAppStatusOverviewReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetAppStatusOverviewReportRequest(functionUrl, this.Client, options);
