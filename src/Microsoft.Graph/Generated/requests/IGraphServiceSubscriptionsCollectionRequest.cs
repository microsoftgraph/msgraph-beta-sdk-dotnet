...
namespace Microsoft.Graph
{
    ...
    public partial interface IGraphServiceSubscriptionsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<Subscription>> AddResponseAsync(Subscription subscription);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Subscription}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Subscription>> AddResponseAsync(Subscription subscription, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<GraphServiceSubscriptionsCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GraphServiceSubscriptionsCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<GraphServiceSubscriptionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
