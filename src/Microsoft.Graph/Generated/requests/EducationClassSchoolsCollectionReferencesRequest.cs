...
namespace Microsoft.Graph
{
    ...
    public partial class EducationClassSchoolsCollectionReferencesRequest : BaseRequest, IEducationClassSchoolsCollectionReferencesRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(EducationSchool educationSchool)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
        public System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(EducationSchool educationSchool, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
