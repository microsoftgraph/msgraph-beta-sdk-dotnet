...
namespace Microsoft.Graph
{
    ...
    public partial interface IAttachmentRequest : IBaseRequest
    {
        ...
        /// <param name="attachmentToUpdate">The Attachment to update.</param>
        /// <returns>The <see cref="GraphResponse{Attachment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Attachment>> UpdateResponseAsync(Attachment attachmentToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Attachment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Attachment>> UpdateResponseAsync(Attachment attachmentToUpdate, CancellationToken cancellationToken);
