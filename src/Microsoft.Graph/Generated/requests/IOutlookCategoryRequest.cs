...
namespace Microsoft.Graph
{
    ...
    public partial interface IOutlookCategoryRequest : IBaseRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{OutlookCategory}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<OutlookCategory>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OutlookCategory}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<OutlookCategory>> GetResponseAsync(CancellationToken cancellationToken);
