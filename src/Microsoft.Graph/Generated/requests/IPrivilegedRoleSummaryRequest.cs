...
namespace Microsoft.Graph
{
    ...
    public partial interface IPrivilegedRoleSummaryRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<PrivilegedRoleSummary> PutAsync(PrivilegedRoleSummary privilegedRoleSummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<PrivilegedRoleSummary>> PutResponseAsync(PrivilegedRoleSummary privilegedRoleSummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
