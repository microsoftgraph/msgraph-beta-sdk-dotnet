...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IUserOauth2PermissionGrantsCollectionWithReferencesRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IUserOauth2PermissionGrantsCollectionWithReferencesRequest Request();
        ...
        /// <returns>The built request.</returns>
        IUserOauth2PermissionGrantsCollectionWithReferencesRequest Request(IEnumerable<Option> options);
        ...
        IUserOauth2PermissionGrantsCollectionReferencesRequestBuilder References { get; }
