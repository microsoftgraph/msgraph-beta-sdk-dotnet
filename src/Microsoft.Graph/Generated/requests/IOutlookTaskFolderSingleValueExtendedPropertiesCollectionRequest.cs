...
namespace Microsoft.Graph
{
    ...
    public partial interface IOutlookTaskFolderSingleValueExtendedPropertiesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<OutlookTaskFolderSingleValueExtendedPropertiesCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OutlookTaskFolderSingleValueExtendedPropertiesCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<OutlookTaskFolderSingleValueExtendedPropertiesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
