...
namespace Microsoft.Graph
{
    ...
    public partial interface IManagementConditionStatementManagementConditionsCollectionReferencesRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task AddAsync(ManagementCondition managementCondition, CancellationToken cancellationToken = default);
        ...
        /// <param name="managementCondition">The ManagementCondition to add.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(ManagementCondition managementCondition, CancellationToken cancellationToken = default);
