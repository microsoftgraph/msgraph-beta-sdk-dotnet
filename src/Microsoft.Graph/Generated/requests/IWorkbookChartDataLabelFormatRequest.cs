...
namespace Microsoft.Graph
{
    ...
    public partial interface IWorkbookChartDataLabelFormatRequest : IBaseRequest
    {
        ...
        /// <param name="workbookChartDataLabelFormatToUpdate">The WorkbookChartDataLabelFormat to update.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookChartDataLabelFormat}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookChartDataLabelFormat>> UpdateResponseAsync(WorkbookChartDataLabelFormat workbookChartDataLabelFormatToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookChartDataLabelFormat}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookChartDataLabelFormat>> UpdateResponseAsync(WorkbookChartDataLabelFormat workbookChartDataLabelFormatToUpdate, CancellationToken cancellationToken);
