...
namespace Microsoft.Graph
{
    ...
    public partial class MuteParticipantsOperationRequest : BaseRequest, IMuteParticipantsOperationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MuteParticipantsOperation>> CreateResponseAsync(MuteParticipantsOperation muteParticipantsOperationToCreate)
        {
            return this.CreateResponseAsync(muteParticipantsOperationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MuteParticipantsOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MuteParticipantsOperation>> CreateResponseAsync(MuteParticipantsOperation muteParticipantsOperationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<MuteParticipantsOperation>(muteParticipantsOperationToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{MuteParticipantsOperation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MuteParticipantsOperation>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MuteParticipantsOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MuteParticipantsOperation>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<MuteParticipantsOperation>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="muteParticipantsOperationToUpdate">The MuteParticipantsOperation to update.</param>
        /// <returns>The <see cref="GraphResponse{MuteParticipantsOperation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MuteParticipantsOperation>> UpdateResponseAsync(MuteParticipantsOperation muteParticipantsOperationToUpdate)
        {
            return this.UpdateResponseAsync(muteParticipantsOperationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MuteParticipantsOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MuteParticipantsOperation>> UpdateResponseAsync(MuteParticipantsOperation muteParticipantsOperationToUpdate, CancellationToken cancellationToken)
        {
			if (muteParticipantsOperationToUpdate.AdditionalData != null)
			{
				if (muteParticipantsOperationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<MuteParticipantsOperation>(muteParticipantsOperationToUpdate, cancellationToken).ConfigureAwait(false);
        }
