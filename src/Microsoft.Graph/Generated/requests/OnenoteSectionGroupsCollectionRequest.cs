...
namespace Microsoft.Graph
{
    ...
    public partial class OnenoteSectionGroupsCollectionRequest : BaseRequest, IOnenoteSectionGroupsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<SectionGroup>> AddResponseAsync(SectionGroup sectionGroup, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        public async System.Threading.Tasks.Task<GraphResponse<OnenoteSectionGroupsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
