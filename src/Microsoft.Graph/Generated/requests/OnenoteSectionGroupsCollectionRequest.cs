...
namespace Microsoft.Graph
{
    ...
    public partial class OnenoteSectionGroupsCollectionRequest : BaseRequest, IOnenoteSectionGroupsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SectionGroup>> AddResponseAsync(SectionGroup sectionGroup)
        {
            return this.AddResponseAsync(sectionGroup, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SectionGroup}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SectionGroup>> AddResponseAsync(SectionGroup sectionGroup, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<SectionGroup>(sectionGroup, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<GraphResponse<OnenoteSectionGroupsCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OnenoteSectionGroupsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OnenoteSectionGroupsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<OnenoteSectionGroupsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
