...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IPlannerGroupRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IPlannerGroupRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IPlannerGroupRequest Request(IEnumerable<Option> options);
