...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementBooleanSettingInstanceRequest : BaseRequest, IDeviceManagementBooleanSettingInstanceRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementBooleanSettingInstance>> CreateResponseAsync(DeviceManagementBooleanSettingInstance deviceManagementBooleanSettingInstanceToCreate)
        {
            return this.CreateResponseAsync(deviceManagementBooleanSettingInstanceToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementBooleanSettingInstance}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementBooleanSettingInstance>> CreateResponseAsync(DeviceManagementBooleanSettingInstance deviceManagementBooleanSettingInstanceToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DeviceManagementBooleanSettingInstance>(deviceManagementBooleanSettingInstanceToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DeviceManagementBooleanSettingInstance}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementBooleanSettingInstance>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementBooleanSettingInstance}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementBooleanSettingInstance>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceManagementBooleanSettingInstance>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="deviceManagementBooleanSettingInstanceToUpdate">The DeviceManagementBooleanSettingInstance to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementBooleanSettingInstance}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementBooleanSettingInstance>> UpdateResponseAsync(DeviceManagementBooleanSettingInstance deviceManagementBooleanSettingInstanceToUpdate)
        {
            return this.UpdateResponseAsync(deviceManagementBooleanSettingInstanceToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementBooleanSettingInstance}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementBooleanSettingInstance>> UpdateResponseAsync(DeviceManagementBooleanSettingInstance deviceManagementBooleanSettingInstanceToUpdate, CancellationToken cancellationToken)
        {
			if (deviceManagementBooleanSettingInstanceToUpdate.AdditionalData != null)
			{
				if (deviceManagementBooleanSettingInstanceToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<DeviceManagementBooleanSettingInstance>(deviceManagementBooleanSettingInstanceToUpdate, cancellationToken).ConfigureAwait(false);
        }
