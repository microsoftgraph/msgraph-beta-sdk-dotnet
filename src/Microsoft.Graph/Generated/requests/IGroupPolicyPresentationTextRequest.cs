...
namespace Microsoft.Graph
{
    ...
    public partial interface IGroupPolicyPresentationTextRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GroupPolicyPresentationText> CreateAsync(GroupPolicyPresentationText groupPolicyPresentationTextToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationText>> CreateResponseAsync(GroupPolicyPresentationText groupPolicyPresentationTextToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationText}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationText>> CreateResponseAsync(GroupPolicyPresentationText groupPolicyPresentationTextToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationText}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationText>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationText}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationText>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="groupPolicyPresentationTextToUpdate">The GroupPolicyPresentationText to update.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationText}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationText>> UpdateResponseAsync(GroupPolicyPresentationText groupPolicyPresentationTextToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationText}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationText>> UpdateResponseAsync(GroupPolicyPresentationText groupPolicyPresentationTextToUpdate, CancellationToken cancellationToken);
