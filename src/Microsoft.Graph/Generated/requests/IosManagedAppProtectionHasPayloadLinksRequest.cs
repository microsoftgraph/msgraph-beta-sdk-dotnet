...
namespace Microsoft.Graph
{
    ...
    public partial class IosManagedAppProtectionHasPayloadLinksRequest : BaseRequest, IIosManagedAppProtectionHasPayloadLinksRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<IosManagedAppProtectionHasPayloadLinksCollectionResponse>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.Post;
            return this.SendAsyncWithGraphResponse<IosManagedAppProtectionHasPayloadLinksCollectionResponse>(this.RequestBody, cancellationToken);
        }
