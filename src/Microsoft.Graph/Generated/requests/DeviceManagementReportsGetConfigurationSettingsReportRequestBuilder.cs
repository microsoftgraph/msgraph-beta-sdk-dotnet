...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetConfigurationSettingsReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetConfigurationSettingsReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetConfigurationSettingsReportRequest>, IDeviceManagementReportsGetConfigurationSettingsReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetConfigurationSettingsReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetConfigurationSettingsReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetConfigurationSettingsReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetConfigurationSettingsReportRequest(functionUrl, this.Client, options);
