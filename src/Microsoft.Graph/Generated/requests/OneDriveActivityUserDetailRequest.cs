...
namespace Microsoft.Graph
{
    ...
    public partial class OneDriveActivityUserDetailRequest : BaseRequest, IOneDriveActivityUserDetailRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<OneDriveActivityUserDetail>> CreateResponseAsync(OneDriveActivityUserDetail oneDriveActivityUserDetailToCreate)
        {
            return this.CreateResponseAsync(oneDriveActivityUserDetailToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OneDriveActivityUserDetail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OneDriveActivityUserDetail>> CreateResponseAsync(OneDriveActivityUserDetail oneDriveActivityUserDetailToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<OneDriveActivityUserDetail>(oneDriveActivityUserDetailToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{OneDriveActivityUserDetail}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OneDriveActivityUserDetail>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OneDriveActivityUserDetail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OneDriveActivityUserDetail>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<OneDriveActivityUserDetail>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
			if (oneDriveActivityUserDetailToUpdate.AdditionalData != null)
			{
				if (oneDriveActivityUserDetailToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					oneDriveActivityUserDetailToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, oneDriveActivityUserDetailToUpdate.GetType().Name)
						});
				}
			}
            if (oneDriveActivityUserDetailToUpdate.AdditionalData != null)
        ...
        /// <param name="oneDriveActivityUserDetailToUpdate">The OneDriveActivityUserDetail to update.</param>
        /// <returns>The <see cref="GraphResponse{OneDriveActivityUserDetail}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OneDriveActivityUserDetail>> UpdateResponseAsync(OneDriveActivityUserDetail oneDriveActivityUserDetailToUpdate)
        {
            return this.UpdateResponseAsync(oneDriveActivityUserDetailToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{OneDriveActivityUserDetail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OneDriveActivityUserDetail>> UpdateResponseAsync(OneDriveActivityUserDetail oneDriveActivityUserDetailToUpdate, CancellationToken cancellationToken)
        {
			if (oneDriveActivityUserDetailToUpdate.AdditionalData != null)
			{
				if (oneDriveActivityUserDetailToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<OneDriveActivityUserDetail>(oneDriveActivityUserDetailToUpdate, cancellationToken).ConfigureAwait(false);
        }
