...
namespace Microsoft.Graph
{
    ...
    public partial interface IActivityHistoryItemRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ActivityHistoryItem> CreateAsync(ActivityHistoryItem activityHistoryItemToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<ActivityHistoryItem>> CreateResponseAsync(ActivityHistoryItem activityHistoryItemToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ActivityHistoryItem> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ActivityHistoryItem}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ActivityHistoryItem>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ActivityHistoryItem> UpdateAsync(ActivityHistoryItem activityHistoryItemToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ActivityHistoryItem}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ActivityHistoryItem>> UpdateResponseAsync(ActivityHistoryItem activityHistoryItemToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<ActivityHistoryItem> PutAsync(ActivityHistoryItem activityHistoryItemToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="activityHistoryItemToUpdate">The ActivityHistoryItem object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{ActivityHistoryItem}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<ActivityHistoryItem>> PutResponseAsync(ActivityHistoryItem activityHistoryItemToUpdate, CancellationToken cancellationToken = default(CancellationToken));
