...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IGroupAppRoleAssignmentsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IGroupAppRoleAssignmentsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IGroupAppRoleAssignmentsCollectionRequest Request(IEnumerable<Option> options);
