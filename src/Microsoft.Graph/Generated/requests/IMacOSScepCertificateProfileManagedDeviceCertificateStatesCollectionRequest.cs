...
namespace Microsoft.Graph
{
    ...
    public partial interface IMacOSScepCertificateProfileManagedDeviceCertificateStatesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<MacOSScepCertificateProfileManagedDeviceCertificateStatesCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MacOSScepCertificateProfileManagedDeviceCertificateStatesCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<MacOSScepCertificateProfileManagedDeviceCertificateStatesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
