...
namespace Microsoft.Graph
{
    ...
    public partial interface ISignInRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<SignIn> PutAsync(SignIn signInToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<SignIn>> PutResponseAsync(SignIn signInToUpdate, CancellationToken cancellationToken = default(CancellationToken));
