...
namespace Microsoft.Graph
{
    ...
    public partial class PrintServiceEndpointRequest : BaseRequest, IPrintServiceEndpointRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<PrintServiceEndpoint> PutAsync(PrintServiceEndpoint printServiceEndpointToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <summary>
        /// Updates the specified PrintServiceEndpoint using PUT and returns a <see cref="GraphResponse{PrintServiceEndpoint}"/> object.
        /// </summary>
        /// <param name="printServiceEndpointToUpdate">The PrintServiceEndpoint object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{PrintServiceEndpoint}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PrintServiceEndpoint>> PutResponseAsync(PrintServiceEndpoint printServiceEndpointToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<PrintServiceEndpoint>(printServiceEndpointToUpdate, cancellationToken);
