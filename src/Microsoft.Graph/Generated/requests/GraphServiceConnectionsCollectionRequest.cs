...
namespace Microsoft.Graph
{
    ...
    public partial class GraphServiceConnectionsCollectionRequest : BaseRequest, IGraphServiceConnectionsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ExternalConnection>> AddResponseAsync(ExternalConnection externalConnection, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        public async System.Threading.Tasks.Task<GraphResponse<GraphServiceConnectionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<GraphServiceConnectionsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
