...
namespace Microsoft.Graph
{
    ...
    public partial class EmailActivityUserDetailRequest : BaseRequest, IEmailActivityUserDetailRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<EmailActivityUserDetail>> CreateResponseAsync(EmailActivityUserDetail emailActivityUserDetailToCreate)
        {
            return this.CreateResponseAsync(emailActivityUserDetailToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EmailActivityUserDetail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EmailActivityUserDetail>> CreateResponseAsync(EmailActivityUserDetail emailActivityUserDetailToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<EmailActivityUserDetail>(emailActivityUserDetailToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{EmailActivityUserDetail}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<EmailActivityUserDetail>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EmailActivityUserDetail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EmailActivityUserDetail>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<EmailActivityUserDetail>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
			if (emailActivityUserDetailToUpdate.AdditionalData != null)
			{
				if (emailActivityUserDetailToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					emailActivityUserDetailToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, emailActivityUserDetailToUpdate.GetType().Name)
						});
				}
			}
            if (emailActivityUserDetailToUpdate.AdditionalData != null)
        ...
        /// <param name="emailActivityUserDetailToUpdate">The EmailActivityUserDetail to update.</param>
        /// <returns>The <see cref="GraphResponse{EmailActivityUserDetail}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<EmailActivityUserDetail>> UpdateResponseAsync(EmailActivityUserDetail emailActivityUserDetailToUpdate)
        {
            return this.UpdateResponseAsync(emailActivityUserDetailToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{EmailActivityUserDetail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EmailActivityUserDetail>> UpdateResponseAsync(EmailActivityUserDetail emailActivityUserDetailToUpdate, CancellationToken cancellationToken)
        {
			if (emailActivityUserDetailToUpdate.AdditionalData != null)
			{
				if (emailActivityUserDetailToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<EmailActivityUserDetail>(emailActivityUserDetailToUpdate, cancellationToken).ConfigureAwait(false);
        }
