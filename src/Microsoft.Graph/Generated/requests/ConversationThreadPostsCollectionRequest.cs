...
namespace Microsoft.Graph
{
    ...
    public partial class ConversationThreadPostsCollectionRequest : BaseRequest, IConversationThreadPostsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Post>> AddResponseAsync(Post post)
        {
            return this.AddResponseAsync(post, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Post}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Post>> AddResponseAsync(Post post, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        public System.Threading.Tasks.Task<GraphResponse<ConversationThreadPostsCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ConversationThreadPostsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ConversationThreadPostsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
