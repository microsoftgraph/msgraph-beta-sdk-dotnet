...
namespace Microsoft.Graph
{
    ...
    public partial class Windows81CertificateProfileBaseRequest : BaseRequest, IWindows81CertificateProfileBaseRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows81CertificateProfileBase>> CreateResponseAsync(Windows81CertificateProfileBase windows81CertificateProfileBaseToCreate)
        {
            return this.CreateResponseAsync(windows81CertificateProfileBaseToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows81CertificateProfileBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Windows81CertificateProfileBase>> CreateResponseAsync(Windows81CertificateProfileBase windows81CertificateProfileBaseToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<Windows81CertificateProfileBase>(windows81CertificateProfileBaseToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Windows81CertificateProfileBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows81CertificateProfileBase>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows81CertificateProfileBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Windows81CertificateProfileBase>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Windows81CertificateProfileBase>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="windows81CertificateProfileBaseToUpdate">The Windows81CertificateProfileBase to update.</param>
        /// <returns>The <see cref="GraphResponse{Windows81CertificateProfileBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows81CertificateProfileBase>> UpdateResponseAsync(Windows81CertificateProfileBase windows81CertificateProfileBaseToUpdate)
        {
            return this.UpdateResponseAsync(windows81CertificateProfileBaseToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Windows81CertificateProfileBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Windows81CertificateProfileBase>> UpdateResponseAsync(Windows81CertificateProfileBase windows81CertificateProfileBaseToUpdate, CancellationToken cancellationToken)
        {
			if (windows81CertificateProfileBaseToUpdate.AdditionalData != null)
			{
				if (windows81CertificateProfileBaseToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<Windows81CertificateProfileBase>(windows81CertificateProfileBaseToUpdate, cancellationToken).ConfigureAwait(false);
        }
