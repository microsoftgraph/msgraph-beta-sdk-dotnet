...
namespace Microsoft.Graph
{
    ...
    public partial class Windows81CertificateProfileBaseRequest : BaseRequest, IWindows81CertificateProfileBaseRequest
    {
        ...
        public async System.Threading.Tasks.Task<Windows81CertificateProfileBase> CreateAsync(Windows81CertificateProfileBase windows81CertificateProfileBaseToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows81CertificateProfileBase>> CreateResponseAsync(Windows81CertificateProfileBase windows81CertificateProfileBaseToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<Windows81CertificateProfileBase> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows81CertificateProfileBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows81CertificateProfileBase>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<Windows81CertificateProfileBase> UpdateAsync(Windows81CertificateProfileBase windows81CertificateProfileBaseToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Windows81CertificateProfileBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows81CertificateProfileBase>> UpdateResponseAsync(Windows81CertificateProfileBase windows81CertificateProfileBaseToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<Windows81CertificateProfileBase> PutAsync(Windows81CertificateProfileBase windows81CertificateProfileBaseToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows81CertificateProfileBase>> PutResponseAsync(Windows81CertificateProfileBase windows81CertificateProfileBaseToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<Windows81CertificateProfileBase>(windows81CertificateProfileBaseToUpdate, cancellationToken);
