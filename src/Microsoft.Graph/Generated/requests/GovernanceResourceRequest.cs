...
namespace Microsoft.Graph
{
    ...
    public partial class GovernanceResourceRequest : BaseRequest, IGovernanceResourceRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<GovernanceResource>> CreateResponseAsync(GovernanceResource governanceResourceToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{GovernanceResource}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GovernanceResource>> UpdateResponseAsync(GovernanceResource governanceResourceToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
