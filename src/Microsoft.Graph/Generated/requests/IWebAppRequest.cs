...
namespace Microsoft.Graph
{
    ...
    public partial interface IWebAppRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WebApp> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WebApp}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WebApp>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<WebApp> PutAsync(WebApp webAppToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<WebApp>> PutResponseAsync(WebApp webAppToUpdate, CancellationToken cancellationToken = default(CancellationToken));
