...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AuthenticationContextClassReferenceWithReferenceRequest.
    /// </summary>
    public partial class AuthenticationContextClassReferenceWithReferenceRequest : BaseRequest, IAuthenticationContextClassReferenceWithReferenceRequest
    {
        /// <summary>
        /// Constructs a new AuthenticationContextClassReferenceWithReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public AuthenticationContextClassReferenceWithReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public async System.Threading.Tasks.Task<AuthenticationContextClassReference> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AuthenticationContextClassReference>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<AuthenticationContextClassReference> CreateAsync(AuthenticationContextClassReference authenticationContextClassReferenceToCreate, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AuthenticationContextClassReference}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AuthenticationContextClassReference>> CreateResponseAsync(AuthenticationContextClassReference authenticationContextClassReferenceToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<AuthenticationContextClassReference> UpdateAsync(AuthenticationContextClassReference authenticationContextClassReferenceToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AuthenticationContextClassReference}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AuthenticationContextClassReference>> UpdateResponseAsync(AuthenticationContextClassReference authenticationContextClassReferenceToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        public IAuthenticationContextClassReferenceWithReferenceRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IAuthenticationContextClassReferenceWithReferenceRequest Expand(Expression<Func<AuthenticationContextClassReference, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IAuthenticationContextClassReferenceWithReferenceRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IAuthenticationContextClassReferenceWithReferenceRequest Select(Expression<Func<AuthenticationContextClassReference, object>> selectExpression)
        {
