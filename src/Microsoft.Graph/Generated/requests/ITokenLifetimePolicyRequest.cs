...
namespace Microsoft.Graph
{
    ...
    public partial interface ITokenLifetimePolicyRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<TokenLifetimePolicy> CreateAsync(TokenLifetimePolicy tokenLifetimePolicyToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<TokenLifetimePolicy>> CreateResponseAsync(TokenLifetimePolicy tokenLifetimePolicyToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<TokenLifetimePolicy> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TokenLifetimePolicy}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<TokenLifetimePolicy>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<TokenLifetimePolicy> UpdateAsync(TokenLifetimePolicy tokenLifetimePolicyToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{TokenLifetimePolicy}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<TokenLifetimePolicy>> UpdateResponseAsync(TokenLifetimePolicy tokenLifetimePolicyToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<TokenLifetimePolicy> PutAsync(TokenLifetimePolicy tokenLifetimePolicyToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<TokenLifetimePolicy>> PutResponseAsync(TokenLifetimePolicy tokenLifetimePolicyToUpdate, CancellationToken cancellationToken = default);
