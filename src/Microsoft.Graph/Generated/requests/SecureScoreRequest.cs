...
namespace Microsoft.Graph
{
    ...
    public partial class SecureScoreRequest : BaseRequest, ISecureScoreRequest
    {
        ...
        /// <param name="secureScoreToUpdate">The SecureScore to update.</param>
        /// <returns>The <see cref="GraphResponse{SecureScore}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SecureScore>> UpdateResponseAsync(SecureScore secureScoreToUpdate)
        {
            return this.UpdateResponseAsync(secureScoreToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SecureScore}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SecureScore>> UpdateResponseAsync(SecureScore secureScoreToUpdate, CancellationToken cancellationToken)
        {
			if (secureScoreToUpdate.AdditionalData != null)
			{
				if (secureScoreToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
