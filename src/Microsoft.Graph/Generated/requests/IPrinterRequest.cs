...
namespace Microsoft.Graph
{
    ...
    public partial interface IPrinterRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<Printer> PutAsync(Printer printerToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<Printer>> PutResponseAsync(Printer printerToUpdate, CancellationToken cancellationToken = default);
