...
namespace Microsoft.Graph
{
    ...
    public partial interface IPrinterRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<Printer> PutAsync(Printer printerToUpdate, CancellationToken cancellationToken = default(CancellationToken));

        /// <summary>
        /// Updates the specified Printer using PUT and returns a <see cref="GraphResponse{Printer}"/> object.
        /// </summary>
        /// <param name="printerToUpdate">The Printer object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{Printer}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<Printer>> PutResponseAsync(Printer printerToUpdate, CancellationToken cancellationToken = default(CancellationToken));
