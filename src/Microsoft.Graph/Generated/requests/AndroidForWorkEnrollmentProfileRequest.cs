...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidForWorkEnrollmentProfileRequest : BaseRequest, IAndroidForWorkEnrollmentProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEnrollmentProfile>> CreateResponseAsync(AndroidForWorkEnrollmentProfile androidForWorkEnrollmentProfileToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkEnrollmentProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkEnrollmentProfile>> UpdateResponseAsync(AndroidForWorkEnrollmentProfile androidForWorkEnrollmentProfileToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
