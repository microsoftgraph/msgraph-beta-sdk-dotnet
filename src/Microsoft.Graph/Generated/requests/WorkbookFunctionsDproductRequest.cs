...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsDproductRequest : BaseRequest, IWorkbookFunctionsDproductRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsDproductRequest.
        /// </summary>
        public WorkbookFunctionsDproductRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsDproductRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsDproductRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsDproductRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsDproductRequest Select(string value)
        {
