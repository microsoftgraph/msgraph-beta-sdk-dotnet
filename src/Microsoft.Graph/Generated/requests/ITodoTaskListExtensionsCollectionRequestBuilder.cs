...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface ITodoTaskListExtensionsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        ITodoTaskListExtensionsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        ITodoTaskListExtensionsCollectionRequest Request(IEnumerable<Option> options);
