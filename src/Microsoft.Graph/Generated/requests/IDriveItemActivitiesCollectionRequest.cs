...
namespace Microsoft.Graph
{
    ...
    public partial interface IDriveItemActivitiesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<DriveItemActivitiesCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DriveItemActivitiesCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<DriveItemActivitiesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
