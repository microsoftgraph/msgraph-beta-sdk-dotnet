...
namespace Microsoft.Graph
{
    ...
    public partial class PostAttachmentsCollectionRequest : BaseRequest, IPostAttachmentsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PostAttachmentsCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PostAttachmentsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PostAttachmentsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<PostAttachmentsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
