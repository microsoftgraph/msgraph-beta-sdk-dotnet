...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceManagementIntegerSettingInstanceRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<DeviceManagementIntegerSettingInstance> PutAsync(DeviceManagementIntegerSettingInstance deviceManagementIntegerSettingInstanceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementIntegerSettingInstance>> PutResponseAsync(DeviceManagementIntegerSettingInstance deviceManagementIntegerSettingInstanceToUpdate, CancellationToken cancellationToken = default(CancellationToken));
