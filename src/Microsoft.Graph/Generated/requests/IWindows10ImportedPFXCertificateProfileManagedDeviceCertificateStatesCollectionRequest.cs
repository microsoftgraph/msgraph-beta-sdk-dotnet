...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindows10ImportedPFXCertificateProfileManagedDeviceCertificateStatesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<Windows10ImportedPFXCertificateProfileManagedDeviceCertificateStatesCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows10ImportedPFXCertificateProfileManagedDeviceCertificateStatesCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<Windows10ImportedPFXCertificateProfileManagedDeviceCertificateStatesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
