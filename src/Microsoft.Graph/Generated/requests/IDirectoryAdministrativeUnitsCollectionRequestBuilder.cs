...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IDirectoryAdministrativeUnitsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IDirectoryAdministrativeUnitsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IDirectoryAdministrativeUnitsCollectionRequest Request(IEnumerable<Option> options);
