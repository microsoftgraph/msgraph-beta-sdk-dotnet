...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DeviceManagementPartnerRequestBuilder : EntityRequestBuilder, IDeviceManagementPartnerRequestBuilder
    {
        ...
        public DeviceManagementPartnerRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public new IDeviceManagementPartnerRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public new IDeviceManagementPartnerRequest Request(IEnumerable<Option> options)
        {
