...
namespace Microsoft.Graph
{
    ...
    public partial class MicrosoftTunnelServerLogCollectionResponseRequest : BaseRequest, IMicrosoftTunnelServerLogCollectionResponseRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelServerLogCollectionResponse>> CreateResponseAsync(MicrosoftTunnelServerLogCollectionResponse microsoftTunnelServerLogCollectionResponseToCreate)
        {
            return this.CreateResponseAsync(microsoftTunnelServerLogCollectionResponseToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MicrosoftTunnelServerLogCollectionResponse}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelServerLogCollectionResponse>> CreateResponseAsync(MicrosoftTunnelServerLogCollectionResponse microsoftTunnelServerLogCollectionResponseToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<MicrosoftTunnelServerLogCollectionResponse>(microsoftTunnelServerLogCollectionResponseToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{MicrosoftTunnelServerLogCollectionResponse}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelServerLogCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MicrosoftTunnelServerLogCollectionResponse}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelServerLogCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<MicrosoftTunnelServerLogCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="microsoftTunnelServerLogCollectionResponseToUpdate">The MicrosoftTunnelServerLogCollectionResponse to update.</param>
        /// <returns>The <see cref="GraphResponse{MicrosoftTunnelServerLogCollectionResponse}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelServerLogCollectionResponse>> UpdateResponseAsync(MicrosoftTunnelServerLogCollectionResponse microsoftTunnelServerLogCollectionResponseToUpdate)
        {
            return this.UpdateResponseAsync(microsoftTunnelServerLogCollectionResponseToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MicrosoftTunnelServerLogCollectionResponse}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelServerLogCollectionResponse>> UpdateResponseAsync(MicrosoftTunnelServerLogCollectionResponse microsoftTunnelServerLogCollectionResponseToUpdate, CancellationToken cancellationToken)
        {
			if (microsoftTunnelServerLogCollectionResponseToUpdate.AdditionalData != null)
			{
				if (microsoftTunnelServerLogCollectionResponseToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<MicrosoftTunnelServerLogCollectionResponse>(microsoftTunnelServerLogCollectionResponseToUpdate, cancellationToken).ConfigureAwait(false);
        }
