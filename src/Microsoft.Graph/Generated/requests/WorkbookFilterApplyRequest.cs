...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFilterApplyRequest : BaseRequest, IWorkbookFilterApplyRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFilterApplyRequest.
        /// </summary>
        public WorkbookFilterApplyRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFilterApplyRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFilterApplyRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFilterApplyRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFilterApplyRequest Select(string value)
        {
