...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface ISalesInvoiceLineRequestBuilder.
    /// </summary>
    public partial interface ISalesInvoiceLineRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new ISalesInvoiceLineRequest Request();
        ...
        /// <returns>The built request.</returns>
        new ISalesInvoiceLineRequest Request(IEnumerable<Option> options);
