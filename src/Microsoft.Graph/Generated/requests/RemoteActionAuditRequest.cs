...
namespace Microsoft.Graph
{
    ...
    public partial class RemoteActionAuditRequest : BaseRequest, IRemoteActionAuditRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<RemoteActionAudit>> CreateResponseAsync(RemoteActionAudit remoteActionAuditToCreate)
        {
            return this.CreateResponseAsync(remoteActionAuditToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{RemoteActionAudit}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<RemoteActionAudit>> CreateResponseAsync(RemoteActionAudit remoteActionAuditToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="remoteActionAuditToUpdate">The RemoteActionAudit to update.</param>
        /// <returns>The <see cref="GraphResponse{RemoteActionAudit}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<RemoteActionAudit>> UpdateResponseAsync(RemoteActionAudit remoteActionAuditToUpdate)
        {
            return this.UpdateResponseAsync(remoteActionAuditToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{RemoteActionAudit}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<RemoteActionAudit>> UpdateResponseAsync(RemoteActionAudit remoteActionAuditToUpdate, CancellationToken cancellationToken)
        {
			if (remoteActionAuditToUpdate.AdditionalData != null)
			{
				if (remoteActionAuditToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
