...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFilterApplyBottomItemsFilterRequest : BaseRequest, IWorkbookFilterApplyBottomItemsFilterRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFilterApplyBottomItemsFilterRequest.
        /// </summary>
        public WorkbookFilterApplyBottomItemsFilterRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFilterApplyBottomItemsFilterRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFilterApplyBottomItemsFilterRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFilterApplyBottomItemsFilterRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFilterApplyBottomItemsFilterRequest Select(string value)
        {
