...
namespace Microsoft.Graph
{
    ...
    public partial interface IUnifiedRoleEligibilityScheduleRequestRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<UnifiedRoleEligibilityScheduleRequestObject> CreateAsync(UnifiedRoleEligibilityScheduleRequestObject unifiedRoleEligibilityScheduleRequestObjectToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleEligibilityScheduleRequestObject>> CreateResponseAsync(UnifiedRoleEligibilityScheduleRequestObject unifiedRoleEligibilityScheduleRequestObjectToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<UnifiedRoleEligibilityScheduleRequestObject> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleEligibilityScheduleRequestObject}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleEligibilityScheduleRequestObject>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<UnifiedRoleEligibilityScheduleRequestObject> UpdateAsync(UnifiedRoleEligibilityScheduleRequestObject unifiedRoleEligibilityScheduleRequestObjectToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleEligibilityScheduleRequestObject}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleEligibilityScheduleRequestObject>> UpdateResponseAsync(UnifiedRoleEligibilityScheduleRequestObject unifiedRoleEligibilityScheduleRequestObjectToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<UnifiedRoleEligibilityScheduleRequestObject> PutAsync(UnifiedRoleEligibilityScheduleRequestObject unifiedRoleEligibilityScheduleRequestObjectToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleEligibilityScheduleRequestObject>> PutResponseAsync(UnifiedRoleEligibilityScheduleRequestObject unifiedRoleEligibilityScheduleRequestObjectToUpdate, CancellationToken cancellationToken = default(CancellationToken));
