...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DeviceManagementReportsGetDevicesWithoutCompliancePolicyReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetDevicesWithoutCompliancePolicyReportRequest>, IDeviceManagementReportsGetDevicesWithoutCompliancePolicyReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetDevicesWithoutCompliancePolicyReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetDevicesWithoutCompliancePolicyReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetDevicesWithoutCompliancePolicyReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetDevicesWithoutCompliancePolicyReportRequest(functionUrl, this.Client, options);
