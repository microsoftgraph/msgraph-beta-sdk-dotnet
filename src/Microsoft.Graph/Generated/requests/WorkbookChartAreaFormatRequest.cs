...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookChartAreaFormatRequest : BaseRequest, IWorkbookChartAreaFormatRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartAreaFormat>> CreateResponseAsync(WorkbookChartAreaFormat workbookChartAreaFormatToCreate)
        {
            return this.CreateResponseAsync(workbookChartAreaFormatToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookChartAreaFormat}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookChartAreaFormat>> CreateResponseAsync(WorkbookChartAreaFormat workbookChartAreaFormatToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<WorkbookChartAreaFormat>(workbookChartAreaFormatToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WorkbookChartAreaFormat}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartAreaFormat>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookChartAreaFormat}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookChartAreaFormat>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WorkbookChartAreaFormat>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="workbookChartAreaFormatToUpdate">The WorkbookChartAreaFormat to update.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookChartAreaFormat}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartAreaFormat>> UpdateResponseAsync(WorkbookChartAreaFormat workbookChartAreaFormatToUpdate)
        {
            return this.UpdateResponseAsync(workbookChartAreaFormatToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookChartAreaFormat}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookChartAreaFormat>> UpdateResponseAsync(WorkbookChartAreaFormat workbookChartAreaFormatToUpdate, CancellationToken cancellationToken)
        {
			if (workbookChartAreaFormatToUpdate.AdditionalData != null)
			{
				if (workbookChartAreaFormatToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<WorkbookChartAreaFormat>(workbookChartAreaFormatToUpdate, cancellationToken).ConfigureAwait(false);
        }
