...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class RiskyServicePrincipalDismissRequest : BaseRequest, IRiskyServicePrincipalDismissRequest
    {
        /// <summary>
        /// Constructs a new RiskyServicePrincipalDismissRequest.
        /// </summary>
        public RiskyServicePrincipalDismissRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new RiskyServicePrincipalDismissRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public RiskyServicePrincipalDismissRequestBody RequestBody { get; private set; }
        ...
        public IRiskyServicePrincipalDismissRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IRiskyServicePrincipalDismissRequest Select(string value)
        {
