...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsTbillPriceRequest : BaseRequest, IWorkbookFunctionsTbillPriceRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsTbillPriceRequest.
        /// </summary>
        public WorkbookFunctionsTbillPriceRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsTbillPriceRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsTbillPriceRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsTbillPriceRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsTbillPriceRequest Select(string value)
        {
