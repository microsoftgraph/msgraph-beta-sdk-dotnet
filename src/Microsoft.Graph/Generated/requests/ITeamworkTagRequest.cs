...
namespace Microsoft.Graph
{
    ...
    public partial interface ITeamworkTagRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<TeamworkTag> PutAsync(TeamworkTag teamworkTagToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<TeamworkTag>> PutResponseAsync(TeamworkTag teamworkTagToUpdate, CancellationToken cancellationToken = default(CancellationToken));
