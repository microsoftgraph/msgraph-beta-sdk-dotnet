...
namespace Microsoft.Graph
{
    ...
    public partial class SkypeForBusinessDeviceUsageDistributionUserCountsRequest : BaseRequest, ISkypeForBusinessDeviceUsageDistributionUserCountsRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<SkypeForBusinessDeviceUsageDistributionUserCounts> PutAsync(SkypeForBusinessDeviceUsageDistributionUserCounts skypeForBusinessDeviceUsageDistributionUserCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<SkypeForBusinessDeviceUsageDistributionUserCounts>> PutResponseAsync(SkypeForBusinessDeviceUsageDistributionUserCounts skypeForBusinessDeviceUsageDistributionUserCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SkypeForBusinessDeviceUsageDistributionUserCounts>(skypeForBusinessDeviceUsageDistributionUserCountsToUpdate, cancellationToken);
