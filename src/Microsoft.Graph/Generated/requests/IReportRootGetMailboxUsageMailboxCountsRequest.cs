...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetMailboxUsageMailboxCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageMailboxCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="mailboxusagemailboxcounts">The MailboxUsageMailboxCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageMailboxCountsCollectionResponse>> PatchResponseAsync(MailboxUsageMailboxCounts mailboxusagemailboxcounts, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="mailboxusagemailboxcounts">The MailboxUsageMailboxCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageMailboxCountsCollectionResponse>> PutResponseAsync(MailboxUsageMailboxCounts mailboxusagemailboxcounts, CancellationToken cancellationToken = default(CancellationToken));
