...
namespace Microsoft.Graph
{
    ...
    public partial interface IEntitlementManagementSubjectsCollectionRequestBuilder : IBaseRequestBuilder
    {
        ...
        /// <returns>The built request.</returns>
        IEntitlementManagementSubjectsCollectionRequest Request(IEnumerable<Option> options);

        /// <summary>
        /// Gets an <see cref="IAccessPackageSubjectRequestBuilder"/> for the specified AccessPackageSubject.
        /// </summary>
        /// <param name="id">The ID for the AccessPackageSubject.</param>
