...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ManagedDeviceDeleteUserFromSharedAppleDeviceRequest : BaseRequest, IManagedDeviceDeleteUserFromSharedAppleDeviceRequest
    {
        /// <summary>
        /// Constructs a new ManagedDeviceDeleteUserFromSharedAppleDeviceRequest.
        /// </summary>
        public ManagedDeviceDeleteUserFromSharedAppleDeviceRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new ManagedDeviceDeleteUserFromSharedAppleDeviceRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public ManagedDeviceDeleteUserFromSharedAppleDeviceRequestBody RequestBody { get; private set; }
        ...
        public IManagedDeviceDeleteUserFromSharedAppleDeviceRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IManagedDeviceDeleteUserFromSharedAppleDeviceRequest Select(string value)
        {
