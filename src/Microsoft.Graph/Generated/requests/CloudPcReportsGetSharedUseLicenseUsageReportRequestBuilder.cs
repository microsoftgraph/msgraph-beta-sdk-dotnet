...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type CloudPcReportsGetSharedUseLicenseUsageReportRequestBuilder.
    /// </summary>
    public partial class CloudPcReportsGetSharedUseLicenseUsageReportRequestBuilder : BaseActionMethodRequestBuilder<ICloudPcReportsGetSharedUseLicenseUsageReportRequest>, ICloudPcReportsGetSharedUseLicenseUsageReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="CloudPcReportsGetSharedUseLicenseUsageReportRequestBuilder"/>.
        /// </summary>
        /// <param name="requestUrl">The URL for the request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="reportName">A reportName parameter for the OData method call.</param>
        ...
        public CloudPcReportsGetSharedUseLicenseUsageReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            CloudPcReportName? reportName,
            string filter,
        ...
        {
            this.SetParameter("reportName", reportName, true);
        ...
        protected override ICloudPcReportsGetSharedUseLicenseUsageReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new CloudPcReportsGetSharedUseLicenseUsageReportRequest(functionUrl, this.Client, options);

            if (this.HasParameter("reportName"))
            {
                request.RequestBody.ReportName = this.GetParameter<CloudPcReportName?>("reportName");
            }
