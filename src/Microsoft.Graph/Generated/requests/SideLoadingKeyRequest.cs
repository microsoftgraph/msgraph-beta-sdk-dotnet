...
namespace Microsoft.Graph
{
    ...
    public partial class SideLoadingKeyRequest : BaseRequest, ISideLoadingKeyRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<SideLoadingKey>> CreateResponseAsync(SideLoadingKey sideLoadingKeyToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SideLoadingKey}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SideLoadingKey>> UpdateResponseAsync(SideLoadingKey sideLoadingKeyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
