...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetEnrollmentConfigurationPoliciesByDeviceRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetEnrollmentConfigurationPoliciesByDeviceRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetEnrollmentConfigurationPoliciesByDeviceRequest>, IDeviceManagementReportsGetEnrollmentConfigurationPoliciesByDeviceRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetEnrollmentConfigurationPoliciesByDeviceRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetEnrollmentConfigurationPoliciesByDeviceRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetEnrollmentConfigurationPoliciesByDeviceRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetEnrollmentConfigurationPoliciesByDeviceRequest(functionUrl, this.Client, options);
