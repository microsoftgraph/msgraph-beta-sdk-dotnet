...
namespace Microsoft.Graph
{
    ...
    public partial class BitlockerRequest : BaseRequest, IBitlockerRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<Bitlocker>> CreateResponseAsync(Bitlocker bitlockerToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Bitlocker}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Bitlocker>> UpdateResponseAsync(Bitlocker bitlockerToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
