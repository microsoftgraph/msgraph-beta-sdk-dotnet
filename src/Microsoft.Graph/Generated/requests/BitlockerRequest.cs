...
namespace Microsoft.Graph
{
    ...
    public partial class BitlockerRequest : BaseRequest, IBitlockerRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Bitlocker>> CreateResponseAsync(Bitlocker bitlockerToCreate)
        {
            return this.CreateResponseAsync(bitlockerToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Bitlocker}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Bitlocker>> CreateResponseAsync(Bitlocker bitlockerToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<Bitlocker>(bitlockerToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Bitlocker}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Bitlocker>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Bitlocker}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Bitlocker>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Bitlocker>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="bitlockerToUpdate">The Bitlocker to update.</param>
        /// <returns>The <see cref="GraphResponse{Bitlocker}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Bitlocker>> UpdateResponseAsync(Bitlocker bitlockerToUpdate)
        {
            return this.UpdateResponseAsync(bitlockerToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Bitlocker}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Bitlocker>> UpdateResponseAsync(Bitlocker bitlockerToUpdate, CancellationToken cancellationToken)
        {
			if (bitlockerToUpdate.AdditionalData != null)
			{
				if (bitlockerToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<Bitlocker>(bitlockerToUpdate, cancellationToken).ConfigureAwait(false);
        }
