...
namespace Microsoft.Graph
{
    ...
    public partial interface IDepOnboardingSettingRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DepOnboardingSetting> CreateAsync(DepOnboardingSetting depOnboardingSettingToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<DepOnboardingSetting>> CreateResponseAsync(DepOnboardingSetting depOnboardingSettingToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DepOnboardingSetting}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DepOnboardingSetting>> CreateResponseAsync(DepOnboardingSetting depOnboardingSettingToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="depOnboardingSettingToUpdate">The DepOnboardingSetting to update.</param>
        /// <returns>The <see cref="GraphResponse{DepOnboardingSetting}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DepOnboardingSetting>> UpdateResponseAsync(DepOnboardingSetting depOnboardingSettingToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DepOnboardingSetting}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DepOnboardingSetting>> UpdateResponseAsync(DepOnboardingSetting depOnboardingSettingToUpdate, CancellationToken cancellationToken);
