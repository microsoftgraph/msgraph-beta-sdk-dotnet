...
namespace Microsoft.Graph
{
    ...
    public partial class MessageExtensionsCollectionRequest : BaseRequest, IMessageExtensionsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MessageExtensionsCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MessageExtensionsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MessageExtensionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
