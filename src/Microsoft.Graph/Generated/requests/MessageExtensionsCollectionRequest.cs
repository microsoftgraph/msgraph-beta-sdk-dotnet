...
namespace Microsoft.Graph
{
    ...
    public partial class MessageExtensionsCollectionRequest : BaseRequest, IMessageExtensionsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<IMessageExtensionsCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
        ...
        public async System.Threading.Tasks.Task<GraphResponse<MessageExtensionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<MessageExtensionsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
