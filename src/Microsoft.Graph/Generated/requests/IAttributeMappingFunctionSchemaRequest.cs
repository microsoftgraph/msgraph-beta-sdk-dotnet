...
namespace Microsoft.Graph
{
    ...
    public partial interface IAttributeMappingFunctionSchemaRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AttributeMappingFunctionSchema> CreateAsync(AttributeMappingFunctionSchema attributeMappingFunctionSchemaToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<AttributeMappingFunctionSchema>> CreateResponseAsync(AttributeMappingFunctionSchema attributeMappingFunctionSchemaToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AttributeMappingFunctionSchema}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AttributeMappingFunctionSchema>> CreateResponseAsync(AttributeMappingFunctionSchema attributeMappingFunctionSchemaToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AttributeMappingFunctionSchema}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AttributeMappingFunctionSchema>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AttributeMappingFunctionSchema}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AttributeMappingFunctionSchema>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="attributeMappingFunctionSchemaToUpdate">The AttributeMappingFunctionSchema to update.</param>
        /// <returns>The <see cref="GraphResponse{AttributeMappingFunctionSchema}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AttributeMappingFunctionSchema>> UpdateResponseAsync(AttributeMappingFunctionSchema attributeMappingFunctionSchemaToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AttributeMappingFunctionSchema}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AttributeMappingFunctionSchema>> UpdateResponseAsync(AttributeMappingFunctionSchema attributeMappingFunctionSchemaToUpdate, CancellationToken cancellationToken);
