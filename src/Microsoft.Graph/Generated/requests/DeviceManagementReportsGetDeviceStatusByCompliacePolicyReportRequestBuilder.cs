...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetDeviceStatusByCompliacePolicyReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetDeviceStatusByCompliacePolicyReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetDeviceStatusByCompliacePolicyReportRequest>, IDeviceManagementReportsGetDeviceStatusByCompliacePolicyReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetDeviceStatusByCompliacePolicyReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetDeviceStatusByCompliacePolicyReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IDeviceManagementReportsGetDeviceStatusByCompliacePolicyReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetDeviceStatusByCompliacePolicyReportRequest(functionUrl, this.Client, options);
