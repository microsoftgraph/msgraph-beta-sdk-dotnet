...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementTemplateRequest : BaseRequest, IDeviceManagementTemplateRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementTemplate>> CreateResponseAsync(DeviceManagementTemplate deviceManagementTemplateToCreate)
        {
            return this.CreateResponseAsync(deviceManagementTemplateToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementTemplate}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementTemplate>> CreateResponseAsync(DeviceManagementTemplate deviceManagementTemplateToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="deviceManagementTemplateToUpdate">The DeviceManagementTemplate to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementTemplate}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementTemplate>> UpdateResponseAsync(DeviceManagementTemplate deviceManagementTemplateToUpdate)
        {
            return this.UpdateResponseAsync(deviceManagementTemplateToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementTemplate}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementTemplate>> UpdateResponseAsync(DeviceManagementTemplate deviceManagementTemplateToUpdate, CancellationToken cancellationToken)
        {
			if (deviceManagementTemplateToUpdate.AdditionalData != null)
			{
				if (deviceManagementTemplateToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
