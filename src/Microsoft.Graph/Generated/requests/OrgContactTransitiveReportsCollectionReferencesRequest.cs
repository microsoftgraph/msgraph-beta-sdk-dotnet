...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type OrgContactTransitiveReportsCollectionReferencesRequest.
    /// </summary>
    public partial class OrgContactTransitiveReportsCollectionReferencesRequest : BaseRequest, IOrgContactTransitiveReportsCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new OrgContactTransitiveReportsCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public OrgContactTransitiveReportsCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
