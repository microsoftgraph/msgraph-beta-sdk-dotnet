...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidManagedStoreWebAppRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AndroidManagedStoreWebApp> CreateAsync(AndroidManagedStoreWebApp androidManagedStoreWebAppToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidManagedStoreWebApp>> CreateResponseAsync(AndroidManagedStoreWebApp androidManagedStoreWebAppToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidManagedStoreWebApp}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidManagedStoreWebApp>> CreateResponseAsync(AndroidManagedStoreWebApp androidManagedStoreWebAppToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="androidManagedStoreWebAppToUpdate">The AndroidManagedStoreWebApp to update.</param>
        /// <returns>The <see cref="GraphResponse{AndroidManagedStoreWebApp}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidManagedStoreWebApp>> UpdateResponseAsync(AndroidManagedStoreWebApp androidManagedStoreWebAppToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidManagedStoreWebApp}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidManagedStoreWebApp>> UpdateResponseAsync(AndroidManagedStoreWebApp androidManagedStoreWebAppToUpdate, CancellationToken cancellationToken);
