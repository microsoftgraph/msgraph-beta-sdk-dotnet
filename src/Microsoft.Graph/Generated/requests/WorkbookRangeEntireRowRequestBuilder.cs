...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookRangeEntireRowRequestBuilder : BaseFunctionMethodRequestBuilder<IWorkbookRangeEntireRowRequest>, IWorkbookRangeEntireRowRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookRangeEntireRowRequestBuilder"/>.
        /// </summary>
        /// <param name="requestUrl">The URL for the request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        public WorkbookRangeEntireRowRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        protected override IWorkbookRangeEntireRowRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookRangeEntireRowRequest(functionUrl, this.Client, options);
