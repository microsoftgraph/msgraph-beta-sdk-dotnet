...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetSharePointActivityPagesRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointActivityPagesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="sharepointactivitypages">The SharePointActivityPages object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointActivityPagesCollectionResponse>> PatchResponseAsync(SharePointActivityPages sharepointactivitypages, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="sharepointactivitypages">The SharePointActivityPages object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetSharePointActivityPagesCollectionResponse>> PutResponseAsync(SharePointActivityPages sharepointactivitypages, CancellationToken cancellationToken = default(CancellationToken));
