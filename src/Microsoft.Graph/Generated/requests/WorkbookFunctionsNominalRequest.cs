...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsNominalRequest : BaseRequest, IWorkbookFunctionsNominalRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsNominalRequest.
        /// </summary>
        public WorkbookFunctionsNominalRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsNominalRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsNominalRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsNominalRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsNominalRequest Select(string value)
        {
