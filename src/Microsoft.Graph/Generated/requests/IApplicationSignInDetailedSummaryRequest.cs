...
namespace Microsoft.Graph
{
    ...
    public partial interface IApplicationSignInDetailedSummaryRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ApplicationSignInDetailedSummary> CreateAsync(ApplicationSignInDetailedSummary applicationSignInDetailedSummaryToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<ApplicationSignInDetailedSummary>> CreateResponseAsync(ApplicationSignInDetailedSummary applicationSignInDetailedSummaryToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ApplicationSignInDetailedSummary}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ApplicationSignInDetailedSummary>> CreateResponseAsync(ApplicationSignInDetailedSummary applicationSignInDetailedSummaryToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ApplicationSignInDetailedSummary}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ApplicationSignInDetailedSummary>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ApplicationSignInDetailedSummary}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ApplicationSignInDetailedSummary>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="applicationSignInDetailedSummaryToUpdate">The ApplicationSignInDetailedSummary to update.</param>
        /// <returns>The <see cref="GraphResponse{ApplicationSignInDetailedSummary}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ApplicationSignInDetailedSummary>> UpdateResponseAsync(ApplicationSignInDetailedSummary applicationSignInDetailedSummaryToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ApplicationSignInDetailedSummary}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ApplicationSignInDetailedSummary>> UpdateResponseAsync(ApplicationSignInDetailedSummary applicationSignInDetailedSummaryToUpdate, CancellationToken cancellationToken);
