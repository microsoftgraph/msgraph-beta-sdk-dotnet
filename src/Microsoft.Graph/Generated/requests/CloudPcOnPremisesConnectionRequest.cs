...
namespace Microsoft.Graph
{
    ...
    public partial class CloudPcOnPremisesConnectionRequest : BaseRequest, ICloudPcOnPremisesConnectionRequest
    {
        ...
        public System.Threading.Tasks.Task<CloudPcOnPremisesConnection> CreateAsync(CloudPcOnPremisesConnection cloudPcOnPremisesConnectionToCreate)
        {
            return this.CreateAsync(cloudPcOnPremisesConnectionToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created CloudPcOnPremisesConnection.</returns>
        public async System.Threading.Tasks.Task<CloudPcOnPremisesConnection> CreateAsync(CloudPcOnPremisesConnection cloudPcOnPremisesConnectionToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<CloudPcOnPremisesConnection>> CreateResponseAsync(CloudPcOnPremisesConnection cloudPcOnPremisesConnectionToCreate)
        {
            return this.CreateResponseAsync(cloudPcOnPremisesConnectionToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{CloudPcOnPremisesConnection}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CloudPcOnPremisesConnection>> CreateResponseAsync(CloudPcOnPremisesConnection cloudPcOnPremisesConnectionToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        public System.Threading.Tasks.Task<CloudPcOnPremisesConnection> UpdateAsync(CloudPcOnPremisesConnection cloudPcOnPremisesConnectionToUpdate)
        {
            return this.UpdateAsync(cloudPcOnPremisesConnectionToUpdate, CancellationToken.None);
        }
        ...
        /// <returns>The updated CloudPcOnPremisesConnection.</returns>
        public async System.Threading.Tasks.Task<CloudPcOnPremisesConnection> UpdateAsync(CloudPcOnPremisesConnection cloudPcOnPremisesConnectionToUpdate, CancellationToken cancellationToken)
        {
			if (cloudPcOnPremisesConnectionToUpdate.AdditionalData != null)
			{
				if (cloudPcOnPremisesConnectionToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					cloudPcOnPremisesConnectionToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, cloudPcOnPremisesConnectionToUpdate.GetType().Name)
						});
				}
			}
            if (cloudPcOnPremisesConnectionToUpdate.AdditionalData != null)
        ...
        /// <param name="cloudPcOnPremisesConnectionToUpdate">The CloudPcOnPremisesConnection to update.</param>
        /// <returns>The <see cref="GraphResponse{CloudPcOnPremisesConnection}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<CloudPcOnPremisesConnection>> UpdateResponseAsync(CloudPcOnPremisesConnection cloudPcOnPremisesConnectionToUpdate)
        {
            return this.UpdateResponseAsync(cloudPcOnPremisesConnectionToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CloudPcOnPremisesConnection}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CloudPcOnPremisesConnection>> UpdateResponseAsync(CloudPcOnPremisesConnection cloudPcOnPremisesConnectionToUpdate, CancellationToken cancellationToken)
        {
			if (cloudPcOnPremisesConnectionToUpdate.AdditionalData != null)
			{
				if (cloudPcOnPremisesConnectionToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
