...
namespace Microsoft.Graph
{
    ...
    public partial interface IOfficeConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<OfficeConfiguration> CreateAsync(OfficeConfiguration officeConfigurationToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<OfficeConfiguration>> CreateResponseAsync(OfficeConfiguration officeConfigurationToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OfficeConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<OfficeConfiguration>> CreateResponseAsync(OfficeConfiguration officeConfigurationToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="officeConfigurationToUpdate">The OfficeConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{OfficeConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<OfficeConfiguration>> UpdateResponseAsync(OfficeConfiguration officeConfigurationToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{OfficeConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<OfficeConfiguration>> UpdateResponseAsync(OfficeConfiguration officeConfigurationToUpdate, CancellationToken cancellationToken);
