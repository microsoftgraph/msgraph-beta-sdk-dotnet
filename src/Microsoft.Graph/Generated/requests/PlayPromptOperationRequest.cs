...
namespace Microsoft.Graph
{
    ...
    public partial class PlayPromptOperationRequest : BaseRequest, IPlayPromptOperationRequest
    {
        ...
        /// <param name="playPromptOperationToUpdate">The PlayPromptOperation to update.</param>
        /// <returns>The <see cref="GraphResponse{PlayPromptOperation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PlayPromptOperation>> UpdateResponseAsync(PlayPromptOperation playPromptOperationToUpdate)
        {
            return this.UpdateResponseAsync(playPromptOperationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PlayPromptOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PlayPromptOperation>> UpdateResponseAsync(PlayPromptOperation playPromptOperationToUpdate, CancellationToken cancellationToken)
        {
			if (playPromptOperationToUpdate.AdditionalData != null)
			{
				if (playPromptOperationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
