...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementComplexSettingDefinitionRequest : BaseRequest, IDeviceManagementComplexSettingDefinitionRequest
    {
        ...
        public async System.Threading.Tasks.Task<DeviceManagementComplexSettingDefinition> CreateAsync(DeviceManagementComplexSettingDefinition deviceManagementComplexSettingDefinitionToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementComplexSettingDefinition>> CreateResponseAsync(DeviceManagementComplexSettingDefinition deviceManagementComplexSettingDefinitionToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<DeviceManagementComplexSettingDefinition> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementComplexSettingDefinition}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementComplexSettingDefinition>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<DeviceManagementComplexSettingDefinition> UpdateAsync(DeviceManagementComplexSettingDefinition deviceManagementComplexSettingDefinitionToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementComplexSettingDefinition}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementComplexSettingDefinition>> UpdateResponseAsync(DeviceManagementComplexSettingDefinition deviceManagementComplexSettingDefinitionToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementComplexSettingDefinition> PutAsync(DeviceManagementComplexSettingDefinition deviceManagementComplexSettingDefinitionToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementComplexSettingDefinition>> PutResponseAsync(DeviceManagementComplexSettingDefinition deviceManagementComplexSettingDefinitionToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<DeviceManagementComplexSettingDefinition>(deviceManagementComplexSettingDefinitionToUpdate, cancellationToken);
