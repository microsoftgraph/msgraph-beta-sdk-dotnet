...
namespace Microsoft.Graph
{
    ...
    public partial interface ITeamsTemplateRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<TeamsTemplate> PutAsync(TeamsTemplate teamsTemplateToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<TeamsTemplate>> PutResponseAsync(TeamsTemplate teamsTemplateToUpdate, CancellationToken cancellationToken = default);
