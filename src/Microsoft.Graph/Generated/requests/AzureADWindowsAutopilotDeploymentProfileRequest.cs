...
namespace Microsoft.Graph
{
    ...
    public partial class AzureADWindowsAutopilotDeploymentProfileRequest : BaseRequest, IAzureADWindowsAutopilotDeploymentProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<AzureADWindowsAutopilotDeploymentProfile> CreateAsync(AzureADWindowsAutopilotDeploymentProfile azureADWindowsAutopilotDeploymentProfileToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AzureADWindowsAutopilotDeploymentProfile>> CreateResponseAsync(AzureADWindowsAutopilotDeploymentProfile azureADWindowsAutopilotDeploymentProfileToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<AzureADWindowsAutopilotDeploymentProfile> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AzureADWindowsAutopilotDeploymentProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AzureADWindowsAutopilotDeploymentProfile>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<AzureADWindowsAutopilotDeploymentProfile> UpdateAsync(AzureADWindowsAutopilotDeploymentProfile azureADWindowsAutopilotDeploymentProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AzureADWindowsAutopilotDeploymentProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AzureADWindowsAutopilotDeploymentProfile>> UpdateResponseAsync(AzureADWindowsAutopilotDeploymentProfile azureADWindowsAutopilotDeploymentProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<AzureADWindowsAutopilotDeploymentProfile> PutAsync(AzureADWindowsAutopilotDeploymentProfile azureADWindowsAutopilotDeploymentProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="azureADWindowsAutopilotDeploymentProfileToUpdate">The AzureADWindowsAutopilotDeploymentProfile object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{AzureADWindowsAutopilotDeploymentProfile}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AzureADWindowsAutopilotDeploymentProfile>> PutResponseAsync(AzureADWindowsAutopilotDeploymentProfile azureADWindowsAutopilotDeploymentProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<AzureADWindowsAutopilotDeploymentProfile>(azureADWindowsAutopilotDeploymentProfileToUpdate, cancellationToken);
