...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetYammerGroupsActivityCountsRequest : BaseRequest, IReportRootGetYammerGroupsActivityCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerGroupsActivityCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetYammerGroupsActivityCountsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="yammergroupsactivitycounts">The YammerGroupsActivityCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerGroupsActivityCountsCollectionResponse>> PatchResponseAsync(YammerGroupsActivityCounts yammergroupsactivitycounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetYammerGroupsActivityCountsCollectionResponse>(yammergroupsactivitycounts, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="yammergroupsactivitycounts">The YammerGroupsActivityCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerGroupsActivityCountsCollectionResponse>> PutResponseAsync(YammerGroupsActivityCounts yammergroupsactivitycounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetYammerGroupsActivityCountsCollectionResponse>(yammergroupsactivitycounts, cancellationToken).ConfigureAwait(false);
        }
