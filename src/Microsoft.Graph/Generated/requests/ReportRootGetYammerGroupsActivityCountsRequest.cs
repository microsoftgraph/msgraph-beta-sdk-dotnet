...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetYammerGroupsActivityCountsRequest : BaseRequest, IReportRootGetYammerGroupsActivityCountsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerGroupsActivityCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="yammergroupsactivitycounts">The YammerGroupsActivityCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerGroupsActivityCountsCollectionResponse>> PatchResponseAsync(YammerGroupsActivityCounts yammergroupsactivitycounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="yammergroupsactivitycounts">The YammerGroupsActivityCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerGroupsActivityCountsCollectionResponse>> PutResponseAsync(YammerGroupsActivityCounts yammergroupsactivitycounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetYammerGroupsActivityCountsCollectionResponse>(yammergroupsactivitycounts, cancellationToken);
        }
