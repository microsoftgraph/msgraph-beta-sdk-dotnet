...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface ITeamIncomingChannelsCollectionReferencesRequest : IBaseRequest
    {
        /// <summary>
        ...
        System.Threading.Tasks.Task AddAsync(ReferenceRequestBody channelReference, CancellationToken cancellationToken = default);
        ...
        /// <param name="channelReference">The ReferenceRequestBody to add.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(ReferenceRequestBody channelReference, CancellationToken cancellationToken = default);
