...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IMailFolderSingleValueExtendedPropertiesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IMailFolderSingleValueExtendedPropertiesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IMailFolderSingleValueExtendedPropertiesCollectionRequest Request(IEnumerable<Option> options);
