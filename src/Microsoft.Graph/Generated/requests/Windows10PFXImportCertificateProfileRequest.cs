...
namespace Microsoft.Graph
{
    ...
    public partial class Windows10PFXImportCertificateProfileRequest : BaseRequest, IWindows10PFXImportCertificateProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<Windows10PFXImportCertificateProfile> CreateAsync(Windows10PFXImportCertificateProfile windows10PFXImportCertificateProfileToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows10PFXImportCertificateProfile>> CreateResponseAsync(Windows10PFXImportCertificateProfile windows10PFXImportCertificateProfileToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<Windows10PFXImportCertificateProfile> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows10PFXImportCertificateProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows10PFXImportCertificateProfile>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<Windows10PFXImportCertificateProfile> UpdateAsync(Windows10PFXImportCertificateProfile windows10PFXImportCertificateProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Windows10PFXImportCertificateProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows10PFXImportCertificateProfile>> UpdateResponseAsync(Windows10PFXImportCertificateProfile windows10PFXImportCertificateProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<Windows10PFXImportCertificateProfile> PutAsync(Windows10PFXImportCertificateProfile windows10PFXImportCertificateProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows10PFXImportCertificateProfile>> PutResponseAsync(Windows10PFXImportCertificateProfile windows10PFXImportCertificateProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<Windows10PFXImportCertificateProfile>(windows10PFXImportCertificateProfileToUpdate, cancellationToken);
