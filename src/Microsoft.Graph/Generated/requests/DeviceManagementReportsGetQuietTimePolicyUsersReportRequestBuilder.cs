...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetQuietTimePolicyUsersReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetQuietTimePolicyUsersReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetQuietTimePolicyUsersReportRequest>, IDeviceManagementReportsGetQuietTimePolicyUsersReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetQuietTimePolicyUsersReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetQuietTimePolicyUsersReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetQuietTimePolicyUsersReportRequest(functionUrl, this.Client, options);
