...
namespace Microsoft.Graph
{
    ...
    public partial class ThumbnailContentRequest : BaseRequest, IThumbnailContentRequest
    {
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream content, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : Thumbnail
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream content, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : Thumbnail
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
