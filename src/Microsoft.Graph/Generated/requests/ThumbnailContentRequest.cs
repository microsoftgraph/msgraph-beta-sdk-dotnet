...
namespace Microsoft.Graph
{
    ...
    public partial class ThumbnailContentRequest : BaseRequest, IThumbnailContentRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream content, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : Thumbnail
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = Constants.HttpMethods.Put;
