...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class OnlineMeetingAttendeeReportRequest : BaseRequest, IOnlineMeetingAttendeeReportRequest
    {
        /// <summary>
        ...
        /// </summary>
        public OnlineMeetingAttendeeReportRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream attendeeReport) where T : OnlineMeeting
        {
            return this.PutAsync<T>(attendeeReport, CancellationToken.None);
        }
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream attendeeReport, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnlineMeeting
        {
            this.ContentType = "application/octet-stream";
            this.Method = "PUT";
            return this.SendAsync<T>(attendeeReport, cancellationToken, completionOption);
        }
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream attendeeReport) where T : OnlineMeeting
        {
            return this.PutResponseAsync<T>(attendeeReport, CancellationToken.None);
        }
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The <see cref="GraphResponse"/> object returned by the PUT call.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream attendeeReport, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnlineMeeting
        {
            this.ContentType = "application/octet-stream";
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<T>(attendeeReport, cancellationToken, completionOption).ConfigureAwait(false);
        }
