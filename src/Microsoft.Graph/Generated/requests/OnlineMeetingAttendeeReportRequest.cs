...
namespace Microsoft.Graph
{
    ...
    public partial class OnlineMeetingAttendeeReportRequest : BaseRequest, IOnlineMeetingAttendeeReportRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream attendeeReport, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnlineMeeting
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = CoreConstants.HttpMethods.PUT.ToString();
            return this.SendAsyncWithGraphResponse<T>(attendeeReport, cancellationToken, completionOption);
        }
