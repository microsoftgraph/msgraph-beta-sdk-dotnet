...
namespace Microsoft.Graph
{
    ...
    public partial class IosVppAppAssignedLicenseRequest : BaseRequest, IIosVppAppAssignedLicenseRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedLicense>> CreateResponseAsync(IosVppAppAssignedLicense iosVppAppAssignedLicenseToCreate)
        {
            return this.CreateResponseAsync(iosVppAppAssignedLicenseToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedLicense}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedLicense>> CreateResponseAsync(IosVppAppAssignedLicense iosVppAppAssignedLicenseToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<IosVppAppAssignedLicense>(iosVppAppAssignedLicenseToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedLicense}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedLicense>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedLicense}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedLicense>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<IosVppAppAssignedLicense>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="iosVppAppAssignedLicenseToUpdate">The IosVppAppAssignedLicense to update.</param>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedLicense}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedLicense>> UpdateResponseAsync(IosVppAppAssignedLicense iosVppAppAssignedLicenseToUpdate)
        {
            return this.UpdateResponseAsync(iosVppAppAssignedLicenseToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedLicense}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedLicense>> UpdateResponseAsync(IosVppAppAssignedLicense iosVppAppAssignedLicenseToUpdate, CancellationToken cancellationToken)
        {
			if (iosVppAppAssignedLicenseToUpdate.AdditionalData != null)
			{
				if (iosVppAppAssignedLicenseToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<IosVppAppAssignedLicense>(iosVppAppAssignedLicenseToUpdate, cancellationToken).ConfigureAwait(false);
        }
