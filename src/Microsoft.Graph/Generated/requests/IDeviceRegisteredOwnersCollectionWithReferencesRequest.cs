...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceRegisteredOwnersCollectionWithReferencesRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceRegisteredOwnersCollectionWithReferencesResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceRegisteredOwnersCollectionWithReferencesResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceRegisteredOwnersCollectionWithReferencesResponse>> GetResponseAsync(CancellationToken cancellationToken);
