...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type UnifiedRoleAssignmentMultipleDirectoryScopesCollectionReferencesRequest.
    /// </summary>
    public partial class UnifiedRoleAssignmentMultipleDirectoryScopesCollectionReferencesRequest : BaseRequest, IUnifiedRoleAssignmentMultipleDirectoryScopesCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new UnifiedRoleAssignmentMultipleDirectoryScopesCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public UnifiedRoleAssignmentMultipleDirectoryScopesCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
