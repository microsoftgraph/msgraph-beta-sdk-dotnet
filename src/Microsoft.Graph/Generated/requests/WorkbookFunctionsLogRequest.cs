...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsLogRequest : BaseRequest, IWorkbookFunctionsLogRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsLogRequest.
        /// </summary>
        public WorkbookFunctionsLogRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsLogRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsLogRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsLogRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsLogRequest Select(string value)
        {
