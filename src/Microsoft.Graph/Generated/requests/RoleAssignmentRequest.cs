...
namespace Microsoft.Graph
{
    ...
    public partial class RoleAssignmentRequest : BaseRequest, IRoleAssignmentRequest
    {
        ...
        /// <param name="roleAssignmentToUpdate">The RoleAssignment to update.</param>
        /// <returns>The <see cref="GraphResponse{RoleAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<RoleAssignment>> UpdateResponseAsync(RoleAssignment roleAssignmentToUpdate)
        {
            return this.UpdateResponseAsync(roleAssignmentToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{RoleAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<RoleAssignment>> UpdateResponseAsync(RoleAssignment roleAssignmentToUpdate, CancellationToken cancellationToken)
        {
			if (roleAssignmentToUpdate.AdditionalData != null)
			{
				if (roleAssignmentToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
