...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsUpdateStateRequest : BaseRequest, IWindowsUpdateStateRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<WindowsUpdateState>> CreateResponseAsync(WindowsUpdateState windowsUpdateStateToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsUpdateState}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsUpdateState>> UpdateResponseAsync(WindowsUpdateState windowsUpdateStateToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
