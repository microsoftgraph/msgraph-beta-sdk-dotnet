...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetMobileApplicationManagementAppConfigurationReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetMobileApplicationManagementAppConfigurationReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetMobileApplicationManagementAppConfigurationReportRequest>, IDeviceManagementReportsGetMobileApplicationManagementAppConfigurationReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetMobileApplicationManagementAppConfigurationReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetMobileApplicationManagementAppConfigurationReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetMobileApplicationManagementAppConfigurationReportRequest(functionUrl, this.Client, options);
