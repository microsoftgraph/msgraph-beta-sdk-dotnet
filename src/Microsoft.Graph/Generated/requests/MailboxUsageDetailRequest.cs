...
namespace Microsoft.Graph
{
    ...
    public partial class MailboxUsageDetailRequest : BaseRequest, IMailboxUsageDetailRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<MailboxUsageDetail>> CreateResponseAsync(MailboxUsageDetail mailboxUsageDetailToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MailboxUsageDetail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MailboxUsageDetail>> UpdateResponseAsync(MailboxUsageDetail mailboxUsageDetailToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
