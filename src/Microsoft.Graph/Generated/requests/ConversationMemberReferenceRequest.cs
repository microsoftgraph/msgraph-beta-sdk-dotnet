...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ConversationMemberReferenceRequest : BaseRequest, IConversationMemberReferenceRequest
    {
        /// <summary>
        ...
        public ConversationMemberReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified ConversationMember reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified ConversationMember reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The ConversationMember reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
