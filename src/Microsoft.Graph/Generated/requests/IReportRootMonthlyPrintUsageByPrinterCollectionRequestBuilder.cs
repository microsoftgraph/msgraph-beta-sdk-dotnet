...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IReportRootMonthlyPrintUsageByPrinterCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IReportRootMonthlyPrintUsageByPrinterCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IReportRootMonthlyPrintUsageByPrinterCollectionRequest Request(IEnumerable<Option> options);
