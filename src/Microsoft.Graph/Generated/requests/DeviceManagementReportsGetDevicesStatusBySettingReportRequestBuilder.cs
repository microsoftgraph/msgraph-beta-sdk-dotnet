...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetDevicesStatusBySettingReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetDevicesStatusBySettingReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetDevicesStatusBySettingReportRequest>, IDeviceManagementReportsGetDevicesStatusBySettingReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetDevicesStatusBySettingReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetDevicesStatusBySettingReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IDeviceManagementReportsGetDevicesStatusBySettingReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetDevicesStatusBySettingReportRequest(functionUrl, this.Client, options);
