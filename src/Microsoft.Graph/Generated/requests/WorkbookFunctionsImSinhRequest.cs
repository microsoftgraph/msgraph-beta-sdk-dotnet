...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsImSinhRequest : BaseRequest, IWorkbookFunctionsImSinhRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsImSinhRequest.
        /// </summary>
        public WorkbookFunctionsImSinhRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsImSinhRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsImSinhRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsImSinhRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsImSinhRequest Select(string value)
        {
