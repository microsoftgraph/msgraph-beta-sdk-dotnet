...
namespace Microsoft.Graph
{
    ...
    public partial class ChatMessageRequest : BaseRequest, IChatMessageRequest
    {
        ...
        /// <param name="chatMessageToUpdate">The ChatMessage to update.</param>
        /// <returns>The <see cref="GraphResponse{ChatMessage}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ChatMessage>> UpdateResponseAsync(ChatMessage chatMessageToUpdate)
        {
            return this.UpdateResponseAsync(chatMessageToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ChatMessage}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ChatMessage>> UpdateResponseAsync(ChatMessage chatMessageToUpdate, CancellationToken cancellationToken)
        {
			if (chatMessageToUpdate.AdditionalData != null)
			{
				if (chatMessageToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
