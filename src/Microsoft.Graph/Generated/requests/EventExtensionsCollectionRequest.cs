...
namespace Microsoft.Graph
{
    ...
    public partial class EventExtensionsCollectionRequest : BaseRequest, IEventExtensionsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<IEventExtensionsCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
        ...
        /// <summary>
        /// Gets the collection page and returns a <see cref="GraphResponse{EventExtensionsCollectionResponse}"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EventExtensionsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EventExtensionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<EventExtensionsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
