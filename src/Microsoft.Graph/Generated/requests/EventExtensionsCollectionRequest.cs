...
namespace Microsoft.Graph
{
    ...
    public partial class EventExtensionsCollectionRequest : BaseRequest, IEventExtensionsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<EventExtensionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.GET.ToString();
            return this.SendAsyncWithGraphResponse<EventExtensionsCollectionResponse>(null, cancellationToken);
        }
