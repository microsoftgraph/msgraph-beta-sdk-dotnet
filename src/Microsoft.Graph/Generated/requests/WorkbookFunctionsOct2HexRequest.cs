...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsOct2HexRequest : BaseRequest, IWorkbookFunctionsOct2HexRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsOct2HexRequest.
        /// </summary>
        public WorkbookFunctionsOct2HexRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsOct2HexRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsOct2HexRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsOct2HexRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsOct2HexRequest Select(string value)
        {
