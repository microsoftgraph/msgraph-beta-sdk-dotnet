...
namespace Microsoft.Graph
{
    ...
    public partial class OnenoteResourceContentRequest : BaseRequest, IOnenoteResourceContentRequest
    {
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream content, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnenoteResource
        {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream content, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnenoteResource
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = "PUT";
