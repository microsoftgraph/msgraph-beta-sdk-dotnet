...
namespace Microsoft.Graph
{
    ...
    public partial class MobileAppDependencyRequest : BaseRequest, IMobileAppDependencyRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MobileAppDependency>> CreateResponseAsync(MobileAppDependency mobileAppDependencyToCreate)
        {
            return this.CreateResponseAsync(mobileAppDependencyToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MobileAppDependency}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MobileAppDependency>> CreateResponseAsync(MobileAppDependency mobileAppDependencyToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<MobileAppDependency>(mobileAppDependencyToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{MobileAppDependency}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MobileAppDependency>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MobileAppDependency}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MobileAppDependency>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<MobileAppDependency>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="mobileAppDependencyToUpdate">The MobileAppDependency to update.</param>
        /// <returns>The <see cref="GraphResponse{MobileAppDependency}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MobileAppDependency>> UpdateResponseAsync(MobileAppDependency mobileAppDependencyToUpdate)
        {
            return this.UpdateResponseAsync(mobileAppDependencyToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MobileAppDependency}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MobileAppDependency>> UpdateResponseAsync(MobileAppDependency mobileAppDependencyToUpdate, CancellationToken cancellationToken)
        {
			if (mobileAppDependencyToUpdate.AdditionalData != null)
			{
				if (mobileAppDependencyToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<MobileAppDependency>(mobileAppDependencyToUpdate, cancellationToken).ConfigureAwait(false);
        }
