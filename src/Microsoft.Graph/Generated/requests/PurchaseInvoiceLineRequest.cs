...
namespace Microsoft.Graph
{
    ...
    public partial class PurchaseInvoiceLineRequest : BaseRequest, IPurchaseInvoiceLineRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PurchaseInvoiceLine>> CreateResponseAsync(PurchaseInvoiceLine purchaseInvoiceLineToCreate)
        {
            return this.CreateResponseAsync(purchaseInvoiceLineToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PurchaseInvoiceLine}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PurchaseInvoiceLine>> CreateResponseAsync(PurchaseInvoiceLine purchaseInvoiceLineToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<PurchaseInvoiceLine>(purchaseInvoiceLineToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{PurchaseInvoiceLine}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PurchaseInvoiceLine>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PurchaseInvoiceLine}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PurchaseInvoiceLine>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<PurchaseInvoiceLine>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="purchaseInvoiceLineToUpdate">The PurchaseInvoiceLine to update.</param>
        /// <returns>The <see cref="GraphResponse{PurchaseInvoiceLine}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PurchaseInvoiceLine>> UpdateResponseAsync(PurchaseInvoiceLine purchaseInvoiceLineToUpdate)
        {
            return this.UpdateResponseAsync(purchaseInvoiceLineToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PurchaseInvoiceLine}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PurchaseInvoiceLine>> UpdateResponseAsync(PurchaseInvoiceLine purchaseInvoiceLineToUpdate, CancellationToken cancellationToken)
        {
			if (purchaseInvoiceLineToUpdate.AdditionalData != null)
			{
				if (purchaseInvoiceLineToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<PurchaseInvoiceLine>(purchaseInvoiceLineToUpdate, cancellationToken).ConfigureAwait(false);
        }
