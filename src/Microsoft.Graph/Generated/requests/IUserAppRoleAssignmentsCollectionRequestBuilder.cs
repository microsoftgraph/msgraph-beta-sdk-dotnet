...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IUserAppRoleAssignmentsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IUserAppRoleAssignmentsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IUserAppRoleAssignmentsCollectionRequest Request(IEnumerable<Option> options);
