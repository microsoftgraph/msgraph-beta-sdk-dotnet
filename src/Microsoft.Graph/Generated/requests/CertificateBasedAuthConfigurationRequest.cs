...
namespace Microsoft.Graph
{
    ...
    public partial class CertificateBasedAuthConfigurationRequest : BaseRequest, ICertificateBasedAuthConfigurationRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<CertificateBasedAuthConfiguration> PutAsync(CertificateBasedAuthConfiguration certificateBasedAuthConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="certificateBasedAuthConfigurationToUpdate">The CertificateBasedAuthConfiguration object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{CertificateBasedAuthConfiguration}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<CertificateBasedAuthConfiguration>> PutResponseAsync(CertificateBasedAuthConfiguration certificateBasedAuthConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<CertificateBasedAuthConfiguration>(certificateBasedAuthConfigurationToUpdate, cancellationToken);
