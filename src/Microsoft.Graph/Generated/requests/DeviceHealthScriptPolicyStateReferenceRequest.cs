...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceHealthScriptPolicyStateReferenceRequest.
    /// </summary>
    public partial class DeviceHealthScriptPolicyStateReferenceRequest : BaseRequest, IDeviceHealthScriptPolicyStateReferenceRequest
    {
        /// <summary>
        /// Constructs a new DeviceHealthScriptPolicyStateReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public DeviceHealthScriptPolicyStateReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified DeviceHealthScriptPolicyState reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// </summary>
        /// <param name="id">The DeviceHealthScriptPolicyState reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified DeviceHealthScriptPolicyState reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The DeviceHealthScriptPolicyState reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
