...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceCompliancePolicyValidateComplianceScriptRequest : BaseRequest, IDeviceCompliancePolicyValidateComplianceScriptRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DeviceComplianceScriptValidationResult>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DeviceComplianceScriptValidationResult>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
