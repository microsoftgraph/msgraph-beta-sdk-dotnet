...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetOneDriveActivityUserDetailRequest : BaseRequest, IReportRootGetOneDriveActivityUserDetailRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.GET.ToString();
            return this.SendAsyncWithGraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>(null, cancellationToken);
        }
        ...
        /// <param name="onedriveactivityuserdetail">The OneDriveActivityUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>> PatchResponseAsync(OneDriveActivityUserDetail onedriveactivityuserdetail, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.PATCH.ToString();
            return this.SendAsyncWithGraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>(onedriveactivityuserdetail, cancellationToken);
        }
        ...
        /// <param name="onedriveactivityuserdetail">The OneDriveActivityUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>> PutResponseAsync(OneDriveActivityUserDetail onedriveactivityuserdetail, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.PUT.ToString();
            return this.SendAsyncWithGraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>(onedriveactivityuserdetail, cancellationToken);
        }
