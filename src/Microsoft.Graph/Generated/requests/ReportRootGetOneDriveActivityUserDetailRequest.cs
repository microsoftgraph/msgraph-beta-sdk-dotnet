...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetOneDriveActivityUserDetailRequest : BaseRequest, IReportRootGetOneDriveActivityUserDetailRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="onedriveactivityuserdetail">The OneDriveActivityUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>> PatchResponseAsync(OneDriveActivityUserDetail onedriveactivityuserdetail, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>(onedriveactivityuserdetail, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="onedriveactivityuserdetail">The OneDriveActivityUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>> PutResponseAsync(OneDriveActivityUserDetail onedriveactivityuserdetail, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>(onedriveactivityuserdetail, cancellationToken).ConfigureAwait(false);
        }
