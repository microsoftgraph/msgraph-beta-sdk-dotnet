...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetOneDriveActivityUserDetailRequest : BaseRequest, IReportRootGetOneDriveActivityUserDetailRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="onedriveactivityuserdetail">The OneDriveActivityUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>> PatchResponseAsync(OneDriveActivityUserDetail onedriveactivityuserdetail, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="onedriveactivityuserdetail">The OneDriveActivityUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>> PutResponseAsync(OneDriveActivityUserDetail onedriveactivityuserdetail, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetOneDriveActivityUserDetailCollectionResponse>(onedriveactivityuserdetail, cancellationToken);
        }
