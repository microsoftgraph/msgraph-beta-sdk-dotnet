...
namespace Microsoft.Graph
{
    ...
    public partial class UserReminderViewRequest : BaseRequest, IUserReminderViewRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<UserReminderViewCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<UserReminderViewCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
