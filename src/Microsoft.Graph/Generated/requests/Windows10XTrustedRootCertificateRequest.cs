...
namespace Microsoft.Graph
{
    ...
    public partial class Windows10XTrustedRootCertificateRequest : BaseRequest, IWindows10XTrustedRootCertificateRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows10XTrustedRootCertificate>> CreateResponseAsync(Windows10XTrustedRootCertificate windows10XTrustedRootCertificateToCreate)
        {
            return this.CreateResponseAsync(windows10XTrustedRootCertificateToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows10XTrustedRootCertificate}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Windows10XTrustedRootCertificate>> CreateResponseAsync(Windows10XTrustedRootCertificate windows10XTrustedRootCertificateToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="windows10XTrustedRootCertificateToUpdate">The Windows10XTrustedRootCertificate to update.</param>
        /// <returns>The <see cref="GraphResponse{Windows10XTrustedRootCertificate}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows10XTrustedRootCertificate>> UpdateResponseAsync(Windows10XTrustedRootCertificate windows10XTrustedRootCertificateToUpdate)
        {
            return this.UpdateResponseAsync(windows10XTrustedRootCertificateToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Windows10XTrustedRootCertificate}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Windows10XTrustedRootCertificate>> UpdateResponseAsync(Windows10XTrustedRootCertificate windows10XTrustedRootCertificateToUpdate, CancellationToken cancellationToken)
        {
			if (windows10XTrustedRootCertificateToUpdate.AdditionalData != null)
			{
				if (windows10XTrustedRootCertificateToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
