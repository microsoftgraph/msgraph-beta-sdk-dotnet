...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IDeltaParticipantsParticipantsCollectionRequestBuilder.
    /// </summary>
    public partial interface IDeltaParticipantsParticipantsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IDeltaParticipantsParticipantsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IDeltaParticipantsParticipantsCollectionRequest Request(IEnumerable<Option> options);
