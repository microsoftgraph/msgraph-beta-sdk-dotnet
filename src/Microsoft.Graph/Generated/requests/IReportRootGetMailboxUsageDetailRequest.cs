...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetMailboxUsageDetailRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageDetailCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="mailboxusagedetail">The MailboxUsageDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageDetailCollectionResponse>> PatchResponseAsync(MailboxUsageDetail mailboxusagedetail, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="mailboxusagedetail">The MailboxUsageDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageDetailCollectionResponse>> PutResponseAsync(MailboxUsageDetail mailboxusagedetail, CancellationToken cancellationToken = default(CancellationToken));
