...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsDeliveryOptimizationConfigurationRequest : BaseRequest, IWindowsDeliveryOptimizationConfigurationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WindowsDeliveryOptimizationConfiguration>> CreateResponseAsync(WindowsDeliveryOptimizationConfiguration windowsDeliveryOptimizationConfigurationToCreate)
        {
            return this.CreateResponseAsync(windowsDeliveryOptimizationConfigurationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsDeliveryOptimizationConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsDeliveryOptimizationConfiguration>> CreateResponseAsync(WindowsDeliveryOptimizationConfiguration windowsDeliveryOptimizationConfigurationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<WindowsDeliveryOptimizationConfiguration>(windowsDeliveryOptimizationConfigurationToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WindowsDeliveryOptimizationConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsDeliveryOptimizationConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsDeliveryOptimizationConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsDeliveryOptimizationConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WindowsDeliveryOptimizationConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="windowsDeliveryOptimizationConfigurationToUpdate">The WindowsDeliveryOptimizationConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{WindowsDeliveryOptimizationConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsDeliveryOptimizationConfiguration>> UpdateResponseAsync(WindowsDeliveryOptimizationConfiguration windowsDeliveryOptimizationConfigurationToUpdate)
        {
            return this.UpdateResponseAsync(windowsDeliveryOptimizationConfigurationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsDeliveryOptimizationConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsDeliveryOptimizationConfiguration>> UpdateResponseAsync(WindowsDeliveryOptimizationConfiguration windowsDeliveryOptimizationConfigurationToUpdate, CancellationToken cancellationToken)
        {
			if (windowsDeliveryOptimizationConfigurationToUpdate.AdditionalData != null)
			{
				if (windowsDeliveryOptimizationConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<WindowsDeliveryOptimizationConfiguration>(windowsDeliveryOptimizationConfigurationToUpdate, cancellationToken).ConfigureAwait(false);
        }
