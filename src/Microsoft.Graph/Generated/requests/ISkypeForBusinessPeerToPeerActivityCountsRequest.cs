...
namespace Microsoft.Graph
{
    ...
    public partial interface ISkypeForBusinessPeerToPeerActivityCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SkypeForBusinessPeerToPeerActivityCounts> CreateAsync(SkypeForBusinessPeerToPeerActivityCounts skypeForBusinessPeerToPeerActivityCountsToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<SkypeForBusinessPeerToPeerActivityCounts>> CreateResponseAsync(SkypeForBusinessPeerToPeerActivityCounts skypeForBusinessPeerToPeerActivityCountsToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<SkypeForBusinessPeerToPeerActivityCounts> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SkypeForBusinessPeerToPeerActivityCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SkypeForBusinessPeerToPeerActivityCounts>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<SkypeForBusinessPeerToPeerActivityCounts> UpdateAsync(SkypeForBusinessPeerToPeerActivityCounts skypeForBusinessPeerToPeerActivityCountsToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SkypeForBusinessPeerToPeerActivityCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SkypeForBusinessPeerToPeerActivityCounts>> UpdateResponseAsync(SkypeForBusinessPeerToPeerActivityCounts skypeForBusinessPeerToPeerActivityCountsToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<SkypeForBusinessPeerToPeerActivityCounts> PutAsync(SkypeForBusinessPeerToPeerActivityCounts skypeForBusinessPeerToPeerActivityCountsToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="skypeForBusinessPeerToPeerActivityCountsToUpdate">The SkypeForBusinessPeerToPeerActivityCounts object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{SkypeForBusinessPeerToPeerActivityCounts}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<SkypeForBusinessPeerToPeerActivityCounts>> PutResponseAsync(SkypeForBusinessPeerToPeerActivityCounts skypeForBusinessPeerToPeerActivityCountsToUpdate, CancellationToken cancellationToken = default);
