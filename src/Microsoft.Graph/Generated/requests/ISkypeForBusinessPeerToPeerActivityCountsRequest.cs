...
namespace Microsoft.Graph
{
    ...
    public partial interface ISkypeForBusinessPeerToPeerActivityCountsRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<SkypeForBusinessPeerToPeerActivityCounts> PutAsync(SkypeForBusinessPeerToPeerActivityCounts skypeForBusinessPeerToPeerActivityCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<SkypeForBusinessPeerToPeerActivityCounts>> PutResponseAsync(SkypeForBusinessPeerToPeerActivityCounts skypeForBusinessPeerToPeerActivityCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken));
