...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class PlannerBucketRequestBuilder : PlannerDeltaRequestBuilder, IPlannerBucketRequestBuilder
    {
        ...
        public PlannerBucketRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public new IPlannerBucketRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public new IPlannerBucketRequest Request(IEnumerable<Option> options)
        {
            return new PlannerBucketRequest(this.RequestUrl, this.Client, options);
        }
