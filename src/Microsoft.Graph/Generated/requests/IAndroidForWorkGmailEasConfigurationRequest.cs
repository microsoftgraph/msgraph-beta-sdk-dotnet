...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidForWorkGmailEasConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AndroidForWorkGmailEasConfiguration> CreateAsync(AndroidForWorkGmailEasConfiguration androidForWorkGmailEasConfigurationToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkGmailEasConfiguration>> CreateResponseAsync(AndroidForWorkGmailEasConfiguration androidForWorkGmailEasConfigurationToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkGmailEasConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkGmailEasConfiguration>> CreateResponseAsync(AndroidForWorkGmailEasConfiguration androidForWorkGmailEasConfigurationToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="androidForWorkGmailEasConfigurationToUpdate">The AndroidForWorkGmailEasConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkGmailEasConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkGmailEasConfiguration>> UpdateResponseAsync(AndroidForWorkGmailEasConfiguration androidForWorkGmailEasConfigurationToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkGmailEasConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkGmailEasConfiguration>> UpdateResponseAsync(AndroidForWorkGmailEasConfiguration androidForWorkGmailEasConfigurationToUpdate, CancellationToken cancellationToken);
