...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IAdministrativeUnitExtensionsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IAdministrativeUnitExtensionsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IAdministrativeUnitExtensionsCollectionRequest Request(IEnumerable<Option> options);
