...
namespace Microsoft.Graph
{
    ...
    public partial interface IIosVppAppAssignedUserLicenseRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<IosVppAppAssignedUserLicense> CreateAsync(IosVppAppAssignedUserLicense iosVppAppAssignedUserLicenseToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedUserLicense>> CreateResponseAsync(IosVppAppAssignedUserLicense iosVppAppAssignedUserLicenseToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedUserLicense}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedUserLicense>> CreateResponseAsync(IosVppAppAssignedUserLicense iosVppAppAssignedUserLicenseToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedUserLicense}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedUserLicense>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedUserLicense}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedUserLicense>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="iosVppAppAssignedUserLicenseToUpdate">The IosVppAppAssignedUserLicense to update.</param>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedUserLicense}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedUserLicense>> UpdateResponseAsync(IosVppAppAssignedUserLicense iosVppAppAssignedUserLicenseToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedUserLicense}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedUserLicense>> UpdateResponseAsync(IosVppAppAssignedUserLicense iosVppAppAssignedUserLicenseToUpdate, CancellationToken cancellationToken);
