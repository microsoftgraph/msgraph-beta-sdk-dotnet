...
namespace Microsoft.Graph
{
    ...
    public partial class SecurityAlertsCollectionRequestBuilder : BaseRequestBuilder, ISecurityAlertsCollectionRequestBuilder
    {
        ...
        /// <summary>
        /// Gets the request builder for AlertUpdateAlerts.
        /// </summary>
        /// <returns>The <see cref="IAlertUpdateAlertsRequestBuilder"/>.</returns>
        public IAlertUpdateAlertsRequestBuilder UpdateAlerts(
            IEnumerable<Alert> value = null)
        {
            return new AlertUpdateAlertsRequestBuilder(
                this.AppendSegmentToRequestUrl("microsoft.graph.updateAlerts"),
                this.Client,
                value);
        }
    }
