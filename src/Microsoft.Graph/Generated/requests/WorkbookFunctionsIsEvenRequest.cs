...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsIsEvenRequest : BaseRequest, IWorkbookFunctionsIsEvenRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsIsEvenRequest.
        /// </summary>
        public WorkbookFunctionsIsEvenRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsIsEvenRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsIsEvenRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsIsEvenRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsIsEvenRequest Select(string value)
        {
