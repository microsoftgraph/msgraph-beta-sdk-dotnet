...
namespace Microsoft.Graph
{
    ...
    public partial class MacOSDeviceFeaturesConfigurationRequest : BaseRequest, IMacOSDeviceFeaturesConfigurationRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{MacOSDeviceFeaturesConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MacOSDeviceFeaturesConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MacOSDeviceFeaturesConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MacOSDeviceFeaturesConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<MacOSDeviceFeaturesConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
