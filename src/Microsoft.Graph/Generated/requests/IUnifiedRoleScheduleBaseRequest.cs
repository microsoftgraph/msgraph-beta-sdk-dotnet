...
namespace Microsoft.Graph
{
    ...
    public partial interface IUnifiedRoleScheduleBaseRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<UnifiedRoleScheduleBase> CreateAsync(UnifiedRoleScheduleBase unifiedRoleScheduleBaseToCreate);
        ...
        /// <returns>The created UnifiedRoleScheduleBase.</returns>
        System.Threading.Tasks.Task<UnifiedRoleScheduleBase> CreateAsync(UnifiedRoleScheduleBase unifiedRoleScheduleBaseToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleScheduleBase>> CreateResponseAsync(UnifiedRoleScheduleBase unifiedRoleScheduleBaseToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleScheduleBase}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleScheduleBase>> CreateResponseAsync(UnifiedRoleScheduleBase unifiedRoleScheduleBaseToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<UnifiedRoleScheduleBase> UpdateAsync(UnifiedRoleScheduleBase unifiedRoleScheduleBaseToUpdate);
        ...
        /// <returns>The updated UnifiedRoleScheduleBase.</returns>
        System.Threading.Tasks.Task<UnifiedRoleScheduleBase> UpdateAsync(UnifiedRoleScheduleBase unifiedRoleScheduleBaseToUpdate, CancellationToken cancellationToken);
        ...
        /// <param name="unifiedRoleScheduleBaseToUpdate">The UnifiedRoleScheduleBase to update.</param>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleScheduleBase}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleScheduleBase>> UpdateResponseAsync(UnifiedRoleScheduleBase unifiedRoleScheduleBaseToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UnifiedRoleScheduleBase}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnifiedRoleScheduleBase>> UpdateResponseAsync(UnifiedRoleScheduleBase unifiedRoleScheduleBaseToUpdate, CancellationToken cancellationToken);
