...
namespace Microsoft.Graph
{
    ...
    public partial class UserExportDeviceAndAppManagementDataRequest : BaseRequest, IUserExportDeviceAndAppManagementDataRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DeviceAndAppManagementData>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceAndAppManagementData>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="deviceandappmanagementdata">The DeviceAndAppManagementData object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceAndAppManagementData>> PatchResponseAsync(DeviceAndAppManagementData deviceandappmanagementdata, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<DeviceAndAppManagementData>(deviceandappmanagementdata, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="deviceandappmanagementdata">The DeviceAndAppManagementData object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceAndAppManagementData>> PutResponseAsync(DeviceAndAppManagementData deviceandappmanagementdata, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<DeviceAndAppManagementData>(deviceandappmanagementdata, cancellationToken).ConfigureAwait(false);
        }
