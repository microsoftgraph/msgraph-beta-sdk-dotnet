...
namespace Microsoft.Graph
{
    ...
    public partial class PrinterBaseRequest : BaseRequest, IPrinterBaseRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<PrinterBase>> CreateResponseAsync(PrinterBase printerBaseToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PrinterBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PrinterBase>> UpdateResponseAsync(PrinterBase printerBaseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
