...
namespace Microsoft.Graph
{
    ...
    public partial class PrinterBaseRequest : BaseRequest, IPrinterBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<PrinterBase> PutAsync(PrinterBase printerBaseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<PrinterBase>> PutResponseAsync(PrinterBase printerBaseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<PrinterBase>(printerBaseToUpdate, cancellationToken);
