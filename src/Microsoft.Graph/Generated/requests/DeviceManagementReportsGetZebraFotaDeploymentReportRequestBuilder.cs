...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetZebraFotaDeploymentReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetZebraFotaDeploymentReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetZebraFotaDeploymentReportRequest>, IDeviceManagementReportsGetZebraFotaDeploymentReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetZebraFotaDeploymentReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetZebraFotaDeploymentReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetZebraFotaDeploymentReportRequest(functionUrl, this.Client, options);
