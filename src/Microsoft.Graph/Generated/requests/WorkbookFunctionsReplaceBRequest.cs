...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsReplaceBRequest : BaseRequest, IWorkbookFunctionsReplaceBRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsReplaceBRequest.
        /// </summary>
        public WorkbookFunctionsReplaceBRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsReplaceBRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsReplaceBRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsReplaceBRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsReplaceBRequest Select(string value)
        {
