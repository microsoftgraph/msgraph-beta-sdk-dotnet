...
namespace Microsoft.Graph
{
    ...
    public partial interface IWorkbookRangeRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WorkbookRange> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<WorkbookRange> PutAsync(WorkbookRange workbookRangeToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<WorkbookRange>> PutResponseAsync(WorkbookRange workbookRangeToUpdate, CancellationToken cancellationToken = default(CancellationToken));
