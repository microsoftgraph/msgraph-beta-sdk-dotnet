...
namespace Microsoft.Graph
{
    ...
    public partial class OnPremisesPublishingProfileAgentsCollectionRequest : BaseRequest, IOnPremisesPublishingProfileAgentsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<OnPremisesPublishingProfileAgentsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<OnPremisesPublishingProfileAgentsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
