...
namespace Microsoft.Graph
{
    ...
    public partial interface IUserWindowsInformationProtectionDeviceRegistrationsCollectionWithReferencesRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<IUserWindowsInformationProtectionDeviceRegistrationsCollectionWithReferencesPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken));

        /// <summary>
        /// Gets the collection page and returns a <see cref="GraphResponse{UserWindowsInformationProtectionDeviceRegistrationsCollectionWithReferencesResponse}"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserWindowsInformationProtectionDeviceRegistrationsCollectionWithReferencesResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<UserWindowsInformationProtectionDeviceRegistrationsCollectionWithReferencesResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
