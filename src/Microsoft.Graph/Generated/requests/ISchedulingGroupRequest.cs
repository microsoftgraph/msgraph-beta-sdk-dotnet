...
namespace Microsoft.Graph
{
    ...
    public partial interface ISchedulingGroupRequest : IBaseRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{SchedulingGroup}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SchedulingGroup>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SchedulingGroup}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SchedulingGroup>> GetResponseAsync(CancellationToken cancellationToken);
