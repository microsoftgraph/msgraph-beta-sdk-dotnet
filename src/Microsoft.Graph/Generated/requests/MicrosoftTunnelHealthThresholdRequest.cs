...
namespace Microsoft.Graph
{
    ...
    public partial class MicrosoftTunnelHealthThresholdRequest : BaseRequest, IMicrosoftTunnelHealthThresholdRequest
    {
        ...
        public async System.Threading.Tasks.Task<MicrosoftTunnelHealthThreshold> CreateAsync(MicrosoftTunnelHealthThreshold microsoftTunnelHealthThresholdToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelHealthThreshold>> CreateResponseAsync(MicrosoftTunnelHealthThreshold microsoftTunnelHealthThresholdToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<MicrosoftTunnelHealthThreshold>(microsoftTunnelHealthThresholdToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<MicrosoftTunnelHealthThreshold> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MicrosoftTunnelHealthThreshold}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelHealthThreshold>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<MicrosoftTunnelHealthThreshold>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<MicrosoftTunnelHealthThreshold> UpdateAsync(MicrosoftTunnelHealthThreshold microsoftTunnelHealthThresholdToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MicrosoftTunnelHealthThreshold}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelHealthThreshold>> UpdateResponseAsync(MicrosoftTunnelHealthThreshold microsoftTunnelHealthThresholdToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<MicrosoftTunnelHealthThreshold> PutAsync(MicrosoftTunnelHealthThreshold microsoftTunnelHealthThresholdToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<MicrosoftTunnelHealthThreshold>> PutResponseAsync(MicrosoftTunnelHealthThreshold microsoftTunnelHealthThresholdToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<MicrosoftTunnelHealthThreshold>(microsoftTunnelHealthThresholdToUpdate, cancellationToken);
