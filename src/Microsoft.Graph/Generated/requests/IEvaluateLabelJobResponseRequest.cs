...
namespace Microsoft.Graph
{
    ...
    public partial interface IEvaluateLabelJobResponseRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<EvaluateLabelJobResponse> CreateAsync(EvaluateLabelJobResponse evaluateLabelJobResponseToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<EvaluateLabelJobResponse>> CreateResponseAsync(EvaluateLabelJobResponse evaluateLabelJobResponseToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EvaluateLabelJobResponse}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EvaluateLabelJobResponse>> CreateResponseAsync(EvaluateLabelJobResponse evaluateLabelJobResponseToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="evaluateLabelJobResponseToUpdate">The EvaluateLabelJobResponse to update.</param>
        /// <returns>The <see cref="GraphResponse{EvaluateLabelJobResponse}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EvaluateLabelJobResponse>> UpdateResponseAsync(EvaluateLabelJobResponse evaluateLabelJobResponseToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{EvaluateLabelJobResponse}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<EvaluateLabelJobResponse>> UpdateResponseAsync(EvaluateLabelJobResponse evaluateLabelJobResponseToUpdate, CancellationToken cancellationToken);
