...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IOnlineMeetingAlternativeRecordingRequest.
    /// </summary>
    public partial interface IOnlineMeetingAlternativeRecordingRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream alternativeRecording, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnlineMeeting;
        ...
        System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream alternativeRecording, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnlineMeeting;
