...
namespace Microsoft.Graph
{
    ...
    public partial class PrinterShareRequest : BaseRequest, IPrinterShareRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<PrinterShare> PutAsync(PrinterShare printerShareToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="printerShareToUpdate">The PrinterShare object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{PrinterShare}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PrinterShare>> PutResponseAsync(PrinterShare printerShareToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<PrinterShare>(printerShareToUpdate, cancellationToken);
