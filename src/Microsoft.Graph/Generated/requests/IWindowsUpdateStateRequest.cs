...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsUpdateStateRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<WindowsUpdateState> PutAsync(WindowsUpdateState windowsUpdateStateToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsUpdateState>> PutResponseAsync(WindowsUpdateState windowsUpdateStateToUpdate, CancellationToken cancellationToken = default(CancellationToken));
