...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsUpdateStateRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WindowsUpdateState> CreateAsync(WindowsUpdateState windowsUpdateStateToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsUpdateState>> CreateResponseAsync(WindowsUpdateState windowsUpdateStateToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsUpdateState}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsUpdateState>> CreateResponseAsync(WindowsUpdateState windowsUpdateStateToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="windowsUpdateStateToUpdate">The WindowsUpdateState to update.</param>
        /// <returns>The <see cref="GraphResponse{WindowsUpdateState}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsUpdateState>> UpdateResponseAsync(WindowsUpdateState windowsUpdateStateToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsUpdateState}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsUpdateState>> UpdateResponseAsync(WindowsUpdateState windowsUpdateStateToUpdate, CancellationToken cancellationToken);
