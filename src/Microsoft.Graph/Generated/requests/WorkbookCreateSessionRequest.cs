...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookCreateSessionRequest : BaseRequest, IWorkbookCreateSessionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WorkbookSessionInfo>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<WorkbookSessionInfo>(this.RequestBody, cancellationToken);
        }
