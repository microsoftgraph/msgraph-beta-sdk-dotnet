...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookCreateSessionRequest : BaseRequest, IWorkbookCreateSessionRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookSessionInfo>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<WorkbookSessionInfo>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
