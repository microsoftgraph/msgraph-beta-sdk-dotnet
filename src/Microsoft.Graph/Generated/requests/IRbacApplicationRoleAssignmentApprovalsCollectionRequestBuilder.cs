...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IRbacApplicationRoleAssignmentApprovalsCollectionRequestBuilder.
    /// </summary>
    public partial interface IRbacApplicationRoleAssignmentApprovalsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IRbacApplicationRoleAssignmentApprovalsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IRbacApplicationRoleAssignmentApprovalsCollectionRequest Request(IEnumerable<Option> options);
