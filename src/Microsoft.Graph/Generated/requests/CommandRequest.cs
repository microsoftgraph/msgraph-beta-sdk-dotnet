...
namespace Microsoft.Graph
{
    ...
    public partial class CommandRequest : BaseRequest, ICommandRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Command>> CreateResponseAsync(Command commandToCreate)
        {
            return this.CreateResponseAsync(commandToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Command}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Command>> CreateResponseAsync(Command commandToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="commandToUpdate">The Command to update.</param>
        /// <returns>The <see cref="GraphResponse{Command}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Command>> UpdateResponseAsync(Command commandToUpdate)
        {
            return this.UpdateResponseAsync(commandToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Command}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Command>> UpdateResponseAsync(Command commandToUpdate, CancellationToken cancellationToken)
        {
			if (commandToUpdate.AdditionalData != null)
			{
				if (commandToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
