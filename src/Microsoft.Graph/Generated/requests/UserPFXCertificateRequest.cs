...
namespace Microsoft.Graph
{
    ...
    public partial class UserPFXCertificateRequest : BaseRequest, IUserPFXCertificateRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<UserPFXCertificate>> CreateResponseAsync(UserPFXCertificate userPFXCertificateToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserPFXCertificate}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserPFXCertificate>> UpdateResponseAsync(UserPFXCertificate userPFXCertificateToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
