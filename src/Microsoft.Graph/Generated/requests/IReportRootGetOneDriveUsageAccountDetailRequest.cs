...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetOneDriveUsageAccountDetailRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetOneDriveUsageAccountDetailCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="onedriveusageaccountdetail">The OneDriveUsageAccountDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetOneDriveUsageAccountDetailCollectionResponse>> PatchResponseAsync(OneDriveUsageAccountDetail onedriveusageaccountdetail, CancellationToken cancellationToken = default);
        ...
        /// <param name="onedriveusageaccountdetail">The OneDriveUsageAccountDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetOneDriveUsageAccountDetailCollectionResponse>> PutResponseAsync(OneDriveUsageAccountDetail onedriveusageaccountdetail, CancellationToken cancellationToken = default);
