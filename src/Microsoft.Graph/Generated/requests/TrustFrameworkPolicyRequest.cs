...
namespace Microsoft.Graph
{
    ...
    public partial class TrustFrameworkPolicyRequest : BaseRequest, ITrustFrameworkPolicyRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<TrustFrameworkPolicy>> CreateResponseAsync(TrustFrameworkPolicy trustFrameworkPolicyToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{TrustFrameworkPolicy}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<TrustFrameworkPolicy>> UpdateResponseAsync(TrustFrameworkPolicy trustFrameworkPolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
