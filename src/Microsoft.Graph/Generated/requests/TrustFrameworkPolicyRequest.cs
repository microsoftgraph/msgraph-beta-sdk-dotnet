...
namespace Microsoft.Graph
{
    ...
    public partial class TrustFrameworkPolicyRequest : BaseRequest, ITrustFrameworkPolicyRequest
    {
        ...
        public async System.Threading.Tasks.Task<TrustFrameworkPolicy> CreateAsync(TrustFrameworkPolicy trustFrameworkPolicyToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<TrustFrameworkPolicy>> CreateResponseAsync(TrustFrameworkPolicy trustFrameworkPolicyToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<TrustFrameworkPolicy> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TrustFrameworkPolicy}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TrustFrameworkPolicy>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<TrustFrameworkPolicy> UpdateAsync(TrustFrameworkPolicy trustFrameworkPolicyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{TrustFrameworkPolicy}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TrustFrameworkPolicy>> UpdateResponseAsync(TrustFrameworkPolicy trustFrameworkPolicyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<TrustFrameworkPolicy> PutAsync(TrustFrameworkPolicy trustFrameworkPolicyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="trustFrameworkPolicyToUpdate">The TrustFrameworkPolicy object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{TrustFrameworkPolicy}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TrustFrameworkPolicy>> PutResponseAsync(TrustFrameworkPolicy trustFrameworkPolicyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<TrustFrameworkPolicy>(trustFrameworkPolicyToUpdate, cancellationToken);
