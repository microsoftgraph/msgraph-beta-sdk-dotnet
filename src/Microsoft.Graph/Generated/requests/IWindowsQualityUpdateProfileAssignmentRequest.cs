...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsQualityUpdateProfileAssignmentRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WindowsQualityUpdateProfileAssignment> CreateAsync(WindowsQualityUpdateProfileAssignment windowsQualityUpdateProfileAssignmentToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateProfileAssignment>> CreateResponseAsync(WindowsQualityUpdateProfileAssignment windowsQualityUpdateProfileAssignmentToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsQualityUpdateProfileAssignment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateProfileAssignment>> CreateResponseAsync(WindowsQualityUpdateProfileAssignment windowsQualityUpdateProfileAssignmentToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="windowsQualityUpdateProfileAssignmentToUpdate">The WindowsQualityUpdateProfileAssignment to update.</param>
        /// <returns>The <see cref="GraphResponse{WindowsQualityUpdateProfileAssignment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateProfileAssignment>> UpdateResponseAsync(WindowsQualityUpdateProfileAssignment windowsQualityUpdateProfileAssignmentToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsQualityUpdateProfileAssignment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsQualityUpdateProfileAssignment>> UpdateResponseAsync(WindowsQualityUpdateProfileAssignment windowsQualityUpdateProfileAssignmentToUpdate, CancellationToken cancellationToken);
