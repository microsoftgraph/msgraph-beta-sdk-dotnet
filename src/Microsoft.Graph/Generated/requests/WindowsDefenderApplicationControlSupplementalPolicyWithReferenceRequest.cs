...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type WindowsDefenderApplicationControlSupplementalPolicyWithReferenceRequest.
    /// </summary>
    public partial class WindowsDefenderApplicationControlSupplementalPolicyWithReferenceRequest : BaseRequest, IWindowsDefenderApplicationControlSupplementalPolicyWithReferenceRequest
    {
        /// <summary>
        /// Constructs a new WindowsDefenderApplicationControlSupplementalPolicyWithReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public WindowsDefenderApplicationControlSupplementalPolicyWithReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<GraphResponse<WindowsDefenderApplicationControlSupplementalPolicy>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsDefenderApplicationControlSupplementalPolicy}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsDefenderApplicationControlSupplementalPolicy>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WindowsDefenderApplicationControlSupplementalPolicy>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="windowsDefenderApplicationControlSupplementalPolicyToCreate">The WindowsDefenderApplicationControlSupplementalPolicy to create.</param>
        /// <returns>The <see cref="GraphResponse{WindowsDefenderApplicationControlSupplementalPolicy}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsDefenderApplicationControlSupplementalPolicy>> CreateResponseAsync(WindowsDefenderApplicationControlSupplementalPolicy windowsDefenderApplicationControlSupplementalPolicyToCreate)
        {
            return this.CreateResponseAsync(windowsDefenderApplicationControlSupplementalPolicyToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsDefenderApplicationControlSupplementalPolicy}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsDefenderApplicationControlSupplementalPolicy>> CreateResponseAsync(WindowsDefenderApplicationControlSupplementalPolicy windowsDefenderApplicationControlSupplementalPolicyToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<WindowsDefenderApplicationControlSupplementalPolicy>(windowsDefenderApplicationControlSupplementalPolicyToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="windowsDefenderApplicationControlSupplementalPolicyToUpdate">The WindowsDefenderApplicationControlSupplementalPolicy to update.</param>
        /// <returns>The <see cref="GraphResponse{WindowsDefenderApplicationControlSupplementalPolicy}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsDefenderApplicationControlSupplementalPolicy>> UpdateResponseAsync(WindowsDefenderApplicationControlSupplementalPolicy windowsDefenderApplicationControlSupplementalPolicyToUpdate)
        {
            return this.UpdateResponseAsync(windowsDefenderApplicationControlSupplementalPolicyToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsDefenderApplicationControlSupplementalPolicy}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsDefenderApplicationControlSupplementalPolicy>> UpdateResponseAsync(WindowsDefenderApplicationControlSupplementalPolicy windowsDefenderApplicationControlSupplementalPolicyToUpdate, CancellationToken cancellationToken)
        {
			if (windowsDefenderApplicationControlSupplementalPolicyToUpdate.AdditionalData != null)
			{
				if (windowsDefenderApplicationControlSupplementalPolicyToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<WindowsDefenderApplicationControlSupplementalPolicy>(windowsDefenderApplicationControlSupplementalPolicyToUpdate, cancellationToken).ConfigureAwait(false);
        }
        ...
        public IWindowsDefenderApplicationControlSupplementalPolicyWithReferenceRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindowsDefenderApplicationControlSupplementalPolicyWithReferenceRequest Expand(Expression<Func<WindowsDefenderApplicationControlSupplementalPolicy, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindowsDefenderApplicationControlSupplementalPolicyWithReferenceRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindowsDefenderApplicationControlSupplementalPolicyWithReferenceRequest Select(Expression<Func<WindowsDefenderApplicationControlSupplementalPolicy, object>> selectExpression)
        {
