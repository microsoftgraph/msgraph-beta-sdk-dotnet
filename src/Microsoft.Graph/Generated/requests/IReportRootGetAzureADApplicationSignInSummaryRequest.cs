...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetAzureADApplicationSignInSummaryRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetAzureADApplicationSignInSummaryCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="applicationsigninsummary">The ApplicationSignInSummary object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetAzureADApplicationSignInSummaryCollectionResponse>> PatchResponseAsync(ApplicationSignInSummary applicationsigninsummary, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="applicationsigninsummary">The ApplicationSignInSummary object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetAzureADApplicationSignInSummaryCollectionResponse>> PutResponseAsync(ApplicationSignInSummary applicationsigninsummary, CancellationToken cancellationToken = default(CancellationToken));
