...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type MobilityManagementPolicyIncludedGroupsCollectionReferencesRequest.
    /// </summary>
    public partial class MobilityManagementPolicyIncludedGroupsCollectionReferencesRequest : BaseRequest, IMobilityManagementPolicyIncludedGroupsCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new MobilityManagementPolicyIncludedGroupsCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public MobilityManagementPolicyIncludedGroupsCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
