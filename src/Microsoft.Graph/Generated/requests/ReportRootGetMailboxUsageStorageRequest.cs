...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetMailboxUsageStorageRequest : BaseRequest, IReportRootGetMailboxUsageStorageRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageStorageCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="mailboxusagestorage">The MailboxUsageStorage object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageStorageCollectionResponse>> PatchResponseAsync(MailboxUsageStorage mailboxusagestorage, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="mailboxusagestorage">The MailboxUsageStorage object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageStorageCollectionResponse>> PutResponseAsync(MailboxUsageStorage mailboxusagestorage, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetMailboxUsageStorageCollectionResponse>(mailboxusagestorage, cancellationToken);
        }
