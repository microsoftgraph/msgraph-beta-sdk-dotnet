...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetMailboxUsageStorageRequest : BaseRequest, IReportRootGetMailboxUsageStorageRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageStorageCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetMailboxUsageStorageCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="mailboxusagestorage">The MailboxUsageStorage object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageStorageCollectionResponse>> PatchResponseAsync(MailboxUsageStorage mailboxusagestorage, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetMailboxUsageStorageCollectionResponse>(mailboxusagestorage, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="mailboxusagestorage">The MailboxUsageStorage object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetMailboxUsageStorageCollectionResponse>> PutResponseAsync(MailboxUsageStorage mailboxusagestorage, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetMailboxUsageStorageCollectionResponse>(mailboxusagestorage, cancellationToken).ConfigureAwait(false);
        }
