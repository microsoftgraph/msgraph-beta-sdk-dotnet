...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IGraphServiceWorkbooksCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IGraphServiceWorkbooksCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IGraphServiceWorkbooksCollectionRequest Request(IEnumerable<Option> options);
