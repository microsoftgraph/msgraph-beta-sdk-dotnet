...
namespace Microsoft.Graph
{
    ...
    public partial interface ISharedEmailDomainRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SharedEmailDomain> CreateAsync(SharedEmailDomain sharedEmailDomainToCreate);
        ...
        /// <returns>The created SharedEmailDomain.</returns>
        System.Threading.Tasks.Task<SharedEmailDomain> CreateAsync(SharedEmailDomain sharedEmailDomainToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<SharedEmailDomain>> CreateResponseAsync(SharedEmailDomain sharedEmailDomainToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SharedEmailDomain}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SharedEmailDomain>> CreateResponseAsync(SharedEmailDomain sharedEmailDomainToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<SharedEmailDomain> UpdateAsync(SharedEmailDomain sharedEmailDomainToUpdate);
        ...
        /// <returns>The updated SharedEmailDomain.</returns>
        System.Threading.Tasks.Task<SharedEmailDomain> UpdateAsync(SharedEmailDomain sharedEmailDomainToUpdate, CancellationToken cancellationToken);
        ...
        /// <param name="sharedEmailDomainToUpdate">The SharedEmailDomain to update.</param>
        /// <returns>The <see cref="GraphResponse{SharedEmailDomain}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SharedEmailDomain>> UpdateResponseAsync(SharedEmailDomain sharedEmailDomainToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SharedEmailDomain}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SharedEmailDomain>> UpdateResponseAsync(SharedEmailDomain sharedEmailDomainToUpdate, CancellationToken cancellationToken);
