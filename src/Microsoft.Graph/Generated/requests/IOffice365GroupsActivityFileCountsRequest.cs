...
namespace Microsoft.Graph
{
    ...
    public partial interface IOffice365GroupsActivityFileCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<Office365GroupsActivityFileCounts> CreateAsync(Office365GroupsActivityFileCounts office365GroupsActivityFileCountsToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityFileCounts>> CreateResponseAsync(Office365GroupsActivityFileCounts office365GroupsActivityFileCountsToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<Office365GroupsActivityFileCounts> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Office365GroupsActivityFileCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityFileCounts>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<Office365GroupsActivityFileCounts> UpdateAsync(Office365GroupsActivityFileCounts office365GroupsActivityFileCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Office365GroupsActivityFileCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityFileCounts>> UpdateResponseAsync(Office365GroupsActivityFileCounts office365GroupsActivityFileCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<Office365GroupsActivityFileCounts> PutAsync(Office365GroupsActivityFileCounts office365GroupsActivityFileCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="office365GroupsActivityFileCountsToUpdate">The Office365GroupsActivityFileCounts object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{Office365GroupsActivityFileCounts}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityFileCounts>> PutResponseAsync(Office365GroupsActivityFileCounts office365GroupsActivityFileCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken));
