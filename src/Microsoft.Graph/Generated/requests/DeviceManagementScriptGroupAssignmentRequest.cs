...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementScriptGroupAssignmentRequest : BaseRequest, IDeviceManagementScriptGroupAssignmentRequest
    {
        ...
        /// <summary>
        /// Updates the specified DeviceManagementScriptGroupAssignment using PUT.
        /// </summary>
        /// <param name="deviceManagementScriptGroupAssignmentToUpdate">The DeviceManagementScriptGroupAssignment object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementScriptGroupAssignment> PutAsync(DeviceManagementScriptGroupAssignment deviceManagementScriptGroupAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <summary>
        /// Updates the specified DeviceManagementScriptGroupAssignment using PUT and returns a <see cref="GraphResponse{DeviceManagementScriptGroupAssignment}"/> object.
        /// </summary>
        /// <param name="deviceManagementScriptGroupAssignmentToUpdate">The DeviceManagementScriptGroupAssignment object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{DeviceManagementScriptGroupAssignment}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementScriptGroupAssignment>> PutResponseAsync(DeviceManagementScriptGroupAssignment deviceManagementScriptGroupAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<DeviceManagementScriptGroupAssignment>(deviceManagementScriptGroupAssignmentToUpdate, cancellationToken);
