...
namespace Microsoft.Graph
{
    ...
    public partial class DirectoryObjectGetMemberObjectsRequest : BaseRequest, IDirectoryObjectGetMemberObjectsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DirectoryObjectGetMemberObjectsCollectionResponse>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DirectoryObjectGetMemberObjectsCollectionResponse>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
