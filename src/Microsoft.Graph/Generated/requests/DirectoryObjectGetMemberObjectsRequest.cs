...
namespace Microsoft.Graph
{
    ...
    public partial class DirectoryObjectGetMemberObjectsRequest : BaseRequest, IDirectoryObjectGetMemberObjectsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DirectoryObjectGetMemberObjectsCollectionResponse>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<DirectoryObjectGetMemberObjectsCollectionResponse>(this.RequestBody, cancellationToken);
        }
