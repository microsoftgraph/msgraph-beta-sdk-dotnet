...
namespace Microsoft.Graph
{
    ...
    public partial class PlannerRosterRequest : BaseRequest, IPlannerRosterRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<PlannerRoster> PutAsync(PlannerRoster plannerRosterToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<PlannerRoster>> PutResponseAsync(PlannerRoster plannerRosterToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<PlannerRoster>(plannerRosterToUpdate, cancellationToken);
