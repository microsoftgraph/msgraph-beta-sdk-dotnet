...
namespace Microsoft.Graph
{
    ...
    public partial class PlannerRosterRequest : BaseRequest, IPlannerRosterRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PlannerRoster>> CreateResponseAsync(PlannerRoster plannerRosterToCreate)
        {
            return this.CreateResponseAsync(plannerRosterToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PlannerRoster}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PlannerRoster>> CreateResponseAsync(PlannerRoster plannerRosterToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        public System.Threading.Tasks.Task<PlannerRoster> UpdateAsync(PlannerRoster plannerRosterToUpdate)
        {
            return this.UpdateAsync(plannerRosterToUpdate, CancellationToken.None);
        }
        ...
        /// <param name="plannerRosterToUpdate">The PlannerRoster to update.</param>
        /// <returns>The <see cref="GraphResponse{PlannerRoster}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<PlannerRoster>> UpdateResponseAsync(PlannerRoster plannerRosterToUpdate)
        {
            return this.UpdateResponseAsync(plannerRosterToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{PlannerRoster}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PlannerRoster>> UpdateResponseAsync(PlannerRoster plannerRosterToUpdate, CancellationToken cancellationToken)
        {
			if (plannerRosterToUpdate.AdditionalData != null)
			{
				if (plannerRosterToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
