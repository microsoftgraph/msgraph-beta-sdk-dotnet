...
namespace Microsoft.Graph
{
    ...
    public partial interface IGraphServiceConnectionsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<Microsoft.Graph.ExternalConnectors.ExternalConnection> AddAsync(Microsoft.Graph.ExternalConnectors.ExternalConnection externalConnection, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<Microsoft.Graph.ExternalConnectors.ExternalConnection>> AddResponseAsync(Microsoft.Graph.ExternalConnectors.ExternalConnection externalConnection, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<IGraphServiceConnectionsCollectionPage> GetAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<GraphServiceConnectionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        IGraphServiceConnectionsCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceConnectionsCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceConnectionsCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceConnectionsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceConnectionsCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceConnectionsCollectionRequest OrderBy(string value);
    }
}
