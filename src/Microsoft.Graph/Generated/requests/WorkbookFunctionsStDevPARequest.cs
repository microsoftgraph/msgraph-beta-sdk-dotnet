...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsStDevPARequest : BaseRequest, IWorkbookFunctionsStDevPARequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsStDevPARequest.
        /// </summary>
        public WorkbookFunctionsStDevPARequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsStDevPARequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsStDevPARequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsStDevPARequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsStDevPARequest Select(string value)
        {
