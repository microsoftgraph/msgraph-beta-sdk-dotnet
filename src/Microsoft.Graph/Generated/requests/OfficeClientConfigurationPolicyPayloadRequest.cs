...
namespace Microsoft.Graph
{
    ...
    public partial class OfficeClientConfigurationPolicyPayloadRequest : BaseRequest, IOfficeClientConfigurationPolicyPayloadRequest
    {
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream policyPayload, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OfficeClientConfiguration
        {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream policyPayload, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OfficeClientConfiguration
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<T>(policyPayload, cancellationToken, completionOption).ConfigureAwait(false);
        }
