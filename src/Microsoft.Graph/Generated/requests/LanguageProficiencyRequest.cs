...
namespace Microsoft.Graph
{
    ...
    public partial class LanguageProficiencyRequest : BaseRequest, ILanguageProficiencyRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<LanguageProficiency>> CreateResponseAsync(LanguageProficiency languageProficiencyToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{LanguageProficiency}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<LanguageProficiency>> UpdateResponseAsync(LanguageProficiency languageProficiencyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
