...
namespace Microsoft.Graph
{
    ...
    public partial class LanguageProficiencyRequest : BaseRequest, ILanguageProficiencyRequest
    {
        ...
        public async System.Threading.Tasks.Task<LanguageProficiency> CreateAsync(LanguageProficiency languageProficiencyToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<LanguageProficiency>> CreateResponseAsync(LanguageProficiency languageProficiencyToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<LanguageProficiency> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{LanguageProficiency}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<LanguageProficiency>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<LanguageProficiency> UpdateAsync(LanguageProficiency languageProficiencyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{LanguageProficiency}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<LanguageProficiency>> UpdateResponseAsync(LanguageProficiency languageProficiencyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<LanguageProficiency> PutAsync(LanguageProficiency languageProficiencyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<LanguageProficiency>> PutResponseAsync(LanguageProficiency languageProficiencyToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<LanguageProficiency>(languageProficiencyToUpdate, cancellationToken);
