...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IReportRootDailyPrintUsageSummariesByUserCollectionRequest.
    /// </summary>
    public partial interface IReportRootDailyPrintUsageSummariesByUserCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootDailyPrintUsageSummariesByUserCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ReportRootDailyPrintUsageSummariesByUserCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootDailyPrintUsageSummariesByUserCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        IReportRootDailyPrintUsageSummariesByUserCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IReportRootDailyPrintUsageSummariesByUserCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IReportRootDailyPrintUsageSummariesByUserCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IReportRootDailyPrintUsageSummariesByUserCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IReportRootDailyPrintUsageSummariesByUserCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IReportRootDailyPrintUsageSummariesByUserCollectionRequest OrderBy(string value);
    }
}
