...
namespace Microsoft.Graph
{
    ...
    public partial interface ISalesInvoiceLineRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SalesInvoiceLine> CreateAsync(SalesInvoiceLine salesInvoiceLineToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<SalesInvoiceLine>> CreateResponseAsync(SalesInvoiceLine salesInvoiceLineToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SalesInvoiceLine}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SalesInvoiceLine>> CreateResponseAsync(SalesInvoiceLine salesInvoiceLineToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{SalesInvoiceLine}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SalesInvoiceLine>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SalesInvoiceLine}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SalesInvoiceLine>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="salesInvoiceLineToUpdate">The SalesInvoiceLine to update.</param>
        /// <returns>The <see cref="GraphResponse{SalesInvoiceLine}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SalesInvoiceLine>> UpdateResponseAsync(SalesInvoiceLine salesInvoiceLineToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SalesInvoiceLine}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SalesInvoiceLine>> UpdateResponseAsync(SalesInvoiceLine salesInvoiceLineToUpdate, CancellationToken cancellationToken);
