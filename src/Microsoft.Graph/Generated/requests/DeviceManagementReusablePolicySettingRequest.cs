...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementReusablePolicySettingRequest : BaseRequest, IDeviceManagementReusablePolicySettingRequest
    {
        ...
        public async System.Threading.Tasks.Task<DeviceManagementReusablePolicySetting> CreateAsync(DeviceManagementReusablePolicySetting deviceManagementReusablePolicySettingToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementReusablePolicySetting>> CreateResponseAsync(DeviceManagementReusablePolicySetting deviceManagementReusablePolicySettingToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<DeviceManagementReusablePolicySetting> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementReusablePolicySetting}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementReusablePolicySetting>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<DeviceManagementReusablePolicySetting> UpdateAsync(DeviceManagementReusablePolicySetting deviceManagementReusablePolicySettingToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementReusablePolicySetting}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementReusablePolicySetting>> UpdateResponseAsync(DeviceManagementReusablePolicySetting deviceManagementReusablePolicySettingToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementReusablePolicySetting> PutAsync(DeviceManagementReusablePolicySetting deviceManagementReusablePolicySettingToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementReusablePolicySetting>> PutResponseAsync(DeviceManagementReusablePolicySetting deviceManagementReusablePolicySettingToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<DeviceManagementReusablePolicySetting>(deviceManagementReusablePolicySettingToUpdate, cancellationToken);
