...
namespace Microsoft.Graph
{
    ...
    public partial class InformationProtectionRequest : BaseRequest, IInformationProtectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<InformationProtection>> CreateResponseAsync(InformationProtection informationProtectionToCreate)
        {
            return this.CreateResponseAsync(informationProtectionToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{InformationProtection}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<InformationProtection>> CreateResponseAsync(InformationProtection informationProtectionToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<InformationProtection>(informationProtectionToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{InformationProtection}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<InformationProtection>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{InformationProtection}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<InformationProtection>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<InformationProtection>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="informationProtectionToUpdate">The InformationProtection to update.</param>
        /// <returns>The <see cref="GraphResponse{InformationProtection}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<InformationProtection>> UpdateResponseAsync(InformationProtection informationProtectionToUpdate)
        {
            return this.UpdateResponseAsync(informationProtectionToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{InformationProtection}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<InformationProtection>> UpdateResponseAsync(InformationProtection informationProtectionToUpdate, CancellationToken cancellationToken)
        {
			if (informationProtectionToUpdate.AdditionalData != null)
			{
				if (informationProtectionToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<InformationProtection>(informationProtectionToUpdate, cancellationToken).ConfigureAwait(false);
        }
