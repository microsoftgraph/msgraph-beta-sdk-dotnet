...
namespace Microsoft.Graph
{
    ...
    public partial class ColumnDefinitionRequest : BaseRequest, IColumnDefinitionRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<ColumnDefinition> PutAsync(ColumnDefinition columnDefinitionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<ColumnDefinition>> PutResponseAsync(ColumnDefinition columnDefinitionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ColumnDefinition>(columnDefinitionToUpdate, cancellationToken);
