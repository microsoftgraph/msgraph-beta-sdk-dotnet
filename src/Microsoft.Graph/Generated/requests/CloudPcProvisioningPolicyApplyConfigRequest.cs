...
namespace Microsoft.Graph
{
    ...
    {
        /// <summary>
        /// Constructs a new CloudPcProvisioningPolicyApplyConfigRequest.
        /// </summary>
        public CloudPcProvisioningPolicyApplyConfigRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new CloudPcProvisioningPolicyApplyConfigRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public CloudPcProvisioningPolicyApplyConfigRequestBody RequestBody { get; private set; }
        ...
        public ICloudPcProvisioningPolicyApplyConfigRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ICloudPcProvisioningPolicyApplyConfigRequest Select(string value)
        {
