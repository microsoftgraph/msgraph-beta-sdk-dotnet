...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IBaseItemRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IBaseItemRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IBaseItemRequest Request(IEnumerable<Option> options);
