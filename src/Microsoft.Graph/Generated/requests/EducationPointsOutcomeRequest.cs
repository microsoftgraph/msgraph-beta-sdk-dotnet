...
namespace Microsoft.Graph
{
    ...
    public partial class EducationPointsOutcomeRequest : BaseRequest, IEducationPointsOutcomeRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<EducationPointsOutcome> PutAsync(EducationPointsOutcome educationPointsOutcomeToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<EducationPointsOutcome>> PutResponseAsync(EducationPointsOutcome educationPointsOutcomeToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<EducationPointsOutcome>(educationPointsOutcomeToUpdate, cancellationToken);
