...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IUnifiedRoleAssignmentScheduleReferenceRequest : IBaseRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Puts the specified UnifiedRoleAssignmentSchedule reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The UnifiedRoleAssignmentSchedule reference reference to update.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
