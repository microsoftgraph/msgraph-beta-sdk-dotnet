...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type CompanyInformationRequest.
    /// </summary>
    public partial class CompanyInformationRequest : BaseRequest, ICompanyInformationRequest
    {
        /// <summary>
        /// Constructs a new CompanyInformationRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public CompanyInformationRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public async System.Threading.Tasks.Task<CompanyInformation> CreateAsync(CompanyInformation companyInformationToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<CompanyInformation>> CreateResponseAsync(CompanyInformation companyInformationToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<CompanyInformation> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{CompanyInformation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<CompanyInformation>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<CompanyInformation> UpdateAsync(CompanyInformation companyInformationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CompanyInformation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<CompanyInformation>> UpdateResponseAsync(CompanyInformation companyInformationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<CompanyInformation> PutAsync(CompanyInformation companyInformationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<CompanyInformation>> PutResponseAsync(CompanyInformation companyInformationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<CompanyInformation>(companyInformationToUpdate, cancellationToken);
        ...
        public ICompanyInformationRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ICompanyInformationRequest Expand(Expression<Func<CompanyInformation, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ICompanyInformationRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ICompanyInformationRequest Select(Expression<Func<CompanyInformation, object>> selectExpression)
        {
