...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DeviceManagementReportsGetDeviceManagementIntentSettingsReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetDeviceManagementIntentSettingsReportRequest>, IDeviceManagementReportsGetDeviceManagementIntentSettingsReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetDeviceManagementIntentSettingsReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetDeviceManagementIntentSettingsReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetDeviceManagementIntentSettingsReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetDeviceManagementIntentSettingsReportRequest(functionUrl, this.Client, options);
