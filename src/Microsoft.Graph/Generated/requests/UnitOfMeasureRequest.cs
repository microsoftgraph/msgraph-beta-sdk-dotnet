...
namespace Microsoft.Graph
{
    ...
    public partial class UnitOfMeasureRequest : BaseRequest, IUnitOfMeasureRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UnitOfMeasure>> CreateResponseAsync(UnitOfMeasure unitOfMeasureToCreate)
        {
            return this.CreateResponseAsync(unitOfMeasureToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UnitOfMeasure}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UnitOfMeasure>> CreateResponseAsync(UnitOfMeasure unitOfMeasureToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<UnitOfMeasure>(unitOfMeasureToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{UnitOfMeasure}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UnitOfMeasure>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UnitOfMeasure}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UnitOfMeasure>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<UnitOfMeasure>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="unitOfMeasureToUpdate">The UnitOfMeasure to update.</param>
        /// <returns>The <see cref="GraphResponse{UnitOfMeasure}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<UnitOfMeasure>> UpdateResponseAsync(UnitOfMeasure unitOfMeasureToUpdate)
        {
            return this.UpdateResponseAsync(unitOfMeasureToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UnitOfMeasure}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UnitOfMeasure>> UpdateResponseAsync(UnitOfMeasure unitOfMeasureToUpdate, CancellationToken cancellationToken)
        {
			if (unitOfMeasureToUpdate.AdditionalData != null)
			{
				if (unitOfMeasureToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<UnitOfMeasure>(unitOfMeasureToUpdate, cancellationToken).ConfigureAwait(false);
        }
