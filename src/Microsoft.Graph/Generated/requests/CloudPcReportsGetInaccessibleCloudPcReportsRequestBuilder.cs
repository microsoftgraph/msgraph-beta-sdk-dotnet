...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type CloudPcReportsGetInaccessibleCloudPcReportsRequestBuilder.
    /// </summary>
    public partial class CloudPcReportsGetInaccessibleCloudPcReportsRequestBuilder : BaseActionMethodRequestBuilder<ICloudPcReportsGetInaccessibleCloudPcReportsRequest>, ICloudPcReportsGetInaccessibleCloudPcReportsRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="CloudPcReportsGetInaccessibleCloudPcReportsRequestBuilder"/>.
        /// </summary>
        ...
        public CloudPcReportsGetInaccessibleCloudPcReportsRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string filter,
        ...
        protected override ICloudPcReportsGetInaccessibleCloudPcReportsRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new CloudPcReportsGetInaccessibleCloudPcReportsRequest(functionUrl, this.Client, options);
