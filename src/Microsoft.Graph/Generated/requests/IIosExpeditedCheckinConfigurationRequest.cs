...
namespace Microsoft.Graph
{
    ...
    public partial interface IIosExpeditedCheckinConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<IosExpeditedCheckinConfiguration> CreateAsync(IosExpeditedCheckinConfiguration iosExpeditedCheckinConfigurationToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<IosExpeditedCheckinConfiguration>> CreateResponseAsync(IosExpeditedCheckinConfiguration iosExpeditedCheckinConfigurationToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosExpeditedCheckinConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IosExpeditedCheckinConfiguration>> CreateResponseAsync(IosExpeditedCheckinConfiguration iosExpeditedCheckinConfigurationToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="iosExpeditedCheckinConfigurationToUpdate">The IosExpeditedCheckinConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{IosExpeditedCheckinConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IosExpeditedCheckinConfiguration>> UpdateResponseAsync(IosExpeditedCheckinConfiguration iosExpeditedCheckinConfigurationToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosExpeditedCheckinConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IosExpeditedCheckinConfiguration>> UpdateResponseAsync(IosExpeditedCheckinConfiguration iosExpeditedCheckinConfigurationToUpdate, CancellationToken cancellationToken);
