...
namespace Microsoft.Graph
{
    ...
    public partial class ExactMatchDataStoreRequest : BaseRequest, IExactMatchDataStoreRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ExactMatchDataStore>> CreateResponseAsync(ExactMatchDataStore exactMatchDataStoreToCreate)
        {
            return this.CreateResponseAsync(exactMatchDataStoreToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ExactMatchDataStore}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ExactMatchDataStore>> CreateResponseAsync(ExactMatchDataStore exactMatchDataStoreToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<ExactMatchDataStore>(exactMatchDataStoreToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ExactMatchDataStore}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ExactMatchDataStore>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ExactMatchDataStore}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ExactMatchDataStore>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ExactMatchDataStore>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="exactMatchDataStoreToUpdate">The ExactMatchDataStore to update.</param>
        /// <returns>The <see cref="GraphResponse{ExactMatchDataStore}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ExactMatchDataStore>> UpdateResponseAsync(ExactMatchDataStore exactMatchDataStoreToUpdate)
        {
            return this.UpdateResponseAsync(exactMatchDataStoreToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ExactMatchDataStore}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ExactMatchDataStore>> UpdateResponseAsync(ExactMatchDataStore exactMatchDataStoreToUpdate, CancellationToken cancellationToken)
        {
			if (exactMatchDataStoreToUpdate.AdditionalData != null)
			{
				if (exactMatchDataStoreToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ExactMatchDataStore>(exactMatchDataStoreToUpdate, cancellationToken).ConfigureAwait(false);
        }
