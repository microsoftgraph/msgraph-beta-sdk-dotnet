...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidDeviceComplianceLocalActionBaseRequest : BaseRequest, IAndroidDeviceComplianceLocalActionBaseRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceComplianceLocalActionBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidDeviceComplianceLocalActionBase>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidDeviceComplianceLocalActionBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidDeviceComplianceLocalActionBase>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<AndroidDeviceComplianceLocalActionBase>(null, cancellationToken).ConfigureAwait(false);
        }
