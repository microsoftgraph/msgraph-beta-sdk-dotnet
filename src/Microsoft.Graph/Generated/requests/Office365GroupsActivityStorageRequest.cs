...
namespace Microsoft.Graph
{
    ...
    public partial class Office365GroupsActivityStorageRequest : BaseRequest, IOffice365GroupsActivityStorageRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityStorage>> CreateResponseAsync(Office365GroupsActivityStorage office365GroupsActivityStorageToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Office365GroupsActivityStorage}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Office365GroupsActivityStorage>> UpdateResponseAsync(Office365GroupsActivityStorage office365GroupsActivityStorageToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
