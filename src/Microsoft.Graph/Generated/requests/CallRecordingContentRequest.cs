...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type CallRecordingContentRequest.
    /// </summary>
    public partial class CallRecordingContentRequest : BaseRequest, ICallRecordingContentRequest
    {
        /// <summary>
        /// Constructs a new CallRecordingContentRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public CallRecordingContentRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream content, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : CallRecording
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream content, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : CallRecording
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
