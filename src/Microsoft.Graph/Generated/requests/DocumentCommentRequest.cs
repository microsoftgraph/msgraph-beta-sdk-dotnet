...
namespace Microsoft.Graph
{
    ...
    public partial class DocumentCommentRequest : BaseRequest, IDocumentCommentRequest
    {
        ...
        public async System.Threading.Tasks.Task<DocumentComment> CreateAsync(DocumentComment documentCommentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DocumentComment>> CreateResponseAsync(DocumentComment documentCommentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<DocumentComment> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DocumentComment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DocumentComment>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<DocumentComment> UpdateAsync(DocumentComment documentCommentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DocumentComment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DocumentComment>> UpdateResponseAsync(DocumentComment documentCommentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<DocumentComment> PutAsync(DocumentComment documentCommentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<DocumentComment>> PutResponseAsync(DocumentComment documentCommentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<DocumentComment>(documentCommentToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(DocumentComment documentCommentToInitialize)
        {
            ...
            if (documentCommentToInitialize != null && documentCommentToInitialize.AdditionalData != null)
            {
                ...
                if (documentCommentToInitialize.Replies != null && documentCommentToInitialize.Replies.CurrentPage != null)
                {
                    ...
                    if(documentCommentToInitialize.AdditionalData.TryGetValue("replies@odata.nextLink", out var nextPageLink))
                    {
