...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsInformationProtectionAppLockerFileRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WindowsInformationProtectionAppLockerFile> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsInformationProtectionAppLockerFile}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WindowsInformationProtectionAppLockerFile>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<WindowsInformationProtectionAppLockerFile> PutAsync(WindowsInformationProtectionAppLockerFile windowsInformationProtectionAppLockerFileToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<WindowsInformationProtectionAppLockerFile>> PutResponseAsync(WindowsInformationProtectionAppLockerFile windowsInformationProtectionAppLockerFileToUpdate, CancellationToken cancellationToken = default(CancellationToken));
