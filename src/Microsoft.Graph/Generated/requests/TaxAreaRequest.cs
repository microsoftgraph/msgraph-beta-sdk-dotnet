...
namespace Microsoft.Graph
{
    ...
    public partial class TaxAreaRequest : BaseRequest, ITaxAreaRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<TaxArea>> CreateResponseAsync(TaxArea taxAreaToCreate)
        {
            return this.CreateResponseAsync(taxAreaToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TaxArea}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<TaxArea>> CreateResponseAsync(TaxArea taxAreaToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="taxAreaToUpdate">The TaxArea to update.</param>
        /// <returns>The <see cref="GraphResponse{TaxArea}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TaxArea>> UpdateResponseAsync(TaxArea taxAreaToUpdate)
        {
            return this.UpdateResponseAsync(taxAreaToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{TaxArea}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<TaxArea>> UpdateResponseAsync(TaxArea taxAreaToUpdate, CancellationToken cancellationToken)
        {
			if (taxAreaToUpdate.AdditionalData != null)
			{
				if (taxAreaToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
