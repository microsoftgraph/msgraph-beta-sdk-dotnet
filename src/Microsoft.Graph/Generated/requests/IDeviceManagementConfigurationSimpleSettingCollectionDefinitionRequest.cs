...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceManagementConfigurationSimpleSettingCollectionDefinitionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DeviceManagementConfigurationSimpleSettingCollectionDefinition> CreateAsync(DeviceManagementConfigurationSimpleSettingCollectionDefinition deviceManagementConfigurationSimpleSettingCollectionDefinitionToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<DeviceManagementConfigurationSimpleSettingCollectionDefinition> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementConfigurationSimpleSettingCollectionDefinition}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationSimpleSettingCollectionDefinition>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<DeviceManagementConfigurationSimpleSettingCollectionDefinition> UpdateAsync(DeviceManagementConfigurationSimpleSettingCollectionDefinition deviceManagementConfigurationSimpleSettingCollectionDefinitionToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<DeviceManagementConfigurationSimpleSettingCollectionDefinition> PutAsync(DeviceManagementConfigurationSimpleSettingCollectionDefinition deviceManagementConfigurationSimpleSettingCollectionDefinitionToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationSimpleSettingCollectionDefinition>> PutResponseAsync(DeviceManagementConfigurationSimpleSettingCollectionDefinition deviceManagementConfigurationSimpleSettingCollectionDefinitionToUpdate, CancellationToken cancellationToken = default(CancellationToken));
