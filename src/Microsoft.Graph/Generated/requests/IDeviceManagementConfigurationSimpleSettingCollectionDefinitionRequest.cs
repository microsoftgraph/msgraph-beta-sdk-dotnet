...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceManagementConfigurationSimpleSettingCollectionDefinitionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DeviceManagementConfigurationSimpleSettingCollectionDefinition> CreateAsync(DeviceManagementConfigurationSimpleSettingCollectionDefinition deviceManagementConfigurationSimpleSettingCollectionDefinitionToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementConfigurationSimpleSettingCollectionDefinition}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationSimpleSettingCollectionDefinition>> CreateResponseAsync(DeviceManagementConfigurationSimpleSettingCollectionDefinition deviceManagementConfigurationSimpleSettingCollectionDefinitionToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DeviceManagementConfigurationSimpleSettingCollectionDefinition}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationSimpleSettingCollectionDefinition>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementConfigurationSimpleSettingCollectionDefinition}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationSimpleSettingCollectionDefinition>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="deviceManagementConfigurationSimpleSettingCollectionDefinitionToUpdate">The DeviceManagementConfigurationSimpleSettingCollectionDefinition to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementConfigurationSimpleSettingCollectionDefinition}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationSimpleSettingCollectionDefinition>> UpdateResponseAsync(DeviceManagementConfigurationSimpleSettingCollectionDefinition deviceManagementConfigurationSimpleSettingCollectionDefinitionToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementConfigurationSimpleSettingCollectionDefinition}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementConfigurationSimpleSettingCollectionDefinition>> UpdateResponseAsync(DeviceManagementConfigurationSimpleSettingCollectionDefinition deviceManagementConfigurationSimpleSettingCollectionDefinitionToUpdate, CancellationToken cancellationToken);
