...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IOrganizationalBrandingPropertiesFaviconRequest.
    /// </summary>
    public partial interface IOrganizationalBrandingPropertiesFaviconRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream favicon, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties;
        ...
        System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream favicon, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties;
