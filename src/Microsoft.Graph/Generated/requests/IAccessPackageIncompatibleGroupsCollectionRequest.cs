...
namespace Microsoft.Graph
{
    ...
    public partial interface IAccessPackageIncompatibleGroupsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<IAccessPackageIncompatibleGroupsCollectionPage> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        System.Threading.Tasks.Task<IAccessPackageIncompatibleGroupsCollectionPage> GetAsync(CancellationToken cancellationToken);
