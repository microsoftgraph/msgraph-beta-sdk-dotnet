...
namespace Microsoft.Graph
{
    ...
    public partial class EventMessageResponseRequest : BaseRequest, IEventMessageResponseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<EventMessageResponse> PutAsync(EventMessageResponse eventMessageResponseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<EventMessageResponse>> PutResponseAsync(EventMessageResponse eventMessageResponseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<EventMessageResponse>(eventMessageResponseToUpdate, cancellationToken);
