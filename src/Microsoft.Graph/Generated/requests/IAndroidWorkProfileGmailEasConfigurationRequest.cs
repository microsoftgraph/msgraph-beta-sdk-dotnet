...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidWorkProfileGmailEasConfigurationRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<AndroidWorkProfileGmailEasConfiguration> PutAsync(AndroidWorkProfileGmailEasConfiguration androidWorkProfileGmailEasConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidWorkProfileGmailEasConfiguration>> PutResponseAsync(AndroidWorkProfileGmailEasConfiguration androidWorkProfileGmailEasConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
