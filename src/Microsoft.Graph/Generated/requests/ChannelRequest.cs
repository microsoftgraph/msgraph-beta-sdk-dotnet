...
namespace Microsoft.Graph
{
    ...
    public partial class ChannelRequest : BaseRequest, IChannelRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Channel>> CreateResponseAsync(Channel channelToCreate)
        {
            return this.CreateResponseAsync(channelToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Channel}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Channel>> CreateResponseAsync(Channel channelToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="channelToUpdate">The Channel to update.</param>
        /// <returns>The <see cref="GraphResponse{Channel}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Channel>> UpdateResponseAsync(Channel channelToUpdate)
        {
            return this.UpdateResponseAsync(channelToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Channel}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Channel>> UpdateResponseAsync(Channel channelToUpdate, CancellationToken cancellationToken)
        {
			if (channelToUpdate.AdditionalData != null)
			{
				if (channelToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
