...
namespace Microsoft.Graph
{
    ...
    public partial class MacOSSoftwareUpdateConfigurationRequest : BaseRequest, IMacOSSoftwareUpdateConfigurationRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<MacOSSoftwareUpdateConfiguration>> CreateResponseAsync(MacOSSoftwareUpdateConfiguration macOSSoftwareUpdateConfigurationToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MacOSSoftwareUpdateConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MacOSSoftwareUpdateConfiguration>> UpdateResponseAsync(MacOSSoftwareUpdateConfiguration macOSSoftwareUpdateConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
