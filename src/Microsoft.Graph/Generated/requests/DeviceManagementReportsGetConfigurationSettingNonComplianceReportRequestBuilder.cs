...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DeviceManagementReportsGetConfigurationSettingNonComplianceReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetConfigurationSettingNonComplianceReportRequest>, IDeviceManagementReportsGetConfigurationSettingNonComplianceReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetConfigurationSettingNonComplianceReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetConfigurationSettingNonComplianceReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetConfigurationSettingNonComplianceReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetConfigurationSettingNonComplianceReportRequest(functionUrl, this.Client, options);
