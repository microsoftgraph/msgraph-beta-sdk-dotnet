...
namespace Microsoft.Graph
{
    ...
    public partial class DomainSecurityProfileRequest : BaseRequest, IDomainSecurityProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DomainSecurityProfile>> CreateResponseAsync(DomainSecurityProfile domainSecurityProfileToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DomainSecurityProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DomainSecurityProfile>> UpdateResponseAsync(DomainSecurityProfile domainSecurityProfileToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
