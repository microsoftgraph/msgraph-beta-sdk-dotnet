...
namespace Microsoft.Graph
{
    ...
    public partial class DomainSecurityProfileRequest : BaseRequest, IDomainSecurityProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<DomainSecurityProfile> CreateAsync(DomainSecurityProfile domainSecurityProfileToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DomainSecurityProfile>> CreateResponseAsync(DomainSecurityProfile domainSecurityProfileToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<DomainSecurityProfile> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DomainSecurityProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DomainSecurityProfile>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<DomainSecurityProfile> UpdateAsync(DomainSecurityProfile domainSecurityProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DomainSecurityProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DomainSecurityProfile>> UpdateResponseAsync(DomainSecurityProfile domainSecurityProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<DomainSecurityProfile> PutAsync(DomainSecurityProfile domainSecurityProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="domainSecurityProfileToUpdate">The DomainSecurityProfile object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{DomainSecurityProfile}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DomainSecurityProfile>> PutResponseAsync(DomainSecurityProfile domainSecurityProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<DomainSecurityProfile>(domainSecurityProfileToUpdate, cancellationToken);
