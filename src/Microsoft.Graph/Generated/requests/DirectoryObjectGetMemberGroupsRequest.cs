...
namespace Microsoft.Graph
{
    ...
    public partial class DirectoryObjectGetMemberGroupsRequest : BaseRequest, IDirectoryObjectGetMemberGroupsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DirectoryObjectGetMemberGroupsCollectionResponse>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = CoreConstants.HttpMethods.POST.ToString();
            return this.SendAsyncWithGraphResponse<DirectoryObjectGetMemberGroupsCollectionResponse>(this.RequestBody, cancellationToken);
        }
