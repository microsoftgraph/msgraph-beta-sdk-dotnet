...
namespace Microsoft.Graph
{
    ...
    public partial class DirectoryObjectGetMemberGroupsRequest : BaseRequest, IDirectoryObjectGetMemberGroupsRequest
    {
        ...
        public async System.Threading.Tasks.Task<IDirectoryObjectGetMemberGroupsCollectionPage> PostAsync(
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DirectoryObjectGetMemberGroupsCollectionResponse>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DirectoryObjectGetMemberGroupsCollectionResponse>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
