...
namespace Microsoft.Graph
{
    ...
    public partial class MicrosoftStoreForBusinessAppRequest : BaseRequest, IMicrosoftStoreForBusinessAppRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<MicrosoftStoreForBusinessApp> PutAsync(MicrosoftStoreForBusinessApp microsoftStoreForBusinessAppToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="microsoftStoreForBusinessAppToUpdate">The MicrosoftStoreForBusinessApp object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{MicrosoftStoreForBusinessApp}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MicrosoftStoreForBusinessApp>> PutResponseAsync(MicrosoftStoreForBusinessApp microsoftStoreForBusinessAppToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<MicrosoftStoreForBusinessApp>(microsoftStoreForBusinessAppToUpdate, cancellationToken);
