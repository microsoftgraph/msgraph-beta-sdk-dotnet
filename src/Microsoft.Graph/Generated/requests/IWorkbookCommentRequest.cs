...
namespace Microsoft.Graph
{
    ...
    public partial interface IWorkbookCommentRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WorkbookComment> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookComment}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookComment>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<WorkbookComment> PutAsync(WorkbookComment workbookCommentToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<WorkbookComment>> PutResponseAsync(WorkbookComment workbookCommentToUpdate, CancellationToken cancellationToken = default(CancellationToken));
