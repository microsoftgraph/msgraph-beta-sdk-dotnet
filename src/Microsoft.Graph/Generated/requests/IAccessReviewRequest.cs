...
namespace Microsoft.Graph
{
    ...
    public partial interface IAccessReviewRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AccessReview> CreateAsync(AccessReview accessReviewToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<AccessReview>> CreateResponseAsync(AccessReview accessReviewToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<AccessReview> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AccessReview}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AccessReview>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<AccessReview> UpdateAsync(AccessReview accessReviewToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AccessReview}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AccessReview>> UpdateResponseAsync(AccessReview accessReviewToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<AccessReview> PutAsync(AccessReview accessReviewToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="accessReviewToUpdate">The AccessReview object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{AccessReview}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<AccessReview>> PutResponseAsync(AccessReview accessReviewToUpdate, CancellationToken cancellationToken = default);
