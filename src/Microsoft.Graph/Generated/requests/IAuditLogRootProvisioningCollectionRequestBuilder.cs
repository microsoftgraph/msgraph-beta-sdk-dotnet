...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IAuditLogRootProvisioningCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IAuditLogRootProvisioningCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IAuditLogRootProvisioningCollectionRequest Request(IEnumerable<Option> options);
