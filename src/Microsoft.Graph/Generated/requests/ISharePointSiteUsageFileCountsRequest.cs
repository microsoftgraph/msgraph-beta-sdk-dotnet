...
namespace Microsoft.Graph
{
    ...
    public partial interface ISharePointSiteUsageFileCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SharePointSiteUsageFileCounts> CreateAsync(SharePointSiteUsageFileCounts sharePointSiteUsageFileCountsToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<SharePointSiteUsageFileCounts>> CreateResponseAsync(SharePointSiteUsageFileCounts sharePointSiteUsageFileCountsToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SharePointSiteUsageFileCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SharePointSiteUsageFileCounts>> CreateResponseAsync(SharePointSiteUsageFileCounts sharePointSiteUsageFileCountsToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="sharePointSiteUsageFileCountsToUpdate">The SharePointSiteUsageFileCounts to update.</param>
        /// <returns>The <see cref="GraphResponse{SharePointSiteUsageFileCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SharePointSiteUsageFileCounts>> UpdateResponseAsync(SharePointSiteUsageFileCounts sharePointSiteUsageFileCountsToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SharePointSiteUsageFileCounts}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SharePointSiteUsageFileCounts>> UpdateResponseAsync(SharePointSiteUsageFileCounts sharePointSiteUsageFileCountsToUpdate, CancellationToken cancellationToken);
