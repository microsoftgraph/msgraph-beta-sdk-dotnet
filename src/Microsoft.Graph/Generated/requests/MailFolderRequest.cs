...
namespace Microsoft.Graph
{
    ...
    public partial class MailFolderRequest : BaseRequest, IMailFolderRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{MailFolder}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MailFolder>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MailFolder}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MailFolder>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<MailFolder>(null, cancellationToken).ConfigureAwait(false);
        }
