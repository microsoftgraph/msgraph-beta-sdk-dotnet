...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type UserTransitiveReportsCollectionReferencesRequest.
    /// </summary>
    public partial class UserTransitiveReportsCollectionReferencesRequest : BaseRequest, IUserTransitiveReportsCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new UserTransitiveReportsCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public UserTransitiveReportsCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
