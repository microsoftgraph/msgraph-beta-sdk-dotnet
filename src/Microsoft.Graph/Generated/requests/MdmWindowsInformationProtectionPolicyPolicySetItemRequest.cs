...
namespace Microsoft.Graph
{
    ...
    public partial class MdmWindowsInformationProtectionPolicyPolicySetItemRequest : BaseRequest, IMdmWindowsInformationProtectionPolicyPolicySetItemRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MdmWindowsInformationProtectionPolicyPolicySetItem>> CreateResponseAsync(MdmWindowsInformationProtectionPolicyPolicySetItem mdmWindowsInformationProtectionPolicyPolicySetItemToCreate)
        {
            return this.CreateResponseAsync(mdmWindowsInformationProtectionPolicyPolicySetItemToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MdmWindowsInformationProtectionPolicyPolicySetItem}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MdmWindowsInformationProtectionPolicyPolicySetItem>> CreateResponseAsync(MdmWindowsInformationProtectionPolicyPolicySetItem mdmWindowsInformationProtectionPolicyPolicySetItemToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<MdmWindowsInformationProtectionPolicyPolicySetItem>(mdmWindowsInformationProtectionPolicyPolicySetItemToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{MdmWindowsInformationProtectionPolicyPolicySetItem}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MdmWindowsInformationProtectionPolicyPolicySetItem>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MdmWindowsInformationProtectionPolicyPolicySetItem}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MdmWindowsInformationProtectionPolicyPolicySetItem>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<MdmWindowsInformationProtectionPolicyPolicySetItem>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="mdmWindowsInformationProtectionPolicyPolicySetItemToUpdate">The MdmWindowsInformationProtectionPolicyPolicySetItem to update.</param>
        /// <returns>The <see cref="GraphResponse{MdmWindowsInformationProtectionPolicyPolicySetItem}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MdmWindowsInformationProtectionPolicyPolicySetItem>> UpdateResponseAsync(MdmWindowsInformationProtectionPolicyPolicySetItem mdmWindowsInformationProtectionPolicyPolicySetItemToUpdate)
        {
            return this.UpdateResponseAsync(mdmWindowsInformationProtectionPolicyPolicySetItemToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MdmWindowsInformationProtectionPolicyPolicySetItem}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MdmWindowsInformationProtectionPolicyPolicySetItem>> UpdateResponseAsync(MdmWindowsInformationProtectionPolicyPolicySetItem mdmWindowsInformationProtectionPolicyPolicySetItemToUpdate, CancellationToken cancellationToken)
        {
			if (mdmWindowsInformationProtectionPolicyPolicySetItemToUpdate.AdditionalData != null)
			{
				if (mdmWindowsInformationProtectionPolicyPolicySetItemToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<MdmWindowsInformationProtectionPolicyPolicySetItem>(mdmWindowsInformationProtectionPolicyPolicySetItemToUpdate, cancellationToken).ConfigureAwait(false);
        }
