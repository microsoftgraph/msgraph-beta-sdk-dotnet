...
namespace Microsoft.Graph
{
    ...
    public partial interface IWorkbookChartPointItemAtRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<WorkbookChartPoint>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="workbookchartpoint">The WorkbookChartPoint object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookChartPoint>> PatchResponseAsync(WorkbookChartPoint workbookchartpoint, CancellationToken cancellationToken = default);
        ...
        /// <param name="workbookchartpoint">The WorkbookChartPoint object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookChartPoint>> PutResponseAsync(WorkbookChartPoint workbookchartpoint, CancellationToken cancellationToken = default);
