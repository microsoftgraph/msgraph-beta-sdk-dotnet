...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ChatMarkChatReadForUserRequest : BaseRequest, IChatMarkChatReadForUserRequest
    {
        /// <summary>
        /// Constructs a new ChatMarkChatReadForUserRequest.
        /// </summary>
        public ChatMarkChatReadForUserRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new ChatMarkChatReadForUserRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public ChatMarkChatReadForUserRequestBody RequestBody { get; private set; }
        ...
        public IChatMarkChatReadForUserRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IChatMarkChatReadForUserRequest Select(string value)
        {
