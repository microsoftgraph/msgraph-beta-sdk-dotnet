...
namespace Microsoft.Graph
{
    ...
    public partial class OrganizationalBrandingPropertiesBackgroundImageRequest : BaseRequest, IOrganizationalBrandingPropertiesBackgroundImageRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream backgroundImage) where T : OrganizationalBrandingProperties
        {
            return this.PutResponseAsync<T>(backgroundImage, CancellationToken.None);
        }
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The <see cref="GraphResponse"/> object returned by the PUT call.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream backgroundImage, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
            this.ContentType = "application/octet-stream";
            this.Method = "PUT";
