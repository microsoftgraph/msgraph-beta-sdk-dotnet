...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class OrganizationalBrandingPropertiesBackgroundImageRequest : BaseRequest, IOrganizationalBrandingPropertiesBackgroundImageRequest
    {
        /// <summary>
        ...
        /// </summary>
        public OrganizationalBrandingPropertiesBackgroundImageRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream backgroundImage, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream backgroundImage, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<T>(backgroundImage, cancellationToken, completionOption).ConfigureAwait(false);
        }
