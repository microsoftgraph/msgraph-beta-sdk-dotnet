...
namespace Microsoft.Graph
{
    ...
    public partial class OrganizationalBrandingPropertiesBackgroundImageRequest : BaseRequest, IOrganizationalBrandingPropertiesBackgroundImageRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream backgroundImage, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBrandingProperties
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = Constants.HttpMethods.PUT.ToString();
