...
namespace Microsoft.Graph
{
    ...
    public partial class CredentialUsageSummaryRequest : BaseRequest, ICredentialUsageSummaryRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<CredentialUsageSummary>> CreateResponseAsync(CredentialUsageSummary credentialUsageSummaryToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CredentialUsageSummary}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<CredentialUsageSummary>> UpdateResponseAsync(CredentialUsageSummary credentialUsageSummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
