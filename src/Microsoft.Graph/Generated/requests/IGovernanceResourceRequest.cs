...
namespace Microsoft.Graph
{
    ...
    public partial interface IGovernanceResourceRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GovernanceResource> CreateAsync(GovernanceResource governanceResourceToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<GovernanceResource>> CreateResponseAsync(GovernanceResource governanceResourceToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GovernanceResource> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GovernanceResource}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<GovernanceResource>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GovernanceResource> UpdateAsync(GovernanceResource governanceResourceToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{GovernanceResource}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<GovernanceResource>> UpdateResponseAsync(GovernanceResource governanceResourceToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<GovernanceResource> PutAsync(GovernanceResource governanceResourceToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<GovernanceResource>> PutResponseAsync(GovernanceResource governanceResourceToUpdate, CancellationToken cancellationToken = default);
