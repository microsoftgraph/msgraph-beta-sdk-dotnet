...
namespace Microsoft.Graph
{
    ...
    public partial interface IGovernancePolicyTemplateRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GovernancePolicyTemplate> CreateAsync(GovernancePolicyTemplate governancePolicyTemplateToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<GovernancePolicyTemplate>> CreateResponseAsync(GovernancePolicyTemplate governancePolicyTemplateToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GovernancePolicyTemplate}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<GovernancePolicyTemplate>> CreateResponseAsync(GovernancePolicyTemplate governancePolicyTemplateToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="governancePolicyTemplateToUpdate">The GovernancePolicyTemplate to update.</param>
        /// <returns>The <see cref="GraphResponse{GovernancePolicyTemplate}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<GovernancePolicyTemplate>> UpdateResponseAsync(GovernancePolicyTemplate governancePolicyTemplateToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{GovernancePolicyTemplate}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<GovernancePolicyTemplate>> UpdateResponseAsync(GovernancePolicyTemplate governancePolicyTemplateToUpdate, CancellationToken cancellationToken);
