...
namespace Microsoft.Graph
{
    ...
    public partial class SubscribeToToneOperationRequest : BaseRequest, ISubscribeToToneOperationRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{SubscribeToToneOperation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SubscribeToToneOperation>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SubscribeToToneOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SubscribeToToneOperation>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<SubscribeToToneOperation>(null, cancellationToken).ConfigureAwait(false);
        }
