...
namespace Microsoft.Graph
{
    ...
    public partial class ConnectorGroupRequest : BaseRequest, IConnectorGroupRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<ConnectorGroup> PutAsync(ConnectorGroup connectorGroupToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="connectorGroupToUpdate">The ConnectorGroup object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{ConnectorGroup}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ConnectorGroup>> PutResponseAsync(ConnectorGroup connectorGroupToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ConnectorGroup>(connectorGroupToUpdate, cancellationToken);
