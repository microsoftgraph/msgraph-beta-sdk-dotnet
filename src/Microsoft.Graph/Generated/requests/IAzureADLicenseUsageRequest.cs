...
namespace Microsoft.Graph
{
    ...
    public partial interface IAzureADLicenseUsageRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AzureADLicenseUsage> CreateAsync(AzureADLicenseUsage azureADLicenseUsageToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<AzureADLicenseUsage>> CreateResponseAsync(AzureADLicenseUsage azureADLicenseUsageToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AzureADLicenseUsage}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AzureADLicenseUsage>> CreateResponseAsync(AzureADLicenseUsage azureADLicenseUsageToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AzureADLicenseUsage}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AzureADLicenseUsage>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AzureADLicenseUsage}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AzureADLicenseUsage>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="azureADLicenseUsageToUpdate">The AzureADLicenseUsage to update.</param>
        /// <returns>The <see cref="GraphResponse{AzureADLicenseUsage}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AzureADLicenseUsage>> UpdateResponseAsync(AzureADLicenseUsage azureADLicenseUsageToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AzureADLicenseUsage}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AzureADLicenseUsage>> UpdateResponseAsync(AzureADLicenseUsage azureADLicenseUsageToUpdate, CancellationToken cancellationToken);
