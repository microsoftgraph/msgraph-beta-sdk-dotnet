...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IUnifiedRoleScheduleInstanceBaseRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IUnifiedRoleScheduleInstanceBaseRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IUnifiedRoleScheduleInstanceBaseRequest Request(IEnumerable<Option> options);
