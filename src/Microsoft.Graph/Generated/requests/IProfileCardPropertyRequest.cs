...
namespace Microsoft.Graph
{
    ...
    public partial interface IProfileCardPropertyRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ProfileCardProperty> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ProfileCardProperty}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ProfileCardProperty>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
