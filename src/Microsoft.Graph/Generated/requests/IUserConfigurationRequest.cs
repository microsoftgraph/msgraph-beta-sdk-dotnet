...
namespace Microsoft.Graph
{
    ...
    public partial interface IUserConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<UserConfiguration> CreateAsync(UserConfiguration userConfigurationToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<UserConfiguration>> CreateResponseAsync(UserConfiguration userConfigurationToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<UserConfiguration> GetAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UserConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UserConfiguration>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<UserConfiguration> UpdateAsync(UserConfiguration userConfigurationToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UserConfiguration>> UpdateResponseAsync(UserConfiguration userConfigurationToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<UserConfiguration> PutAsync(UserConfiguration userConfigurationToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<UserConfiguration>> PutResponseAsync(UserConfiguration userConfigurationToUpdate, CancellationToken cancellationToken = default);
