...
namespace Microsoft.Graph
{
    ...
    public partial class SiteGetApplicableContentTypesForListRequest : BaseRequest, ISiteGetApplicableContentTypesForListRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SiteGetApplicableContentTypesForListCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="contenttype">The ContentType object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<SiteGetApplicableContentTypesForListCollectionResponse>> PatchResponseAsync(ContentType contenttype, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="contenttype">The ContentType object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<SiteGetApplicableContentTypesForListCollectionResponse>> PutResponseAsync(ContentType contenttype, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SiteGetApplicableContentTypesForListCollectionResponse>(contenttype, cancellationToken);
        }
