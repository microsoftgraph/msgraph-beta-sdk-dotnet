...
namespace Microsoft.Graph
{
    ...
    public partial interface IExactMatchDataStoreRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ExactMatchDataStore> CreateAsync(ExactMatchDataStore exactMatchDataStoreToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<ExactMatchDataStore>> CreateResponseAsync(ExactMatchDataStore exactMatchDataStoreToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ExactMatchDataStore}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ExactMatchDataStore>> CreateResponseAsync(ExactMatchDataStore exactMatchDataStoreToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="exactMatchDataStoreToUpdate">The ExactMatchDataStore to update.</param>
        /// <returns>The <see cref="GraphResponse{ExactMatchDataStore}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ExactMatchDataStore>> UpdateResponseAsync(ExactMatchDataStore exactMatchDataStoreToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ExactMatchDataStore}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ExactMatchDataStore>> UpdateResponseAsync(ExactMatchDataStore exactMatchDataStoreToUpdate, CancellationToken cancellationToken);
