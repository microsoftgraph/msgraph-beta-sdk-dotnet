...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class PrintConnectorReferenceRequest : BaseRequest, IPrintConnectorReferenceRequest
    {
        /// <summary>
        ...
        public PrintConnectorReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Puts the specified PrintConnector reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The PrintConnector reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
