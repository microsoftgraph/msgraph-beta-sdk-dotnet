...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceComanagementAuthorityConfigurationRequest : BaseRequest, IDeviceComanagementAuthorityConfigurationRequest
    {
        ...
        public async System.Threading.Tasks.Task<DeviceComanagementAuthorityConfiguration> CreateAsync(DeviceComanagementAuthorityConfiguration deviceComanagementAuthorityConfigurationToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceComanagementAuthorityConfiguration>> CreateResponseAsync(DeviceComanagementAuthorityConfiguration deviceComanagementAuthorityConfigurationToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<DeviceComanagementAuthorityConfiguration> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceComanagementAuthorityConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceComanagementAuthorityConfiguration>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<DeviceComanagementAuthorityConfiguration> UpdateAsync(DeviceComanagementAuthorityConfiguration deviceComanagementAuthorityConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceComanagementAuthorityConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceComanagementAuthorityConfiguration>> UpdateResponseAsync(DeviceComanagementAuthorityConfiguration deviceComanagementAuthorityConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<DeviceComanagementAuthorityConfiguration> PutAsync(DeviceComanagementAuthorityConfiguration deviceComanagementAuthorityConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="deviceComanagementAuthorityConfigurationToUpdate">The DeviceComanagementAuthorityConfiguration object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{DeviceComanagementAuthorityConfiguration}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceComanagementAuthorityConfiguration>> PutResponseAsync(DeviceComanagementAuthorityConfiguration deviceComanagementAuthorityConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<DeviceComanagementAuthorityConfiguration>(deviceComanagementAuthorityConfigurationToUpdate, cancellationToken);
