...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsOct2BinRequest : BaseRequest, IWorkbookFunctionsOct2BinRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsOct2BinRequest.
        /// </summary>
        public WorkbookFunctionsOct2BinRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsOct2BinRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsOct2BinRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsOct2BinRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsOct2BinRequest Select(string value)
        {
