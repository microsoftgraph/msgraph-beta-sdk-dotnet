...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsCeiling_PreciseRequest : BaseRequest, IWorkbookFunctionsCeiling_PreciseRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsCeiling_PreciseRequest.
        /// </summary>
        public WorkbookFunctionsCeiling_PreciseRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsCeiling_PreciseRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsCeiling_PreciseRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsCeiling_PreciseRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsCeiling_PreciseRequest Select(string value)
        {
