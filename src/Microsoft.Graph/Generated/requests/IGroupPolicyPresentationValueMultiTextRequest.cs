...
namespace Microsoft.Graph
{
    ...
    public partial interface IGroupPolicyPresentationValueMultiTextRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<GroupPolicyPresentationValueMultiText> PutAsync(GroupPolicyPresentationValueMultiText groupPolicyPresentationValueMultiTextToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationValueMultiText>> PutResponseAsync(GroupPolicyPresentationValueMultiText groupPolicyPresentationValueMultiTextToUpdate, CancellationToken cancellationToken = default(CancellationToken));
