...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IServicePrincipalCreationPolicyIncludesCollectionRequestBuilder.
    /// </summary>
    public partial interface IServicePrincipalCreationPolicyIncludesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IServicePrincipalCreationPolicyIncludesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IServicePrincipalCreationPolicyIncludesCollectionRequest Request(IEnumerable<Option> options);
