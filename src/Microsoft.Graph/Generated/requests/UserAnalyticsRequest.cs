...
namespace Microsoft.Graph
{
    ...
    public partial class UserAnalyticsRequest : BaseRequest, IUserAnalyticsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<UserAnalytics>> CreateResponseAsync(UserAnalytics userAnalyticsToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UserAnalytics}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<UserAnalytics>> UpdateResponseAsync(UserAnalytics userAnalyticsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
