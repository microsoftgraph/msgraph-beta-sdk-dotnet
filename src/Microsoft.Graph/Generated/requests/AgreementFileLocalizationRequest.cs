...
namespace Microsoft.Graph
{
    ...
    public partial class AgreementFileLocalizationRequest : BaseRequest, IAgreementFileLocalizationRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<AgreementFileLocalization> PutAsync(AgreementFileLocalization agreementFileLocalizationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<AgreementFileLocalization>> PutResponseAsync(AgreementFileLocalization agreementFileLocalizationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<AgreementFileLocalization>(agreementFileLocalizationToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(AgreementFileLocalization agreementFileLocalizationToInitialize)
        {
            ...
            if (agreementFileLocalizationToInitialize != null && agreementFileLocalizationToInitialize.AdditionalData != null)
            {
                ...
                if (agreementFileLocalizationToInitialize.Versions != null && agreementFileLocalizationToInitialize.Versions.CurrentPage != null)
                {
                    ...
                    if(agreementFileLocalizationToInitialize.AdditionalData.TryGetValue("versions@odata.nextLink", out var nextPageLink))
                    {
