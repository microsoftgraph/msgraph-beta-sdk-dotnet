...
namespace Microsoft.Graph
{
    ...
    public partial interface IContentTypeRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<ContentType> PutAsync(ContentType contentTypeToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<ContentType>> PutResponseAsync(ContentType contentTypeToUpdate, CancellationToken cancellationToken = default(CancellationToken));
