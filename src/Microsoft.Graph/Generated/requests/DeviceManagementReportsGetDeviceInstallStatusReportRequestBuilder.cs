...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetDeviceInstallStatusReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetDeviceInstallStatusReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetDeviceInstallStatusReportRequest>, IDeviceManagementReportsGetDeviceInstallStatusReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetDeviceInstallStatusReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetDeviceInstallStatusReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetDeviceInstallStatusReportRequest(functionUrl, this.Client, options);
