...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetYammerActivityCountsRequest : BaseRequest, IReportRootGetYammerActivityCountsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerActivityCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.Get;
        ...
        /// <param name="yammeractivitysummary">The YammerActivitySummary object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerActivityCountsCollectionResponse>> PatchResponseAsync(YammerActivitySummary yammeractivitysummary, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.Patch;
        ...
        /// <param name="yammeractivitysummary">The YammerActivitySummary object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerActivityCountsCollectionResponse>> PutResponseAsync(YammerActivitySummary yammeractivitysummary, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.Put;
            return this.SendAsyncWithGraphResponse<ReportRootGetYammerActivityCountsCollectionResponse>(yammeractivitysummary, cancellationToken);
        }
