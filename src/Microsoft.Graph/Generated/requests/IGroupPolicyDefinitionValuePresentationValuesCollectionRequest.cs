...
namespace Microsoft.Graph
{
    ...
    public partial interface IGroupPolicyDefinitionValuePresentationValuesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationValue>> AddResponseAsync(GroupPolicyPresentationValue groupPolicyPresentationValue);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationValue}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationValue>> AddResponseAsync(GroupPolicyPresentationValue groupPolicyPresentationValue, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<GroupPolicyDefinitionValuePresentationValuesCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyDefinitionValuePresentationValuesCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<GroupPolicyDefinitionValuePresentationValuesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
