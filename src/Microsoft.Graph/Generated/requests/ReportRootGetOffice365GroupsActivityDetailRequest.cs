...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetOffice365GroupsActivityDetailRequest : BaseRequest, IReportRootGetOffice365GroupsActivityDetailRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityDetailCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="office365groupsactivitydetail">The Office365GroupsActivityDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityDetailCollectionResponse>> PatchResponseAsync(Office365GroupsActivityDetail office365groupsactivitydetail, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="office365groupsactivitydetail">The Office365GroupsActivityDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365GroupsActivityDetailCollectionResponse>> PutResponseAsync(Office365GroupsActivityDetail office365groupsactivitydetail, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetOffice365GroupsActivityDetailCollectionResponse>(office365groupsactivitydetail, cancellationToken);
        }
