...
namespace Microsoft.Graph
{
    ...
    public partial class AppleVpnConfigurationRequest : BaseRequest, IAppleVpnConfigurationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AppleVpnConfiguration>> CreateResponseAsync(AppleVpnConfiguration appleVpnConfigurationToCreate)
        {
            return this.CreateResponseAsync(appleVpnConfigurationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AppleVpnConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AppleVpnConfiguration>> CreateResponseAsync(AppleVpnConfiguration appleVpnConfigurationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<AppleVpnConfiguration>(appleVpnConfigurationToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AppleVpnConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AppleVpnConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AppleVpnConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AppleVpnConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<AppleVpnConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="appleVpnConfigurationToUpdate">The AppleVpnConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{AppleVpnConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AppleVpnConfiguration>> UpdateResponseAsync(AppleVpnConfiguration appleVpnConfigurationToUpdate)
        {
            return this.UpdateResponseAsync(appleVpnConfigurationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AppleVpnConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AppleVpnConfiguration>> UpdateResponseAsync(AppleVpnConfiguration appleVpnConfigurationToUpdate, CancellationToken cancellationToken)
        {
			if (appleVpnConfigurationToUpdate.AdditionalData != null)
			{
				if (appleVpnConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<AppleVpnConfiguration>(appleVpnConfigurationToUpdate, cancellationToken).ConfigureAwait(false);
        }
