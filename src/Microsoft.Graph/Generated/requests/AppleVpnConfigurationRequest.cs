...
namespace Microsoft.Graph
{
    ...
    public partial class AppleVpnConfigurationRequest : BaseRequest, IAppleVpnConfigurationRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<AppleVpnConfiguration>> CreateResponseAsync(AppleVpnConfiguration appleVpnConfigurationToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AppleVpnConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AppleVpnConfiguration>> UpdateResponseAsync(AppleVpnConfiguration appleVpnConfigurationToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
