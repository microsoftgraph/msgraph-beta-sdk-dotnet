...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class UnifiedRoleAssignmentScheduleReferenceRequest : BaseRequest, IUnifiedRoleAssignmentScheduleReferenceRequest
    {
        /// <summary>
        ...
        public UnifiedRoleAssignmentScheduleReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified UnifiedRoleAssignmentSchedule reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified UnifiedRoleAssignmentSchedule reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The UnifiedRoleAssignmentSchedule reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
