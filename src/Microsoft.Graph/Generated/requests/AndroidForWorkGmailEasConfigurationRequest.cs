...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidForWorkGmailEasConfigurationRequest : BaseRequest, IAndroidForWorkGmailEasConfigurationRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkGmailEasConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkGmailEasConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkGmailEasConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidForWorkGmailEasConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<AndroidForWorkGmailEasConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
