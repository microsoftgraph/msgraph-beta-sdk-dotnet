...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidForWorkGmailEasConfigurationRequest : BaseRequest, IAndroidForWorkGmailEasConfigurationRequest
    {
        ...
        public async System.Threading.Tasks.Task<AndroidForWorkGmailEasConfiguration> CreateAsync(AndroidForWorkGmailEasConfiguration androidForWorkGmailEasConfigurationToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkGmailEasConfiguration>> CreateResponseAsync(AndroidForWorkGmailEasConfiguration androidForWorkGmailEasConfigurationToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<AndroidForWorkGmailEasConfiguration>(androidForWorkGmailEasConfigurationToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<AndroidForWorkGmailEasConfiguration> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkGmailEasConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkGmailEasConfiguration>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<AndroidForWorkGmailEasConfiguration>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<AndroidForWorkGmailEasConfiguration> UpdateAsync(AndroidForWorkGmailEasConfiguration androidForWorkGmailEasConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkGmailEasConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkGmailEasConfiguration>> UpdateResponseAsync(AndroidForWorkGmailEasConfiguration androidForWorkGmailEasConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<AndroidForWorkGmailEasConfiguration>(androidForWorkGmailEasConfigurationToUpdate, cancellationToken);
        }

        /// <summary>
        /// Updates the specified AndroidForWorkGmailEasConfiguration using PUT.
        /// </summary>
        /// <param name="androidForWorkGmailEasConfigurationToUpdate">The AndroidForWorkGmailEasConfiguration object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<AndroidForWorkGmailEasConfiguration> PutAsync(AndroidForWorkGmailEasConfiguration androidForWorkGmailEasConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <summary>
        /// Updates the specified AndroidForWorkGmailEasConfiguration using PUT and returns a <see cref="GraphResponse{AndroidForWorkGmailEasConfiguration}"/> object.
        /// </summary>
        /// <param name="androidForWorkGmailEasConfigurationToUpdate">The AndroidForWorkGmailEasConfiguration object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{AndroidForWorkGmailEasConfiguration}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidForWorkGmailEasConfiguration>> PutResponseAsync(AndroidForWorkGmailEasConfiguration androidForWorkGmailEasConfigurationToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<AndroidForWorkGmailEasConfiguration>(androidForWorkGmailEasConfigurationToUpdate, cancellationToken);
