...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type CallTranscriptMetadataContentRequest.
    /// </summary>
    public partial class CallTranscriptMetadataContentRequest : BaseRequest, ICallTranscriptMetadataContentRequest
    {
        /// <summary>
        /// Constructs a new CallTranscriptMetadataContentRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public CallTranscriptMetadataContentRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <param name="metadataContent">The stream to PUT.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream metadataContent, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : CallTranscript
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
            return this.SendAsync<T>(metadataContent, cancellationToken, completionOption);
        }
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream metadataContent, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : CallTranscript
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<T>(metadataContent, cancellationToken, completionOption);
        }
