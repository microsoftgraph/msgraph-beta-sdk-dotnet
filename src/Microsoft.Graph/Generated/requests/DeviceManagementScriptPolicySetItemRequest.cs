...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementScriptPolicySetItemRequest : BaseRequest, IDeviceManagementScriptPolicySetItemRequest
    {
        ...
        public async System.Threading.Tasks.Task<DeviceManagementScriptPolicySetItem> CreateAsync(DeviceManagementScriptPolicySetItem deviceManagementScriptPolicySetItemToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementScriptPolicySetItem>> CreateResponseAsync(DeviceManagementScriptPolicySetItem deviceManagementScriptPolicySetItemToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<DeviceManagementScriptPolicySetItem> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementScriptPolicySetItem}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementScriptPolicySetItem>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<DeviceManagementScriptPolicySetItem> UpdateAsync(DeviceManagementScriptPolicySetItem deviceManagementScriptPolicySetItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementScriptPolicySetItem}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementScriptPolicySetItem>> UpdateResponseAsync(DeviceManagementScriptPolicySetItem deviceManagementScriptPolicySetItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementScriptPolicySetItem> PutAsync(DeviceManagementScriptPolicySetItem deviceManagementScriptPolicySetItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementScriptPolicySetItem>> PutResponseAsync(DeviceManagementScriptPolicySetItem deviceManagementScriptPolicySetItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<DeviceManagementScriptPolicySetItem>(deviceManagementScriptPolicySetItemToUpdate, cancellationToken);
