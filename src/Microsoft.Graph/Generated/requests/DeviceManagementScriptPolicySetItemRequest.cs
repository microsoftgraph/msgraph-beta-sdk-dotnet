...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementScriptPolicySetItemRequest : BaseRequest, IDeviceManagementScriptPolicySetItemRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementScriptPolicySetItem>> CreateResponseAsync(DeviceManagementScriptPolicySetItem deviceManagementScriptPolicySetItemToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementScriptPolicySetItem}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementScriptPolicySetItem>> UpdateResponseAsync(DeviceManagementScriptPolicySetItem deviceManagementScriptPolicySetItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
