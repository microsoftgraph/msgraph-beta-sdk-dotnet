...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IAccessPackageAccessPackagesIncompatibleWithCollectionReferencesRequest : IBaseRequest
    {
        /// <summary>
        ...
        System.Threading.Tasks.Task AddAsync(ReferenceRequestBody accessPackageReference, CancellationToken cancellationToken = default);
        ...
        /// <param name="accessPackageReference">The ReferenceRequestBody to add.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        System.Threading.Tasks.Task<GraphResponse> AddResponseAsync(ReferenceRequestBody accessPackageReference, CancellationToken cancellationToken = default);
