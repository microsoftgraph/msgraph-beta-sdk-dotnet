...
namespace Microsoft.Graph
{
    ...
    public partial class ChatInstalledAppsCollectionRequest : BaseRequest, IChatInstalledAppsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ChatInstalledAppsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ChatInstalledAppsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
