...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsAutopilotDeploymentProfileRequest : BaseRequest, IWindowsAutopilotDeploymentProfileRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WindowsAutopilotDeploymentProfile>> CreateResponseAsync(WindowsAutopilotDeploymentProfile windowsAutopilotDeploymentProfileToCreate)
        {
            return this.CreateResponseAsync(windowsAutopilotDeploymentProfileToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsAutopilotDeploymentProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsAutopilotDeploymentProfile>> CreateResponseAsync(WindowsAutopilotDeploymentProfile windowsAutopilotDeploymentProfileToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<WindowsAutopilotDeploymentProfile>(windowsAutopilotDeploymentProfileToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WindowsAutopilotDeploymentProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsAutopilotDeploymentProfile>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsAutopilotDeploymentProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsAutopilotDeploymentProfile>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WindowsAutopilotDeploymentProfile>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="windowsAutopilotDeploymentProfileToUpdate">The WindowsAutopilotDeploymentProfile to update.</param>
        /// <returns>The <see cref="GraphResponse{WindowsAutopilotDeploymentProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsAutopilotDeploymentProfile>> UpdateResponseAsync(WindowsAutopilotDeploymentProfile windowsAutopilotDeploymentProfileToUpdate)
        {
            return this.UpdateResponseAsync(windowsAutopilotDeploymentProfileToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsAutopilotDeploymentProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsAutopilotDeploymentProfile>> UpdateResponseAsync(WindowsAutopilotDeploymentProfile windowsAutopilotDeploymentProfileToUpdate, CancellationToken cancellationToken)
        {
			if (windowsAutopilotDeploymentProfileToUpdate.AdditionalData != null)
			{
				if (windowsAutopilotDeploymentProfileToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<WindowsAutopilotDeploymentProfile>(windowsAutopilotDeploymentProfileToUpdate, cancellationToken).ConfigureAwait(false);
        }
