...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type BulkUploadContentRequest.
    /// </summary>
    public partial class BulkUploadContentRequest : BaseRequest, IBulkUploadContentRequest
    {
        /// <summary>
        /// Constructs a new BulkUploadContentRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public BulkUploadContentRequest(
            string requestUrl,
            IBaseClient client,
