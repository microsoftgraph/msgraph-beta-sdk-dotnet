...
namespace Microsoft.Graph
{
    ...
    public partial interface IUnitOfMeasureRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<UnitOfMeasure> PutAsync(UnitOfMeasure unitOfMeasureToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<UnitOfMeasure>> PutResponseAsync(UnitOfMeasure unitOfMeasureToUpdate, CancellationToken cancellationToken = default(CancellationToken));
