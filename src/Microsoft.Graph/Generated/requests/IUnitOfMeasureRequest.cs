...
namespace Microsoft.Graph
{
    ...
    public partial interface IUnitOfMeasureRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<UnitOfMeasure> CreateAsync(UnitOfMeasure unitOfMeasureToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<UnitOfMeasure>> CreateResponseAsync(UnitOfMeasure unitOfMeasureToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UnitOfMeasure}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnitOfMeasure>> CreateResponseAsync(UnitOfMeasure unitOfMeasureToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{UnitOfMeasure}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnitOfMeasure>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{UnitOfMeasure}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnitOfMeasure>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="unitOfMeasureToUpdate">The UnitOfMeasure to update.</param>
        /// <returns>The <see cref="GraphResponse{UnitOfMeasure}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnitOfMeasure>> UpdateResponseAsync(UnitOfMeasure unitOfMeasureToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{UnitOfMeasure}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<UnitOfMeasure>> UpdateResponseAsync(UnitOfMeasure unitOfMeasureToUpdate, CancellationToken cancellationToken);
