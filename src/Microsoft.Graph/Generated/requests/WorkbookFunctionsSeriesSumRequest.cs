...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsSeriesSumRequest : BaseRequest, IWorkbookFunctionsSeriesSumRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsSeriesSumRequest.
        /// </summary>
        public WorkbookFunctionsSeriesSumRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsSeriesSumRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsSeriesSumRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsSeriesSumRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsSeriesSumRequest Select(string value)
        {
