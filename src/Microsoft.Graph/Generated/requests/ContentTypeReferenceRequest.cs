...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ContentTypeReferenceRequest : BaseRequest, IContentTypeReferenceRequest
    {
        /// <summary>
        ...
        public ContentTypeReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Puts the specified ContentType reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The ContentType reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
