...
namespace Microsoft.Graph
{
    ...
    public partial interface ISynchronizationSchemaRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<SynchronizationSchema> PutAsync(SynchronizationSchema synchronizationSchemaToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<SynchronizationSchema>> PutResponseAsync(SynchronizationSchema synchronizationSchemaToUpdate, CancellationToken cancellationToken = default(CancellationToken));
