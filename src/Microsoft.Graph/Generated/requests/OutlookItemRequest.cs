...
namespace Microsoft.Graph
{
    ...
    public partial class OutlookItemRequest : BaseRequest, IOutlookItemRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<OutlookItem> PutAsync(OutlookItem outlookItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="outlookItemToUpdate">The OutlookItem object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{OutlookItem}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OutlookItem>> PutResponseAsync(OutlookItem outlookItemToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<OutlookItem>(outlookItemToUpdate, cancellationToken);
