...
namespace Microsoft.Graph
{
    ...
    public partial interface ITodoTaskRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<TodoTask> PutAsync(TodoTask todoTaskToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<TodoTask>> PutResponseAsync(TodoTask todoTaskToUpdate, CancellationToken cancellationToken = default(CancellationToken));
