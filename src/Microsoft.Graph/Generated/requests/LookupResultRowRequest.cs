...
namespace Microsoft.Graph
{
    ...
    public partial class LookupResultRowRequest : BaseRequest, ILookupResultRowRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{LookupResultRow}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<LookupResultRow>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{LookupResultRow}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<LookupResultRow>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<LookupResultRow>(null, cancellationToken).ConfigureAwait(false);
        }
