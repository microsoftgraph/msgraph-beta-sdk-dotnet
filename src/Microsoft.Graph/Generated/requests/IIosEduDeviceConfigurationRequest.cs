...
namespace Microsoft.Graph
{
    ...
    public partial interface IIosEduDeviceConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<IosEduDeviceConfiguration> CreateAsync(IosEduDeviceConfiguration iosEduDeviceConfigurationToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<IosEduDeviceConfiguration>> CreateResponseAsync(IosEduDeviceConfiguration iosEduDeviceConfigurationToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosEduDeviceConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IosEduDeviceConfiguration>> CreateResponseAsync(IosEduDeviceConfiguration iosEduDeviceConfigurationToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="iosEduDeviceConfigurationToUpdate">The IosEduDeviceConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{IosEduDeviceConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IosEduDeviceConfiguration>> UpdateResponseAsync(IosEduDeviceConfiguration iosEduDeviceConfigurationToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosEduDeviceConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<IosEduDeviceConfiguration>> UpdateResponseAsync(IosEduDeviceConfiguration iosEduDeviceConfigurationToUpdate, CancellationToken cancellationToken);
