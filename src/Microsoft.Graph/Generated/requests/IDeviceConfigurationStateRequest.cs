...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceConfigurationStateRequest : IBaseRequest
    {
        ...
        /// <param name="deviceConfigurationStateToUpdate">The DeviceConfigurationState to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceConfigurationState}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationState>> UpdateResponseAsync(DeviceConfigurationState deviceConfigurationStateToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceConfigurationState}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationState>> UpdateResponseAsync(DeviceConfigurationState deviceConfigurationStateToUpdate, CancellationToken cancellationToken);
