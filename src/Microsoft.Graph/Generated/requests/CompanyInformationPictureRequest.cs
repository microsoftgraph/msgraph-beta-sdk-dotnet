...
namespace Microsoft.Graph
{
    ...
    public partial class CompanyInformationPictureRequest : BaseRequest, ICompanyInformationPictureRequest
    {
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream picture, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : CompanyInformation
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream picture, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : CompanyInformation
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
