...
namespace Microsoft.Graph
{
    ...
    public partial class CompanyInformationPictureRequest : BaseRequest, ICompanyInformationPictureRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream picture, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : CompanyInformation
        {
            this.ContentType = Constants.ContentTypes.StreamContentType;
            this.Method = Constants.HttpMethods.PUT.ToString();
            return this.SendAsyncWithGraphResponse<T>(picture, cancellationToken, completionOption);
        }
