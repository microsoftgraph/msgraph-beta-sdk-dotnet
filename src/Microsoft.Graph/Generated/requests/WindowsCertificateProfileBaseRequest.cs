...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsCertificateProfileBaseRequest : BaseRequest, IWindowsCertificateProfileBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<WindowsCertificateProfileBase> PutAsync(WindowsCertificateProfileBase windowsCertificateProfileBaseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="windowsCertificateProfileBaseToUpdate">The WindowsCertificateProfileBase object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{WindowsCertificateProfileBase}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsCertificateProfileBase>> PutResponseAsync(WindowsCertificateProfileBase windowsCertificateProfileBaseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<WindowsCertificateProfileBase>(windowsCertificateProfileBaseToUpdate, cancellationToken);
