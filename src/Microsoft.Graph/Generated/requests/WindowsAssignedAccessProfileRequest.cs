...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsAssignedAccessProfileRequest : BaseRequest, IWindowsAssignedAccessProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<WindowsAssignedAccessProfile> CreateAsync(WindowsAssignedAccessProfile windowsAssignedAccessProfileToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WindowsAssignedAccessProfile>> CreateResponseAsync(WindowsAssignedAccessProfile windowsAssignedAccessProfileToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<WindowsAssignedAccessProfile> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WindowsAssignedAccessProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsAssignedAccessProfile>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<WindowsAssignedAccessProfile> UpdateAsync(WindowsAssignedAccessProfile windowsAssignedAccessProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsAssignedAccessProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsAssignedAccessProfile>> UpdateResponseAsync(WindowsAssignedAccessProfile windowsAssignedAccessProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <summary>
        /// Updates the specified WindowsAssignedAccessProfile using PUT.
        /// </summary>
        /// <param name="windowsAssignedAccessProfileToUpdate">The WindowsAssignedAccessProfile object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<WindowsAssignedAccessProfile> PutAsync(WindowsAssignedAccessProfile windowsAssignedAccessProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <summary>
        /// Updates the specified WindowsAssignedAccessProfile using PUT and returns a <see cref="GraphResponse{WindowsAssignedAccessProfile}"/> object.
        /// </summary>
        /// <param name="windowsAssignedAccessProfileToUpdate">The WindowsAssignedAccessProfile object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{WindowsAssignedAccessProfile}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WindowsAssignedAccessProfile>> PutResponseAsync(WindowsAssignedAccessProfile windowsAssignedAccessProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<WindowsAssignedAccessProfile>(windowsAssignedAccessProfileToUpdate, cancellationToken);
