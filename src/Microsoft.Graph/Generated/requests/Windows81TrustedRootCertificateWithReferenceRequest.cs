...
namespace Microsoft.Graph
{
    ...
    public partial class Windows81TrustedRootCertificateWithReferenceRequest : BaseRequest, IWindows81TrustedRootCertificateWithReferenceRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows81TrustedRootCertificate>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows81TrustedRootCertificate}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Windows81TrustedRootCertificate>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Windows81TrustedRootCertificate>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="windows81TrustedRootCertificateToCreate">The Windows81TrustedRootCertificate to create.</param>
        /// <returns>The <see cref="GraphResponse{Windows81TrustedRootCertificate}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows81TrustedRootCertificate>> CreateResponseAsync(Windows81TrustedRootCertificate windows81TrustedRootCertificateToCreate)
        {
            return this.CreateResponseAsync(windows81TrustedRootCertificateToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows81TrustedRootCertificate}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Windows81TrustedRootCertificate>> CreateResponseAsync(Windows81TrustedRootCertificate windows81TrustedRootCertificateToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<Windows81TrustedRootCertificate>(windows81TrustedRootCertificateToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="windows81TrustedRootCertificateToUpdate">The Windows81TrustedRootCertificate to update.</param>
        /// <returns>The <see cref="GraphResponse{Windows81TrustedRootCertificate}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows81TrustedRootCertificate>> UpdateResponseAsync(Windows81TrustedRootCertificate windows81TrustedRootCertificateToUpdate)
        {
            return this.UpdateResponseAsync(windows81TrustedRootCertificateToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Windows81TrustedRootCertificate}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Windows81TrustedRootCertificate>> UpdateResponseAsync(Windows81TrustedRootCertificate windows81TrustedRootCertificateToUpdate, CancellationToken cancellationToken)
        {
			if (windows81TrustedRootCertificateToUpdate.AdditionalData != null)
			{
				if (windows81TrustedRootCertificateToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<Windows81TrustedRootCertificate>(windows81TrustedRootCertificateToUpdate, cancellationToken).ConfigureAwait(false);
        }
