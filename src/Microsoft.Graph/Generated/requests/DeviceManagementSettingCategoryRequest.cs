...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementSettingCategoryRequest : BaseRequest, IDeviceManagementSettingCategoryRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementSettingCategory>> CreateResponseAsync(DeviceManagementSettingCategory deviceManagementSettingCategoryToCreate)
        {
            return this.CreateResponseAsync(deviceManagementSettingCategoryToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementSettingCategory}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementSettingCategory>> CreateResponseAsync(DeviceManagementSettingCategory deviceManagementSettingCategoryToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DeviceManagementSettingCategory>(deviceManagementSettingCategoryToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DeviceManagementSettingCategory}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementSettingCategory>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementSettingCategory}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementSettingCategory>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceManagementSettingCategory>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="deviceManagementSettingCategoryToUpdate">The DeviceManagementSettingCategory to update.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementSettingCategory}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementSettingCategory>> UpdateResponseAsync(DeviceManagementSettingCategory deviceManagementSettingCategoryToUpdate)
        {
            return this.UpdateResponseAsync(deviceManagementSettingCategoryToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceManagementSettingCategory}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementSettingCategory>> UpdateResponseAsync(DeviceManagementSettingCategory deviceManagementSettingCategoryToUpdate, CancellationToken cancellationToken)
        {
			if (deviceManagementSettingCategoryToUpdate.AdditionalData != null)
			{
				if (deviceManagementSettingCategoryToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<DeviceManagementSettingCategory>(deviceManagementSettingCategoryToUpdate, cancellationToken).ConfigureAwait(false);
        }
