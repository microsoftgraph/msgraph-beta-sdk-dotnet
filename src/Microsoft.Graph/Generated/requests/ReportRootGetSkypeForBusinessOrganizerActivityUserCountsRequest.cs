...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetSkypeForBusinessOrganizerActivityUserCountsRequest : BaseRequest, IReportRootGetSkypeForBusinessOrganizerActivityUserCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityUserCountsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="skypeforbusinessorganizeractivityusercounts">The SkypeForBusinessOrganizerActivityUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityUserCountsCollectionResponse>> PatchResponseAsync(SkypeForBusinessOrganizerActivityUserCounts skypeforbusinessorganizeractivityusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityUserCountsCollectionResponse>(skypeforbusinessorganizeractivityusercounts, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="skypeforbusinessorganizeractivityusercounts">The SkypeForBusinessOrganizerActivityUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityUserCountsCollectionResponse>> PutResponseAsync(SkypeForBusinessOrganizerActivityUserCounts skypeforbusinessorganizeractivityusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessOrganizerActivityUserCountsCollectionResponse>(skypeforbusinessorganizeractivityusercounts, cancellationToken).ConfigureAwait(false);
        }
