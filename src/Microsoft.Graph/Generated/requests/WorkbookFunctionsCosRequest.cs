...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsCosRequest : BaseRequest, IWorkbookFunctionsCosRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsCosRequest.
        /// </summary>
        public WorkbookFunctionsCosRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsCosRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsCosRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsCosRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsCosRequest Select(string value)
        {
