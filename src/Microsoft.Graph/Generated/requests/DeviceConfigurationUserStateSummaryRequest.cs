...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceConfigurationUserStateSummaryRequest : BaseRequest, IDeviceConfigurationUserStateSummaryRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationUserStateSummary>> CreateResponseAsync(DeviceConfigurationUserStateSummary deviceConfigurationUserStateSummaryToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DeviceConfigurationUserStateSummary}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceConfigurationUserStateSummary>> UpdateResponseAsync(DeviceConfigurationUserStateSummary deviceConfigurationUserStateSummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
