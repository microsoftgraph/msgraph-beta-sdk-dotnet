...
namespace Microsoft.Graph
{
    ...
    public partial interface IMessageAttachmentsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<MessageAttachmentsCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MessageAttachmentsCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<MessageAttachmentsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
