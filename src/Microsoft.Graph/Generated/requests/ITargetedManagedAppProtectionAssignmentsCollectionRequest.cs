...
namespace Microsoft.Graph
{
    ...
    public partial interface ITargetedManagedAppProtectionAssignmentsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<TargetedManagedAppProtectionAssignmentsCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TargetedManagedAppProtectionAssignmentsCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<TargetedManagedAppProtectionAssignmentsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
