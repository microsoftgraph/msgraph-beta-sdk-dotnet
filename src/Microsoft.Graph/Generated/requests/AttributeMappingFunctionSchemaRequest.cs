...
namespace Microsoft.Graph
{
    ...
    public partial class AttributeMappingFunctionSchemaRequest : BaseRequest, IAttributeMappingFunctionSchemaRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<AttributeMappingFunctionSchema>> CreateResponseAsync(AttributeMappingFunctionSchema attributeMappingFunctionSchemaToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AttributeMappingFunctionSchema}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AttributeMappingFunctionSchema>> UpdateResponseAsync(AttributeMappingFunctionSchema attributeMappingFunctionSchemaToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
