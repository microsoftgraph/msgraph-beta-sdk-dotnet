...
namespace Microsoft.Graph
{
    ...
    public partial class AttributeMappingFunctionSchemaRequest : BaseRequest, IAttributeMappingFunctionSchemaRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AttributeMappingFunctionSchema>> CreateResponseAsync(AttributeMappingFunctionSchema attributeMappingFunctionSchemaToCreate)
        {
            return this.CreateResponseAsync(attributeMappingFunctionSchemaToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AttributeMappingFunctionSchema}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AttributeMappingFunctionSchema>> CreateResponseAsync(AttributeMappingFunctionSchema attributeMappingFunctionSchemaToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<AttributeMappingFunctionSchema>(attributeMappingFunctionSchemaToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AttributeMappingFunctionSchema}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AttributeMappingFunctionSchema>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AttributeMappingFunctionSchema}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AttributeMappingFunctionSchema>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<AttributeMappingFunctionSchema>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="attributeMappingFunctionSchemaToUpdate">The AttributeMappingFunctionSchema to update.</param>
        /// <returns>The <see cref="GraphResponse{AttributeMappingFunctionSchema}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AttributeMappingFunctionSchema>> UpdateResponseAsync(AttributeMappingFunctionSchema attributeMappingFunctionSchemaToUpdate)
        {
            return this.UpdateResponseAsync(attributeMappingFunctionSchemaToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AttributeMappingFunctionSchema}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AttributeMappingFunctionSchema>> UpdateResponseAsync(AttributeMappingFunctionSchema attributeMappingFunctionSchemaToUpdate, CancellationToken cancellationToken)
        {
			if (attributeMappingFunctionSchemaToUpdate.AdditionalData != null)
			{
				if (attributeMappingFunctionSchemaToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<AttributeMappingFunctionSchema>(attributeMappingFunctionSchemaToUpdate, cancellationToken).ConfigureAwait(false);
        }
