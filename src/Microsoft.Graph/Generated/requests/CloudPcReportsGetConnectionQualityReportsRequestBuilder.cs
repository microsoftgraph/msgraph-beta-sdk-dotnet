...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type CloudPcReportsGetConnectionQualityReportsRequestBuilder.
    /// </summary>
    public partial class CloudPcReportsGetConnectionQualityReportsRequestBuilder : BaseActionMethodRequestBuilder<ICloudPcReportsGetConnectionQualityReportsRequest>, ICloudPcReportsGetConnectionQualityReportsRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="CloudPcReportsGetConnectionQualityReportsRequestBuilder"/>.
        /// </summary>
        ...
        public CloudPcReportsGetConnectionQualityReportsRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string filter,
        ...
        protected override ICloudPcReportsGetConnectionQualityReportsRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new CloudPcReportsGetConnectionQualityReportsRequest(functionUrl, this.Client, options);
