...
namespace Microsoft.Graph
{
    ...
    public partial class MacOSEnterpriseWiFiConfigurationRequest : BaseRequest, IMacOSEnterpriseWiFiConfigurationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<MacOSEnterpriseWiFiConfiguration>> CreateResponseAsync(MacOSEnterpriseWiFiConfiguration macOSEnterpriseWiFiConfigurationToCreate)
        {
            return this.CreateResponseAsync(macOSEnterpriseWiFiConfigurationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MacOSEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MacOSEnterpriseWiFiConfiguration>> CreateResponseAsync(MacOSEnterpriseWiFiConfiguration macOSEnterpriseWiFiConfigurationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<MacOSEnterpriseWiFiConfiguration>(macOSEnterpriseWiFiConfigurationToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{MacOSEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MacOSEnterpriseWiFiConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{MacOSEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MacOSEnterpriseWiFiConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<MacOSEnterpriseWiFiConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="macOSEnterpriseWiFiConfigurationToUpdate">The MacOSEnterpriseWiFiConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{MacOSEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<MacOSEnterpriseWiFiConfiguration>> UpdateResponseAsync(MacOSEnterpriseWiFiConfiguration macOSEnterpriseWiFiConfigurationToUpdate)
        {
            return this.UpdateResponseAsync(macOSEnterpriseWiFiConfigurationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MacOSEnterpriseWiFiConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<MacOSEnterpriseWiFiConfiguration>> UpdateResponseAsync(MacOSEnterpriseWiFiConfiguration macOSEnterpriseWiFiConfigurationToUpdate, CancellationToken cancellationToken)
        {
			if (macOSEnterpriseWiFiConfigurationToUpdate.AdditionalData != null)
			{
				if (macOSEnterpriseWiFiConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<MacOSEnterpriseWiFiConfiguration>(macOSEnterpriseWiFiConfigurationToUpdate, cancellationToken).ConfigureAwait(false);
        }
