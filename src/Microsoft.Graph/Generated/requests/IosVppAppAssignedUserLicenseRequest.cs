...
namespace Microsoft.Graph
{
    ...
    public partial class IosVppAppAssignedUserLicenseRequest : BaseRequest, IIosVppAppAssignedUserLicenseRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedUserLicense>> CreateResponseAsync(IosVppAppAssignedUserLicense iosVppAppAssignedUserLicenseToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedUserLicense}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedUserLicense>> UpdateResponseAsync(IosVppAppAssignedUserLicense iosVppAppAssignedUserLicenseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
