...
namespace Microsoft.Graph
{
    ...
    public partial class IosVppAppAssignedUserLicenseRequest : BaseRequest, IIosVppAppAssignedUserLicenseRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedUserLicense>> CreateResponseAsync(IosVppAppAssignedUserLicense iosVppAppAssignedUserLicenseToCreate)
        {
            return this.CreateResponseAsync(iosVppAppAssignedUserLicenseToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedUserLicense}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedUserLicense>> CreateResponseAsync(IosVppAppAssignedUserLicense iosVppAppAssignedUserLicenseToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<IosVppAppAssignedUserLicense>(iosVppAppAssignedUserLicenseToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedUserLicense}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedUserLicense>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedUserLicense}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedUserLicense>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<IosVppAppAssignedUserLicense>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="iosVppAppAssignedUserLicenseToUpdate">The IosVppAppAssignedUserLicense to update.</param>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedUserLicense}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedUserLicense>> UpdateResponseAsync(IosVppAppAssignedUserLicense iosVppAppAssignedUserLicenseToUpdate)
        {
            return this.UpdateResponseAsync(iosVppAppAssignedUserLicenseToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosVppAppAssignedUserLicense}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosVppAppAssignedUserLicense>> UpdateResponseAsync(IosVppAppAssignedUserLicense iosVppAppAssignedUserLicenseToUpdate, CancellationToken cancellationToken)
        {
			if (iosVppAppAssignedUserLicenseToUpdate.AdditionalData != null)
			{
				if (iosVppAppAssignedUserLicenseToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<IosVppAppAssignedUserLicense>(iosVppAppAssignedUserLicenseToUpdate, cancellationToken).ConfigureAwait(false);
        }
