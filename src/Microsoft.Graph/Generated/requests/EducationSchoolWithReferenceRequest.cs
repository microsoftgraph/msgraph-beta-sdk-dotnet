...
namespace Microsoft.Graph
{
    ...
    public partial class EducationSchoolWithReferenceRequest : BaseRequest, IEducationSchoolWithReferenceRequest
    {
        ...
        /// <param name="educationSchoolToUpdate">The EducationSchool to update.</param>
        /// <returns>The <see cref="GraphResponse{EducationSchool}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<EducationSchool>> UpdateResponseAsync(EducationSchool educationSchoolToUpdate)
        {
            return this.UpdateResponseAsync(educationSchoolToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{EducationSchool}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EducationSchool>> UpdateResponseAsync(EducationSchool educationSchoolToUpdate, CancellationToken cancellationToken)
        {
			if (educationSchoolToUpdate.AdditionalData != null)
			{
				if (educationSchoolToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
