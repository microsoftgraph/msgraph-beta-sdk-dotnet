...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetSkypeForBusinessDeviceUsageUserCountsRequest : BaseRequest, IReportRootGetSkypeForBusinessDeviceUsageUserCountsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessDeviceUsageUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="skypeforbusinessdeviceusageusercounts">The SkypeForBusinessDeviceUsageUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessDeviceUsageUserCountsCollectionResponse>> PatchResponseAsync(SkypeForBusinessDeviceUsageUserCounts skypeforbusinessdeviceusageusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="skypeforbusinessdeviceusageusercounts">The SkypeForBusinessDeviceUsageUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetSkypeForBusinessDeviceUsageUserCountsCollectionResponse>> PutResponseAsync(SkypeForBusinessDeviceUsageUserCounts skypeforbusinessdeviceusageusercounts, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetSkypeForBusinessDeviceUsageUserCountsCollectionResponse>(skypeforbusinessdeviceusageusercounts, cancellationToken);
        }
