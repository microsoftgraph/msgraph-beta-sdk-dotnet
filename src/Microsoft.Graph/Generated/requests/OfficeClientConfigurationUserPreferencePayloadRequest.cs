...
namespace Microsoft.Graph
{
    ...
    public partial class OfficeClientConfigurationUserPreferencePayloadRequest : BaseRequest, IOfficeClientConfigurationUserPreferencePayloadRequest
    {
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream userPreferencePayload, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OfficeClientConfiguration
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream userPreferencePayload, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OfficeClientConfiguration
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<T>(userPreferencePayload, cancellationToken, completionOption);
        }
