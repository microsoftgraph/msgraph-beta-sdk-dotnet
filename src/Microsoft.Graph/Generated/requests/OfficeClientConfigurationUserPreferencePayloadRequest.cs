...
namespace Microsoft.Graph
{
    ...
    public partial class OfficeClientConfigurationUserPreferencePayloadRequest : BaseRequest, IOfficeClientConfigurationUserPreferencePayloadRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream userPreferencePayload, CancellationToken cancellationToken = default(CancellationToken), HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OfficeClientConfiguration
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
