...
namespace Microsoft.Graph
{
    ...
    public partial class CloudPcProvisioningPolicyRequest : BaseRequest, ICloudPcProvisioningPolicyRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<CloudPcProvisioningPolicy> PutAsync(CloudPcProvisioningPolicy cloudPcProvisioningPolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<CloudPcProvisioningPolicy>> PutResponseAsync(CloudPcProvisioningPolicy cloudPcProvisioningPolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<CloudPcProvisioningPolicy>(cloudPcProvisioningPolicyToUpdate, cancellationToken);
        ...
        private void InitializeCollectionProperties(CloudPcProvisioningPolicy cloudPcProvisioningPolicyToInitialize)
        {
            ...
            if (cloudPcProvisioningPolicyToInitialize != null && cloudPcProvisioningPolicyToInitialize.AdditionalData != null)
            {
                ...
                if (cloudPcProvisioningPolicyToInitialize.Assignments != null && cloudPcProvisioningPolicyToInitialize.Assignments.CurrentPage != null)
                {
                    ...
                    if(cloudPcProvisioningPolicyToInitialize.AdditionalData.TryGetValue("assignments@odata.nextLink", out var nextPageLink))
                    {
