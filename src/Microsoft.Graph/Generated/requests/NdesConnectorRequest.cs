...
namespace Microsoft.Graph
{
    ...
    public partial class NdesConnectorRequest : BaseRequest, INdesConnectorRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<NdesConnector>> CreateResponseAsync(NdesConnector ndesConnectorToCreate)
        {
            return this.CreateResponseAsync(ndesConnectorToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{NdesConnector}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<NdesConnector>> CreateResponseAsync(NdesConnector ndesConnectorToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<NdesConnector>(ndesConnectorToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{NdesConnector}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<NdesConnector>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{NdesConnector}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<NdesConnector>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<NdesConnector>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
			if (ndesConnectorToUpdate.AdditionalData != null)
			{
				if (ndesConnectorToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					ndesConnectorToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, ndesConnectorToUpdate.GetType().Name)
						});
				}
			}
            if (ndesConnectorToUpdate.AdditionalData != null)
        ...
        /// <param name="ndesConnectorToUpdate">The NdesConnector to update.</param>
        /// <returns>The <see cref="GraphResponse{NdesConnector}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<NdesConnector>> UpdateResponseAsync(NdesConnector ndesConnectorToUpdate)
        {
            return this.UpdateResponseAsync(ndesConnectorToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{NdesConnector}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<NdesConnector>> UpdateResponseAsync(NdesConnector ndesConnectorToUpdate, CancellationToken cancellationToken)
        {
			if (ndesConnectorToUpdate.AdditionalData != null)
			{
				if (ndesConnectorToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<NdesConnector>(ndesConnectorToUpdate, cancellationToken).ConfigureAwait(false);
        }
