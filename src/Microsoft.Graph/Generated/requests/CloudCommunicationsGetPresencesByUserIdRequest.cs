...
namespace Microsoft.Graph
{
    ...
    public partial class CloudCommunicationsGetPresencesByUserIdRequest : BaseRequest, ICloudCommunicationsGetPresencesByUserIdRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<CloudCommunicationsGetPresencesByUserIdCollectionResponse>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<CloudCommunicationsGetPresencesByUserIdCollectionResponse>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
