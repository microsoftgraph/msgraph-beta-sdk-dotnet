...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidWorkProfileCertificateProfileBaseWithReferenceRequest : BaseRequest, IAndroidWorkProfileCertificateProfileBaseWithReferenceRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AndroidWorkProfileCertificateProfileBase>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidWorkProfileCertificateProfileBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidWorkProfileCertificateProfileBase>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<AndroidWorkProfileCertificateProfileBase>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="androidWorkProfileCertificateProfileBaseToCreate">The AndroidWorkProfileCertificateProfileBase to create.</param>
        /// <returns>The <see cref="GraphResponse{AndroidWorkProfileCertificateProfileBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidWorkProfileCertificateProfileBase>> CreateResponseAsync(AndroidWorkProfileCertificateProfileBase androidWorkProfileCertificateProfileBaseToCreate)
        {
            return this.CreateResponseAsync(androidWorkProfileCertificateProfileBaseToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidWorkProfileCertificateProfileBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidWorkProfileCertificateProfileBase>> CreateResponseAsync(AndroidWorkProfileCertificateProfileBase androidWorkProfileCertificateProfileBaseToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<AndroidWorkProfileCertificateProfileBase>(androidWorkProfileCertificateProfileBaseToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="androidWorkProfileCertificateProfileBaseToUpdate">The AndroidWorkProfileCertificateProfileBase to update.</param>
        /// <returns>The <see cref="GraphResponse{AndroidWorkProfileCertificateProfileBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AndroidWorkProfileCertificateProfileBase>> UpdateResponseAsync(AndroidWorkProfileCertificateProfileBase androidWorkProfileCertificateProfileBaseToUpdate)
        {
            return this.UpdateResponseAsync(androidWorkProfileCertificateProfileBaseToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidWorkProfileCertificateProfileBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<AndroidWorkProfileCertificateProfileBase>> UpdateResponseAsync(AndroidWorkProfileCertificateProfileBase androidWorkProfileCertificateProfileBaseToUpdate, CancellationToken cancellationToken)
        {
			if (androidWorkProfileCertificateProfileBaseToUpdate.AdditionalData != null)
			{
				if (androidWorkProfileCertificateProfileBaseToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<AndroidWorkProfileCertificateProfileBase>(androidWorkProfileCertificateProfileBaseToUpdate, cancellationToken).ConfigureAwait(false);
        }
