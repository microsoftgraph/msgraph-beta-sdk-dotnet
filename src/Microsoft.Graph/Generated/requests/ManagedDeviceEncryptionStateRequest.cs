...
namespace Microsoft.Graph
{
    ...
    public partial class ManagedDeviceEncryptionStateRequest : BaseRequest, IManagedDeviceEncryptionStateRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ManagedDeviceEncryptionState}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ManagedDeviceEncryptionState>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ManagedDeviceEncryptionState}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ManagedDeviceEncryptionState>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ManagedDeviceEncryptionState>(null, cancellationToken).ConfigureAwait(false);
        }
