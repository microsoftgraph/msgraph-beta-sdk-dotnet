...
namespace Microsoft.Graph
{
    ...
    public partial class UserExperienceAnalyticsOverviewRequest : BaseRequest, IUserExperienceAnalyticsOverviewRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<UserExperienceAnalyticsOverview> PutAsync(UserExperienceAnalyticsOverview userExperienceAnalyticsOverviewToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<UserExperienceAnalyticsOverview>> PutResponseAsync(UserExperienceAnalyticsOverview userExperienceAnalyticsOverviewToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<UserExperienceAnalyticsOverview>(userExperienceAnalyticsOverviewToUpdate, cancellationToken);
