...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AppManagementPolicyAppliesToCollectionReferencesRequest.
    /// </summary>
    public partial class AppManagementPolicyAppliesToCollectionReferencesRequest : BaseRequest, IAppManagementPolicyAppliesToCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new AppManagementPolicyAppliesToCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public AppManagementPolicyAppliesToCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
