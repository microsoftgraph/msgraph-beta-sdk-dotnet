...
namespace Microsoft.Graph
{
    ...
    public partial class GraphServiceDrivesCollectionRequest : BaseRequest, IGraphServiceDrivesCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<IGraphServiceDrivesCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
        ...
        /// <summary>
        /// Gets the collection page and returns a <see cref="GraphResponse{GraphServiceDrivesCollectionResponse}"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GraphServiceDrivesCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GraphServiceDrivesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<GraphServiceDrivesCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
