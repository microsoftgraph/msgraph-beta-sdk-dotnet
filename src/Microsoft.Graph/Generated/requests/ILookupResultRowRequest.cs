...
namespace Microsoft.Graph
{
    ...
    public partial interface ILookupResultRowRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<LookupResultRow> PutAsync(LookupResultRow lookupResultRowToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<LookupResultRow>> PutResponseAsync(LookupResultRow lookupResultRowToUpdate, CancellationToken cancellationToken = default(CancellationToken));
