...
namespace Microsoft.Graph
{
    ...
    public partial interface IMobileAppRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<MobileApp> PutAsync(MobileApp mobileAppToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="mobileAppToUpdate">The MobileApp object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{MobileApp}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<MobileApp>> PutResponseAsync(MobileApp mobileAppToUpdate, CancellationToken cancellationToken = default(CancellationToken));
