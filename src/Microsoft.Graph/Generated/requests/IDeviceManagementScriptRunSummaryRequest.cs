...
namespace Microsoft.Graph
{
    ...
    public partial interface IDeviceManagementScriptRunSummaryRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<DeviceManagementScriptRunSummary> PutAsync(DeviceManagementScriptRunSummary deviceManagementScriptRunSummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="deviceManagementScriptRunSummaryToUpdate">The DeviceManagementScriptRunSummary object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{DeviceManagementScriptRunSummary}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<DeviceManagementScriptRunSummary>> PutResponseAsync(DeviceManagementScriptRunSummary deviceManagementScriptRunSummaryToUpdate, CancellationToken cancellationToken = default(CancellationToken));
