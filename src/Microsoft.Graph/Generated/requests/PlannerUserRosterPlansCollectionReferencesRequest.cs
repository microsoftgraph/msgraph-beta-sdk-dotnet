...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PlannerUserRosterPlansCollectionReferencesRequest.
    /// </summary>
    public partial class PlannerUserRosterPlansCollectionReferencesRequest : BaseRequest, IPlannerUserRosterPlansCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new PlannerUserRosterPlansCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public PlannerUserRosterPlansCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task AddAsync(PlannerPlan plannerPlan, CancellationToken cancellationToken)
        {
            ...
            var requestBody = new ReferenceRequestBody { ODataId = string.Format("{0}/planner/rosterPlans/{1}", this.Client.BaseUrl, plannerPlan.Id) };
