...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetDeviceStatusByCompliancePolicySettingReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetDeviceStatusByCompliancePolicySettingReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetDeviceStatusByCompliancePolicySettingReportRequest>, IDeviceManagementReportsGetDeviceStatusByCompliancePolicySettingReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetDeviceStatusByCompliancePolicySettingReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetDeviceStatusByCompliancePolicySettingReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IDeviceManagementReportsGetDeviceStatusByCompliancePolicySettingReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetDeviceStatusByCompliancePolicySettingReportRequest(functionUrl, this.Client, options);
