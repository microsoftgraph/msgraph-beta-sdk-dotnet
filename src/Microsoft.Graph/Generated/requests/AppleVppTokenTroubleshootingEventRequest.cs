...
namespace Microsoft.Graph
{
    ...
    public partial class AppleVppTokenTroubleshootingEventRequest : BaseRequest, IAppleVppTokenTroubleshootingEventRequest
    {
        ...
        public async System.Threading.Tasks.Task<AppleVppTokenTroubleshootingEvent> CreateAsync(AppleVppTokenTroubleshootingEvent appleVppTokenTroubleshootingEventToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<AppleVppTokenTroubleshootingEvent>> CreateResponseAsync(AppleVppTokenTroubleshootingEvent appleVppTokenTroubleshootingEventToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<AppleVppTokenTroubleshootingEvent> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AppleVppTokenTroubleshootingEvent}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AppleVppTokenTroubleshootingEvent>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<AppleVppTokenTroubleshootingEvent> UpdateAsync(AppleVppTokenTroubleshootingEvent appleVppTokenTroubleshootingEventToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AppleVppTokenTroubleshootingEvent}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AppleVppTokenTroubleshootingEvent>> UpdateResponseAsync(AppleVppTokenTroubleshootingEvent appleVppTokenTroubleshootingEventToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<AppleVppTokenTroubleshootingEvent> PutAsync(AppleVppTokenTroubleshootingEvent appleVppTokenTroubleshootingEventToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="appleVppTokenTroubleshootingEventToUpdate">The AppleVppTokenTroubleshootingEvent object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{AppleVppTokenTroubleshootingEvent}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AppleVppTokenTroubleshootingEvent>> PutResponseAsync(AppleVppTokenTroubleshootingEvent appleVppTokenTroubleshootingEventToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<AppleVppTokenTroubleshootingEvent>(appleVppTokenTroubleshootingEventToUpdate, cancellationToken);
