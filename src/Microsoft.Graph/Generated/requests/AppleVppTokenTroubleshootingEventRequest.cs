...
namespace Microsoft.Graph
{
    ...
    public partial class AppleVppTokenTroubleshootingEventRequest : BaseRequest, IAppleVppTokenTroubleshootingEventRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<AppleVppTokenTroubleshootingEvent> PutAsync(AppleVppTokenTroubleshootingEvent appleVppTokenTroubleshootingEventToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<AppleVppTokenTroubleshootingEvent>> PutResponseAsync(AppleVppTokenTroubleshootingEvent appleVppTokenTroubleshootingEventToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<AppleVppTokenTroubleshootingEvent>(appleVppTokenTroubleshootingEventToUpdate, cancellationToken);
