...
namespace Microsoft.Graph
{
    ...
    public partial class GovernanceRoleAssignmentRequestUpdateRequestRequest : BaseRequest, IGovernanceRoleAssignmentRequestUpdateRequestRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<GovernanceRoleAssignmentRequest>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<GovernanceRoleAssignmentRequest>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
