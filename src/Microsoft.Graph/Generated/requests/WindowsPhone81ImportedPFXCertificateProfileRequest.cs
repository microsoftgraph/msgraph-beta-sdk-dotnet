...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsPhone81ImportedPFXCertificateProfileRequest : BaseRequest, IWindowsPhone81ImportedPFXCertificateProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<WindowsPhone81ImportedPFXCertificateProfile>> CreateResponseAsync(WindowsPhone81ImportedPFXCertificateProfile windowsPhone81ImportedPFXCertificateProfileToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        public System.Threading.Tasks.Task<WindowsPhone81ImportedPFXCertificateProfile> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The WindowsPhone81ImportedPFXCertificateProfile.</returns>
        public async System.Threading.Tasks.Task<WindowsPhone81ImportedPFXCertificateProfile> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WindowsPhone81ImportedPFXCertificateProfile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WindowsPhone81ImportedPFXCertificateProfile>> UpdateResponseAsync(WindowsPhone81ImportedPFXCertificateProfile windowsPhone81ImportedPFXCertificateProfileToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
