...
namespace Microsoft.Graph
{
    ...
    public partial class GroupPolicyPresentationCheckBoxRequest : BaseRequest, IGroupPolicyPresentationCheckBoxRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationCheckBox>> CreateResponseAsync(GroupPolicyPresentationCheckBox groupPolicyPresentationCheckBoxToCreate)
        {
            return this.CreateResponseAsync(groupPolicyPresentationCheckBoxToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationCheckBox}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationCheckBox>> CreateResponseAsync(GroupPolicyPresentationCheckBox groupPolicyPresentationCheckBoxToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<GroupPolicyPresentationCheckBox>(groupPolicyPresentationCheckBoxToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationCheckBox}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationCheckBox>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationCheckBox}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationCheckBox>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<GroupPolicyPresentationCheckBox>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="groupPolicyPresentationCheckBoxToUpdate">The GroupPolicyPresentationCheckBox to update.</param>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationCheckBox}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationCheckBox>> UpdateResponseAsync(GroupPolicyPresentationCheckBox groupPolicyPresentationCheckBoxToUpdate)
        {
            return this.UpdateResponseAsync(groupPolicyPresentationCheckBoxToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{GroupPolicyPresentationCheckBox}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyPresentationCheckBox>> UpdateResponseAsync(GroupPolicyPresentationCheckBox groupPolicyPresentationCheckBoxToUpdate, CancellationToken cancellationToken)
        {
			if (groupPolicyPresentationCheckBoxToUpdate.AdditionalData != null)
			{
				if (groupPolicyPresentationCheckBoxToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<GroupPolicyPresentationCheckBox>(groupPolicyPresentationCheckBoxToUpdate, cancellationToken).ConfigureAwait(false);
        }
