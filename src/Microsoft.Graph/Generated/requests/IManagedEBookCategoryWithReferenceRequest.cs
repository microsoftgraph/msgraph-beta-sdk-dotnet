...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IManagedEBookCategoryWithReferenceRequest.
    /// </summary>
    public partial interface IManagedEBookCategoryWithReferenceRequest : IBaseRequest
    {
        /// <summary>
        ...
        System.Threading.Tasks.Task<ManagedEBookCategory> CreateAsync(ManagedEBookCategory managedEBookCategoryToCreate);
        ...
        /// <param name="managedEBookCategoryToCreate">The ManagedEBookCategory to create.</param>
        /// <returns>The <see cref="GraphResponse{ManagedEBookCategory}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ManagedEBookCategory>> CreateResponseAsync(ManagedEBookCategory managedEBookCategoryToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ManagedEBookCategory}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ManagedEBookCategory>> CreateResponseAsync(ManagedEBookCategory managedEBookCategoryToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="managedEBookCategoryToUpdate">The ManagedEBookCategory to update.</param>
        /// <returns>The <see cref="GraphResponse{ManagedEBookCategory}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ManagedEBookCategory>> UpdateResponseAsync(ManagedEBookCategory managedEBookCategoryToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ManagedEBookCategory}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ManagedEBookCategory>> UpdateResponseAsync(ManagedEBookCategory managedEBookCategoryToUpdate, CancellationToken cancellationToken);
        ...
        IManagedEBookCategoryWithReferenceRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IManagedEBookCategoryWithReferenceRequest Expand(Expression<Func<ManagedEBookCategory, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IManagedEBookCategoryWithReferenceRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IManagedEBookCategoryWithReferenceRequest Select(Expression<Func<ManagedEBookCategory, object>> selectExpression);
