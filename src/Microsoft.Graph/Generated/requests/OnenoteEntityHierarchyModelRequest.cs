...
namespace Microsoft.Graph
{
    ...
    public partial class OnenoteEntityHierarchyModelRequest : BaseRequest, IOnenoteEntityHierarchyModelRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<OnenoteEntityHierarchyModel> PutAsync(OnenoteEntityHierarchyModel onenoteEntityHierarchyModelToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<OnenoteEntityHierarchyModel>> PutResponseAsync(OnenoteEntityHierarchyModel onenoteEntityHierarchyModelToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<OnenoteEntityHierarchyModel>(onenoteEntityHierarchyModelToUpdate, cancellationToken);
