...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsYearFracRequest : BaseRequest, IWorkbookFunctionsYearFracRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsYearFracRequest.
        /// </summary>
        public WorkbookFunctionsYearFracRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsYearFracRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsYearFracRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsYearFracRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsYearFracRequest Select(string value)
        {
