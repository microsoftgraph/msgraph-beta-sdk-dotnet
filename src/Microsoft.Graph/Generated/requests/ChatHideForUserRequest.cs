...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ChatHideForUserRequest : BaseRequest, IChatHideForUserRequest
    {
        /// <summary>
        /// Constructs a new ChatHideForUserRequest.
        /// </summary>
        public ChatHideForUserRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new ChatHideForUserRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public ChatHideForUserRequestBody RequestBody { get; private set; }
        ...
        public IChatHideForUserRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IChatHideForUserRequest Select(string value)
        {
