...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface INoteSingleValueExtendedPropertiesCollectionRequestBuilder.
    /// </summary>
    public partial interface INoteSingleValueExtendedPropertiesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        INoteSingleValueExtendedPropertiesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        INoteSingleValueExtendedPropertiesCollectionRequest Request(IEnumerable<Option> options);
