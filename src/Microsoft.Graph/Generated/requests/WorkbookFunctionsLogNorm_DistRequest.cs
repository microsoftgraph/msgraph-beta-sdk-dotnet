...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsLogNorm_DistRequest : BaseRequest, IWorkbookFunctionsLogNorm_DistRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsLogNorm_DistRequest.
        /// </summary>
        public WorkbookFunctionsLogNorm_DistRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsLogNorm_DistRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsLogNorm_DistRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsLogNorm_DistRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsLogNorm_DistRequest Select(string value)
        {
