...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type OrganizationalBrandingBannerLogoRequest.
    /// </summary>
    public partial class OrganizationalBrandingBannerLogoRequest : BaseRequest, IOrganizationalBrandingBannerLogoRequest
    {
        /// <summary>
        /// Constructs a new OrganizationalBrandingBannerLogoRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public OrganizationalBrandingBannerLogoRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream bannerLogo) where T : OrganizationalBranding
        {
            return this.PutAsync<T>(bannerLogo, CancellationToken.None);
        }
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream bannerLogo, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBranding
        {
