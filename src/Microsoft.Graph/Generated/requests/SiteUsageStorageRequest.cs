...
namespace Microsoft.Graph
{
    ...
    public partial class SiteUsageStorageRequest : BaseRequest, ISiteUsageStorageRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<SiteUsageStorage> PutAsync(SiteUsageStorage siteUsageStorageToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<SiteUsageStorage>> PutResponseAsync(SiteUsageStorage siteUsageStorageToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SiteUsageStorage>(siteUsageStorageToUpdate, cancellationToken);
