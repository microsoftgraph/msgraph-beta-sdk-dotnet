...
namespace Microsoft.Graph
{
    ...
    public partial interface ITaxGroupRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<TaxGroup> PutAsync(TaxGroup taxGroupToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<TaxGroup>> PutResponseAsync(TaxGroup taxGroupToUpdate, CancellationToken cancellationToken = default(CancellationToken));
