...
namespace Microsoft.Graph
{
    ...
    public partial interface IAccessPackageSubjectRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<AccessPackageSubject> PutAsync(AccessPackageSubject accessPackageSubjectToUpdate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<AccessPackageSubject>> PutResponseAsync(AccessPackageSubject accessPackageSubjectToUpdate, CancellationToken cancellationToken = default);
