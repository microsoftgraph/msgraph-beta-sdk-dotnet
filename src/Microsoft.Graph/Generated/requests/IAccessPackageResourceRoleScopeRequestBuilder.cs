...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IAccessPackageResourceRoleScopeRequestBuilder.
    /// </summary>
    public partial interface IAccessPackageResourceRoleScopeRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IAccessPackageResourceRoleScopeRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IAccessPackageResourceRoleScopeRequest Request(IEnumerable<Option> options);
