...
namespace Microsoft.Graph
{
    ...
    public partial class GroupPolicyObjectFileRequest : BaseRequest, IGroupPolicyObjectFileRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyObjectFile>> CreateResponseAsync(GroupPolicyObjectFile groupPolicyObjectFileToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{GroupPolicyObjectFile}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupPolicyObjectFile>> UpdateResponseAsync(GroupPolicyObjectFile groupPolicyObjectFileToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
