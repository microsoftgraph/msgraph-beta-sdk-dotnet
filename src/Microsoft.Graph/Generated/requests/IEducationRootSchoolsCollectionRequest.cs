...
namespace Microsoft.Graph
{
    ...
    public partial interface IEducationRootSchoolsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<EducationSchool> AddAsync(EducationSchool educationSchool, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<EducationSchool>> AddResponseAsync(EducationSchool educationSchool, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<IEducationRootSchoolsCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken));

        /// <summary>
        /// Gets the collection page and returns a <see cref="GraphResponse{EducationRootSchoolsCollectionResponse}"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EducationRootSchoolsCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<EducationRootSchoolsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
