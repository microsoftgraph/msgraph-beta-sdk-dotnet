...
namespace Microsoft.Graph
{
    ...
    public partial interface IDirectoryRoleScopedMembersCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<DirectoryRoleScopedMembersCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DirectoryRoleScopedMembersCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<DirectoryRoleScopedMembersCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
