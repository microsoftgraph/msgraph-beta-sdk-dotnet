...
namespace Microsoft.Graph
{
    ...
    public partial class AuthenticationContextClassReferenceRequest : BaseRequest, IAuthenticationContextClassReferenceRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<AuthenticationContextClassReference> PutAsync(AuthenticationContextClassReference authenticationContextClassReferenceToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="authenticationContextClassReferenceToUpdate">The AuthenticationContextClassReference object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{AuthenticationContextClassReference}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<AuthenticationContextClassReference>> PutResponseAsync(AuthenticationContextClassReference authenticationContextClassReferenceToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<AuthenticationContextClassReference>(authenticationContextClassReferenceToUpdate, cancellationToken);
