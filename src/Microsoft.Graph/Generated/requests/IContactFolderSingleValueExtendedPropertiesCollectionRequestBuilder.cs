...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IContactFolderSingleValueExtendedPropertiesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IContactFolderSingleValueExtendedPropertiesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IContactFolderSingleValueExtendedPropertiesCollectionRequest Request(IEnumerable<Option> options);
