...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type CloudPcReportsGetTotalAggregatedRemoteConnectionReportsRequestBuilder.
    /// </summary>
    public partial class CloudPcReportsGetTotalAggregatedRemoteConnectionReportsRequestBuilder : BaseActionMethodRequestBuilder<ICloudPcReportsGetTotalAggregatedRemoteConnectionReportsRequest>, ICloudPcReportsGetTotalAggregatedRemoteConnectionReportsRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="CloudPcReportsGetTotalAggregatedRemoteConnectionReportsRequestBuilder"/>.
        /// </summary>
        ...
        public CloudPcReportsGetTotalAggregatedRemoteConnectionReportsRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string filter,
        ...
        protected override ICloudPcReportsGetTotalAggregatedRemoteConnectionReportsRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new CloudPcReportsGetTotalAggregatedRemoteConnectionReportsRequest(functionUrl, this.Client, options);
