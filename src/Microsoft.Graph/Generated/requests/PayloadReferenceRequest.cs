...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PayloadReferenceRequest.
    /// </summary>
    public partial class PayloadReferenceRequest : BaseRequest, IPayloadReferenceRequest
    {
        /// <summary>
        /// Constructs a new PayloadReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public PayloadReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// </summary>
        /// <param name="id">The Payload reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified Payload reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The Payload reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
