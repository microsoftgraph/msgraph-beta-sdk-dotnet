...
namespace Microsoft.Graph
{
    ...
    public partial interface IManagedIOSLobAppRequest : IBaseRequest
    {
        ...
        /// <param name="managedIOSLobAppToUpdate">The ManagedIOSLobApp to update.</param>
        /// <returns>The <see cref="GraphResponse{ManagedIOSLobApp}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ManagedIOSLobApp>> UpdateResponseAsync(ManagedIOSLobApp managedIOSLobAppToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ManagedIOSLobApp}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<ManagedIOSLobApp>> UpdateResponseAsync(ManagedIOSLobApp managedIOSLobAppToUpdate, CancellationToken cancellationToken);
