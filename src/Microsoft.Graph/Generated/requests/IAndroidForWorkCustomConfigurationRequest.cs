...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidForWorkCustomConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AndroidForWorkCustomConfiguration> CreateAsync(AndroidForWorkCustomConfiguration androidForWorkCustomConfigurationToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkCustomConfiguration>> CreateResponseAsync(AndroidForWorkCustomConfiguration androidForWorkCustomConfigurationToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkCustomConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkCustomConfiguration>> CreateResponseAsync(AndroidForWorkCustomConfiguration androidForWorkCustomConfigurationToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkCustomConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkCustomConfiguration>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkCustomConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkCustomConfiguration>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="androidForWorkCustomConfigurationToUpdate">The AndroidForWorkCustomConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkCustomConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkCustomConfiguration>> UpdateResponseAsync(AndroidForWorkCustomConfiguration androidForWorkCustomConfigurationToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AndroidForWorkCustomConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AndroidForWorkCustomConfiguration>> UpdateResponseAsync(AndroidForWorkCustomConfiguration androidForWorkCustomConfigurationToUpdate, CancellationToken cancellationToken);
