...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsSechRequest : BaseRequest, IWorkbookFunctionsSechRequest
    {
        /// <summary>
        /// Constructs a new WorkbookFunctionsSechRequest.
        /// </summary>
        public WorkbookFunctionsSechRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new WorkbookFunctionsSechRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public WorkbookFunctionsSechRequestBody RequestBody { get; private set; }
        ...
        public IWorkbookFunctionsSechRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWorkbookFunctionsSechRequest Select(string value)
        {
