...
namespace Microsoft.Graph
{
    ...
    public partial class Office365ServicesUserCountsRequest : BaseRequest, IOffice365ServicesUserCountsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Office365ServicesUserCounts>> CreateResponseAsync(Office365ServicesUserCounts office365ServicesUserCountsToCreate)
        {
            return this.CreateResponseAsync(office365ServicesUserCountsToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Office365ServicesUserCounts}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Office365ServicesUserCounts>> CreateResponseAsync(Office365ServicesUserCounts office365ServicesUserCountsToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<Office365ServicesUserCounts>(office365ServicesUserCountsToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Office365ServicesUserCounts}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Office365ServicesUserCounts>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Office365ServicesUserCounts}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Office365ServicesUserCounts>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Office365ServicesUserCounts>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="office365ServicesUserCountsToUpdate">The Office365ServicesUserCounts to update.</param>
        /// <returns>The <see cref="GraphResponse{Office365ServicesUserCounts}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Office365ServicesUserCounts>> UpdateResponseAsync(Office365ServicesUserCounts office365ServicesUserCountsToUpdate)
        {
            return this.UpdateResponseAsync(office365ServicesUserCountsToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Office365ServicesUserCounts}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Office365ServicesUserCounts>> UpdateResponseAsync(Office365ServicesUserCounts office365ServicesUserCountsToUpdate, CancellationToken cancellationToken)
        {
			if (office365ServicesUserCountsToUpdate.AdditionalData != null)
			{
				if (office365ServicesUserCountsToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<Office365ServicesUserCounts>(office365ServicesUserCountsToUpdate, cancellationToken).ConfigureAwait(false);
        }
