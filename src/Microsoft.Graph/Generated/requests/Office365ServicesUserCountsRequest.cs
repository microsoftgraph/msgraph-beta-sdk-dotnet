...
namespace Microsoft.Graph
{
    ...
    public partial class Office365ServicesUserCountsRequest : BaseRequest, IOffice365ServicesUserCountsRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<Office365ServicesUserCounts>> CreateResponseAsync(Office365ServicesUserCounts office365ServicesUserCountsToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Office365ServicesUserCounts}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Office365ServicesUserCounts>> UpdateResponseAsync(Office365ServicesUserCounts office365ServicesUserCountsToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
