...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IGroupAcceptedSendersCollectionWithReferencesRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IGroupAcceptedSendersCollectionWithReferencesRequest Request();
        ...
        /// <returns>The built request.</returns>
        IGroupAcceptedSendersCollectionWithReferencesRequest Request(IEnumerable<Option> options);
        ...
        IGroupAcceptedSendersCollectionReferencesRequestBuilder References { get; }
