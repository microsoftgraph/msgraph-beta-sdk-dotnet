...
namespace Microsoft.Graph
{
    ...
    public partial class JobResponseBaseRequest : BaseRequest, IJobResponseBaseRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<JobResponseBase>> CreateResponseAsync(JobResponseBase jobResponseBaseToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{JobResponseBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<JobResponseBase>> UpdateResponseAsync(JobResponseBase jobResponseBaseToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
