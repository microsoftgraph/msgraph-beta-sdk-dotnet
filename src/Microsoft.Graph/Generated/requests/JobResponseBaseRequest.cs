...
namespace Microsoft.Graph
{
    ...
    public partial class JobResponseBaseRequest : BaseRequest, IJobResponseBaseRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<JobResponseBase>> CreateResponseAsync(JobResponseBase jobResponseBaseToCreate)
        {
            return this.CreateResponseAsync(jobResponseBaseToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{JobResponseBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<JobResponseBase>> CreateResponseAsync(JobResponseBase jobResponseBaseToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<JobResponseBase>(jobResponseBaseToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{JobResponseBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<JobResponseBase>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{JobResponseBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<JobResponseBase>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<JobResponseBase>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="jobResponseBaseToUpdate">The JobResponseBase to update.</param>
        /// <returns>The <see cref="GraphResponse{JobResponseBase}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<JobResponseBase>> UpdateResponseAsync(JobResponseBase jobResponseBaseToUpdate)
        {
            return this.UpdateResponseAsync(jobResponseBaseToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{JobResponseBase}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<JobResponseBase>> UpdateResponseAsync(JobResponseBase jobResponseBaseToUpdate, CancellationToken cancellationToken)
        {
			if (jobResponseBaseToUpdate.AdditionalData != null)
			{
				if (jobResponseBaseToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<JobResponseBase>(jobResponseBaseToUpdate, cancellationToken).ConfigureAwait(false);
        }
