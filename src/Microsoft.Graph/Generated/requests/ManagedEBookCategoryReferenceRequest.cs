...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ManagedEBookCategoryReferenceRequest.
    /// </summary>
    public partial class ManagedEBookCategoryReferenceRequest : BaseRequest, IManagedEBookCategoryReferenceRequest
    {
        /// <summary>
        /// Constructs a new ManagedEBookCategoryReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ManagedEBookCategoryReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified ManagedEBookCategory reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified ManagedEBookCategory reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified ManagedEBookCategory reference.
        /// </summary>
        /// <param name="id">The ManagedEBookCategory reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified ManagedEBookCategory reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The ManagedEBookCategory reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
