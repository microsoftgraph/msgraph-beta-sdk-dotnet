...
namespace Microsoft.Graph
{
    ...
    public partial class YammerActivityUserDetailRequest : BaseRequest, IYammerActivityUserDetailRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<YammerActivityUserDetail> PutAsync(YammerActivityUserDetail yammerActivityUserDetailToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<YammerActivityUserDetail>> PutResponseAsync(YammerActivityUserDetail yammerActivityUserDetailToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<YammerActivityUserDetail>(yammerActivityUserDetailToUpdate, cancellationToken);
