...
namespace Microsoft.Graph
{
    ...
    public partial interface IRiskDetectionRequest : IBaseRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{RiskDetection}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<RiskDetection>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{RiskDetection}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<RiskDetection>> GetResponseAsync(CancellationToken cancellationToken);
