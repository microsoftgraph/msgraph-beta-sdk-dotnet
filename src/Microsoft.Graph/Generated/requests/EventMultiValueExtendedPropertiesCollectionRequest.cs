...
namespace Microsoft.Graph
{
    ...
    public partial class EventMultiValueExtendedPropertiesCollectionRequest : BaseRequest, IEventMultiValueExtendedPropertiesCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<EventMultiValueExtendedPropertiesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.GET.ToString();
            return this.SendAsyncWithGraphResponse<EventMultiValueExtendedPropertiesCollectionResponse>(null, cancellationToken);
        }
