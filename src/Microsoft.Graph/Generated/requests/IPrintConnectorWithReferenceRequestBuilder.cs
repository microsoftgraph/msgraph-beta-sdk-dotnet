...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IPrintConnectorWithReferenceRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IPrintConnectorWithReferenceRequest Request();
        ...
        /// <returns>The built request.</returns>
        IPrintConnectorWithReferenceRequest Request(IEnumerable<Option> options);
        ...
        IPrintConnectorReferenceRequestBuilder Reference { get; }
