...
namespace Microsoft.Graph
{
    ...
    public partial class UserOwnedObjectsCollectionWithReferencesRequest : BaseRequest, IUserOwnedObjectsCollectionWithReferencesRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<UserOwnedObjectsCollectionWithReferencesResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<UserOwnedObjectsCollectionWithReferencesResponse>(null, cancellationToken);
        }
