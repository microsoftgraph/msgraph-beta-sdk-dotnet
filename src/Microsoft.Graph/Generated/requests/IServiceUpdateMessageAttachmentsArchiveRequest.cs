...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IServiceUpdateMessageAttachmentsArchiveRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream attachmentsArchive, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : ServiceUpdateMessage;
        ...
        System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream attachmentsArchive, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : ServiceUpdateMessage;
