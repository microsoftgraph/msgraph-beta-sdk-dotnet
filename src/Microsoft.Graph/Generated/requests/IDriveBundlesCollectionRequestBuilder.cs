...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IDriveBundlesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IDriveBundlesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IDriveBundlesCollectionRequest Request(IEnumerable<Option> options);
