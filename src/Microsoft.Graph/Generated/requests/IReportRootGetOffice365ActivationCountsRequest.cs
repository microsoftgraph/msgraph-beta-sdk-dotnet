...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetOffice365ActivationCountsRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ActivationCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="office365activationcounts">The Office365ActivationCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ActivationCountsCollectionResponse>> PatchResponseAsync(Office365ActivationCounts office365activationcounts, CancellationToken cancellationToken = default);
        ...
        /// <param name="office365activationcounts">The Office365ActivationCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetOffice365ActivationCountsCollectionResponse>> PutResponseAsync(Office365ActivationCounts office365activationcounts, CancellationToken cancellationToken = default);
