...
namespace Microsoft.Graph
{
    ...
    public partial class IosLobAppProvisioningConfigurationRequest : BaseRequest, IIosLobAppProvisioningConfigurationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<IosLobAppProvisioningConfiguration>> CreateResponseAsync(IosLobAppProvisioningConfiguration iosLobAppProvisioningConfigurationToCreate)
        {
            return this.CreateResponseAsync(iosLobAppProvisioningConfigurationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosLobAppProvisioningConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosLobAppProvisioningConfiguration>> CreateResponseAsync(IosLobAppProvisioningConfiguration iosLobAppProvisioningConfigurationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<IosLobAppProvisioningConfiguration>(iosLobAppProvisioningConfigurationToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{IosLobAppProvisioningConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosLobAppProvisioningConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosLobAppProvisioningConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosLobAppProvisioningConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<IosLobAppProvisioningConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="iosLobAppProvisioningConfigurationToUpdate">The IosLobAppProvisioningConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{IosLobAppProvisioningConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosLobAppProvisioningConfiguration>> UpdateResponseAsync(IosLobAppProvisioningConfiguration iosLobAppProvisioningConfigurationToUpdate)
        {
            return this.UpdateResponseAsync(iosLobAppProvisioningConfigurationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosLobAppProvisioningConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosLobAppProvisioningConfiguration>> UpdateResponseAsync(IosLobAppProvisioningConfiguration iosLobAppProvisioningConfigurationToUpdate, CancellationToken cancellationToken)
        {
			if (iosLobAppProvisioningConfigurationToUpdate.AdditionalData != null)
			{
				if (iosLobAppProvisioningConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<IosLobAppProvisioningConfiguration>(iosLobAppProvisioningConfigurationToUpdate, cancellationToken).ConfigureAwait(false);
        }
