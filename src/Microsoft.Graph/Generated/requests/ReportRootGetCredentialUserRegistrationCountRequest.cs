...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetCredentialUserRegistrationCountRequest : BaseRequest, IReportRootGetCredentialUserRegistrationCountRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetCredentialUserRegistrationCountCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReportRootGetCredentialUserRegistrationCountCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="credentialuserregistrationcount">The CredentialUserRegistrationCount object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetCredentialUserRegistrationCountCollectionResponse>> PatchResponseAsync(CredentialUserRegistrationCount credentialuserregistrationcount, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<ReportRootGetCredentialUserRegistrationCountCollectionResponse>(credentialuserregistrationcount, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="credentialuserregistrationcount">The CredentialUserRegistrationCount object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReportRootGetCredentialUserRegistrationCountCollectionResponse>> PutResponseAsync(CredentialUserRegistrationCount credentialuserregistrationcount, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "PUT";
            return await this.SendAsyncWithGraphResponse<ReportRootGetCredentialUserRegistrationCountCollectionResponse>(credentialuserregistrationcount, cancellationToken).ConfigureAwait(false);
        }
