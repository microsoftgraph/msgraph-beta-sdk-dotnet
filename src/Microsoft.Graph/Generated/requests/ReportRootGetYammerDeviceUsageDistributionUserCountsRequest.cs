...
namespace Microsoft.Graph
{
    ...
    public partial class ReportRootGetYammerDeviceUsageDistributionUserCountsRequest : BaseRequest, IReportRootGetYammerDeviceUsageDistributionUserCountsRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerDeviceUsageDistributionUserCountsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        /// <param name="yammerdeviceusagedistributionusercounts">The YammerDeviceUsageDistributionUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerDeviceUsageDistributionUserCountsCollectionResponse>> PatchResponseAsync(YammerDeviceUsageDistributionUserCounts yammerdeviceusagedistributionusercounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="yammerdeviceusagedistributionusercounts">The YammerDeviceUsageDistributionUserCounts object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerDeviceUsageDistributionUserCountsCollectionResponse>> PutResponseAsync(YammerDeviceUsageDistributionUserCounts yammerdeviceusagedistributionusercounts, CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<ReportRootGetYammerDeviceUsageDistributionUserCountsCollectionResponse>(yammerdeviceusagedistributionusercounts, cancellationToken);
        }
