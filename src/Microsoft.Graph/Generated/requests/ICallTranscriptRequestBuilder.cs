...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface ICallTranscriptRequestBuilder.
    /// </summary>
    public partial interface ICallTranscriptRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new ICallTranscriptRequest Request();
        ...
        /// <returns>The built request.</returns>
        new ICallTranscriptRequest Request(IEnumerable<Option> options);
