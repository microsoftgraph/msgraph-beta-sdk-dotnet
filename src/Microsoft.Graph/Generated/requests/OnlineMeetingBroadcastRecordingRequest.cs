...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type OnlineMeetingBroadcastRecordingRequest.
    /// </summary>
    public partial class OnlineMeetingBroadcastRecordingRequest : BaseRequest, IOnlineMeetingBroadcastRecordingRequest
    {
        /// <summary>
        /// Constructs a new OnlineMeetingBroadcastRecordingRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public OnlineMeetingBroadcastRecordingRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream broadcastRecording, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnlineMeeting
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
            return this.SendAsync<T>(broadcastRecording, cancellationToken, completionOption);
        }
        ...
        public System.Threading.Tasks.Task<GraphResponse<T>> PutResponseAsync<T>(Stream broadcastRecording, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OnlineMeeting
        {
            this.ContentType ??= CoreConstants.MimeTypeNames.Application.Stream;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<T>(broadcastRecording, cancellationToken, completionOption);
        }
