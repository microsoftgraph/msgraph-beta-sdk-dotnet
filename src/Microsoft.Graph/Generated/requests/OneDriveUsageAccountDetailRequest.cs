...
namespace Microsoft.Graph
{
    ...
    public partial class OneDriveUsageAccountDetailRequest : BaseRequest, IOneDriveUsageAccountDetailRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{OneDriveUsageAccountDetail}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OneDriveUsageAccountDetail>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OneDriveUsageAccountDetail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OneDriveUsageAccountDetail>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<OneDriveUsageAccountDetail>(null, cancellationToken).ConfigureAwait(false);
        }
