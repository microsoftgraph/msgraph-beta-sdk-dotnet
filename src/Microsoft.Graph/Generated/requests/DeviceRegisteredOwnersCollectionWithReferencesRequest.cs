...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceRegisteredOwnersCollectionWithReferencesRequest : BaseRequest, IDeviceRegisteredOwnersCollectionWithReferencesRequest
    {
        ...
        public async System.Threading.Tasks.Task<IDeviceRegisteredOwnersCollectionWithReferencesPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DeviceRegisteredOwnersCollectionWithReferencesResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceRegisteredOwnersCollectionWithReferencesResponse>(null, cancellationToken).ConfigureAwait(false);
        }
