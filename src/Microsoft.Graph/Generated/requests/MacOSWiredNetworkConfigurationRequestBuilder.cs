...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type MacOSWiredNetworkConfigurationRequestBuilder.
    /// </summary>
    public partial class MacOSWiredNetworkConfigurationRequestBuilder : DeviceConfigurationRequestBuilder, IMacOSWiredNetworkConfigurationRequestBuilder
    {

        /// <summary>
        /// Constructs a new MacOSWiredNetworkConfigurationRequestBuilder.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        public MacOSWiredNetworkConfigurationRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public new IMacOSWiredNetworkConfigurationRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public new IMacOSWiredNetworkConfigurationRequest Request(IEnumerable<Option> options)
        {
            return new MacOSWiredNetworkConfigurationRequest(this.RequestUrl, this.Client, options);
        }
