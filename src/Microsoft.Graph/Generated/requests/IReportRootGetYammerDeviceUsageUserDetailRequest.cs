...
namespace Microsoft.Graph
{
    ...
    public partial interface IReportRootGetYammerDeviceUsageUserDetailRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerDeviceUsageUserDetailCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="yammerdeviceusageuserdetail">The YammerDeviceUsageUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerDeviceUsageUserDetailCollectionResponse>> PatchResponseAsync(YammerDeviceUsageUserDetail yammerdeviceusageuserdetail, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="yammerdeviceusageuserdetail">The YammerDeviceUsageUserDetail object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<ReportRootGetYammerDeviceUsageUserDetailCollectionResponse>> PutResponseAsync(YammerDeviceUsageUserDetail yammerdeviceusageuserdetail, CancellationToken cancellationToken = default(CancellationToken));
