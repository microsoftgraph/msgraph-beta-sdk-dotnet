...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IItemActivityStatRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IItemActivityStatRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IItemActivityStatRequest Request(IEnumerable<Option> options);
