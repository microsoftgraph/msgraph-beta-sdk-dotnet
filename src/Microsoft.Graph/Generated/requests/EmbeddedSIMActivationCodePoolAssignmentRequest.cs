...
namespace Microsoft.Graph
{
    ...
    public partial class EmbeddedSIMActivationCodePoolAssignmentRequest : BaseRequest, IEmbeddedSIMActivationCodePoolAssignmentRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<EmbeddedSIMActivationCodePoolAssignment>> CreateResponseAsync(EmbeddedSIMActivationCodePoolAssignment embeddedSIMActivationCodePoolAssignmentToCreate)
        {
            return this.CreateResponseAsync(embeddedSIMActivationCodePoolAssignmentToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EmbeddedSIMActivationCodePoolAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EmbeddedSIMActivationCodePoolAssignment>> CreateResponseAsync(EmbeddedSIMActivationCodePoolAssignment embeddedSIMActivationCodePoolAssignmentToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<EmbeddedSIMActivationCodePoolAssignment>(embeddedSIMActivationCodePoolAssignmentToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{EmbeddedSIMActivationCodePoolAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<EmbeddedSIMActivationCodePoolAssignment>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EmbeddedSIMActivationCodePoolAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EmbeddedSIMActivationCodePoolAssignment>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<EmbeddedSIMActivationCodePoolAssignment>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="embeddedSIMActivationCodePoolAssignmentToUpdate">The EmbeddedSIMActivationCodePoolAssignment to update.</param>
        /// <returns>The <see cref="GraphResponse{EmbeddedSIMActivationCodePoolAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<EmbeddedSIMActivationCodePoolAssignment>> UpdateResponseAsync(EmbeddedSIMActivationCodePoolAssignment embeddedSIMActivationCodePoolAssignmentToUpdate)
        {
            return this.UpdateResponseAsync(embeddedSIMActivationCodePoolAssignmentToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{EmbeddedSIMActivationCodePoolAssignment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EmbeddedSIMActivationCodePoolAssignment>> UpdateResponseAsync(EmbeddedSIMActivationCodePoolAssignment embeddedSIMActivationCodePoolAssignmentToUpdate, CancellationToken cancellationToken)
        {
			if (embeddedSIMActivationCodePoolAssignmentToUpdate.AdditionalData != null)
			{
				if (embeddedSIMActivationCodePoolAssignmentToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<EmbeddedSIMActivationCodePoolAssignment>(embeddedSIMActivationCodePoolAssignmentToUpdate, cancellationToken).ConfigureAwait(false);
        }
