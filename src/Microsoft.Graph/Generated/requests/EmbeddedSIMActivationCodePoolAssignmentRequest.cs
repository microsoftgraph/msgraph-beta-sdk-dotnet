...
namespace Microsoft.Graph
{
    ...
    public partial class EmbeddedSIMActivationCodePoolAssignmentRequest : BaseRequest, IEmbeddedSIMActivationCodePoolAssignmentRequest
    {
        ...
        public async System.Threading.Tasks.Task<EmbeddedSIMActivationCodePoolAssignment> CreateAsync(EmbeddedSIMActivationCodePoolAssignment embeddedSIMActivationCodePoolAssignmentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<EmbeddedSIMActivationCodePoolAssignment>> CreateResponseAsync(EmbeddedSIMActivationCodePoolAssignment embeddedSIMActivationCodePoolAssignmentToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<EmbeddedSIMActivationCodePoolAssignment>(embeddedSIMActivationCodePoolAssignmentToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<EmbeddedSIMActivationCodePoolAssignment> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EmbeddedSIMActivationCodePoolAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<EmbeddedSIMActivationCodePoolAssignment>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<EmbeddedSIMActivationCodePoolAssignment>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<EmbeddedSIMActivationCodePoolAssignment> UpdateAsync(EmbeddedSIMActivationCodePoolAssignment embeddedSIMActivationCodePoolAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{EmbeddedSIMActivationCodePoolAssignment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<EmbeddedSIMActivationCodePoolAssignment>> UpdateResponseAsync(EmbeddedSIMActivationCodePoolAssignment embeddedSIMActivationCodePoolAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<EmbeddedSIMActivationCodePoolAssignment>(embeddedSIMActivationCodePoolAssignmentToUpdate, cancellationToken);
        }

        /// <summary>
        /// Updates the specified EmbeddedSIMActivationCodePoolAssignment using PUT.
        /// </summary>
        /// <param name="embeddedSIMActivationCodePoolAssignmentToUpdate">The EmbeddedSIMActivationCodePoolAssignment object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<EmbeddedSIMActivationCodePoolAssignment> PutAsync(EmbeddedSIMActivationCodePoolAssignment embeddedSIMActivationCodePoolAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <summary>
        /// Updates the specified EmbeddedSIMActivationCodePoolAssignment using PUT and returns a <see cref="GraphResponse{EmbeddedSIMActivationCodePoolAssignment}"/> object.
        /// </summary>
        /// <param name="embeddedSIMActivationCodePoolAssignmentToUpdate">The EmbeddedSIMActivationCodePoolAssignment object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{EmbeddedSIMActivationCodePoolAssignment}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<EmbeddedSIMActivationCodePoolAssignment>> PutResponseAsync(EmbeddedSIMActivationCodePoolAssignment embeddedSIMActivationCodePoolAssignmentToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<EmbeddedSIMActivationCodePoolAssignment>(embeddedSIMActivationCodePoolAssignmentToUpdate, cancellationToken);
