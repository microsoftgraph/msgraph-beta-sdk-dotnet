...
namespace Microsoft.Graph
{
    ...
    public partial class Windows10XWifiConfigurationRequest : BaseRequest, IWindows10XWifiConfigurationRequest
    {
        ...
        public System.Threading.Tasks.Task<Windows10XWifiConfiguration> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The Windows10XWifiConfiguration.</returns>
        public async System.Threading.Tasks.Task<Windows10XWifiConfiguration> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Windows10XWifiConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows10XWifiConfiguration>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows10XWifiConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Windows10XWifiConfiguration>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Windows10XWifiConfiguration>(null, cancellationToken).ConfigureAwait(false);
        }
