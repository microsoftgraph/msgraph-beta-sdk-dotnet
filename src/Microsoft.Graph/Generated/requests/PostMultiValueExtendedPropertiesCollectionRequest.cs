...
namespace Microsoft.Graph
{
    ...
    public partial class PostMultiValueExtendedPropertiesCollectionRequest : BaseRequest, IPostMultiValueExtendedPropertiesCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PostMultiValueExtendedPropertiesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = Constants.HttpMethods.Get;
            return this.SendAsyncWithGraphResponse<PostMultiValueExtendedPropertiesCollectionResponse>(null, cancellationToken);
        }
