...
namespace Microsoft.Graph
{
    ...
    public partial class Windows81SCEPCertificateProfileRequest : BaseRequest, IWindows81SCEPCertificateProfileRequest
    {
        ...
        public async System.Threading.Tasks.Task<Windows81SCEPCertificateProfile> CreateAsync(Windows81SCEPCertificateProfile windows81SCEPCertificateProfileToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows81SCEPCertificateProfile>> CreateResponseAsync(Windows81SCEPCertificateProfile windows81SCEPCertificateProfileToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<Windows81SCEPCertificateProfile> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Windows81SCEPCertificateProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows81SCEPCertificateProfile>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<Windows81SCEPCertificateProfile> UpdateAsync(Windows81SCEPCertificateProfile windows81SCEPCertificateProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Windows81SCEPCertificateProfile}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Windows81SCEPCertificateProfile>> UpdateResponseAsync(Windows81SCEPCertificateProfile windows81SCEPCertificateProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<Windows81SCEPCertificateProfile> PutAsync(Windows81SCEPCertificateProfile windows81SCEPCertificateProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<Windows81SCEPCertificateProfile>> PutResponseAsync(Windows81SCEPCertificateProfile windows81SCEPCertificateProfileToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<Windows81SCEPCertificateProfile>(windows81SCEPCertificateProfileToUpdate, cancellationToken);
