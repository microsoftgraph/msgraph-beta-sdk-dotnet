...
namespace Microsoft.Graph
{
    ...
    public partial class YammerDeviceUsageUserDetailRequest : BaseRequest, IYammerDeviceUsageUserDetailRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{YammerDeviceUsageUserDetail}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<YammerDeviceUsageUserDetail>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{YammerDeviceUsageUserDetail}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<YammerDeviceUsageUserDetail>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<YammerDeviceUsageUserDetail>(null, cancellationToken).ConfigureAwait(false);
        }
