...
namespace Microsoft.Graph
{
    ...
    public partial class NetworkIPv6ConfigurationManagementConditionRequest : BaseRequest, INetworkIPv6ConfigurationManagementConditionRequest
    {
        ...
        public async System.Threading.Tasks.Task<NetworkIPv6ConfigurationManagementCondition> CreateAsync(NetworkIPv6ConfigurationManagementCondition networkIPv6ConfigurationManagementConditionToCreate, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<NetworkIPv6ConfigurationManagementCondition>> CreateResponseAsync(NetworkIPv6ConfigurationManagementCondition networkIPv6ConfigurationManagementConditionToCreate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
            return this.SendAsyncWithGraphResponse<NetworkIPv6ConfigurationManagementCondition>(networkIPv6ConfigurationManagementConditionToCreate, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<NetworkIPv6ConfigurationManagementCondition> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{NetworkIPv6ConfigurationManagementCondition}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<NetworkIPv6ConfigurationManagementCondition>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
            return this.SendAsyncWithGraphResponse<NetworkIPv6ConfigurationManagementCondition>(null, cancellationToken);
        }
        ...
        public async System.Threading.Tasks.Task<NetworkIPv6ConfigurationManagementCondition> UpdateAsync(NetworkIPv6ConfigurationManagementCondition networkIPv6ConfigurationManagementConditionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{NetworkIPv6ConfigurationManagementCondition}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<NetworkIPv6ConfigurationManagementCondition>> UpdateResponseAsync(NetworkIPv6ConfigurationManagementCondition networkIPv6ConfigurationManagementConditionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
            return this.SendAsyncWithGraphResponse<NetworkIPv6ConfigurationManagementCondition>(networkIPv6ConfigurationManagementConditionToUpdate, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<NetworkIPv6ConfigurationManagementCondition> PutAsync(NetworkIPv6ConfigurationManagementCondition networkIPv6ConfigurationManagementConditionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="networkIPv6ConfigurationManagementConditionToUpdate">The NetworkIPv6ConfigurationManagementCondition object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{NetworkIPv6ConfigurationManagementCondition}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<NetworkIPv6ConfigurationManagementCondition>> PutResponseAsync(NetworkIPv6ConfigurationManagementCondition networkIPv6ConfigurationManagementConditionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<NetworkIPv6ConfigurationManagementCondition>(networkIPv6ConfigurationManagementConditionToUpdate, cancellationToken);
