...
namespace Microsoft.Graph
{
    ...
    public partial class GroupAppRoleAssignmentsCollectionRequest : BaseRequest, IGroupAppRoleAssignmentsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<GroupAppRoleAssignmentsCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{GroupAppRoleAssignmentsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<GroupAppRoleAssignmentsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<GroupAppRoleAssignmentsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
