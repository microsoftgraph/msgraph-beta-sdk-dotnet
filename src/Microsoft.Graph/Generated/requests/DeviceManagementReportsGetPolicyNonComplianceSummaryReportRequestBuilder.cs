...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DeviceManagementReportsGetPolicyNonComplianceSummaryReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetPolicyNonComplianceSummaryReportRequest>, IDeviceManagementReportsGetPolicyNonComplianceSummaryReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetPolicyNonComplianceSummaryReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetPolicyNonComplianceSummaryReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetPolicyNonComplianceSummaryReportRequest(functionUrl, this.Client, options);
