...
namespace Microsoft.Graph
{
    ...
    public partial class DirectoryRoleAccessReviewPolicyRequest : BaseRequest, IDirectoryRoleAccessReviewPolicyRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DirectoryRoleAccessReviewPolicy>> CreateResponseAsync(DirectoryRoleAccessReviewPolicy directoryRoleAccessReviewPolicyToCreate)
        {
            return this.CreateResponseAsync(directoryRoleAccessReviewPolicyToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DirectoryRoleAccessReviewPolicy}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DirectoryRoleAccessReviewPolicy>> CreateResponseAsync(DirectoryRoleAccessReviewPolicy directoryRoleAccessReviewPolicyToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DirectoryRoleAccessReviewPolicy>(directoryRoleAccessReviewPolicyToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DirectoryRoleAccessReviewPolicy}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DirectoryRoleAccessReviewPolicy>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DirectoryRoleAccessReviewPolicy}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DirectoryRoleAccessReviewPolicy>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DirectoryRoleAccessReviewPolicy>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="directoryRoleAccessReviewPolicyToUpdate">The DirectoryRoleAccessReviewPolicy to update.</param>
        /// <returns>The <see cref="GraphResponse{DirectoryRoleAccessReviewPolicy}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DirectoryRoleAccessReviewPolicy>> UpdateResponseAsync(DirectoryRoleAccessReviewPolicy directoryRoleAccessReviewPolicyToUpdate)
        {
            return this.UpdateResponseAsync(directoryRoleAccessReviewPolicyToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DirectoryRoleAccessReviewPolicy}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DirectoryRoleAccessReviewPolicy>> UpdateResponseAsync(DirectoryRoleAccessReviewPolicy directoryRoleAccessReviewPolicyToUpdate, CancellationToken cancellationToken)
        {
			if (directoryRoleAccessReviewPolicyToUpdate.AdditionalData != null)
			{
				if (directoryRoleAccessReviewPolicyToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<DirectoryRoleAccessReviewPolicy>(directoryRoleAccessReviewPolicyToUpdate, cancellationToken).ConfigureAwait(false);
        }
