...
namespace Microsoft.Graph
{
    ...
    public partial class DirectoryRoleAccessReviewPolicyRequest : BaseRequest, IDirectoryRoleAccessReviewPolicyRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DirectoryRoleAccessReviewPolicy>> CreateResponseAsync(DirectoryRoleAccessReviewPolicy directoryRoleAccessReviewPolicyToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DirectoryRoleAccessReviewPolicy}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DirectoryRoleAccessReviewPolicy>> UpdateResponseAsync(DirectoryRoleAccessReviewPolicy directoryRoleAccessReviewPolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
