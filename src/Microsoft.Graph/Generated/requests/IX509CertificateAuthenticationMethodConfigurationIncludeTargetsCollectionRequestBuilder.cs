...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IX509CertificateAuthenticationMethodConfigurationIncludeTargetsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IX509CertificateAuthenticationMethodConfigurationIncludeTargetsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IX509CertificateAuthenticationMethodConfigurationIncludeTargetsCollectionRequest Request(IEnumerable<Option> options);
