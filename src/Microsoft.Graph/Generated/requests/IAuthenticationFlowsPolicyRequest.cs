...
namespace Microsoft.Graph
{
    ...
    public partial interface IAuthenticationFlowsPolicyRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<AuthenticationFlowsPolicy> PutAsync(AuthenticationFlowsPolicy authenticationFlowsPolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<AuthenticationFlowsPolicy>> PutResponseAsync(AuthenticationFlowsPolicy authenticationFlowsPolicyToUpdate, CancellationToken cancellationToken = default(CancellationToken));
