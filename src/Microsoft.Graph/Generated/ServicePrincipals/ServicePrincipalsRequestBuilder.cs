...
namespace Microsoft.Graph.Beta.ServicePrincipals {
    ...
    public class ServicePrincipalsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.servicePrincipals.item collection</summary>
        ...
        public ServicePrincipalsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals{?%24top,%24search,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.ServicePrincipal> PostAsync(Microsoft.Graph.Beta.Models.ServicePrincipal body, CancellationToken cancellationToken = default, Action<ServicePrincipalsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
