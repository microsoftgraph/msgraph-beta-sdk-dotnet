...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.ServicePrincipals.Delta {
    ...
    public class DeltaResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as DeltaResponse).Value = n.GetCollectionOfObjectValues<ServicePrincipal>(ServicePrincipal.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
