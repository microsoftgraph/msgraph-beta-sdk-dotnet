...
using MicrosoftGraphSdk.ServicePrincipals.Item.Synchronization.Templates.Item.Schema.Directories.Item;
using System;
...
namespace MicrosoftGraphSdk.ServicePrincipals.Item.Synchronization.Templates.Item.Schema.Directories {
    /// <summary>Builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\synchronization\templates\{synchronizationTemplate-id}\schema\directories</summary>
    public class DirectoriesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.servicePrincipals.item.synchronization.templates.item.schema.directories.item collection</summary>
        ...
        public DirectoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal_id}/synchronization/templates/{synchronizationTemplate_id}/schema/directories{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
