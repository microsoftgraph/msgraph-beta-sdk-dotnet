...
using MicrosoftGraph.ServicePrincipals.Item.Synchronization.Templates.Item.Schema.Directories.Item;
using System;
...
namespace MicrosoftGraph.ServicePrincipals.Item.Synchronization.Templates.Item.Schema.Directories {
    ...
    public class DirectoriesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.servicePrincipals.item.synchronization.templates.item.schema.directories.item collection</summary>
