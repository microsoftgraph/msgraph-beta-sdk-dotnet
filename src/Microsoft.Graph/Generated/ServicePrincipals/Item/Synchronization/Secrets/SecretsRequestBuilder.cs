...
using Microsoft.Graph.Beta.ServicePrincipals.Item.Synchronization.Secrets.Count;
...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.Synchronization.Secrets {
    ...
    public class SecretsRequestBuilder {
        ...
        public SecretsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/secrets";
