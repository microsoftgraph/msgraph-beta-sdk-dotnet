...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.Synchronization.Jobs.Item.ProvisionOnDemand {
    ...
    public class ProvisionOnDemandRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(StringKeyStringValuePairRequestBody body, Action<ProvisionOnDemandRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<StringKeyStringValuePair> PostAsync(StringKeyStringValuePairRequestBody body, Action<ProvisionOnDemandRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
