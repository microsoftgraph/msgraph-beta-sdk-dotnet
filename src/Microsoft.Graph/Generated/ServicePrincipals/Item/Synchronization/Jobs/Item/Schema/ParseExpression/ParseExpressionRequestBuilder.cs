...
namespace MicrosoftGraphSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.ParseExpression {
    /// <summary>Builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\synchronization\jobs\{synchronizationJob-id}\schema\microsoft.graph.parseExpression</summary>
    public class ParseExpressionRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ParseExpressionRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
