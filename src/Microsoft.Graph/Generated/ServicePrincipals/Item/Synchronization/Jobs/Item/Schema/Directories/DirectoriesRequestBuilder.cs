...
namespace MicrosoftGraph.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.Directories {
    /// <summary>Builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\synchronization\jobs\{synchronizationJob-id}\schema\directories</summary>
    public class DirectoriesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.servicePrincipals.item.synchronization.jobs.item.schema.directories.item collection</summary>
        public DirectoriesRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("directoryDefinition_id", position);
            return new DirectoriesRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public DirectoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal_id}/synchronization/jobs/{synchronizationJob_id}/schema/directories{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
