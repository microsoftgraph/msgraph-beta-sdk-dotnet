...
using Microsoft.Graph.Beta.ServicePrincipals.Item.Synchronization.Jobs.Item.BulkUpload.Value;
...
using System;
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.Synchronization.Jobs.Item.BulkUpload {
    /// <summary>
    ...
    public class BulkUploadRequestBuilder : BaseRequestBuilder {
        ...
        public BulkUploadRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/bulkUpload{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new BulkUploadRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BulkUploadRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/bulkUpload{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
