...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.ServicePrincipals.Item.Synchronization.Jobs.Item.Restart {
    public class RestartRequestBody : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"criteria", (o,n) => { (o as RestartRequestBody).Criteria = n.GetObjectValue<SynchronizationJobRestartCriteria>(); } },
            };
        }
        /// <summary>
