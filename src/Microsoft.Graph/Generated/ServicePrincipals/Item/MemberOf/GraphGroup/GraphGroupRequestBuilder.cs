...
#nullable enable
        public async Task<GroupCollectionResponse?> GetAsync(Action<GraphGroupRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<GroupCollectionResponse> GetAsync(Action<GraphGroupRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
