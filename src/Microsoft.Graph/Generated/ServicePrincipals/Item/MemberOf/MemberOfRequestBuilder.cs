...
using MicrosoftGraphSdk.ServicePrincipals.Item.MemberOf.Count;
using MicrosoftGraphSdk.ServicePrincipals.Item.MemberOf.Item;
using System;
...
namespace MicrosoftGraphSdk.ServicePrincipals.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.servicePrincipals.item.memberOf.item collection</summary>
