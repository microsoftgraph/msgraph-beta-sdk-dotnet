...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.GetPasswordSingleSignOnCredentials {
    ...
    public class GetPasswordSingleSignOnCredentialsRequestBuilder {
        ...
        /// </summary>
        public async Task<PasswordSingleSignOnCredentialSet> PostAsync(GetPasswordSingleSignOnCredentialsPostRequestBody body, CancellationToken cancellationToken = default, Action<GetPasswordSingleSignOnCredentialsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<PasswordSingleSignOnCredentialSet>(requestInfo, PasswordSingleSignOnCredentialSet.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
