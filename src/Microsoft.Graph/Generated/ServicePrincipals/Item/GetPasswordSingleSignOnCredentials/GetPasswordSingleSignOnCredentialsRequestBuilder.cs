...
#nullable enable
        public async Task<PasswordSingleSignOnCredentialSet?> PostAsync(GetPasswordSingleSignOnCredentialsPostRequestBody body, CancellationToken cancellationToken = default, Action<GetPasswordSingleSignOnCredentialsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PasswordSingleSignOnCredentialSet> PostAsync(GetPasswordSingleSignOnCredentialsPostRequestBody body, CancellationToken cancellationToken = default, Action<GetPasswordSingleSignOnCredentialsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
