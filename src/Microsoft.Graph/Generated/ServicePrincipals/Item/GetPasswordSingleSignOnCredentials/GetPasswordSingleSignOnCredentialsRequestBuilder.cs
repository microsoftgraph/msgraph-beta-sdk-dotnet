...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.GetPasswordSingleSignOnCredentials {
    ...
    public class GetPasswordSingleSignOnCredentialsRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="PasswordSingleSignOnCredentialSet"></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(GetPasswordSingleSignOnCredentialsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(GetPasswordSingleSignOnCredentialsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default) {
#endif
