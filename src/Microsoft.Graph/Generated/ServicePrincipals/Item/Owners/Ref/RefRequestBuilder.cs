...
namespace MicrosoftGraph.ServicePrincipals.Item.Owners.Ref {
    ...
    public class RefRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftGraph.ServicePrincipals.Item.Owners.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftGraph.ServicePrincipals.Item.Owners.Ref.Ref> PostAsync(MicrosoftGraph.ServicePrincipals.Item.Owners.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<MicrosoftGraph.ServicePrincipals.Item.Owners.Ref.Ref>(requestInfo, responseHandler, default, cancellationToken);
        }
