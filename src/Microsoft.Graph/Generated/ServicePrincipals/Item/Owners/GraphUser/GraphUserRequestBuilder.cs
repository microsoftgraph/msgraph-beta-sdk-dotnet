...
using Microsoft.Graph.Beta.ServicePrincipals.Item.Owners.GraphUser.Count;
...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.Owners.GraphUser {
    /// <summary>
    ...
    public class GraphUserRequestBuilder {
        ...
        public GraphUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
