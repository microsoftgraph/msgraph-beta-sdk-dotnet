...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.OwnedObjects.Item.ServicePrincipal.GetPasswordSingleSignOnCredentials {
    ...
    public class GetPasswordSingleSignOnCredentialsRequestBuilder {
        ...
        public GetPasswordSingleSignOnCredentialsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/{directoryObject%2Did}/microsoft.graph.servicePrincipal/microsoft.graph.getPasswordSingleSignOnCredentials";
        ...
        /// </summary>
        public async Task<PasswordSingleSignOnCredentialSet> PostAsync(GetPasswordSingleSignOnCredentialsPostRequestBody body, Action<GetPasswordSingleSignOnCredentialsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
