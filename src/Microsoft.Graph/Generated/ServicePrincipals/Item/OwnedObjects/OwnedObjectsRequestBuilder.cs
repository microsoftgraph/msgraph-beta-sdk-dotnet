...
using MicrosoftGraphSdk.ServicePrincipals.Item.OwnedObjects.Count;
using MicrosoftGraphSdk.ServicePrincipals.Item.OwnedObjects.Item;
using System;
...
namespace MicrosoftGraphSdk.ServicePrincipals.Item.OwnedObjects {
    ...
    public class OwnedObjectsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.servicePrincipals.item.ownedObjects.item collection</summary>
