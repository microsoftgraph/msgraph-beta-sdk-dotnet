...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.OwnedObjects.MicrosoftGraphGroup.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/microsoft.graph.group/$count{?%24search,%24filter}";
