...
namespace MicrosoftGraphSdk.ServicePrincipals.Item.AddTokenSigningCertificate {
    ...
    public class AddTokenSigningCertificateRequestBuilder {
        ...
        public AddTokenSigningCertificateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal_id}/microsoft.graph.addTokenSigningCertificate";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SelfSignedCertificateRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// </summary>
        public async Task<SelfSignedCertificate> PostAsync(SelfSignedCertificateRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
