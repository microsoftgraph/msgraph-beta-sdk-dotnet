...
#nullable enable
        public async Task<SelfSignedCertificate?> PostAsync(AddTokenSigningCertificatePostRequestBody body, CancellationToken cancellationToken = default, Action<AddTokenSigningCertificateRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SelfSignedCertificate> PostAsync(AddTokenSigningCertificatePostRequestBody body, CancellationToken cancellationToken = default, Action<AddTokenSigningCertificateRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
