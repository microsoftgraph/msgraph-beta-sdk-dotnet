...
namespace MicrosoftGraph.ServicePrincipals.Item.AddTokenSigningCertificate {
    ...
    public class AddTokenSigningCertificateRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SelfSignedCertificateRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
