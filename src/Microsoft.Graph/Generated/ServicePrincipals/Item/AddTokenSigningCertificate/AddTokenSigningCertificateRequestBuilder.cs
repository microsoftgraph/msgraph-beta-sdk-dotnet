...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.AddTokenSigningCertificate {
    ...
    public class AddTokenSigningCertificateRequestBuilder {
        ...
        /// </summary>
        public async Task<SelfSignedCertificate> PostAsync(SelfSignedCertificatePostRequestBody body, CancellationToken cancellationToken = default, Action<AddTokenSigningCertificateRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
