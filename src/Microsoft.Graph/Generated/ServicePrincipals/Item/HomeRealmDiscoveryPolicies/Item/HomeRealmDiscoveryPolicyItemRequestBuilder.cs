...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.HomeRealmDiscoveryPolicies.Item {
    ...
    public class HomeRealmDiscoveryPolicyItemRequestBuilder {
        ...
        /// </summary>
        public async Task<HomeRealmDiscoveryPolicy> GetAsync(Action<HomeRealmDiscoveryPolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
