...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.ServicePrincipals.Item.CreatePasswordSingleSignOnCredentials {
    public class CreatePasswordSingleSignOnCredentialsRequestBody : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"credentials", (o,n) => { (o as CreatePasswordSingleSignOnCredentialsRequestBody).Credentials = n.GetCollectionOfObjectValues<Credential>().ToList(); } },
