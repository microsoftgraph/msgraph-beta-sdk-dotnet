...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item {
    ...
    public class ServicePrincipalItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        {
            get => new CreatePasswordSingleSignOnCredentialsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new UpdatePasswordSingleSignOnCredentialsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
