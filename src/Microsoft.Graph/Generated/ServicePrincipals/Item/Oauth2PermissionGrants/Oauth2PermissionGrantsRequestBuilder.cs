...
using MicrosoftGraphSdk.ServicePrincipals.Item.Oauth2PermissionGrants.Count;
using MicrosoftGraphSdk.ServicePrincipals.Item.Oauth2PermissionGrants.Item;
using System;
...
namespace MicrosoftGraphSdk.ServicePrincipals.Item.Oauth2PermissionGrants {
    ...
    public class Oauth2PermissionGrantsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.servicePrincipals.item.oauth2PermissionGrants.item collection</summary>
