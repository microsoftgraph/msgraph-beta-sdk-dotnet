...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.AppRoleAssignedTo {
    ...
    public class AppRoleAssignedToRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.servicePrincipals.item.appRoleAssignedTo.item collection</summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AppRoleAssignment> PostAsync(AppRoleAssignment body, CancellationToken cancellationToken = default, Action<AppRoleAssignedToRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
