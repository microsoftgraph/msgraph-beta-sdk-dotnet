...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.CreatedObjects.ServicePrincipal.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/createdObjects/microsoft.graph.servicePrincipal/$count";
