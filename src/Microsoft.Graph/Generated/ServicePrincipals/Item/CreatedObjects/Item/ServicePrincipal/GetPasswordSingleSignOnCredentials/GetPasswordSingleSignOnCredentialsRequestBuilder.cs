...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.CreatedObjects.Item.ServicePrincipal.GetPasswordSingleSignOnCredentials {
    ...
    public class GetPasswordSingleSignOnCredentialsRequestBuilder {
        ...
        public GetPasswordSingleSignOnCredentialsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/createdObjects/{directoryObject%2Did}/microsoft.graph.servicePrincipal/microsoft.graph.getPasswordSingleSignOnCredentials";
