...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.DelegatedPermissionClassifications.Item {
    ...
    public class DelegatedPermissionClassificationItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DelegatedPermissionClassification body, Action<DelegatedPermissionClassificationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
