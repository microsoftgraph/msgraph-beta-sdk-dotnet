...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.DelegatedPermissionClassifications.Item {
    ...
    public class DelegatedPermissionClassificationItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DelegatedPermissionClassificationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DelegatedPermissionClassification> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedPermissionClassificationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DelegatedPermissionClassification body, CancellationToken cancellationToken = default, Action<DelegatedPermissionClassificationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
