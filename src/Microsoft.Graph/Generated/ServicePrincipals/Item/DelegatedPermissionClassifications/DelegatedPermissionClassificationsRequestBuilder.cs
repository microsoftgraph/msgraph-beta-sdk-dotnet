...
using MicrosoftGraphSdk.ServicePrincipals.Item.DelegatedPermissionClassifications.Count;
...
namespace MicrosoftGraphSdk.ServicePrincipals.Item.DelegatedPermissionClassifications {
    ...
    public class DelegatedPermissionClassificationsRequestBuilder {
        ...
        /// </summary>
        public async Task<DelegatedPermissionClassificationCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
