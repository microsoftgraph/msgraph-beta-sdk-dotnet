...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.LicenseDetails {
    ...
    public class LicenseDetailsRequestBuilder : BaseRequestBuilder {
        ...
        public LicenseDetailsItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("licenseDetails%2Did", position);
        ...
        public LicenseDetailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/licenseDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LicenseDetailsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LicenseDetailsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/licenseDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<LicenseDetailsCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<LicenseDetailsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<LicenseDetailsCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<LicenseDetailsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<LicenseDetailsCollectionResponse>(requestInfo, LicenseDetailsCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.LicenseDetails?> PostAsync(Microsoft.Graph.Beta.Models.LicenseDetails body, CancellationToken cancellationToken = default, Action<LicenseDetailsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.LicenseDetails> PostAsync(Microsoft.Graph.Beta.Models.LicenseDetails body, CancellationToken cancellationToken = default, Action<LicenseDetailsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
