...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.TokenLifetimePolicies.Item {
    ...
    public class TokenLifetimePolicyItemRequestBuilder {
        ...
        /// </summary>
        public async Task<TokenLifetimePolicy> GetAsync(CancellationToken cancellationToken = default, Action<TokenLifetimePolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
