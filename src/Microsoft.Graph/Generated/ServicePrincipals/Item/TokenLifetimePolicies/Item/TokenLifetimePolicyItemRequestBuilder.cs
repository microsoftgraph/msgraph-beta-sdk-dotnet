...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.TokenLifetimePolicies.Item {
    ...
    public class TokenLifetimePolicyItemRequestBuilder {
        ...
        /// </summary>
        public async Task<TokenLifetimePolicy> GetAsync(Action<TokenLifetimePolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
