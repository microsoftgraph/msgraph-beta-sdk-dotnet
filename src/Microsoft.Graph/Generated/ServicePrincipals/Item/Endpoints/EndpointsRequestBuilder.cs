...
namespace MicrosoftGraph.ServicePrincipals.Item.Endpoints {
    /// <summary>Builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\endpoints</summary>
