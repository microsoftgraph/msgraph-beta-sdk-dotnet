...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.FederatedIdentityCredentials.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal_id}/federatedIdentityCredentials/$count";
