...
using Microsoft.Graph.Beta.ServicePrincipals.Item.TransitiveMemberOf.Application;
using Microsoft.Graph.Beta.ServicePrincipals.Item.TransitiveMemberOf.Count;
using Microsoft.Graph.Beta.ServicePrincipals.Item.TransitiveMemberOf.Device;
using Microsoft.Graph.Beta.ServicePrincipals.Item.TransitiveMemberOf.Group;
using Microsoft.Graph.Beta.ServicePrincipals.Item.TransitiveMemberOf.Item;
using Microsoft.Graph.Beta.ServicePrincipals.Item.TransitiveMemberOf.OrgContact;
using Microsoft.Graph.Beta.ServicePrincipals.Item.TransitiveMemberOf.ServicePrincipal;
using Microsoft.Graph.Beta.ServicePrincipals.Item.TransitiveMemberOf.User;
...
namespace Microsoft.Graph.Beta.ServicePrincipals.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.servicePrincipals.item.transitiveMemberOf.item collection</summary>
        ...
        public TransitiveMemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/transitiveMemberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TransitiveMemberOfRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <summary>Get transitiveMemberOf from servicePrincipals</summary>
