...
namespace MicrosoftGraph.PrivilegedRoleAssignmentRequests {
    ...
    public class PrivilegedRoleAssignmentRequestsRequestBuilder {
        ...
        public PrivilegedRoleAssignmentRequestsRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("privilegedRoleAssignmentRequest_id", position);
            return new PrivilegedRoleAssignmentRequestsRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(PrivilegedRoleAssignmentRequest body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        public async Task<PrivilegedRoleAssignmentRequestsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<PrivilegedRoleAssignmentRequestsResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
