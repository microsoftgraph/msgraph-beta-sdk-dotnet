...
namespace Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests {
    ...
    public class PrivilegedRoleAssignmentRequestsRequestBuilder {
        ...
        /// </summary>
        public async Task<PrivilegedRoleAssignmentRequestCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PrivilegedRoleAssignmentRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PrivilegedRoleAssignmentRequest> PostAsync(PrivilegedRoleAssignmentRequest body, CancellationToken cancellationToken = default, Action<PrivilegedRoleAssignmentRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
