...
namespace Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.MicrosoftGraphCancel {
    /// <summary>
    ...
    public class MicrosoftGraphCancelRequestBuilder {
        ...
        public MicrosoftGraphCancelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/microsoft.graph.cancel";
...
#nullable enable
        public async Task<PrivilegedRoleAssignmentRequest?> PostAsync(Action<MicrosoftGraphCancelRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<PrivilegedRoleAssignmentRequest> PostAsync(Action<MicrosoftGraphCancelRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
