...
namespace Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.Cancel {
    ...
    public class CancelRequestBuilder {
        ...
        /// </summary>
        public async Task<PrivilegedRoleAssignmentRequest> PostAsync(Action<CancelRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
