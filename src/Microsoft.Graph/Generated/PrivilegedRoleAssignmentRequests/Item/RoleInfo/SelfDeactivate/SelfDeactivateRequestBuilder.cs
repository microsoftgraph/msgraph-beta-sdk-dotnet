...
namespace Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.SelfDeactivate {
    /// <summary>
    ...
    public class SelfDeactivateRequestBuilder : BaseRequestBuilder {
        ...
        public SelfDeactivateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo/selfDeactivate", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SelfDeactivateRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SelfDeactivateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo/selfDeactivate", rawUrl) {
        }
        /// <summary>
