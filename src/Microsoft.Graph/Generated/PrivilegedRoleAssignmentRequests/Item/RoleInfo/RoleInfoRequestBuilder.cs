...
namespace Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo
{
    ...
    public class RoleInfoRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.Assignments.AssignmentsRequestBuilder Assignments
        {
            get => new Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.Assignments.AssignmentsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the selfActivate method.</summary>
        public Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.SelfActivate.SelfActivateRequestBuilder SelfActivate
        {
            get => new Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.SelfActivate.SelfActivateRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the selfDeactivate method.</summary>
        public Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.SelfDeactivate.SelfDeactivateRequestBuilder SelfDeactivate
        {
            get => new Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.SelfDeactivate.SelfDeactivateRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the settings property of the microsoft.graph.privilegedRole entity.</summary>
        public Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.Settings.SettingsRequestBuilder Settings
        {
            get => new Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.Settings.SettingsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the summary property of the microsoft.graph.privilegedRole entity.</summary>
        public Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.Summary.SummaryRequestBuilder Summary
        {
            get => new Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.Summary.SummaryRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.RoleInfoRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.PrivilegedRole?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.RoleInfoRequestBuilder.RoleInfoRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.PrivilegedRole> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.RoleInfoRequestBuilder.RoleInfoRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.RoleInfoRequestBuilder.RoleInfoRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.RoleInfoRequestBuilder.RoleInfoRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.RoleInfoRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.RoleInfoRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.RoleInfoRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class RoleInfoRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.RoleInfoRequestBuilder.RoleInfoRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
