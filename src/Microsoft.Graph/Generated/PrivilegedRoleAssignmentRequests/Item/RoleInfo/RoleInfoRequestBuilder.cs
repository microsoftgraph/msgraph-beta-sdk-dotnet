...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<RoleInfoRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<RoleInfoRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PrivilegedRole?> GetAsync(CancellationToken cancellationToken = default, Action<RoleInfoRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrivilegedRole> GetAsync(CancellationToken cancellationToken = default, Action<RoleInfoRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PrivilegedRole?> PatchAsync(PrivilegedRole body, CancellationToken cancellationToken = default, Action<RoleInfoRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrivilegedRole> PatchAsync(PrivilegedRole body, CancellationToken cancellationToken = default, Action<RoleInfoRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
