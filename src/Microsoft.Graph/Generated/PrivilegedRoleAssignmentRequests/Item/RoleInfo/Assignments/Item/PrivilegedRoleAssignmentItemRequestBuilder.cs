...
namespace Microsoft.Graph.Beta.PrivilegedRoleAssignmentRequests.Item.RoleInfo.Assignments.Item {
    ...
    public class PrivilegedRoleAssignmentItemRequestBuilder {
        ...
        public PrivilegedRoleAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo/assignments/{privilegedRoleAssignment%2Did}{?%24select,%24expand}";
