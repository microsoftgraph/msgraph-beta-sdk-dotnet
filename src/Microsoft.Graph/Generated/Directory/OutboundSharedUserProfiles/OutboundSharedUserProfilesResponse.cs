...
namespace MicrosoftGraphSdk.Directory.OutboundSharedUserProfiles {
    public class OutboundSharedUserProfilesResponse : IParsable {
        ...
        /// </summary>
        public static OutboundSharedUserProfilesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new OutboundSharedUserProfilesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as OutboundSharedUserProfilesResponse).Value = n.GetCollectionOfObjectValues<OutboundSharedUserProfile>(OutboundSharedUserProfile.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
