using Microsoft.Graph.Beta.Directory.FederationConfigurations.AvailableProviderTypes;
using Microsoft.Graph.Beta.Directory.FederationConfigurations.Count;
using Microsoft.Graph.Beta.Directory.FederationConfigurations.Item;
...
namespace Microsoft.Graph.Beta.Directory.FederationConfigurations {
    ...
    public class FederationConfigurationsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.directory.federationConfigurations.item collection</summary>
        ...
        /// </summary>
        public FederationConfigurationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/directory/federationConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public FederationConfigurationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<FederationConfigurationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<IdentityProviderBaseCollectionResponse> GetAsync(Action<FederationConfigurationsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<IdentityProviderBase> PostAsync(IdentityProviderBase body, Action<FederationConfigurationsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
