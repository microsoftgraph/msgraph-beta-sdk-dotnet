using Microsoft.Graph.Beta.Directory.AdministrativeUnits.Item.Members.Application;
using Microsoft.Graph.Beta.Directory.AdministrativeUnits.Item.Members.Count;
using Microsoft.Graph.Beta.Directory.AdministrativeUnits.Item.Members.Device;
using Microsoft.Graph.Beta.Directory.AdministrativeUnits.Item.Members.Group;
using Microsoft.Graph.Beta.Directory.AdministrativeUnits.Item.Members.Item;
using Microsoft.Graph.Beta.Directory.AdministrativeUnits.Item.Members.OrgContact;
using Microsoft.Graph.Beta.Directory.AdministrativeUnits.Item.Members.Ref;
using Microsoft.Graph.Beta.Directory.AdministrativeUnits.Item.Members.ServicePrincipal;
using Microsoft.Graph.Beta.Directory.AdministrativeUnits.Item.Members.User;
...
namespace Microsoft.Graph.Beta.Directory.AdministrativeUnits.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(Action<MembersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
