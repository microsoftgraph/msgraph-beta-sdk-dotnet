...
namespace Microsoft.Graph.Beta.Directory.FeatureRolloutPolicies.Item.AppliesTo.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/featureRolloutPolicies/{featureRolloutPolicy_id}/appliesTo/$count";
