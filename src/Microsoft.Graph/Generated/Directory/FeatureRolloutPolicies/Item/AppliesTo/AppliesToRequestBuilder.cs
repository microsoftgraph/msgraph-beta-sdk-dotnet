...
using MicrosoftGraphSdk.Directory.FeatureRolloutPolicies.Item.AppliesTo.Count;
using MicrosoftGraphSdk.Directory.FeatureRolloutPolicies.Item.AppliesTo.Item;
...
namespace MicrosoftGraphSdk.Directory.FeatureRolloutPolicies.Item.AppliesTo {
    ...
    public class AppliesToRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.directory.featureRolloutPolicies.item.appliesTo.item collection</summary>
        ...
        public AppliesToRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/featureRolloutPolicies/{featureRolloutPolicy_id}/appliesTo{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DirectoryObject body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DirectoryObject> PostAsync(DirectoryObject body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
