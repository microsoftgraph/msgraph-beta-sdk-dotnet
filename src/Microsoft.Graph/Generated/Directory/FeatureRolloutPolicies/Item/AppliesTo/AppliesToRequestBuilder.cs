using Microsoft.Graph.Beta.Directory.FeatureRolloutPolicies.Item.AppliesTo.Count;
using Microsoft.Graph.Beta.Directory.FeatureRolloutPolicies.Item.AppliesTo.GetByIds;
using Microsoft.Graph.Beta.Directory.FeatureRolloutPolicies.Item.AppliesTo.GetUserOwnedObjects;
using Microsoft.Graph.Beta.Directory.FeatureRolloutPolicies.Item.AppliesTo.Item;
using Microsoft.Graph.Beta.Directory.FeatureRolloutPolicies.Item.AppliesTo.Ref;
using Microsoft.Graph.Beta.Directory.FeatureRolloutPolicies.Item.AppliesTo.ValidateProperties;
...
namespace Microsoft.Graph.Beta.Directory.FeatureRolloutPolicies.Item.AppliesTo {
    ...
    public class AppliesToRequestBuilder {
        ...
        public AppliesToRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/featureRolloutPolicies/{featureRolloutPolicy%2Did}/appliesTo{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<AppliesToRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DirectoryObject body, Action<AppliesToRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(Action<AppliesToRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DirectoryObject> PostAsync(DirectoryObject body, Action<AppliesToRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
