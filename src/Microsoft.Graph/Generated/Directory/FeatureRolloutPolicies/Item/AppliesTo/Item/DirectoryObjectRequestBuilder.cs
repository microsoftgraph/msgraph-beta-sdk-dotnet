...
namespace MicrosoftGraph.Directory.FeatureRolloutPolicies.Item.AppliesTo.Item {
    ...
    public class DirectoryObjectRequestBuilder {
        ...
        public DirectoryObjectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/featureRolloutPolicies/{featureRolloutPolicy_id}/appliesTo/{directoryObject_id}{?select,expand}";
