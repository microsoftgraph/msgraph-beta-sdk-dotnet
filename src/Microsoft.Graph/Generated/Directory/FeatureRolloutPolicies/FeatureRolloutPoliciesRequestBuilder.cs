...
using MicrosoftGraphSdk.Directory.FeatureRolloutPolicies.Item;
...
namespace MicrosoftGraphSdk.Directory.FeatureRolloutPolicies {
    /// <summary>Builds and executes requests for operations under \directory\featureRolloutPolicies</summary>
    public class FeatureRolloutPoliciesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.directory.featureRolloutPolicies.item collection</summary>
        ...
        public FeatureRolloutPoliciesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/featureRolloutPolicies{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
