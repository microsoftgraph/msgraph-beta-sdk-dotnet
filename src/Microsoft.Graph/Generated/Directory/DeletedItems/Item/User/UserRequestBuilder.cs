...
namespace Microsoft.Graph.Beta.Directory.DeletedItems.Item.User {
    ...
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/deletedItems/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}";
