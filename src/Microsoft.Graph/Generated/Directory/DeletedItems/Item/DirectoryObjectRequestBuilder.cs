...
namespace MicrosoftGraph.Directory.DeletedItems.Item {
    /// <summary>Builds and executes requests for operations under \directory\deletedItems\{directoryObject-id}</summary>
    public class DirectoryObjectRequestBuilder {
        ...
        public DirectoryObjectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/deletedItems/{directoryObject_id}{?select,expand}";
