...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Directory.Recommendations.Item.ImpactedResources.Item.Dismiss {
    ...
    public class DismissPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public string DismissReason {
            get { return BackingStore?.Get<string>(nameof(DismissReason)); }
            set { BackingStore?.Set(nameof(DismissReason), value); }
        }
        /// <summary>
