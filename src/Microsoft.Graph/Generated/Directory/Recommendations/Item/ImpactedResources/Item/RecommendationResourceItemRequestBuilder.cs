...
namespace MicrosoftGraphSdk.Directory.Recommendations.Item.ImpactedResources.Item {
    /// <summary>Builds and executes requests for operations under \directory\recommendations\{recommendation-id}\impactedResources\{recommendationResource-id}</summary>
    public class RecommendationResourceItemRequestBuilder {
        ...
        public RecommendationResourceItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/recommendations/{recommendation_id}/impactedResources/{recommendationResource_id}{?select,expand}";
