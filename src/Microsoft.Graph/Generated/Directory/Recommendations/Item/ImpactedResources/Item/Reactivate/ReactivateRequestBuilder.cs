...
namespace MicrosoftGraphSdk.Directory.Recommendations.Item.ImpactedResources.Item.Reactivate {
    ...
    public class ReactivateRequestBuilder {
        ...
        public ReactivateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/recommendations/{recommendation_id}/impactedResources/{recommendationResource_id}/microsoft.graph.reactivate";
        ...
        public class ReactivateResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"recommendationResource", (o,n) => { (o as ReactivateResponse).RecommendationResource = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.RecommendationResource>(MicrosoftGraphSdk.Models.Microsoft.Graph.RecommendationResource.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
