...
namespace Microsoft.Graph.Beta.Directory.Recommendations.Item.ImpactedResources.Item.Reactivate {
    ...
    public class ReactivateRequestBuilder {
        ...
        /// </summary>
        public async Task<RecommendationResource> PostAsync(Action<ReactivateRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
