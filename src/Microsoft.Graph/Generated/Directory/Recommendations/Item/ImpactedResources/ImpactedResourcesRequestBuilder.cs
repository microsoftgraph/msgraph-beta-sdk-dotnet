...
namespace MicrosoftGraphSdk.Directory.Recommendations.Item.ImpactedResources {
    ...
    public class ImpactedResourcesRequestBuilder {
        ...
        /// </summary>
        public async Task<RecommendationResourceCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
