...
using MicrosoftGraph.Directory.Recommendations.Item.ImpactedResources.Item;
...
namespace MicrosoftGraph.Directory.Recommendations.Item.ImpactedResources {
    /// <summary>Builds and executes requests for operations under \directory\recommendations\{recommendation-id}\impactedResources</summary>
    public class ImpactedResourcesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.directory.recommendations.item.impactedResources.item collection</summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(RecommendationResource body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
