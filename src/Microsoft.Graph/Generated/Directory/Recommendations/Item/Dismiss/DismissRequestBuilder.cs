        ...
        public class DismissResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"recommendation", (o,n) => { (o as DismissResponse).Recommendation = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Recommendation>(MicrosoftGraphSdk.Models.Microsoft.Graph.Recommendation.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
