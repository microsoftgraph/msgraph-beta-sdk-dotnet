...
using MicrosoftGraph.Directory.ImpactedResources.Item.Complete;
using MicrosoftGraph.Directory.ImpactedResources.Item.Dismiss;
using MicrosoftGraph.Directory.ImpactedResources.Item.Postpone;
using MicrosoftGraph.Directory.ImpactedResources.Item.Reactivate;
...
namespace MicrosoftGraph.Directory.ImpactedResources.Item {
    ...
    public class RecommendationResourceRequestBuilder {
        ...
        /// <summary>
        /// Instantiates a new RecommendationResourceRequestBuilder and sets the default values.
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public RecommendationResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/directory/impactedResources/{recommendationResource_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public RecommendationResourceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(RecommendationResource body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
