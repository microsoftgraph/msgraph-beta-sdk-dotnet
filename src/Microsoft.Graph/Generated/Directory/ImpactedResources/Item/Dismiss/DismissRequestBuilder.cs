...
namespace MicrosoftGraphSdk.Directory.ImpactedResources.Item.Dismiss {
    ...
    public class DismissRequestBuilder {
        ...
        public DismissRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/impactedResources/{recommendationResource_id}/microsoft.graph.dismiss";
        ...
        /// </summary>
        public async Task<RecommendationResource> PostAsync(DismissRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
