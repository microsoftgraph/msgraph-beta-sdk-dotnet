using Microsoft.Graph.Beta.Directory.AdministrativeUnits;
using Microsoft.Graph.Beta.Directory.AttributeSets;
using Microsoft.Graph.Beta.Directory.CustomSecurityAttributeDefinitions;
using Microsoft.Graph.Beta.Directory.DeletedItems;
using Microsoft.Graph.Beta.Directory.FeatureRolloutPolicies;
using Microsoft.Graph.Beta.Directory.FederationConfigurations;
using Microsoft.Graph.Beta.Directory.ImpactedResources;
using Microsoft.Graph.Beta.Directory.InboundSharedUserProfiles;
using Microsoft.Graph.Beta.Directory.OutboundSharedUserProfiles;
using Microsoft.Graph.Beta.Directory.Recommendations;
using Microsoft.Graph.Beta.Directory.SharedEmailDomains;
...
namespace Microsoft.Graph.Beta.Directory {
    ...
    public class DirectoryRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(Microsoft.Graph.Beta.Models.Directory body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Directory> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(queryParameters, headers, options);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<Microsoft.Graph.Beta.Models.Directory>(requestInfo, Microsoft.Graph.Beta.Models.Directory.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Update directory
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.Directory body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
