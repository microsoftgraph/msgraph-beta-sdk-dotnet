...
using MicrosoftGraph.Directory.AttributeSets;
using MicrosoftGraph.Directory.CustomSecurityAttributeDefinitions;
using MicrosoftGraph.Directory.DeletedItems;
using MicrosoftGraph.Directory.FeatureRolloutPolicies;
using MicrosoftGraph.Directory.FederationConfigurations;
using MicrosoftGraph.Directory.ImpactedResources;
using MicrosoftGraph.Directory.InboundSharedUserProfiles;
using MicrosoftGraph.Directory.OutboundSharedUserProfiles;
using MicrosoftGraph.Directory.Recommendations;
using MicrosoftGraph.Directory.SharedEmailDomains;
