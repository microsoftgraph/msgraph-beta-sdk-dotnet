...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Drive?> PostAsync(Microsoft.Graph.Beta.Models.Drive body, CancellationToken cancellationToken = default, Action<DrivesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Drive> PostAsync(Microsoft.Graph.Beta.Models.Drive body, CancellationToken cancellationToken = default, Action<DrivesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
