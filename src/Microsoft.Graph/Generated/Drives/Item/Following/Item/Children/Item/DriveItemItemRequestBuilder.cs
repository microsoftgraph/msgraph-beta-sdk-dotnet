...
using MicrosoftGraphSdk.Drives.Item.Following.Item.Children.Item.Content;
...
namespace MicrosoftGraphSdk.Drives.Item.Following.Item.Children.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/following/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
