...
using MicrosoftGraphSdk.Drives.Item.Following.Item.Versions.Item.Content;
using MicrosoftGraphSdk.Drives.Item.Following.Item.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Drives.Item.Following.Item.Versions.Item {
    ...
    public class DriveItemVersionItemRequestBuilder {
        ...
        public DriveItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/following/{driveItem_id}/versions/{driveItemVersion_id}{?select,expand}";
