...
using MicrosoftGraphSdk.Drives.Item.Following.Item.ListItem.Versions.Item.Fields;
using MicrosoftGraphSdk.Drives.Item.Following.Item.ListItem.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Drives.Item.Following.Item.ListItem.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/following/{driveItem_id}/listItem/versions/{listItemVersion_id}{?select,expand}";
