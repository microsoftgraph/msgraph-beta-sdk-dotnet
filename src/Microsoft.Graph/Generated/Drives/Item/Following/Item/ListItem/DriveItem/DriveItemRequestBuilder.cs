...
using MicrosoftGraphSdk.Drives.Item.Following.Item.ListItem.DriveItem.Content;
...
namespace MicrosoftGraphSdk.Drives.Item.Following.Item.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/following/{driveItem_id}/listItem/driveItem{?select,expand}";
