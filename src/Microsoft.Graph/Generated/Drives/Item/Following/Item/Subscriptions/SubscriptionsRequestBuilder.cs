...
using MicrosoftGraphSdk.Drives.Item.Following.Item.Subscriptions.Count;
using MicrosoftGraphSdk.Drives.Item.Following.Item.Subscriptions.Item;
...
namespace MicrosoftGraphSdk.Drives.Item.Following.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.drives.item.following.item.subscriptions.item collection</summary>
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/following/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
