...
using MicrosoftGraphSdk.Drives.Item.Special.Item.ListItem.DriveItem.Content;
...
namespace MicrosoftGraphSdk.Drives.Item.Special.Item.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/special/{driveItem_id}/listItem/driveItem{?select,expand}";
