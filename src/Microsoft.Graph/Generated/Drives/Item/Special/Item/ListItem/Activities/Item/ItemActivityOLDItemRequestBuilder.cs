...
using MicrosoftGraphSdk.Drives.Item.Special.Item.ListItem.Activities.Item.DriveItem;
using MicrosoftGraphSdk.Drives.Item.Special.Item.ListItem.Activities.Item.ListItem;
...
namespace MicrosoftGraphSdk.Drives.Item.Special.Item.ListItem.Activities.Item {
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/special/{driveItem_id}/listItem/activities/{itemActivityOLD_id}{?select,expand}";
