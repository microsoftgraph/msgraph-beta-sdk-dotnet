...
using MicrosoftGraphSdk.Drives.Item.Special.Item.Versions.Item.Content;
using MicrosoftGraphSdk.Drives.Item.Special.Item.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Drives.Item.Special.Item.Versions.Item {
    ...
    public class DriveItemVersionItemRequestBuilder {
        ...
        public DriveItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/special/{driveItem_id}/versions/{driveItemVersion_id}{?select,expand}";
