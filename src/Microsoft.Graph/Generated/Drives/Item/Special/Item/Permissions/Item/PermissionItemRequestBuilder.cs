...
using MicrosoftGraphSdk.Drives.Item.Special.Item.Permissions.Item.Grant;
using MicrosoftGraphSdk.Drives.Item.Special.Item.Permissions.Item.RevokeGrants;
...
namespace MicrosoftGraphSdk.Drives.Item.Special.Item.Permissions.Item {
    ...
    public class PermissionItemRequestBuilder {
        ...
        public PermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/special/{driveItem_id}/permissions/{permission_id}{?select,expand}";
