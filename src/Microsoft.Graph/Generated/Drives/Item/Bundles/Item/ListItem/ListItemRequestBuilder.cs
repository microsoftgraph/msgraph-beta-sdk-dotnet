...
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.ListItem.Activities;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.ListItem.Analytics;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.ListItem.CreateLink;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.ListItem.DriveItem;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.ListItem.Fields;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Drives.Item.Bundles.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}/listItem{?select,expand}";
