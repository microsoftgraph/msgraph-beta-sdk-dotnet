...
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.ListItem.Versions.Item.Fields;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.ListItem.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Drives.Item.Bundles.Item.ListItem.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}/listItem/versions/{listItemVersion_id}{?select,expand}";
