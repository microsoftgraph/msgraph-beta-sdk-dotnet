...
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.Versions.Item.Content;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraphSdk.Drives.Item.Bundles.Item.Versions.Item {
    ...
    public class DriveItemVersionItemRequestBuilder {
        ...
        public DriveItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}/versions/{driveItemVersion_id}{?select,expand}";
