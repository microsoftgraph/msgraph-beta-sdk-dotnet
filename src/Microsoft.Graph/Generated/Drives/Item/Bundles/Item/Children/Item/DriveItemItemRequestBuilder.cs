...
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.Children.Item.Content;
...
namespace MicrosoftGraphSdk.Drives.Item.Bundles.Item.Children.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
