using Microsoft.Graph.Beta.Drives.Item.Bundles.Count;
using Microsoft.Graph.Beta.Drives.Item.Bundles.Item;
...
namespace Microsoft.Graph.Beta.Drives.Item.Bundles {
    /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.DriveItem?> PostAsync(Microsoft.Graph.Beta.Models.DriveItem body, Action<BundlesRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.DriveItem> PostAsync(Microsoft.Graph.Beta.Models.DriveItem body, Action<BundlesRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Models.DriveItem body, Action<BundlesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Models.DriveItem body, Action<BundlesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
