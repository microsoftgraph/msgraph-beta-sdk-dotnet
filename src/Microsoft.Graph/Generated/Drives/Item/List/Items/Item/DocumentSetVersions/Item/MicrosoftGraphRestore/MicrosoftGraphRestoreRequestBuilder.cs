...
namespace Microsoft.Graph.Beta.Drives.Item.List.Items.Item.DocumentSetVersions.Item.MicrosoftGraphRestore {
    /// <summary>
...
#nullable enable
        public async Task PostAsync(Action<MicrosoftGraphRestoreRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(Action<MicrosoftGraphRestoreRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
