...
using MicrosoftGraphSdk.Drives.Item.List.Items.Item.Activities.Item;
...
namespace MicrosoftGraphSdk.Drives.Item.List.Items.Item.Activities {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\list\items\{listItem-id}\activities</summary>
    public class ActivitiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.drives.item.list.items.item.activities.item collection</summary>
