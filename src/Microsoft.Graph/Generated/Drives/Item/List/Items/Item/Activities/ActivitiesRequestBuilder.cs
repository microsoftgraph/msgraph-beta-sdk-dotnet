...
using MicrosoftGraph.Drives.Item.List.Items.Item.Activities.Item;
...
namespace MicrosoftGraph.Drives.Item.List.Items.Item.Activities {
    ...
    public class ActivitiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.drives.item.list.items.item.activities.item collection</summary>
