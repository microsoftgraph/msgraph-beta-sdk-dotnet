using Microsoft.Graph.Beta.Drives.Item.List.Items.Item.Activities.Item.DriveItem;
using Microsoft.Graph.Beta.Drives.Item.List.Items.Item.Activities.Item.ListItem;
...
using System;
namespace Microsoft.Graph.Beta.Drives.Item.List.Items.Item.Activities.Item {
    /// <summary>
    ...
    public class ItemActivityOLDItemRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Drives.Item.List.Items.Item.Activities.Item.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new Microsoft.Graph.Beta.Drives.Item.List.Items.Item.Activities.Item.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ItemActivityOLDItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ItemActivityOLDItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ItemActivityOLDItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ItemActivityOLDItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ItemActivityOLD?> GetAsync(CancellationToken cancellationToken = default, Action<ItemActivityOLDItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ItemActivityOLD> GetAsync(CancellationToken cancellationToken = default, Action<ItemActivityOLDItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ItemActivityOLD?> PatchAsync(ItemActivityOLD body, CancellationToken cancellationToken = default, Action<ItemActivityOLDItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ItemActivityOLD> PatchAsync(ItemActivityOLD body, CancellationToken cancellationToken = default, Action<ItemActivityOLDItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
