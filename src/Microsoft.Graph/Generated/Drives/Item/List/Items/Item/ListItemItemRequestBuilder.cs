...
using MicrosoftGraphSdk.Drives.Item.List.Items.Item.Activities;
using MicrosoftGraphSdk.Drives.Item.List.Items.Item.Analytics;
using MicrosoftGraphSdk.Drives.Item.List.Items.Item.CreateLink;
using MicrosoftGraphSdk.Drives.Item.List.Items.Item.DriveItem;
using MicrosoftGraphSdk.Drives.Item.List.Items.Item.Fields;
using MicrosoftGraphSdk.Drives.Item.List.Items.Item.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Drives.Item.List.Items.Item.Versions;
...
namespace MicrosoftGraphSdk.Drives.Item.List.Items.Item {
    ...
    public class ListItemItemRequestBuilder {
        ...
        public MicrosoftGraphSdk.Drives.Item.List.Items.Item.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new MicrosoftGraphSdk.Drives.Item.List.Items.Item.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
