...
using MicrosoftGraph.Drives.Item.List.Items.Item.Versions.Item.Fields;
using MicrosoftGraph.Drives.Item.List.Items.Item.Versions.Item.RestoreVersion;
...
namespace MicrosoftGraph.Drives.Item.List.Items.Item.Versions.Item {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\list\items\{listItem-id}\versions\{listItemVersion-id}</summary>
    public class ListItemVersionRequestBuilder {
        ...
        public ListItemVersionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/list/items/{listItem_id}/versions/{listItemVersion_id}{?select,expand}";
