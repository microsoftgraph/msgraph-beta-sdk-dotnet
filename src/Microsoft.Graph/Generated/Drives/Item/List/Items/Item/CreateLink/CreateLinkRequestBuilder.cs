...
namespace MicrosoftGraph.Drives.Item.List.Items.Item.CreateLink {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\list\items\{listItem-id}\microsoft.graph.createLink</summary>
    public class CreateLinkRequestBuilder {
        ...
        public CreateLinkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/list/items/{listItem_id}/microsoft.graph.createLink";
