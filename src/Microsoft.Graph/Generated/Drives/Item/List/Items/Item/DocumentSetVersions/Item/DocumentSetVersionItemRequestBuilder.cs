using Microsoft.Graph.Beta.Drives.Item.List.Items.Item.DocumentSetVersions.Item.Fields;
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DocumentSetVersionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DocumentSetVersionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DocumentSetVersion?> GetAsync(CancellationToken cancellationToken = default, Action<DocumentSetVersionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DocumentSetVersion> GetAsync(CancellationToken cancellationToken = default, Action<DocumentSetVersionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DocumentSetVersion?> PatchAsync(DocumentSetVersion body, CancellationToken cancellationToken = default, Action<DocumentSetVersionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DocumentSetVersion> PatchAsync(DocumentSetVersion body, CancellationToken cancellationToken = default, Action<DocumentSetVersionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
