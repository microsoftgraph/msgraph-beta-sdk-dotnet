...
using MicrosoftGraphSdk.Drives.Item.List.Items.Delta;
using MicrosoftGraphSdk.Drives.Item.List.Items.DeltaWithToken;
...
namespace MicrosoftGraphSdk.Drives.Item.List.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <summary>
        /// Builds and executes requests for operations under \drives\{drive-id}\list\items\microsoft.graph.delta()
        /// </summary>
        public DeltaRequestBuilder Delta() {
            return new DeltaRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Builds and executes requests for operations under \drives\{drive-id}\list\items\microsoft.graph.delta(token='{token}')
