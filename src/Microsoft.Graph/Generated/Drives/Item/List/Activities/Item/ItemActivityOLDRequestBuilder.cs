...
using MicrosoftGraph.Drives.Item.List.Activities.Item.DriveItem;
using MicrosoftGraph.Drives.Item.List.Activities.Item.ListItem;
...
namespace MicrosoftGraph.Drives.Item.List.Activities.Item {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\list\activities\{itemActivityOLD-id}</summary>
    public class ItemActivityOLDRequestBuilder {
        ...
        public ItemActivityOLDRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/list/activities/{itemActivityOLD_id}{?select,expand}";
