...
using MicrosoftGraphSdk.Drives.Item.List.Activities.Item.ListItem.CreateLink;
using MicrosoftGraphSdk.Drives.Item.List.Activities.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Drives.Item.List.Activities.Item.ListItem.Ref;
...
namespace MicrosoftGraphSdk.Drives.Item.List.Activities.Item.ListItem {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\list\activities\{itemActivityOLD-id}\listItem</summary>
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/list/activities/{itemActivityOLD_id}/listItem{?select,expand}";
