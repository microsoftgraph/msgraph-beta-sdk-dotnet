...
namespace MicrosoftGraphSdk.Drives.Item.List.Activities.Item.DriveItem.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/list/activities/{itemActivityOLD_id}/driveItem/content";
