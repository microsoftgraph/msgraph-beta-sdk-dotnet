...
namespace MicrosoftGraphSdk.Drives.Item.List.Activities.Item.ListItem.CreateLink {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\list\activities\{itemActivityOLD-id}\listItem\microsoft.graph.createLink</summary>
    public class CreateLinkRequestBuilder {
        ...
        public CreateLinkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/list/activities/{itemActivityOLD_id}/listItem/microsoft.graph.createLink";
