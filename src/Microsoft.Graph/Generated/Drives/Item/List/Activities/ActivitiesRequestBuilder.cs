...
using MicrosoftGraphSdk.Drives.Item.List.Activities.Item;
...
namespace MicrosoftGraphSdk.Drives.Item.List.Activities {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\list\activities</summary>
    public class ActivitiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.drives.item.list.activities.item collection</summary>
        ...
        public ActivitiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/list/activities{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
