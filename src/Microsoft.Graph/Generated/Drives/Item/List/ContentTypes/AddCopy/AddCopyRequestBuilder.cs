...
namespace Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.AddCopy {
    ...
    public class AddCopyRequestBuilder {
        ...
        /// </summary>
        public async Task<ContentType> PostAsync(AddCopyPostRequestBody body, CancellationToken cancellationToken = default, Action<AddCopyRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
