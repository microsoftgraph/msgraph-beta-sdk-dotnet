...
namespace Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.AddCopy {
    ...
    public class AddCopyRequestBuilder : BaseRequestBuilder {
        ...
        public AddCopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/contentTypes/addCopy", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AddCopyRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddCopyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/contentTypes/addCopy", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ContentType?> PostAsync(AddCopyPostRequestBody body, CancellationToken cancellationToken = default, Action<AddCopyRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ContentType> PostAsync(AddCopyPostRequestBody body, CancellationToken cancellationToken = default, Action<AddCopyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
