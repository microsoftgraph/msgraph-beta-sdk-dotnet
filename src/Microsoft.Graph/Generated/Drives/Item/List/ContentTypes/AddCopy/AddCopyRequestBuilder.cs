...
namespace Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.AddCopy {
    ...
    public class AddCopyRequestBuilder {
        ...
        /// </summary>
        public async Task<ContentType> PostAsync(AddCopyRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
