...
namespace Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.AddCopy {
    ...
    public class AddCopyRequestBuilder {
        ...
        public AddCopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/list/contentTypes/microsoft.graph.addCopy";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AddCopyPostRequestBody body, Action<AddCopyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<ContentType> PostAsync(AddCopyPostRequestBody body, Action<AddCopyRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
