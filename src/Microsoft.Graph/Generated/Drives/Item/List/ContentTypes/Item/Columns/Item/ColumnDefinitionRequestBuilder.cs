...
using MicrosoftGraph.Drives.Item.List.ContentTypes.Item.Columns.Item.SourceColumn;
...
namespace MicrosoftGraph.Drives.Item.List.ContentTypes.Item.Columns.Item {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\list\contentTypes\{contentType-id}\columns\{columnDefinition-id}</summary>
    public class ColumnDefinitionRequestBuilder {
        ...
        public ColumnDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/list/contentTypes/{contentType_id}/columns/{columnDefinition_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ColumnDefinitionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
