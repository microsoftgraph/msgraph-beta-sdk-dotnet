...
using MicrosoftGraphSdk.Drives.Item.List.ContentTypes.Item.AssociateWithHubSites;
using MicrosoftGraphSdk.Drives.Item.List.ContentTypes.Item.Base;
using MicrosoftGraphSdk.Drives.Item.List.ContentTypes.Item.BaseTypes;
using MicrosoftGraphSdk.Drives.Item.List.ContentTypes.Item.ColumnLinks;
using MicrosoftGraphSdk.Drives.Item.List.ContentTypes.Item.ColumnPositions;
using MicrosoftGraphSdk.Drives.Item.List.ContentTypes.Item.Columns;
using MicrosoftGraphSdk.Drives.Item.List.ContentTypes.Item.CopyToDefaultContentLocation;
using MicrosoftGraphSdk.Drives.Item.List.ContentTypes.Item.IsPublished;
using MicrosoftGraphSdk.Drives.Item.List.ContentTypes.Item.Publish;
using MicrosoftGraphSdk.Drives.Item.List.ContentTypes.Item.Unpublish;
...
namespace MicrosoftGraphSdk.Drives.Item.List.ContentTypes.Item {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\list\contentTypes\{contentType-id}</summary>
