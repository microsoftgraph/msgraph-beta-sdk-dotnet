using Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.Item.AssociateWithHubSites;
using Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.Item.Base;
using Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.Item.BaseTypes;
using Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.Item.ColumnLinks;
using Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.Item.ColumnPositions;
using Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.Item.Columns;
using Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.Item.CopyToDefaultContentLocation;
using Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.Item.IsPublished;
using Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.Item.Publish;
using Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.Item.Unpublish;
...
using System;
namespace Microsoft.Graph.Beta.Drives.Item.List.ContentTypes.Item {
    /// <summary>
    ...
    public class ContentTypeItemRequestBuilder : BaseRequestBuilder {
        ...
        public ContentTypeItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ContentTypeItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContentTypeItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ContentTypeItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ContentTypeItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ContentType?> GetAsync(CancellationToken cancellationToken = default, Action<ContentTypeItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ContentType> GetAsync(CancellationToken cancellationToken = default, Action<ContentTypeItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ContentType?> PatchAsync(ContentType body, CancellationToken cancellationToken = default, Action<ContentTypeItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ContentType> PatchAsync(ContentType body, CancellationToken cancellationToken = default, Action<ContentTypeItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
