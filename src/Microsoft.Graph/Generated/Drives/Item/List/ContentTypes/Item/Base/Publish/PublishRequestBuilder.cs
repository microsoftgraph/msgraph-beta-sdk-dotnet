...
namespace MicrosoftGraphSdk.Drives.Item.List.ContentTypes.Item.Base.Publish {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\list\contentTypes\{contentType-id}\base\microsoft.graph.publish</summary>
    public class PublishRequestBuilder {
        ...
        public PublishRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/list/contentTypes/{contentType_id}/base/microsoft.graph.publish";
