...
using MicrosoftGraph.Drives.Item.List.ContentTypes.Item.AssociateWithHubSites;
using MicrosoftGraph.Drives.Item.List.ContentTypes.Item.Base;
using MicrosoftGraph.Drives.Item.List.ContentTypes.Item.BaseTypes;
using MicrosoftGraph.Drives.Item.List.ContentTypes.Item.ColumnLinks;
using MicrosoftGraph.Drives.Item.List.ContentTypes.Item.ColumnPositions;
using MicrosoftGraph.Drives.Item.List.ContentTypes.Item.Columns;
using MicrosoftGraph.Drives.Item.List.ContentTypes.Item.CopyToDefaultContentLocation;
using MicrosoftGraph.Drives.Item.List.ContentTypes.Item.IsPublished;
using MicrosoftGraph.Drives.Item.List.ContentTypes.Item.Publish;
using MicrosoftGraph.Drives.Item.List.ContentTypes.Item.Unpublish;
...
namespace MicrosoftGraph.Drives.Item.List.ContentTypes.Item {
