...
namespace Microsoft.Graph.Beta.Drives.Item.List.Subscriptions.Item.Reauthorize {
    /// <summary>
    ...
    public class ReauthorizeRequestBuilder {
        ...
        public ReauthorizeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/list/subscriptions/{subscription%2Did}/reauthorize";
