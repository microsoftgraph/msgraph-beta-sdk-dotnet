...
using MicrosoftGraphSdk.Drives.Item.Activities.Item.DriveItem.Ref;
...
namespace MicrosoftGraphSdk.Drives.Item.Activities.Item.DriveItem {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\activities\{itemActivityOLD-id}\driveItem</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
