...
using MicrosoftGraph.Drives.Item.Activities.Item.DriveItem;
using MicrosoftGraph.Drives.Item.Activities.Item.ListItem;
...
namespace MicrosoftGraph.Drives.Item.Activities.Item {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\activities\{itemActivityOLD-id}</summary>
    public class ItemActivityOLDRequestBuilder {
        ...
        public ItemActivityOLDRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/activities/{itemActivityOLD_id}{?select,expand}";
