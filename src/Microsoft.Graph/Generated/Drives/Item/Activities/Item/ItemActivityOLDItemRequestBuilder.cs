...
using MicrosoftGraphSdk.Drives.Item.Activities.Item.DriveItem;
using MicrosoftGraphSdk.Drives.Item.Activities.Item.ListItem;
...
namespace MicrosoftGraphSdk.Drives.Item.Activities.Item {
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public MicrosoftGraphSdk.Drives.Item.Activities.Item.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new MicrosoftGraphSdk.Drives.Item.Activities.Item.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
