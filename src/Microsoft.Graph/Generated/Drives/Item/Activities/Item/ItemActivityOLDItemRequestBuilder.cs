using Microsoft.Graph.Beta.Drives.Item.Activities.Item.DriveItem;
using Microsoft.Graph.Beta.Drives.Item.Activities.Item.ListItem;
...
namespace Microsoft.Graph.Beta.Drives.Item.Activities.Item {
    /// <summary>
    ...
    public class ItemActivityOLDItemRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Drives.Item.Activities.Item.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new Microsoft.Graph.Beta.Drives.Item.Activities.Item.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ItemActivityOLDItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ItemActivityOLDItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
