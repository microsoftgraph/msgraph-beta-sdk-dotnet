...
namespace Microsoft.Graph.Beta.Drives.Item.Activities.Item.ListItem {
    ...
    public class ListItemRequestBuilder : BaseRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}/listItem{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ListItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ListItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}/listItem{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
