...
using MicrosoftGraphSdk.Drives.Item.Root.ListItem.Activities;
using MicrosoftGraphSdk.Drives.Item.Root.ListItem.Analytics;
using MicrosoftGraphSdk.Drives.Item.Root.ListItem.CreateLink;
using MicrosoftGraphSdk.Drives.Item.Root.ListItem.DriveItem;
using MicrosoftGraphSdk.Drives.Item.Root.ListItem.Fields;
using MicrosoftGraphSdk.Drives.Item.Root.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Drives.Item.Root.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Drives.Item.Root.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public MicrosoftGraphSdk.Drives.Item.Root.ListItem.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new MicrosoftGraphSdk.Drives.Item.Root.ListItem.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
