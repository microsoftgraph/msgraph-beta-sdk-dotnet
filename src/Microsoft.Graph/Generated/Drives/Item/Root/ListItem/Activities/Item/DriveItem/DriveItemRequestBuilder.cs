using Microsoft.Graph.Beta.Drives.Item.Root.ListItem.Activities.Item.DriveItem.Content;
...
namespace Microsoft.Graph.Beta.Drives.Item.Root.ListItem.Activities.Item.DriveItem {
    /// <summary>
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/root/listItem/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}";
