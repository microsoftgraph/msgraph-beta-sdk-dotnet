...
using MicrosoftGraphSdk.Drives.Item.Root.Subscriptions.Count;
using MicrosoftGraphSdk.Drives.Item.Root.Subscriptions.Item;
...
namespace MicrosoftGraphSdk.Drives.Item.Root.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.drives.item.root.subscriptions.item collection</summary>
