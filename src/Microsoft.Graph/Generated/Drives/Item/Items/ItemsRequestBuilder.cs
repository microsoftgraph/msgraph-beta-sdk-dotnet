using Microsoft.Graph.Beta.Drives.Item.Items.Count;
using Microsoft.Graph.Beta.Drives.Item.Items.Item;
...
using System;
namespace Microsoft.Graph.Beta.Drives.Item.Items {
    /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.DriveItem?> PostAsync(Microsoft.Graph.Beta.Models.DriveItem body, CancellationToken cancellationToken = default, Action<ItemsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.DriveItem> PostAsync(Microsoft.Graph.Beta.Models.DriveItem body, CancellationToken cancellationToken = default, Action<ItemsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
