...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.DriveItem?> PostAsync(CopyPostRequestBody body, Action<MicrosoftGraphCopyRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.DriveItem> PostAsync(CopyPostRequestBody body, Action<MicrosoftGraphCopyRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
