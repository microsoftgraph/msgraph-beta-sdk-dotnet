...
using Microsoft.Graph.Beta.Drives.Item.Items.Item.Versions.Item.MicrosoftGraphRestoreVersion;
...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Versions.Item {
    ...
    public class DriveItemVersionItemRequestBuilder {
        ...
        public DriveItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/versions/{driveItemVersion%2Did}{?%24select,%24expand}";
