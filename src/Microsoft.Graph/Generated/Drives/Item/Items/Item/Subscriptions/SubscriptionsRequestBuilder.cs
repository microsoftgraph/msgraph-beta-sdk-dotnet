...
using MicrosoftGraphSdk.Drives.Item.Items.Item.Subscriptions.Count;
using MicrosoftGraphSdk.Drives.Item.Items.Item.Subscriptions.Item;
...
namespace MicrosoftGraphSdk.Drives.Item.Items.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.drives.item.items.item.subscriptions.item collection</summary>
