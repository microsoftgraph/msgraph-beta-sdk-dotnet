...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Analytics.AllTime {
    /// <summary>
    ...
    public class AllTimeRequestBuilder {
        ...
        public AllTimeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AllTimeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
