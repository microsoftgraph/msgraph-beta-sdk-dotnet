...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Permissions.Item.RevokeGrants {
    ...
    public class RevokeGrantsRequestBuilder : BaseRequestBuilder {
        ...
        public RevokeGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/permissions/{permission%2Did}/revokeGrants", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RevokeGrantsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RevokeGrantsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/permissions/{permission%2Did}/revokeGrants", rawUrl) {
        }
        /// <summary>
