...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.DriveItem?> PostAsync(CopyPostRequestBody body, CancellationToken cancellationToken = default, Action<CopyRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.DriveItem> PostAsync(CopyPostRequestBody body, CancellationToken cancellationToken = default, Action<CopyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
