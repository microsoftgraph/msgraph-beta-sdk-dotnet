...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Series.MicrosoftGraphItemAtWithIndex {
    /// <summary>
...
#nullable enable
        public async Task<WorkbookChartSeries?> GetAsync(Action<MicrosoftGraphItemAtWithIndexRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkbookChartSeries> GetAsync(Action<MicrosoftGraphItemAtWithIndexRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
