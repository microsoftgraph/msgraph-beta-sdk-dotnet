...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Floor_Precise {
    public class Floor_PrecisePostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable restore
        ...
        public static Floor_PrecisePostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
