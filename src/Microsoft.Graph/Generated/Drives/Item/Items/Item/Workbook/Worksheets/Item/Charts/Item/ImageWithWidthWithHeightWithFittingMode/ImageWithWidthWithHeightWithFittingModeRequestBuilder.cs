...
#nullable enable
        public async Task<ImageWithWidthWithHeightWithFittingModeResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ImageWithWidthWithHeightWithFittingModeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ImageWithWidthWithHeightWithFittingModeResponse> GetAsync(CancellationToken cancellationToken = default, Action<ImageWithWidthWithHeightWithFittingModeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
