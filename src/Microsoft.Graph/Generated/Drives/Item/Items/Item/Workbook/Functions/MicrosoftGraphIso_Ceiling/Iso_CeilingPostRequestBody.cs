...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.MicrosoftGraphIso_Ceiling {
    public class Iso_CeilingPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable restore
        ...
        /// </summary>
        public Iso_CeilingPostRequestBody() {
        ...
        public static Iso_CeilingPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
