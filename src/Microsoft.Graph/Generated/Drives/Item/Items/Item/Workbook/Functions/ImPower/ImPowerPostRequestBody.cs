...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.ImPower {
    public class ImPowerPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable restore
        ...
        public static ImPowerPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
