...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Ceiling_Precise {
    ...
    /// </summary>
    public class Ceiling_PreciseRequestBuilder {
        ...
        public Ceiling_PreciseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/ceiling_Precise";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Ceiling_PreciseRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
