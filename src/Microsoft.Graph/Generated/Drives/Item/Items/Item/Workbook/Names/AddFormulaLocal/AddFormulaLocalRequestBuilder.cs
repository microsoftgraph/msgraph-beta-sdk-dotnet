...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Names.AddFormulaLocal {
    /// <summary>
    ...
    public class AddFormulaLocalRequestBuilder {
        ...
        public AddFormulaLocalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/addFormulaLocal";
