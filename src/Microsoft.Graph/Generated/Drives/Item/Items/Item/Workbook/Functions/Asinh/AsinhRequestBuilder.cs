...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Asinh {
    ...
    public class AsinhRequestBuilder {
        ...
        public AsinhRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/asinh";
...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(AsinhPostRequestBody body, Action<AsinhRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(AsinhPostRequestBody body, Action<AsinhRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
