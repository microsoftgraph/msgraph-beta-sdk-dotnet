...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.MicrosoftGraphEcma_Ceiling {
    public class Ecma_CeilingPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable restore
        ...
        /// </summary>
        public Ecma_CeilingPostRequestBody() {
        ...
        public static Ecma_CeilingPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
