...
using System.Linq;
using System;
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.OddFPrice {
    public class OddFPricePostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Json? FirstCoupon {
            get { return BackingStore?.Get<Json?>("firstCoupon"); }
