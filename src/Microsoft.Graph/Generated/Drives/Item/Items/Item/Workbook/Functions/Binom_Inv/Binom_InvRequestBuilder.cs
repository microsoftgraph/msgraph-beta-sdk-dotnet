...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(Binom_InvPostRequestBody body, CancellationToken cancellationToken = default, Action<Binom_InvRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(Binom_InvPostRequestBody body, CancellationToken cancellationToken = default, Action<Binom_InvRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
