...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Binom_Inv
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Binom_Inv.Binom_InvRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.WorkbookFunctionResult?> PostAsync(Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Binom_Inv.Binom_InvPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.WorkbookFunctionResult> PostAsync(Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Binom_Inv.Binom_InvPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Binom_Inv.Binom_InvPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Binom_Inv.Binom_InvPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Binom_Inv.Binom_InvRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Binom_Inv.Binom_InvRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Binom_Inv.Binom_InvRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
