...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.MicrosoftGraphCountBlank {
    public class CountBlankPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable restore
        ...
        public static CountBlankPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
