...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(ImLog10PostRequestBody body, CancellationToken cancellationToken = default, Action<ImLog10RequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(ImLog10PostRequestBody body, CancellationToken cancellationToken = default, Action<ImLog10RequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
