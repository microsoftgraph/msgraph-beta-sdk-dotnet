...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.ImLog10 {
    ...
    /// </summary>
    public class ImLog10RequestBuilder {
        ...
        public ImLog10RequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/imLog10";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ImLog10RequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
