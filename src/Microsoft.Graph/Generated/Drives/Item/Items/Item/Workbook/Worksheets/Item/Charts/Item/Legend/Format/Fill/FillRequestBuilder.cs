...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<FillRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<FillRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookChartFill?> GetAsync(CancellationToken cancellationToken = default, Action<FillRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookChartFill> GetAsync(CancellationToken cancellationToken = default, Action<FillRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookChartFill?> PatchAsync(WorkbookChartFill body, CancellationToken cancellationToken = default, Action<FillRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookChartFill> PatchAsync(WorkbookChartFill body, CancellationToken cancellationToken = default, Action<FillRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
