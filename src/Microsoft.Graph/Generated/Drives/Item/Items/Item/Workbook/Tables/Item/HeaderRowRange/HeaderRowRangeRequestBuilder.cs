...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.HeaderRowRange {
    /// <summary>
    ...
    public class HeaderRowRangeRequestBuilder {
        ...
        public HeaderRowRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/headerRowRange()";
