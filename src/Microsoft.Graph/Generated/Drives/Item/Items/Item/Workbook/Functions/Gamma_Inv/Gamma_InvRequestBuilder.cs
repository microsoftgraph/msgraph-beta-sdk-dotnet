...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Gamma_Inv {
    ...
    /// </summary>
    public class Gamma_InvRequestBuilder {
        ...
        public Gamma_InvRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/gamma_Inv";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Gamma_InvRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
