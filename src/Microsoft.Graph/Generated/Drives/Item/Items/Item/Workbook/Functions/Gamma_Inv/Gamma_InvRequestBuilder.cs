...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(Gamma_InvPostRequestBody body, CancellationToken cancellationToken = default, Action<Gamma_InvRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(Gamma_InvPostRequestBody body, CancellationToken cancellationToken = default, Action<Gamma_InvRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
