...
using System;
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Title.Format.Fill.SetSolidColor {
    /// <summary>
    /// Provides operations to call the setSolidColor method.
    /// </summary>
    public class SetSolidColorRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new SetSolidColorRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SetSolidColorRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/title/format/fill/setSolidColor", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SetSolidColorRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(SetSolidColorPostRequestBody body, Action<SetSolidColorRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(SetSolidColorPostRequestBody body, Action<SetSolidColorRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
