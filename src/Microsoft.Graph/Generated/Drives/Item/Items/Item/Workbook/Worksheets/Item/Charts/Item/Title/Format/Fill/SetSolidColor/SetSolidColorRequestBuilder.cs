...
#nullable enable
        public async Task PostAsync(SetSolidColorPostRequestBody body, CancellationToken cancellationToken = default, Action<SetSolidColorRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(SetSolidColorPostRequestBody body, CancellationToken cancellationToken = default, Action<SetSolidColorRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
