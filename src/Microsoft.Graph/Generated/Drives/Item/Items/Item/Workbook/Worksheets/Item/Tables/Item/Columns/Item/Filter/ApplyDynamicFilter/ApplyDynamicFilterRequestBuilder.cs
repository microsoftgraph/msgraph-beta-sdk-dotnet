...
#nullable enable
        public async Task PostAsync(ApplyDynamicFilterPostRequestBody body, CancellationToken cancellationToken = default, Action<ApplyDynamicFilterRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(ApplyDynamicFilterPostRequestBody body, CancellationToken cancellationToken = default, Action<ApplyDynamicFilterRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
