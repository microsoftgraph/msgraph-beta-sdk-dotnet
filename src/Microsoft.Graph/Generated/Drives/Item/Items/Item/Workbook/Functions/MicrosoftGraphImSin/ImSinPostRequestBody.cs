...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.MicrosoftGraphImSin {
    public class ImSinPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable restore
        ...
        public static ImSinPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
