...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Application.MicrosoftGraphCalculate {
    public class CalculatePostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable enable
        public string? CalculationType {
            get { return BackingStore?.Get<string?>("calculationType"); }
            set { BackingStore?.Set("calculationType", value); }
        }
#nullable restore
#else
        public string CalculationType {
