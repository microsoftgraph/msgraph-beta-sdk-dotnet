...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.ChiSq_Dist {
    /// <summary>
    ...
    public class ChiSq_DistRequestBuilder {
        ...
        public ChiSq_DistRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/chiSq_Dist";
