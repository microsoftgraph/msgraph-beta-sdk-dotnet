...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(Percentile_ExcPostRequestBody body, CancellationToken cancellationToken = default, Action<Percentile_ExcRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(Percentile_ExcPostRequestBody body, CancellationToken cancellationToken = default, Action<Percentile_ExcRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
