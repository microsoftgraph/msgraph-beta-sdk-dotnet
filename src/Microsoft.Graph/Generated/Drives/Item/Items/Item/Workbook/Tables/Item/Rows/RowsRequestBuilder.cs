...
using Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Rows.MicrosoftGraphAdd;
using Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Rows.MicrosoftGraphCount;
using Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Rows.MicrosoftGraphItemAtWithIndex;
...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Rows {
    ...
    public class RowsRequestBuilder {
        ...
        public RowsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/rows{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
