...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.ItemAtWithIndex {
    /// <summary>
    ...
    public class ItemAtWithIndexRequestBuilder {
        ...
        public ItemAtWithIndexRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? index = default) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/itemAt(index={index})";
