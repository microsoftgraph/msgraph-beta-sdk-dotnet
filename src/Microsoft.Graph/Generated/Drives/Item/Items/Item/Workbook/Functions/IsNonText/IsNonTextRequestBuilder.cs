...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(IsNonTextPostRequestBody body, CancellationToken cancellationToken = default, Action<IsNonTextRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(IsNonTextPostRequestBody body, CancellationToken cancellationToken = default, Action<IsNonTextRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
