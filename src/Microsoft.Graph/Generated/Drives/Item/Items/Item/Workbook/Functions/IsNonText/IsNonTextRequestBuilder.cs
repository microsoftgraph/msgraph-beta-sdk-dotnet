...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.IsNonText {
    /// <summary>
    ...
    public class IsNonTextRequestBuilder {
        ...
        public IsNonTextRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/isNonText";
