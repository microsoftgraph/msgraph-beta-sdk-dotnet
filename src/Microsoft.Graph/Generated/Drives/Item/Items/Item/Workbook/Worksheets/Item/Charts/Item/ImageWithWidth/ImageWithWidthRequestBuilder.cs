...
#nullable enable
        public async Task<ImageWithWidthResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ImageWithWidthRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ImageWithWidthResponse> GetAsync(CancellationToken cancellationToken = default, Action<ImageWithWidthRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
