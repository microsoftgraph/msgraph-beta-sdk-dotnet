...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.ClearFilters {
    /// <summary>
    ...
    public class ClearFiltersRequestBuilder {
        ...
        public ClearFiltersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/clearFilters";
