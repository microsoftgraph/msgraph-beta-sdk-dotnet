...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(Dec2BinPostRequestBody body, CancellationToken cancellationToken = default, Action<Dec2BinRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(Dec2BinPostRequestBody body, CancellationToken cancellationToken = default, Action<Dec2BinRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
