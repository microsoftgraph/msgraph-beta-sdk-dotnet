...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Dec2Bin {
    ...
    /// </summary>
    public class Dec2BinRequestBuilder {
        ...
        public Dec2BinRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/dec2Bin";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Dec2BinRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
