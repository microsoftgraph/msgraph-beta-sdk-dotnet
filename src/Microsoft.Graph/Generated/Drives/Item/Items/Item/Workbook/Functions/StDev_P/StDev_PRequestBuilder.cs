...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.StDev_P {
    ...
    /// </summary>
    public class StDev_PRequestBuilder {
        ...
        public StDev_PRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/stDev_P";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StDev_PRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
