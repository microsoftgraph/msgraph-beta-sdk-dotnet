...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.Ceiling_Precise {
    public class Ceiling_PrecisePostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable restore
        ...
        /// </summary>
        public Ceiling_PrecisePostRequestBody() {
        ...
        public static Ceiling_PrecisePostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
