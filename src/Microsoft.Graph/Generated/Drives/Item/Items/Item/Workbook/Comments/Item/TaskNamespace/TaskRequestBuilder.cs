...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Comments.Item.TaskNamespace {
    ...
    public class TaskRequestBuilder : BaseRequestBuilder {
        ...
        public TaskRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/task{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TaskRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TaskRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/task{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
