...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.Item.Filter.MicrosoftGraphApplyBottomItemsFilter {
    /// <summary>
    ...
    public class MicrosoftGraphApplyBottomItemsFilterRequestBuilder {
        ...
        public MicrosoftGraphApplyBottomItemsFilterRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/filter/microsoft.graph.applyBottomItemsFilter";
