...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.MicrosoftGraphBase {
    public class BasePostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable enable
        public Json? MinLength {
            get { return BackingStore?.Get<Json?>("minLength"); }
            set { BackingStore?.Set("minLength", value); }
        }
#nullable restore
#else
        public Json MinLength {
...
#nullable enable
        public Json? Radix {
            get { return BackingStore?.Get<Json?>("radix"); }
            set { BackingStore?.Set("radix", value); }
        }
#nullable restore
#else
        public Json Radix {
