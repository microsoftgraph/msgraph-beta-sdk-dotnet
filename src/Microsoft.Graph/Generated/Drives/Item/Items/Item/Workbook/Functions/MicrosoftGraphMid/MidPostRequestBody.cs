...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Functions.MicrosoftGraphMid {
    public class MidPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
...
#nullable enable
        public Json? NumChars {
            get { return BackingStore?.Get<Json?>("numChars"); }
...
#nullable restore
        ...
        public static MidPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
