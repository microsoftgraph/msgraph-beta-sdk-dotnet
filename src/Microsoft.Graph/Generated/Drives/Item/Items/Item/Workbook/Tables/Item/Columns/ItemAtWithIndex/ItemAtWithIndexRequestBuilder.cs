...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex
{
    ...
    public class ItemAtWithIndexRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.DataBodyRange.DataBodyRangeRequestBuilder DataBodyRange
        {
            get => new Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.DataBodyRange.DataBodyRangeRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the filter property of the microsoft.graph.workbookTableColumn entity.</summary>
        public Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.Filter.FilterRequestBuilder Filter
        {
            get => new Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.Filter.FilterRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the headerRowRange method.</summary>
        public Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.HeaderRowRange.HeaderRowRangeRequestBuilder HeaderRowRange
        {
            get => new Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.HeaderRowRange.HeaderRowRangeRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the range method.</summary>
        public Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.RangeNamespace.RangeRequestBuilder Range
        {
            get => new Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.RangeNamespace.RangeRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the totalRowRange method.</summary>
        public Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.TotalRowRange.TotalRowRangeRequestBuilder TotalRowRange
        {
            get => new Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.TotalRowRange.TotalRowRangeRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.ItemAtWithIndexRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.ItemAtWithIndexRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.ItemAtWithIndexRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
