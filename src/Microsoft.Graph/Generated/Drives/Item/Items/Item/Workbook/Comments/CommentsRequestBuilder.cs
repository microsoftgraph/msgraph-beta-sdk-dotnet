using Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Comments.Count;
using Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Comments.Item;
...
namespace Microsoft.Graph.Beta.Drives.Item.Items.Item.Workbook.Comments {
    /// <summary>
    ...
    public class CommentsRequestBuilder {
        ...
        public CommentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
...
#nullable enable
        public async Task<WorkbookCommentCollectionResponse?> GetAsync(Action<CommentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkbookCommentCollectionResponse> GetAsync(Action<CommentsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookComment?> PostAsync(WorkbookComment body, Action<CommentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkbookComment> PostAsync(WorkbookComment body, Action<CommentsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
