...
namespace Microsoft.Graph.Beta.PrivilegedApproval.MyRequests {
    ...
    public class MyRequestsResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Microsoft.Graph.Beta.Models.PrivilegedApproval> Value {
            get { return BackingStore?.Get<List<Microsoft.Graph.Beta.Models.PrivilegedApproval>>(nameof(Value)); }
