...
namespace Microsoft.Graph.Beta.PrivilegedApproval.Item.RoleInfo.SelfDeactivate {
    ...
    public class SelfDeactivateRequestBuilder {
        ...
        /// </summary>
        public async Task<PrivilegedRoleAssignment> PostAsync(CancellationToken cancellationToken = default, Action<SelfDeactivateRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
