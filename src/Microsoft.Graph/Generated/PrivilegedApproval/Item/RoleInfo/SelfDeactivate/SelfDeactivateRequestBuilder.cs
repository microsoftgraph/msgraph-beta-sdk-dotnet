...
namespace Microsoft.Graph.Beta.PrivilegedApproval.Item.RoleInfo.SelfDeactivate {
    ...
    public class SelfDeactivateRequestBuilder {
        ...
        /// </summary>
        public SelfDeactivateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo/microsoft.graph.selfDeactivate";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public SelfDeactivateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public async Task<PrivilegedRoleAssignment> PostAsync(Action<SelfDeactivateRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
