...
using Microsoft.Graph.Beta.PrivilegedApproval.Item.RoleInfo.Assignments.Count;
using Microsoft.Graph.Beta.PrivilegedApproval.Item.RoleInfo.Assignments.Item;
...
namespace Microsoft.Graph.Beta.PrivilegedApproval.Item.RoleInfo.Assignments {
    /// <summary>
    ...
    public class AssignmentsRequestBuilder : BaseRequestBuilder {
        ...
        public AssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AssignmentsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AssignmentsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
