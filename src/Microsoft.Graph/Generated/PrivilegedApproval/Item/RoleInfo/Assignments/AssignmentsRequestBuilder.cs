...
namespace Microsoft.Graph.Beta.PrivilegedApproval.Item.RoleInfo.Assignments {
    ...
    public class AssignmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.privilegedApproval.item.roleInfo.assignments.item collection</summary>
        ...
        public AssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
