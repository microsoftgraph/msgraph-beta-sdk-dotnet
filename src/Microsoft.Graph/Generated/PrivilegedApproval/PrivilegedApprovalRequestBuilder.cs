...
#nullable enable
        public async Task<PrivilegedApprovalCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<PrivilegedApprovalRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrivilegedApprovalCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PrivilegedApprovalRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.PrivilegedApproval?> PostAsync(Microsoft.Graph.Beta.Models.PrivilegedApproval body, CancellationToken cancellationToken = default, Action<PrivilegedApprovalRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.PrivilegedApproval> PostAsync(Microsoft.Graph.Beta.Models.PrivilegedApproval body, CancellationToken cancellationToken = default, Action<PrivilegedApprovalRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
