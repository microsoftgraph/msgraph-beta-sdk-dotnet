...
using MicrosoftGraph.PrivilegedApproval.MyRequests;
using System;
...
namespace MicrosoftGraph.PrivilegedApproval {
    ...
    public class PrivilegedApprovalRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.privilegedApproval.item collection</summary>
        public PrivilegedApprovalRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("privilegedApproval_id", position);
            return new PrivilegedApprovalRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftGraph.Models.Microsoft.Graph.PrivilegedApproval body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftGraph.Models.Microsoft.Graph.PrivilegedApproval> PostAsync(MicrosoftGraph.Models.Microsoft.Graph.PrivilegedApproval body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
