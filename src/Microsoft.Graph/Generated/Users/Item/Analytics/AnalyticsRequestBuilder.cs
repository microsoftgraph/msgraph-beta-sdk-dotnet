...
using Microsoft.Graph.Beta.Users.Item.Analytics.ActivityStatistics;
...
using System;
namespace Microsoft.Graph.Beta.Users.Item.Analytics {
    /// <summary>
    ...
    public class AnalyticsRequestBuilder : BaseRequestBuilder {
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/analytics{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AnalyticsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AnalyticsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/analytics{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
