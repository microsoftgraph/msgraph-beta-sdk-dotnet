...
using MicrosoftGraphSdk.Users.Item.Analytics.ActivityStatistics.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Analytics.ActivityStatistics {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\analytics\activityStatistics</summary>
    public class ActivityStatisticsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.analytics.activityStatistics.item collection</summary>
        ...
        public ActivityStatisticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/analytics/activityStatistics{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
