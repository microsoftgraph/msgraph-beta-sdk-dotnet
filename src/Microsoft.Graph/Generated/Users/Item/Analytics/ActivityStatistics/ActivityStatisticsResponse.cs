...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Users.Item.Analytics.ActivityStatistics {
    public class ActivityStatisticsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ActivityStatisticsResponse).Value = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.ActivityStatistics>().ToList(); } },
            };
        }
        /// <summary>
