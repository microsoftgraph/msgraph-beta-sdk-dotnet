...
namespace Microsoft.Graph.Beta.Users.Item.DirectReports.Item.User.IsManagedAppUserBlocked {
    ...
    public class IsManagedAppUserBlockedRequestBuilder {
        ...
        public IsManagedAppUserBlockedRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/directReports/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.isManagedAppUserBlocked()";
