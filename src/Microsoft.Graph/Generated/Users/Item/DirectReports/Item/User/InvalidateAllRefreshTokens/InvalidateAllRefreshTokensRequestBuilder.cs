...
namespace Microsoft.Graph.Beta.Users.Item.DirectReports.Item.User.InvalidateAllRefreshTokens {
    ...
    public class InvalidateAllRefreshTokensRequestBuilder {
        ...
        public InvalidateAllRefreshTokensRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/directReports/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.invalidateAllRefreshTokens";
