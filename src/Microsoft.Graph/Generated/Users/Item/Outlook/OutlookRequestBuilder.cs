...
#nullable enable
        public async Task<OutlookUser?> GetAsync(CancellationToken cancellationToken = default, Action<OutlookRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OutlookUser> GetAsync(CancellationToken cancellationToken = default, Action<OutlookRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
