...
namespace MicrosoftGraphSdk.Users.Item.Outlook.SupportedTimeZones {
    ...
    public class SupportedTimeZonesResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as SupportedTimeZonesResponse).Value = n.GetCollectionOfObjectValues<TimeZoneInformation>(TimeZoneInformation.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
