...
namespace Microsoft.Graph.Beta.Users.Item.Outlook.SupportedTimeZones {
    ...
    public class SupportedTimeZonesRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="SupportedTimeZonesGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function supportedTimeZones
        /// </summary>
        /// <returns>A <cref="SupportedTimeZonesResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="SupportedTimeZonesRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
