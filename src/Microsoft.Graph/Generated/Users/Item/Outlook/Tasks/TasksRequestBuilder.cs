...
using MicrosoftGraphSdk.Users.Item.Outlook.Tasks.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Outlook.Tasks {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\outlook\tasks</summary>
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.outlook.tasks.item collection</summary>
