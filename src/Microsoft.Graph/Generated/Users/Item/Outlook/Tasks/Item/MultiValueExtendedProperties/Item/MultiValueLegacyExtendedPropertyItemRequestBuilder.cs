...
namespace MicrosoftGraphSdk.Users.Item.Outlook.Tasks.Item.MultiValueExtendedProperties.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\outlook\tasks\{outlookTask-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}</summary>
