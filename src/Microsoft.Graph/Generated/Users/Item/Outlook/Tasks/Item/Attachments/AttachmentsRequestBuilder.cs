...
using Microsoft.Graph.Beta.Users.Item.Outlook.Tasks.Item.Attachments.Count;
using Microsoft.Graph.Beta.Users.Item.Outlook.Tasks.Item.Attachments.CreateUploadSession;
using Microsoft.Graph.Beta.Users.Item.Outlook.Tasks.Item.Attachments.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.Outlook.Tasks.Item.Attachments {
    /// <summary>
    ...
    public class AttachmentsRequestBuilder : BaseRequestBuilder {
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/outlook/tasks/{outlookTask%2Did}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AttachmentsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AttachmentsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/outlook/tasks/{outlookTask%2Did}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
