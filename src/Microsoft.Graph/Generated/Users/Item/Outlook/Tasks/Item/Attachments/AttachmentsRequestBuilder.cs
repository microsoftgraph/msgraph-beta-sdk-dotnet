...
using MicrosoftGraphSdk.Users.Item.Outlook.Tasks.Item.Attachments.CreateUploadSession;
using MicrosoftGraphSdk.Users.Item.Outlook.Tasks.Item.Attachments.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Outlook.Tasks.Item.Attachments {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\outlook\tasks\{outlookTask-id}\attachments</summary>
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.outlook.tasks.item.attachments.item collection</summary>
