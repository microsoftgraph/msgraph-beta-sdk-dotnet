...
namespace MicrosoftGraphSdk.Users.Item.Outlook.Tasks.Item.Attachments.CreateUploadSession {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\outlook\tasks\{outlookTask-id}\attachments\microsoft.graph.createUploadSession</summary>
    public class CreateUploadSessionRequestBuilder {
        ...
        public CreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/outlook/tasks/{outlookTask_id}/attachments/microsoft.graph.createUploadSession";
