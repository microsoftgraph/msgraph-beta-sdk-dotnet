...
using MicrosoftGraph.Users.Item.Outlook.Tasks.Item.MultiValueExtendedProperties.Item;
using System;
...
namespace MicrosoftGraph.Users.Item.Outlook.Tasks.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.users.item.outlook.tasks.item.multiValueExtendedProperties.item collection</summary>
