...
using Microsoft.Graph.Beta.Users.Item.Outlook.TaskFolders.Count;
using Microsoft.Graph.Beta.Users.Item.Outlook.TaskFolders.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.Outlook.TaskFolders {
    ...
    public class TaskFoldersRequestBuilder : BaseRequestBuilder {
        ...
        public TaskFoldersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/outlook/taskFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TaskFoldersRequestBuilder and sets the default values.
        /// </summary>
