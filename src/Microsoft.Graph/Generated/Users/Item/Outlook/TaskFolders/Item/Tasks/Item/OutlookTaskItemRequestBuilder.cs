...
using MicrosoftGraphSdk.Users.Item.Outlook.TaskFolders.Item.Tasks.Item.Attachments;
using MicrosoftGraphSdk.Users.Item.Outlook.TaskFolders.Item.Tasks.Item.Complete;
using MicrosoftGraphSdk.Users.Item.Outlook.TaskFolders.Item.Tasks.Item.MultiValueExtendedProperties;
using MicrosoftGraphSdk.Users.Item.Outlook.TaskFolders.Item.Tasks.Item.SingleValueExtendedProperties;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Outlook.TaskFolders.Item.Tasks.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\outlook\taskFolders\{outlookTaskFolder-id}\tasks\{outlookTask-id}</summary>
    public class OutlookTaskItemRequestBuilder {
        ...
        public OutlookTaskItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/outlook/taskFolders/{outlookTaskFolder_id}/tasks/{outlookTask_id}{?select}";
