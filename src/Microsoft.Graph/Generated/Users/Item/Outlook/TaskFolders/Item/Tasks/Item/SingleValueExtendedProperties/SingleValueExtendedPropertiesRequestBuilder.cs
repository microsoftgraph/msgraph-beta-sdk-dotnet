...
using MicrosoftGraphSdk.Users.Item.Outlook.TaskFolders.Item.Tasks.Item.SingleValueExtendedProperties.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Outlook.TaskFolders.Item.Tasks.Item.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\outlook\taskFolders\{outlookTaskFolder-id}\tasks\{outlookTask-id}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.outlook.taskFolders.item.tasks.item.singleValueExtendedProperties.item collection</summary>
