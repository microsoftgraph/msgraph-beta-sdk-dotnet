...
namespace Microsoft.Graph.Beta.Users.Item.Outlook.TaskFolders.Item {
    ...
    public class OutlookTaskFolderItemRequestBuilder : BaseRequestBuilder {
        ...
        public OutlookTaskFolderItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/outlook/taskFolders/{outlookTaskFolder%2Did}{?%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OutlookTaskFolderItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OutlookTaskFolderItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/outlook/taskFolders/{outlookTaskFolder%2Did}{?%24select}", rawUrl) {
        }
        /// <summary>
        /// Delete the specified Outlook task folder.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/outlooktaskfolder-delete?view=graph-rest-1.0" />
        /// </summary>
...
#nullable restore
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/outlooktaskfolder-get?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
...
#nullable restore
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/outlooktaskfolder-update?view=graph-rest-1.0" />
        /// </summary>
