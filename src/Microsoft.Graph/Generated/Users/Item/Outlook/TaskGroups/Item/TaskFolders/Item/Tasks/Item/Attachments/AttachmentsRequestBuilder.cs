...
namespace MicrosoftGraphSdk.Users.Item.Outlook.TaskGroups.Item.TaskFolders.Item.Tasks.Item.Attachments {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\outlook\taskGroups\{outlookTaskGroup-id}\taskFolders\{outlookTaskFolder-id}\tasks\{outlookTask-id}\attachments</summary>
