...
using MicrosoftGraph.Users.Item.Outlook.TaskGroups.Item.TaskFolders.Item.Tasks.Item;
using System;
...
namespace MicrosoftGraph.Users.Item.Outlook.TaskGroups.Item.TaskFolders.Item.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.users.item.outlook.taskGroups.item.taskFolders.item.tasks.item collection</summary>
