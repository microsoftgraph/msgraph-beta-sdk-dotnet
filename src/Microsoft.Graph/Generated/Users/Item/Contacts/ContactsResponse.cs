...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Users.Item.Contacts {
    public class ContactsResponse : IParsable {
        ...
        /// </summary>
        public static ContactsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ContactsResponse).Value = n.GetCollectionOfObjectValues<Contact>(Contact.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
