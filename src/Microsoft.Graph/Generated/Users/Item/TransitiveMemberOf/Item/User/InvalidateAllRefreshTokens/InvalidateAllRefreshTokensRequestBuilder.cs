...
namespace Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.InvalidateAllRefreshTokens {
    ...
    public class InvalidateAllRefreshTokensRequestBuilder {
        ...
        public InvalidateAllRefreshTokensRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.invalidateAllRefreshTokens";
