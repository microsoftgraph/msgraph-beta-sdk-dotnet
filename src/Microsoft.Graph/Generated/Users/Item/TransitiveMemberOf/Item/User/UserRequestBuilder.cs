...
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.ActivateServicePlan;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.AssignLicense;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.ChangePassword;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.CheckMemberGroups;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.CheckMemberObjects;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.ExportDeviceAndAppManagementData;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.ExportDeviceAndAppManagementDataWithSkipWithTop;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.ExportPersonalData;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.FindMeetingTimes;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.FindRoomLists;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.FindRooms;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.FindRoomsWithRoomList;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.GetEffectiveDeviceEnrollmentConfigurations;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.GetLoggedOnManagedDevices;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.GetMailTips;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.GetManagedAppDiagnosticStatuses;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.GetManagedAppPolicies;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.GetManagedDevicesWithAppFailures;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.GetManagedDevicesWithFailedOrPendingApps;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.GetMemberGroups;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.GetMemberObjects;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.InvalidateAllRefreshTokens;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.IsManagedAppUserBlocked;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.ReminderViewWithStartDateTimeWithEndDateTime;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.RemoveAllDevicesFromManagement;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.ReprocessLicenseAssignment;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.Restore;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.RevokeSignInSessions;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.SendMail;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.TranslateExchangeIds;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.UnblockManagedApps;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.WipeAndBlockManagedApps;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.WipeManagedAppRegistrationByDeviceTag;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.WipeManagedAppRegistrationsByAzureAdDeviceId;
using Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User.WipeManagedAppRegistrationsByDeviceTag;
...
namespace Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.Item.User {
