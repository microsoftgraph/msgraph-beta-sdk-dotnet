...
namespace Microsoft.Graph.Beta.Users.Item.TransitiveMemberOf.User.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/transitiveMemberOf/microsoft.graph.user/$count";
