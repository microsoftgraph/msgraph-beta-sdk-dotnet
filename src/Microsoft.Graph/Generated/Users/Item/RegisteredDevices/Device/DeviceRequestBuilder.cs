...
using Microsoft.Graph.Beta.Users.Item.RegisteredDevices.Device.Count;
...
namespace Microsoft.Graph.Beta.Users.Item.RegisteredDevices.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        public DeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/registeredDevices/microsoft.graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
