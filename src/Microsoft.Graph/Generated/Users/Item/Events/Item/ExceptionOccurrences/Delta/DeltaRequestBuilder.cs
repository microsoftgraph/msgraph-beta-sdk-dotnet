...
namespace MicrosoftGraph.Users.Item.Events.Item.ExceptionOccurrences.Delta {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\events\{event-id}\exceptionOccurrences\microsoft.graph.delta()</summary>
    public class DeltaRequestBuilder {
        ...
        public DeltaRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/events/{event_id}/exceptionOccurrences/microsoft.graph.delta()";
