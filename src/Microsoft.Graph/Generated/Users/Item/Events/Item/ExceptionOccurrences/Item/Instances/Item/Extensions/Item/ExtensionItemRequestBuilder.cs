...
namespace Microsoft.Graph.Beta.Users.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.Extensions.Item {
    ...
    public class ExtensionItemRequestBuilder {
        ...
        public ExtensionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/extensions/{extension%2Did}{?%24select,%24expand}";
