...
namespace Microsoft.Graph.Beta.Users.Item.InferenceClassification.Overrides {
    ...
    public class OverridesRequestBuilder {
        ...
        /// </summary>
        public async Task<InferenceClassificationOverrideCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<OverridesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<InferenceClassificationOverride> PostAsync(InferenceClassificationOverride body, CancellationToken cancellationToken = default, Action<OverridesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
