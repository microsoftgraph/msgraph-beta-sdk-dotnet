        ...
        public class MoveResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"mailFolder", (o,n) => { (o as MoveResponse).MailFolder = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.MailFolder>(MicrosoftGraphSdk.Models.Microsoft.Graph.MailFolder.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
