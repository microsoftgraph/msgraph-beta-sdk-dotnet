...
namespace Microsoft.Graph.Beta.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateReplyAll {
    ...
    public class CreateReplyAllRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Message> PostAsync(CreateReplyAllPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateReplyAllRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
