...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Message?> PostAsync(CreateReplyAllPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Message> PostAsync(CreateReplyAllPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="CreateReplyAllRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public CreateReplyAllRequestBuilder WithUrl(string rawUrl)
        {
            return new CreateReplyAllRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
