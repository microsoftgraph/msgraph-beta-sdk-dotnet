...
namespace Microsoft.Graph.Beta.Users.Item.MailFolders.Item.ChildFolders.Item.MessageRules {
    ...
    public class MessageRulesRequestBuilder {
        ...
        /// </summary>
        public async Task<MessageRuleCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MessageRulesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MessageRule> PostAsync(MessageRule body, CancellationToken cancellationToken = default, Action<MessageRulesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
