using Microsoft.Graph.Beta.Users.Item.MailFolders.Item.Messages.Item.EventMessageRequest.Accept;
using Microsoft.Graph.Beta.Users.Item.MailFolders.Item.Messages.Item.EventMessageRequest.Decline;
using Microsoft.Graph.Beta.Users.Item.MailFolders.Item.Messages.Item.EventMessageRequest.TentativelyAccept;
...
namespace Microsoft.Graph.Beta.Users.Item.MailFolders.Item.Messages.Item.EventMessageRequest {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\mailFolders\{mailFolder-id}\messages\{message-id}\microsoft.graph.eventMessageRequest</summary>
    public class EventMessageRequestRequestBuilder {
        ...
        public EventMessageRequestRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/microsoft.graph.eventMessageRequest";
