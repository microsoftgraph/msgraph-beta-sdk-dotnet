...
namespace Microsoft.Graph.Beta.Users.Item.MailFolders.Item.Messages.Item.Reply {
    /// <summary>
    ...
    public class ReplyRequestBuilder {
        ...
        public ReplyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/reply";
