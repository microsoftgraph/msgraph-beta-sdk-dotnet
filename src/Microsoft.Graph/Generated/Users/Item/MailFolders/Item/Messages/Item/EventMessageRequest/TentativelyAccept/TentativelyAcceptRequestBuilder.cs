...
namespace Microsoft.Graph.Beta.Users.Item.MailFolders.Item.Messages.Item.EventMessageRequest.TentativelyAccept {
    ...
    public class TentativelyAcceptRequestBuilder {
        ...
        public TentativelyAcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/microsoft.graph.eventMessageRequest/microsoft.graph.tentativelyAccept";
