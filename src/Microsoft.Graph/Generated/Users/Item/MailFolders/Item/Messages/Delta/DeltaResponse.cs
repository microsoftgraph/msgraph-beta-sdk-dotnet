...
namespace Microsoft.Graph.Beta.Users.Item.MailFolders.Item.Messages.Delta {
    ...
    public class DeltaResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Microsoft.Graph.Beta.Models.Message> Value {
            get { return BackingStore?.Get<List<Microsoft.Graph.Beta.Models.Message>>(nameof(Value)); }
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Beta.Models.Message>("value", Value);
