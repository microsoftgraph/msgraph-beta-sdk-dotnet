...
namespace Microsoft.Graph.Beta.Users.Item.MailFolders.Item.Messages.Item.CreateForward {
    ...
    public class CreateForwardRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Message> PostAsync(CreateForwardPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateForwardRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
