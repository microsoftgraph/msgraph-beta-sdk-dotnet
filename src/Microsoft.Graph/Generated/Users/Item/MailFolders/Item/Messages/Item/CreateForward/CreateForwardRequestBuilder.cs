...
namespace MicrosoftGraphSdk.Users.Item.MailFolders.Item.Messages.Item.CreateForward {
    ...
    public class CreateForwardRequestBuilder {
        ...
        /// </summary>
        public async Task<Message> PostAsync(CreateForwardRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
