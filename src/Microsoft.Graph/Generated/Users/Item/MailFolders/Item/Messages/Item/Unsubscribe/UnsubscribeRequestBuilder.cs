...
namespace MicrosoftGraphSdk.Users.Item.MailFolders.Item.Messages.Item.Unsubscribe {
    ...
    public class UnsubscribeRequestBuilder {
        ...
        public UnsubscribeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/mailFolders/{mailFolder_id}/messages/{message_id}/microsoft.graph.unsubscribe";
