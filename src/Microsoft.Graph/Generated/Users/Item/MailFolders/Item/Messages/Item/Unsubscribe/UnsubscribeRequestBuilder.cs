...
namespace Microsoft.Graph.Beta.Users.Item.MailFolders.Item.Messages.Item.Unsubscribe {
    ...
    public class UnsubscribeRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<UnsubscribeRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
