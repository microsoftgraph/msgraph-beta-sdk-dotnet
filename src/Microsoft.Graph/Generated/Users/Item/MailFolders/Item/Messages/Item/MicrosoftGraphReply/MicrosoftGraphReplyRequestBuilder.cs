...
namespace Microsoft.Graph.Beta.Users.Item.MailFolders.Item.Messages.Item.MicrosoftGraphReply {
    /// <summary>
    ...
    public class MicrosoftGraphReplyRequestBuilder {
        ...
        public MicrosoftGraphReplyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/microsoft.graph.reply";
