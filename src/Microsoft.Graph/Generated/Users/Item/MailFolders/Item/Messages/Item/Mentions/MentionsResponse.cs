...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Users.Item.MailFolders.Item.Messages.Item.Mentions {
    public class MentionsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as MentionsResponse).Value = n.GetCollectionOfObjectValues<Mention>().ToList(); } },
            };
        }
        /// <summary>
