...
namespace Microsoft.Graph.Beta.Users.Item.AppRoleAssignedResourcesWithAppId {
    ...
    public class AppRoleAssignedResourcesWithAppIdRequestBuilder : BaseRequestBuilder {
        ...
        public AppRoleAssignedResourcesWithAppIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string appId = "") : base(requestAdapter, "{+baseurl}/users/{user%2Did}/appRoleAssignedResources(appId='{appId}'){?%24select,%24expand}", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AppRoleAssignedResourcesWithAppIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/appRoleAssignedResources(appId='{appId}'){?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
