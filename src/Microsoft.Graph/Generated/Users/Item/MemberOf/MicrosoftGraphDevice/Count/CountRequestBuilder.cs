...
namespace Microsoft.Graph.Beta.Users.Item.MemberOf.MicrosoftGraphDevice.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/memberOf/microsoft.graph.device/$count{?%24search,%24filter}";
