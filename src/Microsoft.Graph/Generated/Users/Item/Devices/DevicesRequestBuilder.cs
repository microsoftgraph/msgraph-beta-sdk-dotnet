...
using MicrosoftGraphSdk.Users.Item.Devices.Count;
using MicrosoftGraphSdk.Users.Item.Devices.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Devices {
    ...
    public class DevicesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.devices.item collection</summary>
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.Device body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
