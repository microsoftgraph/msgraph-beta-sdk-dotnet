...
namespace Microsoft.Graph.Beta.Users.Item.Devices {
    ...
    public class DevicesRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DevicesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Device> PostAsync(Microsoft.Graph.Beta.Models.Device body, CancellationToken cancellationToken = default, Action<DevicesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
