...
using MicrosoftGraphSdk.Users.Item.Devices.Item.TransitiveMemberOf.Count;
using MicrosoftGraphSdk.Users.Item.Devices.Item.TransitiveMemberOf.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Devices.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.devices.item.transitiveMemberOf.item collection</summary>
        ...
        public TransitiveMemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/devices/{device_id}/transitiveMemberOf{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
