...
using Microsoft.Graph.Beta.Users.Item.Devices.Item.TransitiveMemberOf.Application;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.TransitiveMemberOf.Count;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.TransitiveMemberOf.Device;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.TransitiveMemberOf.Group;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.TransitiveMemberOf.Item;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.TransitiveMemberOf.OrgContact;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.TransitiveMemberOf.ServicePrincipal;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.TransitiveMemberOf.User;
...
namespace Microsoft.Graph.Beta.Users.Item.Devices.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.devices.item.transitiveMemberOf.item collection</summary>
        ...
        public TransitiveMemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/transitiveMemberOf{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
