...
namespace Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.FindMeetingTimes {
    ...
    public class FindMeetingTimesRequestBuilder {
        ...
        public FindMeetingTimesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.findMeetingTimes";
