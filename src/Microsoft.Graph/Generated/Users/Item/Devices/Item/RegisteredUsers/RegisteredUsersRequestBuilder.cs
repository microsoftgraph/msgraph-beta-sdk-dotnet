...
using MicrosoftGraphSdk.Users.Item.Devices.Item.RegisteredUsers.Count;
using MicrosoftGraphSdk.Users.Item.Devices.Item.RegisteredUsers.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Devices.Item.RegisteredUsers {
    ...
    public class RegisteredUsersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.devices.item.registeredUsers.item collection</summary>
