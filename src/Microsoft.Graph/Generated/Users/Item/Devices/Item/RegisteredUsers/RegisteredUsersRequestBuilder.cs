...
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Count;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.GraphEndpoint;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.GraphServicePrincipal;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.GraphUser;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Ref;
...
using System;
namespace Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers {
    /// <summary>
    ...
    public class RegisteredUsersRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.devices.item.registeredUsers.item collection</summary>
        ...
        public RegisteredUsersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RegisteredUsersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RegisteredUsersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
