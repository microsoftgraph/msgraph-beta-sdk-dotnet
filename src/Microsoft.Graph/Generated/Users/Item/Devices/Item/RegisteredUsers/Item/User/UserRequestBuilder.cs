...
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.ActivateServicePlan;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.AssignLicense;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.ChangePassword;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.CheckMemberGroups;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.CheckMemberObjects;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.ExportDeviceAndAppManagementData;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.ExportDeviceAndAppManagementDataWithSkipWithTop;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.ExportPersonalData;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.FindMeetingTimes;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.FindRoomLists;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.FindRooms;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.FindRoomsWithRoomList;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.GetEffectiveDeviceEnrollmentConfigurations;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.GetLoggedOnManagedDevices;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.GetMailTips;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.GetManagedAppDiagnosticStatuses;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.GetManagedAppPolicies;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.GetManagedDevicesWithAppFailures;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.GetManagedDevicesWithFailedOrPendingApps;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.GetMemberGroups;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.GetMemberObjects;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.InvalidateAllRefreshTokens;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.IsManagedAppUserBlocked;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.ReminderViewWithStartDateTimeWithEndDateTime;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.RemoveAllDevicesFromManagement;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.ReprocessLicenseAssignment;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.Restore;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.RevokeSignInSessions;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.SendMail;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.TranslateExchangeIds;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.UnblockManagedApps;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.WipeAndBlockManagedApps;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.WipeManagedAppRegistrationByDeviceTag;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.WipeManagedAppRegistrationsByAzureAdDeviceId;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User.WipeManagedAppRegistrationsByDeviceTag;
...
namespace Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredUsers.Item.User {
    ...
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}";
