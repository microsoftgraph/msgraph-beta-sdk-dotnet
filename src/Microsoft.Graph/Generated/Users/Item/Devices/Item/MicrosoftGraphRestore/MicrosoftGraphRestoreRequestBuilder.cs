...
namespace Microsoft.Graph.Beta.Users.Item.Devices.Item.MicrosoftGraphRestore {
    /// <summary>
    ...
    public class MicrosoftGraphRestoreRequestBuilder {
        ...
        public MicrosoftGraphRestoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/microsoft.graph.restore";
