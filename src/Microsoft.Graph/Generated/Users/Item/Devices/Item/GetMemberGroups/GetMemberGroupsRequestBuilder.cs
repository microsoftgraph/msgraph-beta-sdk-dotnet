...
namespace Microsoft.Graph.Beta.Users.Item.Devices.Item.GetMemberGroups {
    ...
    public class GetMemberGroupsRequestBuilder : BaseRequestBuilder {
        ...
        public GetMemberGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/getMemberGroups", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetMemberGroupsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetMemberGroupsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/getMemberGroups", rawUrl) {
        }
        /// <summary>
