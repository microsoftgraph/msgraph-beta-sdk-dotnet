...
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredOwners.MicrosoftGraphEndpoint;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredOwners.MicrosoftGraphServicePrincipal;
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredOwners.MicrosoftGraphUser;
...
namespace Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredOwners {
    ...
    public class RegisteredOwnersRequestBuilder {
        ...
        public RegisteredOwnersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
