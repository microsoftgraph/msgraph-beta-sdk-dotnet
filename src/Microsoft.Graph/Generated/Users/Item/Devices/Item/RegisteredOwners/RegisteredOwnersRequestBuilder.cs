...
using MicrosoftGraphSdk.Users.Item.Devices.Item.RegisteredOwners.Count;
using MicrosoftGraphSdk.Users.Item.Devices.Item.RegisteredOwners.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Devices.Item.RegisteredOwners {
    ...
    public class RegisteredOwnersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.devices.item.registeredOwners.item collection</summary>
        ...
        public RegisteredOwnersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/devices/{device_id}/registeredOwners{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
