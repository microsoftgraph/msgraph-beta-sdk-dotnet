...
using Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredOwners.User.Count;
...
namespace Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredOwners.User {
    /// <summary>
    ...
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/microsoft.graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
