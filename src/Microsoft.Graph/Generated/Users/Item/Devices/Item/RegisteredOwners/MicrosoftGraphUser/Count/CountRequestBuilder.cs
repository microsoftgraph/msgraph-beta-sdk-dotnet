...
namespace Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredOwners.MicrosoftGraphUser.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/microsoft.graph.user/$count{?%24search,%24filter}";
