...
namespace Microsoft.Graph.Beta.Users.Item.Devices.Item.RegisteredOwners.Item.User.FindRoomsWithRoomList {
    ...
    public class FindRoomsWithRoomListRequestBuilder {
        ...
        public FindRoomsWithRoomListRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string roomList = default) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.findRooms(RoomList='{RoomList}')";
