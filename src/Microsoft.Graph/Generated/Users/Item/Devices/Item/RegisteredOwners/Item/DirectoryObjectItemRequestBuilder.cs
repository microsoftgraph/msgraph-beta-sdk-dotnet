...
namespace MicrosoftGraphSdk.Users.Item.Devices.Item.RegisteredOwners.Item {
    ...
    public class DirectoryObjectItemRequestBuilder {
        ...
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/devices/{device_id}/registeredOwners/{directoryObject_id}{?select,expand}";
