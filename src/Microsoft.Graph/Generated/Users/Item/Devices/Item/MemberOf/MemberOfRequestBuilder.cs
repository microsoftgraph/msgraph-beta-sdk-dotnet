...
using MicrosoftGraphSdk.Users.Item.Devices.Item.MemberOf.Count;
using MicrosoftGraphSdk.Users.Item.Devices.Item.MemberOf.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Devices.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.devices.item.memberOf.item collection</summary>
        ...
        public MemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/devices/{device_id}/memberOf{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
