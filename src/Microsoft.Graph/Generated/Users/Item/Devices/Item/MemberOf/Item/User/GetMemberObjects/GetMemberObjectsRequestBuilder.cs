...
namespace Microsoft.Graph.Beta.Users.Item.Devices.Item.MemberOf.Item.User.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder {
        ...
        public GetMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.getMemberObjects";
