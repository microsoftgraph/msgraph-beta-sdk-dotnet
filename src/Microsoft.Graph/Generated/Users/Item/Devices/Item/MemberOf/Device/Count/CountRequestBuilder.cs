...
namespace Microsoft.Graph.Beta.Users.Item.Devices.Item.MemberOf.Device.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf/microsoft.graph.device/$count";
