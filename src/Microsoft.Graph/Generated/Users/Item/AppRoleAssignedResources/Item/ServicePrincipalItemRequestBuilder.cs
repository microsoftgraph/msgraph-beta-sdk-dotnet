...
namespace Microsoft.Graph.Beta.Users.Item.AppRoleAssignedResources.Item {
    ...
    public class ServicePrincipalItemRequestBuilder {
        ...
        public ServicePrincipalItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/appRoleAssignedResources/{servicePrincipal%2Did}{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.ServicePrincipal> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <summary>Get appRoleAssignedResources from users</summary>
