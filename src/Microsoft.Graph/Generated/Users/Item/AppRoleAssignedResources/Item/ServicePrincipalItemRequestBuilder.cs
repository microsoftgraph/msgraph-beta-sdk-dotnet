...
using System;
namespace Microsoft.Graph.Beta.Users.Item.AppRoleAssignedResources.Item {
    /// <summary>
    ...
    public class ServicePrincipalItemRequestBuilder : BaseRequestBuilder {
        ...
        public ServicePrincipalItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/appRoleAssignedResources/{servicePrincipal%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ServicePrincipalItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ServicePrincipalItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/appRoleAssignedResources/{servicePrincipal%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
