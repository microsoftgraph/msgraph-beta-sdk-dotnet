...
using Microsoft.Graph.Beta.Users.Item.AppRoleAssignedResources.Count;
using Microsoft.Graph.Beta.Users.Item.AppRoleAssignedResources.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.AppRoleAssignedResources {
    ...
    public class AppRoleAssignedResourcesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.appRoleAssignedResources.item collection</summary>
        ...
        public AppRoleAssignedResourcesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/appRoleAssignedResources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
