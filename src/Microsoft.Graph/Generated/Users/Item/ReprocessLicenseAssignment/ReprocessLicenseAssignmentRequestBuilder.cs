...
namespace MicrosoftGraphSdk.Users.Item.ReprocessLicenseAssignment {
    ...
    public class ReprocessLicenseAssignmentRequestBuilder {
        ...
        /// </summary>
        public async Task<MicrosoftGraphSdk.Models.Microsoft.Graph.User> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
