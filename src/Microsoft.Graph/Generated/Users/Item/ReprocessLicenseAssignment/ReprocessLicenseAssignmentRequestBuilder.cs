...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.User?> PostAsync(CancellationToken cancellationToken = default, Action<ReprocessLicenseAssignmentRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.User> PostAsync(CancellationToken cancellationToken = default, Action<ReprocessLicenseAssignmentRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
