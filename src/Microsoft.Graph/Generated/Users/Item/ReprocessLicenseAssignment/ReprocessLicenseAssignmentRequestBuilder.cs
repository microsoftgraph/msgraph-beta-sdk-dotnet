...
namespace Microsoft.Graph.Beta.Users.Item.ReprocessLicenseAssignment {
    ...
    public class ReprocessLicenseAssignmentRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.User> PostAsync(CancellationToken cancellationToken = default, Action<ReprocessLicenseAssignmentRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
