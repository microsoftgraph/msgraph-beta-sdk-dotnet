...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UsedInsightItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UsedInsightItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UsedInsight?> GetAsync(CancellationToken cancellationToken = default, Action<UsedInsightItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UsedInsight> GetAsync(CancellationToken cancellationToken = default, Action<UsedInsightItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UsedInsight?> PatchAsync(UsedInsight body, CancellationToken cancellationToken = default, Action<UsedInsightItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UsedInsight> PatchAsync(UsedInsight body, CancellationToken cancellationToken = default, Action<UsedInsightItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
