...
namespace Microsoft.Graph.Beta.Users.Item.DevicesWithDeviceId {
    ...
    public class DevicesWithDeviceIdRequestBuilder : BaseRequestBuilder {
        ...
        public DevicesWithDeviceIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string deviceId = "") : base(requestAdapter, "{+baseurl}/users/{user%2Did}/devices(deviceId='{deviceId}'){?%24select,%24expand}", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DevicesWithDeviceIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/devices(deviceId='{deviceId}'){?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
