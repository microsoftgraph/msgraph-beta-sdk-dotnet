...
namespace Microsoft.Graph.Beta.Users.Item.Calendars {
    ...
    public class CalendarsRequestBuilder : BaseRequestBuilder {
        ...
        public CalendarsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CalendarsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CalendarsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<CalendarCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<CalendarsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CalendarCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CalendarsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Calendar?> PostAsync(Microsoft.Graph.Beta.Models.Calendar body, CancellationToken cancellationToken = default, Action<CalendarsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Calendar> PostAsync(Microsoft.Graph.Beta.Models.Calendar body, CancellationToken cancellationToken = default, Action<CalendarsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
