...
namespace Microsoft.Graph.Beta.Users.Item.Calendars.Item.CalendarPermissions.Item {
    ...
    public class CalendarPermissionItemRequestBuilder {
        ...
        public CalendarPermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarPermissions/{calendarPermission%2Did}{?%24select}";
