...
using MicrosoftGraph.Users.Item.Calendars.Item.AllowedCalendarSharingRolesWithUser;
using MicrosoftGraph.Users.Item.Calendars.Item.CalendarPermissions;
using MicrosoftGraph.Users.Item.Calendars.Item.CalendarView;
using MicrosoftGraph.Users.Item.Calendars.Item.Events;
using MicrosoftGraph.Users.Item.Calendars.Item.GetSchedule;
using MicrosoftGraph.Users.Item.Calendars.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Users.Item.Calendars.Item.SingleValueExtendedProperties;
using System;
...
namespace MicrosoftGraph.Users.Item.Calendars.Item {
    ...
    public class CalendarRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraph.Models.Microsoft.Graph.Calendar body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MicrosoftGraph.Models.Microsoft.Graph.Calendar body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
