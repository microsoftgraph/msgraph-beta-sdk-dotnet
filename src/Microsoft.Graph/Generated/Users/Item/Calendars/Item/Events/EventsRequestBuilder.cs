...
using MicrosoftGraph.Users.Item.Calendars.Item.Events.Delta;
using MicrosoftGraph.Users.Item.Calendars.Item.Events.Item;
using System;
...
namespace MicrosoftGraph.Users.Item.Calendars.Item.Events {
    ...
    public class EventsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.users.item.calendars.item.events.item collection</summary>
