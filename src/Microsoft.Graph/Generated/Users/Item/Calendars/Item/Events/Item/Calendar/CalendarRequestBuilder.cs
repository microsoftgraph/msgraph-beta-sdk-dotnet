...
using MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Calendar.AllowedCalendarSharingRolesWithUser;
using MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Calendar.GetSchedule;
using MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Calendar.Ref;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Calendar {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\events\{event-id}\calendar</summary>
    public class CalendarRequestBuilder {
        ...
        /// <summary>
        /// Builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\events\{event-id}\calendar\microsoft.graph.allowedCalendarSharingRoles(User='{User}')
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendars/{calendar_id}/events/{event_id}/calendar{?select}";
