...
namespace MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.ExceptionOccurrences.Delta {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\events\{event-id}\exceptionOccurrences\microsoft.graph.delta()</summary>
