...
namespace Microsoft.Graph.Beta.Users.Item.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.SnoozeReminder {
    ...
    public class SnoozeReminderRequestBuilder {
        ...
        public SnoozeReminderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendars/{calendar_id}/events/{event_id}/exceptionOccurrences/{event_id1}/instances/{event_id2}/microsoft.graph.snoozeReminder";
