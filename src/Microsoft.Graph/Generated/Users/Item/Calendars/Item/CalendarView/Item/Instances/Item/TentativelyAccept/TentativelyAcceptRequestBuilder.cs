...
namespace Microsoft.Graph.Beta.Users.Item.Calendars.Item.CalendarView.Item.Instances.Item.TentativelyAccept {
    /// <summary>
    ...
    public class TentativelyAcceptRequestBuilder {
        ...
        public TentativelyAcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/tentativelyAccept";
