...
namespace MicrosoftGraphSdk.Users.Item.Calendars.Item.CalendarView.Item.Attachments.CreateUploadSession {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\calendarView\{event-id}\attachments\microsoft.graph.createUploadSession</summary>
