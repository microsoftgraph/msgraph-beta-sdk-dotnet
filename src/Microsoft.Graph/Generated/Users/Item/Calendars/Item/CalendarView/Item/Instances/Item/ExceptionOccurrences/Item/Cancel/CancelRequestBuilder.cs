...
namespace Microsoft.Graph.Beta.Users.Item.Calendars.Item.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Cancel {
    ...
    public class CancelRequestBuilder {
        ...
        public CancelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/microsoft.graph.cancel";
