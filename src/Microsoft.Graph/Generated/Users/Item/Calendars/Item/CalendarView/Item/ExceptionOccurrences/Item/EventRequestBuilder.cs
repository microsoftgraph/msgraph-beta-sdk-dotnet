...
using MicrosoftGraph.Users.Item.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.Accept;
using MicrosoftGraph.Users.Item.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.Cancel;
using MicrosoftGraph.Users.Item.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.Decline;
using MicrosoftGraph.Users.Item.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.DismissReminder;
using MicrosoftGraph.Users.Item.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.Forward;
using MicrosoftGraph.Users.Item.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.SnoozeReminder;
using MicrosoftGraph.Users.Item.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item.TentativelyAccept;
using System;
...
namespace MicrosoftGraph.Users.Item.Calendars.Item.CalendarView.Item.ExceptionOccurrences.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\calendarView\{event-id}\exceptionOccurrences\{event-id1}</summary>
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendars/{calendar_id}/calendarView/{event_id}/exceptionOccurrences/{event_id1}{?select,expand}";
