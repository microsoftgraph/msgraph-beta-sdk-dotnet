...
using MicrosoftGraph.Users.Item.Calendars.Item.CalendarView.Item.Attachments.CreateUploadSession;
using MicrosoftGraph.Users.Item.Calendars.Item.CalendarView.Item.Attachments.Item;
using System;
...
namespace MicrosoftGraph.Users.Item.Calendars.Item.CalendarView.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.users.item.calendars.item.calendarView.item.attachments.item collection</summary>
