...
namespace Microsoft.Graph.Beta.Users.Item.Tasks.Alltasks.Item.LinkedResources.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/tasks/alltasks/{baseTask%2Did}/linkedResources/$count";
