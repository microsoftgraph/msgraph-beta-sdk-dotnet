...
namespace Microsoft.Graph.Beta.Users.Item.Tasks.Alltasks.Item.Move {
    ...
    public class MoveRequestBuilder {
        ...
        /// </summary>
        public async Task<BaseTask> PostAsync(MovePostRequestBody body, CancellationToken cancellationToken = default, Action<MoveRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
