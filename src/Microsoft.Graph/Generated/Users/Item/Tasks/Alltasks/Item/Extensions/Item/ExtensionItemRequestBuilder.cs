...
namespace MicrosoftGraphSdk.Users.Item.Tasks.Alltasks.Item.Extensions.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\tasks\alltasks\{baseTask-id}\extensions\{extension-id}</summary>
    public class ExtensionItemRequestBuilder {
        ...
        public ExtensionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/tasks/alltasks/{baseTask_id}/extensions/{extension_id}{?select,expand}";
