...
using Microsoft.Graph.Beta.Users.Item.Tasks.Lists.Count;
using Microsoft.Graph.Beta.Users.Item.Tasks.Lists.Delta;
using Microsoft.Graph.Beta.Users.Item.Tasks.Lists.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.Tasks.Lists {
    ...
    public class ListsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.tasks.lists.item collection</summary>
        ...
        public ListsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/tasks/lists{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
