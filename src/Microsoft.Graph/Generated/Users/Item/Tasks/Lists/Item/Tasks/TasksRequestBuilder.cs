...
namespace Microsoft.Graph.Beta.Users.Item.Tasks.Lists.Item.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// </summary>
        public async Task<BaseTaskCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TasksRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<BaseTask> PostAsync(BaseTask body, CancellationToken cancellationToken = default, Action<TasksRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
