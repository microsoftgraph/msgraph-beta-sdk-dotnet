...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Users.Item.Tasks.Lists.Item.Tasks.Item.Move {
    ...
    public class MoveRequestBody : IAdditionalDataHolder, IParsable {
        ...
        public string DestinationTaskListId { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"destinationTaskListId", (o,n) => { (o as MoveRequestBody).DestinationTaskListId = n.GetStringValue(); } },
            };
        }
        /// <summary>
