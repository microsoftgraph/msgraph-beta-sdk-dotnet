...
namespace MicrosoftGraphSdk.Users.Item.Tasks.Lists.Item.Tasks.Item.Extensions.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\tasks\lists\{baseTaskList-id}\tasks\{baseTask-id}\extensions\{extension-id}</summary>
    public class ExtensionItemRequestBuilder {
        ...
        public ExtensionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/tasks/lists/{baseTaskList_id}/tasks/{baseTask_id}/extensions/{extension_id}{?select,expand}";
