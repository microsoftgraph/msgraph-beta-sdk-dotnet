...
namespace MicrosoftGraphSdk.Users.Item.Tasks.Lists.Item.Tasks.Item.Move {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\tasks\lists\{baseTaskList-id}\tasks\{baseTask-id}\microsoft.graph.move</summary>
    public class MoveRequestBuilder {
        ...
        public MoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/tasks/lists/{baseTaskList_id}/tasks/{baseTask_id}/microsoft.graph.move";
