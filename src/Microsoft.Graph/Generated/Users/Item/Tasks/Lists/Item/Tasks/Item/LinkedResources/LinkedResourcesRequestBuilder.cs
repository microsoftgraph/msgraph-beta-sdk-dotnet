...
using MicrosoftGraphSdk.Users.Item.Tasks.Lists.Item.Tasks.Item.LinkedResources.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Tasks.Lists.Item.Tasks.Item.LinkedResources {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\tasks\lists\{baseTaskList-id}\tasks\{baseTask-id}\linkedResources</summary>
    public class LinkedResourcesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.tasks.lists.item.tasks.item.linkedResources.item collection</summary>
        ...
        public LinkedResourcesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/tasks/lists/{baseTaskList_id}/tasks/{baseTask_id}/linkedResources{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
