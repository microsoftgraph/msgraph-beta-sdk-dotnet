...
using MicrosoftGraphSdk.Users.Item.Tasks.Lists.Item.Extensions.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Tasks.Lists.Item.Extensions {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\tasks\lists\{baseTaskList-id}\extensions</summary>
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.tasks.lists.item.extensions.item collection</summary>
