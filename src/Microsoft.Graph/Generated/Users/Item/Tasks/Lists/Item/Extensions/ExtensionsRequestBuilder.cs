...
using Microsoft.Graph.Beta.Users.Item.Tasks.Lists.Item.Extensions.Count;
using Microsoft.Graph.Beta.Users.Item.Tasks.Lists.Item.Extensions.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.Tasks.Lists.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.tasks.lists.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/tasks/lists/{baseTaskList%2Did}/extensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
