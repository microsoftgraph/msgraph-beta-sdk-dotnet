...
using MicrosoftGraphSdk.Users.Item.Security.InformationProtection;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Security {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\security</summary>
