...
namespace Microsoft.Graph.Beta.Users.Item.Security.InformationProtection {
    ...
    public class InformationProtectionRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Security.InformationProtection> PatchAsync(Microsoft.Graph.Beta.Models.Security.InformationProtection body, Action<InformationProtectionRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
