...
namespace Microsoft.Graph.Beta.Users.Item.Security.InformationProtection.SensitivityLabels.MicrosoftGraphSecurityEvaluateApplication {
    ...
    public class MicrosoftGraphSecurityEvaluateApplicationRequestBuilder : BaseRequestBuilder {
        ...
        public MicrosoftGraphSecurityEvaluateApplicationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/security/informationProtection/sensitivityLabels/microsoft.graph.security.evaluateApplication", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MicrosoftGraphSecurityEvaluateApplicationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphSecurityEvaluateApplicationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/security/informationProtection/sensitivityLabels/microsoft.graph.security.evaluateApplication", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<EvaluateApplicationResponse?> PostAsync(EvaluateApplicationPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphSecurityEvaluateApplicationRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EvaluateApplicationResponse> PostAsync(EvaluateApplicationPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphSecurityEvaluateApplicationRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
