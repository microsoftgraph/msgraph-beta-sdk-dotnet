...
#nullable enable
        public async Task<ContentLabel?> PostAsync(ExtractContentLabelPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphSecurityExtractContentLabelRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ContentLabel> PostAsync(ExtractContentLabelPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphSecurityExtractContentLabelRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
