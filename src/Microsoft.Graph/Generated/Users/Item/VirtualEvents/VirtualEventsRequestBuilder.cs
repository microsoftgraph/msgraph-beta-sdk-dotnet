...
namespace Microsoft.Graph.Beta.Users.Item.VirtualEvents {
    ...
    public class VirtualEventsRequestBuilder : BaseRequestBuilder {
        ...
        public VirtualEventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/virtualEvents{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new VirtualEventsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public VirtualEventsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/virtualEvents{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
