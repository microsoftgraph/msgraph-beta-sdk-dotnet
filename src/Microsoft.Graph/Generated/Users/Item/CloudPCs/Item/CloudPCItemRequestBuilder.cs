...
using MicrosoftGraphSdk.Users.Item.CloudPCs.Item.ChangeUserAccountType;
using MicrosoftGraphSdk.Users.Item.CloudPCs.Item.EndGracePeriod;
using MicrosoftGraphSdk.Users.Item.CloudPCs.Item.GetCloudPcLaunchInfo;
using MicrosoftGraphSdk.Users.Item.CloudPCs.Item.Reboot;
using MicrosoftGraphSdk.Users.Item.CloudPCs.Item.Rename;
using MicrosoftGraphSdk.Users.Item.CloudPCs.Item.Reprovision;
using MicrosoftGraphSdk.Users.Item.CloudPCs.Item.Troubleshoot;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.CloudPCs.Item {
    ...
    public class CloudPCItemRequestBuilder {
        ...
        public CloudPCItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/cloudPCs/{cloudPC_id}{?select,expand}";
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.CloudPC body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftGraphSdk.Models.Microsoft.Graph.CloudPC> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MicrosoftGraphSdk.Models.Microsoft.Graph.CloudPC body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
