...
namespace Microsoft.Graph.Beta.Users.Item.CloudPCs.Item.RetryPartnerAgentInstallation {
    ...
    public class RetryPartnerAgentInstallationRequestBuilder : BaseRequestBuilder {
        ...
        public RetryPartnerAgentInstallationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/cloudPCs/{cloudPC%2Did}/retryPartnerAgentInstallation", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RetryPartnerAgentInstallationRequestBuilder and sets the default values.
        /// </summary>
