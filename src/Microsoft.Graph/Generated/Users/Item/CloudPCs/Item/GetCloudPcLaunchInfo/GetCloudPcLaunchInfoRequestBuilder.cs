...
namespace Microsoft.Graph.Beta.Users.Item.CloudPCs.Item.GetCloudPcLaunchInfo {
    ...
    public class GetCloudPcLaunchInfoRequestBuilder {
        ...
        /// </summary>
        public async Task<CloudPcLaunchInfo> GetAsync(Action<GetCloudPcLaunchInfoRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
