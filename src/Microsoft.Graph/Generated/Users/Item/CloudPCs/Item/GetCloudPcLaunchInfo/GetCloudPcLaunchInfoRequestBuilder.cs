...
namespace Microsoft.Graph.Beta.Users.Item.CloudPCs.Item.GetCloudPcLaunchInfo {
    /// <summary>Provides operations to call the getCloudPcLaunchInfo method.</summary>
    public class GetCloudPcLaunchInfoRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetCloudPcLaunchInfoRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<CloudPcLaunchInfo> GetAsync(CancellationToken cancellationToken = default, Action<GetCloudPcLaunchInfoRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<CloudPcLaunchInfo>(requestInfo, CloudPcLaunchInfo.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
