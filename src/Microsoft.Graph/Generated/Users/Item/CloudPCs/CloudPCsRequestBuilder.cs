...
#nullable enable
        public async Task<CloudPCCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<CloudPCsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CloudPCCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CloudPCsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.CloudPC?> PostAsync(Microsoft.Graph.Beta.Models.CloudPC body, CancellationToken cancellationToken = default, Action<CloudPCsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.CloudPC> PostAsync(Microsoft.Graph.Beta.Models.CloudPC body, CancellationToken cancellationToken = default, Action<CloudPCsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
