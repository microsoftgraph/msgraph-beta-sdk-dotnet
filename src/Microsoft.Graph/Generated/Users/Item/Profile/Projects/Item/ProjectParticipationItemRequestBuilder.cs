...
namespace Microsoft.Graph.Beta.Users.Item.Profile.Projects.Item {
    ...
    public class ProjectParticipationItemRequestBuilder : BaseRequestBuilder {
        ...
        public ProjectParticipationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/profile/projects/{projectParticipation%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ProjectParticipationItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProjectParticipationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/profile/projects/{projectParticipation%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete a projectParticipation object from a user&apos;s profile.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/projectparticipation-delete?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ProjectParticipationItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ProjectParticipationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/projectparticipation-get?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ProjectParticipation?> GetAsync(CancellationToken cancellationToken = default, Action<ProjectParticipationItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ProjectParticipation> GetAsync(CancellationToken cancellationToken = default, Action<ProjectParticipationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/projectparticipation-update?view=graph-rest-1.0" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ProjectParticipation?> PatchAsync(ProjectParticipation body, CancellationToken cancellationToken = default, Action<ProjectParticipationItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ProjectParticipation> PatchAsync(ProjectParticipation body, CancellationToken cancellationToken = default, Action<ProjectParticipationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
