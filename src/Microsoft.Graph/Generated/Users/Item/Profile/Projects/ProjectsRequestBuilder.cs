...
namespace Microsoft.Graph.Beta.Users.Item.Profile.Projects {
    ...
    public class ProjectsRequestBuilder {
        ...
        /// </summary>
        public async Task<ProjectParticipationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ProjectsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ProjectParticipation> PostAsync(ProjectParticipation body, CancellationToken cancellationToken = default, Action<ProjectsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
