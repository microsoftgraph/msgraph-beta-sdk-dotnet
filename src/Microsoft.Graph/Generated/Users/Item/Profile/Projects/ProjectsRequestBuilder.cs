...
#nullable enable
        public async Task<ProjectParticipationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ProjectsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ProjectParticipationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ProjectsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ProjectParticipation?> PostAsync(ProjectParticipation body, CancellationToken cancellationToken = default, Action<ProjectsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ProjectParticipation> PostAsync(ProjectParticipation body, CancellationToken cancellationToken = default, Action<ProjectsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
