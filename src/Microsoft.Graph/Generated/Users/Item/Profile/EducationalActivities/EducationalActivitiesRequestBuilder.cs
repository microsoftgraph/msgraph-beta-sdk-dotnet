...
using MicrosoftGraphSdk.Users.Item.Profile.EducationalActivities.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Profile.EducationalActivities {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\profile\educationalActivities</summary>
    public class EducationalActivitiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.profile.educationalActivities.item collection</summary>
        ...
        public EducationalActivitiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/profile/educationalActivities{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
