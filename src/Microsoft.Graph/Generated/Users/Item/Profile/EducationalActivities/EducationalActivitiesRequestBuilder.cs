...
namespace Microsoft.Graph.Beta.Users.Item.Profile.EducationalActivities {
    ...
    public class EducationalActivitiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.profile.educationalActivities.item collection</summary>
        ...
        public EducationalActivitiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/profile/educationalActivities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
