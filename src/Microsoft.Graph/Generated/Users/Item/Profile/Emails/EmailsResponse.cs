...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Users.Item.Profile.Emails {
    public class EmailsResponse : IParsable {
        ...
        /// </summary>
        public static EmailsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as EmailsResponse).Value = n.GetCollectionOfObjectValues<ItemEmail>(ItemEmail.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
