...
using System;
namespace Microsoft.Graph.Beta.Users.Item.Profile.Skills.Item {
    /// <summary>
    ...
    public class SkillProficiencyItemRequestBuilder : BaseRequestBuilder {
        ...
        public SkillProficiencyItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/profile/skills/{skillProficiency%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SkillProficiencyItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SkillProficiencyItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/profile/skills/{skillProficiency%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
