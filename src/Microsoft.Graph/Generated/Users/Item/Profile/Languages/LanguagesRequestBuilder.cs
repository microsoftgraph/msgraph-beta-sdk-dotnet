...
using MicrosoftGraphSdk.Users.Item.Profile.Languages.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Profile.Languages {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\profile\languages</summary>
    public class LanguagesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.profile.languages.item collection</summary>
        ...
        public LanguagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/profile/languages{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
