...
using MicrosoftGraphSdk.Users.Item.Profile.Anniversaries.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Profile.Anniversaries {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\profile\anniversaries</summary>
    public class AnniversariesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.profile.anniversaries.item collection</summary>
