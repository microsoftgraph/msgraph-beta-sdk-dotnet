...
using MicrosoftGraph.Users.Item.Profile.Interests.Item;
using System;
...
namespace MicrosoftGraph.Users.Item.Profile.Interests {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\profile\interests</summary>
    public class InterestsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.users.item.profile.interests.item collection</summary>
        public PersonInterestRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("personInterest_id", position);
            return new PersonInterestRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
