...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Users.Item.Profile.Names {
    public class NamesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as NamesResponse).Value = n.GetCollectionOfObjectValues<PersonName>(PersonName.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
