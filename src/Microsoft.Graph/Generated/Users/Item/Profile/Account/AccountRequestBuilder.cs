...
using MicrosoftGraphSdk.Users.Item.Profile.Account.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Profile.Account {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\profile\account</summary>
    public class AccountRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.profile.account.item collection</summary>
        ...
        public AccountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/profile/account{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
