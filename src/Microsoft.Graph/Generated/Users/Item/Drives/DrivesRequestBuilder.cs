...
using Microsoft.Graph.Beta.Users.Item.Drives.Count;
using Microsoft.Graph.Beta.Users.Item.Drives.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.Drives {
    /// <summary>
    ...
    public class DrivesRequestBuilder {
        ...
        public DrivesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
