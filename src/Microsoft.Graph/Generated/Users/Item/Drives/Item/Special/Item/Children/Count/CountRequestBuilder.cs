...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Special.Item.Children.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/special/{driveItem_id}/children/$count";
