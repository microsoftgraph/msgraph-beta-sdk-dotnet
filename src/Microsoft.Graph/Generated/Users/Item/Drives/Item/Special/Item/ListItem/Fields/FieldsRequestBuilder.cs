...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Special.Item.ListItem.Fields {
    ...
    public class FieldsRequestBuilder {
        ...
        public FieldsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/special/{driveItem_id}/listItem/fields{?select,expand}";
