...
using MicrosoftGraphSdk.Users.Item.Drives.Item.Special.Item.Permissions.Item.Grant;
using MicrosoftGraphSdk.Users.Item.Drives.Item.Special.Item.Permissions.Item.RevokeGrants;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Special.Item.Permissions.Item {
    ...
    public class PermissionItemRequestBuilder {
        ...
        public PermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/special/{driveItem_id}/permissions/{permission_id}{?select,expand}";
