...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Special.Item.Versions.Item.RestoreVersion {
    ...
    public class RestoreVersionRequestBuilder {
        ...
        public RestoreVersionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/special/{driveItem_id}/versions/{driveItemVersion_id}/microsoft.graph.restoreVersion";
