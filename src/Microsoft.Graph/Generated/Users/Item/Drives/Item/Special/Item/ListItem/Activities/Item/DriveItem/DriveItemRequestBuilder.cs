...
using MicrosoftGraphSdk.Users.Item.Drives.Item.Special.Item.ListItem.Activities.Item.DriveItem.Content;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Special.Item.ListItem.Activities.Item.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/special/{driveItem_id}/listItem/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
