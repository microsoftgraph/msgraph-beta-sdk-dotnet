...
using MicrosoftGraphSdk.Users.Item.Drives.Item.Special.Item.Subscriptions.Count;
using MicrosoftGraphSdk.Users.Item.Drives.Item.Special.Item.Subscriptions.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Special.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.drives.item.special.item.subscriptions.item collection</summary>
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/special/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
