...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Recent {
    ...
    public class RecentRequestBuilder {
        ...
        public RecentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/microsoft.graph.recent()";
        ...
        /// </summary>
        public async Task<RecentResponse> GetAsync(CancellationToken cancellationToken = default, Action<RecentRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
