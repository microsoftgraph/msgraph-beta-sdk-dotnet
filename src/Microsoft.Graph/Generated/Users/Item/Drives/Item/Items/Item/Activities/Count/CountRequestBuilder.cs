...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Items.Item.Activities.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/activities/$count{?%24search,%24filter}";
