...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Items.Item.Preview {
    ...
    public class PreviewRequestBuilder {
        ...
        public async Task<ItemPreviewInfo> PostAsync(PreviewPostRequestBody body, CancellationToken cancellationToken = default, Action<PreviewRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            ...
            return await RequestAdapter.SendAsync<ItemPreviewInfo>(requestInfo, ItemPreviewInfo.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
