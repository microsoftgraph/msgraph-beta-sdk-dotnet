...
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Items.Item.ListItem.Activities.Item.DriveItem.Content;
...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Items.Item.ListItem.Activities.Item.DriveItem {
    /// <summary>
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}";
