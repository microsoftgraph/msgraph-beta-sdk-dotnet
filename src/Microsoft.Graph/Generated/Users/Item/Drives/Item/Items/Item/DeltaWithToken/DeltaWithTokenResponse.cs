...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Items.Item.DeltaWithToken {
    /// <summary>Provides operations to call the delta method.</summary>
    public class DeltaWithTokenResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Microsoft.Graph.Beta.Models.DriveItem> Value {
            get { return BackingStore?.Get<List<Microsoft.Graph.Beta.Models.DriveItem>>(nameof(Value)); }
