...
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Items.Item.Children.Item.Content;
...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Items.Item.Children.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/children/{driveItem%2Did1}{?%24select,%24expand}";
