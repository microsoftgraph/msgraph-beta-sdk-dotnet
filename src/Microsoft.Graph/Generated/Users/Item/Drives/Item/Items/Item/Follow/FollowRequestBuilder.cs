...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Items.Item.Follow {
    /// <summary>
    ...
    public class FollowRequestBuilder {
        ...
        public FollowRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.follow";
