...
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Activities;
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Analytics;
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Children;
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Content;
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.ListItem;
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Permissions;
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Subscriptions;
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Thumbnails;
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Versions;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/following/{driveItem_id}{?select,expand}";
        ...
        /// <summary>
        /// Delete navigation property following for users
        ...
        /// <summary>
        /// Update the navigation property following in users
        /// <param name="body"></param>
        /// <param name="h">Request headers</param>
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.DriveItem body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
