...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.ListItem.Versions.Item.RestoreVersion {
    ...
    public class RestoreVersionRequestBuilder {
        ...
        public RestoreVersionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/following/{driveItem_id}/listItem/versions/{listItemVersion_id}/microsoft.graph.restoreVersion";
