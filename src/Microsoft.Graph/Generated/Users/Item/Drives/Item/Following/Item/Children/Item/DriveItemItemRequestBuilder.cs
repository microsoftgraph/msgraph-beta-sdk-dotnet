...
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Children.Item.Content;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Children.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/following/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
