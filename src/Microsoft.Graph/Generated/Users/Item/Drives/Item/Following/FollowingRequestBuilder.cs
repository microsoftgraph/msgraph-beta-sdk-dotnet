...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Following {
    ...
    public class FollowingRequestBuilder {
        ...
        /// </summary>
        public async Task<DriveItemCollectionResponse> GetAsync(Action<FollowingRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
