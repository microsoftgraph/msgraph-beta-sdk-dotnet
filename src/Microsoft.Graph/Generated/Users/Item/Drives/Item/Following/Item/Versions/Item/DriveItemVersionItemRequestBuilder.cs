...
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Versions.Item.Content;
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Versions.Item.RestoreVersion;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Versions.Item {
    ...
    public class DriveItemVersionItemRequestBuilder {
        ...
        public DriveItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/following/{driveItem_id}/versions/{driveItemVersion_id}{?select,expand}";
