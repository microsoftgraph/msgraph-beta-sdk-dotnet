...
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.ListItem.Versions.Item.Fields;
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.ListItem.Versions.Item.RestoreVersion;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.ListItem.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/following/{driveItem_id}/listItem/versions/{listItemVersion_id}{?select,expand}";
