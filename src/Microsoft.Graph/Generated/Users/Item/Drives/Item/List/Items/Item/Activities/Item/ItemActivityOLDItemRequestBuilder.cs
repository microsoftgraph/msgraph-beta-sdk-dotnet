...
using Microsoft.Graph.Beta.Users.Item.Drives.Item.List.Items.Item.Activities.Item.DriveItem;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.List.Items.Item.Activities.Item.ListItem;
...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.List.Items.Item.Activities.Item {
    /// <summary>
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}";
