...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.List.ContentTypes.AddCopyFromContentTypeHub {
    ...
    public class AddCopyFromContentTypeHubRequestBuilder {
        ...
        /// </summary>
        public async Task<ContentType> PostAsync(AddCopyFromContentTypeHubPostRequestBody body, Action<AddCopyFromContentTypeHubRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
