...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.List.ContentTypes.AddCopyFromContentTypeHub {
    ...
    public class AddCopyFromContentTypeHubRequestBuilder {
        ...
        /// </summary>
        public async Task<ContentType> PostAsync(AddCopyFromContentTypeHubPostRequestBody body, CancellationToken cancellationToken = default, Action<AddCopyFromContentTypeHubRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
