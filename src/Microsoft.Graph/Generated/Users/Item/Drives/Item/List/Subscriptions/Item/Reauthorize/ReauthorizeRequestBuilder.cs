...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.List.Subscriptions.Item.Reauthorize {
    ...
    public class ReauthorizeRequestBuilder {
        ...
        public ReauthorizeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize";
