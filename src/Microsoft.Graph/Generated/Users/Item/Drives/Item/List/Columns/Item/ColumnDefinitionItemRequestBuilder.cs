...
using Microsoft.Graph.Beta.Users.Item.Drives.Item.List.Columns.Item.SourceColumn;
...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.List.Columns.Item {
    ...
    public class ColumnDefinitionItemRequestBuilder {
        ...
        public ColumnDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/columns/{columnDefinition%2Did}{?%24select,%24expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ColumnDefinition> PatchAsync(ColumnDefinition body, Action<ColumnDefinitionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
