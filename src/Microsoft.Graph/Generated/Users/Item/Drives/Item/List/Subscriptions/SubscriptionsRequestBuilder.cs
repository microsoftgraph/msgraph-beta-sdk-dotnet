...
using MicrosoftGraphSdk.Users.Item.Drives.Item.List.Subscriptions.Count;
using MicrosoftGraphSdk.Users.Item.Drives.Item.List.Subscriptions.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.List.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.drives.item.list.subscriptions.item collection</summary>
