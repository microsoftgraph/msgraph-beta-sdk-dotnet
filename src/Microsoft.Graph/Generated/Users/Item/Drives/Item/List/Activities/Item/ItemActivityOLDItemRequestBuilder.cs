...
using MicrosoftGraphSdk.Users.Item.Drives.Item.List.Activities.Item.DriveItem;
using MicrosoftGraphSdk.Users.Item.Drives.Item.List.Activities.Item.ListItem;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.List.Activities.Item {
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/list/activities/{itemActivityOLD_id}{?select,expand}";
