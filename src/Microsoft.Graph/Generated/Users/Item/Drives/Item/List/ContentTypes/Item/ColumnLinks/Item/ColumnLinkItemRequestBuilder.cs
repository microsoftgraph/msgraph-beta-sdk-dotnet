...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.List.ContentTypes.Item.ColumnLinks.Item {
    ...
    public class ColumnLinkItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ColumnLink> PatchAsync(ColumnLink body, Action<ColumnLinkItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
