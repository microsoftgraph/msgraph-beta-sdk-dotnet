...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.List.Activities.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/list/activities/{itemActivityOLD_id}/listItem{?select,expand}";
