...
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Activities;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Bundles;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Following;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Items;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.List;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Recent;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Root;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.SearchWithQ;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.SharedWithMe;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Special;
...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item {
    ...
    public class DriveItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Drive> GetAsync(CancellationToken cancellationToken = default, Action<DriveItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.Drive body, CancellationToken cancellationToken = default, Action<DriveItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
