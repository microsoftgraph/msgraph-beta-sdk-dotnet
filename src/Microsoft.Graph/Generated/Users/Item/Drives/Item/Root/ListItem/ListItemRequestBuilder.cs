...
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.Activities;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.Analytics;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.CreateLink;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.DocumentSetVersions;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.DriveItem;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.Fields;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.Versions;
...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.ListItem> PatchAsync(Microsoft.Graph.Beta.Models.ListItem body, Action<ListItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
