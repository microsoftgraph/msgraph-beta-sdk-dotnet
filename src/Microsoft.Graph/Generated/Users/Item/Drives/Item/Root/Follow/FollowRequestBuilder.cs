...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.Follow {
    /// <summary>
    ...
    public class FollowRequestBuilder {
        ...
        public FollowRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/microsoft.graph.follow";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FollowRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public async Task<Microsoft.Graph.Beta.Models.DriveItem> PostAsync(Action<FollowRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
        ...
        /// </summary>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation ToPostRequestInformation(Action<FollowRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
