...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.Follow {
    ...
    public class FollowRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.DriveItem> PostAsync(CancellationToken cancellationToken = default, Action<FollowRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
