...
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.Activities.Count;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.Activities.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.Activities {
    ...
    public class ActivitiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.drives.item.root.activities.item collection</summary>
        ...
        public ActivitiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
