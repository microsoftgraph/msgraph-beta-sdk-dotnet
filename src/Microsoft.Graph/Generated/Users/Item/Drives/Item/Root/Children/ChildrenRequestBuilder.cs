...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        /// </summary>
        public async Task<DriveItemCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ChildrenRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
