...
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.Activities.Item.DriveItem;
using Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.Activities.Item.ListItem;
...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.Activities.Item {
    /// <summary>
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.Activities.Item.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.Activities.Item.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the listItem property of the microsoft.graph.itemActivityOLD entity.</summary>
        public Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.Activities.Item.ListItem.ListItemRequestBuilder ListItem { get =>
            new Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.ListItem.Activities.Item.ListItem.ListItemRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/listItem/activities/{itemActivityOLD%2Did}{?%24select,%24expand}";
