...
namespace Microsoft.Graph.Beta.Users.Item.Drives.Item.Root.Permissions.Item.RevokeGrants {
    /// <summary>
    ...
    public class RevokeGrantsRequestBuilder {
        ...
        public RevokeGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/permissions/{permission%2Did}/microsoft.graph.revokeGrants";
