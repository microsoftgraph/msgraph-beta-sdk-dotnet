...
using MicrosoftGraphSdk.Users.Item.Drives.Item.Bundles.Item.ListItem.Activities.Item.DriveItem;
using MicrosoftGraphSdk.Users.Item.Drives.Item.Bundles.Item.ListItem.Activities.Item.ListItem;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Bundles.Item.ListItem.Activities.Item {
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/bundles/{driveItem_id}/listItem/activities/{itemActivityOLD_id}{?select,expand}";
