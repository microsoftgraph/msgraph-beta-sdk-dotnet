...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Bundles.Item.Activities.Item {
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/bundles/{driveItem_id}/activities/{itemActivityOLD_id}{?select,expand}";
