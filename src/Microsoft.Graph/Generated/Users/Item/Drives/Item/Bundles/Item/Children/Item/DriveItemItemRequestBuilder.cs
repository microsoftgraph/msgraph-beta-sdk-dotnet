...
using MicrosoftGraphSdk.Users.Item.Drives.Item.Bundles.Item.Children.Item.Content;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Bundles.Item.Children.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/bundles/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
