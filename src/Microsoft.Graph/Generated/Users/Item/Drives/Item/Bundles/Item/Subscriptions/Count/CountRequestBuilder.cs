...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Bundles.Item.Subscriptions.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/bundles/{driveItem_id}/subscriptions/$count";
