...
using MicrosoftGraphSdk.Users.Item.Drives.Item.Bundles.Item.Permissions.Item.Grant;
using MicrosoftGraphSdk.Users.Item.Drives.Item.Bundles.Item.Permissions.Item.RevokeGrants;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Bundles.Item.Permissions.Item {
    ...
    public class PermissionItemRequestBuilder {
        ...
        public PermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/bundles/{driveItem_id}/permissions/{permission_id}{?select,expand}";
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.Permission body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
