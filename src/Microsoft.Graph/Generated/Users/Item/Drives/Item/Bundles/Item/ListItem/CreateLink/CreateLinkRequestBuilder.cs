...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Bundles.Item.ListItem.CreateLink {
    ...
    public class CreateLinkRequestBuilder {
        ...
        public CreateLinkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/bundles/{driveItem_id}/listItem/microsoft.graph.createLink";
