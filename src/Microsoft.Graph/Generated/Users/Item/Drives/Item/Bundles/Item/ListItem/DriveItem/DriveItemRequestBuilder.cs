...
using MicrosoftGraphSdk.Users.Item.Drives.Item.Bundles.Item.ListItem.DriveItem.Content;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Bundles.Item.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/bundles/{driveItem_id}/listItem/driveItem{?select,expand}";
