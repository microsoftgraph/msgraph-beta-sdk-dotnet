...
namespace MicrosoftGraphSdk.Users.Item.Messages.Item.Unsubscribe {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\messages\{message-id}\microsoft.graph.unsubscribe</summary>
    public class UnsubscribeRequestBuilder {
        ...
        public UnsubscribeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/messages/{message_id}/microsoft.graph.unsubscribe";
