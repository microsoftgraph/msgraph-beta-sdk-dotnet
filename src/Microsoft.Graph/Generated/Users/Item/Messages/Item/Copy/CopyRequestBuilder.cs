...
namespace MicrosoftGraphSdk.Users.Item.Messages.Item.Copy {
    ...
    public class CopyRequestBuilder {
        ...
        /// </summary>
        public async Task<Message> PostAsync(CopyRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
