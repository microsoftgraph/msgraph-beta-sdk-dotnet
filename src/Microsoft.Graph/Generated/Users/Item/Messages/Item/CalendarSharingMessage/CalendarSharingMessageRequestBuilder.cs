using Microsoft.Graph.Beta.Users.Item.Messages.Item.CalendarSharingMessage.Accept;
...
namespace Microsoft.Graph.Beta.Users.Item.Messages.Item.CalendarSharingMessage {
    ...
    public class CalendarSharingMessageRequestBuilder {
        ...
        public CalendarSharingMessageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/messages/{message%2Did}/microsoft.graph.calendarSharingMessage";
