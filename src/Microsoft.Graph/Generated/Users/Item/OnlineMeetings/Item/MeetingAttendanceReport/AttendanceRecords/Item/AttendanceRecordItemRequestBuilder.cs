...
namespace MicrosoftGraphSdk.Users.Item.OnlineMeetings.Item.MeetingAttendanceReport.AttendanceRecords.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\onlineMeetings\{onlineMeeting-id}\meetingAttendanceReport\attendanceRecords\{attendanceRecord-id}</summary>
