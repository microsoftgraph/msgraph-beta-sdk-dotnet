...
namespace Microsoft.Graph.Beta.Users.Item.OnlineMeetings.Item.MeetingAttendanceReport.AttendanceRecords.Item {
    ...
    public class AttendanceRecordItemRequestBuilder {
        ...
        public AttendanceRecordItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport/attendanceRecords/{attendanceRecord%2Did}{?%24select,%24expand}";
