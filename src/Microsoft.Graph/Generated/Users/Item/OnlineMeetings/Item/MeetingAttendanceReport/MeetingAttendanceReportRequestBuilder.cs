...
using MicrosoftGraphSdk.Users.Item.OnlineMeetings.Item.MeetingAttendanceReport.AttendanceRecords;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.OnlineMeetings.Item.MeetingAttendanceReport {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\onlineMeetings\{onlineMeeting-id}\meetingAttendanceReport</summary>
    public class MeetingAttendanceReportRequestBuilder {
        ...
        public MeetingAttendanceReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/onlineMeetings/{onlineMeeting_id}/meetingAttendanceReport{?select,expand}";
        ...
        /// <summary>Get meetingAttendanceReport from users</summary>
