...
namespace Microsoft.Graph.Beta.Users.Item.OnlineMeetings.Item.VirtualAppointment {
    ...
    public class VirtualAppointmentRequestBuilder {
        ...
        public VirtualAppointmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/virtualAppointment{?%24select,%24expand}";
        ...
        /// <summary>Get virtualAppointment from users</summary>
