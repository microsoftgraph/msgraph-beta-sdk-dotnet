...
namespace Microsoft.Graph.Beta.Users.Item.OnlineMeetings.Item.Registration.CustomQuestions.Item {
    ...
    public class MeetingRegistrationQuestionItemRequestBuilder : BaseRequestBuilder {
        ...
        public MeetingRegistrationQuestionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/registration/customQuestions/{meetingRegistrationQuestion%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MeetingRegistrationQuestionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MeetingRegistrationQuestionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/registration/customQuestions/{meetingRegistrationQuestion%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<MeetingRegistrationQuestionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<MeetingRegistrationQuestionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MeetingRegistrationQuestion?> GetAsync(CancellationToken cancellationToken = default, Action<MeetingRegistrationQuestionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MeetingRegistrationQuestion> GetAsync(CancellationToken cancellationToken = default, Action<MeetingRegistrationQuestionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MeetingRegistrationQuestion?> PatchAsync(MeetingRegistrationQuestion body, CancellationToken cancellationToken = default, Action<MeetingRegistrationQuestionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MeetingRegistrationQuestion> PatchAsync(MeetingRegistrationQuestion body, CancellationToken cancellationToken = default, Action<MeetingRegistrationQuestionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
