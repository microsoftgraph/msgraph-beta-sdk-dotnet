...
namespace Microsoft.Graph.Beta.Users.Item.OnlineMeetings.Item.Registration {
    ...
    public class RegistrationRequestBuilder : BaseRequestBuilder {
        ...
        public RegistrationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/registration{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RegistrationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RegistrationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/registration{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
