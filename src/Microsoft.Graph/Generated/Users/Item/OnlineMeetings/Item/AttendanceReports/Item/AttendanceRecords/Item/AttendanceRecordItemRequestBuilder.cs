...
namespace Microsoft.Graph.Beta.Users.Item.OnlineMeetings.Item.AttendanceReports.Item.AttendanceRecords.Item {
    ...
    public class AttendanceRecordItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AttendanceRecordItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AttendanceRecord> GetAsync(CancellationToken cancellationToken = default, Action<AttendanceRecordItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AttendanceRecord body, CancellationToken cancellationToken = default, Action<AttendanceRecordItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
