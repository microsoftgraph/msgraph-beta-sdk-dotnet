...
namespace Microsoft.Graph.Beta.Users.Item.OnlineMeetings.Item.AttendanceReports.Item.AttendanceRecords.Item {
    ...
    public class AttendanceRecordItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AttendanceRecord body, Action<AttendanceRecordItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
