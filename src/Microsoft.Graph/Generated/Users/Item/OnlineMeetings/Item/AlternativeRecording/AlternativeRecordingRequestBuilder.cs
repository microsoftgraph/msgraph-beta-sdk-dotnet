...
namespace MicrosoftGraph.Users.Item.OnlineMeetings.Item.AlternativeRecording {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\onlineMeetings\{onlineMeeting-id}\alternativeRecording</summary>
    public class AlternativeRecordingRequestBuilder {
        ...
        public AlternativeRecordingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/onlineMeetings/{onlineMeeting_id}/alternativeRecording";
