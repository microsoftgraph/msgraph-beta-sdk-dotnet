...
namespace MicrosoftGraphSdk.Users.Item.Presence.ClearUserPreferredPresence {
    ...
    public class ClearUserPreferredPresenceRequestBuilder {
        ...
        public ClearUserPreferredPresenceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/presence/microsoft.graph.clearUserPreferredPresence";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ClearUserPreferredPresenceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
