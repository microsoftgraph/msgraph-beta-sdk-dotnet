...
namespace Microsoft.Graph.Beta.Users.Item.Presence.ClearUserPreferredPresence {
    ...
    public class ClearUserPreferredPresenceRequestBuilder {
        ...
        public ClearUserPreferredPresenceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/presence/microsoft.graph.clearUserPreferredPresence";
        ...
        /// </summary>
        public async Task PostAsync(Action<ClearUserPreferredPresenceRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
