...
namespace Microsoft.Graph.Beta.Users.Item.Presence.ClearUserPreferredPresence {
    ...
    public class ClearUserPreferredPresenceRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<ClearUserPreferredPresenceRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
