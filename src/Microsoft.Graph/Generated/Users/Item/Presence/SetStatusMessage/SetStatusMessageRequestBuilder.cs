...
namespace Microsoft.Graph.Beta.Users.Item.Presence.SetStatusMessage {
    /// <summary>
    /// Provides operations to call the setStatusMessage method.
    /// </summary>
    public class SetStatusMessageRequestBuilder {
        ...
        public SetStatusMessageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SetStatusMessageRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreatePostRequestInformation(SetStatusMessagePostRequestBody body, Action<SetStatusMessageRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
