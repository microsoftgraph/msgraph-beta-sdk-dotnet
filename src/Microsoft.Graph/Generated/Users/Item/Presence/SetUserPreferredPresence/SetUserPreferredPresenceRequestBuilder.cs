...
namespace MicrosoftGraph.Users.Item.Presence.SetUserPreferredPresence {
    ...
    public class SetUserPreferredPresenceRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SetUserPreferredPresenceRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// </summary>
        public async Task PostAsync(SetUserPreferredPresenceRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
