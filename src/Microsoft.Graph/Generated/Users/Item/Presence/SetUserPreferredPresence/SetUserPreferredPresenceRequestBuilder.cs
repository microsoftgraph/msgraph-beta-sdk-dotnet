...
namespace MicrosoftGraphSdk.Users.Item.Presence.SetUserPreferredPresence {
    ...
    public class SetUserPreferredPresenceRequestBuilder {
        ...
        public SetUserPreferredPresenceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/presence/microsoft.graph.setUserPreferredPresence";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SetUserPreferredPresenceRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// </summary>
        public async Task PostAsync(SetUserPreferredPresenceRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
