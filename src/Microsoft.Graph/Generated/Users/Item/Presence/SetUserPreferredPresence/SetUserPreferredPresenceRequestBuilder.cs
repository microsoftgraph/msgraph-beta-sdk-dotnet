...
namespace Microsoft.Graph.Beta.Users.Item.Presence.SetUserPreferredPresence {
    ...
    public class SetUserPreferredPresenceRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SetUserPreferredPresenceRequestBody body, Action<SetUserPreferredPresenceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(SetUserPreferredPresenceRequestBody body, Action<SetUserPreferredPresenceRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
