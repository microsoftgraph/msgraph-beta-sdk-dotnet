...
#nullable enable
        public async Task<GetMailTipsResponse?> PostAsync(GetMailTipsPostRequestBody body, CancellationToken cancellationToken = default, Action<GetMailTipsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetMailTipsResponse> PostAsync(GetMailTipsPostRequestBody body, CancellationToken cancellationToken = default, Action<GetMailTipsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
