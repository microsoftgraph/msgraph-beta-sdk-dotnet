...
using Microsoft.Graph.Beta.Users.Item.OwnedDevices.GraphDevice.Count;
...
namespace Microsoft.Graph.Beta.Users.Item.OwnedDevices.GraphDevice {
    /// <summary>
    ...
    public class GraphDeviceRequestBuilder {
        ...
        public GraphDeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/ownedDevices/graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
