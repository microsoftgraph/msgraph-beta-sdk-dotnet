...
namespace Microsoft.Graph.Beta.Users.Item.OwnedDevices.MicrosoftGraphEndpoint.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/ownedDevices/microsoft.graph.endpoint/$count{?%24search,%24filter}";
