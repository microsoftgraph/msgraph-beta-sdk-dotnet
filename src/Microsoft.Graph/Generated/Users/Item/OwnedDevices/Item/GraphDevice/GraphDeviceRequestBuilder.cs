...
namespace Microsoft.Graph.Beta.Users.Item.OwnedDevices.Item.GraphDevice {
    /// <summary>
    ...
    public class GraphDeviceRequestBuilder {
        ...
        public GraphDeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/ownedDevices/{directoryObject%2Did}/graph.device{?%24select,%24expand}";
