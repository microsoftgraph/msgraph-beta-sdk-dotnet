...
namespace Microsoft.Graph.Beta.Users.Item.OwnedDevices {
    ...
    public class OwnedDevicesRequestBuilder {
        ...
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<OwnedDevicesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
