...
namespace Microsoft.Graph.Beta.Users.Item.WipeManagedAppRegistrationsByDeviceTag {
    ...
    public class WipeManagedAppRegistrationsByDeviceTagRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(WipeManagedAppRegistrationsByDeviceTagPostRequestBody body, CancellationToken cancellationToken = default, Action<WipeManagedAppRegistrationsByDeviceTagRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
