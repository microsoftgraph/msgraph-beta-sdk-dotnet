...
namespace Microsoft.Graph.Beta.Users.Item.WipeManagedAppRegistrationsByDeviceTag {
    ...
    public class WipeManagedAppRegistrationsByDeviceTagRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(WipeManagedAppRegistrationsByDeviceTagRequestBody body, Action<WipeManagedAppRegistrationsByDeviceTagRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(WipeManagedAppRegistrationsByDeviceTagRequestBody body, Action<WipeManagedAppRegistrationsByDeviceTagRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
