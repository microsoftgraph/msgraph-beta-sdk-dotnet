...
namespace Microsoft.Graph.Beta.Users.Item.Planner.Tasks.Item.AssignedToTaskBoardFormat {
    ...
    public class AssignedToTaskBoardFormatRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AssignedToTaskBoardFormatRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PlannerAssignedToTaskBoardTaskFormat> GetAsync(CancellationToken cancellationToken = default, Action<AssignedToTaskBoardFormatRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(PlannerAssignedToTaskBoardTaskFormat body, CancellationToken cancellationToken = default, Action<AssignedToTaskBoardFormatRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
