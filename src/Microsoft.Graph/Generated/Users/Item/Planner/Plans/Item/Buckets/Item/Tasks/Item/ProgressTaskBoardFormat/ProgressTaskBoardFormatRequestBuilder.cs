...
namespace Microsoft.Graph.Beta.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.ProgressTaskBoardFormat {
    ...
    public class ProgressTaskBoardFormatRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ProgressTaskBoardFormatRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PlannerProgressTaskBoardTaskFormat> GetAsync(CancellationToken cancellationToken = default, Action<ProgressTaskBoardFormatRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(PlannerProgressTaskBoardTaskFormat body, CancellationToken cancellationToken = default, Action<ProgressTaskBoardFormatRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
