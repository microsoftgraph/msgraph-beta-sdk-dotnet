...
using MicrosoftGraph.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks;
using System;
...
namespace MicrosoftGraph.Users.Item.Planner.Plans.Item.Buckets.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\planner\plans\{plannerPlan-id}\buckets\{plannerBucket-id}</summary>
    public class PlannerBucketRequestBuilder {
        ...
        public PlannerBucketRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/planner/plans/{plannerPlan_id}/buckets/{plannerBucket_id}{?select,expand}";
