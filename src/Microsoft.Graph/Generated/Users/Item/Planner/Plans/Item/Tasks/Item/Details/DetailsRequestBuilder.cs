...
namespace Microsoft.Graph.Beta.Users.Item.Planner.Plans.Item.Tasks.Item.Details {
    /// <summary>
    ...
    public class DetailsRequestBuilder {
        ...
        public DetailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/details{?%24select,%24expand}";
