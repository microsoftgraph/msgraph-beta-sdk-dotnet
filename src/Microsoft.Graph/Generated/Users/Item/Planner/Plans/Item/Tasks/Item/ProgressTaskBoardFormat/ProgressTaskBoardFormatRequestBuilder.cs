...
namespace Microsoft.Graph.Beta.Users.Item.Planner.Plans.Item.Tasks.Item.ProgressTaskBoardFormat {
    /// <summary>
    ...
    public class ProgressTaskBoardFormatRequestBuilder {
        ...
        public ProgressTaskBoardFormatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/progressTaskBoardFormat{?%24select,%24expand}";
