...
using Microsoft.Graph.Beta.Users.Item.Planner.Plans.Item.Tasks.Count;
using Microsoft.Graph.Beta.Users.Item.Planner.Plans.Item.Tasks.Delta;
using Microsoft.Graph.Beta.Users.Item.Planner.Plans.Item.Tasks.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.Planner.Plans.Item.Tasks {
    /// <summary>
    ...
    public class TasksRequestBuilder : BaseRequestBuilder {
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TasksRequestBuilder and sets the default values.
        /// </summary>
