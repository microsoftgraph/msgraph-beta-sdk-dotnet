...
using MicrosoftGraph.Users.Item.Planner.Plans.Item.Tasks.Item;
using System;
...
namespace MicrosoftGraph.Users.Item.Planner.Plans.Item.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.users.item.planner.plans.item.tasks.item collection</summary>
