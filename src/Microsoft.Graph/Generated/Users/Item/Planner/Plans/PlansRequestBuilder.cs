...
namespace MicrosoftGraph.Users.Item.Planner.Plans {
    ...
    public class PlansRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.users.item.planner.plans.item collection</summary>
        public PlansRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("plannerPlan_id", position);
            return new PlansRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
