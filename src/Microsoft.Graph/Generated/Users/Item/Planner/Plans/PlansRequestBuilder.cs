...
#nullable enable
        public async Task<PlannerPlanCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<PlansRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlannerPlanCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PlansRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PlannerPlan?> PostAsync(PlannerPlan body, CancellationToken cancellationToken = default, Action<PlansRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlannerPlan> PostAsync(PlannerPlan body, CancellationToken cancellationToken = default, Action<PlansRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
