...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Users.Item.Planner.RecentPlans {
    public class RecentPlansResponse : IParsable {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        public string NextLink { get; set; }
        public List<PlannerPlan> Value { get; set; }
        /// <summary>
        /// Instantiates a new recentPlansResponse and sets the default values.
        /// </summary>
        public RecentPlansResponse() {
