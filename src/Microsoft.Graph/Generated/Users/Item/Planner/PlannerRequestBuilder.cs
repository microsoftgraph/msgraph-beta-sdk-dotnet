...
namespace Microsoft.Graph.Beta.Users.Item.Planner {
    ...
    public class PlannerRequestBuilder : BaseRequestBuilder 
    {
        ...
        {
            get => new FavoritePlansRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new MyDayTasksRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new RecentPlansRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new RosterPlansRequestBuilder(PathParameters, RequestAdapter);
        }
