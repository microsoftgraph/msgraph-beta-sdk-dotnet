...
namespace MicrosoftGraphSdk.Users.Item.ExportDeviceAndAppManagementData {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\microsoft.graph.exportDeviceAndAppManagementData()</summary>
    public class ExportDeviceAndAppManagementDataRequestBuilder {
        ...
        public ExportDeviceAndAppManagementDataRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/microsoft.graph.exportDeviceAndAppManagementData()";
