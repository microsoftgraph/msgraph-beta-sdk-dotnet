...
namespace Microsoft.Graph.Beta.Users.Item.ManagedDevices.Item.RetrieveRemoteHelpSessionWithSessionKey {
    ...
    public class RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder : BaseRequestBuilder {
        ...
        public RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string sessionKey = "") : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/retrieveRemoteHelpSession(sessionKey='{sessionKey}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/retrieveRemoteHelpSession(sessionKey='{sessionKey}')", rawUrl) {
        }
        /// <summary>
