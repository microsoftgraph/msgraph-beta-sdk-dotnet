...
namespace Microsoft.Graph.Beta.Users.Item.ManagedDevices.Item.RetrieveRemoteHelpSessionWithSessionKey {
    ...
    public class RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder {
        ...
        public RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string sessionKey = default) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/microsoft.graph.retrieveRemoteHelpSession(sessionKey='{sessionKey}')";
