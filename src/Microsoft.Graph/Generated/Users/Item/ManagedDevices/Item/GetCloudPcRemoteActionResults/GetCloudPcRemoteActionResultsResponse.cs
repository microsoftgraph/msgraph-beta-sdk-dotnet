...
namespace Microsoft.Graph.Beta.Users.Item.ManagedDevices.Item.GetCloudPcRemoteActionResults {
    ...
    public class GetCloudPcRemoteActionResultsResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static GetCloudPcRemoteActionResultsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetCloudPcRemoteActionResultsResponse).Value = n.GetCollectionOfObjectValues<CloudPcRemoteActionResult>(CloudPcRemoteActionResult.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
