...
namespace Microsoft.Graph.Beta.Users.Item.ManagedDevices.Item.RotateLocalAdminPassword {
    /// <summary>
    ...
    public class RotateLocalAdminPasswordRequestBuilder : BaseRequestBuilder {
        ...
        public RotateLocalAdminPasswordRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/rotateLocalAdminPassword", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RotateLocalAdminPasswordRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RotateLocalAdminPasswordRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/rotateLocalAdminPassword", rawUrl) {
        }
        /// <summary>
