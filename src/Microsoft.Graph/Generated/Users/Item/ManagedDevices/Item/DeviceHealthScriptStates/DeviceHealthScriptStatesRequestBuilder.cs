...
namespace Microsoft.Graph.Beta.Users.Item.ManagedDevices.Item.DeviceHealthScriptStates {
    ...
    public class DeviceHealthScriptStatesRequestBuilder {
        ...
        public DeviceHealthScriptStatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deviceHealthScriptStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
