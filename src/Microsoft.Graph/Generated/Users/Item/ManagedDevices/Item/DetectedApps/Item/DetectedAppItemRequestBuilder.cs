...
namespace Microsoft.Graph.Beta.Users.Item.ManagedDevices.Item.DetectedApps.Item {
    ...
    public class DetectedAppItemRequestBuilder : BaseRequestBuilder {
        ...
        public DetectedAppItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/detectedApps/{detectedApp%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DetectedAppItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DetectedAppItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/detectedApps/{detectedApp%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DetectedApp?> GetAsync(CancellationToken cancellationToken = default, Action<DetectedAppItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DetectedApp> GetAsync(CancellationToken cancellationToken = default, Action<DetectedAppItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
