...
namespace Microsoft.Graph.Beta.Users.Item.ManagedDevices.Item.Reenable {
    ...
    public class ReenableRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<ReenableRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
