...
using MicrosoftGraphSdk.Users.Item.ManagedDevices.Item.AssignmentFilterEvaluationStatusDetails.Count;
using MicrosoftGraphSdk.Users.Item.ManagedDevices.Item.AssignmentFilterEvaluationStatusDetails.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.ManagedDevices.Item.AssignmentFilterEvaluationStatusDetails {
    ...
    public class AssignmentFilterEvaluationStatusDetailsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.managedDevices.item.assignmentFilterEvaluationStatusDetails.item collection</summary>
        ...
        public AssignmentFilterEvaluationStatusDetailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/managedDevices/{managedDevice_id}/assignmentFilterEvaluationStatusDetails{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.AssignmentFilterEvaluationStatusDetails body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftGraphSdk.Models.Microsoft.Graph.AssignmentFilterEvaluationStatusDetails> PostAsync(MicrosoftGraphSdk.Models.Microsoft.Graph.AssignmentFilterEvaluationStatusDetails body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
