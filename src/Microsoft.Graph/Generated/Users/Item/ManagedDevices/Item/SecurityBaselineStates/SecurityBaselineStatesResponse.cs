...
namespace MicrosoftGraphSdk.Users.Item.ManagedDevices.Item.SecurityBaselineStates {
    public class SecurityBaselineStatesResponse : IParsable {
        ...
        /// </summary>
        public static SecurityBaselineStatesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SecurityBaselineStatesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as SecurityBaselineStatesResponse).Value = n.GetCollectionOfObjectValues<SecurityBaselineState>(SecurityBaselineState.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
