...
namespace Microsoft.Graph.Beta.Users.Item.ManagedDevices.Item.SecurityBaselineStates.Item {
    ...
    public class SecurityBaselineStateItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SecurityBaselineState body, Action<SecurityBaselineStateItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
