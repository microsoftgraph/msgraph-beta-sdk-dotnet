...
namespace MicrosoftGraphSdk.Users.Item.ManagedDevices.Item.SecurityBaselineStates.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\managedDevices\{managedDevice-id}\securityBaselineStates\{securityBaselineState-id}</summary>
