...
namespace Microsoft.Graph.Beta.Users.Item.ManagedDevices.Item.GetFileVaultKey {
    ...
    public class GetFileVaultKeyRequestBuilder : BaseRequestBuilder {
        ...
        public GetFileVaultKeyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/getFileVaultKey()", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetFileVaultKeyRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetFileVaultKeyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/getFileVaultKey()", rawUrl) {
        }
        /// <summary>
