...
namespace Microsoft.Graph.Beta.Users.Item.ManagedDevices.Item.Users {
    ...
    public class UsersRequestBuilder {
        ...
        /// </summary>
        public async Task<UserCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UsersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
