...
using System;
namespace Microsoft.Graph.Beta.Users.Item.ManagedDevices.Item.InitiateMobileDeviceManagementKeyRecovery {
    /// <summary>
    ...
    public class InitiateMobileDeviceManagementKeyRecoveryRequestBuilder : BaseRequestBuilder {
        ...
        public InitiateMobileDeviceManagementKeyRecoveryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/initiateMobileDeviceManagementKeyRecovery", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new InitiateMobileDeviceManagementKeyRecoveryRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InitiateMobileDeviceManagementKeyRecoveryRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/initiateMobileDeviceManagementKeyRecovery", rawUrl) {
        }
        /// <summary>
