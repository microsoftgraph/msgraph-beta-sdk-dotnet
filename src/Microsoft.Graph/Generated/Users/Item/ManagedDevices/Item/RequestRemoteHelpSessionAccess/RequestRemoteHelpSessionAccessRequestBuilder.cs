...
namespace Microsoft.Graph.Beta.Users.Item.ManagedDevices.Item.RequestRemoteHelpSessionAccess {
    ...
    public class RequestRemoteHelpSessionAccessRequestBuilder : BaseRequestBuilder {
        ...
        public RequestRemoteHelpSessionAccessRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/requestRemoteHelpSessionAccess", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RequestRemoteHelpSessionAccessRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RequestRemoteHelpSessionAccessRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/requestRemoteHelpSessionAccess", rawUrl) {
        }
        /// <summary>
