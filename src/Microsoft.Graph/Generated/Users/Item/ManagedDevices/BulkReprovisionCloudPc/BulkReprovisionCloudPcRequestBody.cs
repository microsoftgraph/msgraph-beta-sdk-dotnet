...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Users.Item.ManagedDevices.BulkReprovisionCloudPc {
    /// <summary>Provides operations to call the bulkReprovisionCloudPc method.</summary>
    public class BulkReprovisionCloudPcRequestBody : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static BulkReprovisionCloudPcRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
