...
namespace Microsoft.Graph.Beta.Users.Item.ManagedDevices.BulkReprovisionCloudPc {
    ...
    public class BulkReprovisionCloudPcRequestBuilder : BaseRequestBuilder {
        ...
        public BulkReprovisionCloudPcRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/bulkReprovisionCloudPc", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new BulkReprovisionCloudPcRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BulkReprovisionCloudPcRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/bulkReprovisionCloudPc", rawUrl) {
        }
        /// <summary>
