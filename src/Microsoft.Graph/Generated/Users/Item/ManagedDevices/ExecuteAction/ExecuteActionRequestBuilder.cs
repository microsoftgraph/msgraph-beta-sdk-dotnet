...
namespace MicrosoftGraphSdk.Users.Item.ManagedDevices.ExecuteAction {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\managedDevices\microsoft.graph.executeAction</summary>
    public class ExecuteActionRequestBuilder {
        ...
        public ExecuteActionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/managedDevices/microsoft.graph.executeAction";
