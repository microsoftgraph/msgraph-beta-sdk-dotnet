...
using MicrosoftGraphSdk.Users.Item.TransitiveReports.Count;
using MicrosoftGraphSdk.Users.Item.TransitiveReports.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.TransitiveReports {
    ...
    public class TransitiveReportsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.transitiveReports.item collection</summary>
        ...
        public TransitiveReportsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/transitiveReports{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
