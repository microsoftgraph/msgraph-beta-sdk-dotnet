...
using System;
namespace Microsoft.Graph.Beta.Users.Item.WipeManagedAppRegistrationByDeviceTag {
    /// <summary>
    ...
    public class WipeManagedAppRegistrationByDeviceTagRequestBuilder : BaseRequestBuilder {
        ...
        public WipeManagedAppRegistrationByDeviceTagRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/wipeManagedAppRegistrationByDeviceTag", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WipeManagedAppRegistrationByDeviceTagRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WipeManagedAppRegistrationByDeviceTagRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/wipeManagedAppRegistrationByDeviceTag", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(WipeManagedAppRegistrationByDeviceTagPostRequestBody body, CancellationToken cancellationToken = default, Action<WipeManagedAppRegistrationByDeviceTagRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(WipeManagedAppRegistrationByDeviceTagPostRequestBody body, CancellationToken cancellationToken = default, Action<WipeManagedAppRegistrationByDeviceTagRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
