...
using Microsoft.Graph.Beta.Users.Item.JoinedTeams.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedTeams.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedTeams {
    ...
    public class JoinedTeamsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedTeams.item collection</summary>
        ...
        public JoinedTeamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public async Task<TeamCollectionResponse> GetAsync(Action<JoinedTeamsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
