...
namespace MicrosoftGraph.Users.Item.GetManagedAppDiagnosticStatuses {
    ...
    public class GetManagedAppDiagnosticStatusesRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<MicrosoftGraph.Users.Item.GetManagedAppDiagnosticStatuses.GetManagedAppDiagnosticStatuses>> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await RequestAdapter.SendCollectionAsync<MicrosoftGraph.Users.Item.GetManagedAppDiagnosticStatuses.GetManagedAppDiagnosticStatuses>(requestInfo, responseHandler, default, cancellationToken);
        }
    }
}
