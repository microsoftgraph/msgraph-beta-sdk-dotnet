...
namespace Microsoft.Graph.Beta.Users.Item.GetManagedAppDiagnosticStatuses {
    ...
    public class GetManagedAppDiagnosticStatusesRequestBuilder : BaseRequestBuilder {
        ...
        public GetManagedAppDiagnosticStatusesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/getManagedAppDiagnosticStatuses(){?%24top,%24skip,%24search,%24filter,%24count}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetManagedAppDiagnosticStatusesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetManagedAppDiagnosticStatusesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/getManagedAppDiagnosticStatuses(){?%24top,%24skip,%24search,%24filter,%24count}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<GetManagedAppDiagnosticStatusesResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetManagedAppDiagnosticStatusesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetManagedAppDiagnosticStatusesResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetManagedAppDiagnosticStatusesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
