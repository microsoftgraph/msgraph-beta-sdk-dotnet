...
namespace Microsoft.Graph.Beta.Users.Item.GetManagedAppDiagnosticStatuses {
    ...
    public class GetManagedAppDiagnosticStatusesRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetManagedAppDiagnosticStatusesGetResponse"></returns>
...
#nullable restore
        ...
        /// Gets diagnostics validation status for a given user.
        /// </summary>
        /// <returns>A <cref="GetManagedAppDiagnosticStatusesResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetManagedAppDiagnosticStatusesRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
