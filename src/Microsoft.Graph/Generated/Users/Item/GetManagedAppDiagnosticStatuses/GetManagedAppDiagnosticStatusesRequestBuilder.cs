...
namespace Microsoft.Graph.Beta.Users.Item.GetManagedAppDiagnosticStatuses {
    ...
    public class GetManagedAppDiagnosticStatusesRequestBuilder {
        ...
        public GetManagedAppDiagnosticStatusesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/microsoft.graph.getManagedAppDiagnosticStatuses()";
        ...
        /// </summary>
        public async Task<GetManagedAppDiagnosticStatusesResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetManagedAppDiagnosticStatusesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
