...
namespace MicrosoftGraphSdk.Users.Item.ContactFolders.Item.Contacts.Item.MultiValueExtendedProperties.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\contactFolders\{contactFolder-id}\contacts\{contact-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}</summary>
