...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Users.Item.ContactFolders.Item.ChildFolders {
    public class ChildFoldersResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ChildFoldersResponse).Value = n.GetCollectionOfObjectValues<ContactFolder>().ToList(); } },
            };
        }
        /// <summary>
