...
namespace Microsoft.Graph.Beta.Users.Item.ContactFolders.Item.ChildFolders.Item.Contacts {
    ...
    public class ContactsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.contactFolders.item.childFolders.item.contacts.item collection</summary>
        ...
        /// <summary>Get all the contacts in the signed-in user&apos;s mailbox (.../me/contacts), or from the specified contact folder.</summary>
