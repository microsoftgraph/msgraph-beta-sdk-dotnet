...
using MicrosoftGraphSdk.Users.Item.ContactFolders.Item.ChildFolders.Item.Contacts.Count;
using MicrosoftGraphSdk.Users.Item.ContactFolders.Item.ChildFolders.Item.Contacts.Delta;
using MicrosoftGraphSdk.Users.Item.ContactFolders.Item.ChildFolders.Item.Contacts.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.ContactFolders.Item.ChildFolders.Item.Contacts {
    ...
    public class ContactsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.contactFolders.item.childFolders.item.contacts.item collection</summary>
        ...
        /// </summary>
        public async Task<ContactCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
