...
namespace Microsoft.Graph.Beta.Users.Item.ContactFolders.Item.ChildFolders.Item.Contacts.Item.MultiValueExtendedProperties.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/childFolders/{contactFolder%2Did1}/contacts/{contact%2Did}/multiValueExtendedProperties/$count{?%24search,%24filter}";
