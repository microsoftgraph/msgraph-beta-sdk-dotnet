...
using Microsoft.Graph.Beta.Users.Item.ContactFolders.Count;
using Microsoft.Graph.Beta.Users.Item.ContactFolders.Delta;
using Microsoft.Graph.Beta.Users.Item.ContactFolders.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.ContactFolders {
    ...
    public class ContactFoldersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.contactFolders.item collection</summary>
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ContactFolder body, Action<ContactFoldersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<ContactFolderCollectionResponse> GetAsync(Action<ContactFoldersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ContactFolder> PostAsync(ContactFolder body, Action<ContactFoldersRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
        ...
        /// <summary>Get all the contact folders in the signed-in user&apos;s mailbox.</summary>
