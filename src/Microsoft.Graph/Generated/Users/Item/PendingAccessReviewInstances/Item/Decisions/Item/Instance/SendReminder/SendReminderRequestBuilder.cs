...
namespace Microsoft.Graph.Beta.Users.Item.PendingAccessReviewInstances.Item.Decisions.Item.Instance.SendReminder {
    ...
    public class SendReminderRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>
        /// Send a reminder to the reviewers of a currently active accessReviewInstance. This API is supported in the following national cloud deployments.
...
#nullable restore
        ...
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public SendReminderRequestBuilder WithUrl(string rawUrl) {
