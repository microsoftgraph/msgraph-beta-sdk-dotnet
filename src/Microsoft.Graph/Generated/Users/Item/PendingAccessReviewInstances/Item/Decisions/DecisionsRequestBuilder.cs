...
namespace MicrosoftGraphSdk.Users.Item.PendingAccessReviewInstances.Item.Decisions {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\pendingAccessReviewInstances\{accessReviewInstance-id}\decisions</summary>
    public class DecisionsRequestBuilder {
        ...
        /// <summary>
        /// Builds and executes requests for operations under \users\{user-id}\pendingAccessReviewInstances\{accessReviewInstance-id}\decisions\microsoft.graph.filterByCurrentUser(on={on})
