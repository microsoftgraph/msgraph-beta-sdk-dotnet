...
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.Stages.Item.Decisions.Item.Insights;
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.Stages.Item.Decisions.Item.Instance;
using System;
...
namespace MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.Stages.Item.Decisions.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\pendingAccessReviewInstances\{accessReviewInstance-id}\stages\{accessReviewStage-id}\decisions\{accessReviewInstanceDecisionItem-id}</summary>
    public class AccessReviewInstanceDecisionItemRequestBuilder {
        ...
        public AccessReviewInstanceDecisionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/pendingAccessReviewInstances/{accessReviewInstance_id}/stages/{accessReviewStage_id}/decisions/{accessReviewInstanceDecisionItem_id}{?select,expand}";
