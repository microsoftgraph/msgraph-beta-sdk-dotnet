...
using System;
namespace Microsoft.Graph.Beta.Users.Item.PendingAccessReviewInstances.Item.Stages.Item.Decisions.Item.Instance.Decisions.RecordAllDecisions {
    /// <summary>
    ...
    public class RecordAllDecisionsRequestBuilder : BaseRequestBuilder {
        ...
        public RecordAllDecisionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/decisions/recordAllDecisions", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RecordAllDecisionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecordAllDecisionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/decisions/recordAllDecisions", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(RecordAllDecisionsPostRequestBody body, CancellationToken cancellationToken = default, Action<RecordAllDecisionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(RecordAllDecisionsPostRequestBody body, CancellationToken cancellationToken = default, Action<RecordAllDecisionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
