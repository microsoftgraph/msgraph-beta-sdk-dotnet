...
namespace MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.Stages {
    ...
    public class StagesRequestBuilder {
        ...
        /// <summary>
        /// Builds and executes requests for operations under \users\{user-id}\pendingAccessReviewInstances\{accessReviewInstance-id}\stages\microsoft.graph.filterByCurrentUser(on={on})
