...
namespace Microsoft.Graph.Beta.Users.Item.PendingAccessReviewInstances.Item.Stages.FilterByCurrentUserWithOn {
    ...
    public class FilterByCurrentUserWithOnRequestBuilder {
        ...
        public FilterByCurrentUserWithOnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string on = default) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/microsoft.graph.filterByCurrentUser(on='{on}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
