...
using MicrosoftGraphSdk.Users.Item.PendingAccessReviewInstances.Item.Stages.Item.Decisions.FilterByCurrentUserWithOn;
using MicrosoftGraphSdk.Users.Item.PendingAccessReviewInstances.Item.Stages.Item.Decisions.Item;
using MicrosoftGraphSdk.Users.Item.PendingAccessReviewInstances.Item.Stages.Item.Decisions.RecordAllDecisions;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.PendingAccessReviewInstances.Item.Stages.Item.Decisions {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\pendingAccessReviewInstances\{accessReviewInstance-id}\stages\{accessReviewStage-id}\decisions</summary>
    public class DecisionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.pendingAccessReviewInstances.item.stages.item.decisions.item collection</summary>
        ...
        public DecisionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/pendingAccessReviewInstances/{accessReviewInstance_id}/stages/{accessReviewStage_id}/decisions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>
        /// Builds and executes requests for operations under \users\{user-id}\pendingAccessReviewInstances\{accessReviewInstance-id}\stages\{accessReviewStage-id}\decisions\microsoft.graph.filterByCurrentUser(on={on})
