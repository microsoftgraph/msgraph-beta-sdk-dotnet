...
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.Stages.Item.Decisions.FilterByCurrentUserWithOn;
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.Stages.Item.Decisions.Item;
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.Stages.Item.Decisions.RecordAllDecisions;
using System;
...
namespace MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.Stages.Item.Decisions {
    ...
    public class DecisionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.users.item.pendingAccessReviewInstances.item.stages.item.decisions.item collection</summary>
