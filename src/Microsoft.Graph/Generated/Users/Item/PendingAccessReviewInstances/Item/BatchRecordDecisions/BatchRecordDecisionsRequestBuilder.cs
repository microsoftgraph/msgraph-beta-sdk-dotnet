...
namespace Microsoft.Graph.Beta.Users.Item.PendingAccessReviewInstances.Item.BatchRecordDecisions {
    ...
    public class BatchRecordDecisionsRequestBuilder : BaseRequestBuilder {
        ...
        public BatchRecordDecisionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/batchRecordDecisions", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new BatchRecordDecisionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BatchRecordDecisionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/batchRecordDecisions", rawUrl) {
        }
        /// <summary>
