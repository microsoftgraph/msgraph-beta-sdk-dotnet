...
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.AcceptRecommendations;
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.ApplyDecisions;
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.BatchRecordDecisions;
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.ContactedReviewers;
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.Decisions;
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.Definition;
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.ResetDecisions;
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.SendReminder;
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.Stages;
using MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item.Stop;
using System;
...
namespace MicrosoftGraph.Users.Item.PendingAccessReviewInstances.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\pendingAccessReviewInstances\{accessReviewInstance-id}</summary>
    public class AccessReviewInstanceRequestBuilder {
        ...
        public AccessReviewInstanceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/pendingAccessReviewInstances/{accessReviewInstance_id}{?select,expand}";
