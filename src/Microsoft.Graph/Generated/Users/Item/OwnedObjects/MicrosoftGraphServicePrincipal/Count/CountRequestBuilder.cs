...
namespace Microsoft.Graph.Beta.Users.Item.OwnedObjects.MicrosoftGraphServicePrincipal.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/ownedObjects/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}";
