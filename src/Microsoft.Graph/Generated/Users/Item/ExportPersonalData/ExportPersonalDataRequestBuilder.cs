...
namespace Microsoft.Graph.Beta.Users.Item.ExportPersonalData {
    ...
    public class ExportPersonalDataRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ExportPersonalDataRequestBody body, Action<ExportPersonalDataRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(ExportPersonalDataRequestBody body, Action<ExportPersonalDataRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
