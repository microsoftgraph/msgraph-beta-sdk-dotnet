...
namespace Microsoft.Graph.Beta.Users.Item.ExportPersonalData {
    ...
    public class ExportPersonalDataRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ExportPersonalDataPostRequestBody body, CancellationToken cancellationToken = default, Action<ExportPersonalDataRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
