...
using MicrosoftGraphSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Count;
using MicrosoftGraphSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods {
    ...
    public class MicrosoftAuthenticatorMethodsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.authentication.microsoftAuthenticatorMethods.item collection</summary>
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftAuthenticatorAuthenticationMethod body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// </summary>
        public async Task<MicrosoftAuthenticatorAuthenticationMethodCollectionResponse> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(queryParameters, headers, options);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<MicrosoftAuthenticatorAuthenticationMethodCollectionResponse>(requestInfo, MicrosoftAuthenticatorAuthenticationMethodCollectionResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to microsoftAuthenticatorMethods for users
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftAuthenticatorAuthenticationMethod> PostAsync(MicrosoftAuthenticatorAuthenticationMethod body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
