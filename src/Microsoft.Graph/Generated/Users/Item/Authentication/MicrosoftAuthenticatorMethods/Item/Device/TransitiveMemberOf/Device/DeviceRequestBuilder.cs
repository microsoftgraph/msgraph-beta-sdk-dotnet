...
namespace Microsoft.Graph.Beta.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DeviceRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
