...
using MicrosoftGraphSdk.Users.Item.Authentication.EmailMethods;
using MicrosoftGraphSdk.Users.Item.Authentication.Fido2Methods;
using MicrosoftGraphSdk.Users.Item.Authentication.Methods;
using MicrosoftGraphSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods;
using MicrosoftGraphSdk.Users.Item.Authentication.Operations;
using MicrosoftGraphSdk.Users.Item.Authentication.PasswordlessMicrosoftAuthenticatorMethods;
using MicrosoftGraphSdk.Users.Item.Authentication.PasswordMethods;
using MicrosoftGraphSdk.Users.Item.Authentication.PhoneMethods;
using MicrosoftGraphSdk.Users.Item.Authentication.SoftwareOathMethods;
using MicrosoftGraphSdk.Users.Item.Authentication.TemporaryAccessPassMethods;
using MicrosoftGraphSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Authentication {
    ...
    public class AuthenticationRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.Authentication body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MicrosoftGraphSdk.Models.Microsoft.Graph.Authentication body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
