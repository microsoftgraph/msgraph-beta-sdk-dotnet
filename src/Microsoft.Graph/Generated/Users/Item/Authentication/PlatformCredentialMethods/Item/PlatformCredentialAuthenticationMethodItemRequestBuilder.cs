...
namespace Microsoft.Graph.Beta.Users.Item.Authentication.PlatformCredentialMethods.Item {
    ...
    public class PlatformCredentialAuthenticationMethodItemRequestBuilder : BaseRequestBuilder {
        ...
        public PlatformCredentialAuthenticationMethodItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/platformCredentialMethods/{platformCredentialAuthenticationMethod%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PlatformCredentialAuthenticationMethodItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PlatformCredentialAuthenticationMethodItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/platformCredentialMethods/{platformCredentialAuthenticationMethod%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class PlatformCredentialAuthenticationMethodItemRequestBuilderGetRequestConfiguration : RequestConfiguration<PlatformCredentialAuthenticationMethodItemRequestBuilderGetQueryParameters> {
        }
    }
}
