...
namespace Microsoft.Graph.Beta.Users.Item.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.ServicePrincipal {
    ...
    public class ServicePrincipalRequestBuilder {
        ...
        /// </summary>
        public async Task<ServicePrincipalCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
