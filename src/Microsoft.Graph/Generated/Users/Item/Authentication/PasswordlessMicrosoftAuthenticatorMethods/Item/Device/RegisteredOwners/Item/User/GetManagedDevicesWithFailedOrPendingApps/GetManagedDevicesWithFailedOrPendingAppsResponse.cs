...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Users.Item.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.GetManagedDevicesWithFailedOrPendingApps {
    /// <summary>Provides operations to call the getManagedDevicesWithFailedOrPendingApps method.</summary>
    public class GetManagedDevicesWithFailedOrPendingAppsResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ManagedDeviceSummarizedAppState> Value {
            get { return BackingStore?.Get<List<ManagedDeviceSummarizedAppState>>(nameof(Value)); }
