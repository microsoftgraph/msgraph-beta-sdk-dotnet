...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Users.Item.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.FindRoomsWithRoomList {
    /// <summary>Provides operations to call the findRooms method.</summary>
    public class FindRoomsWithRoomListResponse : IAdditionalDataHolder, IBackedModel, IParsable {
