...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Users.Item.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Item.User.GetEffectiveDeviceEnrollmentConfigurations {
    /// <summary>Provides operations to call the getEffectiveDeviceEnrollmentConfigurations method.</summary>
    public class GetEffectiveDeviceEnrollmentConfigurationsResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceEnrollmentConfiguration> Value {
            get { return BackingStore?.Get<List<DeviceEnrollmentConfiguration>>(nameof(Value)); }
