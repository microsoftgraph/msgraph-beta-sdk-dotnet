...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Users.Item.Authentication.PasswordlessMicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetManagedAppPolicies {
    /// <summary>Provides operations to call the getManagedAppPolicies method.</summary>
    public class GetManagedAppPoliciesResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ManagedAppPolicy> Value {
            get { return BackingStore?.Get<List<ManagedAppPolicy>>(nameof(Value)); }
