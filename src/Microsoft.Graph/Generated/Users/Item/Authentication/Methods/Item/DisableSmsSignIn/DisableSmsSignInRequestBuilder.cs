...
namespace Microsoft.Graph.Beta.Users.Item.Authentication.Methods.Item.DisableSmsSignIn {
    ...
    public class DisableSmsSignInRequestBuilder : BaseRequestBuilder {
        ...
        public DisableSmsSignInRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/methods/{authenticationMethod%2Did}/disableSmsSignIn", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DisableSmsSignInRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DisableSmsSignInRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/methods/{authenticationMethod%2Did}/disableSmsSignIn", rawUrl) {
        }
        /// <summary>
