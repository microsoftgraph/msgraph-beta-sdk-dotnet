...
namespace Microsoft.Graph.Beta.Users.Item.Authentication.Methods.Item.MicrosoftGraphDisableSmsSignIn {
    /// <summary>
    ...
    public class MicrosoftGraphDisableSmsSignInRequestBuilder {
        ...
        public MicrosoftGraphDisableSmsSignInRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/authentication/methods/{authenticationMethod%2Did}/microsoft.graph.disableSmsSignIn";
