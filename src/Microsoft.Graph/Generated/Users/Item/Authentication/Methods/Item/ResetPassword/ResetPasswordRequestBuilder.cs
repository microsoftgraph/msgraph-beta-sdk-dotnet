...
namespace Microsoft.Graph.Beta.Users.Item.Authentication.Methods.Item.ResetPassword {
    ...
    public class ResetPasswordRequestBuilder {
        ...
        /// </summary>
        public async Task<PasswordResetResponse> PostAsync(ResetPasswordPostRequestBody body, Action<ResetPasswordRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<PasswordResetResponse>(requestInfo, PasswordResetResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
