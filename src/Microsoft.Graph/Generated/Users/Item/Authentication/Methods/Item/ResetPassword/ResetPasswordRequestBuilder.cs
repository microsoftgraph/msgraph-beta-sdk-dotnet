...
namespace Microsoft.Graph.Beta.Users.Item.Authentication.Methods.Item.ResetPassword {
    ...
    public class ResetPasswordRequestBuilder {
        ...
        /// </summary>
        public async Task<PasswordResetResponse> PostAsync(ResetPasswordPostRequestBody body, CancellationToken cancellationToken = default, Action<ResetPasswordRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
