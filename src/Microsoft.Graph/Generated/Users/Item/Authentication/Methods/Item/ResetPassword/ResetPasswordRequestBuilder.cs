...
#nullable enable
        public async Task<PasswordResetResponse?> PostAsync(ResetPasswordPostRequestBody body, CancellationToken cancellationToken = default, Action<ResetPasswordRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PasswordResetResponse> PostAsync(ResetPasswordPostRequestBody body, CancellationToken cancellationToken = default, Action<ResetPasswordRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
