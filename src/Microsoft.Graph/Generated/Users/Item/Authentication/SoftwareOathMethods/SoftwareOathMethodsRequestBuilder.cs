...
using MicrosoftGraph.Users.Item.Authentication.SoftwareOathMethods.Item;
using System;
...
namespace MicrosoftGraph.Users.Item.Authentication.SoftwareOathMethods {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\authentication\softwareOathMethods</summary>
    public class SoftwareOathMethodsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.users.item.authentication.softwareOathMethods.item collection</summary>
        ...
        public SoftwareOathMethodsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/authentication/softwareOathMethods{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
