...
using MicrosoftGraphSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Count;
...
namespace MicrosoftGraphSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods {
    ...
    public class WindowsHelloForBusinessMethodsRequestBuilder {
        ...
        /// </summary>
        public async Task<WindowsHelloForBusinessAuthenticationMethodCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
