...
namespace Microsoft.Graph.Beta.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.RegisteredUsers.Item.User.GetLoggedOnManagedDevices {
    ...
    public class GetLoggedOnManagedDevicesRequestBuilder {
        ...
        public GetLoggedOnManagedDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredUsers/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.getLoggedOnManagedDevices()";
