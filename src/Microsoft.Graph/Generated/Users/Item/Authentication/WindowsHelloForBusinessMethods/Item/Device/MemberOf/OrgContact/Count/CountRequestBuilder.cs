...
namespace Microsoft.Graph.Beta.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.OrgContact.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/memberOf/microsoft.graph.orgContact/$count";
