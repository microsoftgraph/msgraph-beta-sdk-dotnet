...
namespace Microsoft.Graph.Beta.Users.Item.DeviceEnrollmentConfigurations.Item.SetPriority {
    ...
    public class SetPriorityRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(SetPriorityPostRequestBody body, CancellationToken cancellationToken = default, Action<SetPriorityRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
