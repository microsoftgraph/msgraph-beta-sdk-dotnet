...
namespace MicrosoftGraphSdk.Users.Item.GetManagedAppPolicies {
    ...
    public class GetManagedAppPoliciesResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetManagedAppPoliciesResponse).Value = n.GetCollectionOfObjectValues<ManagedAppPolicy>(ManagedAppPolicy.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
