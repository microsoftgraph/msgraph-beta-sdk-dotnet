...
namespace Microsoft.Graph.Beta.Users.Item.GetManagedAppPolicies {
    ...
    public class GetManagedAppPoliciesRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetManagedAppPoliciesGetResponse"></returns>
...
#nullable restore
        ...
        /// Gets app restrictions for a given user.
        /// </summary>
        /// <returns>A <cref="GetManagedAppPoliciesResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetManagedAppPoliciesRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
