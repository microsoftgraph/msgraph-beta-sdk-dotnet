...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EmployeeExperienceRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EmployeeExperienceRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EmployeeExperienceUser?> GetAsync(CancellationToken cancellationToken = default, Action<EmployeeExperienceRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EmployeeExperienceUser> GetAsync(CancellationToken cancellationToken = default, Action<EmployeeExperienceRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EmployeeExperienceUser?> PatchAsync(EmployeeExperienceUser body, CancellationToken cancellationToken = default, Action<EmployeeExperienceRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EmployeeExperienceUser> PatchAsync(EmployeeExperienceUser body, CancellationToken cancellationToken = default, Action<EmployeeExperienceRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
