...
using Microsoft.Graph.Beta.Users.Item.CreatedObjects.ServicePrincipal;
...
namespace Microsoft.Graph.Beta.Users.Item.CreatedObjects {
    ...
    public class CreatedObjectsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.createdObjects.item collection</summary>
        ...
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(Action<CreatedObjectsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
