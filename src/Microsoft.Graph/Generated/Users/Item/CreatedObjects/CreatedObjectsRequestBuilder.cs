...
using MicrosoftGraphSdk.Users.Item.CreatedObjects.Count;
using MicrosoftGraphSdk.Users.Item.CreatedObjects.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.CreatedObjects {
    ...
    public class CreatedObjectsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.createdObjects.item collection</summary>
        ...
        public CreatedObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/createdObjects{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
