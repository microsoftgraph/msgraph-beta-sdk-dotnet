...
namespace Microsoft.Graph.Beta.Users.Item.CreatedObjects.GraphServicePrincipal.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/createdObjects/graph.servicePrincipal/$count{?%24search,%24filter}";
