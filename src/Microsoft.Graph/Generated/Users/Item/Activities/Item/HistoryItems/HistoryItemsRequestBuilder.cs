...
namespace MicrosoftGraphSdk.Users.Item.Activities.Item.HistoryItems {
    ...
    public class HistoryItemsRequestBuilder {
        ...
        /// </summary>
        public async Task<ActivityHistoryItemCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
