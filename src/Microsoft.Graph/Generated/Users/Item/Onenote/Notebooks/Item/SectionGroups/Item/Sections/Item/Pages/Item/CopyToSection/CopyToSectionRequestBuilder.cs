...
#nullable enable
        public async Task<OnenoteOperation?> PostAsync(CopyToSectionPostRequestBody body, CancellationToken cancellationToken = default, Action<CopyToSectionRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OnenoteOperation> PostAsync(CopyToSectionPostRequestBody body, CancellationToken cancellationToken = default, Action<CopyToSectionRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
