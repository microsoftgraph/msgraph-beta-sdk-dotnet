...
namespace Microsoft.Graph.Beta.Users.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        /// </summary>
        public async Task<Notebook> GetAsync(CancellationToken cancellationToken = default, Action<ParentNotebookRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
