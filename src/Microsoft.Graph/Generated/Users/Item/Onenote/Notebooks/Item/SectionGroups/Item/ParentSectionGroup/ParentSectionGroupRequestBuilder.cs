...
using System;
namespace Microsoft.Graph.Beta.Users.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentSectionGroup {
    /// <summary>
    ...
    public class ParentSectionGroupRequestBuilder : BaseRequestBuilder {
        ...
        public ParentSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/parentSectionGroup{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ParentSectionGroupRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ParentSectionGroupRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/parentSectionGroup{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<SectionGroup?> GetAsync(CancellationToken cancellationToken = default, Action<ParentSectionGroupRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SectionGroup> GetAsync(CancellationToken cancellationToken = default, Action<ParentSectionGroupRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
