...
using MicrosoftGraph.Users.Item.Onenote.Notebooks.Item.Sections.Item;
using System;
...
namespace MicrosoftGraph.Users.Item.Onenote.Notebooks.Item.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.users.item.onenote.notebooks.item.sections.item collection</summary>
