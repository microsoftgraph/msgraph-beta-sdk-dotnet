...
namespace MicrosoftGraphSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.ParentNotebook.CopyNotebook {
    ...
    public class CopyNotebookRequestBuilder {
        ...
        public CopyNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/parentNotebook/microsoft.graph.copyNotebook";
