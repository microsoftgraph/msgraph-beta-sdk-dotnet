...
namespace Microsoft.Graph.Beta.Users.Item.Onenote.Notebooks {
    ...
    public class NotebooksRequestBuilder : BaseRequestBuilder {
        ...
        public NotebooksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/notebooks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new NotebooksRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public NotebooksRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/notebooks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<NotebookCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<NotebooksRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<NotebookCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<NotebooksRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Notebook?> PostAsync(Notebook body, CancellationToken cancellationToken = default, Action<NotebooksRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Notebook> PostAsync(Notebook body, CancellationToken cancellationToken = default, Action<NotebooksRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
