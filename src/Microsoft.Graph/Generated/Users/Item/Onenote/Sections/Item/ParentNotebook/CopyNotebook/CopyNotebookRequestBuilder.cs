...
namespace MicrosoftGraphSdk.Users.Item.Onenote.Sections.Item.ParentNotebook.CopyNotebook {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\onenote\sections\{onenoteSection-id}\parentNotebook\microsoft.graph.copyNotebook</summary>
    public class CopyNotebookRequestBuilder {
        ...
        public CopyNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/onenote/sections/{onenoteSection_id}/parentNotebook/microsoft.graph.copyNotebook";
