...
using System;
namespace Microsoft.Graph.Beta.Users.Item.Onenote.Sections.Item.Pages.Item.ParentSection {
    /// <summary>
    ...
    public class ParentSectionRequestBuilder : BaseRequestBuilder {
        ...
        public ParentSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/parentSection{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ParentSectionRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ParentSectionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/parentSection{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<OnenoteSection?> GetAsync(CancellationToken cancellationToken = default, Action<ParentSectionRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OnenoteSection> GetAsync(CancellationToken cancellationToken = default, Action<ParentSectionRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
