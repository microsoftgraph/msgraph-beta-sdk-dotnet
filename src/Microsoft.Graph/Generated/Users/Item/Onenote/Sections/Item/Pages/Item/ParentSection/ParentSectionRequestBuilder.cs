...
using MicrosoftGraphSdk.Users.Item.Onenote.Sections.Item.Pages.Item.ParentSection.CopyToNotebook;
using MicrosoftGraphSdk.Users.Item.Onenote.Sections.Item.Pages.Item.ParentSection.CopyToSectionGroup;
using MicrosoftGraphSdk.Users.Item.Onenote.Sections.Item.Pages.Item.ParentSection.Ref;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Onenote.Sections.Item.Pages.Item.ParentSection {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\onenote\sections\{onenoteSection-id}\pages\{onenotePage-id}\parentSection</summary>
    public class ParentSectionRequestBuilder {
        ...
        public ParentSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentSection{?select,expand}";
