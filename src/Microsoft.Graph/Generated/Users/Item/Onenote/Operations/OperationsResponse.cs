...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Users.Item.Onenote.Operations {
    public class OperationsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as OperationsResponse).Value = n.GetCollectionOfObjectValues<OnenoteOperation>(OnenoteOperation.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
