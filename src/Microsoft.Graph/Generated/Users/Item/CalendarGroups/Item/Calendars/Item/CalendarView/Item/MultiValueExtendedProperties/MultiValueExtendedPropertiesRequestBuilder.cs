...
namespace MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendarGroups\{calendarGroup-id}\calendars\{calendar-id}\calendarView\{event-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.users.item.calendarGroups.item.calendars.item.calendarView.item.multiValueExtendedProperties.item collection</summary>
        public MultiValueExtendedPropertiesRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("multiValueLegacyExtendedProperty_id", position);
            return new MultiValueExtendedPropertiesRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
