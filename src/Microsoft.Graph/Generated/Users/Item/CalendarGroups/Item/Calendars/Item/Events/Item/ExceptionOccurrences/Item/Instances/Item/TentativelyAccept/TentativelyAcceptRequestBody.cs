...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.TentativelyAccept {
    /// <summary>Provides operations to call the tentativelyAccept method.</summary>
    public class TentativelyAcceptRequestBody : IParsable, IAdditionalDataHolder {
