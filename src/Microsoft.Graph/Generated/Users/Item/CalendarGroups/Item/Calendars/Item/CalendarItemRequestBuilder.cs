...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Calendar?> GetAsync(CancellationToken cancellationToken = default, Action<CalendarItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Calendar> GetAsync(CancellationToken cancellationToken = default, Action<CalendarItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Calendar?> PatchAsync(Microsoft.Graph.Beta.Models.Calendar body, CancellationToken cancellationToken = default, Action<CalendarItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Calendar> PatchAsync(Microsoft.Graph.Beta.Models.Calendar body, CancellationToken cancellationToken = default, Action<CalendarItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
