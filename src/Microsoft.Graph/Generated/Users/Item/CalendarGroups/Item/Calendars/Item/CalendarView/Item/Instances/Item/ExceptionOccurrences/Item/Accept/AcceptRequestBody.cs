...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Accept {
    /// <summary>Provides operations to call the accept method.</summary>
    public class AcceptRequestBody : IParsable, IAdditionalDataHolder {
