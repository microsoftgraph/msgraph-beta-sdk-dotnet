...
namespace Microsoft.Graph.Beta.Users.Item.OnlineMeetingsWithJoinWebUrl {
    ...
    public class OnlineMeetingsWithJoinWebUrlRequestBuilder : BaseRequestBuilder {
        ...
        public OnlineMeetingsWithJoinWebUrlRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string joinWebUrl = "") : base(requestAdapter, "{+baseurl}/users/{user%2Did}/onlineMeetings(joinWebUrl='{joinWebUrl}'){?%24select,%24expand}", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OnlineMeetingsWithJoinWebUrlRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/onlineMeetings(joinWebUrl='{joinWebUrl}'){?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
