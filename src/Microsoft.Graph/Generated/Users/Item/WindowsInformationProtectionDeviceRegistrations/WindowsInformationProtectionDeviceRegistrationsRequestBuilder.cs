...
using MicrosoftGraphSdk.Users.Item.WindowsInformationProtectionDeviceRegistrations.Count;
using MicrosoftGraphSdk.Users.Item.WindowsInformationProtectionDeviceRegistrations.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.WindowsInformationProtectionDeviceRegistrations {
    ...
    public class WindowsInformationProtectionDeviceRegistrationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.windowsInformationProtectionDeviceRegistrations.item collection</summary>
        ...
        public WindowsInformationProtectionDeviceRegistrationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/windowsInformationProtectionDeviceRegistrations{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
