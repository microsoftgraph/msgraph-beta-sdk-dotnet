...
namespace MicrosoftGraph.Users.Item.Todo.Lists.Item.Tasks.Item.Extensions.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\todo\lists\{todoTaskList-id}\tasks\{todoTask-id}\extensions\{extension-id}</summary>
    public class ExtensionRequestBuilder {
        ...
        public ExtensionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/todo/lists/{todoTaskList_id}/tasks/{todoTask_id}/extensions/{extension_id}{?select,expand}";
