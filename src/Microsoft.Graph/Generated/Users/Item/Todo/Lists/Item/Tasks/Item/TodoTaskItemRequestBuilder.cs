...
using Microsoft.Graph.Beta.Users.Item.Todo.Lists.Item.Tasks.Item.Attachments;
using Microsoft.Graph.Beta.Users.Item.Todo.Lists.Item.Tasks.Item.AttachmentSessions;
using Microsoft.Graph.Beta.Users.Item.Todo.Lists.Item.Tasks.Item.ChecklistItems;
using Microsoft.Graph.Beta.Users.Item.Todo.Lists.Item.Tasks.Item.Extensions;
using Microsoft.Graph.Beta.Users.Item.Todo.Lists.Item.Tasks.Item.LinkedResources;
...
namespace Microsoft.Graph.Beta.Users.Item.Todo.Lists.Item.Tasks.Item {
    ...
    public class TodoTaskItemRequestBuilder {
        ...
        public TodoTaskItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task DeleteAsync(Action<TodoTaskItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TodoTask> GetAsync(Action<TodoTaskItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<TodoTask>(requestInfo, TodoTask.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Update the navigation property tasks in users
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TodoTask> PatchAsync(TodoTask body, Action<TodoTaskItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
