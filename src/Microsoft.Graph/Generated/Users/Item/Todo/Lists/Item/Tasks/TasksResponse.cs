...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Users.Item.Todo.Lists.Item.Tasks {
    public class TasksResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as TasksResponse).Value = n.GetCollectionOfObjectValues<TodoTask>(TodoTask.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
