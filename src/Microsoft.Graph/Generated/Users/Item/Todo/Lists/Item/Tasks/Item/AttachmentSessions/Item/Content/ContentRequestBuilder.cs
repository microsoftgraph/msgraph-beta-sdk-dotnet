...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AttachmentSession?> PutAsync(Stream body, CancellationToken cancellationToken = default, Action<ContentRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AttachmentSession> PutAsync(Stream body, CancellationToken cancellationToken = default, Action<ContentRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
