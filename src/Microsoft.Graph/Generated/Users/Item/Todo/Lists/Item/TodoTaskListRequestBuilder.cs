...
using MicrosoftGraph.Users.Item.Todo.Lists.Item.Extensions;
using MicrosoftGraph.Users.Item.Todo.Lists.Item.Tasks;
using System;
...
namespace MicrosoftGraph.Users.Item.Todo.Lists.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\todo\lists\{todoTaskList-id}</summary>
    public class TodoTaskListRequestBuilder {
        ...
        /// </summary>
        public TodoTaskListRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/users/{user_id}/todo/lists/{todoTaskList_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public TodoTaskListRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(TodoTaskList body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
