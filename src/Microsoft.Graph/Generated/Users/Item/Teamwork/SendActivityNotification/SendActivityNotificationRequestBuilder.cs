...
namespace Microsoft.Graph.Beta.Users.Item.Teamwork.SendActivityNotification {
    ...
    public class SendActivityNotificationRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>
        /// Send an activity feed notification to a user. For more details about sending notifications and the requirements for doing so, see sending Teams activity notifications. This API is supported in the following national cloud deployments.
