...
namespace Microsoft.Graph.Beta.Users.Item.Teamwork.AssociatedTeams.Item {
    ...
    public class AssociatedTeamInfoItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AssociatedTeamInfo body, Action<AssociatedTeamInfoItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
