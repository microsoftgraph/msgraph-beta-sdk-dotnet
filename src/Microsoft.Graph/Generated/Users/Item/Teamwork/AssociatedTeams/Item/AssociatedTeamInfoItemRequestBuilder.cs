...
namespace Microsoft.Graph.Beta.Users.Item.Teamwork.AssociatedTeams.Item {
    ...
    public class AssociatedTeamInfoItemRequestBuilder : BaseRequestBuilder {
        ...
        public AssociatedTeamInfoItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/teamwork/associatedTeams/{associatedTeamInfo%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AssociatedTeamInfoItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AssociatedTeamInfoItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/teamwork/associatedTeams/{associatedTeamInfo%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AssociatedTeamInfoItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AssociatedTeamInfoItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AssociatedTeamInfo?> GetAsync(CancellationToken cancellationToken = default, Action<AssociatedTeamInfoItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AssociatedTeamInfo> GetAsync(CancellationToken cancellationToken = default, Action<AssociatedTeamInfoItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AssociatedTeamInfo?> PatchAsync(AssociatedTeamInfo body, CancellationToken cancellationToken = default, Action<AssociatedTeamInfoItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AssociatedTeamInfo> PatchAsync(AssociatedTeamInfo body, CancellationToken cancellationToken = default, Action<AssociatedTeamInfoItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
