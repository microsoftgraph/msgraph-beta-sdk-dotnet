...
namespace MicrosoftGraphSdk.Users.Item.DeviceManagementTroubleshootingEvents.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\deviceManagementTroubleshootingEvents\{deviceManagementTroubleshootingEvent-id}</summary>
