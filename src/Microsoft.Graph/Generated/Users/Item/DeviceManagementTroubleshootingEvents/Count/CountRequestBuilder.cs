...
namespace Microsoft.Graph.Beta.Users.Item.DeviceManagementTroubleshootingEvents.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/deviceManagementTroubleshootingEvents/$count{?%24search,%24filter}";
