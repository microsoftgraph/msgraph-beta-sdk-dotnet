...
namespace Microsoft.Graph.Beta.Users.Item.MobileAppTroubleshootingEvents {
    ...
    public class MobileAppTroubleshootingEventsRequestBuilder : BaseRequestBuilder {
        ...
        public MobileAppTroubleshootingEventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/mobileAppTroubleshootingEvents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MobileAppTroubleshootingEventsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MobileAppTroubleshootingEventsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/mobileAppTroubleshootingEvents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<MobileAppTroubleshootingEventCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<MobileAppTroubleshootingEventsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MobileAppTroubleshootingEventCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MobileAppTroubleshootingEventsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MobileAppTroubleshootingEvent?> PostAsync(MobileAppTroubleshootingEvent body, CancellationToken cancellationToken = default, Action<MobileAppTroubleshootingEventsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MobileAppTroubleshootingEvent> PostAsync(MobileAppTroubleshootingEvent body, CancellationToken cancellationToken = default, Action<MobileAppTroubleshootingEventsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
