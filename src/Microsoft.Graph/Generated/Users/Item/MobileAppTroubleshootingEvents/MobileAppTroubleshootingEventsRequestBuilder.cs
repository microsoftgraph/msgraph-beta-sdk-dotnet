...
namespace Microsoft.Graph.Beta.Users.Item.MobileAppTroubleshootingEvents {
    ...
    public class MobileAppTroubleshootingEventsRequestBuilder {
        ...
        /// </summary>
        public async Task<MobileAppTroubleshootingEventCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MobileAppTroubleshootingEventsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MobileAppTroubleshootingEvent> PostAsync(MobileAppTroubleshootingEvent body, CancellationToken cancellationToken = default, Action<MobileAppTroubleshootingEventsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
