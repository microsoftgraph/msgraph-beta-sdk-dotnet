...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<MobileAppTroubleshootingEventItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<MobileAppTroubleshootingEventItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MobileAppTroubleshootingEvent?> GetAsync(CancellationToken cancellationToken = default, Action<MobileAppTroubleshootingEventItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MobileAppTroubleshootingEvent> GetAsync(CancellationToken cancellationToken = default, Action<MobileAppTroubleshootingEventItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MobileAppTroubleshootingEvent?> PatchAsync(MobileAppTroubleshootingEvent body, CancellationToken cancellationToken = default, Action<MobileAppTroubleshootingEventItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MobileAppTroubleshootingEvent> PatchAsync(MobileAppTroubleshootingEvent body, CancellationToken cancellationToken = default, Action<MobileAppTroubleshootingEventItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
