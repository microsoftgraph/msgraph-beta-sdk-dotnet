...
namespace Microsoft.Graph.Beta.Users.Item.MobileAppTroubleshootingEvents.Item.AppLogCollectionRequests {
    ...
    public class AppLogCollectionRequestsRequestBuilder {
        ...
        /// </summary>
        public async Task<AppLogCollectionRequestCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AppLogCollectionRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AppLogCollectionRequest> PostAsync(AppLogCollectionRequest body, CancellationToken cancellationToken = default, Action<AppLogCollectionRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
