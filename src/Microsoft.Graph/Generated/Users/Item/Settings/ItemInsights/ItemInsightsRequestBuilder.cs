...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ItemInsightsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ItemInsightsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UserInsightsSettings?> GetAsync(CancellationToken cancellationToken = default, Action<ItemInsightsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserInsightsSettings> GetAsync(CancellationToken cancellationToken = default, Action<ItemInsightsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UserInsightsSettings?> PatchAsync(UserInsightsSettings body, CancellationToken cancellationToken = default, Action<ItemInsightsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserInsightsSettings> PatchAsync(UserInsightsSettings body, CancellationToken cancellationToken = default, Action<ItemInsightsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
