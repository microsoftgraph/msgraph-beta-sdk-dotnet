...
namespace MicrosoftGraphSdk.Users.Item.Settings.RegionalAndLanguageSettings {
    ...
    public class RegionalAndLanguageSettingsRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.RegionalAndLanguageSettings body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
