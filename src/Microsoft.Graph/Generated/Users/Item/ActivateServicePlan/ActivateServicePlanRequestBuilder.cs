...
namespace Microsoft.Graph.Beta.Users.Item.ActivateServicePlan {
    ...
    public class ActivateServicePlanRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ActivateServicePlanPostRequestBody body, CancellationToken cancellationToken = default, Action<ActivateServicePlanRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
