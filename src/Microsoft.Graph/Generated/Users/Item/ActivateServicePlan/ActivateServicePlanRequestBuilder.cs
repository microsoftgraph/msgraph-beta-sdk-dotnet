...
namespace Microsoft.Graph.Beta.Users.Item.ActivateServicePlan {
    ...
    public class ActivateServicePlanRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ActivateServicePlanRequestBody body, Action<ActivateServicePlanRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(ActivateServicePlanRequestBody body, Action<ActivateServicePlanRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
