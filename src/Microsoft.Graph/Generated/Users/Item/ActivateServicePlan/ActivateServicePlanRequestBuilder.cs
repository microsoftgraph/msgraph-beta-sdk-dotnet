...
namespace Microsoft.Graph.Beta.Users.Item.ActivateServicePlan {
    ...
    public class ActivateServicePlanRequestBuilder {
        ...
        public ActivateServicePlanRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/microsoft.graph.activateServicePlan";
        ...
        /// <summary>
        /// Activate a service plan with a given `servicePlanId` and `skuId` for a given user.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/user-activateserviceplan?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public async Task PostAsync(ActivateServicePlanPostRequestBody body, Action<ActivateServicePlanRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
