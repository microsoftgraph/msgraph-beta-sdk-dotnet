...
namespace Microsoft.Graph.Beta.Users.Item.GetLoggedOnManagedDevices {
    ...
    public class GetLoggedOnManagedDevicesRequestBuilder {
        ...
        public GetLoggedOnManagedDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/microsoft.graph.getLoggedOnManagedDevices()";
        ...
        /// </summary>
        public async Task<GetLoggedOnManagedDevicesResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetLoggedOnManagedDevicesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
