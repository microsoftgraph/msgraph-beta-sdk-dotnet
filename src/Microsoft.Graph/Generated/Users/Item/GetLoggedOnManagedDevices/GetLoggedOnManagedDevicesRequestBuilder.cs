...
namespace Microsoft.Graph.Beta.Users.Item.GetLoggedOnManagedDevices {
    ...
    public class GetLoggedOnManagedDevicesRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetLoggedOnManagedDevicesGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function getLoggedOnManagedDevices
        /// </summary>
        /// <returns>A <cref="GetLoggedOnManagedDevicesResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetLoggedOnManagedDevicesRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
