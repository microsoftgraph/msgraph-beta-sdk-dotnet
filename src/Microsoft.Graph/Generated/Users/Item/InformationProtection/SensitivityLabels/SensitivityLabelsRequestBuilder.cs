...
using MicrosoftGraphSdk.Users.Item.InformationProtection.SensitivityLabels.Count;
using MicrosoftGraphSdk.Users.Item.InformationProtection.SensitivityLabels.Evaluate;
using MicrosoftGraphSdk.Users.Item.InformationProtection.SensitivityLabels.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.InformationProtection.SensitivityLabels {
    ...
    public class SensitivityLabelsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.informationProtection.sensitivityLabels.item collection</summary>
