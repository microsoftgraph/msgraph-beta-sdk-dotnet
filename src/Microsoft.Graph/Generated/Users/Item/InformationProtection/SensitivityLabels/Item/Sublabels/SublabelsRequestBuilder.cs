...
using MicrosoftGraphSdk.Users.Item.InformationProtection.SensitivityLabels.Item.Sublabels.Count;
using MicrosoftGraphSdk.Users.Item.InformationProtection.SensitivityLabels.Item.Sublabels.Evaluate;
using MicrosoftGraphSdk.Users.Item.InformationProtection.SensitivityLabels.Item.Sublabels.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.InformationProtection.SensitivityLabels.Item.Sublabels {
    ...
    public class SublabelsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.informationProtection.sensitivityLabels.item.sublabels.item collection</summary>
        public MicrosoftGraphSdk.Users.Item.InformationProtection.SensitivityLabels.Item.Sublabels.Item.SensitivityLabelItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("sensitivityLabel_id1", position);
            return new MicrosoftGraphSdk.Users.Item.InformationProtection.SensitivityLabels.Item.Sublabels.Item.SensitivityLabelItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public SublabelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/informationProtection/sensitivityLabels/{sensitivityLabel_id}/sublabels{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
