...
namespace Microsoft.Graph.Beta.Users.Item.InformationProtection.SensitivityLabels.Item.Sublabels {
    ...
    public class SublabelsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.informationProtection.sensitivityLabels.item.sublabels.item collection</summary>
        ...
        public SublabelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
