...
namespace Microsoft.Graph.Beta.Users.Item.InformationProtection.ThreatAssessmentRequests {
    ...
    public class ThreatAssessmentRequestsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.informationProtection.threatAssessmentRequests.item collection</summary>
        ...
        public ThreatAssessmentRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/informationProtection/threatAssessmentRequests{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>Get threatAssessmentRequests from users</summary>
