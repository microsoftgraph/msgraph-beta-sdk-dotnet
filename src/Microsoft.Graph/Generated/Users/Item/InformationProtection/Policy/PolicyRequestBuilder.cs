...
namespace Microsoft.Graph.Beta.Users.Item.InformationProtection.Policy {
    ...
    public class PolicyRequestBuilder : BaseRequestBuilder {
        ...
        public PolicyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/informationProtection/policy{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PolicyRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PolicyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/informationProtection/policy{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PolicyRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PolicyRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<InformationProtectionPolicy?> GetAsync(CancellationToken cancellationToken = default, Action<PolicyRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<InformationProtectionPolicy> GetAsync(CancellationToken cancellationToken = default, Action<PolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<InformationProtectionPolicy?> PatchAsync(InformationProtectionPolicy body, CancellationToken cancellationToken = default, Action<PolicyRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<InformationProtectionPolicy> PatchAsync(InformationProtectionPolicy body, CancellationToken cancellationToken = default, Action<PolicyRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
