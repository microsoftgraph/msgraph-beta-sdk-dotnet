...
namespace Microsoft.Graph.Beta.Users.Item.InformationProtection.Policy.Labels.EvaluateApplication {
    ...
    public class EvaluateApplicationRequestBuilder : BaseRequestBuilder {
        ...
        public EvaluateApplicationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/informationProtection/policy/labels/evaluateApplication", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EvaluateApplicationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EvaluateApplicationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/informationProtection/policy/labels/evaluateApplication", rawUrl) {
        }
        /// <summary>
