...
namespace Microsoft.Graph.Beta.Users.Item.InformationProtection.Policy.Labels.ExtractLabel {
    ...
    public class ExtractLabelRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ExtractLabelRequestBody body, Action<ExtractLabelRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<InformationProtectionContentLabel> PostAsync(ExtractLabelRequestBody body, Action<ExtractLabelRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
