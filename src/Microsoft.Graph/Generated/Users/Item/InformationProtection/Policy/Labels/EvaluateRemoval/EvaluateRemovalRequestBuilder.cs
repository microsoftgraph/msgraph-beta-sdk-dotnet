...
#nullable enable
        public async Task<EvaluateRemovalPostResponse?> PostAsEvaluateRemovalPostResponseAsync(EvaluateRemovalPostRequestBody body, Action<EvaluateRemovalRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<EvaluateRemovalPostResponse> PostAsEvaluateRemovalPostResponseAsync(EvaluateRemovalPostRequestBody body, Action<EvaluateRemovalRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("This API will no longer be accessible, please see microsoft.graph.security.informationProtection APIs. as of 2021-02/Beta_SensitivityLabels on 2021-02-15 and will be removed 2022-08-15")]
        public EvaluateRemovalRequestBuilder WithUrl(string rawUrl) {
