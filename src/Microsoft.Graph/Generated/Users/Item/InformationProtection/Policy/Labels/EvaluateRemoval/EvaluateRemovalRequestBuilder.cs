...
#nullable enable
        public async Task<EvaluateRemovalResponse?> PostAsync(EvaluateRemovalPostRequestBody body, CancellationToken cancellationToken = default, Action<EvaluateRemovalRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EvaluateRemovalResponse> PostAsync(EvaluateRemovalPostRequestBody body, CancellationToken cancellationToken = default, Action<EvaluateRemovalRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
