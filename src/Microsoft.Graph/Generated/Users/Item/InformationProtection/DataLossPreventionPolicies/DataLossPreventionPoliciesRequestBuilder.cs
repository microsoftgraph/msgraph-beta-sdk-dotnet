...
namespace MicrosoftGraphSdk.Users.Item.InformationProtection.DataLossPreventionPolicies {
    ...
    public class DataLossPreventionPoliciesRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DataLossPreventionPolicy body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
