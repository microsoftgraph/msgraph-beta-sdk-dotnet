...
namespace Microsoft.Graph.Beta.Users.Item.Chats.Item.HideForUser {
    ...
    public class HideForUserRequestBuilder : BaseRequestBuilder {
        ...
        public HideForUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/hideForUser", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HideForUserRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HideForUserRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/hideForUser", rawUrl) {
        }
        /// <summary>
