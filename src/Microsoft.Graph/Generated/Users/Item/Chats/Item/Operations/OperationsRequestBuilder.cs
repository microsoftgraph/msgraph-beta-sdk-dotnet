...
using Microsoft.Graph.Beta.Users.Item.Chats.Item.Operations.Count;
using Microsoft.Graph.Beta.Users.Item.Chats.Item.Operations.Item;
...
using System;
namespace Microsoft.Graph.Beta.Users.Item.Chats.Item.Operations {
    /// <summary>
    ...
    public class OperationsRequestBuilder : BaseRequestBuilder {
        ...
        public OperationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OperationsRequestBuilder and sets the default values.
        /// </summary>
