...
namespace Microsoft.Graph.Beta.Users.Item.Chats.Item.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        /// </summary>
        public async Task<ChatMessageCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MessagesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ChatMessage> PostAsync(ChatMessage body, CancellationToken cancellationToken = default, Action<MessagesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
