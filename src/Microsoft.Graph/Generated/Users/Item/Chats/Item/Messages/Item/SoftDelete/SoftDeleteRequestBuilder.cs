...
namespace Microsoft.Graph.Beta.Users.Item.Chats.Item.Messages.Item.SoftDelete {
    ...
    public class SoftDeleteRequestBuilder {
        ...
        public SoftDeleteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/chats/{chat_id}/messages/{chatMessage_id}/microsoft.graph.softDelete";
