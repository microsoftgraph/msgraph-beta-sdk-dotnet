...
using System;
namespace Microsoft.Graph.Beta.Users.Item.Chats.Item.Messages.Item.UndoSoftDelete {
    /// <summary>
    ...
    public class UndoSoftDeleteRequestBuilder : BaseRequestBuilder {
        ...
        public UndoSoftDeleteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/messages/{chatMessage%2Did}/undoSoftDelete", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UndoSoftDeleteRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UndoSoftDeleteRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/messages/{chatMessage%2Did}/undoSoftDelete", rawUrl) {
        }
        /// <summary>
