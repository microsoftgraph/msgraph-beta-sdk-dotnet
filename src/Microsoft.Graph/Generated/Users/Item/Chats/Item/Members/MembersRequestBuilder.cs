...
namespace Microsoft.Graph.Beta.Users.Item.Chats.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.chats.item.members.item collection</summary>
