...
using MicrosoftGraphSdk.Users.Item.Chats.Item.InstalledApps;
using MicrosoftGraphSdk.Users.Item.Chats.Item.LastMessagePreview;
using MicrosoftGraphSdk.Users.Item.Chats.Item.Members;
using MicrosoftGraphSdk.Users.Item.Chats.Item.Messages;
using MicrosoftGraphSdk.Users.Item.Chats.Item.Operations;
using MicrosoftGraphSdk.Users.Item.Chats.Item.PermissionGrants;
using MicrosoftGraphSdk.Users.Item.Chats.Item.Tabs;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Chats.Item {
    ...
    public class ChatItemRequestBuilder {
        ...
        public ChatItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/chats/{chat_id}{?select,expand}";
