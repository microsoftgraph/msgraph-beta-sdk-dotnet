...
namespace Microsoft.Graph.Beta.Users.Item.Chats.Item.PermissionGrants.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/permissionGrants/$count{?%24search,%24filter}";
