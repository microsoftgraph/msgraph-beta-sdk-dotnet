...
namespace Microsoft.Graph.Beta.Users.Item.Chats.Item.LastMessagePreview {
    /// <summary>
    ...
    public class LastMessagePreviewRequestBuilder {
        ...
        public LastMessagePreviewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/lastMessagePreview{?%24select,%24expand}";
