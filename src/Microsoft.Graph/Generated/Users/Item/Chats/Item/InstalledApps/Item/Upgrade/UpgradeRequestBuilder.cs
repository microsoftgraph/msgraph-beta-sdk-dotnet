...
namespace Microsoft.Graph.Beta.Users.Item.Chats.Item.InstalledApps.Item.Upgrade {
    ...
    public class UpgradeRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<UpgradeRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
