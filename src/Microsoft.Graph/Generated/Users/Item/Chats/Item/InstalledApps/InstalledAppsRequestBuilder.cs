...
namespace Microsoft.Graph.Beta.Users.Item.Chats.Item.InstalledApps {
    ...
    public class InstalledAppsRequestBuilder : BaseRequestBuilder {
        ...
        public InstalledAppsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/installedApps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new InstalledAppsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<TeamsAppInstallationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<InstalledAppsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TeamsAppInstallationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<InstalledAppsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TeamsAppInstallation?> PostAsync(TeamsAppInstallation body, CancellationToken cancellationToken = default, Action<InstalledAppsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TeamsAppInstallation> PostAsync(TeamsAppInstallation body, CancellationToken cancellationToken = default, Action<InstalledAppsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
