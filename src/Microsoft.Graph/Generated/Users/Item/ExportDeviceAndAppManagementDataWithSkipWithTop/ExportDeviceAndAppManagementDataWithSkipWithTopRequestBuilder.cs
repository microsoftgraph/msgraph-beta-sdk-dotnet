...
namespace Microsoft.Graph.Beta.Users.Item.ExportDeviceAndAppManagementDataWithSkipWithTop {
    ...
    public class ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceAndAppManagementData> GetAsync(CancellationToken cancellationToken = default, Action<ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<DeviceAndAppManagementData>(requestInfo, DeviceAndAppManagementData.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
