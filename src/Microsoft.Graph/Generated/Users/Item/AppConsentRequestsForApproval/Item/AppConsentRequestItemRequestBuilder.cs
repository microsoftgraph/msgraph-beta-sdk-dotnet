...
using MicrosoftGraphSdk.Users.Item.AppConsentRequestsForApproval.Item.UserConsentRequests;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.AppConsentRequestsForApproval.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\appConsentRequestsForApproval\{appConsentRequest-id}</summary>
    public class AppConsentRequestItemRequestBuilder {
        ...
        public AppConsentRequestItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/appConsentRequestsForApproval/{appConsentRequest_id}{?select,expand}";
