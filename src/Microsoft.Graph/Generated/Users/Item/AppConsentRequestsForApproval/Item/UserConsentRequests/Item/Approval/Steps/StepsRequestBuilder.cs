...
using MicrosoftGraphSdk.Users.Item.AppConsentRequestsForApproval.Item.UserConsentRequests.Item.Approval.Steps.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.AppConsentRequestsForApproval.Item.UserConsentRequests.Item.Approval.Steps {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\appConsentRequestsForApproval\{appConsentRequest-id}\userConsentRequests\{userConsentRequest-id}\approval\steps</summary>
    public class StepsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.appConsentRequestsForApproval.item.userConsentRequests.item.approval.steps.item collection</summary>
        ...
        public StepsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/appConsentRequestsForApproval/{appConsentRequest_id}/userConsentRequests/{userConsentRequest_id}/approval/steps{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
