...
using Microsoft.Graph.Beta.Users.Item.AppConsentRequestsForApproval.Item.UserConsentRequests.MicrosoftGraphFilterByCurrentUserWithOn;
...
namespace Microsoft.Graph.Beta.Users.Item.AppConsentRequestsForApproval.Item.UserConsentRequests {
    ...
    public class UserConsentRequestsRequestBuilder {
        ...
        public UserConsentRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/appConsentRequestsForApproval/{appConsentRequest%2Did}/userConsentRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
