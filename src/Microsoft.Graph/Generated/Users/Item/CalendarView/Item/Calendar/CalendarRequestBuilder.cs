...
using MicrosoftGraphSdk.Users.Item.CalendarView.Item.Calendar.AllowedCalendarSharingRolesWithUser;
using MicrosoftGraphSdk.Users.Item.CalendarView.Item.Calendar.GetSchedule;
using MicrosoftGraphSdk.Users.Item.CalendarView.Item.Calendar.Ref;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.CalendarView.Item.Calendar {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendarView\{event-id}\calendar</summary>
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendarView/{event_id}/calendar{?select}";
