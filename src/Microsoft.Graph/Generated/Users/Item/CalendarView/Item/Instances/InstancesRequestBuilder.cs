...
using MicrosoftGraph.Users.Item.CalendarView.Item.Instances.Delta;
using MicrosoftGraph.Users.Item.CalendarView.Item.Instances.Item;
using System;
...
namespace MicrosoftGraph.Users.Item.CalendarView.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.users.item.calendarView.item.instances.item collection</summary>
