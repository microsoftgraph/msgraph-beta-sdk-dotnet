...
using MicrosoftGraphSdk.Users.Item.CalendarView.Item.MultiValueExtendedProperties.Count;
using MicrosoftGraphSdk.Users.Item.CalendarView.Item.MultiValueExtendedProperties.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.CalendarView.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.calendarView.item.multiValueExtendedProperties.item collection</summary>
