...
using MicrosoftGraphSdk.Users.Item.CalendarView.Count;
using MicrosoftGraphSdk.Users.Item.CalendarView.Delta;
using MicrosoftGraphSdk.Users.Item.CalendarView.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.calendarView.item collection</summary>
        ...
        public CalendarViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendarView{?startDateTime,endDateTime,top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
