...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.EvaluateDynamicMembership {
    ...
    public class EvaluateDynamicMembershipRequestBuilder : BaseRequestBuilder {
        ...
        public EvaluateDynamicMembershipRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedGroups/evaluateDynamicMembership", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EvaluateDynamicMembershipRequestBuilder and sets the default values.
        /// </summary>
