...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Threads.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Threads.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Threads {
    ...
    public class ThreadsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.threads.item collection</summary>
        ...
        public ThreadsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/threads{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
