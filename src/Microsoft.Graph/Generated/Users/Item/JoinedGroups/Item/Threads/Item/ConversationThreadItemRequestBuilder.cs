...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Threads.Item.Posts;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Threads.Item.Reply;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Threads.Item {
    ...
    public class ConversationThreadItemRequestBuilder {
        ...
        public ConversationThreadItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/threads/{conversationThread%2Did}{?%24select}";
        ...
        /// <summary>
        /// Delete navigation property threads for users
        ...
        /// <summary>
        /// Update the navigation property threads in users
