...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Threads.Item.Posts.Item.InReplyTo.Attachments.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Threads.Item.Posts.Item.InReplyTo.Attachments.CreateUploadSession;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Threads.Item.Posts.Item.InReplyTo.Attachments.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Threads.Item.Posts.Item.InReplyTo.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.threads.item.posts.item.inReplyTo.attachments.item collection</summary>
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/inReplyTo/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
