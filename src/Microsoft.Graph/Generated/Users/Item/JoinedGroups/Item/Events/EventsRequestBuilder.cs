...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Events.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Events.Delta;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Events.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Events {
    ...
    public class EventsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.events.item collection</summary>
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/events{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
