...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Events.Item.ExceptionOccurrences.Item.Instances.Item.Calendar {
    ...
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/calendar{?%24select}";
