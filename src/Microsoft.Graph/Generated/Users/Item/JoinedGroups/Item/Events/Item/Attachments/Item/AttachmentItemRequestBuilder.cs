...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Events.Item.Attachments.Item {
    ...
    public class AttachmentItemRequestBuilder {
        ...
        public AttachmentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/events/{event%2Did}/attachments/{attachment%2Did}{?%24select,%24expand}";
