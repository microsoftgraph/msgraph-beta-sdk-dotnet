...
namespace MicrosoftGraphSdk.Users.Item.JoinedGroups.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\joinedGroups\{group-id}</summary>
    public class GroupItemRequestBuilder {
        ...
        public GroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/joinedGroups/{group_id}{?select}";
