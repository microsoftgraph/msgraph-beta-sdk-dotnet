...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Photo.Value;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Photo {
    ...
    public class PhotoRequestBuilder {
        ...
        public PhotoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/photo{?%24select}";
