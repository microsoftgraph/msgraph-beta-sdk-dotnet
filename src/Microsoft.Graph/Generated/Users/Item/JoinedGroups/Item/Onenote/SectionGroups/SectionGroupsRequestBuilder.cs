...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.SectionGroups.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.SectionGroups.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.onenote.sectionGroups.item collection</summary>
        ...
        public SectionGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
