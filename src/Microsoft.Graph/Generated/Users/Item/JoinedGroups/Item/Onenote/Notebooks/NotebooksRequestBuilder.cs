...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.Notebooks.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.Notebooks.GetNotebookFromWebUrl;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.Notebooks.GetRecentNotebooksWithIncludePersonalNotebooks;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.Notebooks.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.Notebooks {
    ...
    public class NotebooksRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.onenote.notebooks.item collection</summary>
        ...
        public NotebooksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/notebooks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
