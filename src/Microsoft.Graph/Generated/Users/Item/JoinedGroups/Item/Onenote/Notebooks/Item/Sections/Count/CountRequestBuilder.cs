...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.Notebooks.Item.Sections.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sections/$count";
