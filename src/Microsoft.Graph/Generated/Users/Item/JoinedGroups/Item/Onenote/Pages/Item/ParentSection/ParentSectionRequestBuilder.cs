...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.Pages.Item.ParentSection {
    ...
    public class ParentSectionRequestBuilder {
        ...
        public ParentSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/pages/{onenotePage%2Did}/parentSection{?%24select,%24expand}";
