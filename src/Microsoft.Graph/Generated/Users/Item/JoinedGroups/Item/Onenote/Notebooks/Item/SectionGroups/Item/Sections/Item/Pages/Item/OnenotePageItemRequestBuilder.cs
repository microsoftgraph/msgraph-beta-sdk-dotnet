...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages.Item.Content;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages.Item.CopyToSection;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages.Item.OnenotePatchContent;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages.Item.ParentNotebook;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages.Item.ParentSection;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages.Item.Preview;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages.Item {
    ...
    public class OnenotePageItemRequestBuilder {
        ...
        public OnenotePageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task DeleteAsync(Action<OnenotePageItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OnenotePage> GetAsync(Action<OnenotePageItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(OnenotePage body, Action<OnenotePageItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
