...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.AssignedToTaskBoardFormat;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.BucketTaskBoardFormat;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.Details;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.ProgressTaskBoardFormat;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item {
    ...
    public class PlannerTaskItemRequestBuilder {
        ...
        public PlannerTaskItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}{?%24select,%24expand}";
