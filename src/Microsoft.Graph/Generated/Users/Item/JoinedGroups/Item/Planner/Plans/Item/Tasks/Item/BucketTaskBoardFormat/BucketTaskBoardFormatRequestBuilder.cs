...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Planner.Plans.Item.Tasks.Item.BucketTaskBoardFormat {
    ...
    public class BucketTaskBoardFormatRequestBuilder {
        ...
        public BucketTaskBoardFormatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/bucketTaskBoardFormat{?%24select,%24expand}";
