...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Planner.Plans;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Planner {
    ...
    public class PlannerRequestBuilder {
        ...
        public PlannerRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/planner{?%24select,%24expand}";
