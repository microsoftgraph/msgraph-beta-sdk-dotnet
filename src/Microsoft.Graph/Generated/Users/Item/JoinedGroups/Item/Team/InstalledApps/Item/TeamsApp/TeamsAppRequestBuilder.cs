...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.InstalledApps.Item.TeamsApp {
    ...
    public class TeamsAppRequestBuilder {
        ...
        public TeamsAppRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/installedApps/{teamsAppInstallation%2Did}/teamsApp{?%24select,%24expand}";
