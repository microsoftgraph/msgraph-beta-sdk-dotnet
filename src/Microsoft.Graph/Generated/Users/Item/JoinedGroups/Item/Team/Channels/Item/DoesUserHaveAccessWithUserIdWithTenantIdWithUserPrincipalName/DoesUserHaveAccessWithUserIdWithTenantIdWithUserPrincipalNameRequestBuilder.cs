...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Channels.Item.DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalName {
    ...
    public class DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameRequestBuilder {
        ...
        public DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/microsoft.graph.doesUserHaveAccess(userId='{userId}',tenantId='{tenantId}',userPrincipalName='{userPrincipalName}'){?userId,tenantId,userPrincipalName}";
