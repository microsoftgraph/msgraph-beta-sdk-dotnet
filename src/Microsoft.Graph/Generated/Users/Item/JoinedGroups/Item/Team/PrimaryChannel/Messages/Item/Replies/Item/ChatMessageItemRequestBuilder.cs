...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item.HostedContents;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item.SoftDelete;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item.UndoSoftDelete;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item {
    ...
    public class ChatMessageItemRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}{?%24select,%24expand}";
