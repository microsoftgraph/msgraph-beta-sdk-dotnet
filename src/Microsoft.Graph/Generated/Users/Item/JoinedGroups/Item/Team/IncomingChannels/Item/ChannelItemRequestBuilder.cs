...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.IncomingChannels.Item {
    ...
    public class ChannelItemRequestBuilder {
        ...
        public ChannelItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/incomingChannels/{channel%2Did}{?%24select,%24expand}";
