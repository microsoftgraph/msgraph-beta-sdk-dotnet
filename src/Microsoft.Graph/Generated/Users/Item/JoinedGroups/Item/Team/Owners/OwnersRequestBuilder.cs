...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Owners.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Owners.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Owners {
    ...
    public class OwnersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.team.owners.item collection</summary>
        public Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Owners.Item.UserItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("user%2Did1", position);
            return new Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Owners.Item.UserItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public OwnersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/owners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
