...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Channels.Item.SharedWithTeams.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Channels.Item.SharedWithTeams.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Channels.Item.SharedWithTeams {
    ...
    public class SharedWithTeamsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.team.channels.item.sharedWithTeams.item collection</summary>
        ...
        public SharedWithTeamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/sharedWithTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
