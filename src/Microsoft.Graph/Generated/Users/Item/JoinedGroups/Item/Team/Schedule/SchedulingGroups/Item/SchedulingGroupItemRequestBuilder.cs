...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Schedule.SchedulingGroups.Item {
    ...
    public class SchedulingGroupItemRequestBuilder {
        ...
        public SchedulingGroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/schedule/schedulingGroups/{schedulingGroup%2Did}{?%24select}";
