...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Photo.Value;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Photo {
    ...
    public class PhotoRequestBuilder {
        ...
        public PhotoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/photo{?%24select,%24expand}";
