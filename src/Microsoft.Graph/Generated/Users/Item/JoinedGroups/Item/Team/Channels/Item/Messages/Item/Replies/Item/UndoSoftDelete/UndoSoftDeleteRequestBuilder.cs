...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Channels.Item.Messages.Item.Replies.Item.UndoSoftDelete {
    ...
    public class UndoSoftDeleteRequestBuilder {
        ...
        public UndoSoftDeleteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/microsoft.graph.undoSoftDelete";
