...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Members.Add;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Members.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Members.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.team.members.item collection</summary>
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
