...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Channels.Item.SharedWithTeams.Item.AllowedMembers.Item {
    ...
    public class ConversationMemberItemRequestBuilder {
        ...
        public ConversationMemberItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/allowedMembers/{conversationMember%2Did}{?%24select,%24expand}";
