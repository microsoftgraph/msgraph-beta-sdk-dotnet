...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.IncomingChannels.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.IncomingChannels.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.IncomingChannels {
    ...
    public class IncomingChannelsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.team.incomingChannels.item collection</summary>
        ...
        /// </summary>
        public IncomingChannelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/incomingChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public IncomingChannelsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public async Task<ChannelCollectionResponse> GetAsync(Action<IncomingChannelsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <summary>Get incomingChannels from users</summary>
