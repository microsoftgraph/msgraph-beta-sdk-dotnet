...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.PrimaryChannel.Tabs.Item.TeamsApp;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.PrimaryChannel.Tabs.Item {
    ...
    public class TeamsTabItemRequestBuilder {
        ...
        public TeamsTabItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/primaryChannel/tabs/{teamsTab%2Did}{?%24select,%24expand}";
