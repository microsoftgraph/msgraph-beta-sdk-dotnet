...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.Schedule.TimesOff.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/schedule/timesOff/$count";
