...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item.HostedContents.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item.HostedContents.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item.HostedContents {
    ...
    public class HostedContentsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.team.primaryChannel.messages.item.replies.item.hostedContents.item collection</summary>
        ...
        public HostedContentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
