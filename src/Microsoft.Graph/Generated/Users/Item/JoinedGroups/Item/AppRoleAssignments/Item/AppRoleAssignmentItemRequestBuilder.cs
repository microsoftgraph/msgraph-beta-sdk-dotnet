...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.AppRoleAssignments.Item {
    ...
    public class AppRoleAssignmentItemRequestBuilder {
        ...
        public AppRoleAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/appRoleAssignments/{appRoleAssignment%2Did}{?%24select,%24expand}";
