...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.MembersWithLicenseErrors.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.MembersWithLicenseErrors.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.MembersWithLicenseErrors {
    ...
    public class MembersWithLicenseErrorsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.membersWithLicenseErrors.item collection</summary>
        ...
        public MembersWithLicenseErrorsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/membersWithLicenseErrors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
