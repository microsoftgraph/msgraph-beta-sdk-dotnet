...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Endpoints.Item {
    ...
    public class EndpointItemRequestBuilder {
        ...
        public EndpointItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/endpoints/{endpoint%2Did}{?%24select,%24expand}";
        ...
        /// <summary>
        /// Delete navigation property endpoints for users
        ...
        /// <summary>
        /// Update the navigation property endpoints in users
