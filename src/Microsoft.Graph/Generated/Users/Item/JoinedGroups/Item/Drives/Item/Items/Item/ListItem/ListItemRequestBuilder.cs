...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Items.Item.ListItem.Activities;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Items.Item.ListItem.Analytics;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Items.Item.ListItem.CreateLink;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Items.Item.ListItem.DocumentSetVersions;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Items.Item.ListItem.DriveItem;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Items.Item.ListItem.Fields;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Items.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Items.Item.ListItem.Versions;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Items.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Items.Item.ListItem.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Items.Item.ListItem.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task DeleteAsync(Action<ListItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.ListItem> GetAsync(Action<ListItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.ListItem body, Action<ListItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
