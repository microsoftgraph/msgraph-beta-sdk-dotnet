...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Activities;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Bundles;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Following;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Items;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.List;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Root;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Special;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task DeleteAsync(Action<DriveItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.Drive body, Action<DriveItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
