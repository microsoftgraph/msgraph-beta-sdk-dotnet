...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.List.ContentTypes.Item.ColumnLinks.Item {
    ...
    public class ColumnLinkItemRequestBuilder {
        ...
        public ColumnLinkItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columnLinks/{columnLink%2Did}{?%24select,%24expand}";
