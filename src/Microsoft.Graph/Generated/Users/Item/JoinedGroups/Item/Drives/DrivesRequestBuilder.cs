...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives {
    ...
    public class DrivesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.drives.item collection</summary>
        ...
        public DrivesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
