...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.List.Operations.Item {
    ...
    public class RichLongRunningOperationItemRequestBuilder {
        ...
        public RichLongRunningOperationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/operations/{richLongRunningOperation%2Did}{?%24select,%24expand}";
