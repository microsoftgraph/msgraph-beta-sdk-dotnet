...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Root.ListItem.DocumentSetVersions.Item.Restore;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.Root.ListItem.DocumentSetVersions.Item {
    ...
    public class DocumentSetVersionItemRequestBuilder {
        ...
        public DocumentSetVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/root/listItem/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}";
