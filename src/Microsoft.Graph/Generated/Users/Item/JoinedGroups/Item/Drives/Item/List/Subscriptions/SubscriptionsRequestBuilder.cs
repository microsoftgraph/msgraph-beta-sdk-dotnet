...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.List.Subscriptions.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.List.Subscriptions.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.List.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.drives.item.list.subscriptions.item collection</summary>
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
