...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Drives.Item.List.Items.Item.Versions.Item.Fields {
    ...
    public class FieldsRequestBuilder {
        ...
        public FieldsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/versions/{listItemVersion%2Did}/fields{?%24select,%24expand}";
