...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Conversations.Item.Threads;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Conversations.Item {
    ...
    public class ConversationItemRequestBuilder {
        ...
        public ConversationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/conversations/{conversation%2Did}{?%24select}";
