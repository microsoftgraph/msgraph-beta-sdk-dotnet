...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Conversations.Item.Threads.Item.Posts.Item.MultiValueExtendedProperties.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Conversations.Item.Threads.Item.Posts.Item.MultiValueExtendedProperties.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Conversations.Item.Threads.Item.Posts.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.conversations.item.threads.item.posts.item.multiValueExtendedProperties.item collection</summary>
        ...
        public MultiValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
