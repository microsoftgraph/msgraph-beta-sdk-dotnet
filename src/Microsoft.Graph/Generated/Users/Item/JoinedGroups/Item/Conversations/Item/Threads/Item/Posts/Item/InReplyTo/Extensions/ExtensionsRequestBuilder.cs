...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Conversations.Item.Threads.Item.Posts.Item.InReplyTo.Extensions.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Conversations.Item.Threads.Item.Posts.Item.InReplyTo.Extensions.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Conversations.Item.Threads.Item.Posts.Item.InReplyTo.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.conversations.item.threads.item.posts.item.inReplyTo.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/inReplyTo/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
