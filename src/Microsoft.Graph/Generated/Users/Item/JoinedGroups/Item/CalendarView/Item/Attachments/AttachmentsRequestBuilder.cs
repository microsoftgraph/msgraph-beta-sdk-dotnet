...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.CalendarView.Item.Attachments.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.CalendarView.Item.Attachments.CreateUploadSession;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.CalendarView.Item.Attachments.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.CalendarView.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.calendarView.item.attachments.item collection</summary>
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendarView/{event%2Did}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
