...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.CalendarView.Item.ExceptionOccurrences.Item.TentativelyAccept {
    ...
    public class TentativelyAcceptRequestBuilder {
        ...
        public TentativelyAcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/microsoft.graph.tentativelyAccept";
