...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.CalendarView.Item.Instances.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.CalendarView.Item.Instances.Delta;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.CalendarView.Item.Instances.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.CalendarView.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.calendarView.item.instances.item collection</summary>
        public Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.CalendarView.Item.Instances.Item.EventItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("event%2Did1", position);
            return new Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.CalendarView.Item.Instances.Item.EventItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public InstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendarView/{event%2Did}/instances{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
