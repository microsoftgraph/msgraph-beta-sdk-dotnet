...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.CalendarView.Item.SingleValueExtendedProperties.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendarView/{event%2Did}/singleValueExtendedProperties/$count";
