...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Calendar.Events.Item.SingleValueExtendedProperties.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Calendar.Events.Item.SingleValueExtendedProperties.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Calendar.Events.Item.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.calendar.events.item.singleValueExtendedProperties.item collection</summary>
        ...
        public SingleValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
