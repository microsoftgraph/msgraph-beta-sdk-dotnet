...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Calendar.CalendarView.Item.Calendar {
    ...
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/calendar{?%24select}";
