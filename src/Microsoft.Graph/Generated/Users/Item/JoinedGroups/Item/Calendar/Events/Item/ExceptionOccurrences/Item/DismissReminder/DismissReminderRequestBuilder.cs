...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.DismissReminder {
    ...
    public class DismissReminderRequestBuilder {
        ...
        public DismissReminderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/microsoft.graph.dismissReminder";
