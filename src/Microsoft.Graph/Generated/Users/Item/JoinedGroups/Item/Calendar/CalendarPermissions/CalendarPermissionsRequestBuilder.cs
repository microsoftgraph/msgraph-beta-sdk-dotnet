...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Calendar.CalendarPermissions.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Calendar.CalendarPermissions.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Calendar.CalendarPermissions {
    ...
    public class CalendarPermissionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.calendar.calendarPermissions.item collection</summary>
        ...
        public CalendarPermissionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/calendarPermissions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
