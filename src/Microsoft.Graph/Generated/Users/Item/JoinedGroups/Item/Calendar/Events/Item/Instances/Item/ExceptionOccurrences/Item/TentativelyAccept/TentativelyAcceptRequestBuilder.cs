...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.TentativelyAccept {
    ...
    public class TentativelyAcceptRequestBuilder {
        ...
        public TentativelyAcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/microsoft.graph.tentativelyAccept";
