...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.SingleValueExtendedProperties.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/singleValueExtendedProperties/$count";
