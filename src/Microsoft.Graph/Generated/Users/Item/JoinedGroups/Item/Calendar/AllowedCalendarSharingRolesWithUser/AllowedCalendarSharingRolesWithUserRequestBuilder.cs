...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Calendar.AllowedCalendarSharingRolesWithUser {
    ...
    public class AllowedCalendarSharingRolesWithUserRequestBuilder {
        ...
        public AllowedCalendarSharingRolesWithUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string user = default) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/microsoft.graph.allowedCalendarSharingRoles(User='{User}')";
