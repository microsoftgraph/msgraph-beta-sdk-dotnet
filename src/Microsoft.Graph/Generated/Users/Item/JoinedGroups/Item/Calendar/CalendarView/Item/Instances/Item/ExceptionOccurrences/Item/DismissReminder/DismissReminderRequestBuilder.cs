...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.DismissReminder {
    ...
    public class DismissReminderRequestBuilder {
        ...
        public DismissReminderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/microsoft.graph.dismissReminder";
