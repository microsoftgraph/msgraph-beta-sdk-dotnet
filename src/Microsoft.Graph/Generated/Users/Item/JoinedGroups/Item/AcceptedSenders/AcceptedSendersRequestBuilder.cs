...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.AcceptedSenders.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.AcceptedSenders.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.AcceptedSenders {
    ...
    public class AcceptedSendersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.acceptedSenders.item collection</summary>
        ...
        public AcceptedSendersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/acceptedSenders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(Action<AcceptedSendersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
