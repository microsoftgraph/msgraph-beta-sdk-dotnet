...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.FromTerm {
    ...
    public class FromTermRequestBuilder {
        ...
        public FromTermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}/relations/{relation%2Did}/fromTerm{?%24select,%24expand}";
