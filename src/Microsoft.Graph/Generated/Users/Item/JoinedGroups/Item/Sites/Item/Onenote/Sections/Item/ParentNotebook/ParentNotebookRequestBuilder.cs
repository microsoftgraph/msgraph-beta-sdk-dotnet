...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Sites.Item.Onenote.Sections.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public ParentNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/sections/{onenoteSection%2Did}/parentNotebook{?%24select,%24expand}";
