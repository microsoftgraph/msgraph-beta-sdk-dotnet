...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Sites.Item.ContentTypes.Item.Unpublish {
    ...
    public class UnpublishRequestBuilder {
        ...
        public UnpublishRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/microsoft.graph.unpublish";
