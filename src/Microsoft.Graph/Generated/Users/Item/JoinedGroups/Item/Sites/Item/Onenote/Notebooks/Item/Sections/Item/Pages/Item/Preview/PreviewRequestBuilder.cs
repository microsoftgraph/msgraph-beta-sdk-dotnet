...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Sites.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.Preview {
    ...
    public class PreviewRequestBuilder {
        ...
        public PreviewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/microsoft.graph.preview()";
