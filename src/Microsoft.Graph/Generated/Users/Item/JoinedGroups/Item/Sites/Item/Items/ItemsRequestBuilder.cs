...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Sites.Item.Items.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Sites.Item.Items.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Sites.Item.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.sites.item.items.item collection</summary>
        ...
        public ItemsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/items{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
