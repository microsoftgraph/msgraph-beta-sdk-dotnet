...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Sites.Item.Lists.Item.Items.Item.DriveItem.Content;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Sites.Item.Lists.Item.Items.Item.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/driveItem{?%24select,%24expand}";
