...
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Owners.Count;
using Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Owners.Item;
...
namespace Microsoft.Graph.Beta.Users.Item.JoinedGroups.Item.Owners {
    ...
    public class OwnersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.users.item.joinedGroups.item.owners.item collection</summary>
        ...
        public OwnersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/owners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
