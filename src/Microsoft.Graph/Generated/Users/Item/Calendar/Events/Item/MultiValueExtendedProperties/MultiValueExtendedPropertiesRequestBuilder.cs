...
using MicrosoftGraphSdk.Users.Item.Calendar.Events.Item.MultiValueExtendedProperties.Count;
using MicrosoftGraphSdk.Users.Item.Calendar.Events.Item.MultiValueExtendedProperties.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Calendar.Events.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.calendar.events.item.multiValueExtendedProperties.item collection</summary>
