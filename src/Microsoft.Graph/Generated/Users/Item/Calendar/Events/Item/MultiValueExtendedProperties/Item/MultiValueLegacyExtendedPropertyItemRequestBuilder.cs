...
namespace MicrosoftGraphSdk.Users.Item.Calendar.Events.Item.MultiValueExtendedProperties.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendar\events\{event-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}</summary>
