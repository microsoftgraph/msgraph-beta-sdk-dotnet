...
namespace Microsoft.Graph.Beta.Users.Item.Calendar.Events.Item.MicrosoftGraphForward {
    /// <summary>
    ...
    public class MicrosoftGraphForwardRequestBuilder {
        ...
        public MicrosoftGraphForwardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/microsoft.graph.forward";
