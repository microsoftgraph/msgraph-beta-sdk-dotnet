...
using MicrosoftGraph.Users.Item.Calendar.Events.Item.Attachments.CreateUploadSession;
using MicrosoftGraph.Users.Item.Calendar.Events.Item.Attachments.Item;
using System;
...
namespace MicrosoftGraph.Users.Item.Calendar.Events.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.users.item.calendar.events.item.attachments.item collection</summary>
