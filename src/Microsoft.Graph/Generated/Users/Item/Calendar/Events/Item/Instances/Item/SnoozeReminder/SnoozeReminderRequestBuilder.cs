...
namespace Microsoft.Graph.Beta.Users.Item.Calendar.Events.Item.Instances.Item.SnoozeReminder {
    /// <summary>
    ...
    public class SnoozeReminderRequestBuilder {
        ...
        public SnoozeReminderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/microsoft.graph.snoozeReminder";
