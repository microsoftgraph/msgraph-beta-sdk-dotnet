...
namespace MicrosoftGraphSdk.Users.Item.Calendar.Events.Item.Instances.Item.ExceptionOccurrences.Item.Accept {
    ...
    public class AcceptRequestBuilder {
        ...
        public AcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendar/events/{event_id}/instances/{event_id1}/exceptionOccurrences/{event_id2}/microsoft.graph.accept";
