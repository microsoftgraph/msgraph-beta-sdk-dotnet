...
using Microsoft.Graph.Beta.Users.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.Attachments.Count;
using Microsoft.Graph.Beta.Users.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.Attachments.CreateUploadSession;
using Microsoft.Graph.Beta.Users.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.Attachments.Item;
...
using System;
namespace Microsoft.Graph.Beta.Users.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.Attachments {
    /// <summary>
    ...
    public class AttachmentsRequestBuilder : BaseRequestBuilder {
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AttachmentsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AttachmentsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
