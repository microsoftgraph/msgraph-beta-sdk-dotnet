...
using Microsoft.Graph.Beta.Users.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Instances.Count;
using Microsoft.Graph.Beta.Users.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Instances.Delta;
using Microsoft.Graph.Beta.Users.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item;
...
using System;
namespace Microsoft.Graph.Beta.Users.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Instances {
    /// <summary>
    ...
    public class InstancesRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Users.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.EventItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("event%2Did2", position);
            return new Microsoft.Graph.Beta.Users.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.EventItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public InstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances{?startDateTime*,endDateTime*,%24top,%24skip,%24filter,%24count,%24orderby,%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new InstancesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InstancesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances{?startDateTime*,endDateTime*,%24top,%24skip,%24filter,%24count,%24orderby,%24select}", rawUrl) {
        }
        /// <summary>
