...
namespace MicrosoftGraphSdk.Users.Item.Calendar.CalendarView.Item.MultiValueExtendedProperties.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendar\calendarView\{event-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}</summary>
