...
namespace Microsoft.Graph.Beta.Users.Item.Calendar.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.SingleValueExtendedProperties.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendar/calendarView/{event_id}/exceptionOccurrences/{event_id1}/instances/{event_id2}/singleValueExtendedProperties/$count";
