...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Calendar?> PatchAsync(Microsoft.Graph.Beta.Models.Calendar body, CancellationToken cancellationToken = default, Action<CalendarRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Calendar> PatchAsync(Microsoft.Graph.Beta.Models.Calendar body, CancellationToken cancellationToken = default, Action<CalendarRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
