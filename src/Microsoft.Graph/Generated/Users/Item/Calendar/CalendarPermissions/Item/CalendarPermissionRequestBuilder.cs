...
namespace MicrosoftGraph.Users.Item.Calendar.CalendarPermissions.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendar\calendarPermissions\{calendarPermission-id}</summary>
    public class CalendarPermissionRequestBuilder {
        ...
        public CalendarPermissionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendar/calendarPermissions/{calendarPermission_id}{?select}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public CalendarPermissionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
