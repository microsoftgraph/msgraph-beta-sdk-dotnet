...
namespace Microsoft.Graph.Beta.Users.Item.Calendar.AllowedCalendarSharingRolesWithUser {
    ...
    public class AllowedCalendarSharingRolesWithUserRequestBuilder : BaseRequestBuilder {
        ...
        public AllowedCalendarSharingRolesWithUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string user = "") : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/allowedCalendarSharingRoles(User='{User}'){?%24top,%24skip,%24search,%24filter,%24count}", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AllowedCalendarSharingRolesWithUserRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/allowedCalendarSharingRoles(User='{User}'){?%24top,%24skip,%24search,%24filter,%24count}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<AllowedCalendarSharingRolesWithUserResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AllowedCalendarSharingRolesWithUserRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AllowedCalendarSharingRolesWithUserResponse> GetAsync(CancellationToken cancellationToken = default, Action<AllowedCalendarSharingRolesWithUserRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
