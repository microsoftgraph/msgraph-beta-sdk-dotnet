...
#nullable enable
        public async Task<PasswordValidationInformation?> PostAsync(ValidatePasswordPostRequestBody body, CancellationToken cancellationToken = default, Action<ValidatePasswordRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PasswordValidationInformation> PostAsync(ValidatePasswordPostRequestBody body, CancellationToken cancellationToken = default, Action<ValidatePasswordRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
