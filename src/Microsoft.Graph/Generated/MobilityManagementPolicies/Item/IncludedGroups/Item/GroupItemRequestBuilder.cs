...
namespace MicrosoftGraphSdk.MobilityManagementPolicies.Item.IncludedGroups.Item {
    ...
    public class GroupItemRequestBuilder {
        ...
        public GroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/mobilityManagementPolicies/{mobilityManagementPolicy_id}/includedGroups/{group_id}{?select,expand}";
