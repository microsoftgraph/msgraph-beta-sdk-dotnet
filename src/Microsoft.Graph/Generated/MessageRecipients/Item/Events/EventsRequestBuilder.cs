using Microsoft.Graph.Beta.MessageRecipients.Item.Events.Count;
using Microsoft.Graph.Beta.MessageRecipients.Item.Events.Item;
...
namespace Microsoft.Graph.Beta.MessageRecipients.Item.Events {
    ...
    public class EventsRequestBuilder : BaseRequestBuilder {
        ...
        public MessageEventItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("messageEvent%2Did", position);
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/messageRecipients/{messageRecipient%2Did}/events{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/messageRecipients/{messageRecipient%2Did}/events{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<MessageEventCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<EventsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MessageEventCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<EventsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<MessageEventCollectionResponse>(requestInfo, MessageEventCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MessageEvent?> PostAsync(MessageEvent body, CancellationToken cancellationToken = default, Action<EventsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MessageEvent> PostAsync(MessageEvent body, CancellationToken cancellationToken = default, Action<EventsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(MessageEvent body, Action<EventsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(MessageEvent body, Action<EventsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
