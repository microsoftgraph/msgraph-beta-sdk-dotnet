...
using Microsoft.Graph.Beta.AuditLogs.AuditActivityTypes;
...
using Microsoft.Graph.Beta.AuditLogs.SignInEventsAppSummary;
using Microsoft.Graph.Beta.AuditLogs.SignInEventsSummary;
...
namespace Microsoft.Graph.Beta.AuditLogs
{
    ...
    {
        /// <summary>Provides operations to manage the auditActivityTypes property of the microsoft.graph.auditLogRoot entity.</summary>
        public global::Microsoft.Graph.Beta.AuditLogs.AuditActivityTypes.AuditActivityTypesRequestBuilder AuditActivityTypes
        {
            get => new global::Microsoft.Graph.Beta.AuditLogs.AuditActivityTypes.AuditActivityTypesRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public global::Microsoft.Graph.Beta.AuditLogs.SignInEventsAppSummary.SignInEventsAppSummaryRequestBuilder SignInEventsAppSummary
        {
            get => new global::Microsoft.Graph.Beta.AuditLogs.SignInEventsAppSummary.SignInEventsAppSummaryRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the signInEventsSummary property of the microsoft.graph.auditLogRoot entity.</summary>
        public global::Microsoft.Graph.Beta.AuditLogs.SignInEventsSummary.SignInEventsSummaryRequestBuilder SignInEventsSummary
        {
            get => new global::Microsoft.Graph.Beta.AuditLogs.SignInEventsSummary.SignInEventsSummaryRequestBuilder(PathParameters, RequestAdapter);
        }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.AuditLogs.GetSummarizedMSISignInsWithAggregationWindow.GetSummarizedMSISignInsWithAggregationWindowRequestBuilder"/></returns>
        /// <param name="aggregationWindow">Usage: aggregationWindow=&apos;{aggregationWindow}&apos;</param>
        public global::Microsoft.Graph.Beta.AuditLogs.GetSummarizedMSISignInsWithAggregationWindow.GetSummarizedMSISignInsWithAggregationWindowRequestBuilder GetSummarizedMSISignInsWithAggregationWindow(string aggregationWindow)
        {
            if(string.IsNullOrEmpty(aggregationWindow)) throw new ArgumentNullException(nameof(aggregationWindow));
            return new global::Microsoft.Graph.Beta.AuditLogs.GetSummarizedMSISignInsWithAggregationWindow.GetSummarizedMSISignInsWithAggregationWindowRequestBuilder(PathParameters, RequestAdapter, aggregationWindow);
        }
        /// <summary>
        /// Provides operations to call the getSummarizedNonInteractiveSignIns method.
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.AuditLogs.GetSummarizedNonInteractiveSignInsWithAggregationWindow.GetSummarizedNonInteractiveSignInsWithAggregationWindowRequestBuilder"/></returns>
        /// <param name="aggregationWindow">Usage: aggregationWindow=&apos;{aggregationWindow}&apos;</param>
        public global::Microsoft.Graph.Beta.AuditLogs.GetSummarizedNonInteractiveSignInsWithAggregationWindow.GetSummarizedNonInteractiveSignInsWithAggregationWindowRequestBuilder GetSummarizedNonInteractiveSignInsWithAggregationWindow(string aggregationWindow)
        {
            if(string.IsNullOrEmpty(aggregationWindow)) throw new ArgumentNullException(nameof(aggregationWindow));
            return new global::Microsoft.Graph.Beta.AuditLogs.GetSummarizedNonInteractiveSignInsWithAggregationWindow.GetSummarizedNonInteractiveSignInsWithAggregationWindowRequestBuilder(PathParameters, RequestAdapter, aggregationWindow);
        }
        /// <summary>
        /// Provides operations to call the getSummarizedServicePrincipalSignIns method.
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.AuditLogs.GetSummarizedServicePrincipalSignInsWithAggregationWindow.GetSummarizedServicePrincipalSignInsWithAggregationWindowRequestBuilder"/></returns>
        /// <param name="aggregationWindow">Usage: aggregationWindow=&apos;{aggregationWindow}&apos;</param>
        public global::Microsoft.Graph.Beta.AuditLogs.GetSummarizedServicePrincipalSignInsWithAggregationWindow.GetSummarizedServicePrincipalSignInsWithAggregationWindowRequestBuilder GetSummarizedServicePrincipalSignInsWithAggregationWindow(string aggregationWindow)
        {
            if(string.IsNullOrEmpty(aggregationWindow)) throw new ArgumentNullException(nameof(aggregationWindow));
            return new global::Microsoft.Graph.Beta.AuditLogs.GetSummarizedServicePrincipalSignInsWithAggregationWindow.GetSummarizedServicePrincipalSignInsWithAggregationWindowRequestBuilder(PathParameters, RequestAdapter, aggregationWindow);
        }
        /// <summary>
        /// Update auditLogs
        /// </summary>
