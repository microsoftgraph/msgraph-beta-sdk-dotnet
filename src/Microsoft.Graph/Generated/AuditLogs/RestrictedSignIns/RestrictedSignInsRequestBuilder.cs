...
namespace MicrosoftGraph.AuditLogs.RestrictedSignIns {
    ...
    public class RestrictedSignInsRequestBuilder {
        ...
        public RestrictedSignInsRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("restrictedSignIn_id", position);
            return new RestrictedSignInsRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public async Task<RestrictedSignInsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<RestrictedSignInsResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to restrictedSignIns for auditLogs
        /// <param name="body"></param>
