...
using System;
namespace Microsoft.Graph.Beta.AuditLogs.DirectoryProvisioning.Item {
    /// <summary>
    ...
    public class ProvisioningObjectSummaryItemRequestBuilder : BaseRequestBuilder {
        ...
        public ProvisioningObjectSummaryItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/auditLogs/directoryProvisioning/{provisioningObjectSummary%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ProvisioningObjectSummaryItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProvisioningObjectSummaryItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/auditLogs/directoryProvisioning/{provisioningObjectSummary%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
