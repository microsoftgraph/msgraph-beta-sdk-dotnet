...
namespace Microsoft.Graph.Beta.AuditLogs.SignIns {
    ...
    public class SignInsRequestBuilder : BaseRequestBuilder {
        ...
        public SignInsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/auditLogs/signIns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SignInsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<SignInCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SignInsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SignInCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SignInsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SignIn?> PostAsync(SignIn body, CancellationToken cancellationToken = default, Action<SignInsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SignIn> PostAsync(SignIn body, CancellationToken cancellationToken = default, Action<SignInsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
