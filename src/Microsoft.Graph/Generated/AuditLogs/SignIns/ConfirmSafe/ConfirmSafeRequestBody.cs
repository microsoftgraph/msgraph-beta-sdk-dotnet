...
namespace Microsoft.Graph.Beta.AuditLogs.SignIns.ConfirmSafe {
    ...
    public class ConfirmSafeRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ConfirmSafeRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
