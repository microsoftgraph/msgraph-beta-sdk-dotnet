...
namespace Microsoft.Graph.Beta.AuditLogs.SignIns.ConfirmSafe
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.AuditLogs.SignIns.ConfirmSafe.ConfirmSafeRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(global::Microsoft.Graph.Beta.AuditLogs.SignIns.ConfirmSafe.ConfirmSafePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(global::Microsoft.Graph.Beta.AuditLogs.SignIns.ConfirmSafe.ConfirmSafePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Microsoft.Graph.Beta.AuditLogs.SignIns.ConfirmSafe.ConfirmSafePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Microsoft.Graph.Beta.AuditLogs.SignIns.ConfirmSafe.ConfirmSafePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.AuditLogs.SignIns.ConfirmSafe.ConfirmSafeRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Beta.AuditLogs.SignIns.ConfirmSafe.ConfirmSafeRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Beta.AuditLogs.SignIns.ConfirmSafe.ConfirmSafeRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
