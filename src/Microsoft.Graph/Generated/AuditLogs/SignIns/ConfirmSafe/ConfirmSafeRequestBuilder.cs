...
#nullable enable
        public async Task PostAsync(ConfirmSafePostRequestBody body, CancellationToken cancellationToken = default, Action<ConfirmSafeRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(ConfirmSafePostRequestBody body, CancellationToken cancellationToken = default, Action<ConfirmSafeRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
