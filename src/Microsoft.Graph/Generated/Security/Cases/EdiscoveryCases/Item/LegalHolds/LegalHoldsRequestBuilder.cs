...
#nullable enable
        public async Task<EdiscoveryHoldPolicyCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<LegalHoldsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EdiscoveryHoldPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<LegalHoldsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EdiscoveryHoldPolicy?> PostAsync(EdiscoveryHoldPolicy body, CancellationToken cancellationToken = default, Action<LegalHoldsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EdiscoveryHoldPolicy> PostAsync(EdiscoveryHoldPolicy body, CancellationToken cancellationToken = default, Action<LegalHoldsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
