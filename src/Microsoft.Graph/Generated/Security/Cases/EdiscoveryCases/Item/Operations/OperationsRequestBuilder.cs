...
using Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Operations.Count;
using Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Operations.Item;
...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.security.cases.ediscoveryCases.item.operations.item collection</summary>
        ...
        public OperationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CaseOperation body, Action<OperationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<CaseOperationCollectionResponse> GetAsync(Action<OperationsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<CaseOperation> PostAsync(CaseOperation body, Action<OperationsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
