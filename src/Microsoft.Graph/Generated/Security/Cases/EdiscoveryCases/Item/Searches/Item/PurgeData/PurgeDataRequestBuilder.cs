...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Searches.Item.PurgeData {
    ...
    public class PurgeDataRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<PurgeDataRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
