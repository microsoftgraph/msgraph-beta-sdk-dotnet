...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Searches.Item.MicrosoftGraphSecurityEstimateStatistics {
    ...
    /// </summary>
    public class MicrosoftGraphSecurityEstimateStatisticsRequestBuilder {
        ...
        public MicrosoftGraphSecurityEstimateStatisticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphSecurityEstimateStatisticsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
