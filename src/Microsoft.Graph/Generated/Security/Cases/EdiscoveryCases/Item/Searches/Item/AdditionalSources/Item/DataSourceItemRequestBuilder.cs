...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.DataSource?> GetAsync(CancellationToken cancellationToken = default, Action<DataSourceItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.DataSource> GetAsync(CancellationToken cancellationToken = default, Action<DataSourceItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.DataSource?> PatchAsync(Microsoft.Graph.Beta.Models.Security.DataSource body, CancellationToken cancellationToken = default, Action<DataSourceItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.DataSource> PatchAsync(Microsoft.Graph.Beta.Models.Security.DataSource body, CancellationToken cancellationToken = default, Action<DataSourceItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
