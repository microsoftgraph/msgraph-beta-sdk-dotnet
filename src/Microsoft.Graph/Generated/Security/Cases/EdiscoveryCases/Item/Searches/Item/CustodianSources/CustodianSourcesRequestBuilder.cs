...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Searches.Item.CustodianSources {
    ...
    public class CustodianSourcesRequestBuilder {
        ...
        /// </summary>
        public async Task<DataSourceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CustodianSourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
