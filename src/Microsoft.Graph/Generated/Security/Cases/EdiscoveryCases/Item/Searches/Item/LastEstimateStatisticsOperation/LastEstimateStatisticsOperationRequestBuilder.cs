...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Searches.Item.LastEstimateStatisticsOperation {
    ...
    public class LastEstimateStatisticsOperationRequestBuilder {
        ...
        public LastEstimateStatisticsOperationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}/lastEstimateStatisticsOperation{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<EdiscoveryEstimateOperation> GetAsync(Action<LastEstimateStatisticsOperationRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
