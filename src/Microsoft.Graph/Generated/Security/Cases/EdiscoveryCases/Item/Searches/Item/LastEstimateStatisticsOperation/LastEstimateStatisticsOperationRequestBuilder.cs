...
#nullable enable
        public async Task<EdiscoveryEstimateOperation?> GetAsync(Action<RequestConfiguration<LastEstimateStatisticsOperationRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<EdiscoveryEstimateOperation> GetAsync(Action<RequestConfiguration<LastEstimateStatisticsOperationRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="LastEstimateStatisticsOperationRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class LastEstimateStatisticsOperationRequestBuilderGetRequestConfiguration : RequestConfiguration<LastEstimateStatisticsOperationRequestBuilderGetQueryParameters> 
        {
        }
    }
}
