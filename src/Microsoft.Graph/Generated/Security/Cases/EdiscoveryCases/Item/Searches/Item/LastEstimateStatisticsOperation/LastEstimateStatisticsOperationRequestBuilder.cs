...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Searches.Item.LastEstimateStatisticsOperation {
    ...
    public class LastEstimateStatisticsOperationRequestBuilder {
        ...
        /// </summary>
        public async Task<EdiscoveryEstimateOperation> GetAsync(CancellationToken cancellationToken = default, Action<LastEstimateStatisticsOperationRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
