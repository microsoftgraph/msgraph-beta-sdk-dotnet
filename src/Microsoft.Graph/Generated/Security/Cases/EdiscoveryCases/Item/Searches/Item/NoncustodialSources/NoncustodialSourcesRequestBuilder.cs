...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Searches.Item.NoncustodialSources {
    ...
    public class NoncustodialSourcesRequestBuilder {
        ...
        /// </summary>
        public async Task<EdiscoveryNoncustodialDataSourceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<NoncustodialSourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
