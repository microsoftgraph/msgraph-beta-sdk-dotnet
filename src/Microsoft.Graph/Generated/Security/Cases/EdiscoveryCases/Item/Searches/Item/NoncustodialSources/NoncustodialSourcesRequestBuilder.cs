...
using Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Searches.Item.NoncustodialSources.Count;
using Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Searches.Item.NoncustodialSources.Item;
...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Searches.Item.NoncustodialSources {
    ...
    public class NoncustodialSourcesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.security.cases.ediscoveryCases.item.searches.item.noncustodialSources.item collection</summary>
        ...
        public NoncustodialSourcesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}/noncustodialSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public async Task<EdiscoveryNoncustodialDataSourceCollectionResponse> GetAsync(Action<NoncustodialSourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <summary>Get noncustodialSources from security</summary>
