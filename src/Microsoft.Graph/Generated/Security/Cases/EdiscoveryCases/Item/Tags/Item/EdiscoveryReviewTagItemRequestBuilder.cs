...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EdiscoveryReviewTagItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EdiscoveryReviewTagItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EdiscoveryReviewTag?> GetAsync(CancellationToken cancellationToken = default, Action<EdiscoveryReviewTagItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EdiscoveryReviewTag> GetAsync(CancellationToken cancellationToken = default, Action<EdiscoveryReviewTagItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EdiscoveryReviewTag?> PatchAsync(EdiscoveryReviewTag body, CancellationToken cancellationToken = default, Action<EdiscoveryReviewTagItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EdiscoveryReviewTag> PatchAsync(EdiscoveryReviewTag body, CancellationToken cancellationToken = default, Action<EdiscoveryReviewTagItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
