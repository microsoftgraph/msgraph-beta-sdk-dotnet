...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Tags.Item.ChildTags {
    ...
    public class ChildTagsRequestBuilder : BaseRequestBuilder {
        ...
        /// <returns>A <cref="Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Tags.Item.ChildTags.Item.EdiscoveryReviewTagItemRequestBuilder"></returns>
        ...
        /// </summary>
        /// <returns>A <cref="EdiscoveryReviewTagCollectionResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EdiscoveryReviewTagCollectionResponse?> GetAsync(Action<RequestConfiguration<ChildTagsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<EdiscoveryReviewTagCollectionResponse> GetAsync(Action<RequestConfiguration<ChildTagsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="ChildTagsRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public ChildTagsRequestBuilder WithUrl(string rawUrl) {
...
#nullable restore
        ...
        public class ChildTagsRequestBuilderGetRequestConfiguration : RequestConfiguration<ChildTagsRequestBuilderGetQueryParameters> {
        }
    }
}
