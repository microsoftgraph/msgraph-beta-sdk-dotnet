...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Custodians.Item.UnifiedGroupSources.Item.Group {
    ...
    public class GroupRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Group> GetAsync(CancellationToken cancellationToken = default, Action<GroupRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
