...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Custodians.Item.SecurityRelease {
    ...
    /// </summary>
    public class SecurityReleaseRequestBuilder {
        ...
        public SecurityReleaseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/security.release";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecurityReleaseRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
