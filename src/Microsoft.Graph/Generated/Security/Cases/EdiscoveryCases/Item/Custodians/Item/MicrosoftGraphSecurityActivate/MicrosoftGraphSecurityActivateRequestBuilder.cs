...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Custodians.Item.MicrosoftGraphSecurityActivate {
    ...
    public class MicrosoftGraphSecurityActivateRequestBuilder {
        ...
        public MicrosoftGraphSecurityActivateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphSecurityActivateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
