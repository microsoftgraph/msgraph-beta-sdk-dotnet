...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.ReviewSets.Item.Files.Item.Custodian {
    ...
    public class CustodianRequestBuilder {
        ...
        /// </summary>
        public async Task<EdiscoveryCustodian> GetAsync(CancellationToken cancellationToken = default, Action<CustodianRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
