...
#nullable enable
        public async Task<EdiscoveryCustodian?> GetAsync(CancellationToken cancellationToken = default, Action<CustodianRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EdiscoveryCustodian> GetAsync(CancellationToken cancellationToken = default, Action<CustodianRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
