...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.Reopen {
    ...
    public class ReopenRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<ReopenRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
