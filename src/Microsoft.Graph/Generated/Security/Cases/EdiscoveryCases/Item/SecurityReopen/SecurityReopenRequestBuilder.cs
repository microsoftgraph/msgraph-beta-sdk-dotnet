...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.SecurityReopen {
    ...
    public class SecurityReopenRequestBuilder {
        ...
        public SecurityReopenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecurityReopenRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
