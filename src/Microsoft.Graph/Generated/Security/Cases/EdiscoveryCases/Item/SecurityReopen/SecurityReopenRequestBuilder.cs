...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.SecurityReopen {
    /// <summary>
    /// Provides operations to call the reopen method.
    /// </summary>
    public class SecurityReopenRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new SecurityReopenRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecurityReopenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/security.reopen", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SecurityReopenRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecurityReopenRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/security.reopen", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(Action<SecurityReopenRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(Action<SecurityReopenRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
