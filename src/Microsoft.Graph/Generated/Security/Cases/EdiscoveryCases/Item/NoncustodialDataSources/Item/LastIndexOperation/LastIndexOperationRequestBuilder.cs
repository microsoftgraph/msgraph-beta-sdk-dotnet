...
namespace Microsoft.Graph.Beta.Security.Cases.EdiscoveryCases.Item.NoncustodialDataSources.Item.LastIndexOperation {
    ...
    public class LastIndexOperationRequestBuilder {
        ...
        /// </summary>
        public async Task<EdiscoveryIndexOperation> GetAsync(CancellationToken cancellationToken = default, Action<LastIndexOperationRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
