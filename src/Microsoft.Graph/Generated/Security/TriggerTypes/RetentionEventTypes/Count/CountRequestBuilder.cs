...
namespace Microsoft.Graph.Beta.Security.TriggerTypes.RetentionEventTypes.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/security/triggerTypes/retentionEventTypes/$count{?%24search,%24filter}";
