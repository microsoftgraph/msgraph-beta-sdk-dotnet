...
namespace Microsoft.Graph.Beta.Security.SubjectRightsRequests.Item.Notes.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/notes/$count{?%24search,%24filter}";
