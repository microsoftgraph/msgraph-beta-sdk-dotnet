...
namespace Microsoft.Graph.Beta.Security.SubjectRightsRequests.Item.Notes.Item {
    ...
    public class AuthoredNoteItemRequestBuilder {
        ...
        public AuthoredNoteItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/notes/{authoredNote%2Did}{?%24select,%24expand}";
