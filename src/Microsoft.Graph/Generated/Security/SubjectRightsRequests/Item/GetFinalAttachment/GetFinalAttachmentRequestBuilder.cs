...
namespace Microsoft.Graph.Beta.Security.SubjectRightsRequests.Item.GetFinalAttachment {
    ...
    public class GetFinalAttachmentRequestBuilder {
        ...
        public GetFinalAttachmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/microsoft.graph.getFinalAttachment()";
        ...
        /// </summary>
        public async Task<GetFinalAttachmentResponse> GetAsync(Action<GetFinalAttachmentRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<GetFinalAttachmentResponse>(requestInfo, GetFinalAttachmentResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
