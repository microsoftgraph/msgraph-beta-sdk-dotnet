...
namespace Microsoft.Graph.Beta.Security.SubjectRightsRequests.Item.GetFinalAttachment {
    ...
    public class GetFinalAttachmentRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetFinalAttachmentRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
