...
namespace Microsoft.Graph.Beta.Security.SubjectRightsRequests.Item.Team {
    /// <summary>
    ...
    public class TeamRequestBuilder {
        ...
        public TeamRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/team{?%24select,%24expand}";
