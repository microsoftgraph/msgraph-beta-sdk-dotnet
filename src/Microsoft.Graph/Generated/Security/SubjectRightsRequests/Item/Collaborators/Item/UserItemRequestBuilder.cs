...
namespace Microsoft.Graph.Beta.Security.SubjectRightsRequests.Item.Collaborators.Item {
    /// <summary>
    ...
    public class UserItemRequestBuilder {
        ...
        public UserItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/collaborators/{user%2Did}{?%24select,%24expand}";
