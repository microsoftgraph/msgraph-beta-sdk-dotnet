...
namespace Microsoft.Graph.Beta.Security.SubjectRightsRequests.Item.GetFinalReport {
    ...
    public class GetFinalReportRequestBuilder {
        ...
        public GetFinalReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/microsoft.graph.getFinalReport()";
        ...
        /// </summary>
        public async Task<GetFinalReportResponse> GetAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(headers, options);
            return await RequestAdapter.SendAsync<GetFinalReportResponse>(requestInfo, GetFinalReportResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
    }
}
