...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Alert?> PostAsync(Microsoft.Graph.Beta.Models.Alert body, CancellationToken cancellationToken = default, Action<AlertsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Alert> PostAsync(Microsoft.Graph.Beta.Models.Alert body, CancellationToken cancellationToken = default, Action<AlertsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Models.Alert body, Action<AlertsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Models.Alert body, Action<AlertsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
