...
namespace Microsoft.Graph.Beta.Security.Alerts {
    ...
    public class AlertsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Alert> PostAsync(Alert body, CancellationToken cancellationToken = default, Action<AlertsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
