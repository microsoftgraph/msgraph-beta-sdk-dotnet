...
namespace MicrosoftGraphSdk.Security.Alerts.UpdateAlerts {
    ...
    public class UpdateAlertsResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static UpdateAlertsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UpdateAlertsResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as UpdateAlertsResponse).Value = n.GetCollectionOfObjectValues<Alert>(Alert.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
