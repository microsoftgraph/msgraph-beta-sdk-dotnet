...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.Alert?> GetAsync(CancellationToken cancellationToken = default, Action<AlertItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.Alert> GetAsync(CancellationToken cancellationToken = default, Action<AlertItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.Alert?> PatchAsync(Microsoft.Graph.Beta.Models.Security.Alert body, CancellationToken cancellationToken = default, Action<AlertItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.Alert> PatchAsync(Microsoft.Graph.Beta.Models.Security.Alert body, CancellationToken cancellationToken = default, Action<AlertItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
