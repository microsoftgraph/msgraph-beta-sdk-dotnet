...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.Security.DomainSecurityProfiles {
    public class DomainSecurityProfilesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DomainSecurityProfilesResponse).Value = n.GetCollectionOfObjectValues<DomainSecurityProfile>().ToList(); } },
            };
        }
        /// <summary>
