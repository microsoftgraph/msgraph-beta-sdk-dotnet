...
namespace MicrosoftGraphSdk.Security.TiIndicators.DeleteTiIndicatorsByExternalId {
    ...
    public class DeleteTiIndicatorsByExternalIdResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static DeleteTiIndicatorsByExternalIdResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as DeleteTiIndicatorsByExternalIdResponse).Value = n.GetCollectionOfObjectValues<ResultInfo>(ResultInfo.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
