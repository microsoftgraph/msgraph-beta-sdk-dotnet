...
namespace MicrosoftGraphSdk.Security.TiIndicators.UpdateTiIndicators {
    ...
    public class UpdateTiIndicatorsRequestBody : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as UpdateTiIndicatorsRequestBody).Value = n.GetCollectionOfObjectValues<TiIndicator>(TiIndicator.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
