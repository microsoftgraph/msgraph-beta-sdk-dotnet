...
namespace Microsoft.Graph.Beta.Security.TiIndicators.DeleteTiIndicators {
    ...
    public class DeleteTiIndicatorsRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DeleteTiIndicatorsRequestBody body, Action<DeleteTiIndicatorsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<DeleteTiIndicatorsResponse> PostAsync(DeleteTiIndicatorsRequestBody body, Action<DeleteTiIndicatorsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
