...
#nullable enable
        public async Task<DeleteTiIndicatorsPostResponse?> PostAsDeleteTiIndicatorsPostResponseAsync(DeleteTiIndicatorsPostRequestBody body, Action<DeleteTiIndicatorsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<DeleteTiIndicatorsPostResponse> PostAsDeleteTiIndicatorsPostResponseAsync(DeleteTiIndicatorsPostRequestBody body, Action<DeleteTiIndicatorsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
