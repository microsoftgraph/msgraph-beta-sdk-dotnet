...
namespace Microsoft.Graph.Beta.Security.TiIndicators.DeleteTiIndicators {
    ...
    public class DeleteTiIndicatorsResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static DeleteTiIndicatorsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as DeleteTiIndicatorsResponse).Value = n.GetCollectionOfObjectValues<ResultInfo>(ResultInfo.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
