...
namespace MicrosoftGraphSdk.Security.TiIndicators {
    ...
    public class TiIndicatorsRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(TiIndicator body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
