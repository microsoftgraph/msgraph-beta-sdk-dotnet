...
#nullable enable
        public async Task<TiIndicatorCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TiIndicatorsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TiIndicatorCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TiIndicatorsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TiIndicator?> PostAsync(TiIndicator body, CancellationToken cancellationToken = default, Action<TiIndicatorsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TiIndicator> PostAsync(TiIndicator body, CancellationToken cancellationToken = default, Action<TiIndicatorsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<TiIndicatorsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<TiIndicatorsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(TiIndicator body, Action<TiIndicatorsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(TiIndicator body, Action<TiIndicatorsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
