...
#nullable enable
        public async Task<SubmitTiIndicatorsPostResponse?> PostAsSubmitTiIndicatorsPostResponseAsync(SubmitTiIndicatorsPostRequestBody body, Action<SubmitTiIndicatorsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<SubmitTiIndicatorsPostResponse> PostAsSubmitTiIndicatorsPostResponseAsync(SubmitTiIndicatorsPostRequestBody body, Action<SubmitTiIndicatorsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
