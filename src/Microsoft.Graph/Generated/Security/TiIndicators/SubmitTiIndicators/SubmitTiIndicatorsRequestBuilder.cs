...
#nullable enable
        public async Task<SubmitTiIndicatorsResponse?> PostAsync(SubmitTiIndicatorsPostRequestBody body, CancellationToken cancellationToken = default, Action<SubmitTiIndicatorsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SubmitTiIndicatorsResponse> PostAsync(SubmitTiIndicatorsPostRequestBody body, CancellationToken cancellationToken = default, Action<SubmitTiIndicatorsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
