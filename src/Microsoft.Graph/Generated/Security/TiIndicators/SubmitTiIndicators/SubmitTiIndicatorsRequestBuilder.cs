...
namespace Microsoft.Graph.Beta.Security.TiIndicators.SubmitTiIndicators {
    ...
    public class SubmitTiIndicatorsRequestBuilder {
        ...
        /// </summary>
        public async Task<SubmitTiIndicatorsResponse> PostAsync(SubmitTiIndicatorsPostRequestBody body, CancellationToken cancellationToken = default, Action<SubmitTiIndicatorsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<SubmitTiIndicatorsResponse>(requestInfo, SubmitTiIndicatorsResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
