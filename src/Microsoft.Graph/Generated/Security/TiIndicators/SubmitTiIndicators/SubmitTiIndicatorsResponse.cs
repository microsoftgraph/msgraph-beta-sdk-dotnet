...
namespace Microsoft.Graph.Beta.Security.TiIndicators.SubmitTiIndicators {
    ...
    public class SubmitTiIndicatorsResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static SubmitTiIndicatorsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as SubmitTiIndicatorsResponse).Value = n.GetCollectionOfObjectValues<TiIndicator>(TiIndicator.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
