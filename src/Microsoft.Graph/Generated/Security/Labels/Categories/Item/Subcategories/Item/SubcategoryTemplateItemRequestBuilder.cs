...
namespace Microsoft.Graph.Beta.Security.Labels.Categories.Item.Subcategories.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Security.Labels.Categories.Item.Subcategories.Item.SubcategoryTemplateItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.SubcategoryTemplate?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Security.Labels.Categories.Item.Subcategories.Item.SubcategoryTemplateItemRequestBuilder.SubcategoryTemplateItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.SubcategoryTemplate> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Security.Labels.Categories.Item.Subcategories.Item.SubcategoryTemplateItemRequestBuilder.SubcategoryTemplateItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.SubcategoryTemplate?> PatchAsync(Microsoft.Graph.Beta.Models.Security.SubcategoryTemplate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.SubcategoryTemplate> PatchAsync(Microsoft.Graph.Beta.Models.Security.SubcategoryTemplate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Security.Labels.Categories.Item.Subcategories.Item.SubcategoryTemplateItemRequestBuilder.SubcategoryTemplateItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Security.Labels.Categories.Item.Subcategories.Item.SubcategoryTemplateItemRequestBuilder.SubcategoryTemplateItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Beta.Models.Security.SubcategoryTemplate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Beta.Models.Security.SubcategoryTemplate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Security.Labels.Categories.Item.Subcategories.Item.SubcategoryTemplateItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Security.Labels.Categories.Item.Subcategories.Item.SubcategoryTemplateItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class SubcategoryTemplateItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.Security.Labels.Categories.Item.Subcategories.Item.SubcategoryTemplateItemRequestBuilder.SubcategoryTemplateItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
