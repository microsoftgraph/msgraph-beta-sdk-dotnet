...
namespace Microsoft.Graph.Beta.Security.Labels.Authorities
{
    ...
    public class AuthoritiesRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.Security.Labels.Authorities.Count.CountRequestBuilder Count
        {
            get => new Microsoft.Graph.Beta.Security.Labels.Authorities.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Microsoft.Graph.Beta.Security.Labels.Authorities.Item.AuthorityTemplateItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("authorityTemplate%2Did", position);
                return new Microsoft.Graph.Beta.Security.Labels.Authorities.Item.AuthorityTemplateItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Security.Labels.Authorities.AuthoritiesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Models.Security.AuthorityTemplateCollectionResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="Microsoft.Graph.Beta.Models.ODataErrors.ODataError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.AuthorityTemplateCollectionResponse?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Security.Labels.Authorities.AuthoritiesRequestBuilder.AuthoritiesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.AuthorityTemplateCollectionResponse> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Security.Labels.Authorities.AuthoritiesRequestBuilder.AuthoritiesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Beta.Models.Security.AuthorityTemplateCollectionResponse>(requestInfo, Microsoft.Graph.Beta.Models.Security.AuthorityTemplateCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Security.Labels.Authorities.AuthoritiesRequestBuilder.AuthoritiesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Security.Labels.Authorities.AuthoritiesRequestBuilder.AuthoritiesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Security.Labels.Authorities.AuthoritiesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Security.Labels.Authorities.AuthoritiesRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Security.Labels.Authorities.AuthoritiesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get a list of the authorityTemplate objects and their properties.
        /// </summary>
...
#nullable restore
        ...
        public class AuthoritiesRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.Security.Labels.Authorities.AuthoritiesRequestBuilder.AuthoritiesRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
