...
namespace Microsoft.Graph.Beta.Security.Labels.RetentionLabels {
    ...
    public class RetentionLabelsRequestBuilder {
        ...
        /// </summary>
        public async Task<RetentionLabelCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RetentionLabelsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<RetentionLabel> PostAsync(RetentionLabel body, CancellationToken cancellationToken = default, Action<RetentionLabelsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
