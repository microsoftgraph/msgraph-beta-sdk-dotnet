...
using System;
namespace Microsoft.Graph.Beta.Security.Labels.RetentionLabels.Item.Descriptors.CitationTemplate {
    /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.CitationTemplate?> GetAsync(Action<CitationTemplateRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.CitationTemplate> GetAsync(Action<CitationTemplateRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<CitationTemplateRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<CitationTemplateRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new CitationTemplateRequestBuilderGetRequestConfiguration();
...
#nullable restore
        ...
        /// </summary>
        public class CitationTemplateRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public CitationTemplateRequestBuilderGetQueryParameters QueryParameters { get; set; } = new CitationTemplateRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new citationTemplateRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public CitationTemplateRequestBuilderGetRequestConfiguration() {
