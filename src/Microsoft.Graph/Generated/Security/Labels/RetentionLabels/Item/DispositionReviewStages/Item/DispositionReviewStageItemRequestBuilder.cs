...
namespace Microsoft.Graph.Beta.Security.Labels.RetentionLabels.Item.DispositionReviewStages.Item {
    ...
    public class DispositionReviewStageItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DispositionReviewStageItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DispositionReviewStage> GetAsync(CancellationToken cancellationToken = default, Action<DispositionReviewStageItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DispositionReviewStage body, CancellationToken cancellationToken = default, Action<DispositionReviewStageItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
