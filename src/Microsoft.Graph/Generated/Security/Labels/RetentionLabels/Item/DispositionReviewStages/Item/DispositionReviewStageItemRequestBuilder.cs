...
namespace Microsoft.Graph.Beta.Security.Labels.RetentionLabels.Item.DispositionReviewStages.Item {
    ...
    public class DispositionReviewStageItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DispositionReviewStage body, Action<DispositionReviewStageItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
