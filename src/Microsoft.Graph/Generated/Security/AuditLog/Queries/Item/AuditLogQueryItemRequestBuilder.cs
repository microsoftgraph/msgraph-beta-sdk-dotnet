...
namespace Microsoft.Graph.Beta.Security.AuditLog.Queries.Item {
    ...
    public class AuditLogQueryItemRequestBuilder : BaseRequestBuilder {
        ...
        public AuditLogQueryItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/auditLog/queries/{auditLogQuery%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AuditLogQueryItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AuditLogQueryItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/auditLog/queries/{auditLogQuery%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class AuditLogQueryItemRequestBuilderPatchRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
