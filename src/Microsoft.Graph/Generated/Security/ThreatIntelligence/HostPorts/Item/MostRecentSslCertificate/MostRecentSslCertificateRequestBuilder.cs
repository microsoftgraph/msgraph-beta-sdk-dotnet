...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.SslCertificate?> GetAsync(Action<MostRecentSslCertificateRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.SslCertificate> GetAsync(Action<MostRecentSslCertificateRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
