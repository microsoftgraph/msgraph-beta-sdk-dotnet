...
using System;
namespace Microsoft.Graph.Beta.Security.ThreatIntelligence.ArticleIndicators.Item.Artifact {
    /// <summary>
    ...
    public class ArtifactRequestBuilder : BaseRequestBuilder {
        ...
        public ArtifactRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/articleIndicators/{articleIndicator%2Did}/artifact{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ArtifactRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ArtifactRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/articleIndicators/{articleIndicator%2Did}/artifact{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.Artifact?> GetAsync(CancellationToken cancellationToken = default, Action<ArtifactRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.Artifact> GetAsync(CancellationToken cancellationToken = default, Action<ArtifactRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
