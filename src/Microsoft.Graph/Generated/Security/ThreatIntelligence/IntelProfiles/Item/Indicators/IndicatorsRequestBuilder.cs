...
#nullable enable
        public async Task<IntelligenceProfileIndicatorCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<IndicatorsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IntelligenceProfileIndicatorCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<IndicatorsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
