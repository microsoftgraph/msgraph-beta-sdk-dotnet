...
using System;
namespace Microsoft.Graph.Beta.Security.ThreatIntelligence.HostTrackers.Item.Host {
    /// <summary>
    ...
    public class HostRequestBuilder : BaseRequestBuilder {
        ...
        public HostRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/hostTrackers/{hostTracker%2Did}/host{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HostRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HostRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/hostTrackers/{hostTracker%2Did}/host{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.Host?> GetAsync(CancellationToken cancellationToken = default, Action<HostRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.Host> GetAsync(CancellationToken cancellationToken = default, Action<HostRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
