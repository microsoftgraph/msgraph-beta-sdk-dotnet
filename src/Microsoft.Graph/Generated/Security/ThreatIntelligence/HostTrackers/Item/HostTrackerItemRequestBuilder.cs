...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<HostTrackerItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<HostTrackerItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<HostTracker?> GetAsync(CancellationToken cancellationToken = default, Action<HostTrackerItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<HostTracker> GetAsync(CancellationToken cancellationToken = default, Action<HostTrackerItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<HostTracker?> PatchAsync(HostTracker body, CancellationToken cancellationToken = default, Action<HostTrackerItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<HostTracker> PatchAsync(HostTracker body, CancellationToken cancellationToken = default, Action<HostTrackerItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
