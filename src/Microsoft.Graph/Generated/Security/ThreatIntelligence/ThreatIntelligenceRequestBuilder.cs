...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ThreatIntelligenceRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ThreatIntelligenceRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.ThreatIntelligence?> GetAsync(CancellationToken cancellationToken = default, Action<ThreatIntelligenceRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.ThreatIntelligence> GetAsync(CancellationToken cancellationToken = default, Action<ThreatIntelligenceRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.ThreatIntelligence?> PatchAsync(Microsoft.Graph.Beta.Models.Security.ThreatIntelligence body, CancellationToken cancellationToken = default, Action<ThreatIntelligenceRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.ThreatIntelligence> PatchAsync(Microsoft.Graph.Beta.Models.Security.ThreatIntelligence body, CancellationToken cancellationToken = default, Action<ThreatIntelligenceRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
