...
using System;
namespace Microsoft.Graph.Beta.Security.ThreatIntelligence.HostPairs.Item.ChildHost {
    /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Security.Host?> GetAsync(Action<ChildHostRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Security.Host> GetAsync(Action<ChildHostRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<ChildHostRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<ChildHostRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ChildHostRequestBuilderGetRequestConfiguration();
...
#nullable restore
        ...
        /// </summary>
        public class ChildHostRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public ChildHostRequestBuilderGetQueryParameters QueryParameters { get; set; } = new ChildHostRequestBuilderGetQueryParameters();
            /// <summary>
