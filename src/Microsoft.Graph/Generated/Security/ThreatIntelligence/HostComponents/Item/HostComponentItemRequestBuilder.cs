...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<HostComponentItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<HostComponentItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<HostComponent?> GetAsync(CancellationToken cancellationToken = default, Action<HostComponentItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<HostComponent> GetAsync(CancellationToken cancellationToken = default, Action<HostComponentItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<HostComponent?> PatchAsync(HostComponent body, CancellationToken cancellationToken = default, Action<HostComponentItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<HostComponent> PatchAsync(HostComponent body, CancellationToken cancellationToken = default, Action<HostComponentItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
