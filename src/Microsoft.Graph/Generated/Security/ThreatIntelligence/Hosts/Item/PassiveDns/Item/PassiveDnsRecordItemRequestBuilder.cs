...
using System;
namespace Microsoft.Graph.Beta.Security.ThreatIntelligence.Hosts.Item.PassiveDns.Item {
    /// <summary>
    ...
    public class PassiveDnsRecordItemRequestBuilder : BaseRequestBuilder {
        ...
        public PassiveDnsRecordItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/passiveDns/{passiveDnsRecord%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PassiveDnsRecordItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PassiveDnsRecordItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/passiveDns/{passiveDnsRecord%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<PassiveDnsRecord?> GetAsync(CancellationToken cancellationToken = default, Action<PassiveDnsRecordItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PassiveDnsRecord> GetAsync(CancellationToken cancellationToken = default, Action<PassiveDnsRecordItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
