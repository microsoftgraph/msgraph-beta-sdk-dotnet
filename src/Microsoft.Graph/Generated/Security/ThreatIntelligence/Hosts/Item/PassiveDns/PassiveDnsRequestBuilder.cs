...
namespace Microsoft.Graph.Beta.Security.ThreatIntelligence.Hosts.Item.PassiveDns {
    ...
    public class PassiveDnsRequestBuilder : BaseRequestBuilder {
        ...
        public PassiveDnsRecordItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("passiveDnsRecord%2Did", position);
...
#nullable enable
        public async Task<PassiveDnsRecordCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<PassiveDnsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PassiveDnsRecordCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PassiveDnsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
