...
#nullable enable
        public async Task<HostCookie?> GetAsync(CancellationToken cancellationToken = default, Action<HostCookieItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<HostCookie> GetAsync(CancellationToken cancellationToken = default, Action<HostCookieItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
