...
using Microsoft.Graph.Beta.Security.ThreatIntelligence.Hosts.Item.Subdomains.Count;
using Microsoft.Graph.Beta.Security.ThreatIntelligence.Hosts.Item.Subdomains.Item;
...
using System;
namespace Microsoft.Graph.Beta.Security.ThreatIntelligence.Hosts.Item.Subdomains {
    /// <summary>
    ...
    public class SubdomainsRequestBuilder : BaseRequestBuilder {
        ...
        public SubdomainItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("subdomain%2Did", position);
        ...
        public SubdomainsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/subdomains{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SubdomainsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SubdomainsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/subdomains{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the list of subdomain resources associated with a host.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/security-host-list-subdomains?view=graph-rest-1.0" />
        /// </summary>
