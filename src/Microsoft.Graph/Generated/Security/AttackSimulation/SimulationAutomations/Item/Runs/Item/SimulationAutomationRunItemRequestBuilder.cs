...
namespace Microsoft.Graph.Beta.Security.AttackSimulation.SimulationAutomations.Item.Runs.Item {
    ...
    public class SimulationAutomationRunItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SimulationAutomationRunItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SimulationAutomationRun> GetAsync(CancellationToken cancellationToken = default, Action<SimulationAutomationRunItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SimulationAutomationRun body, CancellationToken cancellationToken = default, Action<SimulationAutomationRunItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
