...
namespace Microsoft.Graph.Beta.Security.AttackSimulation.Simulations.Item.Payload {
    /// <summary>
    ...
    public class PayloadRequestBuilder {
        ...
        public PayloadRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/security/attackSimulation/simulations/{simulation%2Did}/payload{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PayloadRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
