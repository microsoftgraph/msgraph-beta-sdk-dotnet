...
using Microsoft.Graph.Beta.Security.AttackSimulation.Operations.Count;
using Microsoft.Graph.Beta.Security.AttackSimulation.Operations.Item;
...
using System;
namespace Microsoft.Graph.Beta.Security.AttackSimulation.Operations {
    /// <summary>
    ...
    public class OperationsRequestBuilder : BaseRequestBuilder {
        ...
        public AttackSimulationOperationItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("attackSimulationOperation%2Did", position);
...
#nullable enable
        public async Task<AttackSimulationOperationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<OperationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AttackSimulationOperationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<OperationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AttackSimulationOperation?> PostAsync(AttackSimulationOperation body, CancellationToken cancellationToken = default, Action<OperationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AttackSimulationOperation> PostAsync(AttackSimulationOperation body, CancellationToken cancellationToken = default, Action<OperationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
