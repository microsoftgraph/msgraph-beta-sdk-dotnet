...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AttackSimulationOperationItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AttackSimulationOperationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AttackSimulationOperation?> GetAsync(CancellationToken cancellationToken = default, Action<AttackSimulationOperationItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AttackSimulationOperation> GetAsync(CancellationToken cancellationToken = default, Action<AttackSimulationOperationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AttackSimulationOperation?> PatchAsync(AttackSimulationOperation body, CancellationToken cancellationToken = default, Action<AttackSimulationOperationItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AttackSimulationOperation> PatchAsync(AttackSimulationOperation body, CancellationToken cancellationToken = default, Action<AttackSimulationOperationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
