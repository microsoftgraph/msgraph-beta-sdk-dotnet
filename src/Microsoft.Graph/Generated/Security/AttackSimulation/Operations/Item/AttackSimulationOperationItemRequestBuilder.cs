...
namespace Microsoft.Graph.Beta.Security.AttackSimulation.Operations.Item {
    ...
    /// </summary>
    public class AttackSimulationOperationItemRequestBuilder {
        ...
        public AttackSimulationOperationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/security/attackSimulation/operations/{attackSimulationOperation%2Did}{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AttackSimulationOperationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
