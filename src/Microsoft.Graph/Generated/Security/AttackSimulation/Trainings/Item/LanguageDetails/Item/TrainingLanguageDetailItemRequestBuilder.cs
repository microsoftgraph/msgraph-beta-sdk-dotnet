...
using System;
namespace Microsoft.Graph.Beta.Security.AttackSimulation.Trainings.Item.LanguageDetails.Item {
    /// <summary>
    /// Provides operations to manage the languageDetails property of the microsoft.graph.training entity.
    /// </summary>
    public class TrainingLanguageDetailItemRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new TrainingLanguageDetailItemRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TrainingLanguageDetailItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/attackSimulation/trainings/{training%2Did}/languageDetails/{trainingLanguageDetail%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TrainingLanguageDetailItemRequestBuilder and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TrainingLanguageDetail?> GetAsync(Action<TrainingLanguageDetailItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<TrainingLanguageDetail> GetAsync(Action<TrainingLanguageDetailItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<TrainingLanguageDetailItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<TrainingLanguageDetailItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new TrainingLanguageDetailItemRequestBuilderGetRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
...
#nullable restore
        ...
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        public class TrainingLanguageDetailItemRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public TrainingLanguageDetailItemRequestBuilderGetQueryParameters QueryParameters { get; set; } = new TrainingLanguageDetailItemRequestBuilderGetQueryParameters();
            /// <summary>
