...
namespace Microsoft.Graph.Beta.Security.HostSecurityProfiles.Item
{
    ...
    public partial class HostSecurityProfileItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public HostSecurityProfileItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/hostSecurityProfiles/{hostSecurityProfile%2Did}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Security.HostSecurityProfiles.Item.HostSecurityProfileItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HostSecurityProfileItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/hostSecurityProfiles/{hostSecurityProfile%2Did}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/security/hostSecurityProfiles/{hostSecurityProfile%2Did}{?%24expand,%24select}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
