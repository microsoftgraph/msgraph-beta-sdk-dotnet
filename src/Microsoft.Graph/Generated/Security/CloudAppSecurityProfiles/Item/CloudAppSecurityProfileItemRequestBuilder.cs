...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CloudAppSecurityProfileItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CloudAppSecurityProfileItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CloudAppSecurityProfile?> GetAsync(CancellationToken cancellationToken = default, Action<CloudAppSecurityProfileItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CloudAppSecurityProfile> GetAsync(CancellationToken cancellationToken = default, Action<CloudAppSecurityProfileItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CloudAppSecurityProfile?> PatchAsync(CloudAppSecurityProfile body, CancellationToken cancellationToken = default, Action<CloudAppSecurityProfileItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CloudAppSecurityProfile> PatchAsync(CloudAppSecurityProfile body, CancellationToken cancellationToken = default, Action<CloudAppSecurityProfileItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
