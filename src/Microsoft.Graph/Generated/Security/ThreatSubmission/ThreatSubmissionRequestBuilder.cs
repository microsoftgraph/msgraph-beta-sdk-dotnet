...
namespace Microsoft.Graph.Beta.Security.ThreatSubmission {
    ...
    public class ThreatSubmissionRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ThreatSubmissionRoot> PatchAsync(ThreatSubmissionRoot body, Action<ThreatSubmissionRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
