...
namespace Microsoft.Graph.Beta.Security.ThreatSubmission.UrlThreats.Item {
    ...
    public class UrlThreatSubmissionItemRequestBuilder : BaseRequestBuilder {
        ...
        public UrlThreatSubmissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatSubmission/urlThreats/{urlThreatSubmission%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UrlThreatSubmissionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UrlThreatSubmissionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatSubmission/urlThreats/{urlThreatSubmission%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UrlThreatSubmissionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UrlThreatSubmissionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/security-urlthreatsubmission-get?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UrlThreatSubmission?> GetAsync(CancellationToken cancellationToken = default, Action<UrlThreatSubmissionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UrlThreatSubmission> GetAsync(CancellationToken cancellationToken = default, Action<UrlThreatSubmissionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UrlThreatSubmission?> PatchAsync(UrlThreatSubmission body, CancellationToken cancellationToken = default, Action<UrlThreatSubmissionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UrlThreatSubmission> PatchAsync(UrlThreatSubmission body, CancellationToken cancellationToken = default, Action<UrlThreatSubmissionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
