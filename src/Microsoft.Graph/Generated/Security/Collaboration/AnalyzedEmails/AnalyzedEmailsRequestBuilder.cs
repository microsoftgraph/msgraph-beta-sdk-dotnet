...
namespace Microsoft.Graph.Beta.Security.Collaboration.AnalyzedEmails {
    ...
    public class AnalyzedEmailsRequestBuilder : BaseRequestBuilder {
        ...
        public MicrosoftGraphSecurityRemediateRequestBuilder MicrosoftGraphSecurityRemediate { get =>
            new MicrosoftGraphSecurityRemediateRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public AnalyzedEmailItemRequestBuilder this[string position] { get {
        ...
        public AnalyzedEmailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/collaboration/analyzedEmails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AnalyzedEmailsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AnalyzedEmailsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/collaboration/analyzedEmails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class AnalyzedEmailsRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
