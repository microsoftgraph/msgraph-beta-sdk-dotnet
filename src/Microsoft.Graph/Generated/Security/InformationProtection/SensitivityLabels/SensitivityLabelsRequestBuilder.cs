...
namespace MicrosoftGraphSdk.Security.InformationProtection.SensitivityLabels {
    /// <summary>Builds and executes requests for operations under \security\informationProtection\sensitivityLabels</summary>
    public class SensitivityLabelsRequestBuilder {
        ...
        public SensitivityLabelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/security/informationProtection/sensitivityLabels{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
