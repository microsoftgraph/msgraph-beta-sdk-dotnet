...
namespace Microsoft.Graph.Beta.Security.InformationProtection.SensitivityLabels.SecurityExtractContentLabel {
    ...
    public class SecurityExtractContentLabelRequestBuilder : BaseRequestBuilder {
        ...
        public SecurityExtractContentLabelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/informationProtection/sensitivityLabels/security.extractContentLabel", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SecurityExtractContentLabelRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecurityExtractContentLabelRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/informationProtection/sensitivityLabels/security.extractContentLabel", rawUrl) {
        }
        /// <summary>
