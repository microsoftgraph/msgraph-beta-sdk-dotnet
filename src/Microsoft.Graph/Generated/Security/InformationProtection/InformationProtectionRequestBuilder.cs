...
using Microsoft.Graph.Beta.Security.InformationProtection.LabelPolicySettings;
using Microsoft.Graph.Beta.Security.InformationProtection.SensitivityLabels;
...
using System;
namespace Microsoft.Graph.Beta.Security.InformationProtection {
    /// <summary>
    ...
    public class InformationProtectionRequestBuilder : BaseRequestBuilder {
        ...
        public InformationProtectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/informationProtection{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new InformationProtectionRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InformationProtectionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/informationProtection{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
