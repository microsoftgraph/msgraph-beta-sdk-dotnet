...
namespace Microsoft.Graph.Beta.Security.SecurityActions.Item.CancelSecurityAction {
    ...
    public class CancelSecurityActionRequestBuilder {
        ...
        /// </summary>
        public CancelSecurityActionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/security/securityActions/{securityAction%2Did}/microsoft.graph.cancelSecurityAction";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public CancelSecurityActionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Action<CancelSecurityActionRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(Action<CancelSecurityActionRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
