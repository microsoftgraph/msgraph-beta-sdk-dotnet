...
namespace Microsoft.Graph.Beta.Security.SecurityActions.Item.CancelSecurityAction {
    ...
    public class CancelSecurityActionRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<CancelSecurityActionRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
