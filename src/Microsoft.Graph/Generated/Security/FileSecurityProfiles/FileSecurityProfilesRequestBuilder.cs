...
namespace Microsoft.Graph.Beta.Security.FileSecurityProfiles {
    ...
    public class FileSecurityProfilesRequestBuilder : BaseRequestBuilder {
        ...
        public FileSecurityProfileItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("fileSecurityProfile%2Did", position);
...
#nullable enable
        public async Task<FileSecurityProfileCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<FileSecurityProfilesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<FileSecurityProfileCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<FileSecurityProfilesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<FileSecurityProfile?> PostAsync(FileSecurityProfile body, CancellationToken cancellationToken = default, Action<FileSecurityProfilesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<FileSecurityProfile> PostAsync(FileSecurityProfile body, CancellationToken cancellationToken = default, Action<FileSecurityProfilesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
