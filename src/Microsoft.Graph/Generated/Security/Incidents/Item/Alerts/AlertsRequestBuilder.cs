...
namespace Microsoft.Graph.Beta.Security.Incidents.Item.Alerts {
    ...
    public class AlertsRequestBuilder {
        ...
        /// </summary>
        public async Task<AlertCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AlertsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
