...
namespace Microsoft.Graph.Beta.Security.Incidents {
    ...
    public class IncidentsRequestBuilder {
        ...
        /// </summary>
        public async Task<IncidentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<IncidentsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Incident> PostAsync(Incident body, CancellationToken cancellationToken = default, Action<IncidentsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
