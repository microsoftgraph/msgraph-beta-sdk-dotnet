...
namespace MicrosoftGraphSdk.OfficeConfiguration.ClientConfigurations.Item.Assignments {
    /// <summary>Builds and executes requests for operations under \officeConfiguration\clientConfigurations\{officeClientConfiguration-id}\assignments</summary>
    public class AssignmentsRequestBuilder {
        ...
        public async Task<OfficeClientConfigurationAssignment> PostAsync(OfficeClientConfigurationAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<OfficeClientConfigurationAssignment>(requestInfo, OfficeClientConfigurationAssignment.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
