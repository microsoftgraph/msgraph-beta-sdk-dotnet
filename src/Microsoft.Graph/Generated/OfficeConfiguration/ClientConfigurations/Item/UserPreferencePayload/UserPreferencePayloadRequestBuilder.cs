...
namespace Microsoft.Graph.Beta.OfficeConfiguration.ClientConfigurations.Item.UserPreferencePayload {
    ...
    public class UserPreferencePayloadRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task PutAsync(Stream body, Action<UserPreferencePayloadRequestBuilderPutRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
