...
using MicrosoftGraph.OfficeConfiguration.ClientConfigurations.Item.Assign;
using MicrosoftGraph.OfficeConfiguration.ClientConfigurations.Item.Assignments;
using MicrosoftGraph.OfficeConfiguration.ClientConfigurations.Item.PolicyPayload;
using MicrosoftGraph.OfficeConfiguration.ClientConfigurations.Item.UserPreferencePayload;
using System;
...
namespace MicrosoftGraph.OfficeConfiguration.ClientConfigurations.Item {
    ...
    public class OfficeClientConfigurationRequestBuilder {
        ...
        /// </summary>
        public OfficeClientConfigurationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public OfficeClientConfigurationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
