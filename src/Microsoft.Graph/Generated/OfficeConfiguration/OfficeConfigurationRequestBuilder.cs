...
namespace Microsoft.Graph.Beta.OfficeConfiguration {
    ...
    public class OfficeConfigurationRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.OfficeConfiguration> PatchAsync(Microsoft.Graph.Beta.Models.OfficeConfiguration body, Action<OfficeConfigurationRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
