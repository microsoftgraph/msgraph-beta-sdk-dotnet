...
namespace Microsoft.Graph.Beta.OfficeConfiguration {
    ...
    public class OfficeConfigurationRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.OfficeConfiguration> GetAsync(CancellationToken cancellationToken = default, Action<OfficeConfigurationRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.OfficeConfiguration body, CancellationToken cancellationToken = default, Action<OfficeConfigurationRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
