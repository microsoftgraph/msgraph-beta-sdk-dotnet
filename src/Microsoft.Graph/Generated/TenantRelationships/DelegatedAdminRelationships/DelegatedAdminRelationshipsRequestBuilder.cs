...
namespace Microsoft.Graph.Beta.TenantRelationships.DelegatedAdminRelationships {
    ...
    public class DelegatedAdminRelationshipsRequestBuilder {
        ...
        /// </summary>
        public async Task<DelegatedAdminRelationshipCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminRelationshipsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DelegatedAdminRelationship> PostAsync(DelegatedAdminRelationship body, CancellationToken cancellationToken = default, Action<DelegatedAdminRelationshipsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
