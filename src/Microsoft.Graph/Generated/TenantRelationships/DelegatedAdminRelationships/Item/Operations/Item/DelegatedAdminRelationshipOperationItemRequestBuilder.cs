...
namespace Microsoft.Graph.Beta.TenantRelationships.DelegatedAdminRelationships.Item.Operations.Item {
    ...
    public class DelegatedAdminRelationshipOperationItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminRelationshipOperationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DelegatedAdminRelationshipOperation> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminRelationshipOperationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DelegatedAdminRelationshipOperation body, CancellationToken cancellationToken = default, Action<DelegatedAdminRelationshipOperationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
