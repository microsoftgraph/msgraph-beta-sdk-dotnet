...
namespace MicrosoftGraphSdk.TenantRelationships.DelegatedAdminRelationships.Item {
    ...
    public class DelegatedAdminRelationshipItemRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(DelegatedAdminRelationship body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
