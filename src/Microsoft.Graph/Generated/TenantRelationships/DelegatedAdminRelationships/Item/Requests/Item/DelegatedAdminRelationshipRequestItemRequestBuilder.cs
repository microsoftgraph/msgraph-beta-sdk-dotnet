...
namespace Microsoft.Graph.Beta.TenantRelationships.DelegatedAdminRelationships.Item.Requests.Item {
    ...
    public class DelegatedAdminRelationshipRequestItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminRelationshipRequestItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DelegatedAdminRelationshipRequest> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminRelationshipRequestItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DelegatedAdminRelationshipRequest body, CancellationToken cancellationToken = default, Action<DelegatedAdminRelationshipRequestItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
