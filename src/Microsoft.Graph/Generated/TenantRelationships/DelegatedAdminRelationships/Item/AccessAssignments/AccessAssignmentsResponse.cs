...
namespace MicrosoftGraphSdk.TenantRelationships.DelegatedAdminRelationships.Item.AccessAssignments {
    public class AccessAssignmentsResponse : IParsable {
        ...
        /// </summary>
        public static AccessAssignmentsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new AccessAssignmentsResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as AccessAssignmentsResponse).Value = n.GetCollectionOfObjectValues<DelegatedAdminAccessAssignment>(DelegatedAdminAccessAssignment.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
