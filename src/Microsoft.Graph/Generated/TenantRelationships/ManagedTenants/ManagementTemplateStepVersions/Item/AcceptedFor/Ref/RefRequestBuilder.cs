...
namespace MicrosoftGraphSdk.TenantRelationships.ManagedTenants.ManagementTemplateStepVersions.Item.AcceptedFor.Ref {
    /// <summary>Builds and executes requests for operations under \tenantRelationships\managedTenants\managementTemplateStepVersions\{managementTemplateStepVersion-id}\acceptedFor\$ref</summary>
    public class RefRequestBuilder {
        ...
        public RefRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/tenantRelationships/managedTenants/managementTemplateStepVersions/{managementTemplateStepVersion_id}/acceptedFor/$ref";
        ...
        /// <summary>
        /// Delete ref of navigation property acceptedFor for tenantRelationships
        ...
        /// <summary>
        /// Get ref of acceptedFor from tenantRelationships
        /// <param name="h">Request headers</param>
        /// <param name="o">Request options</param>
        /// </summary>
        ...
        /// <summary>
        /// Update the ref of navigation property acceptedFor in tenantRelationships
