...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.ManagementTemplateStepVersions.Item.Deployments.Item.MicrosoftGraphManagedTenantsChangeDeploymentStatus {
    ...
    /// </summary>
    public class MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilder {
        ...
        public MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<ManagementTemplateStepDeployment?> PostAsync(ChangeDeploymentStatusPostRequestBody body, Action<MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ManagementTemplateStepDeployment> PostAsync(ChangeDeploymentStatusPostRequestBody body, Action<MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
