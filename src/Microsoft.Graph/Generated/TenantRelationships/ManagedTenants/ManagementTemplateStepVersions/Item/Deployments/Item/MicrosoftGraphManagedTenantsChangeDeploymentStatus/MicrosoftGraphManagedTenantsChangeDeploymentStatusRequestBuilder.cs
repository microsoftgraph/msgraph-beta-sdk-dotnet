...
#nullable enable
        public async Task<ManagementTemplateStepDeployment?> PostAsync(ChangeDeploymentStatusPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ManagementTemplateStepDeployment> PostAsync(ChangeDeploymentStatusPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<ManagementTemplateStepDeployment>(requestInfo, ManagementTemplateStepDeployment.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Invoke action changeDeploymentStatus
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilder WithUrl(string rawUrl)
        {
