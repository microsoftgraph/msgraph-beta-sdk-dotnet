...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagementTemplateStepVersionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagementTemplateStepVersionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagementTemplateStepVersion?> PatchAsync(ManagementTemplateStepVersion body, CancellationToken cancellationToken = default, Action<ManagementTemplateStepVersionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagementTemplateStepVersion> PatchAsync(ManagementTemplateStepVersion body, CancellationToken cancellationToken = default, Action<ManagementTemplateStepVersionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
