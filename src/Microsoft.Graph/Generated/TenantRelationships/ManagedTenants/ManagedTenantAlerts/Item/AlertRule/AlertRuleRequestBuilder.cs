...
#nullable enable
        public async Task<ManagedTenantAlertRule?> GetAsync(CancellationToken cancellationToken = default, Action<AlertRuleRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedTenantAlertRule> GetAsync(CancellationToken cancellationToken = default, Action<AlertRuleRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
