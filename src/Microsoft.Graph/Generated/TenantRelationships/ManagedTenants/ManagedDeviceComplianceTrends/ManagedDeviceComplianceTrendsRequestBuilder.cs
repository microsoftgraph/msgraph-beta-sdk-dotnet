...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.ManagedDeviceComplianceTrends {
    ...
    public class ManagedDeviceComplianceTrendsRequestBuilder : BaseRequestBuilder {
        ...
        public ManagedDeviceComplianceTrendItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("managedDeviceComplianceTrend%2Did", position);
...
#nullable enable
        public async Task<ManagedDeviceComplianceTrendCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceComplianceTrendsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedDeviceComplianceTrendCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceComplianceTrendsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedDeviceComplianceTrend?> PostAsync(ManagedDeviceComplianceTrend body, CancellationToken cancellationToken = default, Action<ManagedDeviceComplianceTrendsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedDeviceComplianceTrend> PostAsync(ManagedDeviceComplianceTrend body, CancellationToken cancellationToken = default, Action<ManagedDeviceComplianceTrendsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
