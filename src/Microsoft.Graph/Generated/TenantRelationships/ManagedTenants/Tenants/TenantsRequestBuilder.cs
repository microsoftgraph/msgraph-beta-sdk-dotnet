...
#nullable enable
        public async Task<TenantCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TenantsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TenantCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TenantsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Tenant?> PostAsync(Tenant body, CancellationToken cancellationToken = default, Action<TenantsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Tenant> PostAsync(Tenant body, CancellationToken cancellationToken = default, Action<TenantsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
