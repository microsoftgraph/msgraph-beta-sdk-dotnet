...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.Tenants.Item.MicrosoftGraphManagedTenantsOffboardTenant {
    ...
    /// </summary>
    public class MicrosoftGraphManagedTenantsOffboardTenantRequestBuilder {
        ...
        public MicrosoftGraphManagedTenantsOffboardTenantRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphManagedTenantsOffboardTenantRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
