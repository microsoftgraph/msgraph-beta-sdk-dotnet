...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.Tenants.Item
{
    ...
    public class TenantItemRequestBuilder : BaseRequestBuilder
    {
        ...
        {
            get => new MicrosoftGraphManagedTenantsOffboardTenantRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new MicrosoftGraphManagedTenantsResetTenantOnboardingStatusRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Tenant?> GetAsync(Action<RequestConfiguration<TenantItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Tenant> GetAsync(Action<RequestConfiguration<TenantItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Tenant?> PatchAsync(Tenant body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Tenant> PatchAsync(Tenant body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class TenantItemRequestBuilderGetRequestConfiguration : RequestConfiguration<TenantItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
