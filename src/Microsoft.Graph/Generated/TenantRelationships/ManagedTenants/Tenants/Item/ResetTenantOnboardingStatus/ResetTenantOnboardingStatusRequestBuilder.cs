...
namespace MicrosoftGraph.TenantRelationships.ManagedTenants.Tenants.Item.ResetTenantOnboardingStatus {
    ...
    public class ResetTenantOnboardingStatusRequestBuilder {
        ...
        public async Task<ResetTenantOnboardingStatusResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<ResetTenantOnboardingStatusResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
        ...
        public class ResetTenantOnboardingStatusResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"tenant", (o,n) => { (o as ResetTenantOnboardingStatusResponse).Tenant = n.GetObjectValue<Tenant>(); } },
                };
            }
            /// <summary>
            ...
            public void Serialize(ISerializationWriter writer) {
                ...
                writer.WriteObjectValue<Tenant>("tenant", Tenant);
