...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.Tenants.Item.ResetTenantOnboardingStatus {
    ...
    public class ResetTenantOnboardingStatusRequestBuilder {
        ...
        /// </summary>
        public async Task<Tenant> PostAsync(Action<ResetTenantOnboardingStatusRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
