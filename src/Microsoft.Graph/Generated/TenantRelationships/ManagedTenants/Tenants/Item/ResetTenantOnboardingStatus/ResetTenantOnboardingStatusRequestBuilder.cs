...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.Tenants.Item.ResetTenantOnboardingStatus {
    ...
    public class ResetTenantOnboardingStatusRequestBuilder {
        ...
        /// </summary>
        public async Task<Tenant> PostAsync(CancellationToken cancellationToken = default, Action<ResetTenantOnboardingStatusRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
