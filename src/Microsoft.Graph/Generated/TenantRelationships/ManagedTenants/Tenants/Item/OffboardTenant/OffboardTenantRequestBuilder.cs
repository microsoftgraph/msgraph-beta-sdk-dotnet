...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.Tenants.Item.OffboardTenant {
    ...
    public class OffboardTenantRequestBuilder {
        ...
        /// </summary>
        public async Task<Tenant> PostAsync(CancellationToken cancellationToken = default, Action<OffboardTenantRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
