...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.TenantTags.Item.AssignTag {
    ...
    public class AssignTagPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        /// </summary>
        public static AssignTagPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
