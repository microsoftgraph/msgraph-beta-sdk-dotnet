...
#nullable enable
        public async Task<TenantTag?> PostAsync(UnassignTagPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphManagedTenantsUnassignTagRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TenantTag> PostAsync(UnassignTagPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphManagedTenantsUnassignTagRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
