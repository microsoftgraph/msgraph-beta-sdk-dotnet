...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.TenantTags.Item.MicrosoftGraphManagedTenantsUnassignTag {
    ...
    /// </summary>
    public class MicrosoftGraphManagedTenantsUnassignTagRequestBuilder {
        ...
        public MicrosoftGraphManagedTenantsUnassignTagRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphManagedTenantsUnassignTagRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
