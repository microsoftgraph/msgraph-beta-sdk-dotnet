...
#nullable enable
        public async Task<TenantTag?> PostAsync(AssignTagPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphManagedTenantsAssignTagRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TenantTag> PostAsync(AssignTagPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphManagedTenantsAssignTagRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
