...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.TenantTags.Item.MicrosoftGraphManagedTenantsAssignTag {
    ...
    /// </summary>
    public class MicrosoftGraphManagedTenantsAssignTagRequestBuilder {
        ...
        public MicrosoftGraphManagedTenantsAssignTagRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphManagedTenantsAssignTagRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
