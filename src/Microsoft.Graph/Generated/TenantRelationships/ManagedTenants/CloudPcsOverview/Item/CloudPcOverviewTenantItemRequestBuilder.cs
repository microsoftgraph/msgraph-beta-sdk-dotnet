...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.CloudPcsOverview.Item {
    ...
    public class CloudPcOverviewTenantItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<CloudPcOverview> PatchAsync(CloudPcOverview body, Action<CloudPcOverviewTenantItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
