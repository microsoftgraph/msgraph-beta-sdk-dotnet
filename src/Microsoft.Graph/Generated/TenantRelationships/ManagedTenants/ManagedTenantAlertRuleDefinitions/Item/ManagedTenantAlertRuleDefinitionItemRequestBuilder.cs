...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagedTenantAlertRuleDefinitionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagedTenantAlertRuleDefinitionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedTenantAlertRuleDefinition?> GetAsync(CancellationToken cancellationToken = default, Action<ManagedTenantAlertRuleDefinitionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedTenantAlertRuleDefinition> GetAsync(CancellationToken cancellationToken = default, Action<ManagedTenantAlertRuleDefinitionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedTenantAlertRuleDefinition?> PatchAsync(ManagedTenantAlertRuleDefinition body, CancellationToken cancellationToken = default, Action<ManagedTenantAlertRuleDefinitionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedTenantAlertRuleDefinition> PatchAsync(ManagedTenantAlertRuleDefinition body, CancellationToken cancellationToken = default, Action<ManagedTenantAlertRuleDefinitionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
