...
#nullable enable
        public async Task<MyRoleCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<MyRolesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MyRoleCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MyRolesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MyRole?> PostAsync(MyRole body, CancellationToken cancellationToken = default, Action<MyRolesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MyRole> PostAsync(MyRole body, CancellationToken cancellationToken = default, Action<MyRolesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
