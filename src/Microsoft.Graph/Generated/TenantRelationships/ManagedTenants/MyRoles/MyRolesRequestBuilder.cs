...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.MyRoles {
    ...
    public class MyRolesRequestBuilder {
        ...
        /// </summary>
        public async Task<MyRoleCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MyRolesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MyRole> PostAsync(MyRole body, CancellationToken cancellationToken = default, Action<MyRolesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
