...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.ManagementActionTenantDeploymentStatuses {
    ...
    public class ManagementActionTenantDeploymentStatusesRequestBuilder {
        ...
        /// </summary>
        public async Task<ManagementActionTenantDeploymentStatusCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ManagementActionTenantDeploymentStatusesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ManagementActionTenantDeploymentStatus> PostAsync(ManagementActionTenantDeploymentStatus body, CancellationToken cancellationToken = default, Action<ManagementActionTenantDeploymentStatusesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
