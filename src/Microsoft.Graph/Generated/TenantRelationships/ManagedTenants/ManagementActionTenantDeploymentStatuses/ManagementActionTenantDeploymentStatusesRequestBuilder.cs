...
#nullable enable
        public async Task<ManagementActionTenantDeploymentStatusCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ManagementActionTenantDeploymentStatusesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagementActionTenantDeploymentStatusCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ManagementActionTenantDeploymentStatusesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagementActionTenantDeploymentStatus?> PostAsync(ManagementActionTenantDeploymentStatus body, CancellationToken cancellationToken = default, Action<ManagementActionTenantDeploymentStatusesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagementActionTenantDeploymentStatus> PostAsync(ManagementActionTenantDeploymentStatus body, CancellationToken cancellationToken = default, Action<ManagementActionTenantDeploymentStatusesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
