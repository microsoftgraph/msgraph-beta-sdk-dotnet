...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.ManagementActionTenantDeploymentStatuses.MicrosoftGraphManagedTenantsChangeDeploymentStatus {
    ...
    public class MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilder : BaseRequestBuilder {
        ...
        public MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/managementActionTenantDeploymentStatuses/microsoft.graph.managedTenants.changeDeploymentStatus", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/managementActionTenantDeploymentStatuses/microsoft.graph.managedTenants.changeDeploymentStatus", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ManagementActionDeploymentStatus?> PostAsync(ChangeDeploymentStatusPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagementActionDeploymentStatus> PostAsync(ChangeDeploymentStatusPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
