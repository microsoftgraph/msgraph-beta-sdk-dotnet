...
#nullable enable
        public async Task<ManagementActionDeploymentStatus?> PostAsync(ChangeDeploymentStatusPostRequestBody body, Action<MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ManagementActionDeploymentStatus> PostAsync(ChangeDeploymentStatusPostRequestBody body, Action<MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
