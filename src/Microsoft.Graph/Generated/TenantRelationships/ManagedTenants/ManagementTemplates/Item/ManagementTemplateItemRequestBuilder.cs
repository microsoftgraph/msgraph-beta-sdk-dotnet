...
namespace MicrosoftGraphSdk.TenantRelationships.ManagedTenants.ManagementTemplates.Item {
    ...
    public class ManagementTemplateItemRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.ManagedTenants.ManagementTemplate body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
