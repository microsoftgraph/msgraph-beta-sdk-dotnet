...
namespace MicrosoftGraphSdk.TenantRelationships.ManagedTenants.ManagementTemplates.Item.ManagementTemplateSteps.Item {
    ...
    public class ManagementTemplateStepItemRequestBuilder {
        ...
        public ManagementTemplateStepItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/tenantRelationships/managedTenants/managementTemplates/{managementTemplate_id}/managementTemplateSteps/{managementTemplateStep_id}{?select,expand}";
