...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.ManagementTemplateCollections {
    ...
    public class ManagementTemplateCollectionsRequestBuilder {
        ...
        /// </summary>
        public async Task<ManagementTemplateCollectionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ManagementTemplateCollectionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ManagementTemplateCollection> PostAsync(ManagementTemplateCollection body, CancellationToken cancellationToken = default, Action<ManagementTemplateCollectionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
