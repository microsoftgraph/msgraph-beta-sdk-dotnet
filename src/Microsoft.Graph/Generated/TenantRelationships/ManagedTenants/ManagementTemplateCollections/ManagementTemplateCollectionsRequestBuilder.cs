...
#nullable enable
        public async Task<ManagementTemplateCollectionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ManagementTemplateCollectionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagementTemplateCollectionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ManagementTemplateCollectionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagementTemplateCollection?> PostAsync(ManagementTemplateCollection body, CancellationToken cancellationToken = default, Action<ManagementTemplateCollectionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagementTemplateCollection> PostAsync(ManagementTemplateCollection body, CancellationToken cancellationToken = default, Action<ManagementTemplateCollectionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
