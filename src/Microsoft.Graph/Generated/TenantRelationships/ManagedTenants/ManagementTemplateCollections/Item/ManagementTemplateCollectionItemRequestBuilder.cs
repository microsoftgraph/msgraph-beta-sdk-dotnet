...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagementTemplateCollectionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagementTemplateCollectionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagementTemplateCollection?> GetAsync(CancellationToken cancellationToken = default, Action<ManagementTemplateCollectionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagementTemplateCollection> GetAsync(CancellationToken cancellationToken = default, Action<ManagementTemplateCollectionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagementTemplateCollection?> PatchAsync(ManagementTemplateCollection body, CancellationToken cancellationToken = default, Action<ManagementTemplateCollectionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagementTemplateCollection> PatchAsync(ManagementTemplateCollection body, CancellationToken cancellationToken = default, Action<ManagementTemplateCollectionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
