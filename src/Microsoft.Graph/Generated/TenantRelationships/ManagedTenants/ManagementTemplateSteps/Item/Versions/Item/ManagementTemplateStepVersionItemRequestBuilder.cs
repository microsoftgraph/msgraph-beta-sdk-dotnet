...
namespace MicrosoftGraphSdk.TenantRelationships.ManagedTenants.ManagementTemplateSteps.Item.Versions.Item {
    ...
    public class ManagementTemplateStepVersionItemRequestBuilder {
        ...
        public ManagementTemplateStepVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/tenantRelationships/managedTenants/managementTemplateSteps/{managementTemplateStep_id}/versions/{managementTemplateStepVersion_id}{?select,expand}";
