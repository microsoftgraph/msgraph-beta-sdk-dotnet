...
namespace MicrosoftGraphSdk.TenantRelationships.ManagedTenants.ManagementTemplateSteps {
    ...
    public class ManagementTemplateStepsRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ManagementTemplateStep body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
