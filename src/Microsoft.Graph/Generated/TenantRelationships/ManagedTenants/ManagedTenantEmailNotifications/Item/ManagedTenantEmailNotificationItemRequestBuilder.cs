...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagedTenantEmailNotificationItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagedTenantEmailNotificationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedTenantEmailNotification?> GetAsync(CancellationToken cancellationToken = default, Action<ManagedTenantEmailNotificationItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedTenantEmailNotification> GetAsync(CancellationToken cancellationToken = default, Action<ManagedTenantEmailNotificationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedTenantEmailNotification?> PatchAsync(ManagedTenantEmailNotification body, CancellationToken cancellationToken = default, Action<ManagedTenantEmailNotificationItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedTenantEmailNotification> PatchAsync(ManagedTenantEmailNotification body, CancellationToken cancellationToken = default, Action<ManagedTenantEmailNotificationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
