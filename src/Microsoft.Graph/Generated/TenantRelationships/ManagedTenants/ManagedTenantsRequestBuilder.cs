...
using MicrosoftGraph.TenantRelationships.ManagedTenants.AggregatedPolicyCompliances;
using MicrosoftGraph.TenantRelationships.ManagedTenants.AuditEvents;
using MicrosoftGraph.TenantRelationships.ManagedTenants.CloudPcConnections;
using MicrosoftGraph.TenantRelationships.ManagedTenants.CloudPcDevices;
using MicrosoftGraph.TenantRelationships.ManagedTenants.CloudPcsOverview;
using MicrosoftGraph.TenantRelationships.ManagedTenants.ConditionalAccessPolicyCoverages;
using MicrosoftGraph.TenantRelationships.ManagedTenants.CredentialUserRegistrationsSummaries;
using MicrosoftGraph.TenantRelationships.ManagedTenants.DeviceCompliancePolicySettingStateSummaries;
using MicrosoftGraph.TenantRelationships.ManagedTenants.ManagedDeviceCompliances;
using MicrosoftGraph.TenantRelationships.ManagedTenants.ManagedDeviceComplianceTrends;
using MicrosoftGraph.TenantRelationships.ManagedTenants.ManagementActions;
using MicrosoftGraph.TenantRelationships.ManagedTenants.ManagementActionTenantDeploymentStatuses;
using MicrosoftGraph.TenantRelationships.ManagedTenants.ManagementIntents;
using MicrosoftGraph.TenantRelationships.ManagedTenants.ManagementTemplateCollections;
using MicrosoftGraph.TenantRelationships.ManagedTenants.ManagementTemplates;
using MicrosoftGraph.TenantRelationships.ManagedTenants.ManagementTemplateSteps;
using MicrosoftGraph.TenantRelationships.ManagedTenants.ManagementTemplateStepVersions;
using MicrosoftGraph.TenantRelationships.ManagedTenants.TenantGroups;
using MicrosoftGraph.TenantRelationships.ManagedTenants.Tenants;
using MicrosoftGraph.TenantRelationships.ManagedTenants.TenantsCustomizedInformation;
using MicrosoftGraph.TenantRelationships.ManagedTenants.TenantsDetailedInformation;
using MicrosoftGraph.TenantRelationships.ManagedTenants.TenantTags;
using MicrosoftGraph.TenantRelationships.ManagedTenants.WindowsDeviceMalwareStates;
using MicrosoftGraph.TenantRelationships.ManagedTenants.WindowsProtectionStates;
using System;
...
namespace MicrosoftGraph.TenantRelationships.ManagedTenants {
