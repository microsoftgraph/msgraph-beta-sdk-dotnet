...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagedTenantsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagedTenantsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedTenant?> GetAsync(CancellationToken cancellationToken = default, Action<ManagedTenantsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedTenant> GetAsync(CancellationToken cancellationToken = default, Action<ManagedTenantsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedTenant?> PatchAsync(ManagedTenant body, CancellationToken cancellationToken = default, Action<ManagedTenantsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedTenant> PatchAsync(ManagedTenant body, CancellationToken cancellationToken = default, Action<ManagedTenantsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
