...
namespace MicrosoftGraph.TenantRelationships.ManagedTenants.AuditEvents {
    /// <summary>Builds and executes requests for operations under \tenantRelationships\managedTenants\auditEvents</summary>
    public class AuditEventsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.tenantRelationships.managedTenants.auditEvents.item collection</summary>
        public AuditEventsRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("auditEvent_id", position);
            return new AuditEventsRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AuditEvent body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
