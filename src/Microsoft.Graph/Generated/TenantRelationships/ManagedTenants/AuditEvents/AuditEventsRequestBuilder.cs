...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.AuditEvents {
    ...
    public class AuditEventsRequestBuilder {
        ...
        /// </summary>
        public async Task<AuditEventCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AuditEventsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AuditEvent> PostAsync(AuditEvent body, CancellationToken cancellationToken = default, Action<AuditEventsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
