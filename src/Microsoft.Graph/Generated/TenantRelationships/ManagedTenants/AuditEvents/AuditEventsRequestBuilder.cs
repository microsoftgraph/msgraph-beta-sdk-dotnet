...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.AuditEvents {
    ...
    public class AuditEventsRequestBuilder : BaseRequestBuilder {
        ...
        public AuditEventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/auditEvents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AuditEventsRequestBuilder and sets the default values.
        /// </summary>
