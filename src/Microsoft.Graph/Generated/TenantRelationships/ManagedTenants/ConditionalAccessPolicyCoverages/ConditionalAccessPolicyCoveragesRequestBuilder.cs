...
#nullable enable
        public async Task<ConditionalAccessPolicyCoverageCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ConditionalAccessPolicyCoveragesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ConditionalAccessPolicyCoverageCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ConditionalAccessPolicyCoveragesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ConditionalAccessPolicyCoverage?> PostAsync(ConditionalAccessPolicyCoverage body, CancellationToken cancellationToken = default, Action<ConditionalAccessPolicyCoveragesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ConditionalAccessPolicyCoverage> PostAsync(ConditionalAccessPolicyCoverage body, CancellationToken cancellationToken = default, Action<ConditionalAccessPolicyCoveragesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
