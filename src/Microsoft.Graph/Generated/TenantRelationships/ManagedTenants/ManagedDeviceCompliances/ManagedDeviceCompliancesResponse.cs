...
namespace MicrosoftGraphSdk.TenantRelationships.ManagedTenants.ManagedDeviceCompliances {
    public class ManagedDeviceCompliancesResponse : IParsable {
        ...
        /// </summary>
        public static ManagedDeviceCompliancesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ManagedDeviceCompliancesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ManagedDeviceCompliancesResponse).Value = n.GetCollectionOfObjectValues<ManagedDeviceCompliance>(ManagedDeviceCompliance.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
