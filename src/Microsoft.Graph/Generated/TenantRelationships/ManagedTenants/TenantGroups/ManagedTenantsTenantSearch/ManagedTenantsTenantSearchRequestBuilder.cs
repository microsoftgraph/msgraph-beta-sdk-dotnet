...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.TenantGroups.ManagedTenantsTenantSearch {
    ...
    /// </summary>
    public class ManagedTenantsTenantSearchRequestBuilder {
        ...
        public ManagedTenantsTenantSearchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/tenantRelationships/managedTenants/tenantGroups/managedTenants.tenantSearch";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ManagedTenantsTenantSearchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
