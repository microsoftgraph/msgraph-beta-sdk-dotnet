...
namespace MicrosoftGraphSdk.TenantRelationships.ManagedTenants.TenantGroups.TenantSearch {
    ...
    public class TenantSearchResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static TenantSearchResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as TenantSearchResponse).Value = n.GetCollectionOfObjectValues<TenantGroup>(TenantGroup.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
