...
namespace MicrosoftGraphSdk.TenantRelationships.ManagedTenants.TenantGroups {
    public class TenantGroupsResponse : IParsable {
        ...
        /// </summary>
        public static TenantGroupsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new TenantGroupsResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as TenantGroupsResponse).Value = n.GetCollectionOfObjectValues<TenantGroup>(TenantGroup.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
