...
#nullable enable
        public async Task<ManagedTenantAlert?> GetAsync(CancellationToken cancellationToken = default, Action<ManagedTenantAlertItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedTenantAlert> GetAsync(CancellationToken cancellationToken = default, Action<ManagedTenantAlertItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
