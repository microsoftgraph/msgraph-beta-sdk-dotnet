...
#nullable enable
        public async Task<WindowsProtectionStateCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<WindowsProtectionStatesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WindowsProtectionStateCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<WindowsProtectionStatesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ManagedTenants.WindowsProtectionState?> PostAsync(Microsoft.Graph.Beta.Models.ManagedTenants.WindowsProtectionState body, CancellationToken cancellationToken = default, Action<WindowsProtectionStatesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ManagedTenants.WindowsProtectionState> PostAsync(Microsoft.Graph.Beta.Models.ManagedTenants.WindowsProtectionState body, CancellationToken cancellationToken = default, Action<WindowsProtectionStatesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
