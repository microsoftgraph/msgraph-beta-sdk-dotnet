...
namespace Microsoft.Graph.Beta.TenantRelationships.ManagedTenants.WindowsProtectionStates {
    ...
    public class WindowsProtectionStatesRequestBuilder {
        ...
        /// </summary>
        public async Task<WindowsProtectionStateCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<WindowsProtectionStatesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.ManagedTenants.WindowsProtectionState> PostAsync(Microsoft.Graph.Beta.Models.ManagedTenants.WindowsProtectionState body, CancellationToken cancellationToken = default, Action<WindowsProtectionStatesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
