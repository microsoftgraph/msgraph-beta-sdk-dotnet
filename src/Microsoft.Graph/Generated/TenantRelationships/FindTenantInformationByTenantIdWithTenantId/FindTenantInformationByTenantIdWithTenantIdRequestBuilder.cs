...
namespace Microsoft.Graph.Beta.TenantRelationships.FindTenantInformationByTenantIdWithTenantId {
    /// <summary>Provides operations to call the findTenantInformationByTenantId method.</summary>
    public class FindTenantInformationByTenantIdWithTenantIdRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<FindTenantInformationByTenantIdWithTenantIdRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<TenantInformation> GetAsync(CancellationToken cancellationToken = default, Action<FindTenantInformationByTenantIdWithTenantIdRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
