...
namespace Microsoft.Graph.Beta.TenantRelationships.FindTenantInformationByTenantIdWithTenantId {
    ...
    public class FindTenantInformationByTenantIdWithTenantIdRequestBuilder {
        ...
        /// </summary>
        public async Task<TenantInformation> GetAsync(Action<FindTenantInformationByTenantIdWithTenantIdRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
