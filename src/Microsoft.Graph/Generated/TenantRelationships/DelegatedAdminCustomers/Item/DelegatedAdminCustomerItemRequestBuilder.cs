...
namespace Microsoft.Graph.Beta.TenantRelationships.DelegatedAdminCustomers.Item {
    ...
    public class DelegatedAdminCustomerItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminCustomerItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DelegatedAdminCustomer> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminCustomerItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DelegatedAdminCustomer body, CancellationToken cancellationToken = default, Action<DelegatedAdminCustomerItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
