...
namespace Microsoft.Graph.Beta.TenantRelationships.DelegatedAdminCustomers.Item {
    ...
    public class DelegatedAdminCustomerItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DelegatedAdminCustomer> PatchAsync(DelegatedAdminCustomer body, Action<DelegatedAdminCustomerItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
