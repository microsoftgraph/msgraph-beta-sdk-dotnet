...
namespace Microsoft.Graph.Beta.TenantRelationships.DelegatedAdminCustomers.Item.ServiceManagementDetails {
    ...
    public class ServiceManagementDetailsRequestBuilder {
        ...
        public DelegatedAdminServiceManagementDetailItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("delegatedAdminServiceManagementDetail%2Did", position);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<ServiceManagementDetailsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<ServiceManagementDetailsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
