...
namespace Microsoft.Graph.Beta.TenantRelationships.DelegatedAdminCustomers.Item.ServiceManagementDetails {
    ...
    public class ServiceManagementDetailsRequestBuilder {
        ...
        public async Task<DelegatedAdminServiceManagementDetailCollectionResponse> GetAsync(Action<ServiceManagementDetailsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<DelegatedAdminServiceManagementDetailCollectionResponse>(requestInfo, DelegatedAdminServiceManagementDetailCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to serviceManagementDetails for tenantRelationships
        /// </summary>
