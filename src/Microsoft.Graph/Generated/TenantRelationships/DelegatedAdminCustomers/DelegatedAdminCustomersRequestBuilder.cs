...
namespace Microsoft.Graph.Beta.TenantRelationships.DelegatedAdminCustomers {
    ...
    public class DelegatedAdminCustomersRequestBuilder {
        ...
        /// </summary>
        public async Task<DelegatedAdminCustomerCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminCustomersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DelegatedAdminCustomer> PostAsync(DelegatedAdminCustomer body, CancellationToken cancellationToken = default, Action<DelegatedAdminCustomersRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
