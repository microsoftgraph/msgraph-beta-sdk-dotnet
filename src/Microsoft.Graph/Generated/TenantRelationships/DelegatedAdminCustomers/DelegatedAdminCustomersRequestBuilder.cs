...
#nullable enable
        public async Task<DelegatedAdminCustomerCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminCustomersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DelegatedAdminCustomerCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminCustomersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DelegatedAdminCustomer?> PostAsync(DelegatedAdminCustomer body, CancellationToken cancellationToken = default, Action<DelegatedAdminCustomersRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DelegatedAdminCustomer> PostAsync(DelegatedAdminCustomer body, CancellationToken cancellationToken = default, Action<DelegatedAdminCustomersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
