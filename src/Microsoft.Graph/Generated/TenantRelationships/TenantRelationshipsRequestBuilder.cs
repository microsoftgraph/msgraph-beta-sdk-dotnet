...
#nullable enable
        public async Task<TenantRelationship?> GetAsync(CancellationToken cancellationToken = default, Action<TenantRelationshipsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TenantRelationship> GetAsync(CancellationToken cancellationToken = default, Action<TenantRelationshipsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TenantRelationship?> PatchAsync(TenantRelationship body, CancellationToken cancellationToken = default, Action<TenantRelationshipsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TenantRelationship> PatchAsync(TenantRelationship body, CancellationToken cancellationToken = default, Action<TenantRelationshipsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
