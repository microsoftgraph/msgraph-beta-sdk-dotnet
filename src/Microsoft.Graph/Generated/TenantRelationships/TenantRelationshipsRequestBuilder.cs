...
namespace Microsoft.Graph.Beta.TenantRelationships {
    ...
    public class TenantRelationshipsRequestBuilder {
        ...
        /// </summary>
        public async Task<TenantRelationship> GetAsync(CancellationToken cancellationToken = default, Action<TenantRelationshipsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(TenantRelationship body, CancellationToken cancellationToken = default, Action<TenantRelationshipsRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
