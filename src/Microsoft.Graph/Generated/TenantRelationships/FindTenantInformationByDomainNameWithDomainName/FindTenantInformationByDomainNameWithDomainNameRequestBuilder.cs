...
namespace Microsoft.Graph.Beta.TenantRelationships.FindTenantInformationByDomainNameWithDomainName {
    ...
    public class FindTenantInformationByDomainNameWithDomainNameRequestBuilder {
        ...
        /// </summary>
        public FindTenantInformationByDomainNameWithDomainNameRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string domainName = default) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public FindTenantInformationByDomainNameWithDomainNameRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<FindTenantInformationByDomainNameWithDomainNameRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<TenantInformation> GetAsync(CancellationToken cancellationToken = default, Action<FindTenantInformationByDomainNameWithDomainNameRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<TenantInformation>(requestInfo, TenantInformation.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
