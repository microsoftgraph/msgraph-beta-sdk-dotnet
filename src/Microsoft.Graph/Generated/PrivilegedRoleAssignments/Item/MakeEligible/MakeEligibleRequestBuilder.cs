...
namespace MicrosoftGraphSdk.PrivilegedRoleAssignments.Item.MakeEligible {
    /// <summary>Builds and executes requests for operations under \privilegedRoleAssignments\{privilegedRoleAssignment-id}\microsoft.graph.makeEligible</summary>
    public class MakeEligibleRequestBuilder {
        ...
        public MakeEligibleRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment_id}/microsoft.graph.makeEligible";
        ...
        public async Task<MakeEligibleResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<MakeEligibleResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>Union type wrapper for classes privilegedRoleAssignment</summary>
        public class MakeEligibleResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"privilegedRoleAssignment", (o,n) => { (o as MakeEligibleResponse).PrivilegedRoleAssignment = n.GetObjectValue<PrivilegedRoleAssignment>(); } },
                };
            }
            /// <summary>
