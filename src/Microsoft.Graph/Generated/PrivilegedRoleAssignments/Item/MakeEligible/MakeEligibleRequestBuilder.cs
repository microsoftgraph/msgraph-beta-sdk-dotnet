...
namespace Microsoft.Graph.Beta.PrivilegedRoleAssignments.Item.MakeEligible {
    ...
    public class MakeEligibleRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Action<MakeEligibleRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<PrivilegedRoleAssignment> PostAsync(CancellationToken cancellationToken = default, Action<MakeEligibleRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
