...
#nullable enable
        public async Task<PrivilegedRoleAssignment?> PostAsync(CancellationToken cancellationToken = default, Action<MakeEligibleRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrivilegedRoleAssignment> PostAsync(CancellationToken cancellationToken = default, Action<MakeEligibleRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
