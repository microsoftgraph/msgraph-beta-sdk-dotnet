...
namespace Microsoft.Graph.Beta.PrivilegedRoleAssignments.Item.RoleInfo.SelfActivate {
    ...
    public class SelfActivateRequestBuilder {
        ...
        /// </summary>
        public async Task<PrivilegedRoleAssignment> PostAsync(SelfActivatePostRequestBody body, CancellationToken cancellationToken = default, Action<SelfActivateRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
