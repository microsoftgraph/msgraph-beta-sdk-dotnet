...
namespace Microsoft.Graph.Beta.PrivilegedRoleAssignments.Item.RoleInfo.SelfActivate {
    ...
    public class SelfActivateRequestBuilder {
        ...
        public SelfActivateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo/microsoft.graph.selfActivate";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SelfActivatePostRequestBody body, Action<SelfActivateRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<PrivilegedRoleAssignment> PostAsync(SelfActivatePostRequestBody body, Action<SelfActivateRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
