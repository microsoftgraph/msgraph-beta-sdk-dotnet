...
using Microsoft.Graph.Beta.PrivilegedRoleAssignments.Item.RoleInfo.Assignments;
using Microsoft.Graph.Beta.PrivilegedRoleAssignments.Item.RoleInfo.SelfActivate;
using Microsoft.Graph.Beta.PrivilegedRoleAssignments.Item.RoleInfo.SelfDeactivate;
using Microsoft.Graph.Beta.PrivilegedRoleAssignments.Item.RoleInfo.Settings;
using Microsoft.Graph.Beta.PrivilegedRoleAssignments.Item.RoleInfo.Summary;
...
using System;
namespace Microsoft.Graph.Beta.PrivilegedRoleAssignments.Item.RoleInfo {
    /// <summary>
    ...
    public class RoleInfoRequestBuilder : BaseRequestBuilder {
        ...
        public RoleInfoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RoleInfoRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RoleInfoRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
