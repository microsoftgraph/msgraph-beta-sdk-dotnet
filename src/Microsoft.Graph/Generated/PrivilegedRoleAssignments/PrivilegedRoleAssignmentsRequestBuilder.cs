...
namespace MicrosoftGraph.PrivilegedRoleAssignments {
    ...
    public class PrivilegedRoleAssignmentsRequestBuilder {
        ...
        public PrivilegedRoleAssignmentsRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("privilegedRoleAssignment_id", position);
            return new PrivilegedRoleAssignmentsRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(PrivilegedRoleAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
