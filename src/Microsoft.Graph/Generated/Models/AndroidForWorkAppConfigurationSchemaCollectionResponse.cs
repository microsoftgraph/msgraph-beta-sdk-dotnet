...
namespace Microsoft.Graph.Beta.Models {
    public class AndroidForWorkAppConfigurationSchemaCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AndroidForWorkAppConfigurationSchema> Value {
            get { return BackingStore?.Get<List<AndroidForWorkAppConfigurationSchema>>(nameof(Value)); }
