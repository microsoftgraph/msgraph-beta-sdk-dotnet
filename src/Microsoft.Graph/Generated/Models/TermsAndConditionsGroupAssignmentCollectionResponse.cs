...
namespace Microsoft.Graph.Beta.Models {
    public class TermsAndConditionsGroupAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TermsAndConditionsGroupAssignment> Value {
            get { return BackingStore?.Get<List<TermsAndConditionsGroupAssignment>>(nameof(Value)); }
