...
namespace Microsoft.Graph.Beta.Models {
    public class WindowsDriverUpdateInventoryCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<WindowsDriverUpdateInventory> Value {
            get { return BackingStore?.Get<List<WindowsDriverUpdateInventory>>(nameof(Value)); }
