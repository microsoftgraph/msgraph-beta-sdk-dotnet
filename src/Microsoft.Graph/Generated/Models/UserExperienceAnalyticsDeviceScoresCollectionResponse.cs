...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsDeviceScoresCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsDeviceScores> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsDeviceScores>>(nameof(Value)); }
