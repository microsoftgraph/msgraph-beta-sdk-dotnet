...
namespace Microsoft.Graph.Beta.Models {
    public class AgedAccountsReceivableCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AgedAccountsReceivable> Value {
            get { return BackingStore?.Get<List<AgedAccountsReceivable>>(nameof(Value)); }
