...
namespace Microsoft.Graph.Beta.Models {
    public class RecommendationResourceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<RecommendationResource> Value {
            get { return BackingStore?.Get<List<RecommendationResource>>(nameof(Value)); }
