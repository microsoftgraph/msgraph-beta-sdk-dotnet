...
namespace Microsoft.Graph.Beta.Models {
    public class JournalLineCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<JournalLine> Value {
            get { return BackingStore?.Get<List<JournalLine>>(nameof(Value)); }
