...
namespace Microsoft.Graph.Beta.Models {
    public class TrustFrameworkPolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TrustFrameworkPolicy> Value {
            get { return BackingStore?.Get<List<TrustFrameworkPolicy>>(nameof(Value)); }
