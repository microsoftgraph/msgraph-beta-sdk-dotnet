...
namespace Microsoft.Graph.Beta.Models {
    /// <summary>The home button configuration base class used to identify the available options</summary>
    public class EdgeHomeButtonConfiguration : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public EdgeHomeButtonConfiguration() {
            ...
            Type = "#microsoft.graph.edgeHomeButtonConfiguration";
        }
        /// <summary>
