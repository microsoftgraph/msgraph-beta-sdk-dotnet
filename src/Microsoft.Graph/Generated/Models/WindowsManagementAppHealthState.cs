...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.HealthState? HealthState
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.HealthState?>("healthState"); }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Models.WindowsManagementAppHealthState"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.Beta.Models.WindowsManagementAppHealthState CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.WindowsManagementAppHealthState();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "healthState", n => { HealthState = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.HealthState>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.HealthState>("healthState", HealthState);
