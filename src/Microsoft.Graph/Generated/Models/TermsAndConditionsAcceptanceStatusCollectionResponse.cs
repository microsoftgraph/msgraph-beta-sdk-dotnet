...
namespace Microsoft.Graph.Beta.Models {
    public class TermsAndConditionsAcceptanceStatusCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TermsAndConditionsAcceptanceStatus> Value {
            get { return BackingStore?.Get<List<TermsAndConditionsAcceptanceStatus>>(nameof(Value)); }
