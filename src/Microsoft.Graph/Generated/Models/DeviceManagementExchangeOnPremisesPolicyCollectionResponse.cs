...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceManagementExchangeOnPremisesPolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceManagementExchangeOnPremisesPolicy> Value {
            get { return BackingStore?.Get<List<DeviceManagementExchangeOnPremisesPolicy>>(nameof(Value)); }
