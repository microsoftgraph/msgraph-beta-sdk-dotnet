...
namespace Microsoft.Graph.Beta.Models {
    public class UnsupportedGroupPolicyExtensionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UnsupportedGroupPolicyExtension> Value {
            get { return BackingStore?.Get<List<UnsupportedGroupPolicyExtension>>(nameof(Value)); }
