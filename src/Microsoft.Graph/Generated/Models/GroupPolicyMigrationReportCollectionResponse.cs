...
namespace Microsoft.Graph.Beta.Models {
    public class GroupPolicyMigrationReportCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<GroupPolicyMigrationReport> Value {
            get { return BackingStore?.Get<List<GroupPolicyMigrationReport>>(nameof(Value)); }
