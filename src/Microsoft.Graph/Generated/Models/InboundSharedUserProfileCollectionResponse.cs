...
namespace Microsoft.Graph.Beta.Models {
    public class InboundSharedUserProfileCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<InboundSharedUserProfile> Value {
            get { return BackingStore?.Get<List<InboundSharedUserProfile>>(nameof(Value)); }
