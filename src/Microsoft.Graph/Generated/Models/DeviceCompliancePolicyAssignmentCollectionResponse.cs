...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceCompliancePolicyAssignmentCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static DeviceCompliancePolicyAssignmentCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DeviceCompliancePolicyAssignmentCollectionResponse).Value = n.GetCollectionOfObjectValues<DeviceCompliancePolicyAssignment>(DeviceCompliancePolicyAssignment.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
