...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsCategoryCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsCategory> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsCategory>>(nameof(Value)); }
