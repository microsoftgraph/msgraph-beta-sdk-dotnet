    ...
    public class ManagedDeviceMobileAppConfigurationUserStatus : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"devicesCount", (o,n) => { (o as ManagedDeviceMobileAppConfigurationUserStatus).DevicesCount = n.GetIntValue(); } },
                {"lastReportedDateTime", (o,n) => { (o as ManagedDeviceMobileAppConfigurationUserStatus).LastReportedDateTime = n.GetDateTimeOffsetValue(); } },
                {"status", (o,n) => { (o as ManagedDeviceMobileAppConfigurationUserStatus).Status = n.GetEnumValue<ComplianceStatus>(); } },
                {"userDisplayName", (o,n) => { (o as ManagedDeviceMobileAppConfigurationUserStatus).UserDisplayName = n.GetStringValue(); } },
                {"userPrincipalName", (o,n) => { (o as ManagedDeviceMobileAppConfigurationUserStatus).UserPrincipalName = n.GetStringValue(); } },
            };
        }
        /// <summary>
