...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsDevicePerformanceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsDevicePerformance> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsDevicePerformance>>(nameof(Value)); }
