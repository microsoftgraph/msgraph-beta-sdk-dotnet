...
namespace Microsoft.Graph.Beta.Models {
    public class ImportedDeviceIdentityResultCollectionResponse : BaseCollectionPaginationCountResponse, IParsable {
...
#nullable restore
        ...
        public static new ImportedDeviceIdentityResultCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ImportedDeviceIdentityResultCollectionResponse();
        }
        /// <summary>
