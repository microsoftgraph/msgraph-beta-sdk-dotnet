...
namespace Microsoft.Graph.Beta.Models {
    public class DimensionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Dimension> Value {
            get { return BackingStore?.Get<List<Dimension>>(nameof(Value)); }
