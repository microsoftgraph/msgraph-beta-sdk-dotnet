...
namespace Microsoft.Graph.Beta.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::Microsoft.Graph.Beta.Models.BackupServiceConsumer? BackupServiceConsumer
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.BackupServiceConsumer?>("backupServiceConsumer"); }
        ...
        public global::Microsoft.Graph.Beta.Models.DisableReason? DisableReason
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.DisableReason?>("disableReason"); }
...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.BackupServiceStatus? Status
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.BackupServiceStatus?>("status"); }
            set { BackingStore?.Set("status", value); }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Models.ServiceStatus"/> and sets the default values.
        /// </summary>
        ...
        public static global::Microsoft.Graph.Beta.Models.ServiceStatus CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.ServiceStatus();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "backupServiceConsumer", n => { BackupServiceConsumer = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.BackupServiceConsumer>(); } },
                { "disableReason", n => { DisableReason = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.DisableReason>(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.BackupServiceStatus>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.BackupServiceConsumer>("backupServiceConsumer", BackupServiceConsumer);
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.DisableReason>("disableReason", DisableReason);
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.BackupServiceStatus>("status", Status);
