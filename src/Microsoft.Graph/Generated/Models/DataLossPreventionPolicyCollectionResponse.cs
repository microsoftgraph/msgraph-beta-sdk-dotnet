...
namespace Microsoft.Graph.Beta.Models {
    public class DataLossPreventionPolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DataLossPreventionPolicy> Value {
            get { return BackingStore?.Get<List<DataLossPreventionPolicy>>(nameof(Value)); }
