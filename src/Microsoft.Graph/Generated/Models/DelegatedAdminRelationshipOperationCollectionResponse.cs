...
namespace Microsoft.Graph.Beta.Models {
    public class DelegatedAdminRelationshipOperationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DelegatedAdminRelationshipOperation> Value {
            get { return BackingStore?.Get<List<DelegatedAdminRelationshipOperation>>(nameof(Value)); }
