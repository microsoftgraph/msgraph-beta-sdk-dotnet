...
namespace Microsoft.Graph.Beta.Models {
    public class PrintServiceEndpointCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        public List<PrintServiceEndpoint> Value { get; set; }
        /// <summary>
        ...
        /// </summary>
        public static PrintServiceEndpointCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as PrintServiceEndpointCollectionResponse).Value = n.GetCollectionOfObjectValues<PrintServiceEndpoint>(PrintServiceEndpoint.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
