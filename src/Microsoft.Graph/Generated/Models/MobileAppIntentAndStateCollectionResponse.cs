...
namespace Microsoft.Graph.Beta.Models {
    public class MobileAppIntentAndStateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<MobileAppIntentAndState> Value {
            get { return BackingStore?.Get<List<MobileAppIntentAndState>>(nameof(Value)); }
