...
namespace Microsoft.Graph.Beta.Models {
    public class ThreatAssessmentResultCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ThreatAssessmentResult> Value {
            get { return BackingStore?.Get<List<ThreatAssessmentResult>>(nameof(Value)); }
