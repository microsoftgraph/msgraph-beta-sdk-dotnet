...
namespace Microsoft.Graph.Beta.Models {
    public class PrinterDefaults : IAdditionalDataHolder, IParsable {
        ...
        public Microsoft.Graph.Beta.Models.PrintColorConfiguration? PrintColorConfiguration { get; set; }
        /// <summary>The printQuality property</summary>
        public Microsoft.Graph.Beta.Models.PrintQuality? PrintQuality { get; set; }
        /// <summary>The default quality to use when printing the document. Valid values are described in the following table.</summary>
        public Microsoft.Graph.Beta.Models.PrintQuality? Quality { get; set; }
