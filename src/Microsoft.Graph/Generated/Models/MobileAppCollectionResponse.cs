    ...
    public class MobileAppCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as MobileAppCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as MobileAppCollectionResponse).Value = n.GetCollectionOfObjectValues<MobileApp>(MobileApp.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
