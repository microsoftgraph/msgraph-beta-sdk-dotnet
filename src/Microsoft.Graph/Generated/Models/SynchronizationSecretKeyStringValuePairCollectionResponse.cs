...
namespace Microsoft.Graph.Beta.Models {
    public class SynchronizationSecretKeyStringValuePairCollectionResponse : BaseCollectionPaginationCountResponse, IParsable {
        ...
        public static new SynchronizationSecretKeyStringValuePairCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SynchronizationSecretKeyStringValuePairCollectionResponse();
        }
        /// <summary>
