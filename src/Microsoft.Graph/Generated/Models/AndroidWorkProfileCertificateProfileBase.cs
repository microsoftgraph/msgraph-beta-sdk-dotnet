...
namespace Microsoft.Graph.Beta.Models
{
    ...
    /// </summary>
    public class AndroidWorkProfileCertificateProfileBase : Microsoft.Graph.Beta.Models.DeviceConfiguration, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Beta.Models.AndroidWorkProfileTrustedRootCertificate? RootCertificate
        {
            get { return BackingStore?.Get<Microsoft.Graph.Beta.Models.AndroidWorkProfileTrustedRootCertificate?>("rootCertificate"); }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Models.AndroidWorkProfileCertificateProfileBase"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Models.AndroidWorkProfileCertificateProfileBase"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Microsoft.Graph.Beta.Models.AndroidWorkProfileCertificateProfileBase CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new Microsoft.Graph.Beta.Models.AndroidWorkProfileCertificateProfileBase(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "rootCertificate", n => { RootCertificate = n.GetObjectValue<Microsoft.Graph.Beta.Models.AndroidWorkProfileTrustedRootCertificate>(Microsoft.Graph.Beta.Models.AndroidWorkProfileTrustedRootCertificate.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Microsoft.Graph.Beta.Models.AndroidWorkProfileTrustedRootCertificate>("rootCertificate", RootCertificate);
