...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceManagementConfigurationPolicyTemplateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceManagementConfigurationPolicyTemplate> Value {
            get { return BackingStore?.Get<List<DeviceManagementConfigurationPolicyTemplate>>(nameof(Value)); }
