...
namespace Microsoft.Graph.Beta.Models {
    public class CloudPcUserSettingAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<CloudPcUserSettingAssignment> Value {
            get { return BackingStore?.Get<List<CloudPcUserSettingAssignment>>(nameof(Value)); }
