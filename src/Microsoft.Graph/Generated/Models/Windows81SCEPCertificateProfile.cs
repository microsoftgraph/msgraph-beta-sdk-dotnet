...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class Windows81SCEPCertificateProfile : global::Microsoft.Graph.Beta.Models.Windows81CertificateProfileBase, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Beta.Models.Windows81TrustedRootCertificate? RootCertificate
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.Windows81TrustedRootCertificate?>("rootCertificate"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Models.Windows81SCEPCertificateProfile"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Models.Windows81SCEPCertificateProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.Beta.Models.Windows81SCEPCertificateProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.Windows81SCEPCertificateProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "rootCertificate", n => { RootCertificate = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.Windows81TrustedRootCertificate>(global::Microsoft.Graph.Beta.Models.Windows81TrustedRootCertificate.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.Windows81TrustedRootCertificate>("rootCertificate", RootCertificate);
