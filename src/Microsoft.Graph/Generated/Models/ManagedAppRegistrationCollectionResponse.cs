...
namespace Microsoft.Graph.Beta.Models {
    public class ManagedAppRegistrationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ManagedAppRegistration> Value {
            get { return BackingStore?.Get<List<ManagedAppRegistration>>(nameof(Value)); }
