...
namespace Microsoft.Graph.Beta.Models {
    public class OAuth2PermissionGrantCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<OAuth2PermissionGrant> Value {
            get { return BackingStore?.Get<List<OAuth2PermissionGrant>>(nameof(Value)); }
