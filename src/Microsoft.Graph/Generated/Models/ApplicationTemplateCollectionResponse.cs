...
namespace Microsoft.Graph.Beta.Models {
    public class ApplicationTemplateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ApplicationTemplate> Value {
            get { return BackingStore?.Get<List<ApplicationTemplate>>(nameof(Value)); }
