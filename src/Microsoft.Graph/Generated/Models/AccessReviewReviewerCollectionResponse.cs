...
namespace Microsoft.Graph.Beta.Models {
    public class AccessReviewReviewerCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AccessReviewReviewer> Value {
            get { return BackingStore?.Get<List<AccessReviewReviewer>>(nameof(Value)); }
