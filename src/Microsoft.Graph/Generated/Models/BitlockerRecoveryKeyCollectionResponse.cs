...
namespace Microsoft.Graph.Beta.Models {
    public class BitlockerRecoveryKeyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<BitlockerRecoveryKey> Value {
            get { return BackingStore?.Get<List<BitlockerRecoveryKey>>(nameof(Value)); }
