...
namespace Microsoft.Graph.Beta.Models {
    public class FederatedIdentityCredentialCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<FederatedIdentityCredential> Value {
            get { return BackingStore?.Get<List<FederatedIdentityCredential>>(nameof(Value)); }
