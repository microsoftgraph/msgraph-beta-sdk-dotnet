...
namespace Microsoft.Graph.Beta.Models {
    public class IdentityProviderCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<IdentityProvider> Value {
            get { return BackingStore?.Get<List<IdentityProvider>>(nameof(Value)); }
