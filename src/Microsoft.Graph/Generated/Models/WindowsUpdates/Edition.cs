...
namespace Microsoft.Graph.Beta.Models.WindowsUpdates
{
    ...
    public partial class Edition : global::Microsoft.Graph.Beta.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.WindowsUpdates.ServicingPeriod>? ServicingPeriods
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.WindowsUpdates.ServicingPeriod>?>("servicingPeriods"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.WindowsUpdates.Edition CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.WindowsUpdates.Edition();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "servicingPeriods", n => { ServicingPeriods = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.WindowsUpdates.ServicingPeriod>(global::Microsoft.Graph.Beta.Models.WindowsUpdates.ServicingPeriod.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.WindowsUpdates.ServicingPeriod>("servicingPeriods", ServicingPeriods);
        }
    }
}
