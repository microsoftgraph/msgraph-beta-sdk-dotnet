...
namespace Microsoft.Graph.Beta.Models.WindowsUpdates {
    public class UpdatableAssetCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UpdatableAsset> Value {
            get { return BackingStore?.Get<List<UpdatableAsset>>(nameof(Value)); }
