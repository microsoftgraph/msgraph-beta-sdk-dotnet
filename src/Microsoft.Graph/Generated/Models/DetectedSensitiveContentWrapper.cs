    ...
    public class DetectedSensitiveContentWrapper : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"classification", (o,n) => { (o as DetectedSensitiveContentWrapper).Classification = n.GetCollectionOfObjectValues<DetectedSensitiveContent>(DetectedSensitiveContent.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
