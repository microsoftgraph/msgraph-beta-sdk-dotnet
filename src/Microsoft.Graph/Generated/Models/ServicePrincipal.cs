...
namespace Microsoft.Graph.Beta.Models {
    public class ServicePrincipal : DirectoryObject, IParsable {
        ...
        public List<Microsoft.Graph.Beta.Models.LicenseDetails> LicenseDetails { get; set; }
        ...
        public Microsoft.Graph.Beta.Models.PasswordSingleSignOnSettings PasswordSingleSignOnSettings { get; set; }
        ...
        public Microsoft.Graph.Beta.Models.SamlSingleSignOnSettings SamlSingleSignOnSettings { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"licenseDetails", (o,n) => { (o as ServicePrincipal).LicenseDetails = n.GetCollectionOfObjectValues<Microsoft.Graph.Beta.Models.LicenseDetails>(Microsoft.Graph.Beta.Models.LicenseDetails.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"passwordSingleSignOnSettings", (o,n) => { (o as ServicePrincipal).PasswordSingleSignOnSettings = n.GetObjectValue<Microsoft.Graph.Beta.Models.PasswordSingleSignOnSettings>(Microsoft.Graph.Beta.Models.PasswordSingleSignOnSettings.CreateFromDiscriminatorValue); } },
                ...
                {"samlSingleSignOnSettings", (o,n) => { (o as ServicePrincipal).SamlSingleSignOnSettings = n.GetObjectValue<Microsoft.Graph.Beta.Models.SamlSingleSignOnSettings>(Microsoft.Graph.Beta.Models.SamlSingleSignOnSettings.CreateFromDiscriminatorValue); } },
                ...
                {"synchronization", (o,n) => { (o as ServicePrincipal).Synchronization = n.GetObjectValue<Microsoft.Graph.Beta.Models.Synchronization>(Microsoft.Graph.Beta.Models.Synchronization.CreateFromDiscriminatorValue); } },
