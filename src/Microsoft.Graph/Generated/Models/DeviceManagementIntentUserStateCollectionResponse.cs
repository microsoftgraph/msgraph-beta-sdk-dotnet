...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceManagementIntentUserStateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceManagementIntentUserState> Value {
            get { return BackingStore?.Get<List<DeviceManagementIntentUserState>>(nameof(Value)); }
