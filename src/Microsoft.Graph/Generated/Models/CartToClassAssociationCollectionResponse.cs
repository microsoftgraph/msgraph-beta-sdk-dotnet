...
namespace Microsoft.Graph.Beta.Models {
    public class CartToClassAssociationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<CartToClassAssociation> Value {
            get { return BackingStore?.Get<List<CartToClassAssociation>>(nameof(Value)); }
