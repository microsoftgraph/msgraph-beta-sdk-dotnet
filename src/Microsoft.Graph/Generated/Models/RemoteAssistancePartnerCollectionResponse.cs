...
namespace Microsoft.Graph.Beta.Models {
    public class RemoteAssistancePartnerCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<RemoteAssistancePartner> Value {
            get { return BackingStore?.Get<List<RemoteAssistancePartner>>(nameof(Value)); }
