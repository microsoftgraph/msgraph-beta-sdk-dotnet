...
namespace Microsoft.Graph.Beta.Models {
    public class B2xIdentityUserFlowCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<B2xIdentityUserFlow> Value {
            get { return BackingStore?.Get<List<B2xIdentityUserFlow>>(nameof(Value)); }
