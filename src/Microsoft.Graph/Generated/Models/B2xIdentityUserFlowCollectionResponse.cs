    ...
    public class B2xIdentityUserFlowCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as B2xIdentityUserFlowCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as B2xIdentityUserFlowCollectionResponse).Value = n.GetCollectionOfObjectValues<B2xIdentityUserFlow>(B2xIdentityUserFlow.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
