...
namespace Microsoft.Graph.Beta.Models {
    public class IdentityApiConnectorCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<IdentityApiConnector> Value {
            get { return BackingStore?.Get<List<IdentityApiConnector>>(nameof(Value)); }
