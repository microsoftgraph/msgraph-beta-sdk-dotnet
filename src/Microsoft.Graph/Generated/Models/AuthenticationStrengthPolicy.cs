...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.AuthenticationCombinationConfiguration>? CombinationConfigurations
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.AuthenticationCombinationConfiguration>?>("combinationConfigurations"); }
...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.AuthenticationStrengthPolicyType? PolicyType
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.AuthenticationStrengthPolicyType?>("policyType"); }
            set { BackingStore?.Set("policyType", value); }
        }
        /// <summary>The requirementsSatisfied property</summary>
        public global::Microsoft.Graph.Beta.Models.AuthenticationStrengthRequirements? RequirementsSatisfied
        {
        ...
        public static new global::Microsoft.Graph.Beta.Models.AuthenticationStrengthPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.AuthenticationStrengthPolicy();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "combinationConfigurations", n => { CombinationConfigurations = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.AuthenticationCombinationConfiguration>(global::Microsoft.Graph.Beta.Models.AuthenticationCombinationConfiguration.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.AuthenticationCombinationConfiguration>("combinationConfigurations", CombinationConfigurations);
