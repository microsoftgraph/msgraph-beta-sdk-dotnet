...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class Mention : global::Microsoft.Graph.Beta.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Beta.Models.EmailAddress? CreatedBy
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.EmailAddress?>("createdBy"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Beta.Models.EmailAddress? Mentioned
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.EmailAddress?>("mentioned"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.Mention CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.Mention();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "createdBy", n => { CreatedBy = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.EmailAddress>(global::Microsoft.Graph.Beta.Models.EmailAddress.CreateFromDiscriminatorValue); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "deepLink", n => { DeepLink = n.GetStringValue(); } },
                { "mentionText", n => { MentionText = n.GetStringValue(); } },
                { "mentioned", n => { Mentioned = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.EmailAddress>(global::Microsoft.Graph.Beta.Models.EmailAddress.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.EmailAddress>("createdBy", CreatedBy);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteStringValue("deepLink", DeepLink);
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.EmailAddress>("mentioned", Mentioned);
