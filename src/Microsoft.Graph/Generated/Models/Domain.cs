...
namespace Microsoft.Graph.Beta.Models {
    public class Domain : Entity, IParsable {
        ...
        public List<SharedEmailDomainInvitation> SharedEmailDomainInvitations {
            get { return BackingStore?.Get<List<SharedEmailDomainInvitation>>(nameof(SharedEmailDomainInvitations)); }
            set { BackingStore?.Set(nameof(SharedEmailDomainInvitations), value); }
        }
