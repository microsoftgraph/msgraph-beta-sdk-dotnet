    ...
    public class DeviceAndAppManagementRoleAssignment : RoleAssignment, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"roleScopeTags", (o,n) => { (o as DeviceAndAppManagementRoleAssignment).RoleScopeTags = n.GetCollectionOfObjectValues<RoleScopeTag>(RoleScopeTag.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
