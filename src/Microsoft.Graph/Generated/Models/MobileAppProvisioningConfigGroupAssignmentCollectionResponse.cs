...
namespace Microsoft.Graph.Beta.Models {
    public class MobileAppProvisioningConfigGroupAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<MobileAppProvisioningConfigGroupAssignment> Value {
            get { return BackingStore?.Get<List<MobileAppProvisioningConfigGroupAssignment>>(nameof(Value)); }
