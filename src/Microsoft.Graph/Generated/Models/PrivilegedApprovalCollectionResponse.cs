...
namespace Microsoft.Graph.Beta.Models {
    public class PrivilegedApprovalCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<PrivilegedApproval> Value {
            get { return BackingStore?.Get<List<PrivilegedApproval>>(nameof(Value)); }
