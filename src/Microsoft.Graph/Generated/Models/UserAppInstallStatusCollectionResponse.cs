...
namespace Microsoft.Graph.Beta.Models {
    public class UserAppInstallStatusCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserAppInstallStatus> Value {
            get { return BackingStore?.Get<List<UserAppInstallStatus>>(nameof(Value)); }
