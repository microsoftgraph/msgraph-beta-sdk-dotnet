...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class TermsAndConditionsGroupAssignmentCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as TermsAndConditionsGroupAssignmentCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as TermsAndConditionsGroupAssignmentCollectionResponse).Value = n.GetCollectionOfObjectValues<TermsAndConditionsGroupAssignment>(TermsAndConditionsGroupAssignment.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
