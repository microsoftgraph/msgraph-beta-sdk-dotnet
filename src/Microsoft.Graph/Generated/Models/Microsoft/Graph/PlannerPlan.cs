    ...
    public class PlannerPlan : PlannerDelta, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"container", (o,n) => { (o as PlannerPlan).Container = n.GetObjectValue<PlannerPlanContainer>(); } },
                {"contexts", (o,n) => { (o as PlannerPlan).Contexts = n.GetObjectValue<PlannerPlanContextCollection>(); } },
