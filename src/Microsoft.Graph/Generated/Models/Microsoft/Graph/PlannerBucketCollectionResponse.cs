...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    public class PlannerBucketCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static PlannerBucketCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as PlannerBucketCollectionResponse).Value = n.GetCollectionOfObjectValues<PlannerBucket>(PlannerBucket.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
