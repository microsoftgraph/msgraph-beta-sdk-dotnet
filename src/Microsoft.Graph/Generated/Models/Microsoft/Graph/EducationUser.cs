    ...
    public class EducationUser : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"passwordProfile", (o,n) => { (o as EducationUser).PasswordProfile = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.PasswordProfile>(MicrosoftGraphSdk.Models.Microsoft.Graph.PasswordProfile.CreateFromDiscriminatorValue); } },
                ...
                {"user", (o,n) => { (o as EducationUser).User = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.User>(MicrosoftGraphSdk.Models.Microsoft.Graph.User.CreateFromDiscriminatorValue); } },
