...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    public class CertificateBasedAuthConfigurationCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as CertificateBasedAuthConfigurationCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as CertificateBasedAuthConfigurationCollectionResponse).Value = n.GetCollectionOfObjectValues<CertificateBasedAuthConfiguration>(CertificateBasedAuthConfiguration.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
