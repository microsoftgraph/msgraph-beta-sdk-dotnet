...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class ScopedRoleMembershipCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ScopedRoleMembershipCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ScopedRoleMembershipCollectionResponse).Value = n.GetCollectionOfObjectValues<ScopedRoleMembership>(ScopedRoleMembership.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
