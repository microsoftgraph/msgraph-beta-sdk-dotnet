    ...
    public class Session : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"failureInfo", (o,n) => { (o as Session).FailureInfo = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.CallRecords.FailureInfo>(MicrosoftGraphSdk.Models.Microsoft.Graph.CallRecords.FailureInfo.CreateFromDiscriminatorValue); } },
