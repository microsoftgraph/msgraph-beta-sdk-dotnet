...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph.CallRecords {
    ...
    public class Segment : Entity, IParsable {
        ...
        public MicrosoftGraphSdk.Models.Microsoft.Graph.CallRecords.FailureInfo FailureInfo { get; set; }
        /// <summary>Media associated with this segment.</summary>
        public List<MicrosoftGraphSdk.Models.Microsoft.Graph.CallRecords.Media> Media { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"failureInfo", (o,n) => { (o as Segment).FailureInfo = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.CallRecords.FailureInfo>(MicrosoftGraphSdk.Models.Microsoft.Graph.CallRecords.FailureInfo.CreateFromDiscriminatorValue); } },
                {"media", (o,n) => { (o as Segment).Media = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.CallRecords.Media>(MicrosoftGraphSdk.Models.Microsoft.Graph.CallRecords.Media.CreateFromDiscriminatorValue).ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.CallRecords.FailureInfo>("failureInfo", FailureInfo);
            writer.WriteCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.CallRecords.Media>("media", Media);
