...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class ProvisionChannelEmailResult : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ProvisionChannelEmailResult CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"email", (o,n) => { (o as ProvisionChannelEmailResult).Email = n.GetStringValue(); } },
            };
        }
        /// <summary>
