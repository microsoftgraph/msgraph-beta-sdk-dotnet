    ...
    public class GroupPolicyConfiguration : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"assignments", (o,n) => { (o as GroupPolicyConfiguration).Assignments = n.GetCollectionOfObjectValues<GroupPolicyConfigurationAssignment>().ToList(); } },
                {"createdDateTime", (o,n) => { (o as GroupPolicyConfiguration).CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                {"definitionValues", (o,n) => { (o as GroupPolicyConfiguration).DefinitionValues = n.GetCollectionOfObjectValues<GroupPolicyDefinitionValue>().ToList(); } },
