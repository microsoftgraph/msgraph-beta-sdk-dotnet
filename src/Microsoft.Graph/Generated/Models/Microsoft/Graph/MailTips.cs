    ...
    public class MailTips : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"emailAddress", (o,n) => { (o as MailTips).EmailAddress = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.EmailAddress>(MicrosoftGraphSdk.Models.Microsoft.Graph.EmailAddress.CreateFromDiscriminatorValue); } },
