...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class TeamsTemplateCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static TeamsTemplateCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as TeamsTemplateCollectionResponse).Value = n.GetCollectionOfObjectValues<TeamsTemplate>(TeamsTemplate.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
