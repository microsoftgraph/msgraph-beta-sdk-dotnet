...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class MessageRuleCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as MessageRuleCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as MessageRuleCollectionResponse).Value = n.GetCollectionOfObjectValues<MessageRule>(MessageRule.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
