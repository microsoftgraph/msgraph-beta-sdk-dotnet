    ...
    public class UserAppInstallStatus : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"app", (o,n) => { (o as UserAppInstallStatus).App = n.GetObjectValue<MobileApp>(); } },
                {"deviceStatuses", (o,n) => { (o as UserAppInstallStatus).DeviceStatuses = n.GetCollectionOfObjectValues<MobileAppInstallStatus>().ToList(); } },
