...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    public class DeviceManagementPartnerAssignment : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"target", (o,n) => { (o as DeviceManagementPartnerAssignment).Target = n.GetObjectValue<DeviceAndAppManagementAssignmentTarget>(); } },
            };
        }
        /// <summary>
