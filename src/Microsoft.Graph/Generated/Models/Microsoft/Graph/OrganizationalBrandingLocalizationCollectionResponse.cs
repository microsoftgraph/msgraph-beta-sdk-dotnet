...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class OrganizationalBrandingLocalizationCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as OrganizationalBrandingLocalizationCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as OrganizationalBrandingLocalizationCollectionResponse).Value = n.GetCollectionOfObjectValues<OrganizationalBrandingLocalization>(OrganizationalBrandingLocalization.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
