...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class AttachmentCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as AttachmentCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as AttachmentCollectionResponse).Value = n.GetCollectionOfObjectValues<Attachment>(Attachment.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
