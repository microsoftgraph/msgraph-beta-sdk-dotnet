    ...
    public class ManagedMobileApp : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"mobileAppIdentifier", (o,n) => { (o as ManagedMobileApp).MobileAppIdentifier = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.MobileAppIdentifier>(MicrosoftGraphSdk.Models.Microsoft.Graph.MobileAppIdentifier.CreateFromDiscriminatorValue); } },
