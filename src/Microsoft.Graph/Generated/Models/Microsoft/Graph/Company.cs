...
namespace MicrosoftGraph.Models.Microsoft.Graph {
    public class Company : Entity, IParsable {
        public List<MicrosoftGraph.Models.Microsoft.Graph.Account> Accounts { get; set; }
        public List<MicrosoftGraph.Models.Microsoft.Graph.AgedAccountsPayable> AgedAccountsPayable { get; set; }
        public List<MicrosoftGraph.Models.Microsoft.Graph.AgedAccountsReceivable> AgedAccountsReceivable { get; set; }
        public string BusinessProfileId { get; set; }
        public List<MicrosoftGraph.Models.Microsoft.Graph.CompanyInformation> CompanyInformation { get; set; }
        public List<CountryRegion> CountriesRegions { get; set; }
        public List<MicrosoftGraph.Models.Microsoft.Graph.Currency> Currencies { get; set; }
        public List<CustomerPaymentJournal> CustomerPaymentJournals { get; set; }
        public List<CustomerPayment> CustomerPayments { get; set; }
        public List<MicrosoftGraph.Models.Microsoft.Graph.Customer> Customers { get; set; }
        ...
        public List<MicrosoftGraph.Models.Microsoft.Graph.ItemCategory> ItemCategories { get; set; }
        public List<MicrosoftGraph.Models.Microsoft.Graph.Item.Item> Items { get; set; }
        public List<JournalLine> JournalLines { get; set; }
        public List<Journal> Journals { get; set; }
        public string Name { get; set; }
        public List<MicrosoftGraph.Models.Microsoft.Graph.PaymentMethod> PaymentMethods { get; set; }
        public List<MicrosoftGraph.Models.Microsoft.Graph.PaymentTerm> PaymentTerms { get; set; }
        ...
        public List<MicrosoftGraph.Models.Microsoft.Graph.ShipmentMethod> ShipmentMethods { get; set; }
        ...
        public List<MicrosoftGraph.Models.Microsoft.Graph.Vendor> Vendors { get; set; }
        /// <summary>
        /// The deserialization information for the current model
        /// </summary>
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"accounts", (o,n) => { (o as Company).Accounts = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.Account>().ToList(); } },
                {"agedAccountsPayable", (o,n) => { (o as Company).AgedAccountsPayable = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.AgedAccountsPayable>().ToList(); } },
                {"agedAccountsReceivable", (o,n) => { (o as Company).AgedAccountsReceivable = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.AgedAccountsReceivable>().ToList(); } },
                {"businessProfileId", (o,n) => { (o as Company).BusinessProfileId = n.GetStringValue(); } },
                {"companyInformation", (o,n) => { (o as Company).CompanyInformation = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.CompanyInformation>().ToList(); } },
                {"countriesRegions", (o,n) => { (o as Company).CountriesRegions = n.GetCollectionOfObjectValues<CountryRegion>().ToList(); } },
                {"currencies", (o,n) => { (o as Company).Currencies = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.Currency>().ToList(); } },
                ...
                {"customers", (o,n) => { (o as Company).Customers = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.Customer>().ToList(); } },
                ...
                {"itemCategories", (o,n) => { (o as Company).ItemCategories = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.ItemCategory>().ToList(); } },
                {"items", (o,n) => { (o as Company).Items = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.Item.Item>().ToList(); } },
                ...
                {"paymentMethods", (o,n) => { (o as Company).PaymentMethods = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.PaymentMethod>().ToList(); } },
                {"paymentTerms", (o,n) => { (o as Company).PaymentTerms = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.PaymentTerm>().ToList(); } },
                {"picture", (o,n) => { (o as Company).Picture = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.Picture>().ToList(); } },
                ...
                {"shipmentMethods", (o,n) => { (o as Company).ShipmentMethods = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.ShipmentMethod>().ToList(); } },
                ...
                {"vendors", (o,n) => { (o as Company).Vendors = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.Vendor>().ToList(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.Account>("accounts", Accounts);
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.AgedAccountsPayable>("agedAccountsPayable", AgedAccountsPayable);
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.AgedAccountsReceivable>("agedAccountsReceivable", AgedAccountsReceivable);
            writer.WriteStringValue("businessProfileId", BusinessProfileId);
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.CompanyInformation>("companyInformation", CompanyInformation);
            writer.WriteCollectionOfObjectValues<CountryRegion>("countriesRegions", CountriesRegions);
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.Currency>("currencies", Currencies);
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.Customer>("customers", Customers);
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.ItemCategory>("itemCategories", ItemCategories);
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.Item.Item>("items", Items);
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.PaymentMethod>("paymentMethods", PaymentMethods);
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.PaymentTerm>("paymentTerms", PaymentTerms);
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.ShipmentMethod>("shipmentMethods", ShipmentMethods);
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.Vendor>("vendors", Vendors);
        }
    }
}
