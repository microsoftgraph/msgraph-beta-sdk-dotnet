...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class ItemActivityOLDCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as ItemActivityOLDCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as ItemActivityOLDCollectionResponse).Value = n.GetCollectionOfObjectValues<ItemActivityOLD>(ItemActivityOLD.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
