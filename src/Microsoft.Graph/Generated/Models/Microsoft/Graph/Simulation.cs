    ...
    public class Simulation : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"createdBy", (o,n) => { (o as Simulation).CreatedBy = n.GetObjectValue<EmailIdentity>(); } },
                ...
                {"lastModifiedBy", (o,n) => { (o as Simulation).LastModifiedBy = n.GetObjectValue<EmailIdentity>(); } },
                ...
                {"report", (o,n) => { (o as Simulation).Report = n.GetObjectValue<SimulationReport>(); } },
