...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class PrintTaskTriggerCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static PrintTaskTriggerCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as PrintTaskTriggerCollectionResponse).Value = n.GetCollectionOfObjectValues<PrintTaskTrigger>(PrintTaskTrigger.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
