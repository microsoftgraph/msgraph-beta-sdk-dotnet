...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class FileSecurityState : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"fileHash", (o,n) => { (o as FileSecurityState).FileHash = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.FileHash>(MicrosoftGraphSdk.Models.Microsoft.Graph.FileHash.CreateFromDiscriminatorValue); } },
