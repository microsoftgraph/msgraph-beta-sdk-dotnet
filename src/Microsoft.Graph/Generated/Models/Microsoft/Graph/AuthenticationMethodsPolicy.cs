    ...
    public class AuthenticationMethodsPolicy : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"registrationEnforcement", (o,n) => { (o as AuthenticationMethodsPolicy).RegistrationEnforcement = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.RegistrationEnforcement>(MicrosoftGraphSdk.Models.Microsoft.Graph.RegistrationEnforcement.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.RegistrationEnforcement>("registrationEnforcement", RegistrationEnforcement);
        }
    }
}
