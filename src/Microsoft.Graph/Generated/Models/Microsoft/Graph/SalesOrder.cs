    ...
    public class SalesOrder : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"currency", (o,n) => { (o as SalesOrder).Currency = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.Currency>(); } },
                {"currencyCode", (o,n) => { (o as SalesOrder).CurrencyCode = n.GetStringValue(); } },
                {"currencyId", (o,n) => { (o as SalesOrder).CurrencyId = n.GetStringValue(); } },
                {"customer", (o,n) => { (o as SalesOrder).Customer = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.Customer>(); } },
                ...
                {"paymentTerm", (o,n) => { (o as SalesOrder).PaymentTerm = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.PaymentTerm>(); } },
