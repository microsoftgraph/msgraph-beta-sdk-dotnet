...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph.ExternalConnectors {
    public class SearchSettings : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"searchResultTemplates", (o,n) => { (o as SearchSettings).SearchResultTemplates = n.GetCollectionOfObjectValues<DisplayTemplate>().ToList(); } },
            };
        }
        /// <summary>
