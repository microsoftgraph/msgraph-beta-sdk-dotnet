...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph.ExternalConnectors {
    ...
    public class ExternalItemCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static ExternalItemCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as ExternalItemCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as ExternalItemCollectionResponse).Value = n.GetCollectionOfObjectValues<ExternalItem>(ExternalItem.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
