...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph.ExternalConnectors {
    ...
    public class IdentityCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as IdentityCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as IdentityCollectionResponse).Value = n.GetCollectionOfObjectValues<Identity>(Identity.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
