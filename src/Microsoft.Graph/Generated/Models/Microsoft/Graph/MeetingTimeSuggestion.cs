...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    public class MeetingTimeSuggestion : IParsable {
        ...
        public List<MicrosoftGraphSdk.Models.Microsoft.Graph.AttendeeAvailability> AttendeeAvailability { get; set; }
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"attendeeAvailability", (o,n) => { (o as MeetingTimeSuggestion).AttendeeAvailability = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.AttendeeAvailability>(MicrosoftGraphSdk.Models.Microsoft.Graph.AttendeeAvailability.CreateFromDiscriminatorValue).ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.AttendeeAvailability>("attendeeAvailability", AttendeeAvailability);
