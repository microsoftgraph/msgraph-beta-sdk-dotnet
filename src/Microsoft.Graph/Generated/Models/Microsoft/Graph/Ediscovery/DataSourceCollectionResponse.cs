...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph.Ediscovery {
    ...
    public class DataSourceCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as DataSourceCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as DataSourceCollectionResponse).Value = n.GetCollectionOfObjectValues<DataSource>(DataSource.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
