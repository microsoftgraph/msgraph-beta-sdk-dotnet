...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph.Search {
    ...
    public class AcronymCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static AcronymCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as AcronymCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as AcronymCollectionResponse).Value = n.GetCollectionOfObjectValues<Acronym>(Acronym.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
