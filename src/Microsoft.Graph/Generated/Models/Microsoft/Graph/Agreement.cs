    ...
    public class Agreement : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"termsExpiration", (o,n) => { (o as Agreement).TermsExpiration = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.TermsExpiration>(MicrosoftGraphSdk.Models.Microsoft.Graph.TermsExpiration.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.TermsExpiration>("termsExpiration", TermsExpiration);
