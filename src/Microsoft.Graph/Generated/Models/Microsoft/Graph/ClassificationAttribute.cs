...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class ClassificationAttribute : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"confidence", (o,n) => { (o as ClassificationAttribute).Confidence = n.GetIntValue(); } },
                {"count", (o,n) => { (o as ClassificationAttribute).Count = n.GetIntValue(); } },
            };
        }
        /// <summary>
