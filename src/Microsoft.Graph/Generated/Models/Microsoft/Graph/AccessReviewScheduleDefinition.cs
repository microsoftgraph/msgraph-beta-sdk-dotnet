    ...
    public class AccessReviewScheduleDefinition : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"backupReviewers", (o,n) => { (o as AccessReviewScheduleDefinition).BackupReviewers = n.GetCollectionOfObjectValues<AccessReviewReviewerScope>().ToList(); } },
                ...
                {"stageSettings", (o,n) => { (o as AccessReviewScheduleDefinition).StageSettings = n.GetCollectionOfObjectValues<AccessReviewStageSettings>().ToList(); } },
