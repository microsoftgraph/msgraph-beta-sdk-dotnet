    ...
    public class AccessReviewInstance : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"definition", (o,n) => { (o as AccessReviewInstance).Definition = n.GetObjectValue<AccessReviewScheduleDefinition>(); } },
                {"endDateTime", (o,n) => { (o as AccessReviewInstance).EndDateTime = n.GetDateTimeOffsetValue(); } },
                {"errors", (o,n) => { (o as AccessReviewInstance).Errors = n.GetCollectionOfObjectValues<AccessReviewError>().ToList(); } },
                ...
                {"stages", (o,n) => { (o as AccessReviewInstance).Stages = n.GetCollectionOfObjectValues<AccessReviewStage>().ToList(); } },
