...
namespace MicrosoftGraph.Models.Microsoft.Graph {
    public class AssignmentFilterEvaluationSummary : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"assignmentFilterTypeAndEvaluationResults", (o,n) => { (o as AssignmentFilterEvaluationSummary).AssignmentFilterTypeAndEvaluationResults = n.GetCollectionOfObjectValues<AssignmentFilterTypeAndEvaluationResult>().ToList(); } },
