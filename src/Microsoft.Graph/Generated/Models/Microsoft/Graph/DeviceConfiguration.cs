    ...
    public class DeviceConfiguration : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"deviceManagementApplicabilityRuleDeviceMode", (o,n) => { (o as DeviceConfiguration).DeviceManagementApplicabilityRuleDeviceMode = n.GetObjectValue<DeviceManagementApplicabilityRuleDeviceMode>(); } },
                {"deviceManagementApplicabilityRuleOsEdition", (o,n) => { (o as DeviceConfiguration).DeviceManagementApplicabilityRuleOsEdition = n.GetObjectValue<DeviceManagementApplicabilityRuleOsEdition>(); } },
                {"deviceManagementApplicabilityRuleOsVersion", (o,n) => { (o as DeviceConfiguration).DeviceManagementApplicabilityRuleOsVersion = n.GetObjectValue<DeviceManagementApplicabilityRuleOsVersion>(); } },
                ...
                {"groupAssignments", (o,n) => { (o as DeviceConfiguration).GroupAssignments = n.GetCollectionOfObjectValues<DeviceConfigurationGroupAssignment>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<DeviceManagementApplicabilityRuleDeviceMode>("deviceManagementApplicabilityRuleDeviceMode", DeviceManagementApplicabilityRuleDeviceMode);
            writer.WriteObjectValue<DeviceManagementApplicabilityRuleOsEdition>("deviceManagementApplicabilityRuleOsEdition", DeviceManagementApplicabilityRuleOsEdition);
            writer.WriteObjectValue<DeviceManagementApplicabilityRuleOsVersion>("deviceManagementApplicabilityRuleOsVersion", DeviceManagementApplicabilityRuleOsVersion);
