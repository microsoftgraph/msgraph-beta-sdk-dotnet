...
namespace MicrosoftGraph.Models.Microsoft.Graph {
    public class PolicyRoot : IParsable {
        ...
        public MicrosoftGraph.Models.Microsoft.Graph.AccessReviewPolicy AccessReviewPolicy { get; set; }
        ...
        public List<MicrosoftGraph.Models.Microsoft.Graph.AuthorizationPolicy> AuthorizationPolicy { get; set; }
        /// <summary>The Azure AD B2C policies that define how end users register via local accounts.</summary>
        public MicrosoftGraph.Models.Microsoft.Graph.B2cAuthenticationMethodsPolicy B2cAuthenticationMethodsPolicy { get; set; }
        ...
        public MicrosoftGraph.Models.Microsoft.Graph.DirectoryRoleAccessReviewPolicy DirectoryRoleAccessReviewPolicy { get; set; }
        public MicrosoftGraph.Models.Microsoft.Graph.ExternalIdentitiesPolicy ExternalIdentitiesPolicy { get; set; }
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"accessReviewPolicy", (o,n) => { (o as PolicyRoot).AccessReviewPolicy = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.AccessReviewPolicy>(); } },
                ...
                {"authorizationPolicy", (o,n) => { (o as PolicyRoot).AuthorizationPolicy = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.AuthorizationPolicy>().ToList(); } },
                {"b2cAuthenticationMethodsPolicy", (o,n) => { (o as PolicyRoot).B2cAuthenticationMethodsPolicy = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.B2cAuthenticationMethodsPolicy>(); } },
                ...
                {"directoryRoleAccessReviewPolicy", (o,n) => { (o as PolicyRoot).DirectoryRoleAccessReviewPolicy = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.DirectoryRoleAccessReviewPolicy>(); } },
                {"externalIdentitiesPolicy", (o,n) => { (o as PolicyRoot).ExternalIdentitiesPolicy = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.ExternalIdentitiesPolicy>(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.AccessReviewPolicy>("accessReviewPolicy", AccessReviewPolicy);
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.AuthorizationPolicy>("authorizationPolicy", AuthorizationPolicy);
            writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.B2cAuthenticationMethodsPolicy>("b2cAuthenticationMethodsPolicy", B2cAuthenticationMethodsPolicy);
            ...
            writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.DirectoryRoleAccessReviewPolicy>("directoryRoleAccessReviewPolicy", DirectoryRoleAccessReviewPolicy);
            writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.ExternalIdentitiesPolicy>("externalIdentitiesPolicy", ExternalIdentitiesPolicy);
