...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class CloudPcUserRoleScopeTagInfo : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"displayName", (o,n) => { (o as CloudPcUserRoleScopeTagInfo).DisplayName = n.GetStringValue(); } },
                {"roleScopeTagId", (o,n) => { (o as CloudPcUserRoleScopeTagInfo).RoleScopeTagId = n.GetStringValue(); } },
            };
        }
        /// <summary>
