...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class ServiceAnnouncementAttachmentCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as ServiceAnnouncementAttachmentCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as ServiceAnnouncementAttachmentCollectionResponse).Value = n.GetCollectionOfObjectValues<ServiceAnnouncementAttachment>(ServiceAnnouncementAttachment.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
