...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class SignInLocation : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"geoCoordinates", (o,n) => { (o as SignInLocation).GeoCoordinates = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.GeoCoordinates>(MicrosoftGraphSdk.Models.Microsoft.Graph.GeoCoordinates.CreateFromDiscriminatorValue); } },
