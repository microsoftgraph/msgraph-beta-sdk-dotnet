...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class WindowsInformationProtectionAppLearningSummaryCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as WindowsInformationProtectionAppLearningSummaryCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as WindowsInformationProtectionAppLearningSummaryCollectionResponse).Value = n.GetCollectionOfObjectValues<WindowsInformationProtectionAppLearningSummary>(WindowsInformationProtectionAppLearningSummary.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
