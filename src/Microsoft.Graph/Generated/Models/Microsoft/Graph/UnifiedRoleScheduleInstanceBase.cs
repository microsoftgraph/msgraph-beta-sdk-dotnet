    ...
    public class UnifiedRoleScheduleInstanceBase : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"principal", (o,n) => { (o as UnifiedRoleScheduleInstanceBase).Principal = n.GetObjectValue<DirectoryObject>(); } },
                {"principalId", (o,n) => { (o as UnifiedRoleScheduleInstanceBase).PrincipalId = n.GetStringValue(); } },
                {"roleDefinition", (o,n) => { (o as UnifiedRoleScheduleInstanceBase).RoleDefinition = n.GetObjectValue<UnifiedRoleDefinition>(); } },
