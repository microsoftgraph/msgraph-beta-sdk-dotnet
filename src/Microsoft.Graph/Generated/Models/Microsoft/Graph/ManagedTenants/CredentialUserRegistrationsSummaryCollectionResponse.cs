...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph.ManagedTenants {
    ...
    public class CredentialUserRegistrationsSummaryCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as CredentialUserRegistrationsSummaryCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as CredentialUserRegistrationsSummaryCollectionResponse).Value = n.GetCollectionOfObjectValues<CredentialUserRegistrationsSummary>(CredentialUserRegistrationsSummary.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
