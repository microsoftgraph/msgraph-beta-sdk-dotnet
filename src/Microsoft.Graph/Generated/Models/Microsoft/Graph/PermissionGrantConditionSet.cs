...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class PermissionGrantConditionSet : Entity, IParsable {
        ...
        public MicrosoftGraphSdk.Models.Microsoft.Graph.PermissionType? PermissionType { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"certifiedClientApplicationsOnly", (o,n) => { (o as PermissionGrantConditionSet).CertifiedClientApplicationsOnly = n.GetBoolValue(); } },
