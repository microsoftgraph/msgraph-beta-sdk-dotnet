...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class RoleDefinitionCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as RoleDefinitionCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as RoleDefinitionCollectionResponse).Value = n.GetCollectionOfObjectValues<RoleDefinition>(RoleDefinition.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
