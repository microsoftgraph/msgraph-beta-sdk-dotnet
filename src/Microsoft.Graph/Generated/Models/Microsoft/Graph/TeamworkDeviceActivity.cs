    ...
    public class TeamworkDeviceActivity : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"activePeripherals", (o,n) => { (o as TeamworkDeviceActivity).ActivePeripherals = n.GetObjectValue<TeamworkActivePeripherals>(); } },
                {"createdBy", (o,n) => { (o as TeamworkDeviceActivity).CreatedBy = n.GetObjectValue<IdentitySet>(); } },
                {"createdDateTime", (o,n) => { (o as TeamworkDeviceActivity).CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                {"lastModifiedBy", (o,n) => { (o as TeamworkDeviceActivity).LastModifiedBy = n.GetObjectValue<IdentitySet>(); } },
