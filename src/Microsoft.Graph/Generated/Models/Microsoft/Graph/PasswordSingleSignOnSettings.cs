...
namespace MicrosoftGraph.Models.Microsoft.Graph {
    public class PasswordSingleSignOnSettings : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"fields", (o,n) => { (o as PasswordSingleSignOnSettings).Fields = n.GetCollectionOfObjectValues<PasswordSingleSignOnField>().ToList(); } },
            };
        }
        /// <summary>
