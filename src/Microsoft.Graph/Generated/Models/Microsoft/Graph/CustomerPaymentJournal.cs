    ...
    public class CustomerPaymentJournal : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"account", (o,n) => { (o as CustomerPaymentJournal).Account = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.Account>(); } },
                ...
                {"customerPayments", (o,n) => { (o as CustomerPaymentJournal).CustomerPayments = n.GetCollectionOfObjectValues<CustomerPayment>().ToList(); } },
