    ...
    public class DeviceConfigurationConflictSummary : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"conflictingDeviceConfigurations", (o,n) => { (o as DeviceConfigurationConflictSummary).ConflictingDeviceConfigurations = n.GetCollectionOfObjectValues<SettingSource>().ToList(); } },
