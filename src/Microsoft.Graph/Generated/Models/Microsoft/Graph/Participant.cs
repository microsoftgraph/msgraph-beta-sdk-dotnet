...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class Participant : Entity, IParsable {
        ...
        public MicrosoftGraphSdk.Models.Microsoft.Graph.RecordingInfo RecordingInfo { get; set; }
        /// <summary>
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"recordingInfo", (o,n) => { (o as Participant).RecordingInfo = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.RecordingInfo>(MicrosoftGraphSdk.Models.Microsoft.Graph.RecordingInfo.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.RecordingInfo>("recordingInfo", RecordingInfo);
        }
    }
}
