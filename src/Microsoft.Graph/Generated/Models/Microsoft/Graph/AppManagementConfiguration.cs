...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    public class AppManagementConfiguration : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"keyCredentials", (o,n) => { (o as AppManagementConfiguration).KeyCredentials = n.GetCollectionOfObjectValues<KeyCredentialConfiguration>().ToList(); } },
                {"passwordCredentials", (o,n) => { (o as AppManagementConfiguration).PasswordCredentials = n.GetCollectionOfObjectValues<PasswordCredentialConfiguration>().ToList(); } },
            };
        }
        /// <summary>
