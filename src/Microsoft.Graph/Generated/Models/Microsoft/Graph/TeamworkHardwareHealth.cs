...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    public class TeamworkHardwareHealth : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"computeHealth", (o,n) => { (o as TeamworkHardwareHealth).ComputeHealth = n.GetObjectValue<TeamworkPeripheralHealth>(); } },
                {"hdmiIngestHealth", (o,n) => { (o as TeamworkHardwareHealth).HdmiIngestHealth = n.GetObjectValue<TeamworkPeripheralHealth>(); } },
            };
        }
        /// <summary>
