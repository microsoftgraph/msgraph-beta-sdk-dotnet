...
namespace MicrosoftGraph.Models.Microsoft.Graph.WindowsUpdates {
    public class Updates : Entity, IParsable {
        ...
        public MicrosoftGraph.Models.Microsoft.Graph.WindowsUpdates.Catalog Catalog { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"catalog", (o,n) => { (o as Updates).Catalog = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.WindowsUpdates.Catalog>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.WindowsUpdates.Catalog>("catalog", Catalog);
