    ...
    public class DeviceHealthScript : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"assignments", (o,n) => { (o as DeviceHealthScript).Assignments = n.GetCollectionOfObjectValues<DeviceHealthScriptAssignment>().ToList(); } },
                ...
                {"detectionScriptParameters", (o,n) => { (o as DeviceHealthScript).DetectionScriptParameters = n.GetCollectionOfObjectValues<DeviceHealthScriptParameter>().ToList(); } },
                {"deviceRunStates", (o,n) => { (o as DeviceHealthScript).DeviceRunStates = n.GetCollectionOfObjectValues<DeviceHealthScriptDeviceState>().ToList(); } },
                ...
                {"remediationScriptParameters", (o,n) => { (o as DeviceHealthScript).RemediationScriptParameters = n.GetCollectionOfObjectValues<DeviceHealthScriptParameter>().ToList(); } },
                ...
                {"runSummary", (o,n) => { (o as DeviceHealthScript).RunSummary = n.GetObjectValue<DeviceHealthScriptRunSummary>(); } },
