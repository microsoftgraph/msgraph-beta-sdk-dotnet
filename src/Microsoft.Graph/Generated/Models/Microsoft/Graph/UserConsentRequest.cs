    ...
    public class UserConsentRequest : Request, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"approval", (o,n) => { (o as UserConsentRequest).Approval = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Approval>(MicrosoftGraphSdk.Models.Microsoft.Graph.Approval.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Approval>("approval", Approval);
