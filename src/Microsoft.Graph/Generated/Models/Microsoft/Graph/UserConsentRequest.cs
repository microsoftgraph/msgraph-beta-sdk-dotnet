...
namespace MicrosoftGraph.Models.Microsoft.Graph {
    public class UserConsentRequest : Request, IParsable {
        ...
        public MicrosoftGraph.Models.Microsoft.Graph.Approval Approval { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"approval", (o,n) => { (o as UserConsentRequest).Approval = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.Approval>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.Approval>("approval", Approval);
