    ...
    public class Drive : BaseItem, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"list", (o,n) => { (o as Drive).List = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.List>(MicrosoftGraphSdk.Models.Microsoft.Graph.List.CreateFromDiscriminatorValue); } },
                {"owner", (o,n) => { (o as Drive).Owner = n.GetObjectValue<IdentitySet>(IdentitySet.CreateFromDiscriminatorValue); } },
                {"quota", (o,n) => { (o as Drive).Quota = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Quota>(MicrosoftGraphSdk.Models.Microsoft.Graph.Quota.CreateFromDiscriminatorValue); } },
                {"root", (o,n) => { (o as Drive).Root = n.GetObjectValue<DriveItem>(DriveItem.CreateFromDiscriminatorValue); } },
                {"sharePointIds", (o,n) => { (o as Drive).SharePointIds = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.SharepointIds>(MicrosoftGraphSdk.Models.Microsoft.Graph.SharepointIds.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Quota>("quota", Quota);
