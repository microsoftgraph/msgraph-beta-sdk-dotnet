...
namespace MicrosoftGraph.Models.Microsoft.Graph {
    public class Drive : BaseItem, IParsable {
        ...
        public MicrosoftGraph.Models.Microsoft.Graph.Quota Quota { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"activities", (o,n) => { (o as Drive).Activities = n.GetCollectionOfObjectValues<ItemActivityOLD>().ToList(); } },
                ...
                {"quota", (o,n) => { (o as Drive).Quota = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.Quota>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.Quota>("quota", Quota);
