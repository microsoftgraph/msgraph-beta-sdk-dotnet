...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class DeviceComplianceActionItemCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static DeviceComplianceActionItemCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DeviceComplianceActionItemCollectionResponse).Value = n.GetCollectionOfObjectValues<DeviceComplianceActionItem>(DeviceComplianceActionItem.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
