    ...
    public class DriveItem : BaseItem, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"activities", (o,n) => { (o as DriveItem).Activities = n.GetCollectionOfObjectValues<ItemActivityOLD>().ToList(); } },
                ...
                {"media", (o,n) => { (o as DriveItem).Media = n.GetObjectValue<Media>(); } },
                ...
                {"source", (o,n) => { (o as DriveItem).Source = n.GetObjectValue<DriveItemSource>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Media>("media", Media);
