    ...
    public class CrossTenantAccessPolicyConfigurationBase : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"b2bCollaborationInbound", (o,n) => { (o as CrossTenantAccessPolicyConfigurationBase).B2bCollaborationInbound = n.GetObjectValue<CrossTenantAccessPolicyB2BSetting>(); } },
                {"b2bCollaborationOutbound", (o,n) => { (o as CrossTenantAccessPolicyConfigurationBase).B2bCollaborationOutbound = n.GetObjectValue<CrossTenantAccessPolicyB2BSetting>(); } },
                {"b2bDirectConnectInbound", (o,n) => { (o as CrossTenantAccessPolicyConfigurationBase).B2bDirectConnectInbound = n.GetObjectValue<CrossTenantAccessPolicyB2BSetting>(); } },
                {"b2bDirectConnectOutbound", (o,n) => { (o as CrossTenantAccessPolicyConfigurationBase).B2bDirectConnectOutbound = n.GetObjectValue<CrossTenantAccessPolicyB2BSetting>(); } },
                {"inboundTrust", (o,n) => { (o as CrossTenantAccessPolicyConfigurationBase).InboundTrust = n.GetObjectValue<CrossTenantAccessPolicyInboundTrust>(); } },
            };
        }
        /// <summary>
