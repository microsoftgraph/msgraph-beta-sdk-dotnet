    ...
    public class Schedule : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"timeCards", (o,n) => { (o as Schedule).TimeCards = n.GetCollectionOfObjectValues<TimeCard>().ToList(); } },
                {"timeClockEnabled", (o,n) => { (o as Schedule).TimeClockEnabled = n.GetBoolValue(); } },
                {"timeClockSettings", (o,n) => { (o as Schedule).TimeClockSettings = n.GetObjectValue<TimeClockSettings>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<TimeClockSettings>("timeClockSettings", TimeClockSettings);
