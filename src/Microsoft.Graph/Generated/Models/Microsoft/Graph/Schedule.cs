    ...
    public class Schedule : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"timeCards", (o,n) => { (o as Schedule).TimeCards = n.GetCollectionOfObjectValues<TimeCard>(TimeCard.CreateFromDiscriminatorValue).ToList(); } },
                {"timeClockEnabled", (o,n) => { (o as Schedule).TimeClockEnabled = n.GetBoolValue(); } },
                {"timeClockSettings", (o,n) => { (o as Schedule).TimeClockSettings = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.TimeClockSettings>(MicrosoftGraphSdk.Models.Microsoft.Graph.TimeClockSettings.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.TimeClockSettings>("timeClockSettings", TimeClockSettings);
