    ...
    public class Call : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"answeredBy", (o,n) => { (o as Call).AnsweredBy = n.GetObjectValue<ParticipantInfo>(); } },
                ...
                {"meetingCapability", (o,n) => { (o as Call).MeetingCapability = n.GetObjectValue<MeetingCapability>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MeetingCapability>("meetingCapability", MeetingCapability);
