...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class Bundle : IParsable, IAdditionalDataHolder {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>If the bundle is an [album][], then the album property is included</summary>
        public MicrosoftGraphSdk.Models.Microsoft.Graph.Album Album { get; set; }
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"album", (o,n) => { (o as Bundle).Album = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Album>(MicrosoftGraphSdk.Models.Microsoft.Graph.Album.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Album>("album", Album);
