    ...
    public class PageLinks : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"oneNoteClientUrl", (o,n) => { (o as PageLinks).OneNoteClientUrl = n.GetObjectValue<ExternalLink>(); } },
                {"oneNoteWebUrl", (o,n) => { (o as PageLinks).OneNoteWebUrl = n.GetObjectValue<ExternalLink>(); } },
            };
        }
        /// <summary>
