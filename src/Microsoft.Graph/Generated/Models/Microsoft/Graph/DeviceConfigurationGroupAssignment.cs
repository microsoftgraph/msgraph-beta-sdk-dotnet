...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    public class DeviceConfigurationGroupAssignment : Entity, IParsable {
        ...
        public MicrosoftGraphSdk.Models.Microsoft.Graph.DeviceConfiguration DeviceConfiguration { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"deviceConfiguration", (o,n) => { (o as DeviceConfigurationGroupAssignment).DeviceConfiguration = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.DeviceConfiguration>(MicrosoftGraphSdk.Models.Microsoft.Graph.DeviceConfiguration.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.DeviceConfiguration>("deviceConfiguration", DeviceConfiguration);
