    ...
    public class UnifiedRoleEligibilityScheduleRequest : Request, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"appScope", (o,n) => { (o as UnifiedRoleEligibilityScheduleRequest).AppScope = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.AppScope>(MicrosoftGraphSdk.Models.Microsoft.Graph.AppScope.CreateFromDiscriminatorValue); } },
                {"appScopeId", (o,n) => { (o as UnifiedRoleEligibilityScheduleRequest).AppScopeId = n.GetStringValue(); } },
                {"directoryScope", (o,n) => { (o as UnifiedRoleEligibilityScheduleRequest).DirectoryScope = n.GetObjectValue<DirectoryObject>(DirectoryObject.CreateFromDiscriminatorValue); } },
                ...
                {"principal", (o,n) => { (o as UnifiedRoleEligibilityScheduleRequest).Principal = n.GetObjectValue<DirectoryObject>(DirectoryObject.CreateFromDiscriminatorValue); } },
                {"principalId", (o,n) => { (o as UnifiedRoleEligibilityScheduleRequest).PrincipalId = n.GetStringValue(); } },
                {"roleDefinition", (o,n) => { (o as UnifiedRoleEligibilityScheduleRequest).RoleDefinition = n.GetObjectValue<UnifiedRoleDefinition>(UnifiedRoleDefinition.CreateFromDiscriminatorValue); } },
                {"roleDefinitionId", (o,n) => { (o as UnifiedRoleEligibilityScheduleRequest).RoleDefinitionId = n.GetStringValue(); } },
                {"scheduleInfo", (o,n) => { (o as UnifiedRoleEligibilityScheduleRequest).ScheduleInfo = n.GetObjectValue<RequestSchedule>(RequestSchedule.CreateFromDiscriminatorValue); } },
                {"targetSchedule", (o,n) => { (o as UnifiedRoleEligibilityScheduleRequest).TargetSchedule = n.GetObjectValue<UnifiedRoleEligibilitySchedule>(UnifiedRoleEligibilitySchedule.CreateFromDiscriminatorValue); } },
                {"targetScheduleId", (o,n) => { (o as UnifiedRoleEligibilityScheduleRequest).TargetScheduleId = n.GetStringValue(); } },
                {"ticketInfo", (o,n) => { (o as UnifiedRoleEligibilityScheduleRequest).TicketInfo = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.TicketInfo>(MicrosoftGraphSdk.Models.Microsoft.Graph.TicketInfo.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
