...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class MailFolderCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as MailFolderCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as MailFolderCollectionResponse).Value = n.GetCollectionOfObjectValues<MailFolder>(MailFolder.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
