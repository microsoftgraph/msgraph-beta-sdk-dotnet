    ...
    public class PrivilegedRole : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"assignments", (o,n) => { (o as PrivilegedRole).Assignments = n.GetCollectionOfObjectValues<PrivilegedRoleAssignment>().ToList(); } },
                {"name", (o,n) => { (o as PrivilegedRole).Name = n.GetStringValue(); } },
                {"settings", (o,n) => { (o as PrivilegedRole).Settings = n.GetObjectValue<PrivilegedRoleSettings>(); } },
                {"summary", (o,n) => { (o as PrivilegedRole).Summary = n.GetObjectValue<PrivilegedRoleSummary>(); } },
            };
        }
        /// <summary>
