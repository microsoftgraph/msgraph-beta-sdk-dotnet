    ...
    public class AccessReviewSettings : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"autoReviewSettings", (o,n) => { (o as AccessReviewSettings).AutoReviewSettings = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.AutoReviewSettings>(MicrosoftGraphSdk.Models.Microsoft.Graph.AutoReviewSettings.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.AutoReviewSettings>("autoReviewSettings", AutoReviewSettings);
