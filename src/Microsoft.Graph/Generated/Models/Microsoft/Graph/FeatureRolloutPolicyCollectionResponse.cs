...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class FeatureRolloutPolicyCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static FeatureRolloutPolicyCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as FeatureRolloutPolicyCollectionResponse).Value = n.GetCollectionOfObjectValues<FeatureRolloutPolicy>(FeatureRolloutPolicy.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
