...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class DeviceCompliancePolicyCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static DeviceCompliancePolicyCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DeviceCompliancePolicyCollectionResponse).Value = n.GetCollectionOfObjectValues<DeviceCompliancePolicy>(DeviceCompliancePolicy.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
