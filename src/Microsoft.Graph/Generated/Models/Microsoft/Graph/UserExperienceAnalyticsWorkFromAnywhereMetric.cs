    ...
    public class UserExperienceAnalyticsWorkFromAnywhereMetric : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"metricDevices", (o,n) => { (o as UserExperienceAnalyticsWorkFromAnywhereMetric).MetricDevices = n.GetCollectionOfObjectValues<UserExperienceAnalyticsWorkFromAnywhereDevice>().ToList(); } },
            };
        }
        /// <summary>
