    ...
    public class ExactMatchClassificationResult : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"classification", (o,n) => { (o as ExactMatchClassificationResult).Classification = n.GetCollectionOfObjectValues<ExactMatchDetectedSensitiveContent>().ToList(); } },
                {"errors", (o,n) => { (o as ExactMatchClassificationResult).Errors = n.GetCollectionOfObjectValues<ClassificationError>().ToList(); } },
            };
        }
        /// <summary>
