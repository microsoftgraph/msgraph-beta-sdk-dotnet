    ...
    public class MeetingParticipants : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"contributors", (o,n) => { (o as MeetingParticipants).Contributors = n.GetCollectionOfObjectValues<MeetingParticipantInfo>().ToList(); } },
                {"organizer", (o,n) => { (o as MeetingParticipants).Organizer = n.GetObjectValue<MeetingParticipantInfo>(); } },
                {"producers", (o,n) => { (o as MeetingParticipants).Producers = n.GetCollectionOfObjectValues<MeetingParticipantInfo>().ToList(); } },
            };
        }
        /// <summary>
