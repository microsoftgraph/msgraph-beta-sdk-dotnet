...
namespace MicrosoftGraph.Models.Microsoft.Graph {
    public class WebApplication : IParsable {
        ...
        public List<RedirectUriSettings> RedirectUriSettings { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"redirectUriSettings", (o,n) => { (o as WebApplication).RedirectUriSettings = n.GetCollectionOfObjectValues<RedirectUriSettings>().ToList(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<RedirectUriSettings>("redirectUriSettings", RedirectUriSettings);
