...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    public class LinkedResource_v2 : Entity, IParsable {
        ...
        /// </summary>
        public static new LinkedResource_v2 CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new LinkedResource_v2();
        }
        /// <summary>
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"applicationName", (o,n) => { (o as LinkedResource_v2).ApplicationName = n.GetStringValue(); } },
                {"displayName", (o,n) => { (o as LinkedResource_v2).DisplayName = n.GetStringValue(); } },
                {"externalId", (o,n) => { (o as LinkedResource_v2).ExternalId = n.GetStringValue(); } },
                {"webUrl", (o,n) => { (o as LinkedResource_v2).WebUrl = n.GetStringValue(); } },
            };
        }
        /// <summary>
