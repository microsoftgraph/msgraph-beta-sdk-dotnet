...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph.TermStore {
    ...
    public class Relation : Entity, IParsable {
        ...
        public MicrosoftGraphSdk.Models.Microsoft.Graph.TermStore.Set Set { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"set", (o,n) => { (o as Relation).Set = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.TermStore.Set>(MicrosoftGraphSdk.Models.Microsoft.Graph.TermStore.Set.CreateFromDiscriminatorValue); } },
