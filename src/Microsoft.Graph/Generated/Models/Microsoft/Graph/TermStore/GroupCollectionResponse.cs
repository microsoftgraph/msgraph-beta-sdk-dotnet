...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph.TermStore {
    ...
    public class GroupCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static GroupCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as GroupCollectionResponse).Value = n.GetCollectionOfObjectValues<Group>(Group.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
