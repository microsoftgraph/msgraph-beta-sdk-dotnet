    ...
    public class PlannerRoster : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"members", (o,n) => { (o as PlannerRoster).Members = n.GetCollectionOfObjectValues<PlannerRosterMember>().ToList(); } },
                {"plans", (o,n) => { (o as PlannerRoster).Plans = n.GetCollectionOfObjectValues<PlannerPlan>().ToList(); } },
            };
        }
        /// <summary>
