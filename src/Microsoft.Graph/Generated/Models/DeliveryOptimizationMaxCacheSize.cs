...
namespace Microsoft.Graph.Beta.Models {
    /// <summary>Delivery Optimization max cache size types.</summary>
    public class DeliveryOptimizationMaxCacheSize : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public DeliveryOptimizationMaxCacheSize() {
            ...
            Type = "#microsoft.graph.deliveryOptimizationMaxCacheSize";
        }
        /// <summary>
