...
namespace Microsoft.Graph.Beta.Models {
    ...
    public class ManagedDeviceCleanupSettings : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public string DeviceInactivityBeforeRetirementInDays {
            get { return BackingStore?.Get<string>(nameof(DeviceInactivityBeforeRetirementInDays)); }
            set { BackingStore?.Set(nameof(DeviceInactivityBeforeRetirementInDays), value); }
        }
        /// <summary>
