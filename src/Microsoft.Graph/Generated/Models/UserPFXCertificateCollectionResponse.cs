...
namespace Microsoft.Graph.Beta.Models {
    public class UserPFXCertificateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserPFXCertificate> Value {
            get { return BackingStore?.Get<List<UserPFXCertificate>>(nameof(Value)); }
