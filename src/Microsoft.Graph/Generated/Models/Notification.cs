...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class Notification : global::Microsoft.Graph.Beta.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Beta.Models.PayloadTypes? Payload
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.PayloadTypes?>("payload"); }
...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.Priority? Priority
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.Priority?>("priority"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Beta.Models.TargetPolicyEndpoints? TargetPolicy
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.TargetPolicyEndpoints?>("targetPolicy"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.Notification CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.Notification();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "payload", n => { Payload = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.PayloadTypes>(global::Microsoft.Graph.Beta.Models.PayloadTypes.CreateFromDiscriminatorValue); } },
                { "priority", n => { Priority = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.Priority>(); } },
                { "targetHostName", n => { TargetHostName = n.GetStringValue(); } },
                { "targetPolicy", n => { TargetPolicy = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.TargetPolicyEndpoints>(global::Microsoft.Graph.Beta.Models.TargetPolicyEndpoints.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.PayloadTypes>("payload", Payload);
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.Priority>("priority", Priority);
            writer.WriteStringValue("targetHostName", TargetHostName);
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.TargetPolicyEndpoints>("targetPolicy", TargetPolicy);
        }
    }
}
