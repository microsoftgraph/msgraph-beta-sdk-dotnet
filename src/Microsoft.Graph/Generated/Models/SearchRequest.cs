...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.AggregationOption>? Aggregations
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.AggregationOption>?>("aggregations"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.CollapseProperty>? CollapseProperties
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.CollapseProperty>?>("collapseProperties"); }
...
#nullable enable
        ...
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.EntityType?>?>("entityTypes"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Beta.Models.SearchQuery? Query
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.SearchQuery?>("query"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Beta.Models.SearchAlterationOptions? QueryAlterationOptions
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.SearchAlterationOptions?>("queryAlterationOptions"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Beta.Models.ResultTemplateOption? ResultTemplateOptions
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.ResultTemplateOption?>("resultTemplateOptions"); }
...
#nullable enable
        ...
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.SharePointOneDriveOptions?>("sharePointOneDriveOptions"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.SortProperty>? SortProperties
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.SortProperty>?>("sortProperties"); }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Models.SearchRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Models.SearchRequest"/></returns>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "aggregations", n => { Aggregations = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.AggregationOption>(global::Microsoft.Graph.Beta.Models.AggregationOption.CreateFromDiscriminatorValue)?.AsList(); } },
                { "collapseProperties", n => { CollapseProperties = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.CollapseProperty>(global::Microsoft.Graph.Beta.Models.CollapseProperty.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "entityTypes", n => { EntityTypes = n.GetCollectionOfEnumValues<global::Microsoft.Graph.Beta.Models.EntityType>()?.AsList(); } },
                { "fields", n => { Fields = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "from", n => { From = n.GetIntValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "query", n => { Query = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.SearchQuery>(global::Microsoft.Graph.Beta.Models.SearchQuery.CreateFromDiscriminatorValue); } },
                { "queryAlterationOptions", n => { QueryAlterationOptions = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.SearchAlterationOptions>(global::Microsoft.Graph.Beta.Models.SearchAlterationOptions.CreateFromDiscriminatorValue); } },
                { "region", n => { Region = n.GetStringValue(); } },
                { "resultTemplateOptions", n => { ResultTemplateOptions = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.ResultTemplateOption>(global::Microsoft.Graph.Beta.Models.ResultTemplateOption.CreateFromDiscriminatorValue); } },
                { "sharePointOneDriveOptions", n => { SharePointOneDriveOptions = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.SharePointOneDriveOptions>(global::Microsoft.Graph.Beta.Models.SharePointOneDriveOptions.CreateFromDiscriminatorValue); } },
                { "size", n => { Size = n.GetIntValue(); } },
                { "sortProperties", n => { SortProperties = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.SortProperty>(global::Microsoft.Graph.Beta.Models.SortProperty.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::Microsoft.Graph.Beta.Models.EntityType>("entityTypes", EntityTypes);
            writer.WriteCollectionOfPrimitiveValues<string>("fields", Fields);
            writer.WriteIntValue("from", From);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.SearchQuery>("query", Query);
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.SearchAlterationOptions>("queryAlterationOptions", QueryAlterationOptions);
            writer.WriteStringValue("region", Region);
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.ResultTemplateOption>("resultTemplateOptions", ResultTemplateOptions);
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.SharePointOneDriveOptions>("sharePointOneDriveOptions", SharePointOneDriveOptions);
            writer.WriteIntValue("size", Size);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.SortProperty>("sortProperties", SortProperties);
