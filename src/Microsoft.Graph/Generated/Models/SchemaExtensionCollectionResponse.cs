...
namespace Microsoft.Graph.Beta.Models {
    public class SchemaExtensionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<SchemaExtension> Value {
            get { return BackingStore?.Get<List<SchemaExtension>>(nameof(Value)); }
