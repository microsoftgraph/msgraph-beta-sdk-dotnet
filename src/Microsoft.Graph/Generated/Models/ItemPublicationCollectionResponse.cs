...
namespace Microsoft.Graph.Beta.Models {
    public class ItemPublicationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ItemPublication> Value {
            get { return BackingStore?.Get<List<ItemPublication>>(nameof(Value)); }
