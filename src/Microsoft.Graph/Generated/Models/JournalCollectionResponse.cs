...
namespace Microsoft.Graph.Beta.Models {
    public class JournalCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Journal> Value {
            get { return BackingStore?.Get<List<Journal>>(nameof(Value)); }
