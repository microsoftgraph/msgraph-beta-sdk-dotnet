...
namespace Microsoft.Graph.Beta.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::Microsoft.Graph.Beta.Models.ThreatCategory? Category
        {
...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.ThreatExpectedAssessment? ExpectedAssessment
        {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.ThreatAssessmentResult>? Results
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.ThreatAssessmentResult>?>("results"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.ThreatAssessmentRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::Microsoft.Graph.Beta.Models.ThreatAssessmentRequest(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "category", n => { Category = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.ThreatCategory>(); } },
                { "contentType", n => { ContentType = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.ThreatAssessmentContentType>(); } },
                ...
                { "expectedAssessment", n => { ExpectedAssessment = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.ThreatExpectedAssessment>(); } },
                { "requestSource", n => { RequestSource = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.ThreatAssessmentRequestSource>(); } },
                { "results", n => { Results = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.ThreatAssessmentResult>(global::Microsoft.Graph.Beta.Models.ThreatAssessmentResult.CreateFromDiscriminatorValue)?.AsList(); } },
                { "status", n => { Status = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.ThreatAssessmentStatus>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.ThreatExpectedAssessment>("expectedAssessment", ExpectedAssessment);
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.ThreatAssessmentRequestSource>("requestSource", RequestSource);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.ThreatAssessmentResult>("results", Results);
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.ThreatAssessmentStatus>("status", Status);
        }
    }
}
