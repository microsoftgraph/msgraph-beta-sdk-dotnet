...
namespace Microsoft.Graph.Beta.Models {
    public class MobileLobAppCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<MobileLobApp> Value {
            get { return BackingStore?.Get<List<MobileLobApp>>(nameof(Value)); }
        ...
        /// </summary>
        public static MobileLobAppCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
