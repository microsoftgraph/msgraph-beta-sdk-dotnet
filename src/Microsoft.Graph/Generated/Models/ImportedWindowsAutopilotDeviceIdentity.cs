...
namespace Microsoft.Graph.Beta.Models
{
    ...
    /// </summary>
    public partial class ImportedWindowsAutopilotDeviceIdentity : global::Microsoft.Graph.Beta.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Beta.Models.ImportedWindowsAutopilotDeviceIdentityState? State
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.ImportedWindowsAutopilotDeviceIdentityState?>("state"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.ImportedWindowsAutopilotDeviceIdentity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.ImportedWindowsAutopilotDeviceIdentity();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "state", n => { State = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.ImportedWindowsAutopilotDeviceIdentityState>(global::Microsoft.Graph.Beta.Models.ImportedWindowsAutopilotDeviceIdentityState.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.ImportedWindowsAutopilotDeviceIdentityState>("state", State);
        }
    }
}
