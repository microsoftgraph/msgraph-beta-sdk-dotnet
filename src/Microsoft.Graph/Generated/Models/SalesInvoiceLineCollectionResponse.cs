...
namespace Microsoft.Graph.Beta.Models {
    public class SalesInvoiceLineCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<SalesInvoiceLine> Value {
            get { return BackingStore?.Get<List<SalesInvoiceLine>>(nameof(Value)); }
