...
namespace Microsoft.Graph.Beta.Models {
    public class SchedulingGroupCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<SchedulingGroup> Value {
            get { return BackingStore?.Get<List<SchedulingGroup>>(nameof(Value)); }
