...
namespace Microsoft.Graph.Beta.Models {
    public class GovernanceRoleSettingCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<GovernanceRoleSetting> Value {
            get { return BackingStore?.Get<List<GovernanceRoleSetting>>(nameof(Value)); }
