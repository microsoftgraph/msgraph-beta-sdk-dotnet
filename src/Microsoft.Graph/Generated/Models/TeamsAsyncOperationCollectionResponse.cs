...
namespace Microsoft.Graph.Beta.Models {
    public class TeamsAsyncOperationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TeamsAsyncOperation> Value {
            get { return BackingStore?.Get<List<TeamsAsyncOperation>>(nameof(Value)); }
