...
namespace Microsoft.Graph.Beta.Models {
    public class TeamDiscoverySettings : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public bool? ShowInTeamsSearchAndSuggestions {
            get { return BackingStore?.Get<bool?>(nameof(ShowInTeamsSearchAndSuggestions)); }
            set { BackingStore?.Set(nameof(ShowInTeamsSearchAndSuggestions), value); }
        }
        /// <summary>
