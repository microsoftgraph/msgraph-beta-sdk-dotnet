...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class UserLastSignInRecommendationInsightSetting : global::Microsoft.Graph.Beta.Models.AccessReviewRecommendationInsightSetting, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::Microsoft.Graph.Beta.Models.UserSignInRecommendationScope? SignInScope
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.UserSignInRecommendationScope?>("signInScope"); }
            set { BackingStore?.Set("signInScope", value); }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Models.UserLastSignInRecommendationInsightSetting"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Models.UserLastSignInRecommendationInsightSetting"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.Beta.Models.UserLastSignInRecommendationInsightSetting CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.UserLastSignInRecommendationInsightSetting();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "signInScope", n => { SignInScope = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.UserSignInRecommendationScope>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.UserSignInRecommendationScope>("signInScope", SignInScope);
        }
    }
}
