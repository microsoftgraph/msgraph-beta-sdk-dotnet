...
namespace Microsoft.Graph.Beta.Models {
    public class ServicePrincipalCreationPolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ServicePrincipalCreationPolicy> Value {
            get { return BackingStore?.Get<List<ServicePrincipalCreationPolicy>>(nameof(Value)); }
