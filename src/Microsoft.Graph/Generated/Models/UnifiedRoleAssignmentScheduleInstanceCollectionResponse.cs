...
namespace Microsoft.Graph.Beta.Models {
    public class UnifiedRoleAssignmentScheduleInstanceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UnifiedRoleAssignmentScheduleInstance> Value {
            get { return BackingStore?.Get<List<UnifiedRoleAssignmentScheduleInstance>>(nameof(Value)); }
