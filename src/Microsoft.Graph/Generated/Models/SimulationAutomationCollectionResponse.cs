...
namespace Microsoft.Graph.Beta.Models {
    public class SimulationAutomationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<SimulationAutomation> Value {
            get { return BackingStore?.Get<List<SimulationAutomation>>(nameof(Value)); }
