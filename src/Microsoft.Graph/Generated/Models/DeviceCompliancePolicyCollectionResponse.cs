...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceCompliancePolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceCompliancePolicy> Value {
            get { return BackingStore?.Get<List<DeviceCompliancePolicy>>(nameof(Value)); }
