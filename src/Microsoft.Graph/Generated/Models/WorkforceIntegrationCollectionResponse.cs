...
namespace Microsoft.Graph.Beta.Models {
    public class WorkforceIntegrationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<WorkforceIntegration> Value {
            get { return BackingStore?.Get<List<WorkforceIntegration>>(nameof(Value)); }
