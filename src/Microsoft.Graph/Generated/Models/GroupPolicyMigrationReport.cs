...
namespace Microsoft.Graph.Beta.Models
{
    ...
    /// </summary>
    public partial class GroupPolicyMigrationReport : global::Microsoft.Graph.Beta.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.GroupPolicySettingMapping>? GroupPolicySettingMappings
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.GroupPolicySettingMapping>?>("groupPolicySettingMappings"); }
...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.GroupPolicyMigrationReadiness? MigrationReadiness
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.GroupPolicyMigrationReadiness?>("migrationReadiness"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.UnsupportedGroupPolicyExtension>? UnsupportedGroupPolicyExtensions
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.UnsupportedGroupPolicyExtension>?>("unsupportedGroupPolicyExtensions"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.GroupPolicyMigrationReport CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.GroupPolicyMigrationReport();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "groupPolicySettingMappings", n => { GroupPolicySettingMappings = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.GroupPolicySettingMapping>(global::Microsoft.Graph.Beta.Models.GroupPolicySettingMapping.CreateFromDiscriminatorValue)?.AsList(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "migrationReadiness", n => { MigrationReadiness = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.GroupPolicyMigrationReadiness>(); } },
                ...
                { "unsupportedGroupPolicyExtensions", n => { UnsupportedGroupPolicyExtensions = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.UnsupportedGroupPolicyExtension>(global::Microsoft.Graph.Beta.Models.UnsupportedGroupPolicyExtension.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.GroupPolicySettingMapping>("groupPolicySettingMappings", GroupPolicySettingMappings);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.GroupPolicyMigrationReadiness>("migrationReadiness", MigrationReadiness);
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.UnsupportedGroupPolicyExtension>("unsupportedGroupPolicyExtensions", UnsupportedGroupPolicyExtensions);
        }
    }
}
