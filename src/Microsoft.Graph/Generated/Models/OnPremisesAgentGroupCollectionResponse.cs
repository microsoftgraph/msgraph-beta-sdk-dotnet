...
namespace Microsoft.Graph.Beta.Models {
    public class OnPremisesAgentGroupCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<OnPremisesAgentGroup> Value {
            get { return BackingStore?.Get<List<OnPremisesAgentGroup>>(nameof(Value)); }
