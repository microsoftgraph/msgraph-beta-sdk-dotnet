    ...
    public class Group : DirectoryObject, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"calendar", (o,n) => { (o as Group).Calendar = n.GetObjectValue<Microsoft.Graph.Beta.Models.Calendar>(Microsoft.Graph.Beta.Models.Calendar.CreateFromDiscriminatorValue); } },
                ...
                {"drive", (o,n) => { (o as Group).Drive = n.GetObjectValue<Microsoft.Graph.Beta.Models.Drive>(Microsoft.Graph.Beta.Models.Drive.CreateFromDiscriminatorValue); } },
                {"drives", (o,n) => { (o as Group).Drives = n.GetCollectionOfObjectValues<Microsoft.Graph.Beta.Models.Drive>(Microsoft.Graph.Beta.Models.Drive.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"infoCatalogs", (o,n) => { (o as Group).InfoCatalogs = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                ...
                {"licenseProcessingState", (o,n) => { (o as Group).LicenseProcessingState = n.GetObjectValue<Microsoft.Graph.Beta.Models.LicenseProcessingState>(Microsoft.Graph.Beta.Models.LicenseProcessingState.CreateFromDiscriminatorValue); } },
                ...
                {"membershipRuleProcessingStatus", (o,n) => { (o as Group).MembershipRuleProcessingStatus = n.GetObjectValue<Microsoft.Graph.Beta.Models.MembershipRuleProcessingStatus>(Microsoft.Graph.Beta.Models.MembershipRuleProcessingStatus.CreateFromDiscriminatorValue); } },
                ...
                {"onenote", (o,n) => { (o as Group).Onenote = n.GetObjectValue<Microsoft.Graph.Beta.Models.Onenote>(Microsoft.Graph.Beta.Models.Onenote.CreateFromDiscriminatorValue); } },
                ...
                {"team", (o,n) => { (o as Group).Team = n.GetObjectValue<Microsoft.Graph.Beta.Models.Team>(Microsoft.Graph.Beta.Models.Team.CreateFromDiscriminatorValue); } },
