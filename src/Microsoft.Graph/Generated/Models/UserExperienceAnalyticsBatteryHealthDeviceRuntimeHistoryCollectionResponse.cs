...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistory> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistory>>(nameof(Value)); }
