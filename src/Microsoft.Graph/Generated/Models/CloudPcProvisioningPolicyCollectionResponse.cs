...
namespace Microsoft.Graph.Beta.Models {
    public class CloudPcProvisioningPolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<CloudPcProvisioningPolicy> Value {
            get { return BackingStore?.Get<List<CloudPcProvisioningPolicy>>(nameof(Value)); }
