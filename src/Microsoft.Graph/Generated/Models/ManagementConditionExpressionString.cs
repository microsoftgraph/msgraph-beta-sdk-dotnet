...
namespace Microsoft.Graph.Beta.Models {
    public class ManagementConditionExpressionString : ManagementConditionExpression, IParsable {
        ...
        /// </summary>
        public static new ManagementConditionExpressionString CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"value", (o,n) => { (o as ManagementConditionExpressionString).Value = n.GetStringValue(); } },
            };
        }
        /// <summary>
