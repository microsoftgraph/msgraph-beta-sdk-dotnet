...
namespace Microsoft.Graph.Beta.Models {
    public class AccessReviewDecisionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AccessReviewDecision> Value {
            get { return BackingStore?.Get<List<AccessReviewDecision>>(nameof(Value)); }
