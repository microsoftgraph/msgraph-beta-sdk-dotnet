...
namespace Microsoft.Graph.Beta.Models.ManagedTenants {
    public class TenantDetailedInformationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TenantDetailedInformation> Value {
            get { return BackingStore?.Get<List<TenantDetailedInformation>>(nameof(Value)); }
