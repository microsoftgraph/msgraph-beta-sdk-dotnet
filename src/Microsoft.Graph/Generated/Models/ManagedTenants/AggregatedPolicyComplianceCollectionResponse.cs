...
namespace Microsoft.Graph.Beta.Models.ManagedTenants {
    public class AggregatedPolicyComplianceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AggregatedPolicyCompliance> Value {
            get { return BackingStore?.Get<List<AggregatedPolicyCompliance>>(nameof(Value)); }
