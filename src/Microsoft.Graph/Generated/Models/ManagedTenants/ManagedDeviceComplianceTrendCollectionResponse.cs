...
namespace Microsoft.Graph.Beta.Models.ManagedTenants {
    public class ManagedDeviceComplianceTrendCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ManagedDeviceComplianceTrend> Value {
            get { return BackingStore?.Get<List<ManagedDeviceComplianceTrend>>(nameof(Value)); }
