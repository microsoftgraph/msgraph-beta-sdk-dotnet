...
namespace Microsoft.Graph.Beta.Models.ManagedTenants {
    public class TenantCustomizedInformationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TenantCustomizedInformation> Value {
            get { return BackingStore?.Get<List<TenantCustomizedInformation>>(nameof(Value)); }
