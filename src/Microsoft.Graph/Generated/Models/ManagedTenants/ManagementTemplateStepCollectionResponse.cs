...
namespace Microsoft.Graph.Beta.Models.ManagedTenants {
    public class ManagementTemplateStepCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ManagementTemplateStep> Value {
            get { return BackingStore?.Get<List<ManagementTemplateStep>>(nameof(Value)); }
