...
namespace Microsoft.Graph.Beta.Models.ManagedTenants {
    public class ManagementTemplateStepDeploymentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ManagementTemplateStepDeployment> Value {
            get { return BackingStore?.Get<List<ManagementTemplateStepDeployment>>(nameof(Value)); }
