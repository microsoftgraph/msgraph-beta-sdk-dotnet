...
namespace Microsoft.Graph.Beta.Models.ManagedTenants {
    public class ConditionalAccessPolicyCoverageCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ConditionalAccessPolicyCoverage> Value {
            get { return BackingStore?.Get<List<ConditionalAccessPolicyCoverage>>(nameof(Value)); }
