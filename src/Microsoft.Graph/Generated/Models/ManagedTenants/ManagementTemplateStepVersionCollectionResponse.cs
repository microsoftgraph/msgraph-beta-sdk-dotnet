...
namespace Microsoft.Graph.Beta.Models.ManagedTenants {
    public class ManagementTemplateStepVersionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ManagementTemplateStepVersion> Value {
            get { return BackingStore?.Get<List<ManagementTemplateStepVersion>>(nameof(Value)); }
