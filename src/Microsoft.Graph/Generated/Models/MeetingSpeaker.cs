...
namespace Microsoft.Graph.Beta.Models {
    public class MeetingSpeaker : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public string Bio {
            get { return BackingStore?.Get<string>(nameof(Bio)); }
            set { BackingStore?.Set(nameof(Bio), value); }
        }
