...
namespace Microsoft.Graph.Beta.Models {
    public class CertificateBasedAuthConfigurationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<CertificateBasedAuthConfiguration> Value {
            get { return BackingStore?.Get<List<CertificateBasedAuthConfiguration>>(nameof(Value)); }
