...
namespace Microsoft.Graph.Beta.Models {
    public class PaymentTermCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<PaymentTerm> Value {
            get { return BackingStore?.Get<List<PaymentTerm>>(nameof(Value)); }
