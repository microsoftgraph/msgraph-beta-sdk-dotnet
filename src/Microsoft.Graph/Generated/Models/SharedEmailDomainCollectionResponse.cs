...
namespace Microsoft.Graph.Beta.Models {
    public class SharedEmailDomainCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<SharedEmailDomain> Value {
            get { return BackingStore?.Get<List<SharedEmailDomain>>(nameof(Value)); }
