...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceLogCollectionResponseCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceLogCollectionResponse> Value {
            get { return BackingStore?.Get<List<DeviceLogCollectionResponse>>(nameof(Value)); }
