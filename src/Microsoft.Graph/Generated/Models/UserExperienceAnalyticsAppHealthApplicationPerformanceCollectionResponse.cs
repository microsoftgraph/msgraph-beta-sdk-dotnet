...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsAppHealthApplicationPerformanceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsAppHealthApplicationPerformance> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsAppHealthApplicationPerformance>>(nameof(Value)); }
