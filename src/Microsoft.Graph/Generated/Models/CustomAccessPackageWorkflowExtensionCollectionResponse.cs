...
namespace Microsoft.Graph.Beta.Models {
    public class CustomAccessPackageWorkflowExtensionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<CustomAccessPackageWorkflowExtension> Value {
            get { return BackingStore?.Get<List<CustomAccessPackageWorkflowExtension>>(nameof(Value)); }
