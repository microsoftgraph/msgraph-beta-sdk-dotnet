...
namespace Microsoft.Graph.Beta.Models {
    public class ServicePrincipalRiskDetectionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ServicePrincipalRiskDetection> Value {
            get { return BackingStore?.Get<List<ServicePrincipalRiskDetection>>(nameof(Value)); }
