...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsDeviceStartupProcessCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsDeviceStartupProcess> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsDeviceStartupProcess>>(nameof(Value)); }
