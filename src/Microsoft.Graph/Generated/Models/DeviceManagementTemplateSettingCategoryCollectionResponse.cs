...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceManagementTemplateSettingCategoryCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceManagementTemplateSettingCategory> Value {
            get { return BackingStore?.Get<List<DeviceManagementTemplateSettingCategory>>(nameof(Value)); }
