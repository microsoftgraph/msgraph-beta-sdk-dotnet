    ...
    public class Message : OutlookItem, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"mentionsPreview", (o,n) => { (o as Message).MentionsPreview = n.GetObjectValue<Microsoft.Graph.Beta.Models.MentionsPreview>(Microsoft.Graph.Beta.Models.MentionsPreview.CreateFromDiscriminatorValue); } },
