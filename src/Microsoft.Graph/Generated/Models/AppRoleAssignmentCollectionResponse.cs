...
namespace Microsoft.Graph.Beta.Models {
    public class AppRoleAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AppRoleAssignment> Value {
            get { return BackingStore?.Get<List<AppRoleAssignment>>(nameof(Value)); }
