...
namespace Microsoft.Graph.Beta.Models {
    public class MeetingRegistrationQuestionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<MeetingRegistrationQuestion> Value {
            get { return BackingStore?.Get<List<MeetingRegistrationQuestion>>(nameof(Value)); }
