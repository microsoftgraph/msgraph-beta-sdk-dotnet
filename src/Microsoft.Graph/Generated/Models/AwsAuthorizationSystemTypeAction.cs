...
namespace Microsoft.Graph.Beta.Models {
    public class AwsAuthorizationSystemTypeAction : AuthorizationSystemTypeAction, IParsable {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="AwsAuthorizationSystemTypeAction"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new AwsAuthorizationSystemTypeAction CreateFromDiscriminatorValue(IParseNode parseNode) {
