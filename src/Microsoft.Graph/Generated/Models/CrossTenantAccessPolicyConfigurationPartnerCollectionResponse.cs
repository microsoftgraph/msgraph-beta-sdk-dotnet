...
namespace Microsoft.Graph.Beta.Models {
    public class CrossTenantAccessPolicyConfigurationPartnerCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<CrossTenantAccessPolicyConfigurationPartner> Value {
            get { return BackingStore?.Get<List<CrossTenantAccessPolicyConfigurationPartner>>(nameof(Value)); }
