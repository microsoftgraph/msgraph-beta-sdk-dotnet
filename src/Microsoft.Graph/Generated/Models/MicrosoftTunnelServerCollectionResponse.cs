...
namespace Microsoft.Graph.Beta.Models {
    public class MicrosoftTunnelServerCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<MicrosoftTunnelServer> Value {
            get { return BackingStore?.Get<List<MicrosoftTunnelServer>>(nameof(Value)); }
