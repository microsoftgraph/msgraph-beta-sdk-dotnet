...
namespace Microsoft.Graph.Beta.Models {
    public class BusinessFlowCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<BusinessFlow> Value {
            get { return BackingStore?.Get<List<BusinessFlow>>(nameof(Value)); }
