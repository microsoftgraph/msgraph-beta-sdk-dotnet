...
namespace Microsoft.Graph.Beta.Models {
    public class DelegatedAdminAccessAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DelegatedAdminAccessAssignment> Value {
            get { return BackingStore?.Get<List<DelegatedAdminAccessAssignment>>(nameof(Value)); }
