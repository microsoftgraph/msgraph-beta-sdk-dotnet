...
namespace Microsoft.Graph.Beta.Models {
    public class ServiceAnnouncementAttachmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ServiceAnnouncementAttachment> Value {
            get { return BackingStore?.Get<List<ServiceAnnouncementAttachment>>(nameof(Value)); }
