...
namespace Microsoft.Graph.Beta.Models {
    public class AccessPackageResourceScopeCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AccessPackageResourceScope> Value {
            get { return BackingStore?.Get<List<AccessPackageResourceScope>>(nameof(Value)); }
