...
namespace Microsoft.Graph.Beta.Models {
    public class MeetingActivityStatistics : ActivityStatistics, IParsable {
        ...
        public TimeSpan? Conflicting {
            get { return BackingStore?.Get<TimeSpan?>(nameof(Conflicting)); }
            set { BackingStore?.Set(nameof(Conflicting), value); }
        }
        ...
        public TimeSpan? Long {
            get { return BackingStore?.Get<TimeSpan?>(nameof(Long)); }
            set { BackingStore?.Set(nameof(Long), value); }
        }
        ...
        public TimeSpan? Multitasking {
            get { return BackingStore?.Get<TimeSpan?>(nameof(Multitasking)); }
            set { BackingStore?.Set(nameof(Multitasking), value); }
        }
        ...
        public TimeSpan? Organized {
            get { return BackingStore?.Get<TimeSpan?>(nameof(Organized)); }
            set { BackingStore?.Set(nameof(Organized), value); }
        }
        ...
        public TimeSpan? Recurring {
            get { return BackingStore?.Get<TimeSpan?>(nameof(Recurring)); }
            set { BackingStore?.Set(nameof(Recurring), value); }
        }
        /// <summary>
