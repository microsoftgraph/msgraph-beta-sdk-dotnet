...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class ActivityHistoryItem : global::Microsoft.Graph.Beta.Models.Entity, IParsable
...
#nullable enable
        public global::Microsoft.Graph.Beta.Models.UserActivity? Activity
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.UserActivity?>("activity"); }
...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.Status? Status
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.Status?>("status"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.ActivityHistoryItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.ActivityHistoryItem();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "activity", n => { Activity = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.UserActivity>(global::Microsoft.Graph.Beta.Models.UserActivity.CreateFromDiscriminatorValue); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "expirationDateTime", n => { ExpirationDateTime = n.GetDateTimeOffsetValue(); } },
                { "lastActiveDateTime", n => { LastActiveDateTime = n.GetDateTimeOffsetValue(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "startedDateTime", n => { StartedDateTime = n.GetDateTimeOffsetValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.Status>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.UserActivity>("activity", Activity);
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.Status>("status", Status);
