...
namespace Microsoft.Graph.Beta.Models {
    public class Fido2AuthenticationMethodCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Fido2AuthenticationMethod> Value {
            get { return BackingStore?.Get<List<Fido2AuthenticationMethod>>(nameof(Value)); }
