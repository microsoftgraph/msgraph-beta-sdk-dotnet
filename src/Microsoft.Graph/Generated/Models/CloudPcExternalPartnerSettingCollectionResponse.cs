...
namespace Microsoft.Graph.Beta.Models {
    public class CloudPcExternalPartnerSettingCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<CloudPcExternalPartnerSetting> Value {
            get { return BackingStore?.Get<List<CloudPcExternalPartnerSetting>>(nameof(Value)); }
        ...
        /// </summary>
        public static CloudPcExternalPartnerSettingCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
