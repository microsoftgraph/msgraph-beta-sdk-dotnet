...
namespace Microsoft.Graph.Beta.Models {
    public class ChromeOSOnboardingSettingsCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ChromeOSOnboardingSettings> Value {
            get { return BackingStore?.Get<List<ChromeOSOnboardingSettings>>(nameof(Value)); }
