...
namespace Microsoft.Graph.Beta.Models {
    public class SecurityBaselineSettingStateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<SecurityBaselineSettingState> Value {
            get { return BackingStore?.Get<List<SecurityBaselineSettingState>>(nameof(Value)); }
