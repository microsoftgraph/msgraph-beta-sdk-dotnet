...
namespace Microsoft.Graph.Beta.Models {
    public class IosLobAppProvisioningConfigurationAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<IosLobAppProvisioningConfigurationAssignment> Value {
            get { return BackingStore?.Get<List<IosLobAppProvisioningConfigurationAssignment>>(nameof(Value)); }
