...
namespace Microsoft.Graph.Beta.Models {
    public class OutboundSharedUserProfileCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<OutboundSharedUserProfile> Value {
            get { return BackingStore?.Get<List<OutboundSharedUserProfile>>(nameof(Value)); }
