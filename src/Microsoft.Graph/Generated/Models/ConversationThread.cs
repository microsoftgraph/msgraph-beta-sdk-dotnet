...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class ConversationThread : global::Microsoft.Graph.Beta.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The Cc: recipients for the thread. Returned only on $select.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.Recipient>? CcRecipients
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.Recipient>?>("ccRecipients"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.Post>? Posts
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.Post>?>("posts"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.ConversationThread CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.ConversationThread();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "ccRecipients", n => { CcRecipients = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.Recipient>(global::Microsoft.Graph.Beta.Models.Recipient.CreateFromDiscriminatorValue)?.AsList(); } },
                { "hasAttachments", n => { HasAttachments = n.GetBoolValue(); } },
                { "isLocked", n => { IsLocked = n.GetBoolValue(); } },
                { "lastDeliveredDateTime", n => { LastDeliveredDateTime = n.GetDateTimeOffsetValue(); } },
                { "posts", n => { Posts = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.Post>(global::Microsoft.Graph.Beta.Models.Post.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.Recipient>("ccRecipients", CcRecipients);
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.Post>("posts", Posts);
