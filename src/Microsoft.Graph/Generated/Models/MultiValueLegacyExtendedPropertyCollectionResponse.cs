...
namespace Microsoft.Graph.Beta.Models {
    public class MultiValueLegacyExtendedPropertyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<MultiValueLegacyExtendedProperty> Value {
            get { return BackingStore?.Get<List<MultiValueLegacyExtendedProperty>>(nameof(Value)); }
