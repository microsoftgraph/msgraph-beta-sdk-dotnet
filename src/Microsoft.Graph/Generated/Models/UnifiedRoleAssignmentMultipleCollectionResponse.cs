...
namespace Microsoft.Graph.Beta.Models {
    public class UnifiedRoleAssignmentMultipleCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UnifiedRoleAssignmentMultiple> Value {
            get { return BackingStore?.Get<List<UnifiedRoleAssignmentMultiple>>(nameof(Value)); }
