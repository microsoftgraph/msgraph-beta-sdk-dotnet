...
namespace Microsoft.Graph.Beta.Models {
    public class AccessPackageAssignmentPolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AccessPackageAssignmentPolicy> Value {
            get { return BackingStore?.Get<List<AccessPackageAssignmentPolicy>>(nameof(Value)); }
