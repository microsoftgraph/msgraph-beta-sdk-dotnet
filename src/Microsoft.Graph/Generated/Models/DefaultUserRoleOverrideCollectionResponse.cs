...
namespace Microsoft.Graph.Beta.Models {
    public class DefaultUserRoleOverrideCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DefaultUserRoleOverride> Value {
            get { return BackingStore?.Get<List<DefaultUserRoleOverride>>(nameof(Value)); }
