...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsDeviceStartupProcessPerformanceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsDeviceStartupProcessPerformance> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsDeviceStartupProcessPerformance>>(nameof(Value)); }
