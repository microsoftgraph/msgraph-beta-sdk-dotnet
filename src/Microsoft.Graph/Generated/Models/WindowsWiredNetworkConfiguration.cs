...
namespace Microsoft.Graph.Beta.Models {
    public class WindowsWiredNetworkConfiguration : DeviceConfiguration, IParsable {
        ...
        public int? AuthenticationBlockPeriodInMinutes {
            get { return BackingStore?.Get<int?>(nameof(AuthenticationBlockPeriodInMinutes)); }
            set { BackingStore?.Set(nameof(AuthenticationBlockPeriodInMinutes), value); }
        }
        ...
        public WiredNetworkAuthenticationMethod? AuthenticationMethod {
            get { return BackingStore?.Get<WiredNetworkAuthenticationMethod?>(nameof(AuthenticationMethod)); }
        ...
        public WiredNetworkAuthenticationType? AuthenticationType {
            get { return BackingStore?.Get<WiredNetworkAuthenticationType?>(nameof(AuthenticationType)); }
        ...
        /// <summary>Extensible Authentication Protocol (EAP). Indicates the type of EAP protocol set on the Wi-Fi endpoint (router). Possible values are: eapTls, leap, eapSim, eapTtls, peap, eapFast, teap. Possible values are: eapTls, leap, eapSim, eapTtls, peap, eapFast, teap.</summary>
        ...
        public bool? Enforce8021X {
            get { return BackingStore?.Get<bool?>(nameof(Enforce8021X)); }
            set { BackingStore?.Set(nameof(Enforce8021X), value); }
        }
        ...
        public WiredNetworkAuthenticationMethod? SecondaryAuthenticationMethod {
            get { return BackingStore?.Get<WiredNetworkAuthenticationMethod?>(nameof(SecondaryAuthenticationMethod)); }
            set { BackingStore?.Set(nameof(SecondaryAuthenticationMethod), value); }
        }
        ...
        public WindowsCertificateProfileBase SecondaryIdentityCertificateForClientAuthentication {
            get { return BackingStore?.Get<WindowsCertificateProfileBase>(nameof(SecondaryIdentityCertificateForClientAuthentication)); }
            set { BackingStore?.Set(nameof(SecondaryIdentityCertificateForClientAuthentication), value); }
        }
        ...
        public Windows81TrustedRootCertificate SecondaryRootCertificateForClientValidation {
            get { return BackingStore?.Get<Windows81TrustedRootCertificate>(nameof(SecondaryRootCertificateForClientValidation)); }
            set { BackingStore?.Set(nameof(SecondaryRootCertificateForClientValidation), value); }
        }
