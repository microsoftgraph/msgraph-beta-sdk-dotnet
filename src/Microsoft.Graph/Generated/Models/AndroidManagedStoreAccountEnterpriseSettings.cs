...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class AndroidManagedStoreAccountEnterpriseSettings : global::Microsoft.Graph.Beta.Models.Entity, IParsable
    {
        ...
        public global::Microsoft.Graph.Beta.Models.AndroidManagedStoreAccountBindStatus? BindStatus
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.AndroidManagedStoreAccountBindStatus?>("bindStatus"); }
            set { BackingStore?.Set("bindStatus", value); }
        }
        /// <summary>Company codes for AndroidManagedStoreAccountEnterpriseSettings</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.AndroidEnrollmentCompanyCode>? CompanyCodes
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.AndroidEnrollmentCompanyCode>?>("companyCodes"); }
...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.AndroidManagedStoreAccountEnrollmentTarget? EnrollmentTarget
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.AndroidManagedStoreAccountEnrollmentTarget?>("enrollmentTarget"); }
        ...
        public global::Microsoft.Graph.Beta.Models.AndroidManagedStoreAccountAppSyncStatus? LastAppSyncStatus
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.AndroidManagedStoreAccountAppSyncStatus?>("lastAppSyncStatus"); }
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "bindStatus", n => { BindStatus = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.AndroidManagedStoreAccountBindStatus>(); } },
                { "companyCodes", n => { CompanyCodes = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.AndroidEnrollmentCompanyCode>(global::Microsoft.Graph.Beta.Models.AndroidEnrollmentCompanyCode.CreateFromDiscriminatorValue)?.AsList(); } },
                { "deviceOwnerManagementEnabled", n => { DeviceOwnerManagementEnabled = n.GetBoolValue(); } },
                { "enrollmentTarget", n => { EnrollmentTarget = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.AndroidManagedStoreAccountEnrollmentTarget>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.AndroidEnrollmentCompanyCode>("companyCodes", CompanyCodes);
            writer.WriteBoolValue("deviceOwnerManagementEnabled", DeviceOwnerManagementEnabled);
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.AndroidManagedStoreAccountEnrollmentTarget>("enrollmentTarget", EnrollmentTarget);
