...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<string>? RecordTypeFilters
        {
            get { return BackingStore?.Get<List<string>?>("recordTypeFilters"); }
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "recordTypeFilters", n => { RecordTypeFilters = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfPrimitiveValues<string>("recordTypeFilters", RecordTypeFilters);
