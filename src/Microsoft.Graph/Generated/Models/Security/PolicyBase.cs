...
namespace Microsoft.Graph.Beta.Models.Security
{
    ...
    public partial class PolicyBase : global::Microsoft.Graph.Beta.Models.Entity, IParsable
...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.Security.PolicyStatus? Status
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.Security.PolicyStatus?>("status"); }
            set { BackingStore?.Set("status", value); }
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Models.Security.PolicyBase"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.Beta.Models.Security.PolicyBase CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::Microsoft.Graph.Beta.Models.Security.PolicyBase(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "status", n => { Status = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.Security.PolicyStatus>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.Security.PolicyStatus>("status", Status);
        }
    }
}
