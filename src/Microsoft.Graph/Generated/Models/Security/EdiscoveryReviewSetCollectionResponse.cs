...
namespace Microsoft.Graph.Beta.Models.Security {
    public class EdiscoveryReviewSetCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<EdiscoveryReviewSet> Value {
            get { return BackingStore?.Get<List<EdiscoveryReviewSet>>(nameof(Value)); }
