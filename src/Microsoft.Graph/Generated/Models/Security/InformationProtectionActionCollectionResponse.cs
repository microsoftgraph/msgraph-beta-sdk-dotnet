...
namespace Microsoft.Graph.Beta.Models.Security {
    public class InformationProtectionActionCollectionResponse : BaseCollectionPaginationCountResponse, IParsable {
...
#nullable restore
        ...
        public static new InformationProtectionActionCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InformationProtectionActionCollectionResponse();
        }
        /// <summary>
