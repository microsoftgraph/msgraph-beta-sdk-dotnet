...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Models.Security.EventQuery"/> and sets the default values.
        /// </summary>
        public EventQuery()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Models.Security.EventQuery"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Microsoft.Graph.Beta.Models.Security.EventQuery CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Beta.Models.Security.EventQuery();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "queryType", n => { QueryType = n.GetEnumValue<Microsoft.Graph.Beta.Models.Security.QueryType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Beta.Models.Security.QueryType>("queryType", QueryType);
