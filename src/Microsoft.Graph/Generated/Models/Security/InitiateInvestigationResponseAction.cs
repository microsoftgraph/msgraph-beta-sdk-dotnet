...
namespace Microsoft.Graph.Beta.Models.Security {
    public class InitiateInvestigationResponseAction : ResponseAction, IParsable {
        ...
        /// </summary>
        public InitiateInvestigationResponseAction() : base() {
            OdataType = "#microsoft.graph.security.initiateInvestigationResponseAction";
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new InitiateInvestigationResponseAction CreateFromDiscriminatorValue(IParseNode parseNode) {
