...
namespace Microsoft.Graph.Beta.Models.Security {
    public class EdiscoverySearchCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<EdiscoverySearch> Value {
            get { return BackingStore?.Get<List<EdiscoverySearch>>(nameof(Value)); }
        ...
        /// </summary>
        public static EdiscoverySearchCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
