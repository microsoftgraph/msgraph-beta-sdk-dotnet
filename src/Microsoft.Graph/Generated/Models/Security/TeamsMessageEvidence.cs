...
namespace Microsoft.Graph.Beta.Models.Security
{
    ...
    public partial class TeamsMessageEvidence : global::Microsoft.Graph.Beta.Models.Security.AlertEvidence, IParsable
...
#nullable enable
        ...
        {
            get { return BackingStore?.Get<string?>("campaignId"); }
            set { BackingStore?.Set("campaignId", value); }
        }
#nullable restore
#else
        public string CampaignId
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.Security.FileEvidence>? Files
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.Security.FileEvidence>?>("files"); }
...
#nullable restore
        ...
        {
            get { return BackingStore?.Get<bool?>("isExternal"); }
            set { BackingStore?.Set("isExternal", value); }
        }
        /// <summary>Indicates whether the message is owned by your organization.</summary>
        public bool? IsOwned
        {
            get { return BackingStore?.Get<bool?>("isOwned"); }
            set { BackingStore?.Set("isOwned", value); }
        }
        ...
        public global::Microsoft.Graph.Beta.Models.Security.AntispamTeamsDirection? MessageDirection
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.Security.AntispamTeamsDirection?>("messageDirection"); }
            set { BackingStore?.Set("messageDirection", value); }
        }
        /// <summary>The message identifier, unique within the thread.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public Guid? OwningTenantId
        {
            get { return BackingStore?.Get<Guid?>("owningTenantId"); }
            set { BackingStore?.Set("owningTenantId", value); }
        }
...
#nullable enable
        ...
        {
            get { return BackingStore?.Get<string?>("senderFromAddress"); }
            set { BackingStore?.Set("senderFromAddress", value); }
        }
#nullable restore
#else
        public string SenderFromAddress
...
#nullable enable
        ...
        {
            get { return BackingStore?.Get<string?>("sourceAppName"); }
            set { BackingStore?.Set("sourceAppName", value); }
        }
#nullable restore
#else
        public string SourceAppName
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<string>? SuspiciousRecipients
        {
            get { return BackingStore?.Get<List<string>?>("suspiciousRecipients"); }
            set { BackingStore?.Set("suspiciousRecipients", value); }
        }
#nullable restore
#else
        public List<string> SuspiciousRecipients
...
#nullable enable
        ...
        {
            get { return BackingStore?.Get<string?>("threadType"); }
            set { BackingStore?.Set("threadType", value); }
        }
#nullable restore
#else
        public string ThreadType
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.Security.UrlEvidence>? Urls
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.Security.UrlEvidence>?>("urls"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Models.Security.TeamsMessageEvidence"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Models.Security.TeamsMessageEvidence"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.Beta.Models.Security.TeamsMessageEvidence CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.Security.TeamsMessageEvidence();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "deliveryAction", n => { DeliveryAction = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.Security.TeamsMessageDeliveryAction>(); } },
                { "deliveryLocation", n => { DeliveryLocation = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.Security.TeamsDeliveryLocation>(); } },
                { "files", n => { Files = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.Security.FileEvidence>(global::Microsoft.Graph.Beta.Models.Security.FileEvidence.CreateFromDiscriminatorValue)?.AsList(); } },
                { "groupId", n => { GroupId = n.GetStringValue(); } },
                { "isExternal", n => { IsExternal = n.GetBoolValue(); } },
                { "isOwned", n => { IsOwned = n.GetBoolValue(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "messageDirection", n => { MessageDirection = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.Security.AntispamTeamsDirection>(); } },
                ...
                { "urls", n => { Urls = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.Security.UrlEvidence>(global::Microsoft.Graph.Beta.Models.Security.UrlEvidence.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.Security.TeamsMessageDeliveryAction>("deliveryAction", DeliveryAction);
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.Security.TeamsDeliveryLocation>("deliveryLocation", DeliveryLocation);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.Security.FileEvidence>("files", Files);
            writer.WriteStringValue("groupId", GroupId);
            writer.WriteBoolValue("isExternal", IsExternal);
            writer.WriteBoolValue("isOwned", IsOwned);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.Security.AntispamTeamsDirection>("messageDirection", MessageDirection);
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.Security.UrlEvidence>("urls", Urls);
        }
    }
}
