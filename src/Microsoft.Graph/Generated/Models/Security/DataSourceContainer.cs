...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.Security.DataSourceHoldStatus? HoldStatus
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.Security.DataSourceHoldStatus?>("holdStatus"); }
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Models.Security.DataSourceContainer"/></returns>
        ...
        public static new global::Microsoft.Graph.Beta.Models.Security.DataSourceContainer CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::Microsoft.Graph.Beta.Models.Security.DataSourceContainer(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "holdStatus", n => { HoldStatus = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.Security.DataSourceHoldStatus>(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "releasedDateTime", n => { ReleasedDateTime = n.GetDateTimeOffsetValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.Security.DataSourceContainerStatus>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.Security.DataSourceHoldStatus>("holdStatus", HoldStatus);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteDateTimeOffsetValue("releasedDateTime", ReleasedDateTime);
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.Security.DataSourceContainerStatus>("status", Status);
        }
    }
}
