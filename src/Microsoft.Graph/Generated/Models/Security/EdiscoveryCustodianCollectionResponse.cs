...
namespace Microsoft.Graph.Beta.Models.Security {
    public class EdiscoveryCustodianCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<EdiscoveryCustodian> Value {
            get { return BackingStore?.Get<List<EdiscoveryCustodian>>(nameof(Value)); }
        ...
        /// </summary>
        public static EdiscoveryCustodianCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
