...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class Agreement : global::Microsoft.Graph.Beta.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Read-only. Information about acceptances of this agreement.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.AgreementAcceptance>? Acceptances
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.AgreementAcceptance>?>("acceptances"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Beta.Models.AgreementFile? File
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.AgreementFile?>("file"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.AgreementFileLocalization>? Files
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.AgreementFileLocalization>?>("files"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Beta.Models.TermsExpiration? TermsExpiration
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.TermsExpiration?>("termsExpiration"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.Agreement CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.Agreement();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "acceptances", n => { Acceptances = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.AgreementAcceptance>(global::Microsoft.Graph.Beta.Models.AgreementAcceptance.CreateFromDiscriminatorValue)?.AsList(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "file", n => { File = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.AgreementFile>(global::Microsoft.Graph.Beta.Models.AgreementFile.CreateFromDiscriminatorValue); } },
                { "files", n => { Files = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.AgreementFileLocalization>(global::Microsoft.Graph.Beta.Models.AgreementFileLocalization.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "termsExpiration", n => { TermsExpiration = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.TermsExpiration>(global::Microsoft.Graph.Beta.Models.TermsExpiration.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.AgreementAcceptance>("acceptances", Acceptances);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.AgreementFile>("file", File);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.AgreementFileLocalization>("files", Files);
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.TermsExpiration>("termsExpiration", TermsExpiration);
