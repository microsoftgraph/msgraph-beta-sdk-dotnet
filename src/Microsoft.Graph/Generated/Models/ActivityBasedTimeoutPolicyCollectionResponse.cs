...
namespace Microsoft.Graph.Beta.Models {
    public class ActivityBasedTimeoutPolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ActivityBasedTimeoutPolicy> Value {
            get { return BackingStore?.Get<List<ActivityBasedTimeoutPolicy>>(nameof(Value)); }
