...
namespace Microsoft.Graph.Beta.Models {
    public class OnenoteSectionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<OnenoteSection> Value {
            get { return BackingStore?.Get<List<OnenoteSection>>(nameof(Value)); }
