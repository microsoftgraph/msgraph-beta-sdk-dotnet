...
namespace Microsoft.Graph.Beta.Models.DeviceManagement {
    public class AlertRecordCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        /// </summary>
        public static AlertRecordCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
