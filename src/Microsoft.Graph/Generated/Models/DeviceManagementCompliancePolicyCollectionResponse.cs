...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceManagementCompliancePolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceManagementCompliancePolicy> Value {
            get { return BackingStore?.Get<List<DeviceManagementCompliancePolicy>>(nameof(Value)); }
