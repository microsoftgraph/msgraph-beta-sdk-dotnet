...
namespace Microsoft.Graph.Beta.Models {
    public class GroupPolicyDefinitionFileCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<GroupPolicyDefinitionFile> Value {
            get { return BackingStore?.Get<List<GroupPolicyDefinitionFile>>(nameof(Value)); }
