...
namespace Microsoft.Graph.Beta.Models {
    public class EnterpriseCodeSigningCertificateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<EnterpriseCodeSigningCertificate> Value {
            get { return BackingStore?.Get<List<EnterpriseCodeSigningCertificate>>(nameof(Value)); }
