...
namespace Microsoft.Graph.Beta.Models {
    public class WindowsQualityUpdateProfileAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<WindowsQualityUpdateProfileAssignment> Value {
            get { return BackingStore?.Get<List<WindowsQualityUpdateProfileAssignment>>(nameof(Value)); }
