...
namespace Microsoft.Graph.Beta.Models {
    public class IosUpdateDeviceStatusCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<IosUpdateDeviceStatus> Value {
            get { return BackingStore?.Get<List<IosUpdateDeviceStatus>>(nameof(Value)); }
