...
namespace Microsoft.Graph.Beta.Models {
    public class CustomSecurityAttributeDefinitionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<CustomSecurityAttributeDefinition> Value {
            get { return BackingStore?.Get<List<CustomSecurityAttributeDefinition>>(nameof(Value)); }
