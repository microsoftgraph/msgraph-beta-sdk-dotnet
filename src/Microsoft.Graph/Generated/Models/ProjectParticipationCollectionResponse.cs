...
namespace Microsoft.Graph.Beta.Models {
    public class ProjectParticipationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ProjectParticipation> Value {
            get { return BackingStore?.Get<List<ProjectParticipation>>(nameof(Value)); }
