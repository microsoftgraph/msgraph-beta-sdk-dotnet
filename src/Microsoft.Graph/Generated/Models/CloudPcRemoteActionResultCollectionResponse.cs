...
namespace Microsoft.Graph.Beta.Models {
    public class CloudPcRemoteActionResultCollectionResponse : BaseCollectionPaginationCountResponse, IParsable {
...
#nullable restore
        ...
        public static new CloudPcRemoteActionResultCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CloudPcRemoteActionResultCollectionResponse();
        }
        /// <summary>
