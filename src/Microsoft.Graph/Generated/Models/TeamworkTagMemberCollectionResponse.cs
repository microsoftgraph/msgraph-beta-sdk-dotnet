...
namespace Microsoft.Graph.Beta.Models {
    public class TeamworkTagMemberCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TeamworkTagMember> Value {
            get { return BackingStore?.Get<List<TeamworkTagMember>>(nameof(Value)); }
