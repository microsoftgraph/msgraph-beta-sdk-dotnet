...
namespace Microsoft.Graph.Beta.Models
{
    ...
    /// </summary>
    public class AndroidWorkProfileEnterpriseWiFiConfiguration : Microsoft.Graph.Beta.Models.AndroidWorkProfileWiFiConfiguration, IParsable
    {
...
#nullable enable
        public Microsoft.Graph.Beta.Models.AndroidWorkProfileCertificateProfileBase? IdentityCertificateForClientAuthentication
        {
            get { return BackingStore?.Get<Microsoft.Graph.Beta.Models.AndroidWorkProfileCertificateProfileBase?>("identityCertificateForClientAuthentication"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Beta.Models.AndroidWorkProfileTrustedRootCertificate? RootCertificateForServerValidation
        {
            get { return BackingStore?.Get<Microsoft.Graph.Beta.Models.AndroidWorkProfileTrustedRootCertificate?>("rootCertificateForServerValidation"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Models.AndroidWorkProfileEnterpriseWiFiConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Models.AndroidWorkProfileEnterpriseWiFiConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Microsoft.Graph.Beta.Models.AndroidWorkProfileEnterpriseWiFiConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Beta.Models.AndroidWorkProfileEnterpriseWiFiConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "identityCertificateForClientAuthentication", n => { IdentityCertificateForClientAuthentication = n.GetObjectValue<Microsoft.Graph.Beta.Models.AndroidWorkProfileCertificateProfileBase>(Microsoft.Graph.Beta.Models.AndroidWorkProfileCertificateProfileBase.CreateFromDiscriminatorValue); } },
                ...
                { "rootCertificateForServerValidation", n => { RootCertificateForServerValidation = n.GetObjectValue<Microsoft.Graph.Beta.Models.AndroidWorkProfileTrustedRootCertificate>(Microsoft.Graph.Beta.Models.AndroidWorkProfileTrustedRootCertificate.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Microsoft.Graph.Beta.Models.AndroidWorkProfileCertificateProfileBase>("identityCertificateForClientAuthentication", IdentityCertificateForClientAuthentication);
            ...
            writer.WriteObjectValue<Microsoft.Graph.Beta.Models.AndroidWorkProfileTrustedRootCertificate>("rootCertificateForServerValidation", RootCertificateForServerValidation);
