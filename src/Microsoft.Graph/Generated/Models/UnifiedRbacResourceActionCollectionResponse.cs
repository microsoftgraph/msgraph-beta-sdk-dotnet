...
namespace Microsoft.Graph.Beta.Models {
    public class UnifiedRbacResourceActionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UnifiedRbacResourceAction> Value {
            get { return BackingStore?.Get<List<UnifiedRbacResourceAction>>(nameof(Value)); }
