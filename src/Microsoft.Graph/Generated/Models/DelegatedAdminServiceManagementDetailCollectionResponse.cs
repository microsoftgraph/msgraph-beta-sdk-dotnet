...
namespace Microsoft.Graph.Beta.Models {
    public class DelegatedAdminServiceManagementDetailCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DelegatedAdminServiceManagementDetail> Value {
            get { return BackingStore?.Get<List<DelegatedAdminServiceManagementDetail>>(nameof(Value)); }
