...
namespace Microsoft.Graph.Beta.Models {
    public class User : DirectoryObject, IParsable {
        ...
        public Microsoft.Graph.Beta.Models.Authentication Authentication { get; set; }
        ...
        public List<Microsoft.Graph.Beta.Models.Calendar> Calendars { get; set; }
        ...
        public Microsoft.Graph.Beta.Models.EmployeeOrgData EmployeeOrgData { get; set; }
        ...
        public Microsoft.Graph.Beta.Models.InferenceClassification InferenceClassification { get; set; }
        ...
        public Microsoft.Graph.Beta.Models.InformationProtection InformationProtection { get; set; }
        ...
        public Microsoft.Graph.Beta.Models.MailboxSettings MailboxSettings { get; set; }
        ...
        public Microsoft.Graph.Beta.Models.OnPremisesExtensionAttributes OnPremisesExtensionAttributes { get; set; }
        ...
        public Microsoft.Graph.Beta.Models.Presence Presence { get; set; }
        ...
        public Microsoft.Graph.Beta.Models.Profile Profile { get; set; }
        ...
        public Microsoft.Graph.Beta.Models.Security.Security Security { get; set; }
        /// <summary>Read-only. Nullable.</summary>
        ...
        public Microsoft.Graph.Beta.Models.SignInActivity SignInActivity { get; set; }
        ...
        public Microsoft.Graph.Beta.Models.Tasks Tasks { get; set; }
        ...
        public Microsoft.Graph.Beta.Models.Todo Todo { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"authentication", (o,n) => { (o as User).Authentication = n.GetObjectValue<Microsoft.Graph.Beta.Models.Authentication>(Microsoft.Graph.Beta.Models.Authentication.CreateFromDiscriminatorValue); } },
                ...
                {"calendar", (o,n) => { (o as User).Calendar = n.GetObjectValue<Microsoft.Graph.Beta.Models.Calendar>(Microsoft.Graph.Beta.Models.Calendar.CreateFromDiscriminatorValue); } },
                ...
                {"calendars", (o,n) => { (o as User).Calendars = n.GetCollectionOfObjectValues<Microsoft.Graph.Beta.Models.Calendar>(Microsoft.Graph.Beta.Models.Calendar.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"drive", (o,n) => { (o as User).Drive = n.GetObjectValue<Microsoft.Graph.Beta.Models.Drive>(Microsoft.Graph.Beta.Models.Drive.CreateFromDiscriminatorValue); } },
                {"drives", (o,n) => { (o as User).Drives = n.GetCollectionOfObjectValues<Microsoft.Graph.Beta.Models.Drive>(Microsoft.Graph.Beta.Models.Drive.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"employeeOrgData", (o,n) => { (o as User).EmployeeOrgData = n.GetObjectValue<Microsoft.Graph.Beta.Models.EmployeeOrgData>(Microsoft.Graph.Beta.Models.EmployeeOrgData.CreateFromDiscriminatorValue); } },
                ...
                {"inferenceClassification", (o,n) => { (o as User).InferenceClassification = n.GetObjectValue<Microsoft.Graph.Beta.Models.InferenceClassification>(Microsoft.Graph.Beta.Models.InferenceClassification.CreateFromDiscriminatorValue); } },
                {"infoCatalogs", (o,n) => { (o as User).InfoCatalogs = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"informationProtection", (o,n) => { (o as User).InformationProtection = n.GetObjectValue<Microsoft.Graph.Beta.Models.InformationProtection>(Microsoft.Graph.Beta.Models.InformationProtection.CreateFromDiscriminatorValue); } },
                ...
                {"licenseDetails", (o,n) => { (o as User).LicenseDetails = n.GetCollectionOfObjectValues<Microsoft.Graph.Beta.Models.LicenseDetails>(Microsoft.Graph.Beta.Models.LicenseDetails.CreateFromDiscriminatorValue).ToList(); } },
                {"mail", (o,n) => { (o as User).Mail = n.GetStringValue(); } },
                {"mailboxSettings", (o,n) => { (o as User).MailboxSettings = n.GetObjectValue<Microsoft.Graph.Beta.Models.MailboxSettings>(Microsoft.Graph.Beta.Models.MailboxSettings.CreateFromDiscriminatorValue); } },
                ...
                {"onenote", (o,n) => { (o as User).Onenote = n.GetObjectValue<Microsoft.Graph.Beta.Models.Onenote>(Microsoft.Graph.Beta.Models.Onenote.CreateFromDiscriminatorValue); } },
                ...
                {"onPremisesExtensionAttributes", (o,n) => { (o as User).OnPremisesExtensionAttributes = n.GetObjectValue<Microsoft.Graph.Beta.Models.OnPremisesExtensionAttributes>(Microsoft.Graph.Beta.Models.OnPremisesExtensionAttributes.CreateFromDiscriminatorValue); } },
                ...
                {"passwordProfile", (o,n) => { (o as User).PasswordProfile = n.GetObjectValue<Microsoft.Graph.Beta.Models.PasswordProfile>(Microsoft.Graph.Beta.Models.PasswordProfile.CreateFromDiscriminatorValue); } },
                ...
                {"presence", (o,n) => { (o as User).Presence = n.GetObjectValue<Microsoft.Graph.Beta.Models.Presence>(Microsoft.Graph.Beta.Models.Presence.CreateFromDiscriminatorValue); } },
                {"print", (o,n) => { (o as User).Print = n.GetObjectValue<UserPrint>(UserPrint.CreateFromDiscriminatorValue); } },
                {"profile", (o,n) => { (o as User).Profile = n.GetObjectValue<Microsoft.Graph.Beta.Models.Profile>(Microsoft.Graph.Beta.Models.Profile.CreateFromDiscriminatorValue); } },
                ...
                {"security", (o,n) => { (o as User).Security = n.GetObjectValue<Microsoft.Graph.Beta.Models.Security.Security>(Microsoft.Graph.Beta.Models.Security.Security.CreateFromDiscriminatorValue); } },
                ...
                {"signInActivity", (o,n) => { (o as User).SignInActivity = n.GetObjectValue<Microsoft.Graph.Beta.Models.SignInActivity>(Microsoft.Graph.Beta.Models.SignInActivity.CreateFromDiscriminatorValue); } },
                ...
                {"tasks", (o,n) => { (o as User).Tasks = n.GetObjectValue<Microsoft.Graph.Beta.Models.Tasks>(Microsoft.Graph.Beta.Models.Tasks.CreateFromDiscriminatorValue); } },
                {"teamwork", (o,n) => { (o as User).Teamwork = n.GetObjectValue<UserTeamwork>(UserTeamwork.CreateFromDiscriminatorValue); } },
                {"todo", (o,n) => { (o as User).Todo = n.GetObjectValue<Microsoft.Graph.Beta.Models.Todo>(Microsoft.Graph.Beta.Models.Todo.CreateFromDiscriminatorValue); } },
