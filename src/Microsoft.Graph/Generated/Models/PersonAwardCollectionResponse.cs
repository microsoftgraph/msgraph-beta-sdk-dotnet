...
namespace Microsoft.Graph.Beta.Models {
    public class PersonAwardCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<PersonAward> Value {
            get { return BackingStore?.Get<List<PersonAward>>(nameof(Value)); }
