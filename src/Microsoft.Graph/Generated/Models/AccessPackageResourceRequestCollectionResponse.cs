...
namespace Microsoft.Graph.Beta.Models {
    public class AccessPackageResourceRequestCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AccessPackageResourceRequest> Value {
            get { return BackingStore?.Get<List<AccessPackageResourceRequest>>(nameof(Value)); }
