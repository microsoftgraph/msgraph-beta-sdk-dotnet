...
namespace Microsoft.Graph.Beta.Models {
    public class SalesInvoiceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<SalesInvoice> Value {
            get { return BackingStore?.Get<List<SalesInvoice>>(nameof(Value)); }
