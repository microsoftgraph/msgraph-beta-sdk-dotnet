...
namespace Microsoft.Graph.Beta.Models {
    public class OnPremisesPublishingProfileCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<OnPremisesPublishingProfile> Value {
            get { return BackingStore?.Get<List<OnPremisesPublishingProfile>>(nameof(Value)); }
