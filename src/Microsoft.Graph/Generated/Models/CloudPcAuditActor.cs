...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.CloudPcAuditActorType? Type
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.CloudPcAuditActorType?>("type"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.CloudPcUserRoleScopeTagInfo>? UserRoleScopeTags
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.CloudPcUserRoleScopeTagInfo>?>("userRoleScopeTags"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Models.CloudPcAuditActor"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Models.CloudPcAuditActor"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Microsoft.Graph.Beta.Models.CloudPcAuditActor CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.CloudPcAuditActor();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "type", n => { Type = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.CloudPcAuditActorType>(); } },
                { "userId", n => { UserId = n.GetStringValue(); } },
                { "userPermissions", n => { UserPermissions = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "userPrincipalName", n => { UserPrincipalName = n.GetStringValue(); } },
                { "userRoleScopeTags", n => { UserRoleScopeTags = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.CloudPcUserRoleScopeTagInfo>(global::Microsoft.Graph.Beta.Models.CloudPcUserRoleScopeTagInfo.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.CloudPcAuditActorType>("type", Type);
            writer.WriteStringValue("userId", UserId);
            writer.WriteCollectionOfPrimitiveValues<string>("userPermissions", UserPermissions);
            writer.WriteStringValue("userPrincipalName", UserPrincipalName);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.CloudPcUserRoleScopeTagInfo>("userRoleScopeTags", UserRoleScopeTags);
