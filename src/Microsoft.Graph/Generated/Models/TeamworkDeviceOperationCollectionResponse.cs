...
namespace Microsoft.Graph.Beta.Models {
    public class TeamworkDeviceOperationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TeamworkDeviceOperation> Value {
            get { return BackingStore?.Get<List<TeamworkDeviceOperation>>(nameof(Value)); }
