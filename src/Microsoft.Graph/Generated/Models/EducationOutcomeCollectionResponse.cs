...
namespace Microsoft.Graph.Beta.Models {
    public class EducationOutcomeCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<EducationOutcome> Value {
            get { return BackingStore?.Get<List<EducationOutcome>>(nameof(Value)); }
