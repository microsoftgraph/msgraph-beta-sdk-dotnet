...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class WorkbookRangeView : global::Microsoft.Graph.Beta.Models.Entity, IParsable
...
#nullable enable
        ...
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.WorkbookRangeView>?>("rows"); }
...
#endif
        /// <summary>The type of data of each cell. Read-only. Possible values are: Unknown, Empty, String, Integer, Double, Boolean, Error.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.WorkbookRangeView CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.WorkbookRangeView();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "rows", n => { Rows = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.WorkbookRangeView>(global::Microsoft.Graph.Beta.Models.WorkbookRangeView.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.WorkbookRangeView>("rows", Rows);
