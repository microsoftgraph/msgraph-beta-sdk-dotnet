...
namespace Microsoft.Graph.Beta.Models {
    public class ExactMatchSessionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ExactMatchSession> Value {
            get { return BackingStore?.Get<List<ExactMatchSession>>(nameof(Value)); }
