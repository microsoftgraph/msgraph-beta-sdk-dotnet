...
namespace Microsoft.Graph.Beta.Models {
    public class Organization : DirectoryObject, IParsable {
        ...
        public List<Microsoft.Graph.Beta.Models.CertificateBasedAuthConfiguration> CertificateBasedAuthConfiguration { get; set; }
        /// <summary>Certificate connector setting.</summary>
        public Microsoft.Graph.Beta.Models.CertificateConnectorSetting CertificateConnectorSetting { get; set; }
        ...
        public Microsoft.Graph.Beta.Models.DirectorySizeQuota DirectorySizeQuota { get; set; }
        ...
        public Microsoft.Graph.Beta.Models.PrivacyProfile PrivacyProfile { get; set; }
        /// <summary>Not nullable.</summary>
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"certificateBasedAuthConfiguration", (o,n) => { (o as Organization).CertificateBasedAuthConfiguration = n.GetCollectionOfObjectValues<Microsoft.Graph.Beta.Models.CertificateBasedAuthConfiguration>(Microsoft.Graph.Beta.Models.CertificateBasedAuthConfiguration.CreateFromDiscriminatorValue).ToList(); } },
                {"certificateConnectorSetting", (o,n) => { (o as Organization).CertificateConnectorSetting = n.GetObjectValue<Microsoft.Graph.Beta.Models.CertificateConnectorSetting>(Microsoft.Graph.Beta.Models.CertificateConnectorSetting.CreateFromDiscriminatorValue); } },
                ...
                {"directorySizeQuota", (o,n) => { (o as Organization).DirectorySizeQuota = n.GetObjectValue<Microsoft.Graph.Beta.Models.DirectorySizeQuota>(Microsoft.Graph.Beta.Models.DirectorySizeQuota.CreateFromDiscriminatorValue); } },
                ...
                {"privacyProfile", (o,n) => { (o as Organization).PrivacyProfile = n.GetObjectValue<Microsoft.Graph.Beta.Models.PrivacyProfile>(Microsoft.Graph.Beta.Models.PrivacyProfile.CreateFromDiscriminatorValue); } },
