...
namespace Microsoft.Graph.Beta.Models {
    public class AccessReviewScheduleDefinitionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AccessReviewScheduleDefinition> Value {
            get { return BackingStore?.Get<List<AccessReviewScheduleDefinition>>(nameof(Value)); }
