...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceConfigurationGroupAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceConfigurationGroupAssignment> Value {
            get { return BackingStore?.Get<List<DeviceConfigurationGroupAssignment>>(nameof(Value)); }
