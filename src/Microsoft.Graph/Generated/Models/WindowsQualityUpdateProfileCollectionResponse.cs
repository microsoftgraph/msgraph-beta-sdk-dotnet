...
namespace Microsoft.Graph.Beta.Models {
    public class WindowsQualityUpdateProfileCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<WindowsQualityUpdateProfile> Value {
            get { return BackingStore?.Get<List<WindowsQualityUpdateProfile>>(nameof(Value)); }
