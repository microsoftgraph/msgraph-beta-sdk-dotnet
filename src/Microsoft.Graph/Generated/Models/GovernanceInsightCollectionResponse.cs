...
namespace Microsoft.Graph.Beta.Models {
    public class GovernanceInsightCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<GovernanceInsight> Value {
            get { return BackingStore?.Get<List<GovernanceInsight>>(nameof(Value)); }
