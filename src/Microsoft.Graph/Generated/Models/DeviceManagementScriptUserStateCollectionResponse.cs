...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceManagementScriptUserStateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceManagementScriptUserState> Value {
            get { return BackingStore?.Get<List<DeviceManagementScriptUserState>>(nameof(Value)); }
