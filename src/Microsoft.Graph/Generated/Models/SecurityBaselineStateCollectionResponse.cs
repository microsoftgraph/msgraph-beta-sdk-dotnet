...
namespace Microsoft.Graph.Beta.Models {
    public class SecurityBaselineStateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<SecurityBaselineState> Value {
            get { return BackingStore?.Get<List<SecurityBaselineState>>(nameof(Value)); }
