...
namespace Microsoft.Graph.Beta.Models {
    public class SharedEmailDomainInvitationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<SharedEmailDomainInvitation> Value {
            get { return BackingStore?.Get<List<SharedEmailDomainInvitation>>(nameof(Value)); }
