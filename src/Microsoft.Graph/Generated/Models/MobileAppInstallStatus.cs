...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class MobileAppInstallStatus : global::Microsoft.Graph.Beta.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.ResultantAppStateDetail? InstallStateDetail
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.ResultantAppStateDetail?>("installStateDetail"); }
        ...
        /// <summary>A list of possible states for application status on an individual device. When devices contact the Intune service and find targeted application enforcement intent, the status of the enforcement is recorded and becomes accessible in the Graph API. Since the application status is identified during device interaction with the Intune service, status records do not immediately appear upon application group assignment; it is created only after the assignment is evaluated in the service and devices start receiving the policy during check-ins.</summary>
        public global::Microsoft.Graph.Beta.Models.ResultantAppState? MobileAppInstallStatusValue
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.ResultantAppState?>("mobileAppInstallStatusValue"); }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Models.MobileAppInstallStatus"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.Beta.Models.MobileAppInstallStatus CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.MobileAppInstallStatus();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "installStateDetail", n => { InstallStateDetail = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.ResultantAppStateDetail>(); } },
                { "lastSyncDateTime", n => { LastSyncDateTime = n.GetDateTimeOffsetValue(); } },
                { "mobileAppInstallStatusValue", n => { MobileAppInstallStatusValue = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.ResultantAppState>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.ResultantAppStateDetail>("installStateDetail", InstallStateDetail);
            writer.WriteDateTimeOffsetValue("lastSyncDateTime", LastSyncDateTime);
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.ResultantAppState>("mobileAppInstallStatusValue", MobileAppInstallStatusValue);
