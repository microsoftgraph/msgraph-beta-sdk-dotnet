...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class HardwareConfiguration : global::Microsoft.Graph.Beta.Models.Entity, IParsable
    {
...
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.HardwareConfigurationAssignment>? Assignments
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.HardwareConfigurationAssignment>?>("assignments"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.HardwareConfigurationDeviceState>? DeviceRunStates
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.HardwareConfigurationDeviceState>?>("deviceRunStates"); }
...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.HardwareConfigurationFormat? HardwareConfigurationFormat
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.HardwareConfigurationFormat?>("hardwareConfigurationFormat"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Beta.Models.HardwareConfigurationRunSummary? RunSummary
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.HardwareConfigurationRunSummary?>("runSummary"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.HardwareConfigurationUserState>? UserRunStates
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.HardwareConfigurationUserState>?>("userRunStates"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.HardwareConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.HardwareConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "assignments", n => { Assignments = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.HardwareConfigurationAssignment>(global::Microsoft.Graph.Beta.Models.HardwareConfigurationAssignment.CreateFromDiscriminatorValue)?.AsList(); } },
                { "configurationFileContent", n => { ConfigurationFileContent = n.GetByteArrayValue(); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "deviceRunStates", n => { DeviceRunStates = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.HardwareConfigurationDeviceState>(global::Microsoft.Graph.Beta.Models.HardwareConfigurationDeviceState.CreateFromDiscriminatorValue)?.AsList(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "fileName", n => { FileName = n.GetStringValue(); } },
                { "hardwareConfigurationFormat", n => { HardwareConfigurationFormat = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.HardwareConfigurationFormat>(); } },
                ...
                { "runSummary", n => { RunSummary = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.HardwareConfigurationRunSummary>(global::Microsoft.Graph.Beta.Models.HardwareConfigurationRunSummary.CreateFromDiscriminatorValue); } },
                { "userRunStates", n => { UserRunStates = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.HardwareConfigurationUserState>(global::Microsoft.Graph.Beta.Models.HardwareConfigurationUserState.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.HardwareConfigurationAssignment>("assignments", Assignments);
            writer.WriteByteArrayValue("configurationFileContent", ConfigurationFileContent);
            writer.WriteStringValue("description", Description);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.HardwareConfigurationDeviceState>("deviceRunStates", DeviceRunStates);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteStringValue("fileName", FileName);
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.HardwareConfigurationFormat>("hardwareConfigurationFormat", HardwareConfigurationFormat);
            writer.WriteBoolValue("perDevicePasswordDisabled", PerDevicePasswordDisabled);
            writer.WriteCollectionOfPrimitiveValues<string>("roleScopeTagIds", RoleScopeTagIds);
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.HardwareConfigurationRunSummary>("runSummary", RunSummary);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.HardwareConfigurationUserState>("userRunStates", UserRunStates);
