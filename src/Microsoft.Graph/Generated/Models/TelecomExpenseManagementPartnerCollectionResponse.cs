...
namespace Microsoft.Graph.Beta.Models {
    public class TelecomExpenseManagementPartnerCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static TelecomExpenseManagementPartnerCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as TelecomExpenseManagementPartnerCollectionResponse).Value = n.GetCollectionOfObjectValues<TelecomExpenseManagementPartner>(TelecomExpenseManagementPartner.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
