...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceEnrollmentPlatformRestrictionsConfiguration : DeviceEnrollmentConfiguration, IParsable {
        ...
        public DeviceEnrollmentPlatformRestriction AndroidForWorkRestriction {
            get { return BackingStore?.Get<DeviceEnrollmentPlatformRestriction>(nameof(AndroidForWorkRestriction)); }
            set { BackingStore?.Set(nameof(AndroidForWorkRestriction), value); }
        }
        ...
        public DeviceEnrollmentPlatformRestriction MacRestriction {
            get { return BackingStore?.Get<DeviceEnrollmentPlatformRestriction>(nameof(MacRestriction)); }
            set { BackingStore?.Set(nameof(MacRestriction), value); }
        }
        ...
        public DeviceEnrollmentPlatformRestriction WindowsHomeSkuRestriction {
            get { return BackingStore?.Get<DeviceEnrollmentPlatformRestriction>(nameof(WindowsHomeSkuRestriction)); }
            set { BackingStore?.Set(nameof(WindowsHomeSkuRestriction), value); }
        }
