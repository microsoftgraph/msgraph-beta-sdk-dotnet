...
namespace Microsoft.Graph.Beta.Models {
    public class ManagedAppStatusCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ManagedAppStatus> Value {
            get { return BackingStore?.Get<List<ManagedAppStatus>>(nameof(Value)); }
