...
namespace Microsoft.Graph.Beta.Models {
    public class FileSecurityProfileCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<FileSecurityProfile> Value {
            get { return BackingStore?.Get<List<FileSecurityProfile>>(nameof(Value)); }
