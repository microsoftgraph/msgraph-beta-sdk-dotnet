...
namespace Microsoft.Graph.Beta.Models.ExternalConnectors {
    public class ExternalActivityResultCollectionResponse : BaseCollectionPaginationCountResponse, IParsable {
...
#nullable restore
        ...
        public static new ExternalActivityResultCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ExternalActivityResultCollectionResponse();
        }
        /// <summary>
