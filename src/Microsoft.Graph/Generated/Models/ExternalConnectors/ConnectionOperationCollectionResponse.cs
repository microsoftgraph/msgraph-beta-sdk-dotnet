...
namespace Microsoft.Graph.Beta.Models.ExternalConnectors {
    public class ConnectionOperationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ConnectionOperation> Value {
            get { return BackingStore?.Get<List<ConnectionOperation>>(nameof(Value)); }
