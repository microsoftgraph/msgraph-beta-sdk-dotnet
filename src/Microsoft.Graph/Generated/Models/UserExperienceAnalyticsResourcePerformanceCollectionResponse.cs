...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsResourcePerformanceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsResourcePerformance> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsResourcePerformance>>(nameof(Value)); }
