...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsWorkFromAnywhereDevice> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsWorkFromAnywhereDevice>>(nameof(Value)); }
