...
namespace Microsoft.Graph.Beta.Models {
    ...
    public class WindowsNetworkIsolationPolicy : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ProxiedDomain> EnterpriseCloudResources {
            get { return BackingStore?.Get<List<ProxiedDomain>>(nameof(EnterpriseCloudResources)); }
            set { BackingStore?.Set(nameof(EnterpriseCloudResources), value); }
        }
        ...
        public List<string> EnterpriseInternalProxyServers {
            get { return BackingStore?.Get<List<string>>(nameof(EnterpriseInternalProxyServers)); }
        ...
        public List<IpRange> EnterpriseIPRanges {
            get { return BackingStore?.Get<List<IpRange>>(nameof(EnterpriseIPRanges)); }
        ...
        public List<string> EnterpriseNetworkDomainNames {
            get { return BackingStore?.Get<List<string>>(nameof(EnterpriseNetworkDomainNames)); }
        ...
        public List<string> EnterpriseProxyServers {
            get { return BackingStore?.Get<List<string>>(nameof(EnterpriseProxyServers)); }
        ...
        public List<string> NeutralDomainResources {
            get { return BackingStore?.Get<List<string>>(nameof(NeutralDomainResources)); }
