...
namespace Microsoft.Graph.Beta.Models {
    public class PlannerRosterMemberCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<PlannerRosterMember> Value {
            get { return BackingStore?.Get<List<PlannerRosterMember>>(nameof(Value)); }
