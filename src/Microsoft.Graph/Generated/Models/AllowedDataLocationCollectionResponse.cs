...
namespace Microsoft.Graph.Beta.Models {
    public class AllowedDataLocationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AllowedDataLocation> Value {
            get { return BackingStore?.Get<List<AllowedDataLocation>>(nameof(Value)); }
