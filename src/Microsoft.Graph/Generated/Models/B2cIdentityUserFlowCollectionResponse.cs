...
namespace Microsoft.Graph.Beta.Models {
    public class B2cIdentityUserFlowCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<B2cIdentityUserFlow> Value {
            get { return BackingStore?.Get<List<B2cIdentityUserFlow>>(nameof(Value)); }
