...
namespace Microsoft.Graph.Beta.Models {
    public class CustomerPaymentJournalCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<CustomerPaymentJournal> Value {
            get { return BackingStore?.Get<List<CustomerPaymentJournal>>(nameof(Value)); }
