...
namespace Microsoft.Graph.Beta.Models {
    public class TargetedManagedAppPolicyAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TargetedManagedAppPolicyAssignment> Value {
            get { return BackingStore?.Get<List<TargetedManagedAppPolicyAssignment>>(nameof(Value)); }
