...
namespace Microsoft.Graph.Beta.Models {
    public class PrintUsageByUserCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<PrintUsageByUser> Value {
            get { return BackingStore?.Get<List<PrintUsageByUser>>(nameof(Value)); }
