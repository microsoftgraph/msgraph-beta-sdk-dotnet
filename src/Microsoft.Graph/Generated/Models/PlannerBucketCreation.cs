...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Models.PlannerBucketCreation"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Models.PlannerBucketCreation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Microsoft.Graph.Beta.Models.PlannerBucketCreation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("@odata.type")?.GetStringValue();
            return mappingValue switch
            {
                "#microsoft.graph.plannerExternalBucketSource" => new Microsoft.Graph.Beta.Models.PlannerExternalBucketSource(),
                _ => new Microsoft.Graph.Beta.Models.PlannerBucketCreation(),
            };
        }
        /// <summary>
