...
namespace Microsoft.Graph.Beta.Models {
    public class SalesOrderCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<SalesOrder> Value {
            get { return BackingStore?.Get<List<SalesOrder>>(nameof(Value)); }
