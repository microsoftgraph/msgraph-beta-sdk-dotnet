...
namespace Microsoft.Graph.Beta.Models {
    public class CalendarPermissionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<CalendarPermission> Value {
            get { return BackingStore?.Get<List<CalendarPermission>>(nameof(Value)); }
