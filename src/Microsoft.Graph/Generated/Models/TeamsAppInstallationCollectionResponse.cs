...
namespace Microsoft.Graph.Beta.Models {
    public class TeamsAppInstallationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TeamsAppInstallation> Value {
            get { return BackingStore?.Get<List<TeamsAppInstallation>>(nameof(Value)); }
