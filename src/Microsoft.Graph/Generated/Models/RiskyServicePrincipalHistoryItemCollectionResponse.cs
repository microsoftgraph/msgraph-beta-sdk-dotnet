...
namespace Microsoft.Graph.Beta.Models {
    public class RiskyServicePrincipalHistoryItemCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<RiskyServicePrincipalHistoryItem> Value {
            get { return BackingStore?.Get<List<RiskyServicePrincipalHistoryItem>>(nameof(Value)); }
