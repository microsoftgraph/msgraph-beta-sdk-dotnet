...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceManagementCachedReportConfigurationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceManagementCachedReportConfiguration> Value {
            get { return BackingStore?.Get<List<DeviceManagementCachedReportConfiguration>>(nameof(Value)); }
