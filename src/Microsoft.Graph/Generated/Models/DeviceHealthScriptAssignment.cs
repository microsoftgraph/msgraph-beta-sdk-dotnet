...
#nullable enable
        public global::Microsoft.Graph.Beta.Models.DeviceHealthScriptRunSchedule? RunSchedule
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.DeviceHealthScriptRunSchedule?>("runSchedule"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.DeviceHealthScriptAssignment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.DeviceHealthScriptAssignment();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "runSchedule", n => { RunSchedule = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.DeviceHealthScriptRunSchedule>(global::Microsoft.Graph.Beta.Models.DeviceHealthScriptRunSchedule.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.DeviceHealthScriptRunSchedule>("runSchedule", RunSchedule);
