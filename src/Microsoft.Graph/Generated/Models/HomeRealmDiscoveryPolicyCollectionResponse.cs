...
namespace Microsoft.Graph.Beta.Models {
    public class HomeRealmDiscoveryPolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<HomeRealmDiscoveryPolicy> Value {
            get { return BackingStore?.Get<List<HomeRealmDiscoveryPolicy>>(nameof(Value)); }
