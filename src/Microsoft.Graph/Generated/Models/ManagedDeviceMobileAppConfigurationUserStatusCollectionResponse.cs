...
namespace Microsoft.Graph.Beta.Models {
    public class ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ManagedDeviceMobileAppConfigurationUserStatus> Value {
            get { return BackingStore?.Get<List<ManagedDeviceMobileAppConfigurationUserStatus>>(nameof(Value)); }
