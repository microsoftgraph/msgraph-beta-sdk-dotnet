...
namespace Microsoft.Graph.Beta.Models
{
    ...
    /// </summary>
    public class DeviceConfigurationState : Microsoft.Graph.Beta.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Beta.Models.DeviceConfigurationSettingState>? SettingStates
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Beta.Models.DeviceConfigurationSettingState>?>("settingStates"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Beta.Models.DeviceConfigurationState CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Beta.Models.DeviceConfigurationState();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "settingStates", n => { SettingStates = n.GetCollectionOfObjectValues<Microsoft.Graph.Beta.Models.DeviceConfigurationSettingState>(Microsoft.Graph.Beta.Models.DeviceConfigurationSettingState.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Beta.Models.DeviceConfigurationSettingState>("settingStates", SettingStates);
