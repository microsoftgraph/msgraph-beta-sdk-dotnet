...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class DeviceConfigurationState : global::Microsoft.Graph.Beta.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.DeviceConfigurationSettingState>? SettingStates
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.DeviceConfigurationSettingState>?>("settingStates"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.DeviceConfigurationState CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.DeviceConfigurationState();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "settingStates", n => { SettingStates = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.DeviceConfigurationSettingState>(global::Microsoft.Graph.Beta.Models.DeviceConfigurationSettingState.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.DeviceConfigurationSettingState>("settingStates", SettingStates);
