...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsDeviceWithoutCloudIdentityCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsDeviceWithoutCloudIdentity> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsDeviceWithoutCloudIdentity>>(nameof(Value)); }
