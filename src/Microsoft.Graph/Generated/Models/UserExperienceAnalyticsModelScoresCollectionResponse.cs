...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsModelScoresCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsModelScores> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsModelScores>>(nameof(Value)); }
