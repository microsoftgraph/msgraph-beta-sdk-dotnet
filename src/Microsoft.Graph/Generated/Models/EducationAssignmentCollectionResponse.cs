...
namespace Microsoft.Graph.Beta.Models {
    public class EducationAssignmentCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        public List<EducationAssignment> Value { get; set; }
        /// <summary>
        ...
        /// </summary>
        public static EducationAssignmentCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as EducationAssignmentCollectionResponse).Value = n.GetCollectionOfObjectValues<EducationAssignment>(EducationAssignment.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
