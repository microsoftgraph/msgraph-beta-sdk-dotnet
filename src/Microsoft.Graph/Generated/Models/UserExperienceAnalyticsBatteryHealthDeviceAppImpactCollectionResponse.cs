...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsBatteryHealthDeviceAppImpactCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsBatteryHealthDeviceAppImpact> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsBatteryHealthDeviceAppImpact>>(nameof(Value)); }
