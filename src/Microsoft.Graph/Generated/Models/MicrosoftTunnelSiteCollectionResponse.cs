...
namespace Microsoft.Graph.Beta.Models {
    public class MicrosoftTunnelSiteCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<MicrosoftTunnelSite> Value {
            get { return BackingStore?.Get<List<MicrosoftTunnelSite>>(nameof(Value)); }
