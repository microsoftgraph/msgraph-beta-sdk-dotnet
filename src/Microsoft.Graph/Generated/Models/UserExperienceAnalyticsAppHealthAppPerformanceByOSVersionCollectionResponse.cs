...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsAppHealthAppPerformanceByOSVersionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion>>(nameof(Value)); }
