...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public class SmsAuthenticationMethodTarget : Microsoft.Graph.Beta.Models.AuthenticationMethodTarget, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Models.SmsAuthenticationMethodTarget"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Microsoft.Graph.Beta.Models.SmsAuthenticationMethodTarget CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Beta.Models.SmsAuthenticationMethodTarget();
        }
        /// <summary>
