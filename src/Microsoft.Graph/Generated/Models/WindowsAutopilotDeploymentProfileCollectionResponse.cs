...
namespace Microsoft.Graph.Beta.Models {
    public class WindowsAutopilotDeploymentProfileCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<WindowsAutopilotDeploymentProfile> Value {
            get { return BackingStore?.Get<List<WindowsAutopilotDeploymentProfile>>(nameof(Value)); }
