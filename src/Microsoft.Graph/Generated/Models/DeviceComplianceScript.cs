...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class DeviceComplianceScript : global::Microsoft.Graph.Beta.Models.Entity, IParsable
    {
        /// <summary>The list of group assignments for the device compliance script</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.DeviceHealthScriptAssignment>? Assignments
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.DeviceHealthScriptAssignment>?>("assignments"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.DeviceComplianceScriptDeviceState>? DeviceRunStates
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.DeviceComplianceScriptDeviceState>?>("deviceRunStates"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Beta.Models.DeviceComplianceScriptRunSummary? RunSummary
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.DeviceComplianceScriptRunSummary?>("runSummary"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.DeviceComplianceScript CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.DeviceComplianceScript();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "assignments", n => { Assignments = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.DeviceHealthScriptAssignment>(global::Microsoft.Graph.Beta.Models.DeviceHealthScriptAssignment.CreateFromDiscriminatorValue)?.AsList(); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "detectionScriptContent", n => { DetectionScriptContent = n.GetByteArrayValue(); } },
                { "deviceRunStates", n => { DeviceRunStates = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.DeviceComplianceScriptDeviceState>(global::Microsoft.Graph.Beta.Models.DeviceComplianceScriptDeviceState.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "runSummary", n => { RunSummary = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.DeviceComplianceScriptRunSummary>(global::Microsoft.Graph.Beta.Models.DeviceComplianceScriptRunSummary.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.DeviceHealthScriptAssignment>("assignments", Assignments);
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.DeviceComplianceScriptRunSummary>("runSummary", RunSummary);
