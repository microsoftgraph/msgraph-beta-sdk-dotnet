...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public class TeamworkDeviceActivity : Microsoft.Graph.Beta.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The active peripheral devices attached to the device.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Beta.Models.TeamworkActivePeripherals? ActivePeripherals
        {
            get { return BackingStore?.Get<Microsoft.Graph.Beta.Models.TeamworkActivePeripherals?>("activePeripherals"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Beta.Models.TeamworkDeviceActivity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Beta.Models.TeamworkDeviceActivity();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "activePeripherals", n => { ActivePeripherals = n.GetObjectValue<Microsoft.Graph.Beta.Models.TeamworkActivePeripherals>(Microsoft.Graph.Beta.Models.TeamworkActivePeripherals.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Microsoft.Graph.Beta.Models.TeamworkActivePeripherals>("activePeripherals", ActivePeripherals);
