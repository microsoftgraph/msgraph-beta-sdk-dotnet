...
namespace Microsoft.Graph.Beta.Models {
    public class AssignmentFilterEvaluationStatusDetailsCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AssignmentFilterEvaluationStatusDetails> Value {
            get { return BackingStore?.Get<List<AssignmentFilterEvaluationStatusDetails>>(nameof(Value)); }
