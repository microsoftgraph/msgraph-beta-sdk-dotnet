...
namespace Microsoft.Graph.Beta.Models {
    public class MacOSDeviceFeaturesConfiguration : AppleDeviceFeaturesConfigurationBase, IParsable {
        ...
        public bool? AdminShowHostInfo {
            get { return BackingStore?.Get<bool?>(nameof(AdminShowHostInfo)); }
            set { BackingStore?.Set(nameof(AdminShowHostInfo), value); }
        }
        ...
        public List<MacOSAssociatedDomainsItem> AppAssociatedDomains {
            get { return BackingStore?.Get<List<MacOSAssociatedDomainsItem>>(nameof(AppAssociatedDomains)); }
            set { BackingStore?.Set(nameof(AppAssociatedDomains), value); }
        }
        ...
        public List<KeyValuePair> AssociatedDomains {
            get { return BackingStore?.Get<List<KeyValuePair>>(nameof(AssociatedDomains)); }
        ...
        public bool? AuthorizedUsersListHidden {
            get { return BackingStore?.Get<bool?>(nameof(AuthorizedUsersListHidden)); }
            set { BackingStore?.Set(nameof(AuthorizedUsersListHidden), value); }
        }
        ...
        public bool? AuthorizedUsersListHideAdminUsers {
            get { return BackingStore?.Get<bool?>(nameof(AuthorizedUsersListHideAdminUsers)); }
            set { BackingStore?.Set(nameof(AuthorizedUsersListHideAdminUsers), value); }
        }
        ...
        public bool? AuthorizedUsersListHideLocalUsers {
            get { return BackingStore?.Get<bool?>(nameof(AuthorizedUsersListHideLocalUsers)); }
            set { BackingStore?.Set(nameof(AuthorizedUsersListHideLocalUsers), value); }
        }
        ...
        public bool? AuthorizedUsersListHideMobileAccounts {
            get { return BackingStore?.Get<bool?>(nameof(AuthorizedUsersListHideMobileAccounts)); }
            set { BackingStore?.Set(nameof(AuthorizedUsersListHideMobileAccounts), value); }
        }
        ...
        public bool? AuthorizedUsersListIncludeNetworkUsers {
            get { return BackingStore?.Get<bool?>(nameof(AuthorizedUsersListIncludeNetworkUsers)); }
            set { BackingStore?.Set(nameof(AuthorizedUsersListIncludeNetworkUsers), value); }
        }
        ...
        public bool? AuthorizedUsersListShowOtherManagedUsers {
            get { return BackingStore?.Get<bool?>(nameof(AuthorizedUsersListShowOtherManagedUsers)); }
            set { BackingStore?.Set(nameof(AuthorizedUsersListShowOtherManagedUsers), value); }
        }
        ...
        public List<MacOSLaunchItem> AutoLaunchItems {
            get { return BackingStore?.Get<List<MacOSLaunchItem>>(nameof(AutoLaunchItems)); }
            set { BackingStore?.Set(nameof(AutoLaunchItems), value); }
        }
        ...
        public bool? ConsoleAccessDisabled {
            get { return BackingStore?.Get<bool?>(nameof(ConsoleAccessDisabled)); }
            set { BackingStore?.Set(nameof(ConsoleAccessDisabled), value); }
        }
        ...
        public bool? ContentCachingBlockDeletion {
            get { return BackingStore?.Get<bool?>(nameof(ContentCachingBlockDeletion)); }
            set { BackingStore?.Set(nameof(ContentCachingBlockDeletion), value); }
        }
        ...
        public List<IpRange> ContentCachingClientListenRanges {
            get { return BackingStore?.Get<List<IpRange>>(nameof(ContentCachingClientListenRanges)); }
            set { BackingStore?.Set(nameof(ContentCachingClientListenRanges), value); }
        }
        /// <summary>Determines the method in which content caching servers will listen for clients. Possible values are: notConfigured, clientsInLocalNetwork, clientsWithSamePublicIpAddress, clientsInCustomLocalNetworks, clientsInCustomLocalNetworksWithFallback.</summary>
        public MacOSContentCachingClientPolicy? ContentCachingClientPolicy {
            get { return BackingStore?.Get<MacOSContentCachingClientPolicy?>(nameof(ContentCachingClientPolicy)); }
            set { BackingStore?.Set(nameof(ContentCachingClientPolicy), value); }
        }
        ...
        public string ContentCachingDataPath {
            get { return BackingStore?.Get<string>(nameof(ContentCachingDataPath)); }
            set { BackingStore?.Set(nameof(ContentCachingDataPath), value); }
        }
        /// <summary>Disables internet connection sharing.</summary>
        public bool? ContentCachingDisableConnectionSharing {
            get { return BackingStore?.Get<bool?>(nameof(ContentCachingDisableConnectionSharing)); }
            set { BackingStore?.Set(nameof(ContentCachingDisableConnectionSharing), value); }
        }
        /// <summary>Enables content caching and prevents it from being disabled by the user.</summary>
        public bool? ContentCachingEnabled {
            get { return BackingStore?.Get<bool?>(nameof(ContentCachingEnabled)); }
            set { BackingStore?.Set(nameof(ContentCachingEnabled), value); }
        }
        ...
        public bool? ContentCachingForceConnectionSharing {
            get { return BackingStore?.Get<bool?>(nameof(ContentCachingForceConnectionSharing)); }
            set { BackingStore?.Set(nameof(ContentCachingForceConnectionSharing), value); }
        }
        /// <summary>Prevent the device from sleeping if content caching is enabled.</summary>
        public bool? ContentCachingKeepAwake {
            get { return BackingStore?.Get<bool?>(nameof(ContentCachingKeepAwake)); }
            set { BackingStore?.Set(nameof(ContentCachingKeepAwake), value); }
        }
        ...
        public bool? ContentCachingLogClientIdentities {
            get { return BackingStore?.Get<bool?>(nameof(ContentCachingLogClientIdentities)); }
            set { BackingStore?.Set(nameof(ContentCachingLogClientIdentities), value); }
        }
        ...
        public long? ContentCachingMaxSizeBytes {
            get { return BackingStore?.Get<long?>(nameof(ContentCachingMaxSizeBytes)); }
            set { BackingStore?.Set(nameof(ContentCachingMaxSizeBytes), value); }
        }
        /// <summary>A list of IP addresses representing parent content caches.</summary>
        public List<string> ContentCachingParents {
            get { return BackingStore?.Get<List<string>>(nameof(ContentCachingParents)); }
            set { BackingStore?.Set(nameof(ContentCachingParents), value); }
        }
        /// <summary>Determines the method in which content caching servers will select parents if multiple are present. Possible values are: notConfigured, roundRobin, firstAvailable, urlPathHash, random, stickyAvailable.</summary>
        public MacOSContentCachingParentSelectionPolicy? ContentCachingParentSelectionPolicy {
            get { return BackingStore?.Get<MacOSContentCachingParentSelectionPolicy?>(nameof(ContentCachingParentSelectionPolicy)); }
            set { BackingStore?.Set(nameof(ContentCachingParentSelectionPolicy), value); }
        }
        ...
        public List<IpRange> ContentCachingPeerFilterRanges {
            get { return BackingStore?.Get<List<IpRange>>(nameof(ContentCachingPeerFilterRanges)); }
            set { BackingStore?.Set(nameof(ContentCachingPeerFilterRanges), value); }
        }
        ...
        public List<IpRange> ContentCachingPeerListenRanges {
            get { return BackingStore?.Get<List<IpRange>>(nameof(ContentCachingPeerListenRanges)); }
            set { BackingStore?.Set(nameof(ContentCachingPeerListenRanges), value); }
        }
        /// <summary>Determines the method in which content caches peer with other caches. Possible values are: notConfigured, peersInLocalNetwork, peersWithSamePublicIpAddress, peersInCustomLocalNetworks.</summary>
        public MacOSContentCachingPeerPolicy? ContentCachingPeerPolicy {
            get { return BackingStore?.Get<MacOSContentCachingPeerPolicy?>(nameof(ContentCachingPeerPolicy)); }
            set { BackingStore?.Set(nameof(ContentCachingPeerPolicy), value); }
        }
        ...
        public int? ContentCachingPort {
            get { return BackingStore?.Get<int?>(nameof(ContentCachingPort)); }
            set { BackingStore?.Set(nameof(ContentCachingPort), value); }
        }
        ...
        public List<IpRange> ContentCachingPublicRanges {
            get { return BackingStore?.Get<List<IpRange>>(nameof(ContentCachingPublicRanges)); }
            set { BackingStore?.Set(nameof(ContentCachingPublicRanges), value); }
        }
        /// <summary>Display content caching alerts as system notifications.</summary>
        public bool? ContentCachingShowAlerts {
            get { return BackingStore?.Get<bool?>(nameof(ContentCachingShowAlerts)); }
            set { BackingStore?.Set(nameof(ContentCachingShowAlerts), value); }
        }
        /// <summary>Determines what type of content is allowed to be cached by Apple&apos;s content caching service. Possible values are: notConfigured, userContentOnly, sharedContentOnly.</summary>
        public MacOSContentCachingType? ContentCachingType {
            get { return BackingStore?.Get<MacOSContentCachingType?>(nameof(ContentCachingType)); }
            set { BackingStore?.Set(nameof(ContentCachingType), value); }
        }
        /// <summary>Custom text to be displayed on the login window.</summary>
        public string LoginWindowText {
            get { return BackingStore?.Get<string>(nameof(LoginWindowText)); }
            set { BackingStore?.Set(nameof(LoginWindowText), value); }
        }
        ...
        public bool? LogOutDisabledWhileLoggedIn {
            get { return BackingStore?.Get<bool?>(nameof(LogOutDisabledWhileLoggedIn)); }
            set { BackingStore?.Set(nameof(LogOutDisabledWhileLoggedIn), value); }
        }
        ...
        public Microsoft.Graph.Beta.Models.MacOSSingleSignOnExtension MacOSSingleSignOnExtension {
            get { return BackingStore?.Get<Microsoft.Graph.Beta.Models.MacOSSingleSignOnExtension>(nameof(MacOSSingleSignOnExtension)); }
            set { BackingStore?.Set(nameof(MacOSSingleSignOnExtension), value); }
        }
        ...
        public bool? PowerOffDisabledWhileLoggedIn {
            get { return BackingStore?.Get<bool?>(nameof(PowerOffDisabledWhileLoggedIn)); }
            set { BackingStore?.Set(nameof(PowerOffDisabledWhileLoggedIn), value); }
        }
        /// <summary>Whether to hide the Restart button item on the login window.</summary>
        public bool? RestartDisabled {
            get { return BackingStore?.Get<bool?>(nameof(RestartDisabled)); }
            set { BackingStore?.Set(nameof(RestartDisabled), value); }
        }
        ...
        public bool? RestartDisabledWhileLoggedIn {
            get { return BackingStore?.Get<bool?>(nameof(RestartDisabledWhileLoggedIn)); }
            set { BackingStore?.Set(nameof(RestartDisabledWhileLoggedIn), value); }
        }
        /// <summary>Whether to disable the immediate screen lock functions.</summary>
        public bool? ScreenLockDisableImmediate {
            get { return BackingStore?.Get<bool?>(nameof(ScreenLockDisableImmediate)); }
            set { BackingStore?.Set(nameof(ScreenLockDisableImmediate), value); }
        }
        /// <summary>Whether to hide the Shut Down button item on the login window.</summary>
        public bool? ShutDownDisabled {
            get { return BackingStore?.Get<bool?>(nameof(ShutDownDisabled)); }
            set { BackingStore?.Set(nameof(ShutDownDisabled), value); }
        }
        ...
        public bool? ShutDownDisabledWhileLoggedIn {
            get { return BackingStore?.Get<bool?>(nameof(ShutDownDisabledWhileLoggedIn)); }
            set { BackingStore?.Set(nameof(ShutDownDisabledWhileLoggedIn), value); }
        }
        ...
        public MacOSCertificateProfileBase SingleSignOnExtensionPkinitCertificate {
            get { return BackingStore?.Get<MacOSCertificateProfileBase>(nameof(SingleSignOnExtensionPkinitCertificate)); }
        ...
        public bool? SleepDisabled {
            get { return BackingStore?.Get<bool?>(nameof(SleepDisabled)); }
            set { BackingStore?.Set(nameof(SleepDisabled), value); }
        }
        /// <summary>
