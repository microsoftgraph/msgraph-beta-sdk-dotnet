...
namespace Microsoft.Graph.Beta.Models {
    public class GroupPolicyOperationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<GroupPolicyOperation> Value {
            get { return BackingStore?.Get<List<GroupPolicyOperation>>(nameof(Value)); }
