...
namespace Microsoft.Graph.Beta.Models {
    public class AdvancedThreatProtectionOnboardingDeviceSettingStateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AdvancedThreatProtectionOnboardingDeviceSettingState> Value {
            get { return BackingStore?.Get<List<AdvancedThreatProtectionOnboardingDeviceSettingState>>(nameof(Value)); }
