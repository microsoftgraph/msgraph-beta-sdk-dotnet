...
namespace Microsoft.Graph.Beta.Models {
    public class AuthorizationPolicy : PolicyBase, IParsable {
        ...
        public Microsoft.Graph.Beta.Models.AllowInvitesFrom? AllowInvitesFrom { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"defaultUserRolePermissions", (o,n) => { (o as AuthorizationPolicy).DefaultUserRolePermissions = n.GetObjectValue<Microsoft.Graph.Beta.Models.DefaultUserRolePermissions>(Microsoft.Graph.Beta.Models.DefaultUserRolePermissions.CreateFromDiscriminatorValue); } },
