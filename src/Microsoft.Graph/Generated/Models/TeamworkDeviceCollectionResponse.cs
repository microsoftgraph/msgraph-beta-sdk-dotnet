...
namespace Microsoft.Graph.Beta.Models {
    public class TeamworkDeviceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TeamworkDevice> Value {
            get { return BackingStore?.Get<List<TeamworkDevice>>(nameof(Value)); }
