...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceManagementScriptGroupAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceManagementScriptGroupAssignment> Value {
            get { return BackingStore?.Get<List<DeviceManagementScriptGroupAssignment>>(nameof(Value)); }
