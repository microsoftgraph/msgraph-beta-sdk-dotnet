...
namespace Microsoft.Graph.Beta.Models {
    public class AccessPackageResourceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AccessPackageResource> Value {
            get { return BackingStore?.Get<List<AccessPackageResource>>(nameof(Value)); }
