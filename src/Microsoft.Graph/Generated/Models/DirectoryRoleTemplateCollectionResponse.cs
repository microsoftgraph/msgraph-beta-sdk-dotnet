...
namespace Microsoft.Graph.Beta.Models {
    public class DirectoryRoleTemplateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DirectoryRoleTemplate> Value {
            get { return BackingStore?.Get<List<DirectoryRoleTemplate>>(nameof(Value)); }
