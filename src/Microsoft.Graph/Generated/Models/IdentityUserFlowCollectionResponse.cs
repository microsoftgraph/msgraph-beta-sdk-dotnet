...
namespace Microsoft.Graph.Beta.Models {
    public class IdentityUserFlowCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<IdentityUserFlow> Value {
            get { return BackingStore?.Get<List<IdentityUserFlow>>(nameof(Value)); }
