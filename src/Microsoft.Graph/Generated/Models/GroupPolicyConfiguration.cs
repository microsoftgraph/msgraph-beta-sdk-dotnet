...
namespace Microsoft.Graph.Beta.Models {
    ...
    public class GroupPolicyConfiguration : Entity, IParsable {
        ...
        public List<GroupPolicyConfigurationAssignment> Assignments {
            get { return BackingStore?.Get<List<GroupPolicyConfigurationAssignment>>(nameof(Assignments)); }
        ...
        public List<GroupPolicyDefinitionValue> DefinitionValues {
            get { return BackingStore?.Get<List<GroupPolicyDefinitionValue>>(nameof(DefinitionValues)); }
            set { BackingStore?.Set(nameof(DefinitionValues), value); }
        }
