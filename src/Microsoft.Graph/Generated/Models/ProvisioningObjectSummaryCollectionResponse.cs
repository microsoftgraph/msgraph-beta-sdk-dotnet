...
namespace Microsoft.Graph.Beta.Models {
    public class ProvisioningObjectSummaryCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ProvisioningObjectSummary> Value {
            get { return BackingStore?.Get<List<ProvisioningObjectSummary>>(nameof(Value)); }
