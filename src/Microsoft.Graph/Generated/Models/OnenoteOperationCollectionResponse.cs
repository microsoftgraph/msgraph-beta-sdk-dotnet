...
namespace Microsoft.Graph.Beta.Models {
    public class OnenoteOperationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<OnenoteOperation> Value {
            get { return BackingStore?.Get<List<OnenoteOperation>>(nameof(Value)); }
