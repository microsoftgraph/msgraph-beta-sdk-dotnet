...
namespace Microsoft.Graph.Beta.Models {
    public class ApprovalWorkflowProviderCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ApprovalWorkflowProvider> Value {
            get { return BackingStore?.Get<List<ApprovalWorkflowProvider>>(nameof(Value)); }
