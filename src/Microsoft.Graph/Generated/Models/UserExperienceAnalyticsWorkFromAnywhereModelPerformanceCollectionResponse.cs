...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsWorkFromAnywhereModelPerformanceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsWorkFromAnywhereModelPerformance> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsWorkFromAnywhereModelPerformance>>(nameof(Value)); }
