...
namespace Microsoft.Graph.Beta.Models {
    public class TokenLifetimePolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TokenLifetimePolicy> Value {
            get { return BackingStore?.Get<List<TokenLifetimePolicy>>(nameof(Value)); }
