...
namespace Microsoft.Graph.Beta.Models {
    public class GroupPolicyPresentationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<GroupPolicyPresentation> Value {
            get { return BackingStore?.Get<List<GroupPolicyPresentation>>(nameof(Value)); }
