...
namespace Microsoft.Graph.Beta.Models.TermStore {
    public class TermCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as TermCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as TermCollectionResponse).Value = n.GetCollectionOfObjectValues<Term>(Term.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
