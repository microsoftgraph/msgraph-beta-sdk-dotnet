...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceManagementScriptDeviceStateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceManagementScriptDeviceState> Value {
            get { return BackingStore?.Get<List<DeviceManagementScriptDeviceState>>(nameof(Value)); }
