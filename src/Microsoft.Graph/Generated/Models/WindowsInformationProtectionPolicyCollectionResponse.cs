...
namespace Microsoft.Graph.Beta.Models {
    public class WindowsInformationProtectionPolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<WindowsInformationProtectionPolicy> Value {
            get { return BackingStore?.Get<List<WindowsInformationProtectionPolicy>>(nameof(Value)); }
