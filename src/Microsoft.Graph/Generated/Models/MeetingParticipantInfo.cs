...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.OnlineMeetingRole? Role
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.OnlineMeetingRole?>("role"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Models.MeetingParticipantInfo"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Models.MeetingParticipantInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Microsoft.Graph.Beta.Models.MeetingParticipantInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("@odata.type")?.GetStringValue();
            return mappingValue switch
            {
                "#microsoft.graph.virtualEventPresenterInfo" => new global::Microsoft.Graph.Beta.Models.VirtualEventPresenterInfo(),
                _ => new global::Microsoft.Graph.Beta.Models.MeetingParticipantInfo(),
            };
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "role", n => { Role = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.OnlineMeetingRole>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.OnlineMeetingRole>("role", Role);
