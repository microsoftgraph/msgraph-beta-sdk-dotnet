...
namespace Microsoft.Graph.Beta.Models {
    public class ManagedDeviceMobileAppConfigurationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ManagedDeviceMobileAppConfiguration> Value {
            get { return BackingStore?.Get<List<ManagedDeviceMobileAppConfiguration>>(nameof(Value)); }
