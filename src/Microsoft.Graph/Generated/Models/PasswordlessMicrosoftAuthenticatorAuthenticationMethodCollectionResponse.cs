...
namespace Microsoft.Graph.Beta.Models {
    public class PasswordlessMicrosoftAuthenticatorAuthenticationMethodCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<PasswordlessMicrosoftAuthenticatorAuthenticationMethod> Value {
            get { return BackingStore?.Get<List<PasswordlessMicrosoftAuthenticatorAuthenticationMethod>>(nameof(Value)); }
