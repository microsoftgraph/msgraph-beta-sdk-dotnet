...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class SecureScoreControlProfile : global::Microsoft.Graph.Beta.Models.Entity, IParsable
...
#nullable enable
        ...
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.ComplianceInformation>?>("complianceInformation"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.SecureScoreControlStateUpdate>? ControlStateUpdates
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.SecureScoreControlStateUpdate>?>("controlStateUpdates"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.SecureScoreControlProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.SecureScoreControlProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "complianceInformation", n => { ComplianceInformation = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.ComplianceInformation>(global::Microsoft.Graph.Beta.Models.ComplianceInformation.CreateFromDiscriminatorValue)?.AsList(); } },
                { "controlCategory", n => { ControlCategory = n.GetStringValue(); } },
                { "controlStateUpdates", n => { ControlStateUpdates = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.SecureScoreControlStateUpdate>(global::Microsoft.Graph.Beta.Models.SecureScoreControlStateUpdate.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.ComplianceInformation>("complianceInformation", ComplianceInformation);
            writer.WriteStringValue("controlCategory", ControlCategory);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.SecureScoreControlStateUpdate>("controlStateUpdates", ControlStateUpdates);
