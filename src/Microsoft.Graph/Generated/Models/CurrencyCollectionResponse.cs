...
namespace Microsoft.Graph.Beta.Models {
    public class CurrencyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Currency> Value {
            get { return BackingStore?.Get<List<Currency>>(nameof(Value)); }
