...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceComplianceScriptDeviceStateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceComplianceScriptDeviceState> Value {
            get { return BackingStore?.Get<List<DeviceComplianceScriptDeviceState>>(nameof(Value)); }
