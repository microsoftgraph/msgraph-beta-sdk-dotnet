...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class SynchronizationTemplate : global::Microsoft.Graph.Beta.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.SynchronizationMetadataEntry>? Metadata
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.SynchronizationMetadataEntry>?>("metadata"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Beta.Models.SynchronizationSchema? Schema
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.SynchronizationSchema?>("schema"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.SynchronizationTemplate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.SynchronizationTemplate();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "metadata", n => { Metadata = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.SynchronizationMetadataEntry>(global::Microsoft.Graph.Beta.Models.SynchronizationMetadataEntry.CreateFromDiscriminatorValue)?.AsList(); } },
                { "schema", n => { Schema = n.GetObjectValue<global::Microsoft.Graph.Beta.Models.SynchronizationSchema>(global::Microsoft.Graph.Beta.Models.SynchronizationSchema.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.SynchronizationMetadataEntry>("metadata", Metadata);
            writer.WriteObjectValue<global::Microsoft.Graph.Beta.Models.SynchronizationSchema>("schema", Schema);
        }
    }
}
