...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceManagementReusablePolicySettingCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceManagementReusablePolicySetting> Value {
            get { return BackingStore?.Get<List<DeviceManagementReusablePolicySetting>>(nameof(Value)); }
