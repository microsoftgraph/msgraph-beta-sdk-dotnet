...
namespace Microsoft.Graph.Beta.Models {
    public class DirectoryDefinitionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DirectoryDefinition> Value {
            get { return BackingStore?.Get<List<DirectoryDefinition>>(nameof(Value)); }
