...
namespace Microsoft.Graph.Beta.Models {
    public class WindowsAutopilotDeploymentProfileAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<WindowsAutopilotDeploymentProfileAssignment> Value {
            get { return BackingStore?.Get<List<WindowsAutopilotDeploymentProfileAssignment>>(nameof(Value)); }
