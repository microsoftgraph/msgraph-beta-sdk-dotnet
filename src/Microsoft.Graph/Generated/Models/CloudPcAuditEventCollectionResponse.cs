...
namespace Microsoft.Graph.Beta.Models {
    public class CloudPcAuditEventCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<CloudPcAuditEvent> Value {
            get { return BackingStore?.Get<List<CloudPcAuditEvent>>(nameof(Value)); }
