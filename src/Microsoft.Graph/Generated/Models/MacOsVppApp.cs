...
namespace Microsoft.Graph.Beta.Models
{
    ...
    /// </summary>
    public class MacOsVppApp : Microsoft.Graph.Beta.Models.MobileApp, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Beta.Models.MacOsVppAppAssignedLicense>? AssignedLicenses
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Beta.Models.MacOsVppAppAssignedLicense>?>("assignedLicenses"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Beta.Models.MacOsVppAppRevokeLicensesActionResult>? RevokeLicenseActionResults
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Beta.Models.MacOsVppAppRevokeLicensesActionResult>?>("revokeLicenseActionResults"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Models.MacOsVppApp"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Models.MacOsVppApp"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Microsoft.Graph.Beta.Models.MacOsVppApp CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Beta.Models.MacOsVppApp();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "assignedLicenses", n => { AssignedLicenses = n.GetCollectionOfObjectValues<Microsoft.Graph.Beta.Models.MacOsVppAppAssignedLicense>(Microsoft.Graph.Beta.Models.MacOsVppAppAssignedLicense.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "revokeLicenseActionResults", n => { RevokeLicenseActionResults = n.GetCollectionOfObjectValues<Microsoft.Graph.Beta.Models.MacOsVppAppRevokeLicensesActionResult>(Microsoft.Graph.Beta.Models.MacOsVppAppRevokeLicensesActionResult.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Beta.Models.MacOsVppAppAssignedLicense>("assignedLicenses", AssignedLicenses);
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Beta.Models.MacOsVppAppRevokeLicensesActionResult>("revokeLicenseActionResults", RevokeLicenseActionResults);
