...
namespace Microsoft.Graph.Beta.Models {
    public class MacOsVppApp : MobileApp, IParsable {
        ...
        public List<MacOsVppAppAssignedLicense> AssignedLicenses {
            get { return BackingStore?.Get<List<MacOsVppAppAssignedLicense>>(nameof(AssignedLicenses)); }
        ...
        public List<MacOsVppAppRevokeLicensesActionResult> RevokeLicenseActionResults {
            get { return BackingStore?.Get<List<MacOsVppAppRevokeLicensesActionResult>>(nameof(RevokeLicenseActionResults)); }
