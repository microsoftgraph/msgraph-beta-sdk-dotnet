...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsWorkFromAnywhereMetric> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsWorkFromAnywhereMetric>>(nameof(Value)); }
