...
namespace Microsoft.Graph.Beta.Models {
    public class DelegatedAdminRelationshipRequestCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DelegatedAdminRelationshipRequest> Value {
            get { return BackingStore?.Get<List<DelegatedAdminRelationshipRequest>>(nameof(Value)); }
