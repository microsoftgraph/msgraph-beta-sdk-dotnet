...
namespace Microsoft.Graph.Beta.Models {
    public class ColumnDefinitionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ColumnDefinition> Value {
            get { return BackingStore?.Get<List<ColumnDefinition>>(nameof(Value)); }
