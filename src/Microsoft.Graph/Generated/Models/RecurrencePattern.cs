...
#nullable restore
        ...
        public Microsoft.Graph.Beta.Models.DayOfWeekObject? FirstDayOfWeek
        {
            get { return BackingStore?.Get<Microsoft.Graph.Beta.Models.DayOfWeekObject?>("firstDayOfWeek"); }
        ...
        public Microsoft.Graph.Beta.Models.WeekIndex? Index
        {
            get { return BackingStore?.Get<Microsoft.Graph.Beta.Models.WeekIndex?>("index"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Beta.Models.RecurrencePatternType? Type
        {
            get { return BackingStore?.Get<Microsoft.Graph.Beta.Models.RecurrencePatternType?>("type"); }
            set { BackingStore?.Set("type", value); }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Models.RecurrencePattern"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Models.RecurrencePattern"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Microsoft.Graph.Beta.Models.RecurrencePattern CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Beta.Models.RecurrencePattern();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "firstDayOfWeek", n => { FirstDayOfWeek = n.GetEnumValue<Microsoft.Graph.Beta.Models.DayOfWeekObject>(); } },
                { "index", n => { Index = n.GetEnumValue<Microsoft.Graph.Beta.Models.WeekIndex>(); } },
                { "interval", n => { Interval = n.GetIntValue(); } },
                { "month", n => { Month = n.GetIntValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<Microsoft.Graph.Beta.Models.RecurrencePatternType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Beta.Models.DayOfWeekObject>("firstDayOfWeek", FirstDayOfWeek);
            writer.WriteEnumValue<Microsoft.Graph.Beta.Models.WeekIndex>("index", Index);
            writer.WriteIntValue("interval", Interval);
            writer.WriteIntValue("month", Month);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<Microsoft.Graph.Beta.Models.RecurrencePatternType>("type", Type);
