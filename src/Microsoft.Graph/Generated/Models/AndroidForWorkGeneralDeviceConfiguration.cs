...
namespace Microsoft.Graph.Beta.Models {
    public class AndroidForWorkGeneralDeviceConfiguration : DeviceConfiguration, IParsable {
        ...
        public AndroidForWorkRequiredPasswordType? PasswordRequiredType {
            get { return BackingStore?.Get<AndroidForWorkRequiredPasswordType?>(nameof(PasswordRequiredType)); }
        ...
        public AndroidForWorkCrossProfileDataSharingType? WorkProfileDataSharingType {
            get { return BackingStore?.Get<AndroidForWorkCrossProfileDataSharingType?>(nameof(WorkProfileDataSharingType)); }
        ...
        public AndroidForWorkDefaultAppPermissionPolicyType? WorkProfileDefaultAppPermissionPolicy {
            get { return BackingStore?.Get<AndroidForWorkDefaultAppPermissionPolicyType?>(nameof(WorkProfileDefaultAppPermissionPolicy)); }
        ...
        public AndroidForWorkRequiredPasswordType? WorkProfilePasswordRequiredType {
            get { return BackingStore?.Get<AndroidForWorkRequiredPasswordType?>(nameof(WorkProfilePasswordRequiredType)); }
