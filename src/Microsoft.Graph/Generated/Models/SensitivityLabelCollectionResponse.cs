...
namespace Microsoft.Graph.Beta.Models {
    public class SensitivityLabelCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<SensitivityLabel> Value {
            get { return BackingStore?.Get<List<SensitivityLabel>>(nameof(Value)); }
