...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceCustomAttributeShellScriptCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceCustomAttributeShellScript> Value {
            get { return BackingStore?.Get<List<DeviceCustomAttributeShellScript>>(nameof(Value)); }
