...
namespace Microsoft.Graph.Beta.Models {
    public class AuthorizationPolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AuthorizationPolicy> Value {
            get { return BackingStore?.Get<List<AuthorizationPolicy>>(nameof(Value)); }
