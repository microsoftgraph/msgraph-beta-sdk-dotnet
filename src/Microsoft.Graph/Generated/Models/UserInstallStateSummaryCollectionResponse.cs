...
namespace Microsoft.Graph.Beta.Models {
    public class UserInstallStateSummaryCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static UserInstallStateSummaryCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UserInstallStateSummaryCollectionResponse).Value = n.GetCollectionOfObjectValues<UserInstallStateSummary>(UserInstallStateSummary.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
