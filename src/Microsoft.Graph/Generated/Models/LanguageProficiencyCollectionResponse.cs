...
namespace Microsoft.Graph.Beta.Models {
    public class LanguageProficiencyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<LanguageProficiency> Value {
            get { return BackingStore?.Get<List<LanguageProficiency>>(nameof(Value)); }
