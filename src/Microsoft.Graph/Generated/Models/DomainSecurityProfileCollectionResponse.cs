...
namespace Microsoft.Graph.Beta.Models {
    public class DomainSecurityProfileCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DomainSecurityProfile> Value {
            get { return BackingStore?.Get<List<DomainSecurityProfile>>(nameof(Value)); }
