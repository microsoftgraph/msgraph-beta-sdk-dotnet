...
namespace Microsoft.Graph.Beta.Models {
    public class PrintUsageByPrinterCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<PrintUsageByPrinter> Value {
            get { return BackingStore?.Get<List<PrintUsageByPrinter>>(nameof(Value)); }
