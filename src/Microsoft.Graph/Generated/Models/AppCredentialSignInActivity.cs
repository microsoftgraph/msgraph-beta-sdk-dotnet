...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class AppCredentialSignInActivity : global::Microsoft.Graph.Beta.Models.Entity, IParsable
...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.ApplicationKeyOrigin? CredentialOrigin
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.ApplicationKeyOrigin?>("credentialOrigin"); }
...
#nullable restore
        ...
        public global::Microsoft.Graph.Beta.Models.ApplicationKeyType? KeyType
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.ApplicationKeyType?>("keyType"); }
        ...
        public global::Microsoft.Graph.Beta.Models.ApplicationKeyUsage? KeyUsage
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Beta.Models.ApplicationKeyUsage?>("keyUsage"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.AppCredentialSignInActivity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.AppCredentialSignInActivity();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "credentialOrigin", n => { CredentialOrigin = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.ApplicationKeyOrigin>(); } },
                { "expirationDateTime", n => { ExpirationDateTime = n.GetDateTimeOffsetValue(); } },
                { "keyId", n => { KeyId = n.GetStringValue(); } },
                { "keyType", n => { KeyType = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.ApplicationKeyType>(); } },
                { "keyUsage", n => { KeyUsage = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.ApplicationKeyUsage>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.ApplicationKeyOrigin>("credentialOrigin", CredentialOrigin);
            writer.WriteDateTimeOffsetValue("expirationDateTime", ExpirationDateTime);
            writer.WriteStringValue("keyId", KeyId);
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.ApplicationKeyType>("keyType", KeyType);
            writer.WriteEnumValue<global::Microsoft.Graph.Beta.Models.ApplicationKeyUsage>("keyUsage", KeyUsage);
