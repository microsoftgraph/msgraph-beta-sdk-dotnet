...
namespace Microsoft.Graph.Beta.Models {
    public class CloudPcSupportedRegionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<CloudPcSupportedRegion> Value {
            get { return BackingStore?.Get<List<CloudPcSupportedRegion>>(nameof(Value)); }
