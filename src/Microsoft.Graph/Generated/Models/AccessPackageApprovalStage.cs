...
#nullable enable
        ...
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.SubjectSet>?>("escalationApprovers"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.SubjectSet>? FallbackEscalationApprovers
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.SubjectSet>?>("fallbackEscalationApprovers"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.SubjectSet>? FallbackPrimaryApprovers
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.SubjectSet>?>("fallbackPrimaryApprovers"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.SubjectSet>? PrimaryApprovers
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.SubjectSet>?>("primaryApprovers"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Models.AccessPackageApprovalStage"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Models.AccessPackageApprovalStage"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Microsoft.Graph.Beta.Models.AccessPackageApprovalStage CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.AccessPackageApprovalStage();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "fallbackEscalationApprovers", n => { FallbackEscalationApprovers = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.SubjectSet>(global::Microsoft.Graph.Beta.Models.SubjectSet.CreateFromDiscriminatorValue)?.AsList(); } },
                { "fallbackPrimaryApprovers", n => { FallbackPrimaryApprovers = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.SubjectSet>(global::Microsoft.Graph.Beta.Models.SubjectSet.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "primaryApprovers", n => { PrimaryApprovers = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.SubjectSet>(global::Microsoft.Graph.Beta.Models.SubjectSet.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.SubjectSet>("fallbackEscalationApprovers", FallbackEscalationApprovers);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.SubjectSet>("fallbackPrimaryApprovers", FallbackPrimaryApprovers);
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.SubjectSet>("primaryApprovers", PrimaryApprovers);
