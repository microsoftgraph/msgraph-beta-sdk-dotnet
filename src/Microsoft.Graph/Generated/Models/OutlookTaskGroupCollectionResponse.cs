...
namespace Microsoft.Graph.Beta.Models {
    public class OutlookTaskGroupCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<OutlookTaskGroup> Value {
            get { return BackingStore?.Get<List<OutlookTaskGroup>>(nameof(Value)); }
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"value", n => { Value = n.GetCollectionOfObjectValues<OutlookTaskGroup>(OutlookTaskGroup.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
