...
namespace Microsoft.Graph.Beta.Models {
    public class ConditionalAccessPolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ConditionalAccessPolicy> Value {
            get { return BackingStore?.Get<List<ConditionalAccessPolicy>>(nameof(Value)); }
