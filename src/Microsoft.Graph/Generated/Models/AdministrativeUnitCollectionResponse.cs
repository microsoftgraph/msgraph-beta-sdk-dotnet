...
namespace Microsoft.Graph.Beta.Models {
    public class AdministrativeUnitCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AdministrativeUnit> Value {
            get { return BackingStore?.Get<List<AdministrativeUnit>>(nameof(Value)); }
