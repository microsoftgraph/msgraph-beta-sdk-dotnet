...
namespace Microsoft.Graph.Beta.Models {
    public class SideLoadingKeyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<SideLoadingKey> Value {
            get { return BackingStore?.Get<List<SideLoadingKey>>(nameof(Value)); }
