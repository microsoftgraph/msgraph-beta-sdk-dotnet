    ...
    public class SubjectRightsRequest : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"dataSubject", (o,n) => { (o as SubjectRightsRequest).DataSubject = n.GetObjectValue<Microsoft.Graph.Beta.Models.DataSubject>(Microsoft.Graph.Beta.Models.DataSubject.CreateFromDiscriminatorValue); } },
                ...
                {"team", (o,n) => { (o as SubjectRightsRequest).Team = n.GetObjectValue<Microsoft.Graph.Beta.Models.Team>(Microsoft.Graph.Beta.Models.Team.CreateFromDiscriminatorValue); } },
