...
namespace Microsoft.Graph.Beta.Models {
    public class ManagedEBookCategoryCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ManagedEBookCategory> Value {
            get { return BackingStore?.Get<List<ManagedEBookCategory>>(nameof(Value)); }
