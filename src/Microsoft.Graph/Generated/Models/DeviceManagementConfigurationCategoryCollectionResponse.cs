...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceManagementConfigurationCategoryCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceManagementConfigurationCategory> Value {
            get { return BackingStore?.Get<List<DeviceManagementConfigurationCategory>>(nameof(Value)); }
