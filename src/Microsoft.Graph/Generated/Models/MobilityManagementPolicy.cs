...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.Group>? IncludedGroups
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.Group>?>("includedGroups"); }
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "appliesTo", n => { AppliesTo = n.GetEnumValue<global::Microsoft.Graph.Beta.Models.PolicyScope>(); } },
                { "complianceUrl", n => { ComplianceUrl = n.GetStringValue(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "discoveryUrl", n => { DiscoveryUrl = n.GetStringValue(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "includedGroups", n => { IncludedGroups = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.Group>(global::Microsoft.Graph.Beta.Models.Group.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.Group>("includedGroups", IncludedGroups);
