...
namespace Microsoft.Graph.Beta.Models {
    public class IntuneBrandingProfileAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<IntuneBrandingProfileAssignment> Value {
            get { return BackingStore?.Get<List<IntuneBrandingProfileAssignment>>(nameof(Value)); }
