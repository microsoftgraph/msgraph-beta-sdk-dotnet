...
namespace Microsoft.Graph.Beta.Models {
    public class WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatusCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatus> Value {
            get { return BackingStore?.Get<List<WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatus>>(nameof(Value)); }
