...
namespace Microsoft.Graph.Beta.Models {
    public class TimeCardCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TimeCard> Value {
            get { return BackingStore?.Get<List<TimeCard>>(nameof(Value)); }
