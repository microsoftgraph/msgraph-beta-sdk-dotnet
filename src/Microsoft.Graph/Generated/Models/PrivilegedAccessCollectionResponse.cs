...
namespace Microsoft.Graph.Beta.Models {
    public class PrivilegedAccessCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<PrivilegedAccess> Value {
            get { return BackingStore?.Get<List<PrivilegedAccess>>(nameof(Value)); }
