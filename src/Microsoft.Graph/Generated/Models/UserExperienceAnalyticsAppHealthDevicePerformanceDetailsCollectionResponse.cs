...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsAppHealthDevicePerformanceDetails> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsAppHealthDevicePerformanceDetails>>(nameof(Value)); }
