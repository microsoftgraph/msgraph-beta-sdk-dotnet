...
namespace Microsoft.Graph.Beta.Models {
    public class UserConfigurationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserConfiguration> Value {
            get { return BackingStore?.Get<List<UserConfiguration>>(nameof(Value)); }
