...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class SecurityBaselineState : global::Microsoft.Graph.Beta.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.SecurityBaselineSettingState>? SettingStates
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.SecurityBaselineSettingState>?>("settingStates"); }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Models.SecurityBaselineState"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.Beta.Models.SecurityBaselineState CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.SecurityBaselineState();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "settingStates", n => { SettingStates = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.SecurityBaselineSettingState>(global::Microsoft.Graph.Beta.Models.SecurityBaselineSettingState.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.SecurityBaselineSettingState>("settingStates", SettingStates);
