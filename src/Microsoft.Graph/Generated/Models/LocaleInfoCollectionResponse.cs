...
namespace Microsoft.Graph.Beta.Models {
    public class LocaleInfoCollectionResponse : BaseCollectionPaginationCountResponse, IParsable {
...
#nullable restore
        ...
        public static new LocaleInfoCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new LocaleInfoCollectionResponse();
        }
        /// <summary>
