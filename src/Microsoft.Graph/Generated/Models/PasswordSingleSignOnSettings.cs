...
namespace Microsoft.Graph.Beta.Models {
    public class PasswordSingleSignOnSettings : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<PasswordSingleSignOnField> Fields {
            get { return BackingStore?.Get<List<PasswordSingleSignOnField>>(nameof(Fields)); }
