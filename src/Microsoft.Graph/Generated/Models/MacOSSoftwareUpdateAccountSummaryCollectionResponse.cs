...
namespace Microsoft.Graph.Beta.Models {
    public class MacOSSoftwareUpdateAccountSummaryCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<MacOSSoftwareUpdateAccountSummary> Value {
            get { return BackingStore?.Get<List<MacOSSoftwareUpdateAccountSummary>>(nameof(Value)); }
