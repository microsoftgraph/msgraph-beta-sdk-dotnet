...
namespace Microsoft.Graph.Beta.Models {
    public class ActivityStatisticsCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ActivityStatistics> Value {
            get { return BackingStore?.Get<List<ActivityStatistics>>(nameof(Value)); }
