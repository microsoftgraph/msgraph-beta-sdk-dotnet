...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class SecureScore : global::Microsoft.Graph.Beta.Models.Entity, IParsable
...
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.AverageComparativeScore>? AverageComparativeScores
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.AverageComparativeScore>?>("averageComparativeScores"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.ControlScore>? ControlScores
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.ControlScore>?>("controlScores"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.SecureScore CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.SecureScore();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "averageComparativeScores", n => { AverageComparativeScores = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.AverageComparativeScore>(global::Microsoft.Graph.Beta.Models.AverageComparativeScore.CreateFromDiscriminatorValue)?.AsList(); } },
                { "azureTenantId", n => { AzureTenantId = n.GetStringValue(); } },
                { "controlScores", n => { ControlScores = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.ControlScore>(global::Microsoft.Graph.Beta.Models.ControlScore.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.AverageComparativeScore>("averageComparativeScores", AverageComparativeScores);
            writer.WriteStringValue("azureTenantId", AzureTenantId);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.ControlScore>("controlScores", ControlScores);
