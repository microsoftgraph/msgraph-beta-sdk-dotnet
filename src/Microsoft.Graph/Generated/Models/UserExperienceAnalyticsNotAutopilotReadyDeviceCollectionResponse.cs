...
namespace Microsoft.Graph.Beta.Models {
    public class UserExperienceAnalyticsNotAutopilotReadyDeviceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserExperienceAnalyticsNotAutopilotReadyDevice> Value {
            get { return BackingStore?.Get<List<UserExperienceAnalyticsNotAutopilotReadyDevice>>(nameof(Value)); }
