...
namespace Microsoft.Graph.Beta.Models {
    public class WindowsInformationProtectionAppLearningSummaryCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<WindowsInformationProtectionAppLearningSummary> Value {
            get { return BackingStore?.Get<List<WindowsInformationProtectionAppLearningSummary>>(nameof(Value)); }
