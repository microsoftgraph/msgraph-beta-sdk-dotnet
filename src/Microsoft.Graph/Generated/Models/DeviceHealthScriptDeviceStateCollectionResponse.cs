...
namespace Microsoft.Graph.Beta.Models {
    public class DeviceHealthScriptDeviceStateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceHealthScriptDeviceState> Value {
            get { return BackingStore?.Get<List<DeviceHealthScriptDeviceState>>(nameof(Value)); }
