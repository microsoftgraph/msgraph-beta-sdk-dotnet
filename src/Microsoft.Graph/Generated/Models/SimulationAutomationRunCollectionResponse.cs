...
namespace Microsoft.Graph.Beta.Models {
    public class SimulationAutomationRunCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<SimulationAutomationRun> Value {
            get { return BackingStore?.Get<List<SimulationAutomationRun>>(nameof(Value)); }
