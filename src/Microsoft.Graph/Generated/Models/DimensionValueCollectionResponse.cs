...
namespace Microsoft.Graph.Beta.Models {
    public class DimensionValueCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DimensionValue> Value {
            get { return BackingStore?.Get<List<DimensionValue>>(nameof(Value)); }
