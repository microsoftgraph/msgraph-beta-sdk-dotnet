...
namespace Microsoft.Graph.Beta.Models {
    public class ManagedMobileAppCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ManagedMobileApp> Value {
            get { return BackingStore?.Get<List<ManagedMobileApp>>(nameof(Value)); }
