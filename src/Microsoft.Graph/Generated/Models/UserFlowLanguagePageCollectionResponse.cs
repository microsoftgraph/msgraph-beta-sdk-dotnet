...
namespace Microsoft.Graph.Beta.Models {
    public class UserFlowLanguagePageCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UserFlowLanguagePage> Value {
            get { return BackingStore?.Get<List<UserFlowLanguagePage>>(nameof(Value)); }
