...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.TermsAndConditionsAcceptanceStatus>? AcceptanceStatuses
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.TermsAndConditionsAcceptanceStatus>?>("acceptanceStatuses"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.TermsAndConditionsAssignment>? Assignments
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.TermsAndConditionsAssignment>?>("assignments"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Beta.Models.TermsAndConditionsGroupAssignment>? GroupAssignments
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Beta.Models.TermsAndConditionsGroupAssignment>?>("groupAssignments"); }
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "acceptanceStatuses", n => { AcceptanceStatuses = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.TermsAndConditionsAcceptanceStatus>(global::Microsoft.Graph.Beta.Models.TermsAndConditionsAcceptanceStatus.CreateFromDiscriminatorValue)?.AsList(); } },
                { "assignments", n => { Assignments = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.TermsAndConditionsAssignment>(global::Microsoft.Graph.Beta.Models.TermsAndConditionsAssignment.CreateFromDiscriminatorValue)?.AsList(); } },
                { "bodyText", n => { BodyText = n.GetStringValue(); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "groupAssignments", n => { GroupAssignments = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.TermsAndConditionsGroupAssignment>(global::Microsoft.Graph.Beta.Models.TermsAndConditionsGroupAssignment.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.TermsAndConditionsAssignment>("assignments", Assignments);
            writer.WriteStringValue("bodyText", BodyText);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteStringValue("description", Description);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Beta.Models.TermsAndConditionsGroupAssignment>("groupAssignments", GroupAssignments);
