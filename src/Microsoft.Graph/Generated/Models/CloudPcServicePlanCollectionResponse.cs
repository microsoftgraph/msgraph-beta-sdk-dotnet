...
namespace Microsoft.Graph.Beta.Models {
    public class CloudPcServicePlanCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<CloudPcServicePlan> Value {
            get { return BackingStore?.Get<List<CloudPcServicePlan>>(nameof(Value)); }
