...
namespace Microsoft.Graph.Beta.Models
{
    ...
    public partial class UserEventsSummary : global::Microsoft.Graph.Beta.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// <summary>The date and time (UTC) when the event occurred.  The DateTimeOffset type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.</summary>
        public DateTimeOffset? EventDateTime
        {
            get { return BackingStore?.Get<DateTimeOffset?>("eventDateTime"); }
            set { BackingStore?.Set("eventDateTime", value); }
        }
        /// <summary>The specific reason why the event failed (if it was not successful.)</summary>
...
#nullable restore
        ...
        /// <summary>Indicates whether the event was successful or not.</summary>
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Beta.Models.UserEventsSummary CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Beta.Models.UserEventsSummary();
        }
        /// <summary>
