...
namespace Microsoft.Graph.Beta.Models {
    public class BusinessFlowTemplateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<BusinessFlowTemplate> Value {
            get { return BackingStore?.Get<List<BusinessFlowTemplate>>(nameof(Value)); }
