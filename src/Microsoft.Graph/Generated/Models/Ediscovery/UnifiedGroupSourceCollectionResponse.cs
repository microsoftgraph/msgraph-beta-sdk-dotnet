...
namespace Microsoft.Graph.Beta.Models.Ediscovery {
    public class UnifiedGroupSourceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UnifiedGroupSource> Value {
            get { return BackingStore?.Get<List<UnifiedGroupSource>>(nameof(Value)); }
