...
namespace Microsoft.Graph.Beta.Models.Ediscovery {
    public class ReviewSetQueryCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ReviewSetQuery> Value {
            get { return BackingStore?.Get<List<ReviewSetQuery>>(nameof(Value)); }
