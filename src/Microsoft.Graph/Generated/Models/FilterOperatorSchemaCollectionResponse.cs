...
namespace Microsoft.Graph.Beta.Models {
    public class FilterOperatorSchemaCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<FilterOperatorSchema> Value {
            get { return BackingStore?.Get<List<FilterOperatorSchema>>(nameof(Value)); }
