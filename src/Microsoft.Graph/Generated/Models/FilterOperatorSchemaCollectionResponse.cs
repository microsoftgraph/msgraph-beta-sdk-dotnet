...
namespace Microsoft.Graph.Beta.Models {
    public class FilterOperatorSchemaCollectionResponse : BaseCollectionPaginationCountResponse, IParsable {
        ...
        public static new FilterOperatorSchemaCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
