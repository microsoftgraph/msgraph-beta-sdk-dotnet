using Microsoft.Graph.Beta.App.OnlineMeetings.Item.Recordings.Item.Content;
...
using System;
namespace Microsoft.Graph.Beta.App.OnlineMeetings.Item.Recordings.Item {
    /// <summary>
    ...
    public class CallRecordingItemRequestBuilder : BaseRequestBuilder {
        ...
        public CallRecordingItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/recordings/{callRecording%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CallRecordingItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CallRecordingItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/recordings/{callRecording%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CallRecordingItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CallRecordingItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CallRecording?> GetAsync(CancellationToken cancellationToken = default, Action<CallRecordingItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CallRecording> GetAsync(CancellationToken cancellationToken = default, Action<CallRecordingItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CallRecording?> PatchAsync(CallRecording body, CancellationToken cancellationToken = default, Action<CallRecordingItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CallRecording> PatchAsync(CallRecording body, CancellationToken cancellationToken = default, Action<CallRecordingItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
