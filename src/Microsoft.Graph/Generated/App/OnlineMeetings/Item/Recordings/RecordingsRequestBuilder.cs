using Microsoft.Graph.Beta.App.OnlineMeetings.Item.Recordings.Count;
using Microsoft.Graph.Beta.App.OnlineMeetings.Item.Recordings.Item;
...
using System;
namespace Microsoft.Graph.Beta.App.OnlineMeetings.Item.Recordings {
    /// <summary>
    ...
    public class RecordingsRequestBuilder : BaseRequestBuilder {
        ...
        public CallRecordingItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("callRecording%2Did", position);
        ...
        public RecordingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/recordings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RecordingsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecordingsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/recordings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
