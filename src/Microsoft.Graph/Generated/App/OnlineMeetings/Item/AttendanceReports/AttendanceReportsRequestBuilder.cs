...
using MicrosoftGraphSdk.App.OnlineMeetings.Item.AttendanceReports.Item;
...
namespace MicrosoftGraphSdk.App.OnlineMeetings.Item.AttendanceReports {
    /// <summary>Builds and executes requests for operations under \app\onlineMeetings\{onlineMeeting-id}\attendanceReports</summary>
    public class AttendanceReportsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.app.onlineMeetings.item.attendanceReports.item collection</summary>
        ...
        public AttendanceReportsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/app/onlineMeetings/{onlineMeeting_id}/attendanceReports{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
