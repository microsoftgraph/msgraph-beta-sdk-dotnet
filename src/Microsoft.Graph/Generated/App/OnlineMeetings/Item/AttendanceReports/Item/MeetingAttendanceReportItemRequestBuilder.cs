...
using MicrosoftGraphSdk.App.OnlineMeetings.Item.AttendanceReports.Item.AttendanceRecords;
...
namespace MicrosoftGraphSdk.App.OnlineMeetings.Item.AttendanceReports.Item {
    /// <summary>Builds and executes requests for operations under \app\onlineMeetings\{onlineMeeting-id}\attendanceReports\{meetingAttendanceReport-id}</summary>
    public class MeetingAttendanceReportItemRequestBuilder {
        ...
        public MeetingAttendanceReportItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/app/onlineMeetings/{onlineMeeting_id}/attendanceReports/{meetingAttendanceReport_id}{?select,expand}";
