...
namespace MicrosoftGraph.App.OnlineMeetings.Item.MeetingAttendanceReport.AttendanceRecords.Item {
    /// <summary>Builds and executes requests for operations under \app\onlineMeetings\{onlineMeeting-id}\meetingAttendanceReport\attendanceRecords\{attendanceRecord-id}</summary>
    public class AttendanceRecordRequestBuilder {
        ...
        public AttendanceRecordRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/app/onlineMeetings/{onlineMeeting_id}/meetingAttendanceReport/attendanceRecords/{attendanceRecord_id}{?select,expand}";
