...
using MicrosoftGraphSdk.App.OnlineMeetings.Item.MeetingAttendanceReport.AttendanceRecords.Item;
...
namespace MicrosoftGraphSdk.App.OnlineMeetings.Item.MeetingAttendanceReport.AttendanceRecords {
    /// <summary>Builds and executes requests for operations under \app\onlineMeetings\{onlineMeeting-id}\meetingAttendanceReport\attendanceRecords</summary>
    public class AttendanceRecordsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.app.onlineMeetings.item.meetingAttendanceReport.attendanceRecords.item collection</summary>
