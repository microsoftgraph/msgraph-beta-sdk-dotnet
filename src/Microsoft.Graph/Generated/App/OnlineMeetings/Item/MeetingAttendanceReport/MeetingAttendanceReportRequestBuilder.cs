...
using MicrosoftGraphSdk.App.OnlineMeetings.Item.MeetingAttendanceReport.AttendanceRecords;
...
namespace MicrosoftGraphSdk.App.OnlineMeetings.Item.MeetingAttendanceReport {
    /// <summary>Builds and executes requests for operations under \app\onlineMeetings\{onlineMeeting-id}\meetingAttendanceReport</summary>
    public class MeetingAttendanceReportRequestBuilder {
        ...
        public MeetingAttendanceReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/app/onlineMeetings/{onlineMeeting_id}/meetingAttendanceReport{?select,expand}";
        ...
        /// <summary>Get meetingAttendanceReport from app</summary>
