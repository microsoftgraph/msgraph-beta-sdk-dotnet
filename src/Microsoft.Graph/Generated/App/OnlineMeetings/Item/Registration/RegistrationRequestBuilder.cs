...
using Microsoft.Graph.Beta.App.OnlineMeetings.Item.Registration.Registrants;
...
namespace Microsoft.Graph.Beta.App.OnlineMeetings.Item.Registration {
    ...
    public class RegistrationRequestBuilder : BaseRequestBuilder {
        ...
        public RegistrationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/registration{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RegistrationRequestBuilder and sets the default values.
        /// </summary>
