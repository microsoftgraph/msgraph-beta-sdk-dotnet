...
namespace Microsoft.Graph.Beta.App.OnlineMeetings.Item.GetVirtualAppointmentJoinWebUrl {
    ...
    public class GetVirtualAppointmentJoinWebUrlRequestBuilder : BaseRequestBuilder {
        ...
        public GetVirtualAppointmentJoinWebUrlRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/getVirtualAppointmentJoinWebUrl()", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetVirtualAppointmentJoinWebUrlRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetVirtualAppointmentJoinWebUrlRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/getVirtualAppointmentJoinWebUrl()", rawUrl) {
        }
        /// <summary>
