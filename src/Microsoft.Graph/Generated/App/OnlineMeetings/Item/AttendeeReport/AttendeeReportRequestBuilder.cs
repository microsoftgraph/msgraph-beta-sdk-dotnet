...
namespace MicrosoftGraphSdk.App.OnlineMeetings.Item.AttendeeReport {
    /// <summary>Builds and executes requests for operations under \app\onlineMeetings\{onlineMeeting-id}\attendeeReport</summary>
    public class AttendeeReportRequestBuilder {
        ...
        public AttendeeReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/app/onlineMeetings/{onlineMeeting_id}/attendeeReport";
