...
namespace Microsoft.Graph.Beta.App.Calls.LogTeleconferenceDeviceQuality {
    ...
    public class LogTeleconferenceDeviceQualityRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(LogTeleconferenceDeviceQualityRequestBody body, Action<LogTeleconferenceDeviceQualityRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
