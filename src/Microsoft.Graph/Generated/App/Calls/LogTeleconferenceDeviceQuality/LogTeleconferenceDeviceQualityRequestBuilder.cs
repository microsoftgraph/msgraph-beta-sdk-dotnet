...
namespace Microsoft.Graph.Beta.App.Calls.LogTeleconferenceDeviceQuality {
    ...
    public class LogTeleconferenceDeviceQualityRequestBuilder {
        ...
        public LogTeleconferenceDeviceQualityRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/app/calls/microsoft.graph.logTeleconferenceDeviceQuality";
        ...
        /// </summary>
        public async Task PostAsync(LogTeleconferenceDeviceQualityPostRequestBody body, CancellationToken cancellationToken = default, Action<LogTeleconferenceDeviceQualityRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
