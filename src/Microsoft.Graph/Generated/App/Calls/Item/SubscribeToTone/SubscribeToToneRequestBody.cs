...
namespace MicrosoftGraphSdk.App.Calls.Item.SubscribeToTone {
    ...
    public class SubscribeToToneRequestBody : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static SubscribeToToneRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
