...
namespace Microsoft.Graph.Beta.App.Calls.Item.MicrosoftGraphReject {
    /// <summary>
    ...
    public class MicrosoftGraphRejectRequestBuilder {
        ...
        public MicrosoftGraphRejectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/app/calls/{call%2Did}/microsoft.graph.reject";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphRejectRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(RejectPostRequestBody body, Action<MicrosoftGraphRejectRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(RejectPostRequestBody body, Action<MicrosoftGraphRejectRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
