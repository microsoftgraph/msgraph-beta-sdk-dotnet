...
using MicrosoftGraph.App.Calls.Item.Participants.Item.Mute;
using MicrosoftGraph.App.Calls.Item.Participants.Item.StartHoldMusic;
using MicrosoftGraph.App.Calls.Item.Participants.Item.StopHoldMusic;
...
namespace MicrosoftGraph.App.Calls.Item.Participants.Item {
    /// <summary>Builds and executes requests for operations under \app\calls\{call-id}\participants\{participant-id}</summary>
    public class ParticipantRequestBuilder {
        ...
        public ParticipantRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/app/calls/{call_id}/participants/{participant_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Participant body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
