...
namespace Microsoft.Graph.Beta.App.Calls.Item.Participants.Item.MicrosoftGraphStartHoldMusic {
    /// <summary>
    ...
    public class MicrosoftGraphStartHoldMusicRequestBuilder {
        ...
        public MicrosoftGraphStartHoldMusicRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/app/calls/{call%2Did}/participants/{participant%2Did}/microsoft.graph.startHoldMusic";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphStartHoldMusicRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<StartHoldMusicOperation?> PostAsync(StartHoldMusicPostRequestBody body, Action<MicrosoftGraphStartHoldMusicRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<StartHoldMusicOperation> PostAsync(StartHoldMusicPostRequestBody body, Action<MicrosoftGraphStartHoldMusicRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
