...
using System;
namespace Microsoft.Graph.Beta.App.Calls.Item.Mute {
    /// <summary>
    ...
    public class MuteRequestBuilder : BaseRequestBuilder {
        ...
        public MuteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/mute", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MuteRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MuteRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/mute", rawUrl) {
        }
        /// <summary>
        /// Invoke action mute
        /// </summary>
