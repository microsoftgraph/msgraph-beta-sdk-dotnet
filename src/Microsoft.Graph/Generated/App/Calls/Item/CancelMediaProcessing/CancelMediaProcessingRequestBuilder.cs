...
#nullable enable
        public async Task<CancelMediaProcessingOperation?> PostAsync(CancelMediaProcessingPostRequestBody body, CancellationToken cancellationToken = default, Action<CancelMediaProcessingRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CancelMediaProcessingOperation> PostAsync(CancelMediaProcessingPostRequestBody body, CancellationToken cancellationToken = default, Action<CancelMediaProcessingRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
