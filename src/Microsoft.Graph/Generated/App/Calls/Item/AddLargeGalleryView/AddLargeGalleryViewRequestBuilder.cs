...
namespace Microsoft.Graph.Beta.App.Calls.Item.AddLargeGalleryView {
    ...
    public class AddLargeGalleryViewRequestBuilder {
        ...
        /// </summary>
        public async Task<AddLargeGalleryViewOperation> PostAsync(AddLargeGalleryViewPostRequestBody body, Action<AddLargeGalleryViewRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<AddLargeGalleryViewOperation>(requestInfo, AddLargeGalleryViewOperation.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
