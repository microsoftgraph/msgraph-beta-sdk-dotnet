...
namespace Microsoft.Graph.Beta.App.Calls.Item.AddLargeGalleryView {
    ...
    public class AddLargeGalleryViewRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AddLargeGalleryViewRequestBody body, Action<AddLargeGalleryViewRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<AddLargeGalleryViewOperation> PostAsync(AddLargeGalleryViewRequestBody body, Action<AddLargeGalleryViewRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
