...
namespace Microsoft.Graph.Beta.App.Calls.Item.UpdateRecordingStatus {
    ...
    public class UpdateRecordingStatusRequestBuilder {
        ...
        /// </summary>
        public async Task<UpdateRecordingStatusOperation> PostAsync(UpdateRecordingStatusPostRequestBody body, CancellationToken cancellationToken = default, Action<UpdateRecordingStatusRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<UpdateRecordingStatusOperation>(requestInfo, UpdateRecordingStatusOperation.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
