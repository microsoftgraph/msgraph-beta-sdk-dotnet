...
#nullable enable
        public async Task<UpdateRecordingStatusOperation?> PostAsync(UpdateRecordingStatusPostRequestBody body, CancellationToken cancellationToken = default, Action<UpdateRecordingStatusRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UpdateRecordingStatusOperation> PostAsync(UpdateRecordingStatusPostRequestBody body, CancellationToken cancellationToken = default, Action<UpdateRecordingStatusRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
