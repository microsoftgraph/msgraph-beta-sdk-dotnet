...
namespace Microsoft.Graph.Beta.App.Calls.Item.UpdateRecordingStatus {
    ...
    public class UpdateRecordingStatusRequestBuilder {
        ...
        /// </summary>
        public async Task<UpdateRecordingStatusOperation> PostAsync(UpdateRecordingStatusPostRequestBody body, Action<UpdateRecordingStatusRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
