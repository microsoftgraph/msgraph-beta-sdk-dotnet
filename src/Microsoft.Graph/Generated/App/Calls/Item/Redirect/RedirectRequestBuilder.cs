...
namespace Microsoft.Graph.Beta.App.Calls.Item.Redirect {
    ...
    public class RedirectRequestBuilder : BaseRequestBuilder {
        ...
        public RedirectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/redirect", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RedirectRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RedirectRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/redirect", rawUrl) {
        }
        /// <summary>
