using Microsoft.Graph.Beta.App.Calls.Item.ContentSharingSessions.Count;
using Microsoft.Graph.Beta.App.Calls.Item.ContentSharingSessions.Item;
...
namespace Microsoft.Graph.Beta.App.Calls.Item.ContentSharingSessions {
    ...
    public class ContentSharingSessionsRequestBuilder : BaseRequestBuilder {
        ...
        public ContentSharingSessionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/contentSharingSessions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ContentSharingSessionsRequestBuilder and sets the default values.
        /// </summary>
