...
namespace Microsoft.Graph.Beta.App.Calls.Item.ChangeScreenSharingRole {
    ...
    public class ChangeScreenSharingRoleRequestBuilder {
        ...
        public ChangeScreenSharingRoleRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/app/calls/{call%2Did}/microsoft.graph.changeScreenSharingRole";
        ...
        /// </summary>
        public async Task PostAsync(ChangeScreenSharingRolePostRequestBody body, CancellationToken cancellationToken = default, Action<ChangeScreenSharingRoleRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
