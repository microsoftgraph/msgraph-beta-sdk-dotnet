...
namespace Microsoft.Graph.Beta.App.Calls.Item.ChangeScreenSharingRole {
    ...
    public class ChangeScreenSharingRoleRequestBuilder : BaseRequestBuilder {
        ...
        public ChangeScreenSharingRoleRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/changeScreenSharingRole", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ChangeScreenSharingRoleRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(ChangeScreenSharingRolePostRequestBody body, Action<ChangeScreenSharingRoleRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(ChangeScreenSharingRolePostRequestBody body, Action<ChangeScreenSharingRoleRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
