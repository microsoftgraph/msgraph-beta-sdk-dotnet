...
#nullable enable
        public async Task<RecordOperation?> PostAsync(RecordResponsePostRequestBody body, CancellationToken cancellationToken = default, Action<RecordResponseRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RecordOperation> PostAsync(RecordResponsePostRequestBody body, CancellationToken cancellationToken = default, Action<RecordResponseRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
