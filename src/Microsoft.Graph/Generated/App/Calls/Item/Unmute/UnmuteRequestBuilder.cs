...
namespace MicrosoftGraphSdk.App.Calls.Item.Unmute {
    /// <summary>Builds and executes requests for operations under \app\calls\{call-id}\microsoft.graph.unmute</summary>
