...
using MicrosoftGraph.App.Calls.Item.Answer;
using MicrosoftGraph.App.Calls.Item.AudioRoutingGroups;
using MicrosoftGraph.App.Calls.Item.CancelMediaProcessing;
using MicrosoftGraph.App.Calls.Item.ChangeScreenSharingRole;
using MicrosoftGraph.App.Calls.Item.KeepAlive;
using MicrosoftGraph.App.Calls.Item.Mute;
using MicrosoftGraph.App.Calls.Item.Operations;
using MicrosoftGraph.App.Calls.Item.Participants;
using MicrosoftGraph.App.Calls.Item.PlayPrompt;
using MicrosoftGraph.App.Calls.Item.Record;
using MicrosoftGraph.App.Calls.Item.RecordResponse;
using MicrosoftGraph.App.Calls.Item.Redirect;
using MicrosoftGraph.App.Calls.Item.Reject;
using MicrosoftGraph.App.Calls.Item.SubscribeToTone;
using MicrosoftGraph.App.Calls.Item.Transfer;
using MicrosoftGraph.App.Calls.Item.Unmute;
using MicrosoftGraph.App.Calls.Item.UpdateRecordingStatus;
...
namespace MicrosoftGraph.App.Calls.Item {
