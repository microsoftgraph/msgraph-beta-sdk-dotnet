...
namespace Microsoft.Graph.Beta.App.Calls.Item.Reject {
    ...
    public class RejectRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(RejectPostRequestBody body, CancellationToken cancellationToken = default, Action<RejectRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
