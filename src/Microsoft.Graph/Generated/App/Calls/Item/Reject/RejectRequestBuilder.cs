...
namespace Microsoft.Graph.Beta.App.Calls.Item.Reject {
    ...
    public class RejectRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(RejectPostRequestBody body, Action<RejectRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
