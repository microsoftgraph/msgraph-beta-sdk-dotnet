...
namespace Microsoft.Graph.Beta.App.Calls.Item.PlayPrompt {
    ...
    public class PlayPromptRequestBuilder : BaseRequestBuilder {
        ...
        public PlayPromptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/playPrompt", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PlayPromptRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PlayPromptRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/playPrompt", rawUrl) {
        }
        /// <summary>
