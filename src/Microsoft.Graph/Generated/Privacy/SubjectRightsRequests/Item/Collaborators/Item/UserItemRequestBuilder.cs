...
namespace Microsoft.Graph.Beta.Privacy.SubjectRightsRequests.Item.Collaborators.Item {
    /// <summary>
    ...
    public class UserItemRequestBuilder {
        ...
        public UserItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/privacy/subjectRightsRequests/{subjectRightsRequest%2Did}/collaborators/{user%2Did}{?%24select,%24expand}";
