...
using MicrosoftGraph.Privacy.SubjectRightsRequests.Item.GetFinalAttachment;
using MicrosoftGraph.Privacy.SubjectRightsRequests.Item.GetFinalReport;
using MicrosoftGraph.Privacy.SubjectRightsRequests.Item.Notes;
using MicrosoftGraph.Privacy.SubjectRightsRequests.Item.Team;
using System;
...
namespace MicrosoftGraph.Privacy.SubjectRightsRequests.Item {
    ...
    public class SubjectRightsRequestRequestBuilder {
        ...
        public async Task<SubjectRightsRequest> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<SubjectRightsRequest>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
