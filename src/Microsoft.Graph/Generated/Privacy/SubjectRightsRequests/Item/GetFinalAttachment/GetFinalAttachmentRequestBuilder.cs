...
namespace MicrosoftGraphSdk.Privacy.SubjectRightsRequests.Item.GetFinalAttachment {
    ...
    public class GetFinalAttachmentRequestBuilder {
        ...
        /// </summary>
        public async Task<GetFinalAttachmentResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
