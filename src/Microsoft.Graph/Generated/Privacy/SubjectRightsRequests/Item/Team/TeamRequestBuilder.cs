...
namespace Microsoft.Graph.Beta.Privacy.SubjectRightsRequests.Item.Team {
    ...
    public class TeamRequestBuilder {
        ...
        public TeamRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/privacy/subjectRightsRequests/{subjectRightsRequest%2Did}/team{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Team> GetAsync(CancellationToken cancellationToken = default, Action<TeamRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
