...
namespace Microsoft.Graph.Beta.Privacy.SubjectRightsRequests {
    ...
    public class SubjectRightsRequestsRequestBuilder {
        ...
        /// </summary>
        public async Task<SubjectRightsRequestCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SubjectRightsRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SubjectRightsRequest> PostAsync(SubjectRightsRequest body, CancellationToken cancellationToken = default, Action<SubjectRightsRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
