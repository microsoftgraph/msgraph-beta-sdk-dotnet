...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Privacy?> GetAsync(CancellationToken cancellationToken = default, Action<PrivacyRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Privacy> GetAsync(CancellationToken cancellationToken = default, Action<PrivacyRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Privacy?> PatchAsync(Microsoft.Graph.Beta.Models.Privacy body, CancellationToken cancellationToken = default, Action<PrivacyRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Privacy> PatchAsync(Microsoft.Graph.Beta.Models.Privacy body, CancellationToken cancellationToken = default, Action<PrivacyRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
