...
namespace Microsoft.Graph.Beta.GovernanceResources.Item.Parent {
    ...
    public class ParentRequestBuilder {
        ...
        public ParentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/governanceResources/{governanceResource%2Did}/parent{?%24select,%24expand}";
