...
namespace Microsoft.Graph.Beta.GovernanceResources.Item.RoleAssignments.Item.RoleDefinition.RoleSetting {
    ...
    public class RoleSettingRequestBuilder {
        ...
        public RoleSettingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/governanceResources/{governanceResource%2Did}/roleAssignments/{governanceRoleAssignment%2Did}/roleDefinition/roleSetting{?%24select,%24expand}";
