...
#nullable enable
        public async Task<GovernanceRoleAssignment?> GetAsync(CancellationToken cancellationToken = default, Action<LinkedEligibleRoleAssignmentRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GovernanceRoleAssignment> GetAsync(CancellationToken cancellationToken = default, Action<LinkedEligibleRoleAssignmentRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
