...
namespace Microsoft.Graph.Beta.GovernanceResources.Item.RoleAssignmentRequests.Item.RoleDefinition {
    ...
    public class RoleDefinitionRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(GovernanceRoleDefinition body, Action<RoleDefinitionRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
