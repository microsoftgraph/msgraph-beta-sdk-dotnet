using Microsoft.Graph.Beta.GovernanceResources.Item.RoleAssignmentRequests.Item.MicrosoftGraphCancel;
using Microsoft.Graph.Beta.GovernanceResources.Item.RoleAssignmentRequests.Item.MicrosoftGraphUpdateRequest;
...
namespace Microsoft.Graph.Beta.GovernanceResources.Item.RoleAssignmentRequests.Item {
    ...
    public class GovernanceRoleAssignmentRequestItemRequestBuilder {
        ...
        public GovernanceRoleAssignmentRequestItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/governanceResources/{governanceResource%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}{?%24select,%24expand}";
