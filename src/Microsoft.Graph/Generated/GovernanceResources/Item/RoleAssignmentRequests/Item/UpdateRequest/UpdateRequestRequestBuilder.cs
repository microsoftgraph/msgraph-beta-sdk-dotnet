...
#nullable enable
        public async Task<GovernanceRoleAssignmentRequest?> PostAsync(UpdateRequestPostRequestBody body, CancellationToken cancellationToken = default, Action<UpdateRequestRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GovernanceRoleAssignmentRequest> PostAsync(UpdateRequestPostRequestBody body, CancellationToken cancellationToken = default, Action<UpdateRequestRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
