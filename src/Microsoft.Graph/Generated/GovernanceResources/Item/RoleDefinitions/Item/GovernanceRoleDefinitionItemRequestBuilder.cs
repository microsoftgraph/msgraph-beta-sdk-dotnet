using Microsoft.Graph.Beta.GovernanceResources.Item.RoleDefinitions.Item.Resource;
using Microsoft.Graph.Beta.GovernanceResources.Item.RoleDefinitions.Item.RoleSetting;
...
namespace Microsoft.Graph.Beta.GovernanceResources.Item.RoleDefinitions.Item {
    /// <summary>
    ...
    public class GovernanceRoleDefinitionItemRequestBuilder : BaseRequestBuilder {
        ...
        public GovernanceRoleDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/governanceResources/{governanceResource%2Did}/roleDefinitions/{governanceRoleDefinition%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GovernanceRoleDefinitionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GovernanceRoleDefinitionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/governanceResources/{governanceResource%2Did}/roleDefinitions/{governanceRoleDefinition%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
