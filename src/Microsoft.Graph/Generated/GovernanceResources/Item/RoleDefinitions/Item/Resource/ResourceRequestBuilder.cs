...
namespace MicrosoftGraphSdk.GovernanceResources.Item.RoleDefinitions.Item.Resource {
    ...
    public class ResourceRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/governanceResources/{governanceResource_id}/roleDefinitions/{governanceRoleDefinition_id}/resource{?select,expand}";
