using Microsoft.Graph.Beta.GovernanceResources.Item.RoleSettings.Item.Resource;
using Microsoft.Graph.Beta.GovernanceResources.Item.RoleSettings.Item.RoleDefinition;
...
using System;
namespace Microsoft.Graph.Beta.GovernanceResources.Item.RoleSettings.Item {
    /// <summary>
    ...
    public class GovernanceRoleSettingItemRequestBuilder : BaseRequestBuilder {
        ...
        public GovernanceRoleSettingItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/governanceResources/{governanceResource%2Did}/roleSettings/{governanceRoleSetting%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GovernanceRoleSettingItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GovernanceRoleSettingItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/governanceResources/{governanceResource%2Did}/roleSettings/{governanceRoleSetting%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
