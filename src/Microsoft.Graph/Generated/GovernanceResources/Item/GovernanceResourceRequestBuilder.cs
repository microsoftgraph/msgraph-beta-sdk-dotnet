...
using MicrosoftGraph.GovernanceResources.Item.Parent;
using MicrosoftGraph.GovernanceResources.Item.RoleAssignmentRequests;
using MicrosoftGraph.GovernanceResources.Item.RoleAssignments;
using MicrosoftGraph.GovernanceResources.Item.RoleDefinitions;
using MicrosoftGraph.GovernanceResources.Item.RoleSettings;
...
namespace MicrosoftGraph.GovernanceResources.Item {
    /// <summary>Builds and executes requests for operations under \governanceResources\{governanceResource-id}</summary>
    public class GovernanceResourceRequestBuilder {
        ...
        /// </summary>
        public GovernanceResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/governanceResources/{governanceResource_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public GovernanceResourceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(GovernanceResource body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <summary>Get entity from governanceResources by key</summary>
