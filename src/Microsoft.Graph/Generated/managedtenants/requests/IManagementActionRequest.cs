...
namespace Microsoft.Graph.ManagedTenants
{
    ...
    public partial interface IManagementActionRequest : Microsoft.Graph.IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ManagementAction> CreateAsync(ManagementAction managementActionToCreate);        /// <summary>
        /// Creates the specified ManagementAction using POST.
        /// </summary>
        /// <param name="managementActionToCreate">The ManagementAction to create.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The created ManagementAction.</returns>
        System.Threading.Tasks.Task<ManagementAction> CreateAsync(ManagementAction managementActionToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<ManagementAction> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The ManagementAction.</returns>
        System.Threading.Tasks.Task<ManagementAction> GetAsync(CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<ManagementAction> UpdateAsync(ManagementAction managementActionToUpdate);
        ...
        /// <returns>The updated ManagementAction.</returns>
        System.Threading.Tasks.Task<ManagementAction> UpdateAsync(ManagementAction managementActionToUpdate, CancellationToken cancellationToken);
