...
namespace Microsoft.Graph.ManagedTenants
{
    ...
    public partial class WindowsProtectionStateRequest : Microsoft.Graph.BaseRequest, IWindowsProtectionStateRequest
    {
        ...
        public async System.Threading.Tasks.Task<WindowsProtectionState> UpdateAsync(WindowsProtectionState windowsProtectionStateToUpdate, CancellationToken cancellationToken)
        {
			...
			{
				if (windowsProtectionStateToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.ResponseHeaders) ||
					windowsProtectionStateToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.StatusCode))
				{
					throw new Microsoft.Graph.ClientException(
						new Microsoft.Graph.Error
						{
							Code = Microsoft.Graph.GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(Microsoft.Graph.GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, windowsProtectionStateToUpdate.GetType().Name)
						});
				}
			}
            if (windowsProtectionStateToUpdate.AdditionalData != null)
