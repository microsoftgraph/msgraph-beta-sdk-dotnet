...
namespace Microsoft.Graph.ManagedTenants
{
    ...
    public partial class WindowsProtectionStateRequest : Microsoft.Graph.BaseRequest, IWindowsProtectionStateRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<WindowsProtectionState> PutAsync(WindowsProtectionState windowsProtectionStateToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<WindowsProtectionState>> PutResponseAsync(WindowsProtectionState windowsProtectionStateToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<WindowsProtectionState>(windowsProtectionStateToUpdate, cancellationToken);
