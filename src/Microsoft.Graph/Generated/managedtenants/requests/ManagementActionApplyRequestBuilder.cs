...
namespace Microsoft.Graph.ManagedTenants
{
    ...
    /// <summary>
    /// The type ManagementActionApplyRequestBuilder.
    /// </summary>
    public partial class ManagementActionApplyRequestBuilder : Microsoft.Graph.BaseActionMethodRequestBuilder<IManagementActionApplyRequest>, IManagementActionApplyRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="ManagementActionApplyRequestBuilder"/>.
        /// </summary>
        ...
        protected override IManagementActionApplyRequest CreateRequest(string functionUrl, IEnumerable<Microsoft.Graph.Option> options)
        {
            var request = new ManagementActionApplyRequest(functionUrl, this.Client, options);
