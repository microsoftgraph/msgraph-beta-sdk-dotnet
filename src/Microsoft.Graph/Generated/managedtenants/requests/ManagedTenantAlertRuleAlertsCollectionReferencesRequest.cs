...
namespace Microsoft.Graph.ManagedTenants
{
    ...
    /// <summary>
    /// The type ManagedTenantAlertRuleAlertsCollectionReferencesRequest.
    /// </summary>
    public partial class ManagedTenantAlertRuleAlertsCollectionReferencesRequest : Microsoft.Graph.BaseRequest, IManagedTenantAlertRuleAlertsCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new ManagedTenantAlertRuleAlertsCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ManagedTenantAlertRuleAlertsCollectionReferencesRequest(
            string requestUrl,
