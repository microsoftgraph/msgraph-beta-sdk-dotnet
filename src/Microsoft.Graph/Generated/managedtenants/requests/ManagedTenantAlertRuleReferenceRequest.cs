...
namespace Microsoft.Graph.ManagedTenants
{
    ...
    /// <summary>
    /// The type ManagedTenantAlertRuleReferenceRequest.
    /// </summary>
    public partial class ManagedTenantAlertRuleReferenceRequest : Microsoft.Graph.BaseRequest, IManagedTenantAlertRuleReferenceRequest
    {
        /// <summary>
        /// Constructs a new ManagedTenantAlertRuleReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ManagedTenantAlertRuleReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified ManagedTenantAlertRule reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified ManagedTenantAlertRule reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified ManagedTenantAlertRule reference.
        /// </summary>
        /// <param name="id">The ManagedTenantAlertRule reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified ManagedTenantAlertRule reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The ManagedTenantAlertRule reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
