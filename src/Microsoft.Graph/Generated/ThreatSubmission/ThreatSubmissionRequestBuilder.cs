...
namespace Microsoft.Graph.Beta.ThreatSubmission {
    ...
    public class ThreatSubmissionRequestBuilder : BaseRequestBuilder {
        ...
        public ThreatSubmissionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/threatSubmission{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ThreatSubmissionRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ThreatSubmissionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/threatSubmission{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
