...
namespace Microsoft.Graph.Beta.Teams.Item.PermissionGrants.Item.Restore {
    /// <summary>
    ...
    public class RestoreRequestBuilder {
        ...
        public RestoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/microsoft.graph.restore";
