...
namespace MicrosoftGraph.Teams.Item.PermissionGrants.Item {
    /// <summary>Builds and executes requests for operations under \teams\{team-id}\permissionGrants\{resourceSpecificPermissionGrant-id}</summary>
    public class ResourceSpecificPermissionGrantRequestBuilder {
        ...
        public ResourceSpecificPermissionGrantRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team_id}/permissionGrants/{resourceSpecificPermissionGrant_id}{?select,expand}";
