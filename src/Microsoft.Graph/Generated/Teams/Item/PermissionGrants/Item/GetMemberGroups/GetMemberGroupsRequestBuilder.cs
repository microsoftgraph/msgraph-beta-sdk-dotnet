...
namespace Microsoft.Graph.Beta.Teams.Item.PermissionGrants.Item.GetMemberGroups {
    ...
    public class GetMemberGroupsRequestBuilder : BaseRequestBuilder {
        ...
        public GetMemberGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/getMemberGroups", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetMemberGroupsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetMemberGroupsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/getMemberGroups", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<GetMemberGroupsResponse?> PostAsync(GetMemberGroupsPostRequestBody body, CancellationToken cancellationToken = default, Action<GetMemberGroupsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetMemberGroupsResponse> PostAsync(GetMemberGroupsPostRequestBody body, CancellationToken cancellationToken = default, Action<GetMemberGroupsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
