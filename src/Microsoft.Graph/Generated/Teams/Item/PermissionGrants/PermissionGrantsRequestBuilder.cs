...
using Microsoft.Graph.Beta.Teams.Item.PermissionGrants.GetByIds;
using Microsoft.Graph.Beta.Teams.Item.PermissionGrants.GetUserOwnedObjects;
using Microsoft.Graph.Beta.Teams.Item.PermissionGrants.Item;
using Microsoft.Graph.Beta.Teams.Item.PermissionGrants.ValidateProperties;
...
namespace Microsoft.Graph.Beta.Teams.Item.PermissionGrants {
    ...
    public class PermissionGrantsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.teams.item.permissionGrants.item collection</summary>
        ...
        public PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
