...
using MicrosoftGraph.Teams.Item.Channels.Item.Members.Add;
using MicrosoftGraph.Teams.Item.Channels.Item.Members.Item;
using System;
...
namespace MicrosoftGraph.Teams.Item.Channels.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.teams.item.channels.item.members.item collection</summary>
