...
namespace Microsoft.Graph.Beta.Teams.Item.Channels.Item.DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalName {
    ...
    public class DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameRequestBuilder {
        ...
        public DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/microsoft.graph.doesUserHaveAccess(userId='{userId}',tenantId='{tenantId}',userPrincipalName='{userPrincipalName}'){?userId,tenantId,userPrincipalName}";
        ...
        /// </summary>
        public async Task<DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameResponse> GetAsync(CancellationToken cancellationToken = default, Action<DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameResponse>(requestInfo, DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
