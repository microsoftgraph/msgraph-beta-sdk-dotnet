...
namespace Microsoft.Graph.Beta.Teams.Item.Channels.Item.MicrosoftGraphProvisionEmail {
    /// <summary>
    ...
    public class MicrosoftGraphProvisionEmailRequestBuilder {
        ...
        public MicrosoftGraphProvisionEmailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/microsoft.graph.provisionEmail";
