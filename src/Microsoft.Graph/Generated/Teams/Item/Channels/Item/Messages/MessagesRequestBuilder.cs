...
using MicrosoftGraph.Teams.Item.Channels.Item.Messages.Delta;
using MicrosoftGraph.Teams.Item.Channels.Item.Messages.Item;
using System;
...
namespace MicrosoftGraph.Teams.Item.Channels.Item.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.teams.item.channels.item.messages.item collection</summary>
