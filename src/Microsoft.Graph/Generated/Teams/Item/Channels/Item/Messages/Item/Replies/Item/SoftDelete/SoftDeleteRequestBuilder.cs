...
namespace Microsoft.Graph.Beta.Teams.Item.Channels.Item.Messages.Item.Replies.Item.SoftDelete {
    ...
    public class SoftDeleteRequestBuilder {
        ...
        public SoftDeleteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team_id}/channels/{channel_id}/messages/{chatMessage_id}/replies/{chatMessage_id1}/microsoft.graph.softDelete";
