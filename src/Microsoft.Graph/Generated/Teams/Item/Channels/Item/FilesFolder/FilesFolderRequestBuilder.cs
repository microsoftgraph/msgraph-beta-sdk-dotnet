...
namespace Microsoft.Graph.Beta.Teams.Item.Channels.Item.FilesFolder {
    ...
    public class FilesFolderRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.DriveItem> GetAsync(CancellationToken cancellationToken = default, Action<FilesFolderRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
