...
namespace Microsoft.Graph.Beta.Teams.Item.Channels.Item.FilesFolder {
    ...
    public class FilesFolderRequestBuilder {
        ...
        public FilesFolderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/filesFolder{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.DriveItem> GetAsync(Action<FilesFolderRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
