...
using MicrosoftGraph.Teams.Item.Channels.Item.Tabs.Item;
using System;
...
namespace MicrosoftGraph.Teams.Item.Channels.Item.Tabs {
    ...
    public class TabsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.teams.item.channels.item.tabs.item collection</summary>
