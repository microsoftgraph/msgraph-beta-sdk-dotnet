...
namespace MicrosoftGraphSdk.Teams.Item.Channels.GetAllMessages {
    ...
    public class GetAllMessagesResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetAllMessagesResponse).Value = n.GetCollectionOfObjectValues<ChatMessage>(ChatMessage.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
