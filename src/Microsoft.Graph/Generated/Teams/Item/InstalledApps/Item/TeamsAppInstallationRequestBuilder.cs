...
using MicrosoftGraph.Teams.Item.InstalledApps.Item.TeamsApp;
using MicrosoftGraph.Teams.Item.InstalledApps.Item.TeamsAppDefinition;
using MicrosoftGraph.Teams.Item.InstalledApps.Item.Upgrade;
using System;
...
namespace MicrosoftGraph.Teams.Item.InstalledApps.Item {
    ...
    public class TeamsAppInstallationRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public TeamsAppInstallationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
