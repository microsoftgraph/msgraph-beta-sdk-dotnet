...
namespace Microsoft.Graph.Beta.Teams.Item.Schedule.TimeCards.Item.EndBreak
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Teams.Item.Schedule.TimeCards.Item.EndBreak.EndBreakRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.TimeCard?> PostAsync(Microsoft.Graph.Beta.Teams.Item.Schedule.TimeCards.Item.EndBreak.EndBreakPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.TimeCard> PostAsync(Microsoft.Graph.Beta.Teams.Item.Schedule.TimeCards.Item.EndBreak.EndBreakPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Teams.Item.Schedule.TimeCards.Item.EndBreak.EndBreakPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Teams.Item.Schedule.TimeCards.Item.EndBreak.EndBreakPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Teams.Item.Schedule.TimeCards.Item.EndBreak.EndBreakRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Teams.Item.Schedule.TimeCards.Item.EndBreak.EndBreakRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Teams.Item.Schedule.TimeCards.Item.EndBreak.EndBreakRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
