...
namespace MicrosoftGraph.Teams.Item.Schedule.TimeCards.Item.EndBreak {
    /// <summary>Builds and executes requests for operations under \teams\{team-id}\schedule\timeCards\{timeCard-id}\microsoft.graph.endBreak</summary>
    public class EndBreakRequestBuilder {
        ...
        public EndBreakRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team_id}/schedule/timeCards/{timeCard_id}/microsoft.graph.endBreak";
