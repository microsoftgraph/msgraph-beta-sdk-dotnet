...
namespace Microsoft.Graph.Beta.Teams.Item.Schedule.SchedulingGroups {
    ...
    public class SchedulingGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.teams.item.schedule.schedulingGroups.item collection</summary>
        ...
        public SchedulingGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/schedule/schedulingGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
