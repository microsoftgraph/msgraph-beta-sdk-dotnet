...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SchedulingGroupItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SchedulingGroupItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SchedulingGroup?> GetAsync(CancellationToken cancellationToken = default, Action<SchedulingGroupItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SchedulingGroup> GetAsync(CancellationToken cancellationToken = default, Action<SchedulingGroupItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SchedulingGroup?> PatchAsync(SchedulingGroup body, CancellationToken cancellationToken = default, Action<SchedulingGroupItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SchedulingGroup> PatchAsync(SchedulingGroup body, CancellationToken cancellationToken = default, Action<SchedulingGroupItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
