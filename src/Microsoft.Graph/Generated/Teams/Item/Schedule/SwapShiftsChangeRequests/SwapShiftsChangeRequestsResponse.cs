...
namespace MicrosoftGraphSdk.Teams.Item.Schedule.SwapShiftsChangeRequests {
    public class SwapShiftsChangeRequestsResponse : IParsable {
        ...
        /// </summary>
        public static SwapShiftsChangeRequestsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SwapShiftsChangeRequestsResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as SwapShiftsChangeRequestsResponse).Value = n.GetCollectionOfObjectValues<SwapShiftsChangeRequest>(SwapShiftsChangeRequest.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
