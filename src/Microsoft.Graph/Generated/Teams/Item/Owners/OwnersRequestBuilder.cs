...
using MicrosoftGraphSdk.Teams.Item.Owners.Count;
using MicrosoftGraphSdk.Teams.Item.Owners.Item;
using System;
...
namespace MicrosoftGraphSdk.Teams.Item.Owners {
    ...
    public class OwnersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.teams.item.owners.item collection</summary>
