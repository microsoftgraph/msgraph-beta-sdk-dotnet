...
using MicrosoftGraph.Teams.Item.Owners.Ref;
using System;
...
namespace MicrosoftGraph.Teams.Item.Owners {
    /// <summary>Builds and executes requests for operations under \teams\{team-id}\owners</summary>
