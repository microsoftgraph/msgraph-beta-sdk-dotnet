...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Teams.Item.PrimaryChannel.Messages {
    public class MessagesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as MessagesResponse).Value = n.GetCollectionOfObjectValues<ChatMessage>(ChatMessage.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
