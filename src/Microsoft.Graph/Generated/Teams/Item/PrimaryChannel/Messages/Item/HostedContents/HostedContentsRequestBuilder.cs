...
using MicrosoftGraph.Teams.Item.PrimaryChannel.Messages.Item.HostedContents.Item;
using System;
...
namespace MicrosoftGraph.Teams.Item.PrimaryChannel.Messages.Item.HostedContents {
    ...
    public class HostedContentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.teams.item.primaryChannel.messages.item.hostedContents.item collection</summary>
