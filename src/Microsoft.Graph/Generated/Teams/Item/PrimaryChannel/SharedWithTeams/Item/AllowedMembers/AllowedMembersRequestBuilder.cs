...
using MicrosoftGraphSdk.Teams.Item.PrimaryChannel.SharedWithTeams.Item.AllowedMembers.Count;
using MicrosoftGraphSdk.Teams.Item.PrimaryChannel.SharedWithTeams.Item.AllowedMembers.Item;
using System;
...
namespace MicrosoftGraphSdk.Teams.Item.PrimaryChannel.SharedWithTeams.Item.AllowedMembers {
    ...
    public class AllowedMembersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.teams.item.primaryChannel.sharedWithTeams.item.allowedMembers.item collection</summary>
        ...
        public AllowedMembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team_id}/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo_id}/allowedMembers{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
