...
using MicrosoftGraph.Teams.Item.PrimaryChannel.Members.Add;
using MicrosoftGraph.Teams.Item.PrimaryChannel.Members.Item;
using System;
...
namespace MicrosoftGraph.Teams.Item.PrimaryChannel.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.teams.item.primaryChannel.members.item collection</summary>
