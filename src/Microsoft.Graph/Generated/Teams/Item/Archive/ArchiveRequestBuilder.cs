...
namespace Microsoft.Graph.Beta.Teams.Item.Archive {
    ...
    public class ArchiveRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ArchiveRequestBody body, Action<ArchiveRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
