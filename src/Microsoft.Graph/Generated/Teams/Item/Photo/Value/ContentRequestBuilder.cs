...
namespace Microsoft.Graph.Beta.Teams.Item.Photo.Value {
    ...
    public class ContentRequestBuilder : BaseRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/photo/$value{?%24format*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="ContentRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContentRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/photo/$value{?%24format*}", rawUrl) {
        }
        /// <summary>
...
#endif
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.PUT, "{+baseurl}/teams/{team%2Did}/photo/$value", PathParameters);
            requestInfo.Configure(requestConfiguration);
