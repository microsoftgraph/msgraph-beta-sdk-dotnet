...
using Microsoft.Graph.Beta.Workbooks.Count;
using Microsoft.Graph.Beta.Workbooks.Item;
...
namespace Microsoft.Graph.Beta.Workbooks {
    ...
    public class WorkbooksRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.workbooks.item collection</summary>
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Microsoft.Graph.Beta.Models.DriveItem body, Action<WorkbooksRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.DriveItem> PostAsync(Microsoft.Graph.Beta.Models.DriveItem body, Action<WorkbooksRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
