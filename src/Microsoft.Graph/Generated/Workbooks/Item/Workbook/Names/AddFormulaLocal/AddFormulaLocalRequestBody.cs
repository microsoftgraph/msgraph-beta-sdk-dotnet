...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.AddFormulaLocal {
    public class AddFormulaLocalRequestBody : IParsable {
        ...
        /// </summary>
        public static AddFormulaLocalRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new AddFormulaLocalRequestBody();
        }
        /// <summary>
