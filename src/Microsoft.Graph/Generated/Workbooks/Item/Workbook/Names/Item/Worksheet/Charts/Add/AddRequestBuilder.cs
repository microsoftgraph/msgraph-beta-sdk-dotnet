...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Add {
        ...
        public class AddResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookChart", (o,n) => { (o as AddResponse).WorkbookChart = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.WorkbookChart>(MicrosoftGraphSdk.Models.Microsoft.Graph.WorkbookChart.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
