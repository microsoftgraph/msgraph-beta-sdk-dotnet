        ...
        public class AddResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookTableColumn", (o,n) => { (o as AddResponse).WorkbookTableColumn = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.WorkbookTableColumn>(MicrosoftGraphSdk.Models.Microsoft.Graph.WorkbookTableColumn.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
