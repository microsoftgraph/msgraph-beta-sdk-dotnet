...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.ItemAtWithIndex {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\names\{workbookNamedItem-id}\worksheet\tables\microsoft.graph.itemAt(index={index})</summary>
        ...
        public class ItemAtWithIndexResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookTable", (o,n) => { (o as ItemAtWithIndexResponse).WorkbookTable = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.WorkbookTable>(MicrosoftGraphSdk.Models.Microsoft.Graph.WorkbookTable.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
