...
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Add;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Count;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.ItemAtWithIndex;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.ItemWithName;
using System;
...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts {
    ...
    public class ChartsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.workbooks.item.workbook.names.item.worksheet.charts.item collection</summary>
        ...
        public async Task<ChartsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<ChartsResponse>(requestInfo, ChartsResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
        /// <summary>
