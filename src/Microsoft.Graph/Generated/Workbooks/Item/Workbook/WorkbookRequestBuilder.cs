...
using MicrosoftGraph.Workbooks.Item.Workbook.Application;
using MicrosoftGraph.Workbooks.Item.Workbook.CloseSession;
using MicrosoftGraph.Workbooks.Item.Workbook.Comments;
using MicrosoftGraph.Workbooks.Item.Workbook.CreateSession;
using MicrosoftGraph.Workbooks.Item.Workbook.Functions;
using MicrosoftGraph.Workbooks.Item.Workbook.Names;
using MicrosoftGraph.Workbooks.Item.Workbook.Operations;
using MicrosoftGraph.Workbooks.Item.Workbook.RefreshSession;
using MicrosoftGraph.Workbooks.Item.Workbook.SessionInfoResourceWithKey;
using MicrosoftGraph.Workbooks.Item.Workbook.TableRowOperationResultWithKey;
using MicrosoftGraph.Workbooks.Item.Workbook.Tables;
using MicrosoftGraph.Workbooks.Item.Workbook.Worksheets;
using System;
...
namespace MicrosoftGraph.Workbooks.Item.Workbook {
    ...
    public class WorkbookRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraph.Models.Microsoft.Graph.Workbook body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftGraph.Models.Microsoft.Graph.Workbook> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<MicrosoftGraph.Models.Microsoft.Graph.Workbook>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// For files that are Excel spreadsheets, accesses the workbook API to work with the spreadsheet's contents. Nullable.
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MicrosoftGraph.Models.Microsoft.Graph.Workbook body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
