...
using MicrosoftGraph.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Add;
using MicrosoftGraph.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Count;
using MicrosoftGraph.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.ItemAtWithIndex;
using MicrosoftGraph.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.ItemWithName;
using System;
...
namespace MicrosoftGraph.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts {
    ...
    public class ChartsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.workbooks.item.workbook.tables.item.worksheet.charts.item collection</summary>
        public ChartsRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("workbookChart_id", position);
            return new ChartsRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
