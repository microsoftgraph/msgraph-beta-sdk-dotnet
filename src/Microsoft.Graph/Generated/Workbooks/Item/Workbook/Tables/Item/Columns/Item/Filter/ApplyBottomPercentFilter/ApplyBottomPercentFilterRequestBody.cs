...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Columns.Item.Filter.ApplyBottomPercentFilter {
    public class ApplyBottomPercentFilterRequestBody : IParsable {
        ...
        /// </summary>
        public static ApplyBottomPercentFilterRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApplyBottomPercentFilterRequestBody();
        }
        /// <summary>
