...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Names {
    public class NamesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as NamesResponse).Value = n.GetCollectionOfObjectValues<WorkbookNamedItem>().ToList(); } },
            };
        }
        /// <summary>
