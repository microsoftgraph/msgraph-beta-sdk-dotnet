...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Columns.Item.Filter.ApplyDynamicFilter {
    public class ApplyDynamicFilterRequestBody : IParsable {
        ...
        /// </summary>
        public static ApplyDynamicFilterRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApplyDynamicFilterRequestBody();
        }
        /// <summary>
