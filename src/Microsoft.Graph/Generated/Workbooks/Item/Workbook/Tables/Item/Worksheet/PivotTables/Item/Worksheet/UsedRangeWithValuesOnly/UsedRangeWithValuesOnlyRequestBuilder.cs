...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.PivotTables.Item.Worksheet.UsedRangeWithValuesOnly {
        ...
        public class UsedRangeWithValuesOnlyResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookRange", (o,n) => { (o as UsedRangeWithValuesOnlyResponse).WorkbookRange = n.GetObjectValue<WorkbookRange>(); } },
                };
            }
            /// <summary>
