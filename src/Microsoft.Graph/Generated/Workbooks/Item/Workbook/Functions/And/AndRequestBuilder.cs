...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Functions.And {
    ...
    public class AndRequestBuilder {
        ...
        public async Task<AndResponse> PostAsync(AndRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<AndResponse>(requestInfo, AndResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
        ...
        public class AndResponse : IParsable {
            ...
            public static AndResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
                _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
                return new AndResponse();
            }
            /// <summary>
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookFunctionResult", (o,n) => { (o as AndResponse).WorkbookFunctionResult = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.WorkbookFunctionResult>(MicrosoftGraphSdk.Models.Microsoft.Graph.WorkbookFunctionResult.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
