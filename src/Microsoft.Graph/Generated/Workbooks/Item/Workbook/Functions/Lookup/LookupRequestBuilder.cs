        ...
        public class LookupResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookFunctionResult", (o,n) => { (o as LookupResponse).WorkbookFunctionResult = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.WorkbookFunctionResult>(MicrosoftGraphSdk.Models.Microsoft.Graph.WorkbookFunctionResult.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
