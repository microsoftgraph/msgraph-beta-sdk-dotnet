...
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet.CellWithRowWithColumn;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet.Range;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet.RangeWithAddress;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet.UsedRange;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet.UsedRangeWithValuesOnly;
using System;
...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\pivotTables\{workbookPivotTable-id}\worksheet</summary>
    public class WorksheetRequestBuilder {
        ...
        public WorksheetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/pivotTables/{workbookPivotTable_id}/worksheet{?select,expand}";
