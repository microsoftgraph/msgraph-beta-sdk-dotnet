...
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Names.Item.Range;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Names.Item.Worksheet;
using System;
...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Names.Item {
    ...
    public class WorkbookNamedItemItemRequestBuilder {
        ...
        /// </summary>
        public WorkbookNamedItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public WorkbookNamedItemItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(WorkbookNamedItem body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
