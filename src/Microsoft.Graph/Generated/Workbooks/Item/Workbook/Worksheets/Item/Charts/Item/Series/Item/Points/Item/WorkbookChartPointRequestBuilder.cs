...
using MicrosoftGraph.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Series.Item.Points.Item.Format;
using System;
...
namespace MicrosoftGraph.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Series.Item.Points.Item {
    ...
    public class WorkbookChartPointRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public WorkbookChartPointRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
