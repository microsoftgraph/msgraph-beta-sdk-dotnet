...
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Worksheet.CellWithRowWithColumn;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Worksheet.Range;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Worksheet.RangeWithAddress;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Worksheet.UsedRange;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Worksheet.UsedRangeWithValuesOnly;
using System;
...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Worksheet {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\tables\{workbookTable-id}\worksheet</summary>
    public class WorksheetRequestBuilder {
        ...
        public WorksheetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/tables/{workbookTable_id}/worksheet{?select,expand}";
