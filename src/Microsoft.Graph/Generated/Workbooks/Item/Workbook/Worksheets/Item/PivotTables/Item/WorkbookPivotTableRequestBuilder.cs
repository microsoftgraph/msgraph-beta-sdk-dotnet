...
using MicrosoftGraph.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Refresh;
using MicrosoftGraph.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet;
using System;
...
namespace MicrosoftGraph.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item {
    ...
    public class WorkbookPivotTableRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public WorkbookPivotTableRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
