...
namespace Microsoft.Graph.Beta.Workbooks.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.DriveItem> PostAsync(RestoreRequestBody body, Action<RestoreRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
