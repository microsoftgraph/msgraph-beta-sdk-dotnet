...
namespace Microsoft.Graph.Beta.Workbooks.Item.Copy {
    ...
    public class CopyRequestBuilder {
        ...
        public CopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/microsoft.graph.copy";
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.DriveItem> PostAsync(CopyRequestBody body, Action<CopyRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
