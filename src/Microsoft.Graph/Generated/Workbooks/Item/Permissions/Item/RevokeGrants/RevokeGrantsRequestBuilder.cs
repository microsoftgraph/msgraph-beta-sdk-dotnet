...
namespace MicrosoftGraph.Workbooks.Item.Permissions.Item.RevokeGrants {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\permissions\{permission-id}\microsoft.graph.revokeGrants</summary>
        ...
        public class RevokeGrantsResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"permission", (o,n) => { (o as RevokeGrantsResponse).Permission = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.Permission>(); } },
                };
            }
            /// <summary>
