...
namespace Microsoft.Graph.Beta.Workbooks.Item.Thumbnails.Item {
    /// <summary>
    ...
    public class ThumbnailSetItemRequestBuilder {
        ...
        public ThumbnailSetItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/thumbnails/{thumbnailSet%2Did}{?%24select,%24expand}";
