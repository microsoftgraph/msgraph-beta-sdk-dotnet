...
namespace Microsoft.Graph.Beta.Workbooks.Item.Activities.Item {
    /// <summary>
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}";
