...
namespace Microsoft.Graph.Beta.Workbooks.Item.ListItem.Versions.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/listItem/versions/$count{?%24search,%24filter}";
