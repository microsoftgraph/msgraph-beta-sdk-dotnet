...
using Microsoft.Graph.Beta.Workbooks.Item.ListItem.DriveItem.Content;
...
namespace Microsoft.Graph.Beta.Workbooks.Item.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/listItem/driveItem{?%24select,%24expand}";
