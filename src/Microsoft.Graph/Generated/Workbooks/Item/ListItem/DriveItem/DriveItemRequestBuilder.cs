...
using MicrosoftGraphSdk.Workbooks.Item.ListItem.DriveItem.Ref;
using System;
...
namespace MicrosoftGraphSdk.Workbooks.Item.ListItem.DriveItem {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\listItem\driveItem</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/listItem/driveItem{?select,expand}";
