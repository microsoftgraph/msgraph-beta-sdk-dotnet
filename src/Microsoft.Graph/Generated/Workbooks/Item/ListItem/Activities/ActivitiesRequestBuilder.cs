...
using MicrosoftGraph.Workbooks.Item.ListItem.Activities.Item;
using System;
...
namespace MicrosoftGraph.Workbooks.Item.ListItem.Activities {
    ...
    public class ActivitiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.workbooks.item.listItem.activities.item collection</summary>
