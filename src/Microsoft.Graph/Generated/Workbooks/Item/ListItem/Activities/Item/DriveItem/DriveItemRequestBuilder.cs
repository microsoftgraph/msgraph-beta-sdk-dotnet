...
using MicrosoftGraphSdk.Workbooks.Item.ListItem.Activities.Item.DriveItem.Ref;
using System;
...
namespace MicrosoftGraphSdk.Workbooks.Item.ListItem.Activities.Item.DriveItem {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\listItem\activities\{itemActivityOLD-id}\driveItem</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/listItem/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
        ...
        /// <summary>Get driveItem from workbooks</summary>
