...
using MicrosoftGraph.Workbooks.Item.ListItem.Activities.Item.DriveItem;
using MicrosoftGraph.Workbooks.Item.ListItem.Activities.Item.ListItem;
using System;
...
namespace MicrosoftGraph.Workbooks.Item.ListItem.Activities.Item {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\listItem\activities\{itemActivityOLD-id}</summary>
    public class ItemActivityOLDRequestBuilder {
        ...
        /// </summary>
        public ItemActivityOLDRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/listItem/activities/{itemActivityOLD_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ItemActivityOLDRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ItemActivityOLD body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
