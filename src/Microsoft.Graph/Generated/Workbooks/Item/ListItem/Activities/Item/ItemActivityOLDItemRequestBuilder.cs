...
using Microsoft.Graph.Beta.Workbooks.Item.ListItem.Activities.Item.DriveItem;
using Microsoft.Graph.Beta.Workbooks.Item.ListItem.Activities.Item.ListItem;
...
namespace Microsoft.Graph.Beta.Workbooks.Item.ListItem.Activities.Item {
    ...
    public class ItemActivityOLDItemRequestBuilder {
        ...
        public Microsoft.Graph.Beta.Workbooks.Item.ListItem.Activities.Item.ListItem.ListItemRequestBuilder ListItem { get =>
            new Microsoft.Graph.Beta.Workbooks.Item.ListItem.Activities.Item.ListItem.ListItemRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/listItem/activities/{itemActivityOLD%2Did}{?%24select,%24expand}";
