...
namespace MicrosoftGraphSdk.Workbooks.Item.ListItem.Activities.Item.ListItem.CreateLink {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\listItem\activities\{itemActivityOLD-id}\listItem\microsoft.graph.createLink</summary>
    public class CreateLinkRequestBuilder {
        ...
        public CreateLinkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/listItem/activities/{itemActivityOLD_id}/listItem/microsoft.graph.createLink";
