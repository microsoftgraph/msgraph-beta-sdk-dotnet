...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.ApplicationTemplates {
    public class ApplicationTemplatesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ApplicationTemplatesResponse).Value = n.GetCollectionOfObjectValues<ApplicationTemplate>().ToList(); } },
            };
        }
        /// <summary>
