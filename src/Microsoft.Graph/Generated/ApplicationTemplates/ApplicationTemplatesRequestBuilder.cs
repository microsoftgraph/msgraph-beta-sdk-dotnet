...
namespace Microsoft.Graph.Beta.ApplicationTemplates {
    ...
    public class ApplicationTemplatesRequestBuilder {
        ...
        /// </summary>
        public async Task<ApplicationTemplateCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ApplicationTemplatesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ApplicationTemplate> PostAsync(ApplicationTemplate body, CancellationToken cancellationToken = default, Action<ApplicationTemplatesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
