...
namespace Microsoft.Graph.Beta.ApplicationTemplates {
    ...
    public class ApplicationTemplatesRequestBuilder {
        ...
        /// </summary>
        public async Task<ApplicationTemplateCollectionResponse> GetAsync(Action<ApplicationTemplatesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ApplicationTemplate> PostAsync(ApplicationTemplate body, Action<ApplicationTemplatesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
        ...
        /// <summary>List applicationTemplates</summary>
