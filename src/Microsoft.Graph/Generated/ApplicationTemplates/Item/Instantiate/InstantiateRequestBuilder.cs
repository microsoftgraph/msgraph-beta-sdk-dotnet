...
namespace Microsoft.Graph.Beta.ApplicationTemplates.Item.Instantiate {
    ...
    public class InstantiateRequestBuilder {
        ...
        /// </summary>
        public async Task<ApplicationServicePrincipal> PostAsync(InstantiatePostRequestBody body, CancellationToken cancellationToken = default, Action<InstantiateRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
