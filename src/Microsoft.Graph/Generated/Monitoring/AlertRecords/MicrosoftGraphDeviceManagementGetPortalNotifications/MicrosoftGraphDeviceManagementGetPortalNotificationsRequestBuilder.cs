...
namespace Microsoft.Graph.Beta.Monitoring.AlertRecords.MicrosoftGraphDeviceManagementGetPortalNotifications {
    ...
    public class MicrosoftGraphDeviceManagementGetPortalNotificationsRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetPortalNotificationsGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function getPortalNotifications
        /// </summary>
        /// <returns>A <cref="GetPortalNotificationsResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="MicrosoftGraphDeviceManagementGetPortalNotificationsRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
