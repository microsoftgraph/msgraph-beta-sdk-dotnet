...
using Microsoft.Graph.Beta.Monitoring.AlertRecords.GetPortalNotifications;
...
namespace Microsoft.Graph.Beta.Monitoring.AlertRecords {
    ...
    public class AlertRecordsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.monitoring.alertRecords.item collection</summary>
        ...
        public AlertRecordsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/monitoring/alertRecords{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
