...
namespace Microsoft.Graph.Beta.PrivilegedOperationEvents {
    ...
    public class PrivilegedOperationEventsRequestBuilder {
        ...
        /// </summary>
        public async Task<PrivilegedOperationEventCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PrivilegedOperationEventsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PrivilegedOperationEvent> PostAsync(PrivilegedOperationEvent body, CancellationToken cancellationToken = default, Action<PrivilegedOperationEventsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
        ...
        /// <summary>Retrieve a list of privilegedOperationEvent objects, which represent the audit events that are generated by Privileged Identity Management for the role operations. For the details about the audit event, refer privilegedOperationEvent. To filter the query results, use the standard OData ``$filter`` expression.</summary>
