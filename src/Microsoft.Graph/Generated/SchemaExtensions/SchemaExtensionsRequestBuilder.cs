...
namespace Microsoft.Graph.Beta.SchemaExtensions {
    ...
    public class SchemaExtensionsRequestBuilder {
        ...
        /// </summary>
        public async Task<SchemaExtensionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SchemaExtensionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SchemaExtension> PostAsync(SchemaExtension body, CancellationToken cancellationToken = default, Action<SchemaExtensionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
