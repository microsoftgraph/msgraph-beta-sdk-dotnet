...
namespace MicrosoftGraphSdk.SchemaExtensions {
    ...
    public class SchemaExtensionsRequestBuilder {
        ...
        /// </summary>
        public async Task<SchemaExtensionCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
