...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EdiscoveryRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EdiscoveryRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Ediscoveryroot?> GetAsync(CancellationToken cancellationToken = default, Action<EdiscoveryRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Ediscoveryroot> GetAsync(CancellationToken cancellationToken = default, Action<EdiscoveryRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Ediscoveryroot?> PatchAsync(Ediscoveryroot body, CancellationToken cancellationToken = default, Action<EdiscoveryRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Ediscoveryroot> PatchAsync(Ediscoveryroot body, CancellationToken cancellationToken = default, Action<EdiscoveryRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
