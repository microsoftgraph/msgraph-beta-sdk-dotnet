...
using MicrosoftGraph.Compliance.Ediscovery.Cases.Item.ReviewSets.Item.AddToReviewSet;
using MicrosoftGraph.Compliance.Ediscovery.Cases.Item.ReviewSets.Item.Export;
using MicrosoftGraph.Compliance.Ediscovery.Cases.Item.ReviewSets.Item.Queries;
...
namespace MicrosoftGraph.Compliance.Ediscovery.Cases.Item.ReviewSets.Item {
    ...
    public class ReviewSetRequestBuilder {
        ...
        /// </summary>
        public ReviewSetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case_id}/reviewSets/{reviewSet_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ReviewSetRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ReviewSet body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
