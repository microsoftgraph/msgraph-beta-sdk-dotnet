...
#nullable enable
        public async Task<ReviewSetCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ReviewSetsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ReviewSetCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ReviewSetsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ReviewSet?> PostAsync(ReviewSet body, CancellationToken cancellationToken = default, Action<ReviewSetsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ReviewSet> PostAsync(ReviewSet body, CancellationToken cancellationToken = default, Action<ReviewSetsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
