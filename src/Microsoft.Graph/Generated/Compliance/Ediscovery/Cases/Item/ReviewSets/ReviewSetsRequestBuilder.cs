...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.ReviewSets {
    ...
    public class ReviewSetsRequestBuilder : BaseRequestBuilder {
        ...
        /// <returns>A <see cref="ReviewSetItemRequestBuilder"/></returns>
        [Obsolete("The ediscovery Apis are deprecated under /compliance and will stop returning data from February 01, 2023. Please use the new ediscovery Apis under /security. as of 2022-12/ediscoveryNamespace")]
...
#nullable enable
        public async Task<ReviewSetCollectionResponse?> GetAsync(Action<RequestConfiguration<ReviewSetsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ReviewSetCollectionResponse> GetAsync(Action<RequestConfiguration<ReviewSetsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
