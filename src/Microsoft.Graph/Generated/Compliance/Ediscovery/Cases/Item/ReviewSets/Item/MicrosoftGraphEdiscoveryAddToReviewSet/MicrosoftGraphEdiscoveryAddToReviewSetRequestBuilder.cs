...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.ReviewSets.Item.MicrosoftGraphEdiscoveryAddToReviewSet {
    ...
    /// </summary>
    public class MicrosoftGraphEdiscoveryAddToReviewSetRequestBuilder {
        ...
        public MicrosoftGraphEdiscoveryAddToReviewSetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphEdiscoveryAddToReviewSetRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
