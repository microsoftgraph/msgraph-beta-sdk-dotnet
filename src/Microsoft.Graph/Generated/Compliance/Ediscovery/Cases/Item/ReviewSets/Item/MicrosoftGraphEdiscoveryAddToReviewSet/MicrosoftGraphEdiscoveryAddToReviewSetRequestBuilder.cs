...
#nullable enable
        public async Task PostAsync(AddToReviewSetPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphEdiscoveryAddToReviewSetRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(AddToReviewSetPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphEdiscoveryAddToReviewSetRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
