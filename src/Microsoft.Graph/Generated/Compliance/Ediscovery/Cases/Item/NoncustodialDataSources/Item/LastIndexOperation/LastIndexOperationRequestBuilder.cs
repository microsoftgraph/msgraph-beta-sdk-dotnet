...
using System;
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.NoncustodialDataSources.Item.LastIndexOperation {
    /// <summary>
    ...
    public class LastIndexOperationRequestBuilder : BaseRequestBuilder {
        ...
        public LastIndexOperationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/noncustodialDataSources/{noncustodialDataSource%2Did}/lastIndexOperation{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LastIndexOperationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LastIndexOperationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/noncustodialDataSources/{noncustodialDataSource%2Did}/lastIndexOperation{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
