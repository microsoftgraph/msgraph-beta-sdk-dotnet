...
#nullable enable
        public async Task<NoncustodialDataSourceCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<NoncustodialDataSourcesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<NoncustodialDataSourceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<NoncustodialDataSourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<NoncustodialDataSource?> PostAsync(NoncustodialDataSource body, CancellationToken cancellationToken = default, Action<NoncustodialDataSourcesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<NoncustodialDataSource> PostAsync(NoncustodialDataSource body, CancellationToken cancellationToken = default, Action<NoncustodialDataSourcesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
