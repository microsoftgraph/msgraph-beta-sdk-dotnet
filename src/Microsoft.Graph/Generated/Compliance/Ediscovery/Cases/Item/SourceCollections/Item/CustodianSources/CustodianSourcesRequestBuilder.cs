...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.CustodianSources {
    ...
    public class CustodianSourcesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.compliance.ediscovery.cases.item.sourceCollections.item.custodianSources.item collection</summary>
        ...
        /// <summary>Get the list of dataSource objects associated with a source collection.</summary>
