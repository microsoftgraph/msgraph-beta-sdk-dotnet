...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.EstimateStatistics {
    ...
    public class EstimateStatisticsRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<EstimateStatisticsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
