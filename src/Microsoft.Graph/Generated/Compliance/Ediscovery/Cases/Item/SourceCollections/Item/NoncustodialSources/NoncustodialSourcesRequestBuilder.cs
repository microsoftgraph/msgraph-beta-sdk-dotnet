...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.NoncustodialSources {
    ...
    public class NoncustodialSourcesRequestBuilder {
        ...
        /// </summary>
        public async Task<NoncustodialDataSourceCollectionResponse> GetAsync(Action<NoncustodialSourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
