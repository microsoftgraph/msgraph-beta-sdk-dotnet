...
using MicrosoftGraph.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.AdditionalSources;
using MicrosoftGraph.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.AddToReviewSetOperation;
using MicrosoftGraph.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.CustodianSources;
using MicrosoftGraph.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.EstimateStatistics;
using MicrosoftGraph.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.LastEstimateStatisticsOperation;
using MicrosoftGraph.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.NoncustodialSources;
...
namespace MicrosoftGraph.Compliance.Ediscovery.Cases.Item.SourceCollections.Item {
