...
namespace MicrosoftGraphSdk.Compliance.Ediscovery.Cases.Item.SourceCollections {
    public class SourceCollectionsResponse : IParsable {
        ...
        /// </summary>
        public static SourceCollectionsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SourceCollectionsResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as SourceCollectionsResponse).Value = n.GetCollectionOfObjectValues<SourceCollection>(SourceCollection.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
