...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.LastEstimateStatisticsOperation {
    ...
    public class LastEstimateStatisticsOperationRequestBuilder {
        ...
        /// </summary>
        public async Task<EstimateStatisticsOperation> GetAsync(CancellationToken cancellationToken = default, Action<LastEstimateStatisticsOperationRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
