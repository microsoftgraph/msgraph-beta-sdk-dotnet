...
#nullable enable
        public async Task<SourceCollectionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SourceCollectionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SourceCollectionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SourceCollectionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SourceCollection?> PostAsync(SourceCollection body, CancellationToken cancellationToken = default, Action<SourceCollectionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SourceCollection> PostAsync(SourceCollection body, CancellationToken cancellationToken = default, Action<SourceCollectionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
