...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.MicrosoftGraphEdiscoveryEstimateStatistics {
    ...
    /// </summary>
    public class MicrosoftGraphEdiscoveryEstimateStatisticsRequestBuilder {
        ...
        public MicrosoftGraphEdiscoveryEstimateStatisticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphEdiscoveryEstimateStatisticsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
