...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.Settings.EdiscoveryResetToDefault {
    ...
    /// </summary>
    public class EdiscoveryResetToDefaultRequestBuilder {
        ...
        public EdiscoveryResetToDefaultRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/settings/ediscovery.resetToDefault";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EdiscoveryResetToDefaultRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
