...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.Settings.MicrosoftGraphEdiscoveryResetToDefault {
    ...
    /// </summary>
    public class MicrosoftGraphEdiscoveryResetToDefaultRequestBuilder {
        ...
        public MicrosoftGraphEdiscoveryResetToDefaultRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphEdiscoveryResetToDefaultRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
