...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.Custodians {
    ...
    public class CustodiansRequestBuilder {
        ...
        /// </summary>
        public async Task<CustodianCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CustodiansRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Ediscovery.Custodian> PostAsync(Microsoft.Graph.Beta.Models.Ediscovery.Custodian body, CancellationToken cancellationToken = default, Action<CustodiansRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
