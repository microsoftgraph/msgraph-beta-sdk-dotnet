...
namespace MicrosoftGraphSdk.Compliance.Ediscovery.Cases.Item.Custodians {
    ...
    public class CustodiansRequestBuilder {
        ...
        /// </summary>
        public async Task<CustodianCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
