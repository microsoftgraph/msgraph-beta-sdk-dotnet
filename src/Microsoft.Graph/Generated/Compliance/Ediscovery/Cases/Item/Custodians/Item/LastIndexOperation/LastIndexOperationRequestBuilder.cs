...
#nullable enable
        public async Task<CaseIndexOperation?> GetAsync(CancellationToken cancellationToken = default, Action<LastIndexOperationRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CaseIndexOperation> GetAsync(CancellationToken cancellationToken = default, Action<LastIndexOperationRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
