...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.Custodians.MicrosoftGraphEdiscoveryRemoveHold {
    ...
    /// </summary>
    public class MicrosoftGraphEdiscoveryRemoveHoldRequestBuilder {
        ...
        public MicrosoftGraphEdiscoveryRemoveHoldRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians/microsoft.graph.ediscovery.removeHold";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphEdiscoveryRemoveHoldRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
