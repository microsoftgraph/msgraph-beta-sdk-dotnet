...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.Custodians.Item.MicrosoftGraphEdiscoveryActivate {
    ...
    /// </summary>
    public class MicrosoftGraphEdiscoveryActivateRequestBuilder {
        ...
        public MicrosoftGraphEdiscoveryActivateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphEdiscoveryActivateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
