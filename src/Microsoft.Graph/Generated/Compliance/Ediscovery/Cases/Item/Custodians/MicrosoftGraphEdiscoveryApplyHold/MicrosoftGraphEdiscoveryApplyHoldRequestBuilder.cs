...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.Custodians.MicrosoftGraphEdiscoveryApplyHold {
    ...
    /// </summary>
    public class MicrosoftGraphEdiscoveryApplyHoldRequestBuilder {
        ...
        public MicrosoftGraphEdiscoveryApplyHoldRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians/microsoft.graph.ediscovery.applyHold";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphEdiscoveryApplyHoldRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
