...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.EdiscoveryClose {
    ...
    /// </summary>
    public class EdiscoveryCloseRequestBuilder {
        ...
        public EdiscoveryCloseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/ediscovery.close";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EdiscoveryCloseRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
