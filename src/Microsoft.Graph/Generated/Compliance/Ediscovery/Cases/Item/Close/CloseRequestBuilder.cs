...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.Close {
    ...
    public class CloseRequestBuilder {
        ...
        public CloseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/microsoft.graph.ediscovery.close";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public CloseRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreatePostRequestInformation(Action<CloseRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new CloseRequestBuilderPostRequestConfiguration();
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<CloseRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        public class CloseRequestBuilderPostRequestConfiguration {
            ...
            /// <summary>
            /// Instantiates a new closeRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
