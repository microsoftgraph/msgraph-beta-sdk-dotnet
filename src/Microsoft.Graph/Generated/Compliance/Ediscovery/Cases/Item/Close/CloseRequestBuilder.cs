...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.Close {
    ...
    public class CloseRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<CloseRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
