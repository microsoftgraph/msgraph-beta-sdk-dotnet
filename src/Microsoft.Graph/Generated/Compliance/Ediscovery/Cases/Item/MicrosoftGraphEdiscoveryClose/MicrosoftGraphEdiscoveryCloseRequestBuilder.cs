...
#nullable enable
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphEdiscoveryCloseRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphEdiscoveryCloseRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
