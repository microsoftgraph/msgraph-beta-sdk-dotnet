...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.MicrosoftGraphEdiscoveryClose {
    ...
    /// </summary>
    public class MicrosoftGraphEdiscoveryCloseRequestBuilder {
        ...
        public MicrosoftGraphEdiscoveryCloseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphEdiscoveryCloseRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
