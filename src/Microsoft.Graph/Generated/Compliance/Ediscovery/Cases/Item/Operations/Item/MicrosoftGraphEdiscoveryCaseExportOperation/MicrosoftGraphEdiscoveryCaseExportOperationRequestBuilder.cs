...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.Operations.Item.MicrosoftGraphEdiscoveryCaseExportOperation {
    ...
    public class MicrosoftGraphEdiscoveryCaseExportOperationRequestBuilder {
        ...
        public MicrosoftGraphEdiscoveryCaseExportOperationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/operations/{caseOperation%2Did}/microsoft.graph.ediscovery.caseExportOperation{?%24select,%24expand}";
...
#nullable enable
        public async Task<CaseExportOperation?> GetAsync(Action<MicrosoftGraphEdiscoveryCaseExportOperationRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CaseExportOperation> GetAsync(Action<MicrosoftGraphEdiscoveryCaseExportOperationRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
