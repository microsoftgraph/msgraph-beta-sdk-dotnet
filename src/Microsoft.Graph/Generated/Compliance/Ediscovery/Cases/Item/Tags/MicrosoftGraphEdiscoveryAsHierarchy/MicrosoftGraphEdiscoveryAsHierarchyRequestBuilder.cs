...
#nullable enable
        public async Task<AsHierarchyResponse?> GetAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphEdiscoveryAsHierarchyRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AsHierarchyResponse> GetAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphEdiscoveryAsHierarchyRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
