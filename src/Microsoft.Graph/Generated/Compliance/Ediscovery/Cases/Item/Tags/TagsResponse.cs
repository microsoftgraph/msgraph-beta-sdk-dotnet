...
namespace MicrosoftGraphSdk.Compliance.Ediscovery.Cases.Item.Tags {
    public class TagsResponse : IParsable {
        ...
        /// </summary>
        public static TagsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as TagsResponse).Value = n.GetCollectionOfObjectValues<Tag>(Tag.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
