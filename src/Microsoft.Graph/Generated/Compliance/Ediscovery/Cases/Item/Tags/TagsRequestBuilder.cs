...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.Tags {
    ...
    public class TagsRequestBuilder {
        ...
        /// </summary>
        public async Task<TagCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TagsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Tag> PostAsync(Tag body, CancellationToken cancellationToken = default, Action<TagsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
