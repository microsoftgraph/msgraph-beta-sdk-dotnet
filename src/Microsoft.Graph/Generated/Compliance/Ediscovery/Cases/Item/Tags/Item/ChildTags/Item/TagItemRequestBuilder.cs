...
namespace MicrosoftGraphSdk.Compliance.Ediscovery.Cases.Item.Tags.Item.ChildTags.Item {
    ...
    public class TagItemRequestBuilder {
        ...
        public TagItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case_id}/tags/{tag_id}/childTags/{tag_id1}{?select,expand}";
