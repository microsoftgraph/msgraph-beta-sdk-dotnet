...
#nullable enable
        public async Task<TagCollectionResponse?> GetAsync(Action<RequestConfiguration<ChildTagsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<TagCollectionResponse> GetAsync(Action<RequestConfiguration<ChildTagsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
