...
#nullable enable
        public async Task<TagCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ChildTagsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TagCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ChildTagsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
