...
namespace MicrosoftGraphSdk.Compliance.Ediscovery.Cases.Item.Tags.Item.ChildTags {
    ...
    public class ChildTagsRequestBuilder {
        ...
        public MicrosoftGraphSdk.Compliance.Ediscovery.Cases.Item.Tags.Item.ChildTags.Item.TagItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("tag_id1", position);
            return new MicrosoftGraphSdk.Compliance.Ediscovery.Cases.Item.Tags.Item.ChildTags.Item.TagItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
