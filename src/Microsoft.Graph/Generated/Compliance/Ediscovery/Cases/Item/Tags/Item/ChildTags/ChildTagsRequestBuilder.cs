...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.Tags.Item.ChildTags {
    ...
    public class ChildTagsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.compliance.ediscovery.cases.item.tags.item.childTags.item collection</summary>
        ...
        /// </summary>
        public async Task<TagCollectionResponse> GetAsync(Action<ChildTagsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <summary>Get a list of child tag objects associated with a tag.</summary>
