...
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.Tags.Item.Parent {
    ...
    public class ParentRequestBuilder {
        ...
        /// </summary>
        public async Task<Tag> GetAsync(CancellationToken cancellationToken = default, Action<ParentRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
