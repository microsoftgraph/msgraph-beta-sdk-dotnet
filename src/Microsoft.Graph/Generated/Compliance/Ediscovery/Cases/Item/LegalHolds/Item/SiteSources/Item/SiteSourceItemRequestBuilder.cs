using Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.LegalHolds.Item.SiteSources.Item.Site;
...
using System;
namespace Microsoft.Graph.Beta.Compliance.Ediscovery.Cases.Item.LegalHolds.Item.SiteSources.Item {
    /// <summary>
    ...
    public class SiteSourceItemRequestBuilder : BaseRequestBuilder {
        ...
        public SiteSourceItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}/siteSources/{siteSource%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SiteSourceItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SiteSourceItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}/siteSources/{siteSource%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
