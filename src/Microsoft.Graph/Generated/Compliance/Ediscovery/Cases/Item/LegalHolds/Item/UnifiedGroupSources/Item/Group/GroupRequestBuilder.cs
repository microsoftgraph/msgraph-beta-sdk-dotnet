...
using MicrosoftGraphSdk.Compliance.Ediscovery.Cases.Item.LegalHolds.Item.UnifiedGroupSources.Item.Group.Ref;
...
namespace MicrosoftGraphSdk.Compliance.Ediscovery.Cases.Item.LegalHolds.Item.UnifiedGroupSources.Item.Group {
    /// <summary>Builds and executes requests for operations under \compliance\ediscovery\cases\{case-id}\legalHolds\{legalHold-id}\unifiedGroupSources\{unifiedGroupSource-id}\group</summary>
    public class GroupRequestBuilder {
        ...
        public GroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case_id}/legalHolds/{legalHold_id}/unifiedGroupSources/{unifiedGroupSource_id}/group{?select,expand}";
