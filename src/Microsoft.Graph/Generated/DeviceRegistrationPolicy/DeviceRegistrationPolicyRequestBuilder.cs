...
namespace Microsoft.Graph.Beta.DeviceRegistrationPolicy {
    /// <summary>Provides operations to manage the deviceRegistrationPolicy singleton.</summary>
    public class DeviceRegistrationPolicyRequestBuilder {
        ...
        /// </summary>
        public DeviceRegistrationPolicyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/deviceRegistrationPolicy{?%24select}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public DeviceRegistrationPolicyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreateGetRequestInformation(Action<DeviceRegistrationPolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new DeviceRegistrationPolicyRequestBuilderGetRequestConfiguration();
        ...
        /// <summary>Get deviceRegistrationPolicy</summary>
        ...
        public class DeviceRegistrationPolicyRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public IDictionary<string, string> Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public DeviceRegistrationPolicyRequestBuilderGetQueryParameters QueryParameters { get; set; } = new DeviceRegistrationPolicyRequestBuilderGetQueryParameters();
            /// <summary>
