...
namespace Microsoft.Graph.Beta.DeviceLocalCredentials {
    ...
    public class DeviceLocalCredentialsRequestBuilder : BaseRequestBuilder {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/devicelocalcredentialinfo-list?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceLocalCredentialInfoCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceLocalCredentialsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceLocalCredentialInfoCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DeviceLocalCredentialsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceLocalCredentialInfo?> PostAsync(DeviceLocalCredentialInfo body, CancellationToken cancellationToken = default, Action<DeviceLocalCredentialsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceLocalCredentialInfo> PostAsync(DeviceLocalCredentialInfo body, CancellationToken cancellationToken = default, Action<DeviceLocalCredentialsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
