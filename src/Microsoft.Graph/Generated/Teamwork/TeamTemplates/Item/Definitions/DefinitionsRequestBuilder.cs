...
namespace Microsoft.Graph.Beta.Teamwork.TeamTemplates.Item.Definitions {
    ...
    public class DefinitionsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.TeamTemplateDefinition> PostAsync(Microsoft.Graph.Beta.Models.TeamTemplateDefinition body, Action<DefinitionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
