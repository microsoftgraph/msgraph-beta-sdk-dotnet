...
namespace Microsoft.Graph.Beta.Teamwork.TeamTemplates.Item.Definitions {
    ...
    public class DefinitionsRequestBuilder : BaseRequestBuilder {
        ...
        public DefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DefinitionsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<TeamTemplateDefinitionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DefinitionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TeamTemplateDefinitionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DefinitionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.TeamTemplateDefinition?> PostAsync(Microsoft.Graph.Beta.Models.TeamTemplateDefinition body, CancellationToken cancellationToken = default, Action<DefinitionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.TeamTemplateDefinition> PostAsync(Microsoft.Graph.Beta.Models.TeamTemplateDefinition body, CancellationToken cancellationToken = default, Action<DefinitionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
