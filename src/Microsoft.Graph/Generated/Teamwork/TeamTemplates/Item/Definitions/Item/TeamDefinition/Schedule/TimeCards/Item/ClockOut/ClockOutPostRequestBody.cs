...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Schedule.TimeCards.Item.ClockOut {
    ...
    public class ClockOutPostRequestBody : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public static ClockOutPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
