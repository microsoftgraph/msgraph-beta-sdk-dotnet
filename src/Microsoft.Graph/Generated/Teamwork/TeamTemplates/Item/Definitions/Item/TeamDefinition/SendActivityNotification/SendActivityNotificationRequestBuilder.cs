...
namespace Microsoft.Graph.Beta.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.SendActivityNotification {
    ...
    public class SendActivityNotificationRequestBuilder : BaseRequestBuilder {
        ...
        public SendActivityNotificationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/sendActivityNotification", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SendActivityNotificationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SendActivityNotificationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/sendActivityNotification", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(SendActivityNotificationPostRequestBody body, CancellationToken cancellationToken = default, Action<SendActivityNotificationRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(SendActivityNotificationPostRequestBody body, CancellationToken cancellationToken = default, Action<SendActivityNotificationRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
