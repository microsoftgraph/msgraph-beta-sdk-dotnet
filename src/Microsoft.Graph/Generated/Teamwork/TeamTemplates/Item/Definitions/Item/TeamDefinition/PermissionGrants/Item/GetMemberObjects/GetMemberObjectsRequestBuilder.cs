...
namespace Microsoft.Graph.Beta.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.PermissionGrants.Item.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder {
        ...
        /// </summary>
        public async Task<GetMemberObjectsResponse> PostAsync(GetMemberObjectsPostRequestBody body, CancellationToken cancellationToken = default, Action<GetMemberObjectsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
