...
namespace Microsoft.Graph.Beta.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.PermissionGrants.Item.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder {
        ...
        public async Task<GetMemberObjectsResponse> PostAsync(GetMemberObjectsPostRequestBody body, Action<GetMemberObjectsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<GetMemberObjectsResponse>(requestInfo, GetMemberObjectsResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
