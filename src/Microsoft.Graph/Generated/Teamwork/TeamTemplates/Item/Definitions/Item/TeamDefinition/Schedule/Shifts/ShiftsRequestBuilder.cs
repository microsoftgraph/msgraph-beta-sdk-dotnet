...
namespace Microsoft.Graph.Beta.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Schedule.Shifts {
    ...
    public class ShiftsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.teamwork.teamTemplates.item.definitions.item.teamDefinition.schedule.shifts.item collection</summary>
        ...
        public ShiftsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/shifts{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
