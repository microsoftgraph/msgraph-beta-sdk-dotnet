...
namespace Microsoft.Graph.Beta.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Schedule.TimeCards {
    ...
    public class TimeCardsRequestBuilder {
        ...
        /// </summary>
        public async Task<TimeCardCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TimeCardsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TimeCard> PostAsync(TimeCard body, CancellationToken cancellationToken = default, Action<TimeCardsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
