...
namespace Microsoft.Graph.Beta.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Schedule.TimeCards.Item.Confirm {
    ...
    public class ConfirmRequestBuilder : BaseRequestBuilder {
        ...
        public ConfirmRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeCards/{timeCard%2Did}/confirm", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ConfirmRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ConfirmRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeCards/{timeCard%2Did}/confirm", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<TimeCard?> PostAsync(CancellationToken cancellationToken = default, Action<ConfirmRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TimeCard> PostAsync(CancellationToken cancellationToken = default, Action<ConfirmRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
