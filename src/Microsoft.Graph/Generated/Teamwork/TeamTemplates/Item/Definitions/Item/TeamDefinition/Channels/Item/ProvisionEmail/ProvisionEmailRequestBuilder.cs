...
namespace Microsoft.Graph.Beta.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Channels.Item.ProvisionEmail {
    ...
    public class ProvisionEmailRequestBuilder : BaseRequestBuilder {
        ...
        public ProvisionEmailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/provisionEmail", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ProvisionEmailRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProvisionEmailRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/provisionEmail", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ProvisionChannelEmailResult?> PostAsync(CancellationToken cancellationToken = default, Action<ProvisionEmailRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ProvisionChannelEmailResult> PostAsync(CancellationToken cancellationToken = default, Action<ProvisionEmailRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
