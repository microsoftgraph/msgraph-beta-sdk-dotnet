...
#nullable enable
        public async Task PostAsync(UpdateSoftwarePostRequestBody body, CancellationToken cancellationToken = default, Action<UpdateSoftwareRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(UpdateSoftwarePostRequestBody body, CancellationToken cancellationToken = default, Action<UpdateSoftwareRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
