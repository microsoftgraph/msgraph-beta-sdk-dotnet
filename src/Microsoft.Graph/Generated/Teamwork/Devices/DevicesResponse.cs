...
namespace MicrosoftGraphSdk.Teamwork.Devices {
    public class DevicesResponse : IParsable {
        ...
        /// </summary>
        public static DevicesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DevicesResponse).Value = n.GetCollectionOfObjectValues<TeamworkDevice>(TeamworkDevice.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
