...
namespace MicrosoftGraphSdk.Teamwork.WorkforceIntegrations {
    ...
    public class WorkforceIntegrationsRequestBuilder {
        ...
        /// </summary>
        public async Task<WorkforceIntegrationCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
