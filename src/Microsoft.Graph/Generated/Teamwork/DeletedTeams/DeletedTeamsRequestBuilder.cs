...
namespace Microsoft.Graph.Beta.Teamwork.DeletedTeams {
    ...
    public class DeletedTeamsRequestBuilder {
        ...
        /// </summary>
        public async Task<DeletedTeamCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DeletedTeamsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeletedTeam> PostAsync(DeletedTeam body, CancellationToken cancellationToken = default, Action<DeletedTeamsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
