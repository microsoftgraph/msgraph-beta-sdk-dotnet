...
namespace Microsoft.Graph.Beta.Teamwork.DeletedTeams.Item.Channels.Item.Messages.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/messages/$count{?%24search,%24filter}";
