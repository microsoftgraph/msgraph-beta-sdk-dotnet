...
namespace Microsoft.Graph.Beta.Teamwork.SendActivityNotificationToRecipients {
    ...
    public class SendActivityNotificationToRecipientsRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public SendActivityNotificationToRecipientsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SendActivityNotificationToRecipientsPostRequestBody body, Action<SendActivityNotificationToRecipientsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(SendActivityNotificationToRecipientsPostRequestBody body, Action<SendActivityNotificationToRecipientsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
