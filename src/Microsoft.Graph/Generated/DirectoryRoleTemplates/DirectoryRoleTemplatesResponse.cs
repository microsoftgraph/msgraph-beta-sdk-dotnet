...
namespace MicrosoftGraphSdk.DirectoryRoleTemplates {
    public class DirectoryRoleTemplatesResponse : IParsable {
        ...
        /// </summary>
        public static DirectoryRoleTemplatesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DirectoryRoleTemplatesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DirectoryRoleTemplatesResponse).Value = n.GetCollectionOfObjectValues<DirectoryRoleTemplate>(DirectoryRoleTemplate.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
