...
namespace MicrosoftGraph.AuthenticationMethodsPolicy.AuthenticationMethodConfigurations.Item {
    ...
    public class AuthenticationMethodConfigurationRequestBuilder {
        ...
        /// <summary>
        /// Instantiates a new AuthenticationMethodConfigurationRequestBuilder and sets the default values.
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AuthenticationMethodConfigurationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/authenticationMethodsPolicy/authenticationMethodConfigurations/{authenticationMethodConfiguration_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AuthenticationMethodConfigurationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
