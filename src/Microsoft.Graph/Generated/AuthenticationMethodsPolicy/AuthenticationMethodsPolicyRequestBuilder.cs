...
namespace Microsoft.Graph.Beta.AuthenticationMethodsPolicy {
    ...
    public class AuthenticationMethodsPolicyRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="Microsoft.Graph.Beta.Models.AuthenticationMethodsPolicy"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.AuthenticationMethodsPolicy?> GetAsync(Action<RequestConfiguration<AuthenticationMethodsPolicyRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.AuthenticationMethodsPolicy> GetAsync(Action<RequestConfiguration<AuthenticationMethodsPolicyRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="AuthenticationMethodsPolicyRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class AuthenticationMethodsPolicyRequestBuilderGetRequestConfiguration : RequestConfiguration<AuthenticationMethodsPolicyRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
