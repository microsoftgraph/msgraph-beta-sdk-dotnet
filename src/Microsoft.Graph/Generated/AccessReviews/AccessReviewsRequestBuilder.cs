...
#nullable enable
        public async Task<AccessReviewCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AccessReviewsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessReviewCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AccessReviewsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessReview?> PostAsync(AccessReview body, CancellationToken cancellationToken = default, Action<AccessReviewsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessReview> PostAsync(AccessReview body, CancellationToken cancellationToken = default, Action<AccessReviewsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
