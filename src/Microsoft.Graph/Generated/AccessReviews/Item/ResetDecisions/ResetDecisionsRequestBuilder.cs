...
namespace Microsoft.Graph.Beta.AccessReviews.Item.ResetDecisions {
    ...
    public class ResetDecisionsRequestBuilder : BaseRequestBuilder {
        ...
        public ResetDecisionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accessReviews/{accessReview%2Did}/resetDecisions", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ResetDecisionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ResetDecisionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accessReviews/{accessReview%2Did}/resetDecisions", rawUrl) {
        }
        /// <summary>
