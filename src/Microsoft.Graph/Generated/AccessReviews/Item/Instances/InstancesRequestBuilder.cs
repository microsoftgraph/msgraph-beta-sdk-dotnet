...
namespace Microsoft.Graph.Beta.AccessReviews.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// </summary>
        public async Task<AccessReviewCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<InstancesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AccessReview> PostAsync(AccessReview body, CancellationToken cancellationToken = default, Action<InstancesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
