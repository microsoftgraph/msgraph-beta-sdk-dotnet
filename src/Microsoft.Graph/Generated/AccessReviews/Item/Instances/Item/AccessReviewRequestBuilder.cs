...
namespace MicrosoftGraph.AccessReviews.Item.Instances.Item {
    ...
    public class AccessReviewRequestBuilder {
        ...
        /// </summary>
        public AccessReviewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AccessReviewRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
