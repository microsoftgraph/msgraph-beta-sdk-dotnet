...
namespace Microsoft.Graph.Beta.AccessReviews.Item.Instances.Item.ApplyDecisions {
    ...
    public class ApplyDecisionsRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<ApplyDecisionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
