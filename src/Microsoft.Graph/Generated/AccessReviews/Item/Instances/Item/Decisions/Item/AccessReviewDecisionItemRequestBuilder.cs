...
using System;
namespace Microsoft.Graph.Beta.AccessReviews.Item.Instances.Item.Decisions.Item {
    /// <summary>
    ...
    public class AccessReviewDecisionItemRequestBuilder : BaseRequestBuilder {
        ...
        public AccessReviewDecisionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accessReviews/{accessReview%2Did}/instances/{accessReview%2Did1}/decisions/{accessReviewDecision%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AccessReviewDecisionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AccessReviewDecisionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accessReviews/{accessReview%2Did}/instances/{accessReview%2Did1}/decisions/{accessReviewDecision%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
