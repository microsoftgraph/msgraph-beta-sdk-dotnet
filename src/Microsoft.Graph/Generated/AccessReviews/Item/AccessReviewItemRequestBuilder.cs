...
namespace MicrosoftGraphSdk.AccessReviews.Item {
    /// <summary>Builds and executes requests for operations under \accessReviews\{accessReview-id}</summary>
    public class AccessReviewItemRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(AccessReview body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
