...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AccessReviewItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AccessReviewItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessReview?> GetAsync(CancellationToken cancellationToken = default, Action<AccessReviewItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessReview> GetAsync(CancellationToken cancellationToken = default, Action<AccessReviewItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessReview?> PatchAsync(AccessReview body, CancellationToken cancellationToken = default, Action<AccessReviewItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessReview> PatchAsync(AccessReview body, CancellationToken cancellationToken = default, Action<AccessReviewItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
