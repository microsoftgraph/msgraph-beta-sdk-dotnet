...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.AccessReviews.Item.Decisions {
    public class DecisionsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DecisionsResponse).Value = n.GetCollectionOfObjectValues<AccessReviewDecision>(AccessReviewDecision.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
