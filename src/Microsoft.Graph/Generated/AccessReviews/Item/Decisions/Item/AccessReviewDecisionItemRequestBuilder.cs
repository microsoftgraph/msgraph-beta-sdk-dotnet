...
namespace Microsoft.Graph.Beta.AccessReviews.Item.Decisions.Item {
    ...
    public class AccessReviewDecisionItemRequestBuilder : BaseRequestBuilder {
        ...
        public AccessReviewDecisionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accessReviews/{accessReview%2Did}/decisions/{accessReviewDecision%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AccessReviewDecisionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AccessReviewDecisionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accessReviews/{accessReview%2Did}/decisions/{accessReviewDecision%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AccessReviewDecisionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AccessReviewDecisionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessReviewDecision?> GetAsync(CancellationToken cancellationToken = default, Action<AccessReviewDecisionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessReviewDecision> GetAsync(CancellationToken cancellationToken = default, Action<AccessReviewDecisionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessReviewDecision?> PatchAsync(AccessReviewDecision body, CancellationToken cancellationToken = default, Action<AccessReviewDecisionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessReviewDecision> PatchAsync(AccessReviewDecision body, CancellationToken cancellationToken = default, Action<AccessReviewDecisionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
