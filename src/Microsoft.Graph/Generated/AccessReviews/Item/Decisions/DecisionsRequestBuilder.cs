...
namespace Microsoft.Graph.Beta.AccessReviews.Item.Decisions {
    ...
    public class DecisionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.accessReviews.item.decisions.item collection</summary>
        ...
        public DecisionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/accessReviews/{accessReview%2Did}/decisions{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
