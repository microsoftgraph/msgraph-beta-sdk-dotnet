...
namespace MicrosoftGraph.AccessReviews.Item.Reviewers {
    ...
    public class ReviewersRequestBuilder {
        ...
        public ReviewersRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("accessReviewReviewer_id", position);
            return new ReviewersRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public ReviewersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/accessReviews/{accessReview_id}/reviewers{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
