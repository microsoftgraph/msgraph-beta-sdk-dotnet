...
using System;
namespace Microsoft.Graph.Beta.AccessReviews.Item.SendReminder {
    /// <summary>
    ...
    public class SendReminderRequestBuilder : BaseRequestBuilder {
        ...
        public SendReminderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accessReviews/{accessReview%2Did}/sendReminder", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SendReminderRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SendReminderRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accessReviews/{accessReview%2Did}/sendReminder", rawUrl) {
        }
        /// <summary>
