...
namespace Microsoft.Graph.Beta.Programs.Item.Controls.Item {
    ...
    public class ProgramControlItemRequestBuilder : BaseRequestBuilder {
        ...
        public ProgramControlItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/programs/{program%2Did}/controls/{programControl%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ProgramControlItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProgramControlItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/programs/{program%2Did}/controls/{programControl%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ProgramControlItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ProgramControlItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ProgramControl?> GetAsync(CancellationToken cancellationToken = default, Action<ProgramControlItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ProgramControl> GetAsync(CancellationToken cancellationToken = default, Action<ProgramControlItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ProgramControl?> PatchAsync(ProgramControl body, CancellationToken cancellationToken = default, Action<ProgramControlItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ProgramControl> PatchAsync(ProgramControl body, CancellationToken cancellationToken = default, Action<ProgramControlItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
