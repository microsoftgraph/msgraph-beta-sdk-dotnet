...
namespace MicrosoftGraph.GovernanceRoleAssignments {
    ...
    public class GovernanceRoleAssignmentsRequestBuilder {
        ...
        public GovernanceRoleAssignmentsRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("governanceRoleAssignment_id", position);
            return new GovernanceRoleAssignmentsRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public GovernanceRoleAssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/governanceRoleAssignments{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
