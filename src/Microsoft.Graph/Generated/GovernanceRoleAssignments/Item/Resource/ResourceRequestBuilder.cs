...
using MicrosoftGraphSdk.GovernanceRoleAssignments.Item.Resource.Ref;
...
namespace MicrosoftGraphSdk.GovernanceRoleAssignments.Item.Resource {
    /// <summary>Builds and executes requests for operations under \governanceRoleAssignments\{governanceRoleAssignment-id}\resource</summary>
    public class ResourceRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment_id}/resource{?select,expand}";
