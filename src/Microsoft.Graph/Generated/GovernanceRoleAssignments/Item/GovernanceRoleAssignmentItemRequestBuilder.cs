...
namespace MicrosoftGraphSdk.GovernanceRoleAssignments.Item {
    /// <summary>Builds and executes requests for operations under \governanceRoleAssignments\{governanceRoleAssignment-id}</summary>
    public class GovernanceRoleAssignmentItemRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(GovernanceRoleAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
