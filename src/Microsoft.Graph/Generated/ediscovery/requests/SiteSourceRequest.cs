...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial class SiteSourceRequest : Microsoft.Graph.BaseRequest, ISiteSourceRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{SiteSource}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SiteSource>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SiteSource}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SiteSource>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<SiteSource>(null, cancellationToken).ConfigureAwait(false);
        }
