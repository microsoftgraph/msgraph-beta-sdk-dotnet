...
namespace Microsoft.Graph.Ediscovery
{
    ...
    /// <summary>
    /// The type SourceCollectionReferenceRequest.
    /// </summary>
    public partial class SourceCollectionReferenceRequest : Microsoft.Graph.BaseRequest, ISourceCollectionReferenceRequest
    {
        /// <summary>
        /// Constructs a new SourceCollectionReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public SourceCollectionReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified SourceCollection reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified SourceCollection reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified SourceCollection reference.
        /// </summary>
        /// <param name="id">The SourceCollection reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified SourceCollection reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The SourceCollection reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
