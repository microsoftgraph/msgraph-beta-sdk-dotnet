...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial class LegalHoldUserSourcesCollectionRequest : Microsoft.Graph.BaseRequest, ILegalHoldUserSourcesCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<LegalHoldUserSourcesCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{LegalHoldUserSourcesCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<LegalHoldUserSourcesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<LegalHoldUserSourcesCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
