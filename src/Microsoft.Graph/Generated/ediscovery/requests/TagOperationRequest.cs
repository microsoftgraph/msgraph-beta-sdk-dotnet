...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial class TagOperationRequest : Microsoft.Graph.BaseRequest, ITagOperationRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{TagOperation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TagOperation>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TagOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<TagOperation>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<TagOperation>(null, cancellationToken).ConfigureAwait(false);
        }
