...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial interface IDataSourceRequest : Microsoft.Graph.IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DataSource> CreateAsync(DataSource dataSourceToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<DataSource>> CreateResponseAsync(DataSource dataSourceToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DataSource}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DataSource>> CreateResponseAsync(DataSource dataSourceToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="dataSourceToUpdate">The DataSource to update.</param>
        /// <returns>The <see cref="GraphResponse{DataSource}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DataSource>> UpdateResponseAsync(DataSource dataSourceToUpdate);
        ...
        /// <exception cref="Microsoft.Graph.ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DataSource}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<DataSource>> UpdateResponseAsync(DataSource dataSourceToUpdate, CancellationToken cancellationToken);
