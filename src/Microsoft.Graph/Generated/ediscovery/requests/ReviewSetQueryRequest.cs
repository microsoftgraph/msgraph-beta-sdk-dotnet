...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial class ReviewSetQueryRequest : Microsoft.Graph.BaseRequest, IReviewSetQueryRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ReviewSetQuery>> CreateResponseAsync(ReviewSetQuery reviewSetQueryToCreate)
        {
            return this.CreateResponseAsync(reviewSetQueryToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ReviewSetQuery}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReviewSetQuery>> CreateResponseAsync(ReviewSetQuery reviewSetQueryToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        public async System.Threading.Tasks.Task<ReviewSetQuery> UpdateAsync(ReviewSetQuery reviewSetQueryToUpdate, CancellationToken cancellationToken)
        {
			...
			{
				if (reviewSetQueryToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.ResponseHeaders) ||
					reviewSetQueryToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.StatusCode))
				{
					throw new Microsoft.Graph.ClientException(
						new Microsoft.Graph.Error
						{
							Code = Microsoft.Graph.GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(Microsoft.Graph.GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, reviewSetQueryToUpdate.GetType().Name)
						});
				}
			}
            if (reviewSetQueryToUpdate.AdditionalData != null)
        ...
        /// <param name="reviewSetQueryToUpdate">The ReviewSetQuery to update.</param>
        /// <returns>The <see cref="GraphResponse{ReviewSetQuery}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReviewSetQuery>> UpdateResponseAsync(ReviewSetQuery reviewSetQueryToUpdate)
        {
            return this.UpdateResponseAsync(reviewSetQueryToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="Microsoft.Graph.ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{ReviewSetQuery}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReviewSetQuery>> UpdateResponseAsync(ReviewSetQuery reviewSetQueryToUpdate, CancellationToken cancellationToken)
        {
			if (reviewSetQueryToUpdate.AdditionalData != null)
			{
				if (reviewSetQueryToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.ResponseHeaders) ||
