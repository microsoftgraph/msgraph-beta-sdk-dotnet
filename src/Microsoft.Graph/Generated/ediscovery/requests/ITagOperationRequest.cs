...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial interface ITagOperationRequest : Microsoft.Graph.IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<TagOperation> CreateAsync(TagOperation tagOperationToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<TagOperation>> CreateResponseAsync(TagOperation tagOperationToCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<TagOperation> UpdateAsync(TagOperation tagOperationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <exception cref="Microsoft.Graph.ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{TagOperation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<TagOperation>> UpdateResponseAsync(TagOperation tagOperationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<TagOperation> PutAsync(TagOperation tagOperationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<TagOperation>> PutResponseAsync(TagOperation tagOperationToUpdate, CancellationToken cancellationToken = default(CancellationToken));
