...
namespace Microsoft.Graph.Ediscovery
{
    ...
    /// <summary>
    /// The type EstimateStatisticsOperationReferenceRequest.
    /// </summary>
    public partial class EstimateStatisticsOperationReferenceRequest : Microsoft.Graph.BaseRequest, IEstimateStatisticsOperationReferenceRequest
    {
        /// <summary>
        /// Constructs a new EstimateStatisticsOperationReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public EstimateStatisticsOperationReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified EstimateStatisticsOperation reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified EstimateStatisticsOperation reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified EstimateStatisticsOperation reference.
        /// </summary>
        /// <param name="id">The EstimateStatisticsOperation reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified EstimateStatisticsOperation reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The EstimateStatisticsOperation reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
