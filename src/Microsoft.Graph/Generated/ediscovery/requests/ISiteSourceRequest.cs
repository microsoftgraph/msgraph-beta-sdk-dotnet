...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial interface ISiteSourceRequest : Microsoft.Graph.IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SiteSource> CreateAsync(SiteSource siteSourceToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<SiteSource>> CreateResponseAsync(SiteSource siteSourceToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SiteSource}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SiteSource>> CreateResponseAsync(SiteSource siteSourceToCreate, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{SiteSource}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SiteSource>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SiteSource}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SiteSource>> GetResponseAsync(CancellationToken cancellationToken);
        ...
        /// <param name="siteSourceToUpdate">The SiteSource to update.</param>
        /// <returns>The <see cref="GraphResponse{SiteSource}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SiteSource>> UpdateResponseAsync(SiteSource siteSourceToUpdate);
        ...
        /// <exception cref="Microsoft.Graph.ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SiteSource}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SiteSource>> UpdateResponseAsync(SiteSource siteSourceToUpdate, CancellationToken cancellationToken);
