...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial class CaseRequest : Microsoft.Graph.BaseRequest, ICaseRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Case}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Case>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Case}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Case>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Case>(null, cancellationToken).ConfigureAwait(false);
        }
