...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial class EdiscoveryrootRequest : Microsoft.Graph.BaseRequest, IEdiscoveryrootRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<Ediscoveryroot>> CreateResponseAsync(Ediscoveryroot ediscoveryrootToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
        ...
        /// <exception cref="Microsoft.Graph.ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Ediscoveryroot}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Ediscoveryroot>> UpdateResponseAsync(Ediscoveryroot ediscoveryrootToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "PATCH";
