...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial class EdiscoveryrootRequest : Microsoft.Graph.BaseRequest, IEdiscoveryrootRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Ediscoveryroot>> CreateResponseAsync(Ediscoveryroot ediscoveryrootToCreate)
        {
            return this.CreateResponseAsync(ediscoveryrootToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Ediscoveryroot}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Ediscoveryroot>> CreateResponseAsync(Ediscoveryroot ediscoveryrootToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<Ediscoveryroot>(ediscoveryrootToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Ediscoveryroot}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Ediscoveryroot>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Ediscoveryroot}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Ediscoveryroot>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Ediscoveryroot>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="ediscoveryrootToUpdate">The Ediscoveryroot to update.</param>
        /// <returns>The <see cref="GraphResponse{Ediscoveryroot}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Ediscoveryroot>> UpdateResponseAsync(Ediscoveryroot ediscoveryrootToUpdate)
        {
            return this.UpdateResponseAsync(ediscoveryrootToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="Microsoft.Graph.ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Ediscoveryroot}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Ediscoveryroot>> UpdateResponseAsync(Ediscoveryroot ediscoveryrootToUpdate, CancellationToken cancellationToken)
        {
			if (ediscoveryrootToUpdate.AdditionalData != null)
			{
				if (ediscoveryrootToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<Ediscoveryroot>(ediscoveryrootToUpdate, cancellationToken).ConfigureAwait(false);
        }
