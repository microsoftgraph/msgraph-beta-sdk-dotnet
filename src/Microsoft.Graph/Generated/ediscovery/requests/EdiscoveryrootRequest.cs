...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial class EdiscoveryrootRequest : Microsoft.Graph.BaseRequest, IEdiscoveryrootRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<Ediscoveryroot> PutAsync(Ediscoveryroot ediscoveryrootToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<Ediscoveryroot>> PutResponseAsync(Ediscoveryroot ediscoveryrootToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<Ediscoveryroot>(ediscoveryrootToUpdate, cancellationToken);
