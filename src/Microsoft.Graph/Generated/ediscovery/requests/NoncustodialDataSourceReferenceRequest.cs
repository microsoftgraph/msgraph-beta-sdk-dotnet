...
namespace Microsoft.Graph.Ediscovery
{
    ...
    /// <summary>
    /// The type NoncustodialDataSourceReferenceRequest.
    /// </summary>
    public partial class NoncustodialDataSourceReferenceRequest : Microsoft.Graph.BaseRequest, INoncustodialDataSourceReferenceRequest
    {
        /// <summary>
        /// Constructs a new NoncustodialDataSourceReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public NoncustodialDataSourceReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified NoncustodialDataSource reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified NoncustodialDataSource reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified NoncustodialDataSource reference.
        /// </summary>
        /// <param name="id">The NoncustodialDataSource reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified NoncustodialDataSource reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The NoncustodialDataSource reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
