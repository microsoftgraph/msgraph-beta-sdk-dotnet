...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial class EstimateStatisticsOperationWithReferenceRequest : Microsoft.Graph.BaseRequest, IEstimateStatisticsOperationWithReferenceRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<EstimateStatisticsOperation>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EstimateStatisticsOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<EstimateStatisticsOperation>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<EstimateStatisticsOperation>(null, cancellationToken).ConfigureAwait(false);
        }
