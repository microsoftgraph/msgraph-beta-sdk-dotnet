...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial class NoncustodialDataSourceRequest : Microsoft.Graph.BaseRequest, INoncustodialDataSourceRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<NoncustodialDataSource>> CreateResponseAsync(NoncustodialDataSource noncustodialDataSourceToCreate)
        {
            return this.CreateResponseAsync(noncustodialDataSourceToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{NoncustodialDataSource}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<NoncustodialDataSource>> CreateResponseAsync(NoncustodialDataSource noncustodialDataSourceToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<NoncustodialDataSource>(noncustodialDataSourceToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{NoncustodialDataSource}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<NoncustodialDataSource>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{NoncustodialDataSource}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<NoncustodialDataSource>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<NoncustodialDataSource>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="noncustodialDataSourceToUpdate">The NoncustodialDataSource to update.</param>
        /// <returns>The <see cref="GraphResponse{NoncustodialDataSource}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<NoncustodialDataSource>> UpdateResponseAsync(NoncustodialDataSource noncustodialDataSourceToUpdate)
        {
            return this.UpdateResponseAsync(noncustodialDataSourceToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="Microsoft.Graph.ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{NoncustodialDataSource}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<NoncustodialDataSource>> UpdateResponseAsync(NoncustodialDataSource noncustodialDataSourceToUpdate, CancellationToken cancellationToken)
        {
			if (noncustodialDataSourceToUpdate.AdditionalData != null)
			{
				if (noncustodialDataSourceToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<NoncustodialDataSource>(noncustodialDataSourceToUpdate, cancellationToken).ConfigureAwait(false);
        }
