...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial class SettingsRequest : Microsoft.Graph.BaseRequest, ISettingsRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Settings}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Settings>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Settings}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Settings>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Settings>(null, cancellationToken).ConfigureAwait(false);
        }
