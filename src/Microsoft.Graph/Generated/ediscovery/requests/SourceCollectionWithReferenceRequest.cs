...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial class SourceCollectionWithReferenceRequest : Microsoft.Graph.BaseRequest, ISourceCollectionWithReferenceRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SourceCollection>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SourceCollection}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SourceCollection>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<SourceCollection>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="sourceCollectionToCreate">The SourceCollection to create.</param>
        /// <returns>The <see cref="GraphResponse{SourceCollection}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SourceCollection>> CreateResponseAsync(SourceCollection sourceCollectionToCreate)
        {
            return this.CreateResponseAsync(sourceCollectionToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SourceCollection}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SourceCollection>> CreateResponseAsync(SourceCollection sourceCollectionToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<SourceCollection>(sourceCollectionToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="sourceCollectionToUpdate">The SourceCollection to update.</param>
        /// <returns>The <see cref="GraphResponse{SourceCollection}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SourceCollection>> UpdateResponseAsync(SourceCollection sourceCollectionToUpdate)
        {
            return this.UpdateResponseAsync(sourceCollectionToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="Microsoft.Graph.ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SourceCollection}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SourceCollection>> UpdateResponseAsync(SourceCollection sourceCollectionToUpdate, CancellationToken cancellationToken)
        {
			if (sourceCollectionToUpdate.AdditionalData != null)
			{
				if (sourceCollectionToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<SourceCollection>(sourceCollectionToUpdate, cancellationToken).ConfigureAwait(false);
        }
