...
namespace Microsoft.Graph.Ediscovery
{
    ...
    /// <summary>
    /// The type CaseIndexOperationReferenceRequest.
    /// </summary>
    public partial class CaseIndexOperationReferenceRequest : Microsoft.Graph.BaseRequest, ICaseIndexOperationReferenceRequest
    {
        /// <summary>
        /// Constructs a new CaseIndexOperationReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public CaseIndexOperationReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified CaseIndexOperation reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// </summary>
        /// <param name="id">The CaseIndexOperation reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified CaseIndexOperation reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The CaseIndexOperation reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
