...
namespace Microsoft.Graph.Ediscovery
{
    ...
    /// <summary>
    /// The interface ICaseIndexOperationRequest.
    /// </summary>
    public partial interface ICaseIndexOperationRequest : Microsoft.Graph.IBaseRequest
    {
        /// <summary>
        ...
        System.Threading.Tasks.Task<CaseIndexOperation> CreateAsync(CaseIndexOperation caseIndexOperationToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<CaseIndexOperation>> CreateResponseAsync(CaseIndexOperation caseIndexOperationToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{CaseIndexOperation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<CaseIndexOperation>> CreateResponseAsync(CaseIndexOperation caseIndexOperationToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="caseIndexOperationToUpdate">The CaseIndexOperation to update.</param>
        /// <returns>The <see cref="GraphResponse{CaseIndexOperation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<CaseIndexOperation>> UpdateResponseAsync(CaseIndexOperation caseIndexOperationToUpdate);
        ...
        /// <exception cref="Microsoft.Graph.ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{CaseIndexOperation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<CaseIndexOperation>> UpdateResponseAsync(CaseIndexOperation caseIndexOperationToUpdate, CancellationToken cancellationToken);
        ...
        ICaseIndexOperationRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        ICaseIndexOperationRequest Expand(Expression<Func<CaseIndexOperation, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        ICaseIndexOperationRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        ICaseIndexOperationRequest Select(Expression<Func<CaseIndexOperation, object>> selectExpression);
