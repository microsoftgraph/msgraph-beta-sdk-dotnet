...
namespace Microsoft.Graph.Ediscovery
{
    ...
    public partial class CustodianRequest : Microsoft.Graph.BaseRequest, ICustodianRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{Custodian}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Custodian>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Custodian}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Custodian>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Custodian>(null, cancellationToken).ConfigureAwait(false);
        }
