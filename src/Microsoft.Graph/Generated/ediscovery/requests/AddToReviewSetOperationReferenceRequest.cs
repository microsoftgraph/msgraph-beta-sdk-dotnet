...
namespace Microsoft.Graph.Ediscovery
{
    ...
    /// <summary>
    /// The type AddToReviewSetOperationReferenceRequest.
    /// </summary>
    public partial class AddToReviewSetOperationReferenceRequest : Microsoft.Graph.BaseRequest, IAddToReviewSetOperationReferenceRequest
    {
        /// <summary>
        /// Constructs a new AddToReviewSetOperationReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public AddToReviewSetOperationReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified AddToReviewSetOperation reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified AddToReviewSetOperation reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified AddToReviewSetOperation reference.
        /// </summary>
        /// <param name="id">The AddToReviewSetOperation reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified AddToReviewSetOperation reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The AddToReviewSetOperation reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
