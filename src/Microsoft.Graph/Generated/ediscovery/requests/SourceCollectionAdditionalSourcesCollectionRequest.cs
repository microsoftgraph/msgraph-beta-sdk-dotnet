...
namespace Microsoft.Graph.Ediscovery
{
    ...
    /// <summary>
    /// The type SourceCollectionAdditionalSourcesCollectionRequest.
    /// </summary>
    public partial class SourceCollectionAdditionalSourcesCollectionRequest : Microsoft.Graph.BaseRequest, ISourceCollectionAdditionalSourcesCollectionRequest
    {
        /// <summary>
        /// Constructs a new SourceCollectionAdditionalSourcesCollectionRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public SourceCollectionAdditionalSourcesCollectionRequest(
            string requestUrl,
        ...
        public System.Threading.Tasks.Task<GraphResponse<DataSource>> AddResponseAsync(DataSource dataSource)
        {
            return this.AddResponseAsync(dataSource, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DataSource}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DataSource>> AddResponseAsync(DataSource dataSource, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            dataSource.ODataType = string.Concat("#", StringHelper.ConvertTypeToLowerCamelCase(dataSource.GetType().FullName));
        ...
        public System.Threading.Tasks.Task<GraphResponse<SourceCollectionAdditionalSourcesCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SourceCollectionAdditionalSourcesCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SourceCollectionAdditionalSourcesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        public ISourceCollectionAdditionalSourcesCollectionRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISourceCollectionAdditionalSourcesCollectionRequest Expand(Expression<Func<DataSource, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISourceCollectionAdditionalSourcesCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISourceCollectionAdditionalSourcesCollectionRequest Select(Expression<Func<DataSource, object>> selectExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISourceCollectionAdditionalSourcesCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISourceCollectionAdditionalSourcesCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISourceCollectionAdditionalSourcesCollectionRequest Skip(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISourceCollectionAdditionalSourcesCollectionRequest OrderBy(string value)
        {
