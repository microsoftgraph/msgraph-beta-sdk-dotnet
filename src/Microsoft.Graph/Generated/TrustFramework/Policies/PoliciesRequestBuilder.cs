...
#nullable restore
        ...
        public async Task<TrustFrameworkPolicyCollectionResponse> GetAsync(Action<PoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<TrustFrameworkPolicyCollectionResponse>(requestInfo, TrustFrameworkPolicyCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
