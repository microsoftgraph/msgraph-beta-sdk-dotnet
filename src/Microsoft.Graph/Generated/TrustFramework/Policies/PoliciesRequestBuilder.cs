...
namespace Microsoft.Graph.Beta.TrustFramework.Policies {
    ...
    public class PoliciesRequestBuilder {
        ...
        /// </summary>
        public async Task<TrustFrameworkPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TrustFrameworkPolicy> PostAsync(TrustFrameworkPolicy body, CancellationToken cancellationToken = default, Action<PoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
