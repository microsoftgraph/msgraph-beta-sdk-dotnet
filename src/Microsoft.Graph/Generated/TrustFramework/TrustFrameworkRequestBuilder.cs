...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.TrustFramework?> GetAsync(CancellationToken cancellationToken = default, Action<TrustFrameworkRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.TrustFramework> GetAsync(CancellationToken cancellationToken = default, Action<TrustFrameworkRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.TrustFramework?> PatchAsync(Microsoft.Graph.Beta.Models.TrustFramework body, CancellationToken cancellationToken = default, Action<TrustFrameworkRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.TrustFramework> PatchAsync(Microsoft.Graph.Beta.Models.TrustFramework body, CancellationToken cancellationToken = default, Action<TrustFrameworkRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
