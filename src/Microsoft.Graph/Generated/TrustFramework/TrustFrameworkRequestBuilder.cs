...
namespace Microsoft.Graph.Beta.TrustFramework {
    ...
    public class TrustFrameworkRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.TrustFramework> PatchAsync(Microsoft.Graph.Beta.Models.TrustFramework body, Action<TrustFrameworkRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
