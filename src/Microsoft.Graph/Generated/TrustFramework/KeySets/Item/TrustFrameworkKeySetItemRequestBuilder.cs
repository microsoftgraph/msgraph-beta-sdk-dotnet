...
namespace MicrosoftGraphSdk.TrustFramework.KeySets.Item {
    ...
    public class TrustFrameworkKeySetItemRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(TrustFrameworkKeySet body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
