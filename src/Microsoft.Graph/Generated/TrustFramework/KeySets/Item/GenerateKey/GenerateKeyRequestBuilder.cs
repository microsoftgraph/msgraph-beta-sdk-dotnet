...
namespace Microsoft.Graph.Beta.TrustFramework.KeySets.Item.GenerateKey {
    ...
    public class GenerateKeyRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GenerateKeyPostRequestBody body, Action<GenerateKeyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<TrustFrameworkKey> PostAsync(GenerateKeyPostRequestBody body, Action<GenerateKeyRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
