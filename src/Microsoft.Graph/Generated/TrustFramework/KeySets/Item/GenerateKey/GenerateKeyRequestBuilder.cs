...
#nullable enable
        public async Task<TrustFrameworkKey?> PostAsync(GenerateKeyPostRequestBody body, CancellationToken cancellationToken = default, Action<GenerateKeyRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TrustFrameworkKey> PostAsync(GenerateKeyPostRequestBody body, CancellationToken cancellationToken = default, Action<GenerateKeyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
