...
#nullable enable
        public async Task<TrustFrameworkKey?> PostAsync(UploadCertificatePostRequestBody body, CancellationToken cancellationToken = default, Action<UploadCertificateRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TrustFrameworkKey> PostAsync(UploadCertificatePostRequestBody body, CancellationToken cancellationToken = default, Action<UploadCertificateRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
