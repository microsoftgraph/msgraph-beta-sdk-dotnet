...
#nullable enable
        public async Task<TrustFrameworkKey?> GetAsync(CancellationToken cancellationToken = default, Action<GetActiveKeyRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TrustFrameworkKey> GetAsync(CancellationToken cancellationToken = default, Action<GetActiveKeyRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
