...
namespace Microsoft.Graph.Beta.TrustFramework.KeySets.Item.GetActiveKey
{
    ...
    public partial class GetActiveKeyRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.TrustFramework.KeySets.Item.GetActiveKey.GetActiveKeyRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Microsoft.Graph.Beta.Models.TrustFrameworkKey?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Microsoft.Graph.Beta.Models.TrustFrameworkKey> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.TrustFramework.KeySets.Item.GetActiveKey.GetActiveKeyRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Beta.TrustFramework.KeySets.Item.GetActiveKey.GetActiveKeyRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Beta.TrustFramework.KeySets.Item.GetActiveKey.GetActiveKeyRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.18.0")]
        public partial class GetActiveKeyRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
