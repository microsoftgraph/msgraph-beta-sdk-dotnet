...
#nullable enable
        public async Task<TrustFrameworkKey?> PostAsync(UploadPkcs12PostRequestBody body, CancellationToken cancellationToken = default, Action<UploadPkcs12RequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TrustFrameworkKey> PostAsync(UploadPkcs12PostRequestBody body, CancellationToken cancellationToken = default, Action<UploadPkcs12RequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
