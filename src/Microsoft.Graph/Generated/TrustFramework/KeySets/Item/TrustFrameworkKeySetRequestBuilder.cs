...
using MicrosoftGraph.TrustFramework.KeySets.Item.GenerateKey;
using MicrosoftGraph.TrustFramework.KeySets.Item.GetActiveKey;
using MicrosoftGraph.TrustFramework.KeySets.Item.UploadCertificate;
using MicrosoftGraph.TrustFramework.KeySets.Item.UploadPkcs12;
using MicrosoftGraph.TrustFramework.KeySets.Item.UploadSecret;
using System;
...
namespace MicrosoftGraph.TrustFramework.KeySets.Item {
    ...
    public class TrustFrameworkKeySetRequestBuilder {
        ...
        /// </summary>
        public TrustFrameworkKeySetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public TrustFrameworkKeySetRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
