...
namespace Microsoft.Graph.IndustryData
{
    ...
    /// <summary>
    /// The type SourceSystemDefinitionRequest.
    /// </summary>
    public partial class SourceSystemDefinitionRequest : Microsoft.Graph.BaseRequest, ISourceSystemDefinitionRequest
    {
        /// <summary>
        /// Constructs a new SourceSystemDefinitionRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public SourceSystemDefinitionRequest(
            string requestUrl,
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<SourceSystemDefinition> PutAsync(SourceSystemDefinition sourceSystemDefinitionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <param name="sourceSystemDefinitionToUpdate">The SourceSystemDefinition object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await of <see cref="GraphResponse{SourceSystemDefinition}"/>.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SourceSystemDefinition>> PutResponseAsync(SourceSystemDefinition sourceSystemDefinitionToUpdate, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SourceSystemDefinition>(sourceSystemDefinitionToUpdate, cancellationToken);
        ...
        public ISourceSystemDefinitionRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISourceSystemDefinitionRequest Expand(Expression<Func<SourceSystemDefinition, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISourceSystemDefinitionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISourceSystemDefinitionRequest Select(Expression<Func<SourceSystemDefinition, object>> selectExpression)
        {
        ...
        /// </summary>
        /// <param name="sourceSystemDefinitionToInitialize">The <see cref="SourceSystemDefinition"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(SourceSystemDefinition sourceSystemDefinitionToInitialize)
        {
