...
namespace Microsoft.Graph.IndustryData
{
    ...
    /// <summary>
    /// The type SourceSystemDefinitionReferenceRequest.
    /// </summary>
    public partial class SourceSystemDefinitionReferenceRequest : Microsoft.Graph.BaseRequest, ISourceSystemDefinitionReferenceRequest
    {
        /// <summary>
        /// Constructs a new SourceSystemDefinitionReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public SourceSystemDefinitionReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified SourceSystemDefinition reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified SourceSystemDefinition reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified SourceSystemDefinition reference.
        /// </summary>
        /// <param name="id">The SourceSystemDefinition reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified SourceSystemDefinition reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The SourceSystemDefinition reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
