...
namespace Microsoft.Graph.IndustryData
{
    ...
    /// <summary>
    /// The type ReferenceDefinitionReferenceRequest.
    /// </summary>
    public partial class ReferenceDefinitionReferenceRequest : Microsoft.Graph.BaseRequest, IReferenceDefinitionReferenceRequest
    {
        /// <summary>
        /// Constructs a new ReferenceDefinitionReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ReferenceDefinitionReferenceRequest(
            string requestUrl,
        ...
        /// </summary>
        /// <param name="id">The ReferenceDefinition reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified ReferenceDefinition reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The ReferenceDefinition reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
