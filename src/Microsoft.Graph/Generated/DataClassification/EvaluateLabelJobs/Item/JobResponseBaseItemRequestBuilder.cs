...
namespace Microsoft.Graph.Beta.DataClassification.EvaluateLabelJobs.Item {
    /// <summary>
    ...
    public class JobResponseBaseItemRequestBuilder : BaseRequestBuilder {
        ...
        public JobResponseBaseItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/dataClassification/evaluateLabelJobs/{jobResponseBase%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new JobResponseBaseItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public JobResponseBaseItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/dataClassification/evaluateLabelJobs/{jobResponseBase%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
