...
#nullable enable
        public async Task<JobResponseBaseCollectionResponse?> GetAsync(Action<RequestConfiguration<EvaluateLabelJobsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<JobResponseBaseCollectionResponse> GetAsync(Action<RequestConfiguration<EvaluateLabelJobsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="EvaluateLabelJobsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class EvaluateLabelJobsRequestBuilderGetRequestConfiguration : RequestConfiguration<EvaluateLabelJobsRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
