...
namespace Microsoft.Graph.Beta.DataClassification.SensitivityLabels.Evaluate {
    ...
    public class EvaluateRequestBuilder {
        ...
        /// </summary>
        public async Task<EvaluateLabelJobResponse> PostAsync(EvaluateRequestBody body, Action<EvaluateRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
