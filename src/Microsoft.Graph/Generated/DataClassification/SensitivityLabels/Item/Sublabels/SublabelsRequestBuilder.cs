...
using MicrosoftGraph.DataClassification.SensitivityLabels.Item.Sublabels.Evaluate;
using MicrosoftGraph.DataClassification.SensitivityLabels.Item.Sublabels.Item;
...
namespace MicrosoftGraph.DataClassification.SensitivityLabels.Item.Sublabels {
    /// <summary>Builds and executes requests for operations under \dataClassification\sensitivityLabels\{sensitivityLabel-id}\sublabels</summary>
    public class SublabelsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.dataClassification.sensitivityLabels.item.sublabels.item collection</summary>
        ...
        public SublabelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/dataClassification/sensitivityLabels/{sensitivityLabel_id}/sublabels{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
