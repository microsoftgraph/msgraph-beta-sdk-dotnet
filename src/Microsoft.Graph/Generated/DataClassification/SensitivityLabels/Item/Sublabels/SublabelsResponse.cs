...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.DataClassification.SensitivityLabels.Item.Sublabels {
    public class SublabelsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as SublabelsResponse).Value = n.GetCollectionOfObjectValues<SensitivityLabel>().ToList(); } },
            };
        }
        /// <summary>
