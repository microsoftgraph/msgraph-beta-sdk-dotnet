...
namespace MicrosoftGraph.DataClassification.SensitivityLabels.Item.Sublabels.Evaluate {
    /// <summary>Builds and executes requests for operations under \dataClassification\sensitivityLabels\{sensitivityLabel-id}\sublabels\microsoft.graph.evaluate</summary>
    public class EvaluateRequestBuilder {
        ...
        public EvaluateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/dataClassification/sensitivityLabels/{sensitivityLabel_id}/sublabels/microsoft.graph.evaluate";
