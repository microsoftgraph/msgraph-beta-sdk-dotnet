...
namespace Microsoft.Graph.Beta.DataClassification.SensitivityLabels
{
    ...
    public partial class SensitivityLabelsRequestBuilder : BaseRequestBuilder
    {
        ...
        {
            get => new global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the evaluate method.</summary>
        public global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.Evaluate.EvaluateRequestBuilder Evaluate
        {
            get => new global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.Evaluate.EvaluateRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.Item.SensitivityLabelItemRequestBuilder"/></returns>
        public global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.Item.SensitivityLabelItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("sensitivityLabel%2Did", position);
                return new global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.Item.SensitivityLabelItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Provides operations to call the computeInheritance method.
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.ComputeInheritanceWithLabelIdsWithLocaleWithContentFormats.ComputeInheritanceWithLabelIdsWithLocaleWithContentFormatsRequestBuilder"/></returns>
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.SensitivityLabelsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Microsoft.Graph.Beta.Models.SensitivityLabelCollectionResponse?> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.SensitivityLabelsRequestBuilder.SensitivityLabelsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Microsoft.Graph.Beta.Models.SensitivityLabelCollectionResponse> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.SensitivityLabelsRequestBuilder.SensitivityLabelsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.SensitivityLabelsRequestBuilder.SensitivityLabelsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.SensitivityLabelsRequestBuilder.SensitivityLabelsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/dataClassification/sensitivityLabels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", PathParameters);
...
#nullable restore
...
#endif
            if(ReferenceEquals(body, null)) throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/dataClassification/sensitivityLabels", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.SensitivityLabelsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.SensitivityLabelsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.SensitivityLabelsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get sensitivityLabels from dataClassification
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SensitivityLabelsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Microsoft.Graph.Beta.DataClassification.SensitivityLabels.SensitivityLabelsRequestBuilder.SensitivityLabelsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
