...
#nullable enable
        public async Task<LookupResponse?> PostAsync(LookupPostRequestBody body, CancellationToken cancellationToken = default, Action<LookupRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<LookupResponse> PostAsync(LookupPostRequestBody body, CancellationToken cancellationToken = default, Action<LookupRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
