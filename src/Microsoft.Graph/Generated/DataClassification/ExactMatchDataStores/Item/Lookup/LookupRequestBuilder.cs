...
namespace Microsoft.Graph.Beta.DataClassification.ExactMatchDataStores.Item.Lookup {
    ...
    public class LookupRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(LookupRequestBody body, Action<LookupRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<LookupResponse> PostAsync(LookupRequestBody body, Action<LookupRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
