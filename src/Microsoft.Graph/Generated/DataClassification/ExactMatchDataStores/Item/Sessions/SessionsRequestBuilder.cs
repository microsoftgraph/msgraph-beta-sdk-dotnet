...
#nullable restore
        ...
        public async Task<ExactMatchSessionCollectionResponse> GetAsync(Action<SessionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<ExactMatchSessionCollectionResponse>(requestInfo, ExactMatchSessionCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
