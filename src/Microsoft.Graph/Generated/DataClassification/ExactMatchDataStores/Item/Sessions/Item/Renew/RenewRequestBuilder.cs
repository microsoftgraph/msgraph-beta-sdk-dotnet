...
namespace Microsoft.Graph.Beta.DataClassification.ExactMatchDataStores.Item.Sessions.Item.Renew {
    ...
    public class RenewRequestBuilder {
        ...
        /// </summary>
        public async Task<ExactMatchSession> PostAsync(Action<RenewRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
