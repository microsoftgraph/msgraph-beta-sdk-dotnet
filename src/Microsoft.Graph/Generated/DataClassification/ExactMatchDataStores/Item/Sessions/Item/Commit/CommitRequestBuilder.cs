...
namespace Microsoft.Graph.Beta.DataClassification.ExactMatchDataStores.Item.Sessions.Item.Commit {
    ...
    public class CommitRequestBuilder {
        ...
        public CommitRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/dataClassification/exactMatchDataStores/{exactMatchDataStore%2Did}/sessions/{exactMatchSession%2Did}/microsoft.graph.commit";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Action<CommitRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(Action<CommitRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
