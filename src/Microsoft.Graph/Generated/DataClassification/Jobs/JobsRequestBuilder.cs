...
#nullable enable
        public async Task<JobResponseBaseCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<JobsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<JobResponseBaseCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<JobsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<JobResponseBase?> PostAsync(JobResponseBase body, CancellationToken cancellationToken = default, Action<JobsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<JobResponseBase> PostAsync(JobResponseBase body, CancellationToken cancellationToken = default, Action<JobsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
