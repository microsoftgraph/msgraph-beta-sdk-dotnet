...
using System;
namespace Microsoft.Graph.Beta.DataClassification.Jobs.Item {
    /// <summary>
    ...
    public class JobResponseBaseItemRequestBuilder : BaseRequestBuilder {
        ...
        public JobResponseBaseItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/dataClassification/jobs/{jobResponseBase%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new JobResponseBaseItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public JobResponseBaseItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/dataClassification/jobs/{jobResponseBase%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
