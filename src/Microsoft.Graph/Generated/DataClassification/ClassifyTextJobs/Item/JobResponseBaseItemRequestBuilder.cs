...
namespace Microsoft.Graph.Beta.DataClassification.ClassifyTextJobs.Item {
    ...
    public class JobResponseBaseItemRequestBuilder : BaseRequestBuilder {
        ...
        public JobResponseBaseItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/dataClassification/classifyTextJobs/{jobResponseBase%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new JobResponseBaseItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public JobResponseBaseItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/dataClassification/classifyTextJobs/{jobResponseBase%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<JobResponseBaseItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<JobResponseBaseItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<JobResponseBase?> GetAsync(CancellationToken cancellationToken = default, Action<JobResponseBaseItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<JobResponseBase> GetAsync(CancellationToken cancellationToken = default, Action<JobResponseBaseItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<JobResponseBase?> PatchAsync(JobResponseBase body, CancellationToken cancellationToken = default, Action<JobResponseBaseItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<JobResponseBase> PatchAsync(JobResponseBase body, CancellationToken cancellationToken = default, Action<JobResponseBaseItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
