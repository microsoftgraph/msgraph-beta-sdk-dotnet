...
#nullable enable
        public async Task<JobResponseBaseCollectionResponse?> GetAsync(Action<RequestConfiguration<EvaluateDlpPoliciesJobsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<JobResponseBaseCollectionResponse> GetAsync(Action<RequestConfiguration<EvaluateDlpPoliciesJobsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<EvaluateDlpPoliciesJobsRequestBuilderGetQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<EvaluateDlpPoliciesJobsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
#endif
...
#nullable restore
        ...
        public class EvaluateDlpPoliciesJobsRequestBuilderGetRequestConfiguration : RequestConfiguration<EvaluateDlpPoliciesJobsRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
