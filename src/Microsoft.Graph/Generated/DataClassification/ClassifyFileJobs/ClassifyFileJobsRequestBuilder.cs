...
namespace Microsoft.Graph.Beta.DataClassification.ClassifyFileJobs
{
    ...
    public class ClassifyFileJobsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.DataClassification.ClassifyFileJobs.Count.CountRequestBuilder Count
        {
            get => new Microsoft.Graph.Beta.DataClassification.ClassifyFileJobs.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Microsoft.Graph.Beta.DataClassification.ClassifyFileJobs.Item.JobResponseBaseItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("jobResponseBase%2Did", position);
                return new Microsoft.Graph.Beta.DataClassification.ClassifyFileJobs.Item.JobResponseBaseItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.DataClassification.ClassifyFileJobs.ClassifyFileJobsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.DataClassification.ClassifyFileJobs.ClassifyFileJobsRequestBuilder.ClassifyFileJobsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.DataClassification.ClassifyFileJobs.ClassifyFileJobsRequestBuilder.ClassifyFileJobsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.DataClassification.ClassifyFileJobs.ClassifyFileJobsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.DataClassification.ClassifyFileJobs.ClassifyFileJobsRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.DataClassification.ClassifyFileJobs.ClassifyFileJobsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get classifyFileJobs from dataClassification
        /// </summary>
...
#nullable restore
        ...
        public class ClassifyFileJobsRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.DataClassification.ClassifyFileJobs.ClassifyFileJobsRequestBuilder.ClassifyFileJobsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
