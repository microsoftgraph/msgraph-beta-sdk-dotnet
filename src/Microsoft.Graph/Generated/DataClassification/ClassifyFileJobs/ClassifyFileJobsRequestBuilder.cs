...
namespace MicrosoftGraph.DataClassification.ClassifyFileJobs {
    ...
    public class ClassifyFileJobsRequestBuilder {
        ...
        public ClassifyFileJobsRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("jobResponseBase_id", position);
            return new ClassifyFileJobsRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public ClassifyFileJobsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/dataClassification/classifyFileJobs{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
