...
namespace Microsoft.Graph.Beta.DataClassification.ExactMatchUploadAgents.Item
{
    ...
    public partial class ExactMatchUploadAgentItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public ExactMatchUploadAgentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/dataClassification/exactMatchUploadAgents/{exactMatchUploadAgent%2Did}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.DataClassification.ExactMatchUploadAgents.Item.ExactMatchUploadAgentItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExactMatchUploadAgentItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/dataClassification/exactMatchUploadAgents/{exactMatchUploadAgent%2Did}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/dataClassification/exactMatchUploadAgents/{exactMatchUploadAgent%2Did}{?%24expand,%24select}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
