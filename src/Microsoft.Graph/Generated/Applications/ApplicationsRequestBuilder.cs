...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Application?> PostAsync(Microsoft.Graph.Beta.Models.Application body, CancellationToken cancellationToken = default, Action<ApplicationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Application> PostAsync(Microsoft.Graph.Beta.Models.Application body, CancellationToken cancellationToken = default, Action<ApplicationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
