...
namespace Microsoft.Graph.Beta.Applications.Item.FederatedIdentityCredentials.Item {
    ...
    public class FederatedIdentityCredentialItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(FederatedIdentityCredential body, Action<FederatedIdentityCredentialItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
