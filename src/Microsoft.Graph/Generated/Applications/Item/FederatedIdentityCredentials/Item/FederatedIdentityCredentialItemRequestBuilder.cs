...
namespace Microsoft.Graph.Beta.Applications.Item.FederatedIdentityCredentials.Item {
    ...
    public class FederatedIdentityCredentialItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<FederatedIdentityCredentialItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<FederatedIdentityCredential> GetAsync(CancellationToken cancellationToken = default, Action<FederatedIdentityCredentialItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(FederatedIdentityCredential body, CancellationToken cancellationToken = default, Action<FederatedIdentityCredentialItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
