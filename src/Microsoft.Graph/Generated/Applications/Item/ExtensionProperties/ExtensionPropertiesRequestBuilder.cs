...
namespace MicrosoftGraphSdk.Applications.Item.ExtensionProperties {
    ...
    public class ExtensionPropertiesRequestBuilder {
        ...
        /// </summary>
        public async Task<ExtensionPropertyCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
