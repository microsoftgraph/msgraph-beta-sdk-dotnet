...
namespace Microsoft.Graph.Beta.Applications.Item.AddPassword {
    ...
    public class AddPasswordRequestBuilder {
        ...
        /// </summary>
        public async Task<PasswordCredential> PostAsync(PasswordCredentialPostRequestBody body, CancellationToken cancellationToken = default, Action<AddPasswordRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<PasswordCredential>(requestInfo, PasswordCredential.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
