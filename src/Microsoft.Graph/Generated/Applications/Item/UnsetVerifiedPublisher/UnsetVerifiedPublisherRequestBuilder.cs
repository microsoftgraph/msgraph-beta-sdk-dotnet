...
namespace Microsoft.Graph.Beta.Applications.Item.UnsetVerifiedPublisher {
    ...
    public class UnsetVerifiedPublisherRequestBuilder {
        ...
        public UnsetVerifiedPublisherRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/applications/{application%2Did}/unsetVerifiedPublisher";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnsetVerifiedPublisherRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
