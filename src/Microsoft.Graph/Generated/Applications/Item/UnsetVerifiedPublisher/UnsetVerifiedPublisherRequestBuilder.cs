...
namespace Microsoft.Graph.Beta.Applications.Item.UnsetVerifiedPublisher {
    ...
    public class UnsetVerifiedPublisherRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<UnsetVerifiedPublisherRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
