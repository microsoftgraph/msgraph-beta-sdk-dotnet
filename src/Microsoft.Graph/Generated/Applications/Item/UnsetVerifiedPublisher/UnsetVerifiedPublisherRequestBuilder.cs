...
namespace MicrosoftGraph.Applications.Item.UnsetVerifiedPublisher {
    /// <summary>Builds and executes requests for operations under \applications\{application-id}\microsoft.graph.unsetVerifiedPublisher</summary>
