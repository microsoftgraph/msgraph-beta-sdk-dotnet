...
namespace Microsoft.Graph.Beta.Applications.Item.RemovePassword {
    ...
    public class RemovePasswordRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(RemovePasswordPostRequestBody body, CancellationToken cancellationToken = default, Action<RemovePasswordRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
