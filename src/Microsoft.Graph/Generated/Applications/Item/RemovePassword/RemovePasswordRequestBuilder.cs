...
namespace Microsoft.Graph.Beta.Applications.Item.RemovePassword {
    ...
    public class RemovePasswordRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(RemovePasswordRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
