...
namespace Microsoft.Graph.Beta.Applications.Item.RemovePassword {
    ...
    public class RemovePasswordRequestBuilder : BaseRequestBuilder {
        ...
        public RemovePasswordRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/removePassword", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RemovePasswordRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(RemovePasswordPostRequestBody body, CancellationToken cancellationToken = default, Action<RemovePasswordRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(RemovePasswordPostRequestBody body, CancellationToken cancellationToken = default, Action<RemovePasswordRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
