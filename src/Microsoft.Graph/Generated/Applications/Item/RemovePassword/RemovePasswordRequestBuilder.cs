...
namespace Microsoft.Graph.Beta.Applications.Item.RemovePassword {
    ...
    public class RemovePasswordRequestBuilder {
        ...
        public RemovePasswordRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/applications/{application%2Did}/microsoft.graph.removePassword";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(RemovePasswordPostRequestBody body, Action<RemovePasswordRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(RemovePasswordPostRequestBody body, Action<RemovePasswordRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
