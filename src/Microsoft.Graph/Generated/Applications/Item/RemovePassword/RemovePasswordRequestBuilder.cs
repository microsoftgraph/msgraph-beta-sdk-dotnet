...
namespace Microsoft.Graph.Beta.Applications.Item.RemovePassword {
    ...
    public class RemovePasswordRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(RemovePasswordRequestBody body, Action<RemovePasswordRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(RemovePasswordRequestBody body, Action<RemovePasswordRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
