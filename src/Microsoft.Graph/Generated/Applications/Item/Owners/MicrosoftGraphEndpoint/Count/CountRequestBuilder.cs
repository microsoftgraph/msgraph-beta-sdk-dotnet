...
namespace Microsoft.Graph.Beta.Applications.Item.Owners.MicrosoftGraphEndpoint.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/applications/{application%2Did}/owners/microsoft.graph.endpoint/$count{?%24search,%24filter}";
