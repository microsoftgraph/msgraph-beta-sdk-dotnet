...
using Microsoft.Graph.Beta.Applications.Item.Owners.Endpoint;
using Microsoft.Graph.Beta.Applications.Item.Owners.Item;
using Microsoft.Graph.Beta.Applications.Item.Owners.Ref;
using Microsoft.Graph.Beta.Applications.Item.Owners.ServicePrincipal;
using Microsoft.Graph.Beta.Applications.Item.Owners.User;
...
namespace Microsoft.Graph.Beta.Applications.Item.Owners {
    ...
    public class OwnersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.applications.item.owners.item collection</summary>
        ...
        public OwnersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/applications/{application%2Did}/owners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
