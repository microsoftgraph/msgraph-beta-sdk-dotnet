...
namespace Microsoft.Graph.Beta.Applications.Item.Synchronization.Secrets
{
    ...
    public partial class SecretsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Secrets.SecretsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// Update property secrets value.
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Secrets.SecretsResponse"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Microsoft.Graph.Beta.Models.ODataErrors.ODataError">When receiving a 4XX or 5XX status code</exception>
