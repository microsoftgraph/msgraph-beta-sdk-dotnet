...
using Microsoft.Graph.Beta.Applications.Item.Synchronization.Secrets;
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Synchronization?> GetAsync(CancellationToken cancellationToken = default, Action<SynchronizationRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Synchronization> GetAsync(CancellationToken cancellationToken = default, Action<SynchronizationRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Synchronization?> PutAsync(Microsoft.Graph.Beta.Models.Synchronization body, CancellationToken cancellationToken = default, Action<SynchronizationRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Synchronization> PutAsync(Microsoft.Graph.Beta.Models.Synchronization body, CancellationToken cancellationToken = default, Action<SynchronizationRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
