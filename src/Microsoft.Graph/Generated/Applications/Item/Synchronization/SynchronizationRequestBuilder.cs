...
using MicrosoftGraphSdk.Applications.Item.Synchronization.AcquireAccessToken;
using MicrosoftGraphSdk.Applications.Item.Synchronization.Jobs;
using MicrosoftGraphSdk.Applications.Item.Synchronization.Ping;
using MicrosoftGraphSdk.Applications.Item.Synchronization.Templates;
...
namespace MicrosoftGraphSdk.Applications.Item.Synchronization {
    ...
    public class SynchronizationRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.Synchronization body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MicrosoftGraphSdk.Models.Microsoft.Graph.Synchronization body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
