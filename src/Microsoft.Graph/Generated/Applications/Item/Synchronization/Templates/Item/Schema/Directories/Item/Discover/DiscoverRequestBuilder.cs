...
namespace MicrosoftGraphSdk.Applications.Item.Synchronization.Templates.Item.Schema.Directories.Item.Discover {
    /// <summary>Builds and executes requests for operations under \applications\{application-id}\synchronization\templates\{synchronizationTemplate-id}\schema\directories\{directoryDefinition-id}\microsoft.graph.discover</summary>
    public class DiscoverRequestBuilder {
        ...
        public DiscoverRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/applications/{application_id}/synchronization/templates/{synchronizationTemplate_id}/schema/directories/{directoryDefinition_id}/microsoft.graph.discover";
