...
using MicrosoftGraphSdk.Applications.Item.Synchronization.Templates.Item.Schema.Directories.Count;
...
namespace MicrosoftGraphSdk.Applications.Item.Synchronization.Templates.Item.Schema.Directories {
    ...
    public class DirectoriesRequestBuilder {
        ...
        public DirectoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/applications/{application_id}/synchronization/templates/{synchronizationTemplate_id}/schema/directories{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
