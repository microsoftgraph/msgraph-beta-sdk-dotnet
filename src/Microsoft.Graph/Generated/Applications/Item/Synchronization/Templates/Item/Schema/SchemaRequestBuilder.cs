...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SynchronizationSchema?> GetAsync(CancellationToken cancellationToken = default, Action<SchemaRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SynchronizationSchema> GetAsync(CancellationToken cancellationToken = default, Action<SchemaRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SynchronizationSchema?> PatchAsync(SynchronizationSchema body, CancellationToken cancellationToken = default, Action<SchemaRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SynchronizationSchema> PatchAsync(SynchronizationSchema body, CancellationToken cancellationToken = default, Action<SchemaRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
