...
namespace Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.Directories.Item.Discover {
    ...
    public class DiscoverRequestBuilder : BaseRequestBuilder {
        ...
        public DiscoverRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/directories/{directoryDefinition%2Did}/discover", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DiscoverRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<DirectoryDefinition?> PostAsync(CancellationToken cancellationToken = default, Action<DiscoverRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectoryDefinition> PostAsync(CancellationToken cancellationToken = default, Action<DiscoverRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
