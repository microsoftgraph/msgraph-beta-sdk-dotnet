...
namespace Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema
{
    ...
    public partial class SchemaRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.Directories.DirectoriesRequestBuilder Directories
        {
            get => new global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.Directories.DirectoriesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the filterOperators method.</summary>
        public global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.FilterOperators.FilterOperatorsRequestBuilder FilterOperators
        {
            get => new global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.FilterOperators.FilterOperatorsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the functions method.</summary>
        public global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.Functions.FunctionsRequestBuilder Functions
        {
            get => new global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.Functions.FunctionsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the parseExpression method.</summary>
        public global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.ParseExpression.ParseExpressionRequestBuilder ParseExpression
        {
            get => new global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.ParseExpression.ParseExpressionRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.SchemaRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.SchemaRequestBuilder.SchemaRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.SchemaRequestBuilder.SchemaRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.SchemaRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.SchemaRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.SchemaRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SchemaRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.SchemaRequestBuilder.SchemaRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
