...
namespace Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs.Item.Schema.Functions {
    ...
    public class FunctionsRequestBuilder {
        ...
        public FunctionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/functions(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
