...
namespace MicrosoftGraph.Applications.Item.Synchronization.Jobs.Item.Schema.Directories {
    /// <summary>Builds and executes requests for operations under \applications\{application-id}\synchronization\jobs\{synchronizationJob-id}\schema\directories</summary>
    public class DirectoriesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.applications.item.synchronization.jobs.item.schema.directories.item collection</summary>
