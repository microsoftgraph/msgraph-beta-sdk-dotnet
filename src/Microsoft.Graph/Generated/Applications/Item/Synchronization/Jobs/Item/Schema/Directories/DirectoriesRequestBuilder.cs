...
using MicrosoftGraphSdk.Applications.Item.Synchronization.Jobs.Item.Schema.Directories.Count;
using MicrosoftGraphSdk.Applications.Item.Synchronization.Jobs.Item.Schema.Directories.Item;
...
namespace MicrosoftGraphSdk.Applications.Item.Synchronization.Jobs.Item.Schema.Directories {
    ...
    public class DirectoriesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.applications.item.synchronization.jobs.item.schema.directories.item collection</summary>
        ...
        public DirectoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/applications/{application_id}/synchronization/jobs/{synchronizationJob_id}/schema/directories{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DirectoryDefinition body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// </summary>
        public async Task<DirectoryDefinitionCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
