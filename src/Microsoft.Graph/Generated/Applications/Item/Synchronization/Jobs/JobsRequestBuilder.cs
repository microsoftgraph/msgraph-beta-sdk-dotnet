...
namespace Microsoft.Graph.Beta.Applications.Item.Synchronization.Jobs {
    ...
    public class JobsRequestBuilder {
        ...
        /// </summary>
        public async Task<SynchronizationJobCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<JobsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SynchronizationJob> PostAsync(SynchronizationJob body, CancellationToken cancellationToken = default, Action<JobsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
