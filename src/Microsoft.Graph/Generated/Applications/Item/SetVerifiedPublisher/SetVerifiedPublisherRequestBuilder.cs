...
namespace Microsoft.Graph.Beta.Applications.Item.SetVerifiedPublisher {
    ...
    public class SetVerifiedPublisherRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(SetVerifiedPublisherPostRequestBody body, CancellationToken cancellationToken = default, Action<SetVerifiedPublisherRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
