...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.Applications.Item.AppManagementPolicies {
    public class AppManagementPoliciesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as AppManagementPoliciesResponse).Value = n.GetCollectionOfObjectValues<AppManagementPolicy>().ToList(); } },
            };
        }
        /// <summary>
