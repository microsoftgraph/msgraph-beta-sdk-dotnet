...
namespace Microsoft.Graph.Beta.Applications.Item.ConnectorGroup {
    ...
    public class ConnectorGroupRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.ConnectorGroup> GetAsync(Action<ConnectorGroupRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
