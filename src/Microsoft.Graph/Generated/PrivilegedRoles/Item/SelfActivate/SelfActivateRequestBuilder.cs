...
namespace Microsoft.Graph.Beta.PrivilegedRoles.Item.SelfActivate {
    ...
    public class SelfActivateRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SelfActivateRequestBody body, Action<SelfActivateRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<PrivilegedRoleAssignment> PostAsync(SelfActivateRequestBody body, Action<SelfActivateRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
