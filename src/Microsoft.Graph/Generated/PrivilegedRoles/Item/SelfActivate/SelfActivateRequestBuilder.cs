...
#nullable enable
        public async Task<PrivilegedRoleAssignment?> PostAsync(SelfActivatePostRequestBody body, CancellationToken cancellationToken = default, Action<SelfActivateRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrivilegedRoleAssignment> PostAsync(SelfActivatePostRequestBody body, CancellationToken cancellationToken = default, Action<SelfActivateRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
