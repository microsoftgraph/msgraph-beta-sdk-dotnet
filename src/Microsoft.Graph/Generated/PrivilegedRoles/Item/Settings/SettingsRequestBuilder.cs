...
using System;
namespace Microsoft.Graph.Beta.PrivilegedRoles.Item.Settings {
    /// <summary>
    ...
    public class SettingsRequestBuilder : BaseRequestBuilder {
        ...
        public SettingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/privilegedRoles/{privilegedRole%2Did}/settings{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SettingsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SettingsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/privilegedRoles/{privilegedRole%2Did}/settings{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
