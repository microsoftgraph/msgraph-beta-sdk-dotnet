...
namespace Microsoft.Graph.Beta.PrivilegedRoles.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder {
        ...
        /// </summary>
        public async Task<PrivilegedRoleAssignmentCollectionResponse> GetAsync(Action<AssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <summary>Retrieve a list of privilegedRoleAssignment objects that are associated with the role. Each privilegedRoleAssignment represents a role assignment to a user.</summary>
