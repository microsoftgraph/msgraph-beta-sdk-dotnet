...
using MicrosoftGraph.Invitations.Item.InvitedUser;
...
namespace MicrosoftGraph.Invitations.Item {
    ...
    public class InvitationRequestBuilder {
        ...
        /// </summary>
        public InvitationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/invitations/{invitation_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public InvitationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
