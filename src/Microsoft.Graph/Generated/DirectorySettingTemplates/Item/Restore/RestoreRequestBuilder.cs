...
namespace Microsoft.Graph.Beta.DirectorySettingTemplates.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        /// </summary>
        public async Task<DirectoryObject> PostAsync(CancellationToken cancellationToken = default, Action<RestoreRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
