...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.DirectorySettingTemplates.Item.CheckMemberGroups {
    /// <summary>Provides operations to call the checkMemberGroups method.</summary>
    public class CheckMemberGroupsResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as CheckMemberGroupsResponse).Value = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
            };
        }
        /// <summary>
