...
namespace Microsoft.Graph.Beta.DirectorySettingTemplates.Item {
    ...
    public class DirectorySettingTemplateItemRequestBuilder : BaseRequestBuilder {
        ...
        public DirectorySettingTemplateItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directorySettingTemplates/{directorySettingTemplate%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DirectorySettingTemplateItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DirectorySettingTemplateItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directorySettingTemplates/{directorySettingTemplate%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DirectorySettingTemplateItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DirectorySettingTemplateItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DirectorySettingTemplate?> GetAsync(CancellationToken cancellationToken = default, Action<DirectorySettingTemplateItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectorySettingTemplate> GetAsync(CancellationToken cancellationToken = default, Action<DirectorySettingTemplateItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DirectorySettingTemplate?> PatchAsync(DirectorySettingTemplate body, CancellationToken cancellationToken = default, Action<DirectorySettingTemplateItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectorySettingTemplate> PatchAsync(DirectorySettingTemplate body, CancellationToken cancellationToken = default, Action<DirectorySettingTemplateItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
