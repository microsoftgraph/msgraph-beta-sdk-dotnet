...
namespace Microsoft.Graph.Beta.DirectorySettingTemplates.Item.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetMemberObjectsPostResponse"></returns>
...
#nullable restore
        ...
        /// Invoke action getMemberObjects
        /// </summary>
        /// <returns>A <cref="GetMemberObjectsResponse"></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetMemberObjectsRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
