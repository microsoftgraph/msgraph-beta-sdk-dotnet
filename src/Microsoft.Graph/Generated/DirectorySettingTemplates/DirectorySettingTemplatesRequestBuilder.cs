...
namespace MicrosoftGraph.DirectorySettingTemplates {
    ...
    public class DirectorySettingTemplatesRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DirectorySettingTemplate body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
