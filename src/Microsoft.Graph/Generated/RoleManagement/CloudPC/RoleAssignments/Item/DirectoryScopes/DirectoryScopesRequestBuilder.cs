...
using MicrosoftGraphSdk.RoleManagement.CloudPC.RoleAssignments.Item.DirectoryScopes.Count;
using MicrosoftGraphSdk.RoleManagement.CloudPC.RoleAssignments.Item.DirectoryScopes.Item;
using System;
...
namespace MicrosoftGraphSdk.RoleManagement.CloudPC.RoleAssignments.Item.DirectoryScopes {
    ...
    public class DirectoryScopesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.roleManagement.cloudPC.roleAssignments.item.directoryScopes.item collection</summary>
