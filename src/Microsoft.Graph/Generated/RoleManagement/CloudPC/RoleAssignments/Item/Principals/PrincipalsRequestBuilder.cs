...
namespace Microsoft.Graph.Beta.RoleManagement.CloudPC.RoleAssignments.Item.Principals {
    ...
    public class PrincipalsRequestBuilder {
        ...
        public PrincipalsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultiple_id}/principals{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
