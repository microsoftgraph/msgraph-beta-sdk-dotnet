...
using MicrosoftGraphSdk.RoleManagement.CloudPC.RoleAssignments.Item.Principals.Count;
using MicrosoftGraphSdk.RoleManagement.CloudPC.RoleAssignments.Item.Principals.Item;
using System;
...
namespace MicrosoftGraphSdk.RoleManagement.CloudPC.RoleAssignments.Item.Principals {
    ...
    public class PrincipalsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.roleManagement.cloudPC.roleAssignments.item.principals.item collection</summary>
