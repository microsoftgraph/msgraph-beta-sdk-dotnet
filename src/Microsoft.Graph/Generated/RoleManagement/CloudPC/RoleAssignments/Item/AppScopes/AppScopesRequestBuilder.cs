...
#nullable enable
        public async Task<AppScopeCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AppScopesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AppScopeCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AppScopesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.AppScope?> PostAsync(Microsoft.Graph.Beta.Models.AppScope body, CancellationToken cancellationToken = default, Action<AppScopesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.AppScope> PostAsync(Microsoft.Graph.Beta.Models.AppScope body, CancellationToken cancellationToken = default, Action<AppScopesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
