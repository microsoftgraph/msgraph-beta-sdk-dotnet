...
namespace MicrosoftGraphSdk.RoleManagement.CloudPC.RoleDefinitions.Item.InheritsPermissionsFrom.Item {
    /// <summary>Builds and executes requests for operations under \roleManagement\cloudPC\roleDefinitions\{unifiedRoleDefinition-id}\inheritsPermissionsFrom\{unifiedRoleDefinition-id1}</summary>
    public class UnifiedRoleDefinitionItemRequestBuilder {
        ...
        public UnifiedRoleDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/cloudPC/roleDefinitions/{unifiedRoleDefinition_id}/inheritsPermissionsFrom/{unifiedRoleDefinition_id1}{?select,expand}";
