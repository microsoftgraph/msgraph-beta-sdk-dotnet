...
using MicrosoftGraphSdk.RoleManagement.CloudPC.RoleDefinitions.Item;
using System;
...
namespace MicrosoftGraphSdk.RoleManagement.CloudPC.RoleDefinitions {
    /// <summary>Builds and executes requests for operations under \roleManagement\cloudPC\roleDefinitions</summary>
    public class RoleDefinitionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.roleManagement.cloudPC.roleDefinitions.item collection</summary>
        ...
        public RoleDefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/cloudPC/roleDefinitions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
