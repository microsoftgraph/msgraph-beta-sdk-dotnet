...
namespace Microsoft.Graph.Beta.RoleManagement.CloudPC.ResourceNamespaces.Item.ResourceActions.Item.ResourceScope {
    ...
    public class ResourceScopeRequestBuilder {
        ...
        public ResourceScopeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/cloudPC/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}/resourceScope{?%24select,%24expand}";
