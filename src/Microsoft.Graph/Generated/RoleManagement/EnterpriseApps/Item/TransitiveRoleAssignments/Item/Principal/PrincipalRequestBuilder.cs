...
namespace Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.TransitiveRoleAssignments.Item.Principal
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.TransitiveRoleAssignments.Item.Principal.PrincipalRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.TransitiveRoleAssignments.Item.Principal.PrincipalRequestBuilder.PrincipalRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.TransitiveRoleAssignments.Item.Principal.PrincipalRequestBuilder.PrincipalRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.TransitiveRoleAssignments.Item.Principal.PrincipalRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.TransitiveRoleAssignments.Item.Principal.PrincipalRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.TransitiveRoleAssignments.Item.Principal.PrincipalRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// The assigned principal. Provided so that callers can get the principal using $expand at the same time as getting the role assignment. Read-only. Supports $expand.
        /// </summary>
...
#nullable restore
        ...
        public class PrincipalRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.TransitiveRoleAssignments.Item.Principal.PrincipalRequestBuilder.PrincipalRequestBuilderGetQueryParameters>
        {
        }
    }
}
