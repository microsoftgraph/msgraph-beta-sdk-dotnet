...
using Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.RoleEligibilitySchedules.Count;
using Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.RoleEligibilitySchedules.FilterByCurrentUserWithOn;
using Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.RoleEligibilitySchedules.Item;
...
using System;
namespace Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.RoleEligibilitySchedules {
    /// <summary>
    ...
    public class RoleEligibilitySchedulesRequestBuilder : BaseRequestBuilder {
        ...
        public RoleEligibilitySchedulesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilitySchedules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RoleEligibilitySchedulesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RoleEligibilitySchedulesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilitySchedules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
