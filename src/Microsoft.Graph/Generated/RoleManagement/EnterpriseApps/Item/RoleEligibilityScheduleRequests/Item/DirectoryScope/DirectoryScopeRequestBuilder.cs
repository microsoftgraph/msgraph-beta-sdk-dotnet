...
using System;
namespace Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.RoleEligibilityScheduleRequests.Item.DirectoryScope {
    /// <summary>
    ...
    public class DirectoryScopeRequestBuilder : BaseRequestBuilder {
        ...
        public DirectoryScopeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/directoryScope{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DirectoryScopeRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DirectoryScopeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/directoryScope{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DirectoryObject?> GetAsync(CancellationToken cancellationToken = default, Action<DirectoryScopeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectoryObject> GetAsync(CancellationToken cancellationToken = default, Action<DirectoryScopeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
