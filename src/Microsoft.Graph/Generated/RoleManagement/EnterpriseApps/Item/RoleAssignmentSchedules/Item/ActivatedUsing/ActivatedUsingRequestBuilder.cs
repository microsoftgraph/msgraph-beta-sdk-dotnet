...
using System;
namespace Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.RoleAssignmentSchedules.Item.ActivatedUsing {
    /// <summary>
    ...
    public class ActivatedUsingRequestBuilder : BaseRequestBuilder {
        ...
        public ActivatedUsingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule%2Did}/activatedUsing{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ActivatedUsingRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ActivatedUsingRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule%2Did}/activatedUsing{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
