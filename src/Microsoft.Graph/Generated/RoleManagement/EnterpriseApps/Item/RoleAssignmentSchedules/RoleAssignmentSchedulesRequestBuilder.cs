...
using Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.RoleAssignmentSchedules.Count;
using Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.RoleAssignmentSchedules.FilterByCurrentUserWithOn;
using Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.RoleAssignmentSchedules.Item;
...
using System;
namespace Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.RoleAssignmentSchedules {
    /// <summary>
    ...
    public class RoleAssignmentSchedulesRequestBuilder : BaseRequestBuilder {
        ...
        public RoleAssignmentSchedulesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleAssignmentSchedules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RoleAssignmentSchedulesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RoleAssignmentSchedulesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleAssignmentSchedules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
