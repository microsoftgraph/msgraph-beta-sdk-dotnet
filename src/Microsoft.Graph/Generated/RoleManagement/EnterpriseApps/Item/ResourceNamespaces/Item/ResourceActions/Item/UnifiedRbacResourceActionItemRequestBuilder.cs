...
using Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.ResourceNamespaces.Item.ResourceActions.Item.AuthenticationContext;
using Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.ResourceNamespaces.Item.ResourceActions.Item.ResourceScope;
...
using System;
namespace Microsoft.Graph.Beta.RoleManagement.EnterpriseApps.Item.ResourceNamespaces.Item.ResourceActions.Item {
    /// <summary>
    ...
    public class UnifiedRbacResourceActionItemRequestBuilder : BaseRequestBuilder {
        ...
        public UnifiedRbacResourceActionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UnifiedRbacResourceActionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnifiedRbacResourceActionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
