...
#nullable enable
        public async Task<UnifiedRoleEligibilitySchedule?> GetAsync(CancellationToken cancellationToken = default, Action<ActivatedUsingRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleEligibilitySchedule> GetAsync(CancellationToken cancellationToken = default, Action<ActivatedUsingRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
