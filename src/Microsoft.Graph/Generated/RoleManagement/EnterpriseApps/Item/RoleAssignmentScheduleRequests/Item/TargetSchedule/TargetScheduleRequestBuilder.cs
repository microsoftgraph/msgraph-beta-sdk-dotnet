...
#nullable enable
        public async Task<UnifiedRoleAssignmentSchedule?> GetAsync(CancellationToken cancellationToken = default, Action<TargetScheduleRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleAssignmentSchedule> GetAsync(CancellationToken cancellationToken = default, Action<TargetScheduleRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
