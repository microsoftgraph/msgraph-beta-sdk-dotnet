...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ExchangeRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ExchangeRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRbacApplication?> GetAsync(CancellationToken cancellationToken = default, Action<ExchangeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRbacApplication> GetAsync(CancellationToken cancellationToken = default, Action<ExchangeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRbacApplication?> PatchAsync(UnifiedRbacApplication body, CancellationToken cancellationToken = default, Action<ExchangeRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRbacApplication> PatchAsync(UnifiedRbacApplication body, CancellationToken cancellationToken = default, Action<ExchangeRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
