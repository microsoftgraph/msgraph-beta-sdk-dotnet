...
using Microsoft.Graph.Beta.RoleManagement.Exchange.RoleAssignments.Item.AppScope;
using Microsoft.Graph.Beta.RoleManagement.Exchange.RoleAssignments.Item.DirectoryScope;
using Microsoft.Graph.Beta.RoleManagement.Exchange.RoleAssignments.Item.Principal;
using Microsoft.Graph.Beta.RoleManagement.Exchange.RoleAssignments.Item.RoleDefinition;
...
using System;
namespace Microsoft.Graph.Beta.RoleManagement.Exchange.RoleAssignments.Item {
    /// <summary>
    ...
    public class UnifiedRoleAssignmentItemRequestBuilder : BaseRequestBuilder {
        ...
        public UnifiedRoleAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/exchange/roleAssignments/{unifiedRoleAssignment%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UnifiedRoleAssignmentItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnifiedRoleAssignmentItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/exchange/roleAssignments/{unifiedRoleAssignment%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Stream?> DeleteAsync(Action<UnifiedRoleAssignmentItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> DeleteAsync(Action<UnifiedRoleAssignmentItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
