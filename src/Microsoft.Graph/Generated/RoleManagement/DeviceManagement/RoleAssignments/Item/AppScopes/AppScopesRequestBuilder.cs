...
namespace Microsoft.Graph.Beta.RoleManagement.DeviceManagement.RoleAssignments.Item.AppScopes {
    ...
    public class AppScopesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.roleManagement.deviceManagement.roleAssignments.item.appScopes.item collection</summary>
        ...
        public AppScopesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/deviceManagement/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}/appScopes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
