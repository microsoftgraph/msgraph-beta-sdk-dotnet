...
namespace MicrosoftGraphSdk.RoleManagement.DeviceManagement.RoleAssignments.Item.DirectoryScopes {
    ...
    public class DirectoryScopesRequestBuilder {
        ...
        /// </summary>
        public async Task<DirectoryScopesResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<DirectoryScopesResponse>(requestInfo, DirectoryScopesResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
