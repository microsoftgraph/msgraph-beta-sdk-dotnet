...
using MicrosoftGraphSdk.RoleManagement.DeviceManagement.RoleAssignments.Item.Principals.Count;
using MicrosoftGraphSdk.RoleManagement.DeviceManagement.RoleAssignments.Item.Principals.Item;
using System;
...
namespace MicrosoftGraphSdk.RoleManagement.DeviceManagement.RoleAssignments.Item.Principals {
    ...
    public class PrincipalsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.roleManagement.deviceManagement.roleAssignments.item.principals.item collection</summary>
