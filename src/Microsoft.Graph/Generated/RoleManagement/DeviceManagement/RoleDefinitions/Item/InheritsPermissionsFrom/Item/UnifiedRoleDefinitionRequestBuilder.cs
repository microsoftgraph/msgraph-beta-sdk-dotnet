...
namespace MicrosoftGraph.RoleManagement.DeviceManagement.RoleDefinitions.Item.InheritsPermissionsFrom.Item {
    /// <summary>Builds and executes requests for operations under \roleManagement\deviceManagement\roleDefinitions\{unifiedRoleDefinition-id}\inheritsPermissionsFrom\{unifiedRoleDefinition-id1}</summary>
    public class UnifiedRoleDefinitionRequestBuilder {
        ...
        public UnifiedRoleDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/deviceManagement/roleDefinitions/{unifiedRoleDefinition_id}/inheritsPermissionsFrom/{unifiedRoleDefinition_id1}{?select,expand}";
