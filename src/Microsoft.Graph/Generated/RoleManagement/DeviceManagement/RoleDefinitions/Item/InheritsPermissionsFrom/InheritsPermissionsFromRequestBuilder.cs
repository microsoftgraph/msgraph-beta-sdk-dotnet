...
namespace MicrosoftGraphSdk.RoleManagement.DeviceManagement.RoleDefinitions.Item.InheritsPermissionsFrom {
    ...
    public class InheritsPermissionsFromRequestBuilder {
        ...
        public InheritsPermissionsFromRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/deviceManagement/roleDefinitions/{unifiedRoleDefinition_id}/inheritsPermissionsFrom{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
