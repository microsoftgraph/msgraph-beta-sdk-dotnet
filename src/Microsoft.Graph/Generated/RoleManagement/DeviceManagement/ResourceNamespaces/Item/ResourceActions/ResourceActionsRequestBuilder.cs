...
using MicrosoftGraph.RoleManagement.DeviceManagement.ResourceNamespaces.Item.ResourceActions.Item;
using System;
...
namespace MicrosoftGraph.RoleManagement.DeviceManagement.ResourceNamespaces.Item.ResourceActions {
    /// <summary>Builds and executes requests for operations under \roleManagement\deviceManagement\resourceNamespaces\{unifiedRbacResourceNamespace-id}\resourceActions</summary>
    public class ResourceActionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.roleManagement.deviceManagement.resourceNamespaces.item.resourceActions.item collection</summary>
