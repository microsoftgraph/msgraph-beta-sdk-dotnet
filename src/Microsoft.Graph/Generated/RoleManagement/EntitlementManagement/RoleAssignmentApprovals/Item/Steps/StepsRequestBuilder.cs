...
using MicrosoftGraphSdk.RoleManagement.EntitlementManagement.RoleAssignmentApprovals.Item.Steps.Item;
using System;
...
namespace MicrosoftGraphSdk.RoleManagement.EntitlementManagement.RoleAssignmentApprovals.Item.Steps {
    /// <summary>Builds and executes requests for operations under \roleManagement\entitlementManagement\roleAssignmentApprovals\{approval-id}\steps</summary>
    public class StepsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.roleManagement.entitlementManagement.roleAssignmentApprovals.item.steps.item collection</summary>
