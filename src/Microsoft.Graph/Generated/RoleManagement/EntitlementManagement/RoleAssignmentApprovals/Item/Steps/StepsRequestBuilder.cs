...
using MicrosoftGraph.RoleManagement.EntitlementManagement.RoleAssignmentApprovals.Item.Steps.Item;
using System;
...
namespace MicrosoftGraph.RoleManagement.EntitlementManagement.RoleAssignmentApprovals.Item.Steps {
    ...
    public class StepsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.roleManagement.entitlementManagement.roleAssignmentApprovals.item.steps.item collection</summary>
