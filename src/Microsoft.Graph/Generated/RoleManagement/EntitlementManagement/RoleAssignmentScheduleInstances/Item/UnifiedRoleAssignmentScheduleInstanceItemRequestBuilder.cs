...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleAssignmentScheduleInstanceItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleAssignmentScheduleInstanceItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleAssignmentScheduleInstance?> GetAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleAssignmentScheduleInstanceItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleAssignmentScheduleInstance> GetAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleAssignmentScheduleInstanceItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleAssignmentScheduleInstance?> PatchAsync(UnifiedRoleAssignmentScheduleInstance body, CancellationToken cancellationToken = default, Action<UnifiedRoleAssignmentScheduleInstanceItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleAssignmentScheduleInstance> PatchAsync(UnifiedRoleAssignmentScheduleInstance body, CancellationToken cancellationToken = default, Action<UnifiedRoleAssignmentScheduleInstanceItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
