...
namespace Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleAssignments
{
    ...
    public class RoleAssignmentsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleAssignments.Count.CountRequestBuilder Count
        {
            get => new Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleAssignments.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleAssignments.Item.UnifiedRoleAssignmentItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("unifiedRoleAssignment%2Did", position);
                return new Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleAssignments.Item.UnifiedRoleAssignmentItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleAssignments.RoleAssignmentsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleAssignments.RoleAssignmentsRequestBuilder.RoleAssignmentsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleAssignments.RoleAssignmentsRequestBuilder.RoleAssignmentsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleAssignments.RoleAssignmentsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleAssignments.RoleAssignmentsRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleAssignments.RoleAssignmentsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get a list of unifiedRoleAssignment objects for the provider. The following RBAC providers are currently supported:- directory (Microsoft Entra ID)- entitlement management (Microsoft Entra entitlement management)- Exchange Online
        /// </summary>
...
#nullable restore
        ...
        public class RoleAssignmentsRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleAssignments.RoleAssignmentsRequestBuilder.RoleAssignmentsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
