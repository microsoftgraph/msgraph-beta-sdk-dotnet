...
using MicrosoftGraphSdk.RoleManagement.EntitlementManagement.RoleEligibilityScheduleRequests.Count;
...
namespace MicrosoftGraphSdk.RoleManagement.EntitlementManagement.RoleEligibilityScheduleRequests {
    ...
    public class RoleEligibilityScheduleRequestsRequestBuilder {
        ...
        /// </summary>
        public async Task<UnifiedRoleEligibilityScheduleRequestCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
