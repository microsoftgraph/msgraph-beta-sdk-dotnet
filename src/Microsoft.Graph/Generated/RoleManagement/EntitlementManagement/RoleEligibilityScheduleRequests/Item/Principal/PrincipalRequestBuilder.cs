...
namespace Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleEligibilityScheduleRequests.Item.Principal {
    ...
    public class PrincipalRequestBuilder {
        ...
        /// </summary>
        public async Task<DirectoryObject> GetAsync(CancellationToken cancellationToken = default, Action<PrincipalRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
