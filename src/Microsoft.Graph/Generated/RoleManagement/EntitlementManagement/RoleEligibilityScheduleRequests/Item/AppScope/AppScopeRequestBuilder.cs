...
namespace Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleEligibilityScheduleRequests.Item.AppScope {
    ...
    public class AppScopeRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.AppScope> GetAsync(Action<AppScopeRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
