...
using Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.TransitiveRoleAssignments.Item.AppScope;
using Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.TransitiveRoleAssignments.Item.DirectoryScope;
using Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.TransitiveRoleAssignments.Item.Principal;
using Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.TransitiveRoleAssignments.Item.RoleDefinition;
...
using System;
namespace Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.TransitiveRoleAssignments.Item {
    /// <summary>
    ...
    public class UnifiedRoleAssignmentItemRequestBuilder : BaseRequestBuilder {
        ...
        public UnifiedRoleAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UnifiedRoleAssignmentItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnifiedRoleAssignmentItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
