...
using MicrosoftGraphSdk.RoleManagement.EntitlementManagement.TransitiveRoleAssignments.Item.DirectoryScope.Ref;
using System;
...
namespace MicrosoftGraphSdk.RoleManagement.EntitlementManagement.TransitiveRoleAssignments.Item.DirectoryScope {
    /// <summary>Builds and executes requests for operations under \roleManagement\entitlementManagement\transitiveRoleAssignments\{unifiedRoleAssignment-id}\directoryScope</summary>
    public class DirectoryScopeRequestBuilder {
        ...
        public DirectoryScopeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/entitlementManagement/transitiveRoleAssignments/{unifiedRoleAssignment_id}/directoryScope{?select,expand}";
