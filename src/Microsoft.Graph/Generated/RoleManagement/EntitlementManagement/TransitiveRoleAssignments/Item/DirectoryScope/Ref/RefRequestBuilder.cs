...
namespace MicrosoftGraphSdk.RoleManagement.EntitlementManagement.TransitiveRoleAssignments.Item.DirectoryScope.Ref {
    /// <summary>Builds and executes requests for operations under \roleManagement\entitlementManagement\transitiveRoleAssignments\{unifiedRoleAssignment-id}\directoryScope\$ref</summary>
    public class RefRequestBuilder {
        ...
        public RefRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/entitlementManagement/transitiveRoleAssignments/{unifiedRoleAssignment_id}/directoryScope/$ref";
