...
namespace Microsoft.Graph.Beta.RoleManagement.EntitlementManagement.RoleDefinitions.Item.AssignedPrincipalsWithTransitiveWithDirectoryScopeTypeWithDirectoryScopeId {
    ...
    public class AssignedPrincipalsWithTransitiveWithDirectoryScopeTypeWithDirectoryScopeIdRequestBuilder {
        ...
        public AssignedPrincipalsWithTransitiveWithDirectoryScopeTypeWithDirectoryScopeIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleDefinitions/{unifiedRoleDefinition%2Did}/microsoft.graph.assignedPrincipals(transitive={transitive},directoryScopeType='{directoryScopeType}',directoryScopeId='{directoryScopeId}'){?transitive,directoryScopeType,directoryScopeId}";
