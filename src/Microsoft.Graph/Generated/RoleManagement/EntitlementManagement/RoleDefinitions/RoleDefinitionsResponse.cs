...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.RoleManagement.EntitlementManagement.RoleDefinitions {
    public class RoleDefinitionsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as RoleDefinitionsResponse).Value = n.GetCollectionOfObjectValues<UnifiedRoleDefinition>(UnifiedRoleDefinition.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
