...
using MicrosoftGraph.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.FilterByCurrentUserWithOn;
using System;
...
namespace MicrosoftGraph.RoleManagement.EntitlementManagement.RoleAssignmentSchedules {
    /// <summary>Builds and executes requests for operations under \roleManagement\entitlementManagement\roleAssignmentSchedules</summary>
    public class RoleAssignmentSchedulesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.roleManagement.entitlementManagement.roleAssignmentSchedules.item collection</summary>
        public RoleAssignmentSchedulesRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("unifiedRoleAssignmentSchedule_id", position);
            return new RoleAssignmentSchedulesRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
