...
#nullable enable
        public async Task<UnifiedRoleAssignmentScheduleCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<RoleAssignmentSchedulesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleAssignmentScheduleCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RoleAssignmentSchedulesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleAssignmentSchedule?> PostAsync(UnifiedRoleAssignmentSchedule body, CancellationToken cancellationToken = default, Action<RoleAssignmentSchedulesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleAssignmentSchedule> PostAsync(UnifiedRoleAssignmentSchedule body, CancellationToken cancellationToken = default, Action<RoleAssignmentSchedulesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
