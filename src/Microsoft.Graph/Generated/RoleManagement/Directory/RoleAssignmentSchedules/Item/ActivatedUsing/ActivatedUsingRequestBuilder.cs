...
using MicrosoftGraphSdk.RoleManagement.Directory.RoleAssignmentSchedules.Item.ActivatedUsing.Ref;
using System;
...
namespace MicrosoftGraphSdk.RoleManagement.Directory.RoleAssignmentSchedules.Item.ActivatedUsing {
    /// <summary>Builds and executes requests for operations under \roleManagement\directory\roleAssignmentSchedules\{unifiedRoleAssignmentSchedule-id}\activatedUsing</summary>
    public class ActivatedUsingRequestBuilder {
        ...
        public ActivatedUsingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule_id}/activatedUsing{?select,expand}";
