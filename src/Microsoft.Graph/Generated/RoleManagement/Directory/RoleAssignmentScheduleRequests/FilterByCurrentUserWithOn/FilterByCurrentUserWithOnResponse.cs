...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.RoleManagement.Directory.RoleAssignmentScheduleRequests.FilterByCurrentUserWithOn {
    ...
    public class FilterByCurrentUserWithOnResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as FilterByCurrentUserWithOnResponse).Value = n.GetCollectionOfObjectValues<UnifiedRoleAssignmentScheduleRequest>(UnifiedRoleAssignmentScheduleRequest.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
