...
using MicrosoftGraphSdk.RoleManagement.Directory.RoleAssignmentScheduleRequests.Item.ActivatedUsing.Ref;
using System;
...
namespace MicrosoftGraphSdk.RoleManagement.Directory.RoleAssignmentScheduleRequests.Item.ActivatedUsing {
    /// <summary>Builds and executes requests for operations under \roleManagement\directory\roleAssignmentScheduleRequests\{unifiedRoleAssignmentScheduleRequest-id}\activatedUsing</summary>
    public class ActivatedUsingRequestBuilder {
        ...
        public ActivatedUsingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest_id}/activatedUsing{?select,expand}";
