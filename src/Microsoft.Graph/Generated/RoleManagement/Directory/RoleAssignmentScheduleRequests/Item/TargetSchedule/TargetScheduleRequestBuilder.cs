...
namespace Microsoft.Graph.Beta.RoleManagement.Directory.RoleAssignmentScheduleRequests.Item.TargetSchedule {
    ...
    public class TargetScheduleRequestBuilder {
        ...
        /// </summary>
        public async Task<UnifiedRoleAssignmentSchedule> GetAsync(Action<TargetScheduleRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
