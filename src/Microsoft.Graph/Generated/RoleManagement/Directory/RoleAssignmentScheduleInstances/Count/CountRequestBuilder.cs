...
namespace Microsoft.Graph.Beta.RoleManagement.Directory.RoleAssignmentScheduleInstances.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/roleAssignmentScheduleInstances/$count";
