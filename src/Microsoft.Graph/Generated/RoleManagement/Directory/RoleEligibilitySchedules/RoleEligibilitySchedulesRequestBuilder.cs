...
namespace Microsoft.Graph.Beta.RoleManagement.Directory.RoleEligibilitySchedules {
    ...
    public class RoleEligibilitySchedulesRequestBuilder {
        ...
        /// </summary>
        public async Task<UnifiedRoleEligibilityScheduleCollectionResponse> GetAsync(Action<RoleEligibilitySchedulesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UnifiedRoleEligibilitySchedule> PostAsync(UnifiedRoleEligibilitySchedule body, Action<RoleEligibilitySchedulesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
