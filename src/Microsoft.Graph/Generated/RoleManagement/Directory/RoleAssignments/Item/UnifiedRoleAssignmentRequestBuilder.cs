...
using MicrosoftGraph.RoleManagement.Directory.RoleAssignments.Item.AppScope;
using MicrosoftGraph.RoleManagement.Directory.RoleAssignments.Item.DirectoryScope;
using MicrosoftGraph.RoleManagement.Directory.RoleAssignments.Item.Principal;
using MicrosoftGraph.RoleManagement.Directory.RoleAssignments.Item.RoleDefinition;
using System;
...
namespace MicrosoftGraph.RoleManagement.Directory.RoleAssignments.Item {
    ...
    public class UnifiedRoleAssignmentRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(UnifiedRoleAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
