...
using MicrosoftGraphSdk.RoleManagement.Directory.ResourceNamespaces.Item.ResourceActions.Item;
using System;
...
namespace MicrosoftGraphSdk.RoleManagement.Directory.ResourceNamespaces.Item.ResourceActions {
    /// <summary>Builds and executes requests for operations under \roleManagement\directory\resourceNamespaces\{unifiedRbacResourceNamespace-id}\resourceActions</summary>
    public class ResourceActionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.roleManagement.directory.resourceNamespaces.item.resourceActions.item collection</summary>
        ...
        public ResourceActionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/resourceNamespaces/{unifiedRbacResourceNamespace_id}/resourceActions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
