...
using MicrosoftGraph.RoleManagement.Directory.ResourceNamespaces.Item.ResourceActions.Item;
using System;
...
namespace MicrosoftGraph.RoleManagement.Directory.ResourceNamespaces.Item.ResourceActions {
    ...
    public class ResourceActionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.roleManagement.directory.resourceNamespaces.item.resourceActions.item collection</summary>
