...
namespace MicrosoftGraphSdk.RoleManagement.Directory.TransitiveRoleAssignments.Item.DirectoryScope.Ref {
    /// <summary>Builds and executes requests for operations under \roleManagement\directory\transitiveRoleAssignments\{unifiedRoleAssignment-id}\directoryScope\$ref</summary>
    public class RefRequestBuilder {
        ...
        public RefRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment_id}/directoryScope/$ref";
