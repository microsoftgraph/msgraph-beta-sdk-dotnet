...
using MicrosoftGraphSdk.RoleManagement.Directory.TransitiveRoleAssignments.Item.DirectoryScope.Ref;
using System;
...
namespace MicrosoftGraphSdk.RoleManagement.Directory.TransitiveRoleAssignments.Item.DirectoryScope {
    /// <summary>Builds and executes requests for operations under \roleManagement\directory\transitiveRoleAssignments\{unifiedRoleAssignment-id}\directoryScope</summary>
    public class DirectoryScopeRequestBuilder {
        ...
        public DirectoryScopeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment_id}/directoryScope{?select,expand}";
