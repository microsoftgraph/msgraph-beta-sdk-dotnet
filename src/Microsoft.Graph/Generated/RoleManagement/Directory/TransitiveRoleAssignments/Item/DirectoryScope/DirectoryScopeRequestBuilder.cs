...
namespace Microsoft.Graph.Beta.RoleManagement.Directory.TransitiveRoleAssignments.Item.DirectoryScope {
    ...
    public class DirectoryScopeRequestBuilder {
        ...
        public DirectoryScopeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/directoryScope{?%24select,%24expand}";
