...
using MicrosoftGraphSdk.RoleManagement.Directory.TransitiveRoleAssignments.Item.RoleDefinition.Ref;
using System;
...
namespace MicrosoftGraphSdk.RoleManagement.Directory.TransitiveRoleAssignments.Item.RoleDefinition {
    /// <summary>Builds and executes requests for operations under \roleManagement\directory\transitiveRoleAssignments\{unifiedRoleAssignment-id}\roleDefinition</summary>
    public class RoleDefinitionRequestBuilder {
        ...
        public RoleDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment_id}/roleDefinition{?select,expand}";
