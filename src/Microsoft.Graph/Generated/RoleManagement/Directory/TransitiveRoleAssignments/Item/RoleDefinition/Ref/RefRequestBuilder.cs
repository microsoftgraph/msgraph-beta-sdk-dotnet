...
namespace MicrosoftGraphSdk.RoleManagement.Directory.TransitiveRoleAssignments.Item.RoleDefinition.Ref {
    /// <summary>Builds and executes requests for operations under \roleManagement\directory\transitiveRoleAssignments\{unifiedRoleAssignment-id}\roleDefinition\$ref</summary>
    public class RefRequestBuilder {
        ...
        public RefRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment_id}/roleDefinition/$ref";
