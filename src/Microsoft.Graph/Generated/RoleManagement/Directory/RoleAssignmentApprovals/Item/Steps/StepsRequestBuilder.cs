...
using MicrosoftGraph.RoleManagement.Directory.RoleAssignmentApprovals.Item.Steps.Item;
using System;
...
namespace MicrosoftGraph.RoleManagement.Directory.RoleAssignmentApprovals.Item.Steps {
    ...
    public class StepsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.roleManagement.directory.roleAssignmentApprovals.item.steps.item collection</summary>
