...
namespace Microsoft.Graph.Beta.RoleManagement.DirectoryNamespace.RoleEligibilitySchedules {
    ...
    public class RoleEligibilitySchedulesRequestBuilder {
        ...
        /// </summary>
        public async Task<UnifiedRoleEligibilityScheduleCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RoleEligibilitySchedulesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UnifiedRoleEligibilitySchedule> PostAsync(UnifiedRoleEligibilitySchedule body, CancellationToken cancellationToken = default, Action<RoleEligibilitySchedulesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
