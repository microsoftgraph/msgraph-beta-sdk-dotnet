...
#nullable enable
        public async Task<UnifiedRoleEligibilityScheduleCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<RoleEligibilitySchedulesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleEligibilityScheduleCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RoleEligibilitySchedulesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleEligibilitySchedule?> PostAsync(UnifiedRoleEligibilitySchedule body, CancellationToken cancellationToken = default, Action<RoleEligibilitySchedulesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleEligibilitySchedule> PostAsync(UnifiedRoleEligibilitySchedule body, CancellationToken cancellationToken = default, Action<RoleEligibilitySchedulesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
