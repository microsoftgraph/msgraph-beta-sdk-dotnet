...
namespace Microsoft.Graph.Beta.RoleManagement.DirectoryNamespace.ResourceNamespaces.Item.ResourceActions.Item.ResourceScope {
    ...
    public class ResourceScopeRequestBuilder {
        ...
        public ResourceScopeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}/resourceScope{?%24select,%24expand}";
