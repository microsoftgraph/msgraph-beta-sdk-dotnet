...
using System;
namespace Microsoft.Graph.Beta.RoleManagement.DirectoryNamespace.ResourceNamespaces.Item.ResourceActions.Item.AuthenticationContext {
    /// <summary>
    ...
    public class AuthenticationContextRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AuthenticationContextRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/directory/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}/authenticationContext{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
