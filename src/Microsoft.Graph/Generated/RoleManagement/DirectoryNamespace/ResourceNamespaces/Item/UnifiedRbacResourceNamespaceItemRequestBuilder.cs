...
using Microsoft.Graph.Beta.RoleManagement.DirectoryNamespace.ResourceNamespaces.Item.ImportResourceActions;
using Microsoft.Graph.Beta.RoleManagement.DirectoryNamespace.ResourceNamespaces.Item.ResourceActions;
...
using System;
namespace Microsoft.Graph.Beta.RoleManagement.DirectoryNamespace.ResourceNamespaces.Item {
    /// <summary>
    ...
    public class UnifiedRbacResourceNamespaceItemRequestBuilder : BaseRequestBuilder {
        ...
        public UnifiedRbacResourceNamespaceItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/directory/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UnifiedRbacResourceNamespaceItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnifiedRbacResourceNamespaceItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/directory/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UnifiedRbacResourceNamespaceItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UnifiedRbacResourceNamespaceItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/unifiedrbacresourcenamespace-get?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRbacResourceNamespace?> GetAsync(CancellationToken cancellationToken = default, Action<UnifiedRbacResourceNamespaceItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRbacResourceNamespace> GetAsync(CancellationToken cancellationToken = default, Action<UnifiedRbacResourceNamespaceItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRbacResourceNamespace?> PatchAsync(UnifiedRbacResourceNamespace body, CancellationToken cancellationToken = default, Action<UnifiedRbacResourceNamespaceItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRbacResourceNamespace> PatchAsync(UnifiedRbacResourceNamespace body, CancellationToken cancellationToken = default, Action<UnifiedRbacResourceNamespaceItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
