...
namespace Microsoft.Graph.Beta.RoleManagement.DirectoryNamespace.RoleAssignmentScheduleInstances.Item.ActivatedUsing {
    ...
    public class ActivatedUsingRequestBuilder {
        ...
        /// </summary>
        public async Task<UnifiedRoleEligibilityScheduleInstance> GetAsync(CancellationToken cancellationToken = default, Action<ActivatedUsingRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
