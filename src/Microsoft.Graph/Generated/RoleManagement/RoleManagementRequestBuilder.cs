...
namespace Microsoft.Graph.Beta.RoleManagement {
    ...
    public class RoleManagementRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.RoleManagement> GetAsync(Action<RoleManagementRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.RoleManagement> PatchAsync(Microsoft.Graph.Beta.Models.RoleManagement body, Action<RoleManagementRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
