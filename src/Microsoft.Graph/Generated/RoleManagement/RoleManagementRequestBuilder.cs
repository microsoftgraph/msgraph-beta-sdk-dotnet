...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.RoleManagement?> GetAsync(CancellationToken cancellationToken = default, Action<RoleManagementRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.RoleManagement> GetAsync(CancellationToken cancellationToken = default, Action<RoleManagementRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.RoleManagement?> PatchAsync(Microsoft.Graph.Beta.Models.RoleManagement body, CancellationToken cancellationToken = default, Action<RoleManagementRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.RoleManagement> PatchAsync(Microsoft.Graph.Beta.Models.RoleManagement body, CancellationToken cancellationToken = default, Action<RoleManagementRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
