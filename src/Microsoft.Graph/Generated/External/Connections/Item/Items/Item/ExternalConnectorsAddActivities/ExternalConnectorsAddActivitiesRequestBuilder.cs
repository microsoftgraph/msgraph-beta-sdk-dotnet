...
namespace Microsoft.Graph.Beta.External.Connections.Item.Items.Item.ExternalConnectorsAddActivities {
    ...
    /// </summary>
    public class ExternalConnectorsAddActivitiesRequestBuilder {
        ...
        public ExternalConnectorsAddActivitiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/external/connections/{externalConnection%2Did}/items/{externalItem%2Did}/externalConnectors.addActivities";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExternalConnectorsAddActivitiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
