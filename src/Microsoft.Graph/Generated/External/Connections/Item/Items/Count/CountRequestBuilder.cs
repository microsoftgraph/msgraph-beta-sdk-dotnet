...
namespace Microsoft.Graph.Beta.External.Connections.Item.Items.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/external/connections/{externalConnection%2Did}/items/$count{?%24search,%24filter}";
