using Microsoft.Graph.Beta.External.IndustryData.Operations.Count;
using Microsoft.Graph.Beta.External.IndustryData.Operations.Item;
...
namespace Microsoft.Graph.Beta.External.IndustryData.Operations {
    /// <summary>
    ...
    public class OperationsRequestBuilder : BaseRequestBuilder {
        ...
        public OperationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/external/industryData/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OperationsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OperationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/external/industryData/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get a list of long-running file validation operations and their statuses.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/industrydata-filevalidateoperation-list?view=graph-rest-1.0" />
        /// </summary>
