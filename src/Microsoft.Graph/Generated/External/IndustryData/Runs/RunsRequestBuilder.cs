...
#nullable enable
        public async Task<IndustryDataRunCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<RunsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IndustryDataRunCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RunsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
