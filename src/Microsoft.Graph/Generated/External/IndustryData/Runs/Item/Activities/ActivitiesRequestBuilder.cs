...
#nullable enable
        public async Task<IndustryDataRunActivityCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ActivitiesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IndustryDataRunActivityCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ActivitiesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
