...
#nullable enable
        public async Task<InboundFlowCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<InboundFlowsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<InboundFlowCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<InboundFlowsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<InboundFlow?> PostAsync(InboundFlow body, CancellationToken cancellationToken = default, Action<InboundFlowsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<InboundFlow> PostAsync(InboundFlow body, CancellationToken cancellationToken = default, Action<InboundFlowsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
