...
#nullable enable
        public async Task<YearTimePeriodDefinition?> GetAsync(CancellationToken cancellationToken = default, Action<YearRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<YearTimePeriodDefinition> GetAsync(CancellationToken cancellationToken = default, Action<YearRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
