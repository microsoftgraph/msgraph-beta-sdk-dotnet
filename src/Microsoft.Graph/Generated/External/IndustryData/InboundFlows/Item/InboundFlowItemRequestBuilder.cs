...
namespace Microsoft.Graph.Beta.External.IndustryData.InboundFlows.Item {
    ...
    /// </summary>
    public class InboundFlowItemRequestBuilder {
        ...
        public InboundFlowItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/external/industryData/inboundFlows/{inboundFlow%2Did}{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InboundFlowItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
