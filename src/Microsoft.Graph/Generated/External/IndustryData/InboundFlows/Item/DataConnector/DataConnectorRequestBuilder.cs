...
#nullable enable
        public async Task<IndustryDataConnector?> GetAsync(Action<RequestConfiguration<DataConnectorRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<IndustryDataConnector> GetAsync(Action<RequestConfiguration<DataConnectorRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="DataConnectorRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public DataConnectorRequestBuilder WithUrl(string rawUrl) {
...
#nullable restore
        ...
        public class DataConnectorRequestBuilderGetRequestConfiguration : RequestConfiguration<DataConnectorRequestBuilderGetQueryParameters> {
        }
    }
}
