...
#nullable enable
        public async Task<IndustryDataConnector?> GetAsync(CancellationToken cancellationToken = default, Action<DataConnectorRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IndustryDataConnector> GetAsync(CancellationToken cancellationToken = default, Action<DataConnectorRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
