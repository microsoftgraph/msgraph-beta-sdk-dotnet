...
namespace Microsoft.Graph.Beta.External.IndustryData.InboundFlows.Item.DataConnector {
    ...
    /// </summary>
    public class DataConnectorRequestBuilder {
        ...
        public DataConnectorRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/external/industryData/inboundFlows/{inboundFlow%2Did}/dataConnector{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DataConnectorRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
