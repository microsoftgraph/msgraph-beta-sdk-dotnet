...
namespace Microsoft.Graph.Beta.External.IndustryData.InboundFlows.Item.DataConnector
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.External.IndustryData.InboundFlows.Item.DataConnector.DataConnectorRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.IndustryData.IndustryDataConnector?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.External.IndustryData.InboundFlows.Item.DataConnector.DataConnectorRequestBuilder.DataConnectorRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.IndustryData.IndustryDataConnector> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.External.IndustryData.InboundFlows.Item.DataConnector.DataConnectorRequestBuilder.DataConnectorRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.External.IndustryData.InboundFlows.Item.DataConnector.DataConnectorRequestBuilder.DataConnectorRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.External.IndustryData.InboundFlows.Item.DataConnector.DataConnectorRequestBuilder.DataConnectorRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.External.IndustryData.InboundFlows.Item.DataConnector.DataConnectorRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.External.IndustryData.InboundFlows.Item.DataConnector.DataConnectorRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
        ...
        public class DataConnectorRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.External.IndustryData.InboundFlows.Item.DataConnector.DataConnectorRequestBuilder.DataConnectorRequestBuilderGetQueryParameters>
        {
        }
    }
}
