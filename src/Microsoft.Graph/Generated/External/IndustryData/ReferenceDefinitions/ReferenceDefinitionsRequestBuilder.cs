...
namespace Microsoft.Graph.Beta.External.IndustryData.ReferenceDefinitions {
    ...
    public class ReferenceDefinitionsRequestBuilder : BaseRequestBuilder {
        ...
        public ReferenceDefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/external/industryData/referenceDefinitions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ReferenceDefinitionsRequestBuilder and sets the default values.
        /// </summary>
