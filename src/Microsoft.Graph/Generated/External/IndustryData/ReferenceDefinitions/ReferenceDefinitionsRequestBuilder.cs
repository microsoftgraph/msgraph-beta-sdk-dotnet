...
#nullable enable
        public async Task<ReferenceDefinitionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ReferenceDefinitionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ReferenceDefinitionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ReferenceDefinitionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ReferenceDefinition?> PostAsync(ReferenceDefinition body, CancellationToken cancellationToken = default, Action<ReferenceDefinitionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ReferenceDefinition> PostAsync(ReferenceDefinition body, CancellationToken cancellationToken = default, Action<ReferenceDefinitionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
