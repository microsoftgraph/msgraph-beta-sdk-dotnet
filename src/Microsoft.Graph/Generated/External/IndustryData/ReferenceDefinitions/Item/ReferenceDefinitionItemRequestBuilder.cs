...
namespace Microsoft.Graph.Beta.External.IndustryData.ReferenceDefinitions.Item {
    ...
    /// </summary>
    public class ReferenceDefinitionItemRequestBuilder {
        ...
        public ReferenceDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/external/industryData/referenceDefinitions/{referenceDefinition%2Did}{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ReferenceDefinitionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
