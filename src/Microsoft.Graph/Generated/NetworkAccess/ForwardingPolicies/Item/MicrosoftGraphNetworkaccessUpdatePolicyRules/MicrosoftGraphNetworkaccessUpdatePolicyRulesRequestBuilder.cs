...
#nullable enable
        public async Task PostAsync(UpdatePolicyRulesPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphNetworkaccessUpdatePolicyRulesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(UpdatePolicyRulesPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphNetworkaccessUpdatePolicyRulesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
