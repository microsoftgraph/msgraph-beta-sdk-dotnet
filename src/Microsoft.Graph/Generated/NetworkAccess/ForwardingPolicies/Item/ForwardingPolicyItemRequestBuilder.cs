...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ForwardingPolicyItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ForwardingPolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ForwardingPolicy?> GetAsync(CancellationToken cancellationToken = default, Action<ForwardingPolicyItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ForwardingPolicy> GetAsync(CancellationToken cancellationToken = default, Action<ForwardingPolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ForwardingPolicy?> PatchAsync(ForwardingPolicy body, CancellationToken cancellationToken = default, Action<ForwardingPolicyItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ForwardingPolicy> PatchAsync(ForwardingPolicy body, CancellationToken cancellationToken = default, Action<ForwardingPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
