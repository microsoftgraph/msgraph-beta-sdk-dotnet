...
namespace Microsoft.Graph.Beta.NetworkAccess.FilteringPolicies.Item {
    ...
    public class FilteringPolicyItemRequestBuilder : BaseRequestBuilder {
        ...
        public FilteringPolicyItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/networkAccess/filteringPolicies/{filteringPolicy%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new FilteringPolicyItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FilteringPolicyItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/networkAccess/filteringPolicies/{filteringPolicy%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
