...
#nullable enable
        public async Task<NetworkAccessRoot?> GetAsync(CancellationToken cancellationToken = default, Action<NetworkAccessRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<NetworkAccessRoot> GetAsync(CancellationToken cancellationToken = default, Action<NetworkAccessRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<NetworkAccessRoot?> PatchAsync(NetworkAccessRoot body, CancellationToken cancellationToken = default, Action<NetworkAccessRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<NetworkAccessRoot> PatchAsync(NetworkAccessRoot body, CancellationToken cancellationToken = default, Action<NetworkAccessRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
