...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.ConditionalAccessSettings?> GetAsync(CancellationToken cancellationToken = default, Action<ConditionalAccessRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.ConditionalAccessSettings> GetAsync(CancellationToken cancellationToken = default, Action<ConditionalAccessRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.ConditionalAccessSettings?> PatchAsync(Microsoft.Graph.Beta.Models.Networkaccess.ConditionalAccessSettings body, CancellationToken cancellationToken = default, Action<ConditionalAccessRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.ConditionalAccessSettings> PatchAsync(Microsoft.Graph.Beta.Models.Networkaccess.ConditionalAccessSettings body, CancellationToken cancellationToken = default, Action<ConditionalAccessRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
