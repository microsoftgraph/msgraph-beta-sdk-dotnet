...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EnrichedAuditLogsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EnrichedAuditLogsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.EnrichedAuditLogs?> GetAsync(CancellationToken cancellationToken = default, Action<EnrichedAuditLogsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.EnrichedAuditLogs> GetAsync(CancellationToken cancellationToken = default, Action<EnrichedAuditLogsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.EnrichedAuditLogs?> PatchAsync(Microsoft.Graph.Beta.Models.Networkaccess.EnrichedAuditLogs body, CancellationToken cancellationToken = default, Action<EnrichedAuditLogsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.EnrichedAuditLogs> PatchAsync(Microsoft.Graph.Beta.Models.Networkaccess.EnrichedAuditLogs body, CancellationToken cancellationToken = default, Action<EnrichedAuditLogsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
