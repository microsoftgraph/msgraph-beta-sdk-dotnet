...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ForwardingOptionsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ForwardingOptionsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.ForwardingOptions?> GetAsync(CancellationToken cancellationToken = default, Action<ForwardingOptionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.ForwardingOptions> GetAsync(CancellationToken cancellationToken = default, Action<ForwardingOptionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.ForwardingOptions?> PatchAsync(Microsoft.Graph.Beta.Models.Networkaccess.ForwardingOptions body, CancellationToken cancellationToken = default, Action<ForwardingOptionsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.ForwardingOptions> PatchAsync(Microsoft.Graph.Beta.Models.Networkaccess.ForwardingOptions body, CancellationToken cancellationToken = default, Action<ForwardingOptionsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
