...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CrossTenantAccessRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CrossTenantAccessRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CrossTenantAccessSettings?> GetAsync(CancellationToken cancellationToken = default, Action<CrossTenantAccessRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CrossTenantAccessSettings> GetAsync(CancellationToken cancellationToken = default, Action<CrossTenantAccessRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CrossTenantAccessSettings?> PatchAsync(CrossTenantAccessSettings body, CancellationToken cancellationToken = default, Action<CrossTenantAccessRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CrossTenantAccessSettings> PatchAsync(CrossTenantAccessSettings body, CancellationToken cancellationToken = default, Action<CrossTenantAccessRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
