...
namespace Microsoft.Graph.Beta.NetworkAccess.Reports.MicrosoftGraphNetworkaccessUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedBy {
    ...
    public class MicrosoftGraphNetworkaccessUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="UsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function usageProfiling
        /// </summary>
        /// <returns>A <cref="UsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="MicrosoftGraphNetworkaccessUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
