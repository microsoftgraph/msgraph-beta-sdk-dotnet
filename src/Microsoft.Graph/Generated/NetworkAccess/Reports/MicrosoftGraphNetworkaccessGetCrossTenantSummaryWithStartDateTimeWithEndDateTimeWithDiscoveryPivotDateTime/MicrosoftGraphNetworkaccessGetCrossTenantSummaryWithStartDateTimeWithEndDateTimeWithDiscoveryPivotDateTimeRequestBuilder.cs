...
#nullable enable
        public async Task<CrossTenantSummary?> GetAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphNetworkaccessGetCrossTenantSummaryWithStartDateTimeWithEndDateTimeWithDiscoveryPivotDateTimeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CrossTenantSummary> GetAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphNetworkaccessGetCrossTenantSummaryWithStartDateTimeWithEndDateTimeWithDiscoveryPivotDateTimeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<CrossTenantSummary>(requestInfo, CrossTenantSummary.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Invoke function getCrossTenantSummary
        /// </summary>
