...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<TenantStatusRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<TenantStatusRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.TenantStatus?> GetAsync(CancellationToken cancellationToken = default, Action<TenantStatusRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.TenantStatus> GetAsync(CancellationToken cancellationToken = default, Action<TenantStatusRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Beta.Models.Networkaccess.TenantStatus>(requestInfo, Microsoft.Graph.Beta.Models.Networkaccess.TenantStatus.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.TenantStatus?> PatchAsync(Microsoft.Graph.Beta.Models.Networkaccess.TenantStatus body, CancellationToken cancellationToken = default, Action<TenantStatusRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.TenantStatus> PatchAsync(Microsoft.Graph.Beta.Models.Networkaccess.TenantStatus body, CancellationToken cancellationToken = default, Action<TenantStatusRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
