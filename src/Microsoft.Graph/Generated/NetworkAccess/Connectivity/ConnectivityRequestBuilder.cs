...
namespace Microsoft.Graph.Beta.NetworkAccess.Connectivity
{
    ...
    public class ConnectivityRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.NetworkAccess.Connectivity.Branches.BranchesRequestBuilder Branches
        {
            get => new Microsoft.Graph.Beta.NetworkAccess.Connectivity.Branches.BranchesRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Microsoft.Graph.Beta.NetworkAccess.Connectivity.RemoteNetworks.RemoteNetworksRequestBuilder RemoteNetworks
        {
            get => new Microsoft.Graph.Beta.NetworkAccess.Connectivity.RemoteNetworks.RemoteNetworksRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.NetworkAccess.Connectivity.ConnectivityRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.Connectivity?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.NetworkAccess.Connectivity.ConnectivityRequestBuilder.ConnectivityRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.Connectivity> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.NetworkAccess.Connectivity.ConnectivityRequestBuilder.ConnectivityRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.NetworkAccess.Connectivity.ConnectivityRequestBuilder.ConnectivityRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.NetworkAccess.Connectivity.ConnectivityRequestBuilder.ConnectivityRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.NetworkAccess.Connectivity.ConnectivityRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.NetworkAccess.Connectivity.ConnectivityRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.NetworkAccess.Connectivity.ConnectivityRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class ConnectivityRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.NetworkAccess.Connectivity.ConnectivityRequestBuilder.ConnectivityRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
