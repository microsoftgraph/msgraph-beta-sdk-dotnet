...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ConnectivityRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ConnectivityRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.Connectivity?> GetAsync(CancellationToken cancellationToken = default, Action<ConnectivityRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.Connectivity> GetAsync(CancellationToken cancellationToken = default, Action<ConnectivityRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.Connectivity?> PatchAsync(Microsoft.Graph.Beta.Models.Networkaccess.Connectivity body, CancellationToken cancellationToken = default, Action<ConnectivityRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.Connectivity> PatchAsync(Microsoft.Graph.Beta.Models.Networkaccess.Connectivity body, CancellationToken cancellationToken = default, Action<ConnectivityRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
