...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<BranchSiteItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<BranchSiteItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BranchSite?> GetAsync(CancellationToken cancellationToken = default, Action<BranchSiteItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BranchSite> GetAsync(CancellationToken cancellationToken = default, Action<BranchSiteItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BranchSite?> PatchAsync(BranchSite body, CancellationToken cancellationToken = default, Action<BranchSiteItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BranchSite> PatchAsync(BranchSite body, CancellationToken cancellationToken = default, Action<BranchSiteItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
