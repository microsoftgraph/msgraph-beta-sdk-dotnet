...
namespace Microsoft.Graph.Beta.NetworkAccess.Connectivity.Branches.Item.DeviceLinks {
    ...
    public class DeviceLinksRequestBuilder : BaseRequestBuilder {
        ...
        public DeviceLinkItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("deviceLink%2Did", position);
...
#nullable enable
        public async Task<DeviceLinkCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceLinksRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceLinkCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DeviceLinksRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceLink?> PostAsync(DeviceLink body, CancellationToken cancellationToken = default, Action<DeviceLinksRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceLink> PostAsync(DeviceLink body, CancellationToken cancellationToken = default, Action<DeviceLinksRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
