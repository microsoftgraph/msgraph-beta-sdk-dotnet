...
namespace Microsoft.Graph.Beta.NetworkAccess.Connectivity.Branches.Item.DeviceLinks {
    ...
    public class DeviceLinksRequestBuilder : BaseRequestBuilder 
    {
        ...
        [Obsolete("The Branches API is deprecated and will stop returning data on March 20, 2024. Please use the new Remote Network API. as of 2022-06/PrivatePreview:NetworkAccess")]
        public DeviceLinkItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="DeviceLinksRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("The Branches API is deprecated and will stop returning data on March 20, 2024. Please use the new Remote Network API. as of 2022-06/PrivatePreview:NetworkAccess")]
...
#nullable restore
        ...
        public class DeviceLinksRequestBuilderGetRequestConfiguration : RequestConfiguration<DeviceLinksRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
