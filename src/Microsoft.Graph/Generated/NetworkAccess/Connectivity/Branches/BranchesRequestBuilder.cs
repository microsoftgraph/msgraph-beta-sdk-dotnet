...
#nullable enable
        public async Task<BranchSiteCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<BranchesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BranchSiteCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<BranchesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BranchSite?> PostAsync(BranchSite body, CancellationToken cancellationToken = default, Action<BranchesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BranchSite> PostAsync(BranchSite body, CancellationToken cancellationToken = default, Action<BranchesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
