...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<NetworkAccessTrafficTransactionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<NetworkAccessTrafficTransactionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<NetworkAccessTraffic?> GetAsync(CancellationToken cancellationToken = default, Action<NetworkAccessTrafficTransactionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<NetworkAccessTraffic> GetAsync(CancellationToken cancellationToken = default, Action<NetworkAccessTrafficTransactionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<NetworkAccessTraffic?> PatchAsync(NetworkAccessTraffic body, CancellationToken cancellationToken = default, Action<NetworkAccessTrafficTransactionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<NetworkAccessTraffic> PatchAsync(NetworkAccessTraffic body, CancellationToken cancellationToken = default, Action<NetworkAccessTrafficTransactionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
