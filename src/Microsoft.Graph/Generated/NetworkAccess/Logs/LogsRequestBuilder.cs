...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<LogsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<LogsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.Logs?> GetAsync(CancellationToken cancellationToken = default, Action<LogsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.Logs> GetAsync(CancellationToken cancellationToken = default, Action<LogsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.Logs?> PatchAsync(Microsoft.Graph.Beta.Models.Networkaccess.Logs body, CancellationToken cancellationToken = default, Action<LogsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Networkaccess.Logs> PatchAsync(Microsoft.Graph.Beta.Models.Networkaccess.Logs body, CancellationToken cancellationToken = default, Action<LogsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
