...
namespace Microsoft.Graph.WindowsUpdates
{
    ...
    /// </summary>
    public partial class AdminRequest : Microsoft.Graph.BaseRequest, IAdminRequest
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Admin> UpdateAsync(Admin adminToUpdate, CancellationToken cancellationToken)
        {
			...
			{
				if (adminToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.ResponseHeaders) ||
					adminToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.StatusCode))
				{
					throw new Microsoft.Graph.ClientException(
						new Microsoft.Graph.Error
						{
							Code = Microsoft.Graph.GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(Microsoft.Graph.GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, adminToUpdate.GetType().Name)
						});
				}
			}
            if (adminToUpdate.AdditionalData != null)
        ...
        /// </summary>
        /// <param name="adminToInitialize">The <see cref="Admin"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(Admin adminToInitialize)
        {
