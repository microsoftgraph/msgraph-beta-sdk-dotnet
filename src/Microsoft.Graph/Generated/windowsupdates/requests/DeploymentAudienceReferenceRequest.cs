...
namespace Microsoft.Graph.WindowsUpdates
{
    ...
    /// <summary>
    /// The type DeploymentAudienceReferenceRequest.
    /// </summary>
    public partial class DeploymentAudienceReferenceRequest : Microsoft.Graph.BaseRequest, IDeploymentAudienceReferenceRequest
    {
        /// <summary>
        /// Constructs a new DeploymentAudienceReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public DeploymentAudienceReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified DeploymentAudience reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified DeploymentAudience reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified DeploymentAudience reference.
        /// </summary>
        /// <param name="id">The DeploymentAudience reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified DeploymentAudience reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The DeploymentAudience reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
