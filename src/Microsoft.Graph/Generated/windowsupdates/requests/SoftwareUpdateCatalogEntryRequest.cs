...
namespace Microsoft.Graph.WindowsUpdates
{
    ...
    public partial class SoftwareUpdateCatalogEntryRequest : Microsoft.Graph.BaseRequest, ISoftwareUpdateCatalogEntryRequest
    {
        ...
        public async System.Threading.Tasks.Task<SoftwareUpdateCatalogEntry> CreateAsync(SoftwareUpdateCatalogEntry softwareUpdateCatalogEntryToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<SoftwareUpdateCatalogEntry>> CreateResponseAsync(SoftwareUpdateCatalogEntry softwareUpdateCatalogEntryToCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<SoftwareUpdateCatalogEntry> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SoftwareUpdateCatalogEntry}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SoftwareUpdateCatalogEntry>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = HttpMethods.GET;
        ...
        public async System.Threading.Tasks.Task<SoftwareUpdateCatalogEntry> UpdateAsync(SoftwareUpdateCatalogEntry softwareUpdateCatalogEntryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        /// <exception cref="Microsoft.Graph.ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SoftwareUpdateCatalogEntry}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SoftwareUpdateCatalogEntry>> UpdateResponseAsync(SoftwareUpdateCatalogEntry softwareUpdateCatalogEntryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PATCH;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        public async System.Threading.Tasks.Task<SoftwareUpdateCatalogEntry> PutAsync(SoftwareUpdateCatalogEntry softwareUpdateCatalogEntryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
        ...
        public System.Threading.Tasks.Task<GraphResponse<SoftwareUpdateCatalogEntry>> PutResponseAsync(SoftwareUpdateCatalogEntry softwareUpdateCatalogEntryToUpdate, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.PUT;
            return this.SendAsyncWithGraphResponse<SoftwareUpdateCatalogEntry>(softwareUpdateCatalogEntryToUpdate, cancellationToken);
