...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.TaxAreas {
    ...
    public class TaxAreasRequestBuilder {
        ...
        /// </summary>
        public async Task<TaxAreaCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TaxAreasRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TaxArea> PostAsync(TaxArea body, CancellationToken cancellationToken = default, Action<TaxAreasRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
