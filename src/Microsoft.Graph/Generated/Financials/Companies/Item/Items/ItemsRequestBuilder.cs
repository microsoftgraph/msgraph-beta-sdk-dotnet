...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// </summary>
        public async Task<ItemCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ItemsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Item> PostAsync(Microsoft.Graph.Beta.Models.Item body, CancellationToken cancellationToken = default, Action<ItemsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
