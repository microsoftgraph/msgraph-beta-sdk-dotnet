...
#nullable enable
        public async Task<DimensionValue?> GetAsync(CancellationToken cancellationToken = default, Action<DimensionValueItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DimensionValue> GetAsync(CancellationToken cancellationToken = default, Action<DimensionValueItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
