...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.DimensionValues.Item {
    ...
    public class DimensionValueItemRequestBuilder {
        ...
        /// </summary>
        public async Task<DimensionValue> GetAsync(CancellationToken cancellationToken = default, Action<DimensionValueItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
