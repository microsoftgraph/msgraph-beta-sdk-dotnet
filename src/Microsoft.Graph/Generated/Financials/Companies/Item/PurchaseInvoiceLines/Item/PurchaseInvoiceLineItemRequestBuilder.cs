...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.PurchaseInvoiceLines.Item {
    ...
    /// </summary>
    public class PurchaseInvoiceLineItemRequestBuilder : BaseRequestBuilder {
        ...
        public PurchaseInvoiceLineItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoiceLines/{purchaseInvoiceLine%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PurchaseInvoiceLineItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PurchaseInvoiceLineItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoiceLines/{purchaseInvoiceLine%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<PurchaseInvoiceLine?> GetAsync(CancellationToken cancellationToken = default, Action<PurchaseInvoiceLineItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PurchaseInvoiceLine> GetAsync(CancellationToken cancellationToken = default, Action<PurchaseInvoiceLineItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PurchaseInvoiceLine?> PatchAsync(PurchaseInvoiceLine body, CancellationToken cancellationToken = default, Action<PurchaseInvoiceLineItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PurchaseInvoiceLine> PatchAsync(PurchaseInvoiceLine body, CancellationToken cancellationToken = default, Action<PurchaseInvoiceLineItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
