...
using MicrosoftGraphSdk.Financials.Companies.Item.PurchaseInvoiceLines.Item.Item.Picture.Item;
...
namespace MicrosoftGraphSdk.Financials.Companies.Item.PurchaseInvoiceLines.Item.Item.Picture {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\purchaseInvoiceLines\{purchaseInvoiceLine-id}\item\picture</summary>
    public class PictureRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.financials.companies.item.purchaseInvoiceLines.item.item.picture.item collection</summary>
        ...
        public PictureRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/purchaseInvoiceLines/{purchaseInvoiceLine_id}/item/picture{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
