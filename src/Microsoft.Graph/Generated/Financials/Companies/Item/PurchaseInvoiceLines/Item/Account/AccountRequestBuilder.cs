...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.PurchaseInvoiceLines.Item.Account {
    /// <summary>
    ...
    public class AccountRequestBuilder : BaseRequestBuilder {
        ...
        public AccountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoiceLines/{purchaseInvoiceLine%2Did}/account{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AccountRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AccountRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoiceLines/{purchaseInvoiceLine%2Did}/account{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
