...
namespace MicrosoftGraphSdk.Financials.Companies.Item.PurchaseInvoiceLines.Item.Item.Picture.Item.Content {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\purchaseInvoiceLines\{purchaseInvoiceLine-id}\item\picture\{picture-id}\content</summary>
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/purchaseInvoiceLines/{purchaseInvoiceLine_id}/item/picture/{picture_id}/content";
