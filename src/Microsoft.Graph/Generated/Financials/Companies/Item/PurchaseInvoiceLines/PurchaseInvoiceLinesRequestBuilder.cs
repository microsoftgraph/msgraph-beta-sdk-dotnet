...
using MicrosoftGraph.Financials.Companies.Item.PurchaseInvoiceLines.Item;
...
namespace MicrosoftGraph.Financials.Companies.Item.PurchaseInvoiceLines {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\purchaseInvoiceLines</summary>
    public class PurchaseInvoiceLinesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.financials.companies.item.purchaseInvoiceLines.item collection</summary>
        ...
        public PurchaseInvoiceLinesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/purchaseInvoiceLines{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
