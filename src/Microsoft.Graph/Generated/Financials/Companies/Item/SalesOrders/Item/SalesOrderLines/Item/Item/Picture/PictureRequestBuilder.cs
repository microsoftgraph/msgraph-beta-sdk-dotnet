...
using MicrosoftGraphSdk.Financials.Companies.Item.SalesOrders.Item.SalesOrderLines.Item.Item.Picture.Item;
...
namespace MicrosoftGraphSdk.Financials.Companies.Item.SalesOrders.Item.SalesOrderLines.Item.Item.Picture {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\salesOrders\{salesOrder-id}\salesOrderLines\{salesOrderLine-id}\item\picture</summary>
    public class PictureRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.financials.companies.item.salesOrders.item.salesOrderLines.item.item.picture.item collection</summary>
