...
namespace MicrosoftGraphSdk.Financials.Companies.Item.SalesOrders.Item.SalesOrderLines.Item.Item.Picture.Item.Content {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\salesOrders\{salesOrder-id}\salesOrderLines\{salesOrderLine-id}\item\picture\{picture-id}\content</summary>
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/salesOrders/{salesOrder_id}/salesOrderLines/{salesOrderLine_id}/item/picture/{picture_id}/content";
