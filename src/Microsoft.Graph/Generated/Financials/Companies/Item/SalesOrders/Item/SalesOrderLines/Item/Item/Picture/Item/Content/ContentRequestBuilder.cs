...
using System;
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesOrders.Item.SalesOrderLines.Item.Item.Picture.Item.Content {
    /// <summary>
    ...
    public class ContentRequestBuilder : BaseRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesOrders/{salesOrder%2Did}/salesOrderLines/{salesOrderLine%2Did}/item/picture/{picture%2Did}/content", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ContentRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContentRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesOrders/{salesOrder%2Did}/salesOrderLines/{salesOrderLine%2Did}/item/picture/{picture%2Did}/content", rawUrl) {
        }
        /// <summary>
