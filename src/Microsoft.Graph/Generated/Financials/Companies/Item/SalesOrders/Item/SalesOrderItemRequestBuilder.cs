...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesOrders.Item {
    ...
    public class SalesOrderItemRequestBuilder {
        ...
        /// </summary>
        public async Task<SalesOrder> GetAsync(CancellationToken cancellationToken = default, Action<SalesOrderItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SalesOrder body, CancellationToken cancellationToken = default, Action<SalesOrderItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
