...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesOrders.Item.SalesOrderLines.Item.Item.Picture.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company%2Did}/salesOrders/{salesOrder%2Did}/salesOrderLines/{salesOrderLine%2Did}/item/picture/$count{?%24search,%24filter}";
