...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.PaymentMethods {
    ...
    public class PaymentMethodsRequestBuilder {
        ...
        /// </summary>
        public async Task<PaymentMethodCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PaymentMethodsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.PaymentMethod> PostAsync(Microsoft.Graph.Beta.Models.PaymentMethod body, CancellationToken cancellationToken = default, Action<PaymentMethodsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
