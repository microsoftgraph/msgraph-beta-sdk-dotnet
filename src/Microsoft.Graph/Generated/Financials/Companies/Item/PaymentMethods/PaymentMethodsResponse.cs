...
namespace MicrosoftGraphSdk.Financials.Companies.Item.PaymentMethods {
    public class PaymentMethodsResponse : IParsable {
        ...
        /// </summary>
        public static PaymentMethodsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as PaymentMethodsResponse).Value = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.PaymentMethod>(MicrosoftGraphSdk.Models.Microsoft.Graph.PaymentMethod.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
