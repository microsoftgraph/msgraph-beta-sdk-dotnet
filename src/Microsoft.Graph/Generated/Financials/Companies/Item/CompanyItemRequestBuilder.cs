...
namespace Microsoft.Graph.Beta.Financials.Companies.Item {
    ...
    public class CompanyItemRequestBuilder {
        ...
        /// </summary>
        public async Task<Company> GetAsync(CancellationToken cancellationToken = default, Action<CompanyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
