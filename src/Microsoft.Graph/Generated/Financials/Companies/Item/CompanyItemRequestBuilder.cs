...
#nullable enable
        public async Task<Company?> GetAsync(CancellationToken cancellationToken = default, Action<CompanyItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Company> GetAsync(CancellationToken cancellationToken = default, Action<CompanyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
