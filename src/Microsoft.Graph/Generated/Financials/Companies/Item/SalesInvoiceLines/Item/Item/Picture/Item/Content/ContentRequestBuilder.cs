...
namespace MicrosoftGraphSdk.Financials.Companies.Item.SalesInvoiceLines.Item.Item.Picture.Item.Content {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\salesInvoiceLines\{salesInvoiceLine-id}\item\picture\{picture-id}\content</summary>
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/salesInvoiceLines/{salesInvoiceLine_id}/item/picture/{picture_id}/content";
