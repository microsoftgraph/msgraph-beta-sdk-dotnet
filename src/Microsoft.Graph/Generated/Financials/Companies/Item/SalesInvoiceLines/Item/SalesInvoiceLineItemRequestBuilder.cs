...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesInvoiceLines.Item {
    ...
    public class SalesInvoiceLineItemRequestBuilder {
        ...
        /// </summary>
        public async Task<SalesInvoiceLine> GetAsync(CancellationToken cancellationToken = default, Action<SalesInvoiceLineItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SalesInvoiceLine body, CancellationToken cancellationToken = default, Action<SalesInvoiceLineItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
