...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesInvoiceLines.Item {
    ...
    public class SalesInvoiceLineItemRequestBuilder : BaseRequestBuilder {
        ...
        public SalesInvoiceLineItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoiceLines/{salesInvoiceLine%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SalesInvoiceLineItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SalesInvoiceLineItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoiceLines/{salesInvoiceLine%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<SalesInvoiceLine?> GetAsync(CancellationToken cancellationToken = default, Action<SalesInvoiceLineItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SalesInvoiceLine> GetAsync(CancellationToken cancellationToken = default, Action<SalesInvoiceLineItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SalesInvoiceLine?> PatchAsync(SalesInvoiceLine body, CancellationToken cancellationToken = default, Action<SalesInvoiceLineItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SalesInvoiceLine> PatchAsync(SalesInvoiceLine body, CancellationToken cancellationToken = default, Action<SalesInvoiceLineItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
