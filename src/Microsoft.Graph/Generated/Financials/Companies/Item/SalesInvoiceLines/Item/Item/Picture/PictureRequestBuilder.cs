...
using MicrosoftGraphSdk.Financials.Companies.Item.SalesInvoiceLines.Item.Item.Picture.Item;
...
namespace MicrosoftGraphSdk.Financials.Companies.Item.SalesInvoiceLines.Item.Item.Picture {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\salesInvoiceLines\{salesInvoiceLine-id}\item\picture</summary>
    public class PictureRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.financials.companies.item.salesInvoiceLines.item.item.picture.item collection</summary>
        ...
        public PictureRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/salesInvoiceLines/{salesInvoiceLine_id}/item/picture{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
