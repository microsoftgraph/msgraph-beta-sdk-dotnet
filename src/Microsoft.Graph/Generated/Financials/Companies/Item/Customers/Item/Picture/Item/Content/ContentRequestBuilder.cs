...
namespace MicrosoftGraphSdk.Financials.Companies.Item.Customers.Item.Picture.Item.Content {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\customers\{customer-id}\picture\{picture-id}\content</summary>
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/customers/{customer_id}/picture/{picture_id}/content";
