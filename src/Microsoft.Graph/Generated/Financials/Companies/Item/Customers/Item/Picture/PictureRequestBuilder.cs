...
using MicrosoftGraphSdk.Financials.Companies.Item.Customers.Item.Picture.Item;
...
namespace MicrosoftGraphSdk.Financials.Companies.Item.Customers.Item.Picture {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\customers\{customer-id}\picture</summary>
    public class PictureRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.financials.companies.item.customers.item.picture.item collection</summary>
        ...
        public PictureRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/customers/{customer_id}/picture{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
