...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.Journals.Item.Account {
    ...
    public class AccountRequestBuilder {
        ...
        public AccountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}/account{?%24select,%24expand}";
