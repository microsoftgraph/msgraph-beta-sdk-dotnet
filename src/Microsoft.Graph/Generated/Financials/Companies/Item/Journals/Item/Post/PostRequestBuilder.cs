...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.Journals.Item.Post {
    ...
    public class PostRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<PostRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
