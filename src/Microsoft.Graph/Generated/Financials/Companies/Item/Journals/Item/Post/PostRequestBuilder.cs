...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.Journals.Item.Post {
    ...
    public class PostRequestBuilder {
        ...
        public PostRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}/microsoft.graph.post";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Action<PostRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(Action<PostRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
