...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.Journals.Item.JournalLines.Item.Account {
    /// <summary>
    ...
    public class AccountRequestBuilder : BaseRequestBuilder {
        ...
        public AccountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}/journalLines/{journalLine%2Did}/account{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AccountRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AccountRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}/journalLines/{journalLine%2Did}/account{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
