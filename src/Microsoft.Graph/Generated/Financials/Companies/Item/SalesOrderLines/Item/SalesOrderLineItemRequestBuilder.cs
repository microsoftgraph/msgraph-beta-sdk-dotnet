...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesOrderLines.Item {
    ...
    public class SalesOrderLineItemRequestBuilder : BaseRequestBuilder {
        ...
        public SalesOrderLineItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesOrderLines/{salesOrderLine%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SalesOrderLineItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SalesOrderLineItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesOrderLines/{salesOrderLine%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<SalesOrderLine?> GetAsync(CancellationToken cancellationToken = default, Action<SalesOrderLineItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SalesOrderLine> GetAsync(CancellationToken cancellationToken = default, Action<SalesOrderLineItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SalesOrderLine?> PatchAsync(SalesOrderLine body, CancellationToken cancellationToken = default, Action<SalesOrderLineItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SalesOrderLine> PatchAsync(SalesOrderLine body, CancellationToken cancellationToken = default, Action<SalesOrderLineItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
