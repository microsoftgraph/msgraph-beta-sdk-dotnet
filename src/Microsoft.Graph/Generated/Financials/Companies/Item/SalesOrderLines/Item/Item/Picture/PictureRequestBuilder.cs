...
using MicrosoftGraphSdk.Financials.Companies.Item.SalesOrderLines.Item.Item.Picture.Item;
...
namespace MicrosoftGraphSdk.Financials.Companies.Item.SalesOrderLines.Item.Item.Picture {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\salesOrderLines\{salesOrderLine-id}\item\picture</summary>
    public class PictureRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.financials.companies.item.salesOrderLines.item.item.picture.item collection</summary>
