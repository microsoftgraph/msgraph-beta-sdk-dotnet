...
using MicrosoftGraphSdk.Financials.Companies.Item.Vendors.Item.Picture.Item;
...
namespace MicrosoftGraphSdk.Financials.Companies.Item.Vendors.Item.Picture {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\vendors\{vendor-id}\picture</summary>
    public class PictureRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.financials.companies.item.vendors.item.picture.item collection</summary>
