...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item
{
    ...
    public class VendorItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.Currency.CurrencyRequestBuilder Currency
        {
            get => new Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.Currency.CurrencyRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the paymentMethod property of the microsoft.graph.vendor entity.</summary>
        public Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.PaymentMethod.PaymentMethodRequestBuilder PaymentMethod
        {
            get => new Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.PaymentMethod.PaymentMethodRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the paymentTerm property of the microsoft.graph.vendor entity.</summary>
        public Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.PaymentTerm.PaymentTermRequestBuilder PaymentTerm
        {
            get => new Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.PaymentTerm.PaymentTermRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the picture property of the microsoft.graph.vendor entity.</summary>
        public Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.Picture.PictureRequestBuilder Picture
        {
            get => new Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.Picture.PictureRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.VendorItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Vendor?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.VendorItemRequestBuilder.VendorItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Vendor> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.VendorItemRequestBuilder.VendorItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.VendorItemRequestBuilder.VendorItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.VendorItemRequestBuilder.VendorItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.VendorItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.VendorItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class VendorItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.Financials.Companies.Item.Vendors.Item.VendorItemRequestBuilder.VendorItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
