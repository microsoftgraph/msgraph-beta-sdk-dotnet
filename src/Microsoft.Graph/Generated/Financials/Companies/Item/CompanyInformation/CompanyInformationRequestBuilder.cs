...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.CompanyInformation {
    ...
    public class CompanyInformationRequestBuilder : BaseRequestBuilder 
    {
        ...
        public CompanyInformationItemRequestBuilder this[Guid position]
        {
            get
            {
        ...
        public CompanyInformationItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="CompanyInformationRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class CompanyInformationRequestBuilderGetRequestConfiguration : RequestConfiguration<CompanyInformationRequestBuilderGetQueryParameters> 
        {
        }
    }
}
