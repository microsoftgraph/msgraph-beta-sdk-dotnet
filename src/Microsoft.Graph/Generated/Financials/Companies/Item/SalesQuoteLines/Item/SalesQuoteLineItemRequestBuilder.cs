...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesQuoteLines.Item {
    ...
    public class SalesQuoteLineItemRequestBuilder {
        ...
        /// </summary>
        public async Task<SalesQuoteLine> GetAsync(CancellationToken cancellationToken = default, Action<SalesQuoteLineItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SalesQuoteLine body, CancellationToken cancellationToken = default, Action<SalesQuoteLineItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
