...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.CustomerPaymentJournals.Item.CustomerPayments.Item.Customer.Picture.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/customerPaymentJournals/{customerPaymentJournal_id}/customerPayments/{customerPayment_id}/customer/picture/$count";
