...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.CustomerPaymentJournals.Item.Account {
    ...
    public class AccountRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.Account> GetAsync(CancellationToken cancellationToken = default, Action<AccountRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.Account body, CancellationToken cancellationToken = default, Action<AccountRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
