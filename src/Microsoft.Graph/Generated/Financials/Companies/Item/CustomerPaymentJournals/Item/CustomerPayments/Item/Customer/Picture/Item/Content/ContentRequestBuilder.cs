...
namespace MicrosoftGraphSdk.Financials.Companies.Item.CustomerPaymentJournals.Item.CustomerPayments.Item.Customer.Picture.Item.Content {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\customerPaymentJournals\{customerPaymentJournal-id}\customerPayments\{customerPayment-id}\customer\picture\{picture-id}\content</summary>
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/customerPaymentJournals/{customerPaymentJournal_id}/customerPayments/{customerPayment_id}/customer/picture/{picture_id}/content";
