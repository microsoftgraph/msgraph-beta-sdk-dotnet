...
using MicrosoftGraphSdk.Financials.Companies.Item.Employees.Item.Picture.Item;
...
namespace MicrosoftGraphSdk.Financials.Companies.Item.Employees.Item.Picture {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\employees\{employee-id}\picture</summary>
    public class PictureRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.financials.companies.item.employees.item.picture.item collection</summary>
        ...
        public PictureRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/employees/{employee_id}/picture{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
