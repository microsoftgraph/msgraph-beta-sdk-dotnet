...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesInvoices.Item {
    ...
    public class SalesInvoiceItemRequestBuilder {
        ...
        /// </summary>
        public async Task<SalesInvoice> GetAsync(CancellationToken cancellationToken = default, Action<SalesInvoiceItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SalesInvoice body, CancellationToken cancellationToken = default, Action<SalesInvoiceItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
