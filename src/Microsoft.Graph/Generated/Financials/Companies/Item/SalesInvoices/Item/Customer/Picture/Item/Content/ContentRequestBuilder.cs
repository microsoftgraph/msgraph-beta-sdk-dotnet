...
namespace MicrosoftGraphSdk.Financials.Companies.Item.SalesInvoices.Item.Customer.Picture.Item.Content {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\salesInvoices\{salesInvoice-id}\customer\picture\{picture-id}\content</summary>
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/salesInvoices/{salesInvoice_id}/customer/picture/{picture_id}/content";
