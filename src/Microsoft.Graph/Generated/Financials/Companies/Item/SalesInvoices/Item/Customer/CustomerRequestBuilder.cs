using Microsoft.Graph.Beta.Financials.Companies.Item.SalesInvoices.Item.Customer.Currency;
using Microsoft.Graph.Beta.Financials.Companies.Item.SalesInvoices.Item.Customer.PaymentMethod;
using Microsoft.Graph.Beta.Financials.Companies.Item.SalesInvoices.Item.Customer.PaymentTerm;
using Microsoft.Graph.Beta.Financials.Companies.Item.SalesInvoices.Item.Customer.Picture;
using Microsoft.Graph.Beta.Financials.Companies.Item.SalesInvoices.Item.Customer.ShipmentMethod;
...
using System;
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesInvoices.Item.Customer {
    /// <summary>
    ...
    public class CustomerRequestBuilder : BaseRequestBuilder {
        ...
        public CustomerRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoices/{salesInvoice%2Did}/customer{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CustomerRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CustomerRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoices/{salesInvoice%2Did}/customer{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
