...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesInvoices.Item.Post {
    /// <summary>
    ...
    public class PostRequestBuilder : BaseRequestBuilder {
        ...
        public PostRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoices/{salesInvoice%2Did}/post", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PostRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PostRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoices/{salesInvoice%2Did}/post", rawUrl) {
        }
        /// <summary>
        /// Invoke action post
        /// </summary>
