...
using MicrosoftGraphSdk.Financials.Companies.Item.SalesInvoices.Item.Customer.Picture.Item;
...
namespace MicrosoftGraphSdk.Financials.Companies.Item.SalesInvoices.Item.Customer.Picture {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\salesInvoices\{salesInvoice-id}\customer\picture</summary>
    public class PictureRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.financials.companies.item.salesInvoices.item.customer.picture.item collection</summary>
