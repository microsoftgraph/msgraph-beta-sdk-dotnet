...
namespace MicrosoftGraphSdk.Financials.Companies.Item.SalesInvoices.Item.SalesInvoiceLines {
    public class SalesInvoiceLinesResponse : IParsable {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        public string NextLink { get; set; }
        public List<SalesInvoiceLine> Value { get; set; }
        /// <summary>
        /// Instantiates a new salesInvoiceLinesResponse and sets the default values.
        /// </summary>
        public SalesInvoiceLinesResponse() {
