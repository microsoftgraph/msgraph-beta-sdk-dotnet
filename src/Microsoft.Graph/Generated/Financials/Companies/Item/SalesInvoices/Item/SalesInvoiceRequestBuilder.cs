...
using MicrosoftGraph.Financials.Companies.Item.SalesInvoices.Item.Cancel;
using MicrosoftGraph.Financials.Companies.Item.SalesInvoices.Item.CancelAndSend;
using MicrosoftGraph.Financials.Companies.Item.SalesInvoices.Item.Currency;
using MicrosoftGraph.Financials.Companies.Item.SalesInvoices.Item.Customer;
using MicrosoftGraph.Financials.Companies.Item.SalesInvoices.Item.PaymentTerm;
using MicrosoftGraph.Financials.Companies.Item.SalesInvoices.Item.Post;
using MicrosoftGraph.Financials.Companies.Item.SalesInvoices.Item.PostAndSend;
using MicrosoftGraph.Financials.Companies.Item.SalesInvoices.Item.SalesInvoiceLines;
using MicrosoftGraph.Financials.Companies.Item.SalesInvoices.Item.Send;
using MicrosoftGraph.Financials.Companies.Item.SalesInvoices.Item.ShipmentMethod;
...
namespace MicrosoftGraph.Financials.Companies.Item.SalesInvoices.Item {
    ...
    public class SalesInvoiceRequestBuilder {
        ...
        /// </summary>
        public SalesInvoiceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public SalesInvoiceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
