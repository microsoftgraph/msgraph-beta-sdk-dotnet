...
#nullable enable
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<CancelAndSendRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<CancelAndSendRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
