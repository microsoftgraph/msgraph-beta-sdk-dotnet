...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesInvoices.Item.CancelAndSend {
    ...
    public class CancelAndSendRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<CancelAndSendRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
