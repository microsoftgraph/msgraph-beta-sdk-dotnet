...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="CancelAndSendRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public CancelAndSendRequestBuilder WithUrl(string rawUrl)
        {
            return new CancelAndSendRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
