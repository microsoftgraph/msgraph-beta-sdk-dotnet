...
using MicrosoftGraphSdk.Financials.Companies.Item.SalesQuotes.Item.SalesQuoteLines.Item;
...
namespace MicrosoftGraphSdk.Financials.Companies.Item.SalesQuotes.Item.SalesQuoteLines {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\salesQuotes\{salesQuote-id}\salesQuoteLines</summary>
    public class SalesQuoteLinesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.financials.companies.item.salesQuotes.item.salesQuoteLines.item collection</summary>
        ...
        public SalesQuoteLinesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/salesQuotes/{salesQuote_id}/salesQuoteLines{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
