...
using MicrosoftGraph.Financials.Companies.Item.SalesQuotes.Item.SalesQuoteLines.Item;
...
namespace MicrosoftGraph.Financials.Companies.Item.SalesQuotes.Item.SalesQuoteLines {
    ...
    public class SalesQuoteLinesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.financials.companies.item.salesQuotes.item.salesQuoteLines.item collection</summary>
