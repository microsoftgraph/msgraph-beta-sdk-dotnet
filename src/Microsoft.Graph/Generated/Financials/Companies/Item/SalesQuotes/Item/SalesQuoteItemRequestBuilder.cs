...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesQuotes.Item {
    ...
    public class SalesQuoteItemRequestBuilder {
        ...
        /// </summary>
        public async Task<SalesQuote> GetAsync(CancellationToken cancellationToken = default, Action<SalesQuoteItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SalesQuote body, CancellationToken cancellationToken = default, Action<SalesQuoteItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
