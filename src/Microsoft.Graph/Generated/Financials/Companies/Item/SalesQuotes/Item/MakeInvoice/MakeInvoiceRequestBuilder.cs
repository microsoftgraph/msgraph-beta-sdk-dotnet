...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesQuotes.Item.MakeInvoice {
    ...
    public class MakeInvoiceRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<MakeInvoiceRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
