...
using MicrosoftGraphSdk.Financials.Companies.Item.SalesQuotes.Item.SalesQuoteLines.Item.Item.Picture.Item;
...
namespace MicrosoftGraphSdk.Financials.Companies.Item.SalesQuotes.Item.SalesQuoteLines.Item.Item.Picture {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\salesQuotes\{salesQuote-id}\salesQuoteLines\{salesQuoteLine-id}\item\picture</summary>
    public class PictureRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.financials.companies.item.salesQuotes.item.salesQuoteLines.item.item.picture.item collection</summary>
