...
using MicrosoftGraphSdk.Financials.Companies.Item.CustomerPayments.Item.Customer.Picture.Item;
...
namespace MicrosoftGraphSdk.Financials.Companies.Item.CustomerPayments.Item.Customer.Picture {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\customerPayments\{customerPayment-id}\customer\picture</summary>
    public class PictureRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.financials.companies.item.customerPayments.item.customer.picture.item collection</summary>
        ...
        public PictureRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/customerPayments/{customerPayment_id}/customer/picture{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
