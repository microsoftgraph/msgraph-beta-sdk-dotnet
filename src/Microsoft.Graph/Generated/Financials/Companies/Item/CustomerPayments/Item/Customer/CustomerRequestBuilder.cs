...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CustomerRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CustomerRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Customer?> GetAsync(CancellationToken cancellationToken = default, Action<CustomerRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Customer> GetAsync(CancellationToken cancellationToken = default, Action<CustomerRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Customer?> PatchAsync(Microsoft.Graph.Beta.Models.Customer body, CancellationToken cancellationToken = default, Action<CustomerRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Customer> PatchAsync(Microsoft.Graph.Beta.Models.Customer body, CancellationToken cancellationToken = default, Action<CustomerRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
