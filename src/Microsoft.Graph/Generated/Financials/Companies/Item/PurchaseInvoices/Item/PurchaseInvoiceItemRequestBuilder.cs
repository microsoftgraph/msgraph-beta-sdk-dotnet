...
#nullable enable
        public async Task<PurchaseInvoice?> GetAsync(CancellationToken cancellationToken = default, Action<PurchaseInvoiceItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PurchaseInvoice> GetAsync(CancellationToken cancellationToken = default, Action<PurchaseInvoiceItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PurchaseInvoice?> PatchAsync(PurchaseInvoice body, CancellationToken cancellationToken = default, Action<PurchaseInvoiceItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PurchaseInvoice> PatchAsync(PurchaseInvoice body, CancellationToken cancellationToken = default, Action<PurchaseInvoiceItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
