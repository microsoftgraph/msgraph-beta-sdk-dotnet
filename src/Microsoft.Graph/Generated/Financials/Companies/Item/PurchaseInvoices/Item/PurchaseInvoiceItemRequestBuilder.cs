...
using MicrosoftGraphSdk.Financials.Companies.Item.PurchaseInvoices.Item.Currency;
using MicrosoftGraphSdk.Financials.Companies.Item.PurchaseInvoices.Item.Post;
using MicrosoftGraphSdk.Financials.Companies.Item.PurchaseInvoices.Item.PurchaseInvoiceLines;
using MicrosoftGraphSdk.Financials.Companies.Item.PurchaseInvoices.Item.Vendor;
...
namespace MicrosoftGraphSdk.Financials.Companies.Item.PurchaseInvoices.Item {
    ...
    public class PurchaseInvoiceItemRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(PurchaseInvoice body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PurchaseInvoice> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(PurchaseInvoice body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
