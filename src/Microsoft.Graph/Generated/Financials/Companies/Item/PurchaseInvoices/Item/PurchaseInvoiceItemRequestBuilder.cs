...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.PurchaseInvoices.Item {
    ...
    public class PurchaseInvoiceItemRequestBuilder {
        ...
        /// </summary>
        public async Task<PurchaseInvoice> GetAsync(CancellationToken cancellationToken = default, Action<PurchaseInvoiceItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(PurchaseInvoice body, CancellationToken cancellationToken = default, Action<PurchaseInvoiceItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
