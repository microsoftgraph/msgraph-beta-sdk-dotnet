...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesCreditMemoLines.Item {
    ...
    public class SalesCreditMemoLineItemRequestBuilder {
        ...
        /// </summary>
        public async Task<SalesCreditMemoLine> GetAsync(CancellationToken cancellationToken = default, Action<SalesCreditMemoLineItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SalesCreditMemoLine body, CancellationToken cancellationToken = default, Action<SalesCreditMemoLineItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
