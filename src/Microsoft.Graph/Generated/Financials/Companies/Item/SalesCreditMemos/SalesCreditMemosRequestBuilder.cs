...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesCreditMemos {
    ...
    public class SalesCreditMemosRequestBuilder {
        ...
        /// </summary>
        public async Task<SalesCreditMemoCollectionResponse> GetAsync(Action<SalesCreditMemosRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SalesCreditMemo> PostAsync(SalesCreditMemo body, Action<SalesCreditMemosRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
