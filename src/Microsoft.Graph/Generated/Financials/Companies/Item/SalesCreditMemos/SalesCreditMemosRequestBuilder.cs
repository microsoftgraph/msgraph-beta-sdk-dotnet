...
#nullable enable
        public async Task<SalesCreditMemoCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SalesCreditMemosRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SalesCreditMemoCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SalesCreditMemosRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
