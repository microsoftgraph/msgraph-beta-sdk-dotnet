...
using MicrosoftGraphSdk.Financials.Companies.Item.SalesCreditMemos.Item.Customer.Picture.Item;
...
namespace MicrosoftGraphSdk.Financials.Companies.Item.SalesCreditMemos.Item.Customer.Picture {
    /// <summary>Builds and executes requests for operations under \financials\companies\{company-id}\salesCreditMemos\{salesCreditMemo-id}\customer\picture</summary>
    public class PictureRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.financials.companies.item.salesCreditMemos.item.customer.picture.item collection</summary>
