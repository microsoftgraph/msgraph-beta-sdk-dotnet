...
using MicrosoftGraph.Financials.Companies.Item.SalesCreditMemos.Item.Currency;
using MicrosoftGraph.Financials.Companies.Item.SalesCreditMemos.Item.Customer;
using MicrosoftGraph.Financials.Companies.Item.SalesCreditMemos.Item.PaymentTerm;
using MicrosoftGraph.Financials.Companies.Item.SalesCreditMemos.Item.SalesCreditMemoLines;
...
namespace MicrosoftGraph.Financials.Companies.Item.SalesCreditMemos.Item {
    ...
    public class SalesCreditMemoRequestBuilder {
        ...
        /// </summary>
        public SalesCreditMemoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/financials/companies/{company_id}/salesCreditMemos/{salesCreditMemo_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public SalesCreditMemoRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(SalesCreditMemo body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
