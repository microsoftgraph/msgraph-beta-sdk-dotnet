...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesCreditMemos.Item.Currency {
    ...
    public class CurrencyRequestBuilder : BaseRequestBuilder {
        ...
        public CurrencyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemos/{salesCreditMemo%2Did}/currency{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CurrencyRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CurrencyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemos/{salesCreditMemo%2Did}/currency{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
