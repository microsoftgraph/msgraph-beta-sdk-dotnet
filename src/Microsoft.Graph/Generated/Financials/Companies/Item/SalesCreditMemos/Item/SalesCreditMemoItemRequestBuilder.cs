...
#nullable enable
        public async Task<SalesCreditMemo?> GetAsync(Action<RequestConfiguration<SalesCreditMemoItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<SalesCreditMemo> GetAsync(Action<RequestConfiguration<SalesCreditMemoItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<SalesCreditMemo>(requestInfo, SalesCreditMemo.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SalesCreditMemo?> PatchAsync(SalesCreditMemo body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<SalesCreditMemo> PatchAsync(SalesCreditMemo body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="SalesCreditMemoItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public SalesCreditMemoItemRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
        ...
        public class SalesCreditMemoItemRequestBuilderGetRequestConfiguration : RequestConfiguration<SalesCreditMemoItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
