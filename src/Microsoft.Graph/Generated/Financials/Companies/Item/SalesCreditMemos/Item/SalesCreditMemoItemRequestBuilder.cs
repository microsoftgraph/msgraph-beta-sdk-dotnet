...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesCreditMemos.Item {
    ...
    public class SalesCreditMemoItemRequestBuilder {
        ...
        /// </summary>
        public async Task<SalesCreditMemo> GetAsync(CancellationToken cancellationToken = default, Action<SalesCreditMemoItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SalesCreditMemo body, CancellationToken cancellationToken = default, Action<SalesCreditMemoItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
