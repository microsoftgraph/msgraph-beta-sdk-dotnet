...
namespace Microsoft.Graph.Beta.Financials.Companies.Item.SalesCreditMemos.Item {
    ...
    public class SalesCreditMemoItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SalesCreditMemo> PatchAsync(SalesCreditMemo body, Action<SalesCreditMemoItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
