...
namespace MicrosoftGraphSdk.Financials.Companies.Item.SalesCreditMemos {
    public class SalesCreditMemosResponse : IParsable {
        ...
        /// </summary>
        public static SalesCreditMemosResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SalesCreditMemosResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as SalesCreditMemosResponse).Value = n.GetCollectionOfObjectValues<SalesCreditMemo>(SalesCreditMemo.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
