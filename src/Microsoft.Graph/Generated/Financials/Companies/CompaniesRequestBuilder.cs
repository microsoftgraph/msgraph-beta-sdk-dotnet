...
namespace Microsoft.Graph.Beta.Financials.Companies {
    ...
    public class CompaniesRequestBuilder {
        ...
        /// </summary>
        public async Task<CompanyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CompaniesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Company> PostAsync(Company body, CancellationToken cancellationToken = default, Action<CompaniesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
