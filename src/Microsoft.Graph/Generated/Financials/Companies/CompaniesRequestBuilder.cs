...
#nullable enable
        public async Task<CompanyCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<CompaniesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CompanyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CompaniesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
