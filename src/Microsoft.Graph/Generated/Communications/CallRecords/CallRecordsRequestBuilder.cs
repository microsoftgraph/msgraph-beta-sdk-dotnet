...
namespace Microsoft.Graph.Beta.Communications.CallRecords {
    ...
    public class CallRecordsRequestBuilder {
        ...
        /// </summary>
        public async Task<CallRecordCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CallRecordsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<CallRecord> PostAsync(CallRecord body, CancellationToken cancellationToken = default, Action<CallRecordsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
