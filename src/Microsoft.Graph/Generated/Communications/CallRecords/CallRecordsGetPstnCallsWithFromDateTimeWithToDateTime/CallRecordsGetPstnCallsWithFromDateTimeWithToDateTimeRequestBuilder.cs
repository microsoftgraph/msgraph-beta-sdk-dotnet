...
namespace Microsoft.Graph.Beta.Communications.CallRecords.CallRecordsGetPstnCallsWithFromDateTimeWithToDateTime {
    ...
    public class CallRecordsGetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilder {
        ...
        public CallRecordsGetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, DateTimeOffset? fromDateTime = default, DateTimeOffset? toDateTime = default) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CallRecordsGetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
