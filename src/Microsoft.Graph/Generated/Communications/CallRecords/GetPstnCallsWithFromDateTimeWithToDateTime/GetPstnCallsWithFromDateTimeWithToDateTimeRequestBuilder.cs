...
namespace Microsoft.Graph.Beta.Communications.CallRecords.GetPstnCallsWithFromDateTimeWithToDateTime {
    ...
    public class GetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public async Task<GetPstnCallsWithFromDateTimeWithToDateTimeResponse> GetAsync(Action<GetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
