...
namespace MicrosoftGraphSdk.Communications.CallRecords.Item.Sessions.Item.Segments {
    public class SegmentsResponse : IParsable {
        ...
        /// </summary>
        public static SegmentsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as SegmentsResponse).Value = n.GetCollectionOfObjectValues<Segment>(Segment.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
