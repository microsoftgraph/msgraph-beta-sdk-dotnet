...
#nullable enable
        public async Task<SessionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SessionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SessionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SessionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Session?> PostAsync(Session body, CancellationToken cancellationToken = default, Action<SessionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Session> PostAsync(Session body, CancellationToken cancellationToken = default, Action<SessionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
