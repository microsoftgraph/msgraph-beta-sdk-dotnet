...
namespace Microsoft.Graph.Beta.Communications.CallRecords.Item.Sessions {
    ...
    public class SessionsRequestBuilder {
        ...
        /// </summary>
        public async Task<SessionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SessionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Session> PostAsync(Session body, CancellationToken cancellationToken = default, Action<SessionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
