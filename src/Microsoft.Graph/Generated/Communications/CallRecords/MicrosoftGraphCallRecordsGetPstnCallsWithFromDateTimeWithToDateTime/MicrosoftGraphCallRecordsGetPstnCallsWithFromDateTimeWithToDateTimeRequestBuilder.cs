...
#nullable enable
        public async Task<GetPstnCallsWithFromDateTimeWithToDateTimeResponse?> GetAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphCallRecordsGetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetPstnCallsWithFromDateTimeWithToDateTimeResponse> GetAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphCallRecordsGetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
