...
namespace MicrosoftGraphSdk.Communications.OnlineMeetings.Item.AlternativeRecording {
    /// <summary>Builds and executes requests for operations under \communications\onlineMeetings\{onlineMeeting-id}\alternativeRecording</summary>
    public class AlternativeRecordingRequestBuilder {
        ...
        public AlternativeRecordingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/communications/onlineMeetings/{onlineMeeting_id}/alternativeRecording";
