...
namespace Microsoft.Graph.Beta.Communications.OnlineMeetings.Item.Registration.CustomQuestions {
    ...
    public class CustomQuestionsRequestBuilder {
        ...
        /// </summary>
        public async Task<MeetingRegistrationQuestionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CustomQuestionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MeetingRegistrationQuestion> PostAsync(MeetingRegistrationQuestion body, CancellationToken cancellationToken = default, Action<CustomQuestionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
