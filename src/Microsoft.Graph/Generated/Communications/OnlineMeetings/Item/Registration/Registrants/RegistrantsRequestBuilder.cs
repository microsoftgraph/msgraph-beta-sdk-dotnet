using Microsoft.Graph.Beta.Communications.OnlineMeetings.Item.Registration.Registrants.Count;
using Microsoft.Graph.Beta.Communications.OnlineMeetings.Item.Registration.Registrants.Item;
...
using System;
namespace Microsoft.Graph.Beta.Communications.OnlineMeetings.Item.Registration.Registrants {
    /// <summary>
    ...
    public class RegistrantsRequestBuilder : BaseRequestBuilder {
        ...
        public RegistrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration/registrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RegistrantsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RegistrantsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration/registrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
