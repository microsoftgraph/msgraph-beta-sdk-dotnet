...
using MicrosoftGraph.Communications.OnlineMeetings.Item.AttendanceReports.Item.AttendanceRecords.Item;
...
namespace MicrosoftGraph.Communications.OnlineMeetings.Item.AttendanceReports.Item.AttendanceRecords {
    ...
    public class AttendanceRecordsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.communications.onlineMeetings.item.attendanceReports.item.attendanceRecords.item collection</summary>
