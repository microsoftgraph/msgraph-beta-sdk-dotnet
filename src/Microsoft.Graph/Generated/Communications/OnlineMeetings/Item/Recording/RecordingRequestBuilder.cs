...
namespace MicrosoftGraphSdk.Communications.OnlineMeetings.Item.Recording {
    /// <summary>Builds and executes requests for operations under \communications\onlineMeetings\{onlineMeeting-id}\recording</summary>
    public class RecordingRequestBuilder {
        ...
        public RecordingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/communications/onlineMeetings/{onlineMeeting_id}/recording";
