...
using MicrosoftGraphSdk.Communications.OnlineMeetings.Item.AlternativeRecording;
...
using MicrosoftGraphSdk.Communications.OnlineMeetings.Item.MeetingAttendanceReport;
using MicrosoftGraphSdk.Communications.OnlineMeetings.Item.Recording;
using MicrosoftGraphSdk.Communications.OnlineMeetings.Item.Registration;
...
namespace MicrosoftGraphSdk.Communications.OnlineMeetings.Item {
    ...
    public class OnlineMeetingItemRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(OnlineMeeting body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OnlineMeeting> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(OnlineMeeting body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
