...
using MicrosoftGraph.Communications.OnlineMeetings.CreateOrGet;
using MicrosoftGraph.Communications.OnlineMeetings.Item;
...
namespace MicrosoftGraph.Communications.OnlineMeetings {
    ...
    public class OnlineMeetingsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.communications.onlineMeetings.item collection</summary>
