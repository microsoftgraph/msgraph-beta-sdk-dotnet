...
namespace Microsoft.Graph.Beta.Communications.Presences.Item.ClearPresence {
    ...
    /// </summary>
    public class ClearPresenceRequestBuilder : BaseRequestBuilder {
        /// <summary>
...
#nullable enable
        public async Task PostAsync(ClearPresencePostRequestBody body, CancellationToken cancellationToken = default, Action<ClearPresenceRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(ClearPresencePostRequestBody body, CancellationToken cancellationToken = default, Action<ClearPresenceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
