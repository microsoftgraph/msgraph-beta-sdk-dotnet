    ...
    public class PresencesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as PresencesResponse).Value = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.Presence>(MicrosoftGraphSdk.Models.Microsoft.Graph.Presence.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
