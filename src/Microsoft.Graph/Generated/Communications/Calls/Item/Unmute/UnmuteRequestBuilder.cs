...
namespace Microsoft.Graph.Beta.Communications.Calls.Item.Unmute {
    ...
    public class UnmuteRequestBuilder {
        ...
        /// </summary>
        public async Task<UnmuteParticipantOperation> PostAsync(UnmutePostRequestBody body, Action<UnmuteRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
