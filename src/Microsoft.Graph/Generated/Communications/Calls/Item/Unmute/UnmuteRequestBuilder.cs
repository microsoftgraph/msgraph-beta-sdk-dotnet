...
namespace Microsoft.Graph.Beta.Communications.Calls.Item.Unmute {
    ...
    public class UnmuteRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(UnmutePostRequestBody body, Action<UnmuteRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<UnmuteParticipantOperation> PostAsync(UnmutePostRequestBody body, CancellationToken cancellationToken = default, Action<UnmuteRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<UnmuteParticipantOperation>(requestInfo, UnmuteParticipantOperation.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
