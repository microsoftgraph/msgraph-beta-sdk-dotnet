...
namespace Microsoft.Graph.Beta.Communications.Calls.Item.Unmute {
    ...
    public class UnmuteRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <see cref="UnmuteParticipantOperation"/></returns>
...
#nullable enable
        public async Task<UnmuteParticipantOperation?> PostAsync(UnmutePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<UnmuteParticipantOperation> PostAsync(UnmutePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="UnmuteRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
