...
namespace Microsoft.Graph.Beta.Communications.Calls.Item.Unmute {
    ...
    public class UnmuteRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(UnmuteRequestBody body, Action<UnmuteRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<UnmuteParticipantOperation> PostAsync(UnmuteRequestBody body, Action<UnmuteRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
