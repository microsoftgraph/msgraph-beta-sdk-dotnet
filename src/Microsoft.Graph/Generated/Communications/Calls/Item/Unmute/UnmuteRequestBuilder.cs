...
namespace MicrosoftGraphSdk.Communications.Calls.Item.Unmute {
    ...
    public class UnmuteRequestBuilder {
        ...
        /// </summary>
        public async Task<UnmuteParticipantOperation> PostAsync(UnmuteRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
