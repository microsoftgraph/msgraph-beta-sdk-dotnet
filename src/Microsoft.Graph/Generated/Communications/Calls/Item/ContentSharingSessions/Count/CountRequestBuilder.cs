...
namespace Microsoft.Graph.Beta.Communications.Calls.Item.ContentSharingSessions.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/communications/calls/{call%2Did}/contentSharingSessions/$count{?%24search,%24filter}";
