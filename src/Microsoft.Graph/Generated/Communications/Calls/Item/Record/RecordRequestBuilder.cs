...
#nullable enable
        public async Task<RecordOperation?> PostAsync(RecordPostRequestBody body, CancellationToken cancellationToken = default, Action<RecordRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RecordOperation> PostAsync(RecordPostRequestBody body, CancellationToken cancellationToken = default, Action<RecordRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
