...
namespace Microsoft.Graph.Beta.Communications.Calls.Item.KeepAlive {
    ...
    public class KeepAliveRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<KeepAliveRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
