...
namespace Microsoft.Graph.Beta.Communications.Calls.Item.Participants.Invite {
    ...
    public class InviteRequestBuilder {
        ...
        /// </summary>
        public async Task<InviteParticipantsOperation> PostAsync(InviteRequestBody body, Action<InviteRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
