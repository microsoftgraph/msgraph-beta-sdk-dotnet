...
#nullable enable
        public async Task<MuteParticipantsOperation?> PostAsync(MuteAllPostRequestBody body, CancellationToken cancellationToken = default, Action<MuteAllRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MuteParticipantsOperation> PostAsync(MuteAllPostRequestBody body, CancellationToken cancellationToken = default, Action<MuteAllRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
