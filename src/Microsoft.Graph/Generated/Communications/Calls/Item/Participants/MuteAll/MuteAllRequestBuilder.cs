...
namespace Microsoft.Graph.Beta.Communications.Calls.Item.Participants.MuteAll {
    ...
    public class MuteAllRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="MuteParticipantsOperation"></returns>
...
#nullable enable
        public async Task<MuteParticipantsOperation?> PostAsync(MuteAllPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<MuteParticipantsOperation> PostAsync(MuteAllPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="MuteAllRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
