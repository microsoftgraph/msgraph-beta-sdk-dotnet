...
namespace Microsoft.Graph.Beta.Communications.Calls.Item.Operations.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/communications/calls/{call%2Did}/operations/$count{?%24search,%24filter}";
