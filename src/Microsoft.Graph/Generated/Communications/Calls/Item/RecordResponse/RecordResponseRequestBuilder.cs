...
namespace Microsoft.Graph.Beta.Communications.Calls.Item.RecordResponse
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Communications.Calls.Item.RecordResponse.RecordResponseRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.RecordOperation?> PostAsync(Microsoft.Graph.Beta.Communications.Calls.Item.RecordResponse.RecordResponsePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.RecordOperation> PostAsync(Microsoft.Graph.Beta.Communications.Calls.Item.RecordResponse.RecordResponsePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Communications.Calls.Item.RecordResponse.RecordResponsePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.Communications.Calls.Item.RecordResponse.RecordResponsePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Communications.Calls.Item.RecordResponse.RecordResponseRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Communications.Calls.Item.RecordResponse.RecordResponseRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Communications.Calls.Item.RecordResponse.RecordResponseRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
