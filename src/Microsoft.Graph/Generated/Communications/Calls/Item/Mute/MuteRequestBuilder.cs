...
namespace Microsoft.Graph.Beta.Communications.Calls.Item.Mute
{
    ...
    public class MuteRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="MuteParticipantOperation"/></returns>
...
#nullable enable
        public async Task<MuteParticipantOperation?> PostAsync(MutePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<MuteParticipantOperation> PostAsync(MutePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="MuteRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
