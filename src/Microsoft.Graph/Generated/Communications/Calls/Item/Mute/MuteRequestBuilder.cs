...
#nullable enable
        public async Task<MuteParticipantOperation?> PostAsync(MutePostRequestBody body, CancellationToken cancellationToken = default, Action<MuteRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MuteParticipantOperation> PostAsync(MutePostRequestBody body, CancellationToken cancellationToken = default, Action<MuteRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
