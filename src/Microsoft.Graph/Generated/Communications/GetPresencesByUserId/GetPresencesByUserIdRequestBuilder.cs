...
namespace Microsoft.Graph.Beta.Communications.GetPresencesByUserId {
    ...
    public class GetPresencesByUserIdRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetPresencesByUserIdPostResponse"></returns>
...
#nullable restore
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/cloudcommunications-getpresencesbyuserid?view=graph-rest-1.0" />
        /// </summary>
        /// <returns>A <cref="GetPresencesByUserIdResponse"></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetPresencesByUserIdRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
