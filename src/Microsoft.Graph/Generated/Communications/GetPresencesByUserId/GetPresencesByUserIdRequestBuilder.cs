...
#nullable enable
        public async Task<GetPresencesByUserIdResponse?> PostAsync(GetPresencesByUserIdPostRequestBody body, CancellationToken cancellationToken = default, Action<GetPresencesByUserIdRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetPresencesByUserIdResponse> PostAsync(GetPresencesByUserIdPostRequestBody body, CancellationToken cancellationToken = default, Action<GetPresencesByUserIdRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
