...
using System;
namespace Microsoft.Graph.Beta.DirectoryNamespace.Recommendations.Item.ImpactedResources.Item.Reactivate {
    /// <summary>
    ...
    public class ReactivateRequestBuilder : BaseRequestBuilder {
        ...
        public ReactivateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directory/recommendations/{recommendation%2Did}/impactedResources/{impactedResource%2Did}/reactivate", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ReactivateRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<ImpactedResource?> PostAsync(CancellationToken cancellationToken = default, Action<ReactivateRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ImpactedResource> PostAsync(CancellationToken cancellationToken = default, Action<ReactivateRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
