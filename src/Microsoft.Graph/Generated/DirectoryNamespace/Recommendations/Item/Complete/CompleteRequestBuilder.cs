...
using System;
namespace Microsoft.Graph.Beta.DirectoryNamespace.Recommendations.Item.Complete {
    /// <summary>
    ...
    public class CompleteRequestBuilder : BaseRequestBuilder {
        ...
        public CompleteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directory/recommendations/{recommendation%2Did}/complete", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CompleteRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Recommendation?> PostAsync(CancellationToken cancellationToken = default, Action<CompleteRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Recommendation> PostAsync(CancellationToken cancellationToken = default, Action<CompleteRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
