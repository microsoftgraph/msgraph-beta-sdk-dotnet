...
namespace Microsoft.Graph.Beta.DirectoryNamespace.Recommendations.Item.MicrosoftGraphDismiss {
    ...
    public class MicrosoftGraphDismissRequestBuilder {
        ...
        public MicrosoftGraphDismissRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/recommendations/{recommendation%2Did}/microsoft.graph.dismiss";
...
#nullable enable
        public async Task<Recommendation?> PostAsync(DismissPostRequestBody body, Action<MicrosoftGraphDismissRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Recommendation> PostAsync(DismissPostRequestBody body, Action<MicrosoftGraphDismissRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
