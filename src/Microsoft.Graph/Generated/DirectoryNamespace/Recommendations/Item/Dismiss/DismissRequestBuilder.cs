...
using System;
namespace Microsoft.Graph.Beta.DirectoryNamespace.Recommendations.Item.Dismiss {
    /// <summary>
    ...
    public class DismissRequestBuilder : BaseRequestBuilder {
        ...
        public DismissRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directory/recommendations/{recommendation%2Did}/dismiss", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DismissRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DismissRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directory/recommendations/{recommendation%2Did}/dismiss", rawUrl) {
        }
        /// <summary>
        /// Dismiss a recommendation object that you consider to be inapplicable to your tenant and update its **status** to `dismissed` .
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/recommendation-dismiss?view=graph-rest-1.0" />
        /// </summary>
...
#nullable enable
        public async Task<Recommendation?> PostAsync(DismissPostRequestBody body, Action<DismissRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Recommendation> PostAsync(DismissPostRequestBody body, Action<DismissRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
