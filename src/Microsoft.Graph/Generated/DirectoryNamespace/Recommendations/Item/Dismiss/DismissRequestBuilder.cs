...
#nullable enable
        public async Task<Recommendation?> PostAsync(DismissPostRequestBody body, CancellationToken cancellationToken = default, Action<DismissRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Recommendation> PostAsync(DismissPostRequestBody body, CancellationToken cancellationToken = default, Action<DismissRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
