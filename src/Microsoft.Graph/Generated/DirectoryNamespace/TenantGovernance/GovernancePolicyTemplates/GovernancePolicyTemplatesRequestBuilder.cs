...
namespace Microsoft.Graph.Beta.DirectoryNamespace.TenantGovernance.GovernancePolicyTemplates
{
    ...
    public partial class GovernancePolicyTemplatesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Microsoft.Graph.Beta.DirectoryNamespace.TenantGovernance.GovernancePolicyTemplates.Count.CountRequestBuilder Count
        {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.DirectoryNamespace.TenantGovernance.GovernancePolicyTemplates.GovernancePolicyTemplatesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GovernancePolicyTemplatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.DirectoryNamespace.TenantGovernance.GovernancePolicyTemplates.GovernancePolicyTemplatesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GovernancePolicyTemplatesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.DirectoryNamespace.TenantGovernance.GovernancePolicyTemplates.GovernancePolicyTemplatesRequestBuilder.GovernancePolicyTemplatesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.DirectoryNamespace.TenantGovernance.GovernancePolicyTemplates.GovernancePolicyTemplatesRequestBuilder.GovernancePolicyTemplatesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/directory/tenantGovernance/governancePolicyTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", PathParameters);
...
#nullable restore
...
#endif
            if(ReferenceEquals(body, null)) throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/directory/tenantGovernance/governancePolicyTemplates", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.DirectoryNamespace.TenantGovernance.GovernancePolicyTemplates.GovernancePolicyTemplatesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Beta.DirectoryNamespace.TenantGovernance.GovernancePolicyTemplates.GovernancePolicyTemplatesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Beta.DirectoryNamespace.TenantGovernance.GovernancePolicyTemplates.GovernancePolicyTemplatesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get a list of the governancePolicyTemplate objects and their properties. Policy templates define the configuration that is applied when establishing governance relationships.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class GovernancePolicyTemplatesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Microsoft.Graph.Beta.DirectoryNamespace.TenantGovernance.GovernancePolicyTemplates.GovernancePolicyTemplatesRequestBuilder.GovernancePolicyTemplatesRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
