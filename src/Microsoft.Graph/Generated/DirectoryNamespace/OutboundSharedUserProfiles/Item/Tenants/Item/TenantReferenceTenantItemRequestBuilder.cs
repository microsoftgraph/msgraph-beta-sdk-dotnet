...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<TenantReferenceTenantItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<TenantReferenceTenantItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TenantReference?> GetAsync(CancellationToken cancellationToken = default, Action<TenantReferenceTenantItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TenantReference> GetAsync(CancellationToken cancellationToken = default, Action<TenantReferenceTenantItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TenantReference?> PatchAsync(TenantReference body, CancellationToken cancellationToken = default, Action<TenantReferenceTenantItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TenantReference> PatchAsync(TenantReference body, CancellationToken cancellationToken = default, Action<TenantReferenceTenantItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
