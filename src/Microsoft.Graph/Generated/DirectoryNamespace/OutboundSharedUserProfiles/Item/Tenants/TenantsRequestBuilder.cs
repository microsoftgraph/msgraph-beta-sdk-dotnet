...
namespace Microsoft.Graph.Beta.DirectoryNamespace.OutboundSharedUserProfiles.Item.Tenants {
    ...
    public class TenantsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <returns>A <see cref="TenantReferenceTenantItemRequestBuilder"/></returns>
        public TenantReferenceTenantItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<TenantReferenceCollectionResponse?> GetAsync(Action<RequestConfiguration<TenantsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<TenantReferenceCollectionResponse> GetAsync(Action<RequestConfiguration<TenantsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<TenantReferenceCollectionResponse>(requestInfo, TenantReferenceCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TenantReference?> PostAsync(TenantReference body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<TenantReference> PostAsync(TenantReference body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
