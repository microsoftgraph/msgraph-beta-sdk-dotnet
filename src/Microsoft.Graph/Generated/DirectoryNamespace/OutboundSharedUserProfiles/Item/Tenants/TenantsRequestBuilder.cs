...
namespace Microsoft.Graph.Beta.DirectoryNamespace.OutboundSharedUserProfiles.Item.Tenants {
    ...
    public class TenantsRequestBuilder {
        ...
        /// </summary>
        public async Task<TenantReferenceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TenantsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TenantReference> PostAsync(TenantReference body, CancellationToken cancellationToken = default, Action<TenantsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
