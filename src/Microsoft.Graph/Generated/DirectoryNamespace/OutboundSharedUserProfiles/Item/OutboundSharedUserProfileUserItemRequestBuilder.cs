...
#nullable restore
        ...
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public OutboundSharedUserProfileUserItemRequestBuilder WithUrl(string rawUrl) {
            return new OutboundSharedUserProfileUserItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
