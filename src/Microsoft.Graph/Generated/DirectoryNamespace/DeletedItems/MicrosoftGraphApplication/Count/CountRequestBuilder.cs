...
namespace Microsoft.Graph.Beta.DirectoryNamespace.DeletedItems.MicrosoftGraphApplication.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/deletedItems/microsoft.graph.application/$count{?%24search,%24filter}";
