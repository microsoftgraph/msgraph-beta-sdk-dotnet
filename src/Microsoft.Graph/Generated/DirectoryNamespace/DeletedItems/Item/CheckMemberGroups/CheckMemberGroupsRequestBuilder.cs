...
namespace Microsoft.Graph.Beta.DirectoryNamespace.DeletedItems.Item.CheckMemberGroups {
    ...
    public class CheckMemberGroupsRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="CheckMemberGroupsPostResponse"></returns>
...
#nullable restore
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/directoryobject-checkmembergroups?view=graph-rest-1.0" />
        /// </summary>
        /// <returns>A <cref="CheckMemberGroupsResponse"></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="CheckMemberGroupsRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
