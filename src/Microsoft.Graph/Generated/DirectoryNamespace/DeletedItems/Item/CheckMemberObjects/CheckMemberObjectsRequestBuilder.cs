...
namespace Microsoft.Graph.Beta.DirectoryNamespace.DeletedItems.Item.CheckMemberObjects {
    ...
    public class CheckMemberObjectsRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="CheckMemberObjectsPostResponse"></returns>
...
#nullable restore
        ...
        /// Invoke action checkMemberObjects
        /// </summary>
        /// <returns>A <cref="CheckMemberObjectsResponse"></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="CheckMemberObjectsRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
