...
namespace Microsoft.Graph.Beta.DirectoryNamespace.InboundSharedUserProfiles.Item {
    ...
    public class InboundSharedUserProfileUserItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<InboundSharedUserProfileUserItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<InboundSharedUserProfile> GetAsync(CancellationToken cancellationToken = default, Action<InboundSharedUserProfileUserItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(InboundSharedUserProfile body, CancellationToken cancellationToken = default, Action<InboundSharedUserProfileUserItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
