...
namespace Microsoft.Graph.Beta.DirectoryNamespace.InboundSharedUserProfiles.Item.MicrosoftGraphExportPersonalData {
    /// <summary>
    ...
    public class MicrosoftGraphExportPersonalDataRequestBuilder {
        ...
        public MicrosoftGraphExportPersonalDataRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/directory/inboundSharedUserProfiles/{inboundSharedUserProfile%2DuserId}/microsoft.graph.exportPersonalData";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphExportPersonalDataRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(ExportPersonalDataPostRequestBody body, Action<MicrosoftGraphExportPersonalDataRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(ExportPersonalDataPostRequestBody body, Action<MicrosoftGraphExportPersonalDataRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
