...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AttributeSetItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AttributeSetItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AttributeSet?> GetAsync(CancellationToken cancellationToken = default, Action<AttributeSetItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AttributeSet> GetAsync(CancellationToken cancellationToken = default, Action<AttributeSetItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AttributeSet?> PatchAsync(AttributeSet body, CancellationToken cancellationToken = default, Action<AttributeSetItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AttributeSet> PatchAsync(AttributeSet body, CancellationToken cancellationToken = default, Action<AttributeSetItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
