...
#nullable enable
        public async Task<ImpactedResource?> PostAsync(PostponePostRequestBody body, CancellationToken cancellationToken = default, Action<PostponeRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ImpactedResource> PostAsync(PostponePostRequestBody body, CancellationToken cancellationToken = default, Action<PostponeRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
