...
namespace Microsoft.Graph.Beta.DirectoryNamespace.ImpactedResources.Item.Dismiss
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.DirectoryNamespace.ImpactedResources.Item.Dismiss.DismissRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ImpactedResource?> PostAsync(Microsoft.Graph.Beta.DirectoryNamespace.ImpactedResources.Item.Dismiss.DismissPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ImpactedResource> PostAsync(Microsoft.Graph.Beta.DirectoryNamespace.ImpactedResources.Item.Dismiss.DismissPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.DirectoryNamespace.ImpactedResources.Item.Dismiss.DismissPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Beta.DirectoryNamespace.ImpactedResources.Item.Dismiss.DismissPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.DirectoryNamespace.ImpactedResources.Item.Dismiss.DismissRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.DirectoryNamespace.ImpactedResources.Item.Dismiss.DismissRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.DirectoryNamespace.ImpactedResources.Item.Dismiss.DismissRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
