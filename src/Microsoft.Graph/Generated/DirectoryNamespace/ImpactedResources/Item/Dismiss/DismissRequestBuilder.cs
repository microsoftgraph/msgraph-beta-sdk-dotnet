...
namespace Microsoft.Graph.Beta.DirectoryNamespace.ImpactedResources.Item.Dismiss {
    ...
    public class DismissRequestBuilder {
        ...
        /// </summary>
        public async Task<RecommendationResource> PostAsync(DismissPostRequestBody body, CancellationToken cancellationToken = default, Action<DismissRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
