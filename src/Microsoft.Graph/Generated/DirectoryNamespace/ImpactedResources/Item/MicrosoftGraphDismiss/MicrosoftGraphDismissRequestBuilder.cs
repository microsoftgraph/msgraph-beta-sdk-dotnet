...
#nullable enable
        public async Task<ImpactedResource?> PostAsync(DismissPostRequestBody body, Action<MicrosoftGraphDismissRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ImpactedResource> PostAsync(DismissPostRequestBody body, Action<MicrosoftGraphDismissRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
