...
namespace Microsoft.Graph.Beta.DirectoryNamespace.CustomSecurityAttributeDefinitions.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/customSecurityAttributeDefinitions/$count{?%24search,%24filter}";
