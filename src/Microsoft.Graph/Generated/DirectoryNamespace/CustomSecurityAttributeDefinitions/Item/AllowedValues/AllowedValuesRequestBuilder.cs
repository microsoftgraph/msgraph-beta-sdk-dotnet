...
namespace Microsoft.Graph.Beta.DirectoryNamespace.CustomSecurityAttributeDefinitions.Item.AllowedValues {
    ...
    public class AllowedValuesRequestBuilder {
        ...
        /// </summary>
        public async Task<AllowedValueCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AllowedValuesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AllowedValue> PostAsync(AllowedValue body, CancellationToken cancellationToken = default, Action<AllowedValuesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
