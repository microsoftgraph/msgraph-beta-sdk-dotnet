...
namespace Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies
{
    ...
    public class FeatureRolloutPoliciesRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies.Count.CountRequestBuilder Count
        {
            get => new Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        /// <returns>A <see cref="Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies.Item.FeatureRolloutPolicyItemRequestBuilder"/></returns>
        [Obsolete("Feature Rollout Policies have been grouped with other policies under /policies. The existing /directory/featureRolloutPolicies is deprecated and will stop returning data on 06/30/2021. Please use /policies/featureRolloutPolicies. as of 2021-01/DirectoryFeatureRolloutPolicies")]
        public Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies.Item.FeatureRolloutPolicyItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("featureRolloutPolicy%2Did", position);
                return new Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies.Item.FeatureRolloutPolicyItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies.FeatureRolloutPoliciesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.FeatureRolloutPolicyCollectionResponse?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies.FeatureRolloutPoliciesRequestBuilder.FeatureRolloutPoliciesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.FeatureRolloutPolicyCollectionResponse> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies.FeatureRolloutPoliciesRequestBuilder.FeatureRolloutPoliciesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies.FeatureRolloutPoliciesRequestBuilder.FeatureRolloutPoliciesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies.FeatureRolloutPoliciesRequestBuilder.FeatureRolloutPoliciesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies.FeatureRolloutPoliciesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("Feature Rollout Policies have been grouped with other policies under /policies. The existing /directory/featureRolloutPolicies is deprecated and will stop returning data on 06/30/2021. Please use /policies/featureRolloutPolicies. as of 2021-01/DirectoryFeatureRolloutPolicies")]
        public Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies.FeatureRolloutPoliciesRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies.FeatureRolloutPoliciesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get featureRolloutPolicies from directory
        /// </summary>
...
#nullable restore
        ...
        public class FeatureRolloutPoliciesRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies.FeatureRolloutPoliciesRequestBuilder.FeatureRolloutPoliciesRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
