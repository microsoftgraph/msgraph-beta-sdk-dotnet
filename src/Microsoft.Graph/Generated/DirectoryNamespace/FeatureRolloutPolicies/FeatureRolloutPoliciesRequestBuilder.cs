...
namespace Microsoft.Graph.Beta.DirectoryNamespace.FeatureRolloutPolicies {
    ...
    public class FeatureRolloutPoliciesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.directory.featureRolloutPolicies.item collection</summary>
        ...
        public FeatureRolloutPoliciesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/featureRolloutPolicies{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
