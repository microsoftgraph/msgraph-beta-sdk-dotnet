...
namespace Microsoft.Graph.Beta.DirectoryNamespace.AdministrativeUnits.Item.Members.MicrosoftGraphOrgContact.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.orgContact/$count{?%24search,%24filter}";
