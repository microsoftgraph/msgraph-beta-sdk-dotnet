...
using System;
namespace Microsoft.Graph.Beta.DirectoryNamespace.AdministrativeUnits.Item.Members.Item.GraphOrgContact {
    /// <summary>
    ...
    public class GraphOrgContactRequestBuilder : BaseRequestBuilder {
        ...
        public GraphOrgContactRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/graph.orgContact{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphOrgContactRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphOrgContactRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/graph.orgContact{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<OrgContact?> GetAsync(CancellationToken cancellationToken = default, Action<GraphOrgContactRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OrgContact> GetAsync(CancellationToken cancellationToken = default, Action<GraphOrgContactRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
