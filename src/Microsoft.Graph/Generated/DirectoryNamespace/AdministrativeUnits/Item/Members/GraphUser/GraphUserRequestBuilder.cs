using Microsoft.Graph.Beta.DirectoryNamespace.AdministrativeUnits.Item.Members.GraphUser.Count;
...
namespace Microsoft.Graph.Beta.DirectoryNamespace.AdministrativeUnits.Item.Members.GraphUser {
    /// <summary>
    ...
    public class GraphUserRequestBuilder {
        ...
        public GraphUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
