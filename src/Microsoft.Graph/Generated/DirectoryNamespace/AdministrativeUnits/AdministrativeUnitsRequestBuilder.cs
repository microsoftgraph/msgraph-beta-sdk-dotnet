...
namespace Microsoft.Graph.Beta.DirectoryNamespace.AdministrativeUnits {
    ...
    public class AdministrativeUnitsRequestBuilder {
        ...
        /// </summary>
        public async Task<AdministrativeUnitCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AdministrativeUnitsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.AdministrativeUnit> PostAsync(Microsoft.Graph.Beta.Models.AdministrativeUnit body, CancellationToken cancellationToken = default, Action<AdministrativeUnitsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
