...
namespace Microsoft.Graph.Beta.IdentityGovernance.RoleManagementAlerts.AlertConfigurations.Item {
    ...
    public class UnifiedRoleManagementAlertConfigurationItemRequestBuilder {
        ...
        public UnifiedRoleManagementAlertConfigurationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/identityGovernance/roleManagementAlerts/alertConfigurations/{unifiedRoleManagementAlertConfiguration%2Did}{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnifiedRoleManagementAlertConfigurationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
