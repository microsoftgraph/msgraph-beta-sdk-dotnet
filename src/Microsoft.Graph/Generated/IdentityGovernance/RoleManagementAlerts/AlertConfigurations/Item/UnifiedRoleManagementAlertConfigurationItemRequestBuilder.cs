...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertConfigurationItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertConfigurationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleManagementAlertConfiguration?> GetAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertConfigurationItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementAlertConfiguration> GetAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertConfigurationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleManagementAlertConfiguration?> PatchAsync(UnifiedRoleManagementAlertConfiguration body, CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertConfigurationItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementAlertConfiguration> PatchAsync(UnifiedRoleManagementAlertConfiguration body, CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertConfigurationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
