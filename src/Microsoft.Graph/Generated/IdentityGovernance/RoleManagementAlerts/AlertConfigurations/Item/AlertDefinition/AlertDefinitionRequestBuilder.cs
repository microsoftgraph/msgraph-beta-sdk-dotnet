...
namespace Microsoft.Graph.Beta.IdentityGovernance.RoleManagementAlerts.AlertConfigurations.Item.AlertDefinition {
    ...
    /// </summary>
    public class AlertDefinitionRequestBuilder {
        ...
        public AlertDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/identityGovernance/roleManagementAlerts/alertConfigurations/{unifiedRoleManagementAlertConfiguration%2Did}/alertDefinition{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AlertDefinitionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
