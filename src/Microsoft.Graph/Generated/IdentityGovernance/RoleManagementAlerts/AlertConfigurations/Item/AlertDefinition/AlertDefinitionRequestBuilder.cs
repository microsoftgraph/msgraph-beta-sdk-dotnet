...
#nullable enable
        public async Task<UnifiedRoleManagementAlertDefinition?> GetAsync(CancellationToken cancellationToken = default, Action<AlertDefinitionRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementAlertDefinition> GetAsync(CancellationToken cancellationToken = default, Action<AlertDefinitionRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
