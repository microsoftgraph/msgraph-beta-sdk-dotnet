...
namespace Microsoft.Graph.Beta.IdentityGovernance.RoleManagementAlerts.AlertDefinitions.Item {
    ...
    public class UnifiedRoleManagementAlertDefinitionItemRequestBuilder {
        ...
        public UnifiedRoleManagementAlertDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/identityGovernance/roleManagementAlerts/alertDefinitions/{unifiedRoleManagementAlertDefinition%2Did}{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnifiedRoleManagementAlertDefinitionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
