using Microsoft.Graph.Beta.IdentityGovernance.RoleManagementAlerts.Operations.Count;
using Microsoft.Graph.Beta.IdentityGovernance.RoleManagementAlerts.Operations.Item;
...
namespace Microsoft.Graph.Beta.IdentityGovernance.RoleManagementAlerts.Operations {
    /// <summary>
    ...
    public class OperationsRequestBuilder : BaseRequestBuilder {
        ...
        public OperationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/roleManagementAlerts/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OperationsRequestBuilder and sets the default values.
        /// </summary>
