...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertIncidentItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertIncidentItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleManagementAlertIncident?> GetAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertIncidentItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementAlertIncident> GetAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertIncidentItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleManagementAlertIncident?> PatchAsync(UnifiedRoleManagementAlertIncident body, CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertIncidentItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementAlertIncident> PatchAsync(UnifiedRoleManagementAlertIncident body, CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertIncidentItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
