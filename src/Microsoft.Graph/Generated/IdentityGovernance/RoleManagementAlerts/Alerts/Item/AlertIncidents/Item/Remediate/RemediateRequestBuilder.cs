...
namespace Microsoft.Graph.Beta.IdentityGovernance.RoleManagementAlerts.Alerts.Item.AlertIncidents.Item.Remediate {
    ...
    /// </summary>
    public class RemediateRequestBuilder {
        ...
        public RemediateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/identityGovernance/roleManagementAlerts/alerts/{unifiedRoleManagementAlert%2Did}/alertIncidents/{unifiedRoleManagementAlertIncident%2Did}/remediate";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemediateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
