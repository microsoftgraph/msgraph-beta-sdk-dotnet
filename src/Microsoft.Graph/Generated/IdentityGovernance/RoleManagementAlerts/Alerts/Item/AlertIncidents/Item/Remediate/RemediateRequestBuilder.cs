...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="RemediateRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public RemediateRequestBuilder WithUrl(string rawUrl)
        {
            return new RemediateRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
