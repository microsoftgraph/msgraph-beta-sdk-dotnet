...
#nullable enable
        public async Task<UnifiedRoleManagementAlertIncidentCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AlertIncidentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementAlertIncidentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AlertIncidentsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleManagementAlertIncident?> PostAsync(UnifiedRoleManagementAlertIncident body, CancellationToken cancellationToken = default, Action<AlertIncidentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementAlertIncident> PostAsync(UnifiedRoleManagementAlertIncident body, CancellationToken cancellationToken = default, Action<AlertIncidentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
