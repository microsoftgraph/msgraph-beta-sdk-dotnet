...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleManagementAlert?> GetAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementAlert> GetAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleManagementAlert?> PatchAsync(UnifiedRoleManagementAlert body, CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementAlert> PatchAsync(UnifiedRoleManagementAlert body, CancellationToken cancellationToken = default, Action<UnifiedRoleManagementAlertItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
