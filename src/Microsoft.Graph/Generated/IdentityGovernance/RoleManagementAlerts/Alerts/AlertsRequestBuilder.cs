...
#nullable enable
        public async Task<UnifiedRoleManagementAlertCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AlertsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementAlertCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AlertsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleManagementAlert?> PostAsync(UnifiedRoleManagementAlert body, CancellationToken cancellationToken = default, Action<AlertsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementAlert> PostAsync(UnifiedRoleManagementAlert body, CancellationToken cancellationToken = default, Action<AlertsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
