...
using MicrosoftGraph.IdentityGovernance.AccessReviews.Definitions.Item.Instances;
using MicrosoftGraph.IdentityGovernance.AccessReviews.Definitions.Item.Stop;
...
namespace MicrosoftGraph.IdentityGovernance.AccessReviews.Definitions.Item {
    ...
    public class AccessReviewScheduleDefinitionRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AccessReviewScheduleDefinitionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
