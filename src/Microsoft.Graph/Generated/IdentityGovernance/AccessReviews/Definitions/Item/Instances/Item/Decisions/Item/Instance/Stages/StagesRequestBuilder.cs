...
#nullable enable
        public async Task<AccessReviewStageCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<StagesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessReviewStageCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<StagesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessReviewStage?> PostAsync(AccessReviewStage body, CancellationToken cancellationToken = default, Action<StagesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessReviewStage> PostAsync(AccessReviewStage body, CancellationToken cancellationToken = default, Action<StagesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
