...
namespace MicrosoftGraphSdk.IdentityGovernance.AccessReviews.Decisions {
    ...
    public class DecisionsRequestBuilder {
        ...
        public DecisionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/accessReviews/decisions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>
        /// Builds and executes requests for operations under \identityGovernance\accessReviews\decisions\microsoft.graph.filterByCurrentUser(on={on})
