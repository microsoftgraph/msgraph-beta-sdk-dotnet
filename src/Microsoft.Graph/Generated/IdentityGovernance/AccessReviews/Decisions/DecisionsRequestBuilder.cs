...
using Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.MicrosoftGraphFilterByCurrentUserWithOn;
using Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.MicrosoftGraphRecordAllDecisions;
...
namespace Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions {
    ...
    public class DecisionsRequestBuilder {
        ...
        public DecisionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/accessReviews/decisions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
