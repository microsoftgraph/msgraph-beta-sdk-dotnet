...
using MicrosoftGraph.IdentityGovernance.AccessReviews.Decisions.Item.Insights.Item;
...
namespace MicrosoftGraph.IdentityGovernance.AccessReviews.Decisions.Item.Insights {
    /// <summary>Builds and executes requests for operations under \identityGovernance\accessReviews\decisions\{accessReviewInstanceDecisionItem-id}\insights</summary>
    public class InsightsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.identityGovernance.accessReviews.decisions.item.insights.item collection</summary>
