...
namespace Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Definition
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Definition.DefinitionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Definition.DefinitionRequestBuilder.DefinitionRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Definition.DefinitionRequestBuilder.DefinitionRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Definition.DefinitionRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Definition.DefinitionRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Definition.DefinitionRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// There&apos;s exactly one accessReviewScheduleDefinition associated with each instance. It&apos;s the parent schedule for the instance, where instances are created for each recurrence of a review definition and each group selected to review by the definition.
        /// </summary>
...
#nullable restore
        ...
        public class DefinitionRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Definition.DefinitionRequestBuilder.DefinitionRequestBuilderGetQueryParameters>
        {
        }
    }
}
