...
namespace MicrosoftGraph.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Decisions.Item {
    /// <summary>Builds and executes requests for operations under \identityGovernance\accessReviews\decisions\{accessReviewInstanceDecisionItem-id}\instance\decisions\{accessReviewInstanceDecisionItem-id1}</summary>
    public class AccessReviewInstanceDecisionItemRequestBuilder {
        ...
        public AccessReviewInstanceDecisionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/accessReviews/decisions/{accessReviewInstanceDecisionItem_id}/instance/decisions/{accessReviewInstanceDecisionItem_id1}{?select,expand}";
