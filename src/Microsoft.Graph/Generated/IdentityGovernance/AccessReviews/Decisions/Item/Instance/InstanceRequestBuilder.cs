...
using Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Definition;
using Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.MicrosoftGraphAcceptRecommendations;
using Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.MicrosoftGraphApplyDecisions;
using Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.MicrosoftGraphBatchRecordDecisions;
using Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.MicrosoftGraphResetDecisions;
using Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.MicrosoftGraphSendReminder;
using Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.MicrosoftGraphStop;
...
namespace Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance {
    /// <summary>
    ...
    public class InstanceRequestBuilder {
        ...
        public Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Decisions.DecisionsRequestBuilder Decisions { get =>
            new Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Decisions.DecisionsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public InstanceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/accessReviews/decisions/{accessReviewInstanceDecisionItem%2Did}/instance{?%24select,%24expand}";
