...
namespace MicrosoftGraphSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance {
    ...
    public class InstanceRequestBuilder {
        ...
        public MicrosoftGraphSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Decisions.DecisionsRequestBuilder Decisions { get =>
            new MicrosoftGraphSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Decisions.DecisionsRequestBuilder(PathParameters, RequestAdapter);
        }
