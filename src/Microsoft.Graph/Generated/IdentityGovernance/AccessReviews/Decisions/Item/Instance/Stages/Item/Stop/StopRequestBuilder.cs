...
namespace MicrosoftGraph.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Stages.Item.Stop {
    ...
    public class StopRequestBuilder {
        ...
        public StopRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/accessReviews/decisions/{accessReviewInstanceDecisionItem_id}/instance/stages/{accessReviewStage_id}/microsoft.graph.stop";
