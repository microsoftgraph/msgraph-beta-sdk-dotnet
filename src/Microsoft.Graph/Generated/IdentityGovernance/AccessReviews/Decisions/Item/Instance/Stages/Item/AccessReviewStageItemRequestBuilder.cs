...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AccessReviewStageItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AccessReviewStageItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessReviewStage?> GetAsync(CancellationToken cancellationToken = default, Action<AccessReviewStageItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessReviewStage> GetAsync(CancellationToken cancellationToken = default, Action<AccessReviewStageItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessReviewStage?> PatchAsync(AccessReviewStage body, CancellationToken cancellationToken = default, Action<AccessReviewStageItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessReviewStage> PatchAsync(AccessReviewStage body, CancellationToken cancellationToken = default, Action<AccessReviewStageItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
