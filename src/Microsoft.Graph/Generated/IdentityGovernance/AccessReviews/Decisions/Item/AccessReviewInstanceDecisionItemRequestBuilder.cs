...
using MicrosoftGraph.IdentityGovernance.AccessReviews.Decisions.Item.Insights;
using MicrosoftGraph.IdentityGovernance.AccessReviews.Decisions.Item.Instance;
...
namespace MicrosoftGraph.IdentityGovernance.AccessReviews.Decisions.Item {
    /// <summary>Builds and executes requests for operations under \identityGovernance\accessReviews\decisions\{accessReviewInstanceDecisionItem-id}</summary>
    public class AccessReviewInstanceDecisionItemRequestBuilder {
        ...
        public AccessReviewInstanceDecisionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/accessReviews/decisions/{accessReviewInstanceDecisionItem_id}{?select,expand}";
