...
namespace Microsoft.Graph.Beta.IdentityGovernance.AccessReviews.Decisions.RecordAllDecisions {
    ...
    public class RecordAllDecisionsRequestBuilder : BaseRequestBuilder {
        ...
        public RecordAllDecisionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/decisions/recordAllDecisions", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RecordAllDecisionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecordAllDecisionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/decisions/recordAllDecisions", rawUrl) {
        }
        /// <summary>
