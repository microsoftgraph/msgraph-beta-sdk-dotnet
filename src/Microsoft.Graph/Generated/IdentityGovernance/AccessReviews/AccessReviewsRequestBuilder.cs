...
#nullable enable
        public async Task<Stream?> DeleteAsync(Action<AccessReviewsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> DeleteAsync(Action<AccessReviewsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        public async Task<AccessReviewSet> GetAsync(Action<AccessReviewsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<AccessReviewSet>(requestInfo, AccessReviewSet.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
