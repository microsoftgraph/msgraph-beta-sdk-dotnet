...
namespace Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows.TaskDefinitions.Item {
    ...
    public class TaskDefinitionItemRequestBuilder : BaseRequestBuilder {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/identitygovernance-taskdefinition-get?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.IdentityGovernance.TaskDefinition?> GetAsync(CancellationToken cancellationToken = default, Action<TaskDefinitionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.IdentityGovernance.TaskDefinition> GetAsync(CancellationToken cancellationToken = default, Action<TaskDefinitionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
