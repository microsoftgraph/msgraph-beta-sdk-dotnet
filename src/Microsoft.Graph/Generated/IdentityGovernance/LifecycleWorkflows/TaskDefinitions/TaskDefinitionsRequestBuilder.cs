...
#nullable enable
        public async Task<TaskDefinitionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TaskDefinitionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TaskDefinitionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TaskDefinitionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
