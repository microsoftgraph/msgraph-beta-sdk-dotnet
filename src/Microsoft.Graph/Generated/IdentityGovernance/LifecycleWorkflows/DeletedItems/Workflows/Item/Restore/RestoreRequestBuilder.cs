...
namespace Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows.DeletedItems.Workflows.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        /// </summary>
        public async Task<Workflow> PostAsync(CancellationToken cancellationToken = default, Action<RestoreRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
