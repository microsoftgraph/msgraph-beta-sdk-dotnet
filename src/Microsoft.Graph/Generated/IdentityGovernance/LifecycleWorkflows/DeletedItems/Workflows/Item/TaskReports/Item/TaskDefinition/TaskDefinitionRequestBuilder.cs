...
namespace Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows.DeletedItems.Workflows.Item.TaskReports.Item.TaskDefinition {
    ...
    public class TaskDefinitionRequestBuilder {
        ...
        public TaskDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/taskReports/{taskReport%2Did}/taskDefinition{?%24select,%24expand}";
        ...
        public RequestInformation CreateGetRequestInformation(Action<TaskDefinitionRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <summary>The taskDefinition associated with the related lifecycle workflow task.Supports $filter(eq, ne) and $expand.</summary>
