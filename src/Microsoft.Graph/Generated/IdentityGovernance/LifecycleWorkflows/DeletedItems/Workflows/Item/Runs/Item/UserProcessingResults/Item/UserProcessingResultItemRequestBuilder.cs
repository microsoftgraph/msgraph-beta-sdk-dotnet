...
namespace Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows.DeletedItems.Workflows.Item.Runs.Item.UserProcessingResults.Item {
    ...
    public class UserProcessingResultItemRequestBuilder : BaseRequestBuilder {
        ...
        public UserProcessingResultItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/runs/{run%2Did}/userProcessingResults/{userProcessingResult%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UserProcessingResultItemRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<UserProcessingResult?> GetAsync(CancellationToken cancellationToken = default, Action<UserProcessingResultItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserProcessingResult> GetAsync(CancellationToken cancellationToken = default, Action<UserProcessingResultItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
