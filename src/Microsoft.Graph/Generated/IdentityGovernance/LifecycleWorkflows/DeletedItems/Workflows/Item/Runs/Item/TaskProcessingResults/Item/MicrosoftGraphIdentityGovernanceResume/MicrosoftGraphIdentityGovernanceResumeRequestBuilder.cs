...
#nullable enable
        public async Task PostAsync(ResumePostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphIdentityGovernanceResumeRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(ResumePostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphIdentityGovernanceResumeRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
