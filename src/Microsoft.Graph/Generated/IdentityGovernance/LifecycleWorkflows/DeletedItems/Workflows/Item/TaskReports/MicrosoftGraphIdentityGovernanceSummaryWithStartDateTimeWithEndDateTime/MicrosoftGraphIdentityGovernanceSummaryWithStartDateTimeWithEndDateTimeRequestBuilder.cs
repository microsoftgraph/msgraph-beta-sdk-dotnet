...
#nullable enable
        public async Task<TaskReportSummary?> GetAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphIdentityGovernanceSummaryWithStartDateTimeWithEndDateTimeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TaskReportSummary> GetAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphIdentityGovernanceSummaryWithStartDateTimeWithEndDateTimeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
