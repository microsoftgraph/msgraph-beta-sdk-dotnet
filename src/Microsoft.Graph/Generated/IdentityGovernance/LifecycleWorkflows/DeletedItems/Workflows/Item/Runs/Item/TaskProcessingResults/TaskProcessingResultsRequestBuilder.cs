...
namespace Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows.DeletedItems.Workflows.Item.Runs.Item.TaskProcessingResults {
    ...
    public class TaskProcessingResultsRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TaskProcessingResultsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/runs/{run%2Did}/taskProcessingResults{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<TaskProcessingResultCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TaskProcessingResultsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TaskProcessingResultCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TaskProcessingResultsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
