...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeletedItemsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeletedItemsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeletedItemContainer?> GetAsync(CancellationToken cancellationToken = default, Action<DeletedItemsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeletedItemContainer> GetAsync(CancellationToken cancellationToken = default, Action<DeletedItemsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
