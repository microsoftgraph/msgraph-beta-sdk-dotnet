...
namespace Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows.Workflows.Item.TaskReports.SummaryWithStartDateTimeWithEndDateTime {
    ...
    public class SummaryWithStartDateTimeWithEndDateTimeRequestBuilder {
        ...
        /// </summary>
        public async Task<TaskReportSummary> GetAsync(CancellationToken cancellationToken = default, Action<SummaryWithStartDateTimeWithEndDateTimeRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
