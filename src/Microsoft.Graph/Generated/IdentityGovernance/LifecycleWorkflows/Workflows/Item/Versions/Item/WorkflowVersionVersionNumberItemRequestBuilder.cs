...
namespace Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Versions.Item {
    ...
    public class WorkflowVersionVersionNumberItemRequestBuilder : BaseRequestBuilder {
        ...
        public WorkflowVersionVersionNumberItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/versions/{workflowVersion%2DversionNumber}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WorkflowVersionVersionNumberItemRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<WorkflowVersion?> GetAsync(CancellationToken cancellationToken = default, Action<WorkflowVersionVersionNumberItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkflowVersion> GetAsync(CancellationToken cancellationToken = default, Action<WorkflowVersionVersionNumberItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
