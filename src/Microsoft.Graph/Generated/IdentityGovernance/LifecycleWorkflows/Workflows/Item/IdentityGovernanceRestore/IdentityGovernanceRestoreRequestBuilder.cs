...
namespace Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows.Workflows.Item.IdentityGovernanceRestore {
    /// <summary>
    ...
    public class IdentityGovernanceRestoreRequestBuilder : BaseRequestBuilder {
        ...
        public IdentityGovernanceRestoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/identityGovernance.restore", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new IdentityGovernanceRestoreRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IdentityGovernanceRestoreRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/identityGovernance.restore", rawUrl) {
        }
        /// <summary>
