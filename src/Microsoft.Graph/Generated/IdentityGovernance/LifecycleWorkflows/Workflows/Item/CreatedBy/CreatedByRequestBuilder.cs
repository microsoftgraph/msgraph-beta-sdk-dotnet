using Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows.Workflows.Item.CreatedBy.MailboxSettings;
...
using System;
namespace Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows.Workflows.Item.CreatedBy {
    /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.User?> GetAsync(CancellationToken cancellationToken = default, Action<CreatedByRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.User> GetAsync(CancellationToken cancellationToken = default, Action<CreatedByRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
