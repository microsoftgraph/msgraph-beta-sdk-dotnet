...
namespace Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows.Workflows.Item.IdentityGovernanceActivate {
    ...
    public class IdentityGovernanceActivateRequestBuilder : BaseRequestBuilder {
        ...
        public IdentityGovernanceActivateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/identityGovernance.activate", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new IdentityGovernanceActivateRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IdentityGovernanceActivateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/identityGovernance.activate", rawUrl) {
        }
        /// <summary>
