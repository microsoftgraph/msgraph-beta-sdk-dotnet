...
#nullable enable
        public async Task<Workflow?> PostAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphIdentityGovernanceRestoreRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Workflow> PostAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphIdentityGovernanceRestoreRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
