...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<WorkflowItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<WorkflowItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Workflow?> GetAsync(CancellationToken cancellationToken = default, Action<WorkflowItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Workflow> GetAsync(CancellationToken cancellationToken = default, Action<WorkflowItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Workflow?> PatchAsync(Workflow body, CancellationToken cancellationToken = default, Action<WorkflowItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Workflow> PatchAsync(Workflow body, CancellationToken cancellationToken = default, Action<WorkflowItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
