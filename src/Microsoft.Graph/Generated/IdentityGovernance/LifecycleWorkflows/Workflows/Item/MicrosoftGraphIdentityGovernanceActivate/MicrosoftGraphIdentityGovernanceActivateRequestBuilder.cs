...
#nullable enable
        public async Task PostAsync(ActivatePostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphIdentityGovernanceActivateRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(ActivatePostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphIdentityGovernanceActivateRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
