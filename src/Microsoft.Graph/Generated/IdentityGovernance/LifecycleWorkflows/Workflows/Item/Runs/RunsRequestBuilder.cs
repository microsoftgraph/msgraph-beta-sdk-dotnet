...
#nullable enable
        public async Task<RunCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<RunsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RunCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RunsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
