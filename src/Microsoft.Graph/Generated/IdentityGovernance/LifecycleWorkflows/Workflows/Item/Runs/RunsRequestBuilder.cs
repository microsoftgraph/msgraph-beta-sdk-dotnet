...
using Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Runs.IdentityGovernanceSummaryWithStartDateTimeWithEndDateTime;
...
namespace Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Runs {
    ...
    public class RunsRequestBuilder {
        ...
        public RunItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("run%2Did", position);
