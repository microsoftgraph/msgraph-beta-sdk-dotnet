...
namespace Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Runs {
    ...
    public class RunsRequestBuilder {
        ...
        /// </summary>
        public async Task<RunCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RunsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.IdentityGovernance.Run> PostAsync(Microsoft.Graph.Beta.Models.IdentityGovernance.Run body, CancellationToken cancellationToken = default, Action<RunsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
