...
namespace Microsoft.Graph.Beta.IdentityGovernance.LifecycleWorkflows {
    ...
    public class LifecycleWorkflowsRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<LifecycleWorkflowsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<LifecycleWorkflowsContainer> GetAsync(CancellationToken cancellationToken = default, Action<LifecycleWorkflowsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(LifecycleWorkflowsContainer body, CancellationToken cancellationToken = default, Action<LifecycleWorkflowsRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
