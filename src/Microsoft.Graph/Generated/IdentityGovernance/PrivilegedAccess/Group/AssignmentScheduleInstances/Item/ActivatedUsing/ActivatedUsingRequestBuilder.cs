...
#nullable enable
        public async Task<PrivilegedAccessGroupEligibilityScheduleInstance?> GetAsync(CancellationToken cancellationToken = default, Action<ActivatedUsingRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrivilegedAccessGroupEligibilityScheduleInstance> GetAsync(CancellationToken cancellationToken = default, Action<ActivatedUsingRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
