...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<GroupRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<GroupRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PrivilegedAccessGroup?> GetAsync(CancellationToken cancellationToken = default, Action<GroupRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrivilegedAccessGroup> GetAsync(CancellationToken cancellationToken = default, Action<GroupRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PrivilegedAccessGroup?> PatchAsync(PrivilegedAccessGroup body, CancellationToken cancellationToken = default, Action<GroupRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrivilegedAccessGroup> PatchAsync(PrivilegedAccessGroup body, CancellationToken cancellationToken = default, Action<GroupRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
