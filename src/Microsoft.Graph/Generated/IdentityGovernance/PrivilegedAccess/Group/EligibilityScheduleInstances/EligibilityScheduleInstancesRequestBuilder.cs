...
#nullable enable
        public async Task<PrivilegedAccessGroupEligibilityScheduleInstanceCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<EligibilityScheduleInstancesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrivilegedAccessGroupEligibilityScheduleInstanceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<EligibilityScheduleInstancesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PrivilegedAccessGroupEligibilityScheduleInstance?> PostAsync(PrivilegedAccessGroupEligibilityScheduleInstance body, CancellationToken cancellationToken = default, Action<EligibilityScheduleInstancesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrivilegedAccessGroupEligibilityScheduleInstance> PostAsync(PrivilegedAccessGroupEligibilityScheduleInstance body, CancellationToken cancellationToken = default, Action<EligibilityScheduleInstancesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
