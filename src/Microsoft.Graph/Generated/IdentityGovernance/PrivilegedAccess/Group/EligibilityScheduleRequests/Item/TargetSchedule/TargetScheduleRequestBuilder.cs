...
using System;
namespace Microsoft.Graph.Beta.IdentityGovernance.PrivilegedAccess.Group.EligibilityScheduleRequests.Item.TargetSchedule {
    /// <summary>
...
#nullable enable
        public async Task<PrivilegedAccessGroupEligibilitySchedule?> GetAsync(CancellationToken cancellationToken = default, Action<TargetScheduleRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrivilegedAccessGroupEligibilitySchedule> GetAsync(CancellationToken cancellationToken = default, Action<TargetScheduleRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
