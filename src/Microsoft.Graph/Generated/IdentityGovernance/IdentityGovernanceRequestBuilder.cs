...
namespace Microsoft.Graph.Beta.IdentityGovernance {
    ...
    public class IdentityGovernanceRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.IdentityGovernance.IdentityGovernance> PatchAsync(Microsoft.Graph.Beta.Models.IdentityGovernance.IdentityGovernance body, Action<IdentityGovernanceRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
