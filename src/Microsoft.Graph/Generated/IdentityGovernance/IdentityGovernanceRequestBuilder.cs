...
namespace Microsoft.Graph.Beta.IdentityGovernance {
    ...
    public class IdentityGovernanceRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.IdentityGovernance.IdentityGovernance> GetAsync(CancellationToken cancellationToken = default, Action<IdentityGovernanceRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Beta.Models.IdentityGovernance.IdentityGovernance body, CancellationToken cancellationToken = default, Action<IdentityGovernanceRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
