...
using MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item.Files.Item.Versions.Count;
using MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item.Files.Item.Versions.Item;
...
namespace MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item.Files.Item.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.identityGovernance.termsOfUse.agreements.item.files.item.versions.item collection</summary>
        ...
        public VersionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement_id}/files/{agreementFileLocalization_id}/versions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public async Task<AgreementFileVersionCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
