...
using MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item.Files.Count;
using MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item.Files.Item;
...
namespace MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item.Files {
    ...
    public class FilesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.identityGovernance.termsOfUse.agreements.item.files.item collection</summary>
        ...
        /// </summary>
        public async Task<AgreementFileLocalizationCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
