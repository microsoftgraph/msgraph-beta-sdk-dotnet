...
using MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item.Files.Item.Versions;
...
namespace MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item.Files.Item {
    ...
    public class AgreementFileLocalizationItemRequestBuilder {
        ...
        public AgreementFileLocalizationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement_id}/files/{agreementFileLocalization_id}{?select,expand}";
