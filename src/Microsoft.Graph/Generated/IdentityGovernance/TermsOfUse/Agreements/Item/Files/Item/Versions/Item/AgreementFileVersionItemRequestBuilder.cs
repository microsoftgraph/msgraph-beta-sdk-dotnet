...
namespace Microsoft.Graph.Beta.IdentityGovernance.TermsOfUse.Agreements.Item.Files.Item.Versions.Item {
    ...
    public class AgreementFileVersionItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AgreementFileVersionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AgreementFileVersion> GetAsync(CancellationToken cancellationToken = default, Action<AgreementFileVersionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AgreementFileVersion body, CancellationToken cancellationToken = default, Action<AgreementFileVersionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
