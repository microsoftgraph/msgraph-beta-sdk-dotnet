...
namespace Microsoft.Graph.Beta.IdentityGovernance.TermsOfUse.Agreements.Item.Files.Item.Versions.Item {
    ...
    public class AgreementFileVersionItemRequestBuilder {
        ...
        public AgreementFileVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement_id}/files/{agreementFileLocalization_id}/versions/{agreementFileVersion_id}{?select,expand}";
