...
using MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations.Item.Versions.Count;
using MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations.Item.Versions.Item;
...
namespace MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations.Item.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.identityGovernance.termsOfUse.agreements.item.file.localizations.item.versions.item collection</summary>
