...
using MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations.Count;
using MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations.Item;
...
namespace MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations {
    ...
    public class LocalizationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.identityGovernance.termsOfUse.agreements.item.file.localizations.item collection</summary>
