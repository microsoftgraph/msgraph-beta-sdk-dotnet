...
namespace Microsoft.Graph.Beta.IdentityGovernance.TermsOfUse.Agreements.Item.FileNamespace.Localizations {
    ...
    public class LocalizationsRequestBuilder : BaseRequestBuilder {
        ...
        public AgreementFileLocalizationItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("agreementFileLocalization%2Did", position);
        ...
        public LocalizationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/file/localizations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LocalizationsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<AgreementFileLocalizationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<LocalizationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AgreementFileLocalizationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<LocalizationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<AgreementFileLocalizationCollectionResponse>(requestInfo, AgreementFileLocalizationCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AgreementFileLocalization?> PostAsync(AgreementFileLocalization body, CancellationToken cancellationToken = default, Action<LocalizationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AgreementFileLocalization> PostAsync(AgreementFileLocalization body, CancellationToken cancellationToken = default, Action<LocalizationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
