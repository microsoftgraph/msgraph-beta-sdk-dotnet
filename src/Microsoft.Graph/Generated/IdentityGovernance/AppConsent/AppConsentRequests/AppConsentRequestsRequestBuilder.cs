...
namespace Microsoft.Graph.Beta.IdentityGovernance.AppConsent.AppConsentRequests {
    ...
    public class AppConsentRequestsRequestBuilder {
        ...
        /// </summary>
        public async Task<AppConsentRequestCollectionResponse> GetAsync(Action<AppConsentRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AppConsentRequest> PostAsync(AppConsentRequest body, Action<AppConsentRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
