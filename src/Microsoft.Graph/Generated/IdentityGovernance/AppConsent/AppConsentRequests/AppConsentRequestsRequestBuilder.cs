...
namespace MicrosoftGraph.IdentityGovernance.AppConsent.AppConsentRequests {
    ...
    public class AppConsentRequestsRequestBuilder {
        ...
        public AppConsentRequestsRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("appConsentRequest_id", position);
            return new AppConsentRequestsRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AppConsentRequest body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        public async Task<AppConsentRequestsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<AppConsentRequestsResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// A collection of userConsentRequest objects for a specific application.
        /// <param name="body"></param>
