...
#nullable enable
        public async Task<CustomAccessPackageWorkflowExtension?> GetAsync(Action<RequestConfiguration<CustomExtensionRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CustomAccessPackageWorkflowExtension> GetAsync(Action<RequestConfiguration<CustomExtensionRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
