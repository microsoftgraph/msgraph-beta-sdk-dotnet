...
namespace MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Search {
    ...
    public class SearchRequestBuilder {
        ...
        /// </summary>
        public async Task<SearchResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
