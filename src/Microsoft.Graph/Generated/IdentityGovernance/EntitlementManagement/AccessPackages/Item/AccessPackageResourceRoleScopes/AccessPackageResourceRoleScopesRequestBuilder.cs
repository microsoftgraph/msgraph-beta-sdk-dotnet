...
namespace Microsoft.Graph.Beta.IdentityGovernance.EntitlementManagement.AccessPackages.Item.AccessPackageResourceRoleScopes {
    ...
    public class AccessPackageResourceRoleScopesRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AccessPackageResourceRoleScopesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages/{accessPackage%2Did}/accessPackageResourceRoleScopes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<AccessPackageResourceRoleScopeCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageResourceRoleScopesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessPackageResourceRoleScopeCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageResourceRoleScopesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessPackageResourceRoleScope?> PostAsync(AccessPackageResourceRoleScope body, CancellationToken cancellationToken = default, Action<AccessPackageResourceRoleScopesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessPackageResourceRoleScope> PostAsync(AccessPackageResourceRoleScope body, CancellationToken cancellationToken = default, Action<AccessPackageResourceRoleScopesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
