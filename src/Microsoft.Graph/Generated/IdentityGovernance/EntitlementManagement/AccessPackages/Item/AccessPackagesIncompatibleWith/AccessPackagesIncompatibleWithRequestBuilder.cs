...
#nullable enable
        public async Task<AccessPackageCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackagesIncompatibleWithRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessPackageCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackagesIncompatibleWithRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
