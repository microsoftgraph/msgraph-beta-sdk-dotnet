...
namespace Microsoft.Graph.Beta.IdentityGovernance.EntitlementManagement.AccessPackages.Item.AccessPackagesIncompatibleWith {
    ...
    public class AccessPackagesIncompatibleWithRequestBuilder : BaseRequestBuilder {
        ...
        /// <returns>A <cref="Microsoft.Graph.Beta.IdentityGovernance.EntitlementManagement.AccessPackages.Item.AccessPackagesIncompatibleWith.Item.AccessPackageItemRequestBuilder"></returns>
        ...
        /// </summary>
        /// <returns>A <cref="AccessPackageCollectionResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessPackageCollectionResponse?> GetAsync(Action<RequestConfiguration<AccessPackagesIncompatibleWithRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<AccessPackageCollectionResponse> GetAsync(Action<RequestConfiguration<AccessPackagesIncompatibleWithRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="AccessPackagesIncompatibleWithRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class AccessPackagesIncompatibleWithRequestBuilderGetRequestConfiguration : RequestConfiguration<AccessPackagesIncompatibleWithRequestBuilderGetQueryParameters> {
        }
    }
}
