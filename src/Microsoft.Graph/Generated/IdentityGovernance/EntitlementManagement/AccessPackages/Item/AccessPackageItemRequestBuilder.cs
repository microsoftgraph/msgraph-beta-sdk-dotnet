...
using MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item.AccessPackageAssignmentPolicies;
using MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item.AccessPackageCatalog;
using MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item.AccessPackageResourceRoleScopes;
using MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item.AccessPackagesIncompatibleWith;
using MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item.GetApplicablePolicyRequirements;
using MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item.IncompatibleAccessPackages;
using MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item.IncompatibleGroups;
