...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CustomExtensionHandlerItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CustomExtensionHandlerItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CustomExtensionHandler?> GetAsync(CancellationToken cancellationToken = default, Action<CustomExtensionHandlerItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CustomExtensionHandler> GetAsync(CancellationToken cancellationToken = default, Action<CustomExtensionHandlerItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CustomExtensionHandler?> PatchAsync(CustomExtensionHandler body, CancellationToken cancellationToken = default, Action<CustomExtensionHandlerItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CustomExtensionHandler> PatchAsync(CustomExtensionHandler body, CancellationToken cancellationToken = default, Action<CustomExtensionHandlerItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
