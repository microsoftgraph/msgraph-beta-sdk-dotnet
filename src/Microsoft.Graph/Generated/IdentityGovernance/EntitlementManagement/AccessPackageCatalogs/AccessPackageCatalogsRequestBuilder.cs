...
#nullable enable
        public async Task<AccessPackageCatalogCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageCatalogsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessPackageCatalogCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageCatalogsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.AccessPackageCatalog?> PostAsync(Microsoft.Graph.Beta.Models.AccessPackageCatalog body, CancellationToken cancellationToken = default, Action<AccessPackageCatalogsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.AccessPackageCatalog> PostAsync(Microsoft.Graph.Beta.Models.AccessPackageCatalog body, CancellationToken cancellationToken = default, Action<AccessPackageCatalogsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
