...
namespace Microsoft.Graph.Beta.IdentityGovernance.EntitlementManagement.AccessPackageCatalogs {
    ...
    public class AccessPackageCatalogsRequestBuilder {
        ...
        /// </summary>
        public async Task<AccessPackageCatalogCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageCatalogsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.AccessPackageCatalog> PostAsync(Microsoft.Graph.Beta.Models.AccessPackageCatalog body, CancellationToken cancellationToken = default, Action<AccessPackageCatalogsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
