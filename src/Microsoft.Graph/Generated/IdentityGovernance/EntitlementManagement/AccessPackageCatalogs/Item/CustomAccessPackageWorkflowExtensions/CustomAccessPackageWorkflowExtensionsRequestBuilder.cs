...
#nullable enable
        public async Task<CustomAccessPackageWorkflowExtensionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<CustomAccessPackageWorkflowExtensionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CustomAccessPackageWorkflowExtensionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CustomAccessPackageWorkflowExtensionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CustomAccessPackageWorkflowExtension?> PostAsync(CustomAccessPackageWorkflowExtension body, CancellationToken cancellationToken = default, Action<CustomAccessPackageWorkflowExtensionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CustomAccessPackageWorkflowExtension> PostAsync(CustomAccessPackageWorkflowExtension body, CancellationToken cancellationToken = default, Action<CustomAccessPackageWorkflowExtensionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
