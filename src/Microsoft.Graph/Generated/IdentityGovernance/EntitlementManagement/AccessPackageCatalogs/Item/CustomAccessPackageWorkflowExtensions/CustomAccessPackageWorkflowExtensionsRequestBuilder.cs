...
namespace Microsoft.Graph.Beta.IdentityGovernance.EntitlementManagement.AccessPackageCatalogs.Item.CustomAccessPackageWorkflowExtensions {
    ...
    public class CustomAccessPackageWorkflowExtensionsRequestBuilder {
        ...
        /// </summary>
        public async Task<CustomAccessPackageWorkflowExtensionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CustomAccessPackageWorkflowExtensionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
