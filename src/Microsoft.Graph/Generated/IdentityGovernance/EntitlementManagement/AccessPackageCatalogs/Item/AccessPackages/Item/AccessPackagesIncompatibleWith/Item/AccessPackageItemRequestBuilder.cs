...
namespace Microsoft.Graph.Beta.IdentityGovernance.EntitlementManagement.AccessPackageCatalogs.Item.AccessPackages.Item.AccessPackagesIncompatibleWith.Item {
    ...
    public class AccessPackageItemRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.AccessPackage> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
