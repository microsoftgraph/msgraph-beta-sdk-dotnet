...
namespace Microsoft.Graph.Beta.IdentityGovernance.EntitlementManagement.AccessPackageResources {
    ...
    public class AccessPackageResourcesRequestBuilder {
        ...
        /// </summary>
        public async Task<AccessPackageResourceCollectionResponse> GetAsync(Action<AccessPackageResourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
