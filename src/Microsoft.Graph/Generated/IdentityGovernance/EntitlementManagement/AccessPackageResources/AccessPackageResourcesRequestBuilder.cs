...
#nullable enable
        public async Task<AccessPackageResourceCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageResourcesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessPackageResourceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageResourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.AccessPackageResource?> PostAsync(Microsoft.Graph.Beta.Models.AccessPackageResource body, CancellationToken cancellationToken = default, Action<AccessPackageResourcesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.AccessPackageResource> PostAsync(Microsoft.Graph.Beta.Models.AccessPackageResource body, CancellationToken cancellationToken = default, Action<AccessPackageResourcesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
