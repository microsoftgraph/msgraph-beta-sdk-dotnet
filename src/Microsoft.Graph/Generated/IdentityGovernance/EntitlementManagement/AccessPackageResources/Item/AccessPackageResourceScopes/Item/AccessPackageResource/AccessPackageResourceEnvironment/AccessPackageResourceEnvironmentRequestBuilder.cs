...
namespace MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AccessPackageResources.Item.AccessPackageResourceScopes.Item.AccessPackageResource.AccessPackageResourceEnvironment {
    ...
    public class AccessPackageResourceEnvironmentRequestBuilder {
        ...
        public AccessPackageResourceEnvironmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResources/{accessPackageResource_id}/accessPackageResourceScopes/{accessPackageResourceScope_id}/accessPackageResource/accessPackageResourceEnvironment{?select,expand}";
