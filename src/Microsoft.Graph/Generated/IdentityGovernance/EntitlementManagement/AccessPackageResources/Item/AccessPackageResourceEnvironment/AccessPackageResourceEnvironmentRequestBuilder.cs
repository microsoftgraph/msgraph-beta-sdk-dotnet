...
using MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AccessPackageResources.Item.AccessPackageResourceEnvironment.Ref;
...
namespace MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AccessPackageResources.Item.AccessPackageResourceEnvironment {
    /// <summary>Builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageResources\{accessPackageResource-id}\accessPackageResourceEnvironment</summary>
    public class AccessPackageResourceEnvironmentRequestBuilder {
        ...
        public AccessPackageResourceEnvironmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResources/{accessPackageResource_id}/accessPackageResourceEnvironment{?select,expand}";
