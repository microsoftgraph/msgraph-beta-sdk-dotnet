...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ConnectedOrganization?> GetAsync(CancellationToken cancellationToken = default, Action<ConnectedOrganizationItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ConnectedOrganization> GetAsync(CancellationToken cancellationToken = default, Action<ConnectedOrganizationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ConnectedOrganization?> PatchAsync(Microsoft.Graph.Beta.Models.ConnectedOrganization body, CancellationToken cancellationToken = default, Action<ConnectedOrganizationItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ConnectedOrganization> PatchAsync(Microsoft.Graph.Beta.Models.ConnectedOrganization body, CancellationToken cancellationToken = default, Action<ConnectedOrganizationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
