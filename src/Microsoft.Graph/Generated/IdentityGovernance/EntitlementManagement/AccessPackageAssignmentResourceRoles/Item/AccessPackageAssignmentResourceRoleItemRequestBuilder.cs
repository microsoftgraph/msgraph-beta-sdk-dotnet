...
namespace Microsoft.Graph.Beta.IdentityGovernance.EntitlementManagement.AccessPackageAssignmentResourceRoles.Item
{
    ...
    public class AccessPackageAssignmentResourceRoleItemRequestBuilder : BaseRequestBuilder
    {
        ...
        {
            get => new AccessPackageResourceRoleRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new AccessPackageResourceScopeRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new AccessPackageSubjectRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessPackageAssignmentResourceRole?> GetAsync(Action<RequestConfiguration<AccessPackageAssignmentResourceRoleItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<AccessPackageAssignmentResourceRole> GetAsync(Action<RequestConfiguration<AccessPackageAssignmentResourceRoleItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessPackageAssignmentResourceRole?> PatchAsync(AccessPackageAssignmentResourceRole body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<AccessPackageAssignmentResourceRole> PatchAsync(AccessPackageAssignmentResourceRole body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public AccessPackageAssignmentResourceRoleItemRequestBuilder WithUrl(string rawUrl)
        {
            return new AccessPackageAssignmentResourceRoleItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class AccessPackageAssignmentResourceRoleItemRequestBuilderGetRequestConfiguration : RequestConfiguration<AccessPackageAssignmentResourceRoleItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
