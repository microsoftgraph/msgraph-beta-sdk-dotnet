...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AccessPackageResourceRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AccessPackageResourceRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.AccessPackageResource?> PatchAsync(Microsoft.Graph.Beta.Models.AccessPackageResource body, CancellationToken cancellationToken = default, Action<AccessPackageResourceRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.AccessPackageResource> PatchAsync(Microsoft.Graph.Beta.Models.AccessPackageResource body, CancellationToken cancellationToken = default, Action<AccessPackageResourceRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
