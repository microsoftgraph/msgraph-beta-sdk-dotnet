...
namespace Microsoft.Graph.Beta.IdentityGovernance.EntitlementManagement.AccessPackageAssignments.AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageId {
    ...
    public class AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder {
        ...
        public async Task<AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdResponse> GetAsync(Action<AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdResponse>(requestInfo, AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
