...
#nullable enable
        public async Task<AccessPackageAssignmentResourceRoleCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageAssignmentResourceRolesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessPackageAssignmentResourceRoleCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageAssignmentResourceRolesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessPackageAssignmentResourceRole?> PostAsync(AccessPackageAssignmentResourceRole body, CancellationToken cancellationToken = default, Action<AccessPackageAssignmentResourceRolesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessPackageAssignmentResourceRole> PostAsync(AccessPackageAssignmentResourceRole body, CancellationToken cancellationToken = default, Action<AccessPackageAssignmentResourceRolesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
