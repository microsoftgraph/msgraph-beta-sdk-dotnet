...
namespace Microsoft.Graph.Beta.IdentityGovernance.EntitlementManagement.AccessPackageAssignments.Item.AccessPackageAssignmentResourceRoles {
    ...
    public class AccessPackageAssignmentResourceRolesRequestBuilder {
        ...
        /// </summary>
        public async Task<AccessPackageAssignmentResourceRoleCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageAssignmentResourceRolesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AccessPackageAssignmentResourceRole> PostAsync(AccessPackageAssignmentResourceRole body, CancellationToken cancellationToken = default, Action<AccessPackageAssignmentResourceRolesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
