...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AccessPackageAssignmentItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AccessPackageAssignmentItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.AccessPackageAssignment?> PatchAsync(Microsoft.Graph.Beta.Models.AccessPackageAssignment body, CancellationToken cancellationToken = default, Action<AccessPackageAssignmentItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.AccessPackageAssignment> PatchAsync(Microsoft.Graph.Beta.Models.AccessPackageAssignment body, CancellationToken cancellationToken = default, Action<AccessPackageAssignmentItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
