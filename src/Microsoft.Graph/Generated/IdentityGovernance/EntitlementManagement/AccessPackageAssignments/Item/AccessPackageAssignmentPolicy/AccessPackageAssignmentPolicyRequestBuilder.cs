...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AccessPackageAssignmentPolicyRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AccessPackageAssignmentPolicyRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.AccessPackageAssignmentPolicy?> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageAssignmentPolicyRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.AccessPackageAssignmentPolicy> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageAssignmentPolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.AccessPackageAssignmentPolicy?> PatchAsync(Microsoft.Graph.Beta.Models.AccessPackageAssignmentPolicy body, CancellationToken cancellationToken = default, Action<AccessPackageAssignmentPolicyRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.AccessPackageAssignmentPolicy> PatchAsync(Microsoft.Graph.Beta.Models.AccessPackageAssignmentPolicy body, CancellationToken cancellationToken = default, Action<AccessPackageAssignmentPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
