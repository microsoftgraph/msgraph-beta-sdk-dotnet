...
using System;
namespace Microsoft.Graph.Beta.IdentityGovernance.EntitlementManagement.AccessPackageAssignments.Item.AccessPackageAssignmentPolicy.CustomExtensionStageSettings.Item.CustomExtension {
    /// <summary>
...
#nullable enable
        public async Task<CustomCalloutExtension?> GetAsync(CancellationToken cancellationToken = default, Action<CustomExtensionRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CustomCalloutExtension> GetAsync(CancellationToken cancellationToken = default, Action<CustomExtensionRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
