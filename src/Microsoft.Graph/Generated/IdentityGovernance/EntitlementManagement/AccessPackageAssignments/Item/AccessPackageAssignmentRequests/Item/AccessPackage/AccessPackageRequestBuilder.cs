...
namespace Microsoft.Graph.Beta.IdentityGovernance.EntitlementManagement.AccessPackageAssignments.Item.AccessPackageAssignmentRequests.Item.AccessPackage {
    ...
    public class AccessPackageRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.AccessPackage> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
