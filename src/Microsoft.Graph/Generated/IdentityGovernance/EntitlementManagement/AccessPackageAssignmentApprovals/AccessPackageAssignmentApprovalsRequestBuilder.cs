...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Approval?> PostAsync(Microsoft.Graph.Beta.Models.Approval body, CancellationToken cancellationToken = default, Action<AccessPackageAssignmentApprovalsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Approval> PostAsync(Microsoft.Graph.Beta.Models.Approval body, CancellationToken cancellationToken = default, Action<AccessPackageAssignmentApprovalsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
