...
namespace Microsoft.Graph.Beta.TeamTemplateDefinition.Item.TeamDefinition.InstalledApps {
    ...
    public class InstalledAppsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.teamTemplateDefinition.item.teamDefinition.installedApps.item collection</summary>
        ...
        public InstalledAppsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/installedApps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>Retrieve the list of apps installed in the specified team.</summary>
