...
namespace Microsoft.Graph.Beta.TeamTemplateDefinition.Item.TeamDefinition.Channels.AllMessages {
    public class AllMessagesGetResponse : BaseCollectionPaginationCountResponse, IParsable 
    {
...
#nullable restore
        ...
        public static new AllMessagesGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new AllMessagesGetResponse();
        }
        /// <summary>
