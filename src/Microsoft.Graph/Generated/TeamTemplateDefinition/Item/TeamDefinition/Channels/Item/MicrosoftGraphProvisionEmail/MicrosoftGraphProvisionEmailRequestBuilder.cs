...
namespace Microsoft.Graph.Beta.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.MicrosoftGraphProvisionEmail {
    /// <summary>
    ...
    public class MicrosoftGraphProvisionEmailRequestBuilder {
        ...
        public MicrosoftGraphProvisionEmailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/microsoft.graph.provisionEmail";
