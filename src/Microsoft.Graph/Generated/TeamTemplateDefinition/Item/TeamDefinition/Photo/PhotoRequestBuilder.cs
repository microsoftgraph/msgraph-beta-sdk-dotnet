...
using Microsoft.Graph.Beta.TeamTemplateDefinition.Item.TeamDefinition.Photo.Value;
...
namespace Microsoft.Graph.Beta.TeamTemplateDefinition.Item.TeamDefinition.Photo {
    ...
    public class PhotoRequestBuilder {
        ...
        public PhotoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/photo{?%24select,%24expand}";
        ...
        /// <summary>
        /// Delete navigation property photo for teamTemplateDefinition
