...
using System;
namespace Microsoft.Graph.Beta.TeamTemplateDefinition.Item.TeamDefinition.PermissionGrants.GetByIds {
    /// <summary>
    ...
    public class GetByIdsRequestBuilder : BaseRequestBuilder {
        ...
        public GetByIdsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/permissionGrants/getByIds", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetByIdsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetByIdsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/permissionGrants/getByIds", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<GetByIdsResponse?> PostAsync(GetByIdsPostRequestBody body, CancellationToken cancellationToken = default, Action<GetByIdsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetByIdsResponse> PostAsync(GetByIdsPostRequestBody body, CancellationToken cancellationToken = default, Action<GetByIdsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
