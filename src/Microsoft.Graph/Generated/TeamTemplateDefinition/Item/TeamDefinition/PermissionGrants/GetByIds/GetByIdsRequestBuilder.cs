...
namespace Microsoft.Graph.Beta.TeamTemplateDefinition.Item.TeamDefinition.PermissionGrants.GetByIds {
    ...
    public class GetByIdsRequestBuilder {
        ...
        /// </summary>
        public async Task<GetByIdsResponse> PostAsync(GetByIdsPostRequestBody body, CancellationToken cancellationToken = default, Action<GetByIdsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
