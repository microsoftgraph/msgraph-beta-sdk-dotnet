...
namespace Microsoft.Graph.Beta.TeamTemplateDefinition.Item.TeamDefinition.Members.Add {
    ...
    public class AddRequestBuilder : BaseRequestBuilder {
        ...
        public AddRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/members/add", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AddRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/members/add", rawUrl) {
        }
        /// <summary>
        /// Invoke action add
        /// </summary>
