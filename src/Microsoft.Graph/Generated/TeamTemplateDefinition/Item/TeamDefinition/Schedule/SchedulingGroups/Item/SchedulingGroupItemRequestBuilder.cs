...
using System;
namespace Microsoft.Graph.Beta.TeamTemplateDefinition.Item.TeamDefinition.Schedule.SchedulingGroups.Item {
    /// <summary>
    ...
    public class SchedulingGroupItemRequestBuilder : BaseRequestBuilder {
        ...
        public SchedulingGroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/schedulingGroups/{schedulingGroup%2Did}{?%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SchedulingGroupItemRequestBuilder and sets the default values.
        /// </summary>
