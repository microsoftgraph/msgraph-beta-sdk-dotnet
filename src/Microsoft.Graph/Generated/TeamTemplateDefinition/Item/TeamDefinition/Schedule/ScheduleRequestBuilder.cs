...
using Microsoft.Graph.Beta.TeamTemplateDefinition.Item.TeamDefinition.Schedule.MicrosoftGraphShare;
...
namespace Microsoft.Graph.Beta.TeamTemplateDefinition.Item.TeamDefinition.Schedule {
    ...
    public class ScheduleRequestBuilder {
        ...
        public ScheduleRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule{?%24select,%24expand}";
