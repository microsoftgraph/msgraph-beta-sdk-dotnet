...
using MicrosoftGraph.Agreements.Item.File.Localizations.Item.Versions.Item;
...
namespace MicrosoftGraph.Agreements.Item.File.Localizations.Item.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.agreements.item.file.localizations.item.versions.item collection</summary>
