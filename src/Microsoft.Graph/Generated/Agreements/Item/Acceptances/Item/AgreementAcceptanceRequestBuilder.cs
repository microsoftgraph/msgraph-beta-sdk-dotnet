...
namespace MicrosoftGraph.Agreements.Item.Acceptances.Item {
    /// <summary>Builds and executes requests for operations under \agreements\{agreement-id}\acceptances\{agreementAcceptance-id}</summary>
    public class AgreementAcceptanceRequestBuilder {
        ...
        /// <summary>
        /// Instantiates a new AgreementAcceptanceRequestBuilder and sets the default values.
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AgreementAcceptanceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/agreements/{agreement_id}/acceptances/{agreementAcceptance_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AgreementAcceptanceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
