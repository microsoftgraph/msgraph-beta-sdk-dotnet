...
namespace Microsoft.Graph.Beta.Agreements.Item.Acceptances {
    ...
    public class AcceptancesRequestBuilder {
        ...
        /// </summary>
        public async Task<AgreementAcceptanceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AcceptancesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AgreementAcceptance> PostAsync(AgreementAcceptance body, CancellationToken cancellationToken = default, Action<AcceptancesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
