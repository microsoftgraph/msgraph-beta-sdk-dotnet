using Microsoft.Graph.Beta.Agreements.Item.FileNamespace.Localizations.Item.Versions;
...
namespace Microsoft.Graph.Beta.Agreements.Item.FileNamespace.Localizations.Item {
    ...
    public class AgreementFileLocalizationItemRequestBuilder {
        ...
        public AgreementFileLocalizationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/agreements/{agreement%2Did}/file/localizations/{agreementFileLocalization%2Did}{?%24select,%24expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AgreementFileLocalization> PatchAsync(AgreementFileLocalization body, Action<AgreementFileLocalizationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
