using Microsoft.Graph.Beta.Contracts.Item.CheckMemberGroups;
using Microsoft.Graph.Beta.Contracts.Item.CheckMemberObjects;
using Microsoft.Graph.Beta.Contracts.Item.GetMemberGroups;
using Microsoft.Graph.Beta.Contracts.Item.GetMemberObjects;
using Microsoft.Graph.Beta.Contracts.Item.Restore;
...
namespace Microsoft.Graph.Beta.Contracts.Item {
    ...
    public class ContractItemRequestBuilder {
        ...
        /// </summary>
        public ContractItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/contracts/{contract%2Did}{?%24select}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ContractItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreateDeleteRequestInformation(Action<ContractItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ContractItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Contract> GetAsync(CancellationToken cancellationToken = default, Action<ContractItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Contract body, CancellationToken cancellationToken = default, Action<ContractItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
