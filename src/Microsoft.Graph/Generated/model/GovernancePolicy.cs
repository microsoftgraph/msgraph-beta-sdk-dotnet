...
namespace Microsoft.Graph
{
    ...
    public partial class GovernancePolicy
    {
        ...
        /// </summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore, PropertyName = "decisionMakerCriteria", Required = Newtonsoft.Json.Required.Default)]
        public IEnumerable<GovernanceCriteria> DecisionMakerCriteria { get; set; }
    
        /// <summary>
        /// Gets or sets notificationPolicy.
        /// </summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore, PropertyName = "notificationPolicy", Required = Newtonsoft.Json.Required.Default)]
