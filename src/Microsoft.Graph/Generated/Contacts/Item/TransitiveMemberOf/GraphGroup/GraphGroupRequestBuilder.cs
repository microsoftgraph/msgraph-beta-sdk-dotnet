using Microsoft.Graph.Beta.Contacts.Item.TransitiveMemberOf.GraphGroup.Count;
...
namespace Microsoft.Graph.Beta.Contacts.Item.TransitiveMemberOf.GraphGroup {
    /// <summary>
    ...
    public class GraphGroupRequestBuilder {
        ...
        public GraphGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/transitiveMemberOf/graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
