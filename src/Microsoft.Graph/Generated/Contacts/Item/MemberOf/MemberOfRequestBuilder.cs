...
using MicrosoftGraphSdk.Contacts.Item.MemberOf.Count;
using MicrosoftGraphSdk.Contacts.Item.MemberOf.Item;
...
namespace MicrosoftGraphSdk.Contacts.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.contacts.item.memberOf.item collection</summary>
