using Microsoft.Graph.Beta.Contacts.Item.DirectReports.GraphOrgContact.Count;
...
namespace Microsoft.Graph.Beta.Contacts.Item.DirectReports.GraphOrgContact {
    /// <summary>
    ...
    public class GraphOrgContactRequestBuilder {
        ...
        public GraphOrgContactRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/directReports/graph.orgContact{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
