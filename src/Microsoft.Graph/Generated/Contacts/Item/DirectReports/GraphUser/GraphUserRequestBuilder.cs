using Microsoft.Graph.Beta.Contacts.Item.DirectReports.GraphUser.Count;
...
namespace Microsoft.Graph.Beta.Contacts.Item.DirectReports.GraphUser {
    /// <summary>
    ...
    public class GraphUserRequestBuilder {
        ...
        public GraphUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/directReports/graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
