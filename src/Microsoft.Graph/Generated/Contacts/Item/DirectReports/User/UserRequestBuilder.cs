using Microsoft.Graph.Beta.Contacts.Item.DirectReports.User.Count;
...
namespace Microsoft.Graph.Beta.Contacts.Item.DirectReports.User {
    ...
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/directReports/microsoft.graph.user{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
