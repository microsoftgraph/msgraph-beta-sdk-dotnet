...
namespace Microsoft.Graph.Beta.Solutions.Approval.ApprovalItems.Item
{
    ...
    public partial class ApprovalItemItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public ApprovalItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/approval/approvalItems/{approvalItem%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Solutions.Approval.ApprovalItems.Item.ApprovalItemItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ApprovalItemItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/approval/approvalItems/{approvalItem%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
