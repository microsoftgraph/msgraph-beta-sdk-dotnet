...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<BusinessScenarioTaskItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<BusinessScenarioTaskItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BusinessScenarioTask?> GetAsync(CancellationToken cancellationToken = default, Action<BusinessScenarioTaskItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BusinessScenarioTask> GetAsync(CancellationToken cancellationToken = default, Action<BusinessScenarioTaskItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BusinessScenarioTask?> PatchAsync(BusinessScenarioTask body, CancellationToken cancellationToken = default, Action<BusinessScenarioTaskItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BusinessScenarioTask> PatchAsync(BusinessScenarioTask body, CancellationToken cancellationToken = default, Action<BusinessScenarioTaskItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
