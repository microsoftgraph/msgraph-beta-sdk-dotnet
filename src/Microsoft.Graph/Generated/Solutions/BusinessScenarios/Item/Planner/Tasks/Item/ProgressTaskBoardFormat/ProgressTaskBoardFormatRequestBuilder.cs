...
using System;
namespace Microsoft.Graph.Beta.Solutions.BusinessScenarios.Item.Planner.Tasks.Item.ProgressTaskBoardFormat {
    /// <summary>
    ...
    public class ProgressTaskBoardFormatRequestBuilder : BaseRequestBuilder {
        ...
        public ProgressTaskBoardFormatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner/tasks/{businessScenarioTask%2Did}/progressTaskBoardFormat{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ProgressTaskBoardFormatRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProgressTaskBoardFormatRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner/tasks/{businessScenarioTask%2Did}/progressTaskBoardFormat{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
