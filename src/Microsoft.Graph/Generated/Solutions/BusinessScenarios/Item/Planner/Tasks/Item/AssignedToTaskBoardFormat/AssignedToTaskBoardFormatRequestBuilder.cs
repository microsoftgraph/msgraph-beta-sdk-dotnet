...
using System;
namespace Microsoft.Graph.Beta.Solutions.BusinessScenarios.Item.Planner.Tasks.Item.AssignedToTaskBoardFormat {
    /// <summary>
    ...
    public class AssignedToTaskBoardFormatRequestBuilder : BaseRequestBuilder {
        ...
        public AssignedToTaskBoardFormatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner/tasks/{businessScenarioTask%2Did}/assignedToTaskBoardFormat{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AssignedToTaskBoardFormatRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AssignedToTaskBoardFormatRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner/tasks/{businessScenarioTask%2Did}/assignedToTaskBoardFormat{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
