...
namespace Microsoft.Graph.Beta.Solutions.BusinessScenarios.Item.Planner.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation CreatePostRequestInformation(BusinessScenarioTask body, Action<TasksRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// <summary>Get tasks from solutions</summary>
