...
#nullable enable
        public async Task<PlannerPlanConfigurationLocalizationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<LocalizationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlannerPlanConfigurationLocalizationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<LocalizationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PlannerPlanConfigurationLocalization?> PostAsync(PlannerPlanConfigurationLocalization body, CancellationToken cancellationToken = default, Action<LocalizationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlannerPlanConfigurationLocalization> PostAsync(PlannerPlanConfigurationLocalization body, CancellationToken cancellationToken = default, Action<LocalizationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
