...
using Microsoft.Graph.Beta.Solutions.BusinessScenarios.Item.Planner.PlanConfiguration.Localizations.Count;
using Microsoft.Graph.Beta.Solutions.BusinessScenarios.Item.Planner.PlanConfiguration.Localizations.Item;
...
namespace Microsoft.Graph.Beta.Solutions.BusinessScenarios.Item.Planner.PlanConfiguration.Localizations {
    /// <summary>
    ...
    public class LocalizationsRequestBuilder : BaseRequestBuilder {
        ...
        public PlannerPlanConfigurationLocalizationItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("plannerPlanConfigurationLocalization%2Did", position);
        ...
        public LocalizationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner/planConfiguration/localizations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LocalizationsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LocalizationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner/planConfiguration/localizations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<PlannerPlanConfigurationLocalizationCollectionResponse?> GetAsync(Action<LocalizationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<PlannerPlanConfigurationLocalizationCollectionResponse> GetAsync(Action<LocalizationsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PlannerPlanConfigurationLocalization?> PostAsync(PlannerPlanConfigurationLocalization body, Action<LocalizationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<PlannerPlanConfigurationLocalization> PostAsync(PlannerPlanConfigurationLocalization body, Action<LocalizationsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(PlannerPlanConfigurationLocalization body, Action<LocalizationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(PlannerPlanConfigurationLocalization body, Action<LocalizationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
