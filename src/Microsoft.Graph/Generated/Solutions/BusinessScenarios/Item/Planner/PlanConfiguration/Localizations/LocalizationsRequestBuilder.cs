...
namespace Microsoft.Graph.Beta.Solutions.BusinessScenarios.Item.Planner.PlanConfiguration.Localizations {
    ...
    public class LocalizationsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation CreatePostRequestInformation(PlannerPlanConfigurationLocalization body, Action<LocalizationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
