...
namespace Microsoft.Graph.Beta.Solutions.BusinessScenarios.Item.Planner.GetPlan {
    ...
    public class GetPlanRequestBuilder {
        ...
        public GetPlanRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetPlanRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreatePostRequestInformation(GetPlanPostRequestBody body, Action<GetPlanRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
