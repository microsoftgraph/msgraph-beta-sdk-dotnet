...
#nullable enable
        public async Task<BusinessScenarioPlanReference?> PostAsync(GetPlanPostRequestBody body, CancellationToken cancellationToken = default, Action<GetPlanRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BusinessScenarioPlanReference> PostAsync(GetPlanPostRequestBody body, CancellationToken cancellationToken = default, Action<GetPlanRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
