...
namespace Microsoft.Graph.Beta.Solutions.BusinessScenarios.Item.Planner {
    ...
    public class PlannerRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation CreatePatchRequestInformation(BusinessScenarioPlanner body, Action<PlannerRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
