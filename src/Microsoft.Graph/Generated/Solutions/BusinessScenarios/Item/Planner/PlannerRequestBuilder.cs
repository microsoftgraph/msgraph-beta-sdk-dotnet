...
namespace Microsoft.Graph.Beta.Solutions.BusinessScenarios.Item.Planner {
    ...
    public class PlannerRequestBuilder : BaseRequestBuilder {
        ...
        public PlanConfigurationRequestBuilder PlanConfiguration { get =>
            new PlanConfigurationRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public TaskConfigurationRequestBuilder TaskConfiguration { get =>
            new TaskConfigurationRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public PlannerRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PlannerRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PlannerRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BusinessScenarioPlanner?> GetAsync(Action<PlannerRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<BusinessScenarioPlanner> GetAsync(Action<PlannerRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<BusinessScenarioPlanner>(requestInfo, BusinessScenarioPlanner.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BusinessScenarioPlanner?> PatchAsync(BusinessScenarioPlanner body, Action<PlannerRequestBuilderPatchRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<BusinessScenarioPlanner> PatchAsync(BusinessScenarioPlanner body, Action<PlannerRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(BusinessScenarioPlanner body, Action<PlannerRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(BusinessScenarioPlanner body, Action<PlannerRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
