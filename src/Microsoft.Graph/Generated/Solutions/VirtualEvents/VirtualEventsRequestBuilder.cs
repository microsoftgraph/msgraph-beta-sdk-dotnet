...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<VirtualEventsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<VirtualEventsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<VirtualEventsRoot?> GetAsync(CancellationToken cancellationToken = default, Action<VirtualEventsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<VirtualEventsRoot> GetAsync(CancellationToken cancellationToken = default, Action<VirtualEventsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<VirtualEventsRoot?> PatchAsync(VirtualEventsRoot body, CancellationToken cancellationToken = default, Action<VirtualEventsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<VirtualEventsRoot> PatchAsync(VirtualEventsRoot body, CancellationToken cancellationToken = default, Action<VirtualEventsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
