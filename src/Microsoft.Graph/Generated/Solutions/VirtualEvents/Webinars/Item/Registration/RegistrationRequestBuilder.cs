...
#nullable enable
        public async Task<VirtualEventRegistration?> GetAsync(CancellationToken cancellationToken = default, Action<RegistrationRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<VirtualEventRegistration> GetAsync(CancellationToken cancellationToken = default, Action<RegistrationRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
