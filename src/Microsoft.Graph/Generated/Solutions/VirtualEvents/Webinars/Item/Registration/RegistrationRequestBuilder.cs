...
using System;
namespace Microsoft.Graph.Beta.Solutions.VirtualEvents.Webinars.Item.Registration {
    /// <summary>
    ...
    public class RegistrationRequestBuilder : BaseRequestBuilder {
        ...
        public RegistrationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registration{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RegistrationRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<VirtualEventRegistration?> GetAsync(Action<RegistrationRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<VirtualEventRegistration> GetAsync(Action<RegistrationRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
