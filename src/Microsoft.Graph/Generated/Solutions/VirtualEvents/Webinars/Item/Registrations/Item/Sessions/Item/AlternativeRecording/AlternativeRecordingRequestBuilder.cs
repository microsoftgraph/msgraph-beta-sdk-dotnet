...
using System;
namespace Microsoft.Graph.Beta.Solutions.VirtualEvents.Webinars.Item.Registrations.Item.Sessions.Item.AlternativeRecording {
    /// <summary>
    ...
    public class AlternativeRecordingRequestBuilder : BaseRequestBuilder {
        ...
        public AlternativeRecordingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}/sessions/{virtualEventSession%2Did}/alternativeRecording", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AlternativeRecordingRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AlternativeRecordingRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}/sessions/{virtualEventSession%2Did}/alternativeRecording", rawUrl) {
        }
        /// <summary>
