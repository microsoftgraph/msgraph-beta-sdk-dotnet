...
using Microsoft.Graph.Beta.Solutions.VirtualEvents.Webinars.Item.Registrations.Item.Sessions.Item.AlternativeRecording;
using Microsoft.Graph.Beta.Solutions.VirtualEvents.Webinars.Item.Registrations.Item.Sessions.Item.AttendeeReport;
using Microsoft.Graph.Beta.Solutions.VirtualEvents.Webinars.Item.Registrations.Item.Sessions.Item.BroadcastRecording;
using Microsoft.Graph.Beta.Solutions.VirtualEvents.Webinars.Item.Registrations.Item.Sessions.Item.Recording;
...
namespace Microsoft.Graph.Beta.Solutions.VirtualEvents.Webinars.Item.Registrations.Item.Sessions.Item {
    ...
    public class VirtualEventSessionItemRequestBuilder : BaseRequestBuilder {
        ...
        public VirtualEventSessionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}/sessions/{virtualEventSession%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new VirtualEventSessionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public VirtualEventSessionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}/sessions/{virtualEventSession%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
