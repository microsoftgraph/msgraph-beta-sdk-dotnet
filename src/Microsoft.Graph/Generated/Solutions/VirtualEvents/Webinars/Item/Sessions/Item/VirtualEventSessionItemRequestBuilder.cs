...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<VirtualEventSessionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<VirtualEventSessionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<VirtualEventSession?> GetAsync(CancellationToken cancellationToken = default, Action<VirtualEventSessionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<VirtualEventSession> GetAsync(CancellationToken cancellationToken = default, Action<VirtualEventSessionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<VirtualEventSession?> PatchAsync(VirtualEventSession body, CancellationToken cancellationToken = default, Action<VirtualEventSessionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<VirtualEventSession> PatchAsync(VirtualEventSession body, CancellationToken cancellationToken = default, Action<VirtualEventSessionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
