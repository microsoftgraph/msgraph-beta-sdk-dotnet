...
namespace Microsoft.Graph.Beta.Solutions.VirtualEvents.Events {
    ...
    public class EventsRequestBuilder : BaseRequestBuilder {
        ...
        public VirtualEventItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("virtualEvent%2Did", position);
...
#nullable enable
        public async Task<VirtualEventCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<EventsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<VirtualEventCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<EventsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<VirtualEvent?> PostAsync(VirtualEvent body, CancellationToken cancellationToken = default, Action<EventsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<VirtualEvent> PostAsync(VirtualEvent body, CancellationToken cancellationToken = default, Action<EventsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
