...
using Microsoft.Graph.Beta.Solutions.VirtualEvents.Events.Item.Sessions.Item.MeetingAttendanceReport.AttendanceRecords;
...
using System;
namespace Microsoft.Graph.Beta.Solutions.VirtualEvents.Events.Item.Sessions.Item.MeetingAttendanceReport {
    /// <summary>
    ...
    public class MeetingAttendanceReportRequestBuilder : BaseRequestBuilder {
        ...
        public MeetingAttendanceReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/meetingAttendanceReport{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MeetingAttendanceReportRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MeetingAttendanceReportRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/meetingAttendanceReport{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
