...
using System;
namespace Microsoft.Graph.Beta.Solutions.VirtualEvents.Events.Item.Sessions.Item.Registration.Registrants.Item {
    /// <summary>
    ...
    public class MeetingRegistrantBaseItemRequestBuilder : BaseRequestBuilder {
        ...
        public MeetingRegistrantBaseItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/registration/registrants/{meetingRegistrantBase%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MeetingRegistrantBaseItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MeetingRegistrantBaseItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/registration/registrants/{meetingRegistrantBase%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<MeetingRegistrantBaseItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<MeetingRegistrantBaseItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MeetingRegistrantBase?> GetAsync(CancellationToken cancellationToken = default, Action<MeetingRegistrantBaseItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MeetingRegistrantBase> GetAsync(CancellationToken cancellationToken = default, Action<MeetingRegistrantBaseItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MeetingRegistrantBase?> PatchAsync(MeetingRegistrantBase body, CancellationToken cancellationToken = default, Action<MeetingRegistrantBaseItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MeetingRegistrantBase> PatchAsync(MeetingRegistrantBase body, CancellationToken cancellationToken = default, Action<MeetingRegistrantBaseItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
