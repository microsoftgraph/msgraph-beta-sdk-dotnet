...
namespace Microsoft.Graph.Beta.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item
{
    ...
    public class VirtualEventPresenterItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.Sessions.SessionsRequestBuilder Sessions
        {
            get => new Microsoft.Graph.Beta.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.Sessions.SessionsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.VirtualEventPresenterItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public Microsoft.Graph.Beta.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.SessionsWithJoinWebUrl.SessionsWithJoinWebUrlRequestBuilder SessionsWithJoinWebUrl(string joinWebUrl)
        {
            if(string.IsNullOrEmpty(joinWebUrl)) throw new ArgumentNullException(nameof(joinWebUrl));
            return new Microsoft.Graph.Beta.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.SessionsWithJoinWebUrl.SessionsWithJoinWebUrlRequestBuilder(PathParameters, RequestAdapter, joinWebUrl);
        }
        /// <summary>
        /// Delete a virtualEventPresenter from a virtual event. Currently the supported virtual event types are: virtualEventTownhall, virtualEventWebinar.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.VirtualEventPresenterItemRequestBuilder.VirtualEventPresenterItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.VirtualEventPresenterItemRequestBuilder.VirtualEventPresenterItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.VirtualEventPresenterItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.VirtualEventPresenterItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class VirtualEventPresenterItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.VirtualEventPresenterItemRequestBuilder.VirtualEventPresenterItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
