...
using System;
namespace Microsoft.Graph.Beta.Solutions.BackupRestore.Reports.GetStatisticsByPolicyWithPolicyId
{
    /// <summary>
    /// Provides operations to call the getStatisticsByPolicy method.
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class GetStatisticsByPolicyWithPolicyIdRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Solutions.BackupRestore.Reports.GetStatisticsByPolicyWithPolicyId.GetStatisticsByPolicyWithPolicyIdRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="policyId">Usage: policyId=&apos;{policyId}&apos;</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetStatisticsByPolicyWithPolicyIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string policyId = "") : base(requestAdapter, "{+baseurl}/solutions/backupRestore/reports/getStatisticsByPolicy(policyId='{policyId}')", pathParameters)
        {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetStatisticsByPolicyWithPolicyIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/backupRestore/reports/getStatisticsByPolicy(policyId='{policyId}')", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class GetStatisticsByPolicyWithPolicyIdRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
