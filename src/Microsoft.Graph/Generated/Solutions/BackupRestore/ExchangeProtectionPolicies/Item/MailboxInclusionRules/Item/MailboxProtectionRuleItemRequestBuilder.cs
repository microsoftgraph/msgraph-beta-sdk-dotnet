...
using System;
namespace Microsoft.Graph.Beta.Solutions.BackupRestore.ExchangeProtectionPolicies.Item.MailboxInclusionRules.Item
{
    /// <summary>
    /// Provides operations to manage the mailboxInclusionRules property of the microsoft.graph.exchangeProtectionPolicy entity.
    /// </summary>
    public class MailboxProtectionRuleItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.Solutions.BackupRestore.ExchangeProtectionPolicies.Item.MailboxInclusionRules.Item.MailboxProtectionRuleItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.Solutions.BackupRestore.ExchangeProtectionPolicies.Item.MailboxInclusionRules.Item.MailboxProtectionRuleItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.Solutions.BackupRestore.ExchangeProtectionPolicies.Item.MailboxInclusionRules.Item.MailboxProtectionRuleItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.Solutions.BackupRestore.ExchangeProtectionPolicies.Item.MailboxInclusionRules.Item.MailboxProtectionRuleItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get a protection rule that&apos;s associated with a protection policy. You can use this operation to get mailbox, drive, and site protection rules. An inclusion rule indicates that a protection policy should contain protection units that match the specified rule criteria. The initial status of a protection rule upon creation is active. After the rule is applied, the state is either completed or completedWithErrors.
        /// </summary>
        public class MailboxProtectionRuleItemRequestBuilderGetQueryParameters 
        {
...
#nullable restore
        ...
        public class MailboxProtectionRuleItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.Solutions.BackupRestore.ExchangeProtectionPolicies.Item.MailboxInclusionRules.Item.MailboxProtectionRuleItemRequestBuilder.MailboxProtectionRuleItemRequestBuilderGetQueryParameters>
        {
        }
    }
}
