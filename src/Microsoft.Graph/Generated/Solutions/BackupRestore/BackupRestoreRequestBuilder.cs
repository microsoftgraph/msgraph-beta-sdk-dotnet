...
using Microsoft.Graph.Beta.Solutions.BackupRestore.DriveExclusionUnits;
using Microsoft.Graph.Beta.Solutions.BackupRestore.DriveExclusionUnitsBulkAdditionJobs;
...
using Microsoft.Graph.Beta.Solutions.BackupRestore.EmailNotificationsSetting;
...
using Microsoft.Graph.Beta.Solutions.BackupRestore.ExclusionUnits;
using Microsoft.Graph.Beta.Solutions.BackupRestore.MailboxExclusionUnits;
using Microsoft.Graph.Beta.Solutions.BackupRestore.MailboxExclusionUnitsBulkAdditionJobs;
...
using Microsoft.Graph.Beta.Solutions.BackupRestore.SiteExclusionUnits;
using Microsoft.Graph.Beta.Solutions.BackupRestore.SiteExclusionUnitsBulkAdditionJobs;
...
namespace Microsoft.Graph.Beta.Solutions.BackupRestore
{
    ...
    public partial class BackupRestoreRequestBuilder : BaseRequestBuilder
    {
        ...
        public BackupRestoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/backupRestore", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Solutions.BackupRestore.BackupRestoreRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BackupRestoreRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/solutions/backupRestore", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        public async Task<global::Microsoft.Graph.Beta.Models.BackupRestoreRoot> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Solutions.BackupRestore.BackupRestoreRequestBuilder.BackupRestoreRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Microsoft.Graph.Beta.Models.BackupRestoreRoot>(requestInfo, global::Microsoft.Graph.Beta.Models.BackupRestoreRoot.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/solutions/backupRestore{?%24expand,%24select}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
