...
namespace Microsoft.Graph.Beta.Shares.Item.List.Operations.Item {
    /// <summary>
    ...
    public class RichLongRunningOperationItemRequestBuilder {
        ...
        public RichLongRunningOperationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/operations/{richLongRunningOperation%2Did}{?%24select,%24expand}";
