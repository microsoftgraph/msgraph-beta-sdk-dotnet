...
using MicrosoftGraph.Shares.Item.List.Activities.Item.DriveItem;
using MicrosoftGraph.Shares.Item.List.Activities.Item.ListItem;
using System;
...
namespace MicrosoftGraph.Shares.Item.List.Activities.Item {
    ...
    public class ItemActivityOLDRequestBuilder {
        ...
        public ItemActivityOLDRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/activities/{itemActivityOLD_id}{?select,expand}";
