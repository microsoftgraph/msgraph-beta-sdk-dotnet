...
using MicrosoftGraphSdk.Shares.Item.List.Activities.Item.DriveItem.Ref;
using System;
...
namespace MicrosoftGraphSdk.Shares.Item.List.Activities.Item.DriveItem {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\activities\{itemActivityOLD-id}\driveItem</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
