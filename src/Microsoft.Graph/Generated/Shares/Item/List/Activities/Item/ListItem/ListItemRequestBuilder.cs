...
using MicrosoftGraph.Shares.Item.List.Activities.Item.ListItem.CreateLink;
using MicrosoftGraph.Shares.Item.List.Activities.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraph.Shares.Item.List.Activities.Item.ListItem.Ref;
using System;
...
namespace MicrosoftGraph.Shares.Item.List.Activities.Item.ListItem {
