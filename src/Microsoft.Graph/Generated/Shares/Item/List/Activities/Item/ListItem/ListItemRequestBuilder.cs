...
using MicrosoftGraphSdk.Shares.Item.List.Activities.Item.ListItem.CreateLink;
using MicrosoftGraphSdk.Shares.Item.List.Activities.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Shares.Item.List.Activities.Item.ListItem.Ref;
using System;
...
namespace MicrosoftGraphSdk.Shares.Item.List.Activities.Item.ListItem {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\activities\{itemActivityOLD-id}\listItem</summary>
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/activities/{itemActivityOLD_id}/listItem{?select,expand}";
