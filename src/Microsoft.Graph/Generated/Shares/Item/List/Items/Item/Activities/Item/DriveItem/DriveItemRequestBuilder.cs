...
using MicrosoftGraphSdk.Shares.Item.List.Items.Item.Activities.Item.DriveItem.Ref;
using System;
...
namespace MicrosoftGraphSdk.Shares.Item.List.Items.Item.Activities.Item.DriveItem {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\items\{listItem-id}\activities\{itemActivityOLD-id}\driveItem</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/items/{listItem_id}/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
        ...
        /// <summary>Get driveItem from shares</summary>
