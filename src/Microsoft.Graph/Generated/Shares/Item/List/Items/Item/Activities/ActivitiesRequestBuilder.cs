...
using MicrosoftGraphSdk.Shares.Item.List.Items.Item.Activities.Item;
using System;
...
namespace MicrosoftGraphSdk.Shares.Item.List.Items.Item.Activities {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\items\{listItem-id}\activities</summary>
    public class ActivitiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.shares.item.list.items.item.activities.item collection</summary>
        ...
        public ActivitiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/items/{listItem_id}/activities{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
