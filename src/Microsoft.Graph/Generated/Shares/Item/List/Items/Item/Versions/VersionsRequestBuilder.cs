...
using MicrosoftGraph.Shares.Item.List.Items.Item.Versions.Item;
using System;
...
namespace MicrosoftGraph.Shares.Item.List.Items.Item.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.shares.item.list.items.item.versions.item collection</summary>
