...
using MicrosoftGraph.Shares.Item.List.Items.Item.Activities.Item.DriveItem;
using MicrosoftGraph.Shares.Item.List.Items.Item.Activities.Item.ListItem;
using System;
...
namespace MicrosoftGraph.Shares.Item.List.Items.Item.Activities.Item {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\items\{listItem-id}\activities\{itemActivityOLD-id}</summary>
    public class ItemActivityOLDRequestBuilder {
        ...
        public ItemActivityOLDRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/items/{listItem_id}/activities/{itemActivityOLD_id}{?select,expand}";
