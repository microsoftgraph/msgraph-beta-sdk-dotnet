...
using Microsoft.Graph.Beta.Shares.Item.List.Items.Item.MicrosoftGraphCreateLink;
using Microsoft.Graph.Beta.Shares.Item.List.Items.Item.MicrosoftGraphGetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
...
#nullable enable
        public async Task DeleteAsync(Action<ListItemItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task DeleteAsync(Action<ListItemItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
