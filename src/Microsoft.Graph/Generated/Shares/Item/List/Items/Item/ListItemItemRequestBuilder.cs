...
using Microsoft.Graph.Beta.Shares.Item.List.Items.Item.CreatedByUser;
...
using Microsoft.Graph.Beta.Shares.Item.List.Items.Item.LastModifiedByUser;
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ListItemItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ListItemItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ListItem?> GetAsync(CancellationToken cancellationToken = default, Action<ListItemItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ListItem> GetAsync(CancellationToken cancellationToken = default, Action<ListItemItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ListItem?> PatchAsync(Microsoft.Graph.Beta.Models.ListItem body, CancellationToken cancellationToken = default, Action<ListItemItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ListItem> PatchAsync(Microsoft.Graph.Beta.Models.ListItem body, CancellationToken cancellationToken = default, Action<ListItemItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
