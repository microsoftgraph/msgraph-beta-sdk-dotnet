...
namespace Microsoft.Graph.Beta.Shares.Item.List.Items.Item.DriveItem.Content {
    /// <summary>
    ...
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/driveItem/content";
