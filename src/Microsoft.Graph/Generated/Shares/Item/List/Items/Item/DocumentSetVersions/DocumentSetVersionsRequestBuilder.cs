...
using Microsoft.Graph.Beta.Shares.Item.List.Items.Item.DocumentSetVersions.Count;
using Microsoft.Graph.Beta.Shares.Item.List.Items.Item.DocumentSetVersions.Item;
...
namespace Microsoft.Graph.Beta.Shares.Item.List.Items.Item.DocumentSetVersions {
    ...
    public class DocumentSetVersionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.shares.item.list.items.item.documentSetVersions.item collection</summary>
