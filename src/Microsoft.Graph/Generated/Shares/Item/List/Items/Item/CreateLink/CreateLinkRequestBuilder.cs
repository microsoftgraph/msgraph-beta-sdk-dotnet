...
namespace MicrosoftGraph.Shares.Item.List.Items.Item.CreateLink {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\items\{listItem-id}\microsoft.graph.createLink</summary>
