...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ListItem?> PostAsync(Microsoft.Graph.Beta.Models.ListItem body, CancellationToken cancellationToken = default, Action<ItemsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ListItem> PostAsync(Microsoft.Graph.Beta.Models.ListItem body, CancellationToken cancellationToken = default, Action<ItemsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
