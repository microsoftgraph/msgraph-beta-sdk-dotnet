...
namespace MicrosoftGraph.Shares.Item.List.ContentTypes.AddCopy {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\contentTypes\microsoft.graph.addCopy</summary>
