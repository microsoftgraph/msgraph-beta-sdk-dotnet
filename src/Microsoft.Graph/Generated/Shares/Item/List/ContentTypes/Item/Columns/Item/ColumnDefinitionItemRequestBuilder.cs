...
using Microsoft.Graph.Beta.Shares.Item.List.ContentTypes.Item.Columns.Item.SourceColumn;
...
namespace Microsoft.Graph.Beta.Shares.Item.List.ContentTypes.Item.Columns.Item {
    /// <summary>
    ...
    public class ColumnDefinitionItemRequestBuilder {
        ...
        public ColumnDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/columns/{columnDefinition%2Did}{?%24select,%24expand}";
