...
namespace Microsoft.Graph.Beta.Shares.Item.List.ContentTypes.Item.MicrosoftGraphPublish {
    /// <summary>
...
#nullable enable
        public async Task PostAsync(Action<MicrosoftGraphPublishRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(Action<MicrosoftGraphPublishRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
