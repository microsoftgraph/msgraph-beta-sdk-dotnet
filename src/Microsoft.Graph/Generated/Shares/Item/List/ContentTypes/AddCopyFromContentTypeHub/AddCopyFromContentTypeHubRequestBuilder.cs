...
#nullable enable
        public async Task<ContentType?> PostAsync(AddCopyFromContentTypeHubPostRequestBody body, CancellationToken cancellationToken = default, Action<AddCopyFromContentTypeHubRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ContentType> PostAsync(AddCopyFromContentTypeHubPostRequestBody body, CancellationToken cancellationToken = default, Action<AddCopyFromContentTypeHubRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
