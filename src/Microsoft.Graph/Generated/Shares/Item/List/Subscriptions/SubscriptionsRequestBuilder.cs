...
using MicrosoftGraph.Shares.Item.List.Subscriptions.Item;
using System;
...
namespace MicrosoftGraph.Shares.Item.List.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.shares.item.list.subscriptions.item collection</summary>
