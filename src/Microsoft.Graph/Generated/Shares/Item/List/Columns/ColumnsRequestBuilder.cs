...
using MicrosoftGraph.Shares.Item.List.Columns.Item;
using System;
...
namespace MicrosoftGraph.Shares.Item.List.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.shares.item.list.columns.item collection</summary>
