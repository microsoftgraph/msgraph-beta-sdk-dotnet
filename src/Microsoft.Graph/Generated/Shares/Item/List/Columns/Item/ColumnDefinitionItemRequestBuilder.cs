...
using Microsoft.Graph.Beta.Shares.Item.List.Columns.Item.SourceColumn;
...
using System;
namespace Microsoft.Graph.Beta.Shares.Item.List.Columns.Item {
    /// <summary>
    ...
    public class ColumnDefinitionItemRequestBuilder : BaseRequestBuilder {
        ...
        public ColumnDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/columns/{columnDefinition%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ColumnDefinitionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ColumnDefinitionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/columns/{columnDefinition%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ColumnDefinitionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ColumnDefinitionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ColumnDefinition?> GetAsync(CancellationToken cancellationToken = default, Action<ColumnDefinitionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ColumnDefinition> GetAsync(CancellationToken cancellationToken = default, Action<ColumnDefinitionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ColumnDefinition?> PatchAsync(ColumnDefinition body, CancellationToken cancellationToken = default, Action<ColumnDefinitionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ColumnDefinition> PatchAsync(ColumnDefinition body, CancellationToken cancellationToken = default, Action<ColumnDefinitionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
