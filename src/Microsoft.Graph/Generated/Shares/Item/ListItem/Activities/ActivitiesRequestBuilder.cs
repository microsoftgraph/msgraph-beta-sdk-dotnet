...
using MicrosoftGraphSdk.Shares.Item.ListItem.Activities.Item;
using System;
...
namespace MicrosoftGraphSdk.Shares.Item.ListItem.Activities {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\listItem\activities</summary>
    public class ActivitiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.shares.item.listItem.activities.item collection</summary>
