...
using MicrosoftGraphSdk.Shares.Item.ListItem.Activities.Item.DriveItem.Ref;
using System;
...
namespace MicrosoftGraphSdk.Shares.Item.ListItem.Activities.Item.DriveItem {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\listItem\activities\{itemActivityOLD-id}\driveItem</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/listItem/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
