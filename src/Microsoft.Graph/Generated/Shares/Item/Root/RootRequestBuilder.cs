...
using Microsoft.Graph.Beta.Shares.Item.Root.Content;
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.DriveItem?> GetAsync(CancellationToken cancellationToken = default, Action<RootRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.DriveItem> GetAsync(CancellationToken cancellationToken = default, Action<RootRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
