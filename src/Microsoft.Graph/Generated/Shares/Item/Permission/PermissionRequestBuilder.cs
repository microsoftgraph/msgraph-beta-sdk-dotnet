...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Permission?> GetAsync(CancellationToken cancellationToken = default, Action<PermissionRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Permission> GetAsync(CancellationToken cancellationToken = default, Action<PermissionRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Permission?> PatchAsync(Microsoft.Graph.Beta.Models.Permission body, CancellationToken cancellationToken = default, Action<PermissionRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Permission> PatchAsync(Microsoft.Graph.Beta.Models.Permission body, CancellationToken cancellationToken = default, Action<PermissionRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
