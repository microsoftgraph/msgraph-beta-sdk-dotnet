...
using MicrosoftGraphSdk.Shares.Item.Items.Item.Content;
using System;
...
namespace MicrosoftGraphSdk.Shares.Item.Items.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/items/{driveItem_id}{?select,expand}";
