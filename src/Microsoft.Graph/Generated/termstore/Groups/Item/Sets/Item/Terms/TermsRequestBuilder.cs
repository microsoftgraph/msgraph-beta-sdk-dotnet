...
using MicrosoftGraph.TermStore.Groups.Item.Sets.Item.Terms.Item;
using System;
...
namespace MicrosoftGraph.TermStore.Groups.Item.Sets.Item.Terms {
    ...
    public class TermsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.termStore.groups.item.sets.item.terms.item collection</summary>
