...
using MicrosoftGraph.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Item;
using System;
...
namespace MicrosoftGraph.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.termStore.groups.item.sets.item.terms.item.relations.item collection</summary>
