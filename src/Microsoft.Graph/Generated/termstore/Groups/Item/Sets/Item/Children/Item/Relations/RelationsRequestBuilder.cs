...
using MicrosoftGraph.TermStore.Groups.Item.Sets.Item.Children.Item.Relations.Item;
using System;
...
namespace MicrosoftGraph.TermStore.Groups.Item.Sets.Item.Children.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.termStore.groups.item.sets.item.children.item.relations.item collection</summary>
