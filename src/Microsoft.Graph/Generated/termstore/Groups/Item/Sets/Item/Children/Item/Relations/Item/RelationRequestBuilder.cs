...
using MicrosoftGraph.TermStore.Groups.Item.Sets.Item.Children.Item.Relations.Item.FromTerm;
using MicrosoftGraph.TermStore.Groups.Item.Sets.Item.Children.Item.Relations.Item.Set;
using MicrosoftGraph.TermStore.Groups.Item.Sets.Item.Children.Item.Relations.Item.ToTerm;
using System;
...
namespace MicrosoftGraph.TermStore.Groups.Item.Sets.Item.Children.Item.Relations.Item {
    /// <summary>Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\children\{term-id}\relations\{relation-id}</summary>
    public class RelationRequestBuilder {
        ...
        public RelationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/groups/{group_id}/sets/{set_id}/children/{term_id}/relations/{relation_id}{?select,expand}";
