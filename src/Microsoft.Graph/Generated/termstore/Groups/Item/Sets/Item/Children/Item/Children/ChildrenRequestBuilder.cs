...
namespace MicrosoftGraph.TermStore.Groups.Item.Sets.Item.Children.Item.Children {
    /// <summary>Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\children\{term-id}\children</summary>
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.termStore.groups.item.sets.item.children.item.children.item collection</summary>
        public ChildrenRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("term_id1", position);
            return new ChildrenRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
