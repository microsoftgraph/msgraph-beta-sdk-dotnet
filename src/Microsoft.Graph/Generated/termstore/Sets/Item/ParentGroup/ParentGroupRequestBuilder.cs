...
using MicrosoftGraph.TermStore.Sets.Item.ParentGroup.Sets;
using System;
...
namespace MicrosoftGraph.TermStore.Sets.Item.ParentGroup {
    /// <summary>Builds and executes requests for operations under \termStore\sets\{set-id}\parentGroup</summary>
    public class ParentGroupRequestBuilder {
        ...
        public ParentGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/sets/{set_id}/parentGroup{?select,expand}";
