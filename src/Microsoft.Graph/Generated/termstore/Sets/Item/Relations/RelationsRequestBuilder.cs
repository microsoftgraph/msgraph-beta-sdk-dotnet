...
using MicrosoftGraph.TermStore.Sets.Item.Relations.Item;
using System;
...
namespace MicrosoftGraph.TermStore.Sets.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.termStore.sets.item.relations.item collection</summary>
