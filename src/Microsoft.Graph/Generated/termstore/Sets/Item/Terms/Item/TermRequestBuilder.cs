...
using MicrosoftGraph.TermStore.Sets.Item.Terms.Item.Children;
using MicrosoftGraph.TermStore.Sets.Item.Terms.Item.Relations;
using MicrosoftGraph.TermStore.Sets.Item.Terms.Item.Set;
using System;
...
namespace MicrosoftGraph.TermStore.Sets.Item.Terms.Item {
    /// <summary>Builds and executes requests for operations under \termStore\sets\{set-id}\terms\{term-id}</summary>
    public class TermRequestBuilder {
        ...
        public TermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/sets/{set_id}/terms/{term_id}{?select,expand}";
