...
using MicrosoftGraph.TermStore.Sets.Item.Terms.Item.Children.Item;
using System;
...
namespace MicrosoftGraph.TermStore.Sets.Item.Terms.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.termStore.sets.item.terms.item.children.item collection</summary>
