...
namespace MicrosoftGraph.TermStore.Sets.Item.Terms.Item.Children.Item {
    /// <summary>Builds and executes requests for operations under \termStore\sets\{set-id}\terms\{term-id}\children\{term-id1}</summary>
    public class TermRequestBuilder {
        ...
        public TermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/sets/{set_id}/terms/{term_id}/children/{term_id1}{?select,expand}";
