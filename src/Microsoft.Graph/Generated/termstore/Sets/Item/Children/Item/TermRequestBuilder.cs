...
using MicrosoftGraph.TermStore.Sets.Item.Children.Item.Children;
using MicrosoftGraph.TermStore.Sets.Item.Children.Item.Relations;
using MicrosoftGraph.TermStore.Sets.Item.Children.Item.Set;
using System;
...
namespace MicrosoftGraph.TermStore.Sets.Item.Children.Item {
    ...
    public class TermRequestBuilder {
        ...
        public TermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/sets/{set_id}/children/{term_id}{?select,expand}";
