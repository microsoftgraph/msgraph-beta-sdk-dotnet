...
using MicrosoftGraph.TermStore.Sets.Item.Children.Item.Relations.Item.FromTerm;
using MicrosoftGraph.TermStore.Sets.Item.Children.Item.Relations.Item.Set;
using MicrosoftGraph.TermStore.Sets.Item.Children.Item.Relations.Item.ToTerm;
using System;
...
namespace MicrosoftGraph.TermStore.Sets.Item.Children.Item.Relations.Item {
    /// <summary>Builds and executes requests for operations under \termStore\sets\{set-id}\children\{term-id}\relations\{relation-id}</summary>
    public class RelationRequestBuilder {
        ...
        public RelationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/sets/{set_id}/children/{term_id}/relations/{relation_id}{?select,expand}";
