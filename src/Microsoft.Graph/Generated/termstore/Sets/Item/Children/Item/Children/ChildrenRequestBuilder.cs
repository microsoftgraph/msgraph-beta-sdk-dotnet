...
using MicrosoftGraph.TermStore.Sets.Item.Children.Item.Children.Item;
using System;
...
namespace MicrosoftGraph.TermStore.Sets.Item.Children.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.termStore.sets.item.children.item.children.item collection</summary>
