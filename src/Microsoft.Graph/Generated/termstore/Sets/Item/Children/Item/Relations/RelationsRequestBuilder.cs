...
using MicrosoftGraph.TermStore.Sets.Item.Children.Item.Relations.Item;
using System;
...
namespace MicrosoftGraph.TermStore.Sets.Item.Children.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.termStore.sets.item.children.item.relations.item collection</summary>
