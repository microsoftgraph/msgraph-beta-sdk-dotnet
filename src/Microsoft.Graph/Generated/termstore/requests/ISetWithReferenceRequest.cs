...
namespace Microsoft.Graph.TermStore
{
    ...
    public partial interface ISetWithReferenceRequest : Microsoft.Graph.IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<Set> GetAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<Set>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<Set> CreateAsync(Set setToCreate, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Set}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Set>> CreateResponseAsync(Set setToCreate, CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<Set> UpdateAsync(Set setToUpdate, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="Microsoft.Graph.ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Set}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Set>> UpdateResponseAsync(Set setToUpdate, CancellationToken cancellationToken = default);
