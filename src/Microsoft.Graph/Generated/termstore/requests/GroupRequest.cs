...
namespace Microsoft.Graph.TermStore
{
    ...
    /// </summary>
    public partial class GroupRequest : Microsoft.Graph.BaseRequest, IGroupRequest
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Group> UpdateAsync(Group groupToUpdate, CancellationToken cancellationToken)
        {
			...
			{
				if (groupToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.ResponseHeaders) ||
					groupToUpdate.AdditionalData.ContainsKey(Microsoft.Graph.Constants.HttpPropertyNames.StatusCode))
				{
					throw new Microsoft.Graph.ClientException(
						new Microsoft.Graph.Error
						{
							Code = Microsoft.Graph.GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(Microsoft.Graph.GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, groupToUpdate.GetType().Name)
						});
				}
			}
            if (groupToUpdate.AdditionalData != null)
