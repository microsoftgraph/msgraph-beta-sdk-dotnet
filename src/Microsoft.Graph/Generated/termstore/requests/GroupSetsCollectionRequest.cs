...
namespace Microsoft.Graph.TermStore
{
    ...
    /// </summary>
    public partial class GroupSetsCollectionRequest : Microsoft.Graph.BaseRequest, IGroupSetsCollectionRequest
    {
        /// <summary>
        ...
        public GroupSetsCollectionRequest(
            string requestUrl,
        ...
        public System.Threading.Tasks.Task<Set> AddAsync(Set set, CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Set>> AddResponseAsync(Set set, CancellationToken cancellationToken = default)
        {
            this.ContentType = CoreConstants.MimeTypeNames.Application.Json;
            this.Method = HttpMethods.POST;
        ...
        public async System.Threading.Tasks.Task<IGroupSetsCollectionPage> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        public System.Threading.Tasks.Task<GraphResponse<GroupSetsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default)
        {
            this.Method = HttpMethods.GET;
        ...
        public IGroupSetsCollectionRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IGroupSetsCollectionRequest Expand(Expression<Func<Set, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IGroupSetsCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IGroupSetsCollectionRequest Select(Expression<Func<Set, object>> selectExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IGroupSetsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IGroupSetsCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IGroupSetsCollectionRequest Skip(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IGroupSetsCollectionRequest OrderBy(string value)
        {
