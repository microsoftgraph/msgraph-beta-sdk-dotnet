...
namespace Microsoft.Graph.TermStore
{
    ...
    public partial interface IStoreRequest : Microsoft.Graph.IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<Store> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Store}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<Store>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<Store> PutAsync(Store storeToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<Store>> PutResponseAsync(Store storeToUpdate, CancellationToken cancellationToken = default(CancellationToken));
