...
namespace Microsoft.Graph.TermStore
{
    ...
    public partial interface IStoreGroupsCollectionRequest : Microsoft.Graph.IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<IStoreGroupsCollectionPage> GetAsync(CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<GraphResponse<StoreGroupsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default);
        ...
        IStoreGroupsCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IStoreGroupsCollectionRequest Expand(Expression<Func<Group, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IStoreGroupsCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IStoreGroupsCollectionRequest Select(Expression<Func<Group, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IStoreGroupsCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IStoreGroupsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IStoreGroupsCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IStoreGroupsCollectionRequest OrderBy(string value);
    }
}
