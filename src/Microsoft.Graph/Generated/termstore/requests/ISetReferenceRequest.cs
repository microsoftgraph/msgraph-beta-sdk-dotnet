...
namespace Microsoft.Graph.TermStore
{
    ...
    /// </summary>
    public partial interface ISetReferenceRequest : Microsoft.Graph.IBaseRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Puts the specified Set reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The Set reference reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
