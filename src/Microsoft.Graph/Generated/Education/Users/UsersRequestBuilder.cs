...
#nullable enable
        public async Task<EducationUserCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<UsersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationUserCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UsersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EducationUser?> PostAsync(EducationUser body, CancellationToken cancellationToken = default, Action<UsersRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationUser> PostAsync(EducationUser body, CancellationToken cancellationToken = default, Action<UsersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
