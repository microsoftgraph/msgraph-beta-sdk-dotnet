...
namespace Microsoft.Graph.Beta.Education.Users {
    ...
    public class UsersRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationUserCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UsersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationUser> PostAsync(EducationUser body, CancellationToken cancellationToken = default, Action<UsersRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
