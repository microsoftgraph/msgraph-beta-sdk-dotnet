...
namespace Microsoft.Graph.Beta.Education.Users.Item.Rubrics.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/users/{educationUser%2Did}/rubrics/$count{?%24search,%24filter}";
