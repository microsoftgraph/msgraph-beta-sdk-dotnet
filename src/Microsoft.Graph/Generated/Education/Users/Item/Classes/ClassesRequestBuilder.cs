...
namespace Microsoft.Graph.Beta.Education.Users.Item.Classes {
    ...
    public class ClassesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.education.users.item.classes.item collection</summary>
        ...
        public ClassesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/users/{educationUser%2Did}/classes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>Retrieve a collection of educationClass resources.</summary>
