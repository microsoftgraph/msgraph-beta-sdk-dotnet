using Microsoft.Graph.Beta.Education.Users.Item.Classes.Count;
using Microsoft.Graph.Beta.Education.Users.Item.Classes.Item;
...
using System;
namespace Microsoft.Graph.Beta.Education.Users.Item.Classes {
    /// <summary>
    ...
    public class ClassesRequestBuilder : BaseRequestBuilder {
        ...
        public ClassesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/classes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ClassesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ClassesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/classes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
