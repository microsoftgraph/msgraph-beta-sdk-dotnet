using Microsoft.Graph.Beta.Education.Users.Item.User.MailboxSettings;
...
using System;
namespace Microsoft.Graph.Beta.Education.Users.Item.User {
    /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.User?> GetAsync(CancellationToken cancellationToken = default, Action<UserRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.User> GetAsync(CancellationToken cancellationToken = default, Action<UserRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
