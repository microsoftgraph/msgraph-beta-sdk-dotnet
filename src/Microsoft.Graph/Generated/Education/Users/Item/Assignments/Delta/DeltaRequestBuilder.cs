...
namespace Microsoft.Graph.Beta.Education.Users.Item.Assignments.Delta {
    /// <summary>
    ...
    public class DeltaRequestBuilder {
        ...
        public DeltaRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/users/{educationUser%2Did}/assignments/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
