...
using System;
namespace Microsoft.Graph.Beta.Education.Users.Item.Assignments.Item.Activate {
    /// <summary>
    ...
    public class ActivateRequestBuilder : BaseRequestBuilder {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/educationassignment-activate?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EducationAssignment?> PostAsync(CancellationToken cancellationToken = default, Action<ActivateRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationAssignment> PostAsync(CancellationToken cancellationToken = default, Action<ActivateRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
