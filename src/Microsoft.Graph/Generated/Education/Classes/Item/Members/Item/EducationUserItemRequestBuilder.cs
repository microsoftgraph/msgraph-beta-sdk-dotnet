...
namespace Microsoft.Graph.Beta.Education.Classes.Item.Members.Item {
    ...
    public class EducationUserItemRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationUser> GetAsync(Action<EducationUserItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
