...
namespace Microsoft.Graph.Beta.Education.Classes.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationUserCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MembersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
