...
using System;
namespace Microsoft.Graph.Beta.Education.Classes.Item.Modules.Item.SetUpResourcesFolder {
    /// <summary>
...
#nullable enable
        public async Task<EducationModule?> PostAsync(Action<SetUpResourcesFolderRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<EducationModule> PostAsync(Action<SetUpResourcesFolderRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
