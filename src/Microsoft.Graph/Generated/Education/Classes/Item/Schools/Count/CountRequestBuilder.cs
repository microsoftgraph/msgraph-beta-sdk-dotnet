...
namespace Microsoft.Graph.Beta.Education.Classes.Item.Schools.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/classes/{educationClass%2Did}/schools/$count{?%24search,%24filter}";
