...
namespace Microsoft.Graph.Beta.Education.Classes.Item.Assignments.Item.Submissions.Item.SetUpResourcesFolder {
    ...
    public class SetUpResourcesFolderRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationSubmission> PostAsync(CancellationToken cancellationToken = default, Action<SetUpResourcesFolderRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
