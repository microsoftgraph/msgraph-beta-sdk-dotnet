...
namespace MicrosoftGraph.Education.Classes.Item.Assignments.Item.Categories.Item {
    ...
    public class EducationCategoryRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public EducationCategoryRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
