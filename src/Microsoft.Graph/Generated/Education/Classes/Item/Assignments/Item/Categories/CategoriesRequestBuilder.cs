...
namespace Microsoft.Graph.Beta.Education.Classes.Item.Assignments.Item.Categories {
    ...
    public class CategoriesRequestBuilder : BaseRequestBuilder {
        ...
        /// <returns>A <cref="EducationCategoryItemRequestBuilder"></returns>
        ...
        /// </summary>
        /// <returns>A <cref="EducationCategoryCollectionResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EducationCategoryCollectionResponse?> GetAsync(Action<RequestConfiguration<CategoriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<EducationCategoryCollectionResponse> GetAsync(Action<RequestConfiguration<CategoriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
        ...
        /// </summary>
        /// <returns>A <cref="EducationCategory"></returns>
