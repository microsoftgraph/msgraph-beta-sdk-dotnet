...
namespace MicrosoftGraphSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Submit {
    ...
    public class SubmitRequestBuilder {
        ...
        public async Task<SubmitResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<SubmitResponse>(requestInfo, SubmitResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
        /// <summary>Union type wrapper for classes educationSubmission</summary>
        public class SubmitResponse : IParsable, IAdditionalDataHolder {
            ...
            public static SubmitResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"educationSubmission", (o,n) => { (o as SubmitResponse).EducationSubmission = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.EducationSubmission>(MicrosoftGraphSdk.Models.Microsoft.Graph.EducationSubmission.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
