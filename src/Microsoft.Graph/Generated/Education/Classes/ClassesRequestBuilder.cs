...
namespace MicrosoftGraphSdk.Education.Classes {
    ...
    public class ClassesRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(EducationClass body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
