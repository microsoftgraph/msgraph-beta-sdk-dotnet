...
namespace MicrosoftGraph.Education.Me.Rubrics {
    ...
    public class RubricsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.education.me.rubrics.item collection</summary>
        public RubricsRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("educationRubric_id", position);
            return new RubricsRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
