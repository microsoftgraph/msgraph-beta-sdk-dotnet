...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Education.Me.Rubrics {
    public class RubricsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as RubricsResponse).Value = n.GetCollectionOfObjectValues<EducationRubric>().ToList(); } },
            };
        }
        /// <summary>
