...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Education.Me.Assignments.Item.Submissions.Item.Resources {
    public class ResourcesResponse : IParsable {
        ...
        /// </summary>
        public static ResourcesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ResourcesResponse).Value = n.GetCollectionOfObjectValues<EducationSubmissionResource>(EducationSubmissionResource.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
