...
#nullable enable
        public async Task<EducationSubmission?> PostAsync(CancellationToken cancellationToken = default, Action<UnsubmitRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationSubmission> PostAsync(CancellationToken cancellationToken = default, Action<UnsubmitRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
