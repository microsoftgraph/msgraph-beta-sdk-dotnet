...
namespace Microsoft.Graph.Beta.Education.Me.Assignments.Item.Submissions.Item.Unsubmit {
    ...
    public class UnsubmitRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationSubmission> PostAsync(CancellationToken cancellationToken = default, Action<UnsubmitRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
