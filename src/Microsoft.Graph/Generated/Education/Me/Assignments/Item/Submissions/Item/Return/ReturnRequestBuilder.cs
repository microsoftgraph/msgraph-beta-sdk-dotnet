...
#nullable enable
        public async Task<EducationSubmission?> PostAsync(CancellationToken cancellationToken = default, Action<ReturnRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationSubmission> PostAsync(CancellationToken cancellationToken = default, Action<ReturnRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
