...
namespace Microsoft.Graph.Beta.Education.Me.Assignments.Item.Submissions.Item.Return {
    ...
    public class ReturnRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationSubmission> PostAsync(CancellationToken cancellationToken = default, Action<ReturnRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
