...
namespace Microsoft.Graph.Beta.Education.Me.Assignments.Item.Submissions {
    ...
    public class SubmissionsRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationSubmissionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SubmissionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationSubmission> PostAsync(EducationSubmission body, CancellationToken cancellationToken = default, Action<SubmissionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
