...
#nullable enable
        public async Task<EducationSubmissionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SubmissionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationSubmissionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SubmissionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EducationSubmission?> PostAsync(EducationSubmission body, CancellationToken cancellationToken = default, Action<SubmissionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationSubmission> PostAsync(EducationSubmission body, CancellationToken cancellationToken = default, Action<SubmissionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
