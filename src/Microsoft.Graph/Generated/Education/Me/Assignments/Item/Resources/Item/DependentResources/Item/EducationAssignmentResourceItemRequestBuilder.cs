...
namespace Microsoft.Graph.Beta.Education.Me.Assignments.Item.Resources.Item.DependentResources.Item {
    ...
    public class EducationAssignmentResourceItemRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EducationAssignmentResourceItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/resources/{educationAssignmentResource%2Did}/dependentResources/{educationAssignmentResource%2Did1}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
