...
namespace Microsoft.Graph.Beta.Education.Me.Assignments.Item.Resources.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/resources/$count{?%24search,%24filter}";
