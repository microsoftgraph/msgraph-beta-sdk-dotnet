...
namespace Microsoft.Graph.Beta.Education.Me.Assignments.Item.SetUpFeedbackResourcesFolder {
    ...
    public class SetUpFeedbackResourcesFolderRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationAssignment> PostAsync(Action<SetUpFeedbackResourcesFolderRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
