...
namespace Microsoft.Graph.Beta.Education.Me.Assignments.Item.SetUpFeedbackResourcesFolder {
    ...
    public class SetUpFeedbackResourcesFolderRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationAssignment> PostAsync(CancellationToken cancellationToken = default, Action<SetUpFeedbackResourcesFolderRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
