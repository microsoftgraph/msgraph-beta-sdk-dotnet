...
#nullable enable
        public async Task<EducationAssignment?> PostAsync(CancellationToken cancellationToken = default, Action<PublishRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationAssignment> PostAsync(CancellationToken cancellationToken = default, Action<PublishRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
