...
namespace Microsoft.Graph.Beta.Education.Me
{
    ...
    public partial class MeRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Microsoft.Graph.Beta.Education.Me.Assignments.AssignmentsRequestBuilder Assignments
        {
            get => new global::Microsoft.Graph.Beta.Education.Me.Assignments.AssignmentsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the classes property of the microsoft.graph.educationUser entity.</summary>
        public global::Microsoft.Graph.Beta.Education.Me.Classes.ClassesRequestBuilder Classes
        {
            get => new global::Microsoft.Graph.Beta.Education.Me.Classes.ClassesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the rubrics property of the microsoft.graph.educationUser entity.</summary>
        public global::Microsoft.Graph.Beta.Education.Me.Rubrics.RubricsRequestBuilder Rubrics
        {
            get => new global::Microsoft.Graph.Beta.Education.Me.Rubrics.RubricsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the schools property of the microsoft.graph.educationUser entity.</summary>
        public global::Microsoft.Graph.Beta.Education.Me.Schools.SchoolsRequestBuilder Schools
        {
            get => new global::Microsoft.Graph.Beta.Education.Me.Schools.SchoolsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the taughtClasses property of the microsoft.graph.educationUser entity.</summary>
        public global::Microsoft.Graph.Beta.Education.Me.TaughtClasses.TaughtClassesRequestBuilder TaughtClasses
        {
            get => new global::Microsoft.Graph.Beta.Education.Me.TaughtClasses.TaughtClassesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the user property of the microsoft.graph.educationUser entity.</summary>
        public global::Microsoft.Graph.Beta.Education.Me.User.UserRequestBuilder User
        {
            get => new global::Microsoft.Graph.Beta.Education.Me.User.UserRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Education.Me.MeRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Microsoft.Graph.Beta.Models.EducationUser?> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Education.Me.MeRequestBuilder.MeRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Microsoft.Graph.Beta.Models.EducationUser> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Education.Me.MeRequestBuilder.MeRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Education.Me.MeRequestBuilder.MeRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Beta.Education.Me.MeRequestBuilder.MeRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Beta.Education.Me.MeRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Beta.Education.Me.MeRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Beta.Education.Me.MeRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.19.0")]
        public partial class MeRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Microsoft.Graph.Beta.Education.Me.MeRequestBuilder.MeRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
