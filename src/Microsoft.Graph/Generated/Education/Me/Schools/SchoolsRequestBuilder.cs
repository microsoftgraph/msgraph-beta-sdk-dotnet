...
namespace Microsoft.Graph.Beta.Education.Me.Schools {
    ...
    public class SchoolsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.education.me.schools.item collection</summary>
        ...
        /// </summary>
        public async Task<EducationSchoolCollectionResponse> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
