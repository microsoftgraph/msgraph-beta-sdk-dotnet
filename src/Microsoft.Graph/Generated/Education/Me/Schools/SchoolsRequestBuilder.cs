...
namespace Microsoft.Graph.Beta.Education.Me.Schools {
    ...
    public class SchoolsRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationSchoolCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SchoolsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
