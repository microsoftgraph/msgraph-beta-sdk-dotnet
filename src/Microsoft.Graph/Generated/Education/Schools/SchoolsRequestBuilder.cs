...
namespace Microsoft.Graph.Beta.Education.Schools {
    ...
    public class SchoolsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationSchool> PostAsync(EducationSchool body, CancellationToken cancellationToken = default, Action<SchoolsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
