...
namespace Microsoft.Graph.Beta.Education.Schools.Item.AdministrativeUnit {
    ...
    public class AdministrativeUnitRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.AdministrativeUnit> GetAsync(CancellationToken cancellationToken = default, Action<AdministrativeUnitRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
