using Microsoft.Graph.Beta.Education.Schools.Item.Users.Count;
using Microsoft.Graph.Beta.Education.Schools.Item.Users.Item;
using Microsoft.Graph.Beta.Education.Schools.Item.Users.Ref;
...
namespace Microsoft.Graph.Beta.Education.Schools.Item.Users {
    ...
    public class UsersRequestBuilder {
        ...
        public UsersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/schools/{educationSchool%2Did}/users{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
