...
namespace Microsoft.Graph.Beta.Education.SynchronizationProfiles.Item.Start {
    ...
    public class StartResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<EducationFileSynchronizationVerificationMessage> Value {
            get { return BackingStore?.Get<List<EducationFileSynchronizationVerificationMessage>>(nameof(Value)); }
