...
namespace Microsoft.Graph.Beta.Education.SynchronizationProfiles.Item.Start {
    ...
    public class StartRequestBuilder {
        ...
        /// </summary>
        public async Task<StartResponse> PostAsync(CancellationToken cancellationToken = default, Action<StartRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<StartResponse>(requestInfo, StartResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
