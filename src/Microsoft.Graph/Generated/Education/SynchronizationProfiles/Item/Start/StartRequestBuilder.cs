...
#nullable enable
        public async Task<StartResponse?> PostAsync(CancellationToken cancellationToken = default, Action<StartRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<StartResponse> PostAsync(CancellationToken cancellationToken = default, Action<StartRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
