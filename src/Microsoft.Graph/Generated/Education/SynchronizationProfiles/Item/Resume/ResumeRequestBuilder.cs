...
namespace Microsoft.Graph.Beta.Education.SynchronizationProfiles.Item.Resume {
    ...
    public class ResumeRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<ResumeRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
