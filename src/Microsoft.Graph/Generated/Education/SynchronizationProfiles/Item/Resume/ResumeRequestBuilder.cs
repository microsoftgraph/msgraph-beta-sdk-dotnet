...
namespace Microsoft.Graph.Beta.Education.SynchronizationProfiles.Item.Resume {
    ...
    public class ResumeRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<ResumeRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
