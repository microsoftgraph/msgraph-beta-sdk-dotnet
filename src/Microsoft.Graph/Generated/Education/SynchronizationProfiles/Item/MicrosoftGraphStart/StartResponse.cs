...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Beta.Education.SynchronizationProfiles.Item.MicrosoftGraphStart {
    public class StartResponse : BaseCollectionPaginationCountResponse, IParsable {
...
#nullable restore
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<EducationFileSynchronizationVerificationMessage>("value", Value);
        }
    }
}
