...
namespace Microsoft.Graph.Beta.Education.SynchronizationProfiles.Item.ProfileStatus {
    ...
    public class ProfileStatusRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(Action<ProfileStatusRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationSynchronizationProfileStatus> GetAsync(Action<ProfileStatusRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
