...
using MicrosoftGraph.Education.SynchronizationProfiles.Item.Errors;
using MicrosoftGraph.Education.SynchronizationProfiles.Item.Pause;
using MicrosoftGraph.Education.SynchronizationProfiles.Item.ProfileStatus;
using MicrosoftGraph.Education.SynchronizationProfiles.Item.Reset;
using MicrosoftGraph.Education.SynchronizationProfiles.Item.Resume;
using MicrosoftGraph.Education.SynchronizationProfiles.Item.Start;
using MicrosoftGraph.Education.SynchronizationProfiles.Item.UploadUrl;
...
namespace MicrosoftGraph.Education.SynchronizationProfiles.Item {
    ...
    public class EducationSynchronizationProfileRequestBuilder {
        ...
        /// </summary>
        public EducationSynchronizationProfileRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public EducationSynchronizationProfileRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
