...
namespace MicrosoftGraphSdk.Education.SynchronizationProfiles.Item {
    ...
    public class EducationSynchronizationProfileItemRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(EducationSynchronizationProfile body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
