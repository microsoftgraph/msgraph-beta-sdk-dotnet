...
namespace Microsoft.Graph.Beta.Education.SynchronizationProfiles {
    ...
    public class SynchronizationProfilesRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationSynchronizationProfileCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SynchronizationProfilesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationSynchronizationProfile> PostAsync(EducationSynchronizationProfile body, CancellationToken cancellationToken = default, Action<SynchronizationProfilesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
