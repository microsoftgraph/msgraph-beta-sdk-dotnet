...
namespace Microsoft.Graph.Beta.Education.SynchronizationProfiles {
    ...
    public class SynchronizationProfilesRequestBuilder : BaseRequestBuilder {
        ...
        /// <returns>A <cref="EducationSynchronizationProfileItemRequestBuilder"></returns>
        ...
        /// <summary>
        /// Instantiates a new <see cref="SynchronizationProfilesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <cref="EducationSynchronizationProfileCollectionResponse"></returns>
...
#nullable restore
...
#endif
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/education/synchronizationProfiles", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
        ...
        /// </summary>
        /// <returns>A <cref="SynchronizationProfilesRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
