...
namespace Microsoft.Graph.Beta.Education.SynchronizationProfiles {
    ...
    public class SynchronizationProfilesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.education.synchronizationProfiles.item collection</summary>
        ...
        public SynchronizationProfilesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/synchronizationProfiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<SynchronizationProfilesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<EducationSynchronizationProfileCollectionResponse> GetAsync(Action<SynchronizationProfilesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationSynchronizationProfile> PostAsync(EducationSynchronizationProfile body, Action<SynchronizationProfilesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
