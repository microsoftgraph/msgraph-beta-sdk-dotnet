...
namespace Microsoft.Graph.Beta.Education.SynchronizationProfiles {
    ...
    public class SynchronizationProfilesRequestBuilder : BaseRequestBuilder {
        ...
        public EducationSynchronizationProfileItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("educationSynchronizationProfile%2Did", position);
...
#nullable enable
        public async Task<EducationSynchronizationProfileCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SynchronizationProfilesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationSynchronizationProfileCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SynchronizationProfilesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EducationSynchronizationProfile?> PostAsync(EducationSynchronizationProfile body, CancellationToken cancellationToken = default, Action<SynchronizationProfilesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationSynchronizationProfile> PostAsync(EducationSynchronizationProfile body, CancellationToken cancellationToken = default, Action<SynchronizationProfilesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
