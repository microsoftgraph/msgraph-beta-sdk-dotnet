...
using Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item.Children.Item.Children;
using Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item.Children.Item.Relations;
using Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item.Children.Item.Set;
...
namespace Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item.Children.Item {
    ...
    public class TermItemRequestBuilder {
        ...
        public Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item.Children.Item.Children.ChildrenRequestBuilder Children { get =>
            new Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item.Children.Item.Children.ChildrenRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public TermItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/children/{term%2Did}{?%24select,%24expand}";
