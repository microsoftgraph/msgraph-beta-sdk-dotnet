...
using MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Children.Item.Children;
using MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Children.Item.Relations;
using MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Children.Item.Set;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Children.Item {
    ...
    public class TermItemRequestBuilder {
        ...
        public MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Children.Item.Children.ChildrenRequestBuilder Children { get =>
            new MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Children.Item.Children.ChildrenRequestBuilder(PathParameters, RequestAdapter);
        }
