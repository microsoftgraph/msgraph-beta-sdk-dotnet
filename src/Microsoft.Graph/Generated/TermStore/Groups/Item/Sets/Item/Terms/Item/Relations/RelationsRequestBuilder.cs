...
using MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Item;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations {
    /// <summary>Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\terms\{term-id}\relations</summary>
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.termStore.groups.item.sets.item.terms.item.relations.item collection</summary>
