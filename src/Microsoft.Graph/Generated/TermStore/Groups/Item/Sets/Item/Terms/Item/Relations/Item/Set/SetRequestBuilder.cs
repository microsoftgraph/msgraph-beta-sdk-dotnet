...
using MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Item.Set.Ref;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Item.Set {
    /// <summary>Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\terms\{term-id}\relations\{relation-id}\set</summary>
    public class SetRequestBuilder {
        ...
        public SetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/groups/{group_id}/sets/{set_id}/terms/{term_id}/relations/{relation_id}/set{?select,expand}";
