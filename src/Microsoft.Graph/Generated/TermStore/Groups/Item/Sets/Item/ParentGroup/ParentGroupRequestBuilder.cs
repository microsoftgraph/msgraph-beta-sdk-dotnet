...
using System;
namespace Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item.ParentGroup {
    /// <summary>
    ...
    public class ParentGroupRequestBuilder : BaseRequestBuilder {
        ...
        public ParentGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/parentGroup{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ParentGroupRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ParentGroupRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/parentGroup{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
