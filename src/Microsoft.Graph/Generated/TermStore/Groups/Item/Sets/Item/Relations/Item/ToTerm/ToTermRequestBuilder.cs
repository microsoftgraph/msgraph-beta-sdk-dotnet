...
using MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Relations.Item.ToTerm.Ref;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Relations.Item.ToTerm {
    /// <summary>Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\relations\{relation-id}\toTerm</summary>
    public class ToTermRequestBuilder {
        ...
        public ToTermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/groups/{group_id}/sets/{set_id}/relations/{relation_id}/toTerm{?select,expand}";
