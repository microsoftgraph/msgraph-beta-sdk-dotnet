...
using MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Item.FromTerm;
using MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Item.Set;
using MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Item.ToTerm;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Item {
    /// <summary>Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\terms\{term-id}\relations\{relation-id}</summary>
    public class RelationItemRequestBuilder {
        ...
        public RelationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/groups/{group_id}/sets/{set_id}/terms/{term_id}/relations/{relation_id}{?select,expand}";
