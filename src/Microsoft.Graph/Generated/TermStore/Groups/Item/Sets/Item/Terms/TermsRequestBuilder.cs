...
using Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item.Terms.Count;
using Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item.Terms.Item;
...
using System;
namespace Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item.Terms {
    /// <summary>
    ...
    public class TermsRequestBuilder : BaseRequestBuilder {
        ...
        public TermsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TermsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TermsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
