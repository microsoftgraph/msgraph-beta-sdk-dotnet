...
using MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Terms.Item;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Terms {
    /// <summary>Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\terms</summary>
    public class TermsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.termStore.groups.item.sets.item.terms.item collection</summary>
