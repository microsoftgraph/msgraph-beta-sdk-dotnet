...
using Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item.Children;
using Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item.ParentGroup;
using Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item.Relations;
using Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item.Terms;
...
namespace Microsoft.Graph.Beta.TermStore.Groups.Item.Sets.Item {
    ...
    public class SetItemRequestBuilder {
        ...
        public SetItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}{?%24select,%24expand}";
