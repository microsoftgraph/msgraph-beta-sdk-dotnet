...
using MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Children.Item.Set.Ref;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Groups.Item.Sets.Item.Children.Item.Set {
    /// <summary>Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\children\{term-id}\set</summary>
    public class SetRequestBuilder {
        ...
        public SetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/groups/{group_id}/sets/{set_id}/children/{term_id}/set{?select,expand}";
