...
using MicrosoftGraphSdk.TermStore.Sets.Item;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Sets {
    /// <summary>Builds and executes requests for operations under \termStore\sets</summary>
    public class SetsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.termStore.sets.item collection</summary>
        ...
        public SetsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/sets{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
