...
using MicrosoftGraphSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Relations.Count;
using MicrosoftGraphSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Relations.Item;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.termStore.sets.item.parentGroup.sets.item.relations.item collection</summary>
