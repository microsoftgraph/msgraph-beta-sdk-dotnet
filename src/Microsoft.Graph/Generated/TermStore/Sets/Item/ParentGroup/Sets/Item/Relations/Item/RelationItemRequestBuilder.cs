...
using MicrosoftGraphSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Relations.Item.FromTerm;
using MicrosoftGraphSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Relations.Item.Set;
using MicrosoftGraphSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Relations.Item.ToTerm;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Relations.Item {
    ...
    public class RelationItemRequestBuilder {
        ...
        public RelationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/sets/{set_id}/parentGroup/sets/{set_id1}/relations/{relation_id}{?select,expand}";
