...
using MicrosoftGraphSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children;
using MicrosoftGraphSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Relations;
using MicrosoftGraphSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Set;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item {
    ...
    public class TermItemRequestBuilder {
        ...
        public MicrosoftGraphSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.ChildrenRequestBuilder Children { get =>
            new MicrosoftGraphSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.ChildrenRequestBuilder(PathParameters, RequestAdapter);
        }
