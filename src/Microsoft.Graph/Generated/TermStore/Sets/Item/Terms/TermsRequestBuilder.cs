...
using MicrosoftGraphSdk.TermStore.Sets.Item.Terms.Item;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Sets.Item.Terms {
    /// <summary>Builds and executes requests for operations under \termStore\sets\{set-id}\terms</summary>
    public class TermsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.termStore.sets.item.terms.item collection</summary>
