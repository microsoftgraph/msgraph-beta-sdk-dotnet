...
using System;
namespace Microsoft.Graph.Beta.TermStore.Sets.Item.Terms.Item.Relations.Item.FromTerm {
    /// <summary>
    ...
    public class FromTermRequestBuilder : BaseRequestBuilder {
        ...
        public FromTermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}/relations/{relation%2Did}/fromTerm{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new FromTermRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FromTermRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}/relations/{relation%2Did}/fromTerm{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
