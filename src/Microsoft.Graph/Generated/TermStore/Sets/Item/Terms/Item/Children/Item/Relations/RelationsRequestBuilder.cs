...
using MicrosoftGraphSdk.TermStore.Sets.Item.Terms.Item.Children.Item.Relations.Count;
using MicrosoftGraphSdk.TermStore.Sets.Item.Terms.Item.Children.Item.Relations.Item;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Sets.Item.Terms.Item.Children.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.termStore.sets.item.terms.item.children.item.relations.item collection</summary>
