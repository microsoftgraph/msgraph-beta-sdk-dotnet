...
using MicrosoftGraphSdk.TermStore.Sets.Item.Terms.Item.Relations.Item.FromTerm;
using MicrosoftGraphSdk.TermStore.Sets.Item.Terms.Item.Relations.Item.Set;
using MicrosoftGraphSdk.TermStore.Sets.Item.Terms.Item.Relations.Item.ToTerm;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Sets.Item.Terms.Item.Relations.Item {
    /// <summary>Builds and executes requests for operations under \termStore\sets\{set-id}\terms\{term-id}\relations\{relation-id}</summary>
    public class RelationItemRequestBuilder {
        ...
        public RelationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/sets/{set_id}/terms/{term_id}/relations/{relation_id}{?select,expand}";
