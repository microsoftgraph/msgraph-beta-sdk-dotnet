...
using Microsoft.Graph.Beta.TermStore.Sets.Item.Terms.Item.Relations.Item.FromTerm;
using Microsoft.Graph.Beta.TermStore.Sets.Item.Terms.Item.Relations.Item.Set;
using Microsoft.Graph.Beta.TermStore.Sets.Item.Terms.Item.Relations.Item.ToTerm;
...
using System;
namespace Microsoft.Graph.Beta.TermStore.Sets.Item.Terms.Item.Relations.Item {
    /// <summary>
    ...
    public class RelationItemRequestBuilder : BaseRequestBuilder {
        ...
        public RelationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}/relations/{relation%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RelationItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RelationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}/relations/{relation%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
