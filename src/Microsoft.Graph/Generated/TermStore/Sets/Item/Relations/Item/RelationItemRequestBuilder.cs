...
using MicrosoftGraphSdk.TermStore.Sets.Item.Relations.Item.FromTerm;
using MicrosoftGraphSdk.TermStore.Sets.Item.Relations.Item.Set;
using MicrosoftGraphSdk.TermStore.Sets.Item.Relations.Item.ToTerm;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Sets.Item.Relations.Item {
    /// <summary>Builds and executes requests for operations under \termStore\sets\{set-id}\relations\{relation-id}</summary>
    public class RelationItemRequestBuilder {
        ...
        public RelationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/sets/{set_id}/relations/{relation_id}{?select,expand}";
