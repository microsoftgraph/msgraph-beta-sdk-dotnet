...
using Microsoft.Graph.Beta.TermStore.Sets.Item.Children;
using Microsoft.Graph.Beta.TermStore.Sets.Item.ParentGroup;
using Microsoft.Graph.Beta.TermStore.Sets.Item.Relations;
using Microsoft.Graph.Beta.TermStore.Sets.Item.Terms;
...
namespace Microsoft.Graph.Beta.TermStore.Sets.Item {
    ...
    public class SetItemRequestBuilder {
        ...
        public SetItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/sets/{set%2Did}{?%24select,%24expand}";
