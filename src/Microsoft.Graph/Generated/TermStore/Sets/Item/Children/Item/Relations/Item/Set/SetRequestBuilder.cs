...
using MicrosoftGraphSdk.TermStore.Sets.Item.Children.Item.Relations.Item.Set.Ref;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Sets.Item.Children.Item.Relations.Item.Set {
    /// <summary>Builds and executes requests for operations under \termStore\sets\{set-id}\children\{term-id}\relations\{relation-id}\set</summary>
    public class SetRequestBuilder {
        ...
        public SetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/sets/{set_id}/children/{term_id}/relations/{relation_id}/set{?select,expand}";
