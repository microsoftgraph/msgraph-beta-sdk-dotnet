...
using MicrosoftGraphSdk.TermStore.Sets.Item.Children.Item.Relations.Item.FromTerm.Ref;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Sets.Item.Children.Item.Relations.Item.FromTerm {
    /// <summary>Builds and executes requests for operations under \termStore\sets\{set-id}\children\{term-id}\relations\{relation-id}\fromTerm</summary>
    public class FromTermRequestBuilder {
        ...
        public FromTermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/sets/{set_id}/children/{term_id}/relations/{relation_id}/fromTerm{?select,expand}";
