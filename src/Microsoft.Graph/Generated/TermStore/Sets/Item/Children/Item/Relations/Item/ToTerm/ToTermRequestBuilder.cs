...
using MicrosoftGraphSdk.TermStore.Sets.Item.Children.Item.Relations.Item.ToTerm.Ref;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Sets.Item.Children.Item.Relations.Item.ToTerm {
    /// <summary>Builds and executes requests for operations under \termStore\sets\{set-id}\children\{term-id}\relations\{relation-id}\toTerm</summary>
    public class ToTermRequestBuilder {
        ...
        public ToTermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/sets/{set_id}/children/{term_id}/relations/{relation_id}/toTerm{?select,expand}";
