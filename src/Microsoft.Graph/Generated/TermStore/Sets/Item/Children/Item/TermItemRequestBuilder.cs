...
using Microsoft.Graph.Beta.TermStore.Sets.Item.Children.Item.Children;
using Microsoft.Graph.Beta.TermStore.Sets.Item.Children.Item.Relations;
using Microsoft.Graph.Beta.TermStore.Sets.Item.Children.Item.Set;
...
namespace Microsoft.Graph.Beta.TermStore.Sets.Item.Children.Item {
    /// <summary>
    ...
    public class TermItemRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Beta.TermStore.Sets.Item.Children.Item.Children.ChildrenRequestBuilder Children { get =>
            new Microsoft.Graph.Beta.TermStore.Sets.Item.Children.Item.Children.ChildrenRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public TermItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/children/{term%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TermItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TermItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/children/{term%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
