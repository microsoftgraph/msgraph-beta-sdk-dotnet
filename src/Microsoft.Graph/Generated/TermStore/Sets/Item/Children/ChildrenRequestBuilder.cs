...
using MicrosoftGraphSdk.TermStore.Sets.Item.Children.Item;
using System;
...
namespace MicrosoftGraphSdk.TermStore.Sets.Item.Children {
    /// <summary>Builds and executes requests for operations under \termStore\sets\{set-id}\children</summary>
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.termStore.sets.item.children.item collection</summary>
        ...
        public ChildrenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/termStore/sets/{set_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
