...
using Microsoft.Graph.Beta.TermStore.Sets.Item.Children.Count;
using Microsoft.Graph.Beta.TermStore.Sets.Item.Children.Item;
...
using System;
namespace Microsoft.Graph.Beta.TermStore.Sets.Item.Children {
    /// <summary>
    ...
    public class ChildrenRequestBuilder : BaseRequestBuilder {
        ...
        public ChildrenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ChildrenRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChildrenRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
