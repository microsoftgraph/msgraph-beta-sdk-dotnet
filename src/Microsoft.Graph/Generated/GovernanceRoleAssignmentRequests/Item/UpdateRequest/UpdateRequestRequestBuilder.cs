...
namespace Microsoft.Graph.Beta.GovernanceRoleAssignmentRequests.Item.UpdateRequest {
    ...
    public class UpdateRequestRequestBuilder : BaseRequestBuilder {
        ...
        public UpdateRequestRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/governanceRoleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}/updateRequest", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UpdateRequestRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UpdateRequestRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/governanceRoleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}/updateRequest", rawUrl) {
        }
        /// <summary>
