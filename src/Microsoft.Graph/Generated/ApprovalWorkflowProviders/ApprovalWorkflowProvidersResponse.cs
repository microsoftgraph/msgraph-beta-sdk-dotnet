...
namespace MicrosoftGraphSdk.ApprovalWorkflowProviders {
    public class ApprovalWorkflowProvidersResponse : IParsable {
        ...
        /// </summary>
        public static ApprovalWorkflowProvidersResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApprovalWorkflowProvidersResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ApprovalWorkflowProvidersResponse).Value = n.GetCollectionOfObjectValues<ApprovalWorkflowProvider>(ApprovalWorkflowProvider.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
