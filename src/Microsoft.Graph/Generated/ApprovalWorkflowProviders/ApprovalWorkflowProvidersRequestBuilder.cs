...
using MicrosoftGraph.ApprovalWorkflowProviders.Item;
...
namespace MicrosoftGraph.ApprovalWorkflowProviders {
    /// <summary>Builds and executes requests for operations under \approvalWorkflowProviders</summary>
    public class ApprovalWorkflowProvidersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.approvalWorkflowProviders.item collection</summary>
        public ApprovalWorkflowProviderRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("approvalWorkflowProvider_id", position);
            return new ApprovalWorkflowProviderRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
