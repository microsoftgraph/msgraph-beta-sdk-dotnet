...
namespace Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlows.Item.RecordDecisions {
    ...
    public class RecordDecisionsRequestBuilder : BaseRequestBuilder {
        ...
        public RecordDecisionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/approvalWorkflowProviders/{approvalWorkflowProvider%2Did}/businessFlows/{businessFlow%2Did}/recordDecisions", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RecordDecisionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecordDecisionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/approvalWorkflowProviders/{approvalWorkflowProvider%2Did}/businessFlows/{businessFlow%2Did}/recordDecisions", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(RecordDecisionsPostRequestBody body, CancellationToken cancellationToken = default, Action<RecordDecisionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(RecordDecisionsPostRequestBody body, CancellationToken cancellationToken = default, Action<RecordDecisionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
