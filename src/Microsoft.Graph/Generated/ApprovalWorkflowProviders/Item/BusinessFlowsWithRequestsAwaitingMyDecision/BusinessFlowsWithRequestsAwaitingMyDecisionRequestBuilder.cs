...
namespace Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision {
    ...
    public class BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilder {
        ...
        /// </summary>
        public async Task<BusinessFlowCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<BusinessFlow> PostAsync(BusinessFlow body, CancellationToken cancellationToken = default, Action<BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
