...
namespace Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision
{
    ...
    public class BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.Count.CountRequestBuilder Count
        {
            get => new Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        /// <returns>A <see cref="Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.Item.BusinessFlowItemRequestBuilder"/></returns>
        public Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.Item.BusinessFlowItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("businessFlow%2Did", position);
                return new Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.Item.BusinessFlowItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.BusinessFlowCollectionResponse?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilder.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.BusinessFlowCollectionResponse> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilder.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilder.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilder.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get businessFlowsWithRequestsAwaitingMyDecision from approvalWorkflowProviders
        /// </summary>
...
#nullable restore
        ...
        public class BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Beta.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilder.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
