...
using MicrosoftGraph.ApprovalWorkflowProviders.Item.BusinessFlows;
using MicrosoftGraph.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision;
using MicrosoftGraph.ApprovalWorkflowProviders.Item.PolicyTemplates;
...
namespace MicrosoftGraph.ApprovalWorkflowProviders.Item {
    ...
    public class ApprovalWorkflowProviderRequestBuilder {
        ...
        /// <summary>
        /// Instantiates a new ApprovalWorkflowProviderRequestBuilder and sets the default values.
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ApprovalWorkflowProviderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/approvalWorkflowProviders/{approvalWorkflowProvider_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ApprovalWorkflowProviderRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApprovalWorkflowProvider body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
