...
namespace Microsoft.Graph.Beta.Admin.ServiceAnnouncement.HealthOverviews.Item.Issues.Item.IncidentReport {
    ...
    public class IncidentReportRequestBuilder {
        ...
        /// </summary>
        public async Task<IncidentReportResponse> GetAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
