...
namespace MicrosoftGraphSdk.Admin.ServiceAnnouncement.HealthOverviews {
    ...
    public class HealthOverviewsRequestBuilder {
        ...
        /// </summary>
        public async Task<ServiceHealthCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
