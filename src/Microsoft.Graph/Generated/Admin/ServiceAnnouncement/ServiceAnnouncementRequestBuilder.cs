...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ServiceAnnouncement?> GetAsync(CancellationToken cancellationToken = default, Action<ServiceAnnouncementRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ServiceAnnouncement> GetAsync(CancellationToken cancellationToken = default, Action<ServiceAnnouncementRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ServiceAnnouncement?> PatchAsync(Microsoft.Graph.Beta.Models.ServiceAnnouncement body, CancellationToken cancellationToken = default, Action<ServiceAnnouncementRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ServiceAnnouncement> PatchAsync(Microsoft.Graph.Beta.Models.ServiceAnnouncement body, CancellationToken cancellationToken = default, Action<ServiceAnnouncementRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
