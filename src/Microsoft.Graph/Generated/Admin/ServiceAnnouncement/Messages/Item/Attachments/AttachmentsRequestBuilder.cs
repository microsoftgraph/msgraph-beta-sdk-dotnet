...
namespace MicrosoftGraphSdk.Admin.ServiceAnnouncement.Messages.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// </summary>
        public async Task<ServiceAnnouncementAttachmentCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
