...
namespace MicrosoftGraphSdk.Admin.ServiceAnnouncement.Issues {
    ...
    public class IssuesRequestBuilder {
        ...
        /// </summary>
        public async Task<ServiceHealthIssueCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
