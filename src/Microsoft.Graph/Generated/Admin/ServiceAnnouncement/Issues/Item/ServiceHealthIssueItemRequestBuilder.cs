...
namespace Microsoft.Graph.Beta.Admin.ServiceAnnouncement.Issues.Item {
    ...
    public class ServiceHealthIssueItemRequestBuilder : BaseRequestBuilder {
        ...
        public ServiceHealthIssueItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/serviceAnnouncement/issues/{serviceHealthIssue%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ServiceHealthIssueItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ServiceHealthIssueItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/serviceAnnouncement/issues/{serviceHealthIssue%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ServiceHealthIssueItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ServiceHealthIssueItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ServiceHealthIssue?> GetAsync(CancellationToken cancellationToken = default, Action<ServiceHealthIssueItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServiceHealthIssue> GetAsync(CancellationToken cancellationToken = default, Action<ServiceHealthIssueItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ServiceHealthIssue?> PatchAsync(ServiceHealthIssue body, CancellationToken cancellationToken = default, Action<ServiceHealthIssueItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServiceHealthIssue> PatchAsync(ServiceHealthIssue body, CancellationToken cancellationToken = default, Action<ServiceHealthIssueItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
