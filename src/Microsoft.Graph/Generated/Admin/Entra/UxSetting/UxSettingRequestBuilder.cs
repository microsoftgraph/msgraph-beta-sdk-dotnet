...
namespace Microsoft.Graph.Beta.Admin.Entra.UxSetting
{
    ...
    public partial class UxSettingRequestBuilder : BaseRequestBuilder
    {
        ...
        public UxSettingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/entra/uxSetting{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Admin.Entra.UxSetting.UxSettingRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UxSettingRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/entra/uxSetting{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
