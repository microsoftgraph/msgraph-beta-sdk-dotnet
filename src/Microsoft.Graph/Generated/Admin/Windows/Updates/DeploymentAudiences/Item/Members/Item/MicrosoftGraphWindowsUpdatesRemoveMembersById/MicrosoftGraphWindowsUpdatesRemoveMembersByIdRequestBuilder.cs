...
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.DeploymentAudiences.Item.Members.Item.MicrosoftGraphWindowsUpdatesRemoveMembersById {
    ...
    public class MicrosoftGraphWindowsUpdatesRemoveMembersByIdRequestBuilder {
        ...
        public MicrosoftGraphWindowsUpdatesRemoveMembersByIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/members/{updatableAsset%2Did}/microsoft.graph.windowsUpdates.removeMembersById";
