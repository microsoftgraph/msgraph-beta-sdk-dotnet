...
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.DeploymentAudiences.Item.Members.Item.WindowsUpdatesAddMembersById {
    ...
    public class WindowsUpdatesAddMembersByIdRequestBuilder : BaseRequestBuilder {
        ...
        public WindowsUpdatesAddMembersByIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/members/{updatableAsset%2Did}/windowsUpdates.addMembersById", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WindowsUpdatesAddMembersByIdRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WindowsUpdatesAddMembersByIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/members/{updatableAsset%2Did}/windowsUpdates.addMembersById", rawUrl) {
        }
        /// <summary>
