...
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.DeploymentAudiences.Item {
    ...
    public class DeploymentAudienceItemRequestBuilder {
        ...
        public DeploymentAudienceItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeploymentAudienceItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
