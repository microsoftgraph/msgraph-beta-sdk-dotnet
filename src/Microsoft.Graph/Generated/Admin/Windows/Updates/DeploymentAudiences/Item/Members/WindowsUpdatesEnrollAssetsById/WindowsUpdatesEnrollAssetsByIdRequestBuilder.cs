...
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.DeploymentAudiences.Item.Members.WindowsUpdatesEnrollAssetsById {
    ...
    public class WindowsUpdatesEnrollAssetsByIdRequestBuilder : BaseRequestBuilder {
        ...
        public WindowsUpdatesEnrollAssetsByIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/members/windowsUpdates.enrollAssetsById", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WindowsUpdatesEnrollAssetsByIdRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WindowsUpdatesEnrollAssetsByIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/members/windowsUpdates.enrollAssetsById", rawUrl) {
        }
        /// <summary>
