using Microsoft.Graph.Beta.Admin.Windows.Updates.Deployments.Item.Audience.Members.Item.WindowsUpdatesAddMembers;
using Microsoft.Graph.Beta.Admin.Windows.Updates.Deployments.Item.Audience.Members.Item.WindowsUpdatesAddMembersById;
using Microsoft.Graph.Beta.Admin.Windows.Updates.Deployments.Item.Audience.Members.Item.WindowsUpdatesRemoveMembers;
using Microsoft.Graph.Beta.Admin.Windows.Updates.Deployments.Item.Audience.Members.Item.WindowsUpdatesRemoveMembersById;
...
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.Deployments.Item.Audience.Members.Item {
    ...
    public class UpdatableAssetItemRequestBuilder : BaseRequestBuilder {
        ...
        public UpdatableAssetItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members/{updatableAsset%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UpdatableAssetItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UpdatableAssetItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members/{updatableAsset%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
