...
using MicrosoftGraph.Admin.Windows.Updates.Deployments.Item.Audience.Exclusions.Item.AddMembers;
using MicrosoftGraph.Admin.Windows.Updates.Deployments.Item.Audience.Exclusions.Item.AddMembersById;
using MicrosoftGraph.Admin.Windows.Updates.Deployments.Item.Audience.Exclusions.Item.RemoveMembers;
using MicrosoftGraph.Admin.Windows.Updates.Deployments.Item.Audience.Exclusions.Item.RemoveMembersById;
...
namespace MicrosoftGraph.Admin.Windows.Updates.Deployments.Item.Audience.Exclusions.Item {
    ...
    public class UpdatableAssetRequestBuilder {
        ...
        /// </summary>
        public UpdatableAssetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/admin/windows/updates/deployments/{deployment_id}/audience/exclusions/{updatableAsset_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public UpdatableAssetRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(UpdatableAsset body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
