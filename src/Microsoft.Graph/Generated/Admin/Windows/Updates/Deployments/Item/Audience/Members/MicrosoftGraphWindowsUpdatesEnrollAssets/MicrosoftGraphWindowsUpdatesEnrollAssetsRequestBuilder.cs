...
#nullable enable
        public async Task PostAsync(EnrollAssetsPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphWindowsUpdatesEnrollAssetsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(EnrollAssetsPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphWindowsUpdatesEnrollAssetsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
