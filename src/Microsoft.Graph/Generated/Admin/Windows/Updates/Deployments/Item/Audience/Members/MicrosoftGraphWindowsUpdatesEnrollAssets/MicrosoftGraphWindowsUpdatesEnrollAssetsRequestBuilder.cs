...
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.Deployments.Item.Audience.Members.MicrosoftGraphWindowsUpdatesEnrollAssets {
    ...
    /// </summary>
    public class MicrosoftGraphWindowsUpdatesEnrollAssetsRequestBuilder {
        ...
        public MicrosoftGraphWindowsUpdatesEnrollAssetsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphWindowsUpdatesEnrollAssetsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
