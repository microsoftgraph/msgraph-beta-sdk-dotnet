...
using System;
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.Deployments.Item.Audience.Members.WindowsUpdatesEnrollAssetsById {
    /// <summary>
    ...
    public class WindowsUpdatesEnrollAssetsByIdRequestBuilder : BaseRequestBuilder {
        ...
        public WindowsUpdatesEnrollAssetsByIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members/windowsUpdates.enrollAssetsById", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WindowsUpdatesEnrollAssetsByIdRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WindowsUpdatesEnrollAssetsByIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members/windowsUpdates.enrollAssetsById", rawUrl) {
        }
        /// <summary>
