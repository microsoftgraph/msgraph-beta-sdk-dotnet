...
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.Deployments.Item.Audience.MicrosoftGraphWindowsUpdatesUpdateAudience {
    ...
    /// </summary>
    public class MicrosoftGraphWindowsUpdatesUpdateAudienceRequestBuilder {
        ...
        public MicrosoftGraphWindowsUpdatesUpdateAudienceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphWindowsUpdatesUpdateAudienceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
