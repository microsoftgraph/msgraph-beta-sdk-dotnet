...
namespace MicrosoftGraphSdk.Admin.Windows.Updates.Deployments.Item.Audience {
    ...
    public class AudienceRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(DeploymentAudience body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
