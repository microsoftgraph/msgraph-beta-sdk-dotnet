...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AudienceRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AudienceRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeploymentAudience?> GetAsync(CancellationToken cancellationToken = default, Action<AudienceRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeploymentAudience> GetAsync(CancellationToken cancellationToken = default, Action<AudienceRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeploymentAudience?> PatchAsync(DeploymentAudience body, CancellationToken cancellationToken = default, Action<AudienceRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeploymentAudience> PatchAsync(DeploymentAudience body, CancellationToken cancellationToken = default, Action<AudienceRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
