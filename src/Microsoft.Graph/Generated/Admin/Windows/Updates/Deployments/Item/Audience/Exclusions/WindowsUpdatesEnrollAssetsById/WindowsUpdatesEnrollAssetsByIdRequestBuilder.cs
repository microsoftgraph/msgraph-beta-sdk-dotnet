...
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.Deployments.Item.Audience.Exclusions.WindowsUpdatesEnrollAssetsById {
    ...
    /// </summary>
    public class WindowsUpdatesEnrollAssetsByIdRequestBuilder {
        ...
        public WindowsUpdatesEnrollAssetsByIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/exclusions/windowsUpdates.enrollAssetsById";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WindowsUpdatesEnrollAssetsByIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
