...
#nullable enable
        public async Task<DeploymentCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DeploymentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeploymentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DeploymentsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Deployment?> PostAsync(Deployment body, CancellationToken cancellationToken = default, Action<DeploymentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Deployment> PostAsync(Deployment body, CancellationToken cancellationToken = default, Action<DeploymentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
