...
using MicrosoftGraph.Admin.Windows.Updates.UpdatableAssets.Item.AddMembers;
using MicrosoftGraph.Admin.Windows.Updates.UpdatableAssets.Item.AddMembersById;
using MicrosoftGraph.Admin.Windows.Updates.UpdatableAssets.Item.RemoveMembers;
using MicrosoftGraph.Admin.Windows.Updates.UpdatableAssets.Item.RemoveMembersById;
...
namespace MicrosoftGraph.Admin.Windows.Updates.UpdatableAssets.Item {
    /// <summary>Builds and executes requests for operations under \admin\windows\updates\updatableAssets\{updatableAsset-id}</summary>
    public class UpdatableAssetRequestBuilder {
        ...
        public UpdatableAssetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/admin/windows/updates/updatableAssets/{updatableAsset_id}{?select,expand}";
