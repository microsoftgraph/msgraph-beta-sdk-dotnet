...
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.Catalog {
    ...
    public class CatalogRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Beta.Models.WindowsUpdates.Catalog> PatchAsync(Microsoft.Graph.Beta.Models.WindowsUpdates.Catalog body, Action<CatalogRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
