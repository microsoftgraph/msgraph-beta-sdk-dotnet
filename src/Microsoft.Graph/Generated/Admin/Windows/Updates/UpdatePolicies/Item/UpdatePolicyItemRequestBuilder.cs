...
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.UpdatePolicies.Item {
    ...
    /// </summary>
    public class UpdatePolicyItemRequestBuilder {
        ...
        public UpdatePolicyItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UpdatePolicyItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
