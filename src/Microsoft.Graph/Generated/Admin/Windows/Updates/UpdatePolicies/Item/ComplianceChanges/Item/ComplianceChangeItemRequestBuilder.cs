...
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.UpdatePolicies.Item.ComplianceChanges.Item {
    ...
    public class ComplianceChangeItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        public UpdatePolicyRequestBuilder UpdatePolicy
        {
            get => new UpdatePolicyRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        ...
        public ComplianceChangeItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/complianceChanges/{complianceChange%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ComplianceChangeItemRequestBuilder"/> and sets the default values.
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ComplianceChange?> GetAsync(Action<RequestConfiguration<ComplianceChangeItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ComplianceChange> GetAsync(Action<RequestConfiguration<ComplianceChangeItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ComplianceChange?> PatchAsync(ComplianceChange body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ComplianceChange> PatchAsync(ComplianceChange body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ComplianceChangeItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class ComplianceChangeItemRequestBuilderGetRequestConfiguration : RequestConfiguration<ComplianceChangeItemRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
