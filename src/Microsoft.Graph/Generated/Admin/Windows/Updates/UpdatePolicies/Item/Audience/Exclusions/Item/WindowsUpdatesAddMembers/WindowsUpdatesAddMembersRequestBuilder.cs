...
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.UpdatePolicies.Item.Audience.Exclusions.Item.WindowsUpdatesAddMembers {
    /// <summary>
    ...
    public class WindowsUpdatesAddMembersRequestBuilder : BaseRequestBuilder {
        ...
        public WindowsUpdatesAddMembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/exclusions/{updatableAsset%2Did}/windowsUpdates.addMembers", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WindowsUpdatesAddMembersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WindowsUpdatesAddMembersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/exclusions/{updatableAsset%2Did}/windowsUpdates.addMembers", rawUrl) {
        }
        /// <summary>
