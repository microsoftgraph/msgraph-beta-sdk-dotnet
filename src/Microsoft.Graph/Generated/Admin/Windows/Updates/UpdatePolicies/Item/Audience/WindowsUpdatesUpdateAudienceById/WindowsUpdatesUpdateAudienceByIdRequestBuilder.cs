...
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.UpdatePolicies.Item.Audience.WindowsUpdatesUpdateAudienceById {
    ...
    /// </summary>
    public class WindowsUpdatesUpdateAudienceByIdRequestBuilder {
        ...
        public WindowsUpdatesUpdateAudienceByIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/windowsUpdates.updateAudienceById";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WindowsUpdatesUpdateAudienceByIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
