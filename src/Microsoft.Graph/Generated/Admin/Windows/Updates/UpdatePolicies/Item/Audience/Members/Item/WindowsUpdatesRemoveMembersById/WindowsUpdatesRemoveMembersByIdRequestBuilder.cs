...
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.UpdatePolicies.Item.Audience.Members.Item.WindowsUpdatesRemoveMembersById {
    ...
    public class WindowsUpdatesRemoveMembersByIdRequestBuilder : BaseRequestBuilder {
        ...
        public WindowsUpdatesRemoveMembersByIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/members/{updatableAsset%2Did}/windowsUpdates.removeMembersById", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WindowsUpdatesRemoveMembersByIdRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WindowsUpdatesRemoveMembersByIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/members/{updatableAsset%2Did}/windowsUpdates.removeMembersById", rawUrl) {
        }
        /// <summary>
