...
using System;
namespace Microsoft.Graph.Beta.Admin.Windows.Updates.UpdatePolicies.Item.Audience.Exclusions.Item.MicrosoftGraphWindowsUpdatesRemoveMembersById {
    /// <summary>
    ...
    public class MicrosoftGraphWindowsUpdatesRemoveMembersByIdRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphWindowsUpdatesRemoveMembersByIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/exclusions/{updatableAsset%2Did}/microsoft.graph.windowsUpdates.removeMembersById", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(RemoveMembersByIdPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphWindowsUpdatesRemoveMembersByIdRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(RemoveMembersByIdPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphWindowsUpdatesRemoveMembersByIdRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
