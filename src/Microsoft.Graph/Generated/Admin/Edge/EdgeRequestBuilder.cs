...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Edge?> GetAsync(CancellationToken cancellationToken = default, Action<EdgeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Edge> GetAsync(CancellationToken cancellationToken = default, Action<EdgeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Edge?> PatchAsync(Microsoft.Graph.Beta.Models.Edge body, CancellationToken cancellationToken = default, Action<EdgeRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Edge> PatchAsync(Microsoft.Graph.Beta.Models.Edge body, CancellationToken cancellationToken = default, Action<EdgeRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
