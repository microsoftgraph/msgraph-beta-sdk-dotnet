...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<BrowserSiteListItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<BrowserSiteListItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BrowserSiteList?> GetAsync(CancellationToken cancellationToken = default, Action<BrowserSiteListItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BrowserSiteList> GetAsync(CancellationToken cancellationToken = default, Action<BrowserSiteListItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BrowserSiteList?> PatchAsync(BrowserSiteList body, CancellationToken cancellationToken = default, Action<BrowserSiteListItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BrowserSiteList> PatchAsync(BrowserSiteList body, CancellationToken cancellationToken = default, Action<BrowserSiteListItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
