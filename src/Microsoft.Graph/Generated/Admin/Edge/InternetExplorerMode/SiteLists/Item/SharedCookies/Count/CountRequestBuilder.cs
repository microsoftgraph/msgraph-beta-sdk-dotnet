...
namespace Microsoft.Graph.Beta.Admin.Edge.InternetExplorerMode.SiteLists.Item.SharedCookies.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}/sharedCookies/$count{?%24search,%24filter}";
