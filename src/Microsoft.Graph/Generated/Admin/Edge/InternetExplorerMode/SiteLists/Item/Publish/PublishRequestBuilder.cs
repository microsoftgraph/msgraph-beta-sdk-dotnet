...
namespace Microsoft.Graph.Beta.Admin.Edge.InternetExplorerMode.SiteLists.Item.Publish {
    ...
    public class PublishRequestBuilder {
        ...
        public RequestInformation CreatePostRequestInformation(PublishPostRequestBody body, Action<PublishRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
