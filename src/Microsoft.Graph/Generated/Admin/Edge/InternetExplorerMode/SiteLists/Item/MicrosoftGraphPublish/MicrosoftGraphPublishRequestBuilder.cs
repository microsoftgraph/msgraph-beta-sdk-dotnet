...
namespace Microsoft.Graph.Beta.Admin.Edge.InternetExplorerMode.SiteLists.Item.MicrosoftGraphPublish {
    ...
    public class MicrosoftGraphPublishRequestBuilder {
        ...
        public MicrosoftGraphPublishRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}/microsoft.graph.publish";
...
#nullable enable
        public async Task<BrowserSiteList?> PostAsync(PublishPostRequestBody body, Action<MicrosoftGraphPublishRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<BrowserSiteList> PostAsync(PublishPostRequestBody body, Action<MicrosoftGraphPublishRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(PublishPostRequestBody body, Action<MicrosoftGraphPublishRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(PublishPostRequestBody body, Action<MicrosoftGraphPublishRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
