using Microsoft.Graph.Beta.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites.Count;
using Microsoft.Graph.Beta.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites.Item;
...
namespace Microsoft.Graph.Beta.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites {
    ...
    public class SitesRequestBuilder {
        ...
        public SitesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}/sites{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation CreatePostRequestInformation(BrowserSite body, Action<SitesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// <summary>Get a list of the browserSite objects and their properties.</summary>
