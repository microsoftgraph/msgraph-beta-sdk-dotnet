...
namespace Microsoft.Graph.Beta.Admin.Edge.InternetExplorerMode.SiteLists.Item.SharedCookies.Item {
    ...
    public class BrowserSharedCookieItemRequestBuilder {
        ...
        public BrowserSharedCookieItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}/sharedCookies/{browserSharedCookie%2Did}{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BrowserSharedCookieItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreateDeleteRequestInformation(Action<BrowserSharedCookieItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation CreateGetRequestInformation(Action<BrowserSharedCookieItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            var requestInfo = new RequestInformation {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation CreatePatchRequestInformation(BrowserSharedCookie body, Action<BrowserSharedCookieItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
