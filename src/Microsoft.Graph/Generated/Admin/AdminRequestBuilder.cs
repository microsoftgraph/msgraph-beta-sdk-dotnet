...
namespace Microsoft.Graph.Beta.Admin
{
    ...
    public partial class AdminRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>Provides operations to manage the cloudLicensing property of the microsoft.graph.admin entity.</summary>
        ...
        public AdminRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Beta.Admin.AdminRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AdminRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "", rawUrl)
        {
        }
        /// <summary>
        /// Get admin
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/admin{?%24expand,%24select}", PathParameters);
