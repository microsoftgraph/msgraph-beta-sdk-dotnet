...
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Admin?> GetAsync(CancellationToken cancellationToken = default, Action<AdminRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Admin> GetAsync(CancellationToken cancellationToken = default, Action<AdminRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.Admin?> PatchAsync(Microsoft.Graph.Beta.Models.Admin body, CancellationToken cancellationToken = default, Action<AdminRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.Admin> PatchAsync(Microsoft.Graph.Beta.Models.Admin body, CancellationToken cancellationToken = default, Action<AdminRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
