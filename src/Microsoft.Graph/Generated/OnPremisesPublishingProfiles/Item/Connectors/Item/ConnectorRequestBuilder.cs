...
using MicrosoftGraph.OnPremisesPublishingProfiles.Item.Connectors.Item.MemberOf;
using System;
...
namespace MicrosoftGraph.OnPremisesPublishingProfiles.Item.Connectors.Item {
    ...
    public class ConnectorRequestBuilder {
        ...
        public ConnectorRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile_id}/connectors/{connector_id}{?select,expand}";
