    ...
    public class ApplicationsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ApplicationsResponse).Value = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.Application>(MicrosoftGraphSdk.Models.Microsoft.Graph.Application.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
