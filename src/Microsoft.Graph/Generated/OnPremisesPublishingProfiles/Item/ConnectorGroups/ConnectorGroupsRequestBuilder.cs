...
#nullable enable
        public async Task<ConnectorGroupCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ConnectorGroupsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ConnectorGroupCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ConnectorGroupsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Beta.Models.ConnectorGroup?> PostAsync(Microsoft.Graph.Beta.Models.ConnectorGroup body, CancellationToken cancellationToken = default, Action<ConnectorGroupsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Beta.Models.ConnectorGroup> PostAsync(Microsoft.Graph.Beta.Models.ConnectorGroup body, CancellationToken cancellationToken = default, Action<ConnectorGroupsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
