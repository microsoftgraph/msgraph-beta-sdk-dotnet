...
namespace MicrosoftGraphSdk.OnPremisesPublishingProfiles.Item.ConnectorGroups.Item.Members.Item.MemberOf.Item {
    ...
    public class ConnectorGroupItemRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.ConnectorGroup body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
