...
using MicrosoftGraph.OnPremisesPublishingProfiles.Item.ConnectorGroups.Item.Members.Item;
using System;
...
namespace MicrosoftGraph.OnPremisesPublishingProfiles.Item.ConnectorGroups.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.onPremisesPublishingProfiles.item.connectorGroups.item.members.item collection</summary>
