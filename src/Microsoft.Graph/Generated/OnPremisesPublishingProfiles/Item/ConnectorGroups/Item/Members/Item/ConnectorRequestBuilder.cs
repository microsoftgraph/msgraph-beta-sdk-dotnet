...
using MicrosoftGraph.OnPremisesPublishingProfiles.Item.ConnectorGroups.Item.Members.Item.MemberOf;
using System;
...
namespace MicrosoftGraph.OnPremisesPublishingProfiles.Item.ConnectorGroups.Item.Members.Item {
    ...
    public class ConnectorRequestBuilder {
        ...
        /// </summary>
        public ConnectorRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ConnectorRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(Connector body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
