...
#nullable enable
        public async Task<ApplicationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ApplicationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ApplicationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ApplicationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
