...
using MicrosoftGraph.OnPremisesPublishingProfiles.Item.Agents.Item.AgentGroups.Item.Agents;
using MicrosoftGraph.OnPremisesPublishingProfiles.Item.Agents.Item.AgentGroups.Item.PublishedResources;
using System;
...
namespace MicrosoftGraph.OnPremisesPublishingProfiles.Item.Agents.Item.AgentGroups.Item {
    /// <summary>Builds and executes requests for operations under \onPremisesPublishingProfiles\{onPremisesPublishingProfile-id}\agents\{onPremisesAgent-id}\agentGroups\{onPremisesAgentGroup-id}</summary>
    public class OnPremisesAgentGroupRequestBuilder {
        ...
        public OnPremisesAgentGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile_id}/agents/{onPremisesAgent_id}/agentGroups/{onPremisesAgentGroup_id}{?select,expand}";
