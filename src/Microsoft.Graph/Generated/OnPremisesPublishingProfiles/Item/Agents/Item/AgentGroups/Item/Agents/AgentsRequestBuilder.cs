...
namespace MicrosoftGraphSdk.OnPremisesPublishingProfiles.Item.Agents.Item.AgentGroups.Item.Agents {
    /// <summary>Builds and executes requests for operations under \onPremisesPublishingProfiles\{onPremisesPublishingProfile-id}\agents\{onPremisesAgent-id}\agentGroups\{onPremisesAgentGroup-id}\agents</summary>
