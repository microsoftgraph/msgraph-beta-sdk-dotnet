...
using MicrosoftGraph.OnPremisesPublishingProfiles.Item.Agents.Item.AgentGroups.Item.Agents.Item;
using System;
...
namespace MicrosoftGraph.OnPremisesPublishingProfiles.Item.Agents.Item.AgentGroups.Item.Agents {
    ...
    public class AgentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.onPremisesPublishingProfiles.item.agents.item.agentGroups.item.agents.item collection</summary>
