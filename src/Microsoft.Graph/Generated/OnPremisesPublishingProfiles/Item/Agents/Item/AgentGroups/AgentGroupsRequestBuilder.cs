...
using MicrosoftGraphSdk.OnPremisesPublishingProfiles.Item.Agents.Item.AgentGroups.Item;
using System;
...
namespace MicrosoftGraphSdk.OnPremisesPublishingProfiles.Item.Agents.Item.AgentGroups {
    /// <summary>Builds and executes requests for operations under \onPremisesPublishingProfiles\{onPremisesPublishingProfile-id}\agents\{onPremisesAgent-id}\agentGroups</summary>
    public class AgentGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.onPremisesPublishingProfiles.item.agents.item.agentGroups.item collection</summary>
        ...
        public AgentGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile_id}/agents/{onPremisesAgent_id}/agentGroups{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
