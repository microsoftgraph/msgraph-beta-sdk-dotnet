...
using MicrosoftGraph.OnPremisesPublishingProfiles.Item.Agents.Item.AgentGroups.Item;
using System;
...
namespace MicrosoftGraph.OnPremisesPublishingProfiles.Item.Agents.Item.AgentGroups {
    ...
    public class AgentGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.onPremisesPublishingProfiles.item.agents.item.agentGroups.item collection</summary>
