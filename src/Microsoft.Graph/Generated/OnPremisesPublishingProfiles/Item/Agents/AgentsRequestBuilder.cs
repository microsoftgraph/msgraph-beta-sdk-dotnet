...
namespace Microsoft.Graph.Beta.OnPremisesPublishingProfiles.Item.Agents {
    ...
    public class AgentsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.Beta.onPremisesPublishingProfiles.item.agents.item collection</summary>
        ...
        public AgentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
