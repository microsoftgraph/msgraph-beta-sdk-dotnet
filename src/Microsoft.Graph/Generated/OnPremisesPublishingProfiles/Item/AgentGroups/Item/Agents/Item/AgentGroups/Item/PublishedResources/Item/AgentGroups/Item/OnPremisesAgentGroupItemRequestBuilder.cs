...
namespace Microsoft.Graph.Beta.OnPremisesPublishingProfiles.Item.AgentGroups.Item.Agents.Item.AgentGroups.Item.PublishedResources.Item.AgentGroups.Item {
    ...
    public class OnPremisesAgentGroupItemRequestBuilder {
        ...
        public OnPremisesAgentGroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile_id}/agentGroups/{onPremisesAgentGroup_id}/agents/{onPremisesAgent_id}/agentGroups/{onPremisesAgentGroup_id1}/publishedResources/{publishedResource_id}/agentGroups/{onPremisesAgentGroup_id2}{?select,expand}";
