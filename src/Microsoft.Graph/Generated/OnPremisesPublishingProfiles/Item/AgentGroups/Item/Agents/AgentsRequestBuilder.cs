...
using MicrosoftGraphSdk.OnPremisesPublishingProfiles.Item.AgentGroups.Item.Agents.Item;
using System;
...
namespace MicrosoftGraphSdk.OnPremisesPublishingProfiles.Item.AgentGroups.Item.Agents {
    /// <summary>Builds and executes requests for operations under \onPremisesPublishingProfiles\{onPremisesPublishingProfile-id}\agentGroups\{onPremisesAgentGroup-id}\agents</summary>
    public class AgentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.onPremisesPublishingProfiles.item.agentGroups.item.agents.item collection</summary>
