...
namespace MicrosoftGraphSdk.OnPremisesPublishingProfiles.Item.AgentGroups.Item.Agents.Item.AgentGroups.Item.PublishedResources.Item.AgentGroups {
    ...
    public class AgentGroupsRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(OnPremisesAgentGroup body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
