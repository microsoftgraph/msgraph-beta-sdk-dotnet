...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<OnPremisesAgentGroupItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<OnPremisesAgentGroupItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OnPremisesAgentGroup?> GetAsync(CancellationToken cancellationToken = default, Action<OnPremisesAgentGroupItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OnPremisesAgentGroup> GetAsync(CancellationToken cancellationToken = default, Action<OnPremisesAgentGroupItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OnPremisesAgentGroup?> PatchAsync(OnPremisesAgentGroup body, CancellationToken cancellationToken = default, Action<OnPremisesAgentGroupItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OnPremisesAgentGroup> PatchAsync(OnPremisesAgentGroup body, CancellationToken cancellationToken = default, Action<OnPremisesAgentGroupItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
