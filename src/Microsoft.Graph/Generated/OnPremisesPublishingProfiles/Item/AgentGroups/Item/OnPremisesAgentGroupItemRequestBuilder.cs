...
using MicrosoftGraphSdk.OnPremisesPublishingProfiles.Item.AgentGroups.Item.Agents;
using MicrosoftGraphSdk.OnPremisesPublishingProfiles.Item.AgentGroups.Item.PublishedResources;
using System;
...
namespace MicrosoftGraphSdk.OnPremisesPublishingProfiles.Item.AgentGroups.Item {
    /// <summary>Builds and executes requests for operations under \onPremisesPublishingProfiles\{onPremisesPublishingProfile-id}\agentGroups\{onPremisesAgentGroup-id}</summary>
    public class OnPremisesAgentGroupItemRequestBuilder {
        ...
        public OnPremisesAgentGroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile_id}/agentGroups/{onPremisesAgentGroup_id}{?select,expand}";
