...
namespace Microsoft.Graph.Beta.OnPremisesPublishingProfiles.Item {
    ...
    public class OnPremisesPublishingProfileItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(Action<OnPremisesPublishingProfileItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OnPremisesPublishingProfile> GetAsync(Action<OnPremisesPublishingProfileItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OnPremisesPublishingProfile> PatchAsync(OnPremisesPublishingProfile body, Action<OnPremisesPublishingProfileItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
