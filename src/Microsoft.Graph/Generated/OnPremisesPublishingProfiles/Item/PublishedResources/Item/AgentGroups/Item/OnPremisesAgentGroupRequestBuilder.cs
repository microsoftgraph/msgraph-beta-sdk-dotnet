...
using MicrosoftGraph.OnPremisesPublishingProfiles.Item.PublishedResources.Item.AgentGroups.Item.Agents;
using MicrosoftGraph.OnPremisesPublishingProfiles.Item.PublishedResources.Item.AgentGroups.Item.PublishedResources;
using System;
...
namespace MicrosoftGraph.OnPremisesPublishingProfiles.Item.PublishedResources.Item.AgentGroups.Item {
    ...
    public class OnPremisesAgentGroupRequestBuilder {
        ...
        public OnPremisesAgentGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile_id}/publishedResources/{publishedResource_id}/agentGroups/{onPremisesAgentGroup_id}{?select,expand}";
