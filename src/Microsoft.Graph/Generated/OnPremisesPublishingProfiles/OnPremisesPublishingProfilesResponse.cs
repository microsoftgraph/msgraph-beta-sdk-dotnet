...
namespace MicrosoftGraphSdk.OnPremisesPublishingProfiles {
    public class OnPremisesPublishingProfilesResponse : IParsable {
        ...
        /// </summary>
        public static OnPremisesPublishingProfilesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new OnPremisesPublishingProfilesResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as OnPremisesPublishingProfilesResponse).Value = n.GetCollectionOfObjectValues<OnPremisesPublishingProfile>(OnPremisesPublishingProfile.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
