...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DataPolicyOperationItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DataPolicyOperationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DataPolicyOperation?> GetAsync(CancellationToken cancellationToken = default, Action<DataPolicyOperationItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DataPolicyOperation> GetAsync(CancellationToken cancellationToken = default, Action<DataPolicyOperationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DataPolicyOperation?> PatchAsync(DataPolicyOperation body, CancellationToken cancellationToken = default, Action<DataPolicyOperationItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DataPolicyOperation> PatchAsync(DataPolicyOperation body, CancellationToken cancellationToken = default, Action<DataPolicyOperationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
