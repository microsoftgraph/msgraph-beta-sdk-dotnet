...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type Comanagement Eligible Device Entity.
    /// </summary>
    [JsonObject(MemberSerialization = MemberSerialization.OptIn)]
    public partial class ComanagementEligibleDeviceEntity : Entity
    {
    
		///<summary>
		/// The ComanagementEligibleDeviceEntity constructor
		///</summary>
        public ComanagementEligibleDeviceEntity()
        {
            this.ODataType = "microsoft.graph.comanagementEligibleDeviceEntity";
        }
        ...
        /// <summary>
        /// Gets or sets co manage eligible status.
        /// CoManageEligibleStatus
        /// </summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore, PropertyName = "coManageEligibleStatus", Required = Newtonsoft.Json.Required.Default)]
        public CoManagementEligibleType? CoManageEligibleStatus { get; set; }
