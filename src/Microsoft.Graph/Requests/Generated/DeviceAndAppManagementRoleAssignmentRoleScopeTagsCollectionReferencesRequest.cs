...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceAndAppManagementRoleAssignmentRoleScopeTagsCollectionReferencesRequest.
    /// </summary>
    public partial class DeviceAndAppManagementRoleAssignmentRoleScopeTagsCollectionReferencesRequest : BaseRequest, IDeviceAndAppManagementRoleAssignmentRoleScopeTagsCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new DeviceAndAppManagementRoleAssignmentRoleScopeTagsCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public DeviceAndAppManagementRoleAssignmentRoleScopeTagsCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task AddAsync(RoleScopeTag roleScopeTag, CancellationToken cancellationToken)
        {
            ...
            var requestBody = new ReferenceRequestBody { ODataId = string.Format("{0}/deviceManagement/roleScopeTags/{1}", this.Client.BaseUrl, roleScopeTag.Id) };
