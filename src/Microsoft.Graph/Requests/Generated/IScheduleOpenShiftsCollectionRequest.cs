...
namespace Microsoft.Graph
{
    ...
    public partial interface IScheduleOpenShiftsCollectionRequest : IBaseRequest
    {
        ...
        IScheduleOpenShiftsCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IScheduleOpenShiftsCollectionRequest Expand(Expression<Func<OpenShift, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IScheduleOpenShiftsCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IScheduleOpenShiftsCollectionRequest Select(Expression<Func<OpenShift, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IScheduleOpenShiftsCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IScheduleOpenShiftsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IScheduleOpenShiftsCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IScheduleOpenShiftsCollectionRequest OrderBy(string value);
    }
}
