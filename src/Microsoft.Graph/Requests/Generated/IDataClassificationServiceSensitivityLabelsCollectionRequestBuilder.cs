...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IDataClassificationServiceSensitivityLabelsCollectionRequestBuilder.
    /// </summary>
    public partial interface IDataClassificationServiceSensitivityLabelsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IDataClassificationServiceSensitivityLabelsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IDataClassificationServiceSensitivityLabelsCollectionRequest Request(IEnumerable<Option> options);
