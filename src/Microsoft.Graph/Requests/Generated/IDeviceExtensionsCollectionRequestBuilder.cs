...
namespace Microsoft.Graph.Beta
{
    ...
    /// </summary>
    public partial interface IDeviceExtensionsCollectionRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IDeviceExtensionsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IDeviceExtensionsCollectionRequest Request(IEnumerable<Option> options);
