...
namespace Microsoft.Graph
{
    ...
    public partial class RecognizeOperationRequest : BaseRequest, IRecognizeOperationRequest
    {
        ...
        {
			if (recognizeOperationToUpdate.AdditionalData != null)
			{
				if (recognizeOperationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					recognizeOperationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, recognizeOperationToUpdate.GetType().Name)
						});
				}
			}
            if (recognizeOperationToUpdate.AdditionalData != null)
