...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetPolicyNoncomplianceReportsRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetPolicyNoncomplianceReportsRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetPolicyNoncomplianceReportsRequest>, IDeviceManagementReportsGetPolicyNoncomplianceReportsRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetPolicyNoncomplianceReportsRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetPolicyNoncomplianceReportsRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetPolicyNoncomplianceReportsRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetPolicyNoncomplianceReportsRequest(functionUrl, this.Client, options);
