...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IChatMessagesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<IChatMessagesCollectionPage> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        System.Threading.Tasks.Task<IChatMessagesCollectionPage> GetAsync(CancellationToken cancellationToken);
        ...
        /// <returns>The request object to send.</returns>
        IChatMessagesCollectionRequest Expand(Expression<Func<ChatMessage, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IChatMessagesCollectionRequest Select(Expression<Func<ChatMessage, object>> selectExpression);
