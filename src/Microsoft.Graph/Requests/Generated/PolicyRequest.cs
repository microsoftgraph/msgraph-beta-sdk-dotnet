...
namespace Microsoft.Graph
{
    ...
    public partial class PolicyRequest : BaseRequest, IPolicyRequest
    {
        ...
        {
			if (policyToUpdate.AdditionalData != null)
			{
				if (policyToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					policyToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, policyToUpdate.GetType().Name)
						});
				}
			}
            if (policyToUpdate.AdditionalData != null)
