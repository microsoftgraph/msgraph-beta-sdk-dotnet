...
namespace Microsoft.Graph
{
    ...
    public partial class IosVppAppAssignedUserLicenseRequest : BaseRequest, IIosVppAppAssignedUserLicenseRequest
    {
        ...
        {
			if (iosVppAppAssignedUserLicenseToUpdate.AdditionalData != null)
			{
				if (iosVppAppAssignedUserLicenseToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					iosVppAppAssignedUserLicenseToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, iosVppAppAssignedUserLicenseToUpdate.GetType().Name)
						});
				}
			}
            if (iosVppAppAssignedUserLicenseToUpdate.AdditionalData != null)
