...
namespace Microsoft.Graph
{
    ...
    public partial interface IPrintJobDocumentsCollectionRequest : IBaseRequest
    {
        ...
        IPrintJobDocumentsCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IPrintJobDocumentsCollectionRequest Expand(Expression<Func<PrintDocument, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IPrintJobDocumentsCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IPrintJobDocumentsCollectionRequest Select(Expression<Func<PrintDocument, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IPrintJobDocumentsCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IPrintJobDocumentsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IPrintJobDocumentsCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IPrintJobDocumentsCollectionRequest OrderBy(string value);
    }
}
