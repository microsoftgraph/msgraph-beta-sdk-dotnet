...
namespace Microsoft.Graph.Beta
{
    ...
    /// </summary>
    public partial interface IDeviceTransitiveMemberOfCollectionWithReferencesRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IDeviceTransitiveMemberOfCollectionWithReferencesRequest Request();
        ...
        /// <returns>The built request.</returns>
        IDeviceTransitiveMemberOfCollectionWithReferencesRequest Request(IEnumerable<Option> options);
        ...
        IDeviceTransitiveMemberOfCollectionReferencesRequestBuilder References { get; }
