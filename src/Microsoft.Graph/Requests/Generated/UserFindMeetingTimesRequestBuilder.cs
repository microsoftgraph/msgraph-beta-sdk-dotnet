...
namespace Microsoft.Graph
{
    ...
    public partial class UserFindMeetingTimesRequestBuilder : BaseActionMethodRequestBuilder<IUserFindMeetingTimesRequest>, IUserFindMeetingTimesRequestBuilder
    {
        ...
        public UserFindMeetingTimesRequestBuilder(
            string requestUrl,
            IBaseClient client,
            IEnumerable<AttendeeDataModel> attendees,
            LocationConstraints locationConstraint,
            FindMeetingTimesTimeConstraints timeConstraint,
        ...
        protected override IUserFindMeetingTimesRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            ...
            {
                request.RequestBody.Attendees = this.GetParameter<IEnumerable<AttendeeDataModel>>("attendees");
            }

            if (this.HasParameter("locationConstraint"))
            {
                request.RequestBody.LocationConstraint = this.GetParameter<LocationConstraints>("locationConstraint");
            }

            if (this.HasParameter("timeConstraint"))
            {
                request.RequestBody.TimeConstraint = this.GetParameter<FindMeetingTimesTimeConstraints>("timeConstraint");
            }
