...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AccessReviewScheduleDefinitionReferenceRequest.
    /// </summary>
    public partial class AccessReviewScheduleDefinitionReferenceRequest : BaseRequest, IAccessReviewScheduleDefinitionReferenceRequest
    {
        /// <summary>
        /// Constructs a new AccessReviewScheduleDefinitionReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public AccessReviewScheduleDefinitionReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// </summary>
        /// <param name="id">The AccessReviewScheduleDefinition reference to update.</param>
        /// <returns>The task to await.</returns>
