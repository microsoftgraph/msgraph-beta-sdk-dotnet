...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type JournalRequestBuilder.
    /// </summary>
    public partial class JournalRequestBuilder : EntityRequestBuilder, IJournalRequestBuilder
    {

        /// <summary>
        /// Constructs a new JournalRequestBuilder.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        public JournalRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public new IJournalRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public new IJournalRequest Request(IEnumerable<Option> options)
        {
            return new JournalRequest(this.RequestUrl, this.Client, options);
        }
        ...
        public IJournalJournalLinesCollectionRequestBuilder JournalLines
        {
            get
            {
                return new JournalJournalLinesCollectionRequestBuilder(this.AppendSegmentToRequestUrl("journalLines"), this.Client);
            }
        }
