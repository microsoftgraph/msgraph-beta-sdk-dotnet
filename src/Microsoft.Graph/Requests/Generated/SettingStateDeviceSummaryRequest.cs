...
namespace Microsoft.Graph
{
    ...
    public partial class SettingStateDeviceSummaryRequest : BaseRequest, ISettingStateDeviceSummaryRequest
    {
        ...
        public System.Threading.Tasks.Task<SettingStateDeviceSummary> CreateAsync(SettingStateDeviceSummary settingStateDeviceSummaryToCreate)
        {
            return this.CreateAsync(settingStateDeviceSummaryToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created SettingStateDeviceSummary.</returns>
        public async System.Threading.Tasks.Task<SettingStateDeviceSummary> CreateAsync(SettingStateDeviceSummary settingStateDeviceSummaryToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<SettingStateDeviceSummary> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The SettingStateDeviceSummary.</returns>
        public async System.Threading.Tasks.Task<SettingStateDeviceSummary> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        public System.Threading.Tasks.Task<SettingStateDeviceSummary> UpdateAsync(SettingStateDeviceSummary settingStateDeviceSummaryToUpdate)
        {
            return this.UpdateAsync(settingStateDeviceSummaryToUpdate, CancellationToken.None);
        }
        ...
        /// <returns>The updated SettingStateDeviceSummary.</returns>
        public async System.Threading.Tasks.Task<SettingStateDeviceSummary> UpdateAsync(SettingStateDeviceSummary settingStateDeviceSummaryToUpdate, CancellationToken cancellationToken)
        {
			if (settingStateDeviceSummaryToUpdate.AdditionalData != null)
			{
				if (settingStateDeviceSummaryToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					settingStateDeviceSummaryToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, settingStateDeviceSummaryToUpdate.GetType().Name)
						});
				}
			}
            if (settingStateDeviceSummaryToUpdate.AdditionalData != null)
