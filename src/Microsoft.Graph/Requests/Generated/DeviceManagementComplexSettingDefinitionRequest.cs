...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementComplexSettingDefinitionRequest : BaseRequest, IDeviceManagementComplexSettingDefinitionRequest
    {
        ...
        public System.Threading.Tasks.Task<DeviceManagementComplexSettingDefinition> CreateAsync(DeviceManagementComplexSettingDefinition deviceManagementComplexSettingDefinitionToCreate)
        {
            return this.CreateAsync(deviceManagementComplexSettingDefinitionToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created DeviceManagementComplexSettingDefinition.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementComplexSettingDefinition> CreateAsync(DeviceManagementComplexSettingDefinition deviceManagementComplexSettingDefinitionToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<DeviceManagementComplexSettingDefinition> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The DeviceManagementComplexSettingDefinition.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementComplexSettingDefinition> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        public System.Threading.Tasks.Task<DeviceManagementComplexSettingDefinition> UpdateAsync(DeviceManagementComplexSettingDefinition deviceManagementComplexSettingDefinitionToUpdate)
        {
            return this.UpdateAsync(deviceManagementComplexSettingDefinitionToUpdate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The updated DeviceManagementComplexSettingDefinition.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementComplexSettingDefinition> UpdateAsync(DeviceManagementComplexSettingDefinition deviceManagementComplexSettingDefinitionToUpdate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "PATCH";
