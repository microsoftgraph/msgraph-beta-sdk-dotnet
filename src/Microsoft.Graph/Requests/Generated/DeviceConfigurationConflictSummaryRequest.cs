...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceConfigurationConflictSummaryRequest : BaseRequest, IDeviceConfigurationConflictSummaryRequest
    {
        ...
        public System.Threading.Tasks.Task<DeviceConfigurationConflictSummary> CreateAsync(DeviceConfigurationConflictSummary deviceConfigurationConflictSummaryToCreate)
        {
            return this.CreateAsync(deviceConfigurationConflictSummaryToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created DeviceConfigurationConflictSummary.</returns>
        public async System.Threading.Tasks.Task<DeviceConfigurationConflictSummary> CreateAsync(DeviceConfigurationConflictSummary deviceConfigurationConflictSummaryToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<DeviceConfigurationConflictSummary> UpdateAsync(DeviceConfigurationConflictSummary deviceConfigurationConflictSummaryToUpdate)
        {
            return this.UpdateAsync(deviceConfigurationConflictSummaryToUpdate, CancellationToken.None);
        }
        ...
        /// <returns>The updated DeviceConfigurationConflictSummary.</returns>
        public async System.Threading.Tasks.Task<DeviceConfigurationConflictSummary> UpdateAsync(DeviceConfigurationConflictSummary deviceConfigurationConflictSummaryToUpdate, CancellationToken cancellationToken)
        {
			if (deviceConfigurationConflictSummaryToUpdate.AdditionalData != null)
			{
				if (deviceConfigurationConflictSummaryToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					deviceConfigurationConflictSummaryToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, deviceConfigurationConflictSummaryToUpdate.GetType().Name)
						});
				}
			}
            if (deviceConfigurationConflictSummaryToUpdate.AdditionalData != null)
