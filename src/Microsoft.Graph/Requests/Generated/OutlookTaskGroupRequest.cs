...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type OutlookTaskGroupRequest.
    /// </summary>
    public partial class OutlookTaskGroupRequest : BaseRequest, IOutlookTaskGroupRequest
    {
        /// <summary>
        /// Constructs a new OutlookTaskGroupRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public OutlookTaskGroupRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public IOutlookTaskGroupRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IOutlookTaskGroupRequest Expand(Expression<Func<OutlookTaskGroup, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IOutlookTaskGroupRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IOutlookTaskGroupRequest Select(Expression<Func<OutlookTaskGroup, object>> selectExpression)
        {
        ...
        private void InitializeCollectionProperties(OutlookTaskGroup outlookTaskGroupToInitialize)
        {
            ...
            if (outlookTaskGroupToInitialize != null && outlookTaskGroupToInitialize.AdditionalData != null)
            {
                ...
                if (outlookTaskGroupToInitialize.TaskFolders != null && outlookTaskGroupToInitialize.TaskFolders.CurrentPage != null)
                {
                    ...
                    object nextPageLink;
                    outlookTaskGroupToInitialize.AdditionalData.TryGetValue("taskFolders@odata.nextLink", out nextPageLink);
