...
namespace Microsoft.Graph
{
    ...
    public partial class DomainSecurityProfileRequest : BaseRequest, IDomainSecurityProfileRequest
    {
        ...
        public System.Threading.Tasks.Task<DomainSecurityProfile> CreateAsync(DomainSecurityProfile domainSecurityProfileToCreate)
        {
            return this.CreateAsync(domainSecurityProfileToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created DomainSecurityProfile.</returns>
        public async System.Threading.Tasks.Task<DomainSecurityProfile> CreateAsync(DomainSecurityProfile domainSecurityProfileToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<DomainSecurityProfile> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The DomainSecurityProfile.</returns>
        public async System.Threading.Tasks.Task<DomainSecurityProfile> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        public System.Threading.Tasks.Task<DomainSecurityProfile> UpdateAsync(DomainSecurityProfile domainSecurityProfileToUpdate)
        {
            return this.UpdateAsync(domainSecurityProfileToUpdate, CancellationToken.None);
        }
        ...
        /// <returns>The updated DomainSecurityProfile.</returns>
        public async System.Threading.Tasks.Task<DomainSecurityProfile> UpdateAsync(DomainSecurityProfile domainSecurityProfileToUpdate, CancellationToken cancellationToken)
        {
			if (domainSecurityProfileToUpdate.AdditionalData != null)
			{
				if (domainSecurityProfileToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					domainSecurityProfileToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, domainSecurityProfileToUpdate.GetType().Name)
						});
				}
			}
            if (domainSecurityProfileToUpdate.AdditionalData != null)
