...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceCompliancePolicyGetDevicesScheduledToRetireRequestBuilder : BaseActionMethodRequestBuilder<IDeviceCompliancePolicyGetDevicesScheduledToRetireRequest>, IDeviceCompliancePolicyGetDevicesScheduledToRetireRequestBuilder
    {
        ...
        public DeviceCompliancePolicyGetDevicesScheduledToRetireRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        protected override IDeviceCompliancePolicyGetDevicesScheduledToRetireRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceCompliancePolicyGetDevicesScheduledToRetireRequest(functionUrl, this.Client, options);
