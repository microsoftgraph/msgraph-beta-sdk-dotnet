...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IProfileWebsitesCollectionRequest.
    /// </summary>
    public partial interface IProfileWebsitesCollectionRequest : IBaseRequest
    {
        ...
        IProfileWebsitesCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IProfileWebsitesCollectionRequest Expand(Expression<Func<PersonWebsite, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IProfileWebsitesCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IProfileWebsitesCollectionRequest Select(Expression<Func<PersonWebsite, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IProfileWebsitesCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IProfileWebsitesCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IProfileWebsitesCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IProfileWebsitesCollectionRequest OrderBy(string value);
    }
}
