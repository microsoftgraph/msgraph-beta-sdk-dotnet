...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type GraphServiceSettingsCollectionRequest.
    /// </summary>
    public partial class GraphServiceSettingsCollectionRequest : BaseRequest, IGraphServiceSettingsCollectionRequest
    {
        /// <summary>
        /// Constructs a new GraphServiceSettingsCollectionRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public GraphServiceSettingsCollectionRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public IGraphServiceSettingsCollectionRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IGraphServiceSettingsCollectionRequest Expand(Expression<Func<DirectorySetting, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IGraphServiceSettingsCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IGraphServiceSettingsCollectionRequest Select(Expression<Func<DirectorySetting, object>> selectExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IGraphServiceSettingsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IGraphServiceSettingsCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IGraphServiceSettingsCollectionRequest Skip(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IGraphServiceSettingsCollectionRequest OrderBy(string value)
        {
