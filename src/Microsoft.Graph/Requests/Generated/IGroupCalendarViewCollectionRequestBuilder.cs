...
namespace Microsoft.Graph.Beta
{
    ...
    /// </summary>
    public partial interface IGroupCalendarViewCollectionRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IGroupCalendarViewCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IGroupCalendarViewCollectionRequest Request(IEnumerable<Option> options);
