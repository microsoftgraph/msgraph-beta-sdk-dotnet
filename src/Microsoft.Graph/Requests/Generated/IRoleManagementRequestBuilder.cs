...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IRoleManagementRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IRoleManagementRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IRoleManagementRequest Request(IEnumerable<Option> options);
