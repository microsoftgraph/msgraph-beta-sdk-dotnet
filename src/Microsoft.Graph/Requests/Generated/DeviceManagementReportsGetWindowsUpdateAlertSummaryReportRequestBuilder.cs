...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequest>, IDeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequest(functionUrl, this.Client, options);
