...
namespace Microsoft.Graph.Beta
{
    ...
    /// </summary>
    public partial interface IEventInstancesCollectionRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IEventInstancesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IEventInstancesCollectionRequest Request(IEnumerable<Option> options);
