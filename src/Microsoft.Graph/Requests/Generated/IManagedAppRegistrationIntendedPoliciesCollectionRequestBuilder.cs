...
namespace Microsoft.Graph.Beta
{
    ...
    /// </summary>
    public partial interface IManagedAppRegistrationIntendedPoliciesCollectionRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IManagedAppRegistrationIntendedPoliciesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IManagedAppRegistrationIntendedPoliciesCollectionRequest Request(IEnumerable<Option> options);
