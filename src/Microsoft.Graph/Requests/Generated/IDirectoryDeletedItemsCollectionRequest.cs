...
namespace Microsoft.Graph.Beta
{
    ...
    public partial interface IDirectoryDeletedItemsCollectionRequest : IBaseRequest
    {
        ...
        IDirectoryDeletedItemsCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IDirectoryDeletedItemsCollectionRequest Expand(Expression<Func<DirectoryObject, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IDirectoryDeletedItemsCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IDirectoryDeletedItemsCollectionRequest Select(Expression<Func<DirectoryObject, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IDirectoryDeletedItemsCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IDirectoryDeletedItemsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IDirectoryDeletedItemsCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IDirectoryDeletedItemsCollectionRequest OrderBy(string value);
    }
}
