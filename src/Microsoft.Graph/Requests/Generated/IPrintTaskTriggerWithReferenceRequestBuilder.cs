...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IPrintTaskTriggerWithReferenceRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IPrintTaskTriggerWithReferenceRequest Request();
        ...
        /// <returns>The built request.</returns>
        IPrintTaskTriggerWithReferenceRequest Request(IEnumerable<Option> options);
        ...
        IPrintTaskTriggerReferenceRequestBuilder Reference { get; }
