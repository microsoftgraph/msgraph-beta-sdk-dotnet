...
namespace Microsoft.Graph.Beta
{
    ...
    /// </summary>
    public partial class MacOSDeviceFeaturesConfigurationRequest : BaseRequest, IMacOSDeviceFeaturesConfigurationRequest
    {
        /// <summary>
        ...
        public MacOSDeviceFeaturesConfigurationRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<MacOSDeviceFeaturesConfiguration> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The MacOSDeviceFeaturesConfiguration.</returns>
        public async System.Threading.Tasks.Task<MacOSDeviceFeaturesConfiguration> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var retrievedEntity = await this.SendAsync<MacOSDeviceFeaturesConfiguration>(null, cancellationToken).ConfigureAwait(false);
        ...
        public IMacOSDeviceFeaturesConfigurationRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IMacOSDeviceFeaturesConfigurationRequest Expand(Expression<Func<MacOSDeviceFeaturesConfiguration, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IMacOSDeviceFeaturesConfigurationRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IMacOSDeviceFeaturesConfigurationRequest Select(Expression<Func<MacOSDeviceFeaturesConfiguration, object>> selectExpression)
        {
        ...
        /// </summary>
        /// <param name="macOSDeviceFeaturesConfigurationToInitialize">The <see cref="MacOSDeviceFeaturesConfiguration"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(MacOSDeviceFeaturesConfiguration macOSDeviceFeaturesConfigurationToInitialize)
        {
