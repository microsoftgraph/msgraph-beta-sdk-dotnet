...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IJournalLineRequest.
    /// </summary>
    public partial interface IJournalLineRequest : IBaseRequest
    {
        ...
        /// <returns>The created JournalLine.</returns>
        System.Threading.Tasks.Task<JournalLine> CreateAsync(JournalLine journalLineToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<JournalLine> UpdateAsync(JournalLine journalLineToUpdate);
        ...
        IJournalLineRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IJournalLineRequest Expand(Expression<Func<JournalLine, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IJournalLineRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IJournalLineRequest Select(Expression<Func<JournalLine, object>> selectExpression);
