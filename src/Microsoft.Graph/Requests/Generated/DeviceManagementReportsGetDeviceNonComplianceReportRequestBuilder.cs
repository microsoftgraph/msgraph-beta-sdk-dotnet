...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DeviceManagementReportsGetDeviceNonComplianceReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetDeviceNonComplianceReportRequest>, IDeviceManagementReportsGetDeviceNonComplianceReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetDeviceNonComplianceReportRequestBuilder"/>.
        /// </summary>
        ...
        protected override IDeviceManagementReportsGetDeviceNonComplianceReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetDeviceNonComplianceReportRequest(functionUrl, this.Client, options);
