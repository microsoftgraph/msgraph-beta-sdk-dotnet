...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetUnhealthyDefenderAgentsReportRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetUnhealthyDefenderAgentsReportRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetUnhealthyDefenderAgentsReportRequest>, IDeviceManagementReportsGetUnhealthyDefenderAgentsReportRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetUnhealthyDefenderAgentsReportRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetUnhealthyDefenderAgentsReportRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetUnhealthyDefenderAgentsReportRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetUnhealthyDefenderAgentsReportRequest(functionUrl, this.Client, options);
