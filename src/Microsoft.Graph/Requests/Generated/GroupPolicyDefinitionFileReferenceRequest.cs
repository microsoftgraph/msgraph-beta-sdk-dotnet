...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type GroupPolicyDefinitionFileReferenceRequest.
    /// </summary>
    public partial class GroupPolicyDefinitionFileReferenceRequest : BaseRequest, IGroupPolicyDefinitionFileReferenceRequest
    {
        /// <summary>
        /// Constructs a new GroupPolicyDefinitionFileReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public GroupPolicyDefinitionFileReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// </summary>
        /// <param name="id">The GroupPolicyDefinitionFile reference to update.</param>
        /// <returns>The task to await.</returns>
