...
namespace Microsoft.Graph.Beta
{
    ...
    /// </summary>
    public partial interface IEducationUserClassesCollectionWithReferencesRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IEducationUserClassesCollectionWithReferencesRequest Request();
        ...
        /// <returns>The built request.</returns>
        IEducationUserClassesCollectionWithReferencesRequest Request(IEnumerable<Option> options);
        ...
        IEducationUserClassesCollectionReferencesRequestBuilder References { get; }
