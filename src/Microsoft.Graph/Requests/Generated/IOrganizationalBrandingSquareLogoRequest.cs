...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IOrganizationalBrandingSquareLogoRequest.
    /// </summary>
    public partial interface IOrganizationalBrandingSquareLogoRequest : IBaseRequest
    {
        /// <summary>
        /// Gets the stream.
        /// </summary>
        ...
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream squareLogo) where T : OrganizationalBranding;
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream squareLogo, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : OrganizationalBranding;
