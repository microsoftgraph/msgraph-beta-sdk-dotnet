...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceManagementReportsGetDeviceNoncomplianceReportsRequestBuilder.
    /// </summary>
    public partial class DeviceManagementReportsGetDeviceNoncomplianceReportsRequestBuilder : BaseActionMethodRequestBuilder<IDeviceManagementReportsGetDeviceNoncomplianceReportsRequest>, IDeviceManagementReportsGetDeviceNoncomplianceReportsRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="DeviceManagementReportsGetDeviceNoncomplianceReportsRequestBuilder"/>.
        /// </summary>
        ...
        public DeviceManagementReportsGetDeviceNoncomplianceReportsRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string name,
        ...
        protected override IDeviceManagementReportsGetDeviceNoncomplianceReportsRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new DeviceManagementReportsGetDeviceNoncomplianceReportsRequest(functionUrl, this.Client, options);
