...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ApplicationSignInSummaryRequest.
    /// </summary>
    public partial class ApplicationSignInSummaryRequest : BaseRequest, IApplicationSignInSummaryRequest
    {
        /// <summary>
        /// Constructs a new ApplicationSignInSummaryRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ApplicationSignInSummaryRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<ApplicationSignInSummary> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The ApplicationSignInSummary.</returns>
        public async System.Threading.Tasks.Task<ApplicationSignInSummary> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var retrievedEntity = await this.SendAsync<ApplicationSignInSummary>(null, cancellationToken).ConfigureAwait(false);
        ...
        public IApplicationSignInSummaryRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IApplicationSignInSummaryRequest Expand(Expression<Func<ApplicationSignInSummary, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IApplicationSignInSummaryRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IApplicationSignInSummaryRequest Select(Expression<Func<ApplicationSignInSummary, object>> selectExpression)
        {
        ...
        /// </summary>
        /// <param name="applicationSignInSummaryToInitialize">The <see cref="ApplicationSignInSummary"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(ApplicationSignInSummary applicationSignInSummaryToInitialize)
        {
