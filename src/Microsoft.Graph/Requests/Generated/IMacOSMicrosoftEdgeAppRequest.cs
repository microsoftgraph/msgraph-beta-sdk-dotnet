...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IMacOSMicrosoftEdgeAppRequest : IBaseRequest
    {
        /// <summary>
        ...
        System.Threading.Tasks.Task<MacOSMicrosoftEdgeApp> CreateAsync(MacOSMicrosoftEdgeApp macOSMicrosoftEdgeAppToCreate);        /// <summary>
        /// Creates the specified MacOSMicrosoftEdgeApp using POST.
        /// </summary>
        /// <param name="macOSMicrosoftEdgeAppToCreate">The MacOSMicrosoftEdgeApp to create.</param>
        ...
        IMacOSMicrosoftEdgeAppRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IMacOSMicrosoftEdgeAppRequest Expand(Expression<Func<MacOSMicrosoftEdgeApp, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IMacOSMicrosoftEdgeAppRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IMacOSMicrosoftEdgeAppRequest Select(Expression<Func<MacOSMicrosoftEdgeApp, object>> selectExpression);
