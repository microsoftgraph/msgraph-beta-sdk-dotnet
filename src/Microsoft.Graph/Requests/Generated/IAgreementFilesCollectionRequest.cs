...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IAgreementFilesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<IAgreementFilesCollectionPage> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        System.Threading.Tasks.Task<IAgreementFilesCollectionPage> GetAsync(CancellationToken cancellationToken);
        ...
        IAgreementFilesCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IAgreementFilesCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IAgreementFilesCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IAgreementFilesCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IAgreementFilesCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IAgreementFilesCollectionRequest OrderBy(string value);
    }
}
