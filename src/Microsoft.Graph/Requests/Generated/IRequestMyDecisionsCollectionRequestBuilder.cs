...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IRequestMyDecisionsCollectionRequestBuilder.
    /// </summary>
    public partial interface IRequestMyDecisionsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IRequestMyDecisionsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IRequestMyDecisionsCollectionRequest Request(IEnumerable<Option> options);
