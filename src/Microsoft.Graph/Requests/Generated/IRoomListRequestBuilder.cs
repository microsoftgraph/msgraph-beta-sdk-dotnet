...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IRoomListRequestBuilder : IPlaceRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IRoomListRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IRoomListRequest Request(IEnumerable<Option> options);
