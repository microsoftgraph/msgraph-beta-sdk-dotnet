...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IDeviceShellScriptUserRunStatesCollectionRequestBuilder.
    /// </summary>
    public partial interface IDeviceShellScriptUserRunStatesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IDeviceShellScriptUserRunStatesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IDeviceShellScriptUserRunStatesCollectionRequest Request(IEnumerable<Option> options);
