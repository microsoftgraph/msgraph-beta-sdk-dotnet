...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidManagedStoreAppConfigurationSchemaRequest : BaseRequest, IAndroidManagedStoreAppConfigurationSchemaRequest
    {
        ...
        {
			if (androidManagedStoreAppConfigurationSchemaToUpdate.AdditionalData != null)
			{
				if (androidManagedStoreAppConfigurationSchemaToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					androidManagedStoreAppConfigurationSchemaToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, androidManagedStoreAppConfigurationSchemaToUpdate.GetType().Name)
						});
				}
			}
            if (androidManagedStoreAppConfigurationSchemaToUpdate.AdditionalData != null)
