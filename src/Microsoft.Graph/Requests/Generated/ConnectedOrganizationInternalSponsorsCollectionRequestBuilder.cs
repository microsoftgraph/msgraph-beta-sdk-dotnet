...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ConnectedOrganizationInternalSponsorsCollectionRequestBuilder : BaseRequestBuilder, IConnectedOrganizationInternalSponsorsCollectionRequestBuilder
    {
        /// <summary>
        ...
        public ConnectedOrganizationInternalSponsorsCollectionRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public IConnectedOrganizationInternalSponsorsCollectionRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public IConnectedOrganizationInternalSponsorsCollectionRequest Request(IEnumerable<Option> options)
        {
            return new ConnectedOrganizationInternalSponsorsCollectionRequest(this.RequestUrl, this.Client, options);
        }

        /// <summary>
        /// Gets an <see cref="IDirectoryObjectRequestBuilder"/> for the specified ConnectedOrganizationDirectoryObject.
        /// </summary>
