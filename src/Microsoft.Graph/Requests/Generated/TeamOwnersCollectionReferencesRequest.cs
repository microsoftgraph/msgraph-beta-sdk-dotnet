...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type TeamOwnersCollectionReferencesRequest.
    /// </summary>
    public partial class TeamOwnersCollectionReferencesRequest : BaseRequest, ITeamOwnersCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new TeamOwnersCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public TeamOwnersCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <returns>The task to await.</returns>
        public System.Threading.Tasks.Task AddAsync(User user, CancellationToken cancellationToken)
        {
