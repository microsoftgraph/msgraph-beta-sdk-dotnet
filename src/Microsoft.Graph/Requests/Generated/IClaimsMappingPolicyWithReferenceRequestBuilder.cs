...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IClaimsMappingPolicyWithReferenceRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IClaimsMappingPolicyWithReferenceRequest Request();
        ...
        /// <returns>The built request.</returns>
        IClaimsMappingPolicyWithReferenceRequest Request(IEnumerable<Option> options);
        ...
        IClaimsMappingPolicyReferenceRequestBuilder Reference { get; }
