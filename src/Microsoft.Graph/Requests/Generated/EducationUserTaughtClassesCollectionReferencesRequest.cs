...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class EducationUserTaughtClassesCollectionReferencesRequest : BaseRequest, IEducationUserTaughtClassesCollectionReferencesRequest
    {
        /// <summary>
        ...
        public EducationUserTaughtClassesCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task AddAsync(EducationClass educationClass, CancellationToken cancellationToken)
        {
            ...
            var requestBody = new ReferenceRequestBody { ODataId = string.Format("{0}/education/taughtClasses/{1}", this.Client.BaseUrl, educationClass.Id) };
