...
namespace Microsoft.Graph
{
    ...
    public partial class ApplicationSignInDetailedSummaryRequest : BaseRequest, IApplicationSignInDetailedSummaryRequest
    {
        ...
        public System.Threading.Tasks.Task<ApplicationSignInDetailedSummary> CreateAsync(ApplicationSignInDetailedSummary applicationSignInDetailedSummaryToCreate)
        {
            return this.CreateAsync(applicationSignInDetailedSummaryToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created ApplicationSignInDetailedSummary.</returns>
        public async System.Threading.Tasks.Task<ApplicationSignInDetailedSummary> CreateAsync(ApplicationSignInDetailedSummary applicationSignInDetailedSummaryToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<ApplicationSignInDetailedSummary> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The ApplicationSignInDetailedSummary.</returns>
        public async System.Threading.Tasks.Task<ApplicationSignInDetailedSummary> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        public System.Threading.Tasks.Task<ApplicationSignInDetailedSummary> UpdateAsync(ApplicationSignInDetailedSummary applicationSignInDetailedSummaryToUpdate)
        {
            return this.UpdateAsync(applicationSignInDetailedSummaryToUpdate, CancellationToken.None);
        }
        ...
        /// <returns>The updated ApplicationSignInDetailedSummary.</returns>
        public async System.Threading.Tasks.Task<ApplicationSignInDetailedSummary> UpdateAsync(ApplicationSignInDetailedSummary applicationSignInDetailedSummaryToUpdate, CancellationToken cancellationToken)
        {
			if (applicationSignInDetailedSummaryToUpdate.AdditionalData != null)
			{
				if (applicationSignInDetailedSummaryToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					applicationSignInDetailedSummaryToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, applicationSignInDetailedSummaryToUpdate.GetType().Name)
						});
				}
			}
            if (applicationSignInDetailedSummaryToUpdate.AdditionalData != null)
