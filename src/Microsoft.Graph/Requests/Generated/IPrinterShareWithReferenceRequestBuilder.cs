...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IPrinterShareWithReferenceRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IPrinterShareWithReferenceRequest Request();
        ...
        /// <returns>The built request.</returns>
        IPrinterShareWithReferenceRequest Request(IEnumerable<Option> options);
        ...
        IPrinterShareReferenceRequestBuilder Reference { get; }
