...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PresenceReferenceRequest.
    /// </summary>
    public partial class PresenceReferenceRequest : BaseRequest, IPresenceReferenceRequest
    {
        /// <summary>
        /// Constructs a new PresenceReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public PresenceReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified Presence reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified Presence reference.
        /// </summary>
        /// <param name="id">The Presence reference to update.</param>
        /// <returns>The task to await.</returns>
