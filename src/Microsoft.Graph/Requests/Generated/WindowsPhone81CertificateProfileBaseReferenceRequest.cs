...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type WindowsPhone81CertificateProfileBaseReferenceRequest.
    /// </summary>
    public partial class WindowsPhone81CertificateProfileBaseReferenceRequest : BaseRequest, IWindowsPhone81CertificateProfileBaseReferenceRequest
    {
        /// <summary>
        /// Constructs a new WindowsPhone81CertificateProfileBaseReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public WindowsPhone81CertificateProfileBaseReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified WindowsPhone81CertificateProfileBase reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified WindowsPhone81CertificateProfileBase reference.
        /// </summary>
        /// <param name="id">The WindowsPhone81CertificateProfileBase reference to update.</param>
        /// <returns>The task to await.</returns>
