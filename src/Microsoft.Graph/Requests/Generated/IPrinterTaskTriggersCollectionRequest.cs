...
namespace Microsoft.Graph
{
    ...
    public partial interface IPrinterTaskTriggersCollectionRequest : IBaseRequest
    {
        ...
        IPrinterTaskTriggersCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IPrinterTaskTriggersCollectionRequest Expand(Expression<Func<PrintTaskTrigger, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IPrinterTaskTriggersCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IPrinterTaskTriggersCollectionRequest Select(Expression<Func<PrintTaskTrigger, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IPrinterTaskTriggersCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IPrinterTaskTriggersCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IPrinterTaskTriggersCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IPrinterTaskTriggersCollectionRequest OrderBy(string value);
    }
}
