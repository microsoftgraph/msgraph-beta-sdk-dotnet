...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceCompliancePolicyGroupAssignmentRequest.
    /// </summary>
    public partial class DeviceCompliancePolicyGroupAssignmentRequest : BaseRequest, IDeviceCompliancePolicyGroupAssignmentRequest
    {
        /// <summary>
        /// Constructs a new DeviceCompliancePolicyGroupAssignmentRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public DeviceCompliancePolicyGroupAssignmentRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<DeviceCompliancePolicyGroupAssignment> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The DeviceCompliancePolicyGroupAssignment.</returns>
        public async System.Threading.Tasks.Task<DeviceCompliancePolicyGroupAssignment> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var retrievedEntity = await this.SendAsync<DeviceCompliancePolicyGroupAssignment>(null, cancellationToken).ConfigureAwait(false);
        ...
        public IDeviceCompliancePolicyGroupAssignmentRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDeviceCompliancePolicyGroupAssignmentRequest Expand(Expression<Func<DeviceCompliancePolicyGroupAssignment, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDeviceCompliancePolicyGroupAssignmentRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDeviceCompliancePolicyGroupAssignmentRequest Select(Expression<Func<DeviceCompliancePolicyGroupAssignment, object>> selectExpression)
        {
        ...
        /// </summary>
        /// <param name="deviceCompliancePolicyGroupAssignmentToInitialize">The <see cref="DeviceCompliancePolicyGroupAssignment"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(DeviceCompliancePolicyGroupAssignment deviceCompliancePolicyGroupAssignmentToInitialize)
        {
