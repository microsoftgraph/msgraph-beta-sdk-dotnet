...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type GroupPolicyCategoryReferenceRequest.
    /// </summary>
    public partial class GroupPolicyCategoryReferenceRequest : BaseRequest, IGroupPolicyCategoryReferenceRequest
    {
        /// <summary>
        /// Constructs a new GroupPolicyCategoryReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public GroupPolicyCategoryReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified GroupPolicyCategory reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified GroupPolicyCategory reference.
        /// </summary>
        /// <param name="id">The GroupPolicyCategory reference to update.</param>
        /// <returns>The task to await.</returns>
