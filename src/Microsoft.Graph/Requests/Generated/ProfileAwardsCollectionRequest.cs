...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ProfileAwardsCollectionRequest.
    /// </summary>
    public partial class ProfileAwardsCollectionRequest : BaseRequest, IProfileAwardsCollectionRequest
    {
        /// <summary>
        /// Constructs a new ProfileAwardsCollectionRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ProfileAwardsCollectionRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public IProfileAwardsCollectionRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IProfileAwardsCollectionRequest Expand(Expression<Func<PersonAward, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IProfileAwardsCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IProfileAwardsCollectionRequest Select(Expression<Func<PersonAward, object>> selectExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IProfileAwardsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IProfileAwardsCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IProfileAwardsCollectionRequest Skip(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IProfileAwardsCollectionRequest OrderBy(string value)
        {
