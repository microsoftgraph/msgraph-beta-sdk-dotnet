...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IRequestDecisionsCollectionRequestBuilder.
    /// </summary>
    public partial interface IRequestDecisionsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IRequestDecisionsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IRequestDecisionsCollectionRequest Request(IEnumerable<Option> options);
