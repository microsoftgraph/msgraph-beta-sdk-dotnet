...
namespace Microsoft.Graph.Beta
{
    ...
    /// </summary>
    public partial interface IInvitationRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IInvitationRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IInvitationRequest Request(IEnumerable<Option> options);
