...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementScriptPolicySetItemRequest : BaseRequest, IDeviceManagementScriptPolicySetItemRequest
    {
        ...
        public System.Threading.Tasks.Task<DeviceManagementScriptPolicySetItem> CreateAsync(DeviceManagementScriptPolicySetItem deviceManagementScriptPolicySetItemToCreate)
        {
            return this.CreateAsync(deviceManagementScriptPolicySetItemToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created DeviceManagementScriptPolicySetItem.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementScriptPolicySetItem> CreateAsync(DeviceManagementScriptPolicySetItem deviceManagementScriptPolicySetItemToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<DeviceManagementScriptPolicySetItem> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The DeviceManagementScriptPolicySetItem.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementScriptPolicySetItem> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        public System.Threading.Tasks.Task<DeviceManagementScriptPolicySetItem> UpdateAsync(DeviceManagementScriptPolicySetItem deviceManagementScriptPolicySetItemToUpdate)
        {
            return this.UpdateAsync(deviceManagementScriptPolicySetItemToUpdate, CancellationToken.None);
        }
        ...
        /// <returns>The updated DeviceManagementScriptPolicySetItem.</returns>
        public async System.Threading.Tasks.Task<DeviceManagementScriptPolicySetItem> UpdateAsync(DeviceManagementScriptPolicySetItem deviceManagementScriptPolicySetItemToUpdate, CancellationToken cancellationToken)
        {
			if (deviceManagementScriptPolicySetItemToUpdate.AdditionalData != null)
			{
				if (deviceManagementScriptPolicySetItemToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					deviceManagementScriptPolicySetItemToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, deviceManagementScriptPolicySetItemToUpdate.GetType().Name)
						});
				}
			}
            if (deviceManagementScriptPolicySetItemToUpdate.AdditionalData != null)
