...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type GroupPolicyDefinitionReferenceRequest.
    /// </summary>
    public partial class GroupPolicyDefinitionReferenceRequest : BaseRequest, IGroupPolicyDefinitionReferenceRequest
    {
        /// <summary>
        /// Constructs a new GroupPolicyDefinitionReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public GroupPolicyDefinitionReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// </summary>
        /// <param name="id">The GroupPolicyDefinition reference to update.</param>
        /// <returns>The task to await.</returns>
