...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ApplicationClaimsMappingPoliciesCollectionReferencesRequest.
    /// </summary>
    public partial class ApplicationClaimsMappingPoliciesCollectionReferencesRequest : BaseRequest, IApplicationClaimsMappingPoliciesCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new ApplicationClaimsMappingPoliciesCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ApplicationClaimsMappingPoliciesCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
