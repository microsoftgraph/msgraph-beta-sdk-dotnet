...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ChatMessageHostedImageContentRequest.
    /// </summary>
    public partial class ChatMessageHostedImageContentRequest : BaseRequest, IChatMessageHostedImageContentRequest
    {
        /// <summary>
        /// Constructs a new ChatMessageHostedImageContentRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public ChatMessageHostedImageContentRequest(
            string requestUrl,
            IBaseClient client,
