...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IChatMessagesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IChatMessagesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IChatMessagesCollectionRequest Request(IEnumerable<Option> options);
