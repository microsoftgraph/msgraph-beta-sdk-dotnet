...
namespace Microsoft.Graph.Beta
{
    ...
    /// </summary>
    public partial interface IUserManagedAppRegistrationsCollectionWithReferencesRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IUserManagedAppRegistrationsCollectionWithReferencesRequest Request();
        ...
        /// <returns>The built request.</returns>
        IUserManagedAppRegistrationsCollectionWithReferencesRequest Request(IEnumerable<Option> options);

        /// <summary>
        /// Gets an <see cref="IManagedAppRegistrationWithReferenceRequestBuilder"/> for the specified ManagedAppRegistration.
        /// </summary>
        ...
        IManagedAppRegistrationWithReferenceRequestBuilder this[string id] { get; }
        ...
        IUserManagedAppRegistrationsCollectionReferencesRequestBuilder References { get; }
