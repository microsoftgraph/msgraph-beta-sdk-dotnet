...
namespace Microsoft.Graph.Beta
{
    ...
    /// </summary>
    public partial interface IPlannerPlanBucketsCollectionRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IPlannerPlanBucketsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IPlannerPlanBucketsCollectionRequest Request(IEnumerable<Option> options);
