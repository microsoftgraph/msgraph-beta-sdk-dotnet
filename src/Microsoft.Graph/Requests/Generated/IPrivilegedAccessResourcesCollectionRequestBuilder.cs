...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IPrivilegedAccessResourcesCollectionRequestBuilder.
    /// </summary>
    public partial interface IPrivilegedAccessResourcesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IPrivilegedAccessResourcesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IPrivilegedAccessResourcesCollectionRequest Request(IEnumerable<Option> options);
