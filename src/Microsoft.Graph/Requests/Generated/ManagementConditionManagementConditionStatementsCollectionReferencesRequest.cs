...
namespace Microsoft.Graph
{
    ...
    public partial class ManagementConditionManagementConditionStatementsCollectionReferencesRequest : BaseRequest, IManagementConditionManagementConditionStatementsCollectionReferencesRequest
    {
        ...
        public System.Threading.Tasks.Task AddAsync(ManagementConditionStatement managementConditionStatement)
        {
            return this.AddAsync(managementConditionStatement, CancellationToken.None);
        }
        ...
        /// <returns>The task to await.</returns>
        public System.Threading.Tasks.Task AddAsync(ManagementConditionStatement managementConditionStatement, CancellationToken cancellationToken)
        {
