...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IManagedDeviceUsersCollectionRequestBuilder.
    /// </summary>
    public partial interface IManagedDeviceUsersCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IManagedDeviceUsersCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IManagedDeviceUsersCollectionRequest Request(IEnumerable<Option> options);
