...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidForWorkEnrollmentProfileRequest : BaseRequest, IAndroidForWorkEnrollmentProfileRequest
    {
        ...
        public System.Threading.Tasks.Task<AndroidForWorkEnrollmentProfile> CreateAsync(AndroidForWorkEnrollmentProfile androidForWorkEnrollmentProfileToCreate)
        {
            return this.CreateAsync(androidForWorkEnrollmentProfileToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created AndroidForWorkEnrollmentProfile.</returns>
        public async System.Threading.Tasks.Task<AndroidForWorkEnrollmentProfile> CreateAsync(AndroidForWorkEnrollmentProfile androidForWorkEnrollmentProfileToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<AndroidForWorkEnrollmentProfile> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The AndroidForWorkEnrollmentProfile.</returns>
        public async System.Threading.Tasks.Task<AndroidForWorkEnrollmentProfile> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        public System.Threading.Tasks.Task<AndroidForWorkEnrollmentProfile> UpdateAsync(AndroidForWorkEnrollmentProfile androidForWorkEnrollmentProfileToUpdate)
        {
            return this.UpdateAsync(androidForWorkEnrollmentProfileToUpdate, CancellationToken.None);
        }
        ...
        /// <returns>The updated AndroidForWorkEnrollmentProfile.</returns>
        public async System.Threading.Tasks.Task<AndroidForWorkEnrollmentProfile> UpdateAsync(AndroidForWorkEnrollmentProfile androidForWorkEnrollmentProfileToUpdate, CancellationToken cancellationToken)
        {
			if (androidForWorkEnrollmentProfileToUpdate.AdditionalData != null)
			{
				if (androidForWorkEnrollmentProfileToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					androidForWorkEnrollmentProfileToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, androidForWorkEnrollmentProfileToUpdate.GetType().Name)
						});
				}
			}
            if (androidForWorkEnrollmentProfileToUpdate.AdditionalData != null)
