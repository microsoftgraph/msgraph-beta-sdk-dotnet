...
namespace Microsoft.Graph.Beta
{
    ...
    public partial interface IDeviceAppManagementManagedAppRegistrationsCollectionRequest : IBaseRequest
    {
        ...
        IDeviceAppManagementManagedAppRegistrationsCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IDeviceAppManagementManagedAppRegistrationsCollectionRequest Expand(Expression<Func<ManagedAppRegistration, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IDeviceAppManagementManagedAppRegistrationsCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IDeviceAppManagementManagedAppRegistrationsCollectionRequest Select(Expression<Func<ManagedAppRegistration, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IDeviceAppManagementManagedAppRegistrationsCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IDeviceAppManagementManagedAppRegistrationsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IDeviceAppManagementManagedAppRegistrationsCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IDeviceAppManagementManagedAppRegistrationsCollectionRequest OrderBy(string value);
    }
}
