...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type WindowsDefenderApplicationControlSupplementalPolicyReferenceRequest.
    /// </summary>
    public partial class WindowsDefenderApplicationControlSupplementalPolicyReferenceRequest : BaseRequest, IWindowsDefenderApplicationControlSupplementalPolicyReferenceRequest
    {
        /// <summary>
        /// Constructs a new WindowsDefenderApplicationControlSupplementalPolicyReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public WindowsDefenderApplicationControlSupplementalPolicyReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// </summary>
        /// <param name="id">The WindowsDefenderApplicationControlSupplementalPolicy reference to update.</param>
        /// <returns>The task to await.</returns>
