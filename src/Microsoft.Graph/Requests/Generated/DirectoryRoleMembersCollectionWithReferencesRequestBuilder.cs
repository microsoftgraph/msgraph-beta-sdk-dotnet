...
namespace Microsoft.Graph.Beta
{
    ...
    /// </summary>
    public partial class DirectoryRoleMembersCollectionWithReferencesRequestBuilder : BaseRequestBuilder, IDirectoryRoleMembersCollectionWithReferencesRequestBuilder
    {
        ...
        /// <summary>
        /// Gets an <see cref="IDirectoryRoleMembersCollectionReferencesRequestBuilder"/> for the references in the collection.
        /// </summary>
        /// <returns>The <see cref="IDirectoryRoleMembersCollectionReferencesRequestBuilder"/>.</returns>
        public IDirectoryRoleMembersCollectionReferencesRequestBuilder References
        {
            get
            {
                return new DirectoryRoleMembersCollectionReferencesRequestBuilder(this.AppendSegmentToRequestUrl("$ref"), this.Client);
            }
        }
