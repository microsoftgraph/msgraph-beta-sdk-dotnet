...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IComplianceRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IComplianceRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IComplianceRequest Request(IEnumerable<Option> options);
