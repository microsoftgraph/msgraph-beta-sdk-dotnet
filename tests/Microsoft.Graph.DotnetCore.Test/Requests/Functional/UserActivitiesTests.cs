    ...
    public class UserActivitiesTests : GraphTestBase
    {
        ...
        public async System.Threading.Tasks.Task ActivitiesCreateActivityAndGetBack()
        {
            try
            {
                ...
                Assert.NotNull(createResponse); // Unexpected results, the results contains a null collection.

                // Get activities
                var getResponse = await graphClient.Me.Activities.Request().GetAsync();

                Assert.NotNull(getResponse); // Unexpected results, the results contains a null collection.
        ...
        public async System.Threading.Tasks.Task ActivitiesCreateHistoryAndGetBack()
        {
            try
            {
                ...
                Assert.NotNull(createActivityResponse); // Unexpected results, the results contains a null collection.
                ...
                Assert.NotNull(createHistoryResponse); // Unexpected results, the results contains a null collection.
        ...
        public async System.Threading.Tasks.Task ActivitiesGetRecentActivities()
        {
            try
            {
                ...
                Assert.NotNull(getRecentResponse); // Unexpected results, the results contains a null collection.
        ...
        public async System.Threading.Tasks.Task ActivitiesDeleteActivityAndGetBack()
        {
            try
            {
                ...
                {
                    Assert.True(false, "Activity has not been deleted");
                }
            }
            catch (ServiceException e)
            {
