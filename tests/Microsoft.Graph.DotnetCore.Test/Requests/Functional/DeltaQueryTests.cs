...
namespace Microsoft.Graph.DotnetCore.Test.Requests.Functional
{
    ...
    public class DeltaQueryTests: GraphTestBase
    {
        ...
        public async Task DeltaLinkDriveItem()
        {
            ...
            {
                driveItemDeltaCollectionPage = await new Microsoft.Graph.Beta.Drives.Item.Root.Delta.DeltaRequestBuilder(driveItemDeltaCollectionPage.OdataNextLink, graphClient.RequestAdapter).GetAsync();
            }
            ...
            {
                driveItemDeltaCollectionPage = await new Microsoft.Graph.Beta.Drives.Item.Root.Delta.DeltaRequestBuilder(driveItemDeltaCollectionPage.OdataDeltaLink, graphClient.RequestAdapter).GetAsync();
            }
